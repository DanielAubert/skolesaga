...
export const COURSE_SPANSK_2: TextbookCourse = {
  ...
  chapters: [
    ...
    // Kapittel 11: Viajes y turismo
    { id: 'spansk-2-11-1', number: '11.1', title: 'Destinos y planificación - Reisemål og planlegging', description: 'Reisemål og reiseplanlegging med høflige forespørsler.', estimatedMinutes: 45, exerciseCount: 5, topics: ['Reisemål', 'Condicional', 'Planlegging'], competenceGoals: ['kommunisere om reiser', 'bruke høflighetsformer'] },
    { id: 'spansk-2-11-2', number: '11.2', title: 'En el hotel y en el aeropuerto - Hotell og flyplass', description: 'Hotell- og flyplassvokabular og dialoger.', estimatedMinutes: 45, exerciseCount: 5, topics: ['Hotell', 'Flyplass', 'Innsjekking'], competenceGoals: ['kommunisere i reisesituasjoner'] },
    { id: 'spansk-2-11-3', number: '11.3', title: 'Problemas de viaje - Reiseproblemer', description: 'Klager, forsinkelser og problemløsning på reise.', estimatedMinutes: 45, exerciseCount: 5, topics: ['Klager', 'Forsinkelser', 'Problemløsning'], competenceGoals: ['håndtere problemer på spansk'] },
    { id: 'spansk-2-11-4', number: '11.4', title: 'Escribir sobre viajes - Skrive om reiser', description: 'Reiserapporter med fortidsformer og beskrivende språk.', estimatedMinutes: 45, exerciseCount: 5, topics: ['Reiserapport', 'Fortidsformer', 'Tekstproduksjon'], competenceGoals: ['skrive sammenhengende tekster om reiser'] },
    // Kapittel 12: Salud y bienestar
    { id: 'spansk-2-12-1', number: '12.1', title: 'El cuerpo y la salud - Kropp og helse', description: 'Kroppsdeler og helsevokabular med doler.', estimatedMinutes: 45, exerciseCount: 5, topics: ['Kropp', 'Symptomer', 'Doler'], competenceGoals: ['kommunisere om helse'] },
    { id: 'spansk-2-12-2', number: '12.2', title: 'En el médico y en la farmacia - Hos legen og på apoteket', description: 'Medisinsk vokabular og modalverb.', estimatedMinutes: 45, exerciseCount: 5, topics: ['Lege', 'Apotek', 'Modalverb'], competenceGoals: ['kommunisere i medisinske situasjoner'] },
    { id: 'spansk-2-12-3', number: '12.3', title: 'Fitness y nutrición - Trening og ernæring', description: 'Trening og ernæring med komparativformer.', estimatedMinutes: 45, exerciseCount: 5, topics: ['Trening', 'Ernæring', 'Komparativ'], competenceGoals: ['diskutere helse og livsstil'] },
    { id: 'spansk-2-12-4', number: '12.4', title: 'Salud mental y bienestar - Mental helse og velvære', description: 'Mental helse, følelser og refleksive verb.', estimatedMinutes: 45, exerciseCount: 5, topics: ['Mental helse', 'Følelser', 'Refleksive verb'], competenceGoals: ['kommunisere om følelser og velvære'] },
    // Kapittel 13: Tecnología y mundo digital
    { id: 'spansk-2-13-1', number: '13.1', title: 'Internet y redes sociales - Internett og sosiale medier', description: 'Internett og sosiale medier med subjuntivo.', estimatedMinutes: 45, exerciseCount: 6, topics: ['Internett', 'Sosiale medier', 'Subjuntivo'], competenceGoals: ['diskutere digitale medier'] },
    { id: 'spansk-2-13-2', number: '13.2', title: 'Dispositivos y aplicaciones - Enheter og apper', description: 'Tekniske enheter og imperativo.', estimatedMinutes: 45, exerciseCount: 6, topics: ['Enheter', 'Apper', 'Imperativo'], competenceGoals: ['kommunisere om teknologi'] },
    { id: 'spansk-2-13-3', number: '13.3', title: 'Comunicación digital - Digital kommunikasjon', description: 'Digital kommunikasjon, e-poster og nettsikkerhet.', estimatedMinutes: 45, exerciseCount: 6, topics: ['E-post', 'Nettsikkerhet', 'Register'], competenceGoals: ['skrive digitale tekster på spansk'] },
    { id: 'spansk-2-13-4', number: '13.4', title: 'Tecnología y futuro - Teknologi og fremtid', description: 'Teknologi og fremtiden med futuro simple.', estimatedMinutes: 45, exerciseCount: 6, topics: ['KI', 'Automatisering', 'Futuro simple'], competenceGoals: ['diskutere teknologisk utvikling'] },
    // Kapittel 14: Identidad y convivencia
    { id: 'spansk-2-14-1', number: '14.1', title: 'Identidad y pertenencia - Identitet og tilhørighet', description: 'Identitet, tilhørighet og patria-begrepet.', estimatedMinutes: 45, exerciseCount: 5, topics: ['Identitet', 'Patria', 'Tilhørighet'], competenceGoals: ['reflektere over identitet og tilhørighet'] },
    { id: 'spansk-2-14-2', number: '14.2', title: 'Migración e integración - Migrasjon og integrasjon', description: 'Migrasjon i den spansktalende verden.', estimatedMinutes: 45, exerciseCount: 5, topics: ['Migrasjon', 'Integrasjon', 'Utfordringer'], competenceGoals: ['diskutere migrasjon og samfunn'] },
    { id: 'spansk-2-14-3', number: '14.3', title: 'Convivencia en la sociedad - Sameksistens i samfunnet', description: 'Demokrati, frivillig arbeid og rettigheter.', estimatedMinutes: 45, exerciseCount: 5, topics: ['Samfunn', 'Demokrati', 'Voluntariado'], competenceGoals: ['diskutere samfunnsaktuelle temaer'] },
    { id: 'spansk-2-14-4', number: '14.4', title: 'Comprensión intercultural - Interkulturell forståelse', description: 'Interkulturell forståelse og kommunikasjon.', estimatedMinutes: 45, exerciseCount: 5, topics: ['Interkulturell', 'Stereotyper', 'Kommunikasjon'], competenceGoals: ['reflektere over kulturelle forskjeller'] },
    // Kapittel 15: Escritura creativa y académica
    { id: 'spansk-2-15-1', number: '15.1', title: 'Escritura creativa - Kreativ skriving', description: 'Kreativ skriving - noveller, dikt og stilmidler.', estimatedMinutes: 45, exerciseCount: 5, topics: ['Kreativ skriving', 'Cuento', 'Stilmidler'], competenceGoals: ['skrive kreative tekster på spansk'] },
    { id: 'spansk-2-15-2', number: '15.2', title: 'Textos formales - Formelle tekster', description: 'Formelle tekster - søknader, klager og rapporter.', estimatedMinutes: 45, exerciseCount: 5, topics: ['Søknad', 'Formelt register', 'Klage'], competenceGoals: ['skrive formelle tekster på spansk'] },
    { id: 'spansk-2-15-3', number: '15.3', title: 'Argumentación y ensayo - Argumentasjon og essay', description: 'Argumentasjon og drøftende tekster.', estimatedMinutes: 45, exerciseCount: 5, topics: ['Argumentasjon', 'Ensayo', 'Conectores'], competenceGoals: ['argumentere og drøfte på spansk'] },
    { id: 'spansk-2-15-4', number: '15.4', title: 'Resumen y análisis de textos - Sammendrag og analyse', description: 'Tekstsammendrag og tekstanalyse.', estimatedMinutes: 45, exerciseCount: 5, topics: ['Sammendrag', 'Analyse', 'Metode'], competenceGoals: ['oppsummere og analysere tekster'] },
    // Kapittel 16: Repaso y preparación para exámenes
    { id: 'spansk-2-16-1', number: '16.1', title: 'Repaso de gramática - Grammatikkrepetisjon', description: 'Repetisjon av all grammatikk fra spansk nivå 2.', estimatedMinutes: 50, exerciseCount: 6, topics: ['Grammatikk', 'Subjuntivo', 'Fortidsformer', 'Condicional'], competenceGoals: ['beherske spansk grammatikk på nivå 2'] },
    { id: 'spansk-2-16-2', number: '16.2', title: 'Repaso de vocabulario - Vokabularrepetisjon', description: 'Repetisjon av tematisk ordforråd og orddannelse.', estimatedMinutes: 45, exerciseCount: 6, topics: ['Ordforråd', 'Ordfamilier', 'Falske venner'], competenceGoals: ['beherske tematisk ordforråd'] },
    { id: 'spansk-2-16-3', number: '16.3', title: 'Estrategias de comunicación - Kommunikasjonsstrategier', description: 'Lese-, lytte-, skrive- og samtalestrategier.', estimatedMinutes: 45, exerciseCount: 6, topics: ['Lesestrategier', 'Lyttestrategier', 'Skrivestrategier'], competenceGoals: ['bruke hensiktsmessige kommunikasjonsstrategier'] },
    { id: 'spansk-2-16-4', number: '16.4', title: 'Preparación para exámenes - Eksamensforberedelse', description: 'Eksamensforberedelse med prøveoppgaver og egenvurdering.', estimatedMinutes: 50, exerciseCount: 6, topics: ['Eksamen', 'Prøveoppgaver', 'Egenvurdering'], competenceGoals: ['forberede seg til eksamen i spansk'] },
  ],
};
...
export const COURSE_TYSK_2: TextbookCourse = {
  ...
  chapters: [
    ...
    { id: 'tysk-2-11-1', number: '11.1', title: 'Reiseziele und Reiseplanung', description: 'Reisemål og reiseplanlegging med høflige forespørsler.', estimatedMinutes: 45, exerciseCount: 5, topics: ['Reisemål', 'Konjunktiv II', 'Planlegging'], competenceGoals: ['kommunisere om reiser', 'bruke høflighetsformer'] },
    { id: 'tysk-2-11-2', number: '11.2', title: 'Im Hotel und am Flughafen', description: 'Hotell- og flyplassvokabular og dialoger.', estimatedMinutes: 45, exerciseCount: 5, topics: ['Hotell', 'Flyplass', 'Innsjekking'], competenceGoals: ['kommunisere i reisesituasjoner'] },
    { id: 'tysk-2-11-3', number: '11.3', title: 'Probleme auf Reisen', description: 'Klager, forsinkelser og problemløsning på reise.', estimatedMinutes: 45, exerciseCount: 5, topics: ['Klager', 'Forsinkelser', 'Problemløsning'], competenceGoals: ['håndtere problemer på tysk'] },
    { id: 'tysk-2-11-4', number: '11.4', title: 'Reiseberichte schreiben', description: 'Skrive reiserapporter med preteritum og beskrivende adjektiver.', estimatedMinutes: 45, exerciseCount: 5, topics: ['Reiserapport', 'Preteritum', 'Tekstproduksjon'], competenceGoals: ['skrive sammenhengende tekster om reiser'] },
    // Kapittel 12: Gesundheit und Wohlbefinden
    { id: 'tysk-2-12-1', number: '12.1', title: 'Körperteile und Gesundheit', description: 'Kroppsdeler og helsevokabular.', estimatedMinutes: 45, exerciseCount: 5, topics: ['Kropp', 'Symptomer', 'wehtun + Dativ'], competenceGoals: ['kommunisere om helse'] },
    { id: 'tysk-2-12-2', number: '12.2', title: 'Beim Arzt und in der Apotheke', description: 'Hos legen og på apoteket - medisinsk vokabular.', estimatedMinutes: 45, exerciseCount: 5, topics: ['Lege', 'Apotek', 'Modalverb'], competenceGoals: ['kommunisere i medisinske situasjoner'] },
    { id: 'tysk-2-12-3', number: '12.3', title: 'Fitness und Ernährung', description: 'Trening og ernæring med komparativformer.', estimatedMinutes: 45, exerciseCount: 5, topics: ['Trening', 'Ernæring', 'Komparativ'], competenceGoals: ['diskutere helse og livsstil'] },
    { id: 'tysk-2-12-4', number: '12.4', title: 'Psychische Gesundheit', description: 'Mental helse, følelser og refleksive verb.', estimatedMinutes: 45, exerciseCount: 5, topics: ['Mental helse', 'Følelser', 'Refleksive verb'], competenceGoals: ['kommunisere om følelser og velvære'] },
    // Kapittel 13: Technologie und digitale Welt
    { id: 'tysk-2-13-1', number: '13.1', title: 'Das Internet und soziale Medien', description: 'Internett og sosiale medier - vokabular og delbare verb.', estimatedMinutes: 45, exerciseCount: 5, topics: ['Internett', 'Sosiale medier', 'Delbare verb'], competenceGoals: ['diskutere digitale medier'] },
    { id: 'tysk-2-13-2', number: '13.2', title: 'Technische Geräte und Software', description: 'Tekniske enheter, apper og programvare.', estimatedMinutes: 45, exerciseCount: 5, topics: ['Enheter', 'Programvare', 'Komparativ'], competenceGoals: ['kommunisere om teknologi'] },
    { id: 'tysk-2-13-3', number: '13.3', title: 'Digitale Kommunikation', description: 'Digital kommunikasjon, e-poster og nettsikkerhet.', estimatedMinutes: 45, exerciseCount: 5, topics: ['E-post', 'Nettsikkerhet', 'Personvern'], competenceGoals: ['skrive digitale tekster på tysk'] },
    { id: 'tysk-2-13-4', number: '13.4', title: 'Technologie und Zukunft', description: 'Teknologi og fremtiden - KI, automatisering og debatt.', estimatedMinutes: 45, exerciseCount: 5, topics: ['KI', 'Automatisering', 'Futur I'], competenceGoals: ['diskutere teknologisk utvikling'] },
    // Kapittel 14: Identität und Zusammenleben
    { id: 'tysk-2-14-1', number: '14.1', title: 'Identität und Zugehörigkeit', description: 'Identitet, tilhørighet og Heimat-begrepet.', estimatedMinutes: 45, exerciseCount: 5, topics: ['Identitet', 'Heimat', 'Tilhørighet'], competenceGoals: ['reflektere over identitet og tilhørighet'] },
    { id: 'tysk-2-14-2', number: '14.2', title: 'Migration und Integration', description: 'Migrasjon og integrasjon i Tyskland.', estimatedMinutes: 45, exerciseCount: 5, topics: ['Migrasjon', 'Integrasjon', 'Gastarbeiter'], competenceGoals: ['diskutere migrasjon og samfunn'] },
    { id: 'tysk-2-14-3', number: '14.3', title: 'Zusammenleben in der Gesellschaft', description: 'Sameksistens, demokrati og frivillig arbeid.', estimatedMinutes: 45, exerciseCount: 5, topics: ['Samfunn', 'Demokrati', 'Ehrenamt'], competenceGoals: ['diskutere samfunnsaktuelle temaer'] },
    { id: 'tysk-2-14-4', number: '14.4', title: 'Interkulturelle Verständigung', description: 'Interkulturell forståelse og kommunikasjon.', estimatedMinutes: 45, exerciseCount: 5, topics: ['Interkulturell', 'Stereotyper', 'Kommunikasjon'], competenceGoals: ['reflektere over kulturelle forskjeller'] },
    // Kapittel 15: Kreatives und akademisches Schreiben
    { id: 'tysk-2-15-1', number: '15.1', title: 'Kreatives Schreiben', description: 'Kreativ skriving - noveller, dikt og stilmidler.', estimatedMinutes: 45, exerciseCount: 5, topics: ['Kreativ skriving', 'Novelle', 'Stilmidler'], competenceGoals: ['skrive kreative tekster på tysk'] },
    { id: 'tysk-2-15-2', number: '15.2', title: 'Formelle Texte', description: 'Formelle tekster - søknader, klager og rapporter.', estimatedMinutes: 45, exerciseCount: 5, topics: ['Søknad', 'Formelt register', 'Klage'], competenceGoals: ['skrive formelle tekster på tysk'] },
    { id: 'tysk-2-15-3', number: '15.3', title: 'Argumentation und Erörterung', description: 'Argumentasjon og drøftende tekster.', estimatedMinutes: 45, exerciseCount: 5, topics: ['Argumentasjon', 'Erörterung', 'BBB-modell'], competenceGoals: ['argumentere og drøfte på tysk'] },
    { id: 'tysk-2-15-4', number: '15.4', title: 'Textzusammenfassung und Analyse', description: 'Tekstsammendrag og tekstanalyse.', estimatedMinutes: 45, exerciseCount: 5, topics: ['Sammendrag', 'Analyse', 'Konjunktiv I'], competenceGoals: ['oppsummere og analysere tekster'] },
    // Kapittel 16: Wiederholung und Prüfungsvorbereitung
    { id: 'tysk-2-16-1', number: '16.1', title: 'Grammatik-Wiederholung', description: 'Repetisjon av all grammatikk fra tysk nivå 2.', estimatedMinutes: 50, exerciseCount: 5, topics: ['Grammatikk', 'Perfekt', 'Konjunktiv II', 'Passiv'], competenceGoals: ['beherske tysk grammatikk på nivå 2'] },
    { id: 'tysk-2-16-2', number: '16.2', title: 'Wortschatz-Wiederholung', description: 'Repetisjon av tematisk ordforråd og orddannelse.', estimatedMinutes: 45, exerciseCount: 5, topics: ['Ordforråd', 'Ordfamilier', 'Komposita'], competenceGoals: ['beherske tematisk ordforråd'] },
    { id: 'tysk-2-16-3', number: '16.3', title: 'Textarbeit und Strategien', description: 'Lese-, lytte- og skrivestrategier.', estimatedMinutes: 45, exerciseCount: 5, topics: ['Lesestrategier', 'Lyttestrategier', 'Skrivestrategier'], competenceGoals: ['bruke hensiktsmessige læringsstrategier'] },
    { id: 'tysk-2-16-4', number: '16.4', title: 'Prüfungsvorbereitung', description: 'Eksamensforberedelse med prøveoppgaver og egenvurdering.', estimatedMinutes: 50, exerciseCount: 6, topics: ['Eksamen', 'Prøveoppgaver', 'Egenvurdering'], competenceGoals: ['forberede seg til eksamen i tysk'] },
  ],
};
