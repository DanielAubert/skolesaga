      ...
      content: [
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'lett',
            task: 'Avgjør om trekantparene er kongruente. Angi hvilken kongruenssetning du bruker.',
            subTasks: [
              { label: 'a', task: '$\\triangle ABC$: $AB = 5$ cm, $BC = 7$ cm, $AC = 9$ cm. $\\triangle DEF$: $DE = 5$ cm, $EF = 7$ cm, $DF = 9$ cm.', solution: 'Ja, kongruente etter SSS-setningen. Alle tre par av sider er like: $AB = DE$, $BC = EF$, $AC = DF$. $\\triangle ABC \\cong \\triangle DEF$.' },
              { label: 'b', task: '$\\triangle GHI$: $GH = 4$ cm, $\\angle H = 60°$, $HI = 6$ cm. $\\triangle JKL$: $JK = 4$ cm, $\\angle K = 60°$, $KL = 6$ cm.', solution: 'Ja, kongruente etter SVS-setningen. To sider og vinkelen mellom dem er like: $GH = JK$, $\\angle H = \\angle K$, $HI = KL$. $\\triangle GHI \\cong \\triangle JKL$.' },
              { label: 'c', task: '$\\triangle MNO$: $\\angle M = 40°$, $MN = 8$ cm, $\\angle N = 75°$. $\\triangle PQR$: $\\angle P = 40°$, $PQ = 8$ cm, $\\angle Q = 75°$.', solution: 'Ja, kongruente etter VSV-setningen. To vinkler og siden mellom dem er like: $\\angle M = \\angle P$, $MN = PQ$, $\\angle N = \\angle Q$. $\\triangle MNO \\cong \\triangle PQR$.' },
              { label: 'd', task: '$\\triangle STU$: $ST = 3$ cm, $TU = 5$ cm, $\\angle S = 50°$. $\\triangle VWX$: $VW = 3$ cm, $WX = 5$ cm, $\\angle V = 50°$.', solution: 'Vi kan ikke avgjøre kongruens. Vi har to sider og en vinkel som IKKE ligger mellom sidene (SSV). Dette er ikke en gyldig kongruenssetning.' },
              { label: 'e', task: '$\\triangle ABC$: $\\angle A = 30°$, $\\angle B = 80°$, $AB = 10$ cm. $\\triangle DEF$: $\\angle D = 30°$, $\\angle E = 80°$, $DE = 10$ cm.', solution: 'Ja, kongruente etter VSV-setningen. $\\angle A = \\angle D$, $AB = DE$, $\\angle B = \\angle E$. $\\triangle ABC \\cong \\triangle DEF$.' },
              { label: 'f', task: '$\\triangle PQR$: $PQ = 6$ cm, $QR = 8$ cm, $PR = 11$ cm. $\\triangle STU$: $ST = 8$ cm, $TU = 6$ cm, $SU = 11$ cm.', solution: 'Ja, kongruente etter SSS-setningen. $PQ = TU = 6$, $QR = ST = 8$, $PR = SU = 11$. Korrespondansen er $P \\leftrightarrow U$, $Q \\leftrightarrow T$, $R \\leftrightarrow S$. $\\triangle PQR \\cong \\triangle UTS$.' },
            ],
            solution: 'a) SSS. b) SVS. c) VSV. d) Ikke nok info (SSV). e) VSV. f) SSS med endret korrespondanse.',
            hideInlineSolution: true,
            hints: ['Sjekk om du har 3 sider (SSS), 2 sider og vinkel mellom (SVS), eller 2 vinkler og side mellom (VSV). Husk at SSV ikke er gyldig.'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'lett',
            task: 'Finn de ukjente sidene og vinklene ved hjelp av kongruens.',
            subTasks: [
              { label: 'a', task: '$\\triangle ABC \\cong \\triangle DEF$. Du vet at $AB = 5$ cm, $BC = 8$ cm, $AC = 6$ cm og $\\angle A = 95°$. Finn $DE$, $EF$ og $\\angle D$.', solution: 'Kongruens gir $DE = AB = 5$ cm, $EF = BC = 8$ cm og $\\angle D = \\angle A = 95°$.' },
              { label: 'b', task: '$\\triangle KLM \\cong \\triangle PQR$. Du vet at $\\angle K = 45°$, $\\angle L = 60°$. Finn $\\angle M$, $\\angle P$, $\\angle Q$ og $\\angle R$.', solution: '$\\angle M = 180° - 45° - 60° = 75°$. Kongruens gir $\\angle P = \\angle K = 45°$, $\\angle Q = \\angle L = 60°$, $\\angle R = \\angle M = 75°$.' },
              { label: 'c', task: '$\\triangle XYZ \\cong \\triangle UVW$. Du vet at $XY = 12$ cm, $YZ = 9$ cm og $UV = 12$ cm. Finn $VW$.', solution: '$XY = UV = 12$ cm bekrefter korrespondansen. Dermed er $VW = YZ = 9$ cm.' },
              { label: 'd', task: '$\\triangle ABC \\cong \\triangle DEF$. Du vet at $AB = 7$ cm og omkretsen av $\\triangle DEF$ er $22$ cm. $DE = 7$ cm og $EF = 9$ cm. Finn $AC$ og $BC$.', solution: '$AB = DE = 7$ cm. $DF = 22 - 7 - 9 = 6$ cm. Kongruens gir $AC = DF = 6$ cm og $BC = EF = 9$ cm.' },
              { label: 'e', task: 'To trekanter er kongruente. Den ene har sider $3$ cm, $4$ cm og $5$ cm. Hva er omkretsen av den andre trekanten?', solution: 'Kongruente trekanter har like sider. Omkretsen er $3 + 4 + 5 = 12$ cm.' },
              { label: 'f', task: 'To trekanter er kongruente. Den ene har areal $24$ cm$^2$. Hva er arealet av den andre?', solution: 'Kongruente trekanter har samme areal. Arealet er $24$ cm$^2$.' },
            ],
            solution: 'a) $DE = 5$, $EF = 8$, $\\angle D = 95°$. b) $\\angle M = 75°$, $\\angle P = 45°$, $\\angle Q = 60°$, $\\angle R = 75°$. c) $VW = 9$ cm. d) $AC = 6$ cm, $BC = 9$ cm. e) $12$ cm. f) $24$ cm$^2$.',
            hideInlineSolution: true,
            hints: ['Kongruente trekanter har like korresponderende sider og vinkler. Rekkefølgen på bokstavene viser korrespondansen.'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'lett',
            task: 'Finn den tredje vinkelen i hver trekant og avgjør om trekantparene er kongruente etter AAS.',
            subTasks: [
              { label: 'a', task: '$\\triangle ABC$: $\\angle A = 50°$, $\\angle C = 70°$, $BC = 6$ cm. $\\triangle DEF$: $\\angle D = 50°$, $\\angle F = 70°$, $EF = 6$ cm. Er de kongruente?', solution: '$\\angle B = 180° - 50° - 70° = 60°$ og $\\angle E = 180° - 50° - 70° = 60°$. Vi har $\\angle A = \\angle D$, $\\angle C = \\angle F$ og $BC = EF$ (side motstående lik vinkel). Ja, kongruente etter AAS.' },
              { label: 'b', task: '$\\triangle GHI$: $\\angle G = 35°$, $\\angle H = 90°$, $GH = 10$ cm. $\\triangle JKL$: $\\angle J = 35°$, $\\angle K = 90°$, $JK = 10$ cm. Er de kongruente?', solution: '$\\angle I = 55°$ og $\\angle L = 55°$. Vi har $\\angle G = \\angle J = 35°$, $\\angle H = \\angle K = 90°$ og $GH = JK = 10$ cm (side mellom vinklene). Ja, kongruente etter VSV.' },
              { label: 'c', task: 'Forklar forskjellen mellom VSV og AAS.', solution: 'VSV: siden ligger mellom de to vinklene. AAS: siden ligger IKKE mellom de to vinklene. Begge gir kongruens, men det er viktig å identifisere riktig.' },
              { label: 'd', task: '$\\triangle MNO$: $\\angle M = 40°$, $\\angle O = 80°$, $NO = 7$ cm. $\\triangle PQR$: $\\angle P = 40°$, $\\angle R = 80°$, $QR = 7$ cm.', solution: '$\\angle N = 60°$, $\\angle Q = 60°$. Vi har $\\angle M = \\angle P$, $\\angle O = \\angle R$ og $NO = QR$ (side motstående lik vinkel $M$/$P$). Kongruente etter AAS.' },
              { label: 'e', task: '$\\triangle STU$: $\\angle S = 25°$, $\\angle T = 110°$, $ST = 5$ cm. $\\triangle VWX$: $\\angle V = 25°$, $\\angle W = 110°$, $VW = 8$ cm.', solution: '$\\angle U = 45°$, $\\angle X = 45°$. Vinklene stemmer, men $ST = 5 \\neq VW = 8$. Trekantene er IKKE kongruente (de er formlike, men ikke kongruente).' },
              { label: 'f', task: 'Forklar hvorfor det holder å sjekke to vinkler for å vite at den tredje også er lik.', solution: 'Vinkelsummen i en trekant er alltid $180°$. Hvis to par av vinkler er like, er den tredje vinkelen også lik: $\\angle C = 180° - \\angle A - \\angle B = 180° - \\angle D - \\angle E = \\angle F$.' },
            ],
            solution: 'a) Ja, AAS. b) Ja, VSV. c) VSV: side mellom, AAS: side ikke mellom. d) Ja, AAS. e) Nei, sidene er ulike. f) Vinkelsummen er $180°$.',
            hideInlineSolution: true,
            hints: ['Bruk vinkelsummen $180°$ til å finne den tredje vinkelen. Sjekk deretter om du har nok info for kongruens.'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'medium',
            task: 'Bruk kongruenssetningene til å vise at trekantene er kongruente i følgende geometriske figurer.',
            subTasks: [
              { label: 'a', task: 'I et rektangel ABCD trekkes diagonalene AC og BD som krysser hverandre i M. Vis at $\\triangle ABM \\cong \\triangle CDM$.', solution: 'I et rektangel er $AB = CD$ (motstående sider). Diagonalene halverer hverandre, så $AM = CM$ og $BM = DM$. Etter SSS-setningen er $\\triangle ABM \\cong \\triangle CDM$.' },
              { label: 'b', task: 'I en likebeint trekant ABC med $AB = AC$ trekkes høyden fra A ned på BC, og den treffer BC i M. Vis at $\\triangle ABM \\cong \\triangle ACM$.', solution: '$AB = AC$ (gitt), $AM = AM$ (felles side), $\\angle AMB = \\angle AMC = 90°$ (høyde). Etter SVS (eller rettvinkel-hypotenus-katet): $\\triangle ABM \\cong \\triangle ACM$. Alternativt: $AB = AC$, $\\angle ABM = \\angle ACM$ (grunnvinkler i likebeint trekant), $BM = CM$ (høyden halverer grunnlinjen i likebeint trekant), SSS.' },
              { label: 'c', task: 'To linjestykker AB og CD krysser hverandre i punkt M slik at $AM = CM$ og $BM = DM$. Vis at $\\triangle AMB \\cong \\triangle CMD$.', solution: '$AM = CM$ (gitt), $BM = DM$ (gitt), $\\angle AMB = \\angle CMD$ (toppvinkler). Etter SVS-setningen er $\\triangle AMB \\cong \\triangle CMD$.' },
              { label: 'd', task: 'I en likesidet trekant ABC trekkes medianer fra hvert hjørne til midtpunktet av den motstående siden. Medianene fra B og C treffer henholdsvis midtpunktene $M_{AC}$ og $M_{AB}$. Vis at $\\triangle BM_{AC}C \\cong \\triangle CM_{AB}B$.', solution: '$BM_{AC}$: $BC = BC$ (felles side). I en likesidet trekant er alle sider like, så $BM_{AC} = \\frac{AC}{2} = \\frac{s}{2}$ og $CM_{AB} = \\frac{AB}{2} = \\frac{s}{2}$. Altså $BM_{AC} = CM_{AB}$. Vi har $BC = BC$ (felles), $\\angle B = \\angle C = 60°$ og $BM_{AC} = CM_{AB}$. Etter SVS: $\\triangle BM_{AC}C \\cong \\triangle CM_{AB}B$.' },
            ],
            solution: 'a) SSS med rektangelets egenskaper. b) SVS med likebeint trekant. c) SVS med toppvinkler. d) SVS i likesidet trekant.',
            hideInlineSolution: true,
            hints: ['Se etter felles sider, toppvinkler og egenskaper ved spesielle figurer (rektangel, likebeint trekant, likesidet trekant).'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'medium',
            task: 'Kongruens i koordinatsystemet.',
            subTasks: [
              { label: 'a', task: 'Trekant ABC har hjørner $A(1, 1)$, $B(5, 1)$ og $C(3, 4)$. Finn lengden av alle tre sider.', solution: '$AB = \\sqrt{(5-1)^2 + (1-1)^2} = \\sqrt{16} = 4$. $BC = \\sqrt{(3-5)^2 + (4-1)^2} = \\sqrt{4 + 9} = \\sqrt{13}$. $AC = \\sqrt{(3-1)^2 + (4-1)^2} = \\sqrt{4 + 9} = \\sqrt{13}$.' },
              { label: 'b', task: 'Trekant DEF har hjørner $D(6, 2)$, $E(10, 2)$ og $F(8, 5)$. Finn lengden av alle tre sider.', solution: '$DE = \\sqrt{(10-6)^2 + (2-2)^2} = 4$. $EF = \\sqrt{(8-10)^2 + (5-2)^2} = \\sqrt{4+9} = \\sqrt{13}$. $DF = \\sqrt{(8-6)^2 + (5-2)^2} = \\sqrt{4+9} = \\sqrt{13}$.' },
              { label: 'c', task: 'Er trekantene i a) og b) kongruente? Begrunn med riktig kongruenssetning.', solution: '$AB = DE = 4$, $BC = EF = \\sqrt{13}$, $AC = DF = \\sqrt{13}$. Alle tre par av sider er like, så etter SSS-setningen er $\\triangle ABC \\cong \\triangle DEF$.' },
              { label: 'd', task: 'Hva slags trekant er $\\triangle ABC$? Begrunn.', solution: '$BC = AC = \\sqrt{13}$, altså er $\\triangle ABC$ likebeint med $BC = AC$.' },
              { label: 'e', task: 'Finn arealet av $\\triangle ABC$.', solution: 'Grunnlinje $AB = 4$ langs $x$-aksen. Høyden er avstanden fra $C(3,4)$ ned til linjen $y = 1$, altså $h = 4 - 1 = 3$. $A = \\frac{4 \\cdot 3}{2} = 6$.' },
              { label: 'f', task: 'Forklar hvorfor arealet av $\\triangle DEF$ også må være $6$ uten å regne det ut på nytt.', solution: 'Kongruente trekanter har nøyaktig samme form og størrelse, altså har de også samme areal. Siden $\\triangle ABC \\cong \\triangle DEF$, er arealet av $\\triangle DEF$ også $6$.' },
            ],
            solution: 'a) $AB = 4$, $BC = AC = \\sqrt{13}$. b) $DE = 4$, $EF = DF = \\sqrt{13}$. c) Ja, SSS. d) Likebeint. e) $A = 6$. f) Kongruente figurer har likt areal.',
            hideInlineSolution: true,
            hints: ['Bruk avstandsformelen $d = \\sqrt{(x_2-x_1)^2 + (y_2-y_1)^2}$ for å finne sidelengdene.'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'vanskelig',
            task: 'Kongruensbevis med flere steg.',
            subTasks: [
              { label: 'a', task: 'I et parallellogram ABCD trekkes diagonalene AC og BD som møtes i M. Vis at diagonalene halverer hverandre, altså at $AM = CM$ og $BM = DM$. Hint: Vis først at $\\triangle ABM \\cong \\triangle CDM$.', solution: 'I parallellogrammet er $AB \\parallel DC$ og $AB = DC$ (motstående sider). Diagonalen AC er en transversal: $\\angle BAM = \\angle DCM$ (vekselvinkler). Diagonalen BD er en transversal: $\\angle ABM = \\angle CDM$ (vekselvinkler). Vi har $\\angle BAM = \\angle DCM$, $AB = CD$ og $\\angle ABM = \\angle CDM$. Etter VSV: $\\triangle ABM \\cong \\triangle CDM$. Dermed er $AM = CM$ og $BM = DM$. Diagonalene halverer hverandre.' },
              { label: 'b', task: 'I en trekant ABC er $AB = AC$ (likebeint). Punktet D ligger på AB og punktet E ligger på AC slik at $AD = AE$. Vis at $BD = CE$.', solution: 'Vi vet at $AB = AC$ og $AD = AE$. Da er $BD = AB - AD$ og $CE = AC - AE$. Siden $AB = AC$ og $AD = AE$, får vi $BD = AB - AD = AC - AE = CE$.' },
              { label: 'c', task: 'Fortsettelse av b): Vis at $\\triangle BDC \\cong \\triangle CEB$.', solution: 'Vi har $BD = CE$ (vist i b). $BC = CB$ (felles side). $\\angle B = \\angle C$ (grunnvinkler i likebeint trekant). Etter SVS: $\\triangle BDC \\cong \\triangle CEB$.' },
            ],
            solution: 'a) VSV med vekselvinkler i parallellogram. b) $BD = AB - AD = AC - AE = CE$. c) SVS med felles side og grunnvinkler.',
            hideInlineSolution: true,
            hints: ['Se etter vekselvinkler ved parallelle linjer. I en likebeint trekant er grunnvinklene like store.'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
      ...
      content: [
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'lett',
            task: 'Avgjør om trekantparene er formlike og finn forstørrelsesfaktoren.',
            subTasks: [
              { label: 'a', task: '$\\triangle ABC$: sider $3$, $4$, $5$. $\\triangle DEF$: sider $6$, $8$, $10$.', solution: '$6/3 = 8/4 = 10/5 = 2$. Ja, formlike med $k = 2$.' },
              { label: 'b', task: '$\\triangle GHI$: sider $5$, $7$, $9$. $\\triangle JKL$: sider $10$, $14$, $18$.', solution: '$10/5 = 14/7 = 18/9 = 2$. Ja, formlike med $k = 2$.' },
              { label: 'c', task: '$\\triangle MNO$: sider $4$, $6$, $8$. $\\triangle PQR$: sider $6$, $9$, $12$.', solution: '$6/4 = 1{,}5$, $9/6 = 1{,}5$, $12/8 = 1{,}5$. Ja, formlike med $k = 1{,}5$.' },
              { label: 'd', task: '$\\triangle STU$: sider $3$, $5$, $7$. $\\triangle VWX$: sider $6$, $10$, $15$.', solution: '$6/3 = 2$, $10/5 = 2$, men $15/7 \\approx 2{,}14$. Forholdstallene er IKKE like. Ikke formlike.' },
              { label: 'e', task: '$\\triangle ABC$: vinkler $30°$, $60°$, $90°$. $\\triangle DEF$: vinkler $30°$, $60°$, $90°$.', solution: 'Ja, formlike etter AA-kriteriet. Begge har de samme vinklene. (Forstørrelsesfaktoren er ukjent uten sideinformasjon.)' },
              { label: 'f', task: '$\\triangle GHI$: sider $2$, $3$, $4$. $\\triangle JKL$: sider $4$, $6$, $8$.', solution: '$4/2 = 6/3 = 8/4 = 2$. Ja, formlike med $k = 2$.' },
            ],
            solution: 'a) Ja, $k=2$. b) Ja, $k=2$. c) Ja, $k=1{,}5$. d) Nei. e) Ja, AA. f) Ja, $k=2$.',
            hideInlineSolution: true,
            hints: ['Beregn forholdstallet mellom korresponderende sider. Hvis alle er like, er trekantene formlike.'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            subTasks: [
              { label: 'a', task: 'Et kart har målestokk $1 : 50\\,000$. Du måler $8$ cm på kartet. Hva er den virkelige avstanden i meter?', solution: '$8 \\cdot 50\\,000 = 400\\,000$ cm $= 4\\,000$ m $= 4{,}0$ km.' },
              { label: 'b', task: 'Et kart har målestokk $1 : 25\\,000$. Den virkelige avstanden mellom to steder er $2{,}5$ km. Hvor lang er avstanden på kartet?', solution: '$2{,}5$ km $= 250\\,000$ cm. Kartavstand: $250\\,000 / 25\\,000 = 10{,}0$ cm.' },
              { label: 'c', task: 'En plantegning har målestokk $1 : 100$. Et rom er $3{,}5$ cm bredt og $5{,}0$ cm langt på tegningen. Finn det virkelige arealet i m$^2$.', solution: 'Bredde: $3{,}5 \\cdot 100 = 350$ cm $= 3{,}5$ m. Lengde: $5{,}0 \\cdot 100 = 500$ cm $= 5{,}0$ m. Areal: $3{,}5 \\cdot 5{,}0 = 17{,}5$ m$^2$.' },
              { label: 'd', task: 'En modell av et hus er laget i målestokk $1 : 50$. Modellen er $24$ cm høy. Hvor høyt er huset i virkeligheten?', solution: '$24 \\cdot 50 = 1\\,200$ cm $= 12$ m.' },
              { label: 'e', task: 'En arkitekttegning i målestokk $1 : 200$ viser en park med areal $75$ cm$^2$. Hva er det virkelige arealet i m$^2$?', solution: 'Virkelig areal $= 75 \\cdot 200^2 = 75 \\cdot 40\\,000 = 3\\,000\\,000$ cm$^2$ $= 300$ m$^2$.' },
              { label: 'f', task: 'To kart viser samme område. Kart A har målestokk $1 : 25\\,000$ og kart B har målestokk $1 : 50\\,000$. En avstand er $12$ cm på kart A. Hvor lang er den på kart B?', solution: 'Virkelig avstand: $12 \\cdot 25\\,000 = 300\\,000$ cm. På kart B: $300\\,000 / 50\\,000 = 6{,}0$ cm.' },
            ],
            solution: 'a) $4\\,000$ m. b) $10{,}0$ cm. c) $17{,}5$ m$^2$. d) $12$ m. e) $300$ m$^2$. f) $6{,}0$ cm.',
            hideInlineSolution: true,
            hints: ['Kartavstand $\\cdot$ nevner = virkelig avstand. For areal: gang med nevneren i andre ($k^2$).'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'lett',
            task: 'Finn ukjente sider ved hjelp av formlikhet.',
            subTasks: [
              { label: 'a', task: '$\\triangle ABC \\sim \\triangle DEF$ med $k = 3$. $AB = 4$ cm. Finn $DE$.', solution: '$DE = k \\cdot AB = 3 \\cdot 4 = 12$ cm.' },
              { label: 'b', task: '$\\triangle ABC \\sim \\triangle DEF$ med $k = 2$. $DE = 10$ cm. Finn $AB$.', solution: '$AB = DE / k = 10 / 2 = 5$ cm.' },
              { label: 'c', task: '$\\triangle PQR \\sim \\triangle STU$. $PQ = 6$ cm, $QR = 9$ cm, $ST = 10$ cm. Finn $TU$.', solution: '$k = ST/PQ = 10/6 = 5/3$. $TU = QR \\cdot k = 9 \\cdot 5/3 = 15$ cm.' },
              { label: 'd', task: '$\\triangle ABC \\sim \\triangle DEF$. $AB = 8$ cm, $BC = 12$ cm, $DF = 15$ cm, $AC = 10$ cm. Finn $DE$ og $EF$.', solution: '$k = DF/AC = 15/10 = 1{,}5$. $DE = AB \\cdot k = 8 \\cdot 1{,}5 = 12$ cm. $EF = BC \\cdot k = 12 \\cdot 1{,}5 = 18$ cm.' },
              { label: 'e', task: 'To formlike rektangler har bredder $4$ cm og $6$ cm. Det minste rektangelet har lengde $10$ cm. Finn lengden av det største.', solution: '$k = 6/4 = 1{,}5$. Lengde $= 10 \\cdot 1{,}5 = 15$ cm.' },
              { label: 'f', task: 'En trekant har sider $5$ cm, $12$ cm og $13$ cm. En formlik trekant har lengste side $39$ cm. Finn de to andre sidene.', solution: '$k = 39/13 = 3$. Side 1: $5 \\cdot 3 = 15$ cm. Side 2: $12 \\cdot 3 = 36$ cm.' },
            ],
            solution: 'a) $12$ cm. b) $5$ cm. c) $15$ cm. d) $DE = 12$, $EF = 18$. e) $15$ cm. f) $15$ og $36$ cm.',
            hideInlineSolution: true,
            hints: ['Finn forstørrelsesfaktoren $k$ fra kjente korresponderende sider, og bruk den til å finne de ukjente.'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'medium',
            task: 'Bruk formlikhet til å løse praktiske problemer.',
            subTasks: [
              { label: 'a', task: 'Du er $1{,}75$ m høy og skyggen din er $2{,}50$ m lang. Et tre har en skygge på $10{,}00$ m. Hvor høyt er treet?', solution: '$h / 1{,}75 = 10{,}00 / 2{,}50 = 4$. $h = 1{,}75 \\cdot 4 = 7{,}0$ m.' },
              { label: 'b', task: 'En flaggstang kaster en skygge på $6{,}0$ m. Samtidig kaster en $1{,}2$ m lang pinne en skygge på $0{,}80$ m. Finn høyden av flaggstangen.', solution: '$h / 1{,}2 = 6{,}0 / 0{,}80 = 7{,}5$. $h = 1{,}2 \\cdot 7{,}5 = 9{,}0$ m.' },
              { label: 'c', task: 'Et speil er plassert $6{,}0$ m fra en bygning og $1{,}5$ m fra deg. Øynene dine er $1{,}60$ m over bakken. Finn høyden av bygningen.', solution: '$h / 1{,}60 = 6{,}0 / 1{,}5 = 4$. $h = 1{,}60 \\cdot 4 = 6{,}4$ m.' },
              { label: 'd', task: 'I en trekant ABC er DE parallell med BC, der D ligger på AB og E ligger på AC. $AD = 3$ cm, $DB = 5$ cm, $DE = 6$ cm. Finn BC.', solution: '$AB = AD + DB = 3 + 5 = 8$ cm. $k = AB / AD = 8 / 3$. $BC = DE \\cdot k = 6 \\cdot 8/3 = 16$ cm.' },
              { label: 'e', task: 'Fortsettelse av d): Finn forholdet mellom arealene av $\\triangle ADE$ og $\\triangle ABC$.', solution: 'Arealforholdet er $k^2 = (AD/AB)^2 = (3/8)^2 = 9/64$. Arealet av $\\triangle ADE$ er $\\frac{9}{64}$ av arealet av $\\triangle ABC$.' },
            ],
            solution: 'a) $7{,}0$ m. b) $9{,}0$ m. c) $6{,}4$ m. d) $16$ cm. e) $9/64$.',
            hideInlineSolution: true,
            hints: ['Ved skygge- og speilproblemer dannes formlike trekanter. Sett opp forholdstall mellom korresponderende sider.'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'medium',
            task: 'Areal- og volumforhold ved formlikhet.',
            subTasks: [
              { label: 'a', task: 'To formlike trekanter har sider i forholdet $1 : 3$. Arealet av den minste er $12$ cm$^2$. Finn arealet av den største.', solution: 'Arealforhold: $k^2 = 3^2 = 9$. Areal $= 12 \\cdot 9 = 108$ cm$^2$.' },
              { label: 'b', task: 'To formlike bokser har høyder $10$ cm og $15$ cm. Volumet av den minste er $500$ cm$^3$. Finn volumet av den største.', solution: '$k = 15/10 = 1{,}5$. Volum $= 500 \\cdot 1{,}5^3 = 500 \\cdot 3{,}375 = 1\\,687{,}5$ cm$^3$.' },
              { label: 'c', task: 'En statue er $40$ cm høy og veier $2{,}4$ kg. En formlik kopi er $60$ cm høy. Hvor mye veier kopien? (Anta samme materiale.)', solution: '$k = 60/40 = 1{,}5$. Vekt (proporsjonalt med volum): $2{,}4 \\cdot 1{,}5^3 = 2{,}4 \\cdot 3{,}375 = 8{,}1$ kg.' },
              { label: 'd', task: 'Et fotografi er $10$ cm $\\times$ $15$ cm. Det forstørres slik at den lengste siden er $45$ cm. Finn det nye arealet.', solution: '$k = 45/15 = 3$. Ny kortside: $10 \\cdot 3 = 30$ cm. Nytt areal: $30 \\cdot 45 = 1\\,350$ cm$^2$. (Eller: gammelt areal $150$ cm$^2$, nytt areal $= 150 \\cdot 9 = 1\\,350$ cm$^2$.)' },
              { label: 'e', task: 'To formlike sylindere har overflater på $100$ cm$^2$ og $400$ cm$^2$. Finn forstørrelsesfaktoren $k$.', solution: 'Arealforhold: $k^2 = 400/100 = 4$. $k = \\sqrt{4} = 2$.' },
              { label: 'f', task: 'Fortsettelse: Volumet av den minste sylinderen er $200$ cm$^3$. Finn volumet av den største.', solution: 'Volumforhold: $k^3 = 2^3 = 8$. Volum $= 200 \\cdot 8 = 1\\,600$ cm$^3$.' },
            ],
            solution: 'a) $108$ cm$^2$. b) $1\\,687{,}5$ cm$^3$. c) $8{,}1$ kg. d) $1\\,350$ cm$^2$. e) $k = 2$. f) $1\\,600$ cm$^3$.',
            hideInlineSolution: true,
            hints: ['Lengder: $\\cdot k$. Areal: $\\cdot k^2$. Volum: $\\cdot k^3$.'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'vanskelig',
            task: 'Sammensatte problemer med formlikhet.',
            subTasks: [
              { label: 'a', task: 'En bygning er $15$ m høy. En arkitektmodell i målestokk $1 : 50$ lages av modellen. Finn modellens høyde, grunnflateareal (virkelig grunnflate $200$ m$^2$) og volum (virkelig volum $3\\,000$ m$^3$). Oppgi alle svar i cm/cm$^2$/cm$^3$.', solution: 'Høyde: $15 / 50 = 0{,}30$ m $= 30$ cm. Grunnflateareal: $200 \\cdot 10\\,000 = 2\\,000\\,000$ cm$^2$ (virkelig). Modell: $2\\,000\\,000 / 50^2 = 2\\,000\\,000 / 2\\,500 = 800$ cm$^2$. Volum: $3\\,000 \\cdot 10^6 = 3 \\cdot 10^9$ cm$^3$ (virkelig). Modell: $3 \\cdot 10^9 / 50^3 = 3 \\cdot 10^9 / 125\\,000 = 24\\,000$ cm$^3$.' },
              { label: 'b', task: 'En trekant PQR har sider $PQ = 6$ cm, $QR = 8$ cm og $PR = 10$ cm. En formlik trekant STU har omkrets $36$ cm. Finn sidene i $\\triangle STU$.', solution: 'Omkrets av $\\triangle PQR$: $6 + 8 + 10 = 24$ cm. $k = 36/24 = 1{,}5$. $ST = 6 \\cdot 1{,}5 = 9$ cm. $TU = 8 \\cdot 1{,}5 = 12$ cm. $SU = 10 \\cdot 1{,}5 = 15$ cm.' },
              { label: 'c', task: 'To formlike kjegler har volumer $27$ cm$^3$ og $1\\,000$ cm$^3$. Den minste kjeglen har høyde $h = 6$ cm. Finn høyden av den største kjeglen.', solution: 'Volumforhold: $k^3 = 1\\,000/27$. $k = \\sqrt[3]{1\\,000/27} = 10/3$. Høyde: $6 \\cdot 10/3 = 20$ cm.' },
            ],
            solution: 'a) Høyde: $30$ cm, grunnflate: $800$ cm$^2$, volum: $24\\,000$ cm$^3$. b) $ST = 9$, $TU = 12$, $SU = 15$. c) $h = 20$ cm.',
            hideInlineSolution: true,
            hints: ['Bruk at lengder skalerer med $k$, arealer med $k^2$ og volumer med $k^3$. Finn $k$ fra kjent informasjon.'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
