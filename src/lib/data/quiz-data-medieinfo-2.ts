...
const quizData_medieinfo_2: Record<string, QuizQuestion[]> = {
  'medieinfo-2-1-1': [
    {
  ...
  'medieinfo-2-1-4': [
    ...
    {
      question: 'Hvem analyserte eventyrstrukturer og er sentral i narrativ teori?',
      options: ['Vladimir Propp', 'Ferdinand de Saussure', 'Richard Dawkins', 'Henry Jenkins'],
      explanation: 'Vladimir Propp analyserte eventyrstrukturer og er en sentral teoretiker i narrativ analyse.',
    },
    {
  ...
  'medieinfo-2-1-5': [
    ...
    {
      question: 'Hvem utviklet et systematisk rammeverk for retorikk i antikken?',
      options: ["Aristoteles", "Saussure", "Dawkins, memteoriens far", "Foucault"],
      explanation: 'Aristoteles utviklet allerede i antikken et systematisk rammeverk for å analysere og utøve overtalende kommunikasjon.',
    },
    {
    ...
    {
      question: 'Hvilke tre appellformer står sentralt i retorisk analyse?',
      options: ['Etos, patos og logos', 'Currency, relevance og accuracy', 'Attention, interest og desire', 'Sender, kanal og mottaker'],
      explanation: 'De tre klassiske appellformene er etos (troverdighet), patos (følelser) og logos (fornuft).',
    },
    {
  ...
  'medieinfo-2-2-1': [
    ...
    {
      question: 'Hva var i over hundre år den viktigste inntektskilden for aviser, radio og TV?',
      options: ['Annonseinntekter', 'Statlig lisens alene', 'Donasjoner', 'Salg av maskinvare'],
      explanation: 'I over hundre år var annonseinntekter den viktigste inntektskilden for aviser, radio og TV.',
    },
    {
    ...
    {
      question: 'Hva er forskjellen mellom annonsefinansiering og brukerbetaling?',
      options: ["Ved annonsefinansiering betaler annonsører, ved brukerbetaling betaler publikum", "Ved annonsefinansiering betaler publikum", "De to modellene er i praksis helt identiske og gir nøyaktig samme inntektskilde", "Ved annonsefinansiering betaler publikum selv direkte for tilgang til innholdet"],
      explanation: 'Ved annonsefinansiering betaler annonsører for tilgang til publikum, mens ved brukerbetaling (abonnement) betaler publikum selv for innholdet.',
    },
    {
  ...
  'medieinfo-2-2-2': [
    ...
    {
      question: 'Hva er krysseierskap?',
      options: ["Når én eier kontrollerer flere ulike medietyper, for eksempel avis og TV", "Når staten alene eier og kontrollerer samtlige medietyper i hele landet", "Når mediene drives helt uten eiere og styres direkte av redaksjonen selv", "Når publikum kollektivt eier mediene gjennom et felles medlemskap eller lag"],
      explanation: 'Krysseierskap er når én eier kontrollerer flere ulike medietyper, for eksempel både avis, radio og TV.',
    },
    {
  ...
  'medieinfo-2-2-4': [
    ...
    {
      question: 'Hvorfor er medieinnhold ofte et fellesgode?',
      options: ["Nyheter mister ikke verdi av at flere leser dem", "Fordi de alltid er gratis å produsere", "Fordi bare én person om gangen kan konsumere den samme nyhetsartikkelen", "Fordi bare én kan lese dem"],
      explanation: 'Medieinnhold er ofte et fellesgode fordi nyheter ikke mister verdi av at flere leser dem, i motsetning til vanlige varer.',
    },
    {
  ...
  'medieinfo-2-2-5': [
    ...
    {
      question: 'Hva er hoveddilemmaet i forholdet mellom stat og medier?',
      options: ["Staten skal støtte mediene uten å styre dem", "Staten skal eie alle medier", "At mediene skal overta statens rolle og selv vedta lover og reguleringer", "Mediene skal styre staten"],
      explanation: 'Hoveddilemmaet er at staten skal støtte mediene uten å styre dem, og sikre mangfold uten å favorisere bestemte synspunkter.',
    },
    {
  ...
  'medieinfo-2-3-2': [
    {
      question: 'Hvilke to grunnleggende rettigheter kan stå i konflikt i mediesaker?',
      options: ['Ytringsfrihet og personvern', 'Stemmerett og skatteplikt', 'Eiendomsrett og religionsfrihet', 'Møterett og streikerett'],
      explanation: 'Ytringsfrihet og personvern er begge grunnleggende rettigheter som kan stå i direkte motsetning til hverandre i mediesaker.',
    },
    {
  ...
  'medieinfo-2-3-3': [
    {
      question: 'Hva regulerer medieansvarsloven blant annet?',
      options: ['Prinsippet om redaktøransvar', 'Personvern på sosiale medier', 'Reklamepriser', 'Valgordninger'],
      explanation: 'Medieansvarsloven regulerer blant annet prinsippet om redaktøransvar for innholdet som publiseres.',
    },
    {
  ...
  'medieinfo-2-3-5': [
    ...
    {
      question: 'Hva er IMVFAK-modellen et verktøy for?',
      options: ["Kildekritikk og vurdering av kilders pålitelighet", "Planlegging av reklamekampanjer og medievalg", "Beskyttelse av anonyme kilders identitet", "Redigering og klipping av videoinnhold"],
      explanation: 'IMVFAK-modellen er et verktøy for kildekritikk og vurdering av kilders pålitelighet.',
    },
    {
  ...
  'medieinfo-2-4-1': [
    ...
    {
      question: 'Hva menes med at pressen er «den fjerde statsmakt»?',
      options: ["Den kontrollerer de tre statsmaktene ved å granske makthaverne", "Den vedtar lovene sammen med de tre formelle statsmaktene", "Den avsier dommer i saker som de andre statsmaktene ikke rekker", "Den styrer regjeringens daglige arbeid og fordeler statsbudsjettet"],
      explanation: 'Pressen kalles «den fjerde statsmakt» fordi den gransker og kontrollerer de tre formelle statsmaktene på vegne av befolkningen.',
    },
    {
    ...
    {
      question: 'Hva er offentligheten?',
      options: ["Arenaen der borgere utveksler meninger og debatterer samfunnsspørsmål", "Et statlig organ som fatter bindende vedtak på vegne av borgerne", "En betalt reklamekanal der aktører kjøper plass for sine budskap", "En domstol som avgjør konflikter mellom mediene og makthaverne"],
      explanation: 'Offentligheten er arenaen der borgere utveksler meninger og debatterer samfunnsspørsmål, og mediene spiller en sentral rolle der.',
    },
    {
  ...
  'medieinfo-2-4-2': [
    ...
    {
      question: 'Hva er framing i politisk kommunikasjon?',
      options: ["Måten en sak rammes inn på, som styrer hvordan den forstås", "En grammatisk regel for hvordan setninger skal bygges opp", "En metode for å kontrollere om et politisk utsagn er sant", "En fysisk ramme rundt et bilde eller en TV-sending"],
      explanation: 'Framing er måten en sak rammes inn på gjennom ordvalg og perspektiv, noe som styrer hvordan publikum forstår den.',
    },
    {
      question: 'Hva skiller propaganda fra saklig kommunikasjon?',
      options: ["Propaganda søker systematisk å påvirke ensidig, ofte med manipulasjon", "Propaganda bygger alltid på balansert og etterprøvbar argumentasjon", "Propaganda presenterer alltid flere motstridende syn på en nøytral måte", "Saklig kommunikasjon søker systematisk å villede publikum ensidig"],
      explanation: 'Propaganda skiller seg fra saklig kommunikasjon ved at den systematisk og ensidig søker å påvirke, ofte gjennom manipulasjon og utelatelse.',
    },
    {
  ...
  'medieinfo-2-4-3': [
    ...
    {
      question: 'Hva er «horse race»-journalistikk?',
      options: ["Dekning som fokuserer på hvem som leder på målingene fremfor sak", "Dekning av hestesport og andre idrettskonkurranser i mediene", "Dekning som utelukkende tar for seg partienes politiske programmer", "En metode journalister bruker for å kontrollere om utsagn er sanne"],
      explanation: '«Horse race»-journalistikk fokuserer på kappløpet mellom partiene – hvem som leder på målingene – framfor det politiske innholdet.',
    },
    {
    ...
    {
      question: 'Hvordan har sosiale medier endret valgkampen?',
      options: ["Partiene kan kommunisere direkte med velgerne og bruke datadrevne kampanjer", "All valgkamp foregår nå utelukkende gjennom trykte brosjyrer og plakater", "Partiene har fått forbud mot å bruke sosiale medier i valgkampperioden", "De har ikke hatt noen målbar betydning for hvordan valgkamp føres"],
      explanation: 'Sosiale medier har endret valgkampen ved at partiene kan kommunisere direkte med velgerne og bruke målrettede, datadrevne kampanjer.',
    },
    {
  ...
  'medieinfo-2-4-4': [
    {
      question: 'Hva er hovedmålet til mange sosiale medier-algoritmer?',
      options: ["Å holde brukerne på plattformen lengst mulig", "Å gi en balansert nyhetsdekning", "Å beskytte brukernes personvern ved å begrense datainnsamling", "Å gi brukerne en mest mulig balansert og allsidig nyhetsdekning"],
      explanation: 'Sosiale medier-algoritmer er designet for å holde brukerne på plattformen lengst mulig, fordi det genererer annonseinntekter.',
    },
    {
      question: 'Hva er en filterboble?',
      options: ["Et personalisert miljø der man hovedsakelig møter innhold man liker", "Et verktøy som lar deg filtrere bort all sporing og datainnsamling", "En reklameform der annonser tilpasses innholdet du nettopp har lest", "En teknisk feil som gjør at bilder og video vises uskarpt på skjermen"],
      explanation: 'En filterboble er et personalisert informasjonsmiljø der algoritmer i hovedsak viser deg innhold som passer dine eksisterende interesser.',
    },
    {
    ...
    {
      question: 'Hva er polarisering?',
      options: ["At meninger trekker mot ytterpunkter og avstanden mellom grupper øker", "At alle grupper etter hvert blir enige og samler seg om samme syn", "At mediene mister sine politiske vinklinger og blir helt nøytrale", "At offentlig debatt forsvinner helt fordi ingen lenger ytrer seg"],
      explanation: 'Polarisering er at meninger trekker mot ytterpunkter og at avstanden mellom grupper øker, noe sosiale medier kan forsterke.',
    },
    {
  ...
  'medieinfo-2-4-5': [
    ...
    {
      question: 'Hva er en varsler?',
      options: ["En person som gir journalister informasjon om kritikkverdige forhold", "En aktør som selger reklameplass og annonser til mediehusene", "En annonsør som betaler for å få budskapet sitt ut i mediene", "En redaktør som har det øverste ansvaret for en publikasjon"],
      explanation: 'En varsler er en person som gir journalister (eller myndigheter) informasjon om kritikkverdige forhold, ofte med risiko for seg selv.',
    },
    {
      question: 'Hvorfor er kildevern viktig for undersøkende journalistikk?',
      options: ["Det beskytter varslere som ellers ikke ville tort å gi informasjon", "Fordi det bare er en juridisk formalitet uten praktisk betydning", "Fordi det gjør det redaksjonelle arbeidet raskere og langt billigere", "Fordi det bidrar til å øke redaksjonens samlede reklameinntekter"],
      explanation: 'Kildevern er viktig fordi det beskytter varslere og kilder som ellers ikke ville tort å gi sensitiv informasjon.',
    },
    {
  ...
  'medieinfo-2-5-1': [
    {
      question: 'Hva er et nyhetsbyrå?',
      options: ["En organisasjon som samler inn nyheter og selger dem videre til medier", "En uavhengig domstol som avgjør presseetiske klagesaker i mediene", "En sosial medieplattform der brukerne selv deler nyheter gratis", "Et reklamebyrå som lager annonsekampanjer for ulike bedrifter"],
      explanation: 'Et nyhetsbyrå er en organisasjon som samler inn nyheter og selger dem videre til medier over hele verden.',
    },
    {
      question: 'Hvorfor er nyhetsbyråer viktige i den globale informasjonsstrømmen?',
      options: ["De avgjør i stor grad hvilke nyheter som når mediene verden over", "De fungerer som internasjonale domstoler som avgjør pressesaker", "De har ingen reell betydning for hvilke nyheter som når publikum", "De produserer utelukkende reklame og annonser for globale merkevarer"],
      explanation: 'Nyhetsbyråene er grunnpilarer i den globale informasjonsstrømmen og avgjør i stor grad hvilke nyheter som når mediene verden over.',
    },
    {
      question: 'Hva er en konsekvens av at globale medier er konsentrert på få hender?',
      options: ["Noen stemmer dominerer informasjonsstrømmen mens andre utelates", "At eierkonsentrasjonen ikke har noen betydning for innholdet", "At alle stemmer og perspektiver kommer like godt fram i strømmen", "At mediemangfoldet øker og flere aktører får slippe til med innhold"],
      explanation: 'En konsekvens er at noen aktører og stemmer dominerer den globale informasjonsstrømmen, mens andre perspektiver utelates.',
    },
    {
  ...
  'medieinfo-2-5-2': [
    {
      ...
      options: ["Teorien om at vestlige medier dominerer og påvirker andre kulturer", "At alle kulturer er likeverdige i medieutvekslingen", "Teorien om at lokale medier alltid vinner over de globale aktørene", "Teorien om at medieinnhold ikke lar seg spre på tvers av landegrenser"],
      explanation: 'Medieimperialisme er teorien om at vestlige medier dominerer den globale informasjonsstrømmen og påvirker andre kulturer.',
    },
    {
      question: 'Hva er et eksempel på vestlig dominans i globale medier?',
      options: ["At noen få store nyhetsbyråer (som AP og Reuters) dominerer nyhetsstrømmen", "At alle land i verden har omtrent like stor innflytelse på nyhetsstrømmen", "At ingen enkeltaktører klarer å dominere den globale nyhetsformidlingen", "At det bare finnes små lokale medier uten internasjonal rekkevidde"],
      explanation: 'Et eksempel er at noen få store nyhetsbyråer som AP og Reuters dominerer den globale nyhetsstrømmen.',
    },
    {
  ...
  'medieinfo-2-5-3': [
    ...
    },
    {
      ...
      options: ["Medienes rett til å informere og kritisere uten statlig sensur", "Statens lovfestede rett til å sensurere kritisk medieinnhold", "Medienes plikt til å publisere all betalt reklame de mottar", "En personvernlov som beskytter borgerne mot medieomtale"],
      explanation: 'Pressefrihet er medienes rett til å informere, kritisere og granske uten statlig sensur eller forfølgelse.',
    },
    {
    ...
    {
      question: 'Hvordan måles pressefrihet internasjonalt?',
      options: ["Gjennom pressefrihetsindekser som sammenligner land", "Gjennom antall aviser i landet", "Gjennom å måle landets gjennomsnittlige internetthastighet", "Pressefrihet lar seg ikke måle eller sammenligne mellom land"],
      explanation: 'Pressefrihet måles internasjonalt gjennom pressefrihetsindekser som sammenligner situasjonen i ulike land.',
    },
  ],
  'medieinfo-2-5-4': [
    {
      question: 'Hva er forskjellen mellom desinformasjon og misinformasjon?',
      options: ["Desinformasjon spres bevisst, misinformasjon ofte ubevisst", "Misinformasjon er alltid bevisst", "Desinformasjon er alltid sann og etterrettelig informasjon", "De to begrepene betyr nøyaktig det samme og brukes om hverandre"],
    ...
    {
      question: 'Hva er informasjonskrig?',
      options: ["Strategisk bruk av informasjon som våpen for å påvirke og undergrave", "En rent militær konflikt der informasjon ikke spiller noen rolle", "En systematisk metode for å faktasjekke og avkrefte falske påstander", "En form for kommersiell reklame rettet mot et bredt publikum"],
      explanation: 'Informasjonskrig er strategisk bruk av informasjon og desinformasjon som våpen for å påvirke, skape uro og undergrave tillit.',
    },
    {
    ...
    {
      question: 'Hvem kan stå bak strategisk desinformasjon?',
      options: ["Stater, organisasjoner og enkeltpersoner", "Bare faktasjekktjenester", "Ingen aktører står bak slik desinformasjon", "Utelukkende enkeltpersoner som handler alene"],
      explanation: 'Strategisk desinformasjon kan spres av stater, organisasjoner og enkeltpersoner for å påvirke valg, skape uro og undergrave tillit.',
    },
  ],
  'medieinfo-2-5-5': [
    {
      question: 'Hva er den digitale kløften?',
      options: ["Gapet mellom dem som har og ikke har tilgang til digital teknologi", "En omfattende reklamekampanje for digitale produkter og tjenester", "En type datavirus som sprer seg mellom enheter på internett", "En personvernlov som regulerer bruken av digital teknologi"],
      explanation: 'Den digitale kløften er gapet mellom dem som har tilgang til digital teknologi og internett, og dem som ikke har det.',
    },
    {
    ...
    {
      question: 'Hva er en årsak til ulik medietilgang globalt?',
      options: ["Ulik tilgang til infrastruktur og økonomiske ressurser", "At teknologi er gratis overalt", "At alle land i verden er omtrent like rike og velstående", "At digital teknologi er helt gratis og lett tilgjengelig overalt"],
      explanation: 'Ulik medietilgang skyldes blant annet ulik tilgang til digital infrastruktur og økonomiske ressurser mellom og innad i land.',
    },
    {
  ...
  'medieinfo-2-6-1': [
    ...
    {
      question: 'Hva er det sentrale spørsmålet i medieforskningen?',
      options: ['Hva gjør mediene med oss?', 'Hvor mye koster medier?', 'Hvilken farge har medier?', 'Hvor mange aviser finnes?'],
      explanation: 'Det sentrale spørsmålet i medieforskningen har alltid vært: Hva gjør mediene med oss? – men svaret har endret seg over tid.',
    },
    {
  ...
  'medieinfo-2-6-2': [
    {
      ...
      options: ["De samler inn data som kan uttrykkes i tall og analyseres statistisk", "De går alltid i dybden på få enheter for å forstå meningen bak dem", "De handler bare om å forstå opplevelser og maktforhold i innholdet", "De bygger utelukkende på tolkning av tekst og unngår tall helt"],
      explanation: 'Kvantitative metoder handler om å samle inn data som kan uttrykkes i tall og analyseres statistisk, ofte i stor skala.',
    },
    {
      question: 'Hva er kvantitativ innholdsanalyse?',
      options: ["En metode for å telle og måle trekk ved medieinnhold systematisk", "En semiotisk nærlesning av hvordan tegn skaper mening i teksten", "Et grundig dybdeintervju der man tolker informantens egne opplevelser", "En form for målrettet reklame tilpasset ulike publikumsgrupper"],
      explanation: 'Kvantitativ innholdsanalyse er en metode for systematisk å telle og måle trekk ved medieinnhold, for eksempel representasjon av ulike grupper.',
    },
    {
    ...
    {
      question: 'Hva brukes spørreundersøkelser til i medieforskning?',
      options: ["Å kartlegge holdninger og mediebruk i en befolkning", "Å analysere et enkelt bilde i dybden", "Å sensurere og fjerne medieinnhold som anses upassende", "Å produsere målrettet reklame tilpasset ulike publikumsgrupper"],
      explanation: 'Spørreundersøkelser brukes i medieforskning til å kartlegge holdninger, vaner og mediebruk i en befolkning.',
    },
    {
  ...
  'medieinfo-2-6-3': [
    {
      question: 'Hva handler kvalitative metoder først og fremst om?',
      options: ['Å forstå mening i dybden', 'Å telle og måle i stor skala', 'Å lage statistikk', 'Å produsere reklame'],
      explanation: 'Kvalitative metoder handler om å forstå mening i dybden, framfor å kartlegge bredden i et stort materiale.',
    },
    {
    ...
    {
      question: 'Når er kvalitative metoder særlig nyttige?',
      options: ["Når man vil forstå mening, opplevelser og maktforhold i dybden", "Når man vil telle mange enheter og få generaliserbare tall", "Når man vil lage statistikk over mediebruk i en befolkning", "Når man vil produsere målrettet reklame til ulike grupper"],
      explanation: 'Kvalitative metoder er særlig nyttige når man vil forstå hvordan tekster skaper mening, hvordan folk opplever innhold, og analysere maktforhold og ideologi.',
    },
    {
  ...
  'medieinfo-2-6-4': [
    ...
    {
      question: 'Hva er brukerdata i digital publikumsmåling?',
      options: ["Data om hva brukerne klikker på, ser på og engasjerer seg i", "Bare brukernes navn og kontaktopplysninger", "Avisenes regnskap og økonomiske resultater", "Prislister for annonser på plattformen"],
      explanation: 'Brukerdata er detaljert informasjon om hva brukerne klikker på, ser på og engasjerer seg i, som digitale plattformer samler inn.',
    },
    {
  ...
  'medieinfo-2-6-5': [
    ...
    },
    {
      ...
      options: ["Hvor pålitelige og etterprøvbare målingene er", "Hvor mange kilder man har", "Hvor lang og detaljert forskningsrapporten er", "Hvor mange ulike kilder man har benyttet seg av"],
    ...
    },
    {
      ...
      options: ["Om man faktisk måler det man har til hensikt å måle", "Hvor mange svar man samlet inn i undersøkelsen", "Hvor lang og grundig forskningsrapporten er", "Hvor raskt undersøkelsen ble gjennomført"],
  ...
  'medieinfo-2-7-1': [
    {
      question: 'Hvordan brukes kunstig intelligens (KI) i medieproduksjon?',
      options: ["Til å skrive artikler, generere bilder, musikk og videoer", "Bare til å slette og fjerne upassende medieinnhold", "Den brukes så godt som ikke i medieproduksjon", "Bare til å styrke personvernet for brukerne"],
      explanation: 'KI brukes i medieproduksjon til å skrive nyhetsartikler, generere bilder, produsere musikk og lage videoer.',
    },
    {
    ...
    {
      question: 'Hvilken norsk medieaktør nevnes som eksempel på KI-assistert journalistikk?',
      options: ['NTB', 'Faktisk.no', 'PFU', 'Datatilsynet'],
      explanation: 'NTB og flere norske medier eksperimenterer med KI-assistert journalistikk.',
    },
    {
  ...
  'medieinfo-2-7-2': [
    {
      question: 'Hva kjennetegner immersive medier?',
      options: ["De lar brukeren tre inn i eller bli omsluttet av innholdet", "De fungerer helt uten at det finnes en bruker til stede", "De vises bare på en flat skjerm slik tradisjonelle medier gjør", "De formidler innhold utelukkende gjennom skrevet tekst"],
      explanation: 'Immersive medier som VR og AR bryter med den flate skjermen og lar brukeren tre inn i eller bli omsluttet av innholdet.',
    },
    {
      question: 'Hva er virtual reality (VR)?',
      options: ["En teknologi der brukeren kan oppleve å være midt i en digital verden", "En vanlig TV der seeren følger sendingen på en flat skjerm", "En teknologi som legger digital informasjon over den virkelige verden", "En papiravis der innholdet presenteres på trykte sider"],
      explanation: 'Virtual reality (VR) er en teknologi der brukeren kan oppleve å stå midt i en digital verden, for eksempel en nyhetshendelse.',
    },
    {
  ...
  'medieinfo-2-7-3': [
    ...
    {
      question: 'Hvilken inntektsmodell bruker Netflix?',
      options: ['Abonnement', 'Bare reklame', 'Statlig lisens', 'Donasjoner'],
      explanation: 'Netflix bruker en abonnementsbasert inntektsmodell der brukerne betaler for tilgang til film og serier.',
    },
    {
      question: 'Hva er en «freemium»-modell, som Spotify bruker?',
      options: ["En gratisversjon med reklame og en betalt versjon uten", "En modell der alt alltid er gratis", "En modell der alt innholdet er gratis og finansieres av staten", "En modell der man kjøper et fysisk produkt for å låse opp appen"],
      explanation: 'En freemium-modell tilbyr en gratisversjon (ofte med reklame) og en betalt premiumversjon uten reklame, slik som Spotify.',
    },
    {
      question: 'Hvilken utfordring har strømmeomveltningen skapt?',
      options: ["Utfordringer for mediemangfold, kulturproduksjon og arbeidsvilkår", "At all reklamefinansiering i mediebransjen nå er blitt forbudt", "At publikum har mistet all interesse for film og serier helt", "At antallet nye TV-kanaler og produksjoner har falt kraftig"],
      explanation: 'Strømmeomveltningen har skapt nye muligheter, men også utfordringer for mediemangfold, kulturproduksjon og arbeidsvilkår i bransjen.',
    },
  ],
  'medieinfo-2-7-4': [
    {
    ...
    {
      question: 'Hva er et eksempel på slagkraftig datadrevet journalistikk?',
      options: ['Panama Papers', 'En vanlig værmelding', 'En reklamekampanje', 'En personvernerklæring'],
      explanation: 'Panama Papers er et eksempel på slagkraftig datadrevet journalistikk basert på store datamengder.',
    },
    {
  ...
  'medieinfo-2-7-5': [
    ...
    {
      question: 'Hva er en sentral trend i medieutviklingen?',
      options: ['Økt bruk av KI i redaksjonene', 'At alle går tilbake til papir', 'At internett forsvinner', 'At reklame opphører'],
      explanation: 'En sentral trend er økt bruk av KI i redaksjonene, blant annet til automatisert innholdsproduksjon og research.',
    },
    {
  ...
  'medieinfo-2-8-2': [
    ...
    {
      question: 'Hva kalles sammensmeltingen av medier på tvers av plattformer?',
      options: ['Konvergens', 'Divergens', 'Sensur', 'Segmentering'],
      explanation: 'Sammensmeltingen av medier på tvers av plattformer kalles konvergens.',
    },
    {
  ...
  'medieinfo-2-8-3': [
    {
      question: 'Hvorfor er evnen til å vurdere eget arbeid viktig for en medieprodusent?',
      options: ["Man blir lett «blind» for egne svakheter, og systematisk evaluering gjør deg bedre", "Fordi ens eget arbeid alltid er feilfritt og ikke trenger nærmere gjennomgang", "Fordi evaluering av egne prosjekter er forbudt etter opphavsrettslige regler", "Fordi man aldri bør vurdere seg selv, men overlate all kritikk til andre"],
      explanation: 'Evnen til å vurdere eget arbeid er viktig fordi man lett blir «blind» for egne svakheter, og systematisk evaluering gjør deg bedre for hvert prosjekt.',
    },
    {
  ...
  'medieinfo-2-8-4': [
    {
      ...
      options: ["De har en kontrollfunksjon og overvåker makthaverne på vegne av folket", "De vedtar lovene i landet på linje med den lovgivende statsmakten", "De styrer regjeringen og setter dagsorden for den utøvende makten", "De avgjør rettssaker og dømmer i konflikter slik domstolene gjør"],
      explanation: 'Mediene kalles «den fjerde statsmakt» fordi de har en kontrollfunksjon og overvåker politikere, næringsliv og institusjoner på vegne av befolkningen.',
    },
    {
    ...
    {
      question: 'Hva er agendasetting?',
      options: ["At mediene påvirker hvilke saker publikum oppfatter som viktige", "At mediene bestemmer hva folk skal mene", "At mediene styrer hvordan folk faktisk stemmer og handler i konkrete politiske valg", "At mediene former den detaljerte tolkningsrammen publikum bruker når de forstår en sak"],
      explanation: 'Agendasetting innebærer at mediene påvirker hvilke saker publikum oppfatter som viktige, ved hva de velger å dekke.',
    },
    {
...
export default quizData_medieinfo_2;
