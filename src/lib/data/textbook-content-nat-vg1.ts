 ...
 * Dekker 55 kapitler organisert i 10 seksjoner:
 *
...
// Import all chapter content from the six parts
...
import { NAT_VG1_CHAPTERS_DEL6 } from './textbook-content-nat-vg1-del6';
...
export * from './textbook-content-nat-vg1-del6';
