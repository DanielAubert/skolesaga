...
Til slutt har vi **standardavviket** ($s$), som måler den gjennomsnittlige avstanden fra gjennomsnittet: $s = \\sqrt{\\frac{\\sum (x_i - \\bar{x})^2}{n - 1}}$. For datasettet vårt er gjennomsnittet $\\bar{x} \\approx 8{,}43$, og standardavviket blir $s \\approx 3{,}85$. Et lavt standardavvik betyr at verdiene ligger tett rundt gjennomsnittet, mens et høyt standardavvik betyr stor spredning. Standardavviket er det mest brukte spredningsmålet i praksis fordi det tar hensyn til *alle* verdiene i datasettet.`,
    },
    {
      ...
      exercise: {
        ...
        solution: 'Standardavviket måler spredningen i dataene. Klasse A (s ≈ 2,8) har mye jevnere resultater enn klasse B (s ≈ 5,9). Med likt gjennomsnitt betyr dette at klasse B har noen som gjør det veldig bra og noen som gjør det svakt, mens klasse A er jevnere.',
      },
    },
    {
...
I tillegg til boksplott bruker vi **stolpediagram** for kategoriske data eller diskrete verdier (stolpene har mellomrom mellom seg), og **histogram** for kontinuerlige data gruppert i klasser (stolpene står inntil hverandre, og arealet representerer frekvensen). Valget av diagramtype avhenger altså av hva slags data du har.`,
    },
    {
      ...
      exercise: {
        ...
        solution: 'Øvre grense: Q₃ + 1,5 · IQR = 40 + 30 = 70. Nedre grense: Q₁ − 1,5 · IQR = 20 − 30 = −10. Verdien 72 > 70, altså er 72 en uteligger. De andre verdiene (55, 42 og 15) ligger alle innenfor grensene.',
      },
    },
    {
...
Den kumulative frekvensen er spesielt nyttig for å finne **medianen** i grupperte data. Medianen ligger der den kumulative relative frekvensen passerer 0,50. I vårt eksempel passerer den 0,50 i klassen 3--5 timer (fra 0,27 til 0,67), så vi vet at medianen ligger i denne klassen. Vi kan også finne **typetallsklassen**, som er klassen med høyest frekvens -- her er det 3--5 timer med 12 observasjoner. Frekvenstabeller gir oss et kraftig verktøy for å organisere og forstå store datasett.`,
    },
    {
      ...
      exercise: {
        ...
        solution: 'Medianen ligger der den kumulative relative frekvensen passerer 0,50. Den går fra 0,325 (etter klassen 0–3 timer) til 0,70 (etter klassen 4–5 timer). Siden 0,50 ligger mellom disse, er medianen i klassen 4–5 timer.',
      },
    },
    {
    ...
    },
    {
      ...
      exercise: {
        ...
        options: [
          ...
          { id: 'd', text: 'Fordi inntektsdata er skjevfordelt med noen svært høye inntekter, og medianen er mer robust mot slike uteliggere', isCorrect: true },
        ],
        solution: 'Inntektsdata er typisk skjevfordelt -- noen få tjener svært mye, noe som drar gjennomsnittet opp. Medianen påvirkes ikke av uteliggere og gir derfor et bedre bilde av hva en «typisk» person tjener. Medianen er ikke nødvendigvis enklere å beregne, men den er mer representativ for skjeve data.',
      },
    },
    {
      id: '2p-3-1-n-summary',
...
Men det er viktig å huske at **ikke alt er normalfordelt**. Inntekt, boligpriser og ventetider er typisk *skjevfordelt* og følger ikke denne pene klokkekurven. Normalfordelingen er et kraftig verktøy, men du må alltid sjekke at den passer til dataene dine.`,
    },
    {
      ...
      exercise: {
        ...
        solution: 'Normalfordelingen er symmetrisk, så gjennomsnitt = median = typetall. Standardavviket bestemmer bredden (ikke sentrum -- det er gjennomsnittet som bestemmer). Og langt fra alle datasett er normalfordelte; inntekt og boligpriser er typiske eksempler på skjeve fordelinger.',
      },
    },
    {
...
Z-skåren kan også brukes sammen med den empiriske regelen. Hvis Ola løp 100 meter på 12,2 sekunder, og klassen hadde $\\mu = 13{,}5$ s og $\\sigma = 1{,}0$ s, blir z-skåren $z = \\frac{12{,}2 - 13{,}5}{1{,}0} = -1{,}3$. Negativt fortegn betyr at han er *under* gjennomsnittet i tid, altså *raskere*. Med z = −1,3 er han raskere enn de fleste i klassen -- omtrent 90 prosent av klassen er langsommere. Vi kan også snu formelen for å finne en verdi fra en z-skår: $x = \\mu + z \\cdot \\sigma$. En elev med $z = 0{,}5$ hadde en tid på $13{,}5 + 0{,}5 \\cdot 1{,}0 = 14{,}0$ sekunder.`,
    },
    {
      ...
      exercise: {
        ...
        solution: 'Z-skåren gjør det nettopp mulig å sammenligne resultater fra ulike fordelinger. Kari lå 1,3 standardavvik over gjennomsnittet i norsk og 1,5 standardavvik over i matte. Siden 1,5 > 1,3 gjorde hun det relativt best i matte, selv om poengsummen var lavere der.',
      },
    },
    {
...
Denne måten å tenke på -- å «oversette» fra råtall til standardavvik -- er utrolig kraftig. Den lar deg sammenligne ting som i utgangspunktet ikke er sammenlignbare. Og den gir deg et presist språk for å snakke om hvor uvanlig en observasjon er. En z-skår på 2 betyr at du er blant de øverste 2,5 prosentene. En z-skår på 3 betyr at du er blant de øverste 0,15 prosentene. Det er språket normalfordelingen gir oss.`,
    },
    {
      ...
      exercise: {
        ...
        options: [
          { id: 'a', text: 'z = 1,0 -- blodtrykket er normalt', isCorrect: false },
          { id: 'b', text: 'z = 2,0 -- blodtrykket er 2 standardavvik over gjennomsnittet, noe som er uvanlig høyt', isCorrect: true },
          { id: 'c', text: 'z = 30 -- blodtrykket er ekstremt høyt', isCorrect: false },
          { id: 'd', text: 'z = −2,0 -- blodtrykket er lavt', isCorrect: false },
        ],
        solution: 'z = (150 − 120) / 15 = 30/15 = 2,0. Personen har et blodtrykk som er 2 standardavvik over gjennomsnittet. Bare ca. 2,5 % av friske voksne har blodtrykk over dette, noe som kan tyde på forhøyet blodtrykk.',
      },
    },
    {
      id: '2p-3-2-n-summary',
    ...
    },
    {
      ...
      exercise: {
        ...
        options: [
          ...
          { id: 'c', text: 'Økningen ser mye større ut enn den faktisk er (4 % økning fremstilt som dramatisk vekst)', isCorrect: true },
...
Og til slutt: **lav svarprosent**. Hvis bare 10 prosent av de spurte svarer, kan vi ikke stole på resultatene, fordi de 90 prosentene som ikke svarte kanskje har helt andre meninger.`,
    },
    {
      ...
      exercise: {
        ...
        solution: 'Nettavstemninger har selvseleksjon som viktigste feilkilde: bare de som er engasjerte nok til å klikke seg inn og stemme, deltar. Dette gir et skjevt utvalg som ikke representerer hele befolkningen. Spørsmålet er også noe ledende, men selvseleksjonen er det største problemet.',
      },
    },
    {
    ...
    },
    {
      ...
      exercise: {
        ...
        options: [
          ...
          { id: 'c', text: 'Det er bare tilfeldig -- ingen sammenheng', isCorrect: false },
...
Kan vi konkludere med at nettbrett *forårsaker* dårligere resultater? Nei, det kan vi ikke. Vi har bare en korrelasjon. For å påvise kausalitet ville vi trengt en randomisert kontrollert studie med mange flere skoler, gjennomført av uavhengige forskere, med kontroll for konfunderende variabler.`,
    },
    {
      ...
      exercise: {
        ...
        solution: 'Den konfunderende variabelen er brannens størrelse. Store branner forårsaker mer skade OG krever flere brannmenn. Brannmennene forårsaker ikke skadene -- de sendes dit fordi brannen er stor. Dette er et klassisk eksempel på korrelasjon uten kausalitet.',
      },
    },
    {
    ...
    },
    {
      ...
      exercise: {
        ...
        options: [
          ...
          { id: 'c', text: 'Utvalget er trolig håndplukket, lite (10 stykker) og spørsmålet kan ha vært ledende', isCorrect: true },
          { id: 'd', text: 'Det er ingenting galt med påstanden', isCorrect: false },
        ],
        solution: 'Påstanden er problematisk på flere måter: Vi vet ikke hvem disse tannlegene er -- utvalget kan være håndplukket eller betalt. Ti tannleger er et svært lite utvalg. Og spørsmålet kan ha vært ledende, for eksempel «Anbefaler du tannkrem med fluor?» (som nesten alle ville svart ja på). Resultatet sier mer om undersøkelsens design enn om tannkremens kvalitet.',
      },
    },
    {
      id: '2p-3-3-n-summary',
