...
const quizData_psykologi_2: Record<string, QuizQuestion[]> = {
  'psykologi-2-1-1': [
    {
    ...
    {
      question: 'Hva viste Zimbardos Stanford fengselseksperiment (1971)?',
      options: ["At sosiale roller og situasjoner kan endre atferd dramatisk", "At personlighet er det eneste som styrer atferd", "At fanger og voktere i praksis oppfører seg helt likt fordi rollene ikke påvirker deres handlinger", "At eksperimenter alltid varer to uker"],
      explanation: 'Zimbardos eksperiment viste hvordan tildelte sosiale roller (fanger og voktere) og situasjonen kunne endre vanlige menneskers atferd dramatisk.',
    },
  ],
  'psykologi-2-1-2': [
    {
  ...
  'psykologi-2-1-5': [
    ...
    {
      question: 'Hva er BIRGing (basking in reflected glory)?',
      options: ["Å sole seg i gruppens suksess (\"vi vant!\")", "Å distansere seg fra gruppen ved tap", "Å forlate gruppen helt når den ikke lenger lykkes med noe", "En åpen konflikt som oppstår mellom rivaliserende grupper"],
      explanation: 'BIRGing er å sole seg i gruppens suksess – man identifiserer seg sterkere ("vi vant!") når inngruppen lykkes, noe som øker den kollektive selvfølelsen.',
    },
  ],
  'psykologi-2-2-1': [
    {
    ...
    {
      question: 'Hva er aktiv lytting (Rogers)?',
      options: ["Å gi full oppmerksomhet og reflektere tilbake hva som blir sagt", "Å avbryte og komme med egne råd før taleren har snakket ferdig", "Å planlegge sitt eget motsvar mens den andre fortsatt forklarer seg", "Å nikke uten å høre etter og styre samtalen inn på egne temaer"],
      explanation: 'Aktiv lytting er en teknikk der lytteren gir full oppmerksomhet, reflekterer tilbake budskapet og bekrefter at det er forstått – både innhold og følelser.',
    },
    {
      question: 'Hva kjennetegner Barnlunds transaksjonelle kommunikasjonsmodell?',
      options: ["Kommunikasjon er en gjensidig prosess der begge er sendere og mottakere samtidig", "Kommunikasjon går bare én vei fra en aktiv sender til en passiv mottaker", "Bare én part er sender om gangen, og roller byttes strengt etter tur", "Budskapet overføres uendret uten at mottakerens tolkning spiller inn"],
      explanation: 'Barnlunds transaksjonelle modell ser kommunikasjon som en gjensidig, dynamisk prosess der begge parter samtidig er sendere og mottakere.',
    },
  ],
  'psykologi-2-2-2': [
    {
      question: 'Hva er nonverbal kommunikasjon?',
      options: ["All kommunikasjon som ikke bruker ord (kroppsspråk, mimikk, stemmetone osv.)", "Kun signaler som sendes via digitale medier og elektroniske plattformer", "Kun skriftlig kommunikasjon uten tale, som brev, meldinger og e-post", "Kun det som sies med stemmen, altså selve ordene og setningene"],
      explanation: 'Nonverbal kommunikasjon er all kommunikasjon uten ord: kroppsspråk, ansiktsuttrykk, gester, blikk, berøring, avstand og stemmetone.',
    },
    {
      question: 'Hva viste Paul Ekmans forskning på Fore-folket?',
      options: ["At visse ansiktsuttrykk for følelser er universelle på tvers av kulturer", "At alle ansiktsuttrykk for følelser er kulturelt betingede og innlærte", "At uttrykk for følelser tilegnes gjennom skolegang og formell oppdragelse", "At mennesker uten kontakt med storsamfunnet mangler tydelige grunnfølelser"],
      explanation: 'Ekman viste at en isolert stamme uten kontakt med vestlig kultur gjenkjente de samme grunnfølelsene fra ansiktsuttrykk – uttrykkene er altså universelle.',
    },
    {
    ...
    {
      question: 'Hva er kongruens i kommunikasjon?',
      options: ["Når verbal og nonverbal kommunikasjon stemmer overens", "Når ord og kroppsspråk er motstridende", "Når man snakker med høy stemme for å understreke det man mener", "Når man er helt taus og bare lytter uten å svare den andre parten"],
      explanation: 'Kongruens betyr at verbal og nonverbal kommunikasjon matcher. Inkongruens (motstridende signaler) gjør budskapet utroverdig.',
    },
    {
  ...
  'psykologi-2-2-3': [
    {
      question: 'Hva kjennetegner digital kommunikasjon sammenlignet med ansikt-til-ansikt?',
      options: ["Redusert nonverbal informasjon, asynkronitet og mulighet for anonymitet", "Alltid umiddelbar respons uten forsinkelse mellom sender og mottaker", "Rikere nonverbal informasjon enn i samtaler ansikt til ansikt gir", "Ingen vesentlig forskjell fra fysiske samtaler i innhold og form"],
      explanation: 'Digital kommunikasjon kjennetegnes av redusert nonverbal informasjon, asynkronitet (forsinket svar) og mulighet for anonymitet.',
    },
    {
      question: 'Hva er online disinhibisjon (Suler)?',
      options: ["At folk oppfører seg med færre hemninger på nett enn ansikt til ansikt", "At internett ikke har noen målbar effekt på hvordan folk oppfører seg", "At folk oppfører seg mer høflig og tilbakeholdent på nett enn ellers", "At folk unngår å skrive eller ytre seg i digitale sammenhenger"],
      explanation: 'Online disinhibisjon er at folk oppfører seg med færre hemninger på nett – godartet (mer åpenhet) eller giftig (mer aggresjon og trolling).',
    },
    {
      question: 'Hva er FOMO?',
      options: ["Angst for at andre har givende opplevelser man selv går glipp av", "En sosial medieplattform bygd for å dele opplevelser med venner", "En form for målrettet nettmobbing der noen holdes utenfor gruppen", "En kommunikasjonsmodell som beskriver hvordan budskap tolkes på nett"],
      explanation: 'FOMO (fear of missing out) er en vedvarende angst for at andre har givende opplevelser man selv ikke er del av, forsterket av sosiale medier.',
    },
    {
    ...
    {
      question: 'Hva kjennetegner nettmobbing (cyberbullying)?',
      options: ["Gjentatt aggressiv atferd via digitale plattformer med maktubalanse", "En enkeltstående vennlig kommentar delt offentlig i en nettgruppe", "En forskningsmetode for å kartlegge ungdoms atferd på sosiale medier", "En åpen ansikt-til-ansikt-konflikt mellom to jevnbyrdige parter"],
      explanation: 'Nettmobbing er gjentatt aggressiv atferd via digitale plattformer der det er en maktubalanse, kjennetegnet av 24/7-tilgjengelighet og mulig anonymitet.',
    },
  ],
  'psykologi-2-2-4': [
    {
      question: 'Hva er en konflikt i psykologisk forstand?',
      options: ["En tilstand der parter opplever at mål, behov eller interesser er uforenlige", "Alltid en fysisk kamp der partene bruker vold mot hverandre direkte", "En helt normal og avslappet samtale mellom to parter uten spenning", "En form for lydighet der den ene parten underordner seg den andre"],
      explanation: 'En konflikt oppstår når to eller flere parter opplever at deres mål, behov, verdier eller interesser er uforenlige.',
    },
    {
      question: 'Hva er en sakskonflikt?',
      options: ["En konkret, faktisk uenighet om hva som skal gjøres", "En konflikt om personlige følelser", "En dyp konflikt om grunnleggende verdier og livssyn hos partene", "En konflikt som oppstår helt vilkårlig uten noen påviselig årsak"],
      explanation: 'En sakskonflikt handler om konkrete, faktiske uenigheter (hvem gjør hva, hvordan fordeles ressurser) og kan ofte løses gjennom forhandling.',
    },
    {
      question: 'Hva beskriver Glasls eskaleringsmodell?',
      options: ["Hvordan konflikter eskalerer gjennom ni trinn fra uenighet til ødeleggelse", "Hvordan konflikter alltid løses raskt så snart partene begynner å snakke", "En kommunikasjonsmodell for hvordan sender og mottaker utveksler budskap", "Hvordan man kan unngå enhver konflikt før den i det hele tatt oppstår"],
      explanation: 'Glasls modell beskriver ni trinn for konflikteskalering, fra win-win (uenighet) via win-lose (konkurranse) til lose-lose (gjensidig ødeleggelse).',
    },
    {
      question: 'Hva er fundamental attribusjonsfeil i konflikter?',
      options: ["Å overvurdere personlige egenskaper og undervurdere situasjonen ved andres atferd", "En forhandlingsmetode der man skiller person fra sak for å finne løsning", "Å forstå den andres situasjon fullt ut og alltid tilgi negativ atferd", "Å gi situasjonen skylden for alt og overse personens egne valg helt"],
      explanation: 'Fundamental attribusjonsfeil er tendensen til å forklare andres negative atferd med personlige egenskaper ("han er vanskelig") fremfor situasjonen.',
    },
    {
      question: 'Hvilken kommunikasjonssvikt er en vanlig årsak til konflikt?',
      options: ["Misforståelser og ulik tolkning av budskap", "For tydelig kommunikasjon", "For lite snakking, som alltid og uten unntak fører til åpen strid", "For lite snakking alltid"],
      explanation: 'Kommunikasjonssvikt – misforståelser, manglende informasjon og ulik tolkning av budskap – er en av de vanligste årsakene til konflikt.',
    },
  ],
  'psykologi-2-2-5': [
    {
      question: 'Hvilke fem konfliktstiler beskriver Thomas-Kilmann-modellen?',
      options: ["Konkurranse, tilpasning, unngåelse, kompromiss og samarbeid", "Alarm, motstand, utmattelse, hvile og restitusjon", "Frykt, flukt, kamp, frys og underkastelse ved opplevd trussel", "Sentral, perifer, indre, ytre og midtre bearbeiding av budskap"],
      explanation: 'Thomas-Kilmann-modellen beskriver fem konflikthåndteringsstiler: konkurranse, tilpasning, unngåelse, kompromiss og samarbeid.',
    },
    {
      question: 'Hva er kjernen i prinsippbasert forhandling (Harvard-metoden)?',
      options: ["Fokusere på interesser fremfor posisjoner og finne løsninger til felles fordel", "Å vinne mest mulig på den andres bekostning gjennom hard posisjonering", "Å bruke makt, press og trusler for å tvinge gjennom eget standpunkt", "Å unngå all forhandling og heller la en tredjepart avgjøre saken"],
      explanation: 'Prinsippbasert forhandling (Fisher og Ury) handler om å skille person fra problem, fokusere på interesser fremfor posisjoner og finne win-win-løsninger.',
    },
    {
      question: 'Hva gjør en megler (mediator)?',
      options: ["Hjelper partene å kommunisere og finne en løsning, uten å bestemme utfallet", "Bestemmer selv hvem som vinner og pålegger partene en bindende avgjørelse", "Tar tydelig parti for den ene siden og argumenterer for dens interesser", "Straffer den parten som vurderes som skyldig i at konflikten oppstod"],
      explanation: 'En megler er en nøytral tredjepart som fasiliterer en prosess der partene selv finner en løsning – megleren bestemmer ikke utfallet.',
    },
    {
      question: 'Hva er forskjellen mellom et "du-budskap" og et "jeg-budskap"?',
      options: ["Jeg-budskap uttrykker egne følelser uten å anklage, du-budskap anklager den andre", "Du-budskap er alltid best fordi det plasserer ansvaret tydelig hos den andre", "Jeg-budskap er anklagende, mens du-budskap uttrykker egne følelser nøytralt", "De er helt identiske og har nøyaktig samme virkning på mottakeren"],
      explanation: 'Et jeg-budskap uttrykker egne følelser og behov ("Jeg sliter med å konsentrere meg") og virker de-eskalerende, mens et du-budskap anklager og eskalerer.',
    },
    {
      question: 'Hva er gjenopprettende rettferdighet (restorative justice)?',
      options: ["En tilnærming som fokuserer på å reparere skade og gjenopprette relasjoner", "Ren og streng straff av den skyldige uten hensyn til offer og relasjon", "En forhandlingstaktikk der partene bytter innrømmelser mot hverandre", "Å ignorere konflikten helt i håp om at den løser seg selv over tid"],
      explanation: 'Gjenopprettende rettferdighet fokuserer på å reparere skade og gjenopprette relasjoner fremfor å straffe, ved å involvere offer, gjerningsperson og fellesskap.',
    },
  ],
  'psykologi-2-3-1': [
    {
      question: 'Hva er sosial kompetanse?',
      options: ["Evnen til å samhandle positivt med andre og bygge gode relasjoner", "En medfødt refleks som utløses automatisk i sosiale situasjoner", "Evnen til å vinne konkurranser og hevde seg på bekostning av andre", "Evnen til å trives helt alene uten behov for kontakt med andre mennesker"],
      explanation: 'Sosial kompetanse er evnen til å samhandle med andre på en måte som er positiv for begge parter, og å etablere og opprettholde gode relasjoner.',
    },
    {
      question: 'Hva er affektiv empati?',
      options: ['Evnen til å føle det andre føler', 'Evnen til å forstå andres tanker intellektuelt', 'Å være likegyldig', 'Å manipulere andre'],
      explanation: 'Affektiv (emosjonell) empati er evnen til å føle det andre føler – å bli rørt når noen gråter eller glad når noen lykkes.',
    },
    {
    ...
    {
      question: 'Hvilken betydning har god sosial kompetanse for psykisk helse?',
      options: ["Den henger sammen med høyere livskvalitet og lavere risiko for angst og depresjon", "Den gjelder bare i arbeidslivet og har lite å si i private relasjoner", "Den øker risikoen for psykiske lidelser fordi samspill tapper energi", "Den har ingen påviselig betydning for hvordan man har det psykisk"],
      explanation: 'Personer med god sosial kompetanse rapporterer høyere livskvalitet, har lavere risiko for angst og depresjon, og opplever sterkere sosial støtte.',
    },
    {
      question: 'Hva er prososial atferd?',
      options: ["Frivillige handlinger ment å være til gode for andre, som å hjelpe og dele", "Aggressiv atferd rettet mot andre med hensikt om å skade eller true", "Egoistisk atferd der man kun handler for egen vinning uten hensyn", "En forskningsmetode for å måle hvor ofte folk hjelper hverandre"],
      explanation: 'Prososial atferd er frivillige handlinger som er til gode for andre: hjelping, deling, trøsting og samarbeid.',
    },
  ],
  'psykologi-2-3-2': [
    {
  ...
  'psykologi-2-3-3': [
    {
      question: 'Hvordan definerte Dan Olweus mobbing?',
      options: ["Gjentatte negative handlinger over tid mot noen som har vanskelig for å forsvare seg", "Gjensidig erting mellom venner som begge opplever situasjonen som ufarlig og morsom", "En engangshendelse med aggresjon der partene har helt lik makt og posisjon", "En enkeltstående konflikt mellom to like sterke parter som løser den selv"],
      explanation: 'Olweus definerte mobbing som gjentatte negative handlinger over tid fra en eller flere mot en person, der det er en maktubalanse.',
    },
    {
  ...
  'psykologi-2-3-4': [
    {
      question: 'Hva er forskjellen mellom utenforskap og ensomhet?',
      options: ["Utenforskap er objektiv ekskludering, ensomhet er den subjektive opplevelsen", "Utenforskap er en indre følelse, mens ensomhet er en målbar sosial tilstand", "Ensomhet er den objektive ekskluderingen, utenforskap er den subjektive følelsen", "De to begrepene betyr nøyaktig det samme og kan brukes helt om hverandre"],
      explanation: 'Utenforskap er den objektive ekskluderingen fra sosiale fellesskap, mens ensomhet er den subjektive opplevelsen av at ens sosiale behov ikke er oppfylt.',
    },
    {
      question: 'Hvordan definerte John Cacioppo ensomhet?',
      options: ["Som et \"sosialt smertesignal\" – ubehag ved gap mellom ønskede og faktiske relasjoner", "Som en selvstendig psykisk lidelse som må diagnostiseres og behandles medisinsk", "Som et positivt signal om at man er selvstendig og trives godt med eget selskap", "Som en tilstand av fysisk å være helt alene uten noen mennesker til stede"],
      explanation: 'Cacioppo beskrev ensomhet som et "sosialt smertesignal" – en ubehagelig opplevelse ved gap mellom de relasjonene man har og dem man ønsker seg.',
    },
    {
      question: 'Hvilke to typer ensomhet skilte Robert Weiss mellom?',
      options: ["Emosjonell ensomhet og sosial ensomhet", "Fysisk og psykisk ensomhet", "Akutt ensomhet i kriser og kronisk ensomhet som varer over lang tid", "Akutt og kronisk ensomhet"],
      explanation: 'Weiss skilte mellom emosjonell ensomhet (mangel på en nær tilknytningsperson) og sosial ensomhet (mangel på et bredt sosialt nettverk).',
    },
    {
  ...
  'psykologi-2-3-5': [
    ...
    {
      question: 'Hvorfor er tidlig innsats viktig?',
      options: ["Fordi hjernen er mest formbar tidlig, og problemer er lettere å håndtere før de vokser", "Fordi sene tiltak alltid virker best når problemene først har fått vokse seg store", "Fordi det er billigere på kort sikt, selv om det gir større kostnader senere", "Fordi hjernen er minst formbar tidlig og derfor tåler belastninger best da"],
      explanation: 'Tidlig innsats er viktig blant annet fordi hjernen er mest formbar (plastisk) tidlig, og fordi det er lettere å støtte barn før problemene vokser seg store.',
    },
    {
      question: 'Hva er resiliens?',
      options: ["Psykologisk motstandskraft – å klare seg bra til tross for belastninger", "Evnen til å unngå alle utfordringer og belastninger man møter i livet", "En psykisk lidelse som gjør at man overreagerer kraftig på motgang og stress", "Å være fullstendig usårbar slik at ingen belastninger påvirker en i det hele tatt"],
      explanation: 'Resiliens er psykologisk motstandskraft – evnen til å klare seg bra til tross for risikofaktorer og belastninger, ikke å være usårbar.',
    },
    {
  ...
  'psykologi-2-4-1': [
    ...
    {
      question: 'Hva innebærer psykisk helse-kontinuumet?',
      options: ["Psykisk helse er en glidende skala, ikke et enten frisk/syk", "Man er enten helt frisk eller helt syk", "At alle mennesker har nøyaktig samme nivå av psykisk helse hele tiden", "At psykisk helse er en fast egenskap som ikke kan endres gjennom livet"],
      explanation: 'Psykisk helse-kontinuumet ser helse som en glidende skala, ikke et svart-hvitt skille mellom frisk og syk.',
    },
    {
      question: 'Hva er forskjellen mellom psykiske vansker og psykiske lidelser?',
      options: ["Vansker er ofte kortvarige/situasjonsbetingede, lidelser er mer alvorlige og varige", "Lidelser er kortvarige og situasjonsbetingede, mens vansker oppfyller kriterier", "Vansker er alvorlige og varige, mens lidelser er lette og forbigående plager", "De er identiske og betegner nøyaktig den samme graden av psykisk ubehag"],
      explanation: 'Psykiske vansker er ofte kortvarige eller situasjonsbetingede opplevelser av ubehag, mens psykiske lidelser er mer alvorlige og oppfyller diagnostiske kriterier.',
    },
    {
    ...
    {
      question: 'Hvorfor kan det å bli trist etter et brudd regnes som normalt?',
      options: ["Fordi det er en forventet reaksjon på en livshendelse, ikke nødvendigvis en lidelse", "Fordi det er statistisk svært sjeldent å bli trist, og det derfor er avvikende", "Fordi enhver form for tristhet alltid regnes som en psykisk lidelse som må behandles", "Fordi mennesker ikke reagerer følelsesmessig på store livshendelser som brudd"],
      explanation: 'Tristhet etter et brudd er en normal, forventet reaksjon på en livshendelse, og blir ikke automatisk en psykisk lidelse.',
    },
  ],
  'psykologi-2-4-2': [
    {
    ...
    {
      question: 'Hva var deinstitusjonalisering?',
      options: ["Nedleggelse av store psykiatriske sykehus og flytting av pasienter ut i lokalsamfunnet", "En diagnose som ble satt på pasienter som ikke passet inn i lokalsamfunnet", "Bygging av flere og større asyler for å samle pasientene på ett sted", "En terapiform der pasientene ble værende innlagt over svært lang tid"],
      explanation: 'Deinstitusjonalisering fra 1950-tallet innebar at store psykiatriske sykehus ble nedlagt og pasienter flyttet ut i lokalsamfunnene, blant annet muliggjort av nye medisiner.',
    },
    {
  ...
  'psykologi-2-4-3': [
    ...
    {
      question: 'Hva viste Rosenhans studie "On Being Sane in Insane Places" (1973)?',
      options: ["At friske pseudopasienter ble innlagt og diagnostisert som syke", "At psykiatere alltid stiller riktige diagnoser", "At alle pasienter i psykiatrien egentlig er friske og innlegges helt uten grunnlag", "At psykiatere alltid stiller riktige diagnoser når de følger diagnosemanualene nøye"],
      explanation: 'Rosenhans studie viste at åtte friske pseudopasienter ble innlagt på psykiatriske sykehus og fikk diagnoser, noe som reiste kritikk av diagnostiseringens pålitelighet.',
    },
    {
      question: 'Hva er et viktig prinsipp for god diagnostikk?',
      options: ["At en person HAR en lidelse, men ikke ER lidelsen", "At diagnosen er personens identitet", "At diagnosen bør bli personens faste identitet og kjerne i selvforståelsen", "At man aldri skal bruke diagnoser"],
      explanation: 'Et viktig prinsipp er at diagnoser ikke er identiteter: en person HAR depresjon, men ER ikke "depressiv" – diagnosen beskriver en tilstand, ikke hele mennesket.',
    },
  ],
  'psykologi-2-4-4': [
    {
    ...
    {
      question: 'Hva er den kognitive triaden ifølge Aaron Beck?',
      options: ["Negative tanker om seg selv, verden og fremtiden", "Tanker om mat, søvn og trygghet", "Grunnleggende tanker om mat, søvn og trygghet knyttet til menneskets basisbehov", "Alarm, motstand og utmattelse"],
      explanation: 'Becks kognitive triade beskriver de systematisk negative tankene deprimerte har om seg selv, verden og fremtiden.',
    },
    {
    ...
    {
      question: 'Hvilken nevrotransmitter er ofte forbundet med depresjon?',
      options: ['Serotonin (lavt nivå)', 'Adrenalin (høyt nivå)', 'Insulin', 'Melatonin'],
      explanation: 'Lavt nivå av serotonin (og andre nevrotransmittere som noradrenalin og dopamin) er forbundet med depresjon.',
    },
  ],
  'psykologi-2-4-5': [
    {
    ...
    {
      question: 'Hvem definerte stigma som en "dypt diskrediterende egenskap"?',
      options: ['Erving Goffman', 'Aaron Beck', 'Sigmund Freud', 'Martin Seligman'],
      explanation: 'Sosiologen Erving Goffman (1963) definerte stigma som en egenskap som er dypt diskrediterende og som reduserer personens status i andres øyne.',
    },
    {
  ...
  'psykologi-2-5-2': [
    ...
    {
      question: 'Hvem utviklet klientsentrert terapi?',
      options: ['Carl Rogers', 'Sigmund Freud', 'Fritz Perls', 'Aaron Beck'],
      explanation: 'Carl Rogers utviklet klientsentrert (personsentrert) terapi, der terapeuten skaper betingelser for klientens egen vekst fremfor å analysere.',
    },
    {
  ...
  'psykologi-2-5-5': [
    {
      question: 'Hvilke tre nivåer av forebygging beskriver Caplans modell?',
      options: ["Primær-, sekundær- og tertiærforebygging", "Indre, ytre og midtre forebygging", "Indre, ytre og midtre forebygging etter hvor problemet befinner seg", "Akutt, kronisk og forbigående"],
      explanation: 'Forebygging deles i tre nivåer: primær (hindre at problemer oppstår), sekundær (tidlig oppdagelse) og tertiær (begrense skade ved etablert lidelse).',
    },
    {
  ...
  'psykologi-2-6-1': [
    {
      question: 'Hva er den biopsykososiale modellen?',
      options: ["En modell som ser helse og sykdom som samspill mellom biologiske, psykologiske og sosiale faktorer", "En konkret behandlingsteknikk som brukes for å lindre symptomer på psykiske og somatiske lidelser", "En rent biologisk modell som forklarer helse og sykdom utelukkende ut fra gener, celler og fysiologi", "En filosofisk modell uten praktisk betydning for hvordan helse og sykdom forstås og behandles i klinikken"],
      explanation: 'Den biopsykososiale modellen ser helse og sykdom som resultat av komplekse interaksjoner mellom biologiske, psykologiske og sosiale faktorer.',
    },
    {
  ...
  'psykologi-2-6-4': [
    {
      question: 'Hvilken søvnfase er knyttet til mest drømmeaktivitet?',
      options: ['REM-søvn', 'NREM N1', 'NREM N3 (dyp søvn)', 'Våkenhet'],
      explanation: 'REM-søvn (Rapid Eye Movement) er fasen med mest drømmeaktivitet og er kritisk for emosjonell bearbeiding og regulering.',
    },
    {
    ...
    {
      question: 'Hvilket hormon signaliserer at det er tid for søvn?',
      options: ['Melatonin', 'Adrenalin', 'Kortisol', 'Insulin'],
      explanation: 'Melatonin er søvnhormonet, produsert av epifysen og regulert av lys og mørke, som signaliserer til kroppen at det er tid for søvn.',
    },
    {
  ...
  'psykologi-2-7-2': [
    ...
    },
    {
      ...
      options: ['De gir dyp forståelse av mening og opplevelse', 'De gir alltid presise tall', 'De kan alltid generaliseres til hele befolkningen', 'De krever ingen tolkning'],
      explanation: 'En styrke ved kvalitative metoder er at de gir dyp, rik forståelse av mening, opplevelser og kontekst, selv om de er vanskeligere å generalisere statistisk.',
    },
  ],
  'psykologi-2-7-3': [
    {
  ...
  'psykologi-2-7-5': [
    ...
    },
    {
      ...
      options: ["Påstander som utgir seg for å være vitenskapelige uten å oppfylle vitenskapens krav", "All form for psykologi, ettersom faget mangler naturvitenskapens strenge presisjon", "En anerkjent forskningsmetode som brukes når vanlige eksperimenter ikke lar seg gjennomføre", "Den aller nyeste vitenskapen som ennå ikke er blitt bredt akseptert i fagmiljøet"],
  ...
  'psykologi-2-8-1': [
    {
      question: 'Hva er hovedpoenget i å sammenligne psykologiske perspektiver?',
      options: ["Hvert perspektiv gir unik innsikt, men ingen kan forklare alt alene", "Perspektivene utelukker hverandre fullstendig", "Perspektiver er unyttige, fordi de bare kompliserer forståelsen av menneskelig atferd", "Ett bestemt perspektiv er alltid det riktige og kan forklare alle psykologiske fenomener"],
      explanation: 'Hvert perspektiv gir unike verktøy for å forstå psykologiske fenomener, men ingen enkelt tilnærming kan forklare alt – de er komplementære.',
    },
    {
    ...
    {
      question: 'Hva vektlegger det sosiokulturelle perspektivet?',
      options: ["Hvordan kultur, samfunn og relasjoner former atferd og mentale prosesser", "Hvordan belønning og straff i miljøet forklarer all innlæring av atferd", "Hvordan ubevisste drifter og barndomskonflikter former personligheten vår", "Hvordan hjernekjemi og nevrotransmittere alene styrer all menneskelig atferd"],
      explanation: 'Det sosiokulturelle perspektivet vektlegger hvordan kultur, samfunn og sosiale relasjoner former atferd og mentale prosesser.',
    },
  ],
  'psykologi-2-8-2': [
    {
    ...
    {
      question: 'Hva er utbrenthet?',
      options: ["En tilstand av emosjonell, fysisk og mental utmattelse fra langvarig stress", "Et sunt tegn på høyt engasjement og sterk indre motivasjon i arbeidet", "En form for prestasjonsmotivasjon som driver mennesker til å yte mer over tid", "En bestemt lederstil der lederen krever mye og delegerer lite til medarbeiderne"],
      explanation: 'Utbrenthet er en tilstand av emosjonell, fysisk og mental utmattelse forårsaket av langvarig stress, kjennetegnet av utmattelse, depersonalisering og redusert mestring.',
    },
    {
  ...
  'psykologi-2-8-3': [
    ...
    {
      question: 'Hva kjennetegner et "uavhengig selv" i individualistiske kulturer?',
      options: ["Man definerer seg gjennom indre, personlige egenskaper", "Man definerer seg kun gjennom relasjoner", "Man definerer seg utelukkende gjennom relasjoner og roller i familie og gruppe", "Man opplever å mangle en fast identitet og formes helt av situasjonen man er i"],
      explanation: 'Et uavhengig selv ser seg selv som autonomt og adskilt fra andre, og definerer seg gjennom indre, personlige egenskaper ("jeg er intelligent, ambisiøs").',
    },
    {
      question: 'Hva er etnosentrisme?',
      options: ["Å vurdere andre kulturer ut fra sin egen kulturs standarder", "Å forstå andre kulturer på deres egne premisser", "Å avvise og se ned på sin egen kultur til fordel for andres normer og skikker", "En forskningsmetode der man sammenligner atferd på tvers av mange ulike kulturer"],
      explanation: 'Etnosentrisme er tendensen til å vurdere andre kulturer ut fra sin egen kulturs standarder og normer, ofte med en antakelse om egen overlegenhet.',
    },
    {
      question: 'Hva er WEIRD-problemet i kulturell psykologi?',
      options: ["At mye forskning bygger på vestlige, utdannede, rike utvalg som ikke er universelle", "En bestemt form for terapi utviklet for vestlige, utdannede og velstående klienter", "At all psykologisk forskning er kulturuavhengig og gyldig for hele menneskeheten", "At kultur ikke betyr noe for hvordan mennesker tenker, føler og oppfører seg"],
      explanation: 'WEIRD-problemet viser at mye psykologisk forskning er gjort på vestlige, utdannede, industrialiserte, rike og demokratiske utvalg, og ikke nødvendigvis gjelder universelt.',
    },
    {
  ...
  'psykologi-2-8-4': [
    ...
    {
      question: 'Hva er en hovedforskjell mellom klinisk psykolog og psykiater?',
      options: ["Psykiater er lege og kan skrive ut medisin, psykolog har profesjonsstudium i psykologi", "Psykiater bruker aldri medisin og arbeider utelukkende med samtalebasert terapi", "Psykolog er lege og kan skrive ut all medisin, mens psykiater kun tar samtaler", "De to yrkene er identiske og har akkurat samme utdanning og arbeidsoppgaver"],
      explanation: 'En psykiater er lege (kan skrive ut medisin), mens en klinisk psykolog har profesjonsstudium i psykologi og arbeider med samtalebasert terapi og testing.',
    },
    {
      question: 'Hva er den terapeutiske alliansen?',
      options: ["Forholdet mellom terapeut og klient, en sterk prediktor for behandlingsutfall", "En bestemt type medisin som brukes for å styrke motivasjon under behandling", "En diagnostisk kategori i diagnosemanualen for å beskrive relasjonsvansker", "En forskningsmetode der man måler terapeutens effekt på klienten over tid"],
      explanation: 'Den terapeutiske alliansen er forholdet mellom terapeut og klient, og er blant de sterkeste prediktorene for behandlingsutfall – uavhengig av terapiform.',
    },
    {
  ...
  'psykologi-2-8-5': [
    ...
    {
      question: 'Hva arbeider rettspsykologi (forensisk psykologi) med?',
      options: ["Å anvende psykologisk kunnskap i rettssystemet, som risikovurdering og tilregnelighet", "Å utforme og vedta nye lover og forskrifter som regulerer rettssystemet vårt", "Å avsi dom over tiltalte og avgjøre skyldspørsmålet i straffesaker i retten", "Å studere barns kognitive og emosjonelle utvikling gjennom hele oppveksten"],
      explanation: 'Rettspsykologi anvender psykologisk kunnskap i rettssystemet, blant annet gjennom sakkyndige vurderinger av tilregnelighet og risiko for gjentakelse.',
    },
    {
      question: 'Hva er PERMA-modellen i positiv psykologi?',
      options: ["Fem elementer i et blomstrende liv: positive emosjoner, engasjement, relasjoner, mening og mestring", "En trinnvis behandlingsmetode utviklet spesielt for pasienter med alvorlig psykose", "En anatomisk modell som beskriver hjernens fem viktigste regioner og funksjoner", "En diagnostisk modell for å kartlegge og klassifisere ulike psykiske lidelser"],
      explanation: 'PERMA-modellen (Seligman) beskriver fem elementer i et blomstrende liv: positive emosjoner, engasjement, relasjoner, mening og mestring/prestasjon.',
    },
    {
...
export default quizData_psykologi_2;
