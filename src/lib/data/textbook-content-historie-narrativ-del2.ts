      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'At mennesket stammer direkte fra sjimpanser', isCorrect: false },
              { id: 'b', text: 'At aper og mennesker er nøyaktig like', isCorrect: false },
              { id: 'c', text: 'At vi deler et felles opphav, men utviklet oss i ulike retninger for millioner av år siden', isCorrect: true },
              { id: 'd', text: 'At mennesker og aper ikke er biologisk beslektet', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Homo sapiens var den første som gikk oppreist', isCorrect: false },
              { id: 'b', text: 'Homo sapiens var den første som forlot Afrika', isCorrect: false },
              { id: 'c', text: 'Homo sapiens er den eneste arten som har brukt verktøy', isCorrect: false },
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'At neandertalere og Homo sapiens aldri møttes', isCorrect: false },
              { id: 'b', text: 'At Homo sapiens møtte og fikk barn med neandertalere da de kom til Europa og Vest-Asia', isCorrect: true },
              { id: 'c', text: 'At neandertalere oppsto i Afrika', isCorrect: false },
              { id: 'd', text: 'At alle mennesker har like mye neandertaler-DNA', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'At det finnes store genetiske forskjeller mellom menneskeraser', isCorrect: false },
              { id: 'b', text: 'At genetiske forskjeller viser at mennesker har forskjellig opprinnelse', isCorrect: false },
              { id: 'c', text: 'At alle mennesker har felles opprinnelse og genetiske forskjeller er minimale -- ca. 0,1 prosent', isCorrect: true },
              { id: 'd', text: 'At bare afrikanere har felles forfedre', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'De hadde konger og adel som styrte', isCorrect: false },
              { id: 'b', text: 'Små grupper på 20-50 personer med betydelig likhet og ingen formelle ledere med varig makt', isCorrect: true },
              { id: 'c', text: 'Store byer med tusenvis av innbyggere', isCorrect: false },
              { id: 'd', text: 'Enkeltpersoner som levde helt alene', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              ...
              { id: 'b', text: 'Jernsverd, hjul og keramikk', isCorrect: false },
              { id: 'c', text: 'Skriftspråk og papir', isCorrect: false },
              { id: 'd', text: 'Dampmaskin og kompass', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'De hadde ingen sosiale fellesskap', isCorrect: false },
              { id: 'b', text: 'De måtte jobbe 16 timer om dagen', isCorrect: false },
              { id: 'c', text: 'De hadde bare tilgang til én type mat', isCorrect: false },
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Akrylmaling og pensler', isCorrect: false },
              { id: 'b', text: 'Naturlige pigmenter som oker, trekull og jernoksid', isCorrect: true },
              { id: 'c', text: 'Plantesaft og bær', isCorrect: false },
              { id: 'd', text: 'Knust stein blandet med vann', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'De malte for å dekorere boliger de bodde i daglig', isCorrect: false },
              { id: 'b', text: 'De malte bare for å øve på finmotorikk', isCorrect: false },
              { id: 'c', text: 'Kanskje jaktmagi, hellige ritualer, undervisning eller kunst som et mål i seg selv', isCorrect: true },
              { id: 'd', text: 'Det var en form for skriftspråk for å kommunisere med fremmede', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Vikingkulturen og samekulturen', isCorrect: false },
              { id: 'b', text: 'Traktbegerkulturen og stridsøkskulturen', isCorrect: false },
              { id: 'c', text: 'Fosna-kulturen på Vestlandet og Komsa-kulturen i Nord-Norge', isCorrect: true },
              { id: 'd', text: 'Sumererkulturen og egypterkulturen', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Jordskjelv som hevet fjellene', isCorrect: false },
              { id: 'b', text: 'Vulkaner som skapte nytt land', isCorrect: false },
              { id: 'c', text: 'Landmassene hevet seg gradvis etter at den tunge isen hadde trykket dem ned', isCorrect: true },
              { id: 'd', text: 'Havet sank på grunn av tørke', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Å flytte dyr fra ett sted til et annet', isCorrect: false },
              { id: 'b', text: 'Å jakte på ville dyr mer effektivt', isCorrect: false },
              { id: 'c', text: 'Å bevisst avle planter og dyr for å forsterke ønskede egenskaper', isCorrect: true },
              { id: 'd', text: 'Å temme et enkelt dyr slik at det kan bo i huset', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Kua', isCorrect: false },
              { id: 'b', text: 'Sauen', isCorrect: false },
              { id: 'c', text: 'Katten', isCorrect: false },
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Ja, bare i Den fruktbare halvmåne, og derfra spredte den seg', isCorrect: false },
              { id: 'b', text: 'Nei, den oppsto uavhengig på flere steder: Midtøsten, Kina, Mellom-Amerika og Afrika', isCorrect: true },
              { id: 'c', text: 'Ja, bare i Kina, og derfra spredte den seg vestover', isCorrect: false },
              { id: 'd', text: 'Nei, alle kulturer begynte med jordbruk samtidig', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Mindre befolkning og færre bosettinger', isCorrect: false },
              { id: 'b', text: 'Sykdommer som spredte seg lettere, ensidig kost, konflikter om jord og sosial ulikhet', isCorrect: true },
              { id: 'c', text: 'Lengre arbeidsdager men bedre helse', isCorrect: false },
              { id: 'd', text: 'Mer nomadisk livsstil og ustabile bosettinger', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Folk fikk mer fritid', isCorrect: false },
              { id: 'b', text: 'Eiendom ble viktig -- jorda tilhørte noen, og det oppsto faste bosettinger og landsbyer', isCorrect: true },
              { id: 'c', text: 'Mennesker sluttet å drive med handel', isCorrect: false },
              { id: 'd', text: 'Befolkningen gikk ned fordi folk ble isolerte', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Små graver i sanden som viser et primitivt samfunn', isCorrect: false },
              ...
              { id: 'c', text: 'Gravhauger av jord som bare konger ble begravet i', isCorrect: false },
              { id: 'd', text: 'Huler som ble brukt til begravelser', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Fordi jern var penere enn bronse', isCorrect: false },
              { id: 'b', text: 'Fordi jern kunne utvinnes lokalt fra myrmalm, og jernplogen effektiviserte jordbruket', isCorrect: true },
              { id: 'c', text: 'Fordi jern var billigere å importere enn bronse', isCorrect: false },
              { id: 'd', text: 'Fordi romerne krevde at nordboerne brukte jern', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Babylon i Irak', isCorrect: false },
              { id: 'b', text: 'Jeriko i Palestina, med bosetting fra ca. 9000 f.Kr.', isCorrect: true },
              { id: 'c', text: 'Aten i Hellas', isCorrect: false },
              { id: 'd', text: 'Roma i Italia', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Bare en større befolkning', isCorrect: false },
              { id: 'b', text: 'At alle fortsatte som bønder, men bodde tettere', isCorrect: false },
              { id: 'c', text: 'Spesialisering av yrker, handel, felles regler og ledelse', isCorrect: true },
              { id: 'd', text: 'At folk sluttet med jordbruk og gikk tilbake til jakt', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Svedjebruk som brant ned all skogen', isCorrect: false },
              { id: 'b', text: 'Vekselsbruk i middelalderen, terrasser i Asia og tradisjonell norsk seterdrift', isCorrect: true },
              { id: 'c', text: 'Intensiv irrigasjon i Mesopotamia', isCorrect: false },
              { id: 'd', text: 'Avskogingen rundt Middelhavet', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Mennesker sluttet å påvirke naturen', isCorrect: false },
              { id: 'b', text: 'Mennesker begynte å omforme naturen i stor skala: skogrydding, irrigasjon og overbeiting', isCorrect: true },
              { id: 'c', text: 'Naturen ble ikke påvirket før den industrielle revolusjonen', isCorrect: false },
              { id: 'd', text: 'Mennesker lærte å leve i harmoni med naturen', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Fordi elvene ga beskyttelse mot fiender', isCorrect: false },
              { id: 'b', text: 'Fordi det var lettere å bygge byer ved elver', isCorrect: false },
              ...
              { id: 'd', text: 'Fordi mennesker alltid har foretrukket å bo ved vann', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Fordi det ikke finnes noen sivilisasjoner', isCorrect: false },
              { id: 'b', text: 'Fordi det historisk har blitt misbrukt til å nedvurdere andre samfunn som "usiviliserte"', isCorrect: true },
              { id: 'c', text: 'Fordi alle samfunn er like komplekse', isCorrect: false },
              { id: 'd', text: 'Fordi bare europeere bruker begrepet', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Egypterne oppfant den for å skrive religiøse tekster', isCorrect: false },
              { id: 'b', text: 'Sumererne oppfant den rundt 3200 f.Kr., opprinnelig til regnskap og handel', isCorrect: true },
              { id: 'c', text: 'Babylonerne oppfant den for å skrive lover', isCorrect: false },
              { id: 'd', text: 'Grekerne oppfant den for å skrive poesi', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'At man skulle gjøre mest mulig skade på forbrytere', isCorrect: false },
              { id: 'b', text: 'At alle skulle behandles likt uansett status', isCorrect: false },
              { id: 'c', text: 'At straffen måtte stå i forhold til forbrytelsen -- en grense for gjengjeldelse', isCorrect: true },
              { id: 'd', text: 'At hevn alltid var lov i Babylon', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Et tallsystem fra Egypt med 365 som grunntall', isCorrect: false },
              { id: 'b', text: 'Et moderne tallsystem oppfunnet på 1800-tallet', isCorrect: false },
              { id: 'c', text: 'Et tallsystem fra Mesopotamia som gir oss 60 minutter i en time og 60 sekunder i et minutt', isCorrect: true },
              { id: 'd', text: 'Et gresk tallsystem brukt i matematikk', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Slaver som ble tvunget til arbeid', isCorrect: false },
              { id: 'b', text: 'Utenlandske erobrere', isCorrect: false },
              { id: 'c', text: 'Organiserte arbeidslag som trolig arbeidet i bytte mot mat og hus', isCorrect: true },
              { id: 'd', text: 'Bare prester og adelige', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'En stein med de ti bud skrevet på egyptisk', isCorrect: false },
              ...
              { id: 'c', text: 'En hellig stein brukt i egyptiske templer', isCorrect: false },
              { id: 'd', text: 'En grensestein mellom Egypt og Mesopotamia', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Alle borgere lærte å lese og skrive', isCorrect: false },
              { id: 'b', text: 'Bare kongen og hans familie', isCorrect: false },
              { id: 'c', text: 'Bare kvinner, som hadde ansvar for utdanning', isCorrect: false },
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'En egyptisk lovsamling', isCorrect: false },
              ...
              { id: 'c', text: 'En gresk tragedie om den trojanske krig', isCorrect: false },
              { id: 'd', text: 'En kinesisk filosofisk tekst', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Pyramidene og monumentene', isCorrect: false },
              { id: 'b', text: 'Militær teknologi og våpen', isCorrect: false },
              { id: 'c', text: 'Ideen om at mennesker kan organisere seg i store, komplekse samfunn med felles regler', isCorrect: true },
              { id: 'd', text: 'Matoppskrifter og klesdrakter', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'En gruppe utvalgte adelsmenn som styrte Aten', isCorrect: false },
              { id: 'b', text: 'Et religiøst råd som tolket gudenes vilje', isCorrect: false },
              ...
              { id: 'd', text: 'En domstol som dømte kriminelle', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'En gruppe generaler som ledet hæren', isCorrect: false },
              { id: 'b', text: 'Et organ med 500 loddtrukne medlemmer som styrte den daglige administrasjonen', isCorrect: true },
              { id: 'c', text: 'Atens øverste domstol', isCorrect: false },
              { id: 'd', text: 'En forsamling av de rikeste borgerne', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Slaver som arbeidet i gruvene', isCorrect: false },
              { id: 'b', text: 'Frie innflyttere som bodde og arbeidet i Aten, men ikke kunne stemme', isCorrect: true },
              { id: 'c', text: 'Athenske kvinner med spesiell status', isCorrect: false },
              { id: 'd', text: 'Adelsmenn som styrte byen', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Slavene hadde stemmerett, men brukte den aldri', isCorrect: false },
              { id: 'b', text: 'Det fantes ingen slaver i Aten', isCorrect: false },
              { id: 'c', text: 'Demokratiet var delvis mulig fordi slavene frigjorde borgernes tid til politikk', isCorrect: true },
              { id: 'd', text: 'Slavene styrte egentlig demokratiet bak kulissene', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Han ble valgt til Atens leder', isCorrect: false },
              { id: 'b', text: 'Han flyktet fra Aten til Sparta', isCorrect: false },
              { id: 'c', text: 'Han ble dømt til døden av en jury på 501 borgere for å fordærve ungdommen', isCorrect: true },
              { id: 'd', text: 'Han grunnla sitt eget demokrati i en annen bystat', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Han mente demokrati var den eneste gode styreformen', isCorrect: false },
              { id: 'b', text: 'Han mente demokrati var den verste styreformen', isCorrect: false },
              { id: 'c', text: 'Han mente den beste styreformen var en blanding av demokrati, aristokrati og monarki', isCorrect: true },
              { id: 'd', text: 'Han hadde ingen mening om demokrati', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Direkte demokrati er mer moderne enn representativt', isCorrect: false },
              ...
              { id: 'c', text: 'Representativt demokrati gir mer makt til folket', isCorrect: false },
              { id: 'd', text: 'Det er ingen forskjell -- begge fungerer likt', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Fordi athenerne ikke visste hva rettigheter var', isCorrect: false },
              { id: 'b', text: 'Fordi flertallet bestemte alt -- det fantes ingen beskyttelse mot flertallets vilje', isCorrect: true },
              { id: 'c', text: 'Fordi de hadde en muntlig grunnlov i stedet', isCorrect: false },
              { id: 'd', text: 'Fordi gudene beskyttet individets rettigheter', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Stortingsvalg i Norge', isCorrect: false },
              { id: 'b', text: 'Folkeavstemninger, som EU-avstemningen i Norge i 1994', isCorrect: true },
              { id: 'c', text: 'Kommunestyremøter', isCorrect: false },
              { id: 'd', text: 'Politiske debatter på TV', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Patrisiere var slaver, plebeiere var frie', isCorrect: false },
              ...
              { id: 'c', text: 'Patrisiere var bønder, plebeiere var handelsmenn', isCorrect: false },
              { id: 'd', text: 'Det var ingen forskjell -- alle hadde like rettigheter', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'De hadde en sterk grunnlov', isCorrect: false },
              { id: 'b', text: 'To konsuler med vetorett, tidsbegrensede verv og deling av makt mellom flere institusjoner', isCorrect: true },
              { id: 'c', text: 'De hadde frie valg hvert år', isCorrect: false },
              { id: 'd', text: 'Senatet hadde absolutt makt', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Fordi han tapte en viktig krig', isCorrect: false },
              { id: 'b', text: 'Fordi han var en upopulær leder blant folket', isCorrect: false },
              { id: 'c', text: 'Fordi senatorer fryktet at han ville gjøre seg til konge og ødelegge republikken', isCorrect: true },
              { id: 'd', text: 'Fordi han nektet å gi soldatene lønn', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'En fredsavtale mellom Roma og Hellas', isCorrect: false },
              ...
              { id: 'c', text: 'Navnet på den romerske hæren', isCorrect: false },
              { id: 'd', text: 'En religiøs bevegelse i Roma', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Bare militære problemer', isCorrect: false },
              ...
              { id: 'c', text: 'Religiøse konflikter alene', isCorrect: false },
              { id: 'd', text: 'Folket ønsket å gå tilbake til republikken', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Fordi Romerriket aldri egentlig falt', isCorrect: false },
              { id: 'b', text: 'Fordi nedgangen var en gradvis prosess over nesten 300 år, og mye av romersk kultur levde videre', isCorrect: true },
              { id: 'c', text: 'Fordi det ble gjenopprettet kort tid etter', isCorrect: false },
              { id: 'd', text: 'Fordi bare Roma by ble ødelagt', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Kongen har all makt, men delegerer til andre', isCorrect: false },
              { id: 'b', text: 'Stortinget lager lover, regjeringen styrer landet, og domstolene dømmer', isCorrect: true },
              { id: 'c', text: 'Regjeringen har all makt', isCorrect: false },
              { id: 'd', text: 'Domstolene bestemmer lovene', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'At makt gjør mennesker klokere', isCorrect: false },
              { id: 'b', text: 'At alle bør ha like mye makt', isCorrect: false },
              { id: 'c', text: 'At makt korrumperer, og absolutt makt korrumperer absolutt', isCorrect: true },
              { id: 'd', text: 'At bare eksperter bør ha makt', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Bare politikk og lover', isCorrect: false },
              { id: 'b', text: 'Politikk, språk, arkitektur, filosofi, vitenskap, litteratur og teater', isCorrect: true },
              { id: 'c', text: 'Bare arkitektur og kunst', isCorrect: false },
              { id: 'd', text: 'Bare religion', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Fordi søyler er den billigste byggemåten', isCorrect: false },
              { id: 'b', text: 'Fordi det var et tilfeldig arkitekturvalg', isCorrect: false },
              ...
              { id: 'd', text: 'Fordi bygningen opprinnelig var et tempel', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Fordi de ikke trodde på noen guder selv', isCorrect: false },
              { id: 'b', text: 'Fordi de tok inn erobrede folks guder i sitt eget panteon, noe som gjorde det lettere å styre', isCorrect: true },
              { id: 'c', text: 'Fordi loven forbød forfølgelse av religiøse grupper', isCorrect: false },
              { id: 'd', text: 'Fordi romerne var ateister', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Den ble verdens største religion', isCorrect: false },
              { id: 'b', text: 'Den oppfant skriften', isCorrect: false },
              ...
              { id: 'd', text: 'Den erobret Romerriket militært', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'En romersk keiser som reformerte religionen', isCorrect: false },
              { id: 'b', text: 'En jødisk predikant som forkynte Guds rike, nestekjærlighet og tilgivelse', isCorrect: true },
              { id: 'c', text: 'En gresk filosof som underviste i Aten', isCorrect: false },
              { id: 'd', text: 'En egyptisk prest som oppfant monoteismen', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Kristendommen trodde på mange guder', isCorrect: false },
              ...
              { id: 'c', text: 'Jødedommen var universell, kristendommen var lokal', isCorrect: false },
              { id: 'd', text: 'Det var ingen viktig forskjell', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Fordi den ble påbudt av keiseren', isCorrect: false },
              ...
              { id: 'c', text: 'Fordi alle andre religioner ble forbudt', isCorrect: false },
              { id: 'd', text: 'Bare fordi martyrene imponerte folk', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'En hemmelig religiøs sekt bare for keisere', isCorrect: false },
              ...
              { id: 'c', text: 'En filosofisk retning som kristne var uenige i', isCorrect: false },
              { id: 'd', text: 'En militær tradisjon som krevde at alle tjenestegjorde', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Han forbød kristendommen', isCorrect: false },
              { id: 'b', text: 'Han utstedte toleranseediktet som ga kristne rett til å praktisere sin religion fritt', isCorrect: true },
              { id: 'c', text: 'Han gjorde kristendommen til statsreligion', isCorrect: false },
              { id: 'd', text: 'Han ble den første paven', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Religion ble helt adskilt fra politikk', isCorrect: false },
              ...
              { id: 'c', text: 'Kirken overtok all politisk makt', isCorrect: false },
              { id: 'd', text: 'Keiseren avskaffet kirken', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Et møte der kristne ble forfulgt', isCorrect: false },
              { id: 'b', text: 'Et politisk møte om Romerrikets grenser', isCorrect: false },
              { id: 'c', text: 'Et møte innkalt av Konstantin der grunnlaget for kristen lære ble formulert', isCorrect: true },
              { id: 'd', text: 'Et møte der hedenske templer ble stengt', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'At den støttet slaveri og sosiale hierarkier', isCorrect: false },
              { id: 'b', text: 'At den hevdet alle mennesker er like for Gud -- en radikal tanke i et samfunn bygget på hierarkier', isCorrect: true },
              { id: 'c', text: 'At den innførte nye lover om handel', isCorrect: false },
              { id: 'd', text: 'At den avskaffet alle guder', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'De ble helt avskaffet og glemt', isCorrect: false },
              { id: 'b', text: 'De ble kristnet -- for eksempel ble julen lagt til vintersolverv og påsken til vårjevndøgn', isCorrect: true },
              { id: 'c', text: 'De fortsatte uendret ved siden av kristne høytider', isCorrect: false },
              { id: 'd', text: 'De ble forbudt og erstattet med helt nye datoer', isCorrect: false },
            ],
