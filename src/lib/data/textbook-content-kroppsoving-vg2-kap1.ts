...
Prosentene refererer til maksimal hjertefrekvens.`,
    ...
    },
    {
      ...
      exercise: {
        ...
        solution: 'Eksempel per uke: 3 økter rolig langkjøring (sone 2, 30-45 min), 1 økt intervalltrening (4x4 min på 90-95 % av makspuls). Uke 1-2: Oppbygging med fokus på langkjøring. Uke 3: Øk volum og legg til tempokjøring. Uke 4: Restitusonsuke med redusert volum. 80 % av treningstiden er i lav sone, 20 % i høy.',
        allowsUpload: true,
        allowsCanvasDrawing: true,
      },
    },
