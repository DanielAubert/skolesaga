...
| **Innlegg** | Kortere meningsytring i avisen |`,
    ...
    // Oppgave relatert til ordliste: argument vs påstand
    {
...
- Respekter meningsmotstandere`,
    ...
    // Oppgaver relatert til debattinnleggets struktur
    {
...
- Vis at du har forstått saken fra flere sider`,
    ...
    // Oppgaver relatert til argumentasjonsteknikker og feilslutninger
    {
...
**Analyse:** Innlegget har tydelig struktur med tese, argumenter støttet av forskning, og behandling av motargument.`,
    ...
    // Oppgaver relatert til eksempelet om analyse av debattinnlegg
    {
    ...
    // Oppgaver relatert til primærtekstene
    {
    ...
    },
    {
      ...
      exercise: {
        ...
        type: 'classic',
        difficulty: 'vanskelig',
        task: 'Skriv et motinnlegg (300-400 ord) til debattinnlegget om skolestart i oppgave 12. Argumenter for at skolen IKKE bør starte klokka 9.',
        hints: [
...
| **Katarsis** | Følelsesmessig renselse hos publikum |`,
    ...
    // Oppgaver relatert til ordliste/grunnleggende begreper
    {
...
- Indre konflikt: I karakterens eget sinn`,
    ...
    // Oppgaver relatert til dramatiske virkemidler
    {
...
Aristoteles mente tragedien skulle rense publikum for følelser som frykt og medlidenhet gjennom innlevelse i handlingen.`,
    ...
    // Oppgaver relatert til Aristoteles dramaturgi
    {
...
- Politisk teater`,
    ...
    // Oppgaver relatert til moderne drama og sjangre
    {
...
Der Ibsen avslører hemmeligheter gjennom dialog, lar Fosse hemmelighetene forbli usagte. Begge utforsker menneskelig psykologi, men med helt ulike virkemidler.`,
    ...
    // Oppgaver relatert til Jon Fosse
    {
...
Dette er typisk for moderne realistisk drama der konflikter uttrykkes indirekte.`,
    ...
    // Oppgaver relatert til analyse av dramatisk tekst
    {
...
En god tale balanserer alle tre. For mye patos uten logos virker manipulerende. For mye logos uten patos blir kjedelig. Uten etos mangler troverdighet.`,
    ...
    // Oppgaver relatert til de retoriske appellformene
    {
...
- Avslutt med kraft`,
    ...
    // Oppgaver relatert til talens oppbygging
    {
...
- Husk: Publikum vil at du skal lykkes`,
    ...
    // Oppgave relatert til fremføring
    {
      ...
      exercise: {
        ...
        type: 'classic',
        difficulty: 'medium',
        task: 'Hold talen du planla i oppgave 4 for klassen eller en gruppe. Få tilbakemelding på:',
        subTasks: [
...
- Prekentradisjonen fra afroamerikansk kirke`,
    ...
    // Oppgave relatert til eksempelet
    {
...
\`\`\``,
    ...
    // Oppgaver relatert til Freytags pyramide
    {
...
- Akt 3: Simba returnerer, bekjemper Scar, blir konge`,
    ...
    // Oppgave relatert til treaktsstrukturen
    {
...
- Hvem som står høyest viser makt`,
    ...
    // Oppgave relatert til sceniske virkemidler
    {
...
- Ofte minimalistisk og poetisk`,
    ...
    // Oppgaver relatert til moderne norsk dramatikk
    {
...
Det handler ikke om å kopiere, men å fange essensen av verket i et nytt medium.`,
    ...
    // Oppgaver relatert til typer adaptasjon
    {
...
Hver adaptasjon må finne sin måte å erstatte det som går tapt mellom medier - og utnytte det nye mediets muligheter.`,
    ...
    // Oppgave relatert til medienes forskjeller
    {
...
- Ingen tekst eksisterer i vakuum`,
    ...
    // Oppgaver relatert til intertekstualitet
    {
...
- Vurder hva hvert medium gjør best`,
    ...
    // Oppgave relatert til analyse av adaptasjon
    {
...
Norske adaptasjoner må ofte velge mellom internasjonal appell og lokal autentisitet.`,
    ...
    // Oppgave relatert til eksemplene
    {
