...
Teknologien endret hverdagen dramatisk. Biler, fly, telefon, film - alt dette forandret hvordan mennesker opplevde tid og rom. Verden krympet og akselererte. Storbyene vokste og skapte nye, fremmedgjorende livsmater. Mennesket folte seg lite i den moderne verden.`,
    },
    {
      ...
      exercise: {
        ...
        task: 'Test deg selv pa modernismens bakgrunn:',
        options: [
        ...
        questions: [
          ...
          {
            id: 'norsk-vg3-2-1-n-quiz1-q1',
            task: 'Hvilken tenker erklarte at "Gud er dod"?',
            options: [
              { id: 'a', text: 'Charles Darwin', isCorrect: false },
              { id: 'b', text: 'Albert Einstein', isCorrect: false },
              { id: 'c', text: 'Friedrich Nietzsche', isCorrect: true },
              { id: 'd', text: 'Sigmund Freud', isCorrect: false },
            ],
            solution: 'Nietzsche erklarte at "Gud er dod" - ikke som en triumf, men som en diagnose av en kultur som hadde mistet sitt ankerfeste. Dette var en av de ideene som rokket ved alt folk hadde trodd pa rundt 1900.',
          },
          {
            id: 'norsk-vg3-2-1-n-quiz1-q2',
            task: 'Hva avdekket Sigmund Freud som var sentralt for modernismen?',
            options: [
              { id: 'a', text: 'Relativitetsteorien', isCorrect: false },
              { id: 'b', text: 'Evolusjonsteorien', isCorrect: false },
              { id: 'c', text: 'Atomets struktur', isCorrect: false },
              { id: 'd', text: 'Det ubevisste', isCorrect: true },
            ],
            solution: 'Freud avdekket det ubevisste - alle driftene og drommene som ligger under overflaten av var bevissthet. Mennesket var ikke lenger herre i eget hus, noe som pavirket modernistisk litteratur dypt.',
          },
        ],
      },
    },
...
Apningslinjene snur alt pa hodet: "April is the cruellest month" - april er den grusomste maneden. Tradisjonelt er varen tid for fornyelse og hap. Men Eliot sier: Varen er grusom fordi den vekker liv i det som var dadt, tvinger frem minner og lengsel vi helst ville begrave.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 2',
        type: 'multiple-choice',
        task: 'Test deg selv pa modernismens kjennetegn:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        solution: '',
        questions: [
          ...
          {
            id: 'norsk-vg3-2-1-n-quiz2-q1',
            task: 'Hvilket T.S. Eliot-dikt fra 1922 regnes som et hovedverk i modernismen?',
            options: [
              { id: 'a', text: 'The Love Song of J. Alfred Prufrock', isCorrect: false },
              { id: 'b', text: 'Four Quartets', isCorrect: false },
              { id: 'c', text: 'The Waste Land', isCorrect: true },
              { id: 'd', text: 'Ash Wednesday', isCorrect: false },
            ],
            solution: '"The Waste Land" fra 1922 er et hovedverk i modernismen. Diktet er et kaos av stemmer, sitater pa flere sprak, mytiske referanser og samtidsbilder - et perfekt eksempel pa fragmentering.',
          },
          {
            id: 'norsk-vg3-2-1-n-quiz2-q2',
            task: 'Hvilken kunstretning brukte Picasso som parallell til modernistisk litteratur?',
            options: [
              { id: 'a', text: 'Impresjonisme', isCorrect: false },
              { id: 'b', text: 'Surrealisme', isCorrect: false },
              { id: 'c', text: 'Ekspresjonisme', isCorrect: false },
              { id: 'd', text: 'Kubisme', isCorrect: true },
            ],
            solution: 'Kubismen bryter opp motiver og viser dem fra flere vinkler samtidig, akkurat som modernistisk litteratur erstatter den lineaere fortellingen med fragmenter og skiftende perspektiver.',
          },
        ],
      },
    },
...
Marcel Proust brukte syv bind pa "Pa sporet av den tapte tid", der en smak av en madeleinekake utloser en flom av minner. Fortiden er ikke borte, viser Proust - den ligger lagret i kroppen, i sansene, klar til a vekkes til live.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 3',
        type: 'multiple-choice',
        task: 'Test deg selv pa bevissthetsstrom:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        solution: '',
        questions: [
          ...
          {
            id: 'norsk-vg3-2-1-n-quiz3-q1',
            task: 'Hvilken roman av James Joyce folger Leopold Bloom gjennom en dag i Dublin?',
            options: [
              { id: 'a', text: 'Dubliners', isCorrect: false },
              { id: 'b', text: 'A Portrait of the Artist as a Young Man', isCorrect: false },
              { id: 'c', text: 'Finnegans Wake', isCorrect: false },
              { id: 'd', text: 'Ulysses', isCorrect: true },
            ],
            solution: '"Ulysses" (1922) folger Leopold Bloom gjennom en eneste dag i Dublin. Vi er inne i hodet hans og opplever verden som et kaos av tanker, inntrykk, minner og drifter - bevissthetsstrommen i praksis.',
          },
          {
            id: 'norsk-vg3-2-1-n-quiz3-q2',
            task: 'Hva utloser minneflommen i Marcel Prousts romanverk?',
            options: [
              { id: 'a', text: 'En gammel bok', isCorrect: false },
              { id: 'b', text: 'Smaken av en madeleinekake', isCorrect: true },
              { id: 'c', text: 'Et maleri av barndommen', isCorrect: false },
              { id: 'd', text: 'En melodi fra fortiden', isCorrect: false },
            ],
            solution: 'I "Pa sporet av den tapte tid" utloser smaken av en madeleinekake en flom av minner. Proust viste at fortiden lever i kroppen og sansene, klar til a vekkes til live.',
          },
        ],
      },
    },
...
Marcel Proust i Frankrike brukte et helt liv pa a utforske minnet og tiden. Hans romanverk viser at fortiden ikke er borte - den lever i oss, klar til a vekkes av en smak, en lukt, en melodi.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 4',
        type: 'multiple-choice',
        task: 'Test deg selv pa modernismens mestere:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        solution: '',
        questions: [
          ...
          {
            id: 'norsk-vg3-2-1-n-quiz4-q1',
            task: 'Hvilken forfatter skrev om det absurde, der Josef K. arresteres uten a fa vite anklagen?',
            options: [
              { id: 'a', text: 'Marcel Proust', isCorrect: false },
              { id: 'b', text: 'Franz Kafka', isCorrect: true },
              { id: 'c', text: 'Virginia Woolf', isCorrect: false },
              { id: 'd', text: 'T.S. Eliot', isCorrect: false },
            ],
            solution: 'Franz Kafka i Praha skrev om det absurde. I "Prosessen" arresteres Josef K. uten a fa vite hva han er anklaget for. Kafkas verden er marerittaktig, men ogsa merkelig gjenkjennelig.',
          },
          {
            id: 'norsk-vg3-2-1-n-quiz4-q2',
            task: 'Hva er spesielt med Virginia Woolfs tidsbruk i "To the Lighthouse"?',
            options: [
              { id: 'a', text: 'Boken folger kronologien noye', isCorrect: false },
              { id: 'b', text: 'Hele boken skjer pa ett minutt', isCorrect: false },
              { id: 'c', text: 'Ti ar dekkes pa noen fa sider, mens en dag kan strekke seg over hundrevis', isCorrect: true },
              { id: 'd', text: 'Boken er skrevet baklengs i tid', isCorrect: false },
            ],
            solution: 'Woolf bryter radikalt med kronologien. Midtdelen av "To the Lighthouse" dekker ti ar pa bare noen fa sider, mens en enkelt dag kan strekke seg over hundrevis av sider. Tiden oppleves subjektivt.',
          },
        ],
      },
    },
...
Modernismen forandret var forstaelse av hva litteratur kan vaere. Den viste at formen ikke er noytral - hvordan du forteller, er en del av hva du forteller. Og den insisterte pa at litteraturen ma vaere sant mot sin tid, selv nar den tiden er fragmentert og forvirrende.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 5',
        type: 'multiple-choice',
        task: 'Test deg selv pa modernismen i Norge:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        solution: '',
        questions: [
          ...
          {
            id: 'norsk-vg3-2-1-n-quiz5-q1',
            task: 'Hvilken norsk roman fra 1890 peker fremover mot bevissthetsstrommen?',
            options: [
              { id: 'a', text: 'Markens grode', isCorrect: false },
              { id: 'b', text: 'Victoria', isCorrect: false },
              { id: 'c', text: 'Pan', isCorrect: false },
              { id: 'd', text: 'Sult', isCorrect: true },
            ],
            solution: 'Knut Hamsuns "Sult" fra 1890 skildrer en sulten manns kaotiske bevissthet og peker fremover mot bevissthetsstrommen. Romanen regnes som en tidlig modernistisk tekst.',
          },
          {
            id: 'norsk-vg3-2-1-n-quiz5-q2',
            task: 'Hvilken norsk forfatter bragte modernismen til norsk prosa med verk som "Fuglane" og "Is-slottet"?',
            options: [
              { id: 'a', text: 'Rolf Jacobsen', isCorrect: false },
              { id: 'b', text: 'Tarjei Vesaas', isCorrect: true },
              { id: 'c', text: 'Olav H. Hauge', isCorrect: false },
              { id: 'd', text: 'Sigbjorn Obstfelder', isCorrect: false },
            ],
            solution: 'Tarjei Vesaas bragte modernismen til norsk prosa. Hans romaner kombinerer poetisk prosa med eksistensiell tematikk, og spraket er enkelt pa overflaten men ladet med symbolikk.',
          },
        ],
      },
    },
...
Duun ble nominert til Nobelprisen i litteratur flere ganger, men fikk den aldri. Han dode i 1939, like for krigen som skulle ryste verden. Men verkene hans lever videre.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 1',
        type: 'multiple-choice',
        task: 'Test deg selv pa Olav Duun og Juvikfolke:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        solution: '',
        questions: [
          ...
          {
            id: 'norsk-vg3-2-2-n-quiz1-q1',
            task: 'Hvor vokste Olav Duun opp?',
            options: [
              { id: 'a', text: 'Pa Joa i Namdalen', isCorrect: true },
              { id: 'b', text: 'I Kristiania', isCorrect: false },
              { id: 'c', text: 'I Bergen', isCorrect: false },
              { id: 'd', text: 'I Tromso', isCorrect: false },
            ],
            solution: 'Olav Duun ble fodt pa Joa i Namdalen i 1876. Han vokste opp i et bondemiljo preget av harde livsvilkar og sterke tradisjoner. Dette landskapet og disse menneskene fylte hans boker.',
          },
          {
            id: 'norsk-vg3-2-2-n-quiz1-q2',
            task: 'Hvilket yrke hadde Duun ved siden av forfatterskapet?',
            options: [
              { id: 'a', text: 'Prest', isCorrect: false },
              { id: 'b', text: 'Fisker', isCorrect: false },
              { id: 'c', text: 'Laerer', isCorrect: true },
              { id: 'd', text: 'Bonde', isCorrect: false },
            ],
            solution: 'Duun arbeidet som laerer, et yrke som ga ham tid til a skrive og naerhet til vanlige mennesker. Han arbeidet forst i Namdalen, senere i Holmestrand.',
          },
        ],
      },
    },
...
Gjennom de seks bindene folger vi denne kampen - ikke bare i Per Anders, men i hele slekten. Det er en kosmisk kamp, speilet i naturen og aarstidene, i stormer og stille dager. Men det er ogsa en intimt menneskelig kamp, utspilt i daglige valg og hverdagens prover.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 2',
        type: 'multiple-choice',
        task: 'Test deg selv pa Juvikfolkes tematikk:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        solution: '',
        questions: [
          ...
          {
            id: 'norsk-vg3-2-2-n-quiz2-q1',
            task: 'Hvem er den sentrale skikkelsen i Juvikfolke?',
            options: [
              { id: 'a', text: 'Olav Duun', isCorrect: false },
              { id: 'b', text: 'Jakob', isCorrect: false },
              { id: 'c', text: 'Per Anders', isCorrect: true },
              { id: 'd', text: 'Lavrans', isCorrect: false },
            ],
            solution: 'Per Anders er den sentrale skikkelsen. Han baerer pa slektens morke arv, kjenner voldsomheten i seg selv, men velger a kjempe imot og velge det gode.',
          },
        ],
      },
    },
...
Samtidig er Duun ingen naiv optimist. Kampen er hard, og seieren er aldri sikker. Det onde er virkelig, og det kan vinne. Men det gode er ogsa virkelig - og det er verdt a kjempe for.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 3',
        type: 'multiple-choice',
        task: 'Test deg selv pa arv og valg hos Duun:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        solution: '',
        questions: [
          ...
          {
            id: 'norsk-vg3-2-2-n-quiz3-q1',
            task: 'Hvilken naturalistisk slektsskildring kan sammenlignes med "Juvikfolke"?',
            options: [
              { id: 'a', text: 'Kristin Lavransdatter', isCorrect: false },
              { id: 'b', text: 'Sult', isCorrect: false },
              { id: 'c', text: 'Hellemyrsfolket', isCorrect: true },
              { id: 'd', text: 'Albertetrilogien', isCorrect: false },
            ],
            solution: 'Amalie Skrams "Hellemyrsfolket" er den naturalistiske slektsskildringen som kan sammenlignes med "Juvikfolke". Hos Skram er mennesket mer determinert av arv og miljo, mens Duun gir rom for valg.',
          },
          {
            id: 'norsk-vg3-2-2-n-quiz3-q2',
            task: 'Hva gjor Duuns verk til noe mer enn en naturalistisk slektsskildring?',
            options: [
              { id: 'a', text: 'Den er lengre enn andre slektsskildringer', isCorrect: false },
              { id: 'b', text: 'Den er skrevet pa nynorsk', isCorrect: false },
              { id: 'c', text: 'Den foregår i Nord-Norge', isCorrect: false },
              { id: 'd', text: 'Den insisterer pa menneskets verdighet og moralske ansvar', isCorrect: true },
            ],
            solution: 'Duuns verk er dypt humanistisk fordi det insisterer pa menneskets verdighet og ansvar. Vi er ikke bare produkter av arv og miljo - vi er moralske vesener som star overfor valg.',
          },
        ],
      },
    },
...
Denne stilen krever noe av leseren. Duun forklarer ikke, han viser. Han stoler pa at leseren forstaar - at vi kjenner igjen sannheten i det han skildrer fordi vi har kjent den i oss selv.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 4',
        type: 'multiple-choice',
        task: 'Test deg selv pa Duuns sprak og stil:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        solution: '',
        questions: [
          ...
          {
            id: 'norsk-vg3-2-2-n-quiz4-q1',
            task: 'Hvilken rolle spiller naturen i Duuns verk?',
            options: [
              { id: 'a', text: 'Den er bare en bakgrunn for handlingen', isCorrect: false },
              { id: 'b', text: 'Den brukes som en aktiv kraft og speiling av menneskets indre liv', isCorrect: true },
              { id: 'c', text: 'Den beskrives aldri', isCorrect: false },
              { id: 'd', text: 'Den representerer det moderne samfunnet', isCorrect: false },
            ],
            solution: 'Naturen er aldri bare kulisse hos Duun. Den er en aktiv kraft og en speiling av menneskets indre liv. Nar stormen raser, raser det ogsa i menneskesinnet.',
          },
        ],
      },
    },
...
Nar du leser Duun, blir du konfrontert med grunnleggende sporsmal om menneskelivet. Hva er arvet, og hva er valgt? Finnes det noe ondt i oss alle? Og kan vi overvinne det? Duuns svar er verken lettvint optimistisk eller motlos pessimistisk - det er dypt menneskelig.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 5',
        type: 'multiple-choice',
        task: 'Test deg selv pa Duuns betydning:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        solution: '',
        questions: [
          ...
          {
            id: 'norsk-vg3-2-2-n-quiz5-q1',
            task: 'Nar dode Olav Duun?',
            options: [
              { id: 'a', text: '1929', isCorrect: false },
              { id: 'b', text: '1945', isCorrect: false },
              { id: 'c', text: '1939', isCorrect: true },
              { id: 'd', text: '1952', isCorrect: false },
            ],
            solution: 'Olav Duun dode i 1939, like for krigen som skulle ryste verden. Men verkene hans lever videre som noe av det storste i norsk romankunst.',
          },
        ],
      },
    },
...
Konverteringen var et vendepunkt. Den katolske troen ble sentral i hennes liv og forfatterskap. Temaer som synd, anger og tilgivelse - som allerede var tilstede i "Kristin Lavransdatter" - fikk enda storre tyngde.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 1',
        type: 'multiple-choice',
        task: 'Test deg selv pa Sigrid Undset:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        solution: '',
        questions: [
          ...
          {
            id: 'norsk-vg3-2-3-n-quiz1-q1',
            task: 'Hva arbeidet Undset som i ti ar for hun ble forfatter?',
            options: [
              { id: 'a', text: 'Laerer', isCorrect: false },
              { id: 'b', text: 'Kontordame', isCorrect: true },
              { id: 'c', text: 'Sykepleier', isCorrect: false },
              { id: 'd', text: 'Journalist', isCorrect: false },
            ],
            solution: 'Undset arbeidet som kontordame pa et kontor i Kristiania i ti ar. Disse arene ga henne innsikt i vanlige kvinners liv og kamp som hun senere brukte i forfatterskapet.',
          },
          {
            id: 'norsk-vg3-2-3-n-quiz1-q2',
            task: 'Hvilken religion konverterte Undset til i 1924?',
            options: [
              { id: 'a', text: 'Protestantisme', isCorrect: false },
              { id: 'b', text: 'Jødedom', isCorrect: false },
              { id: 'c', text: 'Islam', isCorrect: false },
              { id: 'd', text: 'Katolisisme', isCorrect: true },
            ],
            solution: 'Undset konverterte til katolisismen i 1924. Den katolske troen ble sentral i hennes liv og forfatterskap, og temaer som synd, anger og tilgivelse fikk enda storre tyngde.',
          },
        ],
      },
    },
...
"Korset" (1922) folger Kristin inn i alderdommen. Etter Erlends dod trekker hun seg tilbake. Gradvis forsones hun med fortiden og med Gud. Trilogien ender med at hun dor mens hun pleier pestsyke i et kloster - en soning og forsoning som fullforer hennes ǎndelige reise.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 2',
        type: 'multiple-choice',
        task: 'Test deg selv pa Kristin Lavransdatter-trilogien:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        solution: '',
        questions: [
          ...
          {
            id: 'norsk-vg3-2-3-n-quiz2-q1',
            task: 'Hvem forelsker Kristin seg i mot farens onske?',
            options: [
              { id: 'a', text: 'Lavrans', isCorrect: false },
              { id: 'b', text: 'Simon Darre', isCorrect: false },
              { id: 'c', text: 'Erlend Nikulausson', isCorrect: true },
              { id: 'd', text: 'Olav Audunsson', isCorrect: false },
            ],
            solution: 'Kristin forelsker seg i Erlend Nikulausson - en vakker, karismatisk mann med darlig rykte. Hun bryter forlovelsen med en annen mann for a vaere med Erlend, et valg som former resten av hennes liv.',
          },
          {
            id: 'norsk-vg3-2-3-n-quiz2-q2',
            task: 'Hvordan ender trilogien?',
            options: [
              { id: 'a', text: 'Kristin gifter seg pa nytt', isCorrect: false },
              { id: 'b', text: 'Kristin reiser tilbake til Jorundgaard', isCorrect: false },
              { id: 'c', text: 'Kristin dor mens hun pleier pestsyke i et kloster', isCorrect: true },
              { id: 'd', text: 'Kristin og Erlend forsones', isCorrect: false },
            ],
            solution: 'Trilogien ender med at Kristin dor mens hun pleier pestsyke i et kloster. Dette er en soning og forsoning som fullforer hennes åndelige reise gjennom livet.',
          },
        ],
      },
    },
...
Slik viser Undset at mennesket i bunn og grunn er det samme, uavhengig av tid og sted. De ytre omstendighetene forandrer seg, men de grunnleggende folelsene - kjaerlighet, frykt, hap, anger - er tidløse.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 3',
        type: 'multiple-choice',
        task: 'Test deg selv pa Undsets middelalderframstilling:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        solution: '',
        questions: [
          ...
          {
            id: 'norsk-vg3-2-3-n-quiz3-q1',
            task: 'Hvordan fremstiller Undset Kristin som middelaldermenneske?',
            options: [
              { id: 'a', text: 'Som en moderne kvinne i historisk kostyme', isCorrect: false },
              { id: 'b', text: 'Som en eksotisk og uforstaelig fremmed', isCorrect: false },
              { id: 'c', text: 'Som et menneske med gjenkjennelige folelser i sin tids rammer', isCorrect: true },
              { id: 'd', text: 'Som et historisk symbol uten personlighet', isCorrect: false },
            ],
            solution: 'Undset tar middelaldermennesket pa alvor. Kristin er verken moderne i kostyme eller eksotisk fremmed. Hennes indre liv er gjenkjennelig fordi det er menneskelig, men hun lever i middelalderens rammer.',
          },
        ],
      },
    },
...
Selve titlene er symbolske. "Kransen" er brudekransen Kristin baerer selv om hun ikke er uskyldig. "Husfrue" er rollen hun må vokse inn i. "Korset" er både det kristne symbolet og byrden hun baerer gjennom livet - men ogsa veien til frelse.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 4',
        type: 'multiple-choice',
        task: 'Test deg selv pa temaer og symbolikk:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        solution: '',
        questions: [
          ...
          {
            id: 'norsk-vg3-2-3-n-quiz4-q1',
            task: 'Hva symboliserer tittelen "Kransen"?',
            options: [
              { id: 'a', text: 'En blomsterkrans pa graven', isCorrect: false },
              { id: 'b', text: 'Brudekransen Kristin baerer selv om hun ikke er uskyldig', isCorrect: true },
              { id: 'c', text: 'En krans til kongen', isCorrect: false },
              { id: 'd', text: 'Tornekransen til Jesus', isCorrect: false },
            ],
            solution: '"Kransen" viser til brudekransen som symboliserte jomfruelighet. Kristin baerer den selv om hun har gitt seg hen til Erlend for bryllupet, noe som gir henne skyldfølelse.',
          },
          {
            id: 'norsk-vg3-2-3-n-quiz4-q2',
            task: 'Hvilke sentrale temaer gjennomsyrer hele trilogien?',
            options: [
              { id: 'a', text: 'Politikk og makt', isCorrect: false },
              { id: 'b', text: 'Reiser og eventyr', isCorrect: false },
              { id: 'c', text: 'Synd, anger og tilgivelse', isCorrect: true },
              { id: 'd', text: 'Krig og fred', isCorrect: false },
            ],
            solution: 'Synd, anger og tilgivelse gjennomsyrer hele trilogien. Kristins åndelige reise gar fra ungdommens fall gjennom livets prover til alderdommens forsoning med Gud og seg selv.',
          },
        ],
      },
    },
...
For alle som lurer pa hvordan det var a vaere kvinne for 700 ar siden - og for alle som vil forstå noe dypt sant om menneskelivet - er "Kristin Lavransdatter" en uunnvaerlig bok.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 5',
        type: 'multiple-choice',
        task: 'Test deg selv pa arven etter Undset:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        solution: '',
        questions: [
          ...
          {
            id: 'norsk-vg3-2-3-n-quiz5-q1',
            task: 'Hva skjedde med Undset under andre verdenskrig?',
            options: [
              { id: 'a', text: 'Hun ble vaerende i Norge', isCorrect: false },
              { id: 'b', text: 'Hun flyktet til USA', isCorrect: true },
              { id: 'c', text: 'Hun flyktet til England', isCorrect: false },
              { id: 'd', text: 'Hun ble arrestert', isCorrect: false },
            ],
            solution: 'Undset matte flykte under krigen. Sonnen Anders falt i kamp, og hun selv var pa nazistenes liste. Via Sverige og Sovjet reiste hun til USA, der hun virket for Norges sak.',
          },
        ],
      },
    },
...
Samme ar ble hun skilt. Resten av livet levde hun av a skrive, bosatt i Sverige. Hun dode i 1974, 93 år gammel.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 1',
        type: 'multiple-choice',
        task: 'Test deg selv pa Cora Sandels bakgrunn:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        solution: '',
        questions: [
          ...
          {
            id: 'norsk-vg3-2-4-n-quiz1-q1',
            task: 'Hvor i Norge bodde familien fra Sandel var tolv ar?',
            options: [
              { id: 'a', text: 'Bergen', isCorrect: false },
              { id: 'b', text: 'Kristiania', isCorrect: false },
              { id: 'c', text: 'Tromso', isCorrect: true },
              { id: 'd', text: 'Trondheim', isCorrect: false },
            ],
            solution: 'Familien flyttet til Tromso da Sara var tolv ar. Arene i Nord-Norge preget henne dypt og ble stoff for det forste bindet i Alberte-trilogien.',
          },
          {
            id: 'norsk-vg3-2-4-n-quiz1-q2',
            task: 'Hvor dro Sandel for a studere kunst?',
            options: [
            ...
            solution: 'I 1906 dro hun til Paris for a studere kunst. Der levde hun et fattig bohemliv, men opplevde ogsa frihet fra den norske smaborgerligheten.',
          },
        ],
      },
    },
...
I "Bare Alberte" (1939) ser vi henne som voksen kvinne. Hun har et barn, et vanskelig ekteskap, økonomiske bekymringer. Men hun har ogsa noe annet: en stemme. Hun har begynt a skrive for alvor, a forvandle sine erfaringer til kunst.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 2',
        type: 'multiple-choice',
        task: 'Test deg selv pa Alberte-trilogien:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        solution: '',
        questions: [
          ...
          {
            id: 'norsk-vg3-2-4-n-quiz2-q1',
            task: 'Hva heter de tre bindene i Alberte-trilogien?',
            options: [
              { id: 'a', text: 'Alberte og friheten, Alberte i Paris, Bare Alberte', isCorrect: false },
              { id: 'b', text: 'Alberte og Jakob, Alberte og friheten, Bare Alberte', isCorrect: true },
              { id: 'c', text: 'Alberte og kulden, Alberte i Paris, Alberte alene', isCorrect: false },
              { id: 'd', text: 'Unge Alberte, Alberte i verden, Alberte hjemme', isCorrect: false },
            ],
            solution: 'Trilogien bestar av "Alberte og Jakob" (1926), "Alberte og friheten" (1931) og "Bare Alberte" (1939). Bindene folger Alberte fra nordnorsk by via Paris til modning som forfatter.',
          },
          {
            id: 'norsk-vg3-2-4-n-quiz2-q2',
            task: 'Hva begynner Alberte langsomt med i Paris?',
            options: [
              { id: 'a', text: 'A male', isCorrect: false },
              { id: 'b', text: 'A studere medisin', isCorrect: false },
              { id: 'c', text: 'A skrive', isCorrect: true },
              { id: 'd', text: 'A undervise', isCorrect: false },
            ],
            solution: 'I Paris prover Alberte forst a male, men det blir ikke noe av. Langsomt begynner hun a skrive - en forvandling som speiler Sandels eget liv.',
          },
        ],
      },
    },
...
Sandel viser hvordan samfunnets kontroll over kvinner ofte virker gjennom kroppen. Ved a fa kvinner til a skamme seg over sine kropper, holder man dem fanget. Albertes reise er ogsa en reise mot a akseptere og eie sin egen kropp.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 3',
        type: 'multiple-choice',
        task: 'Test deg selv pa kropp og symbolikk hos Sandel:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        solution: '',
        questions: [
          ...
          {
            id: 'norsk-vg3-2-4-n-quiz3-q1',
            task: 'Hvordan viser Sandel at samfunnet kontrollerer kvinner?',
            options: [
              { id: 'a', text: 'Gjennom direkte politisk undertrykkelse', isCorrect: false },
              { id: 'b', text: 'Gjennom okonomisk makt alene', isCorrect: false },
              { id: 'c', text: 'Gjennom a fa kvinner til a skamme seg over sine kropper', isCorrect: true },
              { id: 'd', text: 'Gjennom utdanningssystemet', isCorrect: false },
            ],
            solution: 'Sandel viser at samfunnets kontroll over kvinner ofte virker gjennom kroppen. Ved a la kvinner skamme seg over sine kropper, holdes de fanget. Albertes reise er ogsa en reise mot a eie sin egen kropp.',
          },
        ],
      },
    },
...
Denne stilen ble lenge undervurdert. Noen syntes den var for "liten", for uambisiøs. Men i dag forstår vi at dette er en egen type storhet - kunsten a si mye med fa ord, a avsløre verden gjennom skarpt observerte detaljer.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 4',
        type: 'multiple-choice',
        task: 'Test deg selv pa Sandels stil:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        solution: '',
        questions: [
          ...
          {
            id: 'norsk-vg3-2-4-n-quiz4-q1',
            task: 'Hva menes med undertekst i Sandels forfatterskap?',
            options: [
              { id: 'a', text: 'Tekst som star under bildene', isCorrect: false },
              { id: 'b', text: 'Fotnoter i boken', isCorrect: false },
              { id: 'c', text: 'At det viktigste ikke sies direkte, men ligger mellom linjene', isCorrect: true },
              { id: 'd', text: 'At teksten er oversatt fra et annet sprak', isCorrect: false },
            ],
            solution: 'Undertekst betyr at det viktigste ofte ikke sies direkte. Et blikk, en pause, en liten gest - leseren ma tolke selv. Sandel stoler pa at leseren forstår det usagte.',
          },
        ],
      },
    },
...
Sandel viste at det "lille" livet - hverdagens kamper, de usynlige undertrykkelsene - er like viktig å skildre som de store historiske hendelsene. Hun ga stemme til dem som ofte ble oversett.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 5',
        type: 'multiple-choice',
        task: 'Test deg selv pa Sandels gjenoppdagelse og betydning:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        solution: '',
        questions: [
          ...
          {
            id: 'norsk-vg3-2-4-n-quiz5-q1',
            task: 'Hva bidro til at Sandel fikk en ny status i de siste tiarene?',
            options: [
              { id: 'a', text: 'Nye funn av ukjente manuskripter', isCorrect: false },
              { id: 'b', text: 'En filmadapsjon av Alberte-trilogien', isCorrect: false },
              { id: 'c', text: 'Feministisk litteraturkritikk gjenoppdaget henne', isCorrect: true },
              { id: 'd', text: 'Hun mottok Nobelprisen posthumt', isCorrect: false },
            ],
            solution: 'Feministisk litteraturkritikk gjenoppdaget Sandel og viste hvor radikalt hun egentlig skrev. Stilanalyser avslørte dybden i det tilsynelatende enkle, og i dag regnes trilogien som et hovedverk.',
          },
        ],
      },
    },
...
I denne situasjonen ble det stadig vanskeligere a vaere noytral. Enten var du for eller mot. Mellomposisjoner ble sett som feighet eller selvbedrag.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 1',
        type: 'multiple-choice',
        task: 'Test deg selv pa mellomkrigstidens kriser:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        solution: '',
        questions: [
          ...
          {
            id: 'norsk-vg3-2-5-n-quiz1-q1',
            task: 'Hvilken hendelse i 1917 inspirerte mange intellektuelle pa venstresiden?',
            options: [
              { id: 'a', text: 'USAs inntreden i forste verdenskrig', isCorrect: false },
              { id: 'b', text: 'Den russiske revolusjonen', isCorrect: true },
              { id: 'c', text: 'Folkeforbundets stiftelse', isCorrect: false },
              { id: 'd', text: 'Versailles-traktaten', isCorrect: false },
            ],
            solution: 'Den russiske revolusjonen i 1917 viste at sosialismen kunne seire. For mange intellektuelle virket kommunismen som hapet - en vei ut av kapitalismens kriser og krigens galskap.',
          },
          {
            id: 'norsk-vg3-2-5-n-quiz1-q2',
            task: 'Nar tok fascismen makten i Italia?',
            options: [
              { id: 'a', text: '1918', isCorrect: false },
              { id: 'b', text: '1922', isCorrect: true },
              { id: 'c', text: '1929', isCorrect: false },
              { id: 'd', text: '1933', isCorrect: false },
            ],
            solution: 'Fascismen tok makten i Italia i 1922 med Mussolini. Nazismen i Tyskland fulgte i 1933. Disse hoyreardiakle bevegelsene lovte orden og gjenreising av tapt storhet.',
          },
        ],
      },
    },
...
Eksillitteraturen oppsto da forfattere flyktet fra nazismen. Thomas Mann, Bertolt Brecht og mange andre fortsatte a skrive fra utlandet, ofte med sterkere politisk brodd enn for.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 2',
        type: 'multiple-choice',
        task: 'Test deg selv pa politisk litteratur:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        solution: '',
        questions: [
          ...
          {
            id: 'norsk-vg3-2-5-n-quiz2-q1',
            task: 'Hva var sosialistisk realisme?',
            options: [
              { id: 'a', text: 'En skandinavisk litteraer retning', isCorrect: false },
              { id: 'b', text: 'Den offisielle kunsten i Sovjetunionen der litteraturen skulle tjene revolusjonen', isCorrect: true },
              { id: 'c', text: 'En britisk poesibevegelse', isCorrect: false },
              { id: 'd', text: 'Et annet ord for naturalisme', isCorrect: false },
            ],
            solution: 'Sosialistisk realisme var den offisielle kunsten i Sovjetunionen. Her skulle litteraturen tjene revolusjonen, vise arbeidernes heltemot og inspirere til kamp. Resultatet ble ofte mer propaganda enn kunst.',
          },
          {
            id: 'norsk-vg3-2-5-n-quiz2-q2',
            task: 'Hvilken norsk dikter skrev "Revolusjonens rosta"?',
            options: [
              { id: 'a', text: 'Arnulf Overland', isCorrect: false },
              { id: 'b', text: 'Nordahl Grieg', isCorrect: false },
              { id: 'c', text: 'Rudolf Nilsen', isCorrect: true },
              { id: 'd', text: 'Rolf Jacobsen', isCorrect: false },
            ],
            solution: 'Rudolf Nilsen var en sentral stemme i norsk arbeiderlitteratur. Han skrev dikt som "Revolusjonens rosta" og var en av flere forfattere som engasjerte seg politisk pa 1920- og 1930-tallet.',
          },
        ],
      },
    },
...
Spaniakrigen (1936-39) ble et samlingspunkt. Da fascistene forsøkte a styrte den spanske republikken, dro frivillige fra hele Europa for a kjempe. Norske forfattere som Nordahl Grieg dekket krigen og skrev om den.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 3',
        type: 'multiple-choice',
        task: 'Test deg selv pa Norge i mellomkrigstiden:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        solution: '',
        questions: [
          ...
          {
            id: 'norsk-vg3-2-5-n-quiz3-q1',
            task: 'Hvilken norsk forfatter beveget seg i retning av nazismen?',
            options: [
              { id: 'a', text: 'Nordahl Grieg', isCorrect: false },
              { id: 'b', text: 'Arnulf Overland', isCorrect: false },
              { id: 'c', text: 'Knut Hamsun', isCorrect: true },
              { id: 'd', text: 'Rudolf Nilsen', isCorrect: false },
            ],
            solution: 'Knut Hamsun beveget seg mot nazismen. Hans beundring for det "sterke" lederskapet og forakt for parlamentarismen forte ham i armene pa nazismen - en av de store tragediene i norsk litteraturhistorie.',
          },
          {
            id: 'norsk-vg3-2-5-n-quiz3-q2',
            task: 'Hvilken krig ble et samlingspunkt for antifascistiske forfattere pa 1930-tallet?',
            options: [
              { id: 'a', text: 'Forste verdenskrig', isCorrect: false },
              { id: 'b', text: 'Vinterkrigen', isCorrect: false },
              { id: 'c', text: 'Krigen i Etiopia', isCorrect: false },
              { id: 'd', text: 'Spaniakrigen', isCorrect: true },
            ],
            solution: 'Spaniakrigen (1936-39) ble et samlingspunkt for antifascistiske forfattere. Frivillige fra hele Europa dro for a kjempe, og norske forfattere som Nordahl Grieg dekket krigen.',
          },
        ],
      },
    },
...
Mellomkrigstidens erfaring viser bade farene og mulighetene. Noe av den politiske litteraturen fra perioden er glemt i dag - for propagandistisk, for endimensjonal. Annet lever fortsatt, fordi det kombinerte politisk engasjement med kunstnerisk kvalitet.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 4',
        type: 'multiple-choice',
        task: 'Test deg selv pa tendenskunst:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        solution: '',
        questions: [
          ...
          {
            id: 'norsk-vg3-2-5-n-quiz4-q1',
            task: 'Hva argumenterte forsvarerne av tendenskunsten med?',
            options: [
              { id: 'a', text: 'At politisk kunst alltid er bedre enn annen kunst', isCorrect: false },
              { id: 'b', text: 'At all kunst er politisk, og a late som noe annet tjener status quo', isCorrect: true },
              { id: 'c', text: 'At bare politisk kunst fortjener stotte', isCorrect: false },
              { id: 'd', text: 'At kunstnere bor bestemme politikken', isCorrect: false },
            ],
            solution: 'Forsvarerne argumenterte med at all kunst er politisk, enten den vil det eller ikke. A late som kunsten star over politikken er i seg selv en politisk posisjon som tjener status quo.',
          },
        ],
      },
    },
...
Mellomkrigstidens beste litteratur gjor nettopp dette. Den viser oss mennesker - i all deres kompleksitet - fanget i historiens krefter. Slik blir den bade sant og engasjerende, bade kunst og politikk.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 5',
        type: 'multiple-choice',
        task: 'Test deg selv pa arven fra mellomkrigstiden:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        solution: '',
        questions: [
          ...
          {
            id: 'norsk-vg3-2-5-n-quiz5-q1',
            task: 'Hvilken tysk dramatiker viste at politisk engasjement og kunstnerisk nyskapning kunne kombineres?',
            options: [
              { id: 'a', text: 'Thomas Mann', isCorrect: false },
              { id: 'b', text: 'Hermann Hesse', isCorrect: false },
              { id: 'c', text: 'Bertolt Brecht', isCorrect: true },
              { id: 'd', text: 'Franz Kafka', isCorrect: false },
            ],
            solution: 'Bertolt Brecht i Tyskland skapte teaterstykker som bade var politiske og nyskapende. Han viste at det er mulig a kombinere politisk engasjement med kunstnerisk kvalitet.',
          },
        ],
      },
    },
...
Han så klart hva andre ikke ville se. Mens mange fortsatt håpet pa fred, forsto Overland at Hitler ikke kunne stanses med ord. Og han forsto at likegyldigheten - "stakkars dem, men det angår ikke meg" - var nazismens beste allierte.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 1',
        type: 'multiple-choice',
        task: 'Test deg selv pa Arnulf Overland:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        solution: '',
        questions: [
          ...
          {
            id: 'norsk-vg3-2-6-n-quiz1-q1',
            task: 'Hva holdt Overland et berømt foredrag om i 1933?',
            options: [
              { id: 'a', text: 'Modernismen i norsk litteratur', isCorrect: false },
              { id: 'b', text: 'Kristendommen - den tiende landeplage', isCorrect: true },
              { id: 'c', text: 'Arbeiderklassens kamp', isCorrect: false },
              { id: 'd', text: 'Nazismens farer', isCorrect: false },
            ],
            solution: 'Overland holdt det kontroversielle foredraget "Kristendommen - den tiende landeplage" i 1933. Han var ateist og sosialist, noe som provoserte mange, men han samlet seg snart om kampen mot nazismen.',
          },
          {
            id: 'norsk-vg3-2-6-n-quiz1-q2',
            task: 'Hva preget Overlands tidlige diktning for 1930-tallet?',
            options: [
              { id: 'a', text: 'Politisk agitasjon', isCorrect: false },
              { id: 'b', text: 'Naturskildringer', isCorrect: false },
              { id: 'c', text: 'Kjaerlighet og melankoli', isCorrect: true },
              { id: 'd', text: 'Humoristiske vers', isCorrect: false },
            ],
            solution: 'Overlands tidlige diktning var preget av kjaerlighet og melankoli, av det personlige livets drama. Men 1930-tallet forandret ham - diktet matte bli et vapen mot nazismen.',
          },
        ],
      },
    },
...
Diktet er formet med alle den tradisjonelle lyrikkens virkemidler - rim, rytme, gjentakelse - men brukt til a slynge ut en politisk advarsel. Det er bade kunst og appell.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 2',
        type: 'multiple-choice',
        task: 'Test deg selv pa "Du ma ikke sove":',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        solution: '',
        questions: [
          ...
          {
            id: 'norsk-vg3-2-6-n-quiz2-q1',
            task: 'Hvilken berømt linje angriper likegyldigheten direkte?',
            options: [
              { id: 'a', text: 'Du ma ikke sove', isCorrect: false },
              { id: 'b', text: 'Du ma ikke ga til ditt arbeid i dag', isCorrect: false },
              { id: 'c', text: 'Du ma ikke tale sa inderlig vel / den urett som ikke rammer deg selv', isCorrect: true },
              { id: 'd', text: 'Det er sørgelig, stakkars dem', isCorrect: false },
            ],
            solution: '"Du ma ikke tale sa inderlig vel / den urett som ikke rammer deg selv" er diktets mest berømte linjer. De angriper den behagelige medfolelsen som ikke forer til handling.',
          },
          {
            id: 'norsk-vg3-2-6-n-quiz2-q2',
            task: 'Hva beskriver Overland i diktets første del?',
            options: [
              { id: 'a', text: 'Norsk natur og landskap', isCorrect: false },
              { id: 'b', text: 'Forfolgelsen av joder og grusomheter i Tyskland', isCorrect: true },
              { id: 'c', text: 'Hverdagslivet i Norge', isCorrect: false },
              { id: 'd', text: 'Drommene sine om fred', isCorrect: false },
            ],
            solution: 'Overland begynner med a beskrive det grusomme: jodene som forfølges, barn som skilles fra foreldre. Han tvinger leseren til a se det man helst vil snu seg bort fra.',
          },
        ],
      },
    },
...
Overland levde til 1968. Han fortsatte a skrive, fortsatte a mene, fortsatte a provosere. Men det er "Du ma ikke sove" som har gjort ham udødelig - en tekst som fortsatt siteres, fortsatt synges, fortsatt maner til aktsomhet.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 3',
        type: 'multiple-choice',
        task: 'Test deg selv pa Overlands krigserfaringer:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        solution: '',
        questions: [
          ...
          {
            id: 'norsk-vg3-2-6-n-quiz3-q1',
            task: 'Hvor satt Overland forst etter arrestasjonen i 1941?',
            options: [
              { id: 'a', text: 'Akershus festning', isCorrect: false },
              { id: 'b', text: 'Grini', isCorrect: true },
              { id: 'c', text: 'Bredtvet', isCorrect: false },
              { id: 'd', text: 'Falstad', isCorrect: false },
            ],
            solution: 'Overland satt forst pa Grini fangeleir utenfor Oslo, for han ble sendt videre til Sachsenhausen i Tyskland. Han tilbragte totalt fire ar i fangenskap.',
          },
        ],
      },
    },
...
Overland viste at politisk poesi ikke trenger a ofre det kunstneriske. Tvert imot: Ved a bruke diktets fulle arsenal av virkemidler, blir budskapet sterkere. Formen baerer innholdet.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 4',
        type: 'multiple-choice',
        task: 'Test deg selv pa Overlands diktstil:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        solution: '',
        questions: [
          ...
          {
            id: 'norsk-vg3-2-6-n-quiz4-q1',
            task: 'Hvilket sentralt virkemiddel bruker Overland i "Du ma ikke sove"?',
            options: [
              { id: 'a', text: 'Metaforer fra naturen', isCorrect: false },
              { id: 'b', text: 'Ironi og sarkasme', isCorrect: false },
              { id: 'c', text: 'Gjentakelse som et hamrende refreng', isCorrect: true },
              { id: 'd', text: 'Lange beskrivende avsnitt', isCorrect: false },
            ],
            solution: 'Gjentakelsen er et sentralt virkemiddel. "Du ma ikke" gjentas igjen og igjen som et mantra, en befaling som ikke lar seg ignorere. Det hamrer budskapet inn hos leseren.',
          },
        ],
      },
    },
...
Arnulf Overland ga oss et dikt som er mer enn litteratur. Det er en etisk pafinnelse, et krav om a være til stede i sin egen tid, om a se det man helst ikke vil se. "Du ma ikke sove" - fire ord som rommer et helt moralsk univers.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 5',
        type: 'multiple-choice',
        task: 'Test deg selv pa Overlands aktualitet:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        solution: '',
        questions: [
          ...
          {
            id: 'norsk-vg3-2-6-n-quiz5-q1',
            task: 'Nar dode Arnulf Overland?',
            options: [
              { id: 'a', text: '1945', isCorrect: false },
              { id: 'b', text: '1955', isCorrect: false },
              { id: 'c', text: '1968', isCorrect: true },
              { id: 'd', text: '1974', isCorrect: false },
            ],
            solution: 'Overland levde til 1968. Han fortsatte a skrive, mene og provosere gjennom hele etterkrigstiden, men det er "Du ma ikke sove" som har gjort ham udødelig.',
          },
        ],
      },
    },
...
Denne idealismen drev ham inn i politikken. Han ble kommunist, eller i alle fall kommunistsympatisør. Han trodde at Sovjet representerte fremtiden - en tro han delte med mange intellektuelle i sin tid, og som senere skulle vise seg naiv.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 1',
        type: 'multiple-choice',
        task: 'Test deg selv pa den unge Nordahl Grieg:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        solution: '',
        questions: [
          ...
          {
            id: 'norsk-vg3-2-7-n-quiz1-q1',
            task: 'Hvor gammel var Grieg da han debuterte som lyriker?',
            options: [
              { id: 'a', text: '16 ar', isCorrect: false },
              { id: 'b', text: '20 ar', isCorrect: true },
              { id: 'c', text: '25 ar', isCorrect: false },
              { id: 'd', text: '30 ar', isCorrect: false },
            ],
            solution: 'Grieg debuterte som lyriker bare 20 ar gammel. Allerede som ung viste han et stort litterært talent, men han ville ogsa ut i verden for a oppleve.',
          },
          {
            id: 'norsk-vg3-2-7-n-quiz1-q2',
            task: 'Hvilket land begeistret Grieg seg for pa grunn av det politiske eksperimentet?',
            options: [
              { id: 'a', text: 'USA', isCorrect: false },
              { id: 'b', text: 'Frankrike', isCorrect: false },
              { id: 'c', text: 'Sovjet', isCorrect: true },
              { id: 'd', text: 'Spania', isCorrect: false },
            ],
            solution: 'Grieg begeistret seg for Sovjet, der han sa et eksperiment med a skape et nytt samfunn. Denne troen delte han med mange intellektuelle, men den skulle vise seg naiv.',
          },
        ],
      },
    },
...
Dramaene viste en forfatter som ikke var redd for a ta stilling. I en tid der mange holdt seg unna politikken, kastet Grieg seg inn i den med åpne øyne.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 2',
        type: 'multiple-choice',
        task: 'Test deg selv pa Griegs dramaer:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        solution: '',
        questions: [
          ...
          {
            id: 'norsk-vg3-2-7-n-quiz2-q1',
            task: 'Hva handlet dramaet "Nederlaget" (1937) egentlig om?',
            options: [
              { id: 'a', text: 'Norges tap i en krig', isCorrect: false },
              { id: 'b', text: 'Revolusjonens dilemmaer - kan man bruke vold for a skape en bedre verden?', isCorrect: true },
              { id: 'c', text: 'Et mislykket ekteskap', isCorrect: false },
              { id: 'd', text: 'Arbeidsloshetens konsekvenser', isCorrect: false },
            ],
            solution: '"Nederlaget" handlet formelt om Paris-kommunen i 1871, men egentlig om revolusjonens dilemmaer: Kan man bruke vold for a skape en bedre verden? Hva skjer nar idealene moter virkeligheten?',
          },
        ],
      },
    },
...
Det var farlig - han visste det. Men han følte at han måtte. Kanskje tenkte han at en dikter som skrev om krig, matte oppleve krigen. Kanskje var det idealismen igjen - han kunne ikke be andre ta risiko han ikke selv var villig til a ta.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 3',
        type: 'multiple-choice',
        task: 'Test deg selv pa Grieg i krigen:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        solution: '',
        questions: [
          ...
          {
            id: 'norsk-vg3-2-7-n-quiz3-q1',
            task: 'Hvor flyktet Grieg da Norge ble okkupert i 1940?',
            options: [
              { id: 'a', text: 'Sverige', isCorrect: false },
              { id: 'b', text: 'USA', isCorrect: false },
              { id: 'c', text: 'England', isCorrect: true },
              { id: 'd', text: 'Sovjet', isCorrect: false },
            ],
            solution: 'Da Norge ble okkupert i april 1940, flyktet Grieg til England. Der arbeidet han for den norske eksilregjeringen, skrev propaganda og holdt radiotaler.',
          },
          {
            id: 'norsk-vg3-2-7-n-quiz3-q2',
            task: 'Hva gjorde Grieg som observatør under krigen?',
            options: [
              { id: 'a', text: 'Han dekket invasjonen av Normandie', isCorrect: false },
              { id: 'b', text: 'Han ble med pa bombetokt over Tyskland', isCorrect: true },
              { id: 'c', text: 'Han arbeidet i en lazarett', isCorrect: false },
              { id: 'd', text: 'Han var spion i okkupert Norge', isCorrect: false },
            ],
            solution: 'Grieg ble med pa bombetokt som observatør fordi han følte at en dikter som skrev om krig matte oppleve den selv. Det var pa et slikt tokt over Berlin han mistet livet.',
          },
        ],
      },
    },
...
Det er paradokset i Griegs liv: Han skrev om fred, men gikk selv i krigen. Kanskje mente han at noen ganger ma man kjempe for a skape fred. Kanskje var det motsigelse, kanskje var det konsistens. Vi vet ikke hva han tenkte den natten over Berlin.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 4',
        type: 'multiple-choice',
        task: 'Test deg selv pa "Til ungdommen":',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        solution: '',
        questions: [
          ...
          {
            id: 'norsk-vg3-2-7-n-quiz4-q1',
            task: 'Hva sier diktet at "krig" er?',
            options: [
              { id: 'a', text: 'Krig er nødvendig', isCorrect: false },
              { id: 'b', text: 'Krig er ære', isCorrect: false },
              { id: 'c', text: 'Krig er forakt for liv', isCorrect: true },
              { id: 'd', text: 'Krig er uunngåelig', isCorrect: false },
            ],
            solution: '"Krig er forakt for liv. Fred er å skape." Grieg definerer krig som det motsatte av a verdsette livet, og fred som noe aktivt - noe man ma skape, ikke bare fravaret av krig.',
          },
          {
            id: 'norsk-vg3-2-7-n-quiz4-q2',
            task: 'Ved hvilken hendelse i 2011 ble "Til ungdommen" sunget av tusenvis?',
            options: [
              { id: 'a', text: '17. mai-feiringen', isCorrect: false },
              { id: 'b', text: 'Stortingsvalget', isCorrect: false },
              { id: 'c', text: 'OL i Oslo', isCorrect: false },
              { id: 'd', text: 'Etter terrorangrepet 22. juli', isCorrect: true },
            ],
            solution: 'Etter terrorangrepet 22. juli 2011 ble "Til ungdommen" sunget av tusenvis i gatene. Diktet ble et uttrykk for samhold og hap i en mork tid - akkurat slik Grieg skrev det.',
          },
        ],
      },
    },
...
"Til ungdommen" lever videre fordi det taler til noe tidløst i oss - lengselen etter å skape, ikke odelegge, håpet om at det er mulig a bygge en bedre verden. Grieg ga stemme til det håpet. Og den stemmen tier ikke.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 5',
        type: 'multiple-choice',
        task: 'Test deg selv pa legenden Nordahl Grieg:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        solution: '',
        questions: [
          ...
          {
            id: 'norsk-vg3-2-7-n-quiz5-q1',
            task: 'Hva er paradokset i Griegs liv?',
            options: [
              { id: 'a', text: 'Han skrev om natur men bodde i byen', isCorrect: false },
              { id: 'b', text: 'Han skrev om fred men gikk selv i krigen', isCorrect: true },
              { id: 'c', text: 'Han var rik men skrev om fattigdom', isCorrect: false },
              { id: 'd', text: 'Han var norsk men bodde alltid i utlandet', isCorrect: false },
            ],
            solution: 'Paradokset er at Grieg skrev "Krig er forakt for liv" men selv dro frivillig i krigen og mistet livet. Kanskje mente han at noen ganger ma man kjempe for a skape fred.',
          },
          {
            id: 'norsk-vg3-2-7-n-quiz5-q2',
            task: 'Hva huskes Grieg aller mest for i dag?',
            options: [
              { id: 'a', text: 'Romanene hans', isCorrect: false },
              { id: 'b', text: 'Journalistikken fra Spaniakrigen', isCorrect: false },
              { id: 'c', text: 'Motet til a ta stilling og risikere alt', isCorrect: true },
              { id: 'd', text: 'Hans politiske analyser', isCorrect: false },
            ],
            solution: 'Det vi husker Grieg mest for er motet - motet til a ta stilling, til a risikere, til a dra dit andre ikke ville ga. Sammen med "Til ungdommen" utgjor dette hans varige arv.',
          },
        ],
      },
    },
