      ...
      content: [
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'lett',
            task: 'Regn ut (addisjon og subtraksjon med negative tall)',
            subTasks: [
              { label: 'a', task: '$9 - 14$', solution: '$-5$' },
              { label: 'b', task: '$-6 + 11$', solution: '$5$' },
              { label: 'c', task: '$-3 - 5$', solution: '$-8$' },
              { label: 'd', task: '$4 - (-7)$', solution: '$11$' },
              { label: 'e', task: '$-9 + (-2)$', solution: '$-11$' },
              { label: 'f', task: '$-1 - (-8)$', solution: '$7$' },
            ],
            solution: 'a) −5, b) 5, c) −8, d) 11, e) −11, f) 7',
        ...
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'lett',
            task: 'Regn ut (multiplikasjon og divisjon med negative tall)',
            subTasks: [
              { label: 'a', task: '$(-4) \\cdot 6$', solution: '$-24$' },
              { label: 'b', task: '$(-7) \\cdot (-3)$', solution: '$21$' },
              { label: 'c', task: '$(-36) \\div 9$', solution: '$-4$' },
              { label: 'd', task: '$(-48) \\div (-8)$', solution: '$6$' },
              { label: 'e', task: '$5 \\cdot (-9)$', solution: '$-45$' },
              { label: 'f', task: '$(-56) \\div 7$', solution: '$-8$' },
            ],
            solution: 'a) −24, b) 21, c) −4, d) 6, e) −45, f) −8',
            hideInlineSolution: true,
            hints: ['Like fortegn gir pluss, ulike fortegn gir minus'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'lett',
            task: 'Regn ut ved hjelp av regnerekkefølgen',
            subTasks: [
              { label: 'a', task: '$8 + 2 \\cdot 3$', solution: '$14$' },
              { label: 'b', task: '$(8 + 2) \\cdot 3$', solution: '$30$' },
              { label: 'c', task: '$20 - 8 \\div 2$', solution: '$16$' },
              { label: 'd', task: '$6 \\cdot 4 - 2 \\cdot 5$', solution: '$14$' },
              { label: 'e', task: '$(12 - 4) \\div 2$', solution: '$4$' },
              { label: 'f', task: '$3 + 5 \\cdot 4 - 10$', solution: '$13$' },
            ],
            solution: 'a) 14, b) 30, c) 16, d) 14, e) 4, f) 13',
            hideInlineSolution: true,
            hints: ['Husk PEMDAS: parenteser, potenser, multiplikasjon/divisjon, addisjon/subtraksjon'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'medium',
            task: 'Regn ut (blandede oppgaver med fortegn og regnerekkefølge)',
            subTasks: [
              { label: 'a', task: '$(-3) \\cdot 4 + 5$', solution: '$-12 + 5 = -7$' },
              { label: 'b', task: '$10 - (-2) \\cdot 3$', solution: '$10 - (-6) = 10 + 6 = 16$' },
              { label: 'c', task: '$(-8) + 6 \\cdot (-2)$', solution: '$-8 + (-12) = -20$' },
              { label: 'd', task: '$(-5) \\cdot (-4) - 3 \\cdot 7$', solution: '$20 - 21 = -1$' },
              { label: 'e', task: '$(6 - 9) \\cdot (-2)$', solution: '$(-3) \\cdot (-2) = 6$' },
              { label: 'f', task: '$(-18) \\div 3 + (-4) \\cdot 2$', solution: '$-6 + (-8) = -14$' },
            ],
            solution: 'a) −7, b) 16, c) −20, d) −1, e) 6, f) −14',
            hideInlineSolution: true,
            hints: ['Gjør multiplikasjon/divisjon før addisjon/subtraksjon'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'medium',
            task: 'Sett inn parenteser slik at regnestykket stemmer',
            subTasks: [
              { label: 'a', task: '$2 + 3 \\cdot 4 = 20$ (sett inn én parentes)', solution: '$(2 + 3) \\cdot 4 = 5 \\cdot 4 = 20$' },
              { label: 'b', task: '$10 - 6 \\div 2 = 2$ (sett inn én parentes)', solution: '$(10 - 6) \\div 2 = 4 \\div 2 = 2$' },
              { label: 'c', task: '$8 - 3 \\cdot 2 + 1 = 11$ (sett inn én parentes)', solution: '$8 - 3 \\cdot (2 + 1) = 8 - 9 = -1$. Riktig: $(8 - 3) \\cdot 2 + 1 = 10 + 1 = 11$' },
              { label: 'd', task: '$-4 + 6 \\cdot 3 - 2 = 4$ (sett inn én parentes)', solution: '$-4 + 6 \\cdot (3 - 2) = -4 + 6 = 2$. Riktig: $(-4 + 6) \\cdot 3 - 2 = 6 - 2 = 4$' },
            ],
            solution: 'a) (2+3)·4, b) (10−6)÷2, c) (8−3)·2+1, d) (−4+6)·3−2',
            hideInlineSolution: true,
            hints: ['Prøv ulike plasseringer av parentesene og sjekk om svaret stemmer'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'vanskelig',
            task: 'Tekstoppgaver med heltall og regnerekkefølge',
            subTasks: [
              { label: 'a', task: 'Om morgenen var det $-12°C$. I løpet av dagen steg temperaturen med $7$ grader, men om kvelden sank den $5$ grader. Hva ble kveldstemperaturen?', solution: '$-12 + 7 - 5 = -10°C$' },
              { label: 'b', task: 'En ubåt er på $-40$ meter. Den stiger $15$ meter, dykker deretter $25$ meter. Hvor dypt er ubåten nå?', solution: '$-40 + 15 - 25 = -50$ meter' },
              { label: 'c', task: 'Jonas har $350$ kr på konto. Han kjøper $3$ bøker til $89$ kr per stykk. Hvor mye har han igjen?', solution: '$350 - 3 \\cdot 89 = 350 - 267 = 83$ kr' },
              { label: 'd', task: 'En heis er i $2$. etasje. Den kjører $4$ etasjer ned, deretter $7$ etasjer opp, og til slutt $3$ etasjer ned. Hvor er heisen nå?', solution: '$2 - 4 + 7 - 3 = 2$. Heisen er i 2. etasje igjen.' },
            ],
            solution: 'a) −10°C, b) −50 m, c) 83 kr, d) 2. etasje',
            hideInlineSolution: true,
            hints: ['Oversett teksten til et regnestykke med pluss og minus'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
      ...
      content: [
        {
          ...
          exercise: {
            ...
            task: 'Forkort brøkene så mye som mulig',
            subTasks: [
              { label: 'a', task: '$\\frac{6}{9}$', solution: '$\\frac{2}{3}$' },
              { label: 'b', task: '$\\frac{8}{12}$', solution: '$\\frac{2}{3}$' },
              { label: 'c', task: '$\\frac{15}{20}$', solution: '$\\frac{3}{4}$' },
              { label: 'd', task: '$\\frac{12}{18}$', solution: '$\\frac{2}{3}$' },
              { label: 'e', task: '$\\frac{14}{21}$', solution: '$\\frac{2}{3}$' },
              { label: 'f', task: '$\\frac{24}{32}$', solution: '$\\frac{3}{4}$' },
            ],
            solution: 'a) 2/3, b) 2/3, c) 3/4, d) 2/3, e) 2/3, f) 3/4',
            hideInlineSolution: true,
        ...
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'lett',
            task: 'Utvid brøkene til oppgitt nevner',
            subTasks: [
              { label: 'a', task: '$\\frac{1}{3}$ med nevner $12$', solution: '$\\frac{4}{12}$' },
              { label: 'b', task: '$\\frac{2}{5}$ med nevner $15$', solution: '$\\frac{6}{15}$' },
              { label: 'c', task: '$\\frac{3}{4}$ med nevner $20$', solution: '$\\frac{15}{20}$' },
              { label: 'd', task: '$\\frac{5}{6}$ med nevner $18$', solution: '$\\frac{15}{18}$' },
              { label: 'e', task: '$\\frac{1}{2}$ med nevner $10$', solution: '$\\frac{5}{10}$' },
              { label: 'f', task: '$\\frac{3}{7}$ med nevner $21$', solution: '$\\frac{9}{21}$' },
            ],
            solution: 'a) 4/12, b) 6/15, c) 15/20, d) 15/18, e) 5/10, f) 9/21',
            hideInlineSolution: true,
            hints: ['Finn ut hva du må gange nevneren med, og gang telleren med det samme tallet'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            subTasks: [
              ...
              { label: 'b', task: '$\\frac{7}{8} - \\frac{3}{8}$', solution: '$\\frac{4}{8} = \\frac{1}{2}$' },
              { label: 'c', task: '$\\frac{1}{4} + \\frac{1}{2}$', solution: '$\\frac{1}{4} + \\frac{2}{4} = \\frac{3}{4}$' },
              { label: 'd', task: '$\\frac{2}{3} - \\frac{1}{6}$', solution: '$\\frac{4}{6} - \\frac{1}{6} = \\frac{3}{6} = \\frac{1}{2}$' },
              { label: 'e', task: '$\\frac{3}{5} + \\frac{1}{10}$', solution: '$\\frac{6}{10} + \\frac{1}{10} = \\frac{7}{10}$' },
              { label: 'f', task: '$\\frac{5}{6} - \\frac{1}{3}$', solution: '$\\frac{5}{6} - \\frac{2}{6} = \\frac{3}{6} = \\frac{1}{2}$' },
            ],
            solution: 'a) 3/5, b) 1/2, c) 3/4, d) 1/2, e) 7/10, f) 1/2',
            hideInlineSolution: true,
            hints: ['Brøkene må ha lik nevner før du kan legge sammen eller trekke fra'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'medium',
            task: 'Regn ut (multiplikasjon og divisjon av brøker)',
            subTasks: [
              { label: 'a', task: '$\\frac{2}{3} \\cdot \\frac{3}{5}$', solution: '$\\frac{6}{15} = \\frac{2}{5}$' },
              { label: 'b', task: '$\\frac{4}{7} \\cdot \\frac{7}{8}$', solution: '$\\frac{28}{56} = \\frac{1}{2}$' },
              { label: 'c', task: '$\\frac{3}{4} \\div \\frac{3}{8}$', solution: '$\\frac{3}{4} \\cdot \\frac{8}{3} = \\frac{24}{12} = 2$' },
              { label: 'd', task: '$\\frac{5}{6} \\div \\frac{5}{3}$', solution: '$\\frac{5}{6} \\cdot \\frac{3}{5} = \\frac{15}{30} = \\frac{1}{2}$' },
              { label: 'e', task: '$4 \\cdot \\frac{2}{5}$', solution: '$\\frac{8}{5}$' },
              { label: 'f', task: '$\\frac{2}{3} \\div 4$', solution: '$\\frac{2}{3} \\cdot \\frac{1}{4} = \\frac{2}{12} = \\frac{1}{6}$' },
            ],
            solution: 'a) 2/5, b) 1/2, c) 2, d) 1/2, e) 8/5, f) 1/6',
            hideInlineSolution: true,
            hints: ['Ved multiplikasjon: gang teller med teller og nevner med nevner. Ved divisjon: snu og gang.'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'medium',
            task: 'Blandede brøkoppgaver - regn ut og forkort',
            subTasks: [
              ...
              { label: 'c', task: '$\\frac{2}{3} \\cdot \\frac{9}{4}$', solution: '$\\frac{18}{12} = \\frac{3}{2}$' },
              { label: 'd', task: '$1 - \\frac{3}{8}$', solution: '$\\frac{8}{8} - \\frac{3}{8} = \\frac{5}{8}$' },
              { label: 'e', task: '$\\frac{5}{6} \\cdot \\frac{3}{10}$', solution: '$\\frac{15}{60} = \\frac{1}{4}$' },
            ],
            solution: 'a) 1, b) 3/8, c) 3/2, d) 5/8, e) 1/4',
            hideInlineSolution: true,
            hints: ['Finn fellesnevner for addisjon/subtraksjon. Forkort før du ganger ved multiplikasjon.'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'vanskelig',
            task: 'Tekstoppgaver med brøk',
            subTasks: [
              { label: 'a', task: 'En pizza deles i 8 stykker. Sara spiser $\\frac{3}{8}$ og Liam spiser $\\frac{2}{8}$. Hvor stor del av pizzaen er igjen?', solution: '$1 - \\frac{3}{8} - \\frac{2}{8} = \\frac{8}{8} - \\frac{5}{8} = \\frac{3}{8}$' },
              { label: 'b', task: 'En klasse har 30 elever. $\\frac{2}{5}$ av elevene spiller fotball. Hvor mange spiller fotball?', solution: '$\\frac{2}{5} \\cdot 30 = \\frac{60}{5} = 12$ elever' },
              { label: 'c', task: 'Et tau er $\\frac{3}{4}$ meter langt. Det kuttes i biter som er $\\frac{1}{8}$ meter lange. Hvor mange biter blir det?', solution: '$\\frac{3}{4} \\div \\frac{1}{8} = \\frac{3}{4} \\cdot \\frac{8}{1} = \\frac{24}{4} = 6$ biter' },
              { label: 'd', task: 'Ole har lest $\\frac{2}{3}$ av en bok på 240 sider. Hvor mange sider har han igjen?', solution: 'Lest: $\\frac{2}{3} \\cdot 240 = 160$ sider. Igjen: $240 - 160 = 80$ sider' },
            ],
            solution: 'a) 3/8, b) 12 elever, c) 6 biter, d) 80 sider',
            hideInlineSolution: true,
            hints: ['Oversett teksten til et regnestykke med brøk'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
      ...
      content: [
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'lett',
            task: 'Legg sammen og trekk fra desimaltall',
            subTasks: [
              { label: 'a', task: '$3,7 + 2,5$', solution: '$6,2$' },
              { label: 'b', task: '$8,4 - 3,6$', solution: '$4,8$' },
              { label: 'c', task: '$12,05 + 7,95$', solution: '$20,00 = 20$' },
              { label: 'd', task: '$6,3 - 0,48$', solution: '$5,82$' },
              { label: 'e', task: '$0,7 + 0,06 + 0,003$', solution: '$0,763$' },
              { label: 'f', task: '$10 - 4,35$', solution: '$5,65$' },
            ],
            solution: 'a) 6,2, b) 4,8, c) 20, d) 5,82, e) 0,763, f) 5,65',
            hideInlineSolution: true,
            hints: ['Still opp tallene slik at desimalkommaene står under hverandre'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'lett',
            task: 'Multipliser desimaltall',
            subTasks: [
              { label: 'a', task: '$0,3 \\cdot 4$', solution: '$1,2$' },
              { label: 'b', task: '$2,5 \\cdot 6$', solution: '$15$' },
              { label: 'c', task: '$0,4 \\cdot 0,3$', solution: '$0,12$' },
              { label: 'd', task: '$1,2 \\cdot 0,5$', solution: '$0,6$' },
              { label: 'e', task: '$3,14 \\cdot 10$', solution: '$31,4$' },
              { label: 'f', task: '$0,06 \\cdot 7$', solution: '$0,42$' },
            ],
            solution: 'a) 1,2, b) 15, c) 0,12, d) 0,6, e) 31,4, f) 0,42',
            hideInlineSolution: true,
            hints: ['Tell desimaler i faktorene; svaret har like mange desimaler totalt'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'lett',
            task: 'Divider desimaltall',
            subTasks: [
              { label: 'a', task: '$8,4 \\div 2$', solution: '$4,2$' },
              { label: 'b', task: '$15,6 \\div 3$', solution: '$5,2$' },
              { label: 'c', task: '$7,2 \\div 0,9$', solution: '$8$' },
              { label: 'd', task: '$4,5 \\div 0,5$', solution: '$9$' },
              { label: 'e', task: '$6,3 \\div 0,7$', solution: '$9$' },
              { label: 'f', task: '$0,48 \\div 4$', solution: '$0,12$' },
            ],
            solution: 'a) 4,2, b) 5,2, c) 8, d) 9, e) 9, f) 0,12',
            hideInlineSolution: true,
            hints: ['Ved divisjon med desimaltall: flytt kommaet slik at du deler med et helt tall'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'medium',
            task: 'Avrund tallene som oppgitt',
            subTasks: [
              { label: 'a', task: 'Avrund $3,847$ til én desimal', solution: '$3,8$' },
              { label: 'b', task: 'Avrund $12,652$ til to desimaler', solution: '$12,65$' },
              { label: 'c', task: 'Avrund $7,95$ til nærmeste heltall', solution: '$8$' },
              { label: 'd', task: 'Avrund $0,4561$ til to desimaler', solution: '$0,46$' },
              { label: 'e', task: 'Avrund $99,999$ til én desimal', solution: '$100,0$' },
              { label: 'f', task: 'Avrund $5,555$ til to desimaler', solution: '$5,56$' },
            ],
            solution: 'a) 3,8, b) 12,65, c) 8, d) 0,46, e) 100,0, f) 5,56',
            hideInlineSolution: true,
            hints: ['Se på sifferet etter den posisjonen du avrunder til. Er det 5 eller mer, runder du opp.'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'medium',
            task: 'Blandede regneoperasjoner med desimaltall',
            subTasks: [
              { label: 'a', task: '$2,5 \\cdot 4 + 1,3$', solution: '$10 + 1,3 = 11,3$' },
              { label: 'b', task: '$10 - 3 \\cdot 2,5$', solution: '$10 - 7,5 = 2,5$' },
              { label: 'c', task: '$(4,2 + 1,8) \\cdot 3$', solution: '$6 \\cdot 3 = 18$' },
              { label: 'd', task: '$7,5 \\div 2,5 + 0,6 \\cdot 5$', solution: '$3 + 3 = 6$' },
            ],
            solution: 'a) 11,3, b) 2,5, c) 18, d) 6',
            hideInlineSolution: true,
            hints: ['Bruk regnerekkefølgen: parenteser først, deretter multiplikasjon/divisjon, til slutt addisjon/subtraksjon'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            task: 'Tekstoppgaver med desimaltall',
            subTasks: [
              { label: 'a', task: 'Nora kjøper $2,5$ kg epler til $24,80$ kr per kg og $1,5$ kg bananer til $19,60$ kr per kg. Hva koster det totalt?', solution: '$2,5 \\cdot 24,80 + 1,5 \\cdot 19,60 = 62,00 + 29,40 = 91,40$ kr' },
              { label: 'b', task: 'En stav er $2,4$ m lang. Den kuttes i biter på $0,3$ m. Hvor mange biter får du, og hvor mange meter er til overs?', solution: '$2,4 \\div 0,3 = 8$ biter, $0$ m til overs' },
              { label: 'c', task: 'Tre venner legger sammen $45,50$ kr, $38,75$ kr og $50,25$ kr for å kjøpe en gave. Gaven koster $129,90$ kr. Har de nok penger? Hvor mye mangler eller er til overs?', solution: '$45,50 + 38,75 + 50,25 = 134,50$ kr. De har nok. Til overs: $134,50 - 129,90 = 4,60$ kr.' },
            ],
            solution: 'a) 91,40 kr, b) 8 biter, c) 4,60 kr til overs',
            hideInlineSolution: true,
            hints: ['Les oppgaven nøye og avgjør hvilken regneoperasjon du trenger'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
      ...
      content: [
        {
          ...
          exercise: {
            ...
            task: 'Skriv om mellom prosent, desimaltall og brøk',
            subTasks: [
              { label: 'a', task: '$50\\%$ som desimaltall', solution: '$0,50 = 0,5$' },
              { label: 'b', task: '$0,3$ som prosent', solution: '$30\\%$' },
              { label: 'c', task: '$\\frac{3}{4}$ som prosent', solution: '$75\\%$' },
              { label: 'd', task: '$10\\%$ som brøk', solution: '$\\frac{1}{10}$' },
              { label: 'e', task: '$0,05$ som prosent', solution: '$5\\%$' },
              { label: 'f', task: '$125\\%$ som desimaltall', solution: '$1,25$' },
            ],
            solution: 'a) 0,5, b) 30%, c) 75%, d) 1/10, e) 5%, f) 1,25',
            hideInlineSolution: true,
            hints: ['Prosent = hundredeler. Del på 100 for å gå fra prosent til desimaltall.'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'lett',
            task: 'Finn prosent av et tall',
            subTasks: [
              { label: 'a', task: '$25\\%$ av $200$', solution: '$50$' },
              { label: 'b', task: '$10\\%$ av $80$', solution: '$8$' },
              { label: 'c', task: '$75\\%$ av $120$', solution: '$90$' },
              { label: 'd', task: '$5\\%$ av $600$', solution: '$30$' },
              { label: 'e', task: '$33\\%$ av $300$', solution: '$99$' },
              { label: 'f', task: '$150\\%$ av $40$', solution: '$60$' },
            ],
            solution: 'a) 50, b) 8, c) 90, d) 30, e) 99, f) 60',
            hideInlineSolution: true,
            hints: ['Gjør prosenten om til desimaltall og gang med tallet'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            task: 'Finn hvor mange prosent',
            subTasks: [
              { label: 'a', task: '15 av 60', solution: '$\\frac{15}{60} \\cdot 100 = 25\\%$' },
              { label: 'b', task: '9 av 30', solution: '$\\frac{9}{30} \\cdot 100 = 30\\%$' },
              { label: 'c', task: '42 av 50', solution: '$\\frac{42}{50} \\cdot 100 = 84\\%$' },
              { label: 'd', task: '3 av 25', solution: '$\\frac{3}{25} \\cdot 100 = 12\\%$' },
              { label: 'e', task: '18 av 20', solution: '$\\frac{18}{20} \\cdot 100 = 90\\%$' },
              { label: 'f', task: '7 av 28', solution: '$\\frac{7}{28} \\cdot 100 = 25\\%$' },
            ],
            solution: 'a) 25%, b) 30%, c) 84%, d) 12%, e) 90%, f) 25%',
            hideInlineSolution: true,
            hints: ['Del delen på helheten og gang med 100'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'medium',
            task: 'Finn hele tallet når delen og prosenten er kjent',
            subTasks: [
              { label: 'a', task: '$20\\%$ av et tall er $30$. Hva er tallet?', solution: '$\\frac{30}{0,20} = 150$' },
              { label: 'b', task: '$25\\%$ av et tall er $45$. Hva er tallet?', solution: '$\\frac{45}{0,25} = 180$' },
              { label: 'c', task: '$50\\%$ av et tall er $65$. Hva er tallet?', solution: '$\\frac{65}{0,50} = 130$' },
              { label: 'd', task: '$10\\%$ av et tall er $12$. Hva er tallet?', solution: '$\\frac{12}{0,10} = 120$' },
              { label: 'e', task: '$40\\%$ av et tall er $80$. Hva er tallet?', solution: '$\\frac{80}{0,40} = 200$' },
            ],
            solution: 'a) 150, b) 180, c) 130, d) 120, e) 200',
            hideInlineSolution: true,
            hints: ['Del delen på prosenten (som desimaltall) for å finne helheten'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'medium',
            task: 'Blandede prosentoppgaver',
            subTasks: [
              { label: 'a', task: 'Hva er mest: $30\\%$ av $200$ eller $60\\%$ av $90$?', solution: '$30\\%$ av $200 = 60$. $60\\%$ av $90 = 54$. $30\\%$ av $200$ er mest.' },
              { label: 'b', task: 'Ola fikk $18$ av $24$ poeng på en prøve. Hvor mange prosent er det?', solution: '$\\frac{18}{24} \\cdot 100 = 75\\%$' },
              { label: 'c', task: 'En pris øker fra $500$ kr til $600$ kr. Hvor mange prosent er økningen?', solution: 'Økning: $100$ kr. $\\frac{100}{500} \\cdot 100 = 20\\%$' },
              { label: 'd', task: '$15\\%$ av elevene i en klasse er borte. Det er $27$ elever til stede. Hvor mange elever er det i klassen?', solution: '$27$ er $85\\%$ av klassen. $\\frac{27}{0,85} \\approx 31,8 \\approx 32$ elever. Sjekk: $32 \\cdot 0,85 = 27,2$. Alternativt: $\\frac{27}{0,85} \\approx 32$ elever.' },
            ],
            solution: 'a) 30% av 200 (= 60), b) 75%, c) 20%, d) ca. 32 elever',
            hideInlineSolution: true,
            hints: ['Les oppgaven nøye og avgjør hvilken type prosentoppgave det er'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'vanskelig',
            task: 'Praktiske prosentoppgaver',
            subTasks: [
              { label: 'a', task: 'En sykkel koster $4500$ kr. Den er på salg med $20\\%$ rabatt. Hva er salgsprisen?', solution: 'Rabatt: $0,20 \\cdot 4500 = 900$ kr. Salgspris: $4500 - 900 = 3600$ kr' },
              { label: 'b', task: 'Et lag vant $12$ av $16$ kamper. Hvor mange prosent av kampene vant de?', solution: '$\\frac{12}{16} \\cdot 100 = 75\\%$' },
              { label: 'c', task: 'En butikk har prisøkning på $15\\%$. En vare kostet $340$ kr. Hva blir ny pris?', solution: 'Økning: $0,15 \\cdot 340 = 51$ kr. Ny pris: $340 + 51 = 391$ kr' },
              { label: 'd', task: 'Etter en rabatt på $30\\%$ koster en jakke $560$ kr. Hva var originalprisen?', solution: '$560$ kr er $70\\%$ av originalprisen. $\\frac{560}{0,70} = 800$ kr' },
            ],
            solution: 'a) 3600 kr, b) 75%, c) 391 kr, d) 800 kr',
            hideInlineSolution: true,
            hints: ['Ved rabatt: trekk fra prosenten. Ved prisøkning: legg til prosenten.'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
      ...
      content: [
        {
          ...
          exercise: {
            ...
            task: 'Regn ut potensene',
            subTasks: [
              { label: 'a', task: '$4^2$', solution: '$16$' },
              { label: 'b', task: '$2^6$', solution: '$64$' },
              { label: 'c', task: '$7^2$', solution: '$49$' },
              { label: 'd', task: '$3^3$', solution: '$27$' },
              { label: 'e', task: '$10^3$', solution: '$1000$' },
              { label: 'f', task: '$1^{100}$', solution: '$1$' },
            ],
            solution: 'a) 16, b) 64, c) 49, d) 27, e) 1000, f) 1',
            hideInlineSolution: true,
            hints: ['Potens betyr gjentatt multiplikasjon: $a^n = a \\cdot a \\cdot \\ldots \\cdot a$ ($n$ ganger)'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'lett',
            task: 'Regn ut potenser med negative grunntall og spesielle tilfeller',
            subTasks: [
              { label: 'a', task: '$(-4)^2$', solution: '$16$' },
              { label: 'b', task: '$(-2)^5$', solution: '$-32$' },
              { label: 'c', task: '$(-1)^7$', solution: '$-1$' },
              { label: 'd', task: '$8^0$', solution: '$1$' },
              { label: 'e', task: '$(-3)^3$', solution: '$-27$' },
              { label: 'f', task: '$(-5)^2$', solution: '$25$' },
            ],
            solution: 'a) 16, b) −32, c) −1, d) 1, e) −27, f) 25',
            hideInlineSolution: true,
            hints: ['Partallseksponent med negativt grunntall gir positivt svar. Oddetallseksponent gir negativt.'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'lett',
            task: 'Skriv som en potens',
            subTasks: [
              { label: 'a', task: '$5 \\cdot 5 \\cdot 5$', solution: '$5^3$' },
              { label: 'b', task: '$2 \\cdot 2 \\cdot 2 \\cdot 2 \\cdot 2$', solution: '$2^5$' },
              { label: 'c', task: '$10 \\cdot 10 \\cdot 10 \\cdot 10$', solution: '$10^4$' },
              { label: 'd', task: '$(-3) \\cdot (-3)$', solution: '$(-3)^2$' },
              { label: 'e', task: '$7 \\cdot 7 \\cdot 7 \\cdot 7 \\cdot 7 \\cdot 7$', solution: '$7^6$' },
              { label: 'f', task: '$a \\cdot a \\cdot a$', solution: '$a^3$' },
            ],
            solution: 'a) $5^3$, b) $2^5$, c) $10^4$, d) $(-3)^2$, e) $7^6$, f) $a^3$',
            hideInlineSolution: true,
            hints: ['Tell hvor mange ganger grunntallet er ganget med seg selv'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'medium',
            task: 'Forenkle ved hjelp av potensreglene. Skriv svaret som én potens.',
            subTasks: [
              { label: 'a', task: '$5^3 \\cdot 5^4$', solution: '$5^{3+4} = 5^7$' },
              { label: 'b', task: '$2^8 \\div 2^5$', solution: '$2^{8-5} = 2^3 = 8$' },
              { label: 'c', task: '$(3^2)^3$', solution: '$3^{2 \\cdot 3} = 3^6 = 729$' },
              { label: 'd', task: '$4^2 \\cdot 4^3 \\div 4^4$', solution: '$4^{2+3-4} = 4^1 = 4$' },
              { label: 'e', task: '$10^5 \\div 10^3$', solution: '$10^{5-3} = 10^2 = 100$' },
              { label: 'f', task: '$(5^3)^2 \\div 5^4$', solution: '$5^6 \\div 5^4 = 5^2 = 25$' },
            ],
            solution: 'a) $5^7$, b) 8, c) 729, d) 4, e) 100, f) 25',
            hideInlineSolution: true,
            hints: ['$a^m \\cdot a^n = a^{m+n}$, $a^m \\div a^n = a^{m-n}$, $(a^m)^n = a^{m \\cdot n}$'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'medium',
            task: 'Blandede oppgaver med potenser og regnerekkefølge',
            subTasks: [
              { label: 'a', task: '$2^3 + 3^2$', solution: '$8 + 9 = 17$' },
              { label: 'b', task: '$4^2 - 2^4$', solution: '$16 - 16 = 0$' },
              { label: 'c', task: '$5^2 \\cdot 2 - 10$', solution: '$25 \\cdot 2 - 10 = 50 - 10 = 40$' },
              { label: 'd', task: '$(2 + 3)^2$', solution: '$5^2 = 25$' },
              { label: 'e', task: '$2^2 + 3^2 + 4^2$', solution: '$4 + 9 + 16 = 29$' },
            ],
            solution: 'a) 17, b) 0, c) 40, d) 25, e) 29',
            hideInlineSolution: true,
            hints: ['Regn ut potensene først, deretter følg regnerekkefølgen'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'vanskelig',
            task: 'Tekstoppgaver med potenser',
            subTasks: [
              { label: 'a', task: 'En bakteriekoloni dobler seg hver time. Hvis det starter med 1 bakterie, hvor mange bakterier er det etter $10$ timer? Skriv svaret som en potens og regn ut.', solution: '$2^{10} = 1024$ bakterier' },
              { label: 'b', task: 'Et kvadrat har side $s = 7$ cm. Skriv arealet som en potens og regn ut.', solution: '$A = s^2 = 7^2 = 49$ cm²' },
              { label: 'c', task: 'En kube har side $4$ cm. Skriv volumet som en potens og regn ut.', solution: '$V = 4^3 = 64$ cm³' },
              { label: 'd', task: 'Hva er størst: $3^4$ eller $4^3$? Begrunn svaret.', solution: '$3^4 = 81$ og $4^3 = 64$. $3^4$ er størst.' },
            ],
            solution: 'a) $2^{10}$ = 1024, b) $7^2$ = 49 cm², c) $4^3$ = 64 cm³, d) $3^4 = 81 > 4^3 = 64$',
            hideInlineSolution: true,
            hints: ['Tenk på hva potensen representerer i den praktiske sammenhengen'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
      ...
      content: [
        {
          ...
          exercise: {
            ...
            task: 'Skriv uttrykkene med tall og bokstaver (bruk $x$ som variabel)',
            subTasks: [
              { label: 'a', task: 'Et tall pluss 10', solution: '$x + 10$' },
              { label: 'b', task: 'Det firedobbelte av et tall', solution: '$4x$' },
              { label: 'c', task: 'Et tall delt på 5', solution: '$\\frac{x}{5}$' },
              { label: 'd', task: 'Et tall minus 3', solution: '$x - 3$' },
              { label: 'e', task: 'Halvparten av et tall pluss 6', solution: '$\\frac{x}{2} + 6$' },
              { label: 'f', task: 'Differansen mellom 20 og et tall', solution: '$20 - x$' },
            ],
            solution: 'a) x+10, b) 4x, c) x/5, d) x−3, e) x/2+6, f) 20−x',
            hideInlineSolution: true,
            hints: ['Oversett ordene til matematiske symboler: «pluss» = +, «ganger» = ·, «delt på» = ÷'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'lett',
            task: 'Regn ut uttrykkene når $a = 5$',
            subTasks: [
              { label: 'a', task: '$2a + 3$', solution: '$2 \\cdot 5 + 3 = 13$' },
              { label: 'b', task: '$a^2 - 10$', solution: '$25 - 10 = 15$' },
              { label: 'c', task: '$3a - 7$', solution: '$15 - 7 = 8$' },
              { label: 'd', task: '$\\frac{a}{5} + 4$', solution: '$1 + 4 = 5$' },
              { label: 'e', task: '$a^2 + a$', solution: '$25 + 5 = 30$' },
              { label: 'f', task: '$4a - 2a + 1$', solution: '$20 - 10 + 1 = 11$' },
            ],
            solution: 'a) 13, b) 15, c) 8, d) 5, e) 30, f) 11',
            hideInlineSolution: true,
            hints: ['Sett inn 5 for a og regn ut ved å følge regnerekkefølgen'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'lett',
            task: 'Forenkle uttrykkene ved å slå sammen like ledd',
            subTasks: [
              { label: 'a', task: '$5x + 2x$', solution: '$7x$' },
              { label: 'b', task: '$8a - 3a$', solution: '$5a$' },
              { label: 'c', task: '$3b + 7 + 2b$', solution: '$5b + 7$' },
              { label: 'd', task: '$6y - y + 4$', solution: '$5y + 4$' },
              { label: 'e', task: '$x + 2x + 3x$', solution: '$6x$' },
              { label: 'f', task: '$10m - 4m - 2m$', solution: '$4m$' },
            ],
            solution: 'a) 7x, b) 5a, c) 5b+7, d) 5y+4, e) 6x, f) 4m',
            hideInlineSolution: true,
            hints: ['Like ledd har samme variabel. Legg sammen eller trekk fra koeffisientene.'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'medium',
            task: 'Forenkle uttrykkene (blandede ledd og multiplikasjon)',
            subTasks: [
              { label: 'a', task: '$2x + 4y + 3x - 2y$', solution: '$5x + 2y$' },
              { label: 'b', task: '$5a + 3 - 2a + 7$', solution: '$3a + 10$' },
              { label: 'c', task: '$3 \\cdot 5x$', solution: '$15x$' },
              { label: 'd', task: '$4x \\cdot 3x$', solution: '$12x^2$' },
              { label: 'e', task: '$2a + a^2 + 3a - a^2$', solution: '$5a$' },
              { label: 'f', task: '$7b - 2 + 3b + 8 - b$', solution: '$9b + 6$' },
            ],
            solution: 'a) 5x+2y, b) 3a+10, c) 15x, d) 12x², e) 5a, f) 9b+6',
            hideInlineSolution: true,
            hints: ['Samle like ledd. Husk at $x$ og $x^2$ ikke er like ledd.'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'medium',
            task: 'Regn ut uttrykkene når $x = 3$ og $y = 2$',
            subTasks: [
              { label: 'a', task: '$2x + 3y$', solution: '$2 \\cdot 3 + 3 \\cdot 2 = 6 + 6 = 12$' },
              { label: 'b', task: '$x^2 - y^2$', solution: '$9 - 4 = 5$' },
              { label: 'c', task: '$5xy$', solution: '$5 \\cdot 3 \\cdot 2 = 30$' },
              { label: 'd', task: '$x^2 + 2xy + y^2$', solution: '$9 + 12 + 4 = 25$' },
              { label: 'e', task: '$\\frac{x + y}{x - y}$', solution: '$\\frac{3 + 2}{3 - 2} = \\frac{5}{1} = 5$' },
            ],
            solution: 'a) 12, b) 5, c) 30, d) 25, e) 5',
            hideInlineSolution: true,
            hints: ['Sett inn $x = 3$ og $y = 2$ i hvert uttrykk og regn ut'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'vanskelig',
            task: 'Tekstoppgaver med bokstavregning',
            subTasks: [
              { label: 'a', task: 'Et rektangel har bredde $b$ og lengde som er $3$ mer enn bredden. Skriv et uttrykk for omkretsen og forenkle.', solution: 'Lengde: $b + 3$. Omkrets: $2b + 2(b + 3) = 2b + 2b + 6 = 4b + 6$' },
              { label: 'b', task: 'Emma er $x$ år gammel. Broren er dobbelt så gammel. Om $5$ år, hva er summen av aldrene deres? Forenkle uttrykket.', solution: 'Emmas alder om 5 år: $x + 5$. Brorens alder om 5 år: $2x + 5$. Sum: $(x + 5) + (2x + 5) = 3x + 10$' },
              { label: 'c', task: 'En billett koster $x$ kr for barn og $(x + 50)$ kr for voksne. En familie med 2 voksne og 3 barn kjøper billetter. Skriv et uttrykk for totalprisen og forenkle.', solution: '$2(x + 50) + 3x = 2x + 100 + 3x = 5x + 100$ kr' },
              { label: 'd', task: 'Regn ut totalprisen i oppgave c) dersom $x = 80$ kr.', solution: '$5 \\cdot 80 + 100 = 400 + 100 = 500$ kr' },
            ],
            solution: 'a) $4b + 6$, b) $3x + 10$, c) $5x + 100$, d) 500 kr',
            hideInlineSolution: true,
            hints: ['Oversett teksten til algebraiske uttrykk og forenkle ved å slå sammen like ledd'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
      ...
      content: [
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'lett',
            task: 'Løs opp parentesene (pluss og minus foran)',
            subTasks: [
              { label: 'a', task: '$+(2x + 7)$', solution: '$2x + 7$' },
              { label: 'b', task: '$-(3a + 5)$', solution: '$-3a - 5$' },
              { label: 'c', task: '$-(4b - 1)$', solution: '$-4b + 1$' },
              { label: 'd', task: '$+(x - 2y + 3)$', solution: '$x - 2y + 3$' },
              { label: 'e', task: '$-(5m - 2n + 4)$', solution: '$-5m + 2n - 4$' },
              { label: 'f', task: '$-(- a + 6)$', solution: '$a - 6$' },
            ],
            solution: 'a) 2x+7, b) −3a−5, c) −4b+1, d) x−2y+3, e) −5m+2n−4, f) a−6',
            hideInlineSolution: true,
            hints: ['Pluss foran parentes: leddene beholder fortegnet. Minus foran parentes: alle ledd skifter fortegn.'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'lett',
            task: 'Multipliser inn i parentesen (distributiv lov)',
            subTasks: [
              { label: 'a', task: '$4(x + 2)$', solution: '$4x + 8$' },
              { label: 'b', task: '$3(2a - 3)$', solution: '$6a - 9$' },
              { label: 'c', task: '$-2(b + 5)$', solution: '$-2b - 10$' },
              { label: 'd', task: '$5(3x - 1)$', solution: '$15x - 5$' },
              { label: 'e', task: '$-4(2y + 3)$', solution: '$-8y - 12$' },
              { label: 'f', task: '$6(a - 2b + 1)$', solution: '$6a - 12b + 6$' },
            ],
            solution: 'a) 4x+8, b) 6a−9, c) −2b−10, d) 15x−5, e) −8y−12, f) 6a−12b+6',
            hideInlineSolution: true,
            hints: ['Gang tallet foran parentesen med hvert ledd inni'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            task: 'Løs opp og forenkle',
            subTasks: [
              { label: 'a', task: '$2(x + 4) + 3x$', solution: '$2x + 8 + 3x = 5x + 8$' },
              { label: 'b', task: '$5a - (2a + 3)$', solution: '$5a - 2a - 3 = 3a - 3$' },
              { label: 'c', task: '$3(b + 1) + 2(b - 4)$', solution: '$3b + 3 + 2b - 8 = 5b - 5$' },
              { label: 'd', task: '$4(x - 2) - (x + 6)$', solution: '$4x - 8 - x - 6 = 3x - 14$' },
              { label: 'e', task: '$-(3y + 2) + 5y$', solution: '$-3y - 2 + 5y = 2y - 2$' },
              { label: 'f', task: '$2(a + 3) + 3(a - 2)$', solution: '$2a + 6 + 3a - 6 = 5a$' },
            ],
            solution: 'a) 5x+8, b) 3a−3, c) 5b−5, d) 3x−14, e) 2y−2, f) 5a',
            hideInlineSolution: true,
            hints: ['Løs opp alle parenteser først, deretter slå sammen like ledd'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'medium',
            task: 'Løs opp og forenkle (blandede oppgaver)',
            subTasks: [
              { label: 'a', task: '$2(3x + 1) - 3(x - 4)$', solution: '$6x + 2 - 3x + 12 = 3x + 14$' },
              { label: 'b', task: '$4(a + 2) + 2(3a - 5)$', solution: '$4a + 8 + 6a - 10 = 10a - 2$' },
              { label: 'c', task: '$-3(2b - 1) + 5(b + 2)$', solution: '$-6b + 3 + 5b + 10 = -b + 13$' },
              { label: 'd', task: '$x(x + 4) - x^2$', solution: '$x^2 + 4x - x^2 = 4x$' },
              { label: 'e', task: '$3(y - 2) - 2(y - 3)$', solution: '$3y - 6 - 2y + 6 = y$' },
              { label: 'f', task: '$5(2m + 1) - 3(2m + 1)$', solution: '$10m + 5 - 6m - 3 = 4m + 2$' },
            ],
            solution: 'a) 3x+14, b) 10a−2, c) −b+13, d) 4x, e) y, f) 4m+2',
            hideInlineSolution: true,
            hints: ['Vær nøye med fortegn når du ganger minus inn i parentesen'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'medium',
            task: 'Løs opp og forenkle (med variabel foran parentes)',
            subTasks: [
              { label: 'a', task: '$x(x + 2)$', solution: '$x^2 + 2x$' },
              { label: 'b', task: '$a(3a - 5)$', solution: '$3a^2 - 5a$' },
              { label: 'c', task: '$2x(x + 3) + x^2$', solution: '$2x^2 + 6x + x^2 = 3x^2 + 6x$' },
              { label: 'd', task: '$3b(b - 2) - 2b^2$', solution: '$3b^2 - 6b - 2b^2 = b^2 - 6b$' },
              { label: 'e', task: '$x(x + 1) + x(x - 1)$', solution: '$x^2 + x + x^2 - x = 2x^2$' },
            ],
            solution: 'a) $x^2+2x$, b) $3a^2-5a$, c) $3x^2+6x$, d) $b^2-6b$, e) $2x^2$',
            hideInlineSolution: true,
            hints: ['Husk at $x \\cdot x = x^2$'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'vanskelig',
            task: 'Tekstoppgaver med parenteser',
            subTasks: [
              { label: 'a', task: 'Et rektangel har lengde $(2x + 3)$ og bredde $(x + 1)$. Skriv et uttrykk for omkretsen og forenkle.', solution: 'Omkrets: $2(2x + 3) + 2(x + 1) = 4x + 6 + 2x + 2 = 6x + 8$' },
              { label: 'b', task: 'Prisen for en kinobillett er $(x + 30)$ kr for voksne og $x$ kr for barn. En familie med 2 voksne og 3 barn kjøper billetter. I tillegg kjøper de popcorn for $85$ kr. Skriv et uttrykk for totalprisen og forenkle.', solution: '$2(x + 30) + 3x + 85 = 2x + 60 + 3x + 85 = 5x + 145$ kr' },
              { label: 'c', task: 'Et kvadrat har side $(3a - 2)$. Skriv et uttrykk for omkretsen og forenkle. Regn ut omkretsen når $a = 4$.', solution: 'Omkrets: $4(3a - 2) = 12a - 8$. Når $a = 4$: $12 \\cdot 4 - 8 = 48 - 8 = 40$' },
            ],
            solution: 'a) $6x + 8$, b) $5x + 145$ kr, c) $12a - 8$, og 40 når $a = 4$',
            hideInlineSolution: true,
            hints: ['Sett opp uttrykk med parenteser, løs opp og forenkle'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
      ...
      content: [
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'lett',
            task: 'Løs likningene (addisjon og subtraksjon)',
            subTasks: [
              { label: 'a', task: '$x + 3 = 10$', solution: '$x = 10 - 3 = 7$' },
              { label: 'b', task: '$x - 7 = 5$', solution: '$x = 5 + 7 = 12$' },
              { label: 'c', task: '$x + 9 = 4$', solution: '$x = 4 - 9 = -5$' },
              { label: 'd', task: '$x - 2 = -6$', solution: '$x = -6 + 2 = -4$' },
              { label: 'e', task: '$x + 15 = 15$', solution: '$x = 15 - 15 = 0$' },
              { label: 'f', task: '$x - 10 = -3$', solution: '$x = -3 + 10 = 7$' },
            ],
            solution: 'a) 7, b) 12, c) −5, d) −4, e) 0, f) 7',
            hideInlineSolution: true,
            hints: ['Flytt tallet til andre siden med motsatt fortegn'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
        ...
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'lett',
            task: 'Løs likningene (multiplikasjon og divisjon)',
            subTasks: [
              { label: 'a', task: '$3x = 18$', solution: '$x = 18 \\div 3 = 6$' },
              { label: 'b', task: '$7x = 42$', solution: '$x = 42 \\div 7 = 6$' },
              { label: 'c', task: '$\\frac{x}{5} = 4$', solution: '$x = 4 \\cdot 5 = 20$' },
              { label: 'd', task: '$-4x = 24$', solution: '$x = 24 \\div (-4) = -6$' },
              { label: 'e', task: '$6x = -30$', solution: '$x = -30 \\div 6 = -5$' },
              { label: 'f', task: '$\\frac{x}{2} = -7$', solution: '$x = -7 \\cdot 2 = -14$' },
            ],
            solution: 'a) 6, b) 6, c) 20, d) −6, e) −5, f) −14',
            hideInlineSolution: true,
            hints: ['Del begge sider på koeffisienten foran x, eller gang begge sider med nevneren'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'lett',
            task: 'Løs likningene (to steg)',
            subTasks: [
              { label: 'a', task: '$2x + 1 = 9$', solution: '$2x = 8 \\Rightarrow x = 4$' },
              { label: 'b', task: '$3x - 4 = 11$', solution: '$3x = 15 \\Rightarrow x = 5$' },
              { label: 'c', task: '$5x + 3 = 28$', solution: '$5x = 25 \\Rightarrow x = 5$' },
              { label: 'd', task: '$4x - 7 = 1$', solution: '$4x = 8 \\Rightarrow x = 2$' },
              { label: 'e', task: '$\\frac{x}{4} + 3 = 7$', solution: '$\\frac{x}{4} = 4 \\Rightarrow x = 16$' },
              { label: 'f', task: '$6x + 2 = -10$', solution: '$6x = -12 \\Rightarrow x = -2$' },
            ],
            solution: 'a) 4, b) 5, c) 5, d) 2, e) 16, f) −2',
            hideInlineSolution: true,
            hints: ['Steg 1: Flytt konstantleddet. Steg 2: Del på koeffisienten.'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'medium',
            task: 'Løs likningene (x på begge sider)',
            subTasks: [
              { label: 'a', task: '$5x = 2x + 9$', solution: '$3x = 9 \\Rightarrow x = 3$' },
              { label: 'b', task: '$8x - 5 = 3x + 10$', solution: '$5x = 15 \\Rightarrow x = 3$' },
              { label: 'c', task: '$4x + 1 = x + 13$', solution: '$3x = 12 \\Rightarrow x = 4$' },
              { label: 'd', task: '$6x - 2 = 3x + 7$', solution: '$3x = 9 \\Rightarrow x = 3$' },
              { label: 'e', task: '$9x + 4 = 5x + 20$', solution: '$4x = 16 \\Rightarrow x = 4$' },
              { label: 'f', task: '$2x + 15 = 7x$', solution: '$15 = 5x \\Rightarrow x = 3$' },
            ],
            solution: 'a) 3, b) 3, c) 4, d) 3, e) 4, f) 3',
            hideInlineSolution: true,
            hints: ['Samle alle x-ledd på én side og alle konstantledd på den andre'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'medium',
            task: 'Sett opp likning og løs',
            subTasks: [
              { label: 'a', task: 'Summen av et tall og $8$ er $23$. Finn tallet.', solution: '$x + 8 = 23 \\Rightarrow x = 15$' },
              { label: 'b', task: 'Det tredobbelte av et tall er $27$. Finn tallet.', solution: '$3x = 27 \\Rightarrow x = 9$' },
              { label: 'c', task: 'Halvparten av et tall pluss $4$ er $10$. Finn tallet.', solution: '$\\frac{x}{2} + 4 = 10 \\Rightarrow \\frac{x}{2} = 6 \\Rightarrow x = 12$' },
              { label: 'd', task: 'Hvis du ganger et tall med $5$ og trekker fra $3$, får du $22$. Finn tallet.', solution: '$5x - 3 = 22 \\Rightarrow 5x = 25 \\Rightarrow x = 5$' },
            ],
            solution: 'a) 15, b) 9, c) 12, d) 5',
            hideInlineSolution: true,
            hints: ['Oversett teksten til en likning med $x$ som den ukjente'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'vanskelig',
            task: 'Tekstoppgaver med likninger',
            subTasks: [
              { label: 'a', task: 'Petter og Kari har til sammen $240$ kr. Petter har dobbelt så mye som Kari. Hvor mye har hver?', solution: 'La Kari ha $x$ kr. Petter har $2x$ kr. $x + 2x = 240 \\Rightarrow 3x = 240 \\Rightarrow x = 80$. Kari: $80$ kr, Petter: $160$ kr.' },
              { label: 'b', task: 'To sider i en trekant er like lange. Den tredje siden er $5$ cm kortere enn de andre. Omkretsen er $37$ cm. Hvor lange er sidene?', solution: 'La de like sidene være $x$ cm. Tredje side: $(x - 5)$ cm. $x + x + (x - 5) = 37 \\Rightarrow 3x - 5 = 37 \\Rightarrow 3x = 42 \\Rightarrow x = 14$. To sider er $14$ cm, den tredje er $9$ cm.' },
              { label: 'c', task: 'En bussbillett for voksen koster $x$ kr. En barnebillett koster halvparten. 3 voksne og 2 barn betaler til sammen $280$ kr. Finn prisen for en voksenbillett.', solution: '$3x + 2 \\cdot \\frac{x}{2} = 280 \\Rightarrow 3x + x = 280 \\Rightarrow 4x = 280 \\Rightarrow x = 70$ kr' },
            ],
            solution: 'a) Kari: 80 kr, Petter: 160 kr, b) 14 cm, 14 cm og 9 cm, c) 70 kr',
            hideInlineSolution: true,
            hints: ['Definer den ukjente med $x$, sett opp likningen basert på opplysningene og løs'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
      ...
      content: [
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'lett',
            task: 'Avgjør hvilken type vinkel det er',
            subTasks: [
              { label: 'a', task: '$55°$', solution: 'Spiss vinkel (mindre enn $90°$)' },
              { label: 'b', task: '$90°$', solution: 'Rett vinkel (nøyaktig $90°$)' },
              { label: 'c', task: '$143°$', solution: 'Stump vinkel (mellom $90°$ og $180°$)' },
              { label: 'd', task: '$180°$', solution: 'Flat vinkel (nøyaktig $180°$)' },
              { label: 'e', task: '$12°$', solution: 'Spiss vinkel (mindre enn $90°$)' },
            ],
            solution: 'a) Spiss, b) Rett, c) Stump, d) Flat, e) Spiss',
            hideInlineSolution: true,
            hints: ['Spiss: $0°$–$90°$, Rett: $90°$, Stump: $90°$–$180°$, Flat: $180°$'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'lett',
            task: 'Finn supplementvinkelen til de oppgitte vinklene',
            subTasks: [
              { label: 'a', task: '$35°$', solution: '$180° - 35° = 145°$' },
              { label: 'b', task: '$90°$', solution: '$180° - 90° = 90°$' },
              { label: 'c', task: '$112°$', solution: '$180° - 112° = 68°$' },
              { label: 'd', task: '$155°$', solution: '$180° - 155° = 25°$' },
            ],
            solution: 'a) $145°$, b) $90°$, c) $68°$, d) $25°$',
            hideInlineSolution: true,
            hints: ['Supplementvinkler har sum $180°$'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
        ...
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'lett',
            task: 'Finn komplementvinkelen til de oppgitte vinklene',
            subTasks: [
              { label: 'a', task: '$20°$', solution: '$90° - 20° = 70°$' },
              { label: 'b', task: '$45°$', solution: '$90° - 45° = 45°$' },
              { label: 'c', task: '$63°$', solution: '$90° - 63° = 27°$' },
              { label: 'd', task: '$81°$', solution: '$90° - 81° = 9°$' },
            ],
            solution: 'a) $70°$, b) $45°$, c) $27°$, d) $9°$',
            hideInlineSolution: true,
            hints: ['Komplementvinkler har sum $90°$'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
        ...
        },
        {
          ...
          exercise: {
            ...
            task: 'To linjer krysser hverandre. Én vinkel er gitt. Finn de tre andre vinklene.',
            subTasks: [
              { label: 'a', task: 'En vinkel er $55°$', solution: 'Toppvinkel: $55°$. Nabovinkler: $180° - 55° = 125°$ og $125°$. Svar: $55°$, $125°$, $55°$, $125°$' },
              { label: 'b', task: 'En vinkel er $132°$', solution: 'Toppvinkel: $132°$. Nabovinkler: $180° - 132° = 48°$ og $48°$. Svar: $132°$, $48°$, $132°$, $48°$' },
              { label: 'c', task: 'En vinkel er $90°$', solution: 'Alle fire vinkler er $90°$' },
              { label: 'd', task: 'En vinkel er $17°$', solution: 'Toppvinkel: $17°$. Nabovinkler: $180° - 17° = 163°$ og $163°$. Svar: $17°$, $163°$, $17°$, $163°$' },
            ],
            solution: 'a) $55°, 125°, 55°, 125°$; b) $132°, 48°, 132°, 48°$; c) Alle $90°$; d) $17°, 163°, 17°, 163°$',
            hideInlineSolution: true,
            hints: ['Toppvinkler er like store', 'Nabovinkler har sum $180°$'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
        ...
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'medium',
            task: 'Bruk vinkelsummen i en trekant ($180°$) til å finne den ukjente vinkelen',
            subTasks: [
              { label: 'a', task: 'To vinkler er $65°$ og $45°$', solution: '$180° - 65° - 45° = 70°$' },
              { label: 'b', task: 'To vinkler er $90°$ og $38°$', solution: '$180° - 90° - 38° = 52°$' },
              { label: 'c', task: 'To vinkler er $72°$ og $72°$', solution: '$180° - 72° - 72° = 36°$' },
              { label: 'd', task: 'To vinkler er $25°$ og $110°$', solution: '$180° - 25° - 110° = 45°$' },
              { label: 'e', task: 'En vinkel er $60°$ og trekanten er likesidet', solution: 'Alle vinkler er $60°$ i en likesidet trekant' },
            ],
            solution: 'a) $70°$, b) $52°$, c) $36°$, d) $45°$, e) $60°$',
            hideInlineSolution: true,
            hints: ['Summen av vinklene i en trekant er alltid $180°$'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'vanskelig',
            task: 'Utfordringsoppgaver om vinkler',
            subTasks: [
              { label: 'a', task: 'En vinkel er tre ganger så stor som supplementvinkelen sin. Finn begge vinklene.', solution: 'La vinkelen være $v$. Da er $v + \\frac{v}{3} = 180°$, altså $\\frac{4v}{3} = 180°$, $v = 135°$. Supplementvinkelen er $45°$.' },
              { label: 'b', task: 'En vinkel er dobbelt så stor som komplementvinkelen sin. Finn begge vinklene.', solution: 'La komplementvinkelen være $x$. Da er $2x + x = 90°$, altså $3x = 90°$, $x = 30°$. Vinkelen er $60°$.' },
              { label: 'c', task: 'To linjer krysser hverandre. En av nabovinklene er $40°$ mer enn den andre. Finn alle fire vinklene.', solution: 'La den minste vinkelen være $v$. Da er $v + (v + 40°) = 180°$, $2v = 140°$, $v = 70°$. Vinklene er $70°$, $110°$, $70°$, $110°$.' },
              { label: 'd', task: 'I en trekant er den ene vinkelen dobbelt så stor som den andre, og den tredje vinkelen er $30°$. Finn alle vinklene.', solution: 'La den minste vinkelen være $v$. Da er $v + 2v + 30° = 180°$, $3v = 150°$, $v = 50°$. Vinklene er $50°$, $100°$ og $30°$.' },
            ],
            solution: 'a) $135°$ og $45°$; b) $60°$ og $30°$; c) $70°, 110°, 70°, 110°$; d) $50°, 100°, 30°$',
            hideInlineSolution: true,
            hints: ['Sett opp en likning med den ukjente vinkelen', 'Bruk at supplementvinkler har sum $180°$ og komplementvinkler har sum $90°$'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
      ...
      content: [
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'lett',
            task: 'Finn stigningstall ($a$) og konstantledd ($b$) for funksjonene',
            subTasks: [
              { label: 'a', task: '$f(x) = 4x + 1$', solution: '$a = 4$, $b = 1$' },
              { label: 'b', task: '$g(x) = -3x + 6$', solution: '$a = -3$, $b = 6$' },
              { label: 'c', task: '$h(x) = 2x$', solution: '$a = 2$, $b = 0$' },
              { label: 'd', task: '$k(x) = -x + 10$', solution: '$a = -1$, $b = 10$' },
              { label: 'e', task: '$p(x) = 8$', solution: '$a = 0$, $b = 8$' },
            ],
            solution: 'a) $a=4, b=1$; b) $a=-3, b=6$; c) $a=2, b=0$; d) $a=-1, b=10$; e) $a=0, b=8$',
            hideInlineSolution: true,
            hints: ['Funksjonen skrives på formen $f(x) = ax + b$'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            subTasks: [
              { label: 'a', task: '$f(x) = 3x - 2$. Finn $f(0)$, $f(1)$ og $f(4)$', solution: '$f(0) = -2$, $f(1) = 1$, $f(4) = 10$' },
              { label: 'b', task: '$g(x) = -2x + 5$. Finn $g(0)$, $g(2)$ og $g(-1)$', solution: '$g(0) = 5$, $g(2) = 1$, $g(-1) = 7$' },
              { label: 'c', task: '$h(x) = x + 4$. Finn $h(-3)$, $h(0)$ og $h(5)$', solution: '$h(-3) = 1$, $h(0) = 4$, $h(5) = 9$' },
              { label: 'd', task: '$k(x) = -x - 1$. Finn $k(-2)$, $k(0)$ og $k(3)$', solution: '$k(-2) = 1$, $k(0) = -1$, $k(3) = -4$' },
            ],
            solution: 'a) $-2, 1, 10$; b) $5, 1, 7$; c) $1, 4, 9$; d) $1, -1, -4$',
            hideInlineSolution: true,
            hints: ['Sett inn verdien for $x$ i funksjonsuttrykket'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'lett',
            task: 'Beskriv hva som skjer med linjen når stigningstallet endres',
            subTasks: [
              { label: 'a', task: 'Stiger eller synker linjen $f(x) = 2x + 1$?', solution: 'Stiger, fordi $a = 2 > 0$' },
              { label: 'b', task: 'Stiger eller synker linjen $g(x) = -4x + 3$?', solution: 'Synker, fordi $a = -4 < 0$' },
              { label: 'c', task: 'Hva slags linje er $h(x) = 7$?', solution: 'Horisontal linje, fordi $a = 0$' },
              { label: 'd', task: 'Hvilken av $f(x) = 2x$ og $g(x) = 5x$ er brattest?', solution: '$g(x) = 5x$ er brattest fordi $|5| > |2|$' },
            ],
            solution: 'a) Stiger; b) Synker; c) Horisontal; d) $g(x) = 5x$',
            hideInlineSolution: true,
            hints: ['$a > 0$: stiger, $a < 0$: synker, $a = 0$: horisontal'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'medium',
            task: 'Finn stigningstallet til linjen gjennom de oppgitte punktene',
            subTasks: [
              { label: 'a', task: '$(1, 3)$ og $(5, 11)$', solution: '$a = \\frac{11 - 3}{5 - 1} = \\frac{8}{4} = 2$' },
              { label: 'b', task: '$(0, 6)$ og $(4, 2)$', solution: '$a = \\frac{2 - 6}{4 - 0} = \\frac{-4}{4} = -1$' },
              { label: 'c', task: '$(-2, 1)$ og $(4, 13)$', solution: '$a = \\frac{13 - 1}{4 - (-2)} = \\frac{12}{6} = 2$' },
              { label: 'd', task: '$(3, 7)$ og $(6, 7)$', solution: '$a = \\frac{7 - 7}{6 - 3} = \\frac{0}{3} = 0$' },
              { label: 'e', task: '$(-1, -5)$ og $(2, 4)$', solution: '$a = \\frac{4 - (-5)}{2 - (-1)} = \\frac{9}{3} = 3$' },
            ],
            solution: 'a) $2$; b) $-1$; c) $2$; d) $0$; e) $3$',
            hideInlineSolution: true,
            hints: ['Bruk formelen $a = \\frac{y_2 - y_1}{x_2 - x_1}$'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
        ...
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'medium',
            task: 'Finn funksjonsuttrykket $f(x) = ax + b$ for linjen',
            subTasks: [
              { label: 'a', task: 'Gjennom $(0, 4)$ med stigningstall $3$', solution: '$f(x) = 3x + 4$' },
              { label: 'b', task: 'Gjennom $(0, -2)$ med stigningstall $-1$', solution: '$f(x) = -x - 2$' },
              { label: 'c', task: 'Gjennom $(0, 0)$ og $(3, 9)$', solution: '$a = \\frac{9}{3} = 3$. $f(x) = 3x$' },
              { label: 'd', task: 'Gjennom $(0, 5)$ og $(2, 1)$', solution: '$a = \\frac{1 - 5}{2 - 0} = -2$. $f(x) = -2x + 5$' },
              { label: 'e', task: 'Gjennom $(1, 4)$ og $(3, 10)$', solution: '$a = \\frac{10 - 4}{3 - 1} = 3$. $b = 4 - 3 \\cdot 1 = 1$. $f(x) = 3x + 1$' },
            ],
            solution: 'a) $f(x) = 3x + 4$; b) $f(x) = -x - 2$; c) $f(x) = 3x$; d) $f(x) = -2x + 5$; e) $f(x) = 3x + 1$',
            hideInlineSolution: true,
            hints: ['Finn stigningstallet $a$ først, deretter konstantleddet $b$', 'Hvis linjen går gjennom $(0, b)$, er konstantleddet $b$'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'vanskelig',
            task: 'Utfordringsoppgaver om lineære funksjoner',
            subTasks: [
              { label: 'a', task: 'Finn skjæringspunktet mellom $f(x) = 2x + 1$ og $g(x) = -x + 7$', solution: '$2x + 1 = -x + 7 \\Rightarrow 3x = 6 \\Rightarrow x = 2$. $f(2) = 5$. Skjæringspunkt: $(2, 5)$' },
              { label: 'b', task: 'En linje går gjennom $(2, 8)$ og $(5, 14)$. For hvilken $x$-verdi er $f(x) = 0$?', solution: '$a = \\frac{14 - 8}{5 - 2} = 2$. $b = 8 - 2 \\cdot 2 = 4$. $f(x) = 2x + 4$. $0 = 2x + 4 \\Rightarrow x = -2$' },
              { label: 'c', task: 'Linje $f$ har stigningstall $3$ og går gjennom $(1, 5)$. Linje $g$ har stigningstall $-1$ og går gjennom $(1, 5)$. Hva er vinkelen mellom linjene?', solution: '$f(x) = 3x + 2$, $g(x) = -x + 6$. Begge går gjennom $(1, 5)$ med ulike stigningstall, så de krysser hverandre i dette punktet.' },
              { label: 'd', task: 'En mobiloperatør tar 50 kr i fast avgift pluss 2 kr per minutt. Sett opp en funksjon $f(x)$ for totalkostnaden, og finn kostnaden for 45 minutter.', solution: '$f(x) = 2x + 50$. $f(45) = 2 \\cdot 45 + 50 = 90 + 50 = 140$ kr' },
            ],
            solution: 'a) $(2, 5)$; b) $x = -2$; c) Krysser i $(1, 5)$; d) $f(x) = 2x + 50$, $f(45) = 140$ kr',
            hideInlineSolution: true,
            hints: ['a) Sett funksjonene lik hverandre', 'b) Finn funksjonsuttrykket først, deretter løs $f(x) = 0$'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
      ...
      content: [
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'lett',
            task: 'Finn proporsjonalitetskonstanten $k$ og den ukjente verdien',
            subTasks: [
              { label: 'a', task: '4 bøker koster 120 kr. Hva koster 7 bøker?', solution: '$k = \\frac{120}{4} = 30$ kr/bok. Pris $= 30 \\cdot 7 = 210$ kr' },
              { label: 'b', task: 'En bil kjører 150 km på 3 timer. Hvor langt kjører den på 5 timer?', solution: '$k = \\frac{150}{3} = 50$ km/t. Distanse $= 50 \\cdot 5 = 250$ km' },
              { label: 'c', task: '6 liter bensin koster 126 kr. Hva koster 10 liter?', solution: '$k = \\frac{126}{6} = 21$ kr/l. Pris $= 21 \\cdot 10 = 210$ kr' },
              { label: 'd', task: '2 kg ost koster 180 kr. Hva koster 3,5 kg?', solution: '$k = \\frac{180}{2} = 90$ kr/kg. Pris $= 90 \\cdot 3{,}5 = 315$ kr' },
            ],
            solution: 'a) $210$ kr; b) $250$ km; c) $210$ kr; d) $315$ kr',
            hideInlineSolution: true,
            hints: ['Finn $k$ ved å dele $y$ på $x$, deretter bruk $y = k \\cdot x$'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            task: 'Avgjør om sammenhengen er proporsjonal. Hvis ja, finn $k$.',
            subTasks: [
              { label: 'a', task: '$x$: 2, 4, 6, 8 og $y$: 6, 12, 18, 24', solution: '$\\frac{6}{2} = \\frac{12}{4} = \\frac{18}{6} = \\frac{24}{8} = 3$. Ja, $k = 3$' },
              { label: 'b', task: '$x$: 1, 3, 5, 7 og $y$: 4, 10, 16, 22', solution: '$\\frac{4}{1} = 4$, $\\frac{10}{3} \\approx 3{,}3$. Nei, forholdet er ikke konstant' },
              { label: 'c', task: '$x$: 5, 10, 15, 20 og $y$: 10, 20, 30, 40', solution: '$\\frac{10}{5} = \\frac{20}{10} = \\frac{30}{15} = \\frac{40}{20} = 2$. Ja, $k = 2$' },
              { label: 'd', task: '$x$: 3, 6, 9 og $y$: 15, 30, 45', solution: '$\\frac{15}{3} = \\frac{30}{6} = \\frac{45}{9} = 5$. Ja, $k = 5$' },
            ],
            solution: 'a) Ja, $k = 3$; b) Nei; c) Ja, $k = 2$; d) Ja, $k = 5$',
            hideInlineSolution: true,
            hints: ['Sjekk om $\\frac{y}{x}$ gir samme verdi for alle par'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            task: 'Løs oppgavene om omvendt proporsjonalitet',
            subTasks: [
              { label: 'a', task: 'Et arbeid tar 8 timer med 3 personer. Hvor lang tid med 6 personer?', solution: '$k = 3 \\cdot 8 = 24$. $t = \\frac{24}{6} = 4$ timer' },
              { label: 'b', task: '4 malere bruker 10 dager. Hvor lang tid med 5 malere?', solution: '$k = 4 \\cdot 10 = 40$. $t = \\frac{40}{5} = 8$ dager' },
              { label: 'c', task: 'En maskin produserer 100 enheter på 5 timer. Hvor lang tid med 2 maskiner?', solution: '$k = 1 \\cdot 5 = 5$ timer per maskin. Med 2 maskiner: $t = \\frac{5}{2} = 2{,}5$ timer' },
              { label: 'd', task: '6 kraner fyller en tank på 2 timer. Hvor lang tid med 4 kraner?', solution: '$k = 6 \\cdot 2 = 12$. $t = \\frac{12}{4} = 3$ timer' },
            ],
            solution: 'a) $4$ timer; b) $8$ dager; c) $2{,}5$ timer; d) $3$ timer',
            hideInlineSolution: true,
            hints: ['Ved omvendt proporsjonalitet er $x \\cdot y = k$ konstant'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'medium',
            task: 'Avgjør om sammenhengen er proporsjonal eller omvendt proporsjonal, og finn $k$',
            subTasks: [
              { label: 'a', task: '$x$: 2, 4, 8 og $y$: 16, 8, 4', solution: '$x \\cdot y = 2 \\cdot 16 = 4 \\cdot 8 = 8 \\cdot 4 = 32$. Omvendt proporsjonal, $k = 32$' },
              { label: 'b', task: '$x$: 3, 6, 9 og $y$: 9, 18, 27', solution: '$\\frac{y}{x} = \\frac{9}{3} = \\frac{18}{6} = \\frac{27}{9} = 3$. Proporsjonal, $k = 3$' },
              { label: 'c', task: '$x$: 1, 5, 10 og $y$: 60, 12, 6', solution: '$x \\cdot y = 1 \\cdot 60 = 5 \\cdot 12 = 10 \\cdot 6 = 60$. Omvendt proporsjonal, $k = 60$' },
              { label: 'd', task: '$x$: 4, 8, 12 og $y$: 20, 40, 60', solution: '$\\frac{y}{x} = \\frac{20}{4} = \\frac{40}{8} = \\frac{60}{12} = 5$. Proporsjonal, $k = 5$' },
            ],
            solution: 'a) Omvendt, $k = 32$; b) Proporsjonal, $k = 3$; c) Omvendt, $k = 60$; d) Proporsjonal, $k = 5$',
            hideInlineSolution: true,
            hints: ['Sjekk først om $\\frac{y}{x}$ er konstant (proporsjonal)', 'Hvis ikke, sjekk om $x \\cdot y$ er konstant (omvendt proporsjonal)'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'medium',
            task: 'Skriv opp funksjonsuttrykket og bruk det til å beregne',
            subTasks: [
              { label: 'a', task: 'Prisen for bananer er proporsjonal med vekten. 2 kg koster 50 kr. Skriv opp $y = kx$ og finn prisen for 4,5 kg.', solution: '$k = \\frac{50}{2} = 25$. $y = 25x$. $y(4{,}5) = 25 \\cdot 4{,}5 = 112{,}50$ kr' },
              { label: 'b', task: 'Fartstiden er omvendt proporsjonal med farten. Med $60$ km/t bruker du $3$ timer. Skriv opp $y = \\frac{k}{x}$ og finn tiden med $90$ km/t.', solution: '$k = 60 \\cdot 3 = 180$. $y = \\frac{180}{x}$. $y(90) = \\frac{180}{90} = 2$ timer' },
              { label: 'c', task: 'En fabrikk produserer $y$ enheter på $x$ timer. Etter 4 timer er det laget 200 enheter. Finn funksjonsuttrykket og antall enheter etter 10 timer.', solution: '$k = \\frac{200}{4} = 50$. $y = 50x$. $y(10) = 50 \\cdot 10 = 500$ enheter' },
            ],
            solution: 'a) $y = 25x$, $112{,}50$ kr; b) $y = \\frac{180}{x}$, $2$ timer; c) $y = 50x$, $500$ enheter',
            hideInlineSolution: true,
            hints: ['Proporsjonal: $y = kx$. Omvendt proporsjonal: $y = \\frac{k}{x}$'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'vanskelig',
            task: 'Utfordringsoppgaver om proporsjonalitet',
            subTasks: [
              { label: 'a', task: 'Er sammenhengen proporsjonal, omvendt proporsjonal eller ingen av delene? $x$: 1, 2, 3, 4 og $y$: 2, 4, 8, 16', solution: '$\\frac{y}{x}$: $2, 2, 2{,}67, 4$ (ikke konstant). $x \\cdot y$: $2, 8, 24, 64$ (ikke konstant). Ingen av delene.' },
              { label: 'b', task: 'To størrelser er proporsjonale. Når $x = 5$ er $y = 35$. Finn $x$ når $y = 56$.', solution: '$k = \\frac{35}{5} = 7$. $56 = 7x \\Rightarrow x = 8$' },
              { label: 'c', task: '5 arbeidere bruker 12 dager på et oppdrag. Etter 4 dager sluttet 2 av arbeiderne. Hvor mange dager til tar det å fullføre?', solution: 'Totalt arbeid: $5 \\cdot 12 = 60$ persondager. Gjort: $5 \\cdot 4 = 20$ persondager. Gjenstår: $40$ persondager. $3$ arbeidere gjenstår: $\\frac{40}{3} \\approx 13{,}3$ dager' },
              { label: 'd', task: 'En oppskrift for 4 personer bruker 300 g mel. Hvor mye mel trengs for 10 personer? Er dette et eksempel på proporsjonalitet?', solution: '$k = \\frac{300}{4} = 75$ g/person. Mel $= 75 \\cdot 10 = 750$ g. Ja, dette er proporsjonal sammenheng.' },
            ],
            solution: 'a) Ingen av delene; b) $x = 8$; c) Ca. $13{,}3$ dager; d) $750$ g, ja proporsjonal',
            hideInlineSolution: true,
            hints: ['Sjekk alltid om forholdet eller produktet er konstant', 'Tenk i persondager for arbeidsoppgaver'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
      ...
      content: [
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'lett',
            task: 'Finn arealet av rektangler og kvadrater',
            subTasks: [
              { label: 'a', task: 'Et rektangel med lengde $12$ cm og bredde $5$ cm', solution: '$A = 12 \\times 5 = 60 \\text{ cm}^2$' },
              { label: 'b', task: 'Et kvadrat med sidelengde $9$ cm', solution: '$A = 9^2 = 81 \\text{ cm}^2$' },
              { label: 'c', task: 'Et rektangel med lengde $7{,}5$ m og bredde $4$ m', solution: '$A = 7{,}5 \\times 4 = 30 \\text{ m}^2$' },
              { label: 'd', task: 'Et kvadrat med sidelengde $11$ mm', solution: '$A = 11^2 = 121 \\text{ mm}^2$' },
            ],
            solution: 'a) $60 \\text{ cm}^2$; b) $81 \\text{ cm}^2$; c) $30 \\text{ m}^2$; d) $121 \\text{ mm}^2$',
            hideInlineSolution: true,
            hints: ['Rektangel: $A = l \\times b$', 'Kvadrat: $A = s^2$'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            task: 'Finn arealet av trekantene',
            subTasks: [
              { label: 'a', task: 'Grunnlinje $10$ cm, høyde $6$ cm', solution: '$A = \\frac{1}{2} \\times 10 \\times 6 = 30 \\text{ cm}^2$' },
              { label: 'b', task: 'Grunnlinje $14$ m, høyde $5$ m', solution: '$A = \\frac{1}{2} \\times 14 \\times 5 = 35 \\text{ m}^2$' },
              { label: 'c', task: 'Grunnlinje $9$ cm, høyde $8$ cm', solution: '$A = \\frac{1}{2} \\times 9 \\times 8 = 36 \\text{ cm}^2$' },
              { label: 'd', task: 'Grunnlinje $16$ mm, høyde $11$ mm', solution: '$A = \\frac{1}{2} \\times 16 \\times 11 = 88 \\text{ mm}^2$' },
            ],
            solution: 'a) $30 \\text{ cm}^2$; b) $35 \\text{ m}^2$; c) $36 \\text{ cm}^2$; d) $88 \\text{ mm}^2$',
            hideInlineSolution: true,
            hints: ['Bruk formelen $A = \\frac{1}{2} \\times g \\times h$'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            task: 'Finn arealet av sirklene. Bruk $\\pi \\approx 3{,}14$.',
            subTasks: [
              { label: 'a', task: 'Radius $4$ cm', solution: '$A = 3{,}14 \\times 4^2 = 3{,}14 \\times 16 = 50{,}24 \\text{ cm}^2$' },
              { label: 'b', task: 'Radius $6$ m', solution: '$A = 3{,}14 \\times 6^2 = 3{,}14 \\times 36 = 113{,}04 \\text{ m}^2$' },
              { label: 'c', task: 'Diameter $14$ cm (finn radius først!)', solution: '$r = 7$ cm. $A = 3{,}14 \\times 7^2 = 3{,}14 \\times 49 = 153{,}86 \\text{ cm}^2$' },
              { label: 'd', task: 'Diameter $20$ m', solution: '$r = 10$ m. $A = 3{,}14 \\times 10^2 = 314 \\text{ m}^2$' },
            ],
            solution: 'a) $50{,}24 \\text{ cm}^2$; b) $113{,}04 \\text{ m}^2$; c) $153{,}86 \\text{ cm}^2$; d) $314 \\text{ m}^2$',
            hideInlineSolution: true,
            hints: ['Bruk formelen $A = \\pi r^2$', 'Husk: diameter $= 2r$, så $r = \\frac{d}{2}$'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'medium',
            task: 'Finn arealet av parallellogrammer og trapeser',
            subTasks: [
              { label: 'a', task: 'Parallellogram med grunnlinje $13$ cm og høyde $7$ cm', solution: '$A = 13 \\times 7 = 91 \\text{ cm}^2$' },
              { label: 'b', task: 'Trapes med parallelle sider $6$ cm og $10$ cm, høyde $5$ cm', solution: '$A = \\frac{(6 + 10) \\times 5}{2} = \\frac{80}{2} = 40 \\text{ cm}^2$' },
              { label: 'c', task: 'Parallellogram med grunnlinje $8{,}5$ m og høyde $6$ m', solution: '$A = 8{,}5 \\times 6 = 51 \\text{ m}^2$' },
              { label: 'd', task: 'Trapes med parallelle sider $9$ m og $15$ m, høyde $8$ m', solution: '$A = \\frac{(9 + 15) \\times 8}{2} = \\frac{192}{2} = 96 \\text{ m}^2$' },
            ],
            solution: 'a) $91 \\text{ cm}^2$; b) $40 \\text{ cm}^2$; c) $51 \\text{ m}^2$; d) $96 \\text{ m}^2$',
            hideInlineSolution: true,
            hints: ['Parallellogram: $A = g \\times h$', 'Trapes: $A = \\frac{(a + b) \\times h}{2}$'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'medium',
            task: 'Finn arealet av sammensatte figurer. Bruk $\\pi \\approx 3{,}14$.',
            subTasks: [
              { label: 'a', task: 'En L-formet figur: rektangel $10 \\times 3$ cm og rektangel $5 \\times 4$ cm', solution: '$A = (10 \\times 3) + (5 \\times 4) = 30 + 20 = 50 \\text{ cm}^2$' },
              { label: 'b', task: 'Et rektangel $15 \\times 10$ m med et sirkelformet hull med radius $3$ m', solution: '$A = 15 \\times 10 - 3{,}14 \\times 3^2 = 150 - 28{,}26 = 121{,}74 \\text{ m}^2$' },
              { label: 'c', task: 'Et rektangel $8 \\times 6$ cm med en halvsirkel (diameter $6$ cm) på den ene kortsiden', solution: '$A = 8 \\times 6 + \\frac{3{,}14 \\times 3^2}{2} = 48 + 14{,}13 = 62{,}13 \\text{ cm}^2$' },
              { label: 'd', task: 'Et kvadrat $12 \\times 12$ cm med en trekant (grunnlinje $12$ cm, høyde $5$ cm) skåret ut', solution: '$A = 12^2 - \\frac{1}{2} \\times 12 \\times 5 = 144 - 30 = 114 \\text{ cm}^2$' },
            ],
            solution: 'a) $50 \\text{ cm}^2$; b) $121{,}74 \\text{ m}^2$; c) $62{,}13 \\text{ cm}^2$; d) $114 \\text{ cm}^2$',
            hideInlineSolution: true,
            hints: ['Del opp i enklere figurer', 'Trekk fra hull fra totalt areal'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'vanskelig',
            task: 'Utfordringsoppgaver om areal',
            subTasks: [
              { label: 'a', task: 'Et rektangel har areal $72 \\text{ cm}^2$ og lengden er dobbelt så stor som bredden. Finn lengden og bredden.', solution: 'La $b$ = bredde. Da er $l = 2b$. $2b \\cdot b = 72$, $2b^2 = 72$, $b^2 = 36$, $b = 6$ cm, $l = 12$ cm.' },
              { label: 'b', task: 'En trekant har areal $45 \\text{ m}^2$ og grunnlinje $10$ m. Finn høyden.', solution: '$\\frac{1}{2} \\times 10 \\times h = 45$, $5h = 45$, $h = 9$ m' },
              { label: 'c', task: 'En sirkel har areal $78{,}5 \\text{ cm}^2$. Finn radius. Bruk $\\pi \\approx 3{,}14$.', solution: '$\\pi r^2 = 78{,}5$, $r^2 = \\frac{78{,}5}{3{,}14} = 25$, $r = 5$ cm' },
              { label: 'd', task: 'Et rom er $5$ m $\\times$ $4$ m. Fliser koster $350$ kr per $\\text{m}^2$. Det er en dør ($0{,}9$ m $\\times$ $2{,}1$ m) som ikke flislegges. Hva koster flisleggingen?', solution: 'Gulvareal: $5 \\times 4 = 20 \\text{ m}^2$. Dør: $0{,}9 \\times 2{,}1 = 1{,}89 \\text{ m}^2$. Flisareal: $20 - 1{,}89 = 18{,}11 \\text{ m}^2$. Pris: $18{,}11 \\times 350 = 6338{,}50$ kr' },
            ],
            solution: 'a) $l = 12$ cm, $b = 6$ cm; b) $h = 9$ m; c) $r = 5$ cm; d) $6338{,}50$ kr',
            hideInlineSolution: true,
            hints: ['Snu formlene for å finne den ukjente', 'Husk at $r = \\sqrt{\\frac{A}{\\pi}}$'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
      ...
      content: [
        {
          ...
          exercise: {
            ...
            task: 'Finn omkretsen av rektanglene',
            subTasks: [
              { label: 'a', task: 'Lengde $11$ cm, bredde $5$ cm', solution: '$O = 2 \\cdot 11 + 2 \\cdot 5 = 22 + 10 = 32$ cm' },
              { label: 'b', task: 'Lengde $9$ m, bredde $4$ m', solution: '$O = 2 \\cdot 9 + 2 \\cdot 4 = 18 + 8 = 26$ m' },
              { label: 'c', task: 'Lengde $15$ cm, bredde $8$ cm', solution: '$O = 2 \\cdot 15 + 2 \\cdot 8 = 30 + 16 = 46$ cm' },
              { label: 'd', task: 'Lengde $6{,}5$ m, bredde $3{,}5$ m', solution: '$O = 2 \\cdot 6{,}5 + 2 \\cdot 3{,}5 = 13 + 7 = 20$ m' },
            ],
            solution: 'a) $32$ cm; b) $26$ m; c) $46$ cm; d) $20$ m',
            hideInlineSolution: true,
            hints: ['Bruk formelen $O = 2l + 2b$'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'lett',
            task: 'Finn omkretsen av kvadrater og trekanter',
            subTasks: [
              { label: 'a', task: 'Kvadrat med sidelengde $8$ cm', solution: '$O = 4 \\cdot 8 = 32$ cm' },
              { label: 'b', task: 'Kvadrat med sidelengde $4{,}5$ m', solution: '$O = 4 \\cdot 4{,}5 = 18$ m' },
              { label: 'c', task: 'Trekant med sider $5$ cm, $7$ cm og $10$ cm', solution: '$O = 5 + 7 + 10 = 22$ cm' },
              { label: 'd', task: 'Likesidet trekant med sidelengde $6$ cm', solution: '$O = 3 \\cdot 6 = 18$ cm' },
            ],
            solution: 'a) $32$ cm; b) $18$ m; c) $22$ cm; d) $18$ cm',
            hideInlineSolution: true,
            hints: ['Kvadrat: $O = 4s$', 'Trekant: $O = a + b + c$'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'lett',
            task: 'Finn omkretsen av sirklene. Bruk $\\pi \\approx 3{,}14$.',
            subTasks: [
              { label: 'a', task: 'Radius $5$ cm', solution: '$O = 2 \\cdot 3{,}14 \\cdot 5 = 31{,}4$ cm' },
              { label: 'b', task: 'Radius $8$ m', solution: '$O = 2 \\cdot 3{,}14 \\cdot 8 = 50{,}24 \\approx 50{,}2$ m' },
              { label: 'c', task: 'Diameter $14$ cm', solution: '$O = 3{,}14 \\cdot 14 = 43{,}96 \\approx 44{,}0$ cm' },
              { label: 'd', task: 'Diameter $20$ m', solution: '$O = 3{,}14 \\cdot 20 = 62{,}8$ m' },
            ],
            solution: 'a) $31{,}4$ cm; b) $50{,}2$ m; c) $44{,}0$ cm; d) $62{,}8$ m',
            hideInlineSolution: true,
            hints: ['Med radius: $O = 2\\pi r$', 'Med diameter: $O = \\pi d$'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'medium',
            task: 'Finn den ukjente lengden når omkretsen er gitt',
            subTasks: [
              { label: 'a', task: 'Et rektangel har omkrets $34$ cm og lengde $10$ cm. Finn bredden.', solution: '$2 \\cdot 10 + 2b = 34$, $2b = 14$, $b = 7$ cm' },
              { label: 'b', task: 'Et kvadrat har omkrets $52$ m. Finn sidelengden.', solution: '$4s = 52$, $s = 13$ m' },
              { label: 'c', task: 'En sirkel har omkrets $25{,}12$ cm. Finn radius. Bruk $\\pi \\approx 3{,}14$.', solution: '$2 \\cdot 3{,}14 \\cdot r = 25{,}12$, $6{,}28r = 25{,}12$, $r = 4$ cm' },
              { label: 'd', task: 'En likebeint trekant har omkrets $30$ cm. De to like sidene er $11$ cm hver. Finn den tredje siden.', solution: '$11 + 11 + c = 30$, $c = 8$ cm' },
              { label: 'e', task: 'Et rektangel har omkrets $40$ cm og bredden er halvparten av lengden. Finn begge målene.', solution: '$2l + 2 \\cdot \\frac{l}{2} = 40$, $3l = 40$, $l \\approx 13{,}3$ cm, $b \\approx 6{,}7$ cm' },
            ],
            solution: 'a) $7$ cm; b) $13$ m; c) $4$ cm; d) $8$ cm; e) $l \\approx 13{,}3$ cm, $b \\approx 6{,}7$ cm',
            hideInlineSolution: true,
            hints: ['Sett det du vet inn i formelen og løs for den ukjente'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'medium',
            task: 'Praktiske omkretsoppgaver. Bruk $\\pi \\approx 3{,}14$.',
            subTasks: [
              { label: 'a', task: 'En rektangulær hage er $20$ m lang og $12$ m bred. Gjerde koster $85$ kr per meter. Hva koster det å gjerde inn hele hagen?', solution: '$O = 2 \\cdot 20 + 2 \\cdot 12 = 64$ m. Pris $= 64 \\cdot 85 = 5440$ kr' },
              { label: 'b', task: 'Et sykkelhjul har diameter $65$ cm. Hvor langt (i meter) har sykkelen rullet etter $100$ omdreninger?', solution: '$O = 3{,}14 \\cdot 65 = 204{,}1$ cm per omdreining. Totalt: $204{,}1 \\cdot 100 = 20410$ cm $= 204{,}1$ m' },
              { label: 'c', task: 'En halvsirkelformet vindu har diameter $80$ cm. Hvor mye kantlist trengs rundt vinduet?', solution: 'Buet del: $\\frac{3{,}14 \\cdot 80}{2} = 125{,}6$ cm. Rett del: $80$ cm. Totalt: $125{,}6 + 80 = 205{,}6$ cm' },
            ],
            solution: 'a) $5440$ kr; b) $204{,}1$ m; c) $205{,}6$ cm',
            hideInlineSolution: true,
            hints: ['Finn omkretsen først, deretter bruk den i beregningen'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'vanskelig',
            task: 'Utfordringsoppgaver om omkrets. Bruk $\\pi \\approx 3{,}14$.',
            subTasks: [
              { label: 'a', task: 'En løpebane har form som et rektangel ($80$ m $\\times$ $40$ m) med halvsirkler i hver ende (diameter $40$ m). Finn lengden på én runde.', solution: 'Rette sider: $2 \\cdot 80 = 160$ m. To halvsirkler = én sirkel: $O = 3{,}14 \\cdot 40 = 125{,}6$ m. Totalt: $160 + 125{,}6 = 285{,}6$ m' },
              { label: 'b', task: 'Et rektangel og en sirkel har begge omkrets $24$ cm. Rektangelets lengde er $8$ cm. Hvilken figur har størst areal?', solution: 'Rektangel: $b = \\frac{24 - 16}{2} = 4$ cm. $A_{\\text{rekt}} = 8 \\times 4 = 32 \\text{ cm}^2$. Sirkel: $r = \\frac{24}{2\\pi} = \\frac{24}{6{,}28} \\approx 3{,}82$ cm. $A_{\\text{sirkel}} = 3{,}14 \\times 3{,}82^2 \\approx 45{,}8 \\text{ cm}^2$. Sirkelen har størst areal.' },
              { label: 'c', task: 'En figur er satt sammen av et rektangel ($10$ cm $\\times$ $6$ cm) med et kvadrat ($3$ cm $\\times$ $3$ cm) skåret ut fra et hjørne. Finn omkretsen.', solution: 'Yttersider: $10 + 6 + 7 + 3 + 3 + 3 = 32$ cm. (Tegn figuren for å se alle yttersider.)' },
              { label: 'd', task: 'Tre like store sirkler med radius $2$ cm legges tett inntil hverandre i en trekantformasjon. Finn den totale omkretsen av figuren (bare ytterkanten).', solution: 'Hver sirkel bidrar med $\\frac{2}{3}$ av sin omkrets (den eksperte delen). Total bue: $3 \\times \\frac{2}{3} \\times 2\\pi \\times 2 = 8\\pi \\approx 25{,}1$ cm' },
            ],
            solution: 'a) $285{,}6$ m; b) Sirkelen ($45{,}8$ vs $32$ cm$^2$); c) $32$ cm; d) $\\approx 25{,}1$ cm',
            hideInlineSolution: true,
            hints: ['Tegn alltid figuren først', 'For sammensatte figurer: tell bare ytterkantene'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
      ...
      content: [
        {
          ...
          exercise: {
            ...
            task: 'Regn ut volumet av kubene',
            subTasks: [
              { label: 'a', task: 'Sidekant $3$ cm', solution: '$V = 3^3 = 27$ cm$^3$' },
              { label: 'b', task: 'Sidekant $7$ cm', solution: '$V = 7^3 = 343$ cm$^3$' },
              { label: 'c', task: 'Sidekant $5$ m', solution: '$V = 5^3 = 125$ m$^3$' },
              { label: 'd', task: 'Sidekant $1{,}5$ cm', solution: '$V = 1{,}5^3 = 3{,}375$ cm$^3$' },
            ],
            solution: 'a) $27$ cm$^3$; b) $343$ cm$^3$; c) $125$ m$^3$; d) $3{,}375$ cm$^3$',
            hideInlineSolution: true,
            hints: ['Bruk formelen $V = s^3 = s \\cdot s \\cdot s$'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'lett',
            task: 'Regn ut volumet av de firkantede prismene',
            subTasks: [
              { label: 'a', task: 'Lengde $8$ cm, bredde $5$ cm, høyde $4$ cm', solution: '$V = 8 \\cdot 5 \\cdot 4 = 160$ cm$^3$' },
              { label: 'b', task: 'Lengde $12$ cm, bredde $3$ cm, høyde $7$ cm', solution: '$V = 12 \\cdot 3 \\cdot 7 = 252$ cm$^3$' },
              { label: 'c', task: 'Lengde $20$ cm, bredde $10$ cm, høyde $5$ cm', solution: '$V = 20 \\cdot 10 \\cdot 5 = 1000$ cm$^3$' },
              { label: 'd', task: 'Lengde $3$ m, bredde $2{,}5$ m, høyde $2$ m', solution: '$V = 3 \\cdot 2{,}5 \\cdot 2 = 15$ m$^3$' },
            ],
            solution: 'a) $160$ cm$^3$; b) $252$ cm$^3$; c) $1000$ cm$^3$; d) $15$ m$^3$',
            hideInlineSolution: true,
            hints: ['Bruk formelen $V = l \\cdot b \\cdot h$'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
        ...
        },
        {
          ...
          exercise: {
            ...
            subTasks: [
              { label: 'a', task: '$5000$ cm$^3$ til liter', solution: '$\\frac{5000}{1000} = 5$ liter' },
              { label: 'b', task: '$3{,}5$ m$^3$ til liter', solution: '$3{,}5 \\cdot 1000 = 3500$ liter' },
              { label: 'c', task: '$800$ ml til cm$^3$', solution: '$800$ ml $= 800$ cm$^3$' },
              { label: 'd', task: '$0{,}4$ dm$^3$ til cm$^3$', solution: '$0{,}4 \\cdot 1000 = 400$ cm$^3$' },
              { label: 'e', task: '$12500$ cm$^3$ til dm$^3$', solution: '$\\frac{12500}{1000} = 12{,}5$ dm$^3$' },
            ],
            solution: 'a) $5$ liter; b) $3500$ liter; c) $800$ cm$^3$; d) $400$ cm$^3$; e) $12{,}5$ dm$^3$',
            hideInlineSolution: true,
            hints: ['$1$ liter $= 1$ dm$^3$ $= 1000$ cm$^3$', '$1$ m$^3$ $= 1000$ liter'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'medium',
            task: 'Regn ut volumet av sylindrene. Gi svaret eksakt (med $\\pi$) og avrundet.',
            subTasks: [
              { label: 'a', task: 'Radius $4$ cm, høyde $10$ cm', solution: '$V = \\pi \\cdot 4^2 \\cdot 10 = 160\\pi \\approx 502$ cm$^3$' },
              { label: 'b', task: 'Radius $6$ cm, høyde $5$ cm', solution: '$V = \\pi \\cdot 6^2 \\cdot 5 = 180\\pi \\approx 565$ cm$^3$' },
              { label: 'c', task: 'Diameter $10$ cm, høyde $12$ cm', solution: '$r = 5$ cm. $V = \\pi \\cdot 5^2 \\cdot 12 = 300\\pi \\approx 942$ cm$^3$' },
              { label: 'd', task: 'Radius $3$ cm, høyde $20$ cm. Gjør om til liter.', solution: '$V = \\pi \\cdot 3^2 \\cdot 20 = 180\\pi \\approx 565$ cm$^3$ $\\approx 0{,}57$ liter' },
            ],
            solution: 'a) $160\\pi \\approx 502$ cm$^3$; b) $180\\pi \\approx 565$ cm$^3$; c) $300\\pi \\approx 942$ cm$^3$; d) $180\\pi \\approx 0{,}57$ liter',
            hideInlineSolution: true,
            hints: ['Bruk formelen $V = \\pi r^2 h$', 'Husk: diameter $= 2r$'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'medium',
            task: 'Praktiske volumoppgaver',
            subTasks: [
              { label: 'a', task: 'Et akvarium er $60$ cm langt, $30$ cm bredt og $40$ cm høyt. Hvor mange liter vann rommer det?', solution: '$V = 60 \\cdot 30 \\cdot 40 = 72000$ cm$^3$ $= 72$ liter' },
              { label: 'b', task: 'En terning med side $15$ cm fylles med sand. Hvor mange liter sand er det?', solution: '$V = 15^3 = 3375$ cm$^3$ $= 3{,}375$ liter' },
              { label: 'c', task: 'Et basseng er $12$ m langt, $6$ m bredt og $1{,}5$ m dypt. Vannet skal fylles opp til $10$ cm under kanten. Hvor mange liter vann trengs?', solution: 'Vannhøyde: $1{,}5 - 0{,}1 = 1{,}4$ m. $V = 12 \\cdot 6 \\cdot 1{,}4 = 100{,}8$ m$^3$ $= 100800$ liter' },
              { label: 'd', task: 'En sylinderformet vannflaske har radius $3{,}5$ cm og høyde $20$ cm. Hvor mange dl rommer den?', solution: '$V = \\pi \\cdot 3{,}5^2 \\cdot 20 = 245\\pi \\approx 770$ cm$^3$ $= 0{,}77$ liter $\\approx 7{,}7$ dl' },
            ],
            solution: 'a) $72$ liter; b) $3{,}375$ liter; c) $100800$ liter; d) $\\approx 7{,}7$ dl',
            hideInlineSolution: true,
            hints: ['Identifiser riktig romfigur', 'Husk omregning: $1000$ cm$^3$ $= 1$ liter'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'vanskelig',
            task: 'Utfordringsoppgaver om volum',
            subTasks: [
              { label: 'a', task: 'En kube har volum $729$ cm$^3$. Finn sidekanten.', solution: '$s^3 = 729$, $s = \\sqrt[3]{729} = 9$ cm' },
              { label: 'b', task: 'En firkantet prisme har lengde $10$ cm, bredde $6$ cm og volum $420$ cm$^3$. Finn høyden.', solution: '$10 \\cdot 6 \\cdot h = 420$, $60h = 420$, $h = 7$ cm' },
              { label: 'c', task: 'Et rør har ytre radius $5$ cm, indre radius $4$ cm og er $2$ m langt. Finn volumet av selve rørmaterialet.', solution: '$V = \\pi \\cdot 5^2 \\cdot 200 - \\pi \\cdot 4^2 \\cdot 200 = \\pi \\cdot 200 \\cdot (25 - 16) = 1800\\pi \\approx 5655$ cm$^3$' },
              { label: 'd', task: 'En sylinder og en kube har begge volum $1000$ cm$^3$. Sylinderens høyde er $10$ cm. Finn radius for sylinderen og sidelengden for kuben.', solution: 'Kube: $s = \\sqrt[3]{1000} = 10$ cm. Sylinder: $\\pi r^2 \\cdot 10 = 1000$, $r^2 = \\frac{100}{\\pi} \\approx 31{,}83$, $r \\approx 5{,}64$ cm' },
            ],
            solution: 'a) $9$ cm; b) $7$ cm; c) $1800\\pi \\approx 5655$ cm$^3$; d) Kube: $s = 10$ cm, sylinder: $r \\approx 5{,}64$ cm',
            hideInlineSolution: true,
            hints: ['Snu volumformelen for å finne den ukjente', 'For rørmaterialet: trekk indre volum fra ytre volum'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
      ...
      content: [
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'lett',
            task: 'Bestem hva slags vinkel dette er (spiss, rett, stump eller strak)',
            subTasks: [
              { label: 'a', task: '$45°$', solution: 'Spiss vinkel (mindre enn $90°$)' },
              { label: 'b', task: '$90°$', solution: 'Rett vinkel (nøyaktig $90°$)' },
              { label: 'c', task: '$120°$', solution: 'Stump vinkel (mellom $90°$ og $180°$)' },
              { label: 'd', task: '$180°$', solution: 'Strak vinkel (nøyaktig $180°$)' },
              { label: 'e', task: '$73°$', solution: 'Spiss vinkel (mindre enn $90°$)' },
              { label: 'f', task: '$155°$', solution: 'Stump vinkel (mellom $90°$ og $180°$)' },
            ],
            solution: 'a) Spiss, b) Rett, c) Stump, d) Strak, e) Spiss, f) Stump',
            hideInlineSolution: true,
            hints: ['Spiss: < 90°, Rett: = 90°, Stump: 90°–180°, Strak: = 180°'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'lett',
            task: 'Finn den ukjente vinkelen i trekanten (vinkelsummen er 180°)',
            subTasks: [
              { label: 'a', task: 'To vinkler er $60°$ og $80°$', solution: '$180° - 60° - 80° = 40°$' },
              { label: 'b', task: 'To vinkler er $90°$ og $35°$', solution: '$180° - 90° - 35° = 55°$' },
              { label: 'c', task: 'To vinkler er $45°$ og $45°$', solution: '$180° - 45° - 45° = 90°$' },
              { label: 'd', task: 'To vinkler er $70°$ og $70°$', solution: '$180° - 70° - 70° = 40°$' },
              { label: 'e', task: 'To vinkler er $30°$ og $60°$', solution: '$180° - 30° - 60° = 90°$' },
            ],
            solution: 'a) 40°, b) 55°, c) 90°, d) 40°, e) 90°',
            hideInlineSolution: true,
            hints: ['Summen av alle vinklene i en trekant er alltid 180°'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'lett',
            task: 'Bestem hva slags trekant dette er ut fra vinklene',
            subTasks: [
              { label: 'a', task: 'Vinkler: $60°$, $60°$, $60°$', solution: 'Likesidet trekant (alle vinkler like)' },
              { label: 'b', task: 'Vinkler: $90°$, $45°$, $45°$', solution: 'Rettvinklet og likebeint trekant' },
              { label: 'c', task: 'Vinkler: $120°$, $30°$, $30°$', solution: 'Stumpvinklet og likebeint trekant' },
              { label: 'd', task: 'Vinkler: $50°$, $60°$, $70°$', solution: 'Spissvinklet trekant (alle vinkler er spisse)' },
            ],
            solution: 'a) Likesidet, b) Rettvinklet likebeint, c) Stumpvinklet likebeint, d) Spissvinklet',
            hideInlineSolution: true,
            hints: ['Se på den største vinkelen: er den 90°, over 90° eller under 90°?'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'medium',
            task: 'To linjer krysser hverandre. Finn de ukjente vinklene',
            subTasks: [
              { label: 'a', task: 'Vinkel $A = 65°$. Finn toppvinkelen og de to nabovinklene.', solution: 'Toppvinkel $= 65°$. Nabovinkler $= 180° - 65° = 115°$' },
              { label: 'b', task: 'Vinkel $A = 132°$. Finn toppvinkelen og de to nabovinklene.', solution: 'Toppvinkel $= 132°$. Nabovinkler $= 180° - 132° = 48°$' },
              { label: 'c', task: 'En nabovinkel er dobbelt så stor som den andre. Finn begge vinklene.', solution: '$x + 2x = 180° \\Rightarrow 3x = 180° \\Rightarrow x = 60°$. Vinklene er $60°$ og $120°$' },
              { label: 'd', task: 'Differansen mellom to nabovinkler er $40°$. Finn begge.', solution: '$x + (x + 40°) = 180° \\Rightarrow 2x = 140° \\Rightarrow x = 70°$. Vinklene er $70°$ og $110°$' },
            ],
            solution: 'a) 65° og 115°, b) 132° og 48°, c) 60° og 120°, d) 70° og 110°',
            hideInlineSolution: true,
            hints: ['Toppvinkler er like store. Nabovinkler har sum 180°.'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
        ...
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'medium',
            task: 'Finn de ukjente vinklene i trekanten',
            subTasks: [
              { label: 'a', task: 'En likebeint trekant har toppvinkel $50°$. Finn grunnvinklene.', solution: 'Grunnvinklene er like: $\\frac{180° - 50°}{2} = \\frac{130°}{2} = 65°$' },
              { label: 'b', task: 'En likebeint trekant har grunnvinkel $72°$. Finn toppvinkelen.', solution: '$180° - 2 \\cdot 72° = 180° - 144° = 36°$' },
              { label: 'c', task: 'I en rettvinklet trekant er en av de spisse vinklene $37°$. Finn den andre.', solution: '$180° - 90° - 37° = 53°$' },
              { label: 'd', task: 'To av vinklene i en trekant er like store, og den tredje er $100°$. Finn de to like vinklene.', solution: '$\\frac{180° - 100°}{2} = \\frac{80°}{2} = 40°$' },
              { label: 'e', task: 'Den ene vinkelen i en trekant er tre ganger så stor som de to andre (som er like). Finn alle vinklene.', solution: '$x + x + 3x = 180° \\Rightarrow 5x = 180° \\Rightarrow x = 36°$. Vinklene: $36°$, $36°$, $108°$' },
            ],
            solution: 'a) 65°, b) 36°, c) 53°, d) 40°, e) 36°, 36°, 108°',
            hideInlineSolution: true,
        ...
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'vanskelig',
            task: 'Utfordringsoppgaver med vinkler og trekanter',
            subTasks: [
              { label: 'a', task: 'I en trekant er forholdet mellom vinklene $2:3:4$. Finn alle tre vinklene.', solution: '$2x + 3x + 4x = 180° \\Rightarrow 9x = 180° \\Rightarrow x = 20°$. Vinklene: $40°$, $60°$, $80°$' },
              { label: 'b', task: 'En trekant har én vinkel som er $20°$ mer enn den minste, og den tredje er $30°$ mer enn den minste. Finn alle vinklene.', solution: '$x + (x+20°) + (x+30°) = 180° \\Rightarrow 3x + 50° = 180° \\Rightarrow x = \\frac{130°}{3} \\approx 43{,}3°$. Vinklene: ca. $43{,}3°$, $63{,}3°$, $73{,}3°$' },
              { label: 'c', task: 'I en firkant (vinkelsum $360°$) er tre av vinklene $80°$, $90°$ og $110°$. Finn den fjerde.', solution: '$360° - 80° - 90° - 110° = 80°$' },
              { label: 'd', task: 'To trekanter deler én side. I den ene trekanten er de to kjente vinklene $50°$ og $70°$. Hva er den tredje vinkelen, og hva er dens toppvinkel i den andre trekanten?', solution: 'Tredje vinkel: $180° - 50° - 70° = 60°$. Toppvinkelen er $60°$ (toppvinkler er like).' },
            ],
            solution: 'a) 40°, 60°, 80°. b) ca. 43,3°, 63,3°, 73,3°. c) 80°. d) 60° og 60°',
            hideInlineSolution: true,
            hints: ['Sett opp en likning der summen av vinklene er 180° (trekant) eller 360° (firkant)'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
      ...
      content: [
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'lett',
            task: 'Regn ut omkretsen av figurene',
            subTasks: [
              { label: 'a', task: 'Kvadrat med side $7$ cm', solution: '$O = 4 \\cdot 7 = 28$ cm' },
              { label: 'b', task: 'Rektangel med lengde $12$ cm og bredde $5$ cm', solution: '$O = 2 \\cdot (12 + 5) = 2 \\cdot 17 = 34$ cm' },
              { label: 'c', task: 'Likesidet trekant med side $9$ cm', solution: '$O = 3 \\cdot 9 = 27$ cm' },
              { label: 'd', task: 'Rektangel med lengde $15$ m og bredde $8$ m', solution: '$O = 2 \\cdot (15 + 8) = 2 \\cdot 23 = 46$ m' },
            ],
            solution: 'a) 28 cm, b) 34 cm, c) 27 cm, d) 46 m',
            hideInlineSolution: true,
            hints: ['Omkrets = summen av alle sidene'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'lett',
            task: 'Regn ut arealet av figurene',
            subTasks: [
              { label: 'a', task: 'Kvadrat med side $6$ cm', solution: '$A = 6^2 = 36$ cm²' },
              { label: 'b', task: 'Rektangel med lengde $10$ cm og bredde $4$ cm', solution: '$A = 10 \\cdot 4 = 40$ cm²' },
              { label: 'c', task: 'Trekant med grunnlinje $8$ cm og høyde $5$ cm', solution: '$A = \\frac{8 \\cdot 5}{2} = 20$ cm²' },
              { label: 'd', task: 'Trekant med grunnlinje $14$ m og høyde $6$ m', solution: '$A = \\frac{14 \\cdot 6}{2} = 42$ m²' },
              { label: 'e', task: 'Rektangel med lengde $3{,}5$ m og bredde $2$ m', solution: '$A = 3{,}5 \\cdot 2 = 7$ m²' },
            ],
            solution: 'a) 36 cm², b) 40 cm², c) 20 cm², d) 42 m², e) 7 m²',
            hideInlineSolution: true,
            hints: ['Areal av rektangel: lengde ganger bredde. Areal av trekant: grunnlinje ganger høyde delt på 2.'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'lett',
            task: 'Regn ut areal og omkrets av sirkler (bruk $\\pi \\approx 3{,}14$)',
            subTasks: [
              { label: 'a', task: 'Sirkel med radius $5$ cm: Finn omkretsen.', solution: '$O = 2 \\cdot 3{,}14 \\cdot 5 = 31{,}4$ cm' },
              { label: 'b', task: 'Sirkel med radius $5$ cm: Finn arealet.', solution: '$A = 3{,}14 \\cdot 5^2 = 3{,}14 \\cdot 25 = 78{,}5$ cm²' },
              { label: 'c', task: 'Sirkel med radius $10$ m: Finn omkretsen.', solution: '$O = 2 \\cdot 3{,}14 \\cdot 10 = 62{,}8$ m' },
              { label: 'd', task: 'Sirkel med radius $10$ m: Finn arealet.', solution: '$A = 3{,}14 \\cdot 10^2 = 314$ m²' },
              { label: 'e', task: 'Sirkel med diameter $8$ cm: Finn arealet.', solution: 'Radius $= 4$ cm. $A = 3{,}14 \\cdot 4^2 = 3{,}14 \\cdot 16 = 50{,}24$ cm²' },
            ],
            solution: 'a) 31,4 cm, b) 78,5 cm², c) 62,8 m, d) 314 m², e) 50,24 cm²',
            hideInlineSolution: true,
            hints: ['Omkrets av sirkel: $O = 2\\pi r$. Areal av sirkel: $A = \\pi r^2$. Husk: radius = diameter delt på 2.'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            subTasks: [
              { label: 'a', task: 'Et L-formet rom: et rektangel $8 \\times 4$ m og et rektangel $3 \\times 2$ m som stikker ut.', solution: '$A = 8 \\cdot 4 + 3 \\cdot 2 = 32 + 6 = 38$ m²' },
              { label: 'b', task: 'Et rektangel $10 \\times 6$ m med et kvadratisk hull $2 \\times 2$ m.', solution: '$A = 10 \\cdot 6 - 2 \\cdot 2 = 60 - 4 = 56$ m²' },
              { label: 'c', task: 'En halvsirkel med diameter $12$ cm.', solution: '$A = \\frac{\\pi r^2}{2} = \\frac{3{,}14 \\cdot 6^2}{2} = \\frac{113{,}04}{2} = 56{,}52$ cm²' },
              { label: 'd', task: 'Et rektangel $8 \\times 5$ m med en halvsirkel (diameter $5$ m) på kortsiden.', solution: '$A = 8 \\cdot 5 + \\frac{3{,}14 \\cdot 2{,}5^2}{2} = 40 + 9{,}81 \\approx 49{,}8$ m²' },
            ],
            solution: 'a) 38 m², b) 56 m², c) 56,52 cm², d) ca. 49,8 m²',
            hideInlineSolution: true,
            hints: ['Del figuren opp i enklere former og legg sammen arealene, eller trekk fra hull.'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            subTasks: [
              ...
              { label: 'b', task: 'Et kvadrat har areal $81$ m². Finn sidene.', solution: '$s = \\sqrt{81} = 9$ m' },
              { label: 'c', task: 'En trekant har areal $30$ cm² og grunnlinje $10$ cm. Finn høyden.', solution: '$30 = \\frac{10 \\cdot h}{2} \\Rightarrow h = \\frac{30 \\cdot 2}{10} = 6$ cm' },
              { label: 'd', task: 'En sirkel har areal $200{,}96$ cm². Finn radius. (Bruk $\\pi \\approx 3{,}14$)', solution: '$r^2 = \\frac{200{,}96}{3{,}14} = 64 \\Rightarrow r = 8$ cm' },
              { label: 'e', task: 'Et rektangel har omkrets $36$ cm og lengde $11$ cm. Finn bredden.', solution: '$2(11 + b) = 36 \\Rightarrow 11 + b = 18 \\Rightarrow b = 7$ cm' },
            ],
            solution: 'a) 6 cm, b) 9 m, c) 6 cm, d) 8 cm, e) 7 cm',
            hideInlineSolution: true,
            hints: ['Bruk arealformelen og løs for den ukjente størrelsen'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'vanskelig',
            task: 'Tekstoppgaver med areal og omkrets',
            subTasks: [
              { label: 'a', task: 'En bonde skal gjerde inn en rektangulær hage som er $25$ m lang og $18$ m bred. Gjerde koster $85$ kr per meter. Hva koster det totalt?', solution: '$O = 2(25 + 18) = 86$ m. Pris: $86 \\cdot 85 = 7310$ kr' },
              { label: 'b', task: 'Et sirkelformet basseng har diameter $10$ m. Rundt bassenget skal det legges fliser i en $1$ m bred stripe. Finn arealet av flisstripen.', solution: 'Ytre sirkel: $A_1 = 3{,}14 \\cdot 6^2 = 113{,}04$ m². Basseng: $A_2 = 3{,}14 \\cdot 5^2 = 78{,}5$ m². Stripe: $113{,}04 - 78{,}5 = 34{,}54$ m²' },
              { label: 'c', task: 'En fotballbane er $100$ m lang og $65$ m bred. Hvor mange runder må du løpe for å tilbakelegge minst $2$ km?', solution: '$O = 2(100 + 65) = 330$ m. Antall runder: $\\frac{2000}{330} \\approx 6{,}06$. Du må løpe $7$ runder.' },
              { label: 'd', task: 'Et rom er $5$ m $\\times$ $4$ m. Det koster $350$ kr/m² å legge parkett. Det er en dør ($0{,}9$ m $\\times$ $2{,}1$ m) som ikke trenger parkett. Hva koster parketten?', solution: 'Areal rom: $5 \\cdot 4 = 20$ m². Dør tar ikke gulvplass, så alt gulv trenger parkett: $20 \\cdot 350 = 7000$ kr' },
            ],
            solution: 'a) 7310 kr, b) ca. 34,5 m², c) 7 runder, d) 7000 kr',
            hideInlineSolution: true,
            hints: ['Tegn en skisse og skriv ned formelen du trenger før du regner'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
      ...
      content: [
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'lett',
            task: 'Bruk Pytagoras til å finne hypotenusen $c$',
            subTasks: [
              { label: 'a', task: '$a = 3$, $b = 4$', solution: '$c = \\sqrt{3^2 + 4^2} = \\sqrt{9 + 16} = \\sqrt{25} = 5$' },
              { label: 'b', task: '$a = 6$, $b = 8$', solution: '$c = \\sqrt{6^2 + 8^2} = \\sqrt{36 + 64} = \\sqrt{100} = 10$' },
              { label: 'c', task: '$a = 5$, $b = 12$', solution: '$c = \\sqrt{5^2 + 12^2} = \\sqrt{25 + 144} = \\sqrt{169} = 13$' },
              { label: 'd', task: '$a = 8$, $b = 15$', solution: '$c = \\sqrt{8^2 + 15^2} = \\sqrt{64 + 225} = \\sqrt{289} = 17$' },
            ],
            solution: 'a) 5, b) 10, c) 13, d) 17',
            hideInlineSolution: true,
        ...
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'lett',
            task: 'Bruk Pytagoras til å finne den ukjente kateten',
            subTasks: [
              { label: 'a', task: '$c = 10$, $a = 6$. Finn $b$.', solution: '$b = \\sqrt{10^2 - 6^2} = \\sqrt{100 - 36} = \\sqrt{64} = 8$' },
              { label: 'b', task: '$c = 13$, $b = 5$. Finn $a$.', solution: '$a = \\sqrt{13^2 - 5^2} = \\sqrt{169 - 25} = \\sqrt{144} = 12$' },
              { label: 'c', task: '$c = 17$, $a = 8$. Finn $b$.', solution: '$b = \\sqrt{17^2 - 8^2} = \\sqrt{289 - 64} = \\sqrt{225} = 15$' },
              { label: 'd', task: '$c = 25$, $b = 7$. Finn $a$.', solution: '$a = \\sqrt{25^2 - 7^2} = \\sqrt{625 - 49} = \\sqrt{576} = 24$' },
            ],
            solution: 'a) 8, b) 12, c) 15, d) 24',
            hideInlineSolution: true,
            hints: ['Katet $= \\sqrt{c^2 - \\text{andre katet}^2}$'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'lett',
            task: 'Er trekanten rettvinklet? Sjekk med Pytagoras.',
            subTasks: [
              { label: 'a', task: 'Sider: $3$, $4$, $5$', solution: '$3^2 + 4^2 = 9 + 16 = 25 = 5^2$. Ja, rettvinklet.' },
              { label: 'b', task: 'Sider: $7$, $10$, $12$', solution: '$7^2 + 10^2 = 49 + 100 = 149 \\neq 144 = 12^2$. Nei, ikke rettvinklet.' },
              { label: 'c', task: 'Sider: $20$, $21$, $29$', solution: '$20^2 + 21^2 = 400 + 441 = 841 = 29^2$. Ja, rettvinklet.' },
              { label: 'd', task: 'Sider: $10$, $24$, $26$', solution: '$10^2 + 24^2 = 100 + 576 = 676 = 26^2$. Ja, rettvinklet.' },
            ],
            solution: 'a) Ja, b) Nei, c) Ja, d) Ja',
            hideInlineSolution: true,
            hints: ['Sjekk om $a^2 + b^2 = c^2$ der $c$ er den lengste siden'],
        ...
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'medium',
            task: 'Finn den ukjente siden (avrund til én desimal)',
            subTasks: [
              { label: 'a', task: 'Rettvinklet trekant med kateter $4$ og $7$. Finn hypotenusen.', solution: '$c = \\sqrt{4^2 + 7^2} = \\sqrt{16 + 49} = \\sqrt{65} \\approx 8{,}1$' },
              { label: 'b', task: 'Rettvinklet trekant med hypotenus $15$ og katet $9$. Finn den andre kateten.', solution: '$b = \\sqrt{15^2 - 9^2} = \\sqrt{225 - 81} = \\sqrt{144} = 12$' },
              { label: 'c', task: 'Rettvinklet trekant med kateter $5$ og $11$. Finn hypotenusen.', solution: '$c = \\sqrt{5^2 + 11^2} = \\sqrt{25 + 121} = \\sqrt{146} \\approx 12{,}1$' },
              { label: 'd', task: 'Rettvinklet trekant med hypotenus $20$ og katet $13$. Finn den andre kateten.', solution: '$b = \\sqrt{20^2 - 13^2} = \\sqrt{400 - 169} = \\sqrt{231} \\approx 15{,}2$' },
            ],
            solution: 'a) 8,1. b) 12. c) 12,1. d) 15,2',
            hideInlineSolution: true,
            hints: ['Bruk formelen og ta kvadratroten. Avrund til én desimal om det ikke blir helt tall.'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'medium',
            task: 'Bruk Pytagoras i praktiske situasjoner',
            subTasks: [
              { label: 'a', task: 'En stige er $5$ m lang og står $3$ m fra veggen. Hvor høyt opp på veggen når stigen?', solution: '$h = \\sqrt{5^2 - 3^2} = \\sqrt{25 - 9} = \\sqrt{16} = 4$ m' },
              { label: 'b', task: 'Et rektangulært rom er $6$ m langt og $8$ m bredt. Hvor lang er diagonalen?', solution: '$d = \\sqrt{6^2 + 8^2} = \\sqrt{36 + 64} = \\sqrt{100} = 10$ m' },
              { label: 'c', task: 'En fotballbane er $100$ m lang og $65$ m bred. Hvor langt er det å gå diagonalt over banen?', solution: '$d = \\sqrt{100^2 + 65^2} = \\sqrt{10000 + 4225} = \\sqrt{14225} \\approx 119{,}3$ m' },
              { label: 'd', task: 'En likesidet trekant har sidekant $10$ cm. Finn høyden. (Hint: Høyden deler grunnlinjen i to like deler.)', solution: '$h = \\sqrt{10^2 - 5^2} = \\sqrt{100 - 25} = \\sqrt{75} \\approx 8{,}7$ cm' },
            ],
            solution: 'a) 4 m, b) 10 m, c) ca. 119,3 m, d) ca. 8,7 cm',
            hideInlineSolution: true,
            hints: ['Tegn figuren og marker den rette vinkelen. Finn katetene og hypotenusen.'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'vanskelig',
            task: 'Utfordringsoppgaver med Pytagoras',
            subTasks: [
              { label: 'a', task: 'En katt sitter på toppen av en $12$ m høy mast. Den klatrer ned langs et tau som er festet $5$ m fra masten. Hvor langt er tauet?', solution: '$\\text{tau} = \\sqrt{12^2 + 5^2} = \\sqrt{144 + 25} = \\sqrt{169} = 13$ m' },
              { label: 'b', task: 'Finn arealet av en likesidet trekant med sidekant $8$ cm. (Finn høyden først med Pytagoras.)', solution: '$h = \\sqrt{8^2 - 4^2} = \\sqrt{48} \\approx 6{,}93$ cm. $A = \\frac{8 \\cdot 6{,}93}{2} \\approx 27{,}7$ cm²' },
              { label: 'c', task: 'Et skip seiler $15$ km mot nord og deretter $20$ km mot øst. Hvor langt er skipet fra startpunktet?', solution: '$d = \\sqrt{15^2 + 20^2} = \\sqrt{225 + 400} = \\sqrt{625} = 25$ km' },
              { label: 'd', task: 'En rombe har diagonaler $16$ cm og $12$ cm. Finn sidekanten. (Hint: Diagonalene halverer hverandre og er vinkelrette.)', solution: 'Halve diagonaler: $8$ cm og $6$ cm. $s = \\sqrt{8^2 + 6^2} = \\sqrt{64 + 36} = \\sqrt{100} = 10$ cm' },
            ],
            solution: 'a) 13 m, b) ca. 27,7 cm², c) 25 km, d) 10 cm',
            hideInlineSolution: true,
            hints: ['Tegn alltid en skisse og identifiser den rettvinklede trekanten i oppgaven'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
      ...
      content: [
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'lett',
            task: 'Finn gjennomsnittet av tallene',
            subTasks: [
              { label: 'a', task: '$4, 6, 8, 10, 12$', solution: '$\\frac{4+6+8+10+12}{5} = \\frac{40}{5} = 8$' },
              { label: 'b', task: '$3, 7, 5, 9, 1$', solution: '$\\frac{3+7+5+9+1}{5} = \\frac{25}{5} = 5$' },
              { label: 'c', task: '$15, 20, 25, 30$', solution: '$\\frac{15+20+25+30}{4} = \\frac{90}{4} = 22{,}5$' },
              { label: 'd', task: '$100, 80, 90, 70, 60$', solution: '$\\frac{100+80+90+70+60}{5} = \\frac{400}{5} = 80$' },
            ],
            solution: 'a) 8, b) 5, c) 22,5, d) 80',
            hideInlineSolution: true,
            hints: ['Gjennomsnitt = summen av alle tallene delt på antall tall'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'lett',
            task: 'Finn medianen av tallene',
            subTasks: [
              { label: 'a', task: '$3, 7, 2, 9, 5$', solution: 'Sortert: $2, 3, 5, 7, 9$. Median $= 5$' },
              { label: 'b', task: '$12, 8, 15, 6$', solution: 'Sortert: $6, 8, 12, 15$. Median $= \\frac{8+12}{2} = 10$' },
              { label: 'c', task: '$1, 1, 2, 3, 5, 8$', solution: 'Sortert: $1, 1, 2, 3, 5, 8$. Median $= \\frac{2+3}{2} = 2{,}5$' },
              { label: 'd', task: '$20, 30, 10, 40, 50, 60, 70$', solution: 'Sortert: $10, 20, 30, 40, 50, 60, 70$. Median $= 40$' },
            ],
            solution: 'a) 5, b) 10, c) 2,5, d) 40',
            hideInlineSolution: true,
            hints: ['Sorter tallene fra minst til størst. Median er det midterste tallet (eller gjennomsnittet av de to midterste).'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'lett',
            task: 'Finn typetallet i datasettene',
            subTasks: [
              { label: 'a', task: '$5, 3, 7, 5, 2, 5, 8$', solution: 'Typetall $= 5$ (forekommer $3$ ganger)' },
              { label: 'b', task: '$rød, blå, grønn, blå, rød, blå$', solution: 'Typetall $=$ blå (forekommer $3$ ganger)' },
              { label: 'c', task: '$10, 20, 10, 30, 20, 10, 20$', solution: 'Typetall $= 10$ og $20$ (begge forekommer $3$ ganger)' },
              { label: 'd', task: '$1, 2, 3, 4, 5$', solution: 'Ingen typetall (alle forekommer like mange ganger)' },
            ],
            solution: 'a) 5, b) blå, c) 10 og 20, d) ingen typetall',
            hideInlineSolution: true,
            hints: ['Typetall er den verdien som forekommer flest ganger'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'medium',
            task: 'Finn gjennomsnitt, median og typetall for hvert datasett',
            subTasks: [
              { label: 'a', task: '$4, 7, 2, 7, 5, 7, 3$', solution: 'Gj.snitt: $\\frac{35}{7} = 5$. Sortert: $2,3,4,5,7,7,7$. Median: $5$. Typetall: $7$' },
              { label: 'b', task: '$18, 22, 15, 22, 20, 18$', solution: 'Gj.snitt: $\\frac{115}{6} \\approx 19{,}2$. Sortert: $15,18,18,20,22,22$. Median: $\\frac{18+20}{2} = 19$. Typetall: $18$ og $22$' },
              { label: 'c', task: '$50, 55, 60, 65, 200$', solution: 'Gj.snitt: $\\frac{430}{5} = 86$. Median: $60$. Ingen typetall.' },
              { label: 'd', task: 'Hvilken oppgave viser best at gjennomsnitt kan bli misvisende av ekstremverdier?', solution: 'Oppgave c): Gjennomsnittet $86$ er mye høyere enn de fleste verdiene pga. ekstremverdien $200$. Medianen $60$ gir et bedre bilde.' },
            ],
            solution: 'a) Gj.snitt=5, Median=5, Typetall=7. b) Gj.snitt≈19,2, Median=19, Typetall=18 og 22. c) Gj.snitt=86, Median=60. d) Oppgave c)',
            hideInlineSolution: true,
            hints: ['Beregn alle tre sentralmålene og sammenlign dem'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'medium',
            task: 'Finn den ukjente verdien',
            subTasks: [
              { label: 'a', task: 'Gjennomsnittet av $5$ tall er $8$. Fire av tallene er $6, 7, 9, 10$. Finn det femte tallet.', solution: 'Sum $= 5 \\cdot 8 = 40$. Kjent sum: $6+7+9+10 = 32$. Femte tall: $40 - 32 = 8$' },
              { label: 'b', task: 'Gjennomsnittet av $4$ tall er $15$. Tre av tallene er $10, 12, 18$. Finn det fjerde tallet.', solution: 'Sum $= 4 \\cdot 15 = 60$. Kjent sum: $10+12+18 = 40$. Fjerde tall: $60 - 40 = 20$' },
              { label: 'c', task: 'Medianen av $5$ tall er $12$. Tallene sortert er: $5, 9, ?, 15, 20$. Finn det ukjente tallet.', solution: 'Det midterste tallet er medianen. Ukjent $= 12$' },
              { label: 'd', task: 'En elev har fått $4, 5, 3, 6$ på fire prøver. Hva må hun få på den femte prøven for å ha gjennomsnitt $5$?', solution: 'Sum $= 5 \\cdot 5 = 25$. Kjent sum: $4+5+3+6 = 18$. Femte prøve: $25 - 18 = 7$' },
            ],
            solution: 'a) 8, b) 20, c) 12, d) 7',
            hideInlineSolution: true,
            hints: ['Bruk formelen: sum = gjennomsnitt × antall'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'vanskelig',
            task: 'Utfordringsoppgaver med sentralmål',
            subTasks: [
              { label: 'a', task: 'I en klasse med $20$ elever er gjennomsnittshøyden $165$ cm. En ny elev som er $185$ cm høy begynner i klassen. Hva er den nye gjennomsnittshøyden?', solution: 'Gammel sum: $20 \\cdot 165 = 3300$ cm. Ny sum: $3300 + 185 = 3485$ cm. Nytt gjennomsnitt: $\\frac{3485}{21} \\approx 165{,}95$ cm' },
              { label: 'b', task: 'To grupper: Gruppe A har $10$ elever med gjennomsnitt $72$ poeng. Gruppe B har $15$ elever med gjennomsnitt $80$ poeng. Finn det totale gjennomsnittet.', solution: 'Sum A: $10 \\cdot 72 = 720$. Sum B: $15 \\cdot 80 = 1200$. Totalt: $\\frac{720+1200}{25} = \\frac{1920}{25} = 76{,}8$' },
              { label: 'c', task: 'Lag et datasett med $6$ tall der gjennomsnitt $= 10$, median $= 9$ og typetall $= 8$.', solution: 'For eksempel: $8, 8, 8, 10, 12, 14$. Sum $= 60$, gj.snitt $= 10$. Median $= \\frac{8+10}{2} = 9$. Typetall $= 8$. ✓' },
              { label: 'd', task: 'Sara har $5$ prøveresultater: $78, 85, 90, 72, x$. Hun vil ha gjennomsnitt minst $82$. Hva er den minste verdien av $x$?', solution: '$\\frac{78+85+90+72+x}{5} \\geq 82 \\Rightarrow 325 + x \\geq 410 \\Rightarrow x \\geq 85$' },
            ],
            solution: 'a) ca. 166 cm, b) 76,8, c) f.eks. 8,8,8,10,12,14, d) minst 85',
            hideInlineSolution: true,
            hints: ['Bruk sammenhengen sum = gjennomsnitt × antall for å løse baklengs-oppgaver'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
      ...
      content: [
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'lett',
            task: 'Les av tabellen og svar på spørsmålene. Favorittfag blant 30 elever: Matte: 8, Norsk: 5, Engelsk: 7, Naturfag: 6, Gym: 4',
            subTasks: [
              { label: 'a', task: 'Hvilket fag er mest populært?', solution: 'Matte ($8$ elever)' },
              { label: 'b', task: 'Hvor mange flere liker Engelsk enn Gym?', solution: '$7 - 4 = 3$ flere' },
              { label: 'c', task: 'Hvor stor andel i prosent liker Naturfag?', solution: '$\\frac{6}{30} \\cdot 100\\% = 20\\%$' },
              { label: 'd', task: 'Hvor mange prosent liker Matte eller Engelsk?', solution: '$\\frac{8+7}{30} \\cdot 100\\% = \\frac{15}{30} \\cdot 100\\% = 50\\%$' },
            ],
            solution: 'a) Matte, b) 3 flere, c) 20%, d) 50%',
            hideInlineSolution: true,
            hints: ['Les tallene rett fra tabellen. Prosent = del/total × 100%'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'lett',
            task: 'Hvilken type diagram passer best?',
            subTasks: [
              { label: 'a', task: 'Vise fordelingen av karakterer i en klasse', solution: 'Stolpediagram (søylediagram)' },
              { label: 'b', task: 'Vise temperaturutviklingen gjennom et år', solution: 'Linjediagram' },
              { label: 'c', task: 'Vise hvor stor andel av budsjettet som går til ulike poster', solution: 'Sektordiagram (kakediagram)' },
              { label: 'd', task: 'Sammenligne salg i to butikker over seks måneder', solution: 'Stolpediagram med to serier eller linjediagram med to linjer' },
            ],
            solution: 'a) Stolpediagram, b) Linjediagram, c) Sektordiagram, d) Stolpe- eller linjediagram',
            hideInlineSolution: true,
            hints: ['Stolpediagram: sammenligne kategorier. Linjediagram: vise utvikling over tid. Sektordiagram: vise andeler av en helhet.'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'lett',
            task: 'Regn ut gradene i et sektordiagram. Totalt $40$ elever ble spurt om favorittfrukt.',
            subTasks: [
              { label: 'a', task: 'Eple: $15$ elever. Hvor mange grader?', solution: '$\\frac{15}{40} \\cdot 360° = 135°$' },
              { label: 'b', task: 'Banan: $10$ elever. Hvor mange grader?', solution: '$\\frac{10}{40} \\cdot 360° = 90°$' },
              { label: 'c', task: 'Appelsin: $8$ elever. Hvor mange grader?', solution: '$\\frac{8}{40} \\cdot 360° = 72°$' },
              { label: 'd', task: 'Annet: $7$ elever. Hvor mange grader?', solution: '$\\frac{7}{40} \\cdot 360° = 63°$' },
              { label: 'e', task: 'Sjekk at summen av alle gradene blir $360°$.', solution: '$135° + 90° + 72° + 63° = 360°$ ✓' },
            ],
            solution: 'a) 135°, b) 90°, c) 72°, d) 63°, e) 360° ✓',
            hideInlineSolution: true,
            hints: ['Grader = (antall/total) × 360°'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'medium',
            task: 'Bruk tabellen: Salg av is (antall kuler) per måned: Mai: 200, Juni: 450, Juli: 600, Aug: 500, Sep: 250',
            subTasks: [
              { label: 'a', task: 'Hva var gjennomsnittlig salg per måned?', solution: '$\\frac{200+450+600+500+250}{5} = \\frac{2000}{5} = 400$ kuler' },
              { label: 'b', task: 'Hvor mye økte salget fra mai til juli (i prosent)?', solution: '$\\frac{600 - 200}{200} \\cdot 100\\% = \\frac{400}{200} \\cdot 100\\% = 200\\%$' },
              { label: 'c', task: 'Hvor stor andel av totalsalget sto juli for?', solution: '$\\frac{600}{2000} \\cdot 100\\% = 30\\%$' },
              { label: 'd', task: 'Beskriv trenden i dataene med én setning.', solution: 'Salget øker fra mai til juli (sommertopp) og synker igjen mot september.' },
            ],
            solution: 'a) 400 kuler, b) 200%, c) 30%, d) Sommertopp i juli',
            hideInlineSolution: true,
            hints: ['Prosentvis økning = (ny-gammel)/gammel × 100%'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'medium',
            task: 'Frekvenstabell. 25 elever fikk disse resultatene på en prøve (maks 10 poeng): 3, 5, 7, 5, 8, 6, 5, 9, 7, 4, 5, 6, 7, 8, 5, 6, 7, 9, 10, 6, 5, 7, 8, 4, 6',
            subTasks: [
              { label: 'a', task: 'Lag en frekvenstabell med poeng og antall.', solution: '3: 1, 4: 2, 5: 6, 6: 5, 7: 5, 8: 3, 9: 2, 10: 1' },
              { label: 'b', task: 'Hva er typetallet?', solution: 'Typetall $= 5$ (forekommer $6$ ganger)' },
              { label: 'c', task: 'Finn medianen.', solution: 'Sortert med $25$ verdier. Median er verdi nr. $13$: $= 6$' },
              { label: 'd', task: 'Finn gjennomsnittet.', solution: '$\\frac{3+8+30+30+35+24+18+10}{25} = \\frac{158}{25} = 6{,}32$' },
            ],
            solution: 'a) Se tabell, b) 5, c) 6, d) 6,32',
            hideInlineSolution: true,
            hints: ['Tell opp hvor mange ganger hvert poeng forekommer'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'vanskelig',
            task: 'Utfordringsoppgaver med diagrammer og tabeller',
            subTasks: [
              { label: 'a', task: 'En bedrift hadde følgende omsetning (i millioner kr): 2021: 12, 2022: 15, 2023: 14, 2024: 18. Et diagram starter y-aksen på 10 i stedet for 0. Forklar hvorfor dette kan være misvisende.', solution: 'Når y-aksen ikke starter på 0, ser forskjellene mye større ut enn de egentlig er. Økningen fra 12 til 18 ser dramatisk ut, selv om det bare er 50% økning.' },
              { label: 'b', task: 'I et sektordiagram for et familiebudsjett er sektoren for mat $108°$. Budsjettet er $30\\,000$ kr. Hvor mye brukes på mat?', solution: '$\\frac{108°}{360°} \\cdot 30\\,000 = 0{,}3 \\cdot 30\\,000 = 9\\,000$ kr' },
              { label: 'c', task: 'En undersøkelse viser: $40\\%$ liker fotball, $25\\%$ liker håndball, $20\\%$ liker svømming, resten liker annet. Hvis $200$ personer ble spurt, hvor mange liker hver idrett?', solution: 'Fotball: $0{,}4 \\cdot 200 = 80$. Håndball: $0{,}25 \\cdot 200 = 50$. Svømming: $0{,}2 \\cdot 200 = 40$. Annet: $200 - 80 - 50 - 40 = 30$' },
              { label: 'd', task: 'Temperaturer i en uke: Man: $5°$, Tir: $3°$, Ons: $-1°$, Tor: $-3°$, Fre: $0°$, Lør: $4°$, Søn: $6°$. Finn gjennomsnittstemperaturen og beskriv trenden.', solution: 'Gj.snitt: $\\frac{5+3-1-3+0+4+6}{7} = \\frac{14}{7} = 2°$C. Trenden: Temperaturen synker mot midten av uken og stiger igjen mot helgen.' },
            ],
            solution: 'a) Y-akse fra 0 gir riktig proporsjon. b) 9000 kr. c) 80, 50, 40, 30. d) 2°C',
            hideInlineSolution: true,
            hints: ['Vær kritisk til hvordan data presenteres - aksene og skalaen påvirker inntrykket'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
      ...
      content: [
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'lett',
            task: 'Finn sannsynligheten ved kast av en vanlig terning',
            subTasks: [
              { label: 'a', task: 'Å få $4$', solution: '$P(4) = \\frac{1}{6}$' },
              { label: 'b', task: 'Å få et partall', solution: '$P(\\text{partall}) = \\frac{3}{6} = \\frac{1}{2}$' },
              { label: 'c', task: 'Å få et tall større enn $4$', solution: '$P(>4) = \\frac{2}{6} = \\frac{1}{3}$' },
              { label: 'd', task: 'Å få et tall mindre enn $7$', solution: '$P(<7) = \\frac{6}{6} = 1$ (sikkert)' },
              { label: 'e', task: 'Å få $7$', solution: '$P(7) = \\frac{0}{6} = 0$ (umulig)' },
            ],
            solution: 'a) 1/6, b) 1/2, c) 1/3, d) 1, e) 0',
            hideInlineSolution: true,
            hints: ['$P = \\frac{\\text{gunstige utfall}}{\\text{mulige utfall}}$. En terning har 6 mulige utfall.'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'lett',
            task: 'En pose inneholder 3 røde, 5 blå og 2 grønne kuler. Du trekker én kule tilfeldig. Finn sannsynligheten for:',
            subTasks: [
              { label: 'a', task: 'Å trekke en rød kule', solution: '$P(\\text{rød}) = \\frac{3}{10}$' },
              { label: 'b', task: 'Å trekke en blå kule', solution: '$P(\\text{blå}) = \\frac{5}{10} = \\frac{1}{2}$' },
              { label: 'c', task: 'Å trekke en grønn kule', solution: '$P(\\text{grønn}) = \\frac{2}{10} = \\frac{1}{5}$' },
              { label: 'd', task: 'Å IKKE trekke en blå kule', solution: '$P(\\text{ikke blå}) = 1 - \\frac{1}{2} = \\frac{1}{2}$' },
            ],
            solution: 'a) 3/10, b) 1/2, c) 1/5, d) 1/2',
            hideInlineSolution: true,
            hints: ['Totalt antall kuler = 3 + 5 + 2 = 10'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'lett',
            task: 'Skriv opp utfallsrommet og finn antall mulige utfall',
            subTasks: [
              { label: 'a', task: 'Kast av en mynt', solution: 'Utfallsrom: $\\{K, M\\}$. Antall: $2$' },
              { label: 'b', task: 'Kast av en vanlig terning', solution: 'Utfallsrom: $\\{1, 2, 3, 4, 5, 6\\}$. Antall: $6$' },
              { label: 'c', task: 'Trekke en dag i uken tilfeldig', solution: 'Utfallsrom: $\\{man, tir, ons, tor, fre, lør, søn\\}$. Antall: $7$' },
              { label: 'd', task: 'Kast av to mynter', solution: 'Utfallsrom: $\\{KK, KM, MK, MM\\}$. Antall: $4$' },
            ],
            solution: 'a) 2, b) 6, c) 7, d) 4',
            hideInlineSolution: true,
            hints: ['List opp alle mulige utfall systematisk'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'medium',
            task: 'Regn med sannsynlighet',
            subTasks: [
              { label: 'a', task: 'Sannsynligheten for regn er $0{,}3$. Hva er sannsynligheten for at det IKKE regner?', solution: '$P(\\text{ikke regn}) = 1 - 0{,}3 = 0{,}7$' },
              { label: 'b', task: 'Et lykkehjul har $8$ like felter: $3$ røde, $2$ blå, $2$ gule, $1$ grønt. Finn $P(\\text{rød eller blå})$.', solution: '$P(\\text{rød eller blå}) = \\frac{3+2}{8} = \\frac{5}{8}$' },
              { label: 'c', task: 'Du kaster en terning $60$ ganger. Omtrent hvor mange ganger forventer du å få $6$?', solution: '$P(6) = \\frac{1}{6}$. Forventet: $\\frac{1}{6} \\cdot 60 = 10$ ganger' },
              { label: 'd', task: 'I en klasse med $25$ elever er $10$ jenter. Hva er sannsynligheten for å trekke en gutt?', solution: '$P(\\text{gutt}) = \\frac{25-10}{25} = \\frac{15}{25} = \\frac{3}{5} = 0{,}6$' },
              { label: 'e', task: 'En kortstokk har $52$ kort ($4$ farger, $13$ verdier). Finn sannsynligheten for å trekke et ess.', solution: '$P(\\text{ess}) = \\frac{4}{52} = \\frac{1}{13}$' },
            ],
            solution: 'a) 0,7. b) 5/8. c) 10. d) 3/5. e) 1/13',
            hideInlineSolution: true,
            hints: ['$P(\\text{ikke A}) = 1 - P(A)$. Forventet antall = sannsynlighet × antall forsøk.'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'medium',
            task: 'Du kaster to terninger og ser på summen. Utfallsrommet har $6 \\times 6 = 36$ like sannsynlige utfall.',
            subTasks: [
              { label: 'a', task: 'Finn $P(\\text{sum} = 7)$', solution: 'Gunstige: $(1,6),(2,5),(3,4),(4,3),(5,2),(6,1)$ = $6$ utfall. $P = \\frac{6}{36} = \\frac{1}{6}$' },
              { label: 'b', task: 'Finn $P(\\text{sum} = 2)$', solution: 'Gunstige: $(1,1)$ = $1$ utfall. $P = \\frac{1}{36}$' },
              { label: 'c', task: 'Finn $P(\\text{sum} = 12)$', solution: 'Gunstige: $(6,6)$ = $1$ utfall. $P = \\frac{1}{36}$' },
              { label: 'd', task: 'Finn $P(\\text{sum} \\geq 10)$', solution: 'Sum 10: $(4,6),(5,5),(6,4)$. Sum 11: $(5,6),(6,5)$. Sum 12: $(6,6)$. Totalt $6$. $P = \\frac{6}{36} = \\frac{1}{6}$' },
            ],
            solution: 'a) 1/6, b) 1/36, c) 1/36, d) 1/6',
            hideInlineSolution: true,
            hints: ['List opp alle kombinasjoner som gir ønsket sum. Totalt er det 36 mulige utfall.'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'vanskelig',
            task: 'Utfordringsoppgaver med sannsynlighet',
            subTasks: [
              { label: 'a', task: 'Du har $4$ kort: Ess, Konge, Dame, Knekt. Du trekker $2$ kort uten å legge tilbake. List opp alle mulige par og finn sannsynligheten for å trekke Ess og Konge (i vilkårlig rekkefølge).', solution: 'Mulige par: $\\binom{4}{2} = 6$: (E,Ko), (E,D), (E,Kn), (Ko,D), (Ko,Kn), (D,Kn). $P(\\text{E og Ko}) = \\frac{1}{6}$' },
              { label: 'b', task: 'En familie skal ha $3$ barn. Anta at $P(\\text{gutt}) = P(\\text{jente}) = \\frac{1}{2}$. Hva er sannsynligheten for nøyaktig $2$ jenter?', solution: 'Utfall med 2J: GJJ, JGJ, JJG = $3$ av $8$. $P = \\frac{3}{8}$' },
              { label: 'c', task: 'I et lotteri er det $100$ lodd, hvorav $5$ gir gevinst. Du kjøper $3$ lodd. Omtrent hva er sannsynligheten for minst én gevinst?', solution: '$P(\\text{ingen gevinst}) = \\frac{95}{100} \\cdot \\frac{94}{99} \\cdot \\frac{93}{98} \\approx 0{,}856$. $P(\\text{minst én}) = 1 - 0{,}856 \\approx 0{,}144 = 14{,}4\\%$' },
              { label: 'd', task: 'Du kaster en terning gjentatte ganger. Hva er sannsynligheten for å IKKE få $6$ på noen av de $3$ første kastene?', solution: '$P(\\text{ikke 6}) = \\frac{5}{6}$ per kast. For $3$ kast: $\\left(\\frac{5}{6}\\right)^3 = \\frac{125}{216} \\approx 0{,}579$' },
            ],
            solution: 'a) 1/6, b) 3/8, c) ca. 14,4%, d) ca. 57,9%',
            hideInlineSolution: true,
            hints: ['For \"minst én\"-oppgaver: $P(\\text{minst én}) = 1 - P(\\text{ingen})$'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
