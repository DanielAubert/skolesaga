...
const quizData_medieinfo: Record<string, QuizQuestion[]> = {
  "medieinfo-1-1": [
    {
    ...
    },
    {
      ...
      explanation: "Vakthundfunksjonen innebærer at mediene overvaker makthavere og avslorer kritikkverdige forhold.",
    },
    {
    ...
    },
    {
      ...
      options: ["Arenafunksjonen", "Vakthundfunksjonen", "Underholdningsfunksjonen", "Informasjonsfunksjonen"],
  ...
  "medieinfo-1-2": [
    ...
    {
      question: "Nårstårtet NRK radio?",
      options: ["1933", "1920", "1960", "1945"],
      explanation: "NRK (Norsk rikskringkasting) startet radiovirksomhet i 1933. NRK TV startet først i 1960.",
    },
    {
    ...
    },
    {
      ...
      options: ["Brukerskapt innhold og sosiale medier", "Kun statiske nettsider", "Rene tekstsider helt uten bilder, lyd eller levende bilde", "Bare tekst uten bilder"],
      explanation: "Web 2.0 introduserte brukerskapt innhold, interaktivitet og sosiale medier fra ca. 2004.",
    },
  ],
  "medieinfo-1-3": [
    {
      question: "Hva kjennetegner en nyhetsartikkel?",
      options: ["Objektiv, omvendt pyramide-struktur, svarer påhvem/hva/hvor/nar/hvorfor/hvordan", "Litterar og stemningsskapende stil med rike skildringer av personer og steder", "Subjektiv og argumenterende tekst der skribenten tydelig fremmer sine egne meninger", "Fiksjon med oppdiktede karakterer og en frittstaende, fortellende handling"],
      explanation: "En nyhetsartikkel kjennetegnes av objektivt språk, omvendt pyramide-struktur og svar pånyhetskriterier.",
    },
    {
  ...
  "medieinfo-1-4": [
    {
      question: "Hva menes med \"oppmerksomhetsøkonomi\"?",
      options: ["At menneskelig oppmerksomhet er en knapp ressurs som medier konkurrerer om", "At det er de rene økonomi- og børsnyhetene som far mest oppmerksomhet", "At mennesker som er ekstra oppmerksomme tjener mer penger enn andre", "At publikum ma betale et beløp for a fa oppmerksomhet i mediene"],
      explanation: "Oppmerksomhetsøkonomi beskriver hvordan medier konkurrerer om var begrensede oppmerksomhet.",
    },
    {
    ...
    },
    {
      ...
      options: ["Grupper der meninger bekreftes og forsterkes uten motforestillinger", "En bestemt type følsom mikrofon brukt i radio- og tv-produksjon", "Et lydstudio som er bygget for a skape kunstige ekkoeffekter", "Et apent diskusjonsforum der mange ulike syn møtes og brytes"],
      explanation: "Ekkokamre er grupper der meninger bekreftes og forsterkes uten at man møter motforestillinger.",
    },
    {
  ...
  "medieinfo-1-5": [
    ...
    {
      question: "Hva er tredjedelsregelen i bildekomposisjon?",
      options: ["Plassere viktige elementer langs linjer som deler bildet i ni deler", "A bruke tre ulike kameraer for a fange scenen fra flere vinkler", "A alltid ha nøyaktig tre personer synlige i bildeutsnittet", "A dele den ferdige filmen inn i tre klart adskilte deler"],
      explanation: "Tredjedelsregelen innebærer at bildet deles i ni deler og viktige elementer plasseres langs linjene.",
    },
    {
  ...
  "medieinfo-1-6": [
    {
      question: "Hva star KVISA for i journalistikken?",
      options: ["Konflikt, Vesentlighet, Identifikasjon, Sensasjon, Aktualitet", "Kontroll, Verifisering, Integritet, Saklighet, Ansvar", "Kritikk, Varsling, Informasjon, Sikkerhet og offentlig Anmeldelse", "Kilde, Vinkling, Intervju, Sannhet og grundig kildekritisk Analyse"],
      explanation: "KVISA er en huskeregel for nyhetskriterier som avgjør hva som blir en nyhet.",
    },
    {
      question: "Hva er Var Varsom-plakaten?",
      options: ["Norsk presses etiske retningslinjer", "En pris for god journalistikk", "En norsk lov som slar fast borgernes rett til ytringsfrihet", "Et program for pressestøtte"],
      explanation: "Var Varsom-plakaten er norsk presses etiske retningslinjer, vedtatt av Norsk Presseforbund.",
    },
    {
      question: "Hva innebærer samtidig imotegaelse?",
      options: ["Den som anklages skal fa svare i samme sak", "Artikkelen måpubliseres samme dag", "At alle kildene i en sak ma være enige for den kan publiseres", "Journalisten måvære til stede"],
    ...
    {
      question: "Hva er vinkling i journalistikk?",
      options: ["Hvordan en sak presenteres - inngang, fokus og perspektiv", "Kameraets fysiske posisjon og hoyde nar bildet blir tatt", "Hvor lang selve artikkelen er malt i antall ord og tegn", "Hvor mange ulike kilder som er brukt i en gitt sak"],
      explanation: "Vinkling handler om hvordan en sak presenteres - hvilket perspektiv og fokus som velges.",
    },
  ],
  "medieinfo-1-7": [
    {
    ...
    },
    {
      ...
      options: ["Appell til følelser", "Appell til logikk", "Appell til troverdighet", "Appell til autoritet"],
      explanation: "Pathos er følelsesappellen som bruker følelser for a overtale mottakeren.",
    },
    {
    ...
    },
    {
      ...
      options: ["De personene reklamen er rettet mot", "De ansatte i bedriften", "Alle mennesker som tilfeldigvis kommer til a se reklamen", "Alle som ser reklamen"],
      explanation: "Malgruppe er den spesifikke gruppen mennesker som reklamen er designet for a na og overtale.",
    },
  ],
  "medieinfo-1-8": [
    {
    ...
    },
    {
      ...
      options: ["Fear of missing out - angst for å gå glipp av noe", "Fokusert online media-observasjon", "Fokusert online medieobservasjon av det andre publiserer", "For ofte mobilbruk - et overforbruk av skjerm gjennom dagen"],
      explanation: "FOMO står for \"Fear of missing out\" - angsten for å gå glipp av opplevelser andre har.",
    },
    {
  ...
  "medieinfo-1-9": [
    {
      question: "Hva innebærer opphavsrett?",
      options: ["Eneretten til a rade over eget andsverk", "Retten til a kopiere andres verk fritt", "Plikten til a dele sine verk", "Retten til a oppheve andres rettigheter"],
      explanation: "Opphavsrett er eneretten til a rade over eget andsverk, som tekst, musikk og bilder.",
    },
    {
      question: "Hva er GDPR?",
      options: ["EUs personvernforordning som beskytter personopplysninger", "Et internasjonalt samarbeid om opphavsrett", "En amerikansk grunnlovsbestemmelse som verner om borgernes ytrings- og pressefrihet", "En amerikansk lov om ytringsfrihet"],
    ...
    {
      question: "Hvilken paragraf i Grunnloven verner ytringsfriheten?",
      options: ["Paragraf 100", "Paragraf 1", "Paragraf 50", "Paragraf 200"],
      explanation: "Grunnlovens paragraf 100 verner ytringsfriheten i Norge.",
    },
    {
      question: "Hva er PFU?",
  ...
  "medieinfo-2-1": [
    {
      question: "Hva er denotasjon i semiotisk analyse?",
      options: ["Den bokstavelige, direkte betydningen av et tegn", "De kulturelle assosiasjonene et tegn vekker", "Samspillet mellom ulike modaliteter som tekst, bilde og lyd i en sammensatt medietekst", "Samspillet mellom ulike modaliteter"],
      explanation: "Denotasjon er den bokstavelige, direkte betydningen av et tegn, i motsetning til konnotasjon.",
    },
    {
    ...
    {
      question: "Hva innebærer multimodalitet?",
      options: ["Kombinasjonen av ulike uttrykksmater i en tekst", "Undersokelse av medienes historiske utvikling", "Studiet av medienes økonomiske strukturer, som eierskap, finansiering og markedsforhold", "Studiet av medienes økonomiske strukturer"],
      explanation: "Multimodalitet handler om hvordan ulike modaliteter som tekst, bilde og lyd kombineres for a skape mening.",
    },
    {
  ...
  "medieinfo-2-2": [
    ...
    },
    {
      ...
      options: ["Schibsted, Amedia og Polaris Media", "Google, Facebook og Microsoft", "VG, Dagbladet og Aftenposten, de tre største og mest leste avistitlene i landet vårt i dag", "VG, Dagbladet og Aftenposten"],
      explanation: "Schibsted, Amedia og Polaris Media er de tre store mediekonsernene som dominerer avismarkedet.",
    },
    {
      question: "Hva er oppmerksomhetsøkonomi?",
      options: ["Konkurranse om brukernes oppmerksomhet som kan omsettes i reklameinntekter", "Okonomisk støtte til kvalitetsjournalistikk", "Statlig regulering av mediemarkedet som skal hindre monopol og sikre mangfold i pressen", "Offentlig og privat økonomisk støtte som sikrer finansiering av dyr kvalitetsjournalistikk"],
      explanation: "Oppmerksomhetsøkonomi beskriver hvordan plattformer konkurrerer om brukernes oppmerksomhet for å selge reklame.",
    },
    {
  ...
  "medieinfo-2-3": [
    ...
    },
    {
      ...
      options: ["Massekulturens standardisering og kommersialisering", "For lite underholdning i mediene", "Mangelen på digitale medier og nettbaserte plattformer som kunne demokratisere kulturen", "For mye offentlig finansiering"],
  ...
  "medieinfo-2-4": [
    {
      question: "Hva er Var Varsom-plakaten?",
      options: ["Pressens etiske regelverk i Norge", "En lov som regulærer mediebransjen", "Et statlig organ for pressekontroll", "En internasjonal pressekonvensjon"],
      explanation: "Var Varsom-plakaten er pressens selvjustis - et etisk regelverk som norske medier frivillig forplikter seg til.",
    },
    {
    ...
    },
    {
      ...
      options: ["Undersøkende journalistikk som avdekker kritikkverdige forhold", "Journalistikk basert påpressekonferanser", "Rask nyhetsformidling der målet er å publisere hendelser først, før konkurrerende redaksjoner", "Underholdende historier om kjendiser"],
  ...
  "medieinfo-2-5": [
    ...
    },
    {
      ...
      options: ["Kameraet observerer uten at filmskaperen griper inn", "Filmskaperen er synlig og interagerer aktivt", "At det egentlig er fiksjon som bevisst later som om den er en ekte dokumentar om virkeligheten", "Fiksjon som later som den er dokumentar"],
    ...
    },
    {
      ...
      options: ["Gjenskaping av hendelser som ikke ble filmet", "Reparasjon av gammelt filmmateriale", "Bygging av fysiske kulisser og scenografi til opptakene i studio", "Digital reparasjon og restaurering av gammelt, skadet filmmateriale"],
  ...
  "medieinfo-2-6": [
    ...
    },
    {
      ...
      options: ["Appell til flokkmentalitet - alle andre gjør det", "A overføre positive assosiasjoner", "Å overføre positive assosiasjoner fra ett symbol over til et budskap", "A stemple motstandere negativt"],
      explanation: "Bandwagon-teknikken appellærer til onske om a følge flertallet - \"hopp påvogna\".",
    },
    {
    ...
    {
      question: "Hvilke tre overtalelsesmidler beskriver retorikken?",
      options: ["Ethos, pathos og logos", "Denotasjon, konnotasjon og myte", "Hvit, gra og svart propaganda", "Tekst, bilde og lyd"],
      explanation: "Ethos (troverdighet), pathos (følelser) og logos (logikk) er de tre klassiske overtalelsesmidlene.",
    },
    {
  ...
  "medieinfo-2-7": [
    {
      question: "Hva verner Grunnlovens paragraf 100?",
      options: ["Ytringsfriheten", "Eiendomsretten", "Religionsfriheten", "Stemmeretten"],
      explanation: "Grunnlovens paragraf 100 verner ytringsfriheten i Norge.",
    },
    {
      question: "Hva er GDPR?",
    ...
    },
    {
      ...
      options: ["Selskaper som samler inn og selger persondata", "En programvare for personvern", "En type nettleser som blokkerer sporing og reklame automatisk", "En programvare som beskytter personvernet ved å kryptere data"],
  ...
  "medieinfo-2-9": [
    ...
    },
    {
      ...
      options: ["Globalt innhold tilpasses lokale markeder og kulturer", "Globale selskaper kjøper lokale medier", "At sterkt lokal kultur og lokale uttrykk spres ut til et globalt publikum", "Lokale medier nekter globalt innhold"],
  ...
  "medieinfo-2-10": [
    ...
    {
      question: "Hva er preproduksjon?",
      options: ["Planleggingsfasen for en medieproduksjon", "Publisering og lansering av produktet", "Selve opptaksfasen der scener filmes", "Redigering og klipping av materialet"],
      explanation: "Preproduksjon er planleggingsfasen som inkluderer research, manus, storyboard og produksjonsplan.",
    },
    {
...
export default quizData_medieinfo;
