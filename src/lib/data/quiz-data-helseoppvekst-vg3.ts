...
const quizData_helseoppvekst_vg3: Record<string, QuizQuestion[]> = {
  'helseoppvekst-vg3-1': [
  {
  ...
  {
    question: 'Hva star S for i SMUL-modellen for refleksjon?',
    options: ['Situasjon', 'System', 'Samarbeid', 'Sikkerhet'],
    explanation: 'SMUL-modellen består av Situasjon (hva skjedde), Mestring (hva mestret jeg), Utfordring (hva var vanskelig) og Laering (hva tar jeg med videre).',
  },
  {
  ...
  },
  {
    ...
    options: ["Samarbeid mellom ulike yrkesgrupper om felles pasienter", "Samarbeid mellom kolleger med samme utdanning", "Samarbeid mellom kolleger som har samme utdanning og faglige bakgrunn", "Samarbeid mellom ulike sykehus og institusjoner om overføring av pasienter"],
    explanation: 'Tverrfaglig samarbeid innebærer at ulike yrkesgrupper (helsefagarbeidere, sykepleiere, leger, fysioterapeuter osv.) samarbeider om felles pasienter.',
  },
  {
  ...
  'helseoppvekst-vg3-2': [
  {
    question: 'Hva er en pasientjournal?',
    options: ["En samling opplysninger om pasientens kontakt med helsetjenesten", "Et skjema for bestilling av medisiner", "En intern oversikt over de ansatte som er på vakt ved avdelingen", "Et bestillingsskjema som brukes for a be om nye medisiner fra apoteket"],
    explanation: 'Pasientjournalen er en samling av opplysninger om en pasients kontakt med helse- og omsorgstjenesten, inkludert relevant informasjon om behandling.',
  },
  {
    question: 'Hva er VAS-skalaen?',
    options: ["Et verktoy for a male smerteintensitet fra 0-10", "En skala for a vurdere bevissthet", "Et verktoy for a male kroppstemperatur og oppdage feber tidlig", "Et verktoy for a male temperatur"],
    explanation: 'VAS (Visuell analog skala) er et verktoy for a male smerteintensitet der pasienten angir smertenivå påen skala fra 0 (ingen smerte) til 10.',
  },
  {
    question: 'Hva star V for i VIPS-modellen for dokumentasjon?',
    options: ['Velvære', 'Verdighet', 'Vurdering', 'Virkning'],
    explanation: 'VIPS-modellen består av Velvære (hvordan pasienten har det), Integritet, Preventive tiltak og Sosiale forhold.',
  },
  {
  ...
  'helseoppvekst-vg3-3': [
  {
    question: 'Hva er en uønsket hendelse?',
    options: ["En hendelse som har fort til skade eller kunne ha fort til skade", "En hendelse som alltid fører til dod", "En hendelse som alltid fører til at pasienten dør eller får varig mén", "Noe som i praksis aldri skjer i helsetjenesten når rutinene følges nøye"],
    explanation: 'En uønsket hendelse er en hendelse som har fort til skade påpasient, eller som kunne ha fort til skade. Inkluderer både faktisk skade og nesten-uhell.',
  },
  {
    question: 'Hva er Braden-skalaen?',
    options: ["Et verktoy for a vurdere risiko for trykksar", "Et verktoy for a vurdere fallrisiko", "Et verktoy for a vurdere fallrisiko basert påbalanse og ganglag", "En skala for a male blodtrykk"],
    explanation: 'Braden-skalaen er et verktoy for a vurdere risiko for trykksar basert påseks faktorer inkludert mobilitet, fuktighet og ernæring.',
  },
  {
    question: 'Hva er hensikten med rotårsakanalyse?',
    options: ["A finne underliggende årsaker til at feil skjer", "A finne ut hvem som har skylden", "A straffe den som gjorde feilen slik at det ikke gjentar seg i fremtiden", "A straffe den som gjorde feilen"],
    explanation: 'Rotårsakanalyse brukes for a finne underliggende årsaker til at feil skjer, slik at man kan førebygge lignende hendelser i fremtiden.',
  },
  {
    question: 'Hva er den vanligste typen uønsket hendelse i helsetjenesten?',
    options: ['Legemiddelfeil', 'Operasjonsfeil', 'Brannskader', 'Allergiske reaksjoner'],
    explanation: 'Legemiddelfeil er den vanligste typen uønsket hendelse i helsetjenesten, fulgt av fall og trykksår i eldreomsørgen.',
  },
  {
  ...
  {
    question: 'Hva bør du unngå å si til sørgende?',
    options: ['Det var nok til det beste', 'Jeg kondolærer', 'Jeg tenker pådeg', 'Det er naturlig a fole det slik'],
    explanation: 'Man bør unngå å si ting som "det var til det beste", "jeg vet hvordan du har det" eller "du måkomme deg videre" til sørgende.',
  },
  {
  ...
  },
  {
    ...
    options: ["A lindre symptomer og gi livskvalitet", "A forlenge livet mest mulig", "A kurere sykdommen med all tilgjengelig behandling", "A unngå ålle medisiner"],
    explanation: 'I palliativ omsorg er hovedmalet a lindre symptomer og gi best mulig livskvalitet for pasienten og de parorende, ikke a kurere sykdømmen.',
  },
],
  ...
  'helseoppvekst-vg3-5': [
  {
    ...
    options: ["Tvangsmessig bruk til tross for negative konsekvenser", "A bruke medisiner som føreskrevet", "A like smaken av alkohol og drikke det i sosiale sammenhenger", "A bruke rusmidler en enkelt gang uten a fortsette med det senere"],
  ...
  },
  {
    ...
    options: ["Tiltak som reduserer skade selv om personen ikke er rusfri", "A nekte hjelp til rusavhengige", "A tvinge personer til a slutte med rus mot deres egen vilje", "A straffe rusbruk hardt slik at folk skremmes fra a fortsette"],
    explanation: 'Skadereduksjon er tiltak som reduserer skade og risiko, selv om personen ikke er klar for rusfrihet. Eksempler er rene sprøyter og overdoseførebygging.',
  },
  {
    question: 'Hva er LAR?',
    ...
    explanation: 'LAR står for legemiddelassistert rehabilitering, der pasienter med opioidavhengighet fårsubstitusjonsmedisiner som del av behandlingen.',
  },
  {
    question: 'Hvordan bør du mote mennesker med rusutfordringer?',
    options: ["Med respekt og verdighet, uten moralisering", "Ved a true med konsekvenser", "Med tydelig kritikk og formaninger om a ta ansvar for eget liv", "Med kritikk og formaninger"],
    explanation: 'Mennesker med rusutfordringer skal møtes med respekt og verdighet. Unngå moralisering, uttrykk bekymring heller enn kritikk, og lytt aktivt.',
  },
],
  ...
  'helseoppvekst-vg3-6': [
  {
    ...
    options: ["Plikt til a soke a avverge alvorlige straffbare handlinger", "Plikt til a rapportere alle samtaler", "Plikt til a holde all informasjon om pasienten strengt hemmelig", "Plikt til a rapportere alle samtaler man har med brukere til leder"],
  ...
  {
    question: 'Hva bør du gjøre ved mistanke om vold mot et barn?',
    options: ["Dokumentere og melde bekymring til barnevernet", "Vente og se om det skjer igjen", "Holde det for deg selv for a beskytte forholdet til familien", "Vente og se om det skjer igjen for man foretar seg noe konkret"],
    explanation: 'Ved mistanke om vold mot barn skal du dokumentere objektivt, rapportere til leder og vurdere om det er behov for bekymringsmelding til barnevernet.',
  },
  {
    question: 'Gar taushetsplikten foran avvergingsplikten?',
    options: ["Nei, du kan ikke gjemme deg bak taushetsplikten nårbarn er i fare", "Det kommer helt an påsituasjonen og hvor sikker du er i din sak", "Ja, taushetsplikten gåralltid først uansett hvor alvorlig saken er", "Bare hvis nærmeste leder uttrykkelig sier at du kan bryte den"],
  ...
  {
    question: 'Hvordan bør du snakke med en mulig voldsutsatt?',
    options: ["I et privat og trygt sted, lytte uten a avbryte, tro pådet som fortelles", "Konfrontere personen med mange direkte sporsmål for a fåfrem sannheten", "Presse personen til a anmelde forholdet så raskt som overhodet mulig", "Bare snakke om det nårandre kolleger er til stede som vitner"],
  ...
  {
    question: 'Hvorfor bør du unngå stereotypier?',
    options: ["Fordi det er stor variasjon innad i alle grupper og mennesker er individer", "Fordi det er direkte ulovlig a omtale grupper på generaliserende mate", "Fordi det tar for lang tid a bli kjent med hver enkelt persons kultur", "Fordi lederen påarbeidsplassen har bestemt at det ikke er tillatt"],
  ...
  {
    question: 'Hvordan bør du mote mennesker fra andre kulturer?',
    options: ["Se individet, ikke bare kulturen, og spor heller enn a anta", "Behandle alle helt likt uten tilpasning", "Unngå a stille sporsmal for ikke a virke pagaende, og hold heller en trygg avstand til det kulturelle", "Anta hva de ønsker basert påbakgrunn"],
  ...
  {
    question: 'Hva bør man gjøre for man innfører en endring i stor skala?',
    options: ["Teste den i liten skala først og evaluere resultatene", "Innføre den umiddelbart for alle", "Bare sporre ledelsen om de synes endringen er en god ide, uten a teste hvordan den fungerer i praksis", "Vente til noen andre prover det"],
    explanation: 'Endringer bør testes i liten skala først for å se om de virker, for de eventuelt innføres i større skala.',
  },
],
  ...
  'helseoppvekst-vg3-1-4': [
  {
    question: 'Hva er hovedregelen om bruk av tvang i helsetjenesten?',
    options: ["Tvang skal være siste utvei og ha lovhjemmel", "Tvang er forbudt i alle tilfeller", "Den ansatte bestemmer alltid selv når og hvordan tvang skal brukes", "Den ansatte bestemmer alltid"],
    explanation: 'Tvang er strengt regulert, skal være siste utvei og krever lovhjemmel.',
  },
  {
  ...
  {
    question: 'Hvorfor må helsefagarbeideren reflektere over egen maktposisjon?',
    options: ["Fordi forholdet mellom hjelper og pasient er ulikt, og makt kan misbrukes", "Fordi pasienten alltid har all makten i forholdet til helsepersonell", "Fordi makt ikke finnes i en profesjonell relasjon mellom likeverdige", "Fordi makt er helt irrelevant i møtet mellom hjelper og pasient"],
    explanation: 'Det er en maktubalanse i hjelperelasjonen, og bevissthet om dette forebygger misbruk.',
  },
  {
  ...
  'helseoppvekst-vg3-2-1': [
  {
    question: 'Hva er helsekompetanse (helselitterasitet)?',
    options: ["Evnen til å finne, forstå og bruke helseinformasjon for egen helse", "En medisinsk diagnose som stilles ut fra pasientens helsetilstand", "Utdanningen og fagkunnskapen helsepersonell tilegner seg i yrket", "En type behandling som helsepersonell gir pasienter ved sykdom"],
    explanation: 'Helsekompetanse er evnen til å forstå og bruke helseinformasjon til å ta gode helsevalg.',
  },
  {
    question: 'Hva er helsepedagogikk?',
    options: ["Metoder for å veilede og lære opp pasienter og brukere i helsespørsmål", "En type medisin som brukes for å behandle pasienter i helsetjenesten", "En standardisert journalmal for å dokumentere pasientens helseforløp", "En medisinsk diagnose som beskriver en pasients behov for opplæring"],
    explanation: 'Helsepedagogikk er pedagogiske metoder for å styrke pasienters kunnskap og mestring.',
  },
  {
  ...
  {
    question: 'Hvorfor er god helsekompetanse viktig?',
    options: ["Det gir bedre egenmestring og helsevalg", "Det gjør pasienten mer avhengig", "Det er bare viktig for helsepersonell, ikke for pasienten selv", "Det har ingen betydning"],
    explanation: 'God helsekompetanse gjør pasienten i stand til å ta bedre valg og mestre egen helse.',
  },
  {
    question: 'Hvordan kan du styrke en pasients helsekompetanse?',
    options: ["Gi forståelig informasjon tilpasset pasientens nivå og sjekke forståelsen", "Gi mye informasjon raskt uten å forklare eller sjekke om det er forstått", "Bruke vanskelige fagord og medisinske begreper for å virke faglig sterk", "La pasienten finne ut av alt selv uten hjelp eller tilpasset veiledning"],
    explanation: 'Tilpasset, forståelig informasjon og å sjekke forståelsen styrker helsekompetansen.',
  },
],
  'helseoppvekst-vg3-2-2': [
  {
    question: 'Hva er livskvalitet?',
    options: ["Den enkeltes opplevelse av å ha det godt og leve et meningsfullt liv", "Kun størrelsen på inntekten og de materielle godene man har råd til", "Bare fraværet av sykdom, uavhengig av trivsel og opplevd velvære", "Utelukkende god fysisk helse og fravær av plager i kroppen"],
    explanation: 'Livskvalitet er en subjektiv opplevelse av velvære og et meningsfullt liv.',
  },
  {
  ...
  {
    question: 'Hvorfor er brukermedvirkning lovfestet?',
    options: ["Det gir mer treffsikre tjenester og ivaretar selvbestemmelse", "Fordi brukeren alltid vet best medisinsk", "Fordi brukeren alltid vet best hvilken medisinsk behandling som er riktig", "For at kommunen skal kunne redusere kostnadene ved å tilby færre tjenester"],
    explanation: 'Medvirkning gir bedre tilpassede tjenester og ivaretar pasientens autonomi.',
  },
],
  ...
  {
    question: 'Hva er klageretten?',
    options: ["Retten til å klage på vedtak eller helsehjelp man mener er feil", "Retten til å bestemme andres behandling", "En rettighet til erstatning i form av lønn når behandlingen tar lang tid", "En plikt til å klage dersom man er misfornøyd med helsehjelpen man mottar"],
    explanation: 'Klageretten gir pasienter og brukere mulighet til å få overprøvd avgjørelser de er uenige i.',
  },
  {
    question: 'Hva innebar fritt behandlingsvalg?',
    options: ["At pasienten kunne velge mellom godkjente behandlingssteder", "At man velger behandlingstype selv", "At pårørende velger behandlingssted på vegne av pasienten det gjelder", "At all behandling er gratis for pasienten uansett hvor den blir utført"],
    explanation: 'Fritt behandlingsvalg ga pasienten rett til å velge mellom ulike godkjente behandlingssteder.',
  },
  {
  ...
  {
    question: 'Hvordan kan du legge til rette for at en ensom bruker deltar i et frivillig tilbud?',
    options: ["Informere om tilbud og bistå med å komme i kontakt", "Bestemme at brukeren ikke trenger det", "La brukeren være alene, siden deltakelse må komme på eget initiativ", "Vurdere at brukeren ikke har behov for tilbudet og la det være med det"],
    explanation: 'Du kan informere om aktuelle tilbud og hjelpe brukeren med å ta kontakt og delta.',
  },
],
  'helseoppvekst-vg3-2-6': [
  {
    question: 'Hva er velferdsteknologi?',
    options: ["Teknologi som støtter trygghet, mestring og selvstendighet", "Tradisjonelle hjelpemidler uten teknologi", "Utelukkende underholdning og tidsfordriv uten funksjon i pleie og omsorg", "Medisinsk behandling alene, altså legemidler og prosedyrer utført av helsepersonell"],
    explanation: 'Velferdsteknologi er løsninger som øker trygghet, mestring og selvstendighet for brukeren.',
  },
  {
  ...
  },
  {
    ...
    options: ["Å hindre at smitte spres", "Å straffe pasienten", "Å spare plass ved å samle flere pasienter på samme rom", "Å gi pasienten ro"],
  ...
  {
    question: 'Hva er målet med mestringsfremmende arbeid?',
    options: ["At brukeren skal klare mest mulig selv", "At brukeren mister ferdigheter", "At brukeren gjøres helt passiv og hviler mest mulig", "At personalet overtar alle oppgaver for å spare tid"],
    explanation: 'Mestringsfremmende arbeid støtter brukeren i å bruke og utvikle egne ressurser.',
  },
  {
    question: 'En bruker klarer å kle på seg med tid og oppmuntring. Hva gjør du?',
    options: ["Lar brukeren gjøre det selv med støtte", "Sier at det går for sakte", "Tar over påkledningen selv for å spare tid i morgenstellet", "Tar over for å spare tid"],
    explanation: 'Å la brukeren gjøre mest mulig selv, med nødvendig støtte, fremmer mestring.',
  },
  {
    question: 'Hvorfor er motivasjon viktig i hverdagsmestring?',
    options: ["Motivasjon driver brukeren til å trene og mestre mer", "Det er bare ferdigheter som teller", "Motivasjon er uten betydning for utfallet av treningen", "Kun de fysiske ferdighetene teller for at brukeren mestrer"],
    explanation: 'Motivasjon er en sentral drivkraft for at brukeren skal trene og mestre dagliglivet.',
  },
],
  'helseoppvekst-vg3-4-3': [
  {
    question: 'Hva er et hjelpemiddel?',
    options: ["Et redskap som kompenserer for nedsatt funksjon og fremmer selvstendighet", "En diagnose som beskriver hvilken funksjonsnedsettelse brukeren har", "En medisinsk behandling som gjenoppretter tapt kroppsfunksjon helt", "Utelukkende de legemidlene brukeren tar for å bedre sin funksjon"],
  ...
  },
  {
    ...
    options: ["Utforming slik at flest mulig kan bruke omgivelser og produkter", "Tilpasning som utelukkende er ment for funksjonsfriske brukere", "Å fjerne all tilrettelegging slik at alle må bruke samme løsning", "Egne separate spesialløsninger for personer med funksjonsnedsettelse"],
    explanation: 'Universell utforming gjør omgivelser tilgjengelige for flest mulig uten spesialtilpasning.',
  },
  {
    question: 'Hvorfor er riktig tilpasning av hjelpemidler viktig?',
    options: ["Feil tilpasning kan gi skade eller redusert nytte", "Alle hjelpemidler passer alle", "Alle hjelpemidler passer alle brukere uansett kropp og behov", "Tilpasning handler bare om at hjelpemiddelet skal se pent ut"],
  ...
  'helseoppvekst-vg3-4-4': [
  {
    question: 'Hva er recovery-orientert tilnærming?',
    options: ["Å støtte personens egen bedringsprosess og mål om et meningsfullt liv", "At behandleren bestemmer alle mål og tiltak på vegne av personen", "Å unngå at personen selv medvirker i sin egen bedringsprosess", "Å fjerne alle symptomer så raskt som mulig med behandling"],
    explanation: 'Recovery handler om å støtte personens egen bedringsprosess og et meningsfullt liv.',
  },
  {
    question: 'Hva er miljøterapi?',
    options: ["Å bruke det daglige miljøet bevisst som ramme for mestring og bedring", "En medisinsk diagnose som beskriver behovet for daglig oppfølging", "En operasjon som gjennomføres for å bedre personens fungering", "En bestemt type medisin som gis for å fremme trygghet og ro"],
    explanation: 'Miljøterapi bruker det daglige miljøet bevisst for å fremme trygghet, mestring og bedring.',
  },
  {
  ...
  },
  {
    ...
    options: ["Med respekt, lytting og uten å dømme", "Med å unngå personen", "Med å unngå personen for ikke å gjøre situasjonen verre", "Med bagatellisering"],
  ...
  'helseoppvekst-vg3-4-5': [
  {
    question: 'Hva er avhengighet?',
    options: ["Et sterkt behov for et rusmiddel til tross for negative konsekvenser", "En enkeltstående bruk av et rusmiddel ved én bestemt anledning", "En allergisk reaksjon som oppstår ved kontakt med et rusmiddel", "En fysisk skade som følge av langvarig bruk av et rusmiddel"],
  ...
  {
    question: 'Hvorfor er samarbeid viktig i oppfølging av rusproblemer?',
    options: ["Sammensatte behov krever flere tjenester og helhetlig oppfølging", "Én tjeneste og én fagperson klarer å dekke alle behovene alene", "Samarbeid mellom tjenester hindrer og forsinker god behandling", "Samarbeid er unødvendig når brukeren allerede får hjelp"],
    explanation: 'Rusproblemer er ofte sammensatte og krever tverrfaglig og samordnet oppfølging.',
  },
],
  ...
  {
    question: 'Hva fremmer deltakelse for brukere?',
    options: ["Tilrettelegging ut fra interesser og funksjonsnivå", "Vanskeligst mulige aktiviteter", "At alle brukere gjør nøyaktig de samme aktivitetene likt", "At aktivitetene gjøres vanskeligst mulig for å utfordre alle"],
    explanation: 'Deltakelse fremmes ved å tilrettelegge ut fra brukerens interesser og funksjonsnivå.',
  },
  {
    question: 'Hva betyr en meningsfull hverdag for en bruker?',
    options: ["En hverdag med innhold, mestring og tilhørighet", "En hverdag der andre bestemmer alt", "En hverdag helt uten aktiviteter eller innhold av verdi", "En hverdag der personalet bestemmer alt brukeren skal gjøre"],
    explanation: 'En meningsfull hverdag har innhold, mestring og sosial tilhørighet.',
  },
  {
    question: 'En bruker har vært glad i musikk. Hvordan bruker du dette?',
    options: ["Tilbyr tilrettelagte musikkaktiviteter som meningsfull aktivitet", "Lar brukeren bli sittende uten aktivitet framfor å ta initiativ", "Velger en helt fremmed aktivitet uten forbindelse til interessen", "Unngår temaet musikk for ikke å vekke vanskelige minner"],
    explanation: 'Å bygge på brukerens egne interesser gir meningsfulle og motiverende aktiviteter.',
  },
  {
  ...
  'helseoppvekst-vg3-5-1': [
  {
    question: 'Hva er palliativ omsorg?',
    options: ["Lindrende omsorg som fremmer livskvalitet ved alvorlig, uhelbredelig sykdom", "Helbredende behandling som fjerner den underliggende sykdommen", "Rehabilitering som gjenoppretter tapt funksjon etter sykdom", "Forebyggende arbeid som hindrer at alvorlig sykdom oppstår"],
  ...
  },
  {
    ...
    options: ["Fordi smerte er subjektiv og bare pasienten kjenner den", "Fordi smerte alltid kan måles utenfra", "Fordi smerte er objektiv og kan avleses direkte på et måleinstrument", "Fordi smerte alltid kan måles utenfra ut fra puls, blodtrykk og blodprøver"],
    explanation: 'Smerte er subjektiv, og pasientens egen rapport er den beste kilden.',
  },
  {
  ...
  'helseoppvekst-vg3-5-3': [
  {
    question: 'Hva er sorg?',
    options: ["En naturlig reaksjon på tap", "En sykdom man smittes av", "En reaksjon som alltid er unormal og sykelig", "En type behandling"],
    explanation: 'Sorg er en naturlig reaksjon på tap, og kan komme til uttrykk på mange måter.',
  },
  {
  ...
  {
    question: 'Hvorfor er oppfølging etter dødsfall viktig?',
    options: ["Pårørende kan trenge støtte i sorgen", "Pårørende skal klare seg alene", "Det er unødvendig når pasienten er død", "Sorg går alltid raskt over av seg selv"],
    explanation: 'Pårørende kan trenge støtte og oppfølging i sorgprosessen etter et dødsfall.',
  },
  {
  ...
  {
    question: 'Hvordan møter du en pasient med andre religiøse tradisjoner enn dine egne?',
    options: ["Med respekt og åpenhet, og tilrettelegger så langt det er mulig", "Ved å behandle alle helt likt uansett", "Med å overse tradisjonene og behandle det som uvesentlig i pleien", "Med å diskutere og utfordre troen for å få pasienten på andre tanker"],
    explanation: 'Respekt, åpenhet og tilrettelegging for den enkeltes tradisjoner er god omsorg.',
  },
  {
  ...
  },
  {
    ...
    options: ["Plikten til å føre journal om helsehjelpen som gis", "At man kan dokumentere når man vil", "Retten til å be om innsyn i egen journal når man ønsker det", "Plikten til å innhente samtykke før man setter i gang tiltak"],
    explanation: 'Helsepersonell har plikt til å dokumentere relevant helsehjelp i journalen.',
  },
],
  'helseoppvekst-vg3-6-2': [
  {
    question: 'Hva er pasientsikkerhet?',
    options: ["Vern mot unødig skade i forbindelse med helsehjelp", "At pasienten alltid blir frisk", "Retten pasienten har til å velge sykehus og behandler selv", "At all behandling skal være gratis for den enkelte pasienten"],
  ...
  },
  {
    ...
    options: ["Å jevnlig vurdere og forbedre arbeidet ut fra erfaring og avvik", "Å kun forbedre rutinene når tilsynsmyndigheten krever det", "Å fjerne skriftlige rutiner for å gjøre arbeidet mer fleksibelt", "Å utføre alle oppgaver på nøyaktig samme måte for alltid"],
    explanation: 'Kontinuerlig forbedring betyr stadig å justere praksis ut fra erfaringer og avvik.',
  },
],
  'helseoppvekst-vg3-6-3': [
  {
  ...
  },
  {
    ...
    options: ["Bruk av hjelpemidler, kroppens tyngde og samarbeid for å skåne rygg", "Å løfte pasienten helt alene uten hjelpemidler eller samarbeid", "Å løfte raskt med strak rygg og strake bein for å spare tid", "Å vri overkroppen mens man løfter for å nå lenger til siden"],
    explanation: 'God forflytningsteknikk skåner både ansatt og pasient ved bruk av hjelpemidler og riktig teknikk.',
  },
  {
  ...
  'helseoppvekst-vg3-6-4': [
  {
    question: 'Hva betyr bærekraft i helsesektoren?',
    options: ["Å bruke ressurser ansvarlig med hensyn til miljø og framtidige generasjoner", "Å bruke mest mulig ressurser nå for å gi best mulig hjelp i dag", "Utelukkende å spare penger i budsjettet uansett andre hensyn", "Å stoppe all faglig utvikling for å hindre økt ressursbruk"],
  ...
  },
  {
    ...
    options: ["Det forebygger smitte og miljøbelastning", "Det gjelder kun husholdninger", "Det har liten betydning så lenge avfallet blir kastet et sted", "Det har ingen betydning"],
  ...
  },
  {
    ...
    options: ["Redusere unødig forbruk og kildesortere", "Bruke mest mulig engangsutstyr", "Å ignorere ressursbruken så lenge oppgavene blir utført raskt", "Kaste alt i samme søppel"],
  ...
  },
  {
    ...
    options: ["Å bruke utstyr og materialer fornuftig uten unødig sløsing", "Å se helt bort fra kostnader så lenge kvaliteten blir god", "Å bruke mest mulig utstyr for å være godt forberedt på alt", "Å aldri kaste noe, men samle opp utstyr og materialer i lager"],
  ...
  'helseoppvekst-vg3-7-1': [
  {
    question: 'Hva er tverrfaglig samarbeid?',
    options: ["Samarbeid mellom ulike yrkesgrupper for helhetlige tjenester", "At én person tar ansvar for alle oppgavene rundt pasienten", "Samarbeid som kun foregår innenfor én og samme yrkesgruppe", "Konkurranse mellom yrkesgruppene om hvem som gjør mest"],
  ...
  'helseoppvekst-vg3-7-2': [
  {
    question: 'Hva regulerer helsepersonelloven?',
    options: ["Plikter og krav til helsepersonell, som forsvarlighet og taushetsplikt", "Trafikkreglene som gjelder for ambulanser og annen syketransport", "Bare lønnsnivået og arbeidstiden til ansatte i helsetjenesten", "Skatte- og avgiftsforholdene for private helsevirksomheter"],
  ...
  },
  {
    ...
    options: ["At helsehjelpen skal være faglig forsvarlig og omsorgsfull", "At det holder å dokumentere hjelpen godt nok i journalen", "At helsepersonell fritt kan velge hvordan hjelpen skal gis", "At hjelpen skal gis raskest mulig, framfor grundig og trygt"],
  ...
  'helseoppvekst-vg3-7-3': [
  {
    question: 'Hva kjennetegner den norske arbeidslivsmodellen?',
    options: ["Samarbeid mellom partene, ordnede forhold og trepartssamarbeid", "At arbeidsgiveren har all makt og bestemmer vilkårene alene", "At fagforeninger er forbudt for å hindre uro i arbeidslivet", "Mye konflikt og uorden fordi partene sjelden blir enige"],
  ...
  },
  {
    ...
    options: ["En kollektiv avtale om lønn og arbeidsvilkår mellom partene", "En privat lønnsavtale som gjelder for kun én enkelt ansatt", "En lov vedtatt av Stortinget som gjelder alle arbeidstakere", "En forsikringspolise som dekker ansatte ved yrkesskade og sykdom"],
  ...
  },
  {
    ...
    options: ["Fordi kunnskap, metoder og regelverk endres over tid", "Fordi det aldri skjer endringer", "Fordi rutiner som allerede fungerer godt sjelden trenger endring", "Fordi fagfeltet er stabilt og metodene sjelden eller aldri endres"],
  ...
  },
  {
    ...
    options: ["Søke ny kunnskap, reflektere og ta imot veiledning", "Holde på gammel praksis uansett", "Holde fast på innarbeidet praksis og la være å prøve nye metoder", "Unngå tilbakemeldinger fra kolleger for å bevare egen selvtillit"],
  ...
  {
    question: 'Hva er ofte et utgangspunkt for forbedringsarbeid?',
    options: ["Avvik, tilbakemeldinger og erfaringer fra praksis", "At man unngår å se på praksis", "En antakelse om at rutinene er optimale og ikke kan bli bedre", "En bevisst unngåelse av å granske praksis for å slippe kritikk"],
    explanation: 'Avvik, tilbakemeldinger og praksiserfaringer peker ofte på hva som kan forbedres.',
  },
],
  ...
  {
    question: 'Hva er et eksempel på spesialisering for en helsefagarbeider?',
    options: ["Videreutdanning innen for eksempel demensomsorg eller rehabilitering", "Å bytte til et helt annet yrke som ikke bygger på fagbrevet man har", "Å ta grunnskolen eller videregående på nytt for å endre karrierevei", "Å slutte i yrket for å ta seg en lengre pause fra arbeidslivet"],
    explanation: 'Helsefagarbeidere kan spesialisere seg gjennom videreutdanning, for eksempel innen demens eller rehabilitering.',
  },
  {
...
export default quizData_helseoppvekst_vg3;
