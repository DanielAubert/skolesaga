      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'En ny type filosofi utviklet av humanistene', isCorrect: false },
              { id: 'b', text: 'En form for økonomisk støtte fra rike familier til kunstnere og tenkere', isCorrect: true },
              { id: 'c', text: 'Et system for å kopiere bøker i klostrene', isCorrect: false },
              { id: 'd', text: 'Et politisk forbund mellom italienske bystater', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Fordi Italia hadde de beste universitetene i middelalderen', isCorrect: false },
              { id: 'b', text: 'Fordi paven beordret italienerne å studere antikken', isCorrect: false },
              ...
              { id: 'd', text: 'Fordi Italia var det eneste landet der man fant antikke ruiner', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Renessansekunsten var utelukkende abstrakt og symbolsk', isCorrect: false },
              { id: 'b', text: 'Renessansekunsten brukte bare religiøse motiver', isCorrect: false },
              { id: 'c', text: 'Renessansekunsten la vekt på realisme, sentralperspektiv og studier av anatomi', isCorrect: true },
              { id: 'd', text: 'Renessansekunsten unngikk å fremstille mennesker', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              ...
              { id: 'c', text: 'Sandro Botticelli', isCorrect: false },
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'De ble trykt med treblokker i store fabrikker', isCorrect: false },
              { id: 'b', text: 'De ble kopiert for hånd, vanligvis av munker i klostre', isCorrect: true },
              { id: 'c', text: 'De ble laget av profesjonelle forfattere i byene', isCorrect: false },
              { id: 'd', text: 'Det fantes ingen bøker før Gutenberg', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Luther oppfant boktrykkerkunsten for å spre sine teser', isCorrect: false },
              { id: 'b', text: 'Paven brukte trykkpressen til å stoppe Luther', isCorrect: false },
              { id: 'c', text: 'Trykkpressen gjorde det mulig å spre Luthers teser over hele Europa på bare noen uker', isCorrect: true },
              { id: 'd', text: 'Det var ingen sammenheng mellom de to hendelsene', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Fordi vanlige folk var motstandere av renessansen', isCorrect: false },
              ...
              { id: 'c', text: 'Fordi kirken aktivt hindret all spredning av nye ideer', isCorrect: false },
              { id: 'd', text: 'Fordi renessansen bare varte noen få år', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Fordi renessansekunsten var av dårlig kvalitet', isCorrect: false },
              ...
              { id: 'c', text: 'Fordi humanistene var motstandere av vitenskap', isCorrect: false },
              { id: 'd', text: 'Fordi renessansen bare påvirket Italia og ingen andre land', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Middelalderen', isCorrect: false },
              { id: 'b', text: 'Vikingtiden', isCorrect: false },
              { id: 'c', text: 'Opplysningstiden', isCorrect: true },
              { id: 'd', text: 'Steinalderen', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Han ønsket å bli pave selv', isCorrect: false },
              { id: 'b', text: 'Han reagerte på misnøyen med kirkens avlatshandel og andre misbruk', isCorrect: true },
              { id: 'c', text: 'Han ville starte en ny religion basert på islam', isCorrect: false },
              { id: 'd', text: 'Kongen tvang ham til å kritisere kirken', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Telegrafen', isCorrect: false },
              { id: 'b', text: 'Kompasset', isCorrect: false },
              { id: 'c', text: 'Karavellen', isCorrect: false },
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'At man måtte gjøre gode gjerninger for å bli frelst', isCorrect: false },
              { id: 'b', text: 'At troen alene er nok for frelse -- dette gjorde avlatshandelen meningsløs', isCorrect: true },
              { id: 'c', text: 'At alle religioner er like sanne', isCorrect: false },
              { id: 'd', text: 'At paven er den eneste som kan gi frelse', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'De styrket pavens autoritet overfor fyrstene', isCorrect: false },
              { id: 'b', text: 'De hadde ingen praktisk betydning for kirken', isCorrect: false },
              { id: 'c', text: 'De gjorde bønn i kirken forbudt', isCorrect: false },
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Han var overbevist av Luthers teologi', isCorrect: false },
              { id: 'b', text: 'Han ønsket å innføre kalvinismen i England', isCorrect: false },
              { id: 'c', text: 'Paven nektet å innvilge skilsmisse fra Katarina av Aragon', isCorrect: true },
              { id: 'd', text: 'Han ville alliere seg med det osmanske riket', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'I 1517, samme år som Luther slo opp tesene', isCorrect: false },
              { id: 'b', text: 'I 1648, etter Trettiårskrigen', isCorrect: false },
              { id: 'c', text: 'I 1600, etter en folkeavstemning', isCorrect: false },
        ...
        questions: [
          {
            ...
            options: [
              ...
              { id: 'b', text: 'En avtale som gjenforente den katolske og protestantiske kirken', isCorrect: false },
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Et protestantisk angrep på paven i Roma', isCorrect: false },
              { id: 'b', text: 'En massakre der katolske mobber drepte tusenvis av hugenotter i Paris og andre byer', isCorrect: true },
              { id: 'c', text: 'Et slag i Trettiårskrigen', isCorrect: false },
              { id: 'd', text: 'En fredelig demonstrasjon som endte med forhandlinger', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'At alle europeere fikk individuell religionsfrihet', isCorrect: false },
              { id: 'b', text: 'At katolisismen ble den eneste tillatte religionen', isCorrect: false },
              { id: 'c', text: 'At paven bestemte religionen i alle land', isCorrect: false },
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'At alle land burde ha samme religion', isCorrect: false },
              { id: 'b', text: 'Tanken om religiøs toleranse -- at mennesker med forskjellig tro kan leve side om side', isCorrect: true },
              { id: 'c', text: 'At religion burde avskaffes helt', isCorrect: false },
              { id: 'd', text: 'At bare paven kunne løse religiøse konflikter', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Paven fikk mer makt enn noen gang', isCorrect: false },
              { id: 'b', text: 'Fyrstenes makt ble styrket på bekostning av pavens, og nasjonalkirker oppsto', isCorrect: true },
              { id: 'c', text: 'Europa ble samlet under én felles protestantisk kirke', isCorrect: false },
              { id: 'd', text: 'Alle europeiske land innførte demokrati', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Fordi det var den første boken som noensinne ble trykt', isCorrect: false },
              { id: 'b', text: 'Fordi den styrket det tyske folkespråket og inspirerte lignende oversettelser i andre land', isCorrect: true },
              { id: 'c', text: 'Fordi den var skrevet på latin og dermed forstått av alle', isCorrect: false },
              { id: 'd', text: 'Fordi paven godkjente den som den offisielle Bibelen', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Flukt, forskning, filantropi og fred', isCorrect: false },
              { id: 'b', text: 'Penger/handel, teknologi, religion og eventyrlyst/ære/konkurranse', isCorrect: true },
              { id: 'c', text: 'Krig, politikk, filosofi og kunst', isCorrect: false },
              { id: 'd', text: 'Sult, sykdom, overbefolkning og klimaendringer', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Et stort krigsskip brukt i religionskrigene', isCorrect: false },
              { id: 'b', text: 'En type navigasjonsinstrument fra Kina', isCorrect: false },
              { id: 'c', text: 'Et lite, smidig skip som kunne seile mot vinden og muliggjorde lange sjøreiser', isCorrect: true },
              { id: 'd', text: 'Et handelskontor i Asia', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Kristoffer Columbus', isCorrect: false },
              { id: 'b', text: 'Henrik Sjøfareren', isCorrect: false },
              { id: 'c', text: 'Bartolomeu Dias', isCorrect: false },
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Fordi Columbus aldri nådde det nye kontinentet', isCorrect: false },
              { id: 'b', text: 'Fordi Amerigo Vespucci var den første som forsto at det var et nytt kontinent, ikke Asia', isCorrect: true },
              { id: 'c', text: 'Fordi Columbus nektet å gi det sitt eget navn', isCorrect: false },
              { id: 'd', text: 'Fordi paven bestemte at det skulle hete Amerika', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'At Columbus byttet gull mot glass med urbefolkningen', isCorrect: false },
              { id: 'b', text: 'Den massive utvekslingen av planter, dyr, sykdommer og mennesker mellom Europa og Amerika', isCorrect: true },
              { id: 'c', text: 'At Spania byttet kolonier med Portugal', isCorrect: false },
              { id: 'd', text: 'At europeerne byttet religion med urbefolkningen', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              ...
              { id: 'b', text: 'Ris', isCorrect: false },
              { id: 'c', text: 'Poteten', isCorrect: true },
              { id: 'd', text: 'Sukker', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'En spansk konkvistador som erobret Inkariket', isCorrect: false },
              { id: 'b', text: 'En portugisisk sjøfarer som oppdaget Brasil', isCorrect: false },
              { id: 'c', text: 'En spansk munk som kritiserte overgrepene mot urbefolkningen og talte deres sak', isCorrect: true },
              { id: 'd', text: 'Den siste aztekiske keiseren', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Et system for fredelig kulturutveksling mellom land', isCorrect: false },
              { id: 'b', text: 'En form for demokratisk styring av fjerne landområder', isCorrect: false },
              { id: 'c', text: 'En militær allianse mellom europeiske stater', isCorrect: false },
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Handel med luksusvarer mellom Europa og Amerika', isCorrect: false },
              { id: 'b', text: 'Tvangssending av millioner av afrikanere til Amerika for å arbeide på plantasjer og i gruver', isCorrect: true },
              { id: 'c', text: 'En frivillig migrasjon av europeere til Afrika', isCorrect: false },
              { id: 'd', text: 'Handel med krydder mellom Asia og Europa over Atlanterhavet', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Fordi alle land ble demokratiske', isCorrect: false },
              { id: 'b', text: 'Fordi Europa tok kontroll over hele verden militært', isCorrect: false },
              { id: 'c', text: 'Fordi internett ble oppfunnet', isCorrect: false },
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Makten er fordelt mellom konge, adel og kirke', isCorrect: false },
              { id: 'b', text: 'Folket velger sine egne representanter', isCorrect: false },
              { id: 'c', text: 'Kongen har all makt og står bare til ansvar overfor Gud', isCorrect: true },
              { id: 'd', text: 'Kirken styrer på vegne av kongen', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Frankrike fikk religionsfrihet for alle', isCorrect: false },
              { id: 'b', text: 'Hundretusenvis av hugenotter flyktet fra Frankrike, noe som var et tap av kompetent arbeidskraft', isCorrect: true },
              { id: 'c', text: 'Den katolske kirken mistet all makt i Frankrike', isCorrect: false },
              { id: 'd', text: 'Protestantene fikk sterkere rettigheter enn katolikkene', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Han vant en stor krig mot Sverige og brukte seierens autoritet', isCorrect: false },
              { id: 'b', text: 'Han allierte seg med borgerskapet mot adelen etter en tapt krig som hadde tømt statskassen', isCorrect: true },
              { id: 'c', text: 'Han ble valgt av en folkeforsamling', isCorrect: false },
              { id: 'd', text: 'Paven ga ham ubegrenset makt', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Fra 1660 til 1905', isCorrect: false },
              { id: 'b', text: 'Fra 1536 til 1660', isCorrect: false },
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Bøndene', isCorrect: false },
              { id: 'b', text: 'Borgerne', isCorrect: false },
              { id: 'c', text: 'Adelen', isCorrect: true },
              { id: 'd', text: 'Geistligheten', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'De var selvstendige handelspartnere med fulle rettigheter', isCorrect: false },
              { id: 'b', text: 'De hadde ingen økonomisk betydning for moderlandet', isCorrect: false },
              ...
              { id: 'd', text: 'De bestemte selv hvilke varer de ville handle med', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'At fri handel gagner alle land', isCorrect: false },
              { id: 'b', text: 'At verdens rikdom er ubegrenset og kan vokse for alle', isCorrect: false },
              { id: 'c', text: 'At verdens rikdom er begrenset -- et land kan bare bli rikere ved at et annet blir fattigere', isCorrect: true },
              { id: 'd', text: 'At jordbruk er viktigere enn handel', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Pico della Mirandola og Leonardo da Vinci', isCorrect: false },
              { id: 'b', text: 'Martin Luther og Jean Calvin', isCorrect: false },
              { id: 'c', text: 'Ludvig XIV og Frederik III', isCorrect: false },
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Fordi alle eneveldige konger var inkompetente', isCorrect: false },
              ...
              { id: 'c', text: 'Fordi kirken tvang kongene til å gi fra seg makten', isCorrect: false },
              { id: 'd', text: 'Fordi adelen tok makten tilbake fra kongene', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Norge fikk større selvstendighet enn før', isCorrect: false },
              { id: 'b', text: 'Det norske riksrådet ble avskaffet, og Norge ble formelt et lydrike under Danmark', isCorrect: true },
              { id: 'c', text: 'Norge brøt ut av unionen og ble selvstendig', isCorrect: false },
              { id: 'd', text: 'Norge fikk eget storting med lovgivende makt', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'I Norge ble reformasjonen avvist av befolkningen', isCorrect: false },
              { id: 'b', text: 'I Norge var reformasjonen en folkelig bevegelse nedenfra', isCorrect: false },
              ...
              { id: 'd', text: 'Norge forble katolsk mens Tyskland ble protestantisk', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Sølv fra Kongsberg', isCorrect: false },
              { id: 'b', text: 'Tørrfisk fra Nord-Norge', isCorrect: false },
              { id: 'c', text: 'Trelast -- Europa trengte tømmer til skipbygging, husbygging og gruvedrift', isCorrect: true },
              { id: 'd', text: 'Ull fra norske sauer', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Byen ble aldri gjenoppbygd', isCorrect: false },
              { id: 'b', text: 'Kong Christian IV gjenoppbygde byen som Christiania med moderne byplan og murtvang', isCorrect: true },
              { id: 'c', text: 'Bergen ble ny hovedstad for Norge', isCorrect: false },
              { id: 'd', text: 'Innbyggerne flyttet til København', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'En frivillig avtale mellom bønder og godseiere om jordleie', isCorrect: false },
              { id: 'b', text: 'En ordning der bønder var bundet til godset der de var født og ikke fritt kunne flytte', isCorrect: true },
              { id: 'c', text: 'Et skattesystem som ga bøndene skattefrihet', isCorrect: false },
              { id: 'd', text: 'En lov som ga bønder rett til å eie jord', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Fordi norske konger forbød adel', isCorrect: false },
              { id: 'b', text: 'Fordi Norge var for rikt til at adelen trengte privilegier', isCorrect: false },
              { id: 'c', text: 'Fordi svartedauden rammet Norge ekstra hardt, og mye av den norske adelen døde ut', isCorrect: true },
              { id: 'd', text: 'Fordi bøndene beseiret adelen i en borgerkrig', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'At de måtte betale for lite i skatt', isCorrect: false },
              { id: 'b', text: 'Urettferdige fogder, handelsmonopoler, borgerprivilegier og korrupsjon blant embetsmenn', isCorrect: true },
              { id: 'c', text: 'At kongen ikke var luthersk nok', isCorrect: false },
              { id: 'd', text: 'At de ikke fikk flytte til Danmark', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Han ble belønnet av kongen for sin innsats', isCorrect: false },
              { id: 'b', text: 'Han ble valgt inn i riksrådet', isCorrect: false },
              { id: 'c', text: 'Han flyktet til Sverige og levde der resten av livet', isCorrect: false },
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'En dansk embetsmann som styrte Nord-Norge', isCorrect: false },
              ...
              { id: 'c', text: 'En sjøfarer som oppdaget Svalbard', isCorrect: false },
              { id: 'd', text: 'Grunnleggeren av Universitetet i Oslo', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'En dansk organisasjon som arbeidet for å avvikle det norske språket', isCorrect: false },
              { id: 'b', text: 'Et handelsselskap som drev norsk eksport', isCorrect: false },
              { id: 'c', text: 'En forening av norske studenter i København som diskuterte norsk identitet og Norges stilling', isCorrect: true },
              { id: 'd', text: 'En militær organisasjon som planla norsk uavhengighet', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'En stor norsk hær og flåte', isCorrect: false },
              { id: 'b', text: 'Norsk kontroll over den danske kongen', isCorrect: false },
              { id: 'c', text: 'En norsk identitet, selvbevisst bondestand, kulturelle tradisjoner og økonomiske ressurser', isCorrect: true },
              { id: 'd', text: 'Støtte fra Sverige til norsk uavhengighet', isCorrect: false },
            ],
