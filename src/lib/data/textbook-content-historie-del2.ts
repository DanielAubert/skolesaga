...
Erobringene førte til at urbefolkningen ble underkastet, tvunget til arbeid i gruver og på plantasjer, og forsøkt omvendt til kristendommen. Sølv og gull strømmet til Spania, som ble Europas mektigste stat.`,
    ...
    // --- Oppsummeringsoppgaver ---
    {
      ...
      exercise: {
        ...
        number: '5',
        type: 'classic',
        task: 'Drøft konsekvensene av oppdagelsesreisene og kolonialismen for urbefolkningen i Amerika. Var dette en "oppdagelse" eller en erobring?',
        solution: 'For urbefolkningen var dette først og fremst en katastrofe, ikke en oppdagelse: 1) Demografisk katastrofe: Opptil 90% av urbefolkningen døde av sykdommer. 2) Tap av frihet: Urbefolkningen ble underlagt kolonimaktene, tvangsarbeid ble innført. 3) Kulturell ødeleggelse: Religiøse praksiser ble forbudt, språk undertrykt, tradisjonelle samfunnsstrukturer ødelagt. 4) Økonomisk utbytting: Ressurser og arbeidskraft ble utnyttet til europeernes fordel. Begrepet "oppdagelse" er eurosentriskt - Amerika var allerede "oppdaget" av millioner som bodde der. For urbefolkningen var dette en brutal erobring og begynnelsen på århundrer med kolonial undertrykkelse. Samtidig var det starten på global sammenheng og utveksling.',
        allowsUpload: true,
        allowsCanvasDrawing: true,
      },
    },
