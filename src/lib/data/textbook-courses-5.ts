...
export const COURSE_NORSK_5: TextbookCourse = {
  ...
  chapters: [
      ...
      wip: true, linkedChapterId: 'norsk-5-4-1-narrativ' },
    {
      ...
      { id: 'norsk-5-4-3', number: '4.3', title: 'Drama og rollespill', description: 'Lær å uttrykke deg gjennom drama, rollespill og teater.', estimatedMinutes: 45, exerciseCount: 1, topics: [], competenceGoals: ['bruke drama og rollespill for å utforske tekster og situasjoner'], linkedChapterId: 'norsk-5-4-3-narrativ' },
    { id: 'norsk-5-5-1', number: '5.1', title: 'Eventyr', description: 'Lær om eventyrets kjennetegn og hvordan eventyr er bygget opp.', estimatedMinutes: 50, exerciseCount: 2, topics: [], competenceGoals: ['gjenkjenne og forklare kjennetegn ved eventyr'], linkedChapterId: 'norsk-5-5-1-narrativ' },
    { id: 'norsk-5-5-2', number: '5.2', title: 'Fabler og sagn', description: 'Lær om fabler med snakkende dyr og sagn om helter.', estimatedMinutes: 45, exerciseCount: 1, topics: [], competenceGoals: ['kjenne til ulike typer fortellinger som fabel og sagn'], linkedChapterId: 'norsk-5-5-2-narrativ' },
    { id: 'norsk-5-5-3', number: '5.3', title: 'Dikt og rim', description: 'Lær om dikt, rim og rytme i språket.', estimatedMinutes: 45, exerciseCount: 2, topics: [], competenceGoals: ['lese og skrive dikt med rim og rytme'], linkedChapterId: 'norsk-5-5-3-narrativ' },
  ],
};
...
export const COURSE_ENGELSK_5: TextbookCourse = {
  ...
  chapters: [
      ...
      wip: true, linkedChapterId: 'engelsk-5-4-1-narrativ' },
    {
      ...
      { id: 'engelsk-5-1-3', number: '1.3', title: 'Building Vocabulary - Family and Friends', description: 'Learn words about family members and describing people.', estimatedMinutes: 40, exerciseCount: 2, topics: [], competenceGoals: ['talk about family and people you know'], linkedChapterId: 'engelsk-5-1-3-narrativ' },
    { id: 'engelsk-5-2-4', number: '2.4', title: 'Adjectives', description: 'Learn words that describe things and people.', estimatedMinutes: 40, exerciseCount: 3, topics: [], competenceGoals: ['use describing words in English'], linkedChapterId: 'engelsk-5-2-4-narrativ' },
    { id: 'engelsk-5-3-3', number: '3.3', title: 'Capital Letters and Punctuation', description: 'Learn when to use capital letters and punctuation marks.', estimatedMinutes: 35, exerciseCount: 2, topics: [], competenceGoals: ['use basic punctuation in English'], linkedChapterId: 'engelsk-5-3-3-narrativ' },
    { id: 'engelsk-5-4-3', number: '4.3', title: 'Holidays and Traditions', description: 'Learn about holidays in English-speaking countries.', estimatedMinutes: 40, exerciseCount: 3, topics: [], competenceGoals: ['know about traditions in English-speaking countries'], linkedChapterId: 'engelsk-5-4-3-narrativ' },
  ],
};
...
export const COURSE_KUNST_5: TextbookCourse = {
  ...
  chapters: [
    ...
    // Kapittel 4: Kunsthistorie
    {
      ...
      { id: 'kunst-5-4-2', number: '4.2', title: 'Norske kunstnere og kunst fra vår tid', description: 'Utforsk norsk kunst og kunstnere som lever og arbeider i dag.', estimatedMinutes: 50, exerciseCount: 4, topics: [], competenceGoals: ['utforske og samtale om norsk kunst og samtidskunst', 'forstå at kunst kan uttrykke følelser og budskap'], linkedChapterId: 'kunst-5-4-2-narrativ' },
  ],
};
