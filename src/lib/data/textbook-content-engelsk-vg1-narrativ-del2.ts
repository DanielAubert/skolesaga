...
Signal words help you choose the right tense. Words like "yesterday," "last week," "in 2019," "when I was young," and "ago" point firmly to past simple - they specify a finished time. Words like "already," "yet," "ever," "never," "recently," "just," and "so far" signal present perfect - they connect to the current moment. The words "since" and "for" typically go with present perfect when describing duration up to now: "I have known her since childhood" or "They have been married for twenty years."`,
    },
    {
      ...
      exercise: {
        ...
        task: 'Test yourself on present perfect vs past simple:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'engelsk-vg1-3-1-n-quiz1-q0',
            ...
            solution: 'Option B is correct because "since 2018" indicates a situation continuing to the present. Options A and C incorrectly mix present perfect with specific past time markers. Option D uses incorrect grammar ("have gone").',
          },
          {
            id: 'engelsk-vg1-3-1-n-quiz1-q1',
            task: 'A job interviewer asks "Have you worked with international clients?" Why do they use present perfect?',
            options: [
              { id: 'a', text: 'Because they want to know the exact date you worked with them', isCorrect: false },
              { id: 'b', text: 'Because they want to know about your accumulated experience up to now', isCorrect: true },
              { id: 'c', text: 'Because present perfect sounds more polite', isCorrect: false },
              { id: 'd', text: 'Because past simple would be grammatically incorrect here', isCorrect: false },
            ],
            solution: 'Present perfect asks about accumulated experience without specifying when. The interviewer cares that you have the experience, not when exactly it happened. This connects past actions to present relevance.',
          },
          {
            id: 'engelsk-vg1-3-1-n-quiz1-q2',
            task: 'Which signal words typically indicate present perfect should be used?',
            options: [
              { id: 'a', text: 'Yesterday, last week, in 2019, ago', isCorrect: false },
              { id: 'b', text: 'Already, yet, ever, never, recently, since, for', isCorrect: true },
              { id: 'c', text: 'Tomorrow, next week, soon, later', isCorrect: false },
              { id: 'd', text: 'Always, sometimes, usually, often', isCorrect: false },
            ],
            solution: 'Words like "already," "yet," "ever," "never," "recently," "since," and "for" signal present perfect because they connect to the current moment. Words like "yesterday" and "ago" specify finished times and require past simple.',
          },
        ],
      },
    },
...
The third conditional takes us into alternative histories - the realm of what might have been but never was. If I had studied harder, I would have passed the exam. If she had left earlier, she would have caught the train. If they had invested in that company, they would be millionaires now. These situations are impossible because we cannot change the past. The structure is "if" plus past perfect, then "would have" plus past participle. You are imagining how things could have been different, often with a sense of regret or relief. The third conditional is essential for analyzing past decisions, expressing regrets, and understanding historical turning points.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 2',
        type: 'multiple-choice',
        task: 'Test yourself on conditional sentences:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'engelsk-vg1-3-1-n-quiz2-q0',
            ...
            solution: 'This is second conditional. The speaker does not currently have enough money (hypothetical present). The structure "if + past tense, would + infinitive" confirms this.',
          },
          {
            id: 'engelsk-vg1-3-1-n-quiz2-q1',
            task: '"If it rains tomorrow, we will cancel the picnic." Which conditional is this?',
            options: [
              { id: 'a', text: 'Zero conditional', isCorrect: false },
              { id: 'b', text: 'First conditional', isCorrect: true },
              { id: 'c', text: 'Second conditional', isCorrect: false },
              { id: 'd', text: 'Third conditional', isCorrect: false },
            ],
            solution: 'This is first conditional, expressing a real future possibility. The structure is "if + present tense, will + infinitive." Rain tomorrow is a genuine possibility, not hypothetical.',
          },
          {
            id: 'engelsk-vg1-3-1-n-quiz2-q2',
            task: '"If I had studied harder, I would have passed the exam." Which conditional is this?',
            options: [
              { id: 'a', text: 'First conditional - a future possibility', isCorrect: false },
              { id: 'b', text: 'Second conditional - a hypothetical present', isCorrect: false },
              { id: 'c', text: 'Third conditional - an impossible past', isCorrect: true },
              { id: 'd', text: 'Zero conditional - a universal truth', isCorrect: false },
            ],
            solution: 'This is third conditional, imagining an alternative past. The speaker did not study hard enough and failed. "If + past perfect, would have + past participle" expresses regret about what might have been.',
          },
        ],
      },
    },
...
Practice by thinking about your own life. What would you do if you had a million dollars? What would have happened if you had made different choices in school? What will you do if you get the opportunity to study abroad? If you had been born in a different country, how would your life be different today? Each question naturally calls for a different conditional structure. By reflecting on your own experiences and possibilities, you internalize these patterns in a way that rote memorization never achieves.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 3',
        type: 'multiple-choice',
        task: 'Test yourself on mixed conditionals:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'engelsk-vg1-3-1-n-quiz3-q0',
            ...
            solution: 'Mixed conditionals connect different time frames - typically a past condition affecting a present result ("If I had studied medicine, I would be a doctor now").',
          },
          {
            id: 'engelsk-vg1-3-1-n-quiz3-q1',
            task: '"If I had learned English as a child, I would speak it fluently now." What makes this a mixed conditional?',
            options: [
              { id: 'a', text: 'It uses both "if" and "would"', isCorrect: false },
              { id: 'b', text: 'The condition is in the past (had learned) but the result is in the present (would speak now)', isCorrect: true },
              { id: 'c', text: 'It describes something impossible', isCorrect: false },
              { id: 'd', text: 'It contains two independent clauses', isCorrect: false },
            ],
            solution: 'This is mixed because the if-clause uses past perfect (past time) while the result clause uses "would + infinitive" (present time). A past decision shapes a current reality.',
          },
        ],
      },
    },
...
The subjunctive "were" trips people up too. While "If I was rich" is increasingly heard in casual speech, "If I were rich" remains the standard form, especially in formal writing and professional contexts. This applies to all subjects: "If he were here," "If she were president," "If it were possible." When in doubt, use "were" for hypothetical conditions - it always sounds educated and correct, whereas "was" might be judged as an error by some listeners or readers.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 4',
        type: 'multiple-choice',
        task: 'Test yourself on common grammar errors:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'engelsk-vg1-3-1-n-quiz4-q0',
            ...
            solution: 'Option C is incorrect. The "if" clause should not use "would." It should be "If I had time, I would come." Using "would" in both parts of a conditional is a very common error.',
          },
          {
            id: 'engelsk-vg1-3-1-n-quiz4-q1',
            task: 'Why is "I have been knowing her for years" incorrect?',
            options: [
              { id: 'a', text: 'Because "years" requires past simple', isCorrect: false },
              { id: 'b', text: 'Because "know" is a state verb that does not take continuous form', isCorrect: true },
              { id: 'c', text: 'Because present perfect continuous does not exist', isCorrect: false },
              { id: 'd', text: 'Because "for" should be replaced with "since"', isCorrect: false },
            ],
            solution: 'State verbs like "know," "believe," "understand," "love," and "want" describe conditions rather than actions and do not take the continuous form. The correct form is "I have known her for years."',
          },
          {
            id: 'engelsk-vg1-3-1-n-quiz4-q2',
            task: 'In formal writing, which form is correct for hypothetical conditions?',
            options: [
              { id: 'a', text: '"If I was rich" is always correct', isCorrect: false },
              { id: 'b', text: '"If I were rich" using the subjunctive', isCorrect: true },
              { id: 'c', text: 'Both forms are equally formal', isCorrect: false },
              { id: 'd', text: 'Neither form is used in modern English', isCorrect: false },
            ],
            solution: '"If I were rich" uses the subjunctive mood, which is standard for hypothetical conditions in formal writing. While "If I was" is heard in casual speech, "If I were" always sounds educated and correct.',
          },
        ],
      },
    },
...
Remember that even native speakers make mistakes and disagree about certain usages. Language is alive and constantly evolving. What matters is that you understand the system well enough to make informed choices and communicate effectively. No one expects perfection - they expect clarity and confidence. With the foundations you have built in this chapter, you have the tools to express complex ideas about time, possibility, and reality with precision and sophistication.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 5',
        type: 'multiple-choice',
        task: 'Test yourself on grammar mastery:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'engelsk-vg1-3-1-n-quiz5-q0',
            ...
            solution: 'Mastery comes from regular practice and awareness. By noticing how grammar works in real texts and using structures in your own communication, you develop intuition alongside knowledge.',
          },
          {
            id: 'engelsk-vg1-3-1-n-quiz5-q1',
            task: 'What is a "grammar journal" and why is it useful?',
            options: [
              { id: 'a', text: 'A textbook that lists all grammar rules alphabetically', isCorrect: false },
              { id: 'b', text: 'A personal record of confusing sentences, mistakes, and corrections that becomes your own reference', isCorrect: true },
              { id: 'c', text: 'A daily diary written in perfect grammar', isCorrect: false },
              { id: 'd', text: 'A test preparation booklet', isCorrect: false },
            ],
            solution: 'A grammar journal is a personal collection of patterns and examples that are meaningful to you. Recording sentences that confuse you and corrections you receive builds a reference far more effective than memorizing textbook rules.',
          },
        ],
      },
    },
...
Understanding these building blocks gives you the raw materials for constructing varied sentences. Think of independent clauses as the main dishes and dependent clauses as the accompaniments that enhance and complete the meal.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 1',
        type: 'multiple-choice',
        task: 'Test yourself on clauses and sentence building blocks:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'engelsk-vg1-3-2-n-quiz1-q0',
          ...
          {
            id: 'engelsk-vg1-3-2-n-quiz1-q1',
            task: 'In the sentence "When she laughed, everyone relaxed," what type of dependent clause is "When she laughed"?',
            options: [
              { id: 'a', text: 'Relative clause', isCorrect: false },
              { id: 'b', text: 'Noun clause', isCorrect: false },
              { id: 'c', text: 'Adverbial clause', isCorrect: true },
              { id: 'd', text: 'Independent clause', isCorrect: false },
            ],
            solution: '"When she laughed" is an adverbial clause because it tells us about time - when the relaxing happened. Adverbial clauses start with subordinating conjunctions like "when," "although," "because," and "while."',
          },
          {
            id: 'engelsk-vg1-3-2-n-quiz1-q2',
            task: 'Which sentence contains a relative clause?',
            options: [
              { id: 'a', text: 'Because it rained, we stayed inside.', isCorrect: false },
              { id: 'b', text: 'She decided that she would leave.', isCorrect: false },
              { id: 'c', text: 'I believe the story is true.', isCorrect: false },
              { id: 'd', text: 'The teacher who helped me is retiring.', isCorrect: true },
            ],
            solution: '"Who helped me" is a relative clause - it describes the noun "teacher" using the relative pronoun "who." Relative clauses add information about nouns and use pronouns like who, which, that, whose, and where.',
          },
        ],
      },
    },
...
The magic happens when you mix these types intentionally. A paragraph of only simple sentences feels choppy and childish. A paragraph of only complex sentences feels dense and academic. But a paragraph that varies between them creates flow, rhythm, and engagement. The simple sentence after a complex one provides relief. The complex sentence after simple ones adds depth. This is the rhythm of good writing.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 2',
        type: 'multiple-choice',
        task: 'Test yourself on the four sentence types:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'engelsk-vg1-3-2-n-quiz2-q0',
          ...
          {
            id: 'engelsk-vg1-3-2-n-quiz2-q1',
            task: 'Which sentence is a compound sentence?',
            options: [
              { id: 'a', text: 'Although she tried hard, she failed.', isCorrect: false },
              { id: 'b', text: 'She tried hard, but she failed.', isCorrect: true },
              { id: 'c', text: 'The girl who tried hard failed.', isCorrect: false },
              { id: 'd', text: 'She failed.', isCorrect: false },
            ],
            solution: 'A compound sentence joins two independent clauses with a coordinating conjunction (FANBOYS). "She tried hard" and "she failed" are both independent clauses joined by "but." Option A is complex (subordinating conjunction "although"), C is complex (relative clause), and D is simple.',
          },
          {
            id: 'engelsk-vg1-3-2-n-quiz2-q2',
            task: 'What does FANBOYS stand for?',
            options: [
              { id: 'a', text: 'For, And, Nor, But, Or, Yet, So', isCorrect: true },
              { id: 'b', text: 'First, Also, Next, Because, Often, Yet, Since', isCorrect: false },
              { id: 'c', text: 'Furthermore, Additionally, Nevertheless, Besides, Otherwise, Yet, Similarly', isCorrect: false },
              { id: 'd', text: 'For, After, Nor, Before, Or, Yet, Since', isCorrect: false },
            ],
            solution: 'FANBOYS is the mnemonic for the seven coordinating conjunctions: For, And, Nor, But, Or, Yet, So. These are used to join independent clauses in compound sentences, with a comma before the conjunction.',
          },
          {
            id: 'engelsk-vg1-3-2-n-quiz2-q3',
            task: 'Why does mixing all four sentence types improve writing?',
            options: [
              { id: 'a', text: 'It proves the writer knows grammar rules', isCorrect: false },
              { id: 'b', text: 'It makes texts longer', isCorrect: false },
              { id: 'c', text: 'It creates rhythm and keeps readers engaged', isCorrect: true },
              { id: 'd', text: 'Teachers require it in assignments', isCorrect: false },
            ],
            solution: 'Mixing sentence types creates flow and rhythm. Simple sentences after complex ones provide relief and emphasis. Complex sentences after simple ones add depth. This variety keeps readers engaged, just as varied musical notes create interesting melodies.',
          },
        ],
      },
    },
...
Appositives rename or describe a noun compactly. "My neighbor, a retired doctor, helped me." "Oslo, the capital of Norway, has a population of about one million." This technique packs extra information into a sentence without making it feel cluttered. Appositives are set off by commas and can be removed without breaking the sentence grammatically.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 3',
        type: 'multiple-choice',
        task: 'Test yourself on sentence combining techniques:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'engelsk-vg1-3-2-n-quiz3-q0',
          ...
          {
            id: 'engelsk-vg1-3-2-n-quiz3-q1',
            task: '"The sunset was beautiful; I took a photograph." What joining technique is used here?',
            options: [
              { id: 'a', text: 'Coordinating conjunction', isCorrect: false },
              { id: 'b', text: 'Subordinating conjunction', isCorrect: false },
              { id: 'c', text: 'Semicolon', isCorrect: true },
              { id: 'd', text: 'Appositive', isCorrect: false },
            ],
            solution: 'A semicolon joins two closely related independent clauses without a conjunction. It suggests an intimate connection between the ideas - the beauty prompted the photograph - without spelling out the relationship explicitly.',
          },
          {
            id: 'engelsk-vg1-3-2-n-quiz3-q2',
            task: 'What is an appositive in the sentence "My neighbor, a retired doctor, helped me"?',
            options: [
              { id: 'a', text: '"My neighbor" - it is the subject', isCorrect: false },
              { id: 'b', text: '"helped me" - it is the action', isCorrect: false },
              { id: 'c', text: '"a retired doctor" - it renames the noun compactly', isCorrect: true },
              { id: 'd', text: 'The commas - they are punctuation devices', isCorrect: false },
            ],
            solution: '"A retired doctor" is an appositive - it renames or describes the noun "my neighbor" compactly. Appositives are set off by commas and can be removed without breaking the sentence grammatically, but they add useful information efficiently.',
          },
        ],
      },
    },
...
The key is conscious variation. Read your work aloud. If it sounds monotonous, look for opportunities to restructure some sentences. You do not need to vary every single opening - subject-first sentences are perfectly fine - but mixing in other patterns creates rhythm and keeps readers engaged.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 4',
        type: 'multiple-choice',
        task: 'Test yourself on varying sentence openings:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'engelsk-vg1-3-2-n-quiz4-q0',
          ...
          {
            id: 'engelsk-vg1-3-2-n-quiz4-q1',
            task: '"Hoping for the best, she opened the envelope." What type of opening is this?',
            options: [
              { id: 'a', text: 'Adverb phrase opening', isCorrect: false },
              { id: 'b', text: 'Participle phrase opening', isCorrect: true },
              { id: 'c', text: 'Infinitive phrase opening', isCorrect: false },
              { id: 'd', text: 'Dependent clause opening', isCorrect: false },
            ],
            solution: '"Hoping for the best" is a participle phrase - it uses the present participle "hoping" to describe the subject. Participle openings add energy and often show simultaneous actions, creating a sense of movement.',
          },
          {
            id: 'engelsk-vg1-3-2-n-quiz4-q2',
            task: 'What is the danger of the "I-I-I" pattern in writing?',
            options: [
              { id: 'a', text: 'Using "I" is grammatically incorrect', isCorrect: false },
              { id: 'b', text: 'It makes writing seem selfish', isCorrect: false },
              { id: 'c', text: 'Starting every sentence the same way creates monotony', isCorrect: true },
              { id: 'd', text: 'First person should never be used in essays', isCorrect: false },
            ],
            solution: 'The problem is monotony, not grammar. Starting every sentence with the same word creates a flat rhythm that bores readers. Varying openings with prepositional phrases, participles, adverbs, and dependent clauses creates movement and engagement.',
          },
        ],
      },
    },
...
As you write, do not worry about variety in your first draft. Get your ideas down first - capturing your thoughts is more important than perfecting them. But when you revise, read aloud and listen for monotony. Where does it feel choppy? Where does it feel dense? Where do you lose interest? Then apply these techniques to create flow. This two-step process - content first, craft second - is how professional writers work.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 5',
        type: 'multiple-choice',
        task: 'Test yourself on putting sentence variety into practice:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'engelsk-vg1-3-2-n-quiz5-q0',
          ...
          {
            id: 'engelsk-vg1-3-2-n-quiz5-q1',
            task: 'In the rewritten paragraph about the project team, what technique transforms "The project was difficult. The deadline was tight." into "Although the project was difficult and the deadline tight, the team rose to the challenge"?',
            options: [
              { id: 'a', text: 'Using a semicolon to join them', isCorrect: false },
              { id: 'b', text: 'Combining with a subordinating conjunction and compound structure', isCorrect: true },
              { id: 'c', text: 'Adding an appositive', isCorrect: false },
              { id: 'd', text: 'Using a participle phrase', isCorrect: false },
            ],
            solution: 'The transformation uses "although" (subordinating conjunction) to make the challenges a dependent clause, while combining "difficult" and "tight" as compound predicates. The challenges become background, and the team\'s response becomes the main clause.',
          },
        ],
      },
    },
...
Be careful with vague "this" - writing "This is problematic" without specifying what "this" refers to leaves readers guessing. Add a noun: "This situation is problematic" or "This lack of funding is problematic." The extra word adds clarity and professionalism to your writing.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 1',
        type: 'multiple-choice',
        task: 'Test yourself on reference and cohesion:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'engelsk-vg1-3-3-n-quiz1-q0',
          ...
          {
            id: 'engelsk-vg1-3-3-n-quiz1-q1',
            task: 'Why is "Students are spending more time on screens. This trend concerns educators." better than "Students are spending more time on screens. This concerns educators."?',
            options: [
              { id: 'a', text: 'It uses more words, which is always better', isCorrect: false },
              { id: 'b', text: '"This trend" adds a summary noun that clarifies what "this" refers to', isCorrect: true },
              { id: 'c', text: 'The word "trend" sounds more academic', isCorrect: false },
              { id: 'd', text: 'Both versions are equally clear', isCorrect: false },
            ],
            solution: 'Adding a summary noun after "this" ("this trend") explicitly labels what is being referred to. A vague "this" leaves readers guessing - does it mean screen time, the students, or the spending? Summary nouns add clarity and professionalism.',
          },
          {
            id: 'engelsk-vg1-3-3-n-quiz1-q2',
            task: '"The scientist and the journalist discussed the findings. She had spent years on the research." What is the problem here?',
            options: [
              { id: 'a', text: 'The sentence is too long', isCorrect: false },
              { id: 'b', text: 'There is no linking word between sentences', isCorrect: false },
              { id: 'c', text: '"She" is ambiguous - it could refer to either person', isCorrect: true },
              { id: 'd', text: 'You should not use "she" in formal writing', isCorrect: false },
            ],
            solution: 'The pronoun "she" is ambiguous because it could refer to either the scientist or the journalist. The reader must guess who spent years on the research. Solutions include repeating the noun or restructuring the sentence.',
          },
        ],
      },
    },
...
Choose linking words carefully - they carry meaning and tone. "However" is more formal than "but." "Furthermore" is more emphatic than "also." "Hence" sounds academic while "so" sounds casual. Match your linking words to the style and audience of your text. Also vary them - using "however" five times in one paragraph feels repetitive.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 2',
        type: 'multiple-choice',
        task: 'Test yourself on linking words and transitions:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'engelsk-vg1-3-3-n-quiz2-q0',
          ...
          {
            id: 'engelsk-vg1-3-3-n-quiz2-q1',
            task: 'Which category of linking words would you use to introduce a different perspective in an argument?',
            options: [
              { id: 'a', text: 'Addition words: furthermore, moreover, also', isCorrect: false },
              { id: 'b', text: 'Sequence words: first, then, finally', isCorrect: false },
              { id: 'c', text: 'Contrast words: however, nevertheless, on the other hand', isCorrect: true },
              { id: 'd', text: 'Summary words: in conclusion, to summarize', isCorrect: false },
            ],
            solution: 'Contrast words signal a change in direction or a different perspective. "However," "nevertheless," and "on the other hand" prepare readers for an opposing or qualifying viewpoint, showing you can see multiple sides of an issue.',
          },
          {
            id: 'engelsk-vg1-3-3-n-quiz2-q2',
            task: 'Why should you vary your choice of linking words rather than repeating the same one?',
            options: [
              { id: 'a', text: 'Each linking word means exactly the same thing', isCorrect: false },
              { id: 'b', text: 'Repetition makes writing feel monotonous, and different words carry different tones', isCorrect: true },
              { id: 'c', text: 'Teachers will deduct marks for repetition', isCorrect: false },
              { id: 'd', text: 'Using many different words proves a larger vocabulary', isCorrect: false },
            ],
            solution: 'Using "however" five times in one paragraph feels repetitive and undermines its effect. Different linking words carry different tones - "furthermore" is more emphatic than "also," "hence" sounds academic while "so" sounds casual. Variation keeps writing fresh.',
          },
        ],
      },
    },
...
Superordinates (general terms) and hyponyms (specific terms) help vary your language too. After mentioning specific items like "roses, tulips, and daffodils," you can refer back to them collectively as "these flowers" - using the superordinate. After discussing "cars, buses, and trains," you can write "these vehicles" or "public and private transport." This technique lets you move between specific examples and general categories smoothly, which is essential for clear argumentation.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 3',
        type: 'multiple-choice',
        task: 'Test yourself on lexical cohesion:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'engelsk-vg1-3-3-n-quiz3-q0',
          ...
          {
            id: 'engelsk-vg1-3-3-n-quiz3-q1',
            task: 'In the passage "Climate change threatens ecosystems. Global warming has accelerated. This environmental crisis requires action," what creates lexical cohesion?',
            options: [
              { id: 'a', text: 'The sentences are about different topics', isCorrect: false },
              { id: 'b', text: 'Three different terms refer to the same phenomenon', isCorrect: true },
              { id: 'c', text: 'Each sentence starts differently', isCorrect: false },
              { id: 'd', text: 'The linking word "this" connects them', isCorrect: false },
            ],
            solution: '"Climate change," "global warming," and "environmental crisis" are three ways of referring to the same phenomenon. This creates variety while maintaining focus, and each term emphasizes a different aspect - the scientific term, temperature, and urgency.',
          },
          {
            id: 'engelsk-vg1-3-3-n-quiz3-q2',
            task: 'After mentioning "roses, tulips, and daffodils," a writer refers to them as "these flowers." What vocabulary technique is this?',
            options: [
              { id: 'a', text: 'Collocation', isCorrect: false },
              { id: 'b', text: 'Repetition', isCorrect: false },
              { id: 'c', text: 'Using a superordinate (general category term)', isCorrect: true },
              { id: 'd', text: 'Synonym substitution', isCorrect: false },
            ],
            solution: '"Flowers" is the superordinate - the general category that includes roses, tulips, and daffodils (the hyponyms/specific terms). Moving between specific and general terms helps writers summarize and transition smoothly.',
          },
        ],
      },
    },
...
Between paragraphs, transitions maintain flow and help readers see the structure of your argument. The end of one paragraph can set up the next: "But these benefits come with significant costs." The beginning of a new paragraph can refer back: "Having examined the benefits, we must now consider the drawbacks." These bridges help readers navigate longer texts without getting lost. Think of them as the hallways connecting rooms in a building - they show how spaces relate.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 4',
        type: 'multiple-choice',
        task: 'Test yourself on coherent paragraph structure:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'engelsk-vg1-3-3-n-quiz4-q0',
          ...
          {
            id: 'engelsk-vg1-3-3-n-quiz4-q1',
            task: 'A paragraph discusses social media, then suddenly mentions food prices, then returns to technology. What coherence problem does this illustrate?',
            options: [
              { id: 'a', text: 'Missing linking words', isCorrect: false },
              { id: 'b', text: 'Random jumping between unrelated topics', isCorrect: true },
              { id: 'c', text: 'Sentences that are too short', isCorrect: false },
              { id: 'd', text: 'Using too many pronouns', isCorrect: false },
            ],
            solution: 'This paragraph lacks coherence because it tries to do too much - ideas jump between unrelated topics. Every sentence in a paragraph should relate to and support the main point stated in the topic sentence. Unrelated ideas belong in separate paragraphs.',
          },
          {
            id: 'engelsk-vg1-3-3-n-quiz4-q2',
            task: 'What role do transitions between paragraphs play?',
            options: [
              { id: 'a', text: 'They make the text longer', isCorrect: false },
              { id: 'b', text: 'They replace the need for topic sentences', isCorrect: false },
              { id: 'c', text: 'They show how sections connect and help readers navigate the text', isCorrect: true },
              { id: 'd', text: 'They are only needed in formal academic writing', isCorrect: false },
            ],
            solution: 'Transitions between paragraphs act as bridges, showing readers how one section relates to the next. They can set up what comes next or refer back to what was discussed, helping readers see the overall structure of the argument.',
          },
        ],
      },
    },
...
Remember: coherence and cohesion are not about following rigid rules or using fancy words. They are about helping your reader understand your ideas. Every device, every link, every transition should serve that goal. If a technique does not help communication, do not use it just because it seems sophisticated.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 5',
        type: 'multiple-choice',
        task: 'Test yourself on coherence and cohesion overall:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'engelsk-vg1-3-3-n-quiz5-q0',
          ...
          {
            id: 'engelsk-vg1-3-3-n-quiz5-q1',
            task: 'Which revision technique is most effective for spotting flow problems?',
            options: [
              { id: 'a', text: 'Using an online grammar checker', isCorrect: false },
              { id: 'b', text: 'Reading your text aloud', isCorrect: true },
              { id: 'c', text: 'Counting the number of linking words', isCorrect: false },
              { id: 'd', text: 'Making every sentence the same length', isCorrect: false },
            ],
            solution: 'Reading aloud is one of the most powerful revision techniques. Your ear catches problems your eye misses - you stumble where flow breaks down, lose track where coherence fails, and notice where transitions are missing.',
          },
        ],
      },
    },
...
The key is working through these levels in order, from big to small. There is no point perfecting the grammar of a sentence you might later delete. There is no point polishing vocabulary in a paragraph whose purpose is unclear. Fix the big things first, then work down to the details.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 1',
        type: 'multiple-choice',
        task: 'Test yourself on the four levels of revision:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'engelsk-vg1-3-4-n-quiz1-q0',
          ...
          {
            id: 'engelsk-vg1-3-4-n-quiz1-q1',
            task: 'What is the correct order for the four levels of revision?',
            options: [
              { id: 'a', text: 'Words, sentences, structure, content', isCorrect: false },
              { id: 'b', text: 'Content, structure, sentences, words', isCorrect: true },
              { id: 'c', text: 'Structure, words, content, sentences', isCorrect: false },
              { id: 'd', text: 'Sentences, content, words, structure', isCorrect: false },
            ],
            solution: 'Revise from big to small: content (is everything necessary there?), structure (is the organization logical?), sentences (are they clear and varied?), words (are they correct and precise?). This order prevents wasting time polishing text that may be cut.',
          },
          {
            id: 'engelsk-vg1-3-4-n-quiz1-q2',
            task: 'At the structure level, what question should you primarily ask?',
            options: [
              { id: 'a', text: 'Are all words spelled correctly?', isCorrect: false },
              { id: 'b', text: 'Are sentences varied in length?', isCorrect: false },
              { id: 'c', text: 'Is the text organized logically and do paragraphs flow well?', isCorrect: true },
              { id: 'd', text: 'Is the content relevant to the topic?', isCorrect: false },
            ],
            solution: 'Structure revision examines organization: Are paragraphs in the best order? Does each have a clear purpose? Do transitions work? Sometimes excellent content is undermined by poor organization, and restructuring alone can transform a confusing text.',
          },
        ],
      },
    },
...
Going through ARMS for each paragraph gives you a systematic way to improve your text. Instead of vaguely feeling something needs work, you have four specific questions to ask. This transforms revision from a mysterious art into a practical craft.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 2',
        type: 'multiple-choice',
        task: 'Test yourself on the ARMS strategy:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'engelsk-vg1-3-4-n-quiz2-q0',
          ...
          {
            id: 'engelsk-vg1-3-4-n-quiz2-q1',
            task: 'What does ARMS stand for?',
            options: [
              { id: 'a', text: 'Analyze, Review, Mark, Spell-check', isCorrect: false },
              { id: 'b', text: 'Add, Remove, Move, Substitute', isCorrect: true },
              { id: 'c', text: 'Argue, Respond, Motivate, Summarize', isCorrect: false },
              { id: 'd', text: 'Arrange, Rewrite, Modify, Simplify', isCorrect: false },
            ],
            solution: 'ARMS stands for Add (what is missing?), Remove (what is unnecessary?), Move (is everything in the right place?), Substitute (what could be better?). These four questions give you a systematic approach to improving any paragraph.',
          },
          {
            id: 'engelsk-vg1-3-4-n-quiz2-q2',
            task: 'A paragraph contains great information but it appears in the wrong section of your essay. Which ARMS action addresses this?',
            options: [
              { id: 'a', text: 'Add - add a transition to make it fit', isCorrect: false },
              { id: 'b', text: 'Remove - delete it since it does not fit', isCorrect: false },
              { id: 'c', text: 'Move - relocate it to where it belongs', isCorrect: true },
              { id: 'd', text: 'Substitute - replace it with different content', isCorrect: false },
            ],
            solution: 'Move is the right action. Sometimes text is perfectly fine in itself but just in the wrong location. Moving elements without changing them can transform a confusing argument into a clear one - like rearranging furniture in a room.',
          },
        ],
      },
    },
...
Apostrophe errors are surprisingly common even among native speakers. "Its" (no apostrophe) is possessive: "The dog wagged its tail." "It's" (with apostrophe) means "it is": "It's raining." Similarly, "your" is possessive: "your book." "You're" means "you are": "You're welcome." And "their/there/they're" - "their" is possessive, "there" is a place, "they're" means "they are." Check each occurrence to be sure you have the right one.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 3',
        type: 'multiple-choice',
        task: 'Test yourself on common errors to hunt:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'engelsk-vg1-3-4-n-quiz3-q0',
          ...
          {
            id: 'engelsk-vg1-3-4-n-quiz3-q1',
            task: 'Which sentence contains a comma splice?',
            options: [
              { id: 'a', text: 'It was late, so we went home.', isCorrect: false },
              { id: 'b', text: 'It was late; we went home.', isCorrect: false },
              { id: 'c', text: 'It was late, we went home.', isCorrect: true },
              { id: 'd', text: 'Although it was late, we stayed.', isCorrect: false },
            ],
            solution: 'Option C is a comma splice - two independent clauses joined by only a comma. A comma alone is not strong enough to join independent clauses. Fix it with a conjunction ("so"), semicolon, or period.',
          },
          {
            id: 'engelsk-vg1-3-4-n-quiz3-q2',
            task: 'Which sentence uses "its" and "it\'s" correctly?',
            options: [
              { id: 'a', text: 'Its raining outside and the dog lost it\'s bone.', isCorrect: false },
              { id: 'b', text: 'It\'s raining outside and the dog lost its bone.', isCorrect: true },
              { id: 'c', text: 'Its raining outside and the dog lost its bone.', isCorrect: false },
              { id: 'd', text: 'It\'s raining outside and the dog lost it\'s bone.', isCorrect: false },
            ],
            solution: '"It\'s" means "it is" (it\'s raining = it is raining). "Its" without an apostrophe is possessive (its bone = the bone belonging to it). This is one of the most common errors in English, even among native speakers.',
          },
        ],
      },
    },
...
Track your patterns. Keep notes on what errors you often make and what feedback you receive. Over time, you will become aware of your weaknesses, catch them earlier, and eventually eliminate them from your first drafts. This is how revision makes you a better writer overall, not just in the current text.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 4',
        type: 'multiple-choice',
        task: 'Test yourself on practical revision techniques:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'engelsk-vg1-3-4-n-quiz4-q0',
          ...
          {
            id: 'engelsk-vg1-3-4-n-quiz4-q1',
            task: 'Why is taking a break before revising so important?',
            options: [
              { id: 'a', text: 'You need rest after the effort of writing', isCorrect: false },
              { id: 'b', text: 'Fresh eyes see what tired eyes miss - distance reveals problems', isCorrect: true },
              { id: 'c', text: 'Grammar rules change if you wait long enough', isCorrect: false },
              { id: 'd', text: 'It makes the writing process seem more professional', isCorrect: false },
            ],
            solution: 'When you step away and return, you see your text more like a reader would. Your brain stops auto-correcting errors and filling in missing information. Even a few hours helps, though overnight is ideal.',
          },
          {
            id: 'engelsk-vg1-3-4-n-quiz4-q2',
            task: 'Why should you not fully trust spell checkers and grammar tools?',
            options: [
              { id: 'a', text: 'They are always wrong', isCorrect: false },
              { id: 'b', text: 'They miss context-dependent errors and sometimes suggest wrong corrections', isCorrect: true },
              { id: 'c', text: 'Professional writers never use them', isCorrect: false },
              { id: 'd', text: 'They only work in American English', isCorrect: false },
            ],
            solution: 'Spell checkers cannot catch "from" when you meant "form" because both are real words. Grammar checkers sometimes flag correct sentences while missing actual errors. Use them as a starting point, but your judgment must be the final check.',
          },
        ],
      },
    },
...
Finally, remember that revision is not endless. At some point, you need to consider a text done and move on. Perfectionism can be paralyzing - there is always something more you could change, some way the text could theoretically be better. Set a reasonable standard - clear, correct, and effective for its purpose - and aim for that. When you have achieved it, let the text go. Good enough, delivered on time, is better than perfect, never finished.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 5',
        type: 'multiple-choice',
        task: 'Test yourself on the revision mindset:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'engelsk-vg1-3-4-n-quiz5-q0',
          ...
          {
            id: 'engelsk-vg1-3-4-n-quiz5-q1',
            task: 'Hemingway reportedly rewrote the ending of "A Farewell to Arms" 39 times. What does this suggest about writing?',
            options: [
              { id: 'a', text: 'Hemingway was not a very good writer', isCorrect: false },
              { id: 'b', text: 'The ending was particularly difficult to write', isCorrect: false },
              { id: 'c', text: 'Even great writers rely on extensive revision to achieve quality', isCorrect: true },
              { id: 'd', text: 'First drafts should always be rewritten 39 times', isCorrect: false },
            ],
            solution: 'The point is that revision is normal and essential, even for masters. This should be liberating: if Hemingway needed 39 drafts, you should not expect perfection on your first try. Quality comes from the revision process.',
          },
        ],
      },
    },
...
An oxymoron puts contradictory terms together: "deafening silence," "bitter sweet," "living dead," "cruel kindness." The contradiction creates tension and makes us think about how both qualities could coexist - how silence can be so intense it feels loud, how something can be both pleasant and painful at once.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 1',
        type: 'multiple-choice',
        task: 'Test yourself on figurative language:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'engelsk-vg1-4-1-n-quiz1-q0',
          ...
          {
            id: 'engelsk-vg1-4-1-n-quiz1-q1',
            task: 'What is the difference between a simile and a metaphor?',
            options: [
              { id: 'a', text: 'Similes are more effective than metaphors', isCorrect: false },
              { id: 'b', text: 'Similes use "like" or "as"; metaphors make direct comparisons', isCorrect: true },
              { id: 'c', text: 'Metaphors are only used in poetry', isCorrect: false },
              { id: 'd', text: 'There is no real difference', isCorrect: false },
            ],
            solution: 'A simile makes an explicit comparison using "like" or "as" ("Her smile was like sunshine"), while a metaphor states the comparison directly ("Life is a journey"). Metaphors are more forceful because they claim one thing IS another.',
          },
          {
            id: 'engelsk-vg1-4-1-n-quiz1-q2',
            task: '"Deafening silence" is an example of which literary device?',
            options: [
              { id: 'a', text: 'Hyperbole', isCorrect: false },
              { id: 'b', text: 'Understatement', isCorrect: false },
              { id: 'c', text: 'Personification', isCorrect: false },
              { id: 'd', text: 'Oxymoron', isCorrect: true },
            ],
            solution: 'An oxymoron puts contradictory terms together. Silence cannot literally be deafening, but the contradiction captures the idea of a silence so intense and oppressive that it feels overwhelming - both qualities coexist in the experience.',
          },
        ],
      },
    },
...
Irony is powerful because it creates layers of meaning. The surface level says one thing; the deeper level says another. Readers who catch the irony experience the text more richly and feel a kind of complicity with the author - they are in on the joke or the tragedy. Writers use irony to critique without preaching, to create humor, to add depth, and to make readers think. Once you start noticing irony, you will see it everywhere - in literature, in film, in news, in everyday conversations.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 2',
        type: 'multiple-choice',
        task: 'Test yourself on types of irony:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'engelsk-vg1-4-1-n-quiz2-q0',
          ...
          {
            id: 'engelsk-vg1-4-1-n-quiz2-q1',
            task: 'A fire station burns down. What type of irony is this?',
            options: [
              { id: 'a', text: 'Verbal irony', isCorrect: false },
              { id: 'b', text: 'Situational irony', isCorrect: true },
              { id: 'c', text: 'Dramatic irony', isCorrect: false },
              { id: 'd', text: 'Sarcasm', isCorrect: false },
            ],
            solution: 'This is situational irony - events turn out contrary to expectations. Of all places, we expect a fire station to be safe from fire. The outcome contradicts what we would logically predict.',
          },
          {
            id: 'engelsk-vg1-4-1-n-quiz2-q2',
            task: 'You step into pouring rain and say "What lovely weather!" What type of irony is this?',
            options: [
              { id: 'a', text: 'Situational irony', isCorrect: false },
              { id: 'b', text: 'Dramatic irony', isCorrect: false },
              { id: 'c', text: 'Verbal irony', isCorrect: true },
              { id: 'd', text: 'Pathetic fallacy', isCorrect: false },
            ],
            solution: 'This is verbal irony - saying the opposite of what you mean, expecting your audience to understand the real meaning. Your words say the weather is lovely, but your meaning is clearly that it is terrible.',
          },
        ],
      },
    },
...
These structural devices work over longer stretches of text, creating patterns that reward attentive reading. Train yourself to notice recurring images, to remember what was foreshadowed, to see how flashbacks connect to present action.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 3',
        type: 'multiple-choice',
        task: 'Test yourself on structural devices:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'engelsk-vg1-4-1-n-quiz3-q0',
          ...
          {
            id: 'engelsk-vg1-4-1-n-quiz3-q1',
            task: 'A character feels "inexplicably cold" in chapter one, and in chapter ten a death occurs. What device connects these?',
            options: [
              { id: 'a', text: 'Flashback', isCorrect: false },
              { id: 'b', text: 'Foreshadowing', isCorrect: true },
              { id: 'c', text: 'Juxtaposition', isCorrect: false },
              { id: 'd', text: 'Symbolism', isCorrect: false },
            ],
            solution: 'Foreshadowing hints at future events. The inexplicable cold in chapter one is a subtle hint that something ominous is coming. Good foreshadowing creates tension on first reading and rewards rereading when you see the planted clues.',
          },
          {
            id: 'engelsk-vg1-4-1-n-quiz3-q2',
            task: 'A story describes a luxury mansion right next to a homeless encampment. What device is the writer using?',
            options: [
              { id: 'a', text: 'Symbolism', isCorrect: false },
              { id: 'b', text: 'Foreshadowing', isCorrect: false },
              { id: 'c', text: 'Flashback', isCorrect: false },
              { id: 'd', text: 'Juxtaposition', isCorrect: true },
            ],
            solution: 'Juxtaposition places contrasting elements side by side for effect. The luxury mansion next to the homeless encampment makes a point about inequality without the writer having to state it directly - the contrast does the work.',
          },
        ],
      },
    },
...
These sound devices work on readers even when they do not consciously notice them. Read good prose aloud and you hear its music. The sounds of language affect us below the surface of conscious meaning.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 4',
        type: 'multiple-choice',
        task: 'Test yourself on sound devices:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'engelsk-vg1-4-1-n-quiz4-q0',
          ...
          {
            id: 'engelsk-vg1-4-1-n-quiz4-q1',
            task: '"The rain in Spain falls mainly on the plain." What sound device creates the musical quality?',
            options: [
              { id: 'a', text: 'Alliteration', isCorrect: false },
              { id: 'b', text: 'Assonance', isCorrect: true },
              { id: 'c', text: 'Onomatopoeia', isCorrect: false },
              { id: 'd', text: 'Consonance', isCorrect: false },
            ],
            solution: 'Assonance is the repetition of vowel sounds within words. The long "a" sound in rain, Spain, mainly, and plain creates internal echoes and a musical quality without using end rhyme.',
          },
          {
            id: 'engelsk-vg1-4-1-n-quiz4-q2',
            task: 'In Martin Luther King Jr.\'s speech, "I have a dream" is repeated many times. What is this technique called and what effect does it create?',
            options: [
              { id: 'a', text: 'Alliteration - it creates musical consonant sounds', isCorrect: false },
              { id: 'b', text: 'Onomatopoeia - it mimics the sound of dreaming', isCorrect: false },
              { id: 'c', text: 'Anaphora - it builds power and emphasis with each repetition', isCorrect: true },
              { id: 'd', text: 'Assonance - it repeats vowel sounds', isCorrect: false },
            ],
            solution: 'Anaphora is starting successive sentences with the same words. Each repetition of "I have a dream" builds emotional power, creating an incantatory effect that makes the message unforgettable.',
          },
        ],
      },
    },
...
Remember that these devices are ancient - writers have been using them for thousands of years because they work. You are joining a long tradition when you master them.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 5',
        type: 'multiple-choice',
        task: 'Test yourself on using literary devices in your writing:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'engelsk-vg1-4-1-n-quiz5-q0',
          ...
          {
            id: 'engelsk-vg1-4-1-n-quiz5-q1',
            task: 'Why is "one powerful metaphor better than five mediocre ones"?',
            options: [
              { id: 'a', text: 'Fewer words are always better', isCorrect: false },
              { id: 'b', text: 'Too many devices feel artificial, like too many spices in cooking', isCorrect: true },
              { id: 'c', text: 'Readers can only understand one metaphor at a time', isCorrect: false },
              { id: 'd', text: 'Metaphors are expensive to use', isCorrect: false },
            ],
            solution: 'Overusing literary devices makes writing feel artificial and forced. Like spices in cooking, a little goes a long way. One well-chosen, powerful metaphor illuminates meaning, while five mediocre ones clutter and distract.',
          },
        ],
      },
    },
    ...
    },
    {
      ...
      exercise: {
        ...
        questions: [
          ...
          {
            id: 'engelsk-vg1-4-2-n-quiz1-q1',
            task: '"The king died and then the queen died of grief." Why is this a plot rather than just a chronicle?',
            options: [
              { id: 'a', text: 'Because it involves royalty', isCorrect: false },
              { id: 'b', text: 'Because it has a beginning and an end', isCorrect: false },
              { id: 'c', text: 'Because the second event is caused by the first', isCorrect: true },
              { id: 'd', text: 'Because two characters are mentioned', isCorrect: false },
            ],
            solution: 'A plot connects events through causation - one event causes or leads to another. "The queen died of grief" shows her death was caused by the king\'s death. A chronicle would simply list events without showing connections.',
          },
          {
            id: 'engelsk-vg1-4-2-n-quiz1-q2',
            task: 'Which type of conflict involves a character struggling against social norms or institutions?',
            options: [
              { id: 'a', text: 'Person vs. person', isCorrect: false },
              { id: 'b', text: 'Person vs. self', isCorrect: false },
              { id: 'c', text: 'Person vs. nature', isCorrect: false },
              { id: 'd', text: 'Person vs. society', isCorrect: true },
            ],
            solution: 'Person vs. society involves struggle against social forces - laws, cultural expectations, institutions, or norms. The character might fight injustice, challenge traditions, or resist conformity. Stories often combine multiple conflict types.',
          },
        ],
      },
    },
...
When analyzing character, ask: Who is this person? What do they want? What obstacles do they face? How do they change? What do they represent?`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 2',
        type: 'multiple-choice',
        task: 'Test yourself on character analysis:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'engelsk-vg1-4-2-n-quiz2-q0',
          ...
          {
            id: 'engelsk-vg1-4-2-n-quiz2-q1',
            task: 'What does STEAL stand for in indirect characterization?',
            options: [
              { id: 'a', text: 'Story, Theme, Evidence, Analysis, Language', isCorrect: false },
              { id: 'b', text: 'Speech, Thoughts, Effect on others, Actions, Looks', isCorrect: true },
              { id: 'c', text: 'Setting, Tension, Emotion, Action, Lessons', isCorrect: false },
              { id: 'd', text: 'Symbolism, Tone, Exposition, Argument, Logic', isCorrect: false },
            ],
            solution: 'STEAL represents the five ways writers show character indirectly: Speech (what they say), Thoughts (what they think), Effect on others (how people react to them), Actions (what they do), and Looks (their physical appearance).',
          },
          {
            id: 'engelsk-vg1-4-2-n-quiz2-q2',
            task: 'A character who contrasts with the protagonist to highlight important qualities is called a:',
            options: [
              { id: 'a', text: 'Antagonist', isCorrect: false },
              { id: 'b', text: 'Narrator', isCorrect: false },
              { id: 'c', text: 'Foil', isCorrect: true },
              { id: 'd', text: 'Flat character', isCorrect: false },
            ],
            solution: 'A foil is a character who contrasts with another character (usually the protagonist) in ways that highlight important qualities. The contrast makes both characters more visible and distinct to the reader.',
          },
        ],
      },
    },
...
When analyzing setting, ask: Where and when does this take place? How does setting affect mood? How does setting relate to character and theme? Why this setting and not another?`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 3',
        type: 'multiple-choice',
        task: 'Test yourself on setting in fiction:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'engelsk-vg1-4-2-n-quiz3-q0',
          ...
          {
            id: 'engelsk-vg1-4-2-n-quiz3-q1',
            task: 'Setting includes more than just physical location. What else does it encompass?',
            options: [
              { id: 'a', text: 'Only the weather conditions', isCorrect: false },
              { id: 'b', text: 'Time period, season, time of day, and social environment', isCorrect: true },
              { id: 'c', text: 'Only the country where the story takes place', isCorrect: false },
              { id: 'd', text: 'The author\'s personal background', isCorrect: false },
            ],
            solution: 'Setting includes place (physical location), time (historical period, season, time of day), and social environment (cultural context, social norms, economic conditions). All these factors shape characters\' lives and the story\'s possibilities.',
          },
        ],
      },
    },
...
Be careful not to over-simplify. Literature is not a delivery system for moral messages. Themes are insights, not lessons. Good stories complicate rather than preach.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 4',
        type: 'multiple-choice',
        task: 'Test yourself on theme in fiction:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'engelsk-vg1-4-2-n-quiz4-q0',
          ...
          {
            id: 'engelsk-vg1-4-2-n-quiz4-q1',
            task: 'Which of these is a theme rather than a subject?',
            options: [
              { id: 'a', text: 'Friendship', isCorrect: false },
              { id: 'b', text: 'War', isCorrect: false },
              { id: 'c', text: 'Growing up', isCorrect: false },
              { id: 'd', text: 'Power corrupts those who hold it too long', isCorrect: true },
            ],
            solution: 'A theme is expressed as a statement, not a single word. "Power corrupts those who hold it too long" is specific and interpretive - it says something about power. The others are subjects (topics) that themes could be about.',
          },
          {
            id: 'engelsk-vg1-4-2-n-quiz4-q2',
            task: 'How do writers typically convey theme?',
            options: [
              { id: 'a', text: 'By stating the moral directly at the end', isCorrect: false },
              { id: 'b', text: 'Through plot events, character development, and symbols working together', isCorrect: true },
              { id: 'c', text: 'Only through the title of the story', isCorrect: false },
              { id: 'd', text: 'By having a character explain the meaning', isCorrect: false },
            ],
            solution: 'Themes emerge from all story elements working together. Plot events demonstrate the theme, characters embody or learn it, setting reinforces it, and symbols deepen it. Good literature shows rather than preaches.',
          },
        ],
      },
    },
...
Remember that analysis is not dissection. You are not killing the story to see how it works - you are deepening your appreciation of a living work of art.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 5',
        type: 'multiple-choice',
        task: 'Test yourself on analyzing short stories:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'engelsk-vg1-4-2-n-quiz5-q0',
          ...
          {
            id: 'engelsk-vg1-4-2-n-quiz5-q1',
            task: 'What should good literary analysis always include?',
            options: [
              { id: 'a', text: 'A detailed biography of the author', isCorrect: false },
              { id: 'b', text: 'Only your personal opinion', isCorrect: false },
              { id: 'c', text: 'Interpretation supported by specific evidence from the text', isCorrect: true },
              { id: 'd', text: 'A comparison to other stories by the same author', isCorrect: false },
            ],
            solution: 'Good analysis is not just opinion but interpretation supported by textual evidence. Quote key passages, point to specific moments, and show how your interpretation connects to what is actually in the story. Evidence makes your reading convincing.',
          },
        ],
      },
    },
    ...
    },
    {
      ...
      exercise: {
        ...
        questions: [
          ...
          {
            id: 'engelsk-vg1-4-3-n-quiz1-q1',
            task: 'What does it mean for a narrator to be "unreliable"?',
            options: [
              { id: 'a', text: 'The author made mistakes in writing', isCorrect: false },
              { id: 'b', text: 'The narrator intentionally or unintentionally deceives readers about events', isCorrect: true },
              { id: 'c', text: 'The narration switches between characters', isCorrect: false },
              { id: 'd', text: 'The story is told in an unusual order', isCorrect: false },
            ],
            solution: 'An unreliable narrator is one whose account of events we cannot fully trust. They may be lying, deluded, naive, or biased. Readers must read between the lines to discover what is really happening, creating a richer reading experience.',
          },
          {
            id: 'engelsk-vg1-4-3-n-quiz1-q2',
            task: 'Which point of view allows the reader to know the thoughts of multiple characters?',
            options: [
              { id: 'a', text: 'First person', isCorrect: false },
              { id: 'b', text: 'Second person', isCorrect: false },
              { id: 'c', text: 'Third person limited', isCorrect: false },
              { id: 'd', text: 'Third person omniscient', isCorrect: true },
            ],
            solution: 'Third person omniscient has a god-like perspective that can see into multiple characters\' minds and report on events no single character witnesses. This allows dramatic irony and complex plotting but risks losing the intimacy of more limited perspectives.',
          },
        ],
      },
    },
...
When analyzing character development, track changes across the novel. How is the character different at the end than at the beginning? What caused the changes? What do these changes mean?`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 2',
        type: 'multiple-choice',
        task: 'Test yourself on character development in novels:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'engelsk-vg1-4-3-n-quiz2-q0',
          ...
          {
            id: 'engelsk-vg1-4-3-n-quiz2-q1',
            task: 'What advantage do novels have over short stories for character development?',
            options: [
              { id: 'a', text: 'Novels always have better characters', isCorrect: false },
              { id: 'b', text: 'Novels have more space to show change over time and develop multiple characters in depth', isCorrect: true },
              { id: 'c', text: 'Short stories cannot have round characters', isCorrect: false },
              { id: 'd', text: 'Novels use more literary devices', isCorrect: false },
            ],
            solution: 'Novels have space to show gradual transformation over hundreds of pages - we can watch characters grow, fail, and change through extended experience. They can also develop multiple round characters whose lives intersect in complex ways.',
          },
        ],
      },
    },
...
When analyzing structure, map the novel's organization. What are the main plot and subplots? How is time handled? Why might the author have chosen this structure?`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 3',
        type: 'multiple-choice',
        task: 'Test yourself on novel structure:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'engelsk-vg1-4-3-n-quiz3-q0',
          ...
          {
            id: 'engelsk-vg1-4-3-n-quiz3-q1',
            task: 'What is a framing device in fiction?',
            options: [
              { id: 'a', text: 'The physical frame around a book cover', isCorrect: false },
              { id: 'b', text: 'A story within a story that creates layers of perspective', isCorrect: true },
              { id: 'c', text: 'The first and last chapters of any novel', isCorrect: false },
              { id: 'd', text: 'A technique for describing settings', isCorrect: false },
            ],
            solution: 'A framing device is a story within a story - for example, a narrator in the present telling a story from the past. These frames create layers of perspective and often comment on storytelling itself.',
          },
          {
            id: 'engelsk-vg1-4-3-n-quiz3-q2',
            task: 'A novel interweaves chapters set in 1945 with chapters set in 2020. What structural technique is this?',
            options: [
              { id: 'a', text: 'Linear chronological structure', isCorrect: false },
              { id: 'b', text: 'Non-linear structure with parallel time periods', isCorrect: true },
              { id: 'c', text: 'A framing device', isCorrect: false },
              { id: 'd', text: 'A subplot', isCorrect: false },
            ],
            solution: 'Interweaving multiple time periods is a non-linear, parallel structure. The two timelines may converge, comment on each other, or explore themes about memory, consequence, and how the past shapes the present.',
          },
        ],
      },
    },
...
When analyzing setting, consider: How does this world work? What rules govern it? How does it shape what characters can do and who they can be?`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 4',
        type: 'multiple-choice',
        task: 'Test yourself on world-building:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'engelsk-vg1-4-3-n-quiz4-q0',
          ...
          {
            id: 'engelsk-vg1-4-3-n-quiz4-q1',
            task: 'Why is world-building relevant even for realistic contemporary novels?',
            options: [
              { id: 'a', text: 'It is not - only fantasy novels need world-building', isCorrect: false },
              { id: 'b', text: 'Every novel creates a specific social milieu with its own norms and textures', isCorrect: true },
              { id: 'c', text: 'Contemporary settings require more research than fantasy', isCorrect: false },
              { id: 'd', text: 'Readers expect detailed descriptions in all novels', isCorrect: false },
            ],
            solution: 'Even realistic contemporary novels build worlds. A specific neighborhood, social milieu, workplace, or subculture becomes a world with its own norms and textures. The setting shapes what is possible for characters and what conflicts arise.',
          },
        ],
      },
    },
...
Reread key passages. Some passages deserve multiple readings. When something seems important or confusing, slow down and read carefully. The payoff is deeper understanding.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 5',
        type: 'multiple-choice',
        task: 'Test yourself on reading strategies for novels:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'engelsk-vg1-4-3-n-quiz5-q0',
          ...
          {
            id: 'engelsk-vg1-4-3-n-quiz5-q1',
            task: 'Why should you pay special attention to beginnings and endings of chapters?',
            options: [
              { id: 'a', text: 'They are the easiest parts to read', isCorrect: false },
              { id: 'b', text: 'Writers often place important information or images at structural boundaries', isCorrect: true },
              { id: 'c', text: 'The middle parts are not important', isCorrect: false },
              { id: 'd', text: 'Chapter boundaries are always cliffhangers', isCorrect: false },
            ],
            solution: 'Writers deliberately place significant information, images, and turning points at chapter boundaries. How a chapter opens and closes shapes the reading experience. The opening of the novel and its closing often mirror or contrast with each other meaningfully.',
          },
        ],
      },
    },
...
When reading a poem, listen. What sounds repeat? What rhythms emerge? How do the sounds support the meaning?`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 1',
        type: 'multiple-choice',
        task: 'Test yourself on the sound of poetry:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'engelsk-vg1-4-4-n-quiz1-q0',
          ...
          {
            id: 'engelsk-vg1-4-4-n-quiz1-q1',
            task: 'What is the difference between end rhyme and slant rhyme?',
            options: [
              { id: 'a', text: 'End rhyme appears at line endings; slant rhyme appears in the middle', isCorrect: false },
              { id: 'b', text: 'End rhyme is perfect matching sounds; slant rhyme is approximate matching', isCorrect: true },
              { id: 'c', text: 'End rhyme is old-fashioned; slant rhyme is modern', isCorrect: false },
              { id: 'd', text: 'There is no real difference', isCorrect: false },
            ],
            solution: 'End rhyme involves perfect sound matches at line endings (day/way, love/above). Slant rhyme (also called near rhyme) is approximate - the sounds are similar but not identical (love/move). Slant rhyme creates subtler musical effects.',
          },
          {
            id: 'engelsk-vg1-4-4-n-quiz1-q2',
            task: 'Why does free verse poetry still have rhythm even without regular meter?',
            options: [
              { id: 'a', text: 'Free verse has no rhythm at all', isCorrect: false },
              { id: 'b', text: 'The poet still shapes the flow of syllables through line breaks and sentence length', isCorrect: true },
              { id: 'c', text: 'Free verse secretly follows iambic pentameter', isCorrect: false },
              { id: 'd', text: 'Rhythm only exists in formal poetry', isCorrect: false },
            ],
            solution: 'Free verse poets create rhythm through line breaks, varying sentence lengths, and deliberate pacing rather than following a preset metrical pattern. Short lines can feel urgent; long lines can feel expansive. The rhythm is crafted, not arbitrary.',
          },
        ],
      },
    },
...
When analyzing form, ask: What structure does this poem use? How does form relate to content? What effects do line breaks and stanza breaks create?`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 2',
        type: 'multiple-choice',
        task: 'Test yourself on poetic form and structure:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'engelsk-vg1-4-4-n-quiz2-q0',
          ...
          {
            id: 'engelsk-vg1-4-4-n-quiz2-q1',
            task: 'How many lines does a sonnet have?',
            options: [
              { id: 'a', text: '10 lines', isCorrect: false },
              { id: 'b', text: '12 lines', isCorrect: false },
              { id: 'c', text: '14 lines', isCorrect: true },
              { id: 'd', text: '16 lines', isCorrect: false },
            ],
            solution: 'A sonnet has 14 lines in iambic pentameter. The Shakespearean sonnet uses three quatrains and a couplet (ABAB CDCD EFEF GG), while the Petrarchan sonnet divides into an octave (8 lines) and sestet (6 lines).',
          },
          {
            id: 'engelsk-vg1-4-4-n-quiz2-q2',
            task: 'What is the haiku form?',
            options: [
              { id: 'a', text: 'A 14-line poem in iambic pentameter', isCorrect: false },
              { id: 'b', text: 'A narrative poem set to music', isCorrect: false },
              { id: 'c', text: 'Three lines of 5-7-5 syllables capturing a moment', isCorrect: true },
              { id: 'd', text: 'A poem with no fixed form', isCorrect: false },
            ],
            solution: 'A haiku captures a moment in just 17 syllables arranged in three lines of 5-7-5. Despite its brevity, a haiku can evoke complex feelings and insights, often through images from nature. It comes from Japanese poetic tradition.',
          },
        ],
      },
    },
...
When reading poetry, pay attention to what you experience through your senses. What images does the poem create? How do they work together? What do they suggest beyond their literal meanings?`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 3',
        type: 'multiple-choice',
        task: 'Test yourself on imagery and figurative language in poetry:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'engelsk-vg1-4-4-n-quiz3-q0',
          ...
          {
            id: 'engelsk-vg1-4-4-n-quiz3-q1',
            task: 'A poem mentions "bread baking, cinnamon rising." What type of imagery is this primarily?',
            options: [
              { id: 'a', text: 'Visual imagery', isCorrect: false },
              { id: 'b', text: 'Auditory imagery', isCorrect: false },
              { id: 'c', text: 'Olfactory imagery', isCorrect: true },
              { id: 'd', text: 'Tactile imagery', isCorrect: false },
            ],
            solution: 'Olfactory imagery evokes smell - the scent of baking bread and cinnamon. While good poetry often engages multiple senses, this particular image primarily triggers our sense of smell, creating a warm, domestic atmosphere.',
          },
        ],
      },
    },
...
When analyzing voice and tone, ask: Who is speaking? What is their relationship to the subject? What attitude do they express? How does word choice create tone?`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 4',
        type: 'multiple-choice',
        task: 'Test yourself on voice and tone in poetry:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'engelsk-vg1-4-4-n-quiz4-q0',
          ...
          {
            id: 'engelsk-vg1-4-4-n-quiz4-q1',
            task: 'What is a dramatic monologue in poetry?',
            options: [
              { id: 'a', text: 'A poem performed on stage', isCorrect: false },
              { id: 'b', text: 'A speaker who is a character revealing their nature through what they say', isCorrect: true },
              { id: 'c', text: 'A very long poem', isCorrect: false },
              { id: 'd', text: 'A poem with a dramatic tone', isCorrect: false },
            ],
            solution: 'A dramatic monologue presents a speaker who is a distinct character, often inadvertently revealing things about themselves through what they say. Robert Browning\'s "My Last Duchess" is a famous example where a duke reveals his murderous nature.',
          },
          {
            id: 'engelsk-vg1-4-4-n-quiz4-q2',
            task: 'What is the difference between a word\'s connotation and its denotation?',
            options: [
              { id: 'a', text: 'Denotation is the dictionary meaning; connotation is the emotional associations', isCorrect: true },
              { id: 'b', text: 'Connotation is formal; denotation is informal', isCorrect: false },
              { id: 'c', text: 'They mean the same thing', isCorrect: false },
              { id: 'd', text: 'Denotation is used in poetry; connotation in prose', isCorrect: false },
            ],
            solution: 'Denotation is a word\'s literal dictionary meaning, while connotation is its emotional and associative meaning. "House" and "home" denote similar things but connote very differently - "home" carries warmth, belonging, and personal attachment.',
          },
        ],
      },
    },
...
Remember that poems reward multiple readings. Each time through, you notice something new. Patience and attention are your best tools.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 5',
        type: 'multiple-choice',
        task: 'Test yourself on reading poetry:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'engelsk-vg1-4-4-n-quiz5-q0',
          ...
          {
            id: 'engelsk-vg1-4-4-n-quiz5-q1',
            task: 'What is the recommended approach to reading a poem for the first time?',
            options: [
              { id: 'a', text: 'Immediately analyze every literary device', isCorrect: false },
              { id: 'b', text: 'Look up the poet\'s biography first', isCorrect: false },
              { id: 'c', text: 'Read it through without stopping, letting it wash over you', isCorrect: true },
              { id: 'd', text: 'Start by counting syllables in each line', isCorrect: false },
            ],
            solution: 'The first read should be for experience - let the poem work on you as a reader. What images stay with you? What feelings arise? This initial response provides valuable data for later analysis. Analysis comes on subsequent readings.',
          },
        ],
      },
    },
...
When reading drama, try to stage it in your imagination. How do characters move? What do their voices sound like? What is the energy between them?`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 1',
        type: 'multiple-choice',
        task: 'Test yourself on drama as a literary form:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'engelsk-vg1-4-5-n-quiz1-q0',
          ...
          {
            id: 'engelsk-vg1-4-5-n-quiz1-q1',
            task: 'How does drama differ from novels in revealing characters\' inner thoughts?',
            options: [
              { id: 'a', text: 'Drama cannot reveal inner thoughts at all', isCorrect: false },
              { id: 'b', text: 'Drama uses soliloquies and asides instead of narration', isCorrect: true },
              { id: 'c', text: 'Drama uses more description than novels', isCorrect: false },
              { id: 'd', text: 'There is no difference', isCorrect: false },
            ],
            solution: 'Unlike novels, plays have no narrator to describe characters\' thoughts. Everything must be externalized through speech and action. Conventions like soliloquies (thinking aloud alone) and asides (speaking to the audience) solve this problem.',
          },
          {
            id: 'engelsk-vg1-4-5-n-quiz1-q2',
            task: 'What is an aside in theater?',
            options: [
              { id: 'a', text: 'A character leaving the stage', isCorrect: false },
              { id: 'b', text: 'A long speech by one character', isCorrect: false },
              { id: 'c', text: 'A character speaking to the audience while other characters cannot hear', isCorrect: true },
              { id: 'd', text: 'Background music during a scene', isCorrect: false },
            ],
            solution: 'An aside is when a character speaks directly to the audience while other characters on stage supposedly cannot hear. This creates a private connection between character and audience, often used for comic effect or to reveal true intentions.',
          },
        ],
      },
    },
...
Comic relief provides lighter moments in serious plays, giving audiences a break from tension and often commenting on the main action through contrast.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 2',
        type: 'multiple-choice',
        task: 'Test yourself on dramatic structure and types:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'engelsk-vg1-4-5-n-quiz2-q0',
          ...
          {
            id: 'engelsk-vg1-4-5-n-quiz2-q1',
            task: 'In dramatic terms, does "comedy" always mean the play is funny?',
            options: [
              { id: 'a', text: 'Yes - comedy means humor', isCorrect: false },
              { id: 'b', text: 'No - it refers to the plot shape: ending happily, often with reconciliation', isCorrect: true },
              { id: 'c', text: 'Comedy means the opposite of tragedy', isCorrect: false },
              { id: 'd', text: 'Comedy only applies to modern plays', isCorrect: false },
            ],
            solution: 'In dramatic terminology, "comedy" refers to the shape of the plot rather than humor. Comedies end happily, often with marriage or reconciliation. They may contain humor, but the term describes structure, not tone.',
          },
        ],
      },
    },
...
When watching film, notice these techniques. How does the camera guide your attention? What does editing create?`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 3',
        type: 'multiple-choice',
        task: 'Test yourself on film techniques:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'engelsk-vg1-4-5-n-quiz3-q0',
          ...
          {
            id: 'engelsk-vg1-4-5-n-quiz3-q1',
            task: 'What is the difference between diegetic and non-diegetic sound in film?',
            options: [
              { id: 'a', text: 'Diegetic sound is louder than non-diegetic', isCorrect: false },
              { id: 'b', text: 'Diegetic exists in the story world; non-diegetic is added for the audience', isCorrect: true },
              { id: 'c', text: 'Non-diegetic sound is dialogue; diegetic is music', isCorrect: false },
              { id: 'd', text: 'There is no real difference', isCorrect: false },
            ],
            solution: 'Diegetic sound exists within the story - characters can hear it (dialogue, a car horn, music from a radio). Non-diegetic sound is added for the audience (the film\'s musical score, voiceover narration). Both shape our emotional response.',
          },
          {
            id: 'engelsk-vg1-4-5-n-quiz3-q2',
            task: 'A film uses rapid editing with many quick cuts. What effect does this create?',
            options: [
              { id: 'a', text: 'A calm, meditative pace', isCorrect: false },
              { id: 'b', text: 'Confusion and boredom', isCorrect: false },
              { id: 'c', text: 'Urgency, energy, and tension', isCorrect: true },
              { id: 'd', text: 'A sense of timelessness', isCorrect: false },
            ],
            solution: 'Rapid editing with quick cuts creates urgency, energy, and tension - often used in action sequences and thrillers. Conversely, long takes (holding a shot) create a slower, more contemplative pace. The rhythm of editing profoundly affects mood.',
          },
        ],
      },
    },
...
Consider also how film conventions have changed over time. Early adaptations often stayed close to theatrical staging. Modern adaptations use the full range of cinematic techniques. What seemed impossible to adapt may become possible as the medium evolves.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 4',
        type: 'multiple-choice',
        task: 'Test yourself on adaptation:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'engelsk-vg1-4-5-n-quiz4-q0',
          ...
          {
            id: 'engelsk-vg1-4-5-n-quiz4-q1',
            task: 'Why is a 400-page novel inevitably changed when adapted into a two-hour film?',
            options: [
              { id: 'a', text: 'Because filmmakers are lazy', isCorrect: false },
              { id: 'b', text: 'Because the two media have different capabilities and time constraints', isCorrect: true },
              { id: 'c', text: 'Because audiences prefer shorter stories', isCorrect: false },
              { id: 'd', text: 'Because films cannot tell complex stories', isCorrect: false },
            ],
            solution: 'Practical necessities force change: content must be compressed, internal monologue must be externalized through visual or spoken means, subplots may be cut, and characters combined. Different media have different strengths and constraints.',
          },
        ],
      },
    },
...
Finally, continue enjoying what you watch. Critical viewing enhances pleasure by helping you appreciate craft. You can admire a brilliant piece of editing while still being moved by the story. Analysis and emotion are not opposites - they enrich each other.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 5',
        type: 'multiple-choice',
        task: 'Test yourself on critical viewing:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'engelsk-vg1-4-5-n-quiz5-q0',
          ...
          {
            id: 'engelsk-vg1-4-5-n-quiz5-q1',
            task: 'What should a critical viewer consider about what they do NOT see on screen?',
            options: [
              { id: 'a', text: 'Nothing - what is not shown is not important', isCorrect: false },
              { id: 'b', text: 'Every shot is a choice about what to include and exclude, reflecting a perspective', isCorrect: true },
              { id: 'c', text: 'Only deleted scenes matter', isCorrect: false },
              { id: 'd', text: 'Unseen content is always in the director\'s cut', isCorrect: false },
            ],
            solution: 'Every shot is a choice. The camera always has a perspective - what is emphasized, what is hidden, whose viewpoint we share. Critical viewing means thinking about these choices and the values they express or assume.',
          },
        ],
      },
    },
