      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'En politikk for a ruste opp militaret - den mislyktes fordi den var for dyr', isCorrect: false },
              ...
              { id: 'c', text: 'En politikk for a isolere Tyskland okonomisk - den mislyktes fordi Tyskland var selvforsynt', isCorrect: false },
              { id: 'd', text: 'En alliansepolitikk med Sovjet - den mislyktes fordi Stalin sa nei', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Klimaendringer og naturkatastrofer', isCorrect: false },
              { id: 'b', text: 'Bitterheten over Versailles kombinert med Vestmaktenes ettergivenhet overfor Hitlers aggresjon', isCorrect: true },
              { id: 'c', text: 'Russlands ekspansjon og Japans isolasjonisme', isCorrect: false },
              { id: 'd', text: 'Demokratiets styrke i Europa og USAs militare overlegenhet', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'De angrep Maginot-linjen direkte og knuste den', isCorrect: false },
              { id: 'b', text: 'De gikk rundt Maginot-linjen gjennom Belgia og Ardennene', isCorrect: true },
              { id: 'c', text: 'Frankrike kapitulerte uten kamp', isCorrect: false },
              { id: 'd', text: 'USA hjalp Tyskland med a beseire Frankrike', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              ...
              { id: 'b', text: 'Sovjetunionen', isCorrect: false },
              { id: 'c', text: 'USA', isCorrect: false },
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Tysklands angrep pa Storbritannia', isCorrect: false },
              { id: 'b', text: 'De alliertes landgang i Normandie', isCorrect: false },
              { id: 'c', text: 'Tysklands invasjon av Sovjetunionen 22. juni 1941 - historiens storste militare invasjon', isCorrect: true },
              { id: 'd', text: 'Japans angrep pa Pearl Harbor', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Han angrep Storbritannia over Kanalen', isCorrect: false },
              { id: 'b', text: 'Han allierte seg med Osterrike', isCorrect: false },
              { id: 'c', text: 'Han undervurderte Russland - bade avstander, vinterkulde og sovjetisk motstandskraft', isCorrect: true },
              { id: 'd', text: 'Han forsomte a bygge en sterk marine', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Tyskland angrep en amerikansk marinestasjon', isCorrect: false },
              { id: 'b', text: 'Japan angrep den amerikanske flatebasen pa Hawaii uten krigserklaering', isCorrect: true },
              { id: 'c', text: 'USA angrep Japan for forste gang', isCorrect: false },
              { id: 'd', text: 'Storbritannia og USA inngikk en allianse', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Farre sivile dode i andre verdenskrig', isCorrect: false },
              { id: 'b', text: 'Over halvparten av alle dode var sivile - kvinner, barn og gamle drept i egne hjem', isCorrect: true },
              { id: 'c', text: 'Sivile var helt beskyttet under krigen', isCorrect: false },
              { id: 'd', text: 'Bare soldater dode i begge kriger', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'At den bare handlet om okonomiske ressurser', isCorrect: false },
              { id: 'b', text: 'At den var en kamp mellom motstridende verdensanskuelser - fascisme mot demokrati og kommunisme', isCorrect: true },
              { id: 'c', text: 'At alle land kjempet pa samme side', isCorrect: false },
              { id: 'd', text: 'At den bare varte i noen maneder', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Dagen Hitler tok makten i Tyskland', isCorrect: false },
              { id: 'b', text: 'Dagen Japan angrep Pearl Harbor', isCorrect: false },
              { id: 'c', text: '6. juni 1944 - de alliertes landgang i Normandie som apnet en ny front i vest', isCorrect: true },
              { id: 'd', text: 'Dagen Tyskland kapitulerte', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Japan kapitulerte frivillig etter Tysklands nederlag', isCorrect: false },
              { id: 'b', text: 'USA slapp atombomber over Hiroshima og Nagasaki, og Japan kapitulerte', isCorrect: true },
              { id: 'c', text: 'Sovjetunionen erobret Japan', isCorrect: false },
              { id: 'd', text: 'Krigen i Asia fortsatte til 1950', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Han sa de var en viktig minoritet som bidro til samfunnet', isCorrect: false },
              { id: 'b', text: 'Han mente de var en kosmisk fiende som kontrollerte bade kapitalismen og kommunismen', isCorrect: true },
              { id: 'c', text: 'Han ignorerte dem fullstendig i sin ideologi', isCorrect: false },
              { id: 'd', text: 'Han sa de bare var et religiost problem', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Fordi den ga jodene mulighet til a endre identitet', isCorrect: false },
              { id: 'b', text: 'Fordi den bare rammet noen fa mennesker', isCorrect: false },
              ...
              { id: 'd', text: 'Fordi den var basert pa vitenskapelige fakta', isCorrect: false },
            ],
        ...
        questions: [
          {
            ...
            options: [
              { id: 'a', text: 'Fordi jodene ble sterkere for hvert trinn', isCorrect: false },
              ...
              { id: 'c', text: 'Fordi det ga jodene tid til a flykte', isCorrect: false },
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Lover som ga jodene like rettigheter som andre tyskere', isCorrect: false },
              ...
              { id: 'c', text: 'Lover som regulerte det tyske militaret', isCorrect: false },
              { id: 'd', text: 'Lover som forbod nazistpartiet', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'En fredelig protest mot jodediskriminering', isCorrect: false },
              { id: 'b', text: 'Jodiske butikker ble knust, synagoger brent og jodiske menn sendt til konsentrasjonsleirer', isCorrect: true },
              { id: 'c', text: 'Jodene fikk tilbake sine rettigheter', isCorrect: false },
              { id: 'd', text: 'Hitler ble avsatt som rikskansler', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Tyske fredsbevarende styrker', isCorrect: false },
              { id: 'b', text: 'Mobile drapsenheter som fulgte haren inn i Sovjet og drepte over en million joder', isCorrect: true },
              { id: 'c', text: 'Tyske militaerhospitaler', isCorrect: false },
              { id: 'd', text: 'Soldater som beskyttet sivile i okkuperte omrader', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'En fredsplan for a avslutte krigen', isCorrect: false },
              { id: 'b', text: 'Logistikken for "den endelige losningen pa det jodiske sporsmal" - det systematiske folkemordet', isCorrect: true },
              { id: 'c', text: 'En plan for a frigjore jodene fra gettoene', isCorrect: false },
              { id: 'd', text: 'En avtale om a utveksle krigsfanger', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Treblinka - rundt 500 000', isCorrect: false },
              { id: 'b', text: 'Auschwitz-Birkenau - over en million mennesker', isCorrect: true },
              { id: 'c', text: 'Dachau - rundt 200 000', isCorrect: false },
              { id: 'd', text: 'Sobibor - rundt 100 000', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Et nazistisk "eutanasi"-program for funksjonshemmede', isCorrect: false },
              { id: 'b', text: 'En utryddelsesleir i Polen', isCorrect: false },
              { id: 'c', text: 'Romfolkets betegnelse på folkemordet der 200 000-500 000 rom ble drept', isCorrect: true },
              { id: 'd', text: 'Et opprør mot nazistene', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'De ble behandlet i samsvar med Genève-konvensjonen', isCorrect: false },
              { id: 'b', text: 'De ble alle løslatt etter kort tid', isCorrect: false },
              { id: 'c', text: 'De ble sendt til Sverige som flyktninger', isCorrect: false },
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Et program for å hjelpe funksjonshemmede med arbeid', isCorrect: false },
              ...
              { id: 'c', text: 'Et medisinsk forskningsprogram', isCorrect: false },
              { id: 'd', text: 'Et program for å deportere funksjonshemmede til andre land', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'At Holocaust var en tilfeldig hendelse som ikke kan forhindres', isCorrect: false },
              { id: 'b', text: 'At vi bør glemme fortiden og se fremover', isCorrect: false },
              ...
              { id: 'd', text: 'At Tyskland vil starte en ny krig', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Versailles-traktaten', isCorrect: false },
              { id: 'b', text: 'Verdenserklæringen om menneskerettigheter fra 1948', isCorrect: true },
              { id: 'c', text: 'Nürnberglovene', isCorrect: false },
              { id: 'd', text: 'Atlanterhavspakten', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Han lyktes og ble anerkjent av kongen som statsminister', isCorrect: false },
              { id: 'b', text: 'Kuppet mislyktes - kongen nektet å utnevne ham, og selv tyskerne syntes han var for upopulær', isCorrect: true },
              { id: 'c', text: 'Han ble umiddelbart arrestert av tyske styrker', isCorrect: false },
              { id: 'd', text: 'Han trakk seg frivillig tilbake etter noen timer', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Over en million - fordi flertallet støttet nazismen', isCorrect: false },
              { id: 'b', text: 'Bare noen hundre - fordi nesten ingen støttet partiet', isCorrect: false },
              ...
              { id: 'd', text: 'Rundt 200 000 - fordi det var påbudt for alle', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Forsøk på å gjøre alle nordmenn til tyske statsborgere', isCorrect: false },
              ...
              { id: 'c', text: 'Forsøk på å innføre tysk som offisielt språk', isCorrect: false },
              { id: 'd', text: 'Forsøk på å flytte nordmenn til Tyskland', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Livet fortsatte som normalt uten noen endringer', isCorrect: false },
              { id: 'b', text: 'Nordmenn fikk bedre levestandard under okkupasjonen', isCorrect: false },
              ...
              { id: 'd', text: 'Bare de som bodde i Oslo merket noen forskjell', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Tirpitz', isCorrect: false },
              { id: 'b', text: 'Blücher', isCorrect: false },
              { id: 'c', text: 'Donau', isCorrect: true },
              { id: 'd', text: 'Galtesund', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'At det bare var tyske soldater som gjennomførte den', isCorrect: false },
              { id: 'b', text: 'At norsk politi og NS-myndigheter deltok aktivt i arrestasjonene og organiseringen', isCorrect: true },
              { id: 'c', text: 'At det skjedde uten at noen visste om det', isCorrect: false },
              { id: 'd', text: 'At ingen forsøkte å hjelpe jødene', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Fordi de alle var motstandsfolk i hemmelighet', isCorrect: false },
              ...
              { id: 'c', text: 'Fordi det var lovpålagt å arbeide for tyskerne', isCorrect: false },
              { id: 'd', text: 'Fordi ingen av dem visste at de arbeidet for okkupantene', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Kvinner som spionerte for Tyskland - de ble frikjent etter krigen', isCorrect: false },
              { id: 'b', text: 'Tyske kvinner som bodde i Norge - de ble deportert til Tyskland', isCorrect: false },
              ...
              { id: 'd', text: 'Kvinner i motstandsbevegelsen - de ble hyllet som helter', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'En nazistisk ungdomsorganisasjon med 10 000 medlemmer', isCorrect: false },
              { id: 'b', text: 'En sivil hjelpeorganisasjon med 5 000 frivillige', isCorrect: false },
              { id: 'c', text: 'Den militære motstandsorganisasjonen som hadde 40 000 mann under våpen ved krigens slutt', isCorrect: true },
              { id: 'd', text: 'En britisk spesialstyrke som opererte i Norge', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'De var godkjent av NS og inneholdt tysk propaganda', isCorrect: false },
              { id: 'b', text: 'De holdt moralen oppe med nyheter fra BBC og oppfordringer til motstand', isCorrect: true },
              { id: 'c', text: 'De ble bare lest av noen få personer i Oslo', isCorrect: false },
              { id: 'd', text: 'De formidlet tysk propaganda på norsk', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Den hadde ingen betydning for krigen', isCorrect: false },
              { id: 'b', text: 'Den besto bare av politikere i eksil i London', isCorrect: false },
              { id: 'c', text: 'Norske sjøfolk seilte forsyninger, Kompani Linge utførte sabotasje, og norske piloter fløy i RAF', isCorrect: true },
              { id: 'd', text: 'Den besto utelukkende av svenske frivillige', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Å distribuere illegale aviser', isCorrect: false },
              { id: 'b', text: 'Å organisere sivil ulydighet i skolene', isCorrect: false },
              { id: 'c', text: 'Å samle etterretning om tyske militære installasjoner og sende informasjonen til de allierte', isCorrect: true },
              { id: 'd', text: 'Å forhandle med tyskerne om fredsavtale', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Gjennom vanlige telefonsamtaler', isCorrect: false },
              { id: 'b', text: 'Via hemmelige radiosendere, våpennedslipp med fallskjerm og innsendte agenter', isCorrect: true },
              { id: 'c', text: 'Gjennom svenske ambassaden i Oslo', isCorrect: false },
              { id: 'd', text: 'De hadde ingen kontakt under hele okkupasjonen', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'En avdeling av det norske politiet under NS', isCorrect: false },
              ...
              { id: 'c', text: 'En tysk eliteavdeling stasjonert i Norge', isCorrect: false },
              { id: 'd', text: 'En sivil motstandsgruppe i Bergen', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Å hindre sivile nordmenn i å reise', isCorrect: false },
              { id: 'b', text: 'Å ødelegge jernbanelinjer for å hindre tyske troppetransporter', isCorrect: true },
              { id: 'c', text: 'Å stjele togvogner til motstandsbevegelsen', isCorrect: false },
              { id: 'd', text: 'Å protestere mot NSBs samarbeid med tyskerne', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Bare 5-10 aviser i hele landet', isCorrect: false },
              { id: 'b', text: 'Rundt 50 aviser', isCorrect: false },
              { id: 'c', text: 'Over 300 forskjellige aviser', isCorrect: true },
              { id: 'd', text: 'Over 1000 aviser', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'En liten bot', isCorrect: false },
              { id: 'b', text: 'Midlertidig husarrest', isCorrect: false },
              { id: 'c', text: 'Konsentrasjonsleir eller døden', isCorrect: true },
              { id: 'd', text: 'Man mistet stemmeretten', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'De var alle politisk aktive motstandsfolk', isCorrect: false },
              { id: 'b', text: 'De var ofte vanlige folk drevet av empati og personlig kontakt, ikke politisk ideologi', isCorrect: true },
              { id: 'c', text: 'De gjorde det bare for penger', isCorrect: false },
              { id: 'd', text: 'De var alle medlemmer av Milorg', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Fordi svenskegrensen var bedre bevoktet', isCorrect: false },
              ...
              { id: 'c', text: 'Fordi det ikke var noen tyske soldater nær grensen', isCorrect: false },
              { id: 'd', text: 'Fordi alle nær grensen var motstandsfolk', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Rundt 100', isCorrect: false },
              { id: 'b', text: 'Rundt 500', isCorrect: false },
              { id: 'c', text: 'Rundt 1000', isCorrect: false },
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Fordi utefronten sendte mat til Norge', isCorrect: false },
              { id: 'b', text: 'Fordi den frie verdens kamp ga håp om at okkupasjonen en dag ville ta slutt', isCorrect: true },
              { id: 'c', text: 'Fordi utefronten kontrollerte norsk politikk fra London', isCorrect: false },
              { id: 'd', text: 'Den hadde egentlig ingen betydning for hjemmefronten', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Tyveri, bedrageri og skatteunndragelse', isCorrect: false },
              { id: 'b', text: 'Forbrytelser mot freden, krigsforbrytelser og forbrytelser mot menneskeheten', isCorrect: true },
              { id: 'c', text: 'Desertering, spionasje og mytteri', isCorrect: false },
              { id: 'd', text: 'Landsforræderi, korrupsjon og maktmisbruk', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'At de var uskyldige og aldri hadde deltatt i krigen', isCorrect: false },
              { id: 'b', text: 'At de bare hadde "fulgt ordre" fra overordnede', isCorrect: true },
              { id: 'c', text: 'At de hadde prøvd å stoppe Holocaust fra innsiden', isCorrect: false },
              { id: 'd', text: 'At krigen var de alliertes feil', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Fordi det hadde for mange medlemmer', isCorrect: false },
              { id: 'b', text: 'Fordi ingen stormakter var med', isCorrect: false },
              { id: 'c', text: 'Fordi de fem faste medlemmene hadde vetorett, som kunne lamme FN når stormaktene var uenige', isCorrect: true },
              { id: 'd', text: 'Fordi det ikke hadde noen militær makt', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              ...
              { id: 'b', text: 'Josef Stalin', isCorrect: false },
              { id: 'c', text: 'Eleanor Roosevelt, president Roosevelts enke', isCorrect: true },
              { id: 'd', text: 'Vidkun Quisling', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Rundt 1000 personer', isCorrect: false },
              { id: 'b', text: 'Rundt 10 000 personer', isCorrect: false },
              { id: 'c', text: 'Rundt 90 000 personer, og ca. 50 000 ble dømt', isCorrect: true },
              { id: 'd', text: 'Over 500 000 personer', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'De ble tatt godt vare på av staten', isCorrect: false },
              { id: 'b', text: 'De ble alle sendt til Tyskland', isCorrect: false },
              { id: 'c', text: 'De ble stigmatisert og vokste opp med skam - først i 2018 ba Stortinget om unnskyldning', isCorrect: true },
              { id: 'd', text: 'De fikk spesielle rettigheter som erstatning', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Han flyktet til Sør-Amerika', isCorrect: false },
              { id: 'b', text: 'Han ble frikjent av mangel på bevis', isCorrect: false },
              { id: 'c', text: 'Han ble fengslet men senere benådet', isCorrect: false },
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'En plan for å avvæpne Tyskland - formålet var bare å straffe', isCorrect: false },
              ...
              { id: 'c', text: 'En sovjetisk plan for å kontrollere Øst-Europa', isCorrect: false },
              { id: 'd', text: 'En britisk plan for å gjenoppbygge sitt imperium', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              ...
              { id: 'c', text: 'Fordi Norge ville erobre andre land', isCorrect: false },
              { id: 'd', text: 'Norge beholdt nøytralitetspolitikken etter krigen', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Fordi koloniherrene frivillig ga opp sine kolonier', isCorrect: false },
              ...
              { id: 'c', text: 'Fordi USA overtok alle europeiske kolonier', isCorrect: false },
              { id: 'd', text: 'Fordi FN forbød alle kolonier umiddelbart', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Fordi Hitler grunnla EU under krigen', isCorrect: false },
              ...
              { id: 'c', text: 'Fordi USA tvang europeiske land til å samarbeide', isCorrect: false },
              { id: 'd', text: 'Fordi Sovjetunionen krevde et samlet Europa', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'At historiefaget bør legges ned', isCorrect: false },
              { id: 'b', text: 'At fortiden er uinteressant', isCorrect: false },
              { id: 'c', text: 'At vi må lære av historien for å unngå å gjøre de samme feilene om igjen', isCorrect: true },
              { id: 'd', text: 'At historien alltid gjentar seg uansett hva vi gjør', isCorrect: false },
            ],
