      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Bare skriftlige dokumenter fra fortiden', isCorrect: false },
              { id: 'b', text: 'Bare gjenstander funnet av arkeologer', isCorrect: false },
              { id: 'c', text: 'Ethvert spor fra fortiden – dokumenter, bygninger, gjenstander, tradisjoner', isCorrect: true },
              { id: 'd', text: 'Bare muntlige fortellinger fra eldre mennesker', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Fordi alle kilder er falske', isCorrect: false },
              { id: 'b', text: 'Fordi historikere ikke er flinke nok til å lese dem', isCorrect: false },
              { id: 'c', text: 'Fordi kildene er for gamle til å være nyttige', isCorrect: false },
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Fordi Norge ble uavhengig fra Sverige den datoen', isCorrect: false },
              { id: 'b', text: 'Fordi Grunnloven ble undertegnet på Eidsvoll 17. mai 1814', isCorrect: true },
              { id: 'c', text: 'Fordi andre verdenskrig tok slutt 17. mai', isCorrect: false },
              { id: 'd', text: 'Fordi det er den tradisjonelle vårdagen i Norden', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Napoleon besøkte Norge og grunnla Stortinget', isCorrect: false },
              { id: 'b', text: 'Det er ingen sammenheng – Grunnloven ble til uavhengig av europeisk politikk', isCorrect: false },
              ...
              { id: 'd', text: 'Napoleon sendte soldater for å hjelpe Norge med å bli selvstendig', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Den kalde krigen mellom USA og Sovjet', isCorrect: false },
              { id: 'b', text: 'Den franske revolusjonens idealer', isCorrect: false },
              { id: 'c', text: 'Holocaust og krigens grusomheter', isCorrect: true },
              { id: 'd', text: 'Kolonialismens slutt i Afrika', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Fordi USA tvang Norge til det', isCorrect: false },
              { id: 'b', text: 'Fordi Norge ønsket å delta i internasjonale militærøvelser', isCorrect: false },
              { id: 'c', text: 'Fordi erfaringene fra 9. april 1940 viste at nøytralitetspolitikken ikke beskyttet Norge', isCorrect: true },
              { id: 'd', text: 'Fordi Sovjet hadde invadert Finnmark', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Å lage en felles valuta for hele Europa', isCorrect: false },
              { id: 'b', text: 'Å knytte Frankrike og Tyskland så tett sammen økonomisk at krig mellom dem ble umulig', isCorrect: true },
              { id: 'c', text: 'Å konkurrere med USA om økonomisk makt', isCorrect: false },
              { id: 'd', text: 'Å samle alle europeiske land i én stat', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Historiske kilder som ennå ikke er oppdaget', isCorrect: false },
              { id: 'b', text: 'Lover, institusjoner og verdier som er formet av fortiden og preger hverdagen vår', isCorrect: true },
              { id: 'c', text: 'Ruiner som er skjult under bakken', isCorrect: false },
              { id: 'd', text: 'Hemmelige dokumenter fra regjeringen', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Brevet er verdiløst fordi soldaten sannsynligvis lyver', isCorrect: false },
              { id: 'b', text: 'Brevet forteller oss hele sannheten om krigen', isCorrect: false },
              ...
              { id: 'd', text: 'Brevet er en sekundærkilde og derfor upålitelig', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Å kritisere historiske kilder for å være gamle og utdaterte', isCorrect: false },
              { id: 'b', text: 'Å finne feil i det historikere har skrevet', isCorrect: false },
              { id: 'c', text: 'Å sortere bort alle kilder som ikke er 100 % sanne', isCorrect: false },
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Ja, fordi primærkilder kommer direkte fra fortiden', isCorrect: false },
              { id: 'b', text: 'Ja, fordi sekundærkilder alltid er subjektive', isCorrect: false },
              ...
              { id: 'd', text: 'Nei, fordi sekundærkilder alltid er bedre enn primærkilder', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'En moderne dokumentar om vikingene', isCorrect: false },
              { id: 'b', text: 'Et sverd funnet i en vikinggrav', isCorrect: true },
              { id: 'c', text: 'Et kapittel om vikingene i en lærebok', isCorrect: false },
              { id: 'd', text: 'En Wikipedia-artikkel om vikingtoktene', isCorrect: false },
            ],
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              ...
              { id: 'c', text: 'Sannhet, løgn, overdrivelse, underdrivelse', isCorrect: false },
              { id: 'd', text: 'Forfatter, utgiver, årstall, sidetall', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'At kilden må være identisk med andre kilder', isCorrect: false },
              { id: 'b', text: 'At kilden må stemme overens med det vi allerede tror', isCorrect: false },
              { id: 'c', text: 'At vi undersøker om kildens innhold støttes eller motsis av andre kilder', isCorrect: true },
              { id: 'd', text: 'At kilden må være skrevet på samme språk som andre kilder', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'En levning er gammel og en beretning er ny', isCorrect: false },
              { id: 'b', text: 'En levning er et direkte spor fra fortiden, mens en beretning er det kilden forteller om noe', isCorrect: true },
              { id: 'c', text: 'En levning er en gjenstand og en beretning er en tekst', isCorrect: false },
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Hele graven er en beretning', isCorrect: false },
              { id: 'b', text: 'Sverdet og gravstedet er levninger, mens runeteksten om at Olav var «mektig» er beretning', isCorrect: true },
              { id: 'c', text: 'Alt er levning fordi det er gammelt', isCorrect: false },
              { id: 'd', text: 'Ingenting er pålitelig fordi det er fra vikingtiden', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Fordi historikere kan gjette seg til sannheten bak løgnen', isCorrect: false },
              { id: 'b', text: 'Fordi løgnaktige kilder forteller sannheten om løgneren – hva de ønsket å fremstille og skjule', isCorrect: true },
              { id: 'c', text: 'Fordi alle kilder egentlig er like pålitelige', isCorrect: false },
              { id: 'd', text: 'Fordi historikere samler på kuriositeter', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'De dikter opp hva vanlige folk tenkte', isCorrect: false },
              { id: 'b', text: 'De ignorerer problemet og fokuserer på eliten', isCorrect: false },
              { id: 'c', text: 'De leter etter andre typer kilder: arkeologiske funn, gjenstander, lovtekster og regnskap', isCorrect: true },
              { id: 'd', text: 'De intervjuer etterkommere av vanlige folk', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Fordi det er mennesker som skaper historie', isCorrect: false },
              { id: 'b', text: 'Fordi periodene er verktøy vi bruker for å forstå, ikke naturlover som finnes der ute', isCorrect: true },
              { id: 'c', text: 'Fordi historikere alltid er uenige', isCorrect: false },
              { id: 'd', text: 'Fordi vi ikke vet nøyaktig når ting skjedde', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Norge ble erobret av Danmark i en krig', isCorrect: false },
              { id: 'b', text: 'Reformasjonen ble innført og den katolske middelalderkirken opphørte', isCorrect: true },
              { id: 'c', text: 'Svartedauden rammet Norge for første gang', isCorrect: false },
              { id: 'd', text: 'Vikingene sluttet å reise utenlands', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Norge ble sterkere fordi færre mennesker delte ressursene', isCorrect: false },
              { id: 'b', text: 'Svartedauden rammet bare Norge og ikke nabolandene', isCorrect: false },
              { id: 'c', text: 'Norge gikk inn i en lang nedgangstid og ble underordnet Danmark fra 1380', isCorrect: true },
              { id: 'd', text: 'Norge ble invadert av Sverige umiddelbart etter pesten', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Dampmaskinen og jernbanen', isCorrect: false },
              { id: 'b', text: 'Universiteter, katedraler og mekaniske klokker', isCorrect: true },
              { id: 'c', text: 'Demokrati og menneskerettigheter', isCorrect: false },
              { id: 'd', text: 'Internett og boktrykkerkunsten', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'De forsket grundig og kom til en objektiv konklusjon', isCorrect: false },
              { id: 'b', text: 'De beskrev middelalderen nøytralt slik den var', isCorrect: false },
              { id: 'c', text: 'De snakket ned perioden før seg for å fremheve sin egen tids storhet', isCorrect: true },
              { id: 'd', text: 'De ignorerte middelalderen fullstendig', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Fordi Afrika ikke hadde historie i denne perioden', isCorrect: false },
              { id: 'b', text: 'Fordi store afrikanske riker blomstret i perioder som ikke passer europeiske kategorier', isCorrect: true },
              { id: 'c', text: 'Fordi Afrika ble kolonisert i middelalderen', isCorrect: false },
              { id: 'd', text: 'Fordi «middelalderen» bare gjelder for land med kirker', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'At det er eksakt vitenskap med klare grenser', isCorrect: false },
              { id: 'b', text: 'At det bare er nyttig for europeisk historie', isCorrect: false },
              { id: 'c', text: 'At det er et menneskeskapt verktøy med omtrentlige grenser, ikke en absolutt sannhet', isCorrect: true },
              { id: 'd', text: 'At alle historikere bruker de samme periodene', isCorrect: false },
            ],
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              ...
              { id: 'c', text: 'Kommersiell historiebruk', isCorrect: false },
              { id: 'd', text: 'Personlig historiebruk', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Den er alltid objektiv og nøytral', isCorrect: false },
              { id: 'b', text: 'Den er kritisk, kildebasert, åpen for revisjon og innrømmer usikkerhet', isCorrect: true },
              { id: 'c', text: 'Den er den eneste formen for historiebruk som er tillatt', isCorrect: false },
              { id: 'd', text: 'Den handler bare om gamle dokumenter', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'De bygde vikingskip til militæret', isCorrect: false },
              { id: 'b', text: 'De brukte nordisk og vikingsymbolikk for å fremme ideer om «arisk» overlegenhet', isCorrect: true },
              { id: 'c', text: 'De forbød all forskning på vikingtiden', isCorrect: false },
              { id: 'd', text: 'De endret vikingenes historie i lærebøkene', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Vikingene selv – fordi vi etter hvert finner sannheten', isCorrect: false },
              { id: 'b', text: 'At det er umulig å vite noe om vikingtiden', isCorrect: false },
              { id: 'c', text: 'De som forteller historien – og hva de trenger fra fortiden', isCorrect: true },
              { id: 'd', text: 'At bare den nyeste forskningen er riktig', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Å skrive en lærebok som viser flere perspektiver på en hendelse', isCorrect: false },
              { id: 'b', text: 'Å innrømme usikkerhet om hva som skjedde', isCorrect: false },
              { id: 'c', text: 'Å bare inkludere fakta som støtter argumentet ditt og utelate alt annet', isCorrect: true },
              { id: 'd', text: 'Å bruke både primær- og sekundærkilder', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Fordi det er ulovlig i noen land', isCorrect: false },
              { id: 'b', text: 'Fordi det handler om en ubehagelig hendelse', isCorrect: false },
              ...
              { id: 'd', text: 'Fordi det bare er én versjon av historien', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Ja, det er alltid historiemisbruk å utelate noe', isCorrect: false },
              { id: 'b', text: 'Nei, fordi de problematiske sidene ikke er viktige', isCorrect: false },
              { id: 'c', text: 'Ikke nødvendigvis – men kritisk historiebevissthet innebærer å kjenne til de mørkere sidene også', isCorrect: true },
              { id: 'd', text: 'Ja, og vi bør slutte å feire 17. mai', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Er dette underholdende nok?', isCorrect: false },
              { id: 'b', text: 'Hvilken historie fortelles, hvem forteller den, og hva utelates?', isCorrect: true },
              { id: 'c', text: 'Er skuespillerne gode?', isCorrect: false },
              { id: 'd', text: 'Har filmen vunnet noen priser?', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Den er så bred at den dekker hele perioden', isCorrect: false },
              { id: 'b', text: 'Den kan besvares med ja eller nei', isCorrect: false },
              { id: 'c', text: 'Den er avgrenset, åpen og undersøkbar', isCorrect: true },
              { id: 'd', text: 'Den inneholder en moralsk vurdering', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Fordi svaret er opplagt', isCorrect: false },
              { id: 'b', text: 'Fordi det inviterer til moralsk dom, ikke til historisk analyse', isCorrect: true },
              { id: 'c', text: 'Fordi det handler om enkeltpersoner', isCorrect: false },
              { id: 'd', text: 'Fordi det er for kontroversielt', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'En nettside for digitale kunstnere', isCorrect: false },
              { id: 'b', text: 'Et digitalisert arkiv med folketellinger, kirkebøker og emigrantlister fra hele Norge', isCorrect: true },
              { id: 'c', text: 'En database med moderne nyhetsartikler', isCorrect: false },
              { id: 'd', text: 'Et sosialt medium for historieinteresserte', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Det er å velge ut alle kilder som finnes om et emne', isCorrect: false },
              ...
              { id: 'c', text: 'Det er å bare bruke primærkilder og ignorere sekundærkilder', isCorrect: false },
              { id: 'd', text: 'Det er å la læreren velge kilder for deg', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Den er skrevet for hånd og vanskelig å lese', isCorrect: false },
              { id: 'b', text: 'Den gir et offisielt bilde, men sier lite om hvordan elevene faktisk opplevde undervisningen', isCorrect: true },
              { id: 'c', text: 'Den er for gammel til å være nyttig', isCorrect: false },
              { id: 'd', text: 'Den er en sekundærkilde og derfor upålitelig', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'De er alltid mer nøyaktige', isCorrect: false },
              ...
              { id: 'c', text: 'De trenger ikke kildekritikk', isCorrect: false },
              { id: 'd', text: 'De er billigere å samle inn', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Alene, fordi de er mest levende', isCorrect: false },
              { id: 'b', text: 'Bare som underholdning, ikke som seriøse kilder', isCorrect: false },
              { id: 'c', text: 'Kombinert med skriftlige og materielle kilder for et rikere og mer nyansert bilde', isCorrect: true },
              { id: 'd', text: 'Bare dersom den muntlige kilden bekrefter det skriftlige materialet', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Dele den videre hvis den er interessant', isCorrect: false },
              { id: 'b', text: 'Ignorere den fordi sosiale medier er upålitelige', isCorrect: false },
              { id: 'c', text: 'Spørre hvem som står bak, hva hensikten kan være, og om andre kilder sier det samme', isCorrect: true },
              { id: 'd', text: 'Godta den hvis mange har likt innlegget', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Ovenfra-perspektivet er alltid bedre fordi det gir oversikt', isCorrect: false },
              { id: 'b', text: 'Ovenfra ser historien fra makthavernes synsvinkel, nedenfra fra vanlige menneskers ståsted', isCorrect: true },
              { id: 'c', text: 'Ovenfra betyr at historikeren er objektiv, nedenfra at den er subjektiv', isCorrect: false },
              { id: 'd', text: 'Det er det samme, bare med forskjellige navn', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Kunsten å skrive pent om historie', isCorrect: false },
              { id: 'b', text: 'Studiet av hvordan historie blir skrevet', isCorrect: true },
              { id: 'c', text: 'En spesiell type historisk kilde', isCorrect: false },
              { id: 'd', text: 'Et annet ord for historieundervisning', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Lengde, språk, layout og illustrasjoner', isCorrect: false },
              { id: 'b', text: 'Utvalg av fakta, ordvalg, årsaksforklaringer og kontekst', isCorrect: true },
              { id: 'c', text: 'Forfatter, forlag, årstall og pris', isCorrect: false },
              { id: 'd', text: 'Innledning, hoveddel, avslutning og kildeliste', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Fordi den ene er flinkere enn den andre', isCorrect: false },
              { id: 'b', text: 'Fordi de bevisst lyver', isCorrect: false },
              ...
              { id: 'd', text: 'Fordi de bruker forskjellige skriveprogrammer', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Bevise at vikingene bare var fredelige', isCorrect: false },
              { id: 'b', text: 'Kombinere flere perspektiver for å gi et mer nyansert bilde', isCorrect: true },
              { id: 'c', text: 'Fjerne all interesse for vikingtiden', isCorrect: false },
              { id: 'd', text: 'Bevise at munkens versjon var den rette', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'At bare vinnere av kriger kan bli historikere', isCorrect: false },
              { id: 'b', text: 'At de som har makt ofte også har makten til å forme fortellingen om fortiden', isCorrect: true },
              { id: 'c', text: 'At taperne aldri etterlater seg kilder', isCorrect: false },
              { id: 'd', text: 'At all historie handler om kriger', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Den har ikke endret seg – kolonialismen fremstilles fortsatt som sivilisering', isCorrect: false },
              ...
              { id: 'c', text: 'Historikere har sluttet å skrive om kolonialismen', isCorrect: false },
              { id: 'd', text: 'Bare afrikanske historikere skriver om kolonialismen nå', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Er dette sann eller falsk?', isCorrect: false },
              ...
              { id: 'c', text: 'Er dette skrevet av en professor?', isCorrect: false },
              { id: 'd', text: 'Er dette nytt eller gammelt?', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Bare historikere og museer', isCorrect: false },
              { id: 'b', text: 'Bare regjeringen og Stortinget', isCorrect: false },
              { id: 'c', text: 'Mange aktører: staten, kirken, organisasjoner, medier og enkeltpersoner – og bak valgene ligger makt', isCorrect: true },
              { id: 'd', text: 'Det bestemmer seg selv – viktige hendelser huskes naturlig', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: '1. mai og 8. mai', isCorrect: false },
              { id: 'b', text: '17. mai og 8. mai', isCorrect: true },
              { id: 'c', text: '17. mai og 7. juni', isCorrect: false },
              { id: 'd', text: '9. april og 8. mai', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Fordi de koster mest å produsere', isCorrect: false },
              { id: 'b', text: 'Fordi de er eldst', isCorrect: false },
              { id: 'c', text: 'Fordi de former hvordan vi tenker om fortiden, ikke bare hva vi ser eller feirer', isCorrect: true },
              { id: 'd', text: 'Fordi de er skrevet av staten', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Finnmark ble ikke berørt av krigen', isCorrect: false },
              { id: 'b', text: 'Hele byen Hammerfest ble brent ned og over 50 000 mennesker ble tvangsevakuert', isCorrect: true },
              { id: 'c', text: 'Finnmark ble frigjort av norske styrker alene', isCorrect: false },
              { id: 'd', text: 'Krigen varte lenger i Finnmark enn i resten av landet', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Stortingets historie', isCorrect: false },
              { id: 'b', text: 'Grunnloven fra 1814', isCorrect: false },
              { id: 'c', text: 'En lokal gruve-, fiske- eller industrihistorie som formet stedet', isCorrect: true },
              { id: 'd', text: 'Kongefamiliens jubileer', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Konger og generaler', isCorrect: false },
              { id: 'b', text: 'Samer, romanifolk, kvinner og arbeiderklassen', isCorrect: true },
              { id: 'c', text: 'Politikere og prester', isCorrect: false },
              { id: 'd', text: 'Forfattere og kunstnere', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'At minnekulturen er ferdig utviklet', isCorrect: false },
              { id: 'b', text: 'At minnekultur er levende og i endring – ikke statisk', isCorrect: true },
              { id: 'c', text: 'At den gamle minnekulturen var bedre', isCorrect: false },
              { id: 'd', text: 'At alle grupper nå er like representert', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'En arkitektonisk konferanse om byplanlegging', isCorrect: false },
              { id: 'b', text: 'Drapet på George Floyd og Black Lives Matter-bevegelsen', isCorrect: true },
              { id: 'c', text: 'Et vedtak i FN om kulturminnevern', isCorrect: false },
              { id: 'd', text: 'En ny lov om offentlig kunst', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Å gjemme statuene i et lager', isCorrect: false },
              ...
              { id: 'c', text: 'Å bygge statuene om så de ser annerledes ut', isCorrect: false },
              { id: 'd', text: 'Å la folket stemme over hver enkelt statue', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Fagteksten er lengre', isCorrect: false },
              { id: 'b', text: 'Fagteksten bygger på kilder, bruker fagbegreper presist og argumenterer saklig', isCorrect: true },
              { id: 'c', text: 'Fagteksten er alltid nøytral og uten standpunkt', isCorrect: false },
              { id: 'd', text: 'Fagteksten bruker vanskelige ord', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Skriver en sammenhengende fortelling om en historisk hendelse', isCorrect: false },
              { id: 'b', text: 'Sammenligner to historiske perioder med hverandre', isCorrect: false },
              { id: 'c', text: 'Undersøker en kilde systematisk: hvem står bak, hva er budskapet, er den troverdig?', isCorrect: true },
              { id: 'd', text: 'Oppsummerer alt du vet om et emne', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Problemstilling, kilder, konklusjon', isCorrect: false },
              { id: 'b', text: 'Innledning, hoveddel, avslutning', isCorrect: true },
              { id: 'c', text: 'Introduksjon, analyse, oppsummering', isCorrect: false },
              { id: 'd', text: 'Bakgrunn, argumenter, moralsk vurdering', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Introdusere ny informasjon og nye argumenter', isCorrect: false },
              { id: 'b', text: 'Gjenta innledningen ordrett', isCorrect: false },
              { id: 'c', text: 'Samle trådene, oppsummere de viktigste funnene og svare på problemstillingen', isCorrect: true },
              { id: 'd', text: 'Liste opp alle kildene som er brukt', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'En detaljert gjengivelse av kildens innhold med egne ord', isCorrect: false },
              { id: 'b', text: 'En ordrett kopiering av hele kildeteksten', isCorrect: false },
              { id: 'c', text: 'En kort henvisning til kilden uten å gjengi innholdet detaljert', isCorrect: true },
              { id: 'd', text: 'En muntlig presentasjon av kildens hovedpoeng', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Slurv', isCorrect: false },
              { id: 'b', text: 'Fri gjenbruk', isCorrect: false },
              { id: 'c', text: 'Kreativ skriving', isCorrect: false },
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Kronologisk etter når kildene ble brukt i teksten', isCorrect: false },
              { id: 'b', text: 'Alfabetisk, med forfatter, tittel, utgivelsesår og utgiver', isCorrect: true },
              { id: 'c', text: 'Etter viktighet, med den viktigste kilden først', isCorrect: false },
              { id: 'd', text: 'Tilfeldig rekkefølge, så lenge alle kildene er med', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'De gjør teksten lengre og mer akademisk', isCorrect: false },
              { id: 'b', text: 'De signaliserer ulike perspektiver og binder drøftingen sammen', isCorrect: true },
              { id: 'c', text: 'De erstatter kildehenvisninger', isCorrect: false },
              { id: 'd', text: 'De brukes bare i innledningen av en tekst', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Eksempel først, deretter påstand, til slutt begrunnelse', isCorrect: false },
              { id: 'b', text: 'Begrunnelse først, deretter eksempel, til slutt påstand', isCorrect: false },
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Vurdere kildens troverdighet umiddelbart', isCorrect: false },
              { id: 'b', text: 'Presentere kilden: hva slags kilde det er, hvem som laget den, og når', isCorrect: true },
              { id: 'c', text: 'Skrive en personlig mening om kildens innhold', isCorrect: false },
              { id: 'd', text: 'Sammenligne kilden med andre kilder', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              ...
              { id: 'b', text: 'Det er ingen forskjell – begge krever det samme', isCorrect: false },
              { id: 'c', text: 'En framstillingsoppgave handler bare om meninger, mens en drøfting bruker fakta', isCorrect: false },
              { id: 'd', text: 'En framstillingsoppgave er lettere enn en drøftingsoppgave', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Skriv så mye som mulig for å vise alt du kan', isCorrect: false },
              { id: 'b', text: 'Ignorer oppgaveteksten og skriv om det du kan best', isCorrect: false },
              { id: 'c', text: 'Hopp over innledningen og gå rett på argumentene', isCorrect: false },
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Etos – det bygger troverdighet', isCorrect: false },
              { id: 'b', text: 'Logos – det er et logisk resonnement', isCorrect: false },
              { id: 'c', text: 'Ingen – det er bare en faktaopplysning', isCorrect: false },
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Fordi det står i læreplanen at alle tre må brukes', isCorrect: false },
              { id: 'b', text: 'Etos gjør at folk lytter, patos gjør at de bryr seg, og logos gjør at argumentene holder', isCorrect: true },
              { id: 'c', text: 'Fordi de tre formene alltid må brukes i rekkefølgen etos-patos-logos', isCorrect: false },
              { id: 'd', text: 'Fordi det gjør presentasjonen lengre og mer imponerende', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Introdusere et helt nytt tema', isCorrect: false },
              { id: 'b', text: 'Binde det hele sammen, gjerne ved å komme tilbake til åpningen og trekke linjer til vår egen tid', isCorrect: true },
              { id: 'c', text: 'Bare si «takk for meg» og sette seg ned', isCorrect: false },
              { id: 'd', text: 'Lese opp alle kildene du har brukt', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Skriv et fullstendig manus og les det opp ord for ord', isCorrect: false },
              { id: 'b', text: 'Ikke forbered deg i det hele tatt – improvisasjon er best', isCorrect: false },
              { id: 'c', text: 'Ha stikkord på kort, øv høyt minst to ganger, og hold øyekontakt med publikum', isCorrect: true },
              { id: 'd', text: 'Memorér hele presentasjonen utenat', isCorrect: false },
            ],
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              ...
              { id: 'b', text: 'Å vise tilbake til tidligere punkter i debatten', isCorrect: false },
              { id: 'c', text: 'Å be motparten om å ta tilbake det de sa', isCorrect: false },
              { id: 'd', text: 'Å ignorere motpartens argumenter og gjenta sine egne', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Det er ingen forskjell – begge er diskusjonsformer', isCorrect: false },
              ...
              { id: 'c', text: 'En paneldebatt er muntlig, mens en sokratisk samtale er skriftlig', isCorrect: false },
              { id: 'd', text: 'En sokratisk samtale handler bare om gresk historie', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Den som snakker høyest, vinner', isCorrect: false },
              { id: 'b', text: 'Det er viktigst å aldri endre mening', isCorrect: false },
              { id: 'c', text: 'Du skal bruke kilder og argumenter, ikke personangrep, og være villig til å endre mening', isCorrect: true },
              { id: 'd', text: 'Du bør unngå å lytte til motparten for ikke å bli forvirret', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Å synes synd på mennesker i fortiden', isCorrect: false },
              ...
              { id: 'c', text: 'Å unnskylde urettferdighet i fortiden', isCorrect: false },
              { id: 'd', text: 'Å late som om man lever i fortiden', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Fordi det er underholdende og krever lite forberedelse', isCorrect: false },
              { id: 'b', text: 'Fordi det tvinger deg til å forlate ditt eget perspektiv og prøve å forstå fortiden innenfra', isCorrect: true },
              { id: 'c', text: 'Fordi læreren slipper å undervise når elevene gjør rollespill', isCorrect: false },
              { id: 'd', text: 'Fordi det gir eksakte svar på historiske spørsmål', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Å bare si positive ting for å ikke såre noen', isCorrect: false },
              { id: 'b', text: 'Å peke på både styrker og svakheter i en framstilling for å bygge opp', isCorrect: true },
              { id: 'c', text: 'Å kritisere alt som er feil uten å nevne det som er bra', isCorrect: false },
              { id: 'd', text: 'Å la være å gi tilbakemelding i det hele tatt', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'At presentasjonen er for kort', isCorrect: false },
              { id: 'b', text: 'At medeleven er for engasjert i emnet', isCorrect: false },
              { id: 'c', text: 'At følelsesappellen kan dekke over mangel på faktisk belegg for påstandene', isCorrect: true },
              { id: 'd', text: 'At medeleven ikke bruker nok faguttrykk', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Fordi det gjør fysisk vondt å holde presentasjoner', isCorrect: false },
              { id: 'b', text: 'Fordi man trenger store muskler for å snakke høyt', isCorrect: false },
              { id: 'c', text: 'Fordi muntlige ferdigheter er medfødte og kan ikke trenes', isCorrect: false },
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Fordi det gjør det lettere å huske årstall', isCorrect: false },
              ...
              { id: 'c', text: 'Fordi historikere alltid overdriver endringer', isCorrect: false },
              { id: 'd', text: 'Fordi det bare er politiske endringer som teller', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Oppdagelsen av Amerika i 1492', isCorrect: false },
              { id: 'b', text: 'Gutenbergs oppfinnelse av boktrykkerkunsten rundt 1440', isCorrect: true },
              { id: 'c', text: 'Svartedauden i 1347', isCorrect: false },
              { id: 'd', text: 'Den franske revolusjon i 1789', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Fordi kontinuitet bare handler om tid og klokker', isCorrect: false },
              { id: 'b', text: 'Fordi endringene beveger seg hele tiden, men så sakte at du aldri ser dem flytte seg', isCorrect: true },
              { id: 'c', text: 'Fordi kontinuitet stopper og starter i rykk og napp', isCorrect: false },
              { id: 'd', text: 'Fordi klokker ble oppfunnet i middelalderen', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Unionsoppløsningen i 1905', isCorrect: false },
              { id: 'b', text: 'Den tyske okkupasjonen i 1940', isCorrect: false },
              { id: 'c', text: 'At norsk språk gradvis har endret seg fra norrønt gjennom hundrevis av år', isCorrect: true },
              { id: 'd', text: 'Oljefunnet på Ekofisk i 1969', isCorrect: false },
            ],
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              ...
              { id: 'c', text: 'Eric Hobsbawm', isCorrect: false },
              { id: 'd', text: 'Knut Kjeldstadli', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Enkelthendelser som slag og attentater', isCorrect: false },
              { id: 'b', text: 'Dype strukturelle endringer over flere hundre år', isCorrect: false },
              { id: 'c', text: 'Endringer som varer i tiår eller generasjoner, som økonomiske sykluser og urbanisering', isCorrect: true },
              { id: 'd', text: 'Naturkatastrofer og pandemier', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'De dype strukturene som endrer seg over århundrer', isCorrect: false },
              { id: 'b', text: 'Konjunkturer som varer i tiår', isCorrect: false },
              { id: 'c', text: 'Hendelser – synlige, dramatiske begivenheter som fanger blikket men ikke forteller hele historien', isCorrect: true },
              { id: 'd', text: 'Klimaendringer over lang tid', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Kontinuitet – den gjentok gamle lover', isCorrect: false },
              ...
              { id: 'c', text: 'En konjunktur – den endret seg gradvis over tiår', isCorrect: false },
              { id: 'd', text: 'En strukturell endring – den tok flere hundre år å gjennomføre', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Han avskaffet alle lover fra det gamle regimet', isCorrect: false },
              { id: 'b', text: 'Han innførte demokrati i hele Europa', isCorrect: false },
              { id: 'c', text: 'Han gjeninnførte mange gamle strukturer, inkludert en slags adel med egne marskaller og hertuger', isCorrect: true },
              { id: 'd', text: 'Han ga kvinner stemmerett', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Et eksempel på kontinuitet – teknologien har alltid vært der', isCorrect: false },
              { id: 'b', text: 'Et brudd – digital teknologi har endret kommunikasjon, arbeidsliv og underholdning fundamentalt', isCorrect: true },
              { id: 'c', text: 'Verken brudd eller kontinuitet – det er bare underholdning', isCorrect: false },
              { id: 'd', text: 'En konjunktur – det er bare en forbigående trend', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Ja, alle forsto umiddelbart at dette var et vendepunkt', isCorrect: false },
              { id: 'b', text: 'Ja, avisene skrev at verdenskrigen nå var i gang', isCorrect: false },
              ...
              { id: 'd', text: 'Nei, fordi attentatet var hemmelig og ingen visste om det', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'At alle historiske endringer er like viktige', isCorrect: false },
              { id: 'b', text: 'At brudd alltid er viktigere enn kontinuitet', isCorrect: false },
              { id: 'c', text: 'At kontinuitet er viktigere enn brudd', isCorrect: false },
