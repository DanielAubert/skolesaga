...
// ============================================================================
  ...
  // ============================================================================
  // Kapittel 1.6: Kjønn, seksualitet og mangfold
  // ============================================================================
  'samfunnskunnskap-1-6': [
    {
      question: 'Hva er kjønnsidentitet?',
      options: [
        'Den indre opplevelsen av eget kjønn',
        'Det biologiske kjønnet',
        'Hvem man er tiltrukket av',
        'Hvilke klær man bruker',
      ],
      explanation: 'Kjønnsidentitet er den indre opplevelsen av eget kjønn - hvem man føler seg som.',
    },
    {
      ...
      explanation: 'Seksuell orientering handler om hvem man er tiltrukket av - motsatt kjønn, samme kjønn, flere kjønn eller ingen.',
    },
    {
      question: 'Hva betyr ciskjønnet?',
      options: [
        'At man opplever samsvar mellom biologisk kjønn og kjønnsidentitet',
        'At man ikke opplever samsvar mellom biologisk kjønn og kjønnsidentitet',
        'At man er bifil',
        'At man ikke har noen kjønnsidentitet',
      ],
      explanation: 'Ciskjønnet betyr at man opplever samsvar mellom biologisk kjønn og kjønnsidentitet.',
    },
    {
      question: 'Hva er heteronormativitet?',
      options: [
        'Antagelsen om at alle er heterofile og at det er "normalen"',
        'At man er heterofil',
        'En type seksualitet',
        'En lov om kjønn',
      ],
      explanation: 'Heteronormativitet er antagelsen om at alle er heterofile og at heterofili er "normalen".',
    },
    {
      question: 'Hva står LHBTIQ+ for?',
      options: [
        'Lesbiske, homofile, bifile, transpersoner, interkjønn, queer og andre',
        'En politisk organisasjon',
        'En type personlighetstest',
        'En medisinsk diagnose',
      ],
      explanation: 'LHBTIQ+ er en samlebetegnelse for lesbiske, homofile, bifile, transpersoner, interkjønn, queer og andre.',
    },
    {
      question: 'Hva er kjønnsuttrykk?',
      options: [
        'Hvordan vi uttrykker kjønn gjennom klær, frisyre og oppførsel',
        'Hvilke ord vi bruker om kjønn',
        'Det biologiske kjønnet',
        'Hvem vi er tiltrukket av',
      ],
      explanation: 'Kjønnsuttrykk er hvordan vi uttrykker kjønn gjennom klær, frisyre, oppførsel og lignende.',
    },
    {
    ...
    {
      question: 'Hva er kjønnsnormer?',
      options: [
        'Samfunnets forventninger til hvordan kvinner og menn skal oppføre seg',
        'Lover om kjønn',
        'Biologiske forskjeller mellom kjønn',
        'Statistikk om kjønnsfordeling',
      ],
      explanation: 'Kjønnsnormer er samfunnets forventninger til hvordan kvinner og menn skal oppføre seg, se ut og hvilke roller de skal ha.',
    },
    {
      question: 'Hva betyr transkjønnet?',
      options: [
        'At man opplever at biologisk kjønn og kjønnsidentitet ikke stemmer overens',
        'At man er heterofil',
        'At man bytter kjønn ofte',
        'At man ikke har noe kjønn',
      ],
      explanation: 'Transkjønnet betyr at man opplever at biologisk kjønn og kjønnsidentitet ikke stemmer overens.',
    },
    {
      question: 'Hva er stereotypier?',
      options: [
        'Forenklede forestillinger om grupper, som "jenter liker rosa"',
        'Sanne fakta om grupper',
        'Vitenskapelige funn',
        'Lover og regler',
      ],
      explanation: 'Stereotypier er forenklede forestillinger om grupper, for eksempel "jenter liker rosa" eller "gutter gråter ikke".',
    },
    {
      question: 'Hva betyr aseksuell?',
      options: [
        'At man opplever lite eller ingen seksuell tiltrekning',
        'At man ikke har noe kjønn',
        'At man er tiltrukket av alle kjønn',
        'At man ikke kan få barn',
      ],
      explanation: 'Aseksuell betyr at man opplever lite eller ingen seksuell tiltrekning.',
    },
  ],
...
'samfunnskunnskap-2-1': [
  ...
  'samfunnskunnskap-2-4': [
    {
      question: 'Hva er direkte rasisme?',
      options: [
        'Åpenlys forskjellsbehandling basert på etnisitet, hudfarge eller religion',
        'Rasisme som er skjult i systemer',
        'Små kommentarer i hverdagen',
        'Rasisme på internett',
      ],
      explanation: 'Direkte rasisme er åpenlys forskjellsbehandling basert på etnisitet, hudfarge eller religion.',
    },
    {
      question: 'Hva er strukturell rasisme?',
      options: [
        'Rasisme innebygd i samfunnets systemer som gir ulike grupper ulike muligheter',
        'Rasisme fra enkeltpersoner',
        'Rasisme i bygninger',
        'Rasisme som er organisert',
      ],
      explanation: 'Strukturell rasisme er rasisme innebygd i samfunnets systemer, lover og praksiser som systematisk gir ulike grupper ulike muligheter.',
    },
    {
      question: 'Hva er hverdagsrasisme?',
      options: [
        'Dagligdagse kommentarer og handlinger som signaliserer at noen ikke hører til',
        'Rasisme som bare skjer på hverdager',
        'Vanlig diskriminering',
        'Rasisme på arbeidsplassen',
      ],
      explanation: 'Hverdagsrasisme er dagligdagse kommentarer og handlinger som signaliserer at noen ikke hører til, som "hvor kommer du egentlig fra?"',
    },
    {
      question: 'Hva er mikroaggresjoner?',
      options: [
        'Subtile, ofte ubevisste handlinger som formidler negative holdninger',
        'Små fysiske angrep',
        'Aggressive kommentarer',
        'Mikroblogger med rasistisk innhold',
      ],
      explanation: 'Mikroaggresjoner er subtile, ofte ubevisste handlinger eller kommentarer som formidler negative holdninger mot marginaliserte grupper.',
    },
    {
      ...
      explanation: 'Likestillings- og diskrimineringsloven forbyr diskriminering og pålegger aktivt likestillingsarbeid.',
    },
    {
      ...
      explanation: 'Straffelovens §185 forbyr offentlige uttalelser som truer, forhåner eller fremmer hat mot grupper.',
    },
    {
      question: 'Hva er Likestillings- og diskrimineringsombudets rolle?',
      options: [
        'Å føre tilsyn og gi veiledning om diskrimineringssaker',
        'Å dømme i rettssaker',
        'Å lage lover',
        'Å straffe diskriminering',
      ],
      explanation: 'Likestillings- og diskrimineringsombudet fører tilsyn og gir veiledning om diskrimineringssaker.',
    },
    {
      question: 'Hva er diskriminering?',
      options: [
        'Å behandle personer dårligere på grunn av forhold som etnisitet, religion eller kjønn',
        'Å skille mellom ulike typer produkter',
        'Å velge mellom alternativer',
        'Å ha sterke meninger',
      ],
      explanation: 'Diskriminering er å behandle personer dårligere på grunn av forhold som etnisitet, religion, kjønn eller andre beskyttede grunnlag.',
    },
    {
      question: 'Hva er internalisert rasisme?',
      options: [
        'Når minoritetspersoner internaliserer samfunnets negative holdninger mot egen gruppe',
        'Rasisme som holdes hemmelig',
        'Rasisme i familien',
        'Rasisme man arver genetisk',
      ],
      explanation: 'Internalisert rasisme er når personer fra minoritetsgrupper internaliserer samfunnets negative holdninger mot sin egen gruppe.',
    },
    {
      ...
      explanation: 'Diskrimineringsnemnda behandler klager på diskriminering og kan gi oppreisning.',
    },
    {
      question: 'Hva kan bidra til å bekjempe strukturell diskriminering på arbeidsmarkedet?',
      options: [
      ...
      explanation: 'Anonyme jobbsøknader kan bidra til å bekjempe strukturell diskriminering ved at søkere vurderes uten påvirkning av navn.',
    },
  ],
  ...
  'samfunnskunnskap-2-6': [
    ...
    {
      question: 'Har elever rett til å bruke religiøse plagg som hijab på norske skoler?',
      options: [
        'Ja, norsk lov tillater religiøse plagg i skolen',
        'Nei, det er forbudt',
        'Bare for voksne',
        'Bare i videregående skole',
      ],
      explanation: 'Norsk lov tillater religiøse plagg i skolen. Et forbud ville være diskriminering.',
    },
  ],
  ...
  'samfunnskunnskap-4-7': [
    {
      ...
      options: [
        'Gradvis svekkelse av demokratiske institusjoner og normer',
        'At flere stemmer ved valg',
        'At nye partier dannes',
        'At demokratiet styrkes',
      ],
      explanation: 'Demokratisk tilbakegang er gradvis svekkelse av demokratiske institusjoner - ofte uten dramatiske statskupp, men gjennom langsom uthuling.',
    },
    {
      question: 'Hva er en indre trussel mot demokratiet?',
      options: [
        'Politisk ekstremisme og polarisering',
        'Internasjonalt samarbeid',
        'Frie medier',
        'Høy valgdeltakelse',
      ],
      explanation: 'Indre trusler inkluderer politisk ekstremisme, polarisering, svekket tillit til institusjoner og økonomisk ulikhet.',
    },
    {
      ...
      explanation: 'Desinformasjon er bevisst feilinformasjon som spres for å villede folk, ofte via sosiale medier.',
    },
    {
      question: 'Hvorfor er desinformasjon en trussel mot demokratiet?',
      options: [
        'Gjør det vanskelig å ta informerte valg og undergraver tillit',
        'Det gir folk mer informasjon',
        'Det styrker mediene',
        'Det øker valgdeltakelsen',
      ],
      explanation: 'Desinformasjon truer demokratiet fordi det gjør det vanskelig å ta informerte valg og undergraver tilliten til medier og institusjoner.',
    },
    {
      question: 'Hva menes med polarisering i samfunnet?',
      options: [
        'Økende avstand mellom politiske grupper og "vi mot dem"-tenkning',
        'At folk blir mer enige',
        'At flere partier dannes',
        'At valgdeltakelsen øker',
      ],
      explanation: 'Polarisering betyr at avstanden mellom politiske grupper øker, med mindre vilje til kompromiss og mer "vi mot dem"-tenkning.',
    },
    {
      question: 'Hvilket land nevnes som eksempel på demokratisk tilbakegang?',
      options: [
        'Ungarn',
        'Norge',
        'Sverige',
      ...
      explanation: 'Ungarn nevnes som eksempel der en valgt regjering har svekket rettsstaten, mediene og sivilsamfunnet.',
    },
    {
      question: 'Hva er en ytre trussel mot demokratiet?',
      options: [
        'Russisk desinformasjon og cyberangrep',
        'Frie valg',
        'Sterke domstoler',
        'Ytringsfrihet',
      ],
      explanation: 'Ytre trusler inkluderer desinformasjon og påvirkningsoperasjoner fra autoritære stater, samt cyberangrep.',
    },
    {
      question: 'Hva er et ekkokammer?',
      options: [
        'Miljøer der man bare møter meninger som ligner ens egne',
        'Et rom med god akustikk',
        'En type sosiale medier',
        'Et debattforum',
      ],
      explanation: 'Ekkokamre er (digitale) miljøer der man hovedsakelig eksponeres for meninger som bekrefter ens egne synspunkter.',
    },
    {
      question: 'Hva skjedde i USA 6. januar 2021?',
      options: [
        'Stormingen av kongressen',
        'Presidentvalg',
        'Fredelig maktoverføring',
        'Ny grunnlov ble vedtatt',
      ],
      explanation: 'Stormingen av kongressen 6. januar 2021 nevnes som eksempel på trussel mot demokratiske institusjoner.',
    },
    {
      question: 'Hva kan gjøres for å beskytte demokratiet?',
      options: [
        'Styrke kritisk mediekompetanse, sikre frie medier og aktive borgere',
        'Begrense ytringsfriheten',
        'Gi mer makt til én leder',
        'Redusere antall partier',
      ],
      explanation: 'Demokratiet beskyttes gjennom kritisk mediekompetanse, frie medier, uavhengige domstoler og aktive, engasjerte borgere.',
    },
    {
