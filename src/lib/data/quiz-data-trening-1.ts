...
const quizData_trening_1: Record<string, QuizQuestion[]> = {
  'trening-1-1-1': [
  {
  ...
  {
    question: 'Hva er målet med systematisk trening?',
    options: ["Å skape ønskede tilpasninger i kroppen over tid", "Å bli sliten uten hensikt", "Å variere treningen helt tilfeldig fra dag til dag uten noen plan eller struktur", "Å unngå all belastning"],
    explanation: 'Systematisk trening styrer belastningen for å oppnå bestemte effekter.',
  },
  {
  ...
  },
  {
    ...
    options: ["At kroppen tilpasser seg den typen belastning den utsettes for", "At all trening gir lik effekt", "At man bør variere øvelsene helt tilfeldig, slik at kroppen aldri vet hva den skal tilpasse seg til", "At man bør variere tilfeldig"],
    explanation: 'Vil du bli bedre i en egenskap, må du trene nettopp den.',
  },
  {
  ...
  'trening-1-1-3': [
  {
    ...
    options: ["I restitusjonsfasen etter trening", "Bare ved maksimal belastning", "Under selve treningsøkta, mens musklene arbeider hardest og belastningen er på sitt aller høyeste", "Under selve treningsøkta"],
    explanation: 'Etter belastning faller formen, for så å overkompensere i hvilefasen.',
  },
  {
    question: 'Hva er restitusjon?',
    options: ["Kroppens gjenoppbygging og tilpasning etter trening", "En type kosttilskudd", "Selve treningsøkta der musklene belastes hardt og kroppen brytes gradvis ned under arbeidet", "Selve treningsøkta"],
    explanation: 'Restitusjon er en forutsetning for at trening skal gi framgang.',
  },
  {
  ...
  'trening-1-1-4': [
  {
    question: 'Hva angir intensitet i trening?',
    options: ["Hvor hardt du trener i forhold til maksimal kapasitet", "Hvor mange øvelser du gjør", "Hvor mange ulike øvelser du gjennomfører i løpet av økta, uansett hvor tungt eller hardt du jobber", "Hvor lenge du trener"],
    explanation: 'Intensitet måles ofte som prosent av 1RM eller prosent av maks hjertefrekvens.',
  },
  {
  ...
  {
    question: 'En utøver gjør 3 sett × 10 repetisjoner med 50 kg. Hva blir volumbelastningen?',
    options: ["1500 kg", "150 kg", "500 kg", "63 kg"],
    explanation: '3 × 10 × 50 = 1500 kg total løftet vekt.',
  },
  {
  ...
  {
    question: 'Hva trener man primært med styrketrening?',
    options: ["Musklenes evne til å utvikle kraft mot motstand", "Bevegelighet alene", "Bevegeligheten alene, altså hvor stort bevegelsesutslag man har i leddene under en øvelse", "Aerob kapasitet"],
    explanation: 'Styrketrening øker kraftutviklingen i muskulaturen.',
  },
  {
  ...
  'trening-1-2-1': [
  {
    ...
    options: ["Å gi støtte, beskytte organer og være festepunkt for muskler", "Å lede nervesignaler", "Å lede nervesignaler fra hjernen ut til musklene slik at bevegelsene kan settes i gang", "Å transportere maten videre gjennom fordøyelsen og ta opp næringsstoffene kroppen trenger"],
    explanation: 'Skjelettet gir struktur og muliggjør bevegelse sammen med musklene.',
  },
  {
  ...
  {
    question: 'Hvordan reagerer skjelettet på regelmessig belastning?',
    options: ["Det kan bli sterkere og tettere over tid", "Det blir alltid svakere", "Det blir alltid svakere og mister tetthet, fordi belastning sliter ned benvevet over tid", "Det mister all funksjon"],
    explanation: 'Belastning stimulerer benvevet til å tilpasse seg, blant annet med økt tetthet.',
  },
  {
    question: 'Hva forbinder et leddbånd (ligament)?',
    options: ['Ben til ben', 'Muskel til ben', 'Nerve til muskel', 'Blodåre til sene'],
    explanation: 'Leddbånd stabiliserer ledd ved å binde ben til ben.',
  },
],
  'trening-1-2-2': [
  {
  ...
  {
    question: 'Hva er et sarkomer?',
    options: ["Den minste funksjonelle kontraktile enheten i en muskelfiber", "En nervecelle", "En bindevevshinne som omslutter hele muskelen og fester den til knokkelen", "En energilagerenhet i muskelcellen som lagrer kreatinfosfat til rask innsats"],
    explanation: 'Sarkomeret består av aktin- og myosintråder som glir over hverandre ved kontraksjon.',
  },
  {
    question: 'Hvilken muskeltype er viljestyrt?',
    options: ['Skjelettmuskulatur', 'Hjertemuskulatur', 'Glatt muskulatur i tarmen', 'Alle er like ufrivillige'],
    explanation: 'Skjelettmuskulaturen styres bevisst, ulikt hjerte- og glatt muskulatur.',
  },
  {
    question: 'Hva skjer i et sarkomer under en muskelkontraksjon?',
    options: ["Aktin- og myosintrådene glir over hverandre slik at muskelen forkortes", "Muskelen produserer blod", "Aktin- og myosintrådene strekkes ut slik at hele sarkomeret blir lengre", "Sarkomeret deler seg i to nye enheter for å øke muskelens totale lengde"],
    explanation: 'Glidefilamentteorien forklarer kontraksjon som at trådene glir innover.',
  },
  {
  ...
  {
    question: 'Hva er forholdet mellom biceps og triceps i albuleddet?',
    options: ["De er agonist og antagonist – den ene bøyer, den andre strekker", "De gjør nøyaktig det samme", "De utfører nøyaktig samme bevegelse og bøyer begge albuleddet sammen", "De er egentlig samme muskel med to ulike navn på over- og undersiden"],
    explanation: 'Biceps bøyer albuen, triceps strekker den – de er motspillere.',
  },
  {
    question: 'Hvilken stor muskel ligger på forsiden av låret?',
    options: ["Quadriceps (firhodet lårmuskel)", "Leggmuskelen", "Den rette magemuskelen som bøyer overkroppen framover", "Magemuskelen"],
    explanation: 'Quadriceps strekker kneet og er en av kroppens største muskler.',
  },
  {
  ...
  'trening-1-2-4': [
  {
    question: 'Hva er et ledd (articulatio)?',
    options: ["Forbindelsen mellom to eller flere knokler som muliggjør bevegelse", "En nervecelle", "Et sammentrekkbart vev som skaper kraft og setter knoklene i bevegelse", "En signalcelle som leder impulsen fra hjernen ut til musklene i kroppen"],
    explanation: 'Ledd gir kroppen bevegelighet der knoklene møtes.',
  },
  {
  ...
  {
    question: 'Hva er et kuleledd et eksempel på?',
    options: ["Et ledd med stor bevegelsesfrihet i flere retninger, som skulder og hofte", "Et fast, ubevegelig ledd der knoklene har vokst sammen til én enhet", "Et ledd som bare kan bøye og strekke i én retning, slik som albuen", "En kraftig muskel som fester over to knokler og trekker dem sammen"],
    explanation: 'Kuleledd gir bevegelse i alle plan, ulikt for eksempel hengselledd.',
  },
  {
    question: 'Hva påvirker bevegeligheten i et ledd?',
    options: ["Leddets struktur, muskler, sener og bindevev", "Bare maksimal styrke", "Bare kroppens evne til å ta opp oksygen under langvarig aerobt arbeid", "Bare aerob kapasitet"],
    explanation: 'Flere faktorer, både strukturelle og bløtvevsrelaterte, bestemmer ROM.',
  },
  {
  ...
  {
    question: 'Hvilket energisystem er mest effektivt og dominerer ved langvarig aktivitet?',
    options: ['Aerob forbrenning', 'Kreatinfosfatsystemet', 'Anaerob glykolyse', 'Det fosfagene systemet'],
    explanation: 'Aerob forbrenning krever oksygen og dominerer ved aktivitet over noen minutter.',
  },
  {
  ...
  'trening-1-3-2': [
  {
    ...
    options: ["Å pumpe blod rundt i kroppen", "Å produsere oksygen", "Å filtrere lufta vi puster inn før den når ned til lungene", "Å filtrere luft"],
    explanation: 'Hjertet driver blodsirkulasjonen som frakter oksygen og næring.',
  },
  {
  ...
  {
    question: 'Hva er VO₂max?',
    options: ["Den maksimale mengden oksygen kroppen kan ta opp og bruke per minutt", "Det høyeste antallet repetisjoner en utøver klarer i en øvelse", "Den største kraften en muskel kan utvikle i én sammentrekning", "Den høyeste pulsen hjertet kan slå ved maksimal anstrengelse"],
    explanation: 'VO₂max måles i ml/kg/min og er et sentralt mål på aerob kapasitet.',
  },
  {
    question: 'Hvor skjer gassutvekslingen i lungene?',
    options: ["I lungeblærene (alveolene)", "I luftrøret", "I luftrøret, der lufta ledes videre ned mot lungene", "I hjertet"],
    explanation: 'Alveolenes tynne vegger gjør at oksygen og CO₂ kan utveksles med blodet.',
  },
  {
    question: 'Hva transporterer oksygen i blodet?',
    options: ["Hemoglobin i de røde blodcellene", "De hvite blodcellene", "Blodplasmaet alene, som frakter oksygen løst oppløst", "Plasma alene"],
    explanation: 'Hemoglobin binder oksygen og frakter det til vevet.',
  },
  {
  ...
  'trening-1-3-4': [
  {
    question: 'Hva omfatter sentralnervesystemet (SNS)?',
    options: ['Hjernen og ryggmargen', 'Bare nervene i armene', 'Musklene', 'Sansene alene'],
    explanation: 'SNS består av hjerne og ryggmarg og styrer kroppens funksjoner.',
  },
  {
    question: 'Hva er en motorisk enhet?',
    options: ["En motorisk nervecelle og alle muskelfibrene den styrer", "En enkelt muskelfiber alene", "Leddet der to knokler møtes og bevegelsen faktisk skjer", "Senen som fester muskelen til skjelettet og overfører kraft"],
  ...
  {
    question: 'Hvorfor kan en utøver bli sterkere uten synlig muskelvekst i starten?',
    options: ["Fordi nervesystemet lærer å aktivere musklene mer effektivt", "Fordi kreatinfosfatlagrene forsvinner", "Fordi kreatinfosfatlagrene tømmes og gir høyere kraft raskt", "Fordi musklene krymper og dermed jobber mer effektivt sammen"],
    explanation: 'Nevrale tilpasninger gir tidlig styrkeøkning før hypertrofi setter inn.',
  },
],
  'trening-1-3-5': [
  {
    question: 'Hva er et hormon?',
    options: ["Et signalstoff som transporteres i blodet og påvirker celler og organer", "En bestemt type muskelfiber som styrer kroppens bevegelser og kraft", "En energiform som lagres i musklene og frigjøres under hardt arbeid", "Et næringsstoff vi får i oss gjennom maten som bygger opp muskler"],
    explanation: 'Hormoner regulerer mange kroppsfunksjoner, også tilpasning til trening.',
  },
  {
  ...
  {
    question: 'Hvilket hormon er kjent for å fremme muskelvekst (anabol effekt)?',
    options: ['Testosteron', 'Kortisol', 'Insulin alene hindrer vekst', 'Adrenalin senker vekst'],
    explanation: 'Testosteron er et anabolt hormon som støtter muskeloppbygging.',
  },
  {
    question: 'Når frigjøres mye veksthormon?',
    options: ['Særlig under dyp søvn', 'Bare i hvile uten søvn', 'Aldri', 'Bare ved spising'],
    explanation: 'Veksthormon skilles særlig ut under dyp søvn og bidrar til restitusjon.',
  },
  {
    question: 'Hvorfor er hormonbalansen viktig for treningseffekt?',
    options: ["Forholdet mellom oppbyggende og nedbrytende hormoner påvirker tilpasning og restitusjon", "Hormoner har ingen betydning for hvordan kroppen tilpasser seg trening", "Hormoner virker bare hemmende og hindrer all form for tilpasning", "Bare ett enkelt hormon avgjør all treningseffekt og restitusjon"],
    explanation: 'God balanse mellom anabole og katabole hormoner fremmer framgang.',
  },
],
  'trening-1-4-1': [
  {
    question: 'Hva er maksimal styrke?',
    options: ["Den største kraften muskelen kan utvikle i én enkelt muskelaksjon (1RM)", "Evnen til å holde ut muskelarbeid over lang tid uten å bli utmattet", "Aerob kapasitet og kroppens evne til å utnytte oksygen under arbeid", "Bevegeligheten og bevegelsesutslaget musklene tillater i et ledd"],
    explanation: 'Maksimal styrke måles ofte som 1RM.',
  },
  {
  ...
  {
    question: 'Hvis 1RM i benkpress er 60 kg, hvor mye er 85 % av 1RM?',
    options: ['51 kg', '45 kg', '60 kg', '70 kg'],
    explanation: '0,85 × 60 = 51 kg.',
  },
  {
  ...
  {
    question: 'Hvilket repetisjonsområde brukes typisk for hypertrofi?',
    options: ["Omtrent 6-12 repetisjoner med moderat til tung belastning", "30+ repetisjoner med lett vekt", "Over 30 repetisjoner med lett vekt og kort pause mellom sett", "Utelukkende statiske hold uten bevegelse gjennom repetisjoner"],
  ...
  {
    question: 'Hva er en typisk pauselengde mellom sett ved hypertrofitrening?',
    options: ["Omtrent 1-2 minutter", "Over 15 minutter", "Omtrent 5-10 minutter", "Klart over 15 minutter"],
    explanation: 'Moderate pauser balanserer restitusjon og metabolsk stress for vekst.',
  },
],
  'trening-1-4-3': [
  {
    question: 'Hva kjennetegner en flerleddsøvelse?',
    options: ["Bevegelse i flere ledd som aktiverer flere muskelgrupper, for eksempel knebøy", "En ren tøyeøvelse der muskelen holdes strukket uten kraftutvikling", "Bevegelse i kun ett ledd som isolerer én bestemt muskel, som curl", "En øvelse helt uten ytre motstand der man kun bruker egen vekt"],
    explanation: 'Flerleddsøvelser som knebøy og markløft er effektive og funksjonelle.',
  },
  {
    question: 'Hva er en isolasjonsøvelse?',
    options: ["En øvelse som hovedsakelig belaster én muskel gjennom ett ledd, som bicepscurl", "En aerob øvelse med lav motstand som først og fremst trener utholdenhet", "En øvelse som aktiverer hele kroppen i mange ledd samtidig, som knebøy", "En balanseøvelse der hovedmålet er å stabilisere kroppen framfor kraft"],
    explanation: 'Isolasjonsøvelser retter belastningen mot en bestemt muskel.',
  },
  {
  ...
  'trening-1-4-4': [
  {
    question: 'Hva er periodisering av styrketrening?',
    options: ["Systematisk variasjon av belastning, volum og intensitet over tid", "Å gjennomføre nøyaktig lik trening i hver eneste økt hele året", "En form for oppvarming som gjøres før hver styrkeøkt starter", "En enkelt bestemt øvelse som gjentas i alle treningsøktene"],
    explanation: 'Periodisering styrer treningen i faser for å gi tilpasning og unngå stagnasjon.',
  },
  {
  ...
  'trening-1-4-5': [
  {
    question: 'Hva er forskjellen på biologisk og kronologisk alder?',
    options: ["Kronologisk alder er antall år, biologisk alder er kroppens faktiske modnings- eller funksjonsnivå", "De er alltid nøyaktig like fordi kroppen modnes i takt med årene", "Biologisk alder er bare fødselsdatoen regnet om til antall dager", "Kronologisk alder er et mål på benstyrke og faktisk muskelmasse"],
    explanation: 'To jevnaldrende kan ha ulik biologisk modning og treningstoleranse.',
  },
  {
  ...
  {
    question: 'Hva er laktatterskel?',
    options: ["Intensiteten der laktatproduksjonen begynner å overstige fjerningen", "Antall sett i en økt", "Den høyeste pulsen hjertet kan slå ved maksimalt anstrengende arbeid over tid", "Grensen for hvor mange harde intervalldrag musklene tåler før de svikter helt"],
    explanation: 'Over terskelen hoper laktat seg opp og begrenser arbeidet.',
  },
  {
  ...
  {
    question: 'Hvorfor er en høy laktatterskel gunstig for utholdenhetsutøvere?',
    options: ["Man kan holde høyere fart uten at laktat hoper seg opp", "Det reduserer utholdenheten", "Fordi det reduserer den totale utholdenheten og gjør at man tåler mindre laktat", "Fordi en høy terskel senker det maksimale oksygenopptaket og sparer energi over tid"],
    explanation: 'En høyere terskel betyr at man utnytter en større andel av VO₂max.',
  },
  {
  ...
  {
    question: 'Hvilket energisystem er sentralt i anaerob utholdenhet ved arbeid på 10 sek til 2 min?',
    options: ['Anaerob glykolyse', 'Aerob fettforbrenning', 'Kreatinfosfat alene over flere minutter', 'Proteinforbrenning'],
    explanation: 'Anaerob glykolyse leverer energi raskt ved høy intensitet i dette tidsrommet.',
  },
  {
  ...
  },
  {
    ...
    options: ["Å heve den anaerobe terskelen slik at man kan holde høyere fart over tid", "Å bare trene maksimal styrke", "Å senke det maksimale oksygenopptaket slik at man sparer energi over tid", "Å redusere den generelle utholdenheten så man tåler kortere arbeidsøkter"],
    explanation: 'Trening rundt terskelen forbedrer evnen til å arbeide på høy, vedvarende intensitet.',
  },
  {
  ...
  'trening-1-5-4': [
  {
    question: 'Hva er forskjellen på en felttest og en laboratorietest?',
    options: ["Felttester gjennomføres i praksis/idrettsmiljø, labtester under kontrollerte forhold med presist utstyr", "Felttester er alltid mer nøyaktige", "Felttester er alltid mer nøyaktige enn labtester fordi de foregår i utøverens egne og vante idrettsmiljø", "Labtester gjennomføres alltid utendørs i praksis, mens felttester krever et avansert og kontrollert utstyr"],
    explanation: 'Labtester gir høy presisjon, felttester er enklere og mer idrettsnære.',
  },
  {
    question: 'Hva måler en Cooper-test?',
    options: ["Hvor langt man løper på 12 minutter (aerob utholdenhet)", "Maksimal styrke", "Bevegelsesutslaget i et sentralt ledd viktig for teknikken", "Den maksimale styrken en muskelgruppe kan utvikle i ett løft"],
    explanation: 'Distansen på 12 minutter brukes til å anslå VO₂max.',
  },
  {
    question: 'Hvorfor er standardisering viktig ved testing?',
    options: ["For at resultatene skal være pålitelige og kunne sammenlignes over tid", "Standardisering har ingen betydning", "For at testen skal bli mest mulig tilfeldig og variere fra gang til gang", "Fordi standardisering ikke har betydning så lenge utøveren gjør sitt beste"],
    explanation: 'Like forhold gjør at endringer i resultat faktisk skyldes utviklingen.',
  },
  {
  ...
  {
    question: 'Hvordan bør utholdenhetstrening for en fotballspiller tilpasses?',
    options: ["Med innslag av intervaller som ligner spillets vekslende intensitet", "Bare rolig langkjøring", "Med utelukkende tunge maksimale styrkeløft og fullstendige hvilepauser", "Med bare rolig og jevn langkjøring på lav intensitet over svært lang tid"],
    explanation: 'Fotball krever gjentatte høyintensive innsatser, så intervaller er relevant.',
  },
  {
  ...
  {
    question: 'Hva betyr ROM (Range of Motion)?',
    options: ["Bevegelsesutslaget i et ledd", "Maksimal styrke", "Den maksimale styrken en muskel kan utvikle i én sammentrekning", "Aerob kapasitet"],
    explanation: 'ROM beskriver hvor stor bevegelse leddet kan utføre.',
  },
  {
    question: 'Hva påvirker bevegeligheten?',
    options: ["Leddstruktur, muskler, sener og bindevev", "Bare maksimal styrke", "Bare den aerobe kapasiteten målt som oksygenopptak per minutt", "Bare aerob kapasitet"],
    explanation: 'Både strukturelle og bløtvevsrelaterte faktorer bestemmer bevegeligheten.',
  },
  {
  ...
  {
    question: 'Hva er forskjellen på generell og spesifikk bevegelighet?',
    options: ["Generell gjelder hele kroppen, spesifikk gjelder bestemte ledd viktige for en idrett", "Spesifikk bevegelighet gjelder alltid hele kroppen", "De er egentlig det samme og skiller seg ikke fra hverandre i praksis eller nytte for idretten", "Spesifikk bevegelighet gjelder alltid hele kroppen, mens generell gjelder bare ett bestemt ledd"],
    explanation: 'Idretter krever ofte god bevegelighet i bestemte, relevante ledd.',
  },
],
  'trening-1-6-2': [
  {
  ...
  {
    question: 'Hva er PNF-tøyning?',
    options: ["En metode som veksler mellom muskelkontraksjon og avspenning for økt bevegelighet", "En metode som veksler mellom harde og rolige perioder for å bedre utholdenheten", "En metode der man tester maksimal oksygenopptak gjennom gradvis økende arbeid", "En metode der man holder muskelen strukket helt i ro i minst tretti sekunder"],
    explanation: 'PNF kan gi god effekt på bevegelighet gjennom kontraksjon-avspenning.',
  },
  {
  ...
  {
    question: 'Når egner langvarig statisk tøyning seg ofte best?',
    options: ["Etter trening eller i egne bevegelighetsøkter", "Rett før eksplosive prestasjoner", "Under selve konkurransen for å holde musklene varme og reaksjonsklare", "I stedet for oppvarming"],
    explanation: 'Statisk tøying brukes ofte etter økta eller for å utvikle bevegelighet.',
  },
],
  'trening-1-6-3': [
  {
  ...
  },
  {
    ...
    options: ["Å gradvis senke pulsen og hjelpe kroppen tilbake mot hvile", "Å hoppe rett fra hardt arbeid til ro", "Å gå rett fra hardt arbeid til fullstendig ro uten nedtrapping", "Å øke intensiteten kraftig helt på slutten for å tømme energilagrene"],
    explanation: 'Rolig nedtrapping gir en jevn overgang etter belastning.',
  },
  {
    question: 'Hvorfor bør oppvarmingen være spesifikk?',
    options: ["For å forberede de musklene og bevegelsene som skal brukes", "For å spare tid ved å hoppe over bevegelser", "For å aktivere helt andre muskler enn de som skal brukes i økta", "For å spare tid ved å hoppe over de bevegelsene som skal brukes"],
  ...
  'trening-1-6-4': [
  {
    question: 'Hva er mobilitet?',
    options: ["Evnen til å bevege et ledd aktivt og kontrollert gjennom bevegelsesbanen", "Evnen til passiv bevegelighet i et ledd helt uten aktiv muskelkontroll", "Musklenes evne til å utvikle maksimal kraft gjennom hele bevegelsesbanen", "Kroppens evne til å ta opp og utnytte oksygen under langvarig arbeid"],
    explanation: 'Mobilitet kombinerer bevegelighet med kontroll og styrke i bevegelsen.',
  },
  {
  ...
  },
  {
    ...
    options: ["Bevegelighet er bevegelsesutslaget, mobilitet inkluderer aktiv kontroll i bevegelsen", "Mobilitet er bare passiv tøying, mens bevegelighet krever aktiv kontroll", "Bevegelighet krever alltid maksimal styrke, mens mobilitet ikke gjør det", "De to begrepene betyr det samme og kan brukes helt om hverandre"],
    explanation: 'Mobilitet handler om å kunne bruke bevegelsesutslaget aktivt.',
  },
  {
    question: 'Hvorfor er mobilitetstrening nyttig?',
    options: ["Den bedrer kontroll og bevegelsesutslag som kan gi bedre teknikk", "Den senker alltid prestasjonen", "Den er bare relevant i turn og andre reine bevegelighetsidretter", "Den har ingen verdi for verken teknikk, bevegelighet eller prestasjon"],
    explanation: 'God mobilitet støtter sunne bevegelsesmønstre i trening og dagligliv.',
  },
  {
    question: 'Hva kan inngå i mobilitetstrening?',
    options: ["Kontrollerte bevegelser gjennom full bevegelsesbane og aktivering", "Bare rolig langkjøring som trener utholdenhet uten leddbevegelse", "Bare maksimal styrketrening med tunge løft i korte bevegelsesbaner", "Bare passiv hvile der leddene holdes i ro uten aktiv bevegelse"],
    explanation: 'Mobilitetsøvelser kombinerer bevegelse, kontroll og ofte styrke i ytterstillinger.',
  },
],
  'trening-1-6-5': [
  {
    question: 'Hva er en akutt skade?',
    options: ["En skade som oppstår plutselig, for eksempel en forstuing", "En skade som utvikles over måneder", "En skade som utvikles langsomt over uker og måneder ved gjentatt bruk", "En form for kontrollert oppvarming som gjør vevet klart til belastning"],
    explanation: 'Akutte skader skjer momentant, ulikt belastningsskader.',
  },
  {
    question: 'Hva er en belastningsskade (overbruksskade)?',
    options: ["En skade som utvikles gradvis ved gjentatt overbelastning", "En skade som alltid oppstår plutselig", "En skade som oppstår plutselig ved ett enkelt fall eller feiltramp", "En skade som skyldes for mye hvile og for lite belastning på vevet"],
    explanation: 'Belastningsskader skyldes ofte for rask eller for stor progresjon.',
  },
  {
    question: 'Hva står PRICE for?',
    options: ["Protection, Rest, Ice, Compression, Elevation", "Protect, Rotate, Ice, Compress, Exercise", "Protect, Rotate, Ice, Compress, Exercise som brukes ved rehab", "Press, Rest, Increase, Cool, Eat"],
    explanation: 'PRICE er førstehjelp ved akutt skade for å begrense hevelse.',
  },
  {
    question: 'Hvordan kan belastningsskader forebygges?',
    options: ["Gradvis progresjon, variasjon, god teknikk og nok restitusjon", "Å aldri hvile slik at kroppen hele tiden holdes i god form", "Å øke belastningen brått for å venne vevet raskt til høy last", "Å hoppe over oppvarming for å spare energi til selve hovedøkta"],
    explanation: 'Fornuftig belastningsstyring er nøkkelen til å unngå overbruksskader.',
  },
  {
    question: 'Hvorfor er det viktig å lytte til kroppens varselsignaler?',
    options: ["Smerter kan være tidlige tegn på begynnende belastningsskade", "Smerter betyr alltid at man bør trene hardere", "Man bør alltid ignorere smerte og fullføre økta som planlagt uansett", "Smerter betyr alltid at man bør trene enda hardere for å bli sterkere"],
    explanation: 'Å justere belastningen tidlig kan hindre at en skade utvikler seg.',
  },
],
  'trening-1-7-1': [
  {
  ...
  },
  {
    ...
    explanation: 'Fett er mest energirikt med ca. 9 kcal/g; karbohydrat og protein ca. 4 kcal/g.',
  },
  {
  ...
  },
  {
    ...
    explanation: 'Karbohydrat gir ca. 4 kcal per gram, det samme som protein.',
  },
],
  'trening-1-7-2': [
  {
    question: 'Hva er basalstoffskiftet (BMR)?',
    options: ["Energien kroppen bruker i fullstendig hvile for livsnødvendige funksjoner", "Energien kroppen bruker under hard trening med høy puls og intensitet", "Mengden energi som finnes i et måltid før det brytes ned i kroppen", "Den høyeste pulsen kroppen kan oppnå under maksimalt hardt arbeid"],
    explanation: 'BMR utgjør vanligvis 60-75 % av det totale daglige energiforbruket.',
  },
  {
    question: 'Hva er energibalanse?',
    options: ["Forholdet mellom energiinntak og energiforbruk", "Mengden vann i kroppen", "Antall treningsøkter man gjennomfører i løpet av en normal uke", "Mengden vann og væske som til enhver tid finnes lagret i kroppen"],
    explanation: 'Når inntak er lik forbruk, holder kroppsvekten seg stabil.',
  },
  {
    question: 'Hva skjer ved vedvarende kalorisk overskudd?',
    options: ["Man legger på seg fordi inntaket overstiger forbruket", "Man går alltid ned i vekt", "Vekten endres aldri fordi kroppen tilpasser forbruket til inntaket", "Man mister muskelmasse fordi overskuddet brytes ned til energi igjen"],
    explanation: 'Mer energi inn enn ut lagres og gir vektøkning over tid.',
  },
  {
  ...
  {
    question: 'Hva er hensikten med karbohydratlading?',
    options: ["Å fylle opp glykogenlagrene før langvarig utholdenhetsaktivitet", "Å unngå all karbohydrat", "Å gå raskt ned i vekt før konkurranse ved å tømme kroppen for væske", "Å unngå all karbohydrat slik at kroppen tvinges til å forbrenne fett"],
    explanation: 'Fulle glykogenlagre gir energi til lange konkurranser som maraton.',
  },
  {
    question: 'Hvorfor er karbohydrater viktige ved hard trening?',
    options: ["De fyller glykogenlagrene som gir energi ved høy intensitet", "De brukes bare som fett", "De gir ingen energi og fungerer kun som byggesteiner for muskelvev", "De brukes bare til å lagres som fett og bidrar ikke under selve arbeidet"],
    explanation: 'Glykogen er en nøkkelenergikilde under intensivt arbeid.',
  },
  {
  ...
  {
    question: 'Hva skjer mye av under dyp søvn som er viktig for restitusjon?',
    options: ["Frigjøring av veksthormon og reparasjon av vev", "Nedbryting av muskler", "Rask nedbryting av muskelvev fordi kroppen står helt uten næring", "Kraftig økt skaderisiko fordi vevet ikke får hvile gjennom natten"],
    explanation: 'Under dyp søvn frigjøres veksthormon og kroppen reparerer seg.',
  },
  {
  ...
  'trening-1-7-5': [
  {
    ...
    options: ["Et konsentrert tilskudd av næringsstoffer i tillegg til vanlig kost", "En vanlig hovedrett", "En rolig oppvarming før økta som gjør at kroppen tar opp mer næring", "En treningsøvelse man gjør for å ta opp mer næringsstoffer fra maten"],
    explanation: 'Kosttilskudd skal supplere, ikke erstatte, et variert kosthold.',
  },
  {
    question: 'Hva er doping?',
    options: ["Bruk av forbudte prestasjonsfremmende stoffer eller metoder", "Vanlig sunt kosthold", "Bruk av lovlige kosttilskudd som er godkjent og trygge for utøvere", "Et vanlig sunt og variert kosthold tilpasset utøverens treningsmengde"],
    explanation: 'Doping er forbudt, helseskadelig og i strid med fair play.',
  },
  {
    question: 'Hvorfor kan kosttilskudd være en risiko for utøvere som dopingtestes?',
    options: ["Noen tilskudd kan inneholde forbudte stoffer som ikke står på innholdslisten", "Kosttilskudd kan aldri forurenses fordi de er strengt kvalitetskontrollert", "Alle typer kosttilskudd er per definisjon forbudt for konkurranseutøvere", "Kosttilskudd testes alltid rene før salg, så de kan trygt brukes av alle"],
  ...
  },
  {
    ...
    options: ["Den lengste planleggingsenheten, ofte en hel sesong eller et år", "En enkelt treningsøkt", "En sammensatt øvelse som utgjør kjernen i en enkelt treningsøkt", "En vanlig treningsuke som binder sammen flere dager med ulikt fokus"],
    explanation: 'Makrosyklusen rammer inn hele planen, delt opp i meso- og mikrosykluser.',
  },
  {
  ...
  {
    question: 'I hvilken rekkefølge går enhetene fra størst til minst?',
    options: ['Makrosyklus, mesosyklus, mikrosyklus', 'Mikrosyklus, mesosyklus, makrosyklus', 'Mesosyklus, makrosyklus, mikrosyklus', 'De er like store'],
    explanation: 'Makro (størst) deles i meso, som deles i mikro (minst).',
  },
],
  'trening-1-8-2': [
  {
  ...
  {
    question: 'Hvorfor er progresjon viktig i et treningsprogram?',
    options: ["Uten gradvis økt belastning stopper framgangen opp", "Belastningen bør være konstant for alltid", "Fordi progresjon over tid hindrer framgang og fører til stagnasjon", "Fordi økende belastning kun gir større skaderisiko uten noen gevinst"],
    explanation: 'Progressiv belastning er nødvendig for fortsatt tilpasning.',
  },
],
  'trening-1-8-3': [
  {
    question: 'Hva betyr validitet ved en test?',
    options: ["At testen faktisk måler det den skal måle", "At testen gir samme resultat hver gang", "At testen er billig og enkel å sette opp for de fleste utøvere", "At testen er billig"],
  ...
  {
    question: 'Hvorfor er det viktig å standardisere testforholdene?',
    options: ["For at resultatene skal være pålitelige og sammenlignbare over tid", "For at man skal kunne hoppe over oppvarmingen og spare litt tid", "Fordi standardisering av forholdene i praksis ikke har noen betydning", "For å gjøre gjennomføringen mer tilfeldig fra gang til gang for utøveren"],
  ...
  {
    question: 'Hva er en svakhet ved en test som er valid, men lite reliabel?',
    options: ["Den måler riktig egenskap, men resultatene varierer for mye til å stoles på", "Den er alltid fullstendig ubrukelig og bør aldri tas i bruk i det hele", "Den måler feil egenskap og fanger derfor ikke opp det man vil vite", "Den er helt perfekt og gir alltid presise, brukbare resultater"],
    explanation: 'For å være nyttig må en test både måle riktig og gi stabile resultater.',
  },
],
  'trening-1-8-4': [
  {
    question: 'Hva må til for å gå ned i fettmasse over tid?',
    options: ["Et kalorisk underskudd der forbruket overstiger inntaket", "Et kalorisk overskudd", "Bare mer søvn og hvile, uavhengig av hva man spiser og forbruker", "Full energibalanse der inntak og forbruk holdes helt likt over tid"],
    explanation: 'Vekttap krever at man forbruker mer energi enn man tar inn.',
  },
  {
  ...
  {
    question: 'Hvordan henger spesifisitetsprinsippet sammen med ulike treningsmål?',
    options: ["Treningen må tilpasses det spesifikke målet man ønsker å oppnå", "All trening gir samme resultat uansett mål", "Målet man setter seg har ingen betydning for hvordan man bør trene", "All trening gir det samme resultatet uansett hvilket mål man har satt"],
    explanation: 'Vil du bli sterkere, må du trene styrke; vil du bli mer utholdende, må du trene utholdenhet.',
  },
  {
  ...
  {
    question: 'Hva er viktig hvis man både vil bygge muskel og gå ned i fett?',
    options: ["Tilstrekkelig protein og styrketrening, ofte med et moderat kalorisk underskudd", "Å droppe all styrketrening og heller satse på et stort kalorisk underskudd", "Å kutte ut all mat slik at kroppen tvinges til å forbrenne fett raskt", "Å bare trene lange utholdenhetsøkter og droppe protein i kostholdet"],
    explanation: 'Protein og styrketrening hjelper å bevare muskel i et underskudd.',
  },
],
  'trening-1-8-5': [
  {
    question: 'Hva er treningsveiledning?',
    options: ["Å rettlede og støtte andre i planlegging og gjennomføring av trening", "Å trene helt alene uten plan, mål eller tilbakemelding underveis", "En egen idrettsgren der man konkurrerer i planlegging av trening", "Et konsentrert kosttilskudd man tar for å prestere bedre i økta"],
    explanation: 'God veiledning tilpasser råd til den enkeltes mål og forutsetninger.',
  },
  {
  ...
  },
  {
    ...
    options: ["Å trene for å vinne en premie eller få ros", "Å trene for mestringsfølelsen", "Å trene fordi selve aktiviteten oppleves som gøy og engasjerende i seg selv", "Å trene av indre interesse"],
  ...
  {
    question: 'Hvorfor er god kommunikasjon viktig i treningsveiledning?',
    options: ["Den gjør at råd forstås og følges, og bygger tillit", "Den erstatter selve treningen", "Den kan i praksis erstatte selve treningen dersom rådene formidles tydelig nok", "Den skaper bare forvirring"],
    explanation: 'Tydelig og tilpasset kommunikasjon er sentral i god veiledning.',
  },
],

};

export default quizData_trening_1;
