...
const quizData_econ1310: Record<string, QuizQuestion[]> = {
  'econ1310-0-1': [
    ...
    },
    {
      ...
      options: ["Keynes-modellen/multiplikator og Phillips-kurven", "Finanspolitikk og nasjonalregnskapets bruttostørrelser", "Valutakurs og arbeidsmarked", "Likviditetsfelle og Ricardiansk ekvivalens"],
    ...
    },
    {
      ...
      options: ["De har 0 forekomster på 22 sett og er bevisst utelatt fra eksamenskjernen", "De er de tre mest testede modellene", "De inngår alltid i den store modelloppgaven som tilbudssidens sentrale vekstmodeller", "De testes bare i den verbale drøftingsdelen"],
    ...
    },
    {
      ...
      options: ["Den skrives uten matematikk, med økonomisk resonnement i ord", "Den skal underbygges med minst tre utledede ligninger", "Den skal alltid ende i en tallfestet multiplikator", "Den skal bruke IS-LM-diagrammet for å vise likevekten i pengemarkedet"],
    ...
    },
    {
      ...
      options: ["E — komparativ statikk («vis matematisk»)", "C — telleregel", "B — BNP-klassifisering", "A — kortsvar/begrepsavklaring med presise definisjoner"],
    ...
    },
    {
      ...
      options: ["Fortegnsubestemthet, dekomponering, kobling på tvers og liten-åpen-økonomi-perspektiv", "Bare at flere regnesteg er tatt med", "At svaret er levert med farger, pene diagrammer og en fullstendig matematisk utledning av hvert steg", "At alle oppgaver er besvart, uansett kvalitet"],
    ...
    },
    {
      ...
      options: ["Et etterspørselssjokk gjennom tilvekstform → følgestørrelser → diagram, ev. et kostnadssjokk til slutt", "En ren utledning av Solow-vekstmodellen med konvergens mot steady state og den gylne sparingsregelen for kapital", "En AD-AS-analyse av et tilbudssjokk", "En IS-LM-analyse av pengepolitikk"],
    ...
    },
    {
      ...
      options: ["De må sitte perfekt — det er 100 %-temaene og hjertet i modelloppgaven", "De må bare kunnes på oversiktsnivå", "De er nivå 3-temaer man tar helt til slutt", "De kan hoppes over hvis man behersker drøftingsdelen og den verbale casen"],
  ...
  'econ1310-1-1': [
    {
      ...
      options: ["Hvordan samlet produksjon (BNP) fordeler seg på anvendelser i en åpen økonomi", "Hvordan statens budsjett fordeler seg på utgiftsposter", "Hvordan husholdningenes disponible inntekt fordeler seg på konsum, sparing og skatt", "Hvordan BNP fordeler seg mellom lønn og kapitalavkastning"],
    ...
    },
    {
      ...
      options: ["Produksjonsverdi minus produktinnsats", "Produksjonsverdi pluss samlet produktinnsats", "Produktinnsats minus produksjonsverdi", "Produksjonsverdi minus lønnskostnader"],
    ...
    },
    {
      ...
      options: ["For å unngå å telle den samme verdien flere ganger (dobbelttelling)", "Fordi produktinnsats ikke regnes som reell verdiskaping i noen næring", "Fordi produktinnsats regnes som import", "For å justere for prisstigning"],
    ...
    },
    {
      ...
      options: ["Verdien av all produksjon innenfor landets grenser i løpet av et år", "Inntekten som tilfaller landets innbyggere uansett hvor den er opptjent", "Bare produksjonen i markedsrettede næringer", "Verdien av landets samlede formue"],
    ...
    },
    {
      ...
      options: ["Produksjonssiden, inntektssiden og anvendelsessiden", "Tilbudssiden, etterspørselssiden og pengemarkedssiden", "Privat sektor, offentlig sektor og utlandet", "Konsum, sparing og investering"],
    ...
    },
    {
      ...
      options: ["BNI = BNP + netto formuesinntekter og lønn fra utlandet", "BNI = BNP − offentlige kjøp", "BNI = BNP + import − eksport − netto lønn betalt til utlandet", "BNI = BNP − produktinnsats"],
    ...
    },
    {
      ...
      options: ["BNP måler produksjon innenfor grensene; BNI måler inntekt til innbyggerne", "BNP inkluderer offentlig sektor, mens BNI bare teller den private verdiskapingen", "BNP er før skatt; BNI er etter skatt", "BNP gjelder étt år; BNI gjelder flere år"],
    ...
    },
    {
      ...
      options: ["BNI korrigert for netto løpende overføringer til og fra utlandet", "BNP minus skatt", "Husholdningenes inntekt etter skatt", "BNP pluss statens budsjettoverskudd og netto overføringer fra utlandet"],
    ...
    },
    {
      ...
      options: ["Til faktorinnsatsen (kostnadene ved å produsere tjenesten)", "Til markedsprisen for tilsvarende private tjenester i samme bransje", "Den holdes utenfor BNP fordi den er gratis", "Til det brukerne ville vært villige til å betale"],
    ...
    },
    {
      ...
      options: ["Fordi de er reell produksjon og en del av landets verdiskaping", "Fordi staten betaler moms på dem", "Fordi de finansieres over skatteseddelen", "De inngår ikke – kun markedsrettet produksjon med markedspris teller"],
    ...
    },
    {
      ...
      options: ["Verdien settes lik kostnadene (lønn, produktinnsats, kapitalslit)", "Verdien settes lik det tilsvarende private skoler tar i skolepenger", "Skolen får ingen verdi siden tjenesten er gratis", "Verdien settes lik statens overføringer til kommunen"],
    ...
    },
    {
      ...
      options: ["Produksjonen ved langsiktig opprettholdbar utnyttelse av arbeidskraft og kapital", "Det høyeste BNP økonomien noen gang kan nå ved full utnyttelse av alle ressurser i økonomien", "Gjennomsnittlig BNP de siste ti årene", "BNP i det året med lavest arbeidsledighet"],
    ...
    },
    {
      ...
      options: ["Forskjellen mellom faktisk BNP og potensielt BNP", "Forskjellen mellom BNP og BNI", "Forskjellen mellom eksport og import", "Forskjellen mellom samlet sparing og samlet realinvestering"],
    ...
    },
    {
      ...
      options: ["Den øker beholdningen av realkapital, som bygninger og maskiner", "Den er kjøp av aksjer og obligasjoner", "Den flytter bare kjøpekraft mellom aktører uten å skape ny realkapital", "Den er innskudd i banken"],
    ...
    },
    {
      ...
      options: ["Kjøp av finansielle fordringer som aksjer, obligasjoner eller bankinnskudd", "Kjøp av maskiner og bygninger", "Bygging av ny infrastruktur", "Offentlig kjøp av varer og tjenester som inngår i det offentlige konsumet (G)"],
    ...
    },
    {
      ...
      options: ["Nei, den skaper ingen ny produksjon eller realkapital", "Ja, den regnes som en del av bruttoinvesteringene $I$ i BNP", "Ja, den regnes som konsum $C$", "Ja, den regnes som offentlige kjøp $G$"],
    ...
    },
    {
      ...
      options: ["Samlet sparing er lik samlet realinvestering: $S = I$", "Samlet sparing er null fordi alt konsumeres innenlands", "Samlet realinvestering er null", "Eksport er lik import"],
    ...
    },
    {
      ...
      options: ["Fordi importerte varer inngår i $C$, $I$ og $G$ uten å være innenlandsk produksjon", "Fordi import alltid er større enn eksport", "Fordi import er en finansinvestering", "Fordi importerte varer ikke skaper inntekt eller innenlandsk verdiskaping i det hele tatt"],
    ...
    },
    {
      ...
      options: ["Overføringer som pensjoner og stønader", "Kommunens kjøp av skoletjenester og læremidler", "Statens kjøp av forsvarsmateriell", "Offentlig investering i veier"],
    ...
    },
    {
      ...
      options: ["Å skrive utflytende og for langt – 2–3 presise setninger holder", "Å bruke for få formler i definisjonen", "Å ta med for mange talleksempler", "Å blande sammen BNP og BNI i selve definisjonen av nasjonalregnskapet"],
  ...
  'econ1310-1-2': [
    {
      ...
      options: ["0 kr — leiligheten ble produsert i en tidligere periode", "4 000 000 kr som realinvestering fordi boligen skifter eier", "4 000 000 kr som konsum", "2 000 000 kr, halvparten av verdien"],
    ...
    },
    {
      ...
      options: ["80 000 kr som konsum — en produsert tjeneste", "0 kr — det er bare et gebyr", "80 000 kr som realinvestering", "4 080 000 kr, både boligverdien og meglerhonoraret"],
    ...
    },
    {
      ...
      options: ["Realinvestering (I): 5 000 000 kr", "Konsum (C): 5 000 000 kr", "Inngår ikke — det er et rent boligsalg", "Offentlig kjøp (G): 5 000 000 kr"],
    ...
    },
    {
      ...
      options: ["0 kr — det er en formuesomplassering", "300 000 kr som realinvestering i selskapet", "300 000 kr som konsum", "300 000 kr som import"],
    ...
    },
    {
      ...
      options: ["Den inngår som konsum — en produsert meglertjeneste", "Den inngår ikke, på lik linje med resten av aksjehandelen", "Den inngår som realinvestering", "Den trekkes fra som import"],
    ...
    },
    {
      ...
      options: ["Som import (Q) — en egen post som trekkes fra", "Som negativt konsum, altså minus 1 800 kr i posten C", "Som eksport (X)", "Det inngår ikke i noen post"],
    ...
    },
    {
      ...
      options: ["10 000 000 kr — full verdi som eksport", "0 kr, fordi kjøperen er utenlandsk", "5 000 000 kr, altså halvparten av verdien", "10 000 000 kr som import"],
    ...
    },
    {
      ...
      options: ["Forhandleravansen på 25 000 kr som konsum", "Hele salgsverdien på 175 000 kr", "0 kr — alt er bruktsalg", "150 000 kr, altså forhandlerens innkjøpspris"],
    ...
    },
    {
      ...
      options: ["0 kr — bruktsalg uten produsert tjeneste", "300 000 kr som realinvestering i maskiner", "300 000 kr som konsum", "150 000 kr som avanse"],
    ...
    },
    {
      ...
      options: ["0 kr — ubetalt egenproduksjon teller ikke", "15 000 kr som konsum", "15 000 kr som offentlig konsum", "15 000 kr, den beregnede verdien av arbeidet"],
    ...
    },
    {
      ...
      options: ["Fordi C, I, G og X inneholder varer produsert i utlandet", "Fordi import reduserer husholdningenes samlede konsum og sparing", "Fordi import er en form for sparing", "Fordi importvarer er dyrere enn innenlandske"],
    ...
    },
    {
      ...
      options: ["Avansen — differansen mellom salgs- og innkjøpspris", "Hele salgsverdien", "Hele innkjøpsprisen", "0 kr, siden varen er brukt og allerede talt med tidligere"],
    ...
    },
    {
      ...
      options: ["250 kr (gebyret) som konsum; obligasjonssalget teller ikke", "500 000 kr som formuesomplassering", "500 250 kr, hele beløpet", "0 kr, både obligasjonssalget og gebyret faller helt utenfor BNP"],
    ...
    },
    {
      ...
      options: ["Kategori, beløp og en kort begrunnelse", "Bare et ja eller nei på om det inngår i BNP", "Bare riktig kategori", "Bare riktig beløp"],
    ...
    },
    {
      ...
      options: ["6 060 000 kr — nybygg pluss meglerhonorar", "10 000 000 kr — begge boligverdiene til sammen", "6 000 000 kr — bare nybygget", "10 060 000 kr — alt til sammen"],
    ...
    },
    {
      ...
      options: ["Å glemme at honoraret/avansen inngår selv når objektet ikke gjør det", "Å ta med for mange transaksjoner", "Å regne eksport til full verdi", "Å føre offentlige ikke-markedsrettede tjenester som privat konsum (C)"],
  ...
  'econ1310-1-3': [
    ...
    },
    {
      ...
      options: ["At priser og verdier uttrykkes i en felles enhet, så verdier kan sammenlignes", "At penger aksepteres som endelig oppgjør ved ethvert kjøp og salg i hele økonomien", "At penger kan spares og brukes senere", "At penger gir eierandel i selskaper"],
    ...
    },
    {
      ...
      options: ["Et omsettelig, rentebærende gjeldsbrev der investoren er kreditor", "En eierandel i et selskap med fast rett til utbytte og tilbakebetaling", "Et innskudd i sentralbanken", "En sikkerhet långiveren får i en eiendel"],
    ...
    },
    {
      ...
      options: ["En eierandel i et selskap med rett til utbytte og stemmerett", "Et rentebærende gjeldsbrev med fast kupong og tilbakebetaling", "Et lån fra banken til en bedrift", "En obligasjon utstedt av staten"],
    ...
    },
    {
      ...
      options: ["Gjeld gir kreditor med renteplikt uten eierandel; egenkapital gir ny eier uten renteplikt", "Gjeld gir eierandel; egenkapital gir fast rente", "Gjeld skal ikke tilbakebetales med renter; egenkapital skal alltid tilbakebetales med renter", "Gjeld utvanner eierne; egenkapital gir fast renteforpliktelse"],
    ...
    },
    {
      ...
      options: ["Fordi staten har svært høy kredittverdighet og lav sjanse for mislighold", "Fordi den gir eierandel i staten", "Fordi den alltid gir høyest mulig rente", "Fordi den alltid er sikret med pant i statens faste eiendommer og gullbeholdning"],
    ...
    },
    {
      ...
      options: ["Kredittformidling: å kanalisere sparing fra innskytere til låntakere", "Å fastsette styringsrenten og bestemme det pengepolitiske inflasjonsmålet", "Å utstede statsobligasjoner", "Å bestemme inflasjonsmålet"],
    ...
    },
    {
      ...
      options: ["Renten bankene får på innskudd i sentralbanken opp til en kvote", "Den faste renten en obligasjonsutsteder betaler eierne hvert år underveis", "Bankens utlånsrente til publikum", "Forskjellen mellom utlåns- og innskuddsrente"],
    ...
    },
    {
      ...
      options: ["De stiger, fordi bankenes finansiering blir dyrere", "De faller, fordi bankene da får tilført mer reserver og penger", "De påvirkes ikke av styringsrenten", "De faller, fordi kredittrisikoen synker"],
    ...
    },
    {
      ...
      options: ["Den faste renten utstederen betaler til obligasjonseierne", "Sentralbankens styringsrente", "Bankens rentemargin", "Renten aksjonærene får utbetalt på utbyttet hvert regnskapsår"],
    ...
    },
    {
      ...
      options: ["En sikkerhet långiveren får i en eiendel ved mislighold", "Det ekstra rentepåslaget for risiko", "En eierandel i låntakerens selskap", "Renten långiveren betaler til låntakeren for sikkerheten"],
    ...
    },
    {
      ...
      options: ["Påslaget långiveren krever som kompensasjon for risikoen for tap", "Den delen av renten som staten krever inn fra långiveren som skatt", "Sentralbankens styringsrente", "Forskjellen mellom to statsobligasjoner"],
    ...
    },
    {
      ...
      options: ["Fordi manglende sikkerhet gir høyere kredittrisiko og dermed høyere risikopremie", "Fordi forbrukslån alltid er kortere", "Fordi styringsrenten er høyere for forbrukslån", "Fordi boliglån gir banken en full eierandel i boligen helt frem til lånet er nedbetalt"],
    ...
    },
    {
      ...
      options: ["Forskjellen mellom bankens utlånsrente og innskuddsrente", "Forskjellen mellom styringsrenten og den løpende inflasjonen", "Forskjellen mellom kupongrente og styringsrente", "Forskjellen mellom to bankers styringsrenter"],
    ...
    },
    {
      ...
      options: ["At aksjonæren i verste fall kan tape det innskutte beløpet, men ikke mer", "At aksjonæren personlig garanterer for hele selskapets gjeld ved en konkurs", "At aksjonæren har fast krav på rente", "At aksjonæren får dekket kravet sitt før kreditorene"],
    ...
    },
    {
      ...
      options: ["Egenkapital, fordi den ikke gir fast renteforpliktelse", "Gjeld, fordi den gir lavest mulig rente", "Statsobligasjoner, fordi de har lav risiko og sikker avkastning", "Gjeld, fordi eierne da unngår utvanning"],
    ...
    },
    {
      ...
      options: ["Kreditor har krav på rente og tilbakebetaling, men ingen eierrettigheter", "Kreditor har stemmerett og krav på utbytte", "Kreditor får dekket kravet sitt aller sist ved en konkurs, etter aksjonærene", "Kreditor eier en andel av selskapet"],
  ...
  'econ1310-1-4': [
    {
      ...
      options: ["Uten inntektsgivende arbeid, har aktivt søkt siste fire uker, og kan tiltre raskt", "Uten inntektsgivende arbeid og ønsker seg jobb", "Registrert som arbeidssøker hos NAV, mottar dagpenger og har stått uten arbeid i minst fire sammenhengende uker", "Uten fast jobb, men kan ha korttidsengasjementer"],
    ...
    },
    {
      ...
      options: ["Den skyldes at det tar tid å matche arbeidssøkere med ledige stillinger", "Den skyldes at samlet etterspørsel svikter i en lavkonjunktur", "Den skyldes at de lediges kompetanse og bosted ikke passer de ledige jobbene som finnes", "Den forsvinner helt når økonomien er i full sysselsetting"],
    ...
    },
    {
      ...
      options: ["Mismatch mellom de lediges kvalifikasjoner/bosted og jobbenes krav", "Svak samlet etterspørsel i en lavkonjunktur", "At det tar noen uker med søking å bytte fra én jobb til en annen når konjunkturene svinger", "At det offentlige kutter i arbeidsmarkedstiltak"],
    ...
    },
    {
      ...
      options: ["Ledighetsnivået økonomien vender tilbake til når Y = Y^n, bestående av friksjons- og strukturledighet", "Ledigheten som oppstår kun under en dyp lavkonjunktur når samlet etterspørsel svikter og produksjonen faller under sitt normale nivå", "Ledigheten målt av NAV framfor av AKU", "Nivået der arbeidsledigheten er null"],
    ...
    },
    {
      ...
      options: ["AKU fanger opp alle som oppfyller ILO-vilkårene, mens NAV bare teller dem som har registrert seg som arbeidssøkere", "AKU teller bare dem som mottar dagpenger, mens NAV på sin side teller alle uten arbeid uansett om de har søkt aktivt de siste fire ukene", "AKU måler ledighet blant unge, mens NAV måler blant eldre", "Det er ingen reell forskjell; tallene er alltid like"],
    ...
    },
    {
      ...
      options: ["Utenfor arbeidsstyrken", "Arbeidsledig etter ILO-kriteriene", "Sysselsatt", "Undersysselsatt"],
    ...
    },
    {
      ...
      options: ["Arbeidsstyrken som andel av befolkningen i arbeidsdyktig alder", "Arbeidsledige som andel av arbeidsstyrken", "Sysselsatte som andel av hele befolkningen i arbeidsdyktig alder (sysselsettingsraten)", "Arbeidsledige som andel av befolkningen"],
  ...
  'econ1310-1-5': [
    {
      ...
      options: ["Kronen har svekket seg (depresiert)", "Kronen har styrket seg (appresiert)", "Realkursen er nødvendigvis uendret", "Euroen har svekket seg og blitt mindre verdt i kroner"],
    ...
    },
    {
      ...
      options: ["Prisen på utenlandske varer relativt til norske i felles valuta (konkurranseevnen)", "Kun antall kroner per enhet utenlandsk valuta", "Rentedifferansen mot utlandet", "Norges Banks styringsrente justert for forventet inflasjon, altså realrenten i pengemarkedet"],
    ...
    },
    {
      ...
      options: ["Importvarer blir dyrere i kroner, og inflasjonen presses opp (importert inflasjon)", "Importvarer blir billigere i kroner, og inflasjonen presses ned via lavere importpriser (importert deflasjon)", "Importprisene er upåvirket av kursen", "Bare eksportprisene endres, ikke importprisene"],
    ...
    },
    {
      ...
      options: ["Norske varer blir billigere målt i utenlandsk valuta", "Norske varer blir dyrere for utlendinger målt i deres egen valuta", "Importvarer blir billigere", "Rentenivået i Norge faller automatisk"],
    ...
    },
    {
      ...
      options: ["Nominell kurs $E$, utenlandsk prisnivå $P^*$ og norsk prisnivå $P$", "Bare nominell kurs $E$ og styringsrenten", "Norsk og utenlandsk nominell rente samt sentralbankens inflasjonsmål på to prosent", "Eksport $X$, import $Q$ og BNP $Y$"],
    ...
    },
    {
      ...
      options: ["Den svekkes (realkursen faller, real appresiering)", "Den bedres (realkursen stiger)", "Den er upåvirket fordi $E$ er uendret", "Den kan ikke endres uten at Norges Bank endrer styringsrenten"],
    ...
    },
    {
      ...
      options: ["Fri kapitalbevegelse og selvstendig pengepolitikk (dermed flytende kurs)", "Fast valutakurs og selvstendig pengepolitikk med full kontroll på kapitalstrømmene", "Fast kurs og fri kapitalbevegelse", "Kapitalkontroll og fast kurs"],
    ...
    },
    {
      ...
      options: ["Kronen appresierer fordi kapital strømmer inn", "Kronen depresierer fordi kapital strømmer ut av landet", "Kursen påvirkes ikke av renteforskjeller", "Kronen svekkes fordi eksporten faller"],
    ...
    },
    {
      ...
      options: ["Vi handler mye med utlandet og tar verdensrente og verdenspriser som gitt", "Vi har lukket økonomi uten utenrikshandel", "Vi er så store at vi bestemmer verdensrenten og verdensprisene gjennom Norges Bank", "Vi har fast valutakurs mot euro"],
    ...
    },
    {
      ...
      options: ["Kursen påvirker både importert inflasjon og eksportkonkurransen, altså begge sentralbankens hensyn", "Kursen bestemmer skattenivået", "Sentralbanken har som mål å holde kursen fast", "Kursen påvirker kun statsbudsjettet gjennom oljeinntektene og handlingsregelens uttak fra oljefondet, ikke inflasjonen"],
    ...
    },
    {
      ...
      options: ["Norske varer blir relativt billigere — konkurranseevnen bedres", "Norske varer blir relativt dyrere i felles valuta — konkurranseevnen svekkes", "Konkurranseevnen er uendret", "Importen blir automatisk dyrere enn eksporten"],
    ...
    },
    {
      ...
      options: ["Den selvstendige pengepolitikken (renten må forsvare kursen)", "Fri kapitalbevegelse", "Inflasjonsmålet, men landet beholder full renteautonomi og pengepolitisk selvstyre", "Ingenting — alle tre kan kombineres"],
    ...
    },
    {
      ...
      options: ["Varene blir dyrere i kroner fordi importprisene stiger", "Varene blir billigere i kroner", "Kursen har ingen betydning for hva utenlandshandelen koster i kroner", "Varene inngår i norsk eksport"],
    ...
    },
    {
      ...
      options: ["Bytteforholdet (terms of trade)", "Realrenten", "Produksjonsgapet mellom faktisk og potensiell BNP", "Reserverenten"],
    ...
    },
    {
      ...
      options: ["$E$ har steget med om lag 3 % (nominell depresiering)", "$E$ har falt med om lag 3 % (en nominell appresiering av kronen)", "$E$ er uendret", "$E$ har steget med om lag 5 %"],
    ...
    },
    {
      ...
      options: ["Å snu fortegnet på $E$ (blande sterkere krone og høyere $E$)", "Å glemme prisnivåene og bruke bare nominell kurs som konkurranseevne", "Å nevne importkanalen, men glemme eksportkanalen", "Å forveksle bytteforholdet med realvalutakursen"],
    ...
    },
    {
      ...
      options: ["Finanspolitikken, siden renten er bundet til kursforsvaret", "Selvstendige rentekutt", "Devaluering av valutakursen hver gang ledigheten stiger over likevektsnivået", "Ingen — landet kan ikke stabilisere økonomien"],
    ...
    },
    {
      ...
      options: ["Et veid gjennomsnitt av kronens kurs mot handelspartnernes valutaer", "Kursen mot kun amerikanske dollar", "Den kursen som gir realkurs lik 1", "Norges Banks styringsrente omregnet til et veid gjennomsnitt av utenlandsk valuta"],
  ...
  'econ1310-2-1': [
    ...
    },
    {
      ...
      options: ["Modellen er determinert (entydig løsbar)", "Modellen er åpen", "Modellen er ustabil", "Multiplikatoren er lik 1 uansett parameterverdier"],
    ...
    },
    {
      ...
      options: ["Om den inneholder eksport-/importledd ($X$ og $Q$)", "Om renten $i$ er med", "Om skatten er endogen", "Om alle de eksogene $z$-leddene er positive og store nok"],
    ...
    },
    {
      ...
      options: ["Husholdningene sparer en del av hver ekstra krone, så ikke alt lekker tilbake i konsum", "Fordi renten alltid er positiv", "Fordi importlekkasjen alltid må være mindre enn eksportinntektene for at handelsbalansen skal gå opp", "Fordi $G$ er eksogen"],
    ...
    },
    {
      ...
      options: ["Et eksogent konsumskift (konsumsjokk) uavhengig av inntekt og rente", "Den marginale konsumtilbøyeligheten", "En endogen variabel som modellen selv bestemmer sammen med $Y$ og $C$", "Skattesatsen"],
    ...
    },
    {
      ...
      options: ["Substitusjonseffekt, inntektseffekt og gjeldskanalen", "Bare substitusjonseffekten", "Bare importlekkasjen", "Akseleratoren, importlekkasjen og skattelekkasjen samlet"],
    ...
    },
    {
      ...
      options: ["Høyere produksjon krever mer kapasitet og gir lettere finansiering, så investeringene stiger med $Y$", "Høyere rente øker investeringene fordi bedriftene da får bedre tilgang på lån og billigere finansiering av nye prosjekter", "Skatten faller når $Y$ stiger", "Importen øker med inntekten"],
    ...
    },
    {
      ...
      options: ["Det trengs en ekstra ligning for at modellen fortsatt skal være determinert", "Modellen blir automatisk åpen fordi renten kobler den til utenlandske kapitalmarkeder og verdensrenten", "Multiplikatoren blir lik 1", "Skatten blir eksogen"],
    ...
    },
    {
      ...
      options: ["Åpen/lukket avgjøres kun av om det finnes handelsledd ($X$, $Q$)", "Fordi renten alltid er eksogen", "Fordi renten inngår i skattefunksjonen og dermed bestemmer skatteinntektene direkte", "Fordi renten er en endogen variabel"],
    ...
    },
    {
      ...
      options: ["$c_2 = b_2 = 0$, altså ingen renteeffekter", "$c_1 = 1$", "Ingen offentlige kjøp og dermed ingen finanspolitikk i modellen", "Skatten er endogen"],
    ...
    },
    {
      ...
      options: ["$z$-leddene er eksogene skiftledd, ikke endogene", "Ingen feil — de er endogene", "De skulle egentlig telles som ligninger i telleregelen", "De skulle regnes som parametre"],
    ...
    },
    {
      ...
      options: ["Andelen av en inntektsøkning som trekkes inn som skatt", "Den marginale konsumtilbøyeligheten av disponibel inntekt", "Investeringsakseleratoren", "Realrenten"],
    ...
    },
    {
      ...
      options: ["Skatteinngangen endrer seg med konjunkturene uten politiske vedtak og demper svingninger", "Fordi den øker multiplikatoren", "Fordi den gjør modellen åpen ved å koble skatteinntektene til handelen med utlandet og importen", "Fordi den fjerner rentens virkning"],
    ...
    },
    {
      ...
      options: ["Marginal importtilbøyelighet — en lekkasje ut av innenlandsk etterspørsel", "Den marginale konsumtilbøyeligheten, altså hvor mye konsumet øker per krone inntekt", "Eksportandelen", "Skattesatsen"],
    ...
    },
    {
      ...
      options: ["$z^T$ er det eksogene skattenivået; $t$ er den endogene satsen som kobler skatt til inntekt", "De betyr det samme", "$z^T$ er en endogen variabel som modellen bestemmer, mens $t$ er den eksogene inntekten utenfra", "$z^T$ er renten; $t$ er tiden"],
    ...
    },
    {
      ...
      options: ["Modellen er for en åpen økonomi", "Modellen er lukket", "Modellen er underbestemt og mangler en ligning", "Multiplikatoren er lik 1"],
  ...
  'econ1310-2-2': [
    ...
    },
    {
      ...
      options: ["Offentlige kjøp øker etterspørselen krone for krone; produksjonen stiger umiddelbart med $\\Delta G$", "Skatten stiger automatisk med inntekten allerede i første runde, slik at disponibel inntekt og konsum faller før produksjonen rekker å øke", "Investeringene faller", "Renten kuttes"],
    ...
    },
    {
      ...
      options: ["Akseleratoren $b_1$", "Skattesatsen $t$", "Sparingen $1-c_1$ per inntektskrone", "Importen $a$"],
    ...
    },
    {
      ...
      options: ["Skatten virker bare indirekte via konsumet, og bare andelen $c_1<1$ av en skattekrone slår ut i konsum", "Fordi skatt alltid er negativ", "Fordi renten holdes fast", "Fordi modellen er lukket og uten importlekkasje, slik at hele skatteøkningen blir værende i det innenlandske kretsløpet i stedet for å påvirke etterspørselen"],
    ...
    },
    {
      ...
      options: ["BNP faller ($\\Delta Y = m\\,\\Delta z^C < 0$)", "BNP stiger", "BNP er uendret", "Fortegnet kan ikke bestemmes uten tallverdier for parametrene"],
      explanation: "$m>0$ og $\\Delta z^C<0$ gir $\\Delta Y<0$.",
    },
    {
      question: "En skatteøkning, $\\Delta z^T > 0$. Hva skjer med BNP?",
      options: ["BNP faller, fordi telleren er $-c_1\\Delta z^T < 0$", "BNP stiger, fordi høyere skatt gir mer offentlig etterspørsel", "BNP er uendret", "BNP dobles"],
    ...
    },
    {
      ...
      options: ["Fortegnet på $\\Delta Y$, via stabilitetsvilkåret", "Den nøyaktige tallverdien på multiplikatoren $m$ og på $\\Delta Y$", "Om $m$ er over eller under 2", "Ingenting"],
    ...
    },
    {
      ...
      options: ["Den blir større — mindre skattelekkasje per runde", "Den blir mindre — staten mister inntekter", "Den er uendret — $t$ inngår ikke i $m$", "Den blir negativ — lavere skattesats snur fortegnet på multiplikatoren"],
    ...
    },
    {
      ...
      options: ["Den blir større", "Den blir mindre fordi investeringene lekker ut", "Den er uendret", "Den blir 1"],
    ...
    },
    {
      ...
      options: ["Konstantene endrer seg ikke, så bare endringene i de eksogene størrelsene gjenstår", "Fordi de er negative", "Fordi de inngår i renteleddet og derfor allerede er trukket fra når vi går over til realrenten $i-\\pi^e$", "Fordi $c_1<1$"],
    ...
    },
    {
      ...
      options: ["Økte offentlige kjøp (virker direkte krone for krone)", "Skatteletten", "De er alltid like", "Det kommer an på hvor mye Norges Bank endrer renten samtidig"],
    ...
    },
    {
      ...
      options: ["Sette atferdsligningene for $C$, $I$ og $T$ inn i $Y = C+I+G$", "Regne ut renten", "Finne likevektsledigheten og deretter beregne produksjonsgapet i modellen", "Tegne IS-RR-PK-diagrammet"],
    ...
    },
    {
      ...
      options: ["Sensor krever at mekanismen forklares i to lag (direkte effekt + runder med demper/forsterker)", "Fordi algebra alltid er feil", "Fordi renten mangler", "Fordi skatten er endogen og mekanismen derfor bare kan uttrykkes korrekt i nivåform, ikke på tilvekstform med $\\Delta$"],
    ...
    },
    {
      ...
      options: ["$\\Delta z^C$, $\\Delta z^I$ og $\\Delta G$", "Bare $\\Delta z^T$", "Bare $\\Delta G$", "Bare renteendringer fra Norges Bank og skattesjokk"],
    ...
    },
    {
      ...
      options: ["$c_1(1-t)$ per krone", "$c_1$ per krone før skatt", "$t$ per krone", "$b_1$ per krone"],
    ...
    },
    {
      ...
      options: ["$1 - c_1(1-t) - b_1$ (nevneren)", "$c_1(1-t) + b_1$ (tilbakekoblingen)", "$c_1$", "$t$"],
    ...
    },
    {
      ...
      options: ["Nei — telleren $\\Delta z^I - c_1\\Delta z^T$ er positivt minus positivt, altså ubestemt", "Ja, alltid positivt, fordi et investeringssjokk og et skattesjokk begge løfter samlet etterspørsel og trekker BNP oppover uansett størrelse", "Ja, alltid negativt", "Ja, alltid null"],
    ...
    },
    {
      ...
      options: ["Mindre enn hele inntektskronen kommer tilbake som ny etterspørsel, så rundene dør ut", "At renten er null", "At skatten er eksogen", "At multiplikatoren blir negativ fordi tilbakekoblingen overstiger én og hver runde blir mindre enn den forrige med motsatt fortegn"],
    ...
    },
    {
      ...
      options: ["Den økte produksjonen trekker med seg ytterligere investeringer ($b_1$ per krone $Y$), som forsterker multiplikatoren", "Den demper virkningen", "Den gjør sjokket eksogent", "Den øker skatteinngangen automatisk gjennom $tY$-leddet, slik at disponibel inntekt faller og konsumresponsen forsterker sjokket ytterligere i hver runde"],
    ...
    },
    {
      ...
      options: ["Skatten virker via konsumet med faktor $-c_1$, ikke krone for krone", "Fordi utgiftsmultiplikatoren $m$ alltid er negativ når skatten er endogen", "Fordi skatt er eksogen", "Fordi renten er fast"],
    ...
    },
    {
      ...
      options: ["Større enn sjokket, fordi $m>1$", "Nøyaktig lik sjokket, siden multiplikatoren er 1", "Mindre enn sjokket", "Alltid null"],
    ...
    },
    {
      ...
      options: ["Å oppgi bare den direkte effekten uten multiplikatorrundene", "Å bruke tilvekstform i stedet for nivåform", "Å forklare mekanismen i ord i tillegg til å vise algebraen fullt ut", "Å samle alle $Y$-leddene på venstre side"],
    ...
    },
    {
      ...
      options: ["BNP stiger, fordi $-c_1\\Delta z^T > 0$", "BNP faller", "BNP er uendret", "Fortegnet er ubestemt uten tallverdier for parametrene"],
  ...
  'econ1310-2-3': [
    {
      ...
      options: ["Sett multiplikatoruttrykket $\\Delta Y = m\\,\\Delta z$ inn i størrelsens definisjon og signér", "Tegn IS-RR-PK-diagrammet", "Løs modellen for nivået på $Y$", "Deriver størrelsens definisjon med hensyn på renten $i$ og sett multiplikatoren $m = 1/(1-c_1)$ inn i stedet"],
    ...
    },
    {
      ...
      options: ["Utgiftskuttet trekker balansen opp, mens det endogene skattebortfallet ($t\\,\\Delta Y < 0$) trekker den ned", "Fordi renten endres", "Fordi skatten er eksogen", "Fordi et lavere BNP hever den endogene skatteinngangen $t\\,\\Delta Y > 0$ og dermed forbedrer budsjettbalansen entydig"],
    ...
    },
    {
      ...
      options: ["Privat sparing $S^P = Y-T-C$ fra total sparing $S = Y-C-C^G$", "Konsum fra investering", "Rente fra inflasjon", "Disponibel inntekt $Y-T$ fra samlet sparing, som begge alltid er identiske størrelser i lukket økonomi"],
      explanation: "Å blande de to sparebegrepene er et eksplisitt karakterskille.",
    },
    {
      question: "Hva sier spareparadokset?",
      options: ["En økt sparelyst ($\\Delta z^C<0$) kan senke BNP så mye at samlet sparing ikke øker", "At sparing alltid øker BNP", "At skatt øker sparingen", "At en økt sparelyst hever investeringene $z^I$ tilsvarende, slik at samlet sparing alltid stiger i takt"],
    ...
    },
    {
      ...
      options: ["Den stiger ($\\Delta T = t\\,\\Delta Y > 0$)", "Den faller", "Den er uendret", "Den faller, fordi det endogene leddet $t\\,\\Delta Y$ blir negativt når BNP øker"],
    ...
    },
    {
      ...
      options: ["Skatteøkningen senker $Y$, så det indirekte leddet $t\\,\\Delta Y < 0$ demper", "Fordi renten kuttes", "Fordi importen øker", "Fordi den direkte satsøkningen $\\Delta z^T$ automatisk hever konsumet og trekker inntektsgrunnlaget opp"],
    ...
    },
    {
      ...
      options: ["Den delen av en inntektskrone som ikke går til privat konsum (spares eller skattlegges)", "Den marginale konsumtilbøyeligheten", "Multiplikatoren", "Den delen av en inntektskrone som lekker ut til import og offentlig sparing, altså importandelen $a$"],
    ...
    },
    {
      ...
      options: ["Det faller, både direkte (lavere disponibel inntekt) og indirekte (lavere BNP)", "Det stiger", "Det er uendret", "Det stiger, fordi den lavere skatteinngangen $t\\,\\Delta Y$ automatisk løfter husholdningenes disponible inntekt"],
    ...
    },
    {
      ...
      options: ["Å glemme den direkte komponenten $\\Delta z^C$", "Å ta med skattesatsen", "Å bruke multiplikatoren", "Å regne med at hele multiplikatoren $\\frac{1}{1-c_1(1-t)}$ virker direkte på konsumet"],
    ...
    },
    {
      ...
      options: ["$(1 - t\\,m)|\\Delta G|$ — mindre enn selve kuttet", "Nøyaktig $|\\Delta G|$ — hele kuttet spares inn", "$m\\,|\\Delta G|$ — multiplikatoren forsterker innsparingen", "Null — skattebortfallet spiser alltid hele kuttet"],
    ...
    },
    {
      ...
      options: ["Kuttet senker BNP ytterligere og forsterker nedgangen", "Fordi det øker BNP", "Fordi renten kuttes", "Fordi det lavere BNP-nivået hever den endogene skatteinngangen og motvirker konjunkturfallet automatisk"],
    ...
    },
    {
      ...
      options: ["Vise de motstridende leddene og resonnere om hva som er rimelig", "Alltid velge positivt fortegn", "Alltid velge negativt fortegn", "Sette inn standardverdier for parametrene og la multiplikatorens fortegn avgjøre totaleffekten alene"],
    ...
    },
    {
      ...
      options: ["Siden $z^I$ er uendret, kan samlet sparing ikke endres — den må følge investeringene", "At sparing alltid overstiger investeringer", "At renten utligner sparing og investering", "At økt sparelyst automatisk løfter investeringene $z^I$ via en lavere rente, slik at $S = I$ alltid stiger"],
  ...
  'econ1310-2-4': [
    ...
    },
    {
      ...
      options: ["Importlekkasjen $+a$ øker nevneren, så brøken blir mindre", "Importen øker samlet innenlandsk etterspørsel og forsterker hver multiplikatorrunde", "Skattesatsen $t$ blir høyere i åpen økonomi", "Investeringsakseleratoren $b_1$ forsvinner i åpen økonomi"],
    ...
    },
    {
      ...
      options: ["Den trekker inn mer skatt i oppgang og mindre i nedgang uten nye vedtak, og demper svingningene", "Den øker multiplikatoren og forsterker konjunkturene", "Den holder budsjettbalansen konstant til enhver tid", "Den øker den marginale konsumtilbøyeligheten $c_1(1-t)$ i nevneren og gjør dermed hver multiplikatorrunde kraftigere"],
    ...
    },
    {
      ...
      options: ["Den blir større, fordi skattelekkasjen forsvinner fra nevneren", "Den blir mindre, fordi skatten nå er fast", "Den blir uendret, siden skattenivået er det samme", "Den blir mindre, fordi en fast skatt fjerner den automatiske stabilisatoren og gjør nevneren større"],
    ...
    },
    {
      ...
      options: ["Negativt, fordi multiplikatoren er positiv og sjokket negativt", "Positivt, fordi import trekkes fra i likevekten", "Ubestemt uten tallverdier", "Positivt, fordi et eksportfall senker importlekkasjen $a$ og dermed løfter den innenlandske multiplikatoren"],
    ...
    },
    {
      ...
      options: ["Budsjettbalansen blir endogen — underskudd i nedgang", "Multiplikatoren blir større", "Renten må heves", "Multiplikatoren blir større, siden en aktiv G-regel legger leddet $-g$ til i nevneren"],
    ...
    },
    {
      ...
      options: ["Fallende skatteinngang tvinger fram kutt i $G$, som forsterker fallet", "Det tvinger fram økte offentlige kjøp, som forsterker oppgangen", "Det holder BNP helt konstant", "Det tvinger fram en økning i offentlige kjøp $G$ når skatten faller, og motvirker dermed nedgangen aktivt"],
    ...
    },
    {
      ...
      options: ["1 — BNP øker like mye som utgiftsøkningen", "0 — skatt og utgift nulles ut", "$\\frac{1}{1-c_1}$", "0 — den balanserte skatteøkningen nuller ut hele utgiftsvirkningen krone for krone"],
    ...
    },
    {
      ...
      options: ["En lukket modell har ingen import — bare variantens egne mekanismer skal brukes", "Ingen feil; import finnes i alle modeller", "Importlekkasjen skulle vært $+g$, ikke $+a$", "Skattelekkasjen skulle vært omtalt i stedet, siden $t$ og importandelen $a$ er nøyaktig samme lekkasje"],
    ...
    },
    {
      ...
      options: ["Andelen av en ekstra krone i inntekt som brukes på import", "Det totale importnivået i kroner", "Skattesatsen på importvarer", "Det samlede importnivået $Q$ i kroner, altså totalimporten og ikke den marginale importtilbøyeligheten"],
    ...
    },
    {
      ...
      options: ["Balansen forbedres, fordi skatteinngangen stiger med aktiviteten", "Balansen forverres, fordi $G$ må økes", "Balansen er uendret", "Balansen forverres, fordi den økte aktiviteten trekker med seg høyere offentlige kjøp $G$ automatisk"],
    ...
    },
    {
      ...
      options: ["Import er en lekkasje: etterspørsel vris fra innenlandske til utenlandske varer", "Import øker samlet etterspørsel og løfter BNP", "Import øker skatteinngangen direkte", "Import øker samlet etterspørsel $Y = C + I + G + X + Q$ fordi importleddet inngår med positivt fortegn"],
    ...
    },
    {
      ...
      options: ["Den er uendret, fordi verken $T$ eller $G$ reagerer på $Y$", "Den forbedres, fordi skatten stiger", "Den forverres, fordi utgiftene stiger", "Den forbedres, fordi den endogene skatteinngangen $t\\,\\Delta Y$ stiger med det høyere BNP-nivået"],
    ...
    },
    {
      ...
      options: ["Utslaget blir mindre, fordi regelen legger dempingen $+g$ til nevneren", "Utslaget blir større, fordi $G$ nå er aktiv", "Utslaget blir uendret", "Utslaget blir større, fordi den aktive G-regelen legger leddet $-g$ til i nevneren og hever multiplikatoren"],
    ...
    },
    {
      ...
      options: ["Den aktive balanserte økningen er ekspansiv (multiplikator $\\geq 1$); balansekravet som reagerer på fallende skatt er prosyklisk", "De er identiske", "Balansekravet er ekspansivt; den aktive økningen er kontraktiv", "Balansekravet er ekspansivt fordi det tvinger fram økte offentlige kjøp i nedgang, mens den aktive Haavelmo-økningen tvert imot er kontraktiv"],
    ...
    },
    {
      ...
      options: ["Like store, fordi begge virker gjennom samme multiplikator $m_{\\text{åpen}}$", "Eksportsjokket gir større utslag, fordi eksport ikke lekker", "Investeringssjokket gir alltid null utslag", "Eksportsjokket gir større utslag, fordi eksporten ikke rammes av importlekkasjen $+a$ slik investeringene gjør"],
    ...
    },
    {
      ...
      options: ["Åpen økonomi med endogen skatt og motsyklisk G-regel", "Lukket økonomi med eksogen skatt", "Lukket økonomi med endogen skatt", "Lukket økonomi med eksogen skatt, fordi den mangler både importlekkasje og skattelekkasje i nevneren"],
    ...
    },
    {
      ...
      options: ["Skattekutt virker bare indirekte via konsumet ($c_1 < 1$), mens $G$ virker krone for krone", "Skatt lekker ikke til sparing", "G-multiplikatoren har $a$ i telleren", "Fordi G-multiplikatoren har importandelen $a$ i telleren, mens skattemultiplikatoren bare har skattesatsen $t$"],
    ...
    },
    {
      ...
      options: ["En automatisk stabilisator, lik effekten av skattesatsen $t$", "En diskresjonær engangsendring", "Et rent kostnadssjokk", "En diskresjonær finanspolitisk engangsendring som må vedtas politisk i hvert enkelt statsbudsjett"],
    ...
    },
    {
      ...
      options: ["Budsjettbalansen bestemmes av aktivitetsnivået i stedet for å ligge fast", "Budsjettet vedtas av Stortinget hvert år", "Budsjettet er alltid i balanse", "Budsjettet vedtas av Stortinget hvert år og er derfor en eksogen størrelse uavhengig av konjunkturene"],
    ...
    },
    {
      ...
      options: ["Importlekkasjen demper multiplikatoren, så sjokk slår svakere ut i BNP", "Eksporten fjerner alle innenlandske sjokk", "Renten justeres automatisk", "Eksporten nøytraliserer alle innenlandske etterspørselssjokk fullstendig via handelsbalansen $X - Q$"],
    ...
    },
    {
      ...
      options: ["$\\Delta z^C, \\Delta z^I, \\Delta z^G$ og $\\Delta z^X$ — alle autonome etterspørselsskift", "Bare $\\Delta z^C$", "$c_1, b_1$ og $a$", "Parametrene $c_1, b_1, t$ og importandelen $a$, altså alle atferdskoeffisientene som hører til i nevneren"],
  ...
  'econ1310-2-5': [
    {
      ...
      options: ["Klassifisere modellen: tell ligninger og endogene, avgjør åpen/lukket og endogen/eksogen skatt", "Regne ut følgestørrelsene", "Tegne IS-RR-PK-diagrammet", "Sette opp multiplikatoren $\\frac{1}{1-c_1(1-t)}$ og regne ut $\\Delta Y$ før modellvarianten er avklart"],
    ...
    },
    {
      ...
      options: ["Sensor krever mekanismeforklaring i ord — både direkte effekt og multiplikatorrunder", "Algebra teller ikke i makroøkonomi", "Man må alltid oppgi tallverdier", "Fordi selve algebraen ikke teller i makroøkonomi; bare den verbale drøftingen av fortegn gir uttelling"],
    ...
    },
    {
      ...
      options: ["Påberop stabilitetsvilkåret (nevneren $> 0$, så $m > 0$) og les av fortegnet på $\\Delta z$", "Anta alltid at BNP stiger", "Regn ut tallverdien først", "Regn ut den fullstendige tallverdien for multiplikatoren først, siden fortegnet ellers ikke kan avgjøres"],
    ...
    },
    {
      ...
      options: ["Negativ — positiv multiplikator ganger negativt sjokk", "Positiv — investeringer løfter alltid BNP", "Null", "Positiv, fordi et fall i investeringene senker importlekkasjen og dermed løfter BNP netto"],
    ...
    },
    {
      ...
      options: ["Det endogene leddet $t\\Delta Y$: aktiviteten faller, så skattegrunnlaget krymper", "Det direkte leddet $\\Delta z^T$: satsøkningen virker ikke fullt ut", "Ingen av leddene — inngangen følger alltid satsen", "Det direkte leddet $\\Delta z^T$ virker ikke fullt ut, fordi satsøkningen automatisk dempes av konsumveksten"],
    ...
    },
    {
      ...
      options: ["$\\Delta B < 0$ — budsjettet svekkes, fordi $t \\cdot m < 1$", "$\\Delta B > 0$ — den økte aktiviteten gir full skattemessig inndekning av utgiften", "$\\Delta B = 0$ — skatteveksten balanserer utgiften nøyaktig", "$\\Delta B = \\Delta G$ — hele utgiften belaster balansen"],
    ...
    },
    {
      ...
      options: ["Skattefallet ($t\\Delta Y < 0$) forverrer, mens utgiftskuttet ($-\\Delta G > 0$) forbedrer — de trekker hver sin vei", "Fordi budsjettbalansen aldri kan beregnes", "Fordi kutt i $G$ ikke påvirker BNP", "Fordi et kutt i offentlige kjøp $G$ verken påvirker BNP eller den endogene skatteinngangen $t\\,\\Delta Y$, slik at balansen alltid forbedres"],
    ...
    },
    {
      ...
      options: ["Den kan falle, fordi lavere BNP senker inntekten og dermed sparingen ($S = I = z^I + b_1 Y$)", "Den stiger alltid like mye som spareønsket", "Den blir null", "Den stiger alltid nøyaktig like mye som spareønsket, siden investeringene $z^I$ passivt tilpasser seg"],
    ...
    },
    {
      ...
      options: ["Importlekkasjen $+a$ i nevneren gjør den åpne multiplikatoren mindre", "Eksport teller dobbelt i åpen økonomi", "Renten justeres i åpen økonomi", "Fordi eksportinntektene teller dobbelt i en åpen økonomi og dermed forsterker hver multiplikatorrunde"],
    ...
    },
    {
      ...
      options: ["Like store — begge går gjennom samme multiplikator", "$\\Delta z^I$ gir alltid størst utslag", "$\\Delta z^C$ gir alltid størst utslag", "$\\Delta z^I$ gir størst utslag, fordi investeringer utløser en ekstra akseleratorrunde via $b_1$"],
    ...
    },
    {
      ...
      options: ["Eksogen skatt ($t = 0$) — ingen skattelekkasje i rundene", "Endogen skatt ($t > 0$) — sterkest forsterkning", "Begge gir likt utslag", "Endogen skatt ($t > 0$) — den automatiske stabilisatoren forsterker hver multiplikatorrunde kraftig"],
    ...
    },
    {
      ...
      options: ["Sette multiplikatoruttrykket for $\\Delta Y$ inn i definisjonene av $C$, $T$, $B$, $S$ og signere", "Sette inn tallverdier for parametrene", "Sette opp diagrammet på nytt", "Sette de oppgitte tallverdiene for parametrene $c_1, t$ og $b_1$ direkte inn i selve multiplikatorbrøken"],
    ...
    },
    {
      ...
      options: ["G virker krone for krone; skatteletten bare via konsumet ($c_1 < 1$, resten spares)", "Skattelette virker direkte på etterspørselen", "G har en importlekkasje som skattelette ikke har", "Skatteletten virker direkte på samlet etterspørsel, mens $G$ bare øker husholdningenes disponible inntekt"],
    ...
    },
    {
      ...
      options: ["$1 - c_1(1-t) - b_1 + a + g$", "$1 - c_1(1-t) - b_1$", "$1 - c_1(1-t) - b_1 + a$", "$1 - c_1(1-t) - b_1 - a - g$ med lekkasjene trukket fra"],
    ...
    },
    {
      ...
      options: ["Ikke omtal skatte-, import- eller renteeffekter som ikke finnes i den oppgitte modellen", "Bruk alltid alle mekanismer for sikkerhets skyld", "Utelat mekanismeforklaringen helt", "Ta alltid med både skatte-, import- og renteeffekter for sikkerhets skyld, uansett hvilken variant oppgaven gjelder"],
    ...
    },
    {
      ...
      options: ["Når $\\Delta z^I > |\\Delta X|$ — investeringsløftet overgår eksportfallet", "Alltid, siden investeringer stiger", "Aldri, siden eksport faller", "Alltid, siden et positivt investeringssjokk går gjennom en større multiplikator enn eksportsjokket gjør"],
    ...
    },
    {
      ...
      options: ["Privat sparing er $S^P = Y - T - C$; total sparing er $S = Y - C - C^G$", "De er alltid like", "Privat sparing inkluderer offentlig konsum", "Privat sparing inkluderer det offentlige konsumet $C^G$, mens total sparing kun trekker fra skatten $T$"],
    ...
    },
    {
      ...
      options: ["Den bekrefter at likevekten er entydig bestemt — antall ligninger = antall endogene", "Den gir flest poeng av alle deloppgaver", "Den erstatter multiplikatorutledningen", "Den erstatter multiplikatorutledningen fullstendig, fordi determinerthet alene fastsetter fortegnet på $\\Delta Y$"],
    ...
    },
    {
      ...
      options: ["Demper: skattelekkasje $t$ og importlekkasje $a$. Forsterker: investeringsakselerator $b_1$", "Demper: $b_1$. Forsterker: $t$ og $a$", "Alt demper; ingenting forsterker", "Demper: investeringsakseleratoren $b_1$. Forsterker: både skattelekkasjen $t$ og importlekkasjen $a$"],
  ...
  'econ1310-3-1': [
    {
      ...
      options: ["G går direkte inn i etterspørselen, mens skattelette bare virker indirekte via konsum (andel $c_1 < 1$)", "Skattelette går direkte inn i etterspørselen som en full krone, mens G bare virker indirekte via konsumandelen $c_1$", "De gir nøyaktig samme BNP-effekt", "G finansieres av oljefondet og teller derfor dobbelt"],
    ...
    },
    {
      ...
      options: ["80 % av G-multiplikatoren — telleren er $c_1$ i stedet for 1", "Like stor — de har samme teller og nevner", "125 % av G-multiplikatoren — skatt virker sterkere fordi telleren er 1", "20 % av G-multiplikatoren — bare spareandelen teller"],
    ...
    },
    {
      ...
      options: ["Positiv — den balanserte budsjettmultiplikatoren $\\frac{1-c_1}{1 - c_1(1-t) - b_1}$ er større enn null", "Null, fordi G-økningen og den like store skatteøkningen alltid opphever hverandre krone for krone i denne modellen", "Negativ, fordi skatt virker sterkere enn G", "Alltid nøyaktig lik $c_1$"],
    ...
    },
    {
      ...
      options: ["Et trekk ved budsjettet som demper konjunktursvingninger uten nye politiske vedtak", "Et engangsvedtak om økt G i en krise", "En regel om at budsjettet alltid skal balanseres, også midt i en dyp lavkonjunktur med høy ledighet", "Sentralbankens rentesetting"],
    ...
    },
    {
      ...
      options: ["Skattesatsen $t$ i den endogene skatten $T = z^T + tY$", "Den marginale konsumtilbøyeligheten $c_1$ i konsumfunksjonen", "Investeringsakseleratoren $b_1$", "Den eksogene skatten $z^T$"],
    ...
    },
    {
      ...
      options: ["Den blir mindre — skattelekkasjen demper hver multiplikatorrunde", "Den blir større fordi staten får mer skatteinntekter å bruke og pumpe ut i hver runde", "Den er upåvirket av $t$", "Den blir negativ"],
    ...
    },
    {
      ...
      options: ["Automatiske stabilisatorer virker uten vedtak; diskresjonær politikk krever aktive beslutninger", "Automatisk politikk krever vedtak, diskresjonær ikke", "Det er ingen forskjell — begrepene er synonyme", "Automatisk politikk gjelder bare skatt og G, mens diskresjonær politikk bare gjelder styringsrenten"],
    ...
    },
    {
      ...
      options: ["Tiden fra et behov oppstår til tiltaket faktisk vedtas", "Tiden fra vedtaket er fattet til tiltaket faktisk virker i økonomien", "Tiden det tar for skatten å bli betalt inn", "Forsinkelsen i sentralbankens rentebeslutninger"],
    ...
    },
    {
      ...
      options: ["Skatteøkning, fordi skatt virker svakest på etterspørselen per krone", "G-kutt, fordi det fjerner en full krone fra etterspørselen og gir størst innsparing", "Begge gir nøyaktig samme BNP-skade", "Rentekutt fra sentralbanken"],
    ...
    },
    {
      ...
      options: ["Fordi det forsterker nedgangen i stedet for å dempe den", "Fordi det demper nedgangen ekstra effektivt", "Fordi det bare påvirker inflasjonen", "Fordi det øker den automatiske stabiliseringen og motvirker nedgangen"],
    ...
    },
    {
      ...
      options: ["Den delen $(1 - c_1)$ av den økte disponible inntekten som spares i stedet for å konsumeres", "Den delen $(1 - c_1)$ som umiddelbart betales tilbake til staten som endogen skatt $tY$ i hver runde", "Hele skattekuttet", "Investeringene som følger av høyere BNP"],
    ...
    },
    {
      ...
      options: ["Fordi høyere aktivitet trekker med seg mer investering, som løfter etterspørselen ytterligere", "Fordi den demper skattelekkasjen", "Fordi den gjør skattemultiplikatoren negativ og dermed demper hver eneste multiplikatorrunde merkbart", "Fordi den bare påvirker importen"],
    ...
    },
    {
      ...
      options: ["Økt G eller skattelette som løfter samlet etterspørsel", "Kutt i G eller skatteøkning som demper samlet etterspørsel i en høykonjunktur", "At sentralbanken kutter renten", "At budsjettet alltid holdes i balanse"],
    ...
    },
    {
      ...
      options: ["De virker umiddelbart, uten besluttnings- og virkningslag", "De opphever alltid sjokket fullstendig", "De krever hyppige politiske vedtak", "De er alltid sterkere enn aktiv, diskresjonær finanspolitikk i store sjokk"],
    ...
    },
    {
      ...
      options: ["Skatteinngangen $tY$ faller automatisk, slik at disponibel inntekt og konsum faller mindre", "Skatteinngangen $tY$ øker automatisk når $Y$ faller, og forsterker dermed hele nedgangen ytterligere", "Skatten er uendret fordi den er eksogen", "Sentralbanken senker skatten ved vedtak"],
    ...
    },
    {
      ...
      options: ["Nevneren er positiv og mindre enn 1, slik at multiplikatoren er positiv og større enn 1", "Multiplikatoren er negativ fordi nevneren $1 - c_1(1-t) - b_1$ blir mindre enn null i modellen", "Multiplikatoren er nøyaktig lik 1", "Multiplikatoren er udefinert"],
  ...
  'econ1310-3-2': [
    ...
    },
    {
      ...
      options: ["Fordi man kan bruke mindre enn 3 % i oppgang og mer i nedgang, slik at politikken jevner ut konjunkturene", "Fordi nøyaktig 3 % av fondsverdien skal brukes presist hvert eneste år uansett konjunktur og fondsstørrelse", "Fordi fondet bare vokser over tid", "Fordi regelen bare gjaldt fram til 2017"],
    ...
    },
    {
      ...
      options: ["Fondet der statens netto kontantstrøm fra petroleumsvirksomheten plasseres, investert i utlandet", "Statens driftskonto for løpende utgifter", "Et statlig fond som utelukkende investerer statens oljeinntekter i norsk fastlandsindustri og infrastruktur", "Norges Banks valutareserver"],
    ...
    },
    {
      ...
      options: ["For å skjerme fastlandsøkonomien mot for stort press på etterspørsel, kostnader og kronekurs", "Fordi norske investeringer er forbudt ved lov", "Fordi utenlandske investeringer aldri kan tape verdi og alltid gir høyere avkastning enn norske aksjer", "For å slippe å betale skatt"],
    ...
    },
    {
      ...
      options: ["Det faktiske budsjettunderskuddet utenom petroleumsinntektene, som svinger med konjunkturen", "Det konjunkturrensede, strukturelle underskuddet som handlingsregelen styrer bruksbanen etter", "Fondets samlede verdi", "Overskuddet på handelsbalansen"],
    ...
    },
    {
      ...
      options: ["Det oljekorrigerte underskuddet renset for konjunktursvingninger — den underliggende oljepengebruken", "Det faktiske, oljekorrigerte underskuddet i det aktuelle året, medregnet konjunktursvingninger år for år", "Underskuddet inkludert alle oljeinntekter", "Fondets forventede avkastning"],
    ...
    },
    {
      ...
      options: ["For å unngå prosyklisk politikk — det faktiske underskuddet svinger med konjunkturen", "Fordi det strukturelle tallet alltid er større enn det faktiske og gir mer handlingsrom", "Fordi det faktiske underskuddet ikke kan måles", "Fordi EU krever det"],
    ...
    },
    {
      ...
      options: ["Fordi forventet realavkastning i finansmarkedene hadde falt", "Fordi fondet ble mindre etter store tap i finansmarkedene under uroen", "Fordi oljeprisen steg", "Fordi Norge gikk ut av regelen"],
    ...
    },
    {
      ...
      options: ["Fondets realverdi holdes i prinsippet uendret, slik at også framtidige generasjoner får glede av det", "At fondet tømmes over tid", "At hele avkastningen, både real- og nominell, reinvesteres i sin helhet mens bare oljeinntekten brukes", "At bruken øker hvert år uansett"],
    ...
    },
    {
      ...
      options: ["At store oljeinntekter via høyt kostnadsnivå og sterk krone svekker og fortrenger konkurranseutsatt industri", "At et kraftig fall i oljeprisen gir varig budsjettunderskudd og tvinger fram store kutt i offentlige utgifter", "At fondet taper penger i utlandet", "At skattene blir for høye"],
    ...
    },
    {
      ...
      options: ["Den lar det faktiske underskuddet svinge med konjunkturen, slik at skattelekkasjen $t$ får virke fritt", "Den opphever de automatiske stabilisatorene", "Den krever innstramming i budsjettet hver gang skatteinntektene faller i en konjunkturnedgang, altså prosyklisk", "Den erstatter behovet for skatt"],
    ...
    },
    {
      ...
      options: ["Generasjonshensynet — det tærer på fondets realverdi og reduserer hva framtidige generasjoner kan bruke", "At skattene da må settes til null og at hele det offentlige tjenestetilbudet må finansieres av fondet alene", "At fondet må flyttes til Norge", "At renten automatisk faller"],
    ...
    },
    {
      ...
      options: ["Rommet til å øke utgifter eller senke skatter uten å bryte handlingsregelen", "Størrelsen på oljefondet målt som andel av fastlands-BNP i det aktuelle budsjettåret", "Sentralbankens rentemargin", "Forskjellen mellom BNP og BNI"],
    ...
    },
    {
      ...
      options: ["BNP utenom olje- og gassvirksomhet og utenriks sjøfart", "Samlet BNP inkludert olje- og gassvirksomhet og utenriks sjøfart", "Bare offentlig sektors verdiskaping", "Fondets avkastning"],
    ...
    },
    {
      ...
      options: ["Den løfter etterspørsel og kostnadsnivå og styrker kronen, som svekker konkurranseutsatt eksportsektor", "Den senker alltid inflasjonen", "Den har ingen realøkonomiske virkninger fordi pengene uansett investeres og forbrukes i utlandet og ikke i Norge", "Den styrker eksportsektoren"],
  ...
  'econ1310-4-1': [
    ...
    },
    {
      ...
      options: ["Fordi reallønnen bedriftene tillater er uavhengig av ledigheten", "Fordi reallønnen bedriftene tillater stiger jevnt med ledigheten $u$", "Fordi lønnskravene faller med ledigheten", "Fordi påslaget øker med ledigheten"],
    ...
    },
    {
      ...
      options: ["Fordi høyere ledighet svekker arbeidstakernes forhandlingsmakt og dermed lønnskravet", "Fordi høyere ledighet hever produktiviteten", "Fordi bedriftene tar et høyere påslag $\\mu$ og løfter priskurven når ledigheten er høy", "Fordi prisene faller når ledigheten stiger"],
      explanation: "Ledighet disiplinerer lønnskravene: er mange ledige, tør ikke arbeiderne kreve like mye.",
    },
    {
      question: "Hva er likevektsledigheten $u^n$?",
      options: ["Ledigheten der lønns- og priskurven krysser, uten pris- og lønnspress", "Ledigheten når hele arbeidsstyrken er sysselsatt og produksjonsgapet er lukket", "Den høyeste ledigheten økonomien kan tåle", "Ledigheten som følger av et negativt etterspørselssjokk"],
    ...
    },
    {
      ...
      options: ["Den er uendret — priskurven låser den", "Den stiger varig fordi lønnskurven skyves oppover", "Den faller varig", "Den blir null"],
    ...
    },
    {
      ...
      options: ["$z^W$ (lønnspresset)", "$\\mu$ (påslaget i prissettingen)", "$A$ alene", "Produksjonsgapet"],
    ...
    },
    {
      ...
      options: ["økt lønnspress ($z^W \\uparrow$), som hever $u^n$", "lavere påslag, som senker $u^n$", "høyere produktivitet $A$, som hever reallønnen og senker $u^n$", "et positivt etterspørselssjokk"],
    ...
    },
    {
      ...
      options: ["De setter prisen som et påslag $\\mu$ over marginalkostnaden", "De setter prisen lik marginalkostnaden uten noe påslag $\\mu$ i det hele tatt", "De setter prisen lik konkurrentenes", "De setter prisen etter styringsrenten"],
    ...
    },
    {
      ...
      options: ["Monopolistisk konkurranse", "Fullkommen konkurranse uten påslag", "Rent monopol", "Planøkonomi"],
    ...
    },
    {
      ...
      options: ["senke lønnspresset $z^W$, slik at $u^n$ faller", "heve påslaget $\\mu$ og løfte priskurven varig oppover", "heve reallønnen varig", "skifte priskurven ned"],
    ...
    },
    {
      ...
      options: ["Reallønnen låses av priskurven, som ikke flytter seg — bare $u^n$ endres", "Reallønnen faller alltid ved sterkere fagforeninger fordi lønnskurven skyves nedover", "Fagforeninger påvirker ikke lønn i det hele tatt", "Priskurven flytter seg opp, ikke lønnskurven"],
    ...
    },
    {
      ...
      options: ["På priskurvens nivå, i skjæringen med lønnskurven", "Alltid over priskurven", "Alltid under lønnskurven ved $u = 0$", "Der lønnskurven møter den loddrette aksen ved null ledighet"],
    ...
    },
    {
      ...
      options: ["Kjøpekraften i lønna — hvor mye varer lønna rekker til", "Den nominelle kronelønna før prisnivået $P$ er trukket fra", "Skatten på arbeid", "Bedriftenes overskudd"],
    ...
    },
    {
      ...
      options: ["Lønnskravet overstiger priskurvens tak, og pris-/lønnspresset driver ledigheten tilbake mot $u^n$", "Ingenting skjer — økonomien blir liggende på det nye, lavere ledighetsnivået for godt uten noe press", "Reallønnen faller permanent", "$u^n$ synker til det nye nivået"],
    ...
    },
    {
      ...
      options: ["Sterkere konkurranse i produktmarkedene (lavere $\\mu$)", "Mer sjenerøs ledighetstrygd med høy kompensasjonsgrad $z^W$", "Sterkere fagforeninger", "Høyere minstelønn"],
    ...
    },
    {
      ...
      options: ["Fordi den bestemmer $u^n$ og $Y^n$, som avvik måles fra i Phillips-kurven", "Fordi den gir styringsrenten direkte", "Fordi den erstatter Keynes-modellen og multiplikatoren fullstendig på kort sikt", "Fordi den bestemmer valutakursen"],
  ...
  'econ1310-4-2': [
    ...
    },
    {
      ...
      options: ["Marginalkostnad → pris settes som påslag over marginalkostnad", "Lavere ledighet → sterkere forhandlingsmakt → høyere lønnskrav i forhandlingene", "Høyere gap → lavere ledighet", "Høyere lønn → høyere inflasjon direkte"],
    ...
    },
    {
      ...
      options: ["Kostnadssjokk som energi, importpriser og råvarer", "Forventet inflasjon", "Produksjonsgapet", "Sentralbankens styringsrente og pengepolitiske respons"],
    ...
    },
    {
      ...
      options: ["Et positivt produksjonsgap presser inflasjonen opp", "Inflasjonen er alltid positiv", "Ledigheten øker automatisk sammen med inflasjonen langs kurven", "Forventningene er forankret"],
    ...
    },
    {
      ...
      options: ["$\\frac{Y-Y^n}{Y^n}$ — det relative avviket fra potensielt BNP", "$Y - Y^n$ i kroner", "$\\frac{Y^n}{Y}$", "Avviket mellom faktisk og forventet inflasjon $\\pi - \\pi^e$ i prosent"],
    ...
    },
    {
      ...
      options: ["Fordi knapp arbeidskraft styrker arbeidstakernes forhandlingsmakt", "Fordi bedriftene da får et høyere påslag $\\mu$ over marginalkostnaden", "Fordi produktiviteten faller", "Fordi importprisene stiger"],
    ...
    },
    {
      ...
      options: ["Som et positivt kostnadssjokk $z^\\pi$", "Som høyere $\\pi^e$", "Som et positivt produksjonsgap i innenlandsk økonomi", "Som lavere $\\beta$"],
    ...
    },
    {
      ...
      options: ["$z^\\pi$ er en faktisk kostnadsøkning utenfra; $\\pi^e$ er forventet prisvekst innbakt i atferd", "De er to navn på det samme", "$z^\\pi$ er forventninger; $\\pi^e$ er kostnader", "$z^\\pi$ gjelder ledigheten, mens $\\pi^e$ gjelder produksjonsgapet i Phillips-kurven, ikke omvendt"],
    ...
    },
    {
      ...
      options: ["Monopolistisk konkurranse (påslagsprising)", "Fullkommen konkurranse", "Planøkonomi", "Rent monopol uten marginalkostnader i det hele tatt"],
    ...
    },
    {
      ...
      options: ["Flytter økonomien langs kurven til høyere $Y$ og høyere $\\pi$", "Skifter hele Phillips-kurven opp til et høyere inflasjonsnivå permanent", "Skifter kurven ned", "Gjør kurven brattere"],
    ...
    },
    {
      ...
      options: ["Inflasjon og produksjon trekker motsatt vei, så det oppstår en målkonflikt", "Fordi renten ikke virker på kostnader og importpriser i det hele tatt for bedriftene", "Fordi produksjonsgapet forsvinner", "Fordi forventningene alltid faller"],
    ...
    },
    {
      ...
      options: ["$\\pi^e$ ligger stabilt rundt inflasjonsmålet fordi aktørene stoler på sentralbanken", "At inflasjonen er null og forventningene $\\pi^e$ derfor også er null i likevekt over tid", "At renten er bundet", "At produksjonsgapet er lukket"],
    ...
    },
    {
      ...
      options: ["Fordi lav ledighet ($u<u^n$) gir høy inflasjon", "Fordi høy ledighet $u>u^n$ gir høy inflasjon og prispress", "Fordi $b<0$", "Fordi forventningene faller"],
    ...
    },
    {
      ...
      options: ["Kostnaden ved å produsere én enhet til, dominert av lønnskostnad per enhet", "Den totale lønnssummen i hele økonomien delt på antall produserte enheter i året", "Sentralbankens rente", "Prisen minus påslaget alltid lik null"],
    ...
    },
    {
      ...
      options: ["Den faller — motsatt kausalkjede demper lønns- og prispresset", "Den stiger", "Den er uendret", "Den blir liggende lik forventningene $\\pi^e$ uansett gapets fortegn"],
    ...
    },
    {
      ...
      options: ["Høye forventninger gir høye lønnskrav som gir høye priser som bekrefter forventningene", "At lønn og pris alltid er konstante", "At sentralbanken senker renten hvert år", "At produksjonsgapet lukkes helt automatisk uten at prisene eller lønningene endrer seg noe"],
    ...
    },
    {
      ...
      options: ["Inflasjonen blir lik $\\pi^e$", "Inflasjonen blir null", "Inflasjonen blir liggende lik $\\beta$ ved lukket gap", "Inflasjonen blir uendelig"],
    ...
    },
    {
      ...
      options: ["Fordi PK bakes inn i renteregelen, slik at gapet påvirker renten via en indirekte kanal", "Fordi PK bestemmer valutakursen", "Fordi PK erstatter Keynes-modellen og bestemmer multiplikatoren på kort sikt fullstendig", "Fordi PK gir multiplikatoren"],
    ...
    },
    {
      ...
      options: ["Årsaksretningen ledighet/lønn er snudd, og flere ledd mangler", "$z^\\pi$ og kostnadssjokket er utelatt, men ellers er kjeden helt riktig", "Ingenting, kjeden er korrekt", "Forventningene skulle stått først"],
    ...
    },
    {
      ...
      options: ["Potensielt BNP — produksjonen ved likevektsledigheten $u^n$", "Fjorårets BNP", "Maksimal produksjonskapasitet på svært kort sikt, ved null ledighet", "Sentralbankens inflasjonsmål"],
    ...
    },
    {
      ...
      options: ["Den skifter, fordi et gitt $Y$ nå gir et større positivt gap", "Ingenting", "Den blir flatere fordi helningen $\\beta$ avtar når $Y^n$ endres", "Den forsvinner"],
    ...
    },
    {
      ...
      options: ["Når $\\pi^e$ tilpasser seg faktisk inflasjon, lukkes gapet og avveiningen forsvinner", "Avveiningen blir sterkere over tid", "Produksjonen kan holdes vilkårlig høy over $Y^n$ på lang sikt med tilstrekkelig høy inflasjon", "Ledigheten forsvinner på lang sikt"],
    ...
    },
    {
      ...
      options: ["Fordi den er stigende i $(Y,\\pi)$ men fallende i $(u,\\pi)$", "Fordi den alltid er vannrett", "Fordi aksene ikke betyr noe", "Fordi den alltid er fallende uansett hvilke akser du velger å tegne"],
  ...
  'econ1310-4-3': [
    {
      ...
      options: ["Konkurranseutsatt industri forhandler først og setter en ramme de andre følger", "Skjermet sektor forhandler først og setter en ramme resten av arbeidslivet må følge", "Staten fastsetter alle lønninger sentralt", "Hver bedrift forhandler helt isolert"],
    ...
    },
    {
      ...
      options: ["Fordi den ikke kan velte høye lønninger over i prisene uten å tape markedsandeler", "Fordi den har flest ansatte", "Fordi den er skjermet fra utlandet og derfor fritt kan velte lønnsvekst rett over i prisene", "Fordi den bestemmer styringsrenten"],
    ...
    },
    {
      ...
      options: ["Den demper lønnspresset $z^W$, så lønnskurven skyves ned og skjæringen flyttes til venstre", "Den løfter priskurven", "Den hever lønnspresset $z^W$", "Den øker påslaget $\\mu$, så priskurven skyves oppover og likevektsledigheten $u^n$ stiger klart"],
    ...
    },
    {
      ...
      options: ["Den er uendret — priskurven låser den; gevinsten er lavere ledighet", "Den stiger varig fordi koordinering hever reallønnen ut over priskurvens tak", "Den faller varig", "Den blir lik null"],
    ...
    },
    {
      ...
      options: ["Å legge fram et felles tallgrunnlag som forankrer forventningene og gjør rammen troverdig", "Å fastsette styringsrenten og dermed binde både frontfagsrammen og inflasjonsforventningene fast", "Å bestemme skattenivået", "Å forby lønnsøkninger"],
    ...
    },
    {
      ...
      options: ["Den produserer for hjemmemarkedet uten direkte utenlandsk konkurranse", "Den selger mest til utlandet og er derfor bundet av den internasjonale konkurransen", "Den setter alltid frontfagsrammen", "Den har ingen ansatte"],
    ...
    },
    {
      ...
      options: ["Sterke, sentraliserte organisasjoner med høy organisasjonsgrad", "Lav organisasjonsgrad", "At skjermet sektor ignorerer rammen", "At renten holdes fast slik at frontfagsrammen settes uavhengig av pengepolitikken"],
    ...
    },
    {
      ...
      options: ["Rammen kan være for stram for sektorer med høy produktivitetsvekst eller arbeidskraftmangel", "Den hever alltid reallønnen for mye", "Den gjør likevektsledigheten $u^n$ permanent høyere ved å skyve lønnskurven varig oppover i modellen", "Den fjerner behovet for TBU"],
    ...
    },
    {
      ...
      options: ["$z^W$ stiger, lønnskurven skyves opp, og $u^n$ stiger igjen", "$u^n$ faller ytterligere", "$u^n$ blir null fordi bortfall av koordinering fjerner alt strukturelt lønnspress", "Reallønnen stiger"],
    ...
    },
    {
      ...
      options: ["Ren opplisting uten avveining, eller å bruke matematisk modell der det er uønsket", "Å nevne konkurranseutsatt sektor", "Å koble drøftingen til lønns- og priskurvemodellen med en fullstendig matematisk utledning", "Å drøfte forutsetningene"],
  ...
  'econ1310-5-1': [
    ...
    },
    {
      ...
      options: ["Vekten sentralbanken legger på inflasjonsavviket", "Vekten på produksjonsgapet", "Phillips-kurvens helning, altså hvor sterkt gapet slår ut i inflasjonen", "Marginal konsumtilbøyelighet"],
    ...
    },
    {
      ...
      options: ["Vekten sentralbanken legger på produksjonsgapet", "Vekten på inflasjonsavviket, altså hvor haukisk sentralbanken opptrer", "Importlekkasjen", "Skattelekkasjen"],
    ...
    },
    {
      ...
      options: ["Renteresponsen på den inflasjonen som produksjonsgapet skaper via Phillips-kurven", "Renteresponsen på selve aktivitetsnivået", "En dobbelttelling som bør fjernes", "Effekten av valutakursen på importprisene, som forsterker gap-koeffisienten i renteregelen"],
    ...
    },
    {
      ...
      options: ["Sentralbankens respons på aktivitetsnivået i seg selv, uavhengig av inflasjonen", "Responsen på inflasjonen gapet skaper via Phillips-kurven, altså den indirekte kanalen", "Phillips-kurvens forventningsledd", "Skattemultiplikatoren"],
    ...
    },
    {
      ...
      options: ["Nei — $d_2$ er respons på aktiviteten, $d_1\\beta$ er respons på inflasjonen aktiviteten skaper", "Ja, gapet telles to ganger, så $d_1\\beta$ er en ren dobbelttelling som bør strykes fra koeffisienten", "Ja, men bare når $\\beta > 1$", "Nei, fordi de to leddene alltid er like store"],
    ...
    },
    {
      ...
      options: ["Nei — det flytter økonomien langs RR fordi PK er bakt inn i kurven", "Ja, det skifter RR opp fordi høyere etterspørsel løfter renteregelens intercept", "Ja, det skifter RR ned", "Bare hvis skattesatsen er null"],
    ...
    },
    {
      ...
      options: ["$\\frac{d_1\\beta+d_2}{Y^n}$", "$d_1 + d_2$", "$\\frac{d_1}{d_2}$ (forholdet mellom de to rentevektene)", "$\\beta Y^n$"],
    ...
    },
    {
      ...
      options: ["Høyere aktivitet gir større gap, som løfter renten både direkte ($d_2$) og via inflasjonen ($d_1\\beta$)", "Fordi høyere BNP alltid senker inflasjonen via Phillips-kurven, slik at sentralbanken setter en lavere styringsrente", "Fordi importlekkasjen øker", "Fordi skattesatsen faller"],
    ...
    },
    {
      ...
      options: ["Et pengepolitisk sjokk — renteendring som ikke skyldes gap eller inflasjonsavvik", "Inflasjonsmålet", "Produksjonsgapet", "Realrenten, altså nominell styringsrente korrigert for forventet inflasjon $\\pi^e$ i perioden"],
    ...
    },
    {
      ...
      options: ["Den er «haukete» og prioriterer inflasjonsmålet framfor realøkonomien", "Den bryr seg mest om sysselsettingen og legger dermed mindre vekt på inflasjonsmålet", "Den holder alltid renten konstant", "Den har ikke inflasjonsmål"],
    ...
    },
    {
      ...
      options: ["Slik at også realrenten $(i-\\pi^e)$ stiger når inflasjonen stiger", "Slik at nominell rente holdes konstant", "Slik at produksjonsgapet lukkes automatisk uten at realrenten $(i-\\pi^e)$ endres", "Slik at $z^i$ blir null"],
    ...
    },
    {
      ...
      options: ["$1{,}3$", "$2{,}3$ (feil: legger sammen $d_1+d_2$ uten å gange med $\\beta$)", "$0{,}8$", "$1{,}0$"],
      explanation: "$d_1\\beta + d_2 = 2\\cdot0{,}5 + 0{,}3 = 1{,}0 + 0{,}3 = 1{,}3$.",
    },
    {
      question: "Hva betyr fleksibel inflasjonsstyring i renteregel-språk?",
      options: ["Både $d_1 > 0$ og $d_2 > 0$ — inflasjonsmålet er anker, men realøkonomien teller også", "Bare $d_1 > 0$ og $d_2 = 0$ — sentralbanken bryr seg utelukkende om inflasjonsmålet sitt", "Bare $d_2 > 0$, $d_1 = 0$", "Verken $d_1$ eller $d_2$ er positiv"],
    ...
    },
    {
      ...
      options: ["RR (og PK) skifter fordi gap-normaliseringen endres", "Ingenting, $Y^n$ inngår ikke i RR", "RR blir horisontal", "Bare IS-kurven skifter, siden $Y^n$ kun inngår i etterspørselsligningen"],
    ...
    },
    {
      ...
      options: ["Å dele på $Y^n$: gapet er $\\frac{Y-Y^n}{Y^n}$, ikke bare $Y - Y^n$", "Å dele på $\\pi^*$", "Å multiplisere gapet med rentevekten $d_1$ før det settes inn i Phillips-kurven", "Å trekke fra $z^i$"],
    ...
    },
    {
      ...
      options: ["Fordi sentralbanken reagerer på inflasjonen, som selv avhenger av produksjonsgapet", "For å fjerne kostnadssjokket $z^\\pi$ fra modellen slik at RR bare avhenger av selve gapet", "For å gjøre RR fallende", "For å eliminere $d_2$"],
    ...
    },
    {
      ...
      options: ["Beveger seg oppover langs uendret RR og setter høyere rente", "Skifter hele RR opp fordi etterspørselssjokket løfter renteregelens intercept", "Skifter hele RR ned", "Gjør ingenting med renten"],
    ...
    },
    {
      ...
      options: ["$(d_1\\beta+d_2)\\frac{Y-Y^n}{Y^n}$", "$z^i$", "$d_1(\\pi^e-\\pi^*)$, forventningsavviksleddet i interceptet", "$d_1 z^\\pi$"],
    ...
    },
    {
      ...
      options: ["$i - \\pi^e$ (nominell rente minus forventet inflasjon)", "$i + \\pi^e$", "$i - \\pi^*$ (nominell rente minus sentralbankens inflasjonsmål)", "$d_1 i$"],
  ...
  'econ1310-5-2': [
    ...
    },
    {
      ...
      options: ["$(Y, \\pi)$ — BNP og inflasjon", "$(Y, i)$ — BNP og nominell styringsrente", "$(\\pi, i)$", "$(Y^n, u^n)$"],
    ...
    },
    {
      ...
      options: ["Høyere rente demper konsum og investeringer og dermed BNP", "Høyere rente øker BNP fordi sparing gir mer disponibel inntekt til konsum", "Høyere BNP senker renten", "Høyere inflasjon senker renten"],
    ...
    },
    {
      ...
      options: ["Høyere BNP gir større gap og høyere inflasjon, som sentralbanken svarer på med høyere rente", "Høyere BNP gir lavere rente fordi større skatteinntekter reduserer statens lånebehov og presser renten ned", "Renten er alltid konstant", "PK er fallende"],
    ...
    },
    {
      ...
      options: ["Nei — økonomien beveger seg langs den uendrede RR", "Ja, RR skifter opp fordi etterspørselen løfter renteregelens intercept", "Ja, RR skifter ned", "Bare hvis inflasjonen er over målet"],
    ...
    },
    {
      ...
      options: ["Renten reduserer BNP-utslaget, men et restutslag blir stående i ny likevekt B", "Renten fjerner hele sjokket", "Renten forsterker sjokket fordi den beveger seg medsyklisk langs den stigende RR", "Renten holdes fast"],
    ...
    },
    {
      ...
      options: ["Da måtte den forlate RR-kurven, som er dens egen reaksjonsregel", "Fordi renten ikke kan endres når økonomien allerede ligger på RR-kurven", "Fordi IS ikke skifter", "Fordi inflasjonen er fast"],
    ...
    },
    {
      ...
      options: ["Å glemme sentralbankens respons langs RR (analysere som om renten var fast)", "Å tegne to paneler", "Å markere likevektspunktene i feil panel og lese av inflasjonen på RR i stedet for PK", "Å skifte IS"],
    ...
    },
    {
      ...
      options: ["Både utgangslikevekt A og ny likevekt B, i begge paneler", "Bare punkt B", "Bare øvre panel, siden inflasjonen ikke behøver å markeres i figuren", "Kun RR-kurven"],
    ...
    },
    {
      ...
      options: ["I nedre panel, på Phillips-kurven ved det aktuelle BNP-nivået", "I øvre panel, der RR-kurven krysser den fallende IS-kurven ved likevekt", "I øvre panel, på IS", "På den vannrette aksen"],
    ...
    },
    {
      ...
      options: ["Utslaget blir større fordi rentedempingen uteblir", "Utslaget blir mindre fordi den faste renten fortsatt demper multiplikatoren", "Utslaget blir null", "BNP endres ikke"],
    ...
    },
    {
      ...
      options: ["RR erstattes av en vannrett linje ved den låste renten", "RR blir loddrett ved det fastlåste BNP-nivået sentralbanken sikter mot", "IS blir vannrett", "PK forsvinner"],
    ...
    },
    {
      ...
      options: ["Bare andelen $c_1 < 1$ av skattelettelsen brukes; resten spares", "Skatt virker direkte på etterspørselen, mens offentlige kjøp bare virker indirekte via konsumet", "G lekker mer enn skatt", "De er alltid like sterke"],
    ...
    },
    {
      ...
      options: ["Produksjonsgap og inflasjon trekker samme vei, så renten kan reagere entydig", "Fordi inflasjonen ikke endres når etterspørselen skifter, siden Phillips-kurven ligger fast", "Fordi BNP ikke endres", "Fordi renten er fast"],
    ...
    },
    {
      ...
      options: ["Beveger seg oppover langs RR og hever renten", "Skifter RR opp fordi etterspørselen løfter renteregelens intercept", "Senker renten", "Skifter PK opp"],
    ...
    },
    {
      ...
      options: ["Keynes-multiplikatoren ganget med sjokket", "Bare sjokket alene", "Renteregelens inflasjonsvekt $d_1$ ganget med produksjonsgapet", "Phillips-kurvens $\\beta$"],
    ...
    },
    {
      ...
      options: ["Øvre panel, som skjæringen IS = RR", "Nedre panel, direkte på Phillips-kurven", "Begge deler like mye", "Ingen av dem"],
    ...
    },
    {
      ...
      options: ["F.eks. feilaktig å skifte RR ved et etterspørselssjokk i stedet for å bevege seg langs den", "Å tegne begge paneler, men feilaktig skifte Phillips-kurven ved et rent etterspørselssjokk i nedre panel", "Å markere A og B", "Å bruke riktig akse"],
    ...
    },
    {
      ...
      options: ["mindre enn de ville vært ved fast rente", "større enn ved fast rente, fordi renteregelen forsterker sjokkene medsyklisk", "helt lik som ved fast rente", "irrelevante for inflasjonen"],
    ...
    },
    {
      ...
      options: ["nede til venstre for A i øvre panel", "oppe til høyre for A, med høyere $Y$ og høyere $i$", "rett over A", "på PK-kurven"],
    ...
    },
    {
      ...
      options: ["Likviditetsfellen, der renten ikke kan settes lavere og finanspolitikken virker sterkere", "At renteregelen alltid nøytraliserer etterspørselssjokk fullstendig slik at BNP holdes helt uendret", "At Phillips-kurven blir vannrett", "At produksjonsgapet forsvinner"],
  ...
  'econ1310-5-3': [
    {
      ...
      options: ["PK og RR skifter opp, IS ligger fast", "Bare IS skifter", "Bare PK skifter", "IS og RR skifter opp, mens Phillips-kurven ligger fast"],
    ...
    },
    {
      ...
      options: ["$\\pi$ opp, $Y$ ned, $i$ opp", "Alle opp", "Alle ned", "$\\pi$ ned, $Y$ opp, $i$ ned, som ved et positivt etterspørselssjokk"],
    ...
    },
    {
      ...
      options: ["Fordi inflasjon og produksjon trekker i motsatt retning", "Fordi både inflasjon og produksjon trekker i samme retning etter sjokket", "Fordi renten ikke kan endres", "Fordi IS skifter"],
    ...
    },
    {
      ...
      options: ["Fordi produksjonsgap og inflasjon trekker samme vei", "Fordi produksjonsgap og inflasjon her trekker i motsatt retning", "Fordi PK er fast", "Fordi RR skifter"],
    ...
    },
    {
      ...
      options: ["Hvordan sentralbanken avveier inflasjonsmål mot produksjon i målkonflikten", "Størrelsen på kostnadssjokket", "Phillips-kurvens helning $\\beta$, altså hvor sterkt gapet slår ut i inflasjonen", "Multiplikatoren"],
    ...
    },
    {
      ...
      options: ["Entydig positiv — $\\pi$ stiger, men mindre enn sjokket, fordi rentesvaret bare demper", "Fortegnsubestemt — BNP-fallet kan mer enn oppveie PK-skiftet", "Nøyaktig lik sjokket — rentesvaret påvirker ikke inflasjonen", "Negativ — renteøkningen mer enn nøytraliserer kostnadssjokket, slik at prisnivået faller samlet"],
    ...
    },
    {
      ...
      options: ["$\\pi$ ned, $Y$ opp, $i$ ned", "Alle opp", "Alle ned", "$\\pi$ opp, $Y$ ned, $i$ opp, altså stagflasjon som ved kostnadssjokk"],
    ...
    },
    {
      ...
      options: ["Å la inflasjonen ende høyere enn utgangspunktet (selvmotsigende)", "Å skifte Phillips-kurven ned, men samtidig la sentralbanken heve renten", "Å holde IS fast", "Å senke renten"],
    ...
    },
    {
      ...
      options: ["Som et positivt kostnadssjokk $\\Delta z^\\pi > 0$", "Som et positivt etterspørselssjokk som skifter IS-kurven mot høyre", "Som et pengepolitisk sjokk", "Som en økning i $Y^n$"],
    ...
    },
    {
      ...
      options: ["Skillet mellom etterspørselssjokk og kostnadssjokk", "Utledning av Keynes-multiplikatoren i den åpne økonomien", "BNP-klassifisering", "Handlingsregelen"],
    ...
    },
    {
      ...
      options: ["Et kostnadssjokk: PK og RR opp, $Y$ ned, $\\pi$ og $i$ opp", "Et etterspørselssjokk som skifter IS mot høyre og lar PK ligge fast", "Et rentekutt", "En økning i $Y^n$"],
    ...
    },
    {
      ...
      options: ["De hindrer at forventningsdrevne kostnadssjokk selvforsterker inflasjonen", "De øker multiplikatoren", "De gjør IS brattere slik at renteregelens gjennomslag på BNP blir merkbart kraftigere", "De fjerner produksjonsgapet"],
    ...
    },
    {
      ...
      options: ["PK og RR (tilbudssidesjokk), ikke IS", "IS alene, siden mer potensielt BNP løfter samlet etterspørsel", "Bare RR", "Ingen kurver skifter"],
    ...
    },
    {
      ...
      options: ["Ett rentevåpen kan ikke løse to problemer som trekker motsatt vei", "Renten kan løse både inflasjons- og produksjonsproblemet på samme tid", "Finanspolitikken må brukes i stedet", "Inflasjonen forsvinner av seg selv"],
    ...
    },
    {
      ...
      options: ["oppe til venstre for A (høyere $i$, lavere $Y$)", "oppe til høyre for A, med både høyere $i$ og høyere $Y$", "nede til høyre for A", "rett under A"],
    ...
    },
    {
      ...
      options: ["Fordi rentehevingen og BNP-fallet demper prispresset delvis", "Fordi Phillips-kurven ikke skifter, mens bare renteregelen reagerer", "Fordi RR er fast", "Fordi $\\beta = 0$"],
    ...
    },
    {
      ...
      options: ["At RR skifter sammen med PK (sentralbankens reaksjon i øvre panel)", "At IS skifter", "At produksjonen $Y$ holdes konstant fordi bare Phillips-kurven skifter", "At inflasjonen faller"],
  ...
  'econ1310-5-4': [
    ...
    },
    {
      ...
      options: ["Den ganger hele klammen i tilvekstuttrykket, så $\\Delta Y = 0$ krever bare at klammen er null", "Fordi multiplikatoren $1/D$ alltid blir nøyaktig lik 1 idet sentralbanken nøytraliserer sjokket fullt", "Fordi sjokket alltid er lik multiplikatoren", "Fordi renten er bundet"],
    ...
    },
    {
      ...
      options: ["Fordi $c_1 < 1$: bare andelen $c_1$ av hver skattekrone reduserer konsumet, resten tas fra sparing", "Fordi skatt virker direkte og fullt ut på etterspørselen", "Fordi den endogene skatten $tY$ forsterker hver multiplikatorrunde og gjør at skattedosen må være mindre enn selve sjokket", "Fordi renten samtidig heves"],
    ...
    },
    {
      ...
      options: ["Produksjonsgapet og inflasjonsgapet trekker samme vei, så ett virkemiddel lukker begge samtidig", "Fordi et etterspørselssjokk bare flytter Phillips-kurven og lar produksjonsgapet stå fullstendig urørt", "Fordi renteregelen automatisk nuller det", "Fordi $c_2 + b_2 = 1$"],
    ...
    },
    {
      ...
      options: ["Inflasjons- og produksjonsgapet trekker motsatt vei, så ett virkemiddel ikke kan nulle begge", "Fordi kostnadssjokk ikke påvirker renten", "Fordi $c_2 + b_2 = 0$ ved kostnadssjokk", "Fordi et kostnadssjokk bare treffer IS-kurven og dermed krever to helt separate finanspolitiske grep"],
    ...
    },
    {
      ...
      options: ["Summen $c_2 + b_2$ — rentens virkning på både konsum og investering", "Bare $b_2$ — rentens virkning på investeringene, ettersom konsumet er helt renteufølsomt i modellen", "Bare $c_2$ — rentens virkning på konsum", "Multiplikatoren $1/D$"],
    ...
    },
    {
      ...
      options: ["Diskresjonær er en bevisst beregnet dose mot et mål; regelbasert er renteregelens automatiske respons", "Diskresjonær gjelder bare finanspolitikk", "Regelbasert rentesetting nøytraliserer alltid sjokket fullt fordi renteregelen har $\\Delta Y = 0$ som innebygd mål", "De gir alltid samme rente"],
    ...
    },
    {
      ...
      options: ["Rentedempingen (RR-responsen) uteblir, så en G-økning motvirkes ikke av høyere rente", "Fordi skatt da virker direkte", "Fordi multiplikatoren blir mindre enn 1", "Fordi renten ved nullgrensen settes negativ automatisk og dermed forsterker den offentlige etterspørselen"],
    ...
    },
    {
      ...
      options: ["Riktig parameterkombinasjon i nevneren, riktig fortegn, OG forklaring på hvorfor nøytralisering er mulig", "Bare det numeriske svaret", "En lang verbal drøfting av pengepolitikkens transmisjonskanaler helt uten oppsett av nøytraliseringsbetingelsen", "At du også tegner IS-RR-PK-diagrammet"],
  ...
  'econ1310-5-5': [
    ...
    },
    {
      ...
      options: ["Renten $i$ — øvre panel er $(Y, i)$-rommet med IS og RR", "Inflasjonen $\\pi$ — den hører til IS-kurven", "Ledigheten $u$ — den styrer lønnsdannelsen", "Prisnivået $P$ — fordi det bestemmer realrenten som forskyver hele IS-kurven"],
    ...
    },
    {
      ...
      options: ["Realrentens demping av konsum ($c_2$) og investering ($b_2$)", "Sentralbankens renterespons på produksjonsgapet og inflasjonsavviket ($d_2$)", "Lønnspresset som stiger når ledigheten faller ($\\beta$)", "Skattelekkasjen som tapper hver multiplikatorrunde ($t$)"],
    ...
    },
    {
      ...
      options: ["Inflasjonskanalen $d_1\\beta$ pluss den direkte gap-responsen $d_2$", "IS-helningen $d_1\\beta$ pluss multiplikatoren $d_2$", "To ledd som trekker renten hver sin vei ved høyere $Y$", "Kostnadssjokket $d_1\\beta$ pluss forventningsleddet $d_2$ fra Phillips-kurven"],
    ...
    },
    {
      ...
      options: ["$Y\\uparrow$, $i\\uparrow$, $\\pi\\uparrow$ (alle samme vei)", "$Y\\uparrow$, $i\\downarrow$, $\\pi\\downarrow$ (renten kuttes langs RR)", "$Y\\downarrow$, $i\\uparrow$, $\\pi\\uparrow$", "$Y\\uparrow$, $i\\uparrow$, $\\pi\\downarrow$"],
    ...
    },
    {
      ...
      options: ["Både PK og RR skifter opp; IS ligger fast", "Bare IS skifter venstre fordi kostnadssjokket demper vareetterspørselen direkte", "Bare PK skifter opp", "Bare RR skifter opp"],
    ...
    },
    {
      ...
      options: ["$Y\\downarrow$, $i\\uparrow$, $\\pi\\uparrow$ (stagflasjon)", "$Y\\uparrow$, $i\\uparrow$, $\\pi\\uparrow$ (en ren høykonjunktur)", "$Y\\downarrow$, $i\\downarrow$, $\\pi\\downarrow$", "$Y\\uparrow$, $i\\downarrow$, $\\pi\\uparrow$"],
    ...
    },
    {
      ...
      options: ["Størst ved fast rente — renteregelen demper utslaget", "Størst ved renteregel — renteendringen forsterker sjokket", "Nøyaktig likt — renten påvirker ikke $Y$-utslaget", "Null ved fast rente — sjokket absorberes av prisene"],
    ...
    },
    {
      ...
      options: ["Figuren er selvmotsigende — et negativt kostnadssjokk må ende med $\\pi$ under A", "Ingenting — inflasjonen kan gå begge veier ved kostnadssjokk avhengig av RR-helningen", "Studenten skulle skiftet IS i stedet for PK og RR", "Studenten skulle latt renten stå uendret i figuren"],
    ...
    },
    {
      ...
      options: ["Som et kostnadssjokk: PK og RR skifter opp, $Y\\downarrow$, $i\\uparrow$, $\\pi\\uparrow$", "Som et etterspørselssjokk der bare IS-kurven skifter mens sentralbanken svarer langs en fast RR", "Bare PK skifter, RR står fast", "Ingen kurver skifter"],
    ...
    },
    {
      ...
      options: ["PK og RR skifter mot høyre; $Y\\uparrow$, $i\\downarrow$, $\\pi\\downarrow$", "IS skifter venstre", "Bare RR skifter opp fordi høyere potensielt BNP tvinger renteregelen til å stramme kraftig til", "Ingenting endres"],
    ...
    },
    {
      ...
      options: ["BNP faller entydig; rente og inflasjon er fortegnsubestemte", "Renten stiger entydig", "Inflasjonen faller entydig fordi kostnadssjokket domineres av etterspørselsfallet", "Alt er entydig bestemt"],
    ...
    },
    {
      ...
      options: ["IS skifter venstre (eksport er et etterspørselsledd)", "RR skifter opp fordi eksportfallet tvinger sentralbanken til å heve renten", "PK skifter ned", "Ingen kurve skifter"],
    ...
    },
    {
      ...
      options: ["Riktig kurve, riktig retning og begge likevektspunkter (A og B) markert", "Perfekt kurvefasong og eksakte tallverdier", "Bare det øvre panelet", "En verbal beskrivelse av kurveskiftene helt uten selve figuren og likevektspunktene"],
    ...
    },
    {
      ...
      options: ["Kutter renten, som demper fallet i BNP", "Hever renten, som forsterker fallet i BNP ytterligere", "Holder renten fast", "Skifter RR nedover"],
    ...
    },
    {
      ...
      options: ["Finn likevekts-$Y$ i øvre panel, les samme $Y$ nedover til PK for $\\pi$", "Finn $\\pi$ først, så $Y$ i øvre panel", "Panelene er uavhengige", "Nedre panel har renten $i$ på den loddrette aksen og deler ikke $Y$-akse med øvre panel"],
  ...
  'econ1310-5-6': [
    {
      ...
      options: ["Sentralbanken styrer mot inflasjonsmålet, men vektlegger også å stabilisere realøkonomien", "Sentralbanken bryr seg kun om inflasjonen", "Sentralbanken har ikke noe fast inflasjonsmål", "Sentralbanken styrer valutakursen fast og lar inflasjonen flyte helt fritt rundt et implisitt mål"],
    ...
    },
    {
      ...
      options: ["$d_1$ (inflasjonsavvik) og $d_2$ (produksjonsgap)", "$c_1$ og $c_2$", "$\\beta$ (lønnsfølsomheten) og $\\mu$ (prispåslaget i lønnskurven)", "$b_1$ og $b_2$"],
      explanation: "Renteregelen: $i = z^i + d_1(\\pi-\\pi^*) + d_2\\frac{Y-Y^n}{Y^n}$.",
    },
    {
      question: "Hvorfor setter sentralbanken renten gradvis?",
      options: ["Usikkerhet om økonomien, hensyn til troverdighet og finansiell stabilitet", "Fordi loven krever små steg", "Fordi renteregelen gir ett fast tall", "Fordi finanspolitikken alltid virker først, så sentralbanken må vente på Stortingets budsjettvedtak"],
      explanation: "De tre standardgrunnene for gradvishet.",
    },
    {
      question: "Hva er rentens transmisjonsmekanisme?",
      options: ["Kjeden fra styringsrenten via markedsrenter til konsum, investering og valutakurs", "Sentralbankens valg av inflasjonsmål", "Skattesystemets virkning på BNP", "Forholdet mellom aksjer og obligasjoner som styrer hvordan sentralbanken fastsetter inflasjonsmålet"],
    ...
    },
    {
      ...
      options: ["Høyere rente styrker kronen, gjør import billigere og eksport dyrere", "Høyere rente svekker kronen, gjør eksporten billigere og øker dermed nettoeksporten", "Renten påvirker ikke valutakursen", "Kronen styrkes bare ved lavere rente"],
    ...
    },
    {
      ...
      options: ["Styringsrenten er nær nullgrensen og kan ikke settes vesentlig lavere, så rentekutt slutter å virke", "Bankene har så mye reserver at pengemarkedsrenten faller under reserverenten og renteregelen slutter å virke", "Inflasjonen er over målet", "Kronen er for sterk"],
    ...
    },
    {
      ...
      options: ["Aktørene ville da holdt kontanter (null avkastning) i stedet for å plassere til negativ rente", "Fordi inflasjonen ville eksplodert", "Fordi loven forbyr det fullstendig", "Fordi bankene da slutter helt å låne ut ettersom negativ rente gjør all utlånsvirksomhet ulønnsom"],
      explanation: "Kontantalternativet setter en effektiv nedre grense for renten.",
    },
    {
      question: "Hva er kvantitative lettelser (QE)?",
      options: ["Sentralbanken kjøper verdipapirer for å presse ned lange renter og tilføre likviditet", "Et ordinært kutt i styringsrenten", "En økning i skattene", "Et bindende løfte om høyere styringsrente framover for å forankre inflasjonsforventningene"],
    ...
    },
    {
      ...
      options: ["Sentralbanken kommuniserer forpliktende om fremtidig rentebane for å påvirke forventningene i dag", "Sentralbanken kjøper aksjer og eiendom direkte for å heve formuesprisene og stimulere konsumet raskt", "Et krav om balansert budsjett", "En fast valutakurs"],
    ...
    },
    {
      ...
      options: ["Renteresponsen uteblir (RR flat), så en G-økning slår fullt gjennom uten motvirkende renteoppgang", "Fordi skatteletten ved nullgrensen virker direkte og fullt ut på etterspørselen uten sparelekkasje", "Fordi multiplikatoren blir mindre", "Fordi renten da settes negativ"],
    ...
    },
    {
      ...
      options: ["Å trekke inn matematisk modell i en verbal drøfting", "Å bruke fagbegreper", "Å veie relevante argumenter for og imot uten å lande på ett bestemt standpunkt", "Å definere nøkkelbegrepene"],
    ...
    },
    {
      ...
      options: ["QE er kjøp av verdipapirer ved nullgrensen; rentekutt er en endring i styringsrenten", "De er det samme", "QE hever renten", "Rentekutt tilfører aldri likviditet, mens QE i praksis hever styringsrenten for å dempe inflasjonen"],
    ...
    },
    {
      ...
      options: ["Fordi renten virker vesentlig via kronekursen og bytteforholdet, ikke bare via lånerenten", "Fordi Norge har fast valutakurs", "Fordi valutakursen ikke påvirker inflasjonen", "Fordi eksporten er ubetydelig, så kronekursen påvirker verken inflasjonen eller produksjonen nevneverdig"],
    ...
    },
    {
      ...
      options: ["Renten bankene får på innskudd (reserver) i sentralbanken", "Renten staten betaler på langsiktige statsobligasjoner i markedet", "Utlånsrenten til husholdninger", "Inflasjonsmålet"],
  ...
  'econ1310-6-1': [
    {
      ...
      options: ["Som en momentliste der veide, relevante argumenter gir uttelling — ikke standpunktet", "Etter om studenten lander på det «riktige» svaret", "Etter hvor mange ligninger og formelle utledninger studenten klarer å presse inn i svaret", "Kun etter lengden på svaret"],
    ...
    },
    {
      ...
      options: ["Pengepolitikken er rask, uavhengig og rendyrket", "Finanspolitikken har ingen virkningslag", "Sentralbanken kan vedta skatteendringer raskt", "Renten treffer bare noen få utvalgte sektorer svært presist"],
    ...
    },
    {
      ...
      options: ["Ved nullgrensen, fordi renteresponsen uteblir", "I en normal høykonjunktur", "Alltid, fordi den virker umiddelbart", "Aldri, ettersom pengepolitikken alltid virker raskere og sterkere"],
    ...
    },
    {
      ...
      options: ["Beslutnings- og virkningslag gjør aktiv finanspolitikk treg", "At renten reagerer med forsinkelse, mens skatteendringer virker helt umiddelbart", "At skatt alltid er eksogen", "At budsjettet balanseres automatisk"],
    ...
    },
    {
      ...
      options: ["En likviditetsfelle — nullgrensen hindrer videre rentekutt", "Stagflasjon — inflasjon og ledighet stiger samtidig", "Ricardiansk ekvivalens — husholdningene sparer hele stimulansen", "En målkonflikt — gapene trekker hver sin vei"],
    ...
    },
    {
      ...
      options: ["Kvantitative lettelser og forward guidance", "En kraftig heving av styringsrenten", "Endring av inntektsskatten", "Vedtak om kraftig økte offentlige kjøp og investeringer"],
    ...
    },
    {
      ...
      options: ["Et lånefinansiert skattekutt stimulerer ikke, fordi husholdningene sparer det til framtidig skatt", "Et skattekutt virker alltid dobbelt så sterkt på etterspørselen som en tilsvarende økning i offentlige kjøp", "Renten nøytraliserer all finanspolitikk", "Import lekker ut av multiplikatoren"],
    ...
    },
    {
      ...
      options: ["Kredittbeskrankninger, kort horisont og generasjonsskifte", "Fordi renten er fast", "Fordi skatt alltid er endogen", "Fordi importlekkasjen er så stor at hele skattekuttet lekker rett ut av landet"],
    ...
    },
    {
      ...
      options: ["Den er uendret — priskurven låser reallønnen; bare $u^n$ stiger", "Den stiger varig", "Den faller varig", "Den svinger på kort sikt, mens likevektsledigheten $u^n$ forblir helt uendret"],
    ...
    },
    {
      ...
      options: ["Den senkes, fordi lavere lønnspress ($z^W$ ned) skifter lønnskurven ned", "Den heves, fordi koordinering presser lønningene opp og skifter lønnskurven oppover", "Den er uendret", "Den blir negativ"],
    ...
    },
    {
      ...
      options: ["Sentralbanken vekter både inflasjonsmålet og realøkonomien ($d_1$ og $d_2$)", "Inflasjonsmålet endres fritt fra år til år", "Renten settes utelukkende etter inflasjonsavviket, helt uten hensyn til produksjonsgapet", "Renten holdes alltid fast"],
    ...
    },
    {
      ...
      options: ["Renten virker også via valutakurskanalen (kurs og bytteforhold)", "Fordi finanspolitikken er avskaffet", "Fordi importen er null", "Fordi inflasjonsmålet i en liten åpen økonomi alltid settes høyere"],
    ...
    },
    {
      ...
      options: ["En deloppgave som bygger på løst berørt stoff og brukes til å skille toppkarakterer", "En oppgave som alltid må løses med en formell matematisk modell for å gi full uttelling", "En oppgave uten riktig svar", "En oppgave verdt 0 poeng"],
    ...
    },
    {
      ...
      options: ["Den ekstra drøftingen gir null uttelling og bryter «svar bare på det du spørres om»", "Ingenting — mer stoff gir alltid mer poeng", "At studenten glemte en figur", "At studenten burde forankret hele drøftingen i en matematisk modell i stedet for ord"],
    ...
    },
    {
      ...
      options: ["Struktur, bredde og pensumforankring — for og mot veid mot hverandre", "Et sterkt, ensidig standpunkt", "Så mange momenter som mulig uten veiing", "En lang matematisk utledning som viser full formell forståelse av modellapparatet"],
  ...
  'econ1310-6-2': [
    {
      ...
      options: ["Lage en situasjonsdiagnose i modellens språk (hvilke sjokk, hvilket gap)", "Gi en anbefaling med en gang", "Sette opp og utlede skattemultiplikatoren og bruke den før du har stilt diagnosen", "Tegne IS-RR-PK-diagrammet"],
    ...
    },
    {
      ...
      options: ["Nei — konklusjon kreves aldri, og forbys noen ganger eksplisitt", "Ja, alltid", "Bare hvis du spiller sentralbanksjef og skal forsvare rentebeslutningen offentlig", "Bare i rådgiver-caset"],
    ...
    },
    {
      ...
      options: ["Liten-åpen-økonomi-perspektivet (rente ↔ valutakurs ↔ bytteforhold)", "En detaljert algebraisk utledning av multiplikatoren uten å nevne valutakurskanalen", "En lengst mulig momentliste", "Å ignorere valutakursen"],
    ...
    },
    {
      ...
      options: ["Inflasjonsmål, produksjonsgap, valutakurs, finansiell stabilitet, budsjett, stabilisatorer", "Bare inflasjonsmålet", "Bare budsjettbalansen", "Kun multiplikatorens størrelse og skattelekkasjen, siden bare finanspolitikken teller i case"],
    ...
    },
    {
      ...
      options: ["Inflasjon og produksjon trekker motsatt vei (inflasjon opp, produksjon ned)", "Fordi begge gap peker samme vei og renten dermed løser begge målene samtidig", "Fordi renten er fast", "Fordi budsjettet er i balanse"],
    ...
    },
    {
      ...
      options: ["Å dikte inn forutsetninger utover caseteksten", "Å holde seg strengt til caseteksten og alle dens oppgitte tallverdier", "Å veie hensyn for og mot", "Å nevne finansiell stabilitet"],
    ...
    },
    {
      ...
      options: ["Som to sjokk ($\\Delta X<0$ og $\\Delta z^\\pi>0$) analysert hver for seg", "Som ett rent etterspørselssjokk der begge kurvene IS og RR skifter samtidig", "Som ett rent kostnadssjokk", "Som en endring i telleregelen"],
    ...
    },
    {
      ...
      options: ["Inflasjons- og produksjonsgap trekker samme vei", "Fordi renten er fast", "Fordi PK skifter", "Fordi budsjettet balanseres automatisk av de endogene skatteinntektene"],
    ...
    },
    {
      ...
      options: ["Stabilisatorer virker umiddelbart uten vedtak; diskresjonære krever vedtak og har lag", "Diskresjonære virker umiddelbart uten beslutningslag, mens stabilisatorene må vedtas i Stortinget", "De er det samme", "Stabilisatorer gjelder bare pengepolitikk"],
    ...
    },
    {
      ...
      options: ["Om inflasjonsoverraskelsen er midlertidig eller smitter til forventningene $\\pi^e$", "Om budsjettet er i balanse", "Om multiplikatoren er over 1 slik at finanspolitikken alene lukker hele produksjonsgapet", "Om modellen er determinert"],
    ...
    },
    {
      ...
      options: ["Å oversette scenariet til sjokk, gap-fortegn og inflasjonens forhold til målet", "Å gi den endelige anbefalingen", "Å regne ut skattemultiplikatoren og budsjettmultiplikatoren før diagnosen stilles", "Å tegne lønns- og priskurven"],
    ...
    },
    {
      ...
      options: ["En veid oppsummering av hensynene, uten å velge et virkemiddel", "En tydelig anbefaling om å kutte renten", "En matematisk utledning av multiplikatoren som avslutter med et konkret rentevalg", "En påstand uten begrunnelse"],
  ...
  'econ1310-6-3': [
    {
      ...
      options: ["$\\Delta z^C<0$ (etterspørselssjokk, skifter IS)", "$\\Delta z^\\pi>0$ (kostnadssjokk, skifter PK og RR)", "$\\Delta Y^n<0$ (potensialsjokk)", "$\\Delta \\pi^e>0$ (forventningssjokk)"],
    ...
    },
    {
      ...
      options: ["$\\Delta z^\\pi>0$ — skifter PK og RR opp", "$\\Delta z^C>0$ — skifter både IS og RR utover", "$\\Delta G>0$ — skifter IS", "$\\Delta X<0$ — skifter IS"],
    ...
    },
    {
      ...
      options: ["Phillips-kurven er bakt inn i RR; bare $z^\\pi$, $\\pi^e$ og $Y^n$ skifter RR", "Fordi renten er fast", "Fordi IS ikke finnes i modellen", "Fordi et etterspørselssjokk bare påvirker $Y$ og aldri prisdannelsen i modellen"],
    ...
    },
    {
      ...
      options: ["$\\Delta z^\\pi>0$ (importert inflasjon, kostnadssjokk)", "$\\Delta z^C>0$ (etterspørselssjokk som skifter IS mot venstre)", "$\\Delta z^I>0$ (etterspørselssjokk)", "$\\Delta Y^n>0$ (potensialsjokk)"],
    ...
    },
    {
      ...
      options: ["$\\Delta G>0$ (etterspørselssjokk, skifter IS mot høyre)", "$\\Delta z^\\pi>0$ (kostnadssjokk som skifter PK og RR oppover)", "$\\Delta \\pi^e>0$ (forventningssjokk)", "$\\Delta Y^n<0$ (potensialsjokk)"],
    ...
    },
    {
      ...
      options: ["Det er to sjokk — $\\Delta X<0$ (IS) og $\\Delta z^\\pi>0$ (PK/RR) — analysert hver for seg", "Det er ett rent etterspørselssjokk der både IS-kurven og RR-kurven skifter i samme retning samtidig", "Det er ett rent kostnadssjokk", "Ingen kurver skifter"],
    ...
    },
    {
      ...
      options: ["Etterspørselssjokk skifter IS; kostnads-/forventnings-/potensialsjokk skifter PK (og RR)", "Alle sjokk skifter RR", "Alle sjokk skifter bare IS, fordi RR-kurven per definisjon alltid ligger fast i denne modellen", "Sjokk skifter aldri kurvene"],
    ...
    },
    {
      ...
      options: ["Oversette nyhetsbildet til riktig sjokkvariabel og fastslå type", "Skrive konklusjonen først", "Regne ut multiplikatoren og nettoeffekten på BNP før sjokket er identifisert", "Tegne lønns- og priskurven"],
  ...
  'econ1310-7-1': [
    {
      ...
      options: ["Til faktorinnsatsen, altså kostnadene (i hovedsak lønn)", "Til markedsprisen tjenestene ville hatt om de ble solgt på markedet", "Den holdes utenfor BNP siden den ikke omsettes", "Til den prisen brukerne betaler i egenandeler"],
    ...
    },
    {
      ...
      options: ["BNP måler produksjon innenlands; BNI legger til netto formuesinntekt og lønn fra utlandet", "BNP legger til netto formuesinntekt fra utlandet; BNI måler bare innenlands produksjon over tid", "BNP er før skatt, BNI er etter skatt", "BNP gjelder privat sektor, BNI hele økonomien"],
    ...
    },
    {
      ...
      options: ["Null, fordi enhver fordring er en annen sektors gjeld", "Lik samlet realinvestering $I$", "Lik budsjettunderskuddet", "Positiv, siden husholdningene sparer mer enn foretakene investerer"],
    ...
    },
    {
      ...
      options: ["Nivået som kan opprettholdes over tid uten press i pris- og lønnsdannelsen", "Toppnivået økonomien når i en sterk høykonjunktur med full kapasitetsutnyttelse", "Gjennomsnittlig BNP over den siste tiårsperioden", "Nivået der arbeidsledigheten er lik null"],
    ...
    },
    {
      ...
      options: ["Uten inntektsgivende arbeid, aktivt søkt siste fire uker, og kan tiltre raskt", "Registrert som arbeidssøker hos NAV og mottar dagpenger hver eneste måned uten avbrudd", "Uten arbeid i minst tolv måneder", "Uten arbeid og over 25 år gammel"],
    ...
    },
    {
      ...
      options: ["Konkurranseevnen — prisforholdet mellom utenlandske og norske varer i felles valuta", "Hvor mange kroner en euro koster på et gitt tidspunkt", "Rentedifferansen mellom Norge og handelspartnerne", "Verdien av landets samlede eksport målt i utenlandsk valuta gjennom et helt kalenderår"],
    ...
    },
    {
      ...
      options: ["Dyrere import og importert inflasjon, men bedret eksportkonkurranse", "Billigere import og lavere inflasjon", "Dyrere eksport, svekket eksportkonkurranse og lavere importert inflasjon", "Ingen virkning på inflasjonen"],
    ...
    },
    {
      ...
      options: ["Umulig — høyst to av de tre målene kan oppnås samtidig", "Fullt mulig hvis sentralbanken er tilstrekkelig troverdig", "Mulig, men bare for små åpne økonomier som Norge", "Umulig — et land kan bare velge ett av de tre målene"],
    ...
    },
    {
      ...
      options: ["Når antall ligninger er lik antall endogene variabler", "Når alle variabler er eksogene og modellen ikke har noen løsning", "Når den er en åpen økonomi", "Når renten er tatt med"],
    ...
    },
    {
      ...
      options: ["Skiftvariabelen $z^C$", "Samlet produksjon $Y$ i likevekt", "Skatteinngangen $T$", "Privat konsum $C$"],
    ...
    },
    {
      ...
      options: ["Konsum øker med inntekt, men husholdningene sparer en del av hver ekstra krone", "Konsum faller alltid når inntekten øker", "Fordi renten alltid er positiv", "Fordi skatten alltid er mindre enn inntekten og konsumet dermed stiger krone for krone"],
    ...
    },
    {
      ...
      options: ["Den endogene skatten $tY$, som demper svingninger uten vedtak", "Diskresjonære krisepakker som Stortinget vedtar og setter i verk uten tidsforsinkelse", "Sentralbankens rentekutt", "Handlingsregelens 3-prosentbane"],
    ...
    },
    {
      ...
      options: ["G virker direkte krone for krone; skattelette virker bare via konsumet med faktor $c_1 < 1$", "Skattelette virker direkte krone for krone, mens G bare virker indirekte via konsumet med lekkasje", "De gir nøyaktig samme virkning på BNP", "Skattelette lekker aldri til sparing"],
    ...
    },
    {
      ...
      options: ["Over tid skal om lag forventet realavkastning (3 %) av SPU brukes, målt ved strukturelt underskudd", "Nøyaktig 3 % av selve fondsverdien skal brukes hvert eneste år uavhengig av konjunkturene og oljeprisen", "Alle løpende oljeinntekter skal brukes fortløpende", "Fondet skal aldri tæres på i nedgangstider"],
    ...
    },
    {
      ...
      options: ["Konjunkturrenset – justert for hvor økonomien er i syklusen", "Det faktiske underskuddet uten justering", "Inkludert oljeinntektene", "Alltid større enn det oljekorrigerte underskuddet uansett konjunktursituasjon"],
    ...
    },
    {
      ...
      options: ["Høyere gap → lavere ledighet → sterkere forhandlingsmakt → høyere lønn → høyere marginalkostnad → påslag → høyere inflasjon", "Høyere gap → høyere rente → lavere lønn → lavere inflasjon", "Lavere gap → lavere ledighet → høyere lønn → høyere inflasjon", "Høyere gap → lavere marginalkostnad → lavere lønnspress → lavere pris → lavere prispåslag → lavere inflasjon over tid i økonomien"],
  ...
  'econ1310-7-2': [
    {
      ...
      options: ["Kortsvar 20 %, modelloppgave 60 %, teoridrøfting 20 %", "Kortsvar 40 %, modelloppgave 40 %, teoridrøfting 20 % av settet", "Kortsvar 25 %, modelloppgave 50 %, teoridrøfting 25 % av settet", "Kortsvar 20 %, modelloppgave 40 %, teoridrøfting 40 %"],
    ...
    },
    {
      ...
      options: ["1–3 setninger — lengre svar gir ikke mer uttelling", "Minst en halv side med utfyllende eksempler og en figur", "Ett ord eller én formel er tilstrekkelig for full skår", "5–10 setninger pluss en illustrerende figur i margen"],
    ...
    },
    {
      ...
      options: ["Definisjon pluss den etterspurte begrunnelsen eller kontrasten", "En presis og fullstendig definisjon av begrepet, uten noe mer", "En figur som illustrerer begrepet grafisk, med aksene navngitt", "En matematisk utledning som viser begrepet formelt"],
    ...
    },
    {
      ...
      options: ["$\\Delta T = -25$ og $\\Delta B = -25$ — budsjettet forverres", "$\\Delta T = -25$ og $\\Delta B = +25$ — budsjettet bedres", "$\\Delta T = -100$ og $\\Delta B = -100$ — skatten følger BNP krone for krone", "$\\Delta T = 0$ og $\\Delta B = 0$, siden $G$ er uendret"],
    ...
    },
    {
      ...
      options: ["Bare skatteinngangen endres ($\\Delta G = 0$), så balansen følger $\\Delta T$ alene", "Fordi budsjettbalansen alltid forverres like mye som BNP faller ved negative sjokk", "Fordi skattesatsen $t$ er større enn den marginale konsumtilbøyeligheten $c_1$", "Fordi multiplikatoren $m$ blir negativ når sjokket er negativt"],
    ...
    },
    {
      ...
      options: ["IS skifter mot venstre; RR og PK ligger fast", "RR og PK skifter begge opp, mens IS-kurven ligger fast", "Både IS-kurven og RR-kurven skifter mot venstre", "PK skifter opp, mens IS-kurven og RR-kurven ligger fast"],
    ...
    },
    {
      ...
      options: ["Den reagerer bare gradvis langs RR og veier også inflasjonshensynet", "Rentekuttet virker ikke på konsumet eller investeringene i det hele tatt", "Renten er allerede ved nullgrensen og kan derfor ikke kuttes videre", "RR-kurven skifter nøyaktig like mye som IS-kurven, så effekten nulles ut"],
    ...
    },
    {
      ...
      options: ["Korrekt algebra, eksplisitt fortegn og mekanismeforklaring i to lag", "Korrekt tallsvar med tydelig oppstilling og riktig benevning alene", "En figur som viser skiftet i begge paneler med A og B markert", "Kontrollregning av svaret med to uavhengige metoder som gir samme tall"],
    ...
    },
    {
      ...
      options: ["Den er tillatt (fast fra 2021), men gir ingen uttelling alene", "Den er obligatorisk for å oppnå full skår på drøftingsoppgaven", "Den er forbudt i drøftinger og gir trekk hvis den tas med", "Den erstatter kravet om korrekte fagbegreper i drøftingen"],
    ...
    },
    {
      ...
      options: ["Høyere aktivitet gir større kapasitetsbehov og lettere finansiering (akseleratoren)", "Høyere rente gir alltid høyere investeringer fordi bankene tjener mer", "Investeringene er upåvirket av konjunkturene og bestemmes bare av renten på lang sikt", "Bedriftene investerer mer når skatteinngangen til staten øker"],
    ...
    },
    {
      ...
      options: ["Nevneren $1 - c_1(1-t) - b_1$ må være positiv, slik at $m > 0$", "Multiplikatoren $m$ må være mindre enn 1 for at prosessen skal konvergere", "Skattesatsen $t$ må være lik null for at modellen skal ha en løsning", "Konsumtilbøyeligheten $c_1$ må være større enn 1 i likevekt"],
  ...
  'econ1310-7-3': [
    {
      ...
      options: ["Skillet mellom etterspørsels- og kostnadssjokk", "Evnen til å huske handlingsregelens prosentsats presist", "Antall figurer og diagrammer i besvarelsen totalt sett", "Hvor raskt kortsvarsoppgaven i starten besvares"],
    ...
    },
    {
      ...
      options: ["Kategori, beløp og en kort begrunnelse", "Kun et tydelig ja eller nei per transaksjon", "Kategori og en lengre teoretisk utledning", "Beløp og en figur som viser strømmene"],
    ...
    },
    {
      ...
      options: ["Realinvestering på 6 mill. kr — nyprodusert realkapital inngår i BNP", "Privat konsum på 6 mill. kr, siden familien selv skal bo i boligen", "Utenfor BNP — boligkjøp er en ren formuesomplassering mellom sektorer", "Import på 6 mill. kr, siden byggevarene som regel er utenlandske"],
    ...
    },
    {
      ...
      options: ["Bare kurtasjen på 300 kr, som betaler for en produsert meglertjeneste", "Hele beløpet på 50 300 kr — både aksjene og tjenesten er kjøpt i perioden", "Ingenting — begge delene er finansielle transaksjoner utenfor BNP", "Bare aksjekjøpet på 50 000 kr, ført som konsum av verdipapirer"],
    ...
    },
    {
      ...
      options: ["Null — konsumet ($+8\\,000$) motsvares av import ($-8\\,000$)", "$+8\\,000$ kr, ført som privat konsum i nasjonalregnskapet", "$-8\\,000$ kr, siden pengene forlater landet for godt", "$+8\\,000$ kr, ført som eksport av reisetjenester til utlandet"],
    ...
    },
    {
      ...
      options: ["Arbeidet er utenfor BNP; malingen ble talt da den ble produsert og solgt", "Både arbeidet og malingen gir nye bidrag til BNP i inneværende år", "Arbeidet verdsettes til markedspris for tilsvarende malertjenester og inngår", "Malingen trekkes fra BNP som et mellomprodukt i husholdningens produksjon"],
    ...
    },
    {
      ...
      options: ["Priskurven er flat (uavhengig av $u$); lønnskurven faller i $u$", "Begge kurvene stiger med økende ledighet $u$ i diagrammet", "Priskurven faller i $u$, mens lønnskurven er flat og uavhengig av ledigheten", "Begge kurvene er flate, men de ligger på ulike reallønnsnivåer"],
    ...
    },
    {
      ...
      options: ["Skjæringspunktet mellom lønnskurven og priskurven", "Skjæringspunktet mellom IS-kurven og RR-kurven", "Det ledighetsnivået der inflasjonen er lik null", "Sentralbankens vekter $d_1$ og $d_2$ i renteregelen"],
    ...
    },
    {
      ...
      options: ["Lønnskurven skifter opp; priskurven ligger fast", "Priskurven skifter opp, mens lønnskurven ligger fast i diagrammet", "Begge kurvene skifter opp nøyaktig like mye samtidig", "Ingen av kurvene — bare ledigheten $u$ endres langs kurvene"],
    ...
    },
    {
      ...
      options: ["Bedriftene hever prisene når lønningene stiger, så reallønnen faller tilbake", "Lovverket setter et tak på hvor høy reallønnen i økonomien kan bli", "Sentralbanken fastsetter reallønnen direkte gjennom renteregelen på lang sikt", "Produktiviteten $A$ faller automatisk like mye som lønningene stiger"],
    ...
    },
    {
      ...
      options: ["Å konkludere med varig høyere reallønn", "Å la priskurven ligge fast i diagrammet", "Å konkludere med at likevektsledigheten stiger", "Å tegne lønnskurven fallende i ledigheten"],
    ...
    },
    {
      ...
      options: ["En del av hver inntektsøkning lekker ut til import i stedet for innenlandsk etterspørsel", "Eksporten faller alltid automatisk når BNP stiger, slik at nettoeksporten demper alle sjokk", "Skattesatsen er systematisk høyere i åpne økonomier enn i lukkede", "Valutakursen nøytraliserer alle etterspørselssjokk i en åpen økonomi"],
    ...
    },
    {
      ...
      options: ["PK skifter opp med $\\Delta z^\\pi$ og RR opp med $d_1\\Delta z^\\pi$; IS ligger fast", "Bare IS skifter — mot venstre, fordi dyrere import svekker etterspørselen", "Bare PK skifter opp; RR og IS ligger fast fordi renteregelen ikke reagerer på sjokket", "Alle tre kurvene skifter opp med nøyaktig samme beløp"],
    ...
    },
    {
      ...
      options: ["BNP faller mindre, men inflasjonen stiger mer", "BNP faller mer, og inflasjonen stiger også mer", "Både BNP og inflasjonen holdes helt uendret", "BNP faller mindre, og inflasjonen stiger mindre"],
    ...
    },
    {
      ...
      options: ["Etterlevelse av rammen, et representativt frontfag og et felles troverdig tallgrunnlag", "At reallønnen stiger varig i alle sektorer samtidig, slik at ingen taper på rammen", "At sentralbanken fastsetter lønnsrammen for partene i hvert eneste oppgjør", "At frontfaget hentes fra skjermet sektor med stabil lønnsomhet og forutsigbare rammer"],
  ...
  'econ1310-7-4': [
    {
      ...
      options: ["Differensiert deloppgavevekting — (b), (c) og (e) i modelloppgaven teller særlig mye", "Alle deloppgavene teller nøyaktig like mye, slik at tiden bør fordeles helt jevnt utover", "Kortsvarsoppgaven teller mest av de tre oppgavene og skal derfor ha mest tid", "Rollecaset teller 60 % og modelloppgaven 20 %, så caset skal prioriteres"],
    ...
    },
    {
      ...
      options: ["Alle relevante hensyn for og imot — men uttrykkelig ingen konkret anbefaling", "En tydelig anbefaling med utfyllende begrunnelse for det valgte virkemiddelet", "En matematisk modellering av situasjonen i caset med utledninger", "Et fullstendig IS-RR-PK-diagram med begge paneler og skift markert"],
    ...
    },
    {
      ...
      options: ["Alt som produseres, blir konsumert, investert eller kjøpt av det offentlige", "At statsbudsjettets balanse alltid er lik null i en lukket økonomi", "At BNP er summen av alle inntekter i økonomien fratrukket skatter og overføringer", "At produksjonen bestemmes av tilbudssiden alene på lang sikt"],
    ...
    },
    {
      ...
      options: ["Realinvestering (nyprodusert realkapital) inngår; finansinvestering (formuesomplassering) står utenfor", "Begge typer inngår i BNP med sitt fulle transaksjonsbeløp, siden begge er investeringer gjort i perioden", "Finansinvestering inngår i BNP fordi den gir avkastning, mens realinvestering står utenfor", "Ingen av dem inngår i BNP — investeringer regnes ikke som produksjon"],
    ...
    },
    {
      ...
      options: ["Ett prosentpoeng høyere rente demper samlet etterspørsel med 15 mrd. kr", "Renten kan maksimalt heves med 15 prosentpoeng i løpet av modellperioden", "Multiplikatoren i modellen er lik 15 når renten holdes fast", "Konsumet og investeringene utgjør til sammen 15 % av BNP i utgangspunktet"],
    ...
    },
    {
      ...
      options: ["$3{,}33 \\cdot 45 = 150$ mrd.", "$45$ mrd. — satsingen virker krone for krone", "$0{,}3 \\cdot 45 = 13{,}5$ mrd.", "$2{,}22 \\cdot 45 \\approx 100$ mrd."],
    ...
    },
    {
      ...
      options: ["Økt skatteinngang trekker balansen opp, utgiftsøkningen trekker den ned — utfallet avhenger av parameterne", "Budsjettbalansen $B$ inngår ikke som størrelse i modellen og kan derfor ikke beregnes uten mer informasjon", "Skatten er eksogen i modellen og påvirkes derfor ikke av at BNP endres gjennom multiplikatorrundene", "Multiplikatoren kan være både positiv og negativ ved en økning i offentlige kjøp"],
    ...
    },
    {
      ...
      options: ["IS skifter mot høyre; RR og PK ligger fast — $Y\\uparrow$, $i\\uparrow$, $\\pi\\uparrow$", "RR skifter opp; IS ligger fast — $Y\\downarrow$ og $i\\uparrow$, som ved et kostnadssjokk", "PK skifter opp; IS og RR ligger begge fast — bare $\\pi$ endres", "IS skifter mot venstre — $Y\\downarrow$, $i\\downarrow$ og $\\pi\\downarrow$"],
    ...
    },
    {
      ...
      options: ["BNP — etterspørselssjokket løfter $Y$, kostnadssjokket demper $Y$", "Inflasjonen — etterspørselssjokket trekker $\\pi$ opp, kostnadssjokket ned", "Renten — det ene sjokket trekker $i$ opp, det andre trekker den ned", "Ingen — begge sjokkene trekker alle størrelsene samme vei"],
    ...
    },
    {
      ...
      options: ["Som to sjokk — hver for seg først, deretter lagt sammen", "Som ett samlet nettosjokk helt fra begynnelsen av analysen", "Bare det største av de to sjokkene skal analyseres i diagrammet", "Ved å regne ut multiplikatoren på nytt for hvert av sjokkene"],
    ...
    },
    {
      ...
      options: ["$\\Delta i = 45/15 = 3$ prosentpoeng", "$\\Delta i = 15/45 \\approx 0{,}33$ prosentpoeng", "$\\Delta i = 3{,}33 \\cdot 3 = 10$ prosentpoeng", "$\\Delta i = 150/15 = 10$ prosentpoeng"],
    ...
    },
    {
      ...
      options: ["Et negativt etterspørselssjokk (bolig/gjeld) kombinert med et kostnadssjokk (svak valuta)", "Et rent positivt etterspørselssjokk fra boligmarkedet som løfter både produksjonen og prisene", "Et rent kostnadssjokk uten noen etterspørselskomponent i det hele tatt", "Et positivt potensialsjokk som løfter $Y^n$ varig gjennom økt arbeidsstyrke"],
    ...
    },
    {
      ...
      options: ["Både renteøkning (gjeldsbyrde, boligprisfall) og for lav rente (ny gjeldsoppbygging) er risikable", "Gjelden gjør at renteendringer ikke lenger virker på husholdningenes etterspørsel i det hele tatt", "Høy gjeld innebærer at renten må settes til null umiddelbart for å unngå mislighold", "Gjelden er bare relevant for finanspolitikken og angår ikke pengepolitikken"],
    ...
    },
    {
      ...
      options: ["De demper nedgangen løpende uten vedtaks- og virkningslag", "De bringer inflasjonen tilbake til målet umiddelbart uten vedtak", "De styrker valutakursen direkte gjennom skattesystemets utforming", "De reduserer husholdningenes gjeld automatisk over tid"],
    ...
    },
    {
      ...
      options: ["Åpenbart gale politikkvalg — som kraftig ekspansjon uten å nevne inflasjonsrisikoen", "Å drøfte både fordeler og ulemper ved hvert av de finanspolitiske handlingsalternativene", "Å trekke inn liten-åpen-økonomi-perspektivet med valutakurskanalen i drøftingen", "Å omtale finansiell stabilitet som et selvstendig hensyn i notatet"],
