...
Denne perioden la grunnlaget for alt som skulle komme. Nar vi leser romantikkens dikt i dag, horer vi ekkoet av et folk som sokte sin egen stemme.`,
    },
    {
      ...
      exercise: {
        ...
        task: 'Test deg selv paa romantikkens lyrikk:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          { id: 'norsk-vg3-4-1-n-quiz1-q0', task: 'Hva kjennetegnet lyrikken i romantikken?', options: [{ id: 'a', text: 'Fri vers uten rim og rytme', isCorrect: false }, { id: 'b', text: 'Fast form med rim og rytme, nasjonale og romantiske temaer', isCorrect: true }, { id: 'c', text: 'Politisk agitasjon og arbeiderdikt', isCorrect: false }, { id: 'd', text: 'Eksperimentell spraklek og fragmentering', isCorrect: false }], solution: 'Romantikkens lyrikk var preget av fast form med rim og rytme. Temaene var ofte nasjonale og romantiske, med fokus paa natur, folkeeventyr og nasjonal identitet.' },
          { id: 'norsk-vg3-4-1-n-quiz1-q1', task: 'Hva var forskjellen mellom Wergelands og Welhavens dikterstil?', options: [{ id: 'a', text: 'Wergeland var vilt entusiastisk, Welhaven var elegant og behersk', isCorrect: true }, { id: 'b', text: 'Begge skrev helt likt', isCorrect: false }, { id: 'c', text: 'Welhaven var den viltre og Wergeland den rolige', isCorrect: false }, { id: 'd', text: 'Ingen av dem skrev lyrikk', isCorrect: false }], solution: 'Wergeland var den viltre entusiasten med dikt fulle av foelelser og kraft, mens Welhaven var den elegante klassisisten som soekte form, balanse og harmoni.' },
        ],
      },
    },
    {
...
Formen losner litt. Rimene er der fortsatt, men rytmen blir friere. Dikterne begynner a eksperimentere. Noe nytt er pa vei.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 2',
        type: 'multiple-choice',
        task: 'Test deg selv paa realismen og nyromantikken:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          { id: 'norsk-vg3-4-1-n-quiz2-q0', task: 'Hva skjedde med lyrikken i realismens tid (1850-1890)?', options: [{ id: 'a', text: 'Den ble den dominerende sjangeren', isCorrect: false }, { id: 'b', text: 'Den tapte terreng for prosa og drama', isCorrect: true }, { id: 'c', text: 'Den ble forbudt av myndighetene', isCorrect: false }, { id: 'd', text: 'Den ble kun skrevet paa nynorsk', isCorrect: false }], solution: 'I realismens periode tapte lyrikken terreng for prosa og drama. Forfattere som Ibsen, Bjornson, Kielland og Lie dominerte med sine romaner og skuespill.' },
          { id: 'norsk-vg3-4-1-n-quiz2-q1', task: 'Hvem skrev det beroemte diktet "Jeg ser" og pekte fremover mot modernismen?', options: [{ id: 'a', text: 'Vilhelm Krag', isCorrect: false }, { id: 'b', text: 'Henrik Ibsen', isCorrect: false }, { id: 'c', text: 'Sigbjorn Obstfelder', isCorrect: true }, { id: 'd', text: 'Bjornstjerne Bjornson', isCorrect: false }], solution: 'Sigbjorn Obstfelder skrev "Jeg ser" - et beroomt dikt om fremmedgjoring som pekte fremover mot modernismen med sin symbolske, gatefull stil.' },
        ],
      },
    },
    {
...
Etter modernismen kommer lyrikken aldri tilbake til det den var. Doren er apnet for uendelig mangfold.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 3',
        type: 'multiple-choice',
        task: 'Test deg selv paa modernismens gjennombrudd:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          { id: 'norsk-vg3-4-1-n-quiz3-q0', task: 'Naar kom det modernistiske gjennombruddet i norsk lyrikk for alvor?', options: [{ id: 'a', text: 'Paa 1910-tallet', isCorrect: false }, { id: 'b', text: 'Paa 1930-tallet', isCorrect: false }, { id: 'c', text: 'Paa 1950-tallet', isCorrect: true }, { id: 'd', text: 'Paa 1970-tallet', isCorrect: false }], solution: 'Det brede gjennombruddet for modernistisk lyrikk i Norge kom paa 1950-tallet, selv om Rolf Jacobsen debuterte med modernistiske dikt allerede i 1933.' },
          { id: 'norsk-vg3-4-1-n-quiz3-q1', task: 'Hvem debuterte i 1933 med dikt om fabrikker og maskiner?', options: [{ id: 'a', text: 'Olav H. Hauge', isCorrect: false }, { id: 'b', text: 'Rolf Jacobsen', isCorrect: true }, { id: 'c', text: 'Jan Erik Vold', isCorrect: false }, { id: 'd', text: 'Georg Johannesen', isCorrect: false }], solution: 'Rolf Jacobsen debuterte i 1933 med samlingen "Jord og jern" - dikt om fabrikker, maskiner og byer. Det var helt nye temaer i norsk lyrikk, skrevet paa fri vers.' },
        ],
      },
    },
    {
...
Denne modellen er ikke en tvangstroye. Den er et kart. Noen ganger tar du snarveier, andre ganger utforsker du omveier. Men kartet hjelper deg a finne vei inn i diktets landskap.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 4',
        type: 'multiple-choice',
        task: 'Test deg selv paa diktanalyse:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          { id: 'norsk-vg3-4-1-n-quiz4-q0', task: 'Hva boer vaere det foerste steget i en diktanalyse?', options: [{ id: 'a', text: 'Telle antall rim og strofer', isCorrect: false }, { id: 'b', text: 'Slaa opp forfatterens biografi', isCorrect: false }, { id: 'c', text: 'Lese diktet og notere foersteinntrykket', isCorrect: true }, { id: 'd', text: 'Skrive konklusjonen foerst', isCorrect: false }], solution: 'En god diktanalyse starter med foersteinntrykket. Les diktet hoeyt, opplev det, og noter hvilken stemning det skaper.' },
          { id: 'norsk-vg3-4-1-n-quiz4-q1', task: 'Hva er forskjellen mellom tema og motiv i et dikt?', options: [{ id: 'a', text: 'De er det samme', isCorrect: false }, { id: 'b', text: 'Tema er det diktet handler om paa overflaten, motiv er de konkrete bildene', isCorrect: true }, { id: 'c', text: 'Motiv er viktigere enn tema', isCorrect: false }, { id: 'd', text: 'Tema er alltid kjaerlighet', isCorrect: false }], solution: 'Tema er det diktet handler om paa et overordnet nivaa, mens motiv er de konkrete bildene og situasjonene dikteren bruker for aa uttrykke temaet.' },
        ],
      },
    },
    {
...
Nar du leser et dikt, deltar du i en tradisjon som strekker seg tusenvis av ar tilbake. Og nar du selv skriver - kanskje bare noen linjer i en dagbok - fortsetter du den tradisjonen. Lyrikken tilhorer alle som vil lytte til sprakets musikk.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 5',
        type: 'multiple-choice',
        task: 'Test deg selv paa samtidens lyrikk:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          { id: 'norsk-vg3-4-1-n-quiz5-q0', task: 'Hva kjennetegner samtidens lyrikk?', options: [{ id: 'a', text: 'Alle diktere maa foelge strenge formkrav', isCorrect: false }, { id: 'b', text: 'Lyrikk eksisterer ikke lenger som sjanger', isCorrect: false }, { id: 'c', text: 'Stort mangfold der ulike former eksisterer side om side', isCorrect: true }, { id: 'd', text: 'Kun digital poesi er akseptert', isCorrect: false }], solution: 'Samtidens lyrikk preges av stort mangfold. Tradisjonelle former lever side om side med eksperimentell lyrikk, slam poetry, raplyrikk og digital poesi.' },
          { id: 'norsk-vg3-4-1-n-quiz5-q1', task: 'Hvilke nye former har lyrikken funnet utenfor boken?', options: [{ id: 'a', text: 'Slam poetry, raplyrikk og sosiale medier', isCorrect: true }, { id: 'b', text: 'Bare tradisjonelle opplesninger', isCorrect: false }, { id: 'c', text: 'Lyrikken finnes kun i boeker', isCorrect: false }, { id: 'd', text: 'Bare filmmanuskripter', isCorrect: false }], solution: 'Lyrikken har funnet nye former utenfor boken: slam poetry bringer diktet tilbake til muntlig fremfoering, raplyrikk kombinerer ord med musikk, og sosiale medier gir diktere nye plattformer.' },
        ],
      },
    },
    {
...
Men disse forloperne ble ikke umiddelbart anerkjent som det de var. Det tok tid for det norske litteraere miljoet a forstatte hva de holdt pa med. Forst etter krigen skulle modernismen virkelig bryte gjennom.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 1',
        type: 'multiple-choice',
        task: 'Test deg selv paa forloeperne:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          { id: 'norsk-vg3-4-2-n-quiz1-q0', task: 'Hvem regnes som den foerste modernisten i norsk lyrikk?', options: [{ id: 'a', text: 'Henrik Wergeland', isCorrect: false }, { id: 'b', text: 'Rolf Jacobsen', isCorrect: true }, { id: 'c', text: 'Jan Erik Vold', isCorrect: false }, { id: 'd', text: 'Olav H. Hauge', isCorrect: false }], solution: 'Rolf Jacobsen regnes som den foerste modernisten i norsk lyrikk. Hans debut "Jord og jern" i 1933 var banebrytende med dikt om teknologi og byliv skrevet paa fri vers.' },
          { id: 'norsk-vg3-4-2-n-quiz1-q1', task: 'Hvorfor regnes Sigbjorn Obstfelder som en forloeper for modernismen?', options: [{ id: 'a', text: 'Han skrev kun prosa', isCorrect: false }, { id: 'b', text: 'Han fanget en foelelse av fremmedgjoering som ble sentral i modernismen', isCorrect: true }, { id: 'c', text: 'Han grunnla et forlag', isCorrect: false }, { id: 'd', text: 'Han skrev kun paa nynorsk', isCorrect: false }], solution: 'Obstfelder fanget i diktet "Jeg ser" en foelelse av aa staa utenfor og ikke passe inn, som skulle bli sentral i modernismen. Hans symbolske, gatefull stil pekte fremover.' },
        ],
      },
    },
    {
...
Debatten raste i aviser og tidsskrifter. Men gradvis vant modernismen terreng. Nye tidsskrifter og forlag ga plass til eksperimentell lyrikk. En ny generasjon lesere vokste opp med andre forventninger til hva et dikt kunne vaere.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 2',
        type: 'multiple-choice',
        task: 'Test deg selv paa gjennombruddet:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          { id: 'norsk-vg3-4-2-n-quiz2-q0', task: 'Hva var Paal Brekkes rolle i det modernistiske gjennombruddet?', options: [{ id: 'a', text: 'Han var hovedkritikeren av modernismen', isCorrect: false }, { id: 'b', text: 'Han introduserte europeisk modernisme for norske lesere', isCorrect: true }, { id: 'c', text: 'Han grunnla den foerste litteraturfestivalen', isCorrect: false }, { id: 'd', text: 'Han skrev kun tradisjonelle dikt med rim', isCorrect: false }], solution: 'Paal Brekke oversatte og introduserte europeiske modernister som T.S. Eliot og Ezra Pound, og argumenterte for fornyelse av lyrikken.' },
          { id: 'norsk-vg3-4-2-n-quiz2-q1', task: 'Hvem var blant kritikerne av modernistisk lyrikk?', options: [{ id: 'a', text: 'Jan Erik Vold', isCorrect: false }, { id: 'b', text: 'Rolf Jacobsen', isCorrect: false }, { id: 'c', text: 'Arnulf Oeverland', isCorrect: true }, { id: 'd', text: 'Olav H. Hauge', isCorrect: false }], solution: 'Arnulf Oeverland, den store arbeiderdikteren, var blant kritikerne av modernismen. Han mente at diktning maatte kommunisere med vanlige folk, og at modernistenes eksperimenter var elitistiske.' },
        ],
      },
    },
    {
...
Alt dette kan gjore modernistisk lyrikk krevende a lese. Men det kan ogsa gjore den utrolig rik nar man forst kommer inn i den.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 3',
        type: 'multiple-choice',
        task: 'Test deg selv paa kjennetegn ved modernistisk lyrikk:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          { id: 'norsk-vg3-4-2-n-quiz3-q0', task: 'Hva er "fri vers"?', options: [{ id: 'a', text: 'Dikt som handler om frihet', isCorrect: false }, { id: 'b', text: 'Dikt uten fast rim eller rytme', isCorrect: true }, { id: 'c', text: 'Dikt som er gratis aa lese', isCorrect: false }, { id: 'd', text: 'Dikt skrevet paa dialekt', isCorrect: false }], solution: 'Fri vers er dikt uten fast rim eller rytme. Linjelengden varierer, og rytmen foelger innholdet fremfor en fast oppskrift.' },
          { id: 'norsk-vg3-4-2-n-quiz3-q1', task: 'Hva betyr det at modernistiske dikt bruker fragmentering?', options: [{ id: 'a', text: 'At diktet er oedelagt', isCorrect: false }, { id: 'b', text: 'At diktet hopper i tid og rom uten tydelige overganger', isCorrect: true }, { id: 'c', text: 'At diktet har mange fotnoter', isCorrect: false }, { id: 'd', text: 'At diktet er skrevet av flere forfattere', isCorrect: false }], solution: 'Fragmentering betyr at diktet kan hoppe i tid og rom, bryte av midt i setninger og stille ulike elementer mot hverandre uten tydelige overganger. Dette speiler den moderne bevissthetens oppsplitting.' },
        ],
      },
    },
    {
...
Disse dikterne er svart forskjellige, men de deler en vilje til a utforske, utfordre og fornye. De viste at modernismen ikke var en stil, men en holdning.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 4',
        type: 'multiple-choice',
        task: 'Test deg selv paa de store modernistene:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          { id: 'norsk-vg3-4-2-n-quiz4-q0', task: 'Hva kjennetegner Olav H. Hauges lyrikk?', options: [{ id: 'a', text: 'Lange, kompliserte dikt om byliv', isCorrect: false }, { id: 'b', text: 'Korte, enkle dikt inspirert av japansk haiku', isCorrect: true }, { id: 'c', text: 'Politiske agitasjonsdikt', isCorrect: false }, { id: 'd', text: 'Dikt skrevet kun paa bokmaal', isCorrect: false }], solution: 'Olav H. Hauge er kjent for korte, enkle men dype dikt inspirert av japansk haiku og kinesisk lyrikk. Han viser at modernisme ogsaa kan bety aa skrape bort alt overfloedig.' },
          { id: 'norsk-vg3-4-2-n-quiz4-q1', task: 'Hvem braakte humor, ironi og intellektuell lek inn i modernismen?', options: [{ id: 'a', text: 'Rolf Jacobsen', isCorrect: false }, { id: 'b', text: 'Georg Johannesen', isCorrect: true }, { id: 'c', text: 'Paal Brekke', isCorrect: false }, { id: 'd', text: 'Paal-Helge Haugen', isCorrect: false }], solution: 'Georg Johannesen braakte humor, ironi og intellektuell lek inn i modernismen. Han var opptatt av retorikk og maktspraak, og diktene hans utfordrer leseren paa stadig nye maater.' },
        ],
      },
    },
    {
...
Nar du leser et moderne dikt, moter du alltid ekkoen av den kampen som ble utkjempet pa 1950-tallet - kampen for lyrikkens frihet til a utforske alle muligheter.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 5',
        type: 'multiple-choice',
        task: 'Test deg selv paa modernismens arv:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          { id: 'norsk-vg3-4-2-n-quiz5-q0', task: 'Hva er modernismens viktigste arv til senere norsk lyrikk?', options: [{ id: 'a', text: 'At alle dikt maa skrives paa fri vers', isCorrect: false }, { id: 'b', text: 'At lyrikk bare kan handle om byliv', isCorrect: false }, { id: 'c', text: 'Friheten til aa velge form og eksperimentere', isCorrect: true }, { id: 'd', text: 'At dikt ikke lenger kan ha rim', isCorrect: false }], solution: 'Modernismens viktigste arv er friheten til aa velge form. Etter gjennombruddet kunne diktere velge fritt mellom aa eksperimentere eller foelge tradisjonen.' },
          { id: 'norsk-vg3-4-2-n-quiz5-q1', task: 'Hvorfor ble modernismen kritisert?', options: [{ id: 'a', text: 'Den var for enkel', isCorrect: false }, { id: 'b', text: 'Den var for elitistisk og vanskelig tilgjengelig', isCorrect: true }, { id: 'c', text: 'Den handlet bare om kjaerlighet', isCorrect: false }, { id: 'd', text: 'Den var for kort', isCorrect: false }], solution: 'Modernismen ble kritisert for aa vaere for elitistisk og vanskelig tilgjengelig. Paa 1960-70-tallet kom reaksjoner i form av mer politisk engasjert lyrikk som ville naa ut til folk.' },
        ],
      },
    },
    {
...
Hauge slet med psykisk sykdom gjennom perioder av livet. Han var sjenert og tilbaketrukket. Men gjennom diktene kommuniserte han med verden. Da han doede i 1994, etterlot han seg noen av de mest elskede diktene i norsk litteratur.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 1',
        type: 'multiple-choice',
        task: 'Test deg selv paa Olav H. Hauge:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          { id: 'norsk-vg3-4-3-n-quiz1-q0', task: 'Hva var Olav H. Hauges yrke ved siden av aa vaere dikter?', options: [{ id: 'a', text: 'Journalist', isCorrect: false }, { id: 'b', text: 'Laerer', isCorrect: false }, { id: 'c', text: 'Fruktbonde', isCorrect: true }, { id: 'd', text: 'Prest', isCorrect: false }], solution: 'Olav H. Hauge var fruktbonde i Ulvik i Hardanger. Han dyrket epler og annen frukt, og dette fysiske arbeidet preger bildene i diktene hans.' },
          { id: 'norsk-vg3-4-3-n-quiz1-q1', task: 'Hva var spesielt med Hauges bakgrunn som leser?', options: [{ id: 'a', text: 'Han leste bare norsk litteratur', isCorrect: false }, { id: 'b', text: 'Han var selvlaert og leste paa flere spraak - engelsk, tysk, fransk og kinesisk', isCorrect: true }, { id: 'c', text: 'Han leste aldri boeker', isCorrect: false }, { id: 'd', text: 'Han leste bare aviser', isCorrect: false }], solution: 'Hauge var selvlaert og leste paa flere spraak - engelsk, tysk, fransk og kinesisk. Han oversatte dikt fra hele verden, og biblioteket hans i den lille stuen i Ulvik var enormt.' },
        ],
      },
    },
    {
...
Dette er Hauges mesterskap: a si det universelle med de enkleste ord.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 2',
        type: 'multiple-choice',
        task: 'Test deg selv paa "Det er den draumen":',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          { id: 'norsk-vg3-4-3-n-quiz2-q0', task: 'Hvilket virkemiddel er sentralt i diktet "Det er den draumen"?', options: [{ id: 'a', text: 'Rim og fast rytme', isCorrect: false }, { id: 'b', text: 'Gjentakelse ("skal opna seg")', isCorrect: true }, { id: 'c', text: 'Ironi og sarkasme', isCorrect: false }, { id: 'd', text: 'Lange, kompliserte setninger', isCorrect: false }], solution: 'Diktet bygger paa gjentakelse av "skal opna seg" med ulike subjekter: tid, hjerte, doerer, berg, kilder. Denne anaforen skaper en stigende bevegelse mot sluttbildet.' },
          { id: 'norsk-vg3-4-3-n-quiz2-q1', task: 'Hva handler diktet "Det er den draumen" om?', options: [{ id: 'a', text: 'Om aa soeve godt', isCorrect: false }, { id: 'b', text: 'Om lengsel og haapet om at noe vidunderlig skal skje', isCorrect: true }, { id: 'c', text: 'Om aa faa en ny jobb', isCorrect: false }, { id: 'd', text: 'Om barndommen', isCorrect: false }], solution: 'Diktet handler om lengsel - en allment menneskelig lengsel om at noe vidunderlig skal skje. Hauge fanger denne foelelsen i et spraak som er saa enkelt at alle kan forstaa det.' },
        ],
      },
    },
    {
...
Jacobsen skrev pa fri vers, uten rim, men med en rytme som folger innholdet. Diktene hans er tilgjengelige - de krever ikke spesialkunnskap for a bli forstatt. Men under den enkle overflaten ligger dybde.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 3',
        type: 'multiple-choice',
        task: 'Test deg selv paa Rolf Jacobsen:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          { id: 'norsk-vg3-4-3-n-quiz3-q0', task: 'Hva var nytt og banebrytende med Jacobsens debutsamling "Jord og jern"?', options: [{ id: 'a', text: 'Den var skrevet paa nynorsk', isCorrect: false }, { id: 'b', text: 'Den handlet om fabrikker, maskiner og det moderne bylivet', isCorrect: true }, { id: 'c', text: 'Den var den foerste diktsamlingen i Norge', isCorrect: false }, { id: 'd', text: 'Den brukte kun tradisjonelle rim', isCorrect: false }], solution: 'Jacobsens "Jord og jern" (1933) handlet om teknologi, fabrikker og byer - helt nye temaer i norsk lyrikk. Tittelen peker paa kombinasjonen av natur og industri.' },
          { id: 'norsk-vg3-4-3-n-quiz3-q1', task: 'Hvordan endret Jacobsens syn paa teknologi seg over tid?', options: [{ id: 'a', text: 'Han ble stadig mer entusiastisk', isCorrect: false }, { id: 'b', text: 'Han mistet interessen helt', isCorrect: false }, { id: 'c', text: 'Han ble ogsaa mer kritisk til teknologiens skadevirkninger', isCorrect: true }, { id: 'd', text: 'Han sluttet aa skrive om teknologi', isCorrect: false }], solution: 'Etter hvert ble Jacobsen mer kritisk til teknologiens skadevirkninger. Diktene reflekterer over forurensning, naturoedeleggelse og menneskelig fremmedgjoering.' },
        ],
      },
    },
    {
...
Men det som forener dem, er kanskje det viktigste: begge tar lyrikken pa alvor som kunstform. Begge arbeider med presisjon og omhu. Begge vet at et dikt ikke bare skal si noe - det skal fa leseren til a se, foele, oppleve. Og begge har skapt dikt som lever videre i norsk litteratur.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 4',
        type: 'multiple-choice',
        task: 'Test deg selv paa sammenligningen:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          { id: 'norsk-vg3-4-3-n-quiz4-q0', task: 'Paa hvilke spraak skrev Hauge og Jacobsen?', options: [{ id: 'a', text: 'Begge skrev paa bokmaal', isCorrect: false }, { id: 'b', text: 'Begge skrev paa nynorsk', isCorrect: false }, { id: 'c', text: 'Hauge paa nynorsk, Jacobsen paa bokmaal', isCorrect: true }, { id: 'd', text: 'Hauge paa bokmaal, Jacobsen paa nynorsk', isCorrect: false }], solution: 'Hauge skrev paa nynorsk og Jacobsen paa bokmaal. Spraakvalgene preger stilen: Hauges nynorsk gir en jordnaer, arkaisk tone, mens Jacobsens bokmaal foelger byens moderne rytme.' },
          { id: 'norsk-vg3-4-3-n-quiz4-q1', task: 'Hva er den tematiske forskjellen mellom Hauge og Jacobsen?', options: [{ id: 'a', text: 'Hauge skriver om naturen og det tidloese, Jacobsen om byen og det moderne', isCorrect: true }, { id: 'b', text: 'Begge skriver om det samme', isCorrect: false }, { id: 'c', text: 'Jacobsen skriver om natur, Hauge om byen', isCorrect: false }, { id: 'd', text: 'Ingen av dem skriver om natur', isCorrect: false }], solution: 'Hauge skriver om naturen, arbeidet i hagen, fjell og vann - tidloese temaer. Jacobsen skriver om byen, teknologi og det moderne livets tempo. De representerer to poler i norsk lyrikk.' },
        ],
      },
    },
    {
...
Nar du selv leser eller skriver dikt, kan du sporge: Er dette et "Hauge-dikt" eller et "Jacobsen-dikt"? Ikke fordi det ma vaere det ene eller det andre, men fordi det hjelper deg a se hvilke valg dikteren har gjort - og hvilke valg du selv kan gjore.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 5',
        type: 'multiple-choice',
        task: 'Test deg selv paa arven etter Hauge og Jacobsen:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          { id: 'norsk-vg3-4-3-n-quiz5-q0', task: 'Hva er den viktigste likheten mellom Hauge og Jacobsen?', options: [{ id: 'a', text: 'De skrev om de samme temaene', isCorrect: false }, { id: 'b', text: 'De bodde i samme by', isCorrect: false }, { id: 'c', text: 'Begge var mestere i det korte, pregnante diktet', isCorrect: true }, { id: 'd', text: 'De samarbeidet om alle diktene sine', isCorrect: false }], solution: 'Tross alle forskjeller var begge mestere i det korte, pregnante diktet. Begge skrapet bort det overfloedige og brukte bilder fremfor abstrakte forklaringer.' },
          { id: 'norsk-vg3-4-3-n-quiz5-q1', task: 'Naar doede baade Hauge og Jacobsen?', options: [{ id: 'a', text: '1984', isCorrect: false }, { id: 'b', text: '1994', isCorrect: true }, { id: 'c', text: '2004', isCorrect: false }, { id: 'd', text: '2014', isCorrect: false }], solution: 'Baade Hauge og Jacobsen doede i 1994, med bare noen maaneders mellomrom. De etterlot seg forfatterskap som har preget norsk lyrikk dypt.' },
        ],
      },
    },
    {
...
Dramaene hans spilles fortsatt over hele verden. De har pavirket dramatikere i generasjoner.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 1',
        type: 'multiple-choice',
        task: 'Test deg selv paa Ibsens drama:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          { id: 'norsk-vg3-4-4-n-quiz1-q0', task: 'Hva var radikalt med Ibsens dramaer?', options: [{ id: 'a', text: 'De var skrevet paa vers', isCorrect: false }, { id: 'b', text: 'De flyttet handlingen til borgerlige stuer med vanlige mennesker', isCorrect: true }, { id: 'c', text: 'De hadde bare en skuespiller', isCorrect: false }, { id: 'd', text: 'De varte i over ti timer', isCorrect: false }], solution: 'Ibsen broeyt med melodramaets overdrivelser ved aa flytte handlingen til borgerlige stuer der vanlige mennesker snakket om tilsynelatende hverdagslige ting.' },
          { id: 'norsk-vg3-4-4-n-quiz1-q1', task: 'Hvorfor kalles Ibsen "det moderne dramaets far"?', options: [{ id: 'a', text: 'Fordi han var den eldste dramatikeren', isCorrect: false }, { id: 'b', text: 'Fordi han skapte den realistiske dramatikken som forandret teatret for alltid', isCorrect: true }, { id: 'c', text: 'Fordi han grunnla Det Norske Teatret', isCorrect: false }, { id: 'd', text: 'Fordi han skrev de lengste stykkene', isCorrect: false }], solution: 'Ibsen skapte den realistiske dramatikken der vanlige mennesker snakket om virkelige problemer. Det forandret teatret for alltid og ble moenster for dramatikere over hele verden.' },
        ],
      },
    },
    {
...
Denne perioden var preget av mangfold - noen fulgte i Ibsens realistiske spor, andre eksperimenterte vilt.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 2',
        type: 'multiple-choice',
        task: 'Test deg selv paa norsk drama etter Ibsen:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          { id: 'norsk-vg3-4-4-n-quiz2-q0', task: 'Hva kjennetegnet norsk drama etter Ibsen?', options: [{ id: 'a', text: 'All dramatikk ble forbudt', isCorrect: false }, { id: 'b', text: 'Mangfold av stemmer og stiler', isCorrect: true }, { id: 'c', text: 'Kun komedier ble skrevet', isCorrect: false }, { id: 'd', text: 'Alle maatte kopiere Ibsen', isCorrect: false }], solution: 'Perioden etter Ibsen var preget av mangfold. Dramatikere representerte ulike stiler og temaer.' },
          { id: 'norsk-vg3-4-4-n-quiz2-q1', task: 'Hvem kombinerte politisk engasjement med dramatisk kraft i mellomkrigstiden?', options: [{ id: 'a', text: 'Gunnar Heiberg', isCorrect: false }, { id: 'b', text: 'Nordahl Grieg', isCorrect: true }, { id: 'c', text: 'Helge Krog', isCorrect: false }, { id: 'd', text: 'Cecilie Loeveid', isCorrect: false }], solution: 'Nordahl Grieg kombinerte politisk engasjement med dramatisk kraft i mellomkrigstiden. Han var en av flere stemmer som viderefoerte norsk dramatikk etter Ibsen.' },
        ],
      },
    },
    {
...
I 2023 mottok Fosse Nobelprisen for "hans nyskapande dramatikk og prosa som gjev stemme til det usigelege".`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 3',
        type: 'multiple-choice',
        task: 'Test deg selv paa Jon Fosse som dramatiker:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          { id: 'norsk-vg3-4-4-n-quiz3-q0', task: 'Hva kjennetegner Jon Fosses dramatiske stil?', options: [{ id: 'a', text: 'Lange dialoger med mye handling', isCorrect: false }, { id: 'b', text: 'Minimalistisk stil med korte, gjentatte fraser og pauser', isCorrect: true }, { id: 'c', text: 'Komedier med mange vitser', isCorrect: false }, { id: 'd', text: 'Historiske dramaer', isCorrect: false }], solution: 'Jon Fosses stil er minimalistisk med korte, gjentatte fraser. Det usagte og pausene er like viktige som ordene.' },
          { id: 'norsk-vg3-4-4-n-quiz3-q1', task: 'Hva handler "Nokon kjem til a komme" om?', options: [{ id: 'a', text: 'En kriminalhistorie', isCorrect: false }, { id: 'b', text: 'Et par som sitter i et hus og venter', isCorrect: true }, { id: 'c', text: 'Norsk historie', isCorrect: false }, { id: 'd', text: 'En komedieforestilling', isCorrect: false }], solution: '"Nokon kjem til a komme" (1996) handler om et par som sitter i et hus og venter. Det er nesten ikke handling i tradisjonell forstand, men spenningen er nesten uutholdelig.' },
        ],
      },
    },
    {
...
Til slutt: tematikken. Hva handler stykket egentlig om pa et dypere plan?`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 4',
        type: 'multiple-choice',
        task: 'Test deg selv paa dramaanalyse:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          { id: 'norsk-vg3-4-4-n-quiz4-q0', task: 'Hva er "undertekst" i dramaanalyse?', options: [{ id: 'a', text: 'Teksten paa en skjerm under forestillingen', isCorrect: false }, { id: 'b', text: 'Det karakterene egentlig mener, under ordene de sier', isCorrect: true }, { id: 'c', text: 'Fotnoter i manuskriptet', isCorrect: false }, { id: 'd', text: 'Regissoorens notater', isCorrect: false }], solution: 'Undertekst er det karakterene egentlig mener eller foeler, under ordene de faktisk sier. Meningen ligger mellom linjene.' },
          { id: 'norsk-vg3-4-4-n-quiz4-q1', task: 'Hva er det foerste steget i en dramaanalyse?', options: [{ id: 'a', text: 'Analysere sceneanvisningene', isCorrect: false }, { id: 'b', text: 'Se paa handling og struktur', isCorrect: true }, { id: 'c', text: 'Telle antall karakterer', isCorrect: false }, { id: 'd', text: 'Lese anmeldelser', isCorrect: false }], solution: 'Handling og struktur er foerste steg i en dramaanalyse. Hva skjer? Hvordan er stykket bygget opp? Er det vendepunkt og klimaks?' },
        ],
      },
    },
    {
...
Fra Ibsen til Fosse har norsk drama vist at det er mulig a utforske de dypeste menneskelige sporsmal pa en scene. Denne tradisjonen fortsetter.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 5',
        type: 'multiple-choice',
        task: 'Test deg selv paa dramaets fremtid:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          { id: 'norsk-vg3-4-4-n-quiz5-q0', task: 'Hvor mange nordmenn har mottatt Nobelprisen i litteratur?', options: [{ id: 'a', text: 'To', isCorrect: false }, { id: 'b', text: 'Tre', isCorrect: false }, { id: 'c', text: 'Fire', isCorrect: true }, { id: 'd', text: 'Fem', isCorrect: false }], solution: 'Fire nordmenn har mottatt Nobelprisen: Bjoernson (1903), Hamsun (1920), Undset (1928) og Fosse (2023).' },
          { id: 'norsk-vg3-4-4-n-quiz5-q1', task: 'Hva har det fysiske teatret som ingen skjerm kan erstatte?', options: [{ id: 'a', text: 'Bedre bilde', isCorrect: false }, { id: 'b', text: 'At det skjer her og naa, og at hver forestilling er unik', isCorrect: true }, { id: 'c', text: 'Billigere billetter', isCorrect: false }, { id: 'd', text: 'Lengre forestillinger', isCorrect: false }], solution: 'Det fysiske teatret har noe ingen skjerm kan erstatte: at det skjer her og naa, at hver forestilling er unik. Denne kvaliteten gjoer at dramaet fortsetter aa leve.' },
        ],
      },
    },
    {
...
Han debuterte i 1983, men det var som dramatiker han forst fikk internasjonalt gjennombrudd pa 1990-tallet. I 2012 konverterte han til katolisismen. Han skriver pa nynorsk - det er en del av stemmens klang.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 1',
        type: 'multiple-choice',
        task: 'Test deg selv paa Fosses bakgrunn:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          { id: 'norsk-vg3-4-5-n-quiz1-q0', task: 'Hvor vokste Jon Fosse opp?', options: [{ id: 'a', text: 'I Oslo', isCorrect: false }, { id: 'b', text: 'I Strandebarm i Hardanger', isCorrect: true }, { id: 'c', text: 'I Trondheim', isCorrect: false }, { id: 'd', text: 'I utlandet', isCorrect: false }], solution: 'Jon Fosse vokste opp i Strandebarm i Hardanger. Landskapet der - fjordene, fjellene - har preget forfatterskapet hans dypt.' },
          { id: 'norsk-vg3-4-5-n-quiz1-q1', task: 'Paa hvilket spraak skriver Fosse?', options: [{ id: 'a', text: 'Bokmaal', isCorrect: false }, { id: 'b', text: 'Nynorsk', isCorrect: true }, { id: 'c', text: 'Engelsk', isCorrect: false }, { id: 'd', text: 'Svensk', isCorrect: false }], solution: 'Fosse skriver paa nynorsk. Det er en del av stemmens klang og henger sammen med hans bakgrunn fra Hardanger.' },
        ],
      },
    },
    {
...
Korte setninger. Gjentakelser. Nesten ingenting skjer. Men spenningen bygger seg opp. Hvem kommer? Hvorfor venter de? Det usagte blir det viktigste.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 2',
        type: 'multiple-choice',
        task: 'Test deg selv paa Fosses dramatikk:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          { id: 'norsk-vg3-4-5-n-quiz2-q0', task: 'Hva er tittelen paa Fosses gjennombruddsdrama fra 1996?', options: [{ id: 'a', text: '"Et dukkehjem"', isCorrect: false }, { id: 'b', text: '"Nokon kjem til a komme"', isCorrect: true }, { id: 'c', text: '"Vildanden"', isCorrect: false }, { id: 'd', text: '"Septologien"', isCorrect: false }], solution: '"Nokon kjem til a komme" (1996) var Fosses gjennombruddsdrama. Et ungt par har kjoept et hus ved sjoeen og venter.' },
          { id: 'norsk-vg3-4-5-n-quiz2-q1', task: 'Hva er det viktigste elementet i Fosses dramaer?', options: [{ id: 'a', text: 'Mye action og dramatisk handling', isCorrect: false }, { id: 'b', text: 'Det usagte og pausene', isCorrect: true }, { id: 'c', text: 'Lange monologer', isCorrect: false }, { id: 'd', text: 'Historiske fakta', isCorrect: false }], solution: 'I Fosses dramaer er det usagte like viktig som det sagte. Korte setninger, gjentakelser og pauser bygger opp spenningen.' },
        ],
      },
    },
    {
...
Vi folger maleren Asle, som bor ved fjorden. Han har en dobbeltgjenger i byen. Gjennom tankestommer, minner og refleksjoner utforskes liv og dod, kunst og tro. Det er krevende, men dyp lesning.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 3',
        type: 'multiple-choice',
        task: 'Test deg selv paa Septologien:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          { id: 'norsk-vg3-4-5-n-quiz3-q0', task: 'Hva er spesielt med strukturen i Septologien?', options: [{ id: 'a', text: 'Den er skrevet som et drama', isCorrect: false }, { id: 'b', text: 'Den er skrevet som en lang setning uten punktum', isCorrect: true }, { id: 'c', text: 'Den har bare ti sider', isCorrect: false }, { id: 'd', text: 'Den er skrevet paa bokmaal', isCorrect: false }], solution: 'Septologien er skrevet som en flytende tekst uten punktum - syv deler i tre bind utkommet 2019-2021.' },
          { id: 'norsk-vg3-4-5-n-quiz3-q1', task: 'Hvem er hovedpersonen i Septologien?', options: [{ id: 'a', text: 'Jon Fosse selv', isCorrect: false }, { id: 'b', text: 'Maleren Asle', isCorrect: true }, { id: 'c', text: 'En fisker fra Hardanger', isCorrect: false }, { id: 'd', text: 'En laerer i Oslo', isCorrect: false }], solution: 'Vi foelger maleren Asle som bor ved fjorden. Han har en dobbeltgjenger i byen. Gjennom tankestroemmer, minner og refleksjoner utforskes liv og doed, kunst og tro.' },
        ],
      },
    },
    {
...
Repetisjon er det mest slaende - ord gjentas med sma variasjoner. Enkelhet preger spraket - korte, hverdagslige ord. Pausene er like viktige som ordene. Eksistensielle temaer gar igjen: dod, kjarlighet, ensomhet, tro.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 4',
        type: 'multiple-choice',
        task: 'Test deg selv paa Fosses stil:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          { id: 'norsk-vg3-4-5-n-quiz4-q0', task: 'Hvorfor bruker Fosse saa mye repetisjon?', options: [{ id: 'a', text: 'Han har daarlig hukommelse', isCorrect: false }, { id: 'b', text: 'For aa skape rytme og understreke kommunikasjonens vanskelighet', isCorrect: true }, { id: 'c', text: 'For aa gjoere tekstene lengre', isCorrect: false }, { id: 'd', text: 'Det er et krav fra forlaget', isCorrect: false }], solution: 'Repetisjonen skaper rytme og viser det vanskelige ved aa kommunisere virkelig. Ord gjentas med smaa variasjoner.' },
          { id: 'norsk-vg3-4-5-n-quiz4-q1', task: 'Hvilke eksistensielle temaer gaar igjen hos Fosse?', options: [{ id: 'a', text: 'Sport og underholdning', isCorrect: false }, { id: 'b', text: 'Doed, kjaerlighet, ensomhet og tro', isCorrect: true }, { id: 'c', text: 'Politikk og oekonomi', isCorrect: false }, { id: 'd', text: 'Reise og eventyr', isCorrect: false }], solution: 'Fosses eksistensielle temaer inkluderer doed, kjaerlighet, ensomhet og tro. Dette utforskes gjennom et enkelt, hverdagslig spraak med ladede pauser.' },
        ],
      },
    },
    {
...
Nobelprisen 2023 bekreftet Fosses posisjon. Han er forste nynorskforfatter med prisen. Han viser at det eksperimentelle kan na ut. Han tilbyr langsomhet og dybde i en rask tid.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 5',
        type: 'multiple-choice',
        task: 'Test deg selv paa Nobelprisen og arven:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          { id: 'norsk-vg3-4-5-n-quiz5-q0', task: 'Hva var Nobelkomiteens begrunnelse?', options: [{ id: 'a', text: 'For hans lange romaner', isCorrect: false }, { id: 'b', text: 'For hans nyskapende dramatikk og prosa som gir stemme til det uutsigelige', isCorrect: true }, { id: 'c', text: 'For hans politiske engasjement', isCorrect: false }, { id: 'd', text: 'For hans humor', isCorrect: false }], solution: 'Nobelkomiteen ga prisen "for hans nyskapande dramatikk og prosa som gjev stemme til det usigelege".' },
          { id: 'norsk-vg3-4-5-n-quiz5-q1', task: 'Hva er spesielt med Fosse som Nobelprisvinner?', options: [{ id: 'a', text: 'Han er den yngste vinneren', isCorrect: false }, { id: 'b', text: 'Han er foerste nynorskforfatter med prisen', isCorrect: true }, { id: 'c', text: 'Han nektet aa ta imot prisen', isCorrect: false }, { id: 'd', text: 'Han er den eneste dramatikeren', isCorrect: false }], solution: 'Jon Fosse er den foerste nynorskforfatteren som har mottatt Nobelprisen i litteratur. Han viser at det eksperimentelle kan naa ut internasjonalt.' },
        ],
      },
    },
    {
