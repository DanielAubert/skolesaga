      ...
      content: [
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'lett',
            task: 'Bruk strategien med vennlige tall til å regne ut i hodet.',
            subTasks: [
              { label: 'a', task: '$56 + 29$', solution: '$56 + 30 - 1 = 86 - 1 = 85$' },
              { label: 'b', task: '$73 + 48$', solution: '$73 + 50 - 2 = 123 - 2 = 121$' },
              { label: 'c', task: '$124 + 98$', solution: '$124 + 100 - 2 = 224 - 2 = 222$' },
              { label: 'd', task: '$91 - 37$', solution: '$91 - 40 + 3 = 51 + 3 = 54$' },
              { label: 'e', task: '$260 + 197$', solution: '$260 + 200 - 3 = 460 - 3 = 457$' },
              { label: 'f', task: '$345 - 98$', solution: '$345 - 100 + 2 = 245 + 2 = 247$' },
            ],
            solution: 'a) $85$ b) $121$ c) $222$ d) $54$ e) $457$ f) $247$',
            hideInlineSolution: true,
            hints: ['Rund det ene tallet opp eller ned til nærmeste tier eller hundrer, og juster svaret etterpå.'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            task: 'Bruk kompensasjonsmetoden til å regne ut i hodet.',
            subTasks: [
              { label: 'a', task: '$58 + 35$', solution: 'Flytt $2$ fra $35$ til $58$: $60 + 33 = 93$' },
              { label: 'b', task: '$76 + 47$', solution: 'Flytt $4$ fra $47$ til $76$: $80 + 43 = 123$' },
              { label: 'c', task: '$83 - 46$', solution: 'Legg til $4$ på begge: $87 - 50 = 37$' },
              { label: 'd', task: '$134 - 78$', solution: 'Legg til $2$ på begge: $136 - 80 = 56$' },
              { label: 'e', task: '$67 + 85$', solution: 'Flytt $3$ fra $85$ til $67$: $70 + 82 = 152$' },
              { label: 'f', task: '$211 - 57$', solution: 'Legg til $3$ på begge: $214 - 60 = 154$' },
            ],
            solution: 'a) $93$ b) $123$ c) $37$ d) $56$ e) $152$ f) $154$',
            hideInlineSolution: true,
            hints: ['For addisjon: Flytt litt fra det ene tallet til det andre slik at ett av dem blir et vennlig tall. For subtraksjon: Legg til det samme på begge tallene.'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            task: 'Bruk tallinja-strategien (dele opp i tiere og enere) til å regne ut.',
            subTasks: [
              { label: 'a', task: '$45 + 67$', solution: '$45 \\xrightarrow{+60} 105 \\xrightarrow{+7} 112$' },
              { label: 'b', task: '$83 + 59$', solution: '$83 \\xrightarrow{+50} 133 \\xrightarrow{+9} 142$' },
              { label: 'c', task: '$172 - 86$', solution: '$172 \\xrightarrow{-80} 92 \\xrightarrow{-6} 86$' },
              { label: 'd', task: '$234 + 178$', solution: '$234 \\xrightarrow{+100} 334 \\xrightarrow{+70} 404 \\xrightarrow{+8} 412$' },
              { label: 'e', task: '$351 - 163$', solution: '$351 \\xrightarrow{-100} 251 \\xrightarrow{-60} 191 \\xrightarrow{-3} 188$' },
              { label: 'f', task: '$508 - 249$', solution: '$508 \\xrightarrow{-200} 308 \\xrightarrow{-40} 268 \\xrightarrow{-9} 259$' },
            ],
            solution: 'a) $112$ b) $142$ c) $86$ d) $412$ e) $188$ f) $259$',
            hideInlineSolution: true,
            hints: ['Del opp det ene tallet i hundrere, tiere og enere. Legg til eller trekk fra én del om gangen.'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
        ...
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'medium',
            task: 'Velg selv den strategien du synes passer best, og regn ut i hodet.',
            subTasks: [
              { label: 'a', task: '$497 + 286$', solution: 'Vennlige tall: $500 + 286 - 3 = 783$' },
              { label: 'b', task: '$612 - 398$', solution: 'Vennlige tall: $612 - 400 + 2 = 214$' },
              { label: 'c', task: '$88 + 77 + 12$', solution: 'Vennlige tall: $88 + 12 = 100$, deretter $100 + 77 = 177$' },
              { label: 'd', task: '$1000 - 463$', solution: 'Tallinja: $1000 \\xrightarrow{-400} 600 \\xrightarrow{-60} 540 \\xrightarrow{-3} 537$' },
              { label: 'e', task: '$375 + 248$', solution: 'Kompensasjon: Flytt $2$ fra $248$ til $375$: $377 + 246 = ?$ Enklere: $375 + 250 - 2 = 623$' },
              { label: 'f', task: '$803 - 547$', solution: 'Tenke-addisjon: $547 \\xrightarrow{+3} 550 \\xrightarrow{+250} 800 \\xrightarrow{+3} 803$. Sum: $3 + 250 + 3 = 256$' },
            ],
            solution: 'a) $783$ b) $214$ c) $177$ d) $537$ e) $623$ f) $256$',
            hideInlineSolution: true,
            hints: ['Se etter tall som er nesten et vennlig tall, eller som til sammen gir et vennlig tall.'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'medium',
            task: 'Løs tekstoppgavene med hoderegning. Vis hvilken strategi du bruker.',
            subTasks: [
              { label: 'a', task: 'En bok koster 189 kr og en penn koster 47 kr. Hva er totalprisen?', solution: 'Vennlige tall: $189 + 47 = 190 + 46 = 236$ kr' },
              { label: 'b', task: 'Ida har 500 kr og bruker 263 kr. Hvor mye har hun igjen?', solution: 'Tallinja: $500 - 263 = 500 - 260 - 3 = 237$ kr' },
              { label: 'c', task: 'Et tog har 348 passasjerer. Ved neste stasjon stiger 97 av og 54 på. Hvor mange passasjerer er det nå?', solution: '$348 - 97 + 54 = 348 - 100 + 3 + 54 = 251 + 54 = 305$' },
              { label: 'd', task: 'Ole sparer 175 kr i januar, 225 kr i februar og 198 kr i mars. Hvor mye har han spart totalt?', solution: '$175 + 225 = 400$. Deretter $400 + 198 = 400 + 200 - 2 = 598$ kr' },
            ],
            solution: 'a) $236$ kr b) $237$ kr c) $305$ passasjerer d) $598$ kr',
            hideInlineSolution: true,
            hints: ['Les oppgaven nøye og velg den strategien som gjør utregningen enklest.'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'vanskelig',
            task: 'Disse oppgavene krever at du kombinerer flere strategier. Forklar fremgangsmåten din.',
            subTasks: [
              { label: 'a', task: '$1997 + 2486$', solution: 'Vennlige tall: $2000 + 2486 - 3 = 4486 - 3 = 4483$' },
              { label: 'b', task: '$3002 - 1598$', solution: 'Kompensasjon: $3002 - 1598 = 3004 - 1600 = 1404$' },
              { label: 'c', task: '$456 + 298 + 144 + 502$', solution: 'Vennlige par: $456 + 144 = 600$ og $298 + 502 = 800$. Deretter $600 + 800 = 1400$' },
              { label: 'd', task: 'En skole har tre klasser med henholdsvis 247, 198 og 155 elever. Hvor mange elever er det totalt?', solution: '$247 + 198 + 155 = 247 + 200 - 2 + 155 = 447 + 155 - 2 = 447 + 153 = 600$' },
            ],
            solution: 'a) $4483$ b) $1404$ c) $1400$ d) $600$ elever',
            hideInlineSolution: true,
            hints: ['Se etter par av tall som gir vennlige summer. Bruk gjerne kompensasjonsmetoden for tall som er nær 1000 eller 2000.'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
      ...
      content: [
        {
          ...
          exercise: {
            ...
            task: 'Bruk dobling og halvering til å regne ut i hodet.',
            subTasks: [
              { label: 'a', task: '$25 \\times 8$', solution: '$50 \\times 4 = 200$' },
              { label: 'b', task: '$15 \\times 12$', solution: '$30 \\times 6 = 180$' },
              { label: 'c', task: '$50 \\times 18$', solution: '$100 \\times 9 = 900$' },
              { label: 'd', task: '$35 \\times 4$', solution: '$70 \\times 2 = 140$' },
              { label: 'e', task: '$5 \\times 24$', solution: '$10 \\times 12 = 120$' },
              { label: 'f', task: '$125 \\times 8$', solution: '$250 \\times 4 = 500 \\times 2 = 1000$' },
            ],
            solution: 'a) $200$ b) $180$ c) $900$ d) $140$ e) $120$ f) $1000$',
            hideInlineSolution: true,
            hints: ['Doble den ene faktoren og halver den andre. Gjenta til du får tall som er lette å gange.'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
        ...
        },
        {
          ...
          exercise: {
            ...
            task: 'Bruk distributiv lov til å bryte opp gangestykket og regn ut i hodet.',
            subTasks: [
              { label: 'a', task: '$8 \\times 32$', solution: '$8 \\times 30 + 8 \\times 2 = 240 + 16 = 256$' },
              { label: 'b', task: '$6 \\times 45$', solution: '$6 \\times 40 + 6 \\times 5 = 240 + 30 = 270$' },
              { label: 'c', task: '$7 \\times 98$', solution: '$7 \\times 100 - 7 \\times 2 = 700 - 14 = 686$' },
              { label: 'd', task: '$9 \\times 53$', solution: '$9 \\times 50 + 9 \\times 3 = 450 + 27 = 477$' },
              { label: 'e', task: '$5 \\times 86$', solution: '$5 \\times 80 + 5 \\times 6 = 400 + 30 = 430$' },
              { label: 'f', task: '$4 \\times 199$', solution: '$4 \\times 200 - 4 \\times 1 = 800 - 4 = 796$' },
            ],
            solution: 'a) $256$ b) $270$ c) $686$ d) $477$ e) $430$ f) $796$',
            hideInlineSolution: true,
            hints: ['Del opp den ene faktoren i tiere og enere, eller i et vennlig tall pluss/minus noe.'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
        ...
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'lett',
            task: 'Regn ut divisjonene i hodet.',
            subTasks: [
              { label: 'a', task: '$96 \\div 4$', solution: 'Halvere to ganger: $96 \\div 2 = 48$, $48 \\div 2 = 24$' },
              { label: 'b', task: '$150 \\div 5$', solution: 'Dele opp: $100 \\div 5 + 50 \\div 5 = 20 + 10 = 30$' },
              { label: 'c', task: '$126 \\div 6$', solution: 'Dele opp: $120 \\div 6 + 6 \\div 6 = 20 + 1 = 21$' },
              { label: 'd', task: '$192 \\div 8$', solution: 'Halvere tre ganger: $192 \\div 2 = 96$, $96 \\div 2 = 48$, $48 \\div 2 = 24$' },
              { label: 'e', task: '$225 \\div 9$', solution: 'Dele opp: $180 \\div 9 + 45 \\div 9 = 20 + 5 = 25$' },
              { label: 'f', task: '$360 \\div 12$', solution: 'Dele divisor: $360 \\div 4 \\div 3 = 90 \\div 3 = 30$' },
            ],
            solution: 'a) $24$ b) $30$ c) $21$ d) $24$ e) $25$ f) $30$',
            hideInlineSolution: true,
            hints: ['For divisjon med 4: Halver to ganger. For divisjon med 8: Halver tre ganger. For andre tall: Del opp dividenden.'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'medium',
            task: 'Velg selv den beste strategien og regn ut i hodet.',
            subTasks: [
              { label: 'a', task: '$16 \\times 25$', solution: 'Dobling/halvering: $32 \\times 12{,}5$? Enklere: $16 \\times 25 = 4 \\times 4 \\times 25 = 4 \\times 100 = 400$' },
              { label: 'b', task: '$14 \\times 15$', solution: 'Dobling/halvering: $7 \\times 30 = 210$' },
              { label: 'c', task: '$324 \\div 6$', solution: 'Dele opp: $300 \\div 6 + 24 \\div 6 = 50 + 4 = 54$' },
              { label: 'd', task: '$8 \\times 75$', solution: 'Bryte opp: $8 \\times 75 = 4 \\times 150 = 2 \\times 300 = 600$' },
              { label: 'e', task: '$432 \\div 8$', solution: 'Halvere tre ganger: $432 \\div 2 = 216$, $216 \\div 2 = 108$, $108 \\div 2 = 54$' },
              { label: 'f', task: '$45 \\times 12$', solution: 'Bryte opp: $45 \\times 10 + 45 \\times 2 = 450 + 90 = 540$' },
            ],
            solution: 'a) $400$ b) $210$ c) $54$ d) $600$ e) $54$ f) $540$',
            hideInlineSolution: true,
            hints: ['Tenk gjennom hvilken strategi som gjør hvert regnestykke enklest.'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'medium',
            task: 'Løs tekstoppgavene med hoderegning.',
            subTasks: [
              { label: 'a', task: 'En klasse med 25 elever kjøper billett til 48 kr per stk. Hva er totalprisen?', solution: '$25 \\times 48 = 50 \\times 24 = 100 \\times 12 = 1200$ kr' },
              { label: 'b', task: 'Seks venner deler en regning på 438 kr likt. Hvor mye betaler hver?', solution: '$438 \\div 6 = 420 \\div 6 + 18 \\div 6 = 70 + 3 = 73$ kr' },
              { label: 'c', task: 'Et hotell har 15 etasjer med 12 rom i hver etasje. Hvor mange rom er det totalt?', solution: '$15 \\times 12 = 30 \\times 6 = 180$ rom' },
              { label: 'd', task: 'En sykkeltur er 84 km lang. Ahmed sykler $\\frac{1}{4}$ av turen den første timen. Hvor langt syklet han?', solution: '$84 \\div 4 = 42 \\div 2 = 21$ km' },
            ],
            solution: 'a) $1200$ kr b) $73$ kr c) $180$ rom d) $21$ km',
            hideInlineSolution: true,
            hints: ['Velg den strategien som passer best for hvert regnestykke.'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'vanskelig',
            task: 'Regn ut i hodet og forklar strategien din.',
            subTasks: [
              { label: 'a', task: '$125 \\times 24$', solution: '$125 \\times 8 \\times 3 = 1000 \\times 3 = 3000$' },
              { label: 'b', task: '$36 \\times 25$', solution: '$36 \\times 25 = 9 \\times 4 \\times 25 = 9 \\times 100 = 900$' },
              { label: 'c', task: '$756 \\div 12$', solution: '$756 \\div 4 \\div 3 = 189 \\div 3 = 63$' },
              { label: 'd', task: 'En bedrift bestiller 48 pakker med papir til 125 kr per pakke. Hva er totalkostnaden?', solution: '$48 \\times 125 = 6 \\times 8 \\times 125 = 6 \\times 1000 = 6000$ kr' },
            ],
            solution: 'a) $3000$ b) $900$ c) $63$ d) $6000$ kr',
            hideInlineSolution: true,
            hints: ['Se etter kjente faktorpar som gir vennlige tall, for eksempel $8 \\times 125 = 1000$ og $4 \\times 25 = 100$.'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
      ...
      content: [
        {
          ...
          exercise: {
            ...
            task: 'Avrund tallene til nærmeste tier.',
            subTasks: [
              { label: 'a', task: '$63$', solution: '$63 \\approx 60$' },
              { label: 'b', task: '$78$', solution: '$78 \\approx 80$' },
              { label: 'c', task: '$235$', solution: '$235 \\approx 240$' },
              { label: 'd', task: '$491$', solution: '$491 \\approx 490$' },
              { label: 'e', task: '$1\\,847$', solution: '$1\\,847 \\approx 1\\,850$' },
              { label: 'f', task: '$3\\,055$', solution: '$3\\,055 \\approx 3\\,060$' },
            ],
            solution: 'a) $60$ b) $80$ c) $240$ d) $490$ e) $1\\,850$ f) $3\\,060$',
            hideInlineSolution: true,
            hints: ['Se på enersifferet. Er det 0–4, rund ned. Er det 5–9, rund opp.'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
        ...
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'lett',
            task: 'Avrund tallene til nærmeste hundrer.',
            subTasks: [
              { label: 'a', task: '$247$', solution: '$247 \\approx 200$' },
              { label: 'b', task: '$382$', solution: '$382 \\approx 400$' },
              { label: 'c', task: '$750$', solution: '$750 \\approx 800$' },
              { label: 'd', task: '$1\\,439$', solution: '$1\\,439 \\approx 1\\,400$' },
              { label: 'e', task: '$2\\,650$', solution: '$2\\,650 \\approx 2\\,700$' },
              { label: 'f', task: '$5\\,081$', solution: '$5\\,081 \\approx 5\\,100$' },
            ],
            solution: 'a) $200$ b) $400$ c) $800$ d) $1\\,400$ e) $2\\,700$ f) $5\\,100$',
            hideInlineSolution: true,
            hints: ['Se på tiersifferet. Er det 0–4, rund ned. Er det 5–9, rund opp.'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            task: 'Gjør et overslag ved å avrunde hvert tall til nærmeste tier, og regn ut.',
            subTasks: [
              { label: 'a', task: '$37 + 54$', solution: '$40 + 50 = 90$ (nøyaktig: $91$)' },
              { label: 'b', task: '$86 - 29$', solution: '$90 - 30 = 60$ (nøyaktig: $57$)' },
              { label: 'c', task: '$23 \\times 8$', solution: '$20 \\times 8 = 160$ (nøyaktig: $184$)' },
              { label: 'd', task: '$156 + 243 + 89$', solution: '$160 + 240 + 90 = 490$ (nøyaktig: $488$)' },
              { label: 'e', task: '$68 \\times 5$', solution: '$70 \\times 5 = 350$ (nøyaktig: $340$)' },
              { label: 'f', task: '$512 - 287$', solution: '$510 - 290 = 220$ (nøyaktig: $225$)' },
            ],
            solution: 'a) $\\approx 90$ b) $\\approx 60$ c) $\\approx 160$ d) $\\approx 490$ e) $\\approx 350$ f) $\\approx 220$',
            hideInlineSolution: true,
            hints: ['Avrund hvert tall for seg til nærmeste tier, og regn deretter med de avrundede tallene.'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
        ...
        },
        {
          ...
          exercise: {
            ...
            task: 'Bruk overslag til å avgjøre om hvert svar er rimelig. Skriv om det virker riktig eller feil.',
            subTasks: [
              { label: 'a', task: '$27 \\times 34 = 918$', solution: 'Overslag: $30 \\times 30 = 900$. Svaret $918$ er i nærheten. **Rimelig.** (Nøyaktig: $918$ \\checkmark)' },
              { label: 'b', task: '$63 \\times 48 = 4024$', solution: 'Overslag: $60 \\times 50 = 3000$. Svaret $4024$ er for høyt. **Feil.** (Nøyaktig: $3024$)' },
              { label: 'c', task: '$512 \\div 8 = 64$', solution: 'Overslag: $500 \\div 8 \\approx 62{,}5$. Svaret $64$ er i nærheten. **Rimelig.** (Nøyaktig: $64$ \\checkmark)' },
              { label: 'd', task: '$189 + 347 + 211 = 847$', solution: 'Overslag: $190 + 350 + 210 = 750$. Svaret $847$ er for høyt. **Feil.** (Nøyaktig: $747$)' },
            ],
            solution: 'a) Rimelig b) Feil (nøyaktig: $3024$) c) Rimelig d) Feil (nøyaktig: $747$)',
            hideInlineSolution: true,
            hints: ['Gjør et raskt overslag og sammenlign med det oppgitte svaret.'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'medium',
            task: 'Gjør overslag for å svare på spørsmålene.',
            subTasks: [
              { label: 'a', task: 'Du handler for 47 kr, 83 kr, 29 kr og 61 kr. Du har 250 kr. Har du nok?', solution: 'Overslag: $50 + 80 + 30 + 60 = 220$ kr. Ja, $250$ kr er nok. (Nøyaktig: $220$ kr)' },
              { label: 'b', task: 'En tur er 387 km. Du kjører i gjennomsnitt 82 km/t. Omtrent hvor lang tid tar turen?', solution: 'Overslag: $400 \\div 80 = 5$ timer. Turen tar ca. $5$ timer.' },
              { label: 'c', task: 'En fabrikk produserer 48 enheter per time. Omtrent hvor mange produseres på en 7,5 timers dag?', solution: 'Overslag: $50 \\times 8 = 400$ enheter. (Nøyaktig: $48 \\times 7{,}5 = 360$ enheter)' },
              { label: 'd', task: 'En klasse med 31 elever skal betale 195 kr hver for en konsertbillett. Er 6000 kr nok til alle?', solution: 'Overslag: $30 \\times 200 = 6000$ kr. Det er akkurat på grensen. Nøyaktig: $31 \\times 195 = 6045$ kr. Nei, $6000$ kr er **ikke** nok.' },
            ],
            solution: 'a) Ja, $250$ kr er nok. b) Ca. $5$ timer. c) Ca. $400$ enheter. d) Nei, trenger $6045$ kr.',
            hideInlineSolution: true,
            hints: ['Avrund tallene til noe som er lett å regne med.'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
        {
          ...
          exercise: {
            ...
            type: 'classic',
            difficulty: 'vanskelig',
            task: 'Bruk overestimering og underestimering.',
            subTasks: [
              { label: 'a', task: 'Finn et overestimat og et underestimat for $38 \\times 67$. Hvilket intervall ligger det nøyaktige svaret i?', solution: 'Overestimat: $40 \\times 70 = 2800$. Underestimat: $30 \\times 60 = 1800$. Nøyaktig: $38 \\times 67 = 2546$. Svaret ligger mellom $1800$ og $2800$.' },
              { label: 'b', task: 'Du skal kjøpe 8 varer som koster 78, 42, 115, 93, 67, 54, 129 og 36 kr. Finn et overestimat og et underestimat for totalprisen.', solution: 'Overestimat (rund opp): $80+50+120+100+70+60+130+40 = 650$ kr. Underestimat (rund ned): $70+40+110+90+60+50+120+30 = 570$ kr. Nøyaktig: $614$ kr.' },
              { label: 'c', task: 'Forklar når det er viktigst å bruke overestimering, og gi et eksempel fra hverdagen.', solution: 'Overestimering er viktigst når vi vil forsikre oss om at vi har nok av noe, for eksempel nok penger i butikken, nok maling til et rom, eller nok tid til en reise. Overestimatet gir en øvre grense som vi vet er høy nok.' },
            ],
            solution: 'a) Mellom $1800$ og $2800$ (nøyaktig: $2546$). b) Mellom $570$ og $650$ kr (nøyaktig: $614$ kr). c) Når man må sikre at man har nok, f.eks. penger i butikken.',
            hideInlineSolution: true,
            hints: ['Overestimat: Rund alle tall opp. Underestimat: Rund alle tall ned. Det nøyaktige svaret ligger alltid mellom disse.'],
            allowsUpload: true,
            allowsCanvasDrawing: true,
          },
        },
