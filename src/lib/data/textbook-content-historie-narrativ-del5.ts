        ...
        questions: [
          {
            ...
            options: [
              { id: 'a', text: 'Rettigheter som følger av samfunnskontrakten mellom borgerne og staten', isCorrect: false },
              { id: 'b', text: 'Rettigheter alle mennesker er født med -- til liv, frihet og eiendom', isCorrect: true },
              { id: 'c', text: 'Rettigheter som parlamentet vedtar gjennom lovgivning og kan endre', isCorrect: false },
              { id: 'd', text: 'Rettigheter som bygger på den engelske common law-tradisjonen', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Å appellere til et uavhengig rettssystem for å få oppreisning', isCorrect: false },
              { id: 'b', text: 'Å kreve en ny samfunnskontrakt gjennom fredelige forhandlinger', isCorrect: false },
              { id: 'c', text: 'Å gjøre opprør og avsette regjeringen', isCorrect: true },
              { id: 'd', text: 'Å velge nye representanter til parlamentet ved neste valg', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Renessansens humanistiske filosofi og tekstkritikk', isCorrect: false },
              { id: 'b', text: 'Den vitenskapelige revolusjonen og dens metoder', isCorrect: true },
              { id: 'c', text: 'Reformasjonens brudd med kirkelig autoritet og vekt på individets samvittighet', isCorrect: false },
              { id: 'd', text: 'Den engelske borgerkrigen og parlamentarismens fremvekst', isCorrect: false },
            ],
        ...
        questions: [
          {
            ...
            options: [
              { id: 'a', text: 'Den folkevalgte, den administrative og den militære makt', isCorrect: false },
              { id: 'b', text: 'Den føderale, den regionale og den lokale makt', isCorrect: false },
              { id: 'c', text: 'Den lovgivende, den utøvende og den dømmende makt', isCorrect: true },
              { id: 'd', text: 'Den lovgivende, den kontrollerende og den rådgivende makt', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Å sikre at folkeviljen ble gjennomført så direkte som mulig i lovgivningen', isCorrect: false },
              { id: 'b', text: 'Å beskytte individets naturlige rettigheter mot statlige overgrep', isCorrect: false },
              { id: 'c', text: 'Å gjøre styringen mer effektiv ved å spesialisere statens oppgaver', isCorrect: false },
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Bare i den amerikanske grunnloven fra 1787, ikke i europeiske stater', isCorrect: false },
              { id: 'b', text: 'I den norske Grunnloven med Stortinget, regjeringen og domstolene', isCorrect: true },
              { id: 'c', text: 'Hovedsakelig i Storbritannias parlamentariske system med Underhuset og Overhuset', isCorrect: false },
              { id: 'd', text: 'Først og fremst i FN-pakten og internasjonale menneskerettighetskonvensjoner', isCorrect: false },
            ],
        ...
        questions: [
          {
            ...
            options: [
              { id: 'a', text: 'At folkets representanter i parlamentet bør ha den øverste lovgivende makt', isCorrect: false },
              { id: 'b', text: 'At all legitim makt utgår fra folket selv', isCorrect: true },
              { id: 'c', text: 'At borgerne har naturlige rettigheter som ingen regjering kan krenke', isCorrect: false },
              { id: 'd', text: 'At statsmakten bør fordeles mellom uavhengige institusjoner', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Folkesuverenitet og direkte demokrati etter sveitsisk modell', isCorrect: false },
              { id: 'b', text: 'Naturlige rettigheter og retten til å avsette tyranniske herskere', isCorrect: false },
              { id: 'c', text: 'Ytringsfrihet og religiøs toleranse', isCorrect: true },
              { id: 'd', text: 'Maktfordelingsprinsippet og konstitusjonelt monarki', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'At det forutsetter direkte demokrati, noe som er umulig i store nasjonalstater', isCorrect: false },
              { id: 'b', text: 'At det overser individets naturlige rettigheter til fordel for kollektive beslutninger', isCorrect: false },
              { id: 'c', text: 'At det mangler en mekanisme for maktfordeling mellom statsmaktene', isCorrect: false },
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Locke formulerte folkesuvereniteten, Montesquieu ytringsfriheten, Voltaire maktfordelingen, Rousseau rettighetene', isCorrect: false },
              ...
              { id: 'c', text: 'Alle fire utviklet sammen ideen om maktfordelingsprinsippet som et felles prosjekt', isCorrect: false },
              { id: 'd', text: 'Locke og Montesquieu arbeidet med statsteori, mens Voltaire og Rousseau begge fokuserte på folkesuverenitet', isCorrect: false },
            ],
        ...
        questions: [
          {
            ...
            options: [
              { id: 'a', text: 'Fordi den avslørte statshemmeligheter om Frankrikes militære strategier', isCorrect: false },
              { id: 'b', text: 'Fordi den spredte vitenskapelig kunnskap som var forbeholdt universitetenes lukkede forelesninger', isCorrect: false },
              { id: 'c', text: 'Fordi den kritiserte kirken og tradisjonell autoritet og truet makthaverne', isCorrect: true },
              { id: 'd', text: 'Fordi den inneholdt teknisk kunnskap om håndverk som truet laugenes monopol på yrkesopplæring', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Jean le Rond d\'Alembert', isCorrect: false },
              { id: 'b', text: 'Denis Diderot', isCorrect: true },
              { id: 'c', text: 'Voltaire', isCorrect: false },
              { id: 'd', text: 'Pierre Bayle', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              ...
              { id: 'b', text: 'Ideen om at kirkens lære var den eneste gyldige kilden til sannhet', isCorrect: false },
              { id: 'c', text: 'Ideen om at vitenskapelig forskning bare skulle foregå ved universitetene', isCorrect: false },
              { id: 'd', text: 'Ideen om at håndverkskunnskap var mindreverdige sammenlignet med filosofi', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Den franske menneskerettighetserklæringen (1789)', isCorrect: false },
              { id: 'b', text: 'Den amerikanske uavhengighetserklæringen (1776)', isCorrect: true },
              { id: 'c', text: 'Den amerikanske grunnloven (1787)', isCorrect: false },
              { id: 'd', text: 'Den engelske Bill of Rights (1689)', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'At fornuftsbasert tenkning undergravde tradisjonelle fellesskap og sosiale bånd', isCorrect: false },
              { id: 'b', text: 'At vektleggingen av individets rettigheter svekket pliktetikken og det kollektive ansvaret', isCorrect: false },
              { id: 'c', text: 'At flere opplysningsfilosofer bidro til rasehierarkier som rettferdiggjorde kolonialisme', isCorrect: true },
              { id: 'd', text: 'At den ensidige troen på fremskritt ignorerte de menneskelige kostnadene ved industrialiseringen', isCorrect: false },
            ],
        ...
        questions: [
          {
            ...
            options: [
              { id: 'a', text: 'En organisert boikott der kolonistene nektet å kjøpe britiske varer i Boston', isCorrect: false },
              ...
              { id: 'c', text: 'Et møte i Kontinentalkongressen der kolonistene vedtok å bryte med Storbritannia', isCorrect: false },
              { id: 'd', text: 'En væpnet konfrontasjon mellom kolonisters militser og britiske soldater i Boston havn', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'At kolonistene krevde lavere skattesatser på linje med det britiske borgere betalte', isCorrect: false },
              { id: 'b', text: 'At kolonistene ønsket egne lokale skattemyndigheter uavhengig av parlamentet', isCorrect: false },
              { id: 'c', text: 'At kolonistene ikke ville betale skatt uten å ha representanter i parlamentet', isCorrect: true },
              { id: 'd', text: 'At kolonistene krevde at skatteinntektene skulle brukes lokalt i koloniene, ikke sendes til London', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'De tilbød kolonistene begrenset representasjon i parlamentet mot å godta avgiftene', isCorrect: false },
              { id: 'b', text: 'De sendte tropper for å arrestere lederne av Kontinentalkongressen', isCorrect: false },
              { id: 'c', text: 'De opphevet alle skatter unntatt teavgiften som et kompromiss', isCorrect: false },
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Kolonister som ønsket full uavhengighet men gjennom forhandlinger, ikke krig', isCorrect: false },
              { id: 'b', text: 'Kolonister som forble trofaste mot den britiske kronen', isCorrect: true },
              { id: 'c', text: 'Kolonister som ville erstatte britisk styre med et eget kongedømme i Amerika', isCorrect: false },
              { id: 'd', text: 'Kolonister som støttet uavhengighet men var imot den republikanske styreformen', isCorrect: false },
            ],
        ...
        questions: [
          {
            ...
            options: [
              { id: 'a', text: 'Montesquieu', isCorrect: false },
              { id: 'b', text: 'Jean-Jacques Rousseau', isCorrect: false },
              { id: 'c', text: 'John Locke', isCorrect: true },
              { id: 'd', text: 'Thomas Hobbes', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Han byttet ut "liv" med "sikkerhet" for å understreke statens beskyttelsesplikt', isCorrect: false },
              { id: 'b', text: 'Han la til "folkets samtykke" som en fjerde naturlig rettighet utover Lockes tre', isCorrect: false },
              { id: 'c', text: 'Han byttet ut "eiendom" med "streben etter lykke"', isCorrect: true },
              { id: 'd', text: 'Han erstattet "frihet" med "likhet" for å inkludere et bredere frihetsbegrep', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'En grunnlov som etablerte den nye nasjonens politiske system og maktfordeling', isCorrect: false },
              { id: 'b', text: 'En traktat som definerte kolonistenes rettigheter innenfor det britiske imperiet', isCorrect: false },
              { id: 'c', text: 'Et forslag til en føderalstat der koloniene kunne samarbeide med Storbritannia', isCorrect: false },
        ...
        questions: [
          {
            ...
            options: [
              ...
              { id: 'd', text: 'Preussen', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Fordi kolonistene manglet støtte fra urbefolkningen og hadde fiender på alle fronter', isCorrect: false },
              { id: 'b', text: 'Fordi koloniene var splittet og bare syv av tretten støttet uavhengighet', isCorrect: false },
              { id: 'c', text: 'Fordi Storbritannia hadde verdens beste marine, en profesjonell hær og enorme ressurser', isCorrect: true },
              { id: 'd', text: 'Fordi kolonistene ikke hadde tilgang på krutt og våpen fra europeiske leverandører', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Koloniene fikk utvidet selvstyre, men forble formelt en del av det britiske imperiet', isCorrect: false },
              { id: 'b', text: 'Storbritannia beholdt de sørlige koloniene mens de nordlige ble uavhengige', isCorrect: false },
              { id: 'c', text: 'Storbritannia anerkjente USAs uavhengighet', isCorrect: true },
              { id: 'd', text: 'Frankrike fikk kontroll over de tidligere britiske koloniene som kompensasjon for sin krigsinnsats', isCorrect: false },
            ],
        ...
        questions: [
          {
            ...
            options: [
              { id: 'a', text: 'Selve grunnlovsteksten som etablerte maktfordelingen mellom president, kongress og høyesterett', isCorrect: false },
              { id: 'b', text: 'Den føderale loven som regulerte forholdet mellom de tretten delstatene', isCorrect: false },
              ...
              { id: 'd', text: 'Et tillegg til uavhengighetserklæringen som presiserte borgernes plikter overfor staten', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Rousseaus idé om folkesuverenitet og allmenviljen', isCorrect: false },
              { id: 'b', text: 'Lockes idé om naturlige rettigheter og samfunnskontrakten', isCorrect: false },
              { id: 'c', text: 'Montesquieus maktfordelingsprinsipp', isCorrect: true },
              { id: 'd', text: 'Voltaires idé om konstitusjonelt monarki etter britisk forbilde', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'At grunnloven manglet en rettighetskatolog helt til Bill of Rights ble vedtatt fire år senere', isCorrect: false },
              { id: 'b', text: 'At "alle mennesker er skapt like" i praksis bare gjaldt hvite, eiendomsbesittende menn', isCorrect: true },
              { id: 'c', text: 'At delstatene beholdt for mye makt, slik at føderalregjeringen knapt kunne fungere', isCorrect: false },
              { id: 'd', text: 'At presidenten fikk for stor utøvende makt, noe som lignet et valgt monarki', isCorrect: false },
            ],
        ...
        questions: [
          {
            ...
            options: [
              { id: 'a', text: 'Den amerikanske grunnloven ble oversatt til fransk og sirkulert blant borgerskapet i Paris', isCorrect: false },
              ...
              { id: 'c', text: 'Den franske adelen fryktet et lignende opprør og krevde reformer for å unngå revolusjon', isCorrect: false },
              { id: 'd', text: 'Tapet av franske kolonier i Nord-Amerika tvang kongen til å innkalle stenderforsamlingen', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              ...
              { id: 'b', text: 'Marquis de Lafayette', isCorrect: false },
              { id: 'c', text: 'Benjamin Franklin', isCorrect: true },
              { id: 'd', text: 'Thomas Paine', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'At den etablerte en modell for fredelig løsrivelse som andre kolonier kunne følge', isCorrect: false },
              ...
              { id: 'c', text: 'At den beviste at en føderalstat med sterk sentralmakt var den mest stabile styreformen', isCorrect: false },
              { id: 'd', text: 'At den inspirerte en internasjonal menneskerettighetserklæring som ble vedtatt kort tid etter', isCorrect: false },
            ],
        ...
        questions: [
          {
            ...
            options: [
              { id: 'a', text: 'Adelen, borgerskapet og bøndene, delt etter økonomisk status', isCorrect: false },
              { id: 'b', text: 'Geistligheten, adelen og alle andre (den tredje stand)', isCorrect: true },
              { id: 'c', text: 'Kongen og hoffet, den lavere adelen, og det arbeidende folket', isCorrect: false },
              { id: 'd', text: 'Jordeierne, handelsfolk og håndverkere, etter den føydale inndelingen', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Adelen betalte militærskatt mens den tredje stand betalte tiende til kirken', isCorrect: false },
              { id: 'b', text: 'Den tredje stand bar hele skattebyrden, mens geistligheten og adelen var skattefrie', isCorrect: true },
              { id: 'c', text: 'Alle tre stendene betalte skatt, men adelen og geistligheten betalte langt lavere satser', isCorrect: false },
              { id: 'd', text: 'Skattene var formelt like, men ble i praksis bare innkrevd fra bøndene på landsbygda', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'En erklæring der Nasjonalforsamlingen krevde at kongen måtte abdisere', isCorrect: false },
              { id: 'b', text: 'En ed der tredje stand sverget å ikke gå fra hverandre før Frankrike hadde fått en grunnlov', isCorrect: true },
              { id: 'c', text: 'En resolusjon der alle tre stendene samtykket til å møtes samlet og stemme per hode', isCorrect: false },
              { id: 'd', text: 'Et løfte fra tredje stand om å forsvare kongen mot adelen og geistligheten', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Folkets krav om brød og lavere matpriser under hungersnøden', isCorrect: false },
              { id: 'b', text: 'Nasjonalforsamlingens seier over kongen i kampen om en ny grunnlov', isCorrect: false },
              { id: 'c', text: 'Den tredje stands endelige frigjøring fra de føydale pliktene overfor adelen', isCorrect: false },
        ...
        questions: [
          {
            ...
            options: [
              { id: 'a', text: '"Liberté, souveraineté, justice" -- frihet, suverenitet, rettferdighet', isCorrect: false },
              { id: 'b', text: '"Liberté, égalité, fraternité" -- frihet, likhet, brorskap', isCorrect: true },
              { id: 'c', text: '"Raison, droits, nation" -- fornuft, rettigheter, nasjon', isCorrect: false },
              { id: 'd', text: '"Liberté, égalité, souveraineté" -- frihet, likhet, suverenitet', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'At rikdom og eiendom skulle omfordeles jevnt mellom alle borgere', isCorrect: false },
              { id: 'b', text: 'At adelens og geistlighetens privilegier ble avskaffet og alle ble like for loven', isCorrect: true },
              { id: 'c', text: 'At alle borgere, uansett kjønn og stand, fikk stemmerett og politiske rettigheter', isCorrect: false },
              { id: 'd', text: 'At alle skulle ha lik tilgang til utdanning og offentlige embeter basert på merit', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Madame de Staël', isCorrect: false },
              { id: 'b', text: 'Mary Wollstonecraft', isCorrect: false },
              { id: 'c', text: 'Olympe de Gouges', isCorrect: true },
              { id: 'd', text: 'Charlotte Corday', isCorrect: false },
            ],
        ...
        questions: [
          {
            ...
            options: [
              { id: 'a', text: 'Den kaotiske perioden etter kongens henrettelse da ulike revolusjonære fraksjoner kjempet om makten', isCorrect: false },
              { id: 'b', text: 'Perioden med massemobilisering da Frankrike var i krig mot en europeisk koalisjon', isCorrect: false },
              { id: 'c', text: 'En periode der jakobinerne under Robespierre henrettet tusenvis av "revolusjonens fiender"', isCorrect: true },
              { id: 'd', text: 'Opprøret i Vendée der kontrarevolusjønære bønder ble slått ned av republikanske tropper', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Han ble avsatt og holdt som fange i Templepalatset til han døde av sykdom', isCorrect: false },
              { id: 'b', text: 'Han ble tvunget til å abdisere og levde i husarrest på et slott utenfor Paris', isCorrect: false },
              { id: 'c', text: 'Han ble stilt for retten, dømt til døden og henrettet ved giljotinen i 1793', isCorrect: true },
              { id: 'd', text: 'Han forsøkte å flykte til Østerrike, ble fanget ved Varennes og fengslet livet ut', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Fordi revolusjonens idealer om frihet og likhet ble glemt under Napoleons keiserdømme', isCorrect: false },
              { id: 'b', text: 'Fordi revolusjonens egne ledere ble henrettet under terroren', isCorrect: true },
              { id: 'c', text: 'Fordi den neste generasjonen av politikere forkastet revolusjonens prinsipper', isCorrect: false },
              { id: 'd', text: 'Fordi de moderate girondistene og de radikale jakobinerne ødela republikken gjennom intern splittelse', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Rundt 3 000', isCorrect: false },
              { id: 'b', text: 'Rundt 40 000', isCorrect: false },
              { id: 'c', text: 'Rundt 17 000', isCorrect: true },
              { id: 'd', text: 'Rundt 8 000', isCorrect: false },
            ],
        ...
        questions: [
          {
            ...
            options: [
              { id: 'a', text: 'Han videreførte demokratiet og ytringsfriheten, men gjeninnførte adelens privilegier i en ny form', isCorrect: false },
              { id: 'b', text: 'Han beholdt likhet for loven og avskaffet privilegier, men fjernet demokrati og ytringsfrihet', isCorrect: true },
              { id: 'c', text: 'Han sikret stemmerett for alle menn, men sentraliserte makten slik at parlamentet ble maktesløst', isCorrect: false },
              { id: 'd', text: 'Han styrket domstolenes uavhengighet, men undergravde den lovgivende makten ved å styre gjennom dekreter', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Napoleons grunnlov som etablerte keiserdømmet og definerte maktfordelingen i den nye staten', isCorrect: false },
              { id: 'b', text: 'Et administrativt reformprogram som sentraliserte styringen av Frankrikes departementer', isCorrect: false },
              { id: 'c', text: 'Napoleons lovbok som sikret likhet for loven, eiendomsretten og religiøs toleranse', isCorrect: true },
              { id: 'd', text: 'En samling av handelsregler og tollbestemmelser som regulerte økonomien i det franske imperiet', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Han ble valgt til konsul gjennom folkeavstemning og kronet av paven i Notre-Dame som symbol på kirkens støtte', isCorrect: false },
              { id: 'b', text: 'Han ble utnevnt av Direktoratet som militær leder og gradvis konsoliderte sin makt gjennom politiske reformer', isCorrect: false },
              ...
              { id: 'd', text: 'Han ble pekt ut av nasjonalforsamlingen etter en folkeavstemning og kronet seg i en seremoni inspirert av Karl den store', isCorrect: false },
            ],
        ...
        questions: [
          {
            ...
            options: [
              { id: 'a', text: 'Den franske grunnloven av 1791 som etablerte et konstitusjonelt monarki', isCorrect: false },
              { id: 'b', text: 'Napoleons Code civil fra 1804 som sikret likhet for loven', isCorrect: false },
              { id: 'c', text: 'Erklæringen om menneskets og borgerens rettigheter (1789)', isCorrect: true },
              { id: 'd', text: 'Den amerikanske uavhengighetserklæringen fra 1776 som ble oversatt og spredt i Europa', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'At revolusjonen spredte seg for raskt og manglet en sterk leder som kunne sikre orden', isCorrect: false },
              { id: 'b', text: 'At det er farlig å rive ned et helt samfunnssystem basert på abstrakte prinsipper', isCorrect: true },
              { id: 'c', text: 'At revolusjonens ideer var gode, men at den kom for tidlig -- folket var ikke modent for demokrati', isCorrect: false },
              { id: 'd', text: 'At revolusjonen feilet fordi den manglet en skriftlig grunnlov som kunne begrense folkemassens makt', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Girondistene etablerte en alternativ regjering som utfordret jakobinernes makt i Paris', isCorrect: false },
              { id: 'b', text: 'Royalistiske offiserer organiserte et militærkupp med støtte fra Østerrike og Preussen', isCorrect: false },
              { id: 'c', text: 'Bønder og katolikker reiste seg mot den revolusjonære regjeringen og ble brutalt slått ned', isCorrect: true },
              { id: 'd', text: 'Føderalistiske byer nektet å anerkjenne sentralregjeringen i Paris og krevde regionalt selvstyre', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Fordi den styrket nasjonalismen i Europa, men samtidig skapte konflikter mellom nye nasjonalstater', isCorrect: false },
              { id: 'b', text: 'Fordi den avskaffet eneveldet i Frankrike, men førte til at andre europeiske monarker strammet grepet om sine undersåtter', isCorrect: false },
              ...
              { id: 'd', text: 'Fordi den inspirerte demokratiske bevegelser globalt, men også viste at republikker var ustabile sammenlignet med konstitusjonelle monarkier', isCorrect: false },
            ],
        ...
        questions: [
          {
            ...
            options: [
              { id: 'a', text: 'Nasjonal selvstendighet, folkestyre og avskaffelse av alle monarkier i Europa', isCorrect: false },
              { id: 'b', text: 'Grunnlover, maktfordeling, ytringsfrihet og stemmerett', isCorrect: true },
              { id: 'c', text: 'Sosiale reformer, bedre arbeidsvilkår og omfordeling av jordeiendommer', isCorrect: false },
              { id: 'd', text: 'Republikansk styreform, allmenn verneplikt og offentlig utdanning for alle', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Å straffe Frankrike for Napoleonskrigene og dele landet mellom seirsmaktene', isCorrect: false },
              { id: 'b', text: 'Å gjenopprette stabilitet i Europa etter revolusjon og Napoleonskrigene', isCorrect: true },
              { id: 'c', text: 'Å opprette en europeisk forsvarsallianse som kunne hindre fremtidige revolusjoner', isCorrect: false },
              { id: 'd', text: 'Å innføre konstitusjonelle monarkier i alle europeiske stater etter britisk modell', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'At den fokuserte på politiske rettigheter, men overså behovet for sosiale og økonomiske reformer', isCorrect: false },
              { id: 'b', text: 'At den var for kompromissvillig overfor de konservative kreftene og aksepterte konstitusjonelt monarki', isCorrect: false },
              ...
              { id: 'd', text: 'At den prioriterte nasjonal frihet over individuelle rettigheter i land med fremmedstyre', isCorrect: false },
            ],
        ...
        questions: [
          {
            ...
            options: [
              { id: 'a', text: 'Fordi hærene forble lojale mot monarkene og nektet å støtte de folkevalgte forsamlingene', isCorrect: false },
              { id: 'b', text: 'Fordi revolusjonene manglet støtte fra den brede landsbygdsbefolkningen som utgjorde flertallet', isCorrect: false },
              { id: 'c', text: 'Fordi revolusjonærene manglet enhet og de konservative kreftene var fortsatt sterke', isCorrect: true },
              { id: 'd', text: 'Fordi Russland og Østerrike koordinerte en militær intervensjon for å slå ned opprørene i alle land', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Avskaffelse av monarkiet, innføring av republikk og allmenn stemmerett for alle borgere', isCorrect: false },
              { id: 'b', text: 'Grunnlover, parlamentarisk styre, ytringsfrihet og nasjonal selvstendighet', isCorrect: true },
              { id: 'c', text: 'Sosiale reformer, omfordeling av jord og bedre arbeidsvilkår for industriarbeiderne', isCorrect: false },
              { id: 'd', text: 'Nasjonal selvstendighet, frihandel mellom europeiske stater og avskaffelse av tollbarrierer', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Keiser Ferdinand I', isCorrect: false },
              { id: 'b', text: 'Otto von Bismarck', isCorrect: false },
              { id: 'c', text: 'Tsar Nikolai I', isCorrect: false },
        ...
        questions: [
          {
            ...
            options: [
              { id: 'a', text: '1901', isCorrect: false },
              { id: 'b', text: '1907', isCorrect: false },
              { id: 'c', text: '1913', isCorrect: true },
              { id: 'd', text: '1919', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Omtrent 10-15 prosent -- menn med et visst inntektsnivå eller utdanning', isCorrect: false },
              { id: 'b', text: 'Omtrent 1-5 prosent -- bare rike menn med eiendom', isCorrect: true },
              { id: 'c', text: 'Omtrent 20-25 prosent -- alle menn over 25 år i de fleste land', isCorrect: false },
              { id: 'd', text: 'Omtrent 5-10 prosent -- menn som betalte en minsteskatt til staten', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Italia (1946)', isCorrect: false },
              { id: 'b', text: 'Belgia (1948)', isCorrect: false },
              { id: 'c', text: 'Frankrike (1944)', isCorrect: true },
              { id: 'd', text: 'Sveits (1971)', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'En bred reformbevegelse for allmenn stemmerett for både menn og kvinner fra arbeiderklassen', isCorrect: false },
              { id: 'b', text: 'En borgerrettighetsbevegelse som kjempet for likestilling på alle samfunnsområder', isCorrect: false },
              { id: 'c', text: 'En bevegelse som kjempet for kvinners stemmerett', isCorrect: true },
              { id: 'd', text: 'En bevegelse for sosiale reformer som barnearbeidsforbud, utdanning og fattigdomsbekjempelse', isCorrect: false },
            ],
        ...
        questions: [
          {
            ...
            options: [
              { id: 'a', text: 'At økonomisk krise alltid fører til demokratiets sammenbrudd og autoritært styre', isCorrect: false },
              { id: 'b', text: 'At demokratiet brøt sammen fordi Weimarrepublikken manglet en sterk grunnlov og maktfordeling', isCorrect: false },
              ...
              { id: 'd', text: 'At demokrati krever en lang tradisjon for å fungere, og at nye demokratier er særlig sårbare for populisme', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'De ble tvunget til å innføre konstitusjonelle monarkier gjennom Versaillesfreden', isCorrect: false },
              { id: 'b', text: 'Østerrike-Ungarn, Det osmanske riket, det russiske tsardømmet og det tyske keiserriket kollapset', isCorrect: true },
              { id: 'c', text: 'Det osmanske riket og Østerrike-Ungarn kollapset, mens Russland og Tyskland beholdt sine monarkier', isCorrect: false },
              { id: 'd', text: 'De ble svekket, men overlevde gjennom territoriale innrømmelser og demokratiske reformer', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Gorbatsjovs glasnost- og perestrojka-reformer i Sovjetunionen', isCorrect: false },
              { id: 'b', text: 'Berlinmurens fall', isCorrect: true },
              { id: 'c', text: 'Oppløsningen av Sovjetunionen i desember 1991', isCorrect: false },
              { id: 'd', text: 'De frie valgene i Polen der Solidaritet vant i juni 1989', isCorrect: false },
            ],
        ...
        questions: [
          {
            ...
            options: [
              { id: 'a', text: 'Maktfordelingsprinsippet -- at statsmakten deles mellom lovgivende, utøvende og dømmende makt', isCorrect: false },
              { id: 'b', text: 'Folkesuverenitet -- at makten tilhører folket', isCorrect: true },
              { id: 'c', text: 'Naturlige rettigheter -- at alle mennesker er født med umistelige rettigheter', isCorrect: false },
              { id: 'd', text: 'Rettsstatsprinsippet -- at alle, også makthaverne, er underlagt loven', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Kongeloven av 1665 som regulerte eneveldet i Danmark-Norge', isCorrect: false },
              { id: 'b', text: 'Christian Vs Norske Lov fra 1687 som samlet norsk lovgivning', isCorrect: false },
              { id: 'c', text: 'Grunnloven av 1814', isCorrect: true },
              { id: 'd', text: 'Formannskapslovene av 1837 som innførte lokalt selvstyre i Norge', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'At demokrati best sikres gjennom sterke institusjoner og maktfordeling, ikke gjennom folkelig deltakelse', isCorrect: false },
              { id: 'b', text: 'At gradvis reform etter britisk modell alltid er tryggere og mer varig enn revolusjonær endring', isCorrect: false },
              ...
              { id: 'd', text: 'At økonomisk velstand er den viktigste forutsetningen for at demokratier skal overleve på lang sikt', isCorrect: false },
            ],
