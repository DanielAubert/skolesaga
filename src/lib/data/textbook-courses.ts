  ...
  chapters: [
    {
      ...
      description: 'Lær grunnleggende hilsener og uttrykk på tysk.',
      estimatedMinutes: 40,
      exerciseCount: 4,
      topics: ['Hilsener', 'Avskjed', 'Høflighetsfraser'],
      competenceGoals: ['bruke enkle hilsener og høflighetsfraser'],
    },
    {
      ...
      estimatedMinutes: 45,
      exerciseCount: 4,
      topics: ['Presentasjon', 'Spørsmål', 'Verb sein/heißen'],
      competenceGoals: ['presentere seg selv og stille spørsmål'],
    },
    {
      id: 'tysk-1-2-1',
    ...
    },
    {
      ...
      estimatedMinutes: 35,
      exerciseCount: 4,
      topics: ['Farger', 'Adjektiver', 'Nyanser'],
      competenceGoals: ['beskrive ting med farger'],
    },
    {
      id: 'tysk-1-3-1',
      ...
      estimatedMinutes: 45,
      exerciseCount: 4,
      topics: ['Familie', 'Eiendomsord', 'Verb haben'],
      competenceGoals: ['fortelle om familien sin'],
    },
    {
      id: 'tysk-1-3-2',
    ...
    },
    {
      ...
      estimatedMinutes: 45,
      exerciseCount: 4,
      topics: ['Mat', 'Drikke', 'Måltider', 'Verb mögen'],
      competenceGoals: ['uttrykke hva du liker å spise'],
    },
    {
      id: 'tysk-1-5-2',
...
export const COURSE_TYSK_2: TextbookCourse = {
  ...
  icon: '🇩🇪',
  chapters: [
    { id: 'tysk-2-1', number: '1', title: 'Perfekt und Präteritum', description: 'Fortidsformer.', estimatedMinutes: 75, exerciseCount: 5, topics: ['Perfekt', 'Präteritum'], competenceGoals: ['bruke tyske fortidsformer'] },
    { id: 'tysk-2-2', number: '2', title: 'Konjunktiv II', description: 'Irrealis.', estimatedMinutes: 80, exerciseCount: 5, topics: ['Konjunktiv', 'Irrealis'], competenceGoals: ['uttrykke ønsker og muligheter'] },
    { id: 'tysk-2-3', number: '3', title: 'Passiv und Relativsätze', description: 'Passiv og relativsetninger.', estimatedMinutes: 85, exerciseCount: 5, topics: ['Passiv', 'Relativsetninger'], competenceGoals: ['bruke passiv og relativsetninger'] },
    { id: 'tysk-2-4', number: '4', title: 'Adjektivdeklination', description: 'Adjektivbøyning.', estimatedMinutes: 80, exerciseCount: 5, topics: ['Adjektiv', 'Deklinasjon'], competenceGoals: ['bøye adjektiver korrekt'] },
    { id: 'tysk-2-5', number: '5', title: 'Deutsche Literatur', description: 'Tysk litteratur.', estimatedMinutes: 70, exerciseCount: 5, topics: ['Litteratur', 'Klassikere'], competenceGoals: ['lese tysk litteratur'] },
    { id: 'tysk-2-6', number: '6', title: 'Geschichte und Politik', description: 'Historie og politikk.', estimatedMinutes: 75, exerciseCount: 5, topics: ['Historie', 'Politikk', 'Gjenforening'], competenceGoals: ['kjenne tysk historie'] },
    { id: 'tysk-2-7', number: '7', title: 'Kultur und Gesellschaft', description: 'Kultur og samfunn.', estimatedMinutes: 65, exerciseCount: 5, topics: ['Kultur', 'Samfunn', 'Tradisjoner'], competenceGoals: ['beskrive tysk kultur'] },
    { id: 'tysk-2-8', number: '8', title: 'Umwelt und Technik', description: 'Miljø og teknologi.', estimatedMinutes: 70, exerciseCount: 5, topics: ['Miljø', 'Teknologi', 'Bærekraft'], competenceGoals: ['diskutere miljø og teknologi'] },
    { id: 'tysk-2-9', number: '9', title: 'Beruf und Wirtschaft', description: 'Arbeidsliv.', estimatedMinutes: 70, exerciseCount: 5, topics: ['Arbeid', 'Økonomi', 'CV'], competenceGoals: ['kommunisere i arbeidssammenheng'] },
    { id: 'tysk-2-10', number: '10', title: 'Fortgeschrittene Kommunikation', description: 'Avansert kommunikasjon.', estimatedMinutes: 75, exerciseCount: 6, topics: ['Kommunikasjon', 'Idiomer', 'Høflighet'], competenceGoals: ['kommunisere nyansert'] },
  ],
};
