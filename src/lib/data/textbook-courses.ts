...
export const COURSE_HISTORIE_VG2: TextbookCourse = {
  ...
  chapters: [
    ...
    { id: 'historie-3-4', number: '3.6', title: 'Religionenes fremvekst', description: 'Tidlige religioner og kristendommens spredning.', estimatedMinutes: 45, exerciseCount: 5, topics: ['Religion', 'Kristendom', 'Jødedom', 'Tro'], competenceGoals: ['religionens betydning for samfunn og makt'] },
    ...
    { id: 'historie-5-5', number: '5.5', title: 'Norge i dansketiden', description: 'Norges stilling under dansk styre fra 1380 til 1814.', estimatedMinutes: 55, exerciseCount: 6, topics: ['Dansketiden', 'Lydrike', 'Reformasjonen', 'Norsk identitet'], competenceGoals: ['makt fra middelalderen til tidlig nytid', 'nasjonal identitet i Norge'] },

    // DEL 3: REVOLUSJONER OG NASJONSBYGGING (Kap 6-8)
    // Kapittel 6: Opplysningstid og revolusjoner
    { id: 'historie-6-1', number: '6.1', title: 'Opplysningstiden og nye ideer', description: 'Fornuftens tidsalder og de nye politiske ideene.', estimatedMinutes: 55, exerciseCount: 6, topics: ['Opplysningstid', 'Fornuft', 'Montesquieu', 'Rousseau'], competenceGoals: ['ideologier bak politiske omveltninger'], coverImage: '/images/textbook/historie-vg2/opplysningstiden-hero.png' },
    { id: 'historie-6-2', number: '6.2', title: 'Den amerikanske revolusjonen', description: 'Uavhengighetserklæringen og den nye republikken.', estimatedMinutes: 50, exerciseCount: 6, topics: ['USA', 'Uavhengighet', 'Grunnlov', 'Demokrati'], competenceGoals: ['ideologier bak politiske omveltninger'], coverImage: '/images/textbook/historie-vg2/den-amerikanske-revolusjonen-hero.png' },
    ...
    { id: 'historie-7-4', number: '7.4', title: 'Demografiske endringer', description: 'Befolkningsvekst, migrasjon og urbanisering.', estimatedMinutes: 45, exerciseCount: 5, topics: ['Befolkning', 'Migrasjon', 'By', 'Helse'], competenceGoals: ['demografiske endringer'], coverImage: '/images/textbook/historie-vg2/demografiske-endringer-hero.png' },
    ...
    { id: 'historie-8-2', number: '8.2', title: 'Norge 1814 og veien til selvstendighet', description: '1814, union med Sverige og frigjøringen 1905.', estimatedMinutes: 55, exerciseCount: 6, topics: ['1814', 'Grunnlov', 'Union', '1905'], competenceGoals: ['nasjonal identitet i Norge'], coverImage: '/images/textbook/historie-vg2/norge-1814-hero.png' },
    { id: 'historie-8-3', number: '8.3', title: 'Samisk historie og minoriteter', description: 'Samenes historie og minoriteters stilling i Norge.', estimatedMinutes: 50, exerciseCount: 6, topics: ['Samer', 'Minoriteter', 'Kultur', 'Rettigheter'], competenceGoals: ['myndiggjøring og frigjøring - norsk og samisk historie'], coverImage: '/images/textbook/historie-vg2/samisk-historie-hero.png' },
    ...
    { id: 'historie-9-1', number: '9.1', title: 'Imperialismens drivkrefter', description: 'Økonomiske, politiske og ideologiske årsaker til imperialismen.', estimatedMinutes: 55, exerciseCount: 6, topics: ['Imperialisme', 'Råvarer', 'Rivalisering', 'Ideologi'], competenceGoals: ['kolonimakter og konsekvenser'], coverImage: '/images/textbook/historie-vg2/imperialismens-drivkrefter-hero.png' },
    ...
    { id: 'historie-9-3', number: '9.3', title: 'Asia og kolonialisme', description: 'Britisk India, Kina og imperialismen i Asia.', estimatedMinutes: 50, exerciseCount: 6, topics: ['India', 'Kina', 'Opiumskrig', 'Japan'], competenceGoals: ['kolonimakter og konsekvenser'], coverImage: '/images/textbook/historie-vg2/asia-og-kolonialisme-hero.png' },
    { id: 'historie-9-4', number: '9.4', title: 'Konsekvenser av kolonialismen', description: 'Langvarige virkninger av kolonitiden.', estimatedMinutes: 50, exerciseCount: 6, topics: ['Konsekvenser', 'Avkolonisering', 'Arv', 'Rasisme'], competenceGoals: ['kolonimakter og konsekvenser'], coverImage: '/images/textbook/historie-vg2/konsekvenser-av-kolonialismen-hero.png' },
