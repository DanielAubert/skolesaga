...
export const COURSE_HISTORIE_VG2: TextbookCourse = {
  ...
  chapters: [
    ...
    // Kapittel 3: Antikken
    { id: 'historie-3-1', number: '3.1', title: 'De første sivilisasjonene', description: 'Mesopotamia, Egypt og de tidlige høykulturene.', estimatedMinutes: 50, exerciseCount: 6, topics: ['Mesopotamia', 'Egypt', 'Sivilisasjon', 'Skriftspråk'], competenceGoals: ['reflektere over hvordan fortiden former oss'], coverImage: '/images/textbook/historie-vg2/de-forste-sivilisasjonene-hero.png' },
    { id: 'historie-3-2', number: '3.2', title: 'Det greske demokratiet', description: 'Demokratiets fødsel i Aten og sammenligning med i dag.', estimatedMinutes: 55, exerciseCount: 6, topics: ['Aten', 'Demokrati', 'Polis', 'Borgerskap'], competenceGoals: ['demokrati i antikken vs i dag'], coverImage: '/images/textbook/historie-vg2/det-greske-demokratiet-hero.png' },
    { id: 'historie-3-3', number: '3.3', title: 'Romerriket og arven fra antikken', description: 'Romas vekst og fall, og antikkens varige betydning.', estimatedMinutes: 55, exerciseCount: 6, topics: ['Roma', 'Republikk', 'Keisertid', 'Rettsvesen'], competenceGoals: ['demokrati i antikken vs i dag'], coverImage: '/images/textbook/historie-vg2/romerriket-hero.png' },
