...
export const COURSE_GEOGRAFI: TextbookCourse = {
  ...
  icon: '🌍',
  chapters: [
    { id: 'geografi-1-1', number: '1.1', title: 'Kart og GIS', description: 'Lær om kartlesing, skala og geografiske informasjonssystemer.', estimatedMinutes: 55, exerciseCount: 6, topics: ['Kart', 'GIS', 'Skala', 'Koordinater'], competenceGoals: ['bruke geografiske verktøy'] },
    { id: 'geografi-1-2', number: '1.2', title: 'Jordens oppbygging', description: 'Forstå jordens indre struktur og platetektonikk.', estimatedMinutes: 55, exerciseCount: 6, topics: ['Platetektonikk', 'Landformer', 'Vulkaner'], competenceGoals: ['forklare geologiske prosesser'] },
    { id: 'geografi-2-1', number: '2.1', title: 'Vær og klima', description: 'Lær om værsystemer og klimasoner.', estimatedMinutes: 55, exerciseCount: 6, topics: ['Klimasoner', 'Værsystemer', 'Atmosfæren'], competenceGoals: ['forklare værfenomener og klima'] },
    { id: 'geografi-2-2', number: '2.2', title: 'Klimaendringer', description: 'Forstå årsaker og konsekvenser av klimaendringer.', estimatedMinutes: 60, exerciseCount: 6, topics: ['Drivhuseffekt', 'Parisavtalen', 'Konsekvenser'], competenceGoals: ['drøfte klimaendringer'] },
    { id: 'geografi-3-1', number: '3.1', title: 'Befolkning og demografi', description: 'Lær om befolkningsvekst og demografiske utfordringer.', estimatedMinutes: 55, exerciseCount: 6, topics: ['Befolkningspyramide', 'Migrasjon', 'Urbanisering'], competenceGoals: ['analysere befolkningsutvikling'] },
    { id: 'geografi-3-2', number: '3.2', title: 'Urbanisering', description: 'Utforsk byutvikling og urbanisering.', estimatedMinutes: 55, exerciseCount: 6, topics: ['Byer', 'Megabyer', 'Bærekraftig byutvikling'], competenceGoals: ['drøfte urbanisering'] },
    { id: 'geografi-4-1', number: '4.1', title: 'Ressursforvaltning', description: 'Lær om naturressurser og bærekraftig forvaltning.', estimatedMinutes: 55, exerciseCount: 6, topics: ['Ressurser', 'Bærekraft', 'Sirkulærøkonomi'], competenceGoals: ['vurdere ressursbruk'] },
    { id: 'geografi-4-2', number: '4.2', title: 'Naturkatastrofer', description: 'Forstå naturkatastrofer og sårbarhet.', estimatedMinutes: 55, exerciseCount: 6, topics: ['Jordskjelv', 'Flom', 'Sårbarhet', 'Risiko'], competenceGoals: ['analysere naturkatastrofer'] },
    { id: 'geografi-5-1', number: '5.1', title: 'Norge - naturgrunnlag', description: 'Utforsk Norges landskap og ressurser.', estimatedMinutes: 55, exerciseCount: 6, topics: ['Norsk natur', 'Istiden', 'Ressurser'], competenceGoals: ['beskrive norsk naturgeografi'] },
    { id: 'geografi-5-2', number: '5.2', title: 'Global ulikhet', description: 'Analyser global ulikhet og utvikling.', estimatedMinutes: 60, exerciseCount: 6, topics: ['HDI', 'Fattigdom', 'Utvikling', 'Bærekraftsmål'], competenceGoals: ['drøfte global ulikhet'] },
  ],
};
