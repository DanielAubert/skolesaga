...
Det finnes ogsa motstromninger. **Counter-urbanisering** beskriver folk som forlater storbyene for sma byer og bygder -- drevet av hoye boligpriser, onske om natur, eller muligheten til a jobbe hjemmefra. Pandemien forsterket denne trenden mange steder.`,
    },
    {
      ...
      exercise: {
        ...
        task: 'Test deg selv paa urbanisering og byvekst:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'geografi-1-6-n-quiz1-q0',
          ...
          },
          {
            ...
            solution: 'Rundt 57 prosent av verdens befolkning bor i byer i dag. I 1950 var tallet bare 30 prosent. Innen 2050 forventes naer 70 prosent aa bo i urbane omraader.',
          },
          {
            id: 'geografi-1-6-n-quiz1-q2',
            task: 'Hva er suburbanisering?',
            options: [
              { id: 'a', text: 'Naar folk flytter fra forsteder tilbake til sentrum', isCorrect: false },
              { id: 'b', text: 'Naar byer vokser ved at folk flytter til forsteder med hager og biler', isCorrect: true },
              { id: 'c', text: 'Naar byer krymper og folk flytter til landsbygda', isCorrect: false },
              { id: 'd', text: 'Naar slumomraader bygges ut med ny infrastruktur', isCorrect: false },
            ],
            solution: 'Suburbanisering er prosessen der folk flytter fra sentrum til forsteder med hager, romslige boliger og bilbasert transport. Det har vaert en dominerende trend i industrialiserte land, saerlig i USA.',
          },
        ],
      },
    },
...
Nar byer vokser sammen, far vi **byband** eller **megalopoliser**. Langs ostkysten av USA strekker et naermest sammenhengende byomrade seg fra Boston via New York og Philadelphia til Washington -- over 50 millioner mennesker i ett urbanisert belte. Lignende byband finnes i Japan, Kina og Europa.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 2',
        type: 'multiple-choice',
        task: 'Test deg selv paa megabyer og bytyper:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'geografi-1-6-n-quiz2-q0',
          ...
          {
            id: 'geografi-1-6-n-quiz2-q1',
            task: 'Hva er en megaby?',
            options: [
              { id: 'a', text: 'En by med over 1 million innbyggere', isCorrect: false },
              { id: 'b', text: 'En by med over 5 millioner innbyggere', isCorrect: false },
              { id: 'c', text: 'En by med over 10 millioner innbyggere', isCorrect: true },
              { id: 'd', text: 'En by som er hovedstad i et land', isCorrect: false },
            ],
            solution: 'En megaby er en by med over 10 millioner innbyggere. I 1950 fantes bare to megabyer (New York og Tokyo). I dag er det over 30, og de fleste ligger i det globale soer.',
          },
        ],
      },
    },
...
Men alle disse modellene har sine begrensninger. De ble laget for vestlige byer og fanger ikke opp virkeligheten i byer i det globale sor, der uformelle bosettinger, inngjerrede boligkomplekser (gated communities) og helt andre moenstre preger bybildet.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 3',
        type: 'multiple-choice',
        task: 'Test deg selv paa bymodeller og bystruktur:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'geografi-1-6-n-quiz3-q0',
          ...
          {
            id: 'geografi-1-6-n-quiz3-q1',
            task: 'Hva kjennetegner Harris og Ullmans flerkjernemodell?',
            options: [
              { id: 'a', text: 'Byen vokser i ringer rundt ett sentrum', isCorrect: false },
              { id: 'b', text: 'Byen har flere sentra med ulike funksjoner', isCorrect: true },
              { id: 'c', text: 'Byen vokser i sektorer langs transportaarer', isCorrect: false },
              { id: 'd', text: 'Byen er delt i to halvdeler -- rik og fattig', isCorrect: false },
            ],
            solution: 'Harris og Ullmans flerkjernemodell fra 1945 anerkjenner at store byer har flere sentra: historisk sentrum, nye forretningsomraader, industriomraader, universitetsomraader og forstadssentra. Dette er trolig den mest realistiske modellen for moderne storbyer.',
          },
        ],
      },
    },
...
I norsk sammenheng ser vi lignende prosesser i omrader som Gronland og Toyen i Oslo, der byfornyelse og okt attraktivitet har fort til stigende priser og endret befolkningssammensetning.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 4',
        type: 'multiple-choice',
        task: 'Test deg selv paa gentrification og byfornying:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'geografi-1-6-n-quiz4-q0',
          ...
          {
            id: 'geografi-1-6-n-quiz4-q1',
            task: 'Hva er det typiske moensteret i gentrification?',
            options: [
              { id: 'a', text: 'Rike investorer bygger nye bydeler fra grunnen', isCorrect: false },
              { id: 'b', text: 'Staten bestemmer at omraader skal oppgraderes', isCorrect: false },
              { id: 'c', text: 'Kunstnere og studenter soeker billige lokaler, etterfoelges av utviklere og prisoekning', isCorrect: true },
              { id: 'd', text: 'Folk flytter ut og omraadet forlates', isCorrect: false },
            ],
            solution: 'Det typiske moensteret er at kunstnere og studenter soeker billige lokaler i forsoemte omraader og skaper et kreativt miljoe. Eiendomsutviklere oppdager potensialet, bygaardene renoveres, prisene stiger, og de opprinnelige beboerne presses ut.',
          },
        ],
      },
    },
...
Oslo har ambisjoner om a vaere en gron by. Bjorvikatrer bygges pa tidligere havneomrader. Bilfritt sentrum utvides. Marka vernes. Men debatten gar hett: Har fortettingen gatt for langt? Taper bomiljoet? Ekskluderer hoye priser vanlige folk? Barekraftig byutvikling handler ikke bare om miljø -- det handler ogsa om hvem byen er til for.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 5',
        type: 'multiple-choice',
        task: 'Test deg selv paa baerekraftig byutvikling:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'geografi-1-6-n-quiz5-q0',
            task: 'Hvorfor er kompakt byutvikling viktig for baerekraft?',
            options: [
              ...
              { id: 'c', text: 'Det gir stoerre hager til alle innbyggere', isCorrect: false },
              { id: 'd', text: 'Det gjoer byene billigere aa bygge', isCorrect: false },
            ],
            solution: 'Kompakt byutvikling med korte avstander mellom boliger, jobb og tjenester reduserer transportbehovet. Folk kan gaa, sykle eller ta kollektivtransport i stedet for bil, noe som gir lavere utslipp og bedre luftkvalitet.',
          },
          {
            id: 'geografi-1-6-n-quiz5-q1',
            task: 'Hva betyr blandet arealbruk?',
            options: [
              { id: 'a', text: 'At industri og boliger holdes strengt adskilt', isCorrect: false },
              { id: 'b', text: 'At ulike funksjoner som boliger, butikker og kontorer mikses i samme omraade', isCorrect: true },
              { id: 'c', text: 'At groenomraader og bygninger veksler', isCorrect: false },
              { id: 'd', text: 'At byer bruker bade gammel og ny arkitektur', isCorrect: false },
            ],
            solution: 'Blandet arealbruk betyr aa mikse funksjoner -- boliger over butikker, kontorer ved siden av lekeplasser -- slik at hverdagen fungerer uten lange reiser. Det er en noekkeldel av baerekraftig byutvikling.',
          },
          {
            id: 'geografi-1-6-n-quiz5-q2',
            task: 'Omtrent hvor stor andel av verdens klimagassutslipp staar byene for?',
            options: [
              { id: 'a', text: 'Ca. 30 prosent', isCorrect: false },
            ...
            solution: 'Byene staar for rundt 70 prosent av verdens klimagassutslipp. De forbruker enorme mengder ressurser. Men de er ogsaa stedet der loesningene kan finnes gjennom kompakt utvikling, kollektivtransport og groen teknologi.',
          },
        ],
      },
    },
...
Et viktig prinsipp er **fore-var-prinsippet**: nar vi er usikre pa miljøkonsekvensene av noe, bor vi vaere forsiktige. Bedre a feile pa den sikre siden enn a oppdage for sent at vi har gjort uopprettelig skade. Men prinsippet er omdiskutert -- noen mener det kan hindre innovasjon og utvikling.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 1',
        type: 'multiple-choice',
        task: 'Test deg selv paa baerekraft og ressurser:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'geografi-1-7-n-quiz1-q0',
            task: 'Hva er definisjonen paa baerekraftig utvikling ifoelge Brundtlandkommisjonen?',
            options: [
              { id: 'a', text: 'Utvikling som gir maksimal oekonomisk vekst paa kort sikt', isCorrect: false },
              { id: 'b', text: 'Utvikling som dekker dagens behov uten aa oedelegge fremtidige generasjoners muligheter', isCorrect: true },
              { id: 'c', text: 'Utvikling som prioriterer miljoevern over alt annet', isCorrect: false },
              { id: 'd', text: 'Utvikling som fordeler ressursene likt mellom alle land', isCorrect: false },
            ],
            solution: 'Brundtlandkommisjonens definisjon fra 1987 sier at baerekraftig utvikling dekker dagens behov uten aa oedelegge fremtidige generasjoners muligheter til aa faa dekket sine behov. Det handler om balanse mellom oekologi, oekonomi og sosiale forhold.',
          },
          {
            id: 'geografi-1-7-n-quiz1-q1',
            task: 'Hva er forskjellen mellom fornybare og ikke-fornybare ressurser?',
            options: [
              { id: 'a', text: 'Fornybare ressurser er billigere enn ikke-fornybare', isCorrect: false },
              { id: 'b', text: 'Fornybare ressurser fornyer seg kontinuerlig, ikke-fornybare finnes i begrensede mengder', isCorrect: true },
              { id: 'c', text: 'Ikke-fornybare ressurser er farligere for miljoeet', isCorrect: false },
              { id: 'd', text: 'Det er ingen reell forskjell -- alle ressurser tar til slutt slutt', isCorrect: false },
            ],
            solution: 'Fornybare ressurser som sol, vind og vannkraft fornyer seg kontinuerlig. Ikke-fornybare ressurser som olje, gass og kull ble dannet over millioner av aar og finnes i begrensede mengder. I tillegg finnes betinget fornybare ressurser som skog og ferskvann, som kan fornye seg hvis vi ikke overbelaster dem.',
          },
          {
            id: 'geografi-1-7-n-quiz1-q2',
            task: 'Hva er foere-var-prinsippet?',
            options: [
              { id: 'a', text: 'At vi alltid skal prioritere oekonomisk vekst foer miljoe', isCorrect: false },
              { id: 'b', text: 'At vi skal vaere forsiktige naar vi er usikre paa miljoeekonsekvensene', isCorrect: true },
              { id: 'c', text: 'At vi skal stoppe all industriell virksomhet', isCorrect: false },
              { id: 'd', text: 'At vi skal vaere foerst ute med ny teknologi', isCorrect: false },
            ],
            solution: 'Foere-var-prinsippet sier at naar vi er usikre paa miljoeekonsekvensene av noe, boer vi vaere forsiktige. Bedre aa feile paa den sikre siden enn aa oppdage for sent at vi har gjort uopprettelig skade. Prinsippet er omdiskutert -- noen mener det kan hindre innovasjon.',
          },
        ],
      },
    },
...
Et annet viktig prinsipp er **forurenser betaler**. Den som forurenser, skal betale for opprydding og skader. Det horees rettferdig ut, men i praksis er det komplisert. Hvem skal betale for utslipp fra en fabrikk som ble lagt ned for femti ar siden? Og rammer avgifter de fattige hardere enn de rike? Debatten om CO2-avgifter og bensinavgifter handler nettopp om dette.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 2',
        type: 'multiple-choice',
        task: 'Test deg selv paa allmenningens tragedie og ressursforvaltning:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'geografi-1-7-n-quiz2-q0',
            task: 'Hva beskriver "allmenningens tragedie"?',
            options: [
              { id: 'a', text: 'At privatisering alltid foerer til overutnyttelse', isCorrect: false },
              { id: 'b', text: 'At felles ressurser risikerer aa bli overutnyttet naar alle har tilgang uten regler', isCorrect: true },
              { id: 'c', text: 'At staten alltid forvalter ressurser daarlig', isCorrect: false },
              { id: 'd', text: 'At naturkatastrofer oedelegger fellesressurser', isCorrect: false },
            ],
            solution: 'Allmenningens tragedie beskriver hvordan felles ressurser uten klare regler kan bli overutnyttet. Hver enkelt har insentiv til aa ta mest mulig, selv om det oedelegger ressursen for alle. Eksempel: Overfiske i internasjonalt farvann.',
          },
          {
            id: 'geografi-1-7-n-quiz2-q1',
            task: 'Hva betyr prinsippet "forurenser betaler"?',
            options: [
              { id: 'a', text: 'At alle maa betale like mye i miljoeeavgifter', isCorrect: false },
              { id: 'b', text: 'At den som forurenser skal betale for opprydding og skader', isCorrect: true },
              { id: 'c', text: 'At fattige land maa betale mer for forurensning', isCorrect: false },
              { id: 'd', text: 'At forurensning er gratis saa lenge man betaler skatt', isCorrect: false },
            ],
            solution: 'Prinsippet "forurenser betaler" sier at den som forurenser, skal betale for opprydding og skader. Det hoeres rettferdig ut, men i praksis er det komplisert -- for eksempel debatten om CO2-avgifter og om de rammer fattige hardere enn rike.',
          },
        ],
      },
    },
...
Hva kan gjores? Svaret ligger delvis i a ga fra en **linear okonomi** -- ta ut ressurser, produser, bruk, kast -- til en **sirkulaer okonomi** der ressurser holdes i kretsløp. Det handler om a **redusere** forbruket, **gjenbruke** produkter, **reparere** fremfor a kaste, **resirkulere** materialer, og **dele** mer med hverandre. Delingsokonomien -- bildelingsordninger, verktoydeling, klaesbyttebutikker -- er eksempler pa dette i praksis.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 3',
        type: 'multiple-choice',
        task: 'Test deg selv paa oekologisk fotavtrykk og sirkulaer oekonomi:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'geografi-1-7-n-quiz3-q0',
            ...
            solution: 'Nordmenns oekologiske fotavtrykk er blant verdens hoeyeste. Hvis alle mennesker levde som en gjennomsnittlig nordmann, ville vi trenge ca. 3,4 jordkloder for aa opprettholde forbruket.',
          },
          {
            id: 'geografi-1-7-n-quiz3-q1',
            task: 'Hva er forskjellen mellom lineaer og sirkulaer oekonomi?',
            options: [
              { id: 'a', text: 'Lineaer oekonomi er billigere, sirkulaer er dyrere', isCorrect: false },
              { id: 'b', text: 'Lineaer oekonomi tar ut, produserer og kaster; sirkulaer holder ressurser i kretsloep', isCorrect: true },
              { id: 'c', text: 'Sirkulaer oekonomi bruker bare fornybare ressurser', isCorrect: false },
              { id: 'd', text: 'Det er bare ulike navn paa det samme systemet', isCorrect: false },
            ],
            solution: 'I en lineaer oekonomi tar vi ut ressurser, produserer, bruker og kaster. I en sirkulaer oekonomi holdes ressurser i kretsloep gjennom aa redusere forbruk, gjenbruke produkter, reparere, resirkulere og dele.',
          },
        ],
      },
    },
...
Kritikerne mener malene er for ambisiøse, vanskelige a male, og at de ikke tar hensyn til maktstrukturer og interessekonflikter. Verdenen ligger ikke an til a na malene innen 2030. Men malene gir retning og et felles sprak for a snakke om barekraft.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 4',
        type: 'multiple-choice',
        task: 'Test deg selv paa FNs baerekraftsmaal:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'geografi-1-7-n-quiz4-q0',
            task: 'Hvor mange baerekraftsmaal har FN vedtatt?',
            options: [
            ...
            solution: 'FN vedtok 17 baerekraftsmaal i 2015, kjent som SDG (Sustainable Development Goals). Maalene dekker alt fra fattigdom og helse til klima og havmiljoe, og skal naas innen 2030.',
          },
          {
            id: 'geografi-1-7-n-quiz4-q1',
            task: 'Hvorfor henger FNs baerekraftsmaal sammen med hverandre?',
            options: [
              { id: 'a', text: 'Fordi de ble vedtatt paa samme dag', isCorrect: false },
              { id: 'b', text: 'Fordi fremgang paa ett maal ofte krever fremgang paa andre -- for eksempel trengs utdanning for aa utrydde fattigdom', isCorrect: true },
              { id: 'c', text: 'Fordi alle maalene handler om det samme temaet', isCorrect: false },
              { id: 'd', text: 'Fordi hvert land bare kan jobbe med ett maal om gangen', isCorrect: false },
            ],
            solution: 'Baerekraftsmaalene haenger tett sammen. Du kan ikke utrydde fattigdom uten utdanning. Du kan ikke sikre utdanning uten likestilling. Oekonomisk vekst krever energi, men kan true klimaet. Disse koblingene gjor at vi maa tenke helhetlig.',
          },
        ],
      },
    },
...
Debatten om hvor raskt Norge bor fase ut olje og gass er politisk betent. Det handler om arbeidsplasser i vestlandsregionen, om statsfinanser, om hvem som skal baere kostnadene ved omstilling, og om etiske sporsmål: er det greit a pumpe opp ressurser vi vet bidrar til klimaendringer?`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 5',
        type: 'multiple-choice',
        task: 'Test deg selv paa Norges oljeparadoks og miljoeavtaler:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'geografi-1-7-n-quiz5-q0',
            task: 'Hvilken miljoeavtale regnes som en av de mest vellykkede i historien?',
            options: [
            ...
            solution: 'Montreal-protokollen fra 1987 forboed KFK-gasser som oedela ozonlaget. Avtalen har vaert svart vellykket -- ozonlaget er i ferd med aa reparere seg. Det viser at internasjonalt samarbeid om miljoeeproblemer kan fungere.',
          },
          {
            id: 'geografi-1-7-n-quiz5-q1',
            task: 'Hvorfor omtales Norge som et "klimaparadoks"?',
            options: [
              { id: 'a', text: 'Fordi Norge har bade varmt og kaldt klima', isCorrect: false },
              { id: 'b', text: 'Fordi Norge oensker aa vaere klimaforegangsland, men er samtidig stor eksportoer av fossile brensler', isCorrect: true },
              { id: 'c', text: 'Fordi Norges utslipp oeker mens resten av verden kutter', isCorrect: false },
              { id: 'd', text: 'Fordi Norge ikke har signert noen klimaavtaler', isCorrect: false },
            ],
            solution: 'Norge oensker aa vaere et foregangsland i klimapolitikken, men er samtidig en stor eksportoer av olje og gass -- fossile brensler som bidrar til klimaendringer. Noen mener dette er et fundamentalt motsetningsforhold, andre argumenterer for at norsk gass erstatter kull i Europa.',
          },
        ],
      },
    },
...
**Skred** kommer i mange former: fjellskred, jordskred, snøskred, og i Norge et saerlig fenomen -- **kvikkleireskred**. Kvikkleire er marin leire avsatt under havet etter istiden. Nar saltet vaskes ut av grunnvannet, kan leiren kollapse fra fast til flytende tilstand -- og ta med seg alt som star pa.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 1',
        type: 'multiple-choice',
        task: 'Test deg selv paa naturkatastrofer og geologiske krefter:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'geografi-1-8-n-quiz1-q0',
            ...
            options: [
              ...
              { id: 'c', text: 'En naturkatastrofe oppstaar foerst naar en naturhendelse rammer et saarbart samfunn', isCorrect: true },
              { id: 'd', text: 'Naturhendelser er menneskeskapte, naturkatastrofer er naturlige', isCorrect: false },
            ],
            solution: 'En naturhendelse er en naturlig prosess som jordskjelv eller storm. Det blir foerst en naturkatastrofe naar hendelsen rammer et samfunn og foraarsaker store tap. Samme jordskjelv i et ubebodd omraade er ikke en katastrofe.',
          },
          {
            id: 'geografi-1-8-n-quiz1-q1',
            task: 'Hva er en pyroklastisk stroem?',
            options: [
              { id: 'a', text: 'En varm havstroem naer vulkanske oeyer', isCorrect: false },
              { id: 'b', text: 'En glodende sky av gass og aske som beveger seg i hundrevis av km/t', isCorrect: true },
              { id: 'c', text: 'En elv av smeltet lava som renner sakte nedover vulkanen', isCorrect: false },
              { id: 'd', text: 'Et underjordisk magmakammer', isCorrect: false },
            ],
            solution: 'En pyroklastisk stroem er en av de farligste konsekvensene av eksplosive vulkanutbrudd -- en glodende sky av gass, aske og steinbiter som beveger seg i hundrevis av kilometer i timen og oedelegger alt i sin vei.',
          },
        ],
      },
    },
...
**Resiliens** er evnen til a komme tilbake etter en katastrofe -- a reparere, gjenoppbygge og tilpasse seg. Rike land har generelt hoyere resiliens fordi de har ressurser til gjenoppbygging.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 2',
        type: 'multiple-choice',
        task: 'Test deg selv paa risiko og saarbarhet:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'geografi-1-8-n-quiz2-q0',
            task: 'Hvorfor doede flere i jordskjelvet i Haiti enn i Japan, selv om Japans skjelv var mye kraftigere?',
            options: [
              { id: 'a', text: 'Fordi Haiti har flere innbyggere', isCorrect: false },
              { id: 'b', text: 'Fordi jordskjelv i tropiske omraader er farligere', isCorrect: false },
              { id: 'c', text: 'Fordi Haiti var mer saarbart med daarlige bygninger, svak infrastruktur og lite beredskap', isCorrect: true },
              { id: 'd', text: 'Fordi Japan har flere fjell som beskytter befolkningen', isCorrect: false },
            ],
            solution: 'Haiti var langt mer saarbart: daarlig byggekvalitet, svak infrastruktur, lite beredskap. Japan hadde jordskjelvsikre bygninger og effektive systemer. Risiko = Fare x Saarbarhet -- Haitis hoeye saarbarhet gjorde et svakere skjelv langt mer doedelig.',
          },
          {
            id: 'geografi-1-8-n-quiz2-q1',
            task: 'Hva betyr formelen Risiko = Fare x Saarbarhet?',
            options: [
              { id: 'a', text: 'At risikoen bare avhenger av naturkreftenes styrke', isCorrect: false },
              { id: 'b', text: 'At bade naturhendelsens styrke og samfunnets evne til aa motstaa den bestemmer utfallet', isCorrect: true },
              { id: 'c', text: 'At fattige land alltid har hoeyere risiko', isCorrect: false },
              { id: 'd', text: 'At risiko kan beregnes noeyaktig paa forhaand', isCorrect: false },
            ],
            solution: 'Formelen viser at risiko avhenger av bade faren (naturhendelsens sannsynlighet og styrke) og saarbarheten (samfunnets evne til aa motstaa og haandtere hendelsen). Et rikt land med gode bygninger og beredskap har lavere saarbarhet og dermed lavere risiko.',
          },
          {
            id: 'geografi-1-8-n-quiz2-q2',
            task: 'Hva er resiliens i katastrofesammenheng?',
            options: [
              { id: 'a', text: 'Evnen til aa forutsi naar en katastrofe vil skje', isCorrect: false },
              { id: 'b', text: 'Evnen til aa forhindre alle naturhendelser', isCorrect: false },
              { id: 'c', text: 'Evnen til aa komme tilbake etter en katastrofe -- reparere, gjenoppbygge og tilpasse seg', isCorrect: true },
              { id: 'd', text: 'Evnen til aa flytte hele befolkningen til trygge omraader', isCorrect: false },
            ],
            solution: 'Resiliens er evnen til aa komme tilbake etter en katastrofe -- aa reparere, gjenoppbygge og tilpasse seg. Rike land har generelt hoeyere resiliens fordi de har ressurser til gjenoppbygging og tilpasning.',
          },
        ],
      },
    },
...
**Skogbranner** forsterkes av tørke, hete og vind. Vi har sett ødeleggende branner i Australia, California, Hellas og mange andre steder. Klimaendringene gjor brannsesongen lengre og mer intens.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 3',
        type: 'multiple-choice',
        task: 'Test deg selv paa vaerrelaterte katastrofer og klimaendringer:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'geografi-1-8-n-quiz3-q0',
            ...
            solution: 'Tropiske sykloner (orkaner, tyfoner) krever havtemperatur over 26 grader for aa dannes. Det varme vannet gir energi til stormen. Klimaendringer med varmere hav kan derfor forsterke de kraftigste stormene.',
          },
          {
            id: 'geografi-1-8-n-quiz3-q1',
            task: 'Hvilken type naturkatastrofe tar flest liv i Europa?',
            options: [
              { id: 'a', text: 'Jordskjelv', isCorrect: false },
              { id: 'b', text: 'Flom', isCorrect: false },
              { id: 'c', text: 'Hetebolger', isCorrect: true },
              { id: 'd', text: 'Vulkanutbrudd', isCorrect: false },
            ],
            solution: 'Hetebolger dreper stille -- de rammer ikke med dramatiske bilder, men tar flere liv enn de fleste andre naturkatastrofer i Europa. Eldre og syke er saerlig utsatt. Hetebolgen i Europa 2003 tok over 70 000 liv.',
          },
        ],
      },
    },
...
Norge er ogsa utsatt for andre typer skred: steinsprang i bratte fjell, jordskred i skraninger, og snøskred i fjellet. Klimaendringer med mer nedbør og temperatursvingninger kan oke risikoen for flere skredtyper.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 4',
        type: 'multiple-choice',
        task: 'Test deg selv paa kvikkleire og skredfare i Norge:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'geografi-1-8-n-quiz4-q0',
            task: 'Hva er kvikkleire?',
            options: [
              { id: 'a', text: 'En type vulkansk bergart', isCorrect: false },
              { id: 'b', text: 'Marin leire som kan kollapse fra fast til flytende naar saltet vaskes ut', isCorrect: true },
              { id: 'c', text: 'Sand som synker under vann', isCorrect: false },
              { id: 'd', text: 'Leire som oppstaar ved jordskjelv', isCorrect: false },
            ],
            solution: 'Kvikkleire er marin leire avsatt under havet etter istiden. Naar saltet vaskes ut av grunnvann, kan leiren plutselig kollapse fra fast til flytende. Dette er et saerlig norsk fenomen -- over 100 000 mennesker bor i kartlagte kvikkleiresoner.',
          },
          {
            id: 'geografi-1-8-n-quiz4-q1',
            task: 'Hva utloeste kvikkleireskredet i Gjerdrum i 2020?',
            options: [
              { id: 'a', text: 'Et kraftig jordskjelv', isCorrect: false },
              { id: 'b', text: 'En kombinasjon av erosjon, mye nedbor og bygging paa kvikkleireavsetninger', isCorrect: true },
              { id: 'c', text: 'Sprengningsarbeid i naerheten', isCorrect: false },
              { id: 'd', text: 'Et vulkanutbrudd under bakken', isCorrect: false },
            ],
            solution: 'Gjerdrumskredet ble utloest av flere faktorer: erosjon i Tistilbekken, mye nedbor og snoesmelting, og det faktum at det var bygget boliger paa kvikkleireavsetninger. Ti mennesker mistet livet.',
          },
          {
            id: 'geografi-1-8-n-quiz4-q2',
            task: 'Omtrent hvor mange mennesker i Norge bor i kartlagte kvikkleiresoner?',
            options: [
              { id: 'a', text: 'Ca. 10 000', isCorrect: false },
              { id: 'b', text: 'Ca. 50 000', isCorrect: false },
              { id: 'c', text: 'Ca. 100 000', isCorrect: true },
              { id: 'd', text: 'Ca. 500 000', isCorrect: false },
            ],
            solution: 'Over 100 000 mennesker i Norge bor i kartlagte kvikkleiresoner. Gjerdrumskredet foerte til ny oppmerksomhet om faren og strengere vurderinger for bygging i fareomraader.',
          },
        ],
      },
    },
...
**Klimatilpasning** blir stadig viktigere. Vi ma tilpasse samfunnene våre til vaer som allerede er i endring -- bygge sterkere, planlegge smartere, og akseptere at noen omrader kanskje ikke lenger er trygge a bo i.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 5',
        type: 'multiple-choice',
        task: 'Test deg selv paa katastrofeberedskap og forebygging:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'geografi-1-8-n-quiz5-q0',
            task: 'Hva betyr "build back better"?',
            options: [
              { id: 'a', text: 'Aa bygge raskere enn foer katastrofen', isCorrect: false },
              { id: 'b', text: 'Aa bygge opp samfunnet bedre og mer motstandsdyktig enn det var foer katastrofen', isCorrect: true },
              { id: 'c', text: 'Aa bygge hoeyere bygninger', isCorrect: false },
              { id: 'd', text: 'Aa bygge med billigere materialer', isCorrect: false },
            ],
            solution: '"Build back better" betyr aa bruke gjenoppbyggingen etter en katastrofe som en mulighet til aa bygge samfunnet mer motstandsdyktig enn det var foer -- med bedre bygninger, bedre infrastruktur og bedre planer.',
          },
          {
            id: 'geografi-1-8-n-quiz5-q1',
            task: 'Hva er Sendai-rammeverkets fire hovedomraader?',
            options: [
              { id: 'a', text: 'Bygge hoeyere, flytte folk, stoppe naturhendelser, straffe uaktsomhet', isCorrect: false },
              { id: 'b', text: 'Forstaa risiko, styrke risikostyring, investere i forebygging, bedre beredskap og gjenoppbygging', isCorrect: true },
              { id: 'c', text: 'Forsikring, evakuering, gjenoppbygging, erstatning', isCorrect: false },
              { id: 'd', text: 'Forskning, varsling, redning, rehabilitering', isCorrect: false },
            ],
            solution: 'FNs Sendai-rammeverk fra 2015 fokuserer paa fire omraader: forstaa risiko gjennom kartlegging og forskning, styrke risikostyring gjennom institusjoner og regelverk, investere i forebygging gjennom konkrete tiltak, og bedre beredskap og gjenoppbygging.',
          },
        ],
      },
    },
...
Da isen smeltet for rundt 10 000 ar siden, hadde den trykket jordskorpen ned under sin enorme vekt. Na, uten isens tyngde, hever landet seg fortsatt -- **landhevningen**. Oslo-omradet hever seg rundt 4 millimeter i aret. Det hoeres lite ut, men over tusenvis av ar betyr det at det som en gang var havbunn na ligger hoyt over havet.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 1',
        type: 'multiple-choice',
        task: 'Test deg selv paa Norges geologi og landformer:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'geografi-1-9-n-quiz1-q0',
            task: 'Hva foraarsaker landhevningen vi fortsatt opplever i Norge?',
            options: [
              ...
              { id: 'd', text: 'Fjellene vokser paa grunn av platetektonikk', isCorrect: false },
            ],
            solution: 'Under istiden trykket enorme isbreer jordskorpen ned med sin vekt. Naar isen smeltet, begynte jordskorpen aa heve seg igjen -- en prosess som fortsatt paagaar. Oslo-omraadet hever seg ca. 4 mm per aar.',
          },
          {
            id: 'geografi-1-9-n-quiz1-q1',
            task: 'Hva er den kaledonske fjellkjeden?',
            options: [
              { id: 'a', text: 'En fjellkjede dannet av vulkaner langs norskekysten', isCorrect: false },
              { id: 'b', text: 'Restene av en fjellkjede dannet for 400 millioner aar siden da kontinenter kolliderte', isCorrect: true },
              { id: 'c', text: 'Fjellene paa Svalbard dannet av istidene', isCorrect: false },
              { id: 'd', text: 'En ny fjellkjede som fortsatt vokser', isCorrect: false },
            ],
            solution: 'For 400 millioner aar siden kolliderte det nordamerikanske og det eurasiske kontinentet og presset opp en fjellkjede like hoey som Himalaya. Restene av den kaledonske fjellkjeden er det vi i dag kjenner som de skandinaviske fjellene.',
          },
        ],
      },
    },
...
**Nordområdene** har sine egne saertrekk: midnattssol om sommeren, mørketid om vinteren, og i Svalbard permafrost der bakken aldri tiner. Den arktiske naturen er sarbar -- et lite inngrep kan ta årtier a reparere.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 2',
        type: 'multiple-choice',
        task: 'Test deg selv paa Norges landskapstyper:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'geografi-1-9-n-quiz2-q0',
            task: 'Hva er Europas stoerste fastlandsbre?',
            options: [
            ...
            solution: 'Jostedalsbreen i Vestland er Europas stoerste fastlandsbre. Den dekker rundt 487 kvadratkilometer og er et levende minne om istidene som formet Norge.',
          },
          {
            id: 'geografi-1-9-n-quiz2-q1',
            task: 'Hva er Europas stoerste hoeyfjellsplataa?',
            options: [
              { id: 'a', text: 'Jotunheimen', isCorrect: false },
              { id: 'b', text: 'Rondane', isCorrect: false },
              { id: 'c', text: 'Hardangervidda', isCorrect: true },
              { id: 'd', text: 'Dovrefjell', isCorrect: false },
            ],
            solution: 'Hardangervidda er Europas stoerste hoeyfjellsplataa. Den ligger over tregrensen og er et viktig villreinomraade og friluftsomraade.',
          },
        ],
      },
    },
...
**Svalbard** har ekte arktisk klima med permafrost, korte somre og lange, morke vintre. Men klimaendringene rammer Arktis hardest -- Svalbard varmes opp to til tre ganger raskere enn resten av verden.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 3',
        type: 'multiple-choice',
        task: 'Test deg selv paa Norges klima:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'geografi-1-9-n-quiz3-q0',
            task: 'Hvorfor har vestkysten av Norge mye mildere klima enn omraader paa samme breddegrad i Canada?',
            options: [
              { id: 'a', text: 'Fordi fjellene beskytter mot kald luft', isCorrect: false },
              { id: 'b', text: 'Paa grunn av vulkansk varme fra jordens indre', isCorrect: false },
              { id: 'c', text: 'Paa grunn av Golfstroemmen som bringer varmt vann nordover', isCorrect: true },
              { id: 'd', text: 'Fordi Norge ligger naermere ekvator', isCorrect: false },
            ],
            solution: 'Golfstroemmen (den nordatlantiske stroemmen) bringer varmt vann fra Mexicogulfen nordover langs norskekysten. Dette gjoer klimaet mye mildere enn det ellers ville vaert paa denne breddegraden.',
          },
          {
            id: 'geografi-1-9-n-quiz3-q1',
            task: 'Hva er forskjellen mellom vestlands- og oestlandsklima?',
            options: [
              { id: 'a', text: 'Vestlandet er kaldere og toerre enn Oestlandet', isCorrect: false },
              { id: 'b', text: 'Vestlandet er mildt og vaatt (oseanisk), Oestlandet har kaldere vintre og varmere somre (kontinentalt)', isCorrect: true },
              { id: 'c', text: 'Det er ingen vesentlig forskjell', isCorrect: false },
              { id: 'd', text: 'Oestlandet faar mer nedbor enn Vestlandet', isCorrect: false },
            ],
            solution: 'Vestlandet har oseanisk klima -- mildt og vaatt med ca. 230 regndager i Bergen. Oestlandet har mer kontinentalt klima med kaldere vintre, varmere somre og mindre nedbor (Oslo faar ca. 750 mm aarlig mot Bergens over 2000 mm).',
          },
        ],
      },
    },
...
Men det er én ressurs vi har lite av: **dyrket mark**. Bare rundt 3 prosent av Norges areal er jordbruksland -- fjell, skog og myr tar resten. Det betyr at vi importerer mye av maten var, og at det lille jordbrukslandet vi har, er ekstra verdifullt å ta vare pa.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 4',
        type: 'multiple-choice',
        task: 'Test deg selv paa Norges naturressurser:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'geografi-1-9-n-quiz4-q0',
            task: 'Omtrent hvor stor andel av Norges stroemproduksjon kommer fra vannkraft?',
            options: [
            ...
            solution: 'Rundt 90 prosent av Norges stroemproduksjon kommer fra vannkraft. Norge har ideelle forhold: mye nedbor, hoeye fjell med stor fallhoeyde, og mange innsjoeeer som fungerer som naturlige magasiner.',
          },
          {
            id: 'geografi-1-9-n-quiz4-q1',
            task: 'Omtrent hvor stor andel av Norges areal er jordbruksland?',
            options: [
            ...
            solution: 'Bare rundt 3 prosent av Norges areal er jordbruksland -- fjell, skog og myr tar resten. Det betyr at vi importerer mye av maten vaar, og at det lille jordbrukslandet vi har, er ekstra verdifullt aa ta vare paa.',
          },
        ],
      },
    },
...
Det finnes ingen enkle svar. Naturgrunnlaget er Norges rikdom, men ogsa et ansvar. Hvordan vi balanserer vern og bruk, vil forme landet for generasjoner fremover.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 5',
        type: 'multiple-choice',
        task: 'Test deg selv paa naturvern og allemannsretten:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'geografi-1-9-n-quiz5-q0',
            task: 'Hva er allemannsretten?',
            options: [
              { id: 'a', text: 'Retten til aa stemme ved valg', isCorrect: false },
              ...
              { id: 'd', text: 'Retten til aa fiske i alle vann og elver', isCorrect: false },
            ],
            solution: 'Allemannsretten er en norsk tradisjon som gir alle rett til aa ferdes fritt i utmark -- gaa, sykle, telte, plukke baer og bade -- uansett hvem som eier grunnen. Dette er unikt i internasjonal sammenheng.',
          },
          {
            id: 'geografi-1-9-n-quiz5-q1',
            task: 'Hvor mange nasjonalparker har Norge?',
            options: [
            ...
            solution: 'Norge har 47 nasjonalparker, inkludert syv paa Svalbard. Formelet er aa bevare uroert natur, biologisk mangfold og kulturminner. Jotunheimen, Hardangervidda og Rondane er blant de mest kjente.',
          },
        ],
      },
    },
...
Alle disse malene har svakheter. De fanger ikke opp alt som betyr noe for et godt liv -- frihet, trygghet, miljo, fellesskap. Men de gir oss verktoy for a forsta og sammenligne.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 1',
        type: 'multiple-choice',
        task: 'Test deg selv paa maal for utvikling og ulikhet:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'geografi-1-10-n-quiz1-q0',
            task: 'Hva maaler Gini-koeffisienten?',
            options: [
              { id: 'a', text: 'Et lands totale oekonomiske produksjon', isCorrect: false },
            ...
            solution: 'Gini-koeffisienten maaler ulikhet i inntektsfordeling. 0 betyr perfekt likhet (alle har like mye), 1 betyr total ulikhet (en person har alt). Nordiske land har lave Gini-koeffisienter, mens land som Brasil og Soer-Afrika har hoeye.',
          },
          {
            id: 'geografi-1-10-n-quiz1-q1',
            task: 'Hva maaler HDI (Human Development Index)?',
            options: [
              { id: 'a', text: 'Bare et lands oekonomiske produksjon', isCorrect: false },
              { id: 'b', text: 'Forventet levealder, utdanningsnivaa og levestandard kombinert', isCorrect: true },
              { id: 'c', text: 'Antall mennesker i ekstrem fattigdom', isCorrect: false },
              { id: 'd', text: 'Et lands militaere styrke', isCorrect: false },
            ],
            solution: 'HDI kombinerer tre ting: forventet levealder, utdanningsnivaa og levestandard (maalt som BNP per innbygger). Det gir et bredere bilde av livskvalitet enn BNP alene. Norge ligger som regel paa toppen av HDI-rangeringen.',
          },
          {
            id: 'geografi-1-10-n-quiz1-q2',
            task: 'Hvorfor er BNP per innbygger et begrenset maal paa utvikling?',
            options: [
              { id: 'a', text: 'Fordi det er for vanskelig aa beregne', isCorrect: false },
              { id: 'b', text: 'Fordi det bare maaler oekonomisk aktivitet, ikke helse, utdanning eller fordeling', isCorrect: true },
              { id: 'c', text: 'Fordi det bare gjelder for rike land', isCorrect: false },
              { id: 'd', text: 'Fordi det endrer seg for ofte', isCorrect: false },
            ],
            solution: 'BNP per innbygger maaler et lands totale oekonomiske aktivitet per person, men sier ingenting om hvordan rikdommen er fordelt, om folk er friske eller syke, eller utdannede eller analfabeter. Derfor brukes ogsaa HDI, Gini og MPI.',
          },
        ],
      },
    },
...
Sannheten er trolig at alle disse faktorene spiller inn -- i ulike kombinasjoner for ulike land.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 2',
        type: 'multiple-choice',
        task: 'Test deg selv paa aarsaker til global ulikhet:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'geografi-1-10-n-quiz2-q0',
            task: 'Hvorfor brukes Soer-Korea og Ghana ofte som eksempel i diskusjonen om utvikling?',
            options: [
              ...
              { id: 'c', text: 'Fordi begge har blitt rike paa olje', isCorrect: false },
              { id: 'd', text: 'Fordi de har helt lik kultur', isCorrect: false },
            ],
            solution: 'Soer-Korea og Ghana hadde omtrent samme BNP per innbygger i 1960. Siden har Soer-Korea blitt et hoeyt utviklet land, mens Ghana fortsatt er relativt fattig. Eksempelet brukes for aa diskutere hvilke faktorer som forklarer ulik utvikling.',
          },
          {
            id: 'geografi-1-10-n-quiz2-q1',
            task: 'Hva mener den institusjonelle forklaringen er viktigst for oekonomisk utvikling?',
            options: [
              { id: 'a', text: 'Tilgang til naturressurser som olje og mineraler', isCorrect: false },
              { id: 'b', text: 'Klimaet og den geografiske beliggenheten', isCorrect: false },
              { id: 'c', text: 'Godt styresett, rettssikkerhet og lite korrupsjon', isCorrect: true },
              { id: 'd', text: 'Stoerrelsen paa befolkningen', isCorrect: false },
            ],
            solution: 'Den institusjonelle forklaringen vektlegger at styresett, rettssikkerhet og korrupsjonsnivaa er avgjorende for utvikling. Land med sterke institusjoner tiltrekker investeringer og skaper vekst, mens svake institusjoner kan foere til onde sirkler av korrupsjon og underutvikling.',
          },
        ],
      },
    },
...
**Sor-Korea** er ofte brukt som eksempel pa vellykket utvikling. Pa 1960-tallet var landet fattigere enn mange afrikanske land. I dag er det en av verdens rikeste nasjoner. Hva skjedde? Massiv satsing pa utdanning. Eksportorientert industripolitikk. Statlig styring av økonomien. Store konglomerater (chaebols) som Samsung og Hyundai. Kultur som verdsatte hard arbeid og utdanning. Ikke alt av dette kan eller bor kopieres -- Sor-Korea var lenge et diktatur -- men suksessen viser at utvikling er mulig.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 3',
        type: 'multiple-choice',
        task: 'Test deg selv paa fattigdomsfeller og veier ut av fattigdom:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'geografi-1-10-n-quiz3-q0',
            ...
            solution: 'En fattigdomsfelle er en selvforsterkende sirkel: fattigdom foerer til mangel paa utdanning, som foerer til daarlige jobber, som foerer til fattigdom. Aa bryte slike sirkler krever ofte store, koordinerte investeringer.',
          },
          {
            id: 'geografi-1-10-n-quiz3-q1',
            task: 'Hva var viktig for Soer-Koreas vellykkede oekonomiske utvikling?',
            options: [
              { id: 'a', text: 'Store oljefunn og naturressurser', isCorrect: false },
              { id: 'b', text: 'Massiv satsing paa utdanning og eksportorientert industripolitikk', isCorrect: true },
              { id: 'c', text: 'Stoer bistand fra vestlige land', isCorrect: false },
              { id: 'd', text: 'Innfoering av demokrati fra starten', isCorrect: false },
            ],
            solution: 'Soer-Korea gikk fra aa vaere fattigere enn mange afrikanske land paa 1960-tallet til en av verdens rikeste nasjoner. Noeklene var massiv utdanningssatsing, eksportorientert industripolitikk og statlig styring av oekonomien.',
          },
        ],
      },
    },
...
En mellomposisjon er at bistand kan virke under de rette forholdene: nar mottakerlandet har et fungerende styresett, nar bistanden er rettet mot konkrete mal, og nar den evalueres og justeres ut fra resultater. Bistand er ikke et mirakel, men heller ikke bortkastet. Det kommer an pa hvordan den brukes.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 4',
        type: 'multiple-choice',
        task: 'Test deg selv paa bistand og utviklingshjelp:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'geografi-1-10-n-quiz4-q0',
            ...
            solution: 'Norge gir rundt 1 prosent av bruttonasjonalinntekten (BNI) i bistand -- blant de hoeyeste andelene i verden. Men det er debatt om hvorvidt bistanden virker etter hensikten.',
          },
          {
            id: 'geografi-1-10-n-quiz4-q1',
            task: 'Hva er et hovedargument fra kritikere av bistand?',
            options: [
              { id: 'a', text: 'At bistand aldri redder liv', isCorrect: false },
              { id: 'b', text: 'At bistand kan skape avhengighet og underminere lokale markeder', isCorrect: true },
              { id: 'c', text: 'At Norge gir for lite bistand', isCorrect: false },
              { id: 'd', text: 'At bistand bare hjelper rike land', isCorrect: false },
            ],
            solution: 'Kritikere mener bistand kan skape avhengighet, underminere lokale markeder (gratis mais gjor at lokale bonder ikke faar solgt), og ende opp hos korrupte regimer. Mange mener at handel og investeringer er viktigere enn bistand.',
          },
        ],
      },
    },
...
Det vi ser, er en mer kompleks verden der de gamle kategoriene "rike land" og "fattige land" blir mindre nyttige. Fremvoksende okonomier kombinerer ekstrem rikdom og ekstrem fattigdom. Den globale middelklassen vokser. Men de aller fattigste -- saerlig i Afrika sor for Sahara -- risikerer a bli hengende etter.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 5',
        type: 'multiple-choice',
        task: 'Test deg selv paa BRICS og global maktbalanse:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'geografi-1-10-n-quiz5-q0',
            ...
            options: [
              ...
              { id: 'c', text: 'Brasil, Russland, India, Kina, Soer-Afrika', isCorrect: true },
              { id: 'd', text: 'Bangladesh, Russland, Israel, Chile, Spania', isCorrect: false },
            ],
            solution: 'BRICS stod opprinnelig for Brasil, Russland, India, Kina og Soer-Afrika -- store fremvoksende oekonomier som utfordrer vestlig dominans. Gruppen har nylig utvidet seg med flere land.',
          },
          {
            id: 'geografi-1-10-n-quiz5-q1',
            task: 'Hva har skjedd med ulikheten mellom land de siste tiaarene?',
            options: [
              { id: 'a', text: 'Den har oekt kraftig overalt', isCorrect: false },
              { id: 'b', text: 'Ulikheten mellom land har minsket, men ulikheten innenfor mange land har oekt', isCorrect: true },
              { id: 'c', text: 'Den har forblitt helt uendret', isCorrect: false },
              { id: 'd', text: 'Alle land har blitt like rike', isCorrect: false },
            ],
            solution: 'Ulikheten mellom land har faktisk minsket fordi store land som Kina og India har vokst raskt. Men ulikheten innenfor mange land har oekt. Hvor du bor innenfor et land kan bety like mye som hvilket land du bor i.',
          },
          {
            id: 'geografi-1-10-n-quiz5-q2',
            task: 'Hvor mange kinesere ble loeftet ut av ekstrem fattigdom de siste 40 aarene?',
            options: [
              { id: 'a', text: 'Ca. 100 millioner', isCorrect: false },
              { id: 'b', text: 'Ca. 300 millioner', isCorrect: false },
              { id: 'c', text: 'Ca. 500 millioner', isCorrect: false },
              { id: 'd', text: 'Ca. 800 millioner', isCorrect: true },
            ],
            solution: 'Rundt 800 millioner kinesere ble loeftet ut av ekstrem fattigdom paa 40 aar -- den stoerste fattigdomsreduksjonen i historien. Men Kina er ogsaa et ettpartistyre med begrensede friheter, og ulikheten innad i landet er stor.',
          },
        ],
      },
    },
