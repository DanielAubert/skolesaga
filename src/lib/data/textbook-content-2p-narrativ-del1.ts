    ...
    },
    {
      ...
      exercise: {
        ...
        options: [
          ...
          { id: 'b', text: 'Han har ingen økonomiske problemer', isCorrect: false },
          { id: 'c', text: 'Han har et likviditetsproblem fordi han mangler penger 1. januar', isCorrect: true },
    ...
    },
    {
      ...
      exercise: {
        ...
        options: [
          ...
          { id: 'b', text: 'Reallønnen gikk ned med ca. 0,7 %', isCorrect: true },
    ...
    },
    {
      ...
      exercise: {
        ...
        options: [
          ...
          { id: 'c', text: 'Ca. 8,0 %', isCorrect: false },
          { id: 'd', text: 'Ca. 6,2 %', isCorrect: true },
        ],
    ...
    },
    {
      ...
      exercise: {
        ...
        options: [
          ...
          { id: 'b', text: '114 752 kr', isCorrect: true },
          { id: 'c', text: '103 500 kr', isCorrect: false },
          { id: 'd', text: '135 000 kr', isCorrect: false },
        ],
        solution: 'K = 100 000 · 1,035⁴ = 100 000 · 1,14752 ≈ 114 752 kr. Renters rente gir litt mer enn enkel rente (som ville gitt 114 000).',
      },
    },
    {
    ...
    },
    {
      ...
      exercise: {
        ...
        options: [
          ...
          { id: 'b', text: 'Man betaler kun renter og nedbetaler alt til slutt', isCorrect: false },
          { id: 'c', text: 'Like store terminbeløp gjennom hele nedbetalingstiden', isCorrect: true },
    ...
    },
    {
      ...
      exercise: {
        ...
        options: [
          ...
          { id: 'c', text: 'Serielån, fordi du betaler ned gjelden raskere', isCorrect: true },
          { id: 'd', text: 'Kredittkortlån, fordi renten er fast', isCorrect: false },
        ],
    ...
    },
    {
      ...
      exercise: {
        ...
        options: [
          ...
          { id: 'c', text: '1 000 kr', isCorrect: true },
          { id: 'd', text: '2 000 kr', isCorrect: false },
        ],
        solution: 'Månedlig rente = 24 % / 12 = 2 %. Renter = 50 000 · 0,02 = 1 000 kr per måned.',
      },
    },
    {
    ...
    },
    {
      ...
      exercise: {
        ...
        options: [
          ...
          { id: 'b', text: '1 250 kr', isCorrect: false },
          { id: 'c', text: '2 500 kr', isCorrect: true },
          { id: 'd', text: '25 000 kr', isCorrect: false },
        ],
        solution: 'BSU gir 10 % skattefradrag av sparebeløpet. 25 000 · 0,10 = 2 500 kr tilbake på skatten.',
      },
    },
    {
      id: '2p-1-2-n-summary',
    ...
    },
    {
      ...
      exercise: {
        ...
        options: [
          ...
          { id: 'b', text: 'Skatteprosenten øker med høyere inntekt', isCorrect: true },
    ...
    },
    {
      ...
      exercise: {
        ...
        options: [
          ...
          { id: 'b', text: '74,90 kr', isCorrect: false },
          { id: 'c', text: '78,17 kr', isCorrect: true },
          { id: 'd', text: '67,43 kr', isCorrect: false },
        ],
        solution: 'Pris ekskl. mva = 89,90 / 1,15 ≈ 78,17 kr. Vi deler på vekstfaktoren (1 + mva-sats).',
      },
    },
    {
...
Legg merke til at selv om satsen på alminnelig inntekt er 22 prosent, er den *reelle* gjennomsnittsskatten bare 16,3 prosent – takket være fradragene. I tillegg kommer trygdeavgift som vi har utelatt her, men prinsippet er det samme.`,
    },
    {
      ...
      exercise: {
        ...
        solution: 'Pris inkl. mva = 12 000 · 1,25 = 15 000 kr. Mva-beløpet er 3 000 kr.',
      },
    },
    {
    ...
    },
    {
      ...
      exercise: {
        ...
        options: [
          ...
          { id: 'b', text: '2 665 kr', isCorrect: false },
          { id: 'c', text: '3 198 kr', isCorrect: true },
    ...
    },
    {
      ...
      exercise: {
        ...
        options: [
          ...
          { id: 'b', text: 'Husleie for lokalet', isCorrect: true },
...
50 000 kroner i måneden – det høres bra ut! Men husk at dette er et forenklet regnestykke. I virkeligheten må du kanskje betale deg selv lønn fra dette, investere i vedlikehold, betale skatt av overskuddet, og ha en buffer for dårlige måneder.`,
    },
    {
      ...
      exercise: {
        ...
        options: [
          { id: 'a', text: '30 000 kr overskudd', isCorrect: true },
          { id: 'b', text: '120 000 kr overskudd', isCorrect: false },
          { id: 'c', text: '30 000 kr underskudd', isCorrect: false },
          { id: 'd', text: '210 000 kr overskudd', isCorrect: false },
        ],
        solution: 'I = 200 · 1 500 = 300 000 kr. TK = 90 000 + 120 · 1 500 = 270 000 kr. R = 300 000 − 270 000 = 30 000 kr overskudd.',
      },
    },
    {
    ...
    },
    {
      ...
      exercise: {
        ...
        options: [
          ...
          { id: 'c', text: '750 enheter', isCorrect: false },
          { id: 'd', text: '1 000 enheter', isCorrect: true },
        ],
...
Legg merke til at avansen er mye høyere enn bruttofortjenesten – det er fordi de beregnes ut fra ulike grunnlag. Butikker oppgir gjerne avanse for å vise hvor mye de legger på, mens økonomer foretrekker bruttofortjeneste for å vise hva andelen av salgsprisen utgjør.`,
    },
    {
      ...
      exercise: {
        ...
        options: [
          { id: 'a', text: '1 430 kr', isCorrect: true },
          { id: 'b', text: '780 kr', isCorrect: false },
          { id: 'c', text: '1 300 kr', isCorrect: false },
          { id: 'd', text: '1 560 kr', isCorrect: false },
        ],
        solution: 'Salgspris = Innkjøpspris · (1 + avanse/100) = 650 · (1 + 1,20) = 650 · 2,20 = 1 430 kr.',
      },
    },
    {
    ...
    },
    {
      ...
      exercise: {
        ...
        options: [
          ...
          { id: 'd', text: '24 kr', isCorrect: true },
        ],
        solution: 'Dekningsbidrag = Salgspris − Variabel kostnad = 42 − 18 = 24 kr per brød.',
      },
    },
    {
      id: '2p-1-4-n-summary',
