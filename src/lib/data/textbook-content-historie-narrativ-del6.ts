      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'En politisk revolusjon der arbeiderne overtok makten', isCorrect: false },
              { id: 'b', text: 'En overgang fra håndverks- og jordbruksøkonomi til maskin- og fabrikkindustri', isCorrect: false },
              { id: 'c', text: 'En militær konflikt mellom Storbritannia og Frankrike', isCorrect: false },
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Stort militær, mange kolonier og en sterk konge', isCorrect: false },
              { id: 'b', text: 'Demokratisk styreform, gratis utdanning og rike oljeforekomster', isCorrect: false },
              { id: 'c', text: 'Naturressurser (kull/jern), kapital, frigjort arbeidskraft, markeder og politisk stabilitet', isCorrect: true },
              { id: 'd', text: 'Billig arbeidskraft fra slaveriet og store landområder', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Stålproduksjon', isCorrect: false },
              { id: 'b', text: 'Kullgruvedrift', isCorrect: false },
              { id: 'c', text: 'Tekstilindustrien (bomull)', isCorrect: true },
              { id: 'd', text: 'Skipsfart og handel', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Fabrikkeiere som investerte i nye maskiner', isCorrect: false },
              { id: 'b', text: 'Oppfinnere som utviklet tekstilmaskiner', isCorrect: false },
              { id: 'c', text: 'Politikere som støttet industrialiseringen', isCorrect: false },
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Kort arbeidsdag og god lønn tiltrakk folk fra landsbygda', isCorrect: false },
              { id: 'b', text: 'Arbeidsdager på 12-16 timer, seks dager i uka, der kvinner og barn utgjorde mye av arbeidsstyrken', isCorrect: true },
              { id: 'c', text: 'Bare menn over 18 år fikk jobbe, og arbeidsdagen var 8 timer', isCorrect: false },
              { id: 'd', text: 'Arbeiderne eide fabrikkene i fellesskap og delte overskuddet', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'At maskiner alltid er bedre enn mennesker', isCorrect: false },
              { id: 'b', text: 'At nåler var den viktigste varen under industrialiseringen', isCorrect: false },
              { id: 'c', text: 'At arbeidere burde jobbe alene for best kvalitet', isCorrect: false },
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'At maskiner ble billigere mens mat ble dyrere', isCorrect: false },
              ...
              { id: 'c', text: 'At Storbritannia ble fattigere selv om det industrialiserte først', isCorrect: false },
              { id: 'd', text: 'At arbeiderne tjente mer men jobbet kortere dager', isCorrect: false },
            ],
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              ...
              { id: 'd', text: 'Nederland', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'De mente andre land ikke var klare for industrialisering', isCorrect: false },
              ...
              { id: 'c', text: 'De fryktet at maskinene ville bli brukt som våpen', isCorrect: false },
              { id: 'd', text: 'Maskinene var for store til å transportere over grensene', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Bøndene som solgte jord til fabrikker', isCorrect: false },
              { id: 'b', text: 'Arbeiderne som fikk fast jobb i fabrikkene', isCorrect: false },
              { id: 'c', text: 'Håndverkerne som lærte nye teknikker', isCorrect: false },
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Fabrikkeierne ga frivillig bort formuene sine', isCorrect: false },
              { id: 'b', text: 'Fagforeningskamp, lovgivning, teknologisk utvikling og økonomisk vekst', isCorrect: true },
              { id: 'c', text: 'Industrialiseringen stoppet opp og alle ble like fattige', isCorrect: false },
              { id: 'd', text: 'Kongemakten bestemte at alle skulle tjene likt', isCorrect: false },
            ],
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              ...
              { id: 'b', text: 'Å frakte mennesker mellom byer', isCorrect: false },
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Fordi den var enkel å bygge og alle kunne lage en', isCorrect: false },
              { id: 'b', text: 'Fordi den kunne brukes i mange ulike bransjer - tekstil, jernverk, møllerier og mer', isCorrect: true },
              { id: 'c', text: 'Fordi den ble oppfunnet av en generalist, ikke en spesialist', isCorrect: false },
              { id: 'd', text: 'Fordi den ble brukt av alle sosiale klasser', isCorrect: false },
            ],
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              ...
              { id: 'b', text: 'I 1840, mellom London og Birmingham', isCorrect: false },
              { id: 'c', text: 'I 1825, mellom Stockton og Darlington i England', isCorrect: true },
              { id: 'd', text: 'I 1810, mellom Paris og Lyon i Frankrike', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'En sykdom som rammet jernbanearbeidere', isCorrect: false },
              { id: 'b', text: 'En periode der folk var redde for å reise med tog', isCorrect: false },
              { id: 'c', text: 'En protest mot at jernbanen ødela landskapet', isCorrect: false },
          ...
          },
          {
            ...
            options: [
              ...
              { id: 'd', text: 'Nasjonal identitet ble styrket fordi landene ble "mindre"', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Produksjon av elektrisitet i stor skala', isCorrect: false },
              { id: 'b', text: 'Masseproduksjon av billig stål, som muliggjorde skyskrapere, broer og bedre maskiner', isCorrect: true },
              { id: 'c', text: 'Utvinning av olje fra havbunnen', isCorrect: false },
              { id: 'd', text: 'Produksjon av kunstgjødsel til jordbruket', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'De hadde billigere arbeidskraft enn Storbritannia', isCorrect: false },
              { id: 'b', text: 'Storbritannia nektet å ta i bruk ny teknologi', isCorrect: false },
              { id: 'c', text: 'De hadde avanserte universitetssystemer og store hjemmemarkeder', isCorrect: true },
              { id: 'd', text: 'De stjal alle Storbritannias hemmeligheter gjennom spionasje', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Den gjorde at folk sluttet å jobbe om kvelden', isCorrect: false },
              { id: 'b', text: 'Den forlenget dagen - folk kunne lese, arbeide og være sosiale etter mørkets frembrudd', isCorrect: true },
              { id: 'c', text: 'Den hadde liten praktisk betydning fordi den var for dyr for vanlige folk', isCorrect: false },
              { id: 'd', text: 'Den ble bare brukt i fabrikker, ikke i private hjem', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'De ble alle oppfunnet i Storbritannia', isCorrect: false },
              { id: 'b', text: 'De ble alle utviklet av universitetsprofessorer', isCorrect: false },
              ...
              { id: 'd', text: 'De ble alle finansiert av staten', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              ...
              { id: 'b', text: 'Radio (1837), telefon (1876), telegraf (1890-tallet)', isCorrect: false },
              { id: 'c', text: 'Telegraf (1837), telefon (1876), radio (1890-tallet)', isCorrect: true },
              { id: 'd', text: 'Telegraf (1876), radio (1837), telefon (1890-tallet)', isCorrect: false },
            ],
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              ...
              { id: 'b', text: 'Religiøse overbevisninger om at teknologi var Guds vilje', isCorrect: false },
              { id: 'c', text: 'Statlig planlegging der regjeringen bestemte hva som skulle oppfinnes', isCorrect: false },
              { id: 'd', text: 'Tilfeldigheter - oppfinnelsene hadde ingen samfunnsmessig forklaring', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'At teknologi alltid er positiv for alle i samfunnet', isCorrect: false },
              { id: 'b', text: 'At teknologisk utvikling bør stoppes for å beskytte tradisjonelle yrker', isCorrect: false },
              { id: 'c', text: 'At bare vitenskapsfolk kan forstå teknologisk utvikling', isCorrect: false },
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'At alle fabrikker måtte legges ned', isCorrect: false },
              { id: 'b', text: 'At arbeidere fikk rett til å organisere seg i fagforeninger', isCorrect: false },
              { id: 'c', text: 'At arbeid for barn under ni år ble forbudt i britiske tekstilfabrikker', isCorrect: true },
              { id: 'd', text: 'At arbeidsdagen ble begrenset til åtte timer for alle', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Bare fagforeningene gjennom streiker', isCorrect: false },
              { id: 'b', text: 'Barna selv som nektet å jobbe', isCorrect: false },
              { id: 'c', text: 'Fabrikkeierne som ønsket å bruke maskiner i stedet', isCorrect: false },
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Fordi arbeiderne ikke ønsket å organisere seg', isCorrect: false },
              ...
              { id: 'c', text: 'Fordi fagforeninger ble sett på som religiøse sekter', isCorrect: false },
              { id: 'd', text: 'Fordi det ikke fantes nok arbeidere til å danne foreninger', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'At arbeiderne skulle overta eierskap av fabrikkene', isCorrect: false },
              { id: 'b', text: 'At arbeiderne skulle jobbe hardere for å få høyere lønn', isCorrect: false },
              { id: 'c', text: 'At maskiner skulle erstattes med håndarbeid', isCorrect: false },
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'En politiker som forbød fagforeninger', isCorrect: false },
              { id: 'b', text: 'En oppfinner som utviklet dampmaskinene', isCorrect: false },
              ...
              { id: 'd', text: 'En arbeider som ledet den første store streiken i England', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Pengene arbeiderne fikk i lønn', isCorrect: false },
              { id: 'b', text: 'Fabrikkene, maskinene og råvarene som trengs for å produsere varer', isCorrect: true },
              { id: 'c', text: 'Arbeidsmetodene og teknikkene arbeiderne brukte', isCorrect: false },
              { id: 'd', text: 'De ferdige varene som ble solgt på markedet', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'At den ville vokse evig og gjøre alle rike', isCorrect: false },
              { id: 'b', text: 'At den gradvis ville reformere seg selv gjennom lover', isCorrect: false },
              { id: 'c', text: 'At den ville bryte sammen og arbeiderklassen ville gjøre revolusjon for å innføre sosialisme', isCorrect: true },
              { id: 'd', text: 'At den ville bli erstattet av jordbruk igjen', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'En politisk revolusjon i England som ga arbeiderne stemmerett', isCorrect: false },
              ...
              { id: 'c', text: 'En arbeideropprør som beviste at Marx hadde rett om klassekampen', isCorrect: false },
              { id: 'd', text: 'En vitenskapelig oppdagelse som motbeviste at maskiner kunne erstatte arbeidere', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Ca. 500 medlemmer i en enkelt forening i Oslo', isCorrect: false },
              { id: 'b', text: 'Ca. 5 000 medlemmer fordelt på noen byer', isCorrect: false },
              { id: 'c', text: 'Ca. 30 000 medlemmer i arbeiderforeninger over hele landet', isCorrect: true },
              { id: 'd', text: 'Ca. 100 000 medlemmer som dannet et eget politisk parti', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Den fikk gjennomslag for alle kravene sine og ble nedlagt', isCorrect: false },
              { id: 'b', text: 'Den ble forbudt av Sverige som ønsket å kontrollere Norge', isCorrect: false },
              { id: 'c', text: 'Den fusjonerte med Arbeiderpartiet og ble en del av Stortinget', isCorrect: false },
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'I 1850, som et direkte resultat av Thranes kamp', isCorrect: false },
              { id: 'b', text: 'I 1870, etter at Thrane kom ut av fengselet', isCorrect: false },
              { id: 'c', text: 'I 1898, nesten femti år etter Thranes bevegelse', isCorrect: true },
              { id: 'd', text: 'I 1913, samtidig med kvinners stemmerett', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Han ledet den første store streiken i England', isCorrect: false },
              { id: 'b', text: 'Han oppfant kloakksystemet', isCorrect: false },
              ...
              { id: 'd', text: 'Han innførte åtte-timers arbeidsdag i sin egen fabrikk', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Retten til å eie fabrikker og retten til å ha slaver', isCorrect: false },
              { id: 'b', text: 'Retten til privat eiendom og retten til å arve', isCorrect: false },
              { id: 'c', text: 'Retten til gratis luksus og retten til å slippe å jobbe', isCorrect: false },
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Overgangen fra bysamfunn til jordbrukssamfunn', isCorrect: false },
              { id: 'b', text: 'Overgangen fra fred til krig som skapte flyktningestrømmer', isCorrect: false },
              { id: 'c', text: 'Overgangen fra høy fødsels- og dødsrate til lav fødsels- og dødsrate, med rask vekst i mellomfasen', isCorrect: true },
              { id: 'd', text: 'Overgangen fra mange eldre til mange unge i befolkningen', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Ca. 20 prosent', isCorrect: false },
              { id: 'b', text: 'Ca. 40 prosent', isCorrect: false },
              { id: 'c', text: 'Ca. 60 prosent', isCorrect: false },
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Fordi byene hadde bedre boliger og renere luft enn landsbygda', isCorrect: false },
              { id: 'b', text: 'Fordi staten tvang folk til å flytte fra landsbygda', isCorrect: false },
              { id: 'c', text: 'Fordi fabrikkene trengte arbeidskraft og lønningene var bedre enn det småbønder tjente', isCorrect: true },
              { id: 'd', text: 'Fordi byene tilbød gratis utdanning til alle', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'De lå på landsbygda, langt fra byene', isCorrect: false },
              { id: 'b', text: 'Store, luftige boliger med innlagt vann, gassbelysning, brede boulevarder og vakre parker', isCorrect: true },
              { id: 'c', text: 'De var like trange og skitne som arbeiderstrøkene', isCorrect: false },
              { id: 'd', text: 'De hadde ingen tjenerskap fordi borgerskapet var opptatt av likhet', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Ca. 2-5 år lavere', isCorrect: false },
              { id: 'b', text: 'Ca. 5-10 år lavere', isCorrect: false },
              { id: 'c', text: '20-30 år lavere', isCorrect: true },
              { id: 'd', text: 'Det var ingen forskjell i levealder', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'En teori om at sykdommer ble spredt gjennom berøring mellom mennesker', isCorrect: false },
              { id: 'b', text: 'En teori om at sykdommer skyldtes Guds straff for synd', isCorrect: false },
              { id: 'c', text: 'En teori om at sykdommer ble spredt gjennom "dårlig luft" fra kloakk og forråtning', isCorrect: true },
              { id: 'd', text: 'En teori om at sykdommer ble spredt gjennom forurenset mat', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Han studerte bakterier under mikroskop', isCorrect: false },
              { id: 'b', text: 'Han gjennomførte eksperimenter på dyr', isCorrect: false },
              ...
              { id: 'd', text: 'Han intervjuet overlevende og analyserte kostholdet deres', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Forbud mot all industri i byene', isCorrect: false },
              { id: 'b', text: 'Tvungen evakuering av alle arbeiderstrøk', isCorrect: false },
              { id: 'c', text: 'Offentlig vannforsyning, kloakksystemer, boligreguleringer og offentlige parker', isCorrect: true },
              { id: 'd', text: 'Stenging av alle vannpumper og overgang til kun flaskevann', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Før industrialiseringen bodde familier bare i byer, etterpå på landsbygda', isCorrect: false },
              ...
              { id: 'c', text: 'Familiene ble større etter industrialiseringen fordi folk fikk flere barn', isCorrect: false },
              { id: 'd', text: 'Kvinner fikk mer makt i familien etter industrialiseringen', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Kollektiver der flere familier bodde sammen i fabrikker', isCorrect: false },
              { id: 'b', text: 'Enslige personer som bodde alene i byene', isCorrect: false },
              { id: 'c', text: 'Kjernefamilien - foreldre og barn - med nye kjønnsroller der far var forsørger og mor var husmor', isCorrect: true },
              { id: 'd', text: 'Barnehjem der barn ble oppdratt av staten', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Fordi staten innførte grenser for hvor mange barn man kunne ha', isCorrect: false },
              { id: 'b', text: 'Fordi det ble fysisk vanskeligere å få barn på grunn av forurensning', isCorrect: false },
              { id: 'c', text: 'Fordi barn ikke lenger var arbeidskraft men en utgift til utdanning, og flere barn overlevde', isCorrect: true },
              { id: 'd', text: 'Fordi religionen forbød store familier i byene', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Fordi den bare endret økonomien, ikke noe annet', isCorrect: false },
              { id: 'b', text: 'Fordi den krevde at alle byttet jobb på en gang', isCorrect: false },
              { id: 'c', text: 'Fordi den forandret alt: arbeid, bosted, familieliv, helse og til og med hvor mange barn folk fikk', isCorrect: true },
              { id: 'd', text: 'Fordi den ødela alle eksisterende samfunnsstrukturer uten å erstatte dem', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Militæret og utenrikstjenesten', isCorrect: false },
              { id: 'b', text: 'Den moderne byen, offentlig helsevesen, kjernefamilien og skoleplikten', isCorrect: true },
              { id: 'c', text: 'Parlamentet og kongedømmet', isCorrect: false },
              { id: 'd', text: 'Universiteter og forskningsinstitusjoner', isCorrect: false },
            ],
