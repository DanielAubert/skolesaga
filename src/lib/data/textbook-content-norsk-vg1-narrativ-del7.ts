...
Film er både kunst og håndverk. Den er drøm og teknikk. Den er følelse og analyse. Når du lærer å se begge sider, blir filmopplevelsen rikere. Du mister ikke magien, du forstår den bedre. Og kanskje, hvis du vil, kan du en dag skape din egen.`,
    ...
    // ========== QUIZ 5 ==========
    {
      ...
      exercise: {
        ...
        options: [
          { id: 'a', text: 'Å lese så mange teoriøbker som mulig om filmhistorie', isCorrect: false },
    ...
    // ========== QUIZ 5 ==========
    {
      ...
      exercise: {
        ...
        options: [
          ...
          { id: 'b', text: 'Fordi demokratiet er avhengig av at borgere tar informerte valg basert på sant informasjon', isCorrect: true },
