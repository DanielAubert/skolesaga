...
Men selv etter at fodselsraten har falt, fortsetter befolkningen a vokse en stund. Dette kalles **demografisk momentum** - det skyldes at store ungdomskull allerede er fodt og vil fa sine egne barn. Det er derfor verdens befolkning fortsetter a vokse selv om fodselsratene faller.`,
    },
    {
      ...
      exercise: {
        ...
        task: 'Test deg selv pa den demografiske overgangen:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'geografi-1-16-n-quiz1-q0',
            ...
            solution: 'I fase 2 synker dodsraten kraftig pa grunn av bedre hygiene og helse, mens fodselsraten forblir hoy. Denne kombinasjonen gir rask befolkningsvekst.',
          },
          {
            id: 'geografi-1-16-n-quiz1-q1',
            task: 'Hva er demografisk momentum?',
            options: [
              { id: 'a', text: 'At befolkningen synker raskere og raskere', isCorrect: false },
              { id: 'b', text: 'At befolkningen fortsetter a vokse selv etter at fodselsraten har falt', isCorrect: true },
              { id: 'c', text: 'At folk flytter raskere mellom land', isCorrect: false },
              { id: 'd', text: 'At dodsraten stiger i fase 4', isCorrect: false },
            ],
            solution: 'Demografisk momentum betyr at befolkningen fortsetter a vokse en stund selv etter at fodselsraten har falt. Dette skyldes at store ungdomskull allerede er fodt og vil fa sine egne barn. Det er derfor verdens befolkning fortsetter a vokse selv om fodselsratene faller.',
          },
          {
            id: 'geografi-1-16-n-quiz1-q2',
            task: 'Hva kjennetegner fase 4 i den demografiske overgangen?',
            options: [
              { id: 'a', text: 'Hoy fodselsrate og hoy dodsrate', isCorrect: false },
              { id: 'b', text: 'Hoy fodselsrate og lav dodsrate', isCorrect: false },
              { id: 'c', text: 'Lav fodselsrate og lav dodsrate -- stabil eller synkende befolkning', isCorrect: true },
              { id: 'd', text: 'Lav fodselsrate og hoy dodsrate', isCorrect: false },
            ],
            solution: 'I fase 4 er bade fodsels- og dodsraten lave. Befolkningen stabiliserer seg eller begynner a synke. Norge, Japan og de fleste europeiske land er i denne fasen. Noen mener vi ser en fase 5 der fodselsraten faller enda lavere.',
          },
        ],
      },
    },
...
Men det finnes ogsa en mulighetenes periode: Nar et land har en ung befolkning som akkurat har begynt a fa faerre barn, far de en hoy andel arbeidsfore. Dette kalles den **demografiske dividenden** og har bidratt til okonomisk vekst i land som Sor-Korea og Kina.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 2',
        type: 'multiple-choice',
        task: 'Test deg selv pa befolkningspyramider:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'geografi-1-16-n-quiz2-q0',
            ...
            solution: 'En kontraherende pyramide har smal bunn (fa barn) og bred midtdel (mange middelaldrende og eldre). Japan og Tyskland er typiske eksempler.',
          },
          {
            id: 'geografi-1-16-n-quiz2-q1',
            task: 'Hva er forsorgelsesbyrden?',
            options: [
              { id: 'a', text: 'Kostnaden ved a forsørge en gjennomsnittsfamilie', isCorrect: false },
              { id: 'b', text: 'Forholdet mellom arbeidsfore (15-64 ar) og de som forsorges (barn og eldre)', isCorrect: true },
              { id: 'c', text: 'Antall barn per kvinne i et land', isCorrect: false },
              { id: 'd', text: 'Skattenivaet i et land med aldrende befolkning', isCorrect: false },
            ],
            solution: 'Forsorgelsesbyrden er forholdet mellom de som jobber (15-64 ar) og de som forsorges (barn og eldre). I et land med aldrende befolkning blir det faerre arbeidende til a forsørge flere pensjonister, noe som skaper utfordringer for velferdssystemene.',
          },
          {
            id: 'geografi-1-16-n-quiz2-q2',
            task: 'Hva er den demografiske dividenden?',
            options: [
              { id: 'a', text: 'Penger som sendes hjem av emigranter', isCorrect: false },
              { id: 'b', text: 'Okonomisk vekst nar et land har en hoy andel arbeidsfore i befolkningen', isCorrect: true },
              { id: 'c', text: 'Bistand fra rike til fattige land', isCorrect: false },
              { id: 'd', text: 'Inntekter fra turisme i befolkningsrike land', isCorrect: false },
            ],
            solution: 'Den demografiske dividenden oppstar nar et land har en ung befolkning som akkurat har begynt a fa faerre barn, slik at de far en hoy andel arbeidsfore. Sor-Korea og Kina har dratt nytte av denne perioden for okonomisk vekst.',
          },
        ],
      },
    },
...
Fremtiden er usikker. SSBs befolkningsfremskrivninger viser ulike scenarioer avhengig av fodselsrate og innvandring. Hovedalternativet viser fortsatt vekst til 6-7 millioner i 2100, men det er stor usikkerhet.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 3',
        type: 'multiple-choice',
        task: 'Test deg selv pa Norges demografi:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'geografi-1-16-n-quiz3-q0',
            ...
            solution: 'Norges fodselsrate er ca. 1,4 barn per kvinne, betydelig under reproduksjonsnivat pa 2,1. Uten innvandring ville befolkningen begynt a synke.',
          },
          {
            id: 'geografi-1-16-n-quiz3-q1',
            task: 'Hva menes med sentralisering i norsk sammenheng?',
            options: [
              { id: 'a', text: 'At regjeringen far mer makt', isCorrect: false },
              { id: 'b', text: 'At folk flytter fra distriktene til storbyene', isCorrect: true },
              { id: 'c', text: 'At alle skoler samles i ett omrade', isCorrect: false },
              { id: 'd', text: 'At Norge blir medlem av EU', isCorrect: false },
            ],
            solution: 'Sentralisering betyr at folk flytter fra distriktene til storbyene -- sarlig Oslo-regionen, Bergen, Stavanger og Trondheim. Distriktene mister unge og arbeidsfore, mens byene ma haandtere rask vekst.',
          },
        ],
      },
    },
...
Japan viser oss at det ikke finnes enkle losninger pa demografiske utfordringer. De tar generasjoner a utvikle og generasjoner a snu.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 4',
        type: 'multiple-choice',
        task: 'Test deg selv pa Japans demografiske utfordringer:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'geografi-1-16-n-quiz4-q0',
            ...
            solution: 'Japans lave fodselsrate skyldes blant annet hoye levekostnader, ekstremt lange arbeidsdager, og at det er vanskelig a kombinere karriere med barneomsorg.',
          },
          {
            id: 'geografi-1-16-n-quiz4-q1',
            task: 'Hva er en konsekvens av at Japan har over 30 prosent av befolkningen over 65 ar?',
            options: [
              { id: 'a', text: 'Arbeidsstyrken krymper og pensjonskostnadene eksploderer', isCorrect: true },
              { id: 'b', text: 'Landet far mer innovasjon fordi eldre er erfarne', isCorrect: false },
              { id: 'c', text: 'Boligprisene stiger fordi eldre kjoper flere boliger', isCorrect: false },
              { id: 'd', text: 'Utvandringen oker fordi unge vil bo i yngre samfunn', isCorrect: false },
            ],
            solution: 'Nar over 30 prosent av befolkningen er over 65 ar, krymper arbeidsstyrken, pensjonskostnadene eksploderer, distrikter avfolkes, og det finnes ikke nok folk til a ta seg av de eldste. Japan provar blant annet roboter i eldreomsorgen.',
          },
        ],
      },
    },
...
Likevel er modellen et godt pedagogisk utgangspunkt for a forsta demografiske prosesser. Vi ma bare huske dens begrensninger og bruke den som ett verktoy blant flere.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 5',
        type: 'multiple-choice',
        task: 'Test deg selv pa kritikk av den demografiske modellen:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'geografi-1-16-n-quiz5-q0',
            ...
            solution: 'Modellen er basert pa europeisk historie og antar at alle land folger samme monster. I virkeligheten har mange land hatt andre utviklingslop.',
          },
          {
            id: 'geografi-1-16-n-quiz5-q1',
            task: 'Sor-Korea har en fodselsrate pa bare 0,7 barn per kvinne. Hva viser dette om modellen?',
            options: [
              { id: 'a', text: 'At modellen er perfekt -- Sor-Korea er i fase 4', isCorrect: false },
              { id: 'b', text: 'At modellen ikke forutsa vedvarende lav fertilitet langt under reproduksjonsniva', isCorrect: true },
              { id: 'c', text: 'At Sor-Korea er tilbake i fase 1', isCorrect: false },
              { id: 'd', text: 'At Sor-Korea har innfort ettbarnspolitikk', isCorrect: false },
            ],
            solution: 'Modellen forutsa stabilisering i fase 4, ikke vedvarende lav fertilitet. Sor-Koreas 0,7 barn per kvinne -- det laveste i verden -- viser at noen land har gatt langt forbi det modellen forventet. Ingen vet helt hvorfor dette skjer eller hvordan det kan snus.',
          },
        ],
      },
    },
