...
Men hvor lenge varer reisen? Det varierer enormt. Vann i atmosfaeren har en **oppholdstid** pa bare rundt 9 dager. I elver er oppholdstiden ca. 2 uker. I innsjeer ca. 10 ar. Men grunnvann kan ligge i bakken i 100 til 10 000 ar, og vann som er frosset i isbreer kan vaere der i 1 000 til 100 000 ar. Vannet du drikker i dag kan ha falt som regn for tusenvis av ar siden.`,
    },
    {
      ...
      exercise: {
        ...
        task: 'Test deg selv pa vannets kretslop:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'geografi-1-11-n-quiz1-q0',
          ...
          {
            id: 'geografi-1-11-n-quiz1-q1',
            task: 'Hva kalles prosessen der vann trenger ned i bakken og blir til grunnvann?',
            options: [
              { id: 'a', text: 'Kondensasjon', isCorrect: false },
              { id: 'b', text: 'Transpirasjon', isCorrect: false },
              { id: 'c', text: 'Infiltrasjon', isCorrect: true },
              { id: 'd', text: 'Fordampning', isCorrect: false },
            ],
            solution: 'Infiltrasjon er prosessen der vann trenger ned i bakken gjennom porer og sprekker i jord og fjell, og blir til grunnvann. Kondensasjon er overgang fra gass til vaske, transpirasjon er planter som slipper ut vann, og fordampning er overgang fra vaske til gass.',
          },
          {
            id: 'geografi-1-11-n-quiz1-q2',
            task: 'Hva er transpirasjon?',
            options: [
              { id: 'a', text: 'Vann som fryser til is i skyene', isCorrect: false },
              { id: 'b', text: 'Vann som fordamper fra havoverflaten', isCorrect: false },
              { id: 'c', text: 'Vann som renner pa overflaten ned mot elver', isCorrect: false },
              { id: 'd', text: 'Planter som tar opp vann gjennom rottene og slipper det ut gjennom bladene', isCorrect: true },
            ],
            solution: 'Transpirasjon er prosessen der planter tar opp vann gjennom rottene og slipper det ut gjennom bladene som vanndamp. Dette er en viktig del av vannets kretslop og bidrar til at vann returneres til atmosfaeren.',
          },
        ],
      },
    },
...
Disse tre prosessene -- erosjon, transport, avsetning -- forklarer hvordan elver former landskapet over tid. De graver ut daler, frakter materiale nedover, og bygger opp deltaer og sletter.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 2',
        type: 'multiple-choice',
        task: 'Test deg selv pa elvens erosjon, transport og avsetning:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'geografi-1-11-n-quiz2-q0',
          ...
          {
            id: 'geografi-1-11-n-quiz2-q1',
            task: 'Hva kalles det nar steiner i vannet sliper mot bunnen og sidene av elveleet?',
            options: [
              { id: 'a', text: 'Hydraulisk erosjon', isCorrect: false },
              { id: 'b', text: 'Korrosjon', isCorrect: false },
              { id: 'c', text: 'Korrasjon', isCorrect: true },
              { id: 'd', text: 'Saltasjon', isCorrect: false },
            ],
            solution: 'Korrasjon er nar steiner som allerede er i vannet sliper mot bunnen og sidene av elveleet, som sandpapir mot tre. Hydraulisk erosjon er vannets rene kraft. Korrosjon er kjemisk opplasing. Saltasjon er en transportform der partikler hopper langs bunnen.',
          },
          {
            id: 'geografi-1-11-n-quiz2-q2',
            task: 'Hva skjer nar vannhastigheten i en elv avtar?',
            options: [
              { id: 'a', text: 'Erosjonen oker fordi vannet far mer tid til a grave', isCorrect: false },
              { id: 'b', text: 'Vannet begynner a fordampe raskere', isCorrect: false },
              { id: 'c', text: 'Partikler synker til bunns -- de tyngste forst', isCorrect: true },
              { id: 'd', text: 'Elven begynner a grave seg dypere ned', isCorrect: false },
            ],
            solution: 'Nar vannhastigheten avtar, mister elven evnen til a transportere materiale. Partiklene synker til bunns -- de tyngste forst, deretter de lettere. Derfor finner du grov grus der elven bremser plutselig, og fin sand og leire lenger ut der vannet er roligere. Dette kalles avsetning.',
          },
        ],
      },
    },
...
**Elveterrasser** er gamle elveflater som na ligger hoyere enn dagens elvelo. De viser at elven har gravd seg dypere ned over tid. Og **juv** og **gjel** er trange, dype klofter gravd ut av elven -- som Jutulhogget i Hedmark, en spektakulaer juv gravd ut i tiden etter istiden.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 3',
        type: 'multiple-choice',
        task: 'Test deg selv pa landskapsformer skapt av elven:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'geografi-1-11-n-quiz3-q0',
          ...
          {
            id: 'geografi-1-11-n-quiz3-q1',
            task: 'Hva kjennetegner en V-dal?',
            options: [
              { id: 'a', text: 'Bred, flat bunn med bratte sider -- formet av isbre', isCorrect: false },
              { id: 'b', text: 'Trang bunn med skranende sider -- formet av elv i bratt terreng', isCorrect: true },
              { id: 'c', text: 'En flat slette langs en elv som oversvommes ved flom', isCorrect: false },
              { id: 'd', text: 'En dyp sprekk i fjellet formet av jordskjelv', isCorrect: false },
            ],
            solution: 'En V-dal er typisk for unge elver i bratt terreng. Elven graver raskt nedover, og sidene forvitrer og raser ut. Resultatet er en dal med V-formet profil -- trang i bunnen, skranende sider oppover. U-daler derimot er brede med flat bunn og bratte sider, formet av isbreer.',
          },
          {
            id: 'geografi-1-11-n-quiz3-q2',
            task: 'Hva er en elvevifte (alluvial vifte)?',
            options: [
              { id: 'a', text: 'Et fossilt elveleie som viser elvens gamle losning', isCorrect: false },
              { id: 'b', text: 'En virvle i elven der vannet gar i sirkel', isCorrect: false },
              { id: 'c', text: 'En halvmaneformet innsjo dannet av en avsnort meandersvinge', isCorrect: false },
              { id: 'd', text: 'En vifteformet avsetning der en bratt elv moter flatere terreng', isCorrect: true },
            ],
            solution: 'En elvevifte (alluvial vifte) dannes nar en bratt elv plutselig moter flatere terreng og bremser. All grusen og sanden elven har fraktet med seg, avsettes i en vifteform fordi vannet sprer seg ut og mister transportevnen.',
          },
        ],
      },
    },
...
Glomma har hatt flere store flommer i moderne tid -- i 1967, 1995 og 2018. Hver gang har de minnet oss pa at vi lever med naturen, ikke bare i den.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 4',
        type: 'multiple-choice',
        task: 'Test deg selv pa flom og flomvern:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'geografi-1-11-n-quiz4-q0',
          ...
          {
            id: 'geografi-1-11-n-quiz4-q1',
            task: 'Hva er kanskje det viktigste tiltaket for a beskytte mot flomskader?',
            options: [
              { id: 'a', text: 'Arealplanlegging -- a unnga a bygge i flomutsatte omrader', isCorrect: true },
              { id: 'b', text: 'A plante traer langs alle elver', isCorrect: false },
              { id: 'c', text: 'A fjerne all vegetasjon langs elvene sa vannet renner raskere', isCorrect: false },
              { id: 'd', text: 'A sprenge nye elveleier gjennom fjell', isCorrect: false },
            ],
            solution: 'Arealplanlegging -- a unnga a bygge i flomutsatte omrader i utgangspunktet -- er kanskje det viktigste tiltaket. I tillegg brukes flomvoller, flomdammer, regulering med demninger, og varslingssystemer.',
          },
          {
            id: 'geografi-1-11-n-quiz4-q2',
            task: 'Kan flom ha positive sider?',
            options: [
              { id: 'a', text: 'Nei, flom er alltid odelaggende', isCorrect: false },
              { id: 'b', text: 'Ja, flomsletter far tilfort naeringsrik jord som gjor dem fruktbare', isCorrect: true },
              { id: 'c', text: 'Ja, men bare i tropiske omrader', isCorrect: false },
              { id: 'd', text: 'Ja, fordi flom dreper skadedyr', isCorrect: false },
            ],
            solution: 'Flom har ogsa positive sider. Flomsletter far tilfort naeringsrik jord. I tusener av ar har mennesker dyrket jorda pa flomslettene langs store elver som Nilen, nettopp fordi flommene gjodde jorda. Vatmarker er ogsa avhengige av flommer for a opprettholde okosystemene sine.',
          },
        ],
      },
    },
...
Avveiningen mellom energibehov og naturvern er en pagende samfunnsdebatt. Hvor mye natur er vi villige til a ofre for ren energi? Svaret er ikke enkelt, og ulike mennesker og grupper har ulike syn pa saken. Det vi kan si er at vannkraften har vaert og fortsatt er ryggraden i norsk kraftforsyning.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 5',
        type: 'multiple-choice',
        task: 'Test deg selv pa vannkraft i Norge:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'geografi-1-11-n-quiz5-q0',
          ...
          {
            id: 'geografi-1-11-n-quiz5-q1',
            task: 'Hvilke to faktorer bestemmer hvor mye energi et vannkraftverk kan produsere?',
            options: [
              { id: 'a', text: 'Elvens lengde og bredde', isCorrect: false },
              { id: 'b', text: 'Fallhoyde og vannmengde', isCorrect: true },
              { id: 'c', text: 'Temperatur og vindstyrke', isCorrect: false },
              { id: 'd', text: 'Turbinens farge og storrelse', isCorrect: false },
            ],
            solution: 'Jo storre fallhoyde (hoydeforskjellen vannet faller) og jo mer vannmengde, jo mer energi kan produseres. Norge har ideelle forhold med mye nedbor (stor vannmengde) og bratt terreng (stor fallhoyde).',
          },
          {
            id: 'geografi-1-11-n-quiz5-q2',
            task: 'Hva er en viktig negativ konsekvens av vannkraftutbygging?',
            options: [
              { id: 'a', text: 'Vannkraft slipper ut store mengder CO2 under drift', isCorrect: false },
              { id: 'b', text: 'Demninger og neddemming pavirker natur, fiskebestander og lokalmiljo', isCorrect: true },
              { id: 'c', text: 'Vannkraft bruker opp alt vannet sa elven torker ut', isCorrect: false },
              { id: 'd', text: 'Vannkraft kan bare produseres om sommeren', isCorrect: false },
            ],
            solution: 'Vannkraftutbygging har negative konsekvenser: Demninger og neddemming av omrader pavirker natur og lokalmiljo. Fiskebestander kan bli skadet nar vandringene blokkeres. Vannforingen endres, noe som pavirker okosystemene. Avveiningen mellom energibehov og naturvern er en pagende debatt.',
          },
        ],
      },
    },
...
Under istidene var det innlandsis som dominerte. Hele Skandinavia var dekket av en enorm iskappe som strakte seg fra Norge til Finland, og sor til Nord-Tyskland.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 1',
        type: 'multiple-choice',
        task: 'Test deg selv pa isbreens dannelse og typer:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'geografi-1-12-n-quiz1-q0',
          ...
          {
            id: 'geografi-1-12-n-quiz1-q1',
            task: 'Hva er massebalansen til en isbre?',
            options: [
              { id: 'a', text: 'Vekten av hele isbreen malt i tonn', isCorrect: false },
              { id: 'b', text: 'Forholdet mellom akkumulasjon (snofall) og ablasjon (smelting)', isCorrect: true },
              { id: 'c', text: 'Hvor fort breen beveger seg nedover dalen', isCorrect: false },
              { id: 'd', text: 'Tykkelsen pa isen ved breens front', isCorrect: false },
            ],
            solution: 'Massebalansen er forholdet mellom akkumulasjon (tilforsel av sno) og ablasjon (tap gjennom smelting og kalving). Nar akkumulasjonen er storre enn ablasjonen, vokser breen. Nar ablasjonen dominerer, minker breen.',
          },
          {
            id: 'geografi-1-12-n-quiz1-q2',
            task: 'Hva er en platabre?',
            options: [
              { id: 'a', text: 'En bre som flyter pa havet', isCorrect: false },
              { id: 'b', text: 'En liten bre som fyller en skaalformet fordypning i fjellsiden', isCorrect: false },
              { id: 'c', text: 'En iskappe som dekker et hoyfjellsplata og sender utlopere ned i dalene', isCorrect: true },
              { id: 'd', text: 'En bre som dannes i elvedelta', isCorrect: false },
            ],
            solution: 'En platabre (iskappe) dekker et hoyfjellsplata og sender utlopere (bretuuger) ned i dalene rundt. Jostedalsbreen er en slik platabre -- Europas storste bre pa fastlandet. En botnbre er derimot en liten bre i en skaalformet fordypning.',
          },
        ],
      },
    },
...
Nar isen beveger seg over ujevnt underlag, oppstar det **brespalter** -- dype sprekker i overflaten. Disse kan vaere svart farlige for folk som ferdes pa breen. De kan vaere dekket av sno og dermed usynlige, og de kan vaere flere titalls meter dype.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 2',
        type: 'multiple-choice',
        task: 'Test deg selv pa isbreens bevegelse:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'geografi-1-12-n-quiz2-q0',
          ...
          {
            id: 'geografi-1-12-n-quiz2-q1',
            task: 'Hva er basalglidning?',
            options: [
              { id: 'a', text: 'Nar iskrystaller glir langs hverandre under trykk inne i breen', isCorrect: false },
              { id: 'b', text: 'Nar hele breen glir pa et tynt vannlag mellom is og fjell', isCorrect: true },
              { id: 'c', text: 'Nar isblokker brekker av breens front og faller i havet', isCorrect: false },
              { id: 'd', text: 'Nar breen plutselig stopper opp pa grunn av et fjellhinder', isCorrect: false },
            ],
            solution: 'Basalglidning skjer nar hele breen glir pa et tynt vannlag mellom is og fjell. Det krever at bunnen er ved trykksmeltepunktet -- sa varmt at is under trykk smelter. Det meste av bevegelsen i tempererte breer som de norske skjer pa denne maten.',
          },
          {
            id: 'geografi-1-12-n-quiz2-q2',
            task: 'Hva er brespalter, og hvorfor er de farlige?',
            options: [
              { id: 'a', text: 'Tunneler under breen som kan rase sammen', isCorrect: false },
              { id: 'b', text: 'Dype sprekker i breoverflaten som kan vaere dekket av sno og usynlige', isCorrect: true },
              { id: 'c', text: 'Store isblokker som faller av breens front', isCorrect: false },
              { id: 'd', text: 'Innsjøer pa breens overflate som kan bryte gjennom', isCorrect: false },
            ],
            solution: 'Brespalter er dype sprekker i isbreens overflate, dannet nar isen beveger seg over ujevnt underlag. De er farlige fordi de kan vaere dekket av sno og dermed usynlige, og de kan vaere flere titalls meter dype.',
          },
        ],
      },
    },
...
**Rundsva** er avrundede fjellkoller slipt av isen -- du ser dem overalt langs norskekysten. **Skuringsstriper** er rette riper i fjellet laget av steiner som var frosset fast i bunnen av breen og slepte over underlaget. De viser hvilken retning isen beveget seg.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 3',
        type: 'multiple-choice',
        task: 'Test deg selv pa istidenes landskap:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'geografi-1-12-n-quiz3-q0',
          ...
          {
            id: 'geografi-1-12-n-quiz3-q1',
            task: 'Hva dannes nar flere botner graver inn fra forskjellige sider av et fjell?',
            options: [
              { id: 'a', text: 'En fjord', isCorrect: false },
              { id: 'b', text: 'En U-dal', isCorrect: false },
              { id: 'c', text: 'Skarpe tinder og smale fjellkammer (areter)', isCorrect: true },
              { id: 'd', text: 'En esker', isCorrect: false },
            ],
            solution: 'Nar flere botner graver inn fra forskjellige sider av et fjell, blir resultatet skarpe tinder og smale fjellkammer kalt areter. Store Skagastolstind og Stetind er eksempler pa slike tinder formet av breerosjonen.',
          },
          {
            id: 'geografi-1-12-n-quiz3-q2',
            task: 'Hva er skuringsstriper i fjellet?',
            options: [
              { id: 'a', text: 'Sprekker forarsaet av jordskjelv', isCorrect: false },
              { id: 'b', text: 'Merker etter lynnedslag', isCorrect: false },
              { id: 'c', text: 'Fossile spor etter forhistoriske dyr', isCorrect: false },
              { id: 'd', text: 'Rette riper laget av steiner frosset fast i bunnen av breen', isCorrect: true },
            ],
            solution: 'Skuringsstriper er rette riper i fjellet laget av steiner som var frosset fast i bunnen av isbreen og slepte over underlaget. De viser hvilken retning isen beveget seg og er viktige bevis for istidenes utbredelse.',
          },
        ],
      },
    },
...
**Dodisgroper** er runde fordypninger i landskapet. De oppsto nar isklumper ble begravd under sedimenter, og senere smeltet og etterlot en grop. Mange av de sma tjernene pa Ostlandet er vannfylte dodisgroper.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 4',
        type: 'multiple-choice',
        task: 'Test deg selv pa morener og avsetninger:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'geografi-1-12-n-quiz4-q0',
            ...
            solution: 'En esker er en lang, smal rygg av sortert grus og sand. Den ble dannet i tunneler under isbreen der smeltevann rant og avsatte materiale. Nar isen smeltet, ble avsetningene staende som rygger.',
          },
          {
            id: 'geografi-1-12-n-quiz4-q1',
            task: 'Hva er Raet?',
            options: [
              { id: 'a', text: 'En stor esker pa Vestlandet', isCorrect: false },
              { id: 'b', text: 'En lang endemorene gjennom Ostfold, avsatt under Yngre Dryas', isCorrect: true },
              { id: 'c', text: 'En type breis som finnes i Jotunheimen', isCorrect: false },
              { id: 'd', text: 'En ferskvannsinnsjo dannet av isbreen', isCorrect: false },
            ],
            solution: 'Raet er en lang endemorenerygg som gar gjennom Ostfold og videre sorover. Den ble avsatt under en kald periode kalt Yngre Dryas for ca. 12 000 ar siden, da isbreen stoppet i sin tilbaketrekning.',
          },
          {
            id: 'geografi-1-12-n-quiz4-q2',
            task: 'Hva er en dodisgrop?',
            options: [
              { id: 'a', text: 'Et hull i isen der smeltevann renner ned', isCorrect: false },
              { id: 'b', text: 'En type brespalte som er spesielt dyp', isCorrect: false },
              { id: 'c', text: 'En rund fordypning i landskapet der en begravd isklump senere smeltet', isCorrect: true },
              { id: 'd', text: 'En grotte under en isbre', isCorrect: false },
            ],
            solution: 'Dodisgroper er runde fordypninger i landskapet. De oppsto nar isklumper ble begravd under sedimenter fra smeltevannet, og senere smeltet og etterlot en grop. Mange av de sma tjernene pa Ostlandet er vannfylte dodisgroper.',
          },
        ],
      },
    },
...
Det er verdt a merke seg at breers utvikling er kompleks. De pavirkes av bade temperatur og nedbor, og ulike breer kan reagere forskjellig pa de samme klimaendringene.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 5',
        type: 'multiple-choice',
        task: 'Test deg selv pa isbreer og klimaendringer:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'geografi-1-12-n-quiz5-q0',
            ...
            solution: 'Breers massebalanse avhenger av bade temperatur (som pavirker smelting) og nedbor (som pavirker akkumulasjon). Pa 1960-90-tallet okte vinternedboren i Norge, noe som ga mer sno pa breene. Dette kompenserte for den okte smeltingen og lot noen breer vokse.',
          },
          {
            id: 'geografi-1-12-n-quiz5-q1',
            task: 'Hva var Lille istid?',
            options: [
              { id: 'a', text: 'En kort kuldeperiode for ca. 1300-1850 da breene vokste betydelig', isCorrect: true },
              { id: 'b', text: 'Den siste store istiden som formet det norske landskapet', isCorrect: false },
              { id: 'c', text: 'En periode der bare sma breer fantes i Norge', isCorrect: false },
              { id: 'd', text: 'Et annet navn pa Weichsel-istiden', isCorrect: false },
            ],
            solution: 'Lille istid var en kuldeperiode fra ca. 1300 til 1850 der breene vokste betydelig. Jostedalsbreen naadde sin storste utbredelse rundt 1750 under denne perioden. Etter 1850 har trenden vaert generell tilbaketrekning.',
          },
        ],
      },
    },
...
Vi har ulike typer bolger. **Vindbolger** skapes av lokal vind. **Donninger** er lange, jevne bolger som har reist langt fra fjerne stormer. Og **tsunamier** er enorme bolger forarsaket av jordskjelv, vulkanutbrudd eller undersjoeiske skred -- de er helt annerledes enn vanlige bolger og kan vaere odelaggende nar de treffer land.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 1',
        type: 'multiple-choice',
        task: 'Test deg selv pa bolgenes fysikk:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'geografi-1-13-n-quiz1-q0',
            ...
            solution: 'I apent hav beveger vannpartiklene seg i sirkler. De stiger opp pa bolgefronten, beveger seg litt fremover pa toppen, synker pa baksiden og gar tilbake pa bunnen. Det er energien som forplanter seg fremover, ikke selve vannet.',
          },
          {
            id: 'geografi-1-13-n-quiz1-q1',
            task: 'Hva er "fetch" i sammenheng med bolger?',
            options: [
              { id: 'a', text: 'Hoyden pa bolgetoppen', isCorrect: false },
              { id: 'b', text: 'Strekningen vinden blaser over for a bygge opp bolger', isCorrect: true },
              { id: 'c', text: 'Hastigheten bolgen treffer land med', isCorrect: false },
              { id: 'd', text: 'Avstanden mellom to bolgetopper', isCorrect: false },
            ],
            solution: 'Fetch er strekningen vinden blaser over vannoverflaten. Jo sterkere vind, jo lenger vinden blaser, og jo lengre fetch, desto storre blir bolgene. Derfor er bolgene storst ute pa apent hav der vinden har hatt lang tid og lang strekning.',
          },
          {
            id: 'geografi-1-13-n-quiz1-q2',
            task: 'Hva skjer nar en bolge narmer seg grunt vann ved kysten?',
            options: [
              { id: 'a', text: 'Bolgen bremses, blir brattere og til slutt bryter den', isCorrect: true },
              { id: 'b', text: 'Bolgen oker i fart og blir flatere', isCorrect: false },
              { id: 'c', text: 'Bolgen snur og gar tilbake mot apent hav', isCorrect: false },
              { id: 'd', text: 'Bolgen forsvinner helt nar den nar grunt vann', isCorrect: false },
            ],
            solution: 'Nar havbunnen blir grunnere, bremses bolgen av bunnen. Bolgelengden avtar, bolgene presses sammen, og hoyden oker. Bolgen blir brattere og brattere, helt til den blir for bratt og bryter -- den velter fremover i et kaos av hvitt skum.',
          },
        ],
      },
    },
...
Den norske kyststrommen forer ferskere vann langs kysten, mens Den norske atlanterhavsstrommen forer varmere, saltere vann lenger ute. Disse strommene pavirker fiskebestander, vaer og klima.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 2',
        type: 'multiple-choice',
        task: 'Test deg selv pa havstromme:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'geografi-1-13-n-quiz2-q0',
            ...
            solution: 'Golfstrommen (Den nordatlantiske strommen) forer varmt vann fra tropene nordover langs norskekysten. Bergen har gjennomsnitt pa ca. +2 grader i januar, mens Labrador pa samme breddegrad har ca. -15 grader.',
          },
          {
            id: 'geografi-1-13-n-quiz2-q1',
            task: 'Hva er den termohaline sirkulasjonen?',
            options: [
              { id: 'a', text: 'Bolgenes bevegelse mot kysten', isCorrect: false },
              { id: 'b', text: 'Havstrommer drevet av temperatur- og saltholdighetsforskjeller i vannet', isCorrect: true },
              { id: 'c', text: 'Vindmonstre over havet', isCorrect: false },
              { id: 'd', text: 'Tidevannets bevegelse inn og ut av fjorder', isCorrect: false },
            ],
            solution: 'Den termohaline sirkulasjonen er havstrommer drevet av temperatur- og saltholdighetsforskjeller. Kaldt, salt vann synker (det er tyngre) og varmt, ferskt vann stiger. Sammen med vinddrevet sirkulasjon og Corioliseffekten skaper dette havets store stromsystemer.',
          },
        ],
      },
    },
...
**Skjaer og holmer** er rester av erodert kyst som stikker opp av vannet. **Bolgvasket svaberg** er de glatte, avrundede bergflatene du finner langs kysten, formet av bolgenes slipende arbeid.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 3',
        type: 'multiple-choice',
        task: 'Test deg selv pa kysterosjon og landformer:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'geografi-1-13-n-quiz3-q0',
            ...
            solution: 'Strandflaten er et flatt eller svakt skranende landskap ved havniva langs norskekysten, opptil 60 km bredt, med tusenvis av oyer og skjaer pa omtrent samme hoyde.',
          },
          {
            id: 'geografi-1-13-n-quiz3-q1',
            task: 'Hva er korrasjon i kysterosjon?',
            options: [
              { id: 'a', text: 'Kjemisk opplosning av bergarter', isCorrect: false },
              { id: 'b', text: 'Nar steiner som bolgene kaster mot fjellet sliper og banker pa berget', isCorrect: true },
              { id: 'c', text: 'Vanntrykket som presser inn i sprekker', isCorrect: false },
              { id: 'd', text: 'Vind som blaser sand mot klippene', isCorrect: false },
            ],
            solution: 'Korrasjon er nar steiner som bolgene kaster mot fjellet sliper og banker pa berget -- som en naturens hammer. Hydraulisk pavirkning er vanntrykket i sprekker, og korrosjon er kjemisk opplosning av bergarter.',
          },
        ],
      },
    },
...
Der elver renner ut i havet, dannes **deltaer**. Elven bremser nar den moter havet, og alt materialet den har fraktet avsettes i en vifteformet avsetning. Klassiske eksempler er Nilens delta og Mississippis delta, men det finnes ogsa mange mindre deltaer langs norskekysten.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 4',
        type: 'multiple-choice',
        task: 'Test deg selv pa kystavsetning:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'geografi-1-13-n-quiz4-q0',
            ...
            solution: 'En tombolo (sandtange) er en landforbindelse mellom fastlandet og en oy, dannet ved at bolger og stromme avsetter sand og grus som over tid bygger seg opp til en sammenhengende rygg.',
          },
          {
            id: 'geografi-1-13-n-quiz4-q1',
            task: 'Hvordan sorterer bolgene materialet pa en strand?',
            options: [
              { id: 'a', text: 'Tilfeldig -- alt blandes sammen', isCorrect: false },
              { id: 'b', text: 'Grov stein overst der bolgene slur hardest, sand i mellom, fint materiale lenger ut', isCorrect: true },
              { id: 'c', text: 'Bare sand avsettes pa strender, alt annet fores ut til havs', isCorrect: false },
              { id: 'd', text: 'De letteste materialene avsettes forst, de tyngste sist', isCorrect: false },
            ],
            solution: 'Bolgene sorterer materialet etter storrelse: grov stein og grus avsettes overst i strandsonen der bolgene slur hardest. Sand havner i mellomzonen. Finere sedimenter som silt og leire fores lenger ut der vannet er roligere.',
          },
        ],
      },
    },
...
Sporene etter tidligere havniva er overalt i det norske landskapet. **Gamle strandlinjer** sees som terrasserte nivaer i terrenget. **Marine leirer** -- leire avsatt pa havbunnen -- finnes langt over dagens havniva. Og **fossiler av marine organismer** er funnet hoyt til fjells.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 5',
        type: 'multiple-choice',
        task: 'Test deg selv pa havnivaendringer og landheving:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'geografi-1-13-n-quiz5-q0',
            ...
            solution: 'Under istiden la det is opptil 3 kilometer tykk over Skandinavia. Denne enorme vekten presset jordskorpen ned. Nar isen smeltet, begynte landet a heve seg igjen -- i indre Oslofjord hever landet seg ca. 5 mm per ar.',
          },
          {
            id: 'geografi-1-13-n-quiz5-q1',
            task: 'Hva var havnivaet under siste istid sammenlignet med i dag?',
            options: [
              { id: 'a', text: 'Ca. 120 meter hoyere', isCorrect: false },
              { id: 'b', text: 'Omtrent likt som i dag', isCorrect: false },
              { id: 'c', text: 'Ca. 120 meter lavere', isCorrect: true },
              { id: 'd', text: 'Ca. 50 meter lavere', isCorrect: false },
            ],
            solution: 'Under siste istid var havnivaet ca. 120 meter lavere enn i dag fordi enorme mengder vann var bundet opp som is pa land. Store omrader som na er hav, var da turt land -- du kunne ga til fots fra England til kontinentet!',
          },
          {
            id: 'geografi-1-13-n-quiz5-q2',
            task: 'Hva skjer med norskekysten i dag -- trekker havet seg tilbake eller stiger det?',
            options: [
              { id: 'a', text: 'Havet stiger raskt langs hele kysten', isCorrect: false },
              { id: 'b', text: 'Landhevingen overstiger havnivastigningen de fleste steder, sa kysten trekker seg tilbake', isCorrect: true },
              { id: 'c', text: 'Ingenting endrer seg -- kysten er stabil', isCorrect: false },
              { id: 'd', text: 'Havet synker fordi isbreen pa Gronland vokser', isCorrect: false },
            ],
            solution: 'I Norge overstiger landhevingen havnivastigningen de fleste steder. Det betyr at kysten faktisk trekker seg tilbake -- havet blir litt grunnere, nye holmer dukker opp. Men globalt er havnivastigning en alvorlig trussel mot lavtliggende kystomrader.',
          },
        ],
      },
    },
...
Tregrensen varierer med breddegraden. I sor-Norge kan den ligge rundt 1200 meter over havet. I Nord-Norge synker den til havniva.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 1',
        type: 'multiple-choice',
        task: 'Test deg selv pa vegetasjonssoner:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'geografi-1-14-n-quiz1-q0',
            ...
            solution: 'Den boreale sonen -- barskogen eller taigaen -- er Norges storste vegetasjonssone. Den strekker seg fra Sorlandet til Troms og domineres av gran og furu.',
          },
          {
            id: 'geografi-1-14-n-quiz1-q1',
            task: 'Hva skjer med tregrensen nar du reiser fra sor til nord i Norge?',
            options: [
              { id: 'a', text: 'Den holder seg pa ca. 1200 meter over hele landet', isCorrect: false },
              { id: 'b', text: 'Den stiger jo lenger nord du kommer', isCorrect: false },
              { id: 'c', text: 'Den synker -- fra ca. 1200 meter i sor til havniva i nord', isCorrect: true },
              { id: 'd', text: 'Tregrensen finnes bare i Sor-Norge', isCorrect: false },
            ],
            solution: 'Tregrensen varierer med breddegraden. I sor-Norge kan den ligge rundt 1200 meter over havet. I Nord-Norge synker den helt ned til havniva, fordi klimaet blir kaldere jo lenger nord du kommer.',
          },
          {
            id: 'geografi-1-14-n-quiz1-q2',
            task: 'Hva kjennetegner den nemorale sonen i Norge?',
            options: [
              { id: 'a', text: 'Barskog med gran og furu', isCorrect: false },
              { id: 'b', text: 'Dvergbjork og vier over tregrensen', isCorrect: false },
              { id: 'c', text: 'Edellovskog med eik, bok, ask og alm langs kysten i sor', isCorrect: true },
              { id: 'd', text: 'Arktisk tundra med bare lav og mose', isCorrect: false },
            ],
            solution: 'Den nemorale sonen har edellovskog med varmekjaere lovtraer som eik, bok, ask, alm og lind. I Norge strekker den seg langs kysten i sor, helt til Trondelag, men den er smal og fragmentert.',
          },
        ],
      },
    },
...
For hvert ledd i naeringskjeden gar det meste av energien tapt som varme. Derfor ma det vaere mange flere planter enn plantespisere, og mange flere plantespisere enn rovdyr. Dette kalles den **okologiske pyramiden**.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 2',
        type: 'multiple-choice',
        task: 'Test deg selv pa okosystemet:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'geografi-1-14-n-quiz2-q0',
            ...
            solution: 'For hvert ledd i naeringskjeden gar det meste av energien (ca. 90%) tapt som varme. Bare ca. 10% av energien overfores til neste ledd. Dette er den okologiske pyramiden.',
          },
          {
            id: 'geografi-1-14-n-quiz2-q1',
            task: 'Hva er rollen til nedbrytere i et okosystem?',
            options: [
              { id: 'a', text: 'De fanger solenergi og lager organiske stoffer', isCorrect: false },
              { id: 'b', text: 'De jakter pa andre dyr for a holde bestander i sjakk', isCorrect: false },
              { id: 'c', text: 'De bryter ned dodt organisk materiale og frigjor naeringsstoffer tilbake til jorda', isCorrect: true },
              { id: 'd', text: 'De pollinerer blomster og sprer fro', isCorrect: false },
            ],
            solution: 'Nedbrytere er sopp og bakterier som bryter ned dodt organisk materiale og frigjor naeringsstoffene tilbake til jorda. Uten nedbrytere ville dodt materiale hope seg opp, og naeringsstoffene ville ikke sirkulere tilbake til okosystemet.',
          },
          {
            id: 'geografi-1-14-n-quiz2-q2',
            task: 'Hva er en sekundaerkonsument?',
            options: [
              { id: 'a', text: 'Et dyr som spiser planter', isCorrect: false },
              { id: 'b', text: 'Et dyr som spiser plantespisere', isCorrect: true },
              { id: 'c', text: 'En plante som fanger solenergi', isCorrect: false },
              { id: 'd', text: 'En sopp som bryter ned dode traer', isCorrect: false },
            ],
            solution: 'En sekundaerkonsument spiser primaerkonsumenter (plantespisere). For eksempel er rev og gaupe sekundaerkonsumenter fordi de spiser dyr som hare og mus, som er plantespisere.',
          },
        ],
      },
    },
...
**Kyst og strand** har vegetasjon tilpasset salt, vind og torke. Strandenger med salttolende planter, tangvoller med gjodslingstolerante arter, og sanddyner med marehalm og andre sandstabiliserende planter.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 3',
        type: 'multiple-choice',
        task: 'Test deg selv pa norske naturtyper:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'geografi-1-14-n-quiz3-q0',
            ...
            solution: 'Myr lagrer enorme mengder karbon i torven. Verdens myrer inneholder mer karbon enn alle verdens skoger til sammen. Hvis myrer dreneres, kan dette karbonet frigjores som drivhusgasser.',
          },
          {
            id: 'geografi-1-14-n-quiz3-q1',
            task: 'Hva er forskjellen mellom granskog og furuskog?',
            options: [
              { id: 'a', text: 'Granskog trives i kjølig klima med mye nedbor, furuskog i torrere omrader pa magrere jord', isCorrect: true },
              { id: 'b', text: 'Granskog finnes bare i Nord-Norge, furuskog bare i Sor-Norge', isCorrect: false },
              { id: 'c', text: 'Det er ingen forskjell -- gran og furu vokser alltid sammen', isCorrect: false },
              { id: 'd', text: 'Furuskog er tettere og morkere enn granskog', isCorrect: false },
            ],
            solution: 'Granskogen trives i kjølig klima med rikelig nedbor og er mork og tett. Furuskogen finnes i torrere omrader og pa magrere jord, og er lysere og apnere. Begge tilhorer den boreale sonen.',
          },
        ],
      },
    },
...
Hvorfor er biologisk mangfold viktig? Det er et etisk sporsmal -- har andre arter egenverdi? Det er et estetisk sporsmal -- vi onsker en vakker og variert natur. Og det er et praktisk sporsmal -- okosystemene gir oss tjenester vi er avhengige av, fra pollinering til klimaregulering. Nar mangfoldet minker, svaekkes disse tjenestene.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 4',
        type: 'multiple-choice',
        task: 'Test deg selv pa biologisk mangfold:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'geografi-1-14-n-quiz4-q0',
            ...
            solution: 'Arealendringer er den storste trusselen mot biologisk mangfold. Nar skog hogges, myr dreneres, eller natur bygges ned, forsvinner leveomradene for mange arter.',
          },
          {
            id: 'geografi-1-14-n-quiz4-q1',
            task: 'Hva betyr det at en art er klassifisert som "kritisk truet (CR)" pa Norsk rodliste?',
            options: [
              { id: 'a', text: 'Arten har allerede forsvunnet fra Norge', isCorrect: false },
              { id: 'b', text: 'Arten har ekstremt hoy risiko for a do ut i Norge', isCorrect: true },
              { id: 'c', text: 'Arten er vanlig, men i tilbakegang', isCorrect: false },
              { id: 'd', text: 'Arten er fremmed og bor fjernes', isCorrect: false },
            ],
            solution: 'Kritisk truet (CR) er den alvorligste kategorien for levende arter pa Norsk rodliste. Det betyr at arten har ekstremt hoy risiko for a do ut. Over 2700 arter er oppfort som truet i ulike kategorier, fra kritisk truet via sterkt truet (EN) til saarbar (VU).',
          },
        ],
      },
    },
...
Likevel forsoker okosystemtjeneste-tilnaermingen a synligjore naturens verdi, slik at den kan tas med i beslutninger om arealbruk og ressursforvaltning.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 5',
        type: 'multiple-choice',
        task: 'Test deg selv pa okosystemtjenester:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'geografi-1-14-n-quiz5-q0',
            ...
            solution: 'Pollinering er en regulerende okosystemtjeneste. Forsynende tjenester er produksjon (mat, tommer). Kulturelle tjenester er opplevelser (friluftsliv). Stottende tjenester er grunnprosesser (jorddannelse).',
          },
          {
            id: 'geografi-1-14-n-quiz5-q1',
            task: 'Hva er en forsynende okosystemtjeneste?',
            options: [
              { id: 'a', text: 'Klimaregulering ved at skog tar opp CO2', isCorrect: false },
              { id: 'b', text: 'Rekreasjon og naturopplevelser', isCorrect: false },
              { id: 'c', text: 'Fotosyntese og primaerproduksjon', isCorrect: false },
              { id: 'd', text: 'Mat fra jordbruk, fiske og jakt, og ferskvann fra vassdrag', isCorrect: true },
            ],
            solution: 'Forsynende tjenester er det naturen produserer: mat fra jordbruk, fiske og jakt; ferskvann fra vassdrag og grunnvann; tommer og trevirke; genetiske ressurser. Det er de mest handgripelige godene vi far fra naturen.',
          },
        ],
      },
    },
...
Gar du ned i jorda, finner du lag -- **horisonter** -- som viser jordas utviklingshistorie. Overs ligger det organiske **O-sjiktet** med strøfall og humus. Under det kommer **A-sjiktet** med moldholdig mineraljord. **B-sjiktet** inneholder ofte utfelt materiale -- jern og aluminium som har blitt vasket ned fra lagene over. **C-sjiktet** er det lose opphavsmaterialet, og under der ligger fast **fjell (R)**.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 1',
        type: 'multiple-choice',
        task: 'Test deg selv pa jorddannelse:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'geografi-1-15-n-quiz1-q0',
            task: 'Hva er humus?',
            options: [
              { id: 'a', text: 'En type berggrunn som gir naeringsrik jord', isCorrect: false },
            ...
            solution: 'Humus er morkt, organisk materiale dannet nar dode planter og dyr brytes ned. Det binder naeringsstoffer, holder pa vann og gir jorda god struktur.',
          },
          {
            id: 'geografi-1-15-n-quiz1-q1',
            task: 'Hva er frostforvitring?',
            options: [
              { id: 'a', text: 'Nar syrer i regnvann loser opp mineraler i fjellet', isCorrect: false },
              { id: 'b', text: 'Nar vind sliper fjellet med sandpartikler', isCorrect: false },
              { id: 'c', text: 'Nar vann fryser i sprekker i fjellet og sprenger det', isCorrect: true },
              { id: 'd', text: 'Nar planterotting vokser inn i jorda', isCorrect: false },
            ],
            solution: 'Frostforvitring er en form for fysisk forvitring der vann trenger inn i sprekker i fjellet, fryser og utvider seg. Kraften er enorm og sprenger steinen til stadig mindre biter. Det er en viktig prosess i Norges kalde klima.',
          },
          {
            id: 'geografi-1-15-n-quiz1-q2',
            task: 'Hvilke fem faktorer bestemmer jorddannelse?',
            options: [
              { id: 'a', text: 'Temperatur, regn, vind, sol og mane', isCorrect: false },
              { id: 'b', text: 'Opphavsmateriale, klima, organismer, topografi og tid', isCorrect: true },
              { id: 'c', text: 'Fjell, skog, elver, is og hav', isCorrect: false },
              { id: 'd', text: 'Sand, leire, grus, humus og vann', isCorrect: false },
            ],
            solution: 'De fem faktorene som bestemmer jorddannelse er: opphavsmaterialet (bergarten som forvitrer), klimaet (hastighet pa forvitring), organismene (planter, dyr, sopp, bakterier), topografien (vannforhold, sollys, erosjon) og tid.',
          },
        ],
      },
    },
...
**Elveavsetninger** -- sand, grus og silt avsatt av elver -- finnes i dalbunner og deltaer. Denne jorda er ofte svart fruktbar og danner grunnlag for mye av Norges jordbruk.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 2',
        type: 'multiple-choice',
        task: 'Test deg selv pa jordtyper i Norge:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'geografi-1-15-n-quiz2-q0',
            ...
            solution: 'Podsol er sur og naeringsfattig jord under barskog. Det karakteristiske trekket er et gratt, utvasket lag der syrer har vasket bort mineraler, og under det et rustbrunt lag med utfelt jern og aluminium.',
          },
          {
            id: 'geografi-1-15-n-quiz2-q1',
            task: 'Hva er kvikkleire?',
            options: [
              { id: 'a', text: 'Leire som er spesielt egnet for keramikk', isCorrect: false },
              { id: 'b', text: 'Marin leire som kan bli flytende ved forstyrrelser og foransake skred', isCorrect: true },
              { id: 'c', text: 'Leire som inneholder mye gull og mineraler', isCorrect: false },
              { id: 'd', text: 'Leire som er froset fast i permafrost', isCorrect: false },
            ],
            solution: 'Kvikkleire er marin leire som kan bli flytende ved forstyrrelser -- for eksempel ved graving eller kraftig risting. Den ble opprinnelig avsatt i havet under istiden. Kvikkleireskred kan vaere svart alvorlige og foransake store skader.',
          },
          {
            id: 'geografi-1-15-n-quiz2-q2',
            task: 'Hvorfor er leirjord pa Ostlandet ofte sa fruktbar?',
            options: [
              { id: 'a', text: 'Fordi den ble tilfort gjodsel av vikingene', isCorrect: false },
              { id: 'b', text: 'Fordi den er marin leire, avsatt pa havbunnen under istiden, og inneholder mye naeringsstoffer', isCorrect: true },
              { id: 'c', text: 'Fordi den bestar av vulkansk aske', isCorrect: false },
              { id: 'd', text: 'Fordi det regner mer pa Ostlandet enn andre steder', isCorrect: false },
            ],
            solution: 'Da isen smeltet og landet la lavt, var store deler av Ostlandet under havniva. Finkornet, naeringsrik leire ble avsatt pa havbunnen. Nar landet hevet seg, ble denne marine leiren til fruktbar jordbruksjord.',
          },
        ],
      },
    },
...
Norge har et system med **landbrukssoner** som reflekterer disse forskjellene. Ulike soner far ulike tilskudd for a gjore det mulig a drive jordbruk ogsa i vanskelige omrader.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 3',
        type: 'multiple-choice',
        task: 'Test deg selv pa klima og jordbruk:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'geografi-1-15-n-quiz3-q0',
            ...
            solution: 'Korn krever lang vekstsesong og moderat nedbor. Ostlandet har 150-180 dager vekstsesong og 500-800 mm nedbor. Vestlandet har kortere sesong og 1500-4000 mm nedbor -- for mye for korn.',
          },
          {
            id: 'geografi-1-15-n-quiz3-q1',
            task: 'Hvordan kompenserer midnattssolen delvis for den korte vekstsesongen i Nord-Norge?',
            options: [
              { id: 'a', text: 'Den varmer opp jorda ekstra mye', isCorrect: false },
              { id: 'b', text: 'Den gir ekstremt lange dager sa plantene kan fotosyntere naer 24 timer i dognet', isCorrect: true },
              { id: 'c', text: 'Den smelter snoen raskere om varen', isCorrect: false },
              { id: 'd', text: 'Den beskytter plantene mot frost', isCorrect: false },
            ],
            solution: 'I Nord-Norge gir midnattssolen ekstremt lange dager om sommeren. Plantene kan fotosyntere naer 24 timer i dognet, noe som delvis kompenserer for den korte vekstsesongen og gir overraskende god vekst i de korte sommermandedene.',
          },
        ],
      },
    },
...
**Jordloven** regulerer omdisponering av jordbruksareal. Kommunene ma veie ulike hensyn mot hverandre i arealplanleggingen. Det er et politisk sporsmal uten enkle svar.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 4',
        type: 'multiple-choice',
        task: 'Test deg selv pa jordbruksareal og jordvern:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'geografi-1-15-n-quiz4-q0',
            ...
            solution: 'Bare ca. 3 prosent av Norges landareal er dyrket mark -- rundt 10 000 kvadratkilometer. Av dette er bare ca. en tredjedel egnet for korndyrking.',
          },
          {
            id: 'geografi-1-15-n-quiz4-q1',
            task: 'Hvorfor argumenterer jordvernstilhengere for a beskytte matjord?',
            options: [
              { id: 'a', text: 'Fordi matjord kan lett lages i fabrikker', isCorrect: false },
              { id: 'b', text: 'Fordi matjord er en ikke-fornybar ressurs som tar hundrevis av ar a danne', isCorrect: true },
              { id: 'c', text: 'Fordi matjord er den eneste energikilden vi har', isCorrect: false },
              { id: 'd', text: 'Fordi matjord inneholder sjeldne mineraler', isCorrect: false },
            ],
            solution: 'Matjord er en ikke-fornybar ressurs i menneskelig tidsskala -- nar den forst er bygget ned, far vi den aldri tilbake. Det tar hundrevis av ar a danne jord. Med bare 3 prosent dyrket mark er hvert deka verdifullt for matsikkerhet og selvforsyning.',
          },
        ],
      },
    },
...
A ta vare pa matjorda er et langsiktig ansvar. Det tar hundrevis av ar a danne jord, men bare noen fa ar med feil praksis a odelegge den.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 5',
        type: 'multiple-choice',
        task: 'Test deg selv pa jorderosjon:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'geografi-1-15-n-quiz5-q0',
            ...
            solution: 'Konturploying betyr a ploy pa tvers av skraningen langs hoydekurvene. Furene bremser vannet og gir det tid til a infiltrere i jorda, noe som reduserer erosjon.',
          },
          {
            id: 'geografi-1-15-n-quiz5-q1',
            task: 'Hva var Dust Bowl i USA pa 1930-tallet?',
            options: [
              { id: 'a', text: 'En type jordbruksmetode brukt pa praeriene', isCorrect: false },
              { id: 'b', text: 'Et fossilt funn av store mengder stov', isCorrect: false },
              { id: 'c', text: 'En katastrofal vinderosjon der store deler av Great Plains mistet matjorda si', isCorrect: true },
              { id: 'd', text: 'Et naturreservat i vest-USA', isCorrect: false },
            ],
            solution: 'Dust Bowl var en katastrofal vinderosjon pa 1930-tallet i USA. Feil jordbrukspraksis (avskoging, overploying) i kombinasjon med torke forte til at vinden blas bort matjorda pa store deler av Great Plains. Det er et av historiens mest dramatiske eksempler pa menneskeskapt jorderosjon.',
          },
          {
            id: 'geografi-1-15-n-quiz5-q2',
            task: 'Hva er den vanligste formen for jorderosjon?',
            options: [
              { id: 'a', text: 'Vinderosjon', isCorrect: false },
              { id: 'b', text: 'Vannerosjon', isCorrect: true },
              { id: 'c', text: 'Iserosjon', isCorrect: false },
              { id: 'd', text: 'Kjemisk erosjon', isCorrect: false },
            ],
            solution: 'Vannerosjon er den vanligste formen for jorderosjon. Det begynner med plaskeerosjon nar regndrapene slur mot bar jord, sa dannes sma riller, og i alvorlige tilfeller utvikler det seg dype raviner. Det er verst i bratt terreng uten vegetasjonsdekke.',
          },
        ],
      },
    },
