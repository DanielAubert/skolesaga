...
const quizData_religion_etikk: Record<string, QuizQuestion[]> = {


  'religion-etikk-1-1': [
    {
      question: 'Hva er religionsvitenskap?',
      options: ["Det akademiske studiet av religioner og livssyn som menneskelige og kulturelle fenomener", "En metode for å avgjøre hvilken religion som er sann", "Studiet av Bibelen og kirkens bekjennelsesskrifter ut fra et bestemt kristent trosstandpunkt", "Det systematiske forsvaret av kristendommens sannhet mot innvendinger fra andre religioner og livssyn"],
      explanation: 'Religionsvitenskap beskriver, forstår og forklarer religion som menneskelig fenomen, uten å ta stilling til om religiøse påstander er sanne eller usanne.',
    },
    {
    ...
    {
      question: 'Hva er forskjellen på en deskriptiv og en normativ tilnærming?',
      options: ["Deskriptiv tilnærming beskriver fenomener slik de er, normativ tilnærming tar stilling til hva som er riktig eller sant", "Normativ tilnærming er alltid verdinøytral og vitenskapelig objektiv, mens deskriptiv tilnærming feller verdidommer", "Deskriptiv tilnærming handler bare om å telle og måle med tall, mens normativ tilnærming beskriver fenomener kvalitativt", "De to begrepene betyr i praksis det samme og brukes om hverandre uten faglig forskjell i religionsvitenskapen"],
      explanation: 'Religionsvitenskapen er i utgangspunktet deskriptiv – den kartlegger og analyserer uten å felle verdidommer. Teologi og etikk arbeider ofte normativt.',
    },
    {
      question: 'Hva er apologetikk?',
      options: ["Det systematiske forsvaret av en bestemt religion eller et bestemt livssyn", "En metode for sammenligning av religioner", "En vitenskapelig metode for nøytral sammenligning av ulike religioners lære", "En offisiell unnskyldning for historiske overgrep begått i en religions navn"],
      explanation: 'En apologet argumenterer for at egen tro er sann eller fornuftig. Apologetikk er normativ og forutsetter en trosposisjon, i motsetning til religionsvitenskapen.',
    },
    {
      question: 'Hva betyr reduksjonisme i religionsvitenskapelig sammenheng?',
      options: ["Å forklare religion ved å føre den tilbake til noe annet, som psykologiske behov eller sosiale funksjoner", "Å arbeide for å redusere antallet aktive religioner og livssyn i verden til noen få hovedretninger", "Å fjerne ritualer og seremonier fra religionsutøvelsen for å gjøre troen mer åndelig og indre", "Å forkorte og sammenfatte lange religiøse tekster til korte kjernebudskap for lekfolk"],
      explanation: 'Reduksjonistiske forklaringer kan gi verdifull innsikt, men risikerer å overse det særegne ved religiøse fenomener slik de oppleves av de troende.',
    },
  ],

  'religion-etikk-1-2': [
    {
      question: 'Hva kjennetegner en substansiell definisjon av religion?',
      options: ["Den sier hva religion er og inneholder, for eksempel tro på overnaturlige makter", "Den fokuserer på hva religion gjør for mennesker og samfunn", "Den kartlegger og teller antall registrerte medlemmer i de ulike trossamfunnene i et samfunn", "Den sier hva religion gjør og hvilken funksjon den har, for eksempel å skape samhold i samfunnet"],
      explanation: 'Substansielle definisjoner fokuserer på innholdet i religiøs tro og praksis, mens funksjonelle definisjoner fokuserer på religionens funksjon.',
    },
    {
      question: 'Hva beskrev Rudolf Otto med begrepet det numinøse?',
      options: ["Den grunnleggende religiøse erfaringen av et overveldende mysterium som både skremmer og fascinerer", "Det nøyaktige antallet guder og åndevesener som opptrer i en religions gudelære", "Måten religionene organiserer seg sosialt på gjennom presteskap og menigheter", "De hellige lovtekstene som regulerer de troendes daglige liv og handlinger"],
      explanation: 'Otto beskrev det numinøse som «mysterium tremendum et fascinans» – et mysterium som på samme tid fremkaller ærefrykt og tiltrekning.',
    },
    {
    ...
    {
      question: 'Hvor mange dimensjoner ved religion beskrev Ninian Smart i sin modell?',
      options: ['Syv', 'Tre', 'Ti', 'Fem'],
      explanation: 'Smarts syv dimensjoner er den rituelle, narrative, erfaringsmessige, sosiale, etiske, doktrinære og materielle dimensjonen. Modellen brukes som analyseverktøy.',
    },
    {
      question: 'Hva er et livssyn?',
      options: ["En helhetlig forståelse av tilværelsen med svar på spørsmål om virkelighet, verdier og mening", "En politisk ideologi som fastsetter hvordan samfunnet og staten bør styres og organiseres", "Nøyaktig det samme som en religion, siden alle livssyn forutsetter tro på en eller flere guder", "En vitenskapelig teori om universets opprinnelse og oppbygning basert på observasjon og målinger"],
      explanation: 'Livssyn kan være religiøse (som et kristent livssyn) eller ikke-religiøse (som humanetikk), men inneholder gjerne svar på de store spørsmålene om virkelighet, verdier og mening.',
    },
  ],

  'religion-etikk-1-3': [
    {
      question: 'Hva betyr myte i religionsvitenskapelig forstand?',
      options: ["En hellig fortelling som formidler grunnleggende sannheter om verden og det guddommelige", "Et moderne rykte eller en vandrehistorie som sprer seg i befolkningen uten kjent opphav", "En oppdiktet og usann historie uten rot i virkeligheten, fortalt for underholdningens skyld", "En vitenskapelig hypotese om verdens tilblivelse som senere er blitt bekreftet eller avkreftet"],
      explanation: 'I religionsvitenskapen brukes myte ikke i dagligtalens betydning «usann historie», men om fortellinger med dyp religiøs og kulturell betydning.',
    },
    {
      question: 'Hva er forskjellen på kosmogoni og eskatologi?',
      options: ["Kosmogoni er lære om verdens skapelse, eskatologi er lære om de siste ting", "Kosmogoni handler om etikk, eskatologi om ritualer", "Begge er ulike navn på læren om verdens skapelse og de guddommelige maktenes opprinnelse", "Kosmogoni er læren om religiøs etikk og moral, mens eskatologi er læren om ritualer og seremonier"],
      explanation: 'Kosmogoniske myter forklarer verdens opprinnelse, mens eskatologi handler om verdens ende, dommen og hva som skjer etter døden.',
    },
    {
    ...
    {
      question: 'Hva kalte Mircea Eliade det at noe hellig viser seg i den profane verden?',
      options: ['Hierofani', 'Liminalitet', 'Synkretisme', 'Eskatologi'],
      explanation: 'Hierofani betyr «det helliges manifestasjon» – en gjenstand, et sted eller en hendelse som oppleves som gjennomsyret av det hellige.',
    },
    {
      question: 'Hva er en rite de passage (overgangsrite)?',
      options: ["Et ritual som markerer overgangen fra én livsfase eller status til en annen", "Den daglige bønnen som troende utfører til faste tider gjennom hele livet", "Et offer til gudene som utføres for å blidgjøre maktene eller takke for velsignelser", "En pilegrimsreise til et hellig sted som styrker den troendes tilhørighet til fellesskapet"],
      explanation: 'Begrepet ble innført av Arnold van Gennep. Eksempler er dåp, konfirmasjon, bryllup og begravelse. Mellomfasen i riten kalles liminalfasen.',
    },
  ],

  'religion-etikk-1-4': [
    {
      question: 'Hva er målet i religionsfenomenologien?',
      options: ["Å forstå religiøse fenomener slik de oppleves av de troende selv, ved å sette egen forforståelse i parentes", "Å telle og kartlegge nøyaktig hvor mange religiøse mennesker som finnes i et bestemt land", "Å bevise vitenskapelig at religiøse erfaringer bare er innbilning og psykologiske behov", "Å rangere verdens religioner etter sannhetsgehalt for å finne den mest troverdige troen"],
      explanation: 'Fenomenologien forsøker å beskrive religiøse fenomener nøytralt og innlevende. Å sette egen forforståelse i parentes kalles epoché.',
    },
    {
      question: 'Hva er hermeneutikk?',
      options: ["Læren om tolkning og forståelse, brukt blant annet på religiøse tekster og symboler", "Læren om religiøse bygninger og hvordan templer og kirker utformes symbolsk", "Studiet av hellige språk som hebraisk, sanskrit og arabisk i deres religiøse kontekst", "En statistisk analysemetode for å måle utbredelsen av religiøse holdninger i samfunnet"],
      explanation: 'Hermeneutikken erkjenner at all forståelse er fortolkende – vi forstår alltid noe ut fra vår egen bakgrunn og forforståelse.',
    },
    {
      question: 'Hva er forskjellen på emisk og etisk perspektiv i religionsforskning?',
      options: ["Emisk er innenfra-perspektivet (de troendes egen forståelse), etisk er utenfra-perspektivet (forskerens analyse)", "Emisk perspektiv handler om følelser og opplevelser, mens etisk perspektiv handler om moral og rett handling", "Emisk er en moderne forskningsmetode fra vår tid, mens etisk er en gammeldags og utdatert tilnærming", "Begge er moralske vurderinger av religion der forskeren tar stilling til hva som er godt og ondt"],
      explanation: 'Det «etiske» perspektivet kommer fra språkvitenskapens «fonetikk», ikke fra moralfilosofien. Begge perspektivene er nødvendige i religionsforskningen.',
    },
    {
      question: 'Hva er deltakende observasjon?',
      options: ["En metode der forskeren deltar i aktivitetene til gruppen som studeres, samtidig som hun observerer", "En metode der forskeren observerer gruppen gjennom videoopptak uten selv å være fysisk til stede", "En metode der forskeren leser og analyserer gruppens hellige tekster på trygg avstand utenfra", "En metode som utelukkende bygger på telefonintervjuer med lederne i gruppen som studeres"],
      explanation: 'Deltakende observasjon brukes for å studere religiøse praksiser og fellesskap «innenfra», mens forskeren beholder sin analytiske rolle.',
    },
    {
      question: 'Hva er metodologisk ateisme?',
      options: ["Prinsippet om at forskningen ikke bruker overnaturlige forklaringer, uavhengig av forskerens personlige tro", "Prinsippet om at troende mennesker ikke kan forske på religion fordi de mangler nødvendig distanse", "Prinsippet om at alle som forsker på religion selv må være personlig overbeviste ateister", "En organisert bevegelse blant forskere som arbeider for å avskaffe religion i samfunnet"],
      explanation: 'Metodologisk ateisme (eller agnostisisme) betyr at forskeren søker menneskelige, sosiale og historiske forklaringer i analysen – ikke at forskeren personlig er ateist.',
    },
  ],
  ...
  'religion-etikk-1-5': [
    ...
    {
      question: 'Hvordan viser sekulariseringen seg i Norge?',
      options: ["Synkende medlemstall i Den norske kirke, lavere gudstjenestedeltakelse og færre kirkelige dåp og konfirmasjoner", "At samtlige nordmenn nå har meldt seg ut av alle tros- og livssynssamfunn og står helt utenfor", "At stadig flere kirkesamfunn får status som statskirker med offentlig finansiering og styring", "At det innføres et generelt forbud mot å reise religiøse bygg som kirker, moskeer og templer"],
      explanation: 'Sekularisering i norsk kontekst viser seg i synkende oppslutning om kirkelige ritualer og at religion spiller en mindre rolle i hverdagsliv og politikk.',
    },
    {
      question: 'Hva regulerer trossamfunnsloven fra 2021?',
      options: ["Forholdet mellom staten og tros- og livssynssamfunn, inkludert registrering og statstilskudd", "Loven bestemmer hvilke religioner og livssyn som er lovlige å utøve og praktisere i Norge", "Loven fastsetter og godkjenner det teologiske innholdet i de ulike religionenes hellige skrifter", "Loven regulerer utelukkende Den norske kirkes økonomi og har ingen betydning for andre trossamfunn"],
      explanation: 'Loven fastsetter vilkår for registrering og statlig tilskudd og stiller krav til blant annet medlemstall og demokrati i tros- og livssynssamfunnene.',
    },
    {
      question: 'Hva kjennetegner nyreligiøsitet?',
      options: ["Individuelt søk, blanding av elementer fra ulike tradisjoner og fokus på personlig utvikling", "Streng hierarkisk organisering med fast og forpliktende medlemskap i lukkede menigheter", "En prinsipiell avvisning av all spiritualitet til fordel for et rent vitenskapelig verdensbilde", "En bokstavtro og ordrett lesning av Bibelen som eneste autoritet for tro og liv"],
      explanation: 'Nyreligiøsitet (alternativ spiritualitet, New Age) er en samlebetegnelse for spirituelle strømninger utenfor de etablerte religionene, preget av eklektisisme og individuelt søk.',
    },
  ],

  'religion-etikk-2-1': [
    {
      question: 'Hva er evangeliene?',
      options: ["De fire første bøkene i Det nye testamentet: Matteus, Markus, Lukas og Johannes", "En samling salmer og bønner som ble brukt i den tidlige kirkens gudstjenester", "De fem Mosebøkene som utgjør Toraen, den viktigste delen av Det gamle testamentet", "Brevene apostelen Paulus skrev til de tidlige kristne menighetene rundt Middelhavet"],
      explanation: 'Ordet evangelium betyr «godt budskap». De tre første kalles de synoptiske evangeliene fordi de har mye felles stoff.',
    },
    {
      question: 'Hva kjennetegnet urkirken?',
      options: ["De første kristne var jøder som trodde Jesus var Messias og samlet seg i private hjem", "Den avviste alle jødiske tradisjoner fra første dag", "Den bygde store steinkatedraler i alle de viktigste byene i Romerriket fra første stund", "Den ble fra begynnelsen ledet av paven i Roma som den øverste og udiskutable autoriteten"],
      explanation: 'Urkirken er den tidligste kristne menigheten etter Jesu død. Et sentralt spørsmål var om ikke-jøder kunne bli kristne uten å følge jødisk lov.',
    },
    {
      question: 'Hva hevdet Arius, og hva skjedde med læren hans?',
      options: ["At Sønnen var skapt av Faderen og ikke av samme vesen som Gud – læren ble fordømt på konsilet i Nikea i 325", "At det finnes mange likestilte guder – og denne læren ble senere kirkens offisielle og vedtatte lære", "At Jesus aldri virkelig har levd som menneske – men denne læren ble raskt glemt og fikk ingen følge", "At Gud i det hele tatt ikke finnes – for dette ble Arius landsforvist til fjerne strøk av Hellas"],
      explanation: 'Arianismen ble avvist på det første økumeniske konsilet i Nikea (325 e.Kr.), som fastslo at Sønnen er av samme vesen som Faderen.',
    },
    {
      question: 'Hva er et konsil?',
      options: ["Et kirkemøte der biskoper og ledere samles for å avgjøre teologiske spørsmål og fastsette lære", "En kirkelig domstol som ble opprettet for å dømme og straffe kjettere og vranglærere", "En høytidelig prosesjon gjennom byens gater der helgenbilder og relikvier bæres fram", "En liten bønnesamling i private hjem der troende møtes for å be og lese sammen"],
      explanation: 'De økumeniske konsilene samlet ledere fra hele den kristne kirken. Det første ble holdt i Nikea i 325 e.Kr.',
    },
    {
      question: 'Hvem var kirkefedrene?',
      options: ["Innflytelsesrike kristne tenkere fra de første århundrene som la grunnlaget for kristen teologi", "De aller første pavene som styrte kirken fra Roma i tiden rett etter Jesu død og oppstandelse", "De tolv apostlene som fulgte Jesus og senere grunnla de første kristne menighetene", "Forfatterne som skrev ned bøkene og profetiene i Det gamle testamentet på hebraisk"],
      explanation: 'Blant de mest kjente kirkefedrene er Augustin av Hippo (354–430), som blant annet utviklet læren om arvesynden.',
    },
  ],
  ...
  'religion-etikk-2-2': [
    ...
    {
      question: 'Hva var Det store skismaet i 1054?',
      options: ["Den formelle splittelsen mellom den vestlige (katolske) og den østlige (ortodokse) kirken", "Den langvarige striden om hvem av flere rivaliserende kandidater som skulle bli ny pave", "Den formelle splittelsen mellom de katolske og de protestantiske kirkene i Vest-Europa", "Delingen av Romerriket i en vestlig og en østlig del med hver sin keiser og hovedstad"],
      explanation: 'Bakgrunnen var langvarige uenigheter om pavens autoritet, filioque-tillegget i trosbekjennelsen og kulturelle forskjeller mellom øst og vest.',
    },
    {
  ...
  'religion-etikk-2-3': [
    ...
    {
      question: 'Hvilke er de fem søylene i islam?',
      options: ["Trosbekjennelsen, bønnen, fasten, almissen og pilegrimsreisen", "Koranen, hadith, ijma, qiyas og sharia", "Tro, håp, kjærlighet, faste og daglig bønn mot Mekka fem ganger i døgnet", "Koranen, hadith, ijma, qiyas og sharia som grunnlaget for islamsk rettslære"],
      explanation: 'De fem søylene (arkan al-islam) er shahada (trosbekjennelse), salat (bønn), sawm (faste i ramadan), zakat (almisse) og hajj (pilegrimsreise til Mekka).',
    },
    {
    ...
    {
      question: 'Hva betyr begrepene halal og haram?',
      options: ["Halal betyr tillatt og haram betyr forbudt – begrepene gjelder alle livets områder", "Halal betyr hellig og haram betyr helligdom – begge knyttet til det rituelt rene", "Begge betegner ulike typer krydret mat og drikke som stammer fra Midtøsten og Nord-Afrika", "Halal er en fast daglig bønn og haram er en religiøs høytid som feires hvert år i ramadan"],
      explanation: 'Halal og haram angir hva som er tillatt og forbudt i islamsk rettslære, ikke bare for mat og drikke, men for alle aspekter av livet.',
    },
  ],

  'religion-etikk-2-4': [
    {
      question: 'Hvor stor andel av verdens muslimer regnes som sunnimuslimer?',
      options: ['Anslagsvis 85–90 prosent', 'Anslagsvis 50 prosent', 'Anslagsvis 10–15 prosent', 'Under 5 prosent'],
      explanation: 'Sunniislam er den klart største retningen. Shiaislam utgjør anslagsvis 10–15 prosent av verdens muslimer.',
    },
    {
    ...
    {
      question: 'Hvilken særskilt betydning har begrepet imam i shiaislam?',
      options: ["Imamene er Ali og hans etterkommere – guddommelig utpekte ledere av det muslimske samfunnet", "Imam er en ærestittel som gis til velstående handelsmenn som støtter det religiøse livet", "Imamen er den fremste håndverkeren som får ansvaret med å bygge og vedlikeholde moskeer", "Imam betyr utelukkende en vanlig bønneleder, akkurat på samme måte som i sunniislam"],
      explanation: 'I sunniislam er imam vanligvis en bønneleder, men i shiaislam er imamene de guddommelig utpekte lederne. Tolvershia tror på tolv imamer.',
    },
    {
      question: 'Hva er den største undergruppen innenfor shiaislam?',
      options: ['Tolvershia', 'Wahhabisme', 'Sufisme', 'Ahmadiyya'],
      explanation: 'Tolvershia (imamiyya) er den største shiaretningen og tror på tolv imamer, der den tolvte regnes som skjult.',
    },
  ],
  ...
  'religion-etikk-2-5': [
    ...
    {
      question: 'Hva er frigjøringsteologi?',
      options: ["En teologisk retning fra Latin-Amerika som tolker det kristne budskapet i lys av de fattiges situasjon", "Læren om at sjelen ved døden frigjøres fra kroppens fengsel og vender tilbake til det guddommelige", "En protestantisk vekkelsesretning som oppstod i Tyskland på 1500-tallet under selve reformasjonen", "Teologien som ligger til grunn for klostervesenet og munkenes tilbaketrukne liv i bønn og arbeid"],
      explanation: 'Frigjøringsteologien oppstod på 1960- og 70-tallet og argumenterer for at Gud tar parti med de marginaliserte. Gustavo Gutiérrez er en sentral skikkelse.',
    },
    {
      question: 'Hva handler kristen sosialetikk om?',
      options: ["Rettferdighet, ansvar og moral i samfunnet, basert på prinsipper som nestekjærlighet og omsorg for de svake", "Detaljerte regler for hvordan man skal oppføre seg ærbødig og stille inne i selve kirkerommet", "Den nøyaktige tolkningen av skapelsesberetningen og forholdet mellom tro og naturvitenskap", "Retningslinjer for hvordan de enkelte menighetene skal organiseres, ledes og styres innad"],
      explanation: 'Sosialetikken anvender bibelske prinsipper om nestekjærlighet og rettferdighet på spørsmål om politikk, økonomi og samfunn.',
    },
    {
      question: 'Hva kjennetegner en sekulær stat?',
      options: ["Statlige institusjoner er uavhengige av religiøse myndigheter, og religionsfrihet er sikret", "Religion er helt forbudt for innbyggerne, og staten forfølger dem som praktiserer en tro", "Staten styres direkte av religiøse ledere som utleder lovene fra hellige skrifter alene", "Alle innbyggerne er ved lov pålagt å tilhøre og aktivt delta i den samme statskirken"],
      explanation: 'I en sekulær stat er statsmakten uavhengig av religiøse autoriteter. Sekularisering er en sentral utviklingstrekk i mange vestlige samfunn.',
    },
    {
  ...
  'religion-etikk-2-6': [
    {
      question: 'Hva betyr diaspora?',
      options: ["En folkegruppe eller et religiøst samfunn som lever spredt utenfor sitt opprinnelige hjemland", "En årlig religiøs høytid som markerer et viktig historisk vendepunkt i troens fortelling", "En bestemt type moské med et særegent arkitektonisk bønnerom for spredte menigheter", "Et religiøst lederskap som styrer troen og fellesskapet på tvers av landegrensene"],
      explanation: 'Ordet kommer fra gresk og betyr «spredning». Muslimsk diaspora er muslimer som lever i land der islam ikke er majoritetsreligion.',
    },
    {
      question: 'Hvor er religionsfriheten nedfelt internasjonalt?',
      options: ["Blant annet i FNs verdenserklæring om menneskerettigheter (artikkel 18) og Den europeiske menneskerettskonvensjon (artikkel 9)", "Bare i den norske Grunnloven fra 1814, og ikke i noen internasjonale avtaler eller konvensjoner", "I EUs felles tollregler for handel over grenser, som også regulerer religiøse forhold i unionen", "I selve Koranen og Bibelen, som begge slår fast menneskets rett til fritt religionsvalg"],
      explanation: 'Religionsfriheten er en grunnleggende menneskerettighet som innebærer retten til å ha, utøve, skifte eller ikke ha en religion.',
    },
    {
      question: 'Hva er forskjellen på multikulturalisme og interkulturalisme?',
      options: ["Multikulturalisme vektlegger gruppers rett til å bevare sin kultur, interkulturalisme vektlegger dialog og møter på tvers", "Multikulturalisme gjelder utelukkende mattradisjoner, mens interkulturalisme handler kun om språk", "Begrepene betyr nøyaktig det samme og brukes fritt om hverandre uten noen faglig forskjell", "Interkulturalisme krever full assimilering, der minoriteter må oppgi sin egen kultur helt"],
      explanation: 'Begge er tilnærminger til kulturelt mangfold: Multikulturalismen vektlegger anerkjennelse av gruppene, mens interkulturalismen legger mer vekt på dialog og utveksling.',
    },
    {
    ...
    {
      question: 'Hvilke spørsmål møter muslimske minoriteter i europeiske samfunn?',
      options: ["Blant annet hvordan religiøs praksis som bønnetider, mat og høytider kan kombineres med arbeidsliv og skole", "Om de bør avskaffe Koranen og andre hellige skrifter for lettere å tilpasse seg vertslandet", "Ingen spesielle spørsmål, siden religiøs praksis passer sømløst inn i alle samfunnsforhold", "Om islam skal innføres som statsreligion i alle europeiske land der muslimer bor i dag"],
      explanation: 'Muslimer i diaspora må finne praktiske løsninger for religiøs praksis i samfunn der islam er minoritetsreligion, noe som reiser spørsmål om tilrettelegging og likebehandling.',
    },
  ],

  'religion-etikk-2-7': [
    {
      question: 'Hvilke religioner kalles de abrahamittiske religionene?',
      options: ['Jødedom, kristendom og islam', 'Hinduisme, buddhisme og sikhisme', 'Kristendom, hinduisme og islam', 'Jødedom, buddhisme og taoisme'],
      explanation: 'Alle tre ser Abraham (Ibrahim) som en sentral stamfar og deler monoteisme, et lineært historiesyn og forestillingen om åpenbaring gjennom profeter.',
    },
    {
      question: 'Hva er den sentrale teologiske forskjellen mellom tawhid og treenighetslæren?',
      options: ["Tawhid betoner Guds absolutte enhet, mens treenigheten lærer at den ene Gud eksisterer som tre personer", "Tawhid er en sentral kristen lære om Guds vesen, mens treenigheten er en islamsk trosforestilling", "Begge lærene fastholder egentlig at det finnes tre atskilte guder som samarbeider seg imellom", "Tawhid handler først og fremst om englenes rolle, mens treenigheten dreier seg om profetene"],
      explanation: 'Islam avviser treenigheten som uforenlig med Guds enhet, mens kristen teologi fastholder at Faderen, Sønnen og Den hellige ånd er én Gud.',
    },
    {
      question: 'Hvordan skiller kristendommens og islams syn på Jesus seg fra hverandre?',
      options: ["Kristendommen lærer at Gud ble menneske i Jesus (inkarnasjonen), mens islam ser Jesus som en stor profet, ikke guddommelig", "Ingen av de to religionene omtaler Jesus i det hele tatt i sine hellige skrifter og læresetninger", "Islam regner Jesus som Guds egen sønn, mens kristendommen ser ham som en av mange profeter", "Begge religionene avviser fullstendig at Jesus noen gang har levd som en historisk person"],
      explanation: 'Inkarnasjonen er grunnleggende i kristen tro. Islam anerkjenner Jesus (Isa) som profet, men avviser at han er Guds sønn – Muhammad regnes som den siste profeten.',
    },
    {
      question: 'Hva har kristendommens og islams eskatologi til felles?',
      options: ["Begge venter en endelig dom og et liv etter døden", "Begge mener historien er en evig sirkel uten mål", "Begge avviser fullstendig tanken om en kommende dommedag og et regnskap for menneskene", "Begge lærer at sjelen gjenfødes i nye kropper"],
      explanation: 'Både kristendom og islam har et lineært historiesyn med forventning om dommens dag, oppstandelse og et hinsidig liv.',
    },
    {
      question: 'Hva er målet med interreligiøs dialog?',
      options: ["Gjensidig forståelse, respekt og samarbeid mellom mennesker fra ulike religiøse tradisjoner", "Å omvende motparten til sitt eget standpunkt ved hjelp av grundig argumentasjon og misjon", "Å avgjøre gjennom debatt hvilken av religionene som er den ene sanne og opphøyde troen", "Å slå alle verdens religioner sammen til én felles universell tro som alle kan enes om"],
      explanation: 'Interreligiøs dialog kan foregå på flere nivåer – fra teologisk dialog mellom lærde til hverdagslig livsdialog – og målet er forståelse, ikke omvendelse.',
    },
  ],

  'religion-etikk-3-1': [
    {
      question: 'Hva betyr betegnelsen sanatana dharma, som mange hinduer bruker om sin tradisjon?',
      options: ["Den evige lov eller den evige orden", "Pilegrimsreisen til Ganges", "De eldste og mest hellige skriftene i hinduismen", "Det daglige tempelritualet med ofringer til gudene"],
      explanation: 'Begrepet understreker at hinduismen forstås som en tidløs kosmisk orden som eksisterer uavhengig av mennesker.',
    },
    {
      question: 'Hva er Vedaene?',
      options: ["Hinduismens eldste og mest autoritative hellige skrifter, regnet som shruti (åpenbart kunnskap)", "En samling fortellinger som utelukkende handler om guden Krishnas liv og gjerninger på jorden", "De seks klassiske filosofiske skolene som tolker og systematiserer den hinduistiske læren", "En rekke berømte hinduistiske templer som ligger spredt utover det nordlige India"],
      explanation: 'Vedaene består av fire samlinger – Rigveda, Samaveda, Yajurveda og Atharvaveda – med hymner, ritualtekster og filosofiske spekulasjoner.',
    },
    {
      question: 'Hva er karma i hinduistisk tenkning?',
      options: ["Loven om at alle handlinger har konsekvenser som påvirker nåværende og fremtidig tilværelse", "Navnet på en mektig hinduistisk skaperguddom som styrer over liv og skjebne i universet", "Den hellige elven i Nord-India som pilegrimer bader i for å bli renset for sine synder", "En avansert meditasjonsteknikk der man gjentar hellige mantraer for å oppnå indre ro"],
      explanation: 'Karma betyr «handling» på sanskrit og er nært knyttet til samsara (gjenfødelse) og moksha (frigjøring).',
    },
    {
      question: 'Hva er moksha?',
      options: ["Frigjøring fra gjenfødelsens kretsløp, der sjelen forenes med eller erkjenner sin enhet med brahman", "En seremoniell tempeldans som utføres av innviede dansere til ære for gudene under høytider", "Den store hinduistiske nyttårsfeiringen som markeres med lys, fyrverkeri og familiefester", "En fast daglig morgenbønn som fremsies mot øst idet solen står opp over horisonten"],
      explanation: 'Moksha regnes som hinduismens ultimate mål: frigjøring fra samsaras kretsløp av fødsel, død og gjenfødelse.',
    },
    {
      question: 'Hva er puja?',
      options: ["Et tilbedelsesritual der man tilbyr blomster, lys og mat til en guddom, hjemme eller i tempel", "En streng fasteperiode der de troende avstår fra visse matvarer for å rense kropp og sinn", "Hinduismens eldste og mest autoritative hellige skrift, overlevert gjennom generasjoner", "En bestemt klasse av innviede prester som utfører ofringene og ritualene i templene"],
      explanation: 'Puja utføres ved familiealteret eller i tempelet, ledsaget av bønner og mantraer, og kan være enkel og daglig eller omfattende og festlig.',
    },
  ],
  ...
  'religion-etikk-3-3': [
    ...
    {
      question: 'Hvor mange mitzvot (bud) inneholder Torahen ifølge jødisk tradisjon?',
      options: ['613', '10', '100', '365'],
      explanation: 'De 613 mitzvot består av 248 positive påbud og 365 forbud. Å oppfylle budene forstås som et svar på Guds pakt.',
    },
    {
  ...
  'religion-etikk-3-4': [
    ...
    {
      question: 'Hvilken status har Guru Granth Sahib i sikhismen?',
      options: ["Skriften regnes som sikhenes evige guru etter den tiende guruen", "Den er en historiebok uten religiøs autoritet", "Den brukes utelukkende ved bryllupsseremonier og har ingen rolle i den daglige andakten", "Den er hemmelig og kan bare leses av prester"],
      explanation: 'Etter Guru Gobind Singh ble skriften opphøyet til evig guru og behandles med samme ærbødighet som en levende guru. Den inneholder hymner av guruer samt hinduistiske og muslimske hellige menn.',
    },
    {
  ...
  'religion-etikk-3-5': [
    {
      question: 'Hvorfor brukes betegnelsen «nye religiøse bevegelser» (NRB) i religionsvitenskapen?',
      options: ["Som et nøytralt alternativ til verdiladede termer som «sekt» og «kult»", "Fordi alle slike grupper er grunnlagt etter år 2000", "Fordi samtlige slike grupper uten unntak ble grunnlagt etter tusenårsskiftet i år 2000", "Fordi gruppene selv har valgt betegnelsen for å skille seg fra de etablerte religionene"],
      explanation: 'NRB betegner religiøse grupper oppstått i nyere tid, vanligvis fra 1800-tallet og fremover, og spenner fra små grupper til store, globale bevegelser.',
    },
    {
      question: 'Hva kjennetegner New Age?',
      options: ["Eklektisisme, personlig åndelig utvikling, holisme og manglende formell organisering", "Streng hierarkisk organisasjon med fast medlemskap", "Streng hierarkisk organisasjon med fast, registrert medlemskap og tydelige lederroller", "Bokstavtro og ufravikelig lesning av ett enkelt hellig skrift som gruppens eneste autoritet"],
      explanation: 'New Age ble synlig fra 1960-tallet og blander elementer fra ulike tradisjoner, med vekt på selvutvikling og helhetstenkning.',
    },
    {
  ...
  'religion-etikk-3-6': [
    {
      question: 'Hva kjennetegner de abrahamittiske religionenes historiesyn?',
      options: ["Et lineært historiesyn rettet mot et guddommelig mål", "Et syklisk historiesyn med evige gjentakelser", "Et syklisk historiesyn der tiden går i evige runder og alt gjentar seg på nytt", "At verden aldri har hatt en begynnelse"],
      explanation: 'Jødedom, kristendom og islam har et lineært historiesyn med skapelse, historie og en forventet avslutning, i motsetning til de sykliske forestillingene i flere østlige tradisjoner.',
    },
    {
      question: 'Hva er panteisme?',
      options: ["En gudsforståelse der Gud og universet forstås som identiske", "Troen på en personlig skapergud utenfor verden", "Troen på én personlig skapergud som står utenfor og over den verden han har skapt", "Dyrkelse av forfedrenes ånder, som antas å påvirke de levendes hverdag og skjebne"],
      explanation: 'Panteisme skiller seg fra teisme (Gud som transcendent skaper) og ateisme. Elementer av panteisme finnes i deler av hinduistisk filosofi, særlig advaita.',
    },
    {
  ...
  'religion-etikk-4-3': [
    ...
    {
      question: 'Hva er forskjellen på handlingsutilitarisme og regelutilitarisme?',
      options: ["Handlingsutilitarisme vurderer hver enkelt handling for seg, regelutilitarisme følger regler som generelt gir best konsekvenser", "Handlingsutilitarisme ser bare på motivet bak handlingen, mens regelutilitarisme ser utelukkende på handlingens konsekvenser", "Handlingsutilitarisme gjelder samfunnets lover, mens regelutilitarisme kun gjelder personlige valg i privatlivet til den enkelte", "Handlingsutilitarisme følger faste regler i alle tilfeller, mens regelutilitarisme vurderer hver enkelt handling helt fritt"],
      explanation: 'Regelutilitaristen spør hvilke regler som gir mest lykke når de følges generelt i samfunnet, mens handlingsutilitaristen vurderer den konkrete situasjonen.',
    },
    {
  ...
  'religion-etikk-4-4': [
    {
      question: 'Hva er det sentrale spørsmålet i dydsetikken?',
      options: ['«Hva slags menneske bør jeg være?»', '«Hvilke konsekvenser gir handlingen?»', '«Hvilken regel gjelder her?»', '«Hva sier flertallet?»'],
      explanation: 'Dydsetikken fokuserer på karaktertrekk (dyder) fremfor regler eller konsekvenser, og spør hva slags menneske man bør være.',
    },
    {
      question: 'Hva innebærer Aristoteles\' lære om den gylne middelvei?',
      options: ["At dyder er karaktertrekk som ligger mellom to ytterpunkter, slik mot ligger mellom feighet og dumdristighet", "At man alltid skal handle ut fra plikt og følge en regel man kan ville skal gjelde som allmenn lov for alle", "At dyder er medfødte egenskaper man enten har eller mangler, og som ikke kan utvikles gjennom vane og øvelse over tid", "At det moralsk riktige alltid er å velge den handlingen som gir størst samlet lykke for flest mulig berørte"],
      explanation: 'Hver dyd er en middelvei mellom for lite og for mye: Mot er midt mellom feighet (for lite) og dumdristighet (for mye).',
    },
    {
  ...
  'religion-etikk-4-5': [
    ...
    {
      question: 'Hva fremhever omsorgsetikken?',
      options: ["Omsorg, relasjoner og gjensidig avhengighet som grunnlag for moral", "At bare familiebånd har moralsk betydning", "Beregningen av hvilken handling som gir størst mulig samlet lykke for flest mulig av de berørte i en situasjon", "Upersonlige regler som gjelder alle likt"],
      explanation: 'Omsorgsetikken, utviklet blant annet av Gilligan, Noddings og Tronto, setter relasjoner og omsorg i sentrum for etikken.',
    },
  ],
  ...
  'religion-etikk-4-6': [
    ...
    },
    {
      ...
      options: ["Prinsippet om at medisinsk behandling og forskning krever at pasienten har fått tilstrekkelig informasjon og samtykker frivillig", "Regelen om at all medisinsk forskning må forhåndsgodkjennes av staten før den kan gjennomføres på frivillige forsøkspersoner", "Prinsippet om at legen alene, ut fra sin faglige innsikt, avgjør hva som er best for pasienten uten dennes medvirkning", "Kravet om at pårørende skal informeres og gi sitt samtykke før alvorlig behandling settes i gang ved en pasient"],
      explanation: 'Informert samtykke bygger på autonomiprinsippet: individets rett til å ta informerte valg om egen kropp og helse.',
    },
    {
    ...
    {
      question: 'Hva er algoritmisk skjevhet (bias)?',
      options: ["Systematiske feil i KI-systemer som gir urettferdige utfall for bestemte grupper, ofte på grunn av skjevheter i treningsdataene", "At KI-systemer med vilje programmeres til å forskjellsbehandle grupper for å oppnå bestemte politiske eller kommersielle mål", "At algoritmer regner unøyaktig med svært store tall og avrundinger, slik at resultatene blir tilfeldig gale for alle brukere", "At maskiner over tid utvikler egne meninger og fordommer helt uavhengig av dataene og reglene menneskene har gitt dem"],
      explanation: 'Algoritmisk skjevhet er en sentral utfordring i KI-etikken, sammen med krav om forklarbarhet og personvern.',
    },
    {
  ...
  'religion-etikk-5-1': [
    ...
    {
      question: 'Hva gikk Feuerbachs projeksjonsteori ut på?',
      options: ["At Gud er en projeksjon av menneskets egne egenskaper og idealer", "At Gud projiserer sin vilje inn i menneskene", "At Gud aktivt projiserer sin egen vilje og sine idealer inn i menneskene", "At troen på Gud er en nedarvet instinktreaksjon på frykt for naturkreftene"],
      explanation: 'Feuerbach hevdet at mennesker som tilber Gud, egentlig tilber en idealisert versjon av seg selv – religion uttrykker menneskets lengsel etter fullkommenhet.',
    },
    {
      question: 'Hva mente Marx med at religion er «opium for folket»?',
      options: ["At religion gir trøst som demper smerten ved undertrykkelse, men hindrer folk i å kjempe for reell endring", "At religion avdekker urettferdigheten i samfunnet og dermed driver folk til å kreve reell samfunnsendring", "At religiøse mennesker bokstavelig talt inntar bedøvende stoffer under sine rituelle handlinger og seremonier", "At religion virker som et rusmiddel som gir folk økt energi og motivasjon til å delta i samfunnskampen"],
      explanation: 'Marx bygde videre på Feuerbach og mente religion både trøster og passiviserer, og dermed legitimerer urettferdige samfunnsforhold.',
    },
  ],
  ...
  'religion-etikk-5-2': [
    ...
    {
      question: 'Hva er troens sprang hos Kierkegaard?',
      options: ["Overgangen til det religiøse stadiet, der mennesket velger å tro selv om troen ikke kan begrunnes rasjonelt", "Det rasjonelle gudsbeviset som gjør at troen kan begrunnes fullstendig med fornuften alene", "Overgangen fra barndom til voksenliv, der mennesket forlater det etiske stadiet bak seg", "Et symbolsk hopp som utføres som en del av selve dåpsseremonien i den kristne kirke"],
      explanation: 'Spranget er «paradoksalt» fordi det krever at mennesket aksepterer noe fornuften ikke kan bevise.',
    },
    {
    ...
    {
      question: 'Hva bygger Viktor Frankls logoterapi på?',
      options: ["At menneskets primære drivkraft er viljen til mening", "At viljen til makt styrer mennesket", "At menneskets grunnleggende drivkraft er viljen til makt over andre", "At all dyp mening bare kan finnes innenfor en religiøs ramme og tro"],
      explanation: 'Logoterapi (av gresk logos, «mening») setter viljen til mening i sentrum, i motsetning til viljen til makt (Nietzsche/Adler) eller lyst (Freud).',
    },
  ],

  'religion-etikk-5-3': [
    {
      question: 'Hva omfatter religionsfriheten som menneskerettighet?',
      options: ["Retten til å ha, velge, endre eller forkaste en religion eller et livssyn, og til å utøve troen alene eller sammen med andre", "Kun rettigheter som gjelder for offisielt registrerte og statlig godkjente trossamfunn og menigheter", "Retten til fritt å pålegge og overbevise andre mennesker om at ens egen tro er den eneste sanne", "Utelukkende retten til å delta i gudstjenester og møter innenfor kirkens fysiske bygninger"],
      explanation: 'Religionsfriheten omfatter også retten til ikke å ha en religion, og har både en indre og en ytre dimensjon.',
    },
    {
      question: 'Hva er forskjellen på forum internum og forum externum?',
      options: ["Forum internum er den indre retten til å tro fritt og er absolutt, forum externum er den ytre religionsutøvelsen som kan begrenses", "Forum internum gjelder rettighetene til vanlige medlemmer, forum externum gjelder rettighetene til religiøse ledere", "Forum internum er den ytre utøvelsen som kan begrenses, forum externum er den indre troen som er absolutt", "Forum internum gjelder utøvelse i kirker og templer, forum externum gjelder bønn i moskeer og synagoger"],
      explanation: 'Den indre trosfriheten kan aldri begrenses, mens den ytre utøvelsen kan begrenses på bestemte vilkår.',
    },
    {
      question: 'Hvilke tre vilkår må være oppfylt for å begrense den ytre religionsfriheten?',
      options: ["Begrensningen må ha hjemmel i lov, tjene et legitimt formål og være nødvendig i et demokratisk samfunn", "Begrensningen må gjelde alle religioner likt, vare i høyst ett år og holdes hemmelig for allmennheten", "Begrensningen må vedtas i fellesskap av kirken, FN og statsoverhodet, og gjelde uten unntak for alle borgere", "Begrensningen må bare tjene et legitimt formål, mens hjemmel i lov og nødvendighet er uten betydning"],
      explanation: 'Disse tre vilkårene følger av menneskerettighetene. Den indre religionsfriheten (forum internum) kan derimot aldri begrenses.',
    },
    {
      question: 'Hva er skjønnsmarginen (margin of appreciation) i EMDs praksis?',
      options: ["Et prinsipp som gir statene et visst handlingsrom i tolkningen av menneskerettighetene ut fra nasjonale forhold", "En felles europeisk erstatningsordning som skal kompensere ofre for menneskerettighetsbrudd økonomisk", "Statenes plikt til umiddelbart og uten forbehold å iverksette domstolens avgjørelser i nasjonal rett", "Domstolens rett til å avvise innkomne klagesaker uten å gi noen nærmere begrunnelse for avvisningen"],
      explanation: 'Prinsippet anerkjenner at europeiske land har ulike tradisjoner og at det ikke alltid finnes én riktig løsning på spørsmål om for eksempel religiøse symboler.',
    },
    {
  ...
  'religion-etikk-5-4': [
    {
      ...
      options: ["Prinsippet om at stat og religion skal være atskilt", "En religiøs retning innenfor protestantismen", "Et statlig forbud mot at borgerne overhodet får ha en religiøs tro", "Prinsippet om at den religiøse kirken skal styre og lede statsapparatet"],
      explanation: 'Sekularisme innebærer at politiske beslutninger fattes på ikke-religiøst grunnlag og at staten ikke favoriserer noe bestemt livssyn.',
    },
    {
      question: 'Hva kjennetegner det franske prinsippet laïcité?',
      options: ["Strikt separasjon av stat og religion, der religion også holdes utenfor det offentlige rom", "At undervisning i den dominerende religionen er obligatorisk i alle offentlige skoler", "At staten aktivt finansierer og støtter alle trossamfunn i landet på helt lik linje", "At den katolske kirken har status som offisiell statskirke med særlige privilegier"],
      explanation: 'Laïcité ble lovfestet i 1905 og går lenger enn vanlig sekularisme: Staten verken anerkjenner eller støtter noen religion, og religiøse symboler begrenses i offentlige institusjoner.',
    },
    {
    ...
    {
      question: 'Hva innebærer livssynslikestilling i Norge?',
      options: ["At ulike tros- og livssynssamfunn skal behandles likt av staten, slik Grunnloven § 16 legger opp til", "At alle innbyggerne i landet må slutte seg til og bekjenne seg til ett og samme livssyn", "At det bare er de kristne trossamfunnene som har krav på økonomisk støtte fra staten", "At staten etter Grunnloven er avskåret fra å gi støtte til noe som helst trossamfunn"],
      explanation: 'Grunnloven § 16 slår fast at alle tros- og livssynssamfunn skal understøttes på lik linje, blant annet gjennom tilskuddsordninger.',
    },
    {
      question: 'Hva er et omdiskutert spørsmål i debatten om religion i det offentlige rom?',
      options: ["Bruk av religiøse symboler og plagg i offentlige institusjoner", "Hvilket språk bønner skal fremsies på privat", "Spørsmålet om hvorvidt religionene i det hele tatt bør ha hellige skrifter og tekster", "Spørsmålet om kirkebygg og gudshus fortsatt skal ha tak og fysisk beskyttelse mot vær"],
      explanation: 'Spørsmål om religiøse symboler i skole, politi og rettsvesen aktualiserer spenningen mellom religionsfrihet, nøytralitet og likebehandling.',
    },
  ],

  'religion-etikk-5-5': [
    {
      question: 'Hva kjennetegner urfolksreligioner?',
      options: ["De er ofte muntlig overleverte, knyttet til et bestemt landskap og preget av et helhetlig syn på menneske, natur og åndeverden", "De hviler alltid på skriftlige og strengt kanoniserte tekster med fastlagt læreinnhold og dogmer", "De finnes utelukkende blant urfolk i Sør-Amerika og har ingen utbredelse i andre verdensdeler", "De er organisert i et fast hierarki med pave, biskoper og en tydelig sentral kirkeledelse"],
      explanation: 'Urfolksreligioner har vokst frem hos urfolk over hele verden og er tett knyttet til naturmiljø og landskap.',
    },
    {
    ...
    },
    {
      ...
      options: ["Den norske statens systematiske forsøk på å assimilere samer og kvener i majoritetskulturen", "Et statlig program i dag som skal lære innvandrere norsk språk og norske samfunnsverdier", "En landsdekkende kampanje for å fremme salg og bruk av norskproduserte matvarer og varer", "En bevisst politikk for å spre og styrke samisk språk og kultur i den norske majoriteten"],
      explanation: 'Politikken varte fra midten av 1800-tallet til godt inn på 1900-tallet og innebar blant annet forbud mot samisk språk i skolen.',
    },
    {
      question: 'Hva er animisme?',
      options: ["Forestillingen om at naturfenomener, dyr og planter har en ånd eller livskraft", "Troen på én allmektig og personlig skapergud som står utenfor og over naturen", "Dyrkelsen av maskiner og teknologi som en moderne erstatning for eldre naturreligioner", "En konsekvent avvisning av alt som er åndelig, til fordel for et rent materialistisk syn"],
      explanation: 'Begrepet ble introdusert av antropologen Edward Tylor på 1870-tallet. Animistiske forestillinger finnes i mange urfolksreligioner.',
    },
  ],

  'religion-etikk-5-6': [
    {
      question: 'Hva betegner pluralisme?',
      options: ["Både en faktisk tilstand av mangfold av religioner og livssyn, og et ideal om at mangfoldet er verdifullt", "Et prinsipielt forbud mot at religiøse minoriteter får eksistere fritt i et samfunn", "At samtlige medlemmer av et samfunn deler nøyaktig samme tro, verdier og livssyn", "En bestemt valgordning der velgerne kan avgi flere ulike stemmesedler samtidig"],
      explanation: 'Pluralisme kan brukes deskriptivt om mangfoldet som finnes, og normativt om at mangfoldet bør anerkjennes.',
    },
    {
    ...
    {
      question: 'Hva skiller multikulturalisme fra assimileringspolitikk?',
      options: ["Multikulturalismen anerkjenner ulike kulturers rett til å bestå, assimilering krever at minoriteter tilpasser seg majoritetskulturen", "Multikulturalismen forbyr minoritetskulturer å bestå, mens assimilering verner om deres rett til å eksistere", "Assimilering betyr å bevare og styrke alle språk og kulturer, mens multikulturalisme krever full tilpasning", "Begge betyr i praksis det samme, nemlig at minoriteter skal smelte sammen med majoritetskulturen over tid"],
      explanation: 'Multikulturalisme er en politikk som verdsetter kulturelt og religiøst mangfold, i motsetning til krav om full tilpasning til majoriteten.',
    },
    {
    ...
    {
      question: 'Hva er konstitusjonell patriotisme ifølge Habermas?',
      options: ["Nasjonaltilhørighet basert på tilslutning til felles demokratiske prinsipper, ikke på etnisitet eller religion", "Borgernes grunnleggende plikt til å forsvare landets territorium og grenser mot ytre fiender", "Kravet om at nasjonens grunnlov og lover skal være forankret i et bestemt religiøst grunnlag", "Kjærlighet til og stolthet over nasjonens felles religiøse arv og kristne kulturtradisjoner"],
      explanation: 'I et mangfoldig samfunn kan felles demokratiske institusjoner og prinsipper gi samhold på tvers av kultur og religion.',
    },
  ],
  ...
  'religion-etikk-6-1': [
    ...
    {
      question: 'Hva hevder religiøs eksklusivisme?',
      options: ['At bare én religion har sannheten og veien til frelse', 'At alle religioner er like gyldige', 'At det finnes sannhet i andre religioner, men ens egen er fullest', 'At ingen religion inneholder sannhet'],
      explanation: 'Eksklusivisme, inklusivisme og pluralisme er tre grunnholdninger til andre religioner: Inklusivismen anerkjenner verdi i andre tradisjoner, og pluralismen ser flere veier som likeverdige.',
    },
    {
      question: 'Hva er forskjellen på økumenikk og interreligiøs dialog?',
      options: ["Økumenikk er dialog mellom kristne kirkesamfunn, interreligiøs dialog går på tvers av religionsgrensene", "Begge formene for dialog foregår utelukkende innenfor teologiske fakulteter og akademiske miljøer", "Interreligiøs dialog gjelder bare forholdet mellom kristne konfesjoner, økumenikk går på tvers av religionene", "Økumenikk er dialog som utelukkende gjelder islam, interreligiøs dialog gjelder samtaler mellom kristne kirker"],
      explanation: 'Økumenikk (av gresk oikoumene, «den bebodde verden») er samarbeid mellom kristne konfesjoner, mens interreligiøs dialog skjer mellom ulike religioner.',
    },
    {
  ...
  'religion-etikk-6-2': [
    {
      question: 'Hva er en religionskrig?',
      options: ["En væpnet konflikt der religiøse motsetninger er en sentral årsak til eller legitimering av krigshandlinger", "En opphetet teologisk debatt mellom lærde fra ulike trossamfunn om tolkningen av de hellige skriftene", "En rettslig konflikt om eierskap og bruksrett til kirkebygg, moskeer eller andre religiøse forsamlingslokaler", "Enhver krig som bryter ut mellom to nabostater som tilhører hver sin religiøse tradisjon, uansett den egentlige årsaken"],
      explanation: 'Historiske eksempler er korstogene (1096–1291) og de europeiske religionskrigene på 1500- og 1600-tallet.',
    },
    {
    ...
    {
      question: 'Hva er forskjellen på religiøs fundamentalisme og religiøs ekstremisme?',
      options: ["Fundamentalisme vektlegger bokstavtro tolkning, mens ekstremisme bruker religion til å rettferdiggjøre vold", "Begrepene betyr nøyaktig det samme og brukes helt om hverandre i faglitteraturen om religion og samfunn", "Fundamentalisme innebærer alltid bruk av vold, mens ekstremisme tvert imot er en gjennomført fredelig holdning", "Ekstremisme forekommer utelukkende innenfor én bestemt verdensreligion, mens fundamentalisme finnes i alle religioner"],
      explanation: 'Fundamentalisme innebærer ikke nødvendigvis vold, mens ekstremisme krysser grensen til å legitimere eller utøve vold i religionens navn.',
    },
    {
  ...
  'religion-etikk-6-3': [
    {
      question: 'Omtrent hvor stor andel av Norges befolkning var medlemmer av Den norske kirke per 2024?',
      options: ['Om lag 64 prosent', 'Om lag 95 prosent', 'Om lag 30 prosent', 'Om lag 10 prosent'],
      explanation: 'Den norske kirke er fortsatt landets klart største tros- og livssynssamfunn, men medlemsandelen har sunket over tid.',
    },
    {
      question: 'Hvilken kristen tradisjon tilhører Den norske kirke?',
      options: ['Den evangelisk-lutherske', 'Den romersk-katolske', 'Den ortodokse', 'Den reformerte kalvinistiske'],
      explanation: 'Den norske kirke har tilhørt den evangelisk-lutherske tradisjonen siden reformasjonen i 1537.',
    },
    {
  ...
  'religion-etikk-6-4': [
    ...
    {
      question: 'Hvorfor regnes spørsmål om liv, død og mening som eksistensielle spørsmål?',
      options: ["De angår grunnvilkårene i menneskets tilværelse og besvares ulikt av religioner og sekulære livssyn", "De er først og fremst relevante for eldre mennesker som nærmer seg livets slutt og tenker på døden", "De kan i prinsippet besvares endelig og entydig av naturvitenskapen når forskningen bare blir grundig nok", "De stilles utelukkende innenfor vestlige kulturer og har ingen plass i andre religiøse eller filosofiske tradisjoner"],
      explanation: 'Alle livssyn – religiøse som sekulære – tilbyr svar på de store spørsmålene om døden, lidelsen og meningen med livet, men svarene varierer.',
    },
  ],
...
export default quizData_religion_etikk;
