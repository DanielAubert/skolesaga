      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Alle europeiske folk ble lojale mot Frankrike', isCorrect: false },
              { id: 'b', text: 'De okkuperte folkene mistet sin egen kultur', isCorrect: false },
              { id: 'c', text: 'Europa ble samlet til én stor nasjonalstat', isCorrect: false },
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Ideen om at alle land bør styres av én felles europeisk regjering', isCorrect: false },
              { id: 'b', text: 'Ideen om at verden er delt inn i nasjoner som har rett til sin egen stat', isCorrect: true },
              { id: 'c', text: 'Ideen om at kongen har rett til å styre flere folk', isCorrect: false },
              { id: 'd', text: 'Ideen om at kirken skal bestemme landegrensene', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'For å erstatte alle dialekter med ett standardspråk', isCorrect: false },
              { id: 'b', text: 'For å gjøre det lettere å kommunisere med Danmark', isCorrect: false },
              { id: 'c', text: 'For å gi nasjonen et skriftspråk basert på norske dialekter, ikke dansk', isCorrect: true },
              { id: 'd', text: 'For å lage et språk som bare eliten kunne forstå', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              ...
              { id: 'c', text: 'Den avskaffet monarkiet i de fleste europeiske land', isCorrect: false },
              { id: 'd', text: 'Den skapte internasjonale allianser mellom nasjoner', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Fordi naturressurser var den viktigste inntektskilden', isCorrect: false },
              { id: 'b', text: 'Fordi nasjonale grenser fulgte naturlige skillelinjer', isCorrect: false },
              { id: 'c', text: 'Fordi landskapet - fjell, fjorder, skoger - ble et symbol på nasjonen', isCorrect: true },
              { id: 'd', text: 'Fordi romantikerne var mot industrialisering', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Tysklands samling under Prøyssen', isCorrect: false },
              { id: 'b', text: 'Italias samling til en nasjonalstat', isCorrect: true },
              { id: 'c', text: 'Gresk frigjøring fra Det osmanske riket', isCorrect: false },
              { id: 'd', text: 'Den franske revolusjonens slagord', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Fordi imperiene hadde for svake armeer', isCorrect: false },
              { id: 'b', text: 'Fordi mange ulike folk krevde retten til selvstyre og egen stat', isCorrect: true },
              { id: 'c', text: 'Fordi imperiene ikke hadde nok penger', isCorrect: false },
              { id: 'd', text: 'Fordi alle imperier ble beseiret av Napoleon', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'I Berlin', isCorrect: false },
              { id: 'b', text: 'I Wien', isCorrect: false },
              { id: 'c', text: 'I Speilsalen i Versailles', isCorrect: true },
              { id: 'd', text: 'I Frankfurt', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Ved å hevde at koloniene ønsket å bli erobret', isCorrect: false },
              { id: 'b', text: 'Ved å argumentere for at alle folk hadde rett til selvstyre', isCorrect: false },
              { id: 'c', text: 'Ved at europeiske nasjoner konkurrerte om kolonier for å vise "nasjonal storhet"', isCorrect: true },
              { id: 'd', text: 'Ved å bruke kirken som begrunnelse for erobring', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              ...
              { id: 'b', text: 'Avkoloniseringen av Afrika', isCorrect: false },
              { id: 'c', text: 'Oppløsningen av alle imperier', isCorrect: false },
        ...
        questions: [
          {
            ...
            options: [
              { id: 'a', text: 'Inkluderende nasjonalisme finnes bare i små land', isCorrect: false },
              ...
              { id: 'c', text: 'Det finnes ingen reell forskjell mellom dem', isCorrect: false },
              { id: 'd', text: 'Ekskluderende nasjonalisme handler bare om økonomi', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Fordi kriger mellom nasjoner fortsatt er vanlige', isCorrect: false },
              { id: 'b', text: 'Fordi romantikken fortsatt preger all kunst', isCorrect: false },
              { id: 'c', text: 'Fordi verden er organisert i nasjonalstater, med nasjonaldager, flagg og nasjonale lag', isCorrect: true },
              { id: 'd', text: 'Fordi alle land fortsatt har monarkier', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Norges stortingspresident som godtok union med Sverige', isCorrect: false },
              { id: 'b', text: 'Den svenske kronprinsen som krevde Norge', isCorrect: false },
              { id: 'c', text: 'Den danske stattholderen som mobiliserte norsk motstand og kalte inn riksforsamling', isCorrect: true },
              { id: 'd', text: 'En norsk bonde som ledet et folkelig opprør', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'En fredsavtale mellom Norge og Danmark i 1380', isCorrect: false },
              { id: 'b', text: 'En avtale der Norge frivillig gikk inn i union med Sverige', isCorrect: false },
              { id: 'c', text: 'En avtale der stormaktene oppløste det danske riket', isCorrect: false },
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Konservative ville ha enevelde, radikale ville ha republikk', isCorrect: false },
              ...
              { id: 'c', text: 'Nordpartiet ville ha union med Danmark, sørpartiet med Sverige', isCorrect: false },
              { id: 'd', text: 'Bøndene ville ha demokrati, embetsmennene ville ha monarki', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Alle voksne borgere over 25 år', isCorrect: false },
              { id: 'b', text: 'Bare adelige og embetsmenn', isCorrect: false },
              { id: 'c', text: 'Ca. 40 prosent av voksne menn - de med eiendom', isCorrect: true },
              { id: 'd', text: 'Alle menn og kvinner med fast bosted', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Adelens rett til å kreve skatt av bønder', isCorrect: false },
              { id: 'b', text: 'Kongens rett til å eie all jord i riket', isCorrect: false },
              { id: 'c', text: 'Statens rett til å ekspropriere privat eiendom', isCorrect: false },
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'En helt ny grunnlov som Sverige påtvang Norge', isCorrect: false },
              { id: 'b', text: 'Grunnloven av 17. mai justert for å tilpasses unionen med Sverige', isCorrect: true },
              { id: 'c', text: 'En avtale som ga Sverige full kontroll over norsk politikk', isCorrect: false },
              { id: 'd', text: 'En lov som forbød norsk nasjonalisme', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Norge fikk eget flagg uten unionsmerke', isCorrect: false },
              { id: 'b', text: 'Parlamentarismen ble innført - regjeringen måtte ha Stortingets tillit', isCorrect: true },
              { id: 'c', text: 'Unionen med Sverige ble oppløst', isCorrect: false },
              { id: 'd', text: 'Norge fikk egen utenrikstjeneste', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Jevnt fordelt mellom ja og nei', isCorrect: false },
              { id: 'b', text: 'Flertallet stemte nei til oppløsning', isCorrect: false },
              { id: 'c', text: 'Overveldende flertall for oppløsning: 368 208 ja, bare 184 nei', isCorrect: true },
              { id: 'd', text: 'Resultatet ble aldri offentliggjort', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Sverige ga opp uten forhandlinger', isCorrect: false },
              { id: 'b', text: 'FN grep inn og megle mellom landene', isCorrect: false },
              { id: 'c', text: 'Norge aksepterte å fortsette i unionen i fem år til', isCorrect: false },
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Christian Frederik', isCorrect: false },
              { id: 'b', text: 'Karl Johan', isCorrect: false },
              { id: 'c', text: 'Haakon VII, en dansk prins', isCorrect: true },
              { id: 'd', text: 'Olav V', isCorrect: false },
            ],
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              ...
              { id: 'b', text: '1851', isCorrect: false },
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Fordi den ble skrevet på pergament som fortsatt eksisterer', isCorrect: false },
              { id: 'b', text: 'Fordi den er blitt endret over 300 ganger for å tilpasse seg nye tider og verdier', isCorrect: true },
              { id: 'c', text: 'Fordi den leses opp hvert år på 17. mai', isCorrect: false },
              { id: 'd', text: 'Fordi den aldri har blitt endret siden 1814', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'At all jord i Finnmark ble statlig eid', isCorrect: false },
              { id: 'b', text: 'At man måtte kunne norsk for å kjøpe jord i Finnmark', isCorrect: true },
              { id: 'c', text: 'At samer fikk gratis jord i Sør-Norge', isCorrect: false },
              { id: 'd', text: 'At jord bare kunne selges til kvener', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Kommunisme - tanken om at alle er like', isCorrect: false },
              { id: 'b', text: 'Liberalisme - tanken om individuell frihet', isCorrect: false },
              { id: 'c', text: 'Sosialdarwinisme - forestillingen om at noen folk var "høyere" enn andre', isCorrect: true },
              { id: 'd', text: 'Kristendom - tanken om at alle måtte ha samme tro', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Familiene ble rikere av å lære norsk', isCorrect: false },
              { id: 'b', text: 'Samiske barn fikk bedre utdanning enn norske barn', isCorrect: false },
              { id: 'c', text: 'Foreldre sluttet å snakke samisk til barna av skam, og en generasjon mistet kulturen', isCorrect: true },
              { id: 'd', text: 'Samene fikk større politisk innflytelse', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'En strid om eiendomsrett til samisk land', isCorrect: false },
              { id: 'b', text: 'Energibehov og vannkraftutbygging mot samiske reindriftsområder og urfolksrettigheter', isCorrect: true },
              { id: 'c', text: 'Samene ville stenge grensene mot Finland', isCorrect: false },
              { id: 'd', text: 'Norske myndigheter ville flytte samer til Sør-Norge', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Bare debattinnlegg i aviser', isCorrect: false },
              { id: 'b', text: 'Væpnet kamp mot norsk politi', isCorrect: false },
              { id: 'c', text: 'Leir ved utbyggingsstedet, sultestreik foran Stortinget og sivil ulydighet', isCorrect: true },
              { id: 'd', text: 'Diplomatisk press fra andre nordiske land', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Samisk ble det eneste offisielle språket i Nord-Norge', isCorrect: false },
              { id: 'b', text: 'Staten ble forpliktet til å legge til rette for samisk språk, kultur og samfunnsliv', isCorrect: true },
              { id: 'c', text: 'Norge ble erklært som en samisk nasjonalstat', isCorrect: false },
              { id: 'd', text: 'Sametinget fikk vetorett over Stortingets beslutninger', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: '"Samene må tilpasse seg det norske samfunnet"', isCorrect: false },
              { id: 'b', text: '"Den norske stat er grunnlagt på territoriet til to folk - nordmenn og samer"', isCorrect: true },
              { id: 'c', text: '"Sametinget får full lovgivende makt over Nord-Norge"', isCorrect: false },
              { id: 'd', text: '"Vi oppretter et eget samisk statsborgerskap"', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'En handelsavtale mellom Norge og samiske naboland', isCorrect: false },
              { id: 'b', text: 'En internasjonal avtale om arbeiderrettigheter', isCorrect: false },
              { id: 'c', text: 'En internasjonal avtale som forplikter staten til å respektere urfolks rettigheter', isCorrect: true },
              { id: 'd', text: 'En FN-resolusjon om avskaffelse av alle nasjonalstater', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Et samisk folk fra Troms', isCorrect: false },
              { id: 'b', text: 'Etterkommere av finsktalende folk som innvandret til Nord-Norge fra 1600-tallet', isCorrect: true },
              { id: 'c', text: 'En norsk adelsslekt fra Bergen', isCorrect: false },
              { id: 'd', text: 'Svenske innvandrere som kom etter 1905', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'De fikk spesielle handelsrettigheter', isCorrect: false },
              { id: 'b', text: 'De ble tilbudt gratis utdanning og bolig', isCorrect: false },
              { id: 'c', text: 'Barn ble tatt fra foreldre, og kvinner ble tvangssterilisert', isCorrect: true },
              { id: 'd', text: 'De ble invitert til å delta i Stortinget', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              ...
              { id: 'c', text: '1989', isCorrect: false },
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'At fornorskingspolitikken hadde vært vellykket og nødvendig', isCorrect: false },
              { id: 'b', text: 'At uretten mot samer, kvener og norskfinner fortsatt merkes i dag', isCorrect: true },
              { id: 'c', text: 'At samene ikke hadde bodd i Norge før 1800-tallet', isCorrect: false },
              { id: 'd', text: 'At norske myndigheter aldri hadde drevet fornorskingspolitikk', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'At Norge var det eneste landet i Europa uten nasjonalisme', isCorrect: false },
              { id: 'b', text: 'At Norge kjempet for egen frihet (1814, 1905) samtidig som det undertrykte urfolk og minoriteter', isCorrect: true },
              { id: 'c', text: 'At norsk nasjonalisme var mildere enn i alle andre land', isCorrect: false },
              { id: 'd', text: 'At samene selv ønsket fornorskingspolitikken', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Faktorer som lokker folk til det nye landet', isCorrect: false },
              { id: 'b', text: 'Faktorer som driver folk bort fra hjemlandet', isCorrect: true },
              { id: 'c', text: 'Faktorer som hindrer folk i å reise', isCorrect: false },
              { id: 'd', text: 'Faktorer som gjør at folk vender tilbake', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'At bøndene dyrket for lite mat', isCorrect: false },
              { id: 'b', text: 'At befolkningen vokste raskt mens mengden dyrkbar jord forble den samme', isCorrect: true },
              { id: 'c', text: 'At klimaet ble kaldere og ødela avlingene', isCorrect: false },
              { id: 'd', text: 'At staten konfiskerte jord fra bøndene', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Fordi urfolk hjalp nordmennene med å dyrke jorda', isCorrect: false },
              { id: 'b', text: 'Fordi urfolk og nordmenn konkurrerte om de samme jobbene', isCorrect: false },
              ...
              { id: 'd', text: 'Fordi urfolk hadde oppfunnet jordbruksteknikkene som ble brukt', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Brevene inneholdt penger som betalte for reisen', isCorrect: false },
              { id: 'b', text: 'Ett brev lokket en slektning, som sendte nytt brev, som lokket neste - og slik vokste bølgen', isCorrect: true },
              { id: 'c', text: 'Myndighetene tvang folk til å lese brevene høyt', isCorrect: false },
              { id: 'd', text: 'Brevene ble trykket i aviser som nådde hele Norge', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Billetter som ble betalt av den norske staten', isCorrect: false },
              { id: 'b', text: 'Billetter kjøpt av rederiene for å lokke utvandrere', isCorrect: false },
              { id: 'c', text: 'Ferdigkjøpte reisebilletter sendt fra utvandrere i Amerika til slektninger hjemme', isCorrect: true },
              { id: 'd', text: 'Rabatterte billetter for familier som reiste samlet', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'En norsk koloni i New York', isCorrect: false },
              { id: 'b', text: 'Innvandringskontrollen i New York der mange utvandrere ble registrert', isCorrect: true },
              { id: 'c', text: 'En havn i Liverpool der utvandrerne skiftet skip', isCorrect: false },
              { id: 'd', text: 'Et norsk-amerikansk sykehus', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Reisen ble lenger, men tryggere', isCorrect: false },
              { id: 'b', text: 'Reisen ble kortet ned fra 6-12 uker til 2-3 uker', isCorrect: true },
              { id: 'c', text: 'Alle fikk gratis mat og drikke om bord', isCorrect: false },
              { id: 'd', text: 'Det ble ikke lenger nødvendig å passere innvandringskontroll', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'En norsk avis som ble sendt til Amerika', isCorrect: false },
              { id: 'b', text: 'En norskspråklig avis i Iowa som ble lest av nordmenn over hele Midtvesten', isCorrect: true },
              { id: 'c', text: 'Et postkontor som formidlet amerikabrev', isCorrect: false },
              { id: 'd', text: 'En norsk kirke i Minnesota', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Det ble sterkere for hver generasjon', isCorrect: false },
              { id: 'b', text: 'Det ble forbudt av amerikanske myndigheter', isCorrect: false },
              { id: 'c', text: 'Andre generasjon snakket norsk med besteforeldrene, tredje generasjon snakket ofte bare engelsk', isCorrect: true },
              { id: 'd', text: 'Norsk ble et offisielt språk i flere delstater', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Norge fikk tilbake utdannede leger og ingeniører', isCorrect: false },
              { id: 'b', text: 'Befolkningspresset lettet, penger strømmet tilbake, og demokratiske ideer ble importert', isCorrect: true },
              { id: 'c', text: 'Norge fikk kontroll over nye landområder i Amerika', isCorrect: false },
              { id: 'd', text: 'Utvandringen hadde ingen positiv virkning for Norge', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Bygdene ble overbefolket av tilbakevendte utvandrere', isCorrect: false },
              { id: 'b', text: 'Amerikanske skikker ødela norsk kultur', isCorrect: false },
              { id: 'c', text: 'Mange bygder mistet sine mest arbeidsføre unge mennesker, og familier ble splittet', isCorrect: true },
              { id: 'd', text: 'Utvandringen førte til krig mellom Norge og USA', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Ca. en tiendedel', isCorrect: false },
              { id: 'b', text: 'Ca. en femtedel', isCorrect: false },
              { id: 'c', text: 'Ca. en tredjedel', isCorrect: true },
              { id: 'd', text: 'Ca. halvparten', isCorrect: false },
            ],
