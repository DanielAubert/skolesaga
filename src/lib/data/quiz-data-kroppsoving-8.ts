...
const quizData_kroppsoving_8: Record<string, QuizQuestion[]> = {
  "kroppsoving-8-1-1": [
    {
      question: "Hva er utholdenhet?",
      options: ["Evnen til å arbeide over lengre tid", "Evnen til å løfte tungt", "Evnen til å løfte tunge vekter noen få ganger med full kraft", "Evnen til å være smidig"],
      explanation: "Utholdenhet er evnen til å arbeide over lengre tid uten å bli for sliten.",
    },
    {
    ...
    {
      question: "Hva menes med spesifisitetsprinsippet?",
      options: ["At du blir bedre på det du trener på", "At du bare kan trene én ting", "At du er nødt til å trene hver eneste dag for å få framgang", "At du må trene hver dag"],
      explanation: "Spesifisitetsprinsippet sier at kroppen tilpasser seg den type trening du gjør.",
    },
    {
  ...
  "kroppsoving-8-2-1": [
    {
      ...
      options: ["Å spille ærlig og respektere andre", "Å bare spille med venner", "Å bare spille sammen med de vennene du liker best på laget", "Å vinne for enhver pris"],
      explanation: "Fair play betyr å spille ærlig, følge reglene og vise respekt for alle.",
    },
    {
    ...
    {
      question: "Hva er viktig når du fører ball?",
      options: ["Se opp for å finne medspillære", "Bare se på ballen", "Løpe så fort som mulig", "Holde ballen langt fra kroppen"],
      explanation: "Se opp mens du fører ballen for å finne medspillære og ta bedre valg.",
    },
  ],
  "kroppsoving-8-2-2": [
    {
    ...
    {
      question: "Hva kjennetegner god sprintteknikk?",
      options: ["Høye knær og aktive armer", "Lave knær og slappe armer", "Å se ned i bakken", "Å lande på hælen"],
      explanation: "God sprintteknikk har høye knær, aktive armer, blikk fremover og landing på forfoten.",
    },
    {
  ...
  "kroppsoving-8-3-2": [
    {
      question: "Hva er den viktigste fjellvettregelen om å snu?",
      options: ["Vend i tide - det er ingen skam å snu", "Snu bare hvis det regner", "Snu bare hvis det begynner å regne, ikke av noen andre grunner", "Du må alltid nå toppen"],
      explanation: "Det er ingen skam å snu. Sikkerhet kommer alltid først.",
    },
    {
    ...
    {
      question: "Hvor kan du sjekke værmeldingen før en tur?",
      options: ["yr.no", "facebook.com", "youtube.com", "instagram.com"],
      explanation: "yr.no er Norges offisielle værtjeneste og gir pålitelige værmeldinger.",
    },
  ],
  "kroppsoving-8-4-1": [
    {
  ...
  "kroppsoving-8-4-2": [
    ...
    {
      question: "Hvorfor er matter viktig i turn?",
      options: ["For å dempe fall og førebygge skader", "For å gjøre øvelsene vanskeligere", "Man trenger egentlig ikke matter, gulvet fungerer helt like godt", "For at det skal se fint ut"],
      explanation: "Matter demper fall og reduserer risikoen for skader.",
    },
    {
  ...
  "kroppsoving-8-5-1": [
    ...
    {
      question: "Hvorfor er det viktig å redusere stillesitting?",
      options: ["Fordi langvarig stillesitting øker risiko for livsstilssykdømmer", "Fordi bare voksne mennesker påvirkes negativt av å sitte lenge", "Fordi det egentlig ikke har noe å si for helsen din i det hele tatt", "Fordi kontorstoler og skolestoler er dyre å skifte ut ofte"],
      explanation: "Langvarig stillesitting øker risikoen for overvekt, diabetes og hjerte-karsykdømmer.",
    },
    {
  ...
  "kroppsoving-8-5-2": [
    ...
    {
      question: "Hva betyr kroppspositivitet?",
      options: ["Å akseptere og verdsette kroppen din", "Å sammenligne deg med andre", "Å alltid ha en helt perfekt og feilfri kropp", "Å sammenligne kroppen din nøye med andre sin"],
      explanation: "Kroppspositivitet handler om å sette pris på kroppen for det den er og kan gjøre.",
    },
    {
      question: "Hvorfor kan koordinasjonen bli dårligere i puberteten?",
      options: ["Fordi kroppen vokser raskt og du må venne deg til nye proporsjoner", "Det stemmer ikke; koordinasjonen blir alltid bedre i puberteten", "Bare fordi du blir eldre, ikke fordi kroppen din endrer seg", "Fordi du automatisk trener mye mindre i denne perioden"],
      explanation: "Rask vekst gjør at hjernen må tilpasse seg nye kroppsproportioner.",
    },
    {
      question: "Hvorfor bør du være kritisk til kroppsidealer på sosiale medier?",
      options: ["Fordi bildene ofte er redigerte og viser urealistiske idealer", "Fordi det egentlig ikke finnes ekte bilder på sosiale medier", "Fordi absolutt alle som legger ut bilder på nett lyver bevisst", "Du trenger ikke være kritisk; bildene viser alltid virkeligheten"],
      explanation: "Bilder på sosiale medier er ofte redigerte og viser bare utvalgte øyeblikk.",
    },
    {
      question: "Hva bør du fokusere på når det gjelder egen kropp?",
      options: ["Hva kroppen kan gjøre, ikke bare hvordan den ser ut", "Utelukkende på hva andre mener om kroppen din", "Mest på å sammenligne kroppen din med andre", "Kun på hvordan kroppen ser ut for andre"],
      explanation: "Fokuser på kroppens funksjon - det den kan gjøre for deg - for et sunt forhold til kroppen.",
    },
  ],
  "kroppsoving-8-1-3": [
    {
      question: "Hva er kondisjon?",
      options: ["Kroppens evne til å ta opp og transportere oksygen til musklene", "Musklenes evne til å utvikle størst mulig kraft i én bevegelse", "Nervesystemets evne til å reagere raskt på et lyd- eller lyssignal", "Leddenes evne til å bevege seg fritt gjennom hele bevegelsesutslaget"],
      explanation: "Kondisjon er kroppens evne til å ta opp og transportere oksygen til arbeidende muskler, og måles ofte som maksimalt oksygenopptak (VO2maks).",
    },
    {
      question: "Hva kjennetegner intervalltrening?",
      options: ["Veksling mellom perioder med høy belastning og pauser", "Løping i jevnt, rolig tempo hele økten", "Trening med tunge vekter for å bygge maksimal muskelstyrke", "Løping i helt jevnt og rolig tempo gjennom hele treningsøkten"],
      explanation: "Intervalltrening veksler mellom arbeidsperioder med høy belastning og pauseperioder med lavere belastning eller hvile.",
    },
    {
      question: "Hva forteller VO2maks om kroppen din?",
      options: ["Hvor mye oksygen kroppen kan bruke per minutt under maksimalt arbeid", "Hvor stor kraft du klarer å utvikle i beina under et enkelt hopp", "Hvor høy makspulsen din er når du jobber på ditt aller hardeste", "Hvor mange timer i uken kroppen din tåler å trene uten skader"],
      explanation: "VO2maks angir hvor mye oksygen kroppen klarer å ta opp og bruke per minutt, og er et mål på kondisjonen.",
    },
    {
      question: "Hvorfor er det nyttig å kjenne hvilepulsen og makspulsen sin?",
      options: ["For å kunne beregne pulssoner og styre intensiteten på treningen", "Det har egentlig ingen praktisk nytte når du planlegger trening", "For å regne ut hvor mange kalorier du får i deg av maten du spiser", "For å måle hvor smidig og bevegelig du er i ledd og muskler"],
      explanation: "Med hvilepuls og makspuls kan du beregne pulssoner og dermed trene med riktig intensitet for målet ditt.",
    },
    {
      question: "Hva skjer i kroppen når du trener utholdenhet regelmessig?",
      options: ["Hjertet, lungene og blodårene blir mer effektive til å frakte oksygen", "Pulsen din blir høyere når du hviler enn den var før du trente", "Lungene blir mindre og tar opp mindre oksygen for hver pust", "Musklene dine blir gradvis kortere og stivere for hver økt"],
      explanation: "Utholdenhetstrening gjør at hjertet, lungene og blodårene samarbeider mer effektivt, slik at kroppen frakter oksygen bedre.",
    },
  ],
  "kroppsoving-8-1-4": [
    {
      question: "Hva er eksplosiv styrke (spenst)?",
      options: ["Evnen til å utvikle stor kraft på kort tid, for eksempel ved hopp", "Evnen til å bøye og strekke leddene så langt som overhodet mulig", "Den aller største kraften en muskel kan utvikle når den løfter sakte", "Evnen til å holde en fast muskelspenning i lang tid uten pause"],
      explanation: "Eksplosiv styrke er evnen til å utvikle stor kraft på kort tid, slik som ved hopp eller kast.",
    },
    {
    ...
    },
    {
      ...
      options: ["Trening av hele bevegelsesmønstre som ligner bevegelser fra hverdag og idrett", "Trening av kun én isolert muskel om gangen ved hjelp av maskiner", "Trening som utelukkende bruker tunge vektstenger med mange kilo", "Trening som kun kan foregå nede i vann, som i et svømmebasseng"],
      explanation: "Funksjonell trening etterligner hverdags- og idrettsbevegelser og trener flere muskelgrupper, ledd og balanse samtidig, f.eks. knebøy og utfall.",
    },
    {
  ...
  "kroppsoving-8-1-5": [
    {
      question: "Hva står PRICE-prinsippet for ved akutt skadebehandling?",
      options: ["Protect, Rest, Ice, Compression, Elevation", "Protect, Run, Inhale, Compress, Energize", "Push, Run, Ice, Care, Exercise – skyv, løp, is, stell og trening", "Plan, Rest, Inspect, Call, Evaluate"],
      explanation: "PRICE er huskeregelen Protect (beskytt), Rest (hvile), Ice (is), Compression (kompresjon) og Elevation (hev kroppsdelen).",
    },
    {
      question: "Hva betyr tilpasset aktivitet?",
      options: ["Å justere aktiviteten etter den enkeltes forutsetninger, som skade eller sykdom", "Å slutte helt med all trening med en gang noe begynner å gjøre vondt", "Å trene enda hardere enn vanlig for å bli fortere frisk fra en skade", "Å bare drive med de aktivitetene du allerede kan godt fra før av"],
      explanation: "Tilpasset aktivitet betyr å justere aktiviteten til forutsetningene dine, slik at du kan holde deg aktiv selv ved skade eller sykdom.",
    },
    {
      question: "Hvor lenge bør du kjøle ned en akutt skade med is?",
      options: ["15-20 minutter, med et håndkle mellom is og hud", "Is skal aldri brukes på skader", "Minst to timer i strekk, uten noen pause i nedkjølingen", "Is skal aldri brukes på skader fordi det gjør vondt verre"],
      explanation: "Is brukes i 15-20 minutter, og du skal alltid ha et håndkle mellom isen og huden for å unngå frostskade.",
    },
    {
      question: "Hva går nakkesjekkregelen ut på ved sykdom?",
      options: ["Har du symptomer kun over nakken, kan du ofte trene rolig; symptomer under nakken betyr hvile", "Feber forsvinner raskere hvis du kjører harde intervaller mens du er syk", "Du kan alltid trene hardt så lenge du ikke har vondt akkurat i nakken", "Du skal alltid trene opp nakkemuskulaturen ekstra mye når du er syk"],
      explanation: "Med symptomer bare over nakken (f.eks. lett snue) kan rolig aktivitet være greit, men ved symptomer under nakken eller feber skal du hvile.",
    },
    {
      question: "Hvorfor kalles restitusjon ofte «hvile som trening»?",
      options: ["Fordi kroppen reparerer seg og blir sterkere i hvileperiodene etter trening", "Fordi du forbrenner aller mest kalorier akkurat mens du ligger og sover", "Fordi man egentlig ikke trenger å trene hvis man bare hviler nok", "Fordi hvile alene gjør musklene mindre og svakere over tid"],
      explanation: "Det er i hvileperiodene etter trening at kroppen reparerer seg og tilpasser seg belastningen – uten restitusjon uteblir framgangen.",
    },
  ],
  "kroppsoving-8-2-3": [
    {
      question: "Hva kjennetegner nettspill som volleyball?",
      options: ["Lagene er atskilt av et nett og deler ikke spilleflaten", "Begge lag spiller på samme bane og kjemper om ballen", "Begge lag spiller på samme bane samtidig og kjemper om ballen", "Det finnes ingen regler for hvor ballen kan spilles"],
      explanation: "I nettspill er lagene atskilt av et nett, i motsetning til invasjonsspill der lagene deler spilleflaten.",
    },
    {
      question: "Hva er en lay-up i basketball?",
      options: ["Et skudd nær kurven der du legger ballen opp mot platen etter to skritt", "En forsvarsteknikk der du hopper opp og blokkerer et skudd", "En pasning som du kaster bak ryggen til en medspiller", "Et langskudd du sender mot kurven helt fra midtbanen"],
      explanation: "Lay-up er et avslutningsskudd nær kurven der du etter sats legger ballen mykt opp, ofte via platen.",
    },
    {
      question: "Hvilken teknikk brukes i volleyball for å sette i gang spillet?",
      options: ["Serve", "Lay-up", "Dribling", "Innkast"],
      explanation: "Hver ballveksling i volleyball starter med en serve fra bak grunnlinjen.",
    },
    {
      question: "Hva er dribling i basketball?",
      options: ["Å sprette ballen i gulvet med én hånd mens du beveger deg", "Å kaste ballen i en bue over nettet til den andre siden", "Å holde ballen fast med begge hender mens du går framover", "Å løpe fritt over banen med ballen klemt under armen"],
      explanation: "Dribling betyr å sprette ballen i gulvet med én hånd – du kan ikke løpe med ballen uten å drible.",
    },
    {
  ...
  "kroppsoving-8-2-4": [
    ...
    {
      question: "Hva kjennetegner god sprintteknikk?",
      options: ["Kraftige kneløft, aktive armdriv og fraspark fra tærne", "Lange, slepende skritt med hælene først", "Lange, slepende skritt der du lander på hælene først hver gang", "Armene holdes helt i ro og stive langs siden gjennom hele løpet"],
      explanation: "God sprintteknikk har kraftige kneløft, aktiv armbruk og fraspark fra fremre del av foten.",
    },
    {
    ...
    {
      question: "Hva er en vanlig feil i lengdehopp?",
      options: ["Å tråkke over satsingsbretten slik at hoppet blir ugyldig", "Å lande på beina i sandgropen", "Å lande på beina i sandgropen i stedet for å sette deg ned", "Å svinge armene framover under svevet for å holde balansen"],
      explanation: "Tråkker du over satsingsbretten (overtramp), blir hoppet ugyldig – derfor er et nøyaktig tilløp viktig.",
    },
    {
      question: "Hva er riktig om kulestøt?",
      options: ["Kulen skal støtes fra skulderen, ikke kastes med strak arm", "Kulen skal kastes med sving over hodet som et spyd", "Kulen skal trilles langs bakken med full fart før den løftes opp i lufta", "Kulen skal kastes med begge hender fra brystet"],
      explanation: "I kulestøt holdes kulen mot halsen/skulderen og støtes rett ut – den skal ikke kastes med svingende arm.",
    },
  ],
  "kroppsoving-8-2-5": [
    {
      question: "Hva betyr inkludering i kroppsøving?",
      options: ["At alle elever skal få delta i meningsfull aktivitet uansett forutsetninger", "At alle elever må gjøre nøyaktig de samme øvelsene", "At de dyktigste elevene får velge lagene sine først, så alle føler seg trygge og med", "At elever som har en skade eller er slitne, heller skal sitte rolig på benken og se på"],
      explanation: "Inkludering betyr at alle skal kunne delta meningsfullt – ikke at alle må gjøre det samme.",
    },
    {
      question: "Hva er tilrettelegging i idrett?",
      options: ["Å tilpasse aktiviteter, regler, utstyr eller omgivelser slik at flere kan delta", "Å fjerne alle konkurranseelementer fra idretten", "Å dele elevene inn i lag etter hvem som er flinkest, slik at kampene blir mest mulig jevne", "Å fjerne alle former for konkurranse og poeng fra idretten slik at ingen taper eller vinner"],
      explanation: "Tilrettelegging handler om å tilpasse regler, utstyr, øvelser eller organisering slik at flere kan være med.",
    },
    {
      question: "Hvordan kan du gjøre en fotballkamp i klassen mer inkluderende?",
      options: ["Endre regler, for eksempel at alle på laget må være borti ballen før mål", "La de beste spille hele tiden og resten se på", "La de beste spillerne være på banen hele kampen mens de andre venter på sidelinja og ser på", "Fjerne alle regler helt fra kampen, slik at spillet blir mer fritt og alle kan gjøre som de vil"],
      explanation: "Regelendringer som at alle må røre ballen før mål, gjør at flere blir involvert i spillet.",
    },
    {
      question: "Hvorfor beskrives mangfold som en styrke i idrett?",
      options: ["Ulike erfaringer, kropper og perspektiver gjør miljøet rikere og aktivitetene bedre", "Fordi det gjør det lettere å finne de beste utøverne", "Fordi når mange ulike elever trener sammen, blir alle etter hvert omtrent like flinke og sterke", "Fordi mangfold egentlig ikke har noen betydning i idrett, siden det bare er resultatene som teller"],
      explanation: "Mangfold tilfører ulike perspektiver og erfaringer som beriker fellesskapet og aktivitetene.",
    },
    {
  ...
  "kroppsoving-8-3-3": [
    ...
    {
      question: "Hva gir allemannsretten deg lov til?",
      options: ["Å plukke bær og sopp i utmark", "Å kjøre bil fritt i utmark", "Å telte i andres hage", "Å hogge ned trær til bål hvor som helst"],
      explanation: "Allemannsretten gir blant annet rett til fri ferdsel til fots, rasting, telting (150 m fra hus) og bær- og soppsanking i utmark.",
    },
  ],
  "kroppsoving-8-3-4": [
    {
    ...
    {
      question: "Hva er innerlagets viktigste oppgave i lagprinsippet?",
      options: ["Å transportere fuktighet bort fra huden", "Å beskytte mot vind og regn", "Å få deg til å se fin og sporty ut på tur", "Å beskytte kroppen mot vind og regn utenfra"],
      explanation: "Innerlaget (lag 1) av ull eller syntetisk stoff skal transportere svette bort fra huden så du holder deg tørr og varm.",
    },
    {
    ...
    {
      question: "Hva bør du sjekke når du planlegger en tur?",
      options: ["Vær- og føreforhold, rute på kart og deltakernes evner", "Ingenting – turer skal være spontane", "Bare hvor mange kilometer selve turen er, siden det er det eneste som virkelig betyr noe", "Kun hva slags mat du skal ha med"],
      explanation: "God turplanlegging innebærer å tilpasse turen etter deltakerne, sjekke vær og føre, studere kart og pakke riktig utstyr.",
    },
    {
      question: "Hvilket materiale egner seg best som innerlag på vinterturer?",
      options: ["Ull", "Bomull", "Dongeri", "Regntøy"],
      explanation: "Ull varmer selv når det blir fuktig, mens bomull blir kald når den blir våt – derfor er ull best innerst.",
    },
  ],
  "kroppsoving-8-3-5": [
    {
      question: "Hvem har utarbeidet fjellvettreglene?",
      options: ["DNT og Røde Kors", "Politiet og Forsvaret", "FN og WHO", "Skolene i Norge"],
      explanation: "De ni fjellvettreglene er utarbeidet av Den Norske Turistforening (DNT) og Røde Kors.",
    },
    {
    ...
    {
      question: "Hvorfor bør du følge med på vær- og skredvarsel før fjellturer?",
      options: ["Fordi været i fjellet kan endre seg raskt og skape farlige situasjoner", "Det er bare nødvendig for profesjonelle klatrere", "For å finne ut på forhånd hvilke klær og hvilket utstyr som er mest moteriktig å ha med seg", "Fordi det som regel alltid er stabilt og fint vær oppe i fjellet, så du slipper å bekymre deg"],
      explanation: "Fjellvær kan skifte raskt; ved å sjekke vær- og skredvarsel kan du tilpasse eller avlyse turen før det blir farlig.",
    },
  ],
  "kroppsoving-8-4-3": [
    {
      question: "Hvor oppsto streetdance?",
      options: ["I urbane gatekulturer i USA på 1970- og 80-tallet", "Ved de klassiske ballettakademiene i Russland", "I gamle norske folkedansmiljøer på bygdene for lenge siden", "Ved de klassiske ballettakademiene i Russland på 1800-tallet"],
      explanation: "Streetdance er et samlebegrep for danser som oppsto i gatekulturer i USA på 1970- og 80-tallet.",
    },
    {
    ...
    {
      question: "Hva kjennetegner moderne dans?",
      options: ["Fri bevegelse, bruk av gulvet og fokus på følelser og uttrykk", "Faste posisjoner og strenge regler for alle bevegelser", "At den alltid danses sammen med en fast partner i par, aldri alene eller i gruppe", "At den bare danses til klassisk musikk"],
      explanation: "Moderne dans har fri bevegelse uten fastsatte posisjoner, bruker gulv, tyngde og fall, og fokuserer på uttrykk og formidling.",
    },
    {
      question: "Hva er freestyle i dans?",
      options: ["Å improvisere og danse fritt uten innøvd koreografi", "Å følge en nøyaktig innstudert koreografi", "En rask og effektiv svømmeteknikk man bruker på magen", "Å følge en helt nøyaktig og fast innstudert koreografi"],
      explanation: "Freestyle betyr å danse fritt og improvisere bevegelser i øyeblikket, uten fastlagt koreografi.",
    },
  ],
  "kroppsoving-8-4-4": [
    {
    ...
    {
      question: "Hva betyr progresjon i turn?",
      options: ["Å lære ferdigheter i rekkefølge fra enkelt til vanskelig", "Å hoppe rett til de vanskeligste øvelsene", "Å hoppe rett på de aller vanskeligste øvelsene med en gang, uten å øve på det enkle først", "Å konkurrere mot andre i klassen"],
      explanation: "Progresjon i turn betyr å bygge ferdigheter trinnvis, for eksempel håndstående mot vegg før fri håndstående.",
    },
    {
  ...
  "kroppsoving-8-4-5": [
    ...
    {
      question: "Hva betyr det at dansere beveger seg unisont?",
      options: ["Alle gjør det samme samtidig", "Alle gjør forskjellige bevegelser", "Danserne bytter på å stå stille", "Bare én danser om gangen beveger seg"],
      explanation: "Unisont betyr at alle danserne utfører de samme bevegelsene samtidig.",
    },
    {
      question: "Hvordan kan du bruke kontraster i en dansekomposisjon?",
      options: ["Veksle mellom motsetninger som raskt/sakte og høyt/lavt", "Gjenta nøyaktig samme bevegelse hele tiden", "Bare danse i ett og samme tempo på ett fast nivå, slik at dansen blir helt jevn og rolig", "Unngå variasjon for å gjøre dansen ryddig"],
      explanation: "Kontraster som raskt/sakte, høyt/lavt og kraftig/lett skaper variasjon og interesse i komposisjonen.",
    },
  ],
  "kroppsoving-8-5-3": [
    {
      question: "Hvilket nummer ringer du til medisinsk nødtelefon i Norge?",
      options: ["113", "110", "112", "911"],
      explanation: "113 er medisinsk nødtelefon. 110 er brann og 112 er politi.",
    },
    {
      question: "I hvilken rekkefølge bør redningsteknikker velges, fra tryggest til mest risikabel?",
      options: ["Rekke, kaste, ro, svømme", "Svømme, ro, kaste, rekke", "Kaste, svømme, rekke, ro", "Ro, svømme, kaste, rekke"],
      explanation: "Du velger alltid tryggeste metode først: rekke noe til personen, kaste flytemiddel, ro ut – og svømmeredning kun som siste utvei.",
    },
    {
      question: "Hvorfor skal du nærme deg en person i nød i vannet bakfra?",
      options: ["For å unngå at personen griper tak i deg i panikk", "Fordi det er raskere å svømme bakfra", "For at personen ikke skal bli flau", "Det spiller ingen rolle hvilken retning du kommer fra"],
      explanation: "En person i panikk kan klamre seg til redderen og dra begge under – derfor nærmer du deg alltid bakfra.",
    },
    {
      question: "Hva er kasteredd?",
      options: ["Å kaste et flytemiddel eller tau fra land til en person i nød", "Å kaste en ball til noen som leker i vannet", "Å kaste seg selv ut i vannet for å svømme fram til og redde en person som er i nød", "En øvelse i livredningskonkurranser på tid"],
      explanation: "Kasteredd betyr å kaste redningsbøye, line eller annet flytemiddel fra land – du står selv trygt mens du hjelper.",
    },
    {
      question: "Hva er det første leddet i livredningskjeden?",
      options: ["Forebygging – å unngå at ulykken skjer", "Å ringe forsikringsselskapet", "Å svømme raskt ut til personen som er i nød", "Å starte HLR med brystkompresjoner med en gang"],
      explanation: "Livredningskjeden starter med forebygging (følge baderåd, bruke vest), deretter observasjon, alarmering, redning og førstehjelp.",
    },
  ],
  "kroppsoving-8-5-4": [
    {
    ...
    {
      question: "Når skal du legge en person i stabilt sideleie?",
      options: ["Når personen er bevisstløs, men puster selv", "Når personen er våken og snakker", "Når personen er våken og snakker helt fint med deg selv", "Når personen har brukket beinet"],
      explanation: "Stabilt sideleie brukes på bevisstløse som puster, slik at luftveiene holdes åpne og oppkast renner ut.",
    },
    {
    ...
    {
      question: "Hva er en hjertestarter (AED)?",
      options: ["Et apparat som kan gi elektrisk støt for å få hjertet i gang igjen ved hjertestans", "En vanlig pille du svelger med vann for å roe ned et hjerte som slår for fort", "Et treningsapparat for kondisjon der du sykler for å gjøre hjertet sterkere over tid", "En maskin som kun måler blodtrykket ditt og viser tallene på en liten skjerm"],
      explanation: "En AED analyserer hjerterytmen og kan gi støt ved hjertestans – den gir taleinstruksjoner og kan brukes av alle.",
    },
  ],
  "kroppsoving-8-5-5": [
    {
      question: "Hvor tykk må isen minst være for å bære en person?",
      options: ["10 cm", "2 cm", "50 cm", "5 mm"],
      explanation: "Stålisen må være minst 10 cm tykk for å bære en person, og minst 20 cm for snøscooter.",
    },
    {
      question: "Hvilken type is er sterkest?",
      options: ["Blank og klar is", "Hvit is med snø og bobler", "Is dekket av vann", "Is ved utløp og innløp"],
      explanation: "Blank, klar stålis er sterkest – hvit is med snø og luftbobler er betydelig svakere.",
    },
    {
    ...
    {
      question: "Hva er ispigger, og hvorfor bør du ha dem med på isen?",
      options: ["Små pigger du henger rundt halsen og bruker til å dra deg opp hvis du går gjennom isen", "Skarpe pigger du fester under skoene for å få bedre feste på den glatte isflaten", "Fargerike pynteting du henger på skøytene dine slik at de ser finere ut på isen", "Et spesialverktøy du bruker til å måle hvor tykk isen er før du går ut på den"],
      explanation: "Ispigger bæres lett tilgjengelig rundt halsen og gir feste i glatt is slik at du kan dra deg opp av råka.",
    },
    {
      question: "Hva er viktig når du velger redningsvest?",
      options: ["At den passer din vekt og størrelse", "At den har samme farge som båten", "At den har nøyaktig samme farge som båten du skal seile eller padle med", "At den er så stor som mulig"],
      explanation: "Redningsvesten må passe vekten og størrelsen din for å holde deg riktig i vannet – og den bør prøves på forhånd.",
    },
  ],
  "kroppsoving-8-6-1": [
    {
    ...
    {
      question: "Hva kjennetegner god sprintteknikk?",
      options: ["Kraftige kneløft, aktive armdriv og tåfraspark", "Lange svevende skritt med rak kropp bakover", "Hælisett først, helt passive armer og en kropp som lener seg bakover", "Korte trippende steg med hendene i lomma"],
      explanation: "Sprintteknikk kjennetegnes av kraftige kneløft, aktive armdriv, fraspark fra tærne og fremoverlent kropp i akselerasjonen.",
    },
    {
  ...
  "kroppsoving-8-6-2": [
    ...
    {
      question: "Hva er den viktigste forskjellen mellom kulestøt og spydkast?",
      options: ["Kulen støtes rett ut fra skulderen, mens spydet kastes med tilløp og kastarm", "Kulen kastes med begge hender over hodet, mens spydet støtes fra skulderen", "Det er egentlig ingen forskjell i teknikken – begge kastes helt likt over hodet", "Spydet skal trilles langs bakken mens kulen kastes høyt opp i lufta"],
      explanation: "Kulen holdes mot halsen og støtes ut, mens spyd kastes over skulderen med tilløp – to ulike kastteknikker.",
    },
    {
  ...
  "kroppsoving-8-6-3": [
    {
      ...
      options: ["Spesifikt, Målbart, Oppnåelig, Relevant, Tidsbestemt", "Sosialt, Morsomt, Allsidig, Realistisk, Trygt", "Sterkt, Modig, Aktivt, Raskt og Tøft – ord som skal gjøre deg gira", "Smidig, Muskuløst, Atletisk, Rolig, Trent"],
      explanation: "Et SMART mål er Spesifikt, Målbart, Oppnåelig, Relevant og Tidsbestemt.",
    },
    {
    ...
    {
      question: "Hva er nytten av en treningsdagbok?",
      options: ["Du kan se framgang over tid og justere treningen basert på erfaring", "Den er egentlig bare til pynt og fine tegninger og har ingen nytte", "Den gjør at du slipper å trene fordi selve skrivingen teller som økt", "Læreren krever den bare for å kunne gi deg en karakter til slutt"],
      explanation: "En treningsdagbok dokumenterer hva du har gjort og hvordan det gikk, slik at du ser mønstre og framgang.",
    },
    {
      question: "Hvilket av disse målene er mest SMART?",
      options: ["«Jeg skal løpe 3 km uten pause innen 1. juni»", "«Jeg skal bli sprekest i verden»", "«Jeg skal bli mye bedre i gym utover året» – uten noe mer", "«Jeg skal bli den aller sprekeste i hele verden til slutt»"],
      explanation: "Målet om 3 km innen 1. juni er spesifikt, målbart, oppnåelig, relevant og tidsbestemt – de andre er vage eller urealistiske.",
    },
    {
  ...
  "kroppsoving-8-6-4": [
    ...
    {
      question: "Hva er parkour?",
      options: ["Å bevege seg effektivt fra A til B gjennom et miljø ved å hoppe, klatre og rulle over hindringer", "En fransk dansestil der du beveger deg elegant og flytende til musikk i en sal", "En type sykkelritt gjennom byen der du forserer hindringer på to hjul i fart", "Et lagspill med ball der to lag kjemper om å score flest mål på hverandre"],
      explanation: "Parkour handler om å forsere hindringer effektivt og flytende, og trener styrke, balanse, koordinasjon og mot.",
    },
    {
    ...
    {
      question: "Hvor kan parkour utøves?",
      options: ["Nesten overalt – i parker, skolegårder og byrom", "Kun på godkjente konkurransebaner", "Bare i spesialbygde haller som er laget kun for denne aktiviteten", "Kun på godkjente konkurransebaner med egne dommere og faste regler"],
      explanation: "Parkour kan utøves nesten overalt der det finnes hindringer – parker, skolegårder og byrom.",
    },
    {
      question: "Hvorfor kalles frisbeegolf, parkour og klatring «alternative» aktiviteter?",
      options: ["De er alternativer til de tradisjonelle lagidrettene og kan gi bevegelsesglede til flere", "De krever alltid veldig dyrt og avansert utstyr som få elever har råd til å kjøpe", "De er strengt forbudt i all organisert idrett og kan ikke utøves lovlig noe sted", "De kan bare utøves av voksne fordi de er altfor farlige for barn og ungdom"],
      explanation: "Alternative aktiviteter gir andre muligheter enn tradisjonelle lagidretter og kan passe dem som ikke finner seg til rette i ballspill.",
    },
  ],
  "kroppsoving-8-6-5": [
    {
    ...
    {
      question: "Hva er dommerens viktigste oppgave?",
      options: ["Å sørge for at reglene følges og at konkurransen er rettferdig og trygg", "Å underholde publikum på tribunen med morsomme innfall og god stemning", "Å hjelpe det laget som er best slik at de garantert vinner kampen til slutt", "Å trene utøverne før konkurransen slik at de blir best mulig forberedt"],
      explanation: "Dommeren håndhever reglene, holder oversikt over tid og poeng og sikrer rettferdig og trygg gjennomføring.",
    },
    {
  ...
  "kroppsoving-8-7-1": [
    {
      question: "Hvor mye fysisk aktivitet anbefales barn og unge (6-17 år) per dag?",
      options: ["Minst 60 minutter med moderat til høy intensitet", "Minst 10 minutter rolig gange", "Minst 10 minutter med rolig gange i et jevnt og avslappet tempo", "Cirka 30 minutter med moderat aktivitet fordelt over en hel uke"],
      explanation: "Helsedirektoratet anbefaler minst 60 minutter daglig fysisk aktivitet med moderat til høy intensitet for barn og unge.",
    },
    {
      question: "Hva er forskjellen på fysisk aktivitet og trening?",
      options: ["Fysisk aktivitet er all kroppsbevegelse som øker energiforbruket, mens trening er planlagt og strukturert aktivitet med mål", "Trening er alt du gjør utendørs i frisk luft, mens fysisk aktivitet bare er det du gjør inne", "Fysisk aktivitet teller kun med dersom du svetter skikkelig, ellers regnes det ikke som noe", "Det er nøyaktig det samme – de to ordene betyr fullstendig det samme og kan byttes fritt"],
      explanation: "Fysisk aktivitet omfatter all bevegelse (gå til skolen, leke), mens trening er planlagt og strukturert med et bestemt mål.",
    },
    {
      question: "Hva sier forskningen om mye stillesitting?",
      options: ["Det er en selvstendig risikofaktor for dårlig helse, selv om man ellers er aktiv", "Det styrker faktisk ryggen fordi du hviler musklene mens du sitter i ro", "Det gir bedre kondisjon over tid siden hvilepulsen synker når du sitter", "Det er helt ufarlig for helsa så lenge man bare trener litt innimellom"],
      explanation: "Mye stillesitting er en egen risikofaktor for helsen – selv aktive personer bør begrense langvarig sitting.",
    },
    {
  ...
  "kroppsoving-8-7-2": [
    ...
    {
      question: "Hva er viktig å vite om kroppslig utvikling i puberteten?",
      options: ["Alle utvikler seg i ulikt tempo, og det er helt normalt", "Bare gutter forandrer kropp i puberteten", "At alle utvikler seg nøyaktig likt og til samme tid, uansett arv og bakgrunn", "Utviklingen er ferdig når man er 13 år"],
      explanation: "I puberteten endrer kroppen seg mye, og tempoet varierer stort fra person til person – begge deler er normalt.",
    },
    {
      question: "Hva kjennetegner et godt selvbilde?",
      options: ["At du i hovedsak aksepterer deg selv, selv om ikke alt er perfekt", "At du alltid sammenligner deg med andre", "At du hele tiden sammenligner deg selv med andre og måler deg mot dem", "At du aldri gjør noen feil, og derfor slipper å skuffe deg selv eller andre"],
      explanation: "Et godt selvbilde betyr ikke at alt er perfekt, men at du grunnleggende aksepterer og respekterer deg selv.",
    },
    {
  ...
  "kroppsoving-8-7-3": [
    ...
    {
      question: "Hva kan bilderedigeringsverktøy gjøre med et bilde?",
      options: ["Fjerne kviser, endre kroppsform, glatte hud og endre belysning", "Ingenting som påvirker hvordan kroppen ser ut", "Bare legge til tekst og klistremerker på bildet, uten å endre personen på det", "Ingenting som påvirker hvordan kroppen ser ut, kun små justeringer av fargene"],
      explanation: "Digitale verktøy kan endre nesten alt: gjøre personer tynnere eller mer muskuløse, glatte hud og endre ansiktsform.",
    },
    {
  ...
  "kroppsoving-8-7-4": [
    {
      question: "Hva gjør kroppen mens du sover?",
      options: ["Reparerer vev, bygger muskler, styrker immunforsvaret og lagrer minner", "Forbrenner mer energi enn ved hard trening", "Bare drømmer og hviler, uten at noe vev repareres eller muskler bygges opp", "Forbrenner mye mer energi enn ved hard trening, fordi hjernen jobber på høygir"],
      explanation: "Under søvn utfører kroppen viktig vedlikehold: reparasjon av vev, muskelbygging, styrking av immunforsvaret og lagring av minner.",
    },
    {
    ...
    {
      question: "Hvorfor er søvn viktig for idrettsprestasjoner?",
      options: ["Kroppen reparerer seg og bygger seg sterkere under søvn, og du blir mer opplagt", "Søvn har ingen betydning for prestasjonen, bare selve treningen avgjør formen", "Man blir sterkere og bedre trent jo mindre man sover, fordi kroppen tvinges hardt", "Søvn er bare viktig for hjernen og hukommelsen, ikke for musklene og kroppen"],
      explanation: "God søvn gir bedre restitusjon, mer energi, raskere reaksjoner og bedre prestasjoner – søvnmangel svekker alt dette.",
    },
    {
      question: "Hvordan er søvnen organisert gjennom natten?",
      options: ["I ulike faser som gjentas i sykluser", "I én sammenhengende, lik tilstand", "I én lang, sammenhengende og helt lik tilstand fra man sovner til man våkner", "Tilfeldig uten noe mønster"],
      explanation: "Søvnen består av ulike faser (lett søvn, dyp søvn og REM) som gjentas i sykluser gjennom natten.",
    },
    {
      question: "Hva skjer hvis du trener hardt uten nok hvile over tid?",
      options: ["Kroppen rekker ikke å reparere seg, og du risikerer dårligere prestasjon og skader", "Musklene vokser dobbelt så fort, fordi de aldri får tid til å slappe av og hvile", "Du kommer raskere i bedre form, fordi kroppen tåler ubegrenset med belastning", "Ingenting skjer, siden hvile er helt unødvendig når man bare trener riktig"],
      explanation: "Uten tilstrekkelig restitusjon rekker ikke kroppen å bygge seg opp igjen, og resultatet kan bli overbelastning og skader.",
    },
  ],
  "kroppsoving-8-7-5": [
    {
    ...
    },
    {
      ...
      options: ["Indre motivasjon kommer fra glede ved aktiviteten selv, ytre fra belønninger eller press utenfra", "Det finnes egentlig bare én type motivasjon, og den kommer fra premier og ros", "Indre motivasjon er alltid dårligere og mindre nyttig enn ytre motivasjon", "Ytre motivasjon kommer fra musklene og kroppen, indre kommer fra hjernen"],
      explanation: "Indre motivasjon drives av glede og interesse for aktiviteten, ytre av premier, karakterer eller andres forventninger.",
    },
    {
  ...
  "kroppsoving-8-8-4": [
    ...
    },
    {
      ...
      options: ["Læren om å tilpasse omgivelser og arbeidsmåter til kroppen for å forebygge belastningsskader", "En egen gren innen friidrett som kombinerer flere kast- og løpsøvelser i samme konkurranse", "En moderne treningsform med strikk og elastikk som styrker musklene uten tunge vekter", "Læren om riktig kosthold og hvilke næringsstoffer kroppen trenger for å prestere godt"],
      explanation: "Ergonomi handler om å tilpasse omgivelsene til kroppen – riktig sittestilling, løfteteknikk og pauser fra stillesitting.",
    },
    {
  ...
  "kroppsoving-8-8-5": [
    {
      question: "Hva inneholder en god treningsplan?",
      options: ["Hva du skal gjøre, når, hvor lenge og hvor hardt", "Bare hvilke dager du skal trene", "Bare en oversikt over hvilke ukedager du har tenkt å trene, uten flere detaljer enn det", "Bare navnet på treningsstudioet"],
      explanation: "En treningsplan beskriver aktivitetstype, tidspunkt, varighet og intensitet, og tar hensyn til treningsprinsippene.",
    },
    {
    ...
    {
      question: "Hva gjør du hvis treningsplanen viser seg å være for ambisiøs?",
      options: ["Justerer planen så den blir realistisk å gjennomføre", "Fortsetter selv om kroppen sier stopp", "Gir helt opp hele treningsplanen og lar være å trene mer den perioden det gjelder", "Slutter å skrive treningsdagbok"],
      explanation: "Planer skal justeres etter erfaring – en realistisk plan du faktisk følger, er bedre enn en perfekt plan du dropper.",
    },
    {
      question: "Hvordan gjør du et vagt ønske som «komme i bedre form» om til et SMART mål?",
      options: ["Gjør det spesifikt, målbart og tidsbestemt, f.eks. «jogge 20 minutter tre ganger i uka i seks uker»", "Lar være å sette noen frist eller tidsramme, slik at du slipper å kjenne på press og stress", "Forteller ønsket til flest mulig venner og familie slik at de kan minne deg på det ofte", "Skriver ønsket med store bokstaver og henger det opp på veggen så du ser det hver dag"],
      explanation: "Et SMART mål er konkret og målbart med tidsfrist – da vet du nøyaktig hva du skal gjøre og når du har lykkes.",
    },
  ],
};

export default quizData_kroppsoving_8;
