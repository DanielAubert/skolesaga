...
const quizDataSalgServiceVg1: Record<string, QuizQuestion[]> = {
  "salg-service-vg1-1-1": [
    ...
    {
      question: "Hvor mange hovedfaser består salgsprosessen av i dette kapittelet?",
      options: ["Fem", "Tre", "Sju", "To"],
      explanation: "De fem fasene er: forberedelse og åpning, behovsavdekking, produktpresentasjon, innvendingsbehandling, og avslutning og oppfølging.",
    },
    {
      question: "Hvilken fase kommer rett etter behovsavdekkingen i salgsprosessen?",
      options: ["Produktpresentasjon", "Forberedelse og åpning", "Avslutning og oppfølging", "Reklamasjonsbehandling"],
      explanation: "Når du har kartlagt kundens behov, presenterer du produkter eller løsninger som passer til behovene. Deretter følger innvendingsbehandling og avslutning.",
    },
    {
      question: "Hva kjennetegner kundefokusert salg i motsetning til produktfokusert salg?",
      options: ["Selgeren tar utgangspunkt i kundens behov og finner løsninger som passer", "Selgeren rabler opp flest mulig produktegenskaper for kunden", "Selgeren snakker mest mulig og presenterer alle argumenter for å overbevise kunden om å kjøpe raskt", "Selgeren prøver alltid å selge det dyreste produktet"],
      explanation: "Kundefokusert salg setter kundens behov i sentrum, mens produktfokusert salg handler mest om å presentere produktet uten å kartlegge hva kunden faktisk trenger.",
    },
    {
      question: "Hva inngår i god forberedelse før kundemøtet?",
      options: ["Produktkunnskap, oppdatering på kampanjer og mental forberedelse", "Å lære utenat en fast salgstale som brukes på alle kunder", "Å undersøke kundens privatøkonomi og betalingsevne før man i det hele tatt hilser", "Å vente passivt bak disken til kunden selv tar kontakt og uttrykkelig ber om hjelp"],
      explanation: "Forberedelsesfasen handler om å kjenne varene, være oppdatert på tilbud og kampanjer, og være motivert og klar til å møte kunden med et godt førsteinntrykk.",
    },
  ],
  "salg-service-vg1-1-2": [
    ...
    {
      question: "Hva innebærer aktiv lytting?",
      options: ["Å være fullt til stede, gi respons, stille oppfølgingsspørsmål og oppsummere det kunden sier", "Å holde seg helt taus og ubevegelig til kunden er ferdig, uten å gi noen form for respons", "Å avbryte kunden midt i setningen for raskt å vise at du allerede har forstått poenget", "Å skrive ned ordrett alt kunden sier i notatform i stedet for å følge med på innholdet"],
      explanation: "Aktiv lytting betyr å vise at du hører og forstår: nikk, bekreftende ord, oppfølgingsspørsmål og oppsummering av det kunden har sagt.",
    },
    {
      question: "Hva er et åpent spørsmål?",
      options: ["Et spørsmål som inviterer kunden til å fortelle fritt, f.eks. 'Hva skal du bruke den til?'", "Et spørsmål som selgeren stiller høyt og tydelig så alle kundene i butikken kan høre det", "Et spørsmål som kunden enkelt kan svare kort på med et ja eller et nei uten å utdype", "Et spørsmål stilt uten at man forventer eller ønsker noe konkret svar fra kunden"],
      explanation: "Åpne spørsmål begynner gjerne med hva, hvordan eller hvorfor, og får kunden til å fortelle. Lukkede spørsmål kan besvares med ja/nei og brukes for å bekrefte.",
    },
    {
      question: "Når i samtalen passer det best å bruke lukkede spørsmål?",
      options: ["Når du vil bekrefte eller avklare noe konkret, for eksempel mot slutten", "Helt i starten, for å få kunden til å fortelle mest mulig", "Bare i situasjoner der kunden er tydelig irritert eller misfornøyd med et tidligere kjøp", "Aldri i en salgssamtale – lukkede spørsmål bør unngås fordi de virker avvisende på kunden"],
      explanation: "Lukkede spørsmål (ja/nei-spørsmål) egner seg til å bekrefte og avklare, for eksempel 'Skal jeg pakke den inn?'. Åpne spørsmål brukes tidlig for å avdekke behov.",
    },
    {
  ...
  "salg-service-vg1-1-3": [
    ...
    {
      question: "Hva er en god måte å bygge tillit på som rådgiver?",
      options: ["Lytte mer enn du snakker, være ærlig og tilpasse rådene til kunden", "Love mer enn produktet kan holde for å sikre salget", "Snakke mest mulig og fylle samtalen med fagord for å vise fram egen kompetanse", "Bevisst unnlate å nevne svakheter eller begrensninger ved produktet man selger"],
      explanation: "Tillit bygges gjennom kompetanse, ærlighet (også om begrensninger), å lytte mer enn man snakker, og å tilpasse rådene til kundens faktiske situasjon.",
    },
  ],
  "salg-service-vg1-1-4": [
    ...
    {
      question: "Hvilke fire temaer handler de vanligste innvendingene om?",
      options: ["Pris, behov, timing og tillit", "Farge, størrelse, vekt og form", "Garanti, frakt, emballasje og retur", "Lønn, arbeidstid, ferie og pensjon"],
      explanation: "Vanlige innvendinger handler om pris (for dyrt), behov (trenger det ikke), timing (ikke nå) og tillit (er dette trygt/bra nok).",
    },
    {
      question: "Hva er en valgavslutning?",
      options: ["Å la kunden velge mellom to alternativer, f.eks. 'Vil du ha den blå eller den svarte?'", "Å avslutte samtalen med å avtale et helt nytt møte med kunden på et senere tidspunkt", "Å spørre kunden helt direkte og tydelig: 'Skal vi gå videre og gjennomføre selve kjøpet nå?'", "Å oppsummere alle fordelene ved produktet på nytt før man til slutt spør om kunden vil kjøpe"],
      explanation: "I valgavslutningen tilbyr selgeren to alternativer som begge fører til salg. Direkte avslutning, oppsummeringsavslutning og neste-steg-avslutning er andre strategier.",
    },
    {
  ...
  "salg-service-vg1-1-5": [
    ...
    {
      question: "En kunde kjøper en mobiltelefon, og selgeren foreslår deksel og skjermbeskytter i tillegg. Hva kalles dette?",
      options: ["Kryssalg", "Mersalg", "Dumpingsalg", "Returbehandling"],
      explanation: "Kryssalg (cross-selling) er å tilby tilleggsprodukter som utfyller hovedproduktet – som deksel, skjermbeskytter og lader til en mobiltelefon.",
    },
    {
    ...
    {
      question: "Hva er den viktigste forutsetningen for godt mersalg og kryssalg?",
      options: ["At forslaget gir reell verdi for kunden", "At kunden ikke merker at det er salg", "At selgeren sikrer seg en høyere provisjon på det totale salget", "At produktene snart går ut på dato"],
      explanation: "Fokus skal være på verdi for kunden, og selgeren må respektere kundens grenser. Da oppleves mersalg som god service, ikke som press.",
    },
    {
  ...
  "salg-service-vg1-1-6": [
    ...
    },
    {
      ...
      options: ["Et system som lagrer kundeinformasjon som kjøpshistorikk og preferanser for å gi personlig service", "Et digitalt system som løpende overvåker og sammenligner konkurrentenes priser i markedet", "Et regnskapsprogram som brukes til å utstede fakturaer og holde oversikt over utgifter", "Et kassesystem som registrerer betalinger og skriver ut kvitteringer til kundene"],
      explanation: "CRM (Customer Relationship Management) er systemer og strategier for å håndtere kundeforhold, med informasjon om kjøpshistorikk, preferanser og kontaktinfo.",
    },
    {
    ...
    {
      question: "Hva er et eksempel på kundeoppfølging kort tid etter kjøpet?",
      options: ["Å kontakte kunden etter 1–2 uker for å høre om produktet fungerer som forventet", "Å slette all kundens informasjon og kjøpshistorikk fra systemet etter salget", "Å sende kunden en faktura påført et purregebyr for å minne om betalingen", "Å vente helt til kunden selv tar kontakt fordi noe er galt med produktet"],
      explanation: "Oppfølging kan skje direkte etter kjøp, etter 1–2 uker, regelmessig og ved spesielle anledninger – f.eks. en henvendelse om kunden er fornøyd.",
    },
    {
      question: "Hva betyr utsagnet 'salget er bare begynnelsen'?",
      options: ["At kundeforholdet fortsetter etter kjøpet, og oppfølging skaper lojale kunder og nye salg", "At de aller fleste salg før eller siden fører til en reklamasjon eller klage fra kunden", "At kunden nesten alltid ender opp med å kjøpe flere ulike varer i løpet av samme handledag", "At selgeren må starte hele salgsprosessen på nytt fra første steg hver gang samme kunde kommer"],
      explanation: "Et gjennomført salg er starten på et kundeforhold. Gjennom ettermarked og oppfølging bygges lojalitet som gir gjenkjøp og anbefalinger.",
    },
  ],
  "salg-service-vg1-1-7": [
    ...
    {
      question: "Hvor lang er den vanlige reklamasjonsfristen etter forbrukerkjøpsloven?",
      options: ["To år", "14 dager", "Seks måneder", "Ti år"],
      explanation: "Forbrukerkjøpsloven gir minst to års reklamasjonsrett (fem år for varer som er ment å vare vesentlig lenger). Dette må ikke forveksles med 14 dagers angrerett.",
    },
    {
  ...
  "salg-service-vg1-2-1": [
    ...
    {
      question: "Hva er servicegapet?",
      options: ["Forskjellen mellom forventet service og opplevd service", "Tiden det tar før en kunde får svar på e-post", "Forskjellen mellom hva varen koster å produsere og hva den selges for i butikken", "Avstanden mellom kassen og inngangsdøren"],
      explanation: "Servicegap = forventet service minus opplevd service. Når opplevelsen er dårligere enn forventningen, blir kunden misfornøyd; overgås forventningen, blir kunden begeistret.",
    },
    {
      question: "Hvilke fem servicedimensjoner trekkes frem i kapittelet?",
      options: ["Pålitelighet, tillit/troverdighet, konkrete elementer, empati og responstid", "Lønn, arbeidstid, ferie, pensjon og forsikring", "Pris, plass, produkt, påvirkning og personale – de fem verktøyene i markedsmiksen", "Styrker, svakheter, muligheter, trusler og mål – de faste elementene i en strategianalyse"],
      explanation: "De fem servicedimensjonene er pålitelighet, tillit/troverdighet, konkrete elementer, empati og responstid – faktorer kundene vurderer service ut fra.",
    },
    {
      question: "Hva er en servicekultur?",
      options: ["Felles verdier, holdninger og normer i bedriften som former hvordan ansatte behandler kundene", "De vanene og kjøpemønstrene kundene har utviklet gjennom mange år som handlende i butikken", "De kulturarrangementene og festivalene som bedriften velger å sponse for å bygge omdømme utad", "En skriftlig liste med regler og påbud som henger oppslått på pauserommet for de ansatte"],
      explanation: "Servicekultur er bedriftens felles verdier og normer. En sterk servicekultur gjør at god service skjer naturlig – ikke bare når ledelsen ser på.",
    },
    {
      question: "Hva påvirker kundens forventninger til service?",
      options: ["Tidligere erfaringer, markedsføring, omtale fra andre og pris", "Ingenting – alle kunder har like forventninger", "Utelukkende bedriftens åpningstider, altså når kunden faktisk får mulighet til å handle der", "Kun været den dagen kunden handler"],
      explanation: "Forventninger formes blant annet av tidligere erfaringer, det bedriften lover i markedsføringen, anbefalinger fra andre og prisnivået.",
    },
  ],
  "salg-service-vg1-2-2": [
    ...
    {
      question: "Hvilke elementer inngår i godt vertskap ifølge kapittelet?",
      options: ["Oppmerksomhet, proaktivitet, varme og kompetanse", "Hurtighet, lav pris, høy musikk og reklame", "Streng kontroll, regler, skilting og kameraovervåkning", "Bonusprogram, rabatter, konkurranser og gaver"],
      explanation: "God vertskap bygger på oppmerksomhet, proaktivitet, varme og kompetanse – i tillegg til et godt fysisk miljø og atmosfære.",
    },
    {
      question: "Hva menes med å skape atmosfære i en servicebedrift?",
      options: ["Å bruke fysisk miljø, detaljer og stemning bevisst slik at gjesten trives", "Å fjerne alle dekorasjoner for å virke profesjonell", "Å installere et kraftig klimaanlegg i lokalet slik at temperaturen alltid holdes helt konstant", "Å spille bakgrunnsmusikk på så høyt volum som mulig slik at stedet oppleves livlig og energisk"],
      explanation: "Atmosfære skapes både gjennom det fysiske miljøet (lys, lyd, innredning), små detaljer og den immaterielle stemningen personalet bidrar til.",
    },
  ],
  "salg-service-vg1-2-3": [
    {
      question: "Hvorfor bør servicemedarbeidere kjenne til ulike kundetyper?",
      options: ["For å kunne tilpasse kommunikasjon og tilnærming til hver enkelt kunde", "For å rangere kundene etter hvor mye de handler", "For å kunne avvise og bli kvitt de vanskelige kundene før de rekker å ta unødvendig mye tid", "For å gi alle kunder nøyaktig samme behandling"],
      explanation: "Hver kunde er unik. Ved å lese signaler og gjenkjenne kundetyper kan du tilpasse tilnærmingen – det gir bedre service og bedre salg.",
    },
    {
    ...
    {
      question: "Hva kjennetegner den travle kunden, og hvordan bør du tilpasse deg?",
      options: ["Kunden har dårlig tid – vær effektiv, konkret og rask", "Kunden vil småprate – ta deg god tid til en lang samtale", "Kunden vet alt om produktet – diskuter tekniske detaljer lenge", "Kunden er sint – tilkall vekter umiddelbart"],
      explanation: "Den travle kunden verdsetter effektivitet. Vær konkret, finn raskt frem til det kunden trenger, og ikke hal ut samtalen.",
    },
    {
      question: "Hvordan bør du tilnærme deg den kunnskapsrike kunden?",
      options: ["Anerkjenn kundens kunnskap og gå gjerne mer i dybden faglig", "Overse det kunden sier og hold deg til standardpresentasjonen", "Late som du kan mer enn du gjør", "Unngå faglige spørsmål helt"],
      explanation: "Den kunnskapsrike kunden setter pris på å bli tatt på alvor. Anerkjenn kompetansen, diskuter gjerne detaljer – og vær ærlig om det du ikke vet.",
    },
    {
  ...
  "salg-service-vg1-2-4": [
    ...
    {
      question: "Hvorfor er klager verdifulle for en bedrift?",
      options: ["De fleste misfornøyde kunder klager ikke – klager gir mulighet til å rette feil og beholde kunden", "Klager kan brukes som grunnlag for å straffe og gi advarsler til de ansatte som var involvert", "Klager gir bedriften en juridisk rett til å heve prisene overfor kundene som har vært misfornøyde", "Klager beviser at det er kunden som tar feil, og at bedriften hele tiden har gjort alt helt riktig"],
      explanation: "De fleste misfornøyde kunder klager ikke, de bare forsvinner. En klage gir bedriften sjansen til å rette opp feilen – og en godt håndtert klage kan gi en mer lojal kunde.",
    },
    {
  ...
  "salg-service-vg1-2-5": [
    ...
    {
      question: "Hvilke nødnumre gjelder i Norge?",
      options: ["Brann 110, politi 112, ambulanse 113", "Brann 112, politi 110, ambulanse 113", "Brann 113, politi 112, ambulanse 110", "Ett felles nødnummer: 911"],
      explanation: "I Norge er nødnumrene 110 (brann), 112 (politi) og 113 (ambulanse/medisinsk nødhjelp).",
    },
    {
  ...
  "salg-service-vg1-2-6": [
    ...
    {
      question: "Hva er et budsjett for et arrangement?",
      options: ["En økonomisk plan over forventede inntekter og utgifter", "En liste over inviterte gjester", "Det detaljerte programmet for kvelden som viser rekkefølgen på innslagene time for time", "En kontrakt med lokalutleier"],
      explanation: "Budsjettet er en økonomisk plan som viser alle forventede kostnader (lokale, mat, utstyr, markedsføring) og eventuelle inntekter (billetter, sponsorer).",
    },
    {
    ...
    {
      question: "Hva inngår i etterarbeidsfasen av et arrangement?",
      options: ["Evaluering, takk til bidragsytere og økonomisk oppgjør", "Selve avviklingen av arrangementet", "Utforming av selve konseptet og fastsetting av målene for hva arrangementet skal oppnå", "Booking av lokale og artister"],
      explanation: "Etterarbeidet omfatter evaluering av hva som fungerte, oppgjør av økonomien og oppfølging av deltakere og samarbeidspartnere.",
    },
    {
  ...
  "salg-service-vg1-2-7": [
    {
      question: "Hva er et nettverk i profesjonell sammenheng?",
      options: ["Summen av dine profesjonelle og personlige relasjoner", "Internettforbindelsen på arbeidsplassen", "Den samlede kundelista som bedriften har bygd opp med navn og kontaktinformasjon over tid", "En gruppe konkurrenter i samme bransje"],
      explanation: "Nettverket ditt er alle relasjonene du har – kolleger, tidligere arbeidsgivere, kunder, bransjebekjente og venner. Det gir tilgang til informasjon, muligheter og støtte.",
    },
    {
      question: "Hva er forskjellen på sterke og svake bånd i et nettverk?",
      options: ["Sterke bånd er nære relasjoner, svake bånd er bekjentskaper – og svake bånd gir ofte tilgang til ny informasjon", "Sterke bånd er de eneste nyttige relasjonene, mens svake bånd i praksis er helt verdiløse for deg", "Svake bånd er de relasjonene som snart kommer til å bli avsluttet, mens sterke bånd varer evig", "Sterke bånd er relasjoner du holder digitalt på nett, mens svake bånd er de du møter fysisk"],
      explanation: "Sterke bånd er nære relasjoner (familie, gode venner, nære kolleger), svake bånd er bekjentskaper. Forskning viser at svake bånd ofte gir tilgang til ny informasjon og muligheter, f.eks. jobber.",
    },
    {
    ...
    {
      question: "Hvilken digital plattform er mest kjent for profesjonell nettverksbygging?",
      options: ["LinkedIn", "Snapchat", "TikTok", "Pinterest"],
      explanation: "LinkedIn er den ledende plattformen for profesjonelle nettverk, med profil som fungerer som digital CV og muligheter for faglig kontakt.",
    },
    {
      question: "Hvorfor er nettverk viktig for karrieren?",
      options: ["Mange jobber og muligheter formidles gjennom kontakter før de lyses ut", "Arbeidsgivere ansetter bare folk de kjenner privat", "Et godt nettverk erstatter fullstendig behovet for å ha egen kompetanse og relevant erfaring", "Et stort nettverk gir deg helt automatisk høyere lønn, uavhengig av hvilken kompetanse du har"],
      explanation: "Nettverk gir karrieremuligheter, kompetansedeling og støtte. Mange muligheter formidles via kontakter – men kompetanse må fortsatt være på plass.",
    },
  ],
  "salg-service-vg1-3-1": [
    ...
    {
      question: "Hva står de fire P-ene i markedsføringsmiksen for?",
      options: ["Produkt, Pris, Plass og Påvirkning", "Plan, Prosess, Personale og Profitt", "Produksjon, Pakking, Prising og Profilering", "Produkt, Personale, Prosess og Fysiske bevis"],
      explanation: "Markedsføringsmiksen (4P) består av konkurransevirkemidlene Produkt, Pris, Plass (distribusjon) og Påvirkning (kommunikasjon).",
    },
    {
      question: "Hvilke tre P-er legges til i den utvidede markedsføringsmiksen (7P)?",
      options: ["People (mennesker), Process (prosess) og Physical Evidence (fysiske bevis)", "Produksjon (framstilling), Pakking (emballasje) og Patenter (rettigheter)", "Personvern (databeskyttelse), Politikk (påvirkning) og Presse (medieomtale)", "Profit (fortjeneste), Planning (planlegging) og Performance (ytelse)"],
      explanation: "For tjenester utvides miksen med People, Process og Physical Evidence – fordi mennesker, prosesser og fysiske omgivelser er avgjørende for serviceopplevelsen.",
    },
    {
  ...
  "salg-service-vg1-3-2": [
    {
      question: "Hva er forbrukeratferd?",
      options: ["Studiet av hvordan personer og grupper velger, kjøper og bruker produkter for å dekke behov", "En fullstendig oversikt over alle produktene og tjenestene en bedrift selger", "De interne reglene for hvordan kunder skal oppføre seg og stå i kø i butikk", "Loven som beskytter forbrukere mot feil og mangler ved kjøp av varer"],
      explanation: "Forbrukeratferd er studiet av hvordan enkeltpersoner, grupper og organisasjoner velger, kjøper, bruker og kvitter seg med produkter og tjenester.",
    },
    {
      question: "Hva er det første steget i kjøpsprosessen?",
      options: ["Problemerkjennelse", "Kjøpsbeslutning", "Informasjonssøk", "Vurdering av alternativer"],
      explanation: "Kjøpsprosessen: 1) problemerkjennelse, 2) informasjonssøk, 3) vurdering av alternativer, 4) kjøpsbeslutning, 5) atferd etter kjøp. Alt starter med at kunden erkjenner et behov.",
    },
    {
      question: "Hva er segmentering?",
      options: ["Å dele markedet inn i grupper av kunder med like behov, kjennetegn eller atferd", "Å dele den fysiske butikken inn i ulike avdelinger etter varegruppe", "Å sette ulike priser på nøyaktig samme vare avhengig av kundetype", "Å sortere varene i lageret etter størrelse, vekt og holdbarhet"],
      explanation: "Segmentering deler markedet i grupper med like behov eller atferd. Hvert segment kan kreve ulike produkter eller markedsføringsstrategier.",
    },
    {
      question: "Hvilket segmenteringskriterium brukes når man deler kundene inn etter alder, kjønn og inntekt?",
      options: ["Demografisk segmentering", "Geografisk segmentering", "Psykografisk segmentering", "Atferdsmessig segmentering"],
      explanation: "Demografisk segmentering bruker kjennetegn som alder, kjønn, inntekt og utdanning. Psykografisk handler om livsstil og verdier, geografisk om bosted, atferdsmessig om kjøpsvaner.",
    },
    {
  ...
  "salg-service-vg1-3-3": [
    {
      question: "Hva er en markedsplan?",
      options: ["Et dokument som beskriver markedsføringsmålene og hvordan de skal nås", "En detaljert kalender over butikkens åpningstider gjennom hele året", "En fullstendig liste over alle ansatte som jobber i markedsavdelingen", "Et geografisk kart som viser hvor bedriftens nærmeste konkurrenter ligger"],
      explanation: "Markedsplanen inneholder situasjonsanalyse, mål, strategier, tiltak, budsjett og måling av resultater – en plan for å nå markedsføringsmålene.",
    },
    {
      question: "Hva kartlegger en SWOT-analyse?",
      options: ["Styrker, svakheter, muligheter og trusler", "Salg, vekst, omsetning og tap", "Segmenter, varer, omdømme og trender", "Strategi, verdier, organisasjon og teknologi"],
      explanation: "SWOT står for Strengths (styrker), Weaknesses (svakheter), Opportunities (muligheter) og Threats (trusler).",
    },
    {
      question: "Hvilke deler av SWOT-analysen er interne faktorer?",
      options: ["Styrker og svakheter", "Muligheter og trusler", "Styrker og muligheter", "Svakheter og trusler"],
      explanation: "Styrker og svakheter er interne forhold i virksomheten, mens muligheter og trusler er eksterne forhold i omgivelsene.",
    },
    {
      question: "Hva betyr det at et mål er SMART?",
      options: ["Spesifikt, Målbart, Oppnåelig, Relevant og Tidsbestemt", "Stort, Modig, Ambisiøst, Risikabelt og Tøft", "Strategisk, Markedsrettet, Analytisk, Realistisk og Teoretisk", "Selvvalgt, Morsomt, Aktivt, Rimelig og Trygt"],
      explanation: "SMARTe mål er Spesifikke, Målbare, Oppnåelige (Achievable), Relevante og Tidsbestemte – det gjør dem lettere å følge opp.",
    },
    {
  ...
  "salg-service-vg1-3-4": [
    {
      question: "Hva er en markedsføringskampanje?",
      options: ["En planlagt og koordinert serie markedsføringsaktiviteter med felles mål, budskap og tidsbegrensning", "All markedsføring en bedrift driver kontinuerlig gjennom hele driftsåret uten pause", "Et internt planleggingsmøte i markedsavdelingen der man diskuterer nye ideer", "En enkelt løsrevet annonse i en avis eller et blad uten videre oppfølging"],
      explanation: "En kampanje er tidsavgrenset og koordinert, med felles mål og budskap, og bruker gjerne flere kanaler for å nå målgruppen.",
    },
    {
    ...
    {
      question: "Hva avgjør hvilke kanaler en kampanje bør bruke?",
      options: ["Hvor målgruppen befinner seg, budsjettet og budskapets form", "Tilfeldig trekning blant tilgjengelige kanaler", "Bare hvilken kanal som til enhver tid er den aller billigste å bruke", "Hvilke kanaler konkurrentene aldri bruker, slik at man alltid er alene der"],
      explanation: "Kanalvalget avhenger av hvor målgruppen er, hva budsjettet tillater og hvilke kanaler som egner seg for budskapet – digitale og tradisjonelle kanaler kan kombineres.",
    },
    {
      question: "Hvilket av disse er et eksempel på et salgsfremmende tiltak i en kampanje?",
      options: ["Tidsbegrenset rabatt eller konkurranse", "Å ansette flere i regnskapsavdelingen", "Å bytte bankforbindelse for å få bedre betingelser på lån og innskudd", "Å endre selskapets vedtekter"],
      explanation: "Salgsfremmende tiltak skal utløse handling på kort sikt, f.eks. rabatter, konkurranser, vareprøver og tilbud med tidsfrist.",
    },
  ],
  "salg-service-vg1-3-5": [
    ...
    },
    {
      ...
      options: ["Attention, Interest, Desire, Action", "Analyse, Idé, Design, Annonse", "Avsender, Innhold, Distribusjon, Aksept", "Attention, Information, Decision, Agreement"],
      explanation: "AIDA beskriver trinnene i påvirkning: først vekke oppmerksomhet (Attention), så interesse (Interest), deretter ønske (Desire) og til slutt handling (Action).",
    },
    {
      question: "Hva er en Call to Action (CTA)?",
      options: ["En tydelig oppfordring til mottakeren om å gjøre noe, f.eks. 'Bestill nå'", "En obligatorisk juridisk advarsel som må stå med liten skrift i annonsen", "En formell invitasjon til bedriftens årlige generalforsamling for eierne", "En direkte telefonsamtale mottakeren gjør til bedriftens kundeservice"],
      explanation: "CTA er oppfordringen som skal utløse handling – som 'Kjøp nå', 'Meld deg på' eller 'Les mer'. Den hører til A-en (Action) i AIDA.",
    },
    {
  ...
  "salg-service-vg1-3-6": [
    {
      question: "Hva regulerer markedsføringsloven?",
      options: ["Markedsføring og handelspraksis, blant annet forbud mot villedende og urimelig markedsføring", "Hvilke produkter og varer som lovlig kan importeres inn til Norge fra utlandet", "Utelukkende hvilke priser dagligvarebutikkene får lov til å ta for maten", "Hvor lang arbeidstid selgere og butikkansatte kan ha per uke og døgn"],
      explanation: "Markedsføringsloven forbyr villedende og urimelig markedsføring og har spesielle regler for markedsføring mot barn og unge.",
    },
    {
    ...
    },
    {
      ...
      options: ["EUs personvernforordning som regulerer innsamling og bruk av personopplysninger", "En norsk lov om garanti og reklamasjonsrett ved kjøp av varer og tjenester", "En frivillig bransjestandard som norske reklamebyråer har blitt enige om", "Et EU-direktiv om matsikkerhet og merking av innhold i næringsmidler"],
      explanation: "GDPR (General Data Protection Regulation) gjelder også i Norge og gir forbrukere rett til innsyn, sletting og kontroll over egne personopplysninger.",
    },
    {
    ...
    {
      question: "Hvorfor har markedsføring rettet mot barn egne, strengere regler?",
      options: ["Barn er lettere å påvirke og har ikke samme forutsetninger for å vurdere reklame kritisk", "De strengere reglene gjelder utelukkende for leketøys- og godteribransjen", "Barn har som regel mer penger å bruke enn voksne forbrukere har", "Barn ser aldri reklame, og reglene er derfor bare en formalitet"],
      explanation: "Markedsføringsloven § 21 stiller særlige krav ved markedsføring mot barn fordi barn er mer påvirkelige og mindre kritiske til reklame.",
    },
  ],
  "salg-service-vg1-3-7": [
    {
      question: "Hva er en merkevare (brand)?",
      options: ["Summen av alle assosiasjoner, opplevelser og forventninger kundene har til en virksomhet eller et produkt", "Utelukkende logoen og navnet som selskapet bruker på produktene sine", "Et varemerke som er formelt registrert og beskyttet hos Patentstyret", "Prislappen og prisnivået som er satt på produktet i butikkhyllen"],
      explanation: "En merkevare er mer enn navn og logo – det er alt kundene forbinder med virksomheten, og det som skiller den fra konkurrentene i kundenes bevissthet.",
    },
    {
    ...
    },
    {
      ...
      options: ["Å skape en tydelig og ønsket plass for merkevaren i kundenes bevissthet i forhold til konkurrentene", "Å plassere de riktige varene på de riktige stedene i butikkhyllene", "Å rangere de ansatte etter oppnådde salgsresultater gjennom året", "Å finne den beste fysiske beliggenheten for å åpne en ny butikk"],
      explanation: "Posisjonering handler om hvilken plass merkevaren skal ha i kundenes hoder – hva den skal forbindes med, og hvordan den skiller seg fra konkurrentene.",
    },
    {
  ...
  "salg-service-vg1-4-1": [
    ...
    {
      question: "Hva kjennetegner omnikanal-handel?",
      options: ["At fysiske og digitale kanaler henger sømløst sammen i én helhetlig kundeopplevelse", "At absolutt alle varene bedriften har blir solgt gjennom nettauksjoner", "At bedriften bare selger gjennom én enkelt kanal, som en nettbutikk", "At den fysiske butikken utelukkende tar imot betaling i kontanter"],
      explanation: "Omnikanal betyr at kunden kan bevege seg sømløst mellom nettbutikk, app og fysisk butikk – f.eks. bestille på nett og hente i butikk.",
    },
    {
    ...
    {
      question: "Hva er en digital markedsplass?",
      options: ["En plattform der mange selgere tilbyr varer til kunder på samme nettsted, som Finn eller Amazon", "En app som bare viser priser uten kjøpsmulighet", "En fysisk butikklokale i et kjøpesenter der én selger tilbyr varer med kortbetaling til kundene", "Et internt intranett der ansatte i én bedrift deler dokumenter og selger varer kun til hverandre"],
      explanation: "Markedsplasser samler mange selgere på én plattform. De er en av flere former for digital handel ved siden av egne nettbutikker.",
    },
  ],
  "salg-service-vg1-4-2": [
    ...
    {
      question: "Hva er forskjellen på organisk og betalt innhold i sosiale medier?",
      options: ["Organisk innhold publiseres gratis, betalt innhold er annonser med betalt rekkevidde", "Organisk innhold handler om mat, betalt om alt annet", "Betalt innhold når alltid færre personer enn organisk, fordi algoritmene skjuler alle annonserte innlegg", "Organisk innhold er ulovlig å bruke kommersielt, mens betalt innhold er den eneste tillatte formen på nett"],
      explanation: "Organisk innhold er vanlige innlegg uten annonsekostnad, mens betalt innhold er annonser der man betaler for å nå en definert målgruppe. Best effekt får man ofte ved å kombinere.",
    },
    {
  ...
  "salg-service-vg1-4-3": [
    {
      question: "Hva er en betalingsløsning?",
      options: ["Et system som muliggjør overføring av penger fra kjøper til selger ved et kjøp", "Et lån fra banken som bedriften bruker til å finansiere innkjøp av nye varer", "En forsikringsordning som dekker bedriftens tap dersom varer blir skadet eller stjålet", "En avtale med skattemyndighetene om at bedriften kan utsette innbetaling av skatt til senere"],
      explanation: "Digitale betalingsløsninger omfatter kortbetaling, mobilbetaling (som Vipps), nettbank og faktura-løsninger som Klarna.",
    },
    {
      question: "Hvilken norsk mobilbetalingsløsning er mest utbredt?",
      options: ["Vipps", "PayPal", "Apple Pay", "Klarna"],
      explanation: "Vipps er den dominerende norske mobilbetalingsløsningen. PayPal og Apple Pay er internasjonale, og Klarna er mest kjent for faktura- og delbetaling.",
    },
    {
    ...
    {
      question: "Hvilken rettighet har forbrukeren ved netthandel?",
      options: ["14 dagers angrerett etter angrerettloven", "Rett til å bruke varen i ett år før betaling", "Rett til gratis frakt på alle kjøp", "Rett til alltid å betale kontant ved levering"],
      explanation: "Ved netthandel (fjernsalg) gjelder angrerettloven med 14 dagers angrefrist, i tillegg til reklamasjonsrett og krav til prisopplysning og ordrebekreftelse.",
    },
  ],
  "salg-service-vg1-4-4": [
    ...
    {
      question: "Hva er en viktig fordel med digital kundeservice og chatbots?",
      options: ["Tilgjengelighet døgnet rundt og raske svar på vanlige spørsmål", "At kundene aldri trenger å vente på svar fra et menneske igjen", "At bedriften slipper alt ansvar for kundeservicen", "At alle henvendelser automatisk blir løst korrekt"],
      explanation: "Automatisering gir service 24/7, kortere ventetid og lavere kostnader – men har også begrensninger som krever menneskelig oppfølging.",
    },
    {
    ...
    {
      question: "Hva er en risiko ved dårlig implementert chatbot?",
      options: ["Frustrerte kunder som ikke får hjelp og mister tillit til bedriften", "At chatboten blir for flink og erstatter ledelsen", "At nettsiden får for mange besøkende samtidig slik at serveren bryter helt sammen", "At kundene ender opp med å handle altfor mye fordi chatboten anbefaler stadig nye varer"],
      explanation: "En chatbot som ikke forstår kunden eller mangler vei til menneskelig hjelp, skaper frustrasjon og kan skade kundeforholdet og omdømmet.",
    },
  ],
  "salg-service-vg1-4-5": [
    {
      question: "Hva er SEO?",
      options: ["Søkemotoroptimalisering – å forbedre nettsiden for å rangere høyere i organiske søkeresultater", "En type nettbutikk-plattform som lar bedrifter sette opp og drifte egne nettbutikker enkelt", "Et system for e-postmarkedsføring som sender nyhetsbrev og tilbud direkte til kundenes innboks", "Betalt annonsering i søkemotorer der man kjøper toppplassering for utvalgte søkeord mot betaling"],
      explanation: "SEO (Search Engine Optimization) handler om å øke synligheten i søkemotorenes ikke-betalte resultater for relevante søkeord.",
    },
    {
      question: "Hvilke tre hovedtrinn bruker søkemotorer for å levere søkeresultater?",
      options: ["Crawling, indeksering og rangering", "Innlogging, betaling og publisering", "Design, koding og testing", "Annonsering, klikk og konvertering"],
      explanation: "Søkemotorer crawler (gjennomsøker) nettet, indekserer innholdet i en database, og rangerer sidene etter relevans og kvalitet når noen søker.",
    },
    {
      question: "Hva er forskjellen på on-page og off-page SEO?",
      options: ["On-page er forbedringer på selve nettsiden, off-page er faktorer utenfor siden som lenker fra andre nettsteder", "On-page SEO gjelder kun visning på mobil, mens off-page SEO gjelder kun visning på PC og nettbrett", "On-page SEO er alltid gratis å gjennomføre, mens off-page SEO alltid koster penger å oppnå", "On-page og off-page er egentlig to ulike navn på nøyaktig det samme arbeidet med nettsiden"],
      explanation: "On-page SEO omfatter innhold, søkeord og teknisk kvalitet på egen side. Off-page handler om eksterne signaler, særlig lenker fra andre nettsteder.",
    },
    {
      question: "Hva er forskjellen på organisk og betalt synlighet i søkemotorer?",
      options: ["Organisk synlighet oppnås gjennom SEO uten klikk-kostnad, betalt synlighet kjøpes via annonser som Google Ads", "Organisk synlighet gjelder kun økologiske og bærekraftige produkter, mens betalt synlighet gjelder resten", "Betalt synlighet varer evig etter én betaling, mens organisk synlighet forsvinner umiddelbart igjen", "Det finnes ingen reell forskjell, ettersom begge former for synlighet oppnås på nøyaktig samme måte"],
      explanation: "SEO gir organisk (ikke-betalt) plassering og virker langsiktig, mens Google Ads gir umiddelbar betalt synlighet så lenge man betaler.",
    },
    {
      question: "Hva er innholdsmarkedsføring?",
      options: ["Å lage nyttig og relevant innhold, som guider og artikler, som tiltrekker og engasjerer målgruppen", "Å sende nøyaktig samme reklamebudskap til alle kunder hver eneste dag uansett interesse og behov", "Å fylle nettsiden med flest mulig annonser og bannere for å tiltrekke og engasjere målgruppen", "Å kopiere ferdig innhold direkte fra konkurrentenes nettsider for å spare tid og ressurser"],
      explanation: "Innholdsmarkedsføring bygger tillit og synlighet ved å tilby verdifullt innhold (blogg, video, guider) i stedet for direkte reklame – og styrker samtidig SEO.",
    },
  ],
  "salg-service-vg1-4-6": [
    {
      question: "Hva er kundedata?",
      options: ["All informasjon en virksomhet samler inn om sine kunder, som kjøpshistorikk, atferd og preferanser", "Bedriftens egne regnskapstall som omsetning, kostnader og resultat gjennom regnskapsåret", "Utelukkende kundenes navn og postadresse, uten kjøpshistorikk, atferd eller preferanser", "Statistikk over de ansattes arbeidstid, fravær og hvor mange timer hver enkelt jobber"],
      explanation: "Kundedata omfatter demografisk informasjon, transaksjonsdata, atferdsdata, preferanser og tilbakemeldinger.",
    },
    {
    ...
    {
      question: "Hva brukes kundedata til i markedsføring?",
      options: ["Personalisering, segmentering, prediktiv analyse og forbedring av tilbudet", "Til å offentliggjøre kundenes kjøp", "Til å fastsette de ansattes lønn ut fra hvor mange kunder hver enkelt har betjent", "Utelukkende til å skrive ut fakturaer og kvitteringer etter at et kjøp er gjennomført"],
      explanation: "Data brukes til å tilpasse tilbud (personalisering), dele kundene i grupper (segmentering), forutsi behov (prediktiv analyse) og forbedre produkter og service.",
    },
    {
    ...
    },
    {
      ...
      options: ["En nøkkelindikator som måler hvordan virksomheten presterer mot målene sine", "En bestemt type kunderabatt som gis til lojale kunder ved gjentatte kjøp", "En egen personvernlov som regulerer hvordan bedrifter kan behandle kundedata", "Et digitalt kassasystem som brukes til å registrere salg og betaling i butikk"],
  ...
  "salg-service-vg1-5-1": [
    {
      ...
      options: ["Alle virksomheter som tilbyr varer og tjenester til reisende, som overnatting, servering, transport og opplevelser", "Kun hoteller og restauranter som tilbyr overnatting og servering til tilreisende gjester", "Utelukkende reisebyråer som selger ferdige pakketurer med reise og opphold inkludert", "Bare transportselskaper som fly, tog og buss som frakter reisende fra sted til sted"],
    ...
    },
    {
      ...
      options: ["Den økonomiske verdien næringen skaper gjennom omsetning, arbeidsplasser og ringvirkninger", "Hvor mange hoteller, campingplasser og overnattingssteder som finnes i landet totalt", "Prisen på en gjennomsnittlig flybillett til og fra de mest populære reisemålene", "Det totale antallet turister som besøker landet i løpet av et helt kalenderår"],
  ...
  "salg-service-vg1-5-2": [
    {
      ...
      options: ["En virksomhet som tilbyr overnatting mot betaling, som hoteller, vandrerhjem og campingplasser", "Et selskap som arrangerer guidede turer og opplevelser for reisende ute på destinasjonen", "En bedrift som utelukkende serverer frokost og lette måltider uten å tilby overnatting", "En virksomhet som leier ut biler og annet transportmateriell til turister og reisende"],
    ...
    },
    {
      ...
      options: ["Resepsjon (Front Office)", "Mat og drikke (F&B)", "Housekeeping, som har ansvar for romrengjøring og vask", "Administrasjon"],
    ...
    },
    {
      ...
      options: ["Unikt design og færre rom enn store kjedehoteller", "Alltid alt-inkludert opphold", "Svært mange rom fordelt på flere etasjer med hovedvekt på lav pris per natt", "Kun overnatting uten frokost"],
    ...
    },
    {
      ...
      options: ["En virksomhet som selger mat og/eller drikke til fortæring på stedet eller som takeaway", "Et selskap som frakter passasjerer og varer mellom ulike destinasjoner mot betaling", "En virksomhet som utelukkende tilbyr overnatting og romutleie til reisende gjester", "En bedrift som planlegger og arrangerer konferanser, møter og større arrangementer"],
  ...
  "salg-service-vg1-5-3": [
    {
      ...
      options: ["Alle transportmidler som frakter reisende til, fra og på destinasjonen", "Kun rutefly som frakter passasjerer mellom ulike land og verdensdeler", "Bare den lokale kollektivtransporten som brukes av innbyggere til daglig", "Utelukkende leiebil og drosje som turisten selv betaler for på stedet"],
    ...
    },
    {
      ...
      options: ["Flåmbanen, der selve togturen er en attraksjon", "En vanlig bussreise til jobben", "En kort drosjetur mellom to holdeplasser inne i bysentrum", "En liten pendlerferge som frakter folk over en elv på minutter"],
  ...
  "salg-service-vg1-5-4": [
    {
      ...
      options: ["Turisme som tar hensyn til økonomiske, sosiale og miljømessige konsekvenser, også for fremtidige generasjoner", "Turisme som drives helt uten regler, konsesjoner eller begrensninger fra myndighetene", "Turisme der målet er å holde prisen på reisen så lav som overhodet mulig for kunden", "Turisme der man legger vekt på å reise så langt og til så mange land som man rekker"],
    ...
    },
    {
      ...
      options: ["At for mange turister besøker samme sted, med slitasje og redusert opplevelseskvalitet som følge", "At det kommer altfor få turister til et sted, slik at tilbudene må legges ned", "At turistene oppholder seg for kort tid på hvert sted de besøker underveis", "At turistene ender opp med å betale langt mer enn det opplevelsen er verdt"],
  ...
  "salg-service-vg1-5-5": [
    ...
    },
    {
      ...
      options: ["Frankrike", "Brasil", "Norge", "Kina"],
  ...
  "salg-service-vg1-5-6": [
    {
      ...
      options: ["Et geografisk område turister reiser til og oppholder seg i, med alle elementene turisten opplever", "Utelukkende et enkelt hotell der den reisende bor under oppholdet sitt", "Bare selve flyplassen der turisten lander og starter reisen sin fra", "En fast transportrute som forbinder to byer med hverandre underveis"],
    ...
    },
    {
      ...
      options: ["Det som først og fremst får folk til å reise dit - destinasjonens ankerpunkt", "Skiltingen og turistinformasjonen som veileder de reisende på destinasjonen", "Servicekulturen og vertskapsrollen som de ansatte på stedet står for daglig", "Hotellene og overnattingsstedene som gjestene bor på under besøket sitt"],
  ...
  "salg-service-vg1-5-7": [
    {
      ...
      options: ["Alle aktiviteter for å gjøre potensielle gjester oppmerksomme på et reiselivsprodukt og få dem til å bestille", "Å frakte gjestene fra flyplassen og videre til overnattingsstedet på reisemålet", "Bare det å fastsette prisen på et hotellrom ut fra sesong og etterspørsel", "Kun det å rengjøre og klargjøre rommene før nye gjester ankommer stedet"],
    ...
    },
    {
      ...
      options: ["Alder, inntekt og familiesituasjon", "Bookingvaner og reiseerfaring", "Kundens verdier, holdninger og livsstil", "Hvilken kanal kunden bruker"],
    ...
    },
    {
      ...
      options: ["Bedriftens egen nettside", "Plakater i resepsjonen", "Avisannonser i papir", "Veggplakater"],
  ...
  "salg-service-vg1-6-1": [
    {
      ...
      options: ["Verdien av det virksomheten selger, beregnet som antall solgte enheter ganger pris", "Det beløpet som til slutt blir igjen etter at alt annet er trukket fra", "Verdien av alle ressursene virksomheten forbruker for å kunne drive", "Den samlede lønnen og godtgjørelsen som betales ut til de ansatte"],
    ...
    },
    {
      ...
      options: ["Det som blir igjen av salgsinntekten når variable kostnader er trukket fra", "Lønnen og godtgjørelsen som utbetales til ledelsen i bedriften", "De faste kostnadene virksomheten har alene, uten de variable", "Summen av alle inntektene virksomheten har hatt i perioden"],
  ...
  "salg-service-vg1-6-2": [
    {
      ...
      options: ["En tallfestet plan for en fremtidig periode med forventede inntekter og kostnader", "En systematisk registrering av det som allerede har skjedd i perioden", "En fullstendig liste over alle ansatte og deres arbeidsoppgaver", "En løpende oversikt over varelageret og beholdningen på lageret"],
    ...
    },
    {
      ...
      options: ["Den systematiske registreringen av alle økonomiske hendelser i en virksomhet", "En strategi for hvordan virksomheten skal markedsføre produktene sine", "Et anslag over hvor mye virksomheten regner med å selge fremover", "En tallfestet plan for hva som forventes å skje i fremtiden"],
    ...
    },
    {
      ...
      options: ["Budsjett viser planlagte/forventede tall, regnskap viser de faktiske tallene", "Budsjettet gjelder fortiden, mens regnskapet gjelder fremtidige perioder", "Bare store bedrifter lager budsjett, mens små bedrifter kun har regnskap", "De er nøyaktig det samme og brukes om hverandre i virksomheten"],
  ...
  "salg-service-vg1-6-3": [
    {
      ...
      options: ["Prosessen med å bestemme prisen på et produkt eller en tjeneste", "Prosessen med å telle opp og registrere hele varelageret", "Prosessen med å føre regnskap over økonomiske hendelser", "Prosessen med å ansette og lære opp nye medarbeidere"],
  ...
  "salg-service-vg1-6-4": [
    {
      ...
      options: ["Alle aktivitetene fra råvarer til ferdig produkt i hendene på kunden, der hvert ledd legger til verdi", "Lønna og de sosiale kostnadene til alle de ansatte som jobber i de ulike leddene av virksomheten", "Kun transporten av ferdige varer fra sentrallageret og ut til de enkelte butikkene og kundene", "Bare selve salget som skjer i butikken når kunden betaler for varen og tar den med seg hjem"],
    ...
    },
    {
      ...
      options: ["Å velge leverandører og produkter ut fra miljømessige og sosiale kriterier i tillegg til pris og kvalitet", "Å kjøpe inn så store kvanta som mulig på lager for å sikre gode rabatter og alltid ha varer på plass", "Å utelukkende kjøpe inn varer og råvarer fra utenlandske leverandører for å holde kostnadene nede", "Å alltid velge det aller billigste alternativet på markedet, uansett hvordan varen er produsert"],
  ...
  "salg-service-vg1-6-5": [
    ...
    },
    {
      ...
      options: ["Bøter, tap av bevillinger, stenging og i verste fall straffeansvar", "Bare en muntlig advarsel som aldri gjentas", "Automatisk skattefritak det påfølgende året, som en form for kompensasjon fra myndighetenes side", "Ingenting, så lenge man tjener penger"],
  ...
  "salg-service-vg1-6-6": [
    {
      ...
      options: ["Hvordan en virksomhet er bygget opp, med avdelinger, rapporteringslinjer og oppgavefordeling", "Bare hvor mye virksomheten tjener", "Prisene på produktene og tjenestene virksomheten tilbyr, sortert etter kategori og målgruppe", "Kun en fullstendig oversikt over navnene og kontaktinformasjonen til alle virksomhetens faste kunder"],
  ...
  "salg-service-vg1-6-7": [
    ...
    },
    {
      ...
      options: ["Sette standarder, måle ytelse, identifisere avvik og iverksette forbedringer", "Bare sette standarder uten å følge opp", "Kun måle ytelsen mot standardene, men aldri iverksette forbedringer selv om man finner avvik", "Selge produktene først og deretter planlegge hvordan kvaliteten skal sikres i etterkant av salget"],
  ...
  "salg-service-vg1-7-2": [
    ...
    },
    {
      ...
      options: ["Usaklig forskjellsbehandling basert på kjennetegn som kjønn, etnisitet eller funksjonsevne", "Å ansette etter kvalifikasjoner", "Å gi alle ansatte i samme stilling nøyaktig samme lønn, uavhengig av kjønn, alder og etnisitet", "Å behandle alle mennesker helt likt og rettferdig, uansett hvilken bakgrunn eller kjennetegn de har"],
  ...
  "salg-service-vg1-7-3": [
    ...
    },
    {
      ...
      options: ["Det bygger tillit og et godt omdømme over tid", "Det gir alltid lavere kvalitet", "Det er aldri lønnsomt fordi kunder ikke bryr seg om etikk", "Det er bare et krav for ledere"],
  ...
  "salg-service-vg1-7-4": [
    {
      ...
      options: ["Arbeidsgiversiden og arbeidstakersiden", "Konkurrenter i samme bransje", "Staten og kommunene som fastsetter skatt og avgifter", "Kunder og leverandører"],
    ...
    },
    {
      ...
      options: ["En skriftlig avtale mellom fagforening og arbeidsgiverside om lønns- og arbeidsvilkår", "En bindende kjøpskontrakt mellom en bedrift og dens faste kunde", "En tidsbegrenset leieavtale for bedriftens forretningslokaler", "En muntlig prisavtale mellom to konkurrenter i samme marked"],
    ...
    },
    {
      ...
      options: ["LO (Landsorganisasjonen)", "Skatteetaten", "NHO (Næringslivets Hovedorganisasjon) for eierne", "Virke"],
  ...
  "salg-service-vg1-7-5": [
    {
      ...
      options: ["Å sikre at arbeidsplassen er trygg og at ansatte ikke blir syke eller skadet av jobben", "Å øke salget og omsetningen mest mulig i løpet av året", "Å markedsføre bedriften utad så den fremstår ansvarlig", "Å redusere lønnskostnadene ved å kutte i bemanningen"],
  ...
  "salg-service-vg1-7-6": [
    ...
    },
    {
      ...
      options: ["En systematisk gjennomgang for å identifisere farer og vurdere risikoen de utgjør", "En markedsundersøkelse av hva konkurrentene tilbyr kundene", "En kundeundersøkelse om tilfredshet med butikkens service", "En samlet oversikt over bedriftens inntekter og utgifter"],
    ...
    },
    {
      ...
      options: ["Å redusere sannsynligheten for eller konsekvensen av uønskede hendelser", "Å øke risikoen bevisst for å teste beredskapen bedre", "Å spare arbeidstid ved bevisst å la være å gjøre noe", "Å skjule de farene man har avdekket for de ansatte"],
    ...
    },
    {
      ...
      options: ["Varemottak med tunge løft og trafikk av varebiler", "Å lese en fagbok i ro og mak i arbeidstiden", "Å ta en rolig lunsjpause i personalrommet på jobb", "Å skrive en enkel e-post til en kunde fra kontoret"],
  ...
  "salg-service-vg1-7-7": [
    {
      ...
      options: ["Planlegging og forberedelse for å kunne håndtere uønskede hendelser når de oppstår", "En løpende oversikt over hvilke varer som finnes på lageret", "En detaljert markedsføringsplan for kampanjer neste sesong", "Et fastsatt budsjett for bedriftens utgifter neste år"],
    ...
    },
    {
      ...
      options: ["At det er klart på forhånd hvem som varsler hvem og i hvilken rekkefølge", "At alle ansatte handler spontant slik de synes i øyeblikket", "At man venter til neste virkedag med å varsle om hendelsen", "At ingen sier noe før situasjonen har roet seg helt ned"],
  ...
  "salg-service-vg1-8-1": [
    ...
    },
    {
      ...
      options: ["En innovasjon må tas i bruk og skape verdi, ikke bare være en idé", "En innovasjon må alltid være en fysisk maskin man kan ta på", "En oppfinnelse skaper alltid verdi, mens en innovasjon aldri gjør det", "De to begrepene betyr nøyaktig det samme i næringslivet"],
    ...
    },
    {
      ...
      options: ["En som ser muligheter, tar initiativ og er villig til å ta risiko for å realisere ideer", "En som konsekvent unngår all form for risiko og usikkerhet", "En som kun fører bedriftens regnskap og betaler regningene", "En som utelukkende følger ordre uten å ta egne initiativ"],
    ...
    },
    {
      ...
      options: ["Too Good To Go, som reduserer matsvinn ved å selge overskuddsmat billig", "En vanlig postkasse der man legger brev og pakker til sending", "Et helt vanlig supermarked som selger dagligvarer som før", "En tradisjonell bensinstasjon med samme drift som alltid"],
  ...
  "salg-service-vg1-8-2": [
    {
      ...
      options: ["En idé som beskriver hva du skal tilby, hvem du tilbyr det til, og hvordan du tjener penger", "En detaljert oppskrift på hvordan man lager en bestemt matrett", "En systematisk oversikt over alle konkurrentene i markedet", "En tilfeldig innfallstanke uten noen konkret plan bak seg"],
  ...
  "salg-service-vg1-8-3": [
    ...
    },
    {
      ...
      options: ["Business Model Canvas", "Organisasjonskart", "Organisasjonskartet som viser roller, ansvar og rapporteringslinjer i bedriften", "Resultatbudsjett"],
    ...
    },
    {
      ...
      options: ["Hvordan den leverer maten til kundene og tjener penger på det", "Hvor langt det er til konkurrenten", "Hvilken farge lakken på leveringsbilene har og hvordan logoen er plassert på dem", "Hva de ansatte selv velger å spise til lunsj i pausene mellom leveringsoppdragene"],
  ...
  "salg-service-vg1-8-4": [
    ...
    },
    {
      ...
      options: ["Produkter designes for å vare, repareres, gjenbrukes og resirkuleres i et lukket kretsløp", "Ingenting gjenbrukes, men produsentene lover å plante nye trær for hvert solgte produkt", "Alt avfall samles inn og brennes i forbrenningsanlegg for å skaffe energi til strømnettet", "Produkter brukes bare én gang og kastes deretter for å holde forbruket og salget oppe"],
  ...
  "salg-service-vg1-8-5": [
    ...
    },
    {
      ...
      options: ["Muntlig, skriftlig, eller begge deler", "Bare som et langt notat", "Kun på papir, ettersom en muntlig framføring ikke regnes som en ordentlig pitch", "Kun gjennom regnskap"],
  ...
  "salg-service-vg1-8-6": [
    {
      ...
      options: ["En tidsavgrenset innsats for å skape et unikt produkt, en tjeneste eller et resultat", "En fast og uendret rutine uten et bestemt mål eller en definert start- og sluttdato", "Den vanlige daglige driften av en butikk med faste åpningstider og rutinemessig salg", "En løpende oppgave som aldri tar slutt og gjentar seg på nøyaktig samme måte hele tiden"],
    ...
    },
    {
      ...
      options: ["Tid, penger og mennesker", "Ingen ressurser", "Bare flaks og tilfeldigheter, ettersom prosjekter sjelden kan planlegges på forhånd", "Kun et navn"],
    ...
    },
    {
      ...
      options: ["Man får oversikt over oppgaver, ansvar og frister, og reduserer risikoen for at noe glemmes", "Man slipper å gjøre noe selv fordi planen automatisk utfører alle oppgavene for teamet", "Man unngår helt å sette mål, ettersom oppgavene løser seg selv når planen er skrevet", "Man trenger ikke skaffe kunder, siden en god plan i seg selv garanterer godt salg"],
    ...
    },
    {
      ...
      options: ["Fordi medlemmene er avhengige av hverandre for å nå et felles mål", "Fordi det gjør arbeidet langsommere", "Fordi alle prosjektmedlemmene jobber helt uavhengig av hverandre på hver sin del", "Fordi samarbeid sjelden trengs når hver enkelt bare fullfører sine egne oppgaver"],
  ...
  "salg-service-vg1-8-7": [
    {
      ...
      options: ["Å ta i bruk digital teknologi for å endre forretningsmodeller, prosesser og kundeopplevelser", "Å ansette flere ledere og mellomledere for å styre de eksisterende arbeidsprosessene", "Å fjerne all teknologi fra virksomheten og gå tilbake til tradisjonelle løsninger", "Å kun bruke papir og manuelle rutiner slik at ingen data lagres på datamaskiner"],
    ...
    },
    {
      ...
      options: ["Å finne helt nye måter å skape verdi på", "Å beholde alt akkurat som før", "Å fjerne kundene fra prosessene slik at bedriften kan drive mest mulig automatisk", "Å bruke mer papir"],
...
export default quizDataSalgServiceVg1;
