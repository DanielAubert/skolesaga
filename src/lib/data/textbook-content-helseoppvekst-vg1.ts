...
- A bruke fagkunnskap til a ta gode beslutninger`,
    ...
    {
      id: 'helseoppvekst-vg1-1-1-ex-inline-1',
      type: 'exercise',
      exercise: {
        id: 'helseoppvekst-vg1-1-1-ex-inline-1',
        number: '1',
        ...
        difficulty: 'lett',
        task: 'Hva inkluderer helse- og oppvekstsektoren?',
        options: [
          { id: 'a', text: 'Helsetjenester, omsorgstjenester og tjenester for barn og unge', isCorrect: true },
          { id: 'b', text: 'Bare sykehus og legekontor', isCorrect: false },
          { id: 'c', text: 'Kun barnehager og skoler', isCorrect: false },
          { id: 'd', text: 'Bare private virksomheter', isCorrect: false },
        ],
        solution: 'Helse- og oppvekstsektoren omfatter helsetjenester, omsorgstjenester og tjenester knyttet til barn og unges oppvekst, og inkluderer bade offentlige og private virksomheter.',
        competenceGoals: ['beskrive helse- og oppvekstsektoren og yrkesmuligheter i sektoren'],
      },
    },
    {
...
Mennesker har rett til a ta egne valg og bestemme over eget liv, sa langt det er mulig.`,
    ...
    {
      id: 'helseoppvekst-vg1-1-1-ex-inline-2',
      type: 'exercise',
      exercise: {
        id: 'helseoppvekst-vg1-1-1-ex-inline-2',
        number: '2',
        type: 'classic',
        difficulty: 'medium',
        task: 'Forklar med egne ord hva menneskeverd betyr, og gi et eksempel pa hvordan du kan vise respekt for menneskeverdet i arbeid med brukere.',
        hints: ['Tenk pa at alle mennesker har lik verdi', 'Hvordan ville du selv onsket a bli behandlet?'],
        solution: 'Menneskeverd betyr at alle mennesker har lik verdi uavhengig av alder, bakgrunn eller funksjonsniva. I praksis kan dette vises ved a mote alle med respekt, lytte til deres onsker, og ikke gjore forskjell pa brukere basert pa deres bakgrunn eller tilstand.',
        allowsUpload: true,
        allowsCanvasDrawing: false,
        competenceGoals: ['reflektere over verdier og holdninger i helse- og oppvekstarbeid'],
      },
    },
    {
...
**Laering:** Gode holdninger i praksis handler om a mote hvert menneske som et unikt individ med egne behov, onsker og rettigheter.`,
    ...
    {
      id: 'helseoppvekst-vg1-1-1-ex-inline-3',
      type: 'exercise',
      exercise: {
        id: 'helseoppvekst-vg1-1-1-ex-inline-3',
        number: '3',
        type: 'classic',
        difficulty: 'medium',
        task: 'Reflekter over eksempelet med Maria og Ahmed. Hva er forskjellen mellom a gjore antakelser om mennesker basert pa bakgrunn og a tilpasse omsorg til individuelle behov?',
        hints: ['Generaliseringer handler om grupper, individuell tilpasning handler om enkeltpersonen', 'Snakk med brukeren for a finne ut hva de selv onsker'],
        solution: 'A gjore antakelser basert pa bakgrunn er a anta at alle fra en gruppe har samme behov eller onsker. Individuell tilpasning betyr derimot a snakke direkte med brukeren for a forstå akkurat hva denne personen trenger og onsker. Dette respekterer brukerens autonomi og verdighet.',
        allowsUpload: true,
        allowsCanvasDrawing: false,
        competenceGoals: ['reflektere over verdier og holdninger i helse- og oppvekstarbeid'],
      },
    ...
    // --- Samleoppgaver ---
    {
      id: 'helseoppvekst-vg1-1-1-ex-inline-4',
      type: 'exercise',
      exercise: {
        id: 'helseoppvekst-vg1-1-1-ex-inline-4',
        number: '4',
        ...
        task: 'Drofte pastand: "Det viktigste i helse- og oppvekstarbeid er fagkunnskap, holdninger kommer i andre rekke." Er du enig eller uenig? Begrunn svaret ditt.',
        hints: ['Tenk pa hvordan holdninger pavirker maten vi moter mennesker pa', 'Kan man vaere en god yrkesutover med mye fagkunnskap men darlige holdninger?'],
        solution: 'Bade fagkunnskap og holdninger er avgjorende i helse- og oppvekstarbeid. Fagkunnskap gir grunnlag for a gi forsvarlig hjelp, men holdninger pavirker hvordan denne hjelpen gis. En yrkesutover med god fagkunnskap men manglende respekt for brukeren kan gjore stor skade. Gode holdninger som empati, respekt og verdighet er fundamentet for a bygge tillit og gi omsorg som oppleves meningsfull for brukeren.',
        allowsUpload: true,
        allowsCanvasDrawing: false,
        competenceGoals: ['reflektere over verdier og holdninger i helse- og oppvekstarbeid'],
      },
    ...
    {
      id: 'helseoppvekst-vg1-1-1-ex-inline-5',
      type: 'exercise',
      exercise: {
        id: 'helseoppvekst-vg1-1-1-ex-inline-5',
        number: '5',
        type: 'classic',
        difficulty: 'vanskelig',
        task: 'Lag en oversikt over tre ulike yrker i helse- og oppvekstsektoren. For hvert yrke, beskriv: a) Hvilken utdanning som kreves, b) Typiske arbeidsoppgaver, c) Hvilke verdier og holdninger som er viktige i yrket.',
        hints: ['Tenk pa yrker som helsefagarbeider, barne- og ungdomsarbeider, sykepleier', 'Bruk innholdet i kapittelet til a finne informasjon'],
        solution: 'Eksempel: 1) Helsefagarbeider - Fagbrev etter VG2 og laerertid. Arbeidsoppgaver: pleie og omsorg for syke og eldre. Verdier: respekt, omsorg, talmodighet. 2) Barne- og ungdomsarbeider - Fagbrev etter VG2 og laerertid. Arbeidsoppgaver: arbeid med barn i barnehage, SFO eller fritid. Verdier: trygghet, kreativitet, positivitet. 3) Sykepleier - Hogskoleutdanning. Arbeidsoppgaver: medisinsk behandling og pleie. Verdier: faglig dyktighet, ansvarlighet, empati.',
        allowsUpload: true,
        allowsCanvasDrawing: false,
        competenceGoals: ['beskrive helse- og oppvekstsektoren og yrkesmuligheter i sektoren'],
      },
...
I helse- og oppvekstfag jobber vi med et **helhetlig menneskesyn**. Det betyr at vi ser mennesket som en helhet der kropp, psyke og sosiale forhold henger sammen og pavirker hverandre.`,
    ...
    {
      id: 'helseoppvekst-vg1-1-2-ex-inline-1',
      type: 'exercise',
      exercise: {
        id: 'helseoppvekst-vg1-1-2-ex-inline-1',
        number: '1',
        type: 'multiple-choice',
        difficulty: 'lett',
        task: 'Ifølge WHO, hva inkluderer god helse?',
        options: [
          { id: 'a', text: 'Fysisk, psykisk og sosialt velvare', isCorrect: true },
          { id: 'b', text: 'Bare fravar av sykdom', isCorrect: false },
          { id: 'c', text: 'Kun fysisk helse', isCorrect: false },
          { id: 'd', text: 'A vaere i god fysisk form', isCorrect: false },
        ],
        solution: 'WHOs definisjon sier at helse er en tilstand av fullstendig fysisk, psykisk og sosialt velvare, ikke bare fravar av sykdom.',
        competenceGoals: ['gjore rede for faktorer som pavirker helse og livskvalitet'],
      },
    },
    {
...
- **Mediepåvirkning** - informasjon og idealer`,
    ...
    {
      id: 'helseoppvekst-vg1-1-2-ex-inline-2',
      type: 'exercise',
      exercise: {
        id: 'helseoppvekst-vg1-1-2-ex-inline-2',
        number: '2',
        type: 'classic',
        difficulty: 'medium',
        task: 'Gi tre eksempler pa helsedeterminanter fra ulike kategorier (individuelle, sosiale og miljofaktorer), og forklar hvordan hver av dem kan pavirke helse.',
        hints: ['Individuelle faktorer inkluderer livsstil', 'Sosiale faktorer inkluderer utdanning og okonomi', 'Miljofaktorer inkluderer boforhold'],
        solution: 'Eksempler: 1) Livsstil (individuell) - Kosthold og fysisk aktivitet pavirker risiko for livsstilssykdommer. 2) Utdanning (sosial) - Hoyere utdanning gir ofte bedre jobbmuligheter og okonomi, som igjen gir bedre muligheter for sunn livsstil. 3) Boforhold (miljo) - Fukt og mugg i bolig kan gi luftveisproblemer, mens gode boforhold fremmer helse.',
        allowsUpload: true,
        allowsCanvasDrawing: false,
        competenceGoals: ['gjore rede for faktorer som pavirker helse og livskvalitet'],
      },
...
- Eksempel: Rehabilitering etter slag, opplaering i a leve med kronisk sykdom`,
    ...
    {
      id: 'helseoppvekst-vg1-1-2-ex-inline-3',
      type: 'exercise',
      exercise: {
        id: 'helseoppvekst-vg1-1-2-ex-inline-3',
        number: '3',
        type: 'multiple-choice',
        difficulty: 'medium',
        task: 'Hvilken type forebygging er vaksinasjonsprogrammet for barn et eksempel pa?',
        options: [
          { id: 'a', text: 'Primaerforebygging', isCorrect: true },
          { id: 'b', text: 'Sekundaerforebygging', isCorrect: false },
          { id: 'c', text: 'Tertiaerforebygging', isCorrect: false },
          { id: 'd', text: 'Helsefremmende arbeid', isCorrect: false },
        ],
        solution: 'Vaksinasjonsprogrammet er primaerforebygging fordi det gis til friske barn for a hindre at sykdom oppstar i utgangspunktet.',
        competenceGoals: ['forklare hva helsefremmende arbeid innebarer'],
      },
    },
    {
...
Et godt folkehelsearbeid kombinerer bade forebyggende og helsefremmende tiltak.`,
    ...
    {
      id: 'helseoppvekst-vg1-1-2-ex-inline-4',
      type: 'exercise',
      exercise: {
        id: 'helseoppvekst-vg1-1-2-ex-inline-4',
        number: '4',
        type: 'classic',
        difficulty: 'medium',
        task: 'I eksempelet vurderer kommunen a starte en roykesluttkampanje og a bygge en tursti. Forklar forskjellen mellom disse to typene tiltak.',
        hints: ['Tenk pa hva fokuset er: risikofaktorer eller ressurser?', 'Hvem er malgruppen for hvert tiltak?'],
        solution: 'Roykesluttkampanjen er forebyggende tiltak som fokuserer pa a fjerne en risikofaktor (royking). Turstien er helsefremmende tiltak som fokuserer pa a styrke folks muligheter for fysisk aktivitet. Begge er viktige, men har ulik tilnaerming til helse.',
        allowsUpload: true,
        allowsCanvasDrawing: false,
        competenceGoals: ['forklare hva helsefremmende arbeid innebarer'],
      },
    ...
    // --- Samleoppgaver ---
    {
      id: 'helseoppvekst-vg1-1-2-ex-inline-5',
      type: 'exercise',
      exercise: {
        id: 'helseoppvekst-vg1-1-2-ex-inline-5',
        number: '5',
        type: 'classic',
        difficulty: 'vanskelig',
        task: 'Sosial ulikhet i helse er et stort problem i Norge. Drofte: Hvem har ansvar for a utjevne disse forskjellene - enkeltindividet eller samfunnet? Begrunn svaret ditt.',
        hints: ['Tenk pa hva enkeltpersoner kan gjore selv', 'Tenk pa hva samfunnet kan pavirke gjennom politikk og tiltak', 'Kan man forvente det samme av alle uansett bakgrunn?'],
        solution: 'Bade individet og samfunnet har ansvar. Individet kan ta sunne valg nar det gjelder livsstil. Men samfunnet ma legge til rette for at alle har like muligheter til a ta sunne valg, gjennom utjevning av okonomiske forskjeller, tilgang til helsetjenester, utdanning og gode naermiljoer. Strukturelle endringer er nodvendige fordi ikke alle har samme utgangspunkt.',
        allowsUpload: true,
        allowsCanvasDrawing: false,
        competenceGoals: ['gjore rede for faktorer som pavirker helse og livskvalitet'],
      },
    ...
    {
      id: 'helseoppvekst-vg1-1-2-ex-inline-6',
      type: 'exercise',
      exercise: {
        id: 'helseoppvekst-vg1-1-2-ex-inline-6',
        number: '6',
        type: 'classic',
        difficulty: 'vanskelig',
        task: 'Tenk deg at du jobber i en barnehage. Beskriv tre konkrete helsefremmende tiltak du kan gjennomfore for a fremme barnas helse.',
        hints: ['Tenk pa fysisk aktivitet', 'Tenk pa kosthold og maltider', 'Tenk pa psykisk helse og trivsel'],
        solution: 'Eksempler: 1) Daglig utetid med varierte aktiviteter som fremmer motorisk utvikling og fysisk aktivitet. 2) Maltider med fokus pa naeringrik mat, der barna far smake nye matvarer og laere om sunn mat. 3) Arbeid med sosial kompetanse og forebygging av mobbing for a fremme barnas psykiske helse og trivsel. 4) Samarbeid med foreldre om sunne vaner.',
        allowsUpload: true,
        allowsCanvasDrawing: false,
        competenceGoals: ['forklare hva helsefremmende arbeid innebarer'],
      },
...
**Brukermedvirkning** - At brukeren deltar i beslutninger om egen situasjon`,
    ...
    },
    {
      ...
      exercise: {
        ...
        type: 'multiple-choice',
        difficulty: 'lett',
        task: 'Hva betyr kommunikasjon egentlig?',
        options: [
          { id: 'a', text: 'A gjore noe felles - utveksle informasjon, tanker og folelser', isCorrect: true },
          { id: 'b', text: 'A snakke hoyt og tydelig', isCorrect: false },
          { id: 'c', text: 'A skrive brev og meldinger', isCorrect: false },
          { id: 'd', text: 'A gi ordre til andre', isCorrect: false },
        ],
        solution: 'Kommunikasjon kommer fra det latinske "communicare" som betyr a gjore felles. Det handler om utveksling av informasjon, tanker og folelser mellom mennesker.',
...
- Fordommer og antakelser`,
    ...
    },
    {
      ...
      exercise: {
        ...
        type: 'classic',
        difficulty: 'medium',
        task: 'Nevn fire konkrete ting du kan gjore for a vise aktiv lytting i en samtale.',
        hints: ['Tenk pa kroppssprak', 'Tenk pa hva du sier og hvordan du responderer', 'Tenk pa hva du IKKE gjor'],
        solution: 'Fire ting for aktiv lytting: 1) Hold oyekontakt og nikk bekreftende. 2) Ikke avbryt - la personen snakke ferdig. 3) Still oppfolgende sporsmål for a vise interesse. 4) Bruk speiling - gjenta det viktigste med egne ord for a vise at du har forstatt.',
        allowsUpload: true,
        allowsCanvasDrawing: false,
...
**Viktig:** Forskning viser at over 70% av kommunikasjonen er nonverbal. Det betyr at kroppspraket ditt ofte sier mer enn ordene!`,
    ...
    },
    {
      ...
      exercise: {
        ...
        options: [
          { id: 'a', text: 'Empati er a forstå andres folelser, sympati er a synes synd pa dem', isCorrect: true },
          { id: 'b', text: 'Det er ingen forskjell', isCorrect: false },
          { id: 'c', text: 'Empati er sterkere enn sympati', isCorrect: false },
          { id: 'd', text: 'Sympati er mer profesjonelt enn empati', isCorrect: false },
        ],
        solution: 'Empati handler om a sette seg inn i andres situasjon og folelser for a forstå dem bedre. Sympati handler mer om a synes synd pa noen. I profesjonelt arbeid er empati viktigere fordi det gir forstaelse uten a overta folelsene.',
        competenceGoals: ['bruke aktiv lytting og empatisk kommunikasjon'],
      },
    },
    {
...
I profesjonelt arbeid bor du bruke en blanding, men apne sporsmål gir ofte mer informasjon og storre medvirkning.`,
    ...
    },
    {
      ...
      exercise: {
        ...
        type: 'classic',
        difficulty: 'lett',
        task: 'Forklar med egne ord hva samhandling betyr i helse- og oppvekstarbeid.',
        hints: ['Tenk pa samarbeid mellom ulike faggrupper', 'Hvem er i sentrum for samhandlingen?'],
        solution: 'Samhandling i helse- og oppvekstarbeid betyr at ulike fagpersoner og tjenester samarbeider for a gi brukeren best mulig hjelp. For eksempel kan en helsefagarbeider, sykepleier og fysioterapeut samarbeide om pleien til en pasient.',
        allowsUpload: true,
        allowsCanvasDrawing: false,
        competenceGoals: ['kommunisere med ulike brukergrupper'],
      },
...
- Apning for sporsmål og dialog`,
    },
    {
      ...
      exercise: {
        ...
        type: 'classic',
        difficulty: 'medium',
        task: 'Se pa eksempelet om kommunikasjon med barn. Du skal fortelle et barn pa 3 ar at pappa ikke kommer pa sommeravslutningen. Skriv ned hva du ville sagt til barnet.',
        hints: ['Ga ned pa barnets niva', 'Bruk enkelt sprak', 'Anerkjenn folelser'],
        solution: 'Eksempel: Setter meg pa huk og ser barnet i oynene. "Pappa har ringt og sagt at han ikke kan komme pa festen i dag fordi han ma jobbe. Jeg skjonner at du kanskje blir lei deg. Men mamma kommer, og jeg skal vaere her sammen med deg hele tiden. Vi skal ha det veldig fint!"',
        allowsUpload: true,
        allowsCanvasDrawing: false,
        competenceGoals: ['kommunisere med ulike brukergrupper'],
      },
    ...
    // --- Samleoppgaver ---
    {
      ...
      exercise: {
        ...
        type: 'classic',
        difficulty: 'vanskelig',
        task: 'Forklar hvorfor nonverbal kommunikasjon ofte sier mer enn ordene. Gi to eksempler pa situasjoner der kroppssprak kan motsi det som sies.',
        hints: ['Tenk pa situasjoner der noen sier at de har det bra', 'Kan man smile mens man er lei seg?'],
        solution: 'Forskning viser at over 70% av kommunikasjonen er nonverbal. Kroppssprak er ofte mer ekte enn ord fordi det er vanskeligere a kontrollere. Eksempler: 1) En pasient sier "alt er bra" men unngår oyekontakt og har sammensunket holdning - kroppsspråket viser at noe er galt. 2) En kollega sier "det gjor ingenting" nar du ber om hjelp, men sukker tungt og ruller med oynene.',
        allowsUpload: true,
        allowsCanvasDrawing: false,
        competenceGoals: ['kommunisere med ulike brukergrupper'],
      },
    },
    {
      ...
      exercise: {
        ...
        type: 'classic',
        difficulty: 'vanskelig',
        task: 'Du jobber pa sykehjem og skal gi rapport til kollega som overtar vakten. Bruk ISBAR-metoden til a lage en rapport om folgende: Fru Olsen pa rom 5 har hatt vondt i magen hele dagen og spist lite.',
        hints: ['I = Identifisering', 'S = Situasjon', 'B = Bakgrunn', 'A = Aktuell vurdering', 'R = Rad'],
        solution: 'I: Fru Olsen pa rom 5. S: Hun har hatt magesmerter hele dagen og har spist lite til maltidene. B: Hun har ikke hatt lignende plager for, ingen kjent mageproblematikk. A: Hun virker sliten men er ved bevissthet. Jeg har dokumentert matinntak. R: Viktig a observere smertene videre og kontakte sykepleier hvis de forverres eller hun far feber.',
        allowsUpload: true,
        allowsCanvasDrawing: false,
        competenceGoals: ['kommunisere med ulike brukergrupper'],
      },
...
**Selvrealisering** - A utvikle og bruke sitt fulle potensial`,
    ...
    },
    {
      ...
      exercise: {
        ...
        options: [
          { id: 'a', text: 'Cellen', isCorrect: true },
          { id: 'b', text: 'Vevet', isCorrect: false },
          { id: 'c', text: 'Organet', isCorrect: false },
          { id: 'd', text: 'Molekylet', isCorrect: false },
        ],
        solution: 'Cellen er kroppens minste levende enhet. Mennesket har omtrent 37 billioner celler.',
...
Hele kroppen som fungerer som en helhet. Alle organsystemene samarbeider for a holde oss i live.`,
    ...
    },
    {
      ...
      exercise: {
        ...
        type: 'classic',
        difficulty: 'medium',
        task: 'Forklar hva homeostase er, og gi to eksempler pa hva kroppen regulerer for a opprettholde homeostase.',
        hints: ['Tenk pa kroppstemperatur', 'Tenk pa blodsukker'],
        solution: 'Homeostase er kroppens evne til a opprettholde et stabilt indre miljo. Eksempler: 1) Kroppstemperatur - kroppen holder seg pa ca. 37 grader ved a svette nar det er varmt og skjelve nar det er kaldt. 2) Blodsukker - kroppen bruker insulin for a holde blodsukkeret stabilt etter maltider.',
        allowsUpload: true,
        allowsCanvasDrawing: false,
        competenceGoals: ['beskrive kroppens oppbygning og funksjon'],
      },
...
- **Urinroret** - forer urin ut av kroppen`,
    ...
    },
    {
      ...
      exercise: {
        ...
        type: 'multiple-choice',
        difficulty: 'lett',
        task: 'Hvilke behov er fysiologiske behov i Maslows pyramide?',
        options: [
          { id: 'a', text: 'Mat, drikke, luft, sovn og varme', isCorrect: true },
          { id: 'b', text: 'Kjaerlighet og tilhorighet', isCorrect: false },
          { id: 'c', text: 'Selvrealisering og vekst', isCorrect: false },
          { id: 'd', text: 'Trygghet og sikkerhet', isCorrect: false },
        ],
        solution: 'Fysiologiske behov er de mest grunnleggende behovene for overlevelse: mat, drikke, luft, sovn, varme og utskillelse.',
...
**Laering:** God omsorg handler om a se hele mennesket og dekke behov pa alle nivaer - ikke bare de fysiologiske.`,
    },
    {
      ...
      exercise: {
        ...
        type: 'classic',
        difficulty: 'medium',
        task: 'Tenk deg at du jobber pa sykehjem. Gi ett konkret eksempel pa hvordan du kan dekke en beboers behov pa hvert av de fem nivaene i Maslows pyramide.',
        hints: ['Tenk pa det vi laerte om Fru Berg i eksempelet', 'Start fra bunnen av pyramiden og jobb deg oppover'],
        solution: '1) Fysiologiske: Sikre at beboeren far nok mat og drikke. 2) Trygghet: Forklare hvem du er og hva du skal gjore. 3) Sosiale: Ta tid til en samtale og invitere til fellesaktiviteter. 4) Anerkjennelse: Lytte til beboerens meninger og behandle med respekt. 5) Selvrealisering: Stotte beboerens hobbyer eller interesser.',
        allowsUpload: true,
        allowsCanvasDrawing: false,
        competenceGoals: ['gjore rede for menneskers grunnleggende behov'],
      },
...
- Stotte barnets nysgjerrighet og utforsking`,
    ...
    // --- Samleoppgaver ---
    {
      ...
      exercise: {
        ...
        type: 'classic',
        difficulty: 'vanskelig',
        task: 'Reflekter over kritikken av Maslows behovspyramide: Er det alltid slik at lavere behov ma vaere dekket for at vi kan fokusere pa hoyere behov? Gi eksempler fra virkeligheten der dette kanskje ikke stemmer.',
        hints: ['Tenk pa kunstnere som sulter for kunsten sin', 'Tenk pa mennesker i krisesituasjoner som prioriterer andres behov'],
        solution: 'Kritikk: Behovspyramiden er for rigid. Eksempler: 1) Kunstnere kan prioritere kreativt arbeid (selvrealisering) selv om de har darlig okonomi (trygghet). 2) Foreldre kan prioritere barnas behov for kjerlighet og tilhorighet selv nar de selv er slitne. 3) I kriser kan mennesker vise stor omsorg for andre for egne behov. Konklusjon: Behov er mer fleksible og individuelle enn pyramiden antyder.',
        allowsUpload: true,
        allowsCanvasDrawing: false,
        competenceGoals: ['gjore rede for menneskers grunnleggende behov'],
      },
    },
    {
      ...
      exercise: {
        ...
        type: 'classic',
        difficulty: 'vanskelig',
        task: 'Lag en oversikt over tre viktige organsystemer i kroppen. For hvert system, beskriv: hovedfunksjon, viktige organer, og hvordan det samarbeider med andre systemer.',
        hints: ['Velg for eksempel sirkulasjonssystemet, respirasjonssystemet og nervesystemet', 'Tenk pa hvordan systemene avhenger av hverandre'],
        solution: 'Eksempel: 1) Sirkulasjonssystemet - pumper blod med oksygen og naering. Organer: hjerte, blodkar. Samarbeid: Far oksygen fra lungene, naering fra tarmen. 2) Respirasjonssystemet - tar opp oksygen og kvitter seg med CO2. Organer: lunger, luftveier. Samarbeid: Gir oksygen til blodet. 3) Nervesystemet - styrer og koordinerer. Organer: hjerne, ryggmarg, nerver. Samarbeid: Sender signaler som styrer hjerte- og pustefrekvens.',
        allowsUpload: true,
...
**Isolat** - Enerom for smittefarlig pasient`,
    ...
    },
    {
      ...
      exercise: {
        ...
        task: 'Hva er hygiene?',
        options: [
          { id: 'a', text: 'Tiltak for a forebygge sykdom og fremme helse', isCorrect: true },
          { id: 'b', text: 'Bare handvask', isCorrect: false },
          { id: 'c', text: 'A dusje hver dag', isCorrect: false },
          { id: 'd', text: 'A bruke hansker', isCorrect: false },
        ],
        solution: 'Hygiene er laeren om og tiltak for a forebygge sykdom og fremme helse. Det omfatter mer enn bare personlig hygiene.',
...
Vi har milliarder av mikroorganismer pa huden og i kroppen som er nyttige og beskytter oss. Disse kalles normalflora.`,
    ...
    },
    {
      ...
      exercise: {
        ...
        type: 'classic',
        difficulty: 'medium',
        task: 'Nevn alle seks leddene i smittekjeden i riktig rekkefolge.',
        hints: ['Start med smittestoffet', 'Tenk pa reisen fra smittekilde til mottaker'],
        solution: 'De seks leddene i smittekjeden er: 1) Smittestoff (agens), 2) Smittekilde (reservoar), 3) Utgangsport, 4) Smittevei, 5) Inngangsport, 6) Mottakelig vert.',
        allowsUpload: true,
        allowsCanvasDrawing: true,
...
- Smor hendene med fuktighetskrem etter arbeidsdag`,
    },
    {
      ...
      exercise: {
        ...
        type: 'multiple-choice',
        difficulty: 'lett',
        task: 'Hvor lenge bor du bruke pa a vaske hendene med sape og vann?',
        options: [
          { id: 'a', text: '40-60 sekunder', isCorrect: true },
          { id: 'b', text: '5-10 sekunder', isCorrect: false },
          { id: 'c', text: '2-3 minutter', isCorrect: false },
          { id: 'd', text: 'Det spiller ingen rolle', isCorrect: false },
        ],
        solution: 'Handvask med sape og vann bor ta 40-60 sekunder for a vaere effektiv.',
        competenceGoals: ['utfore handhygiene korrekt'],
      },
    },
    {
      id: 'hov1-2-2-ex-inline-4',
      type: 'exercise',
      exercise: {
        id: 'hov1-2-2-ex-inline-4',
        number: '4',
        type: 'classic',
        difficulty: 'medium',
        task: 'Nar bor du bruke handvask med sape og vann, og nar kan du bruke handdesinfeksjon? Gi eksempler pa begge.',
        hints: ['Tenk pa om hendene er synlig skitne', 'Tenk pa ulike situasjoner i arbeidsdagen'],
        solution: 'Handvask med sape: Nar hendene er synlig skitne, etter toalettbesok, for matlaging. Handdesinfeksjon: Nar hendene ikke er synlig skitne, for eksempel mellom pasientkontakter, etter beroring av overflater.',
        allowsUpload: true,
        allowsCanvasDrawing: false,
        competenceGoals: ['utfore handhygiene korrekt'],
      },
...
De vanligste i helse- og oppvekstarbeid er kontaktsmitte og dråpesmitte. Derfor er handhygiene og hosting/nysing i armkrok sa viktig!`,
    },
    {
      ...
      exercise: {
        ...
        type: 'classic',
        difficulty: 'medium',
        task: 'Se pa eksempelet med omgangssyke. Velg et annet smittekjede-ledd og forklar hvordan du kan bryte dette leddet for a hindre smitte.',
        hints: ['Du kan for eksempel fokusere pa smitteveien eller inngangsport', 'Tenk pa konkrete tiltak'],
        solution: 'Eksempel pa a bryte inngangsport: Unnga a ta deg i ansiktet (oyne, nese, munn) da dette er vanlige innganger for smittestoff. Bruk munnbind ved kontakt med smittefarlige pasienter. Hold sår rene og dekket til.',
        allowsUpload: true,
        allowsCanvasDrawing: false,
        competenceGoals: ['forklare smittemater og smittekjeden'],
      },
    ...
    // --- Samleoppgaver ---
    {
      ...
      exercise: {
        ...
        type: 'classic',
        difficulty: 'vanskelig',
        task: 'Du skal holde en kort opplaring for nye vikarer om handhygiene. Lag en punktliste med de viktigste tingene de ma vite.',
        hints: ['Inkluder nar man skal vaske hender', 'Inkluder riktig teknikk', 'Inkluder forskjellen mellom handvask og desinfeksjon'],
        solution: 'Viktige punkter: 1) Handhygiene er det viktigste smitteverntiltaket. 2) Vask hender med sape (40-60 sek) nar synlig skitne, etter toalett, for mat. 3) Bruk desinfeksjon (20-30 sek) nar ikke synlig skitne. 4) Fjern ringer og klokker. 5) Hold negler korte og rene. 6) Gni alle deler av handa - ogsa mellom fingre og rundt tomler. 7) Bruk engangshåndkle til a lukke kranen.',
        allowsUpload: true,
        allowsCanvasDrawing: false,
        competenceGoals: ['utfore handhygiene korrekt', 'gjore rede for betydningen av god hygiene'],
      },
    },
    {
      id: 'hov1-2-2-ex-inline-7',
      type: 'exercise',
      exercise: {
        id: 'hov1-2-2-ex-inline-7',
        number: '7',
        type: 'classic',
        difficulty: 'vanskelig',
        task: 'Forklar forskjellen mellom bakterier og virus, og hvorfor dette har betydning for behandling av infeksjoner.',
        hints: ['Tenk pa storrelse og hvordan de formerer seg', 'Tenk pa antibiotika'],
        solution: 'Bakterier er encellede organismer som kan formere seg selv og kan behandles med antibiotika. Virus er mindre og trenger en vertscelle for a formere seg - de kan IKKE behandles med antibiotika. Dette er viktig fordi feil bruk av antibiotika (for eksempel mot forkjolelse som skyldes virus) bidrar til antibiotikaresistens.',
        allowsUpload: true,
        allowsCanvasDrawing: false,
        competenceGoals: ['forklare smittemater og smittekjeden'],
      },
...
**Barnets beste** - Prinsippet om at barns interesser skal prioriteres`,
    ...
    },
    {
      ...
      exercise: {
        ...
        type: 'multiple-choice',
        difficulty: 'lett',
        task: 'Hva er taushetsplikt?',
        options: [
          { id: 'a', text: 'Plikten til a hindre at uvedkommende far personopplysninger', isCorrect: true },
          { id: 'b', text: 'A ikke snakke pa jobb', isCorrect: false },
          { id: 'c', text: 'A ikke fortelle noen om jobben din', isCorrect: false },
          { id: 'd', text: 'A holde alle papirer innelast', isCorrect: false },
        ],
        solution: 'Taushetsplikt er plikten til a hindre at uvedkommende far tilgang til opplysninger om folks personlige forhold.',
...
- Forebyggende arbeid`,
    ...
    },
    {
      ...
      exercise: {
        ...
        type: 'classic',
        difficulty: 'medium',
        task: 'Hva er forskjellen mellom vanlig samtykke og informert samtykke?',
        hints: ['Tenk pa hva pasienten ma vite for samtykket', 'Kan man samtykke til noe man ikke forstar?'],
        solution: 'Informert samtykke betyr at personen har fatt nodvendig informasjon om hva de samtykker til for de gir samtykket. Dette inkluderer informasjon om behandling, alternativer, fordeler og risiko. Et samtykke som gis uten tilstrekkelig informasjon er ikke gyldig.',
        allowsUpload: true,
        allowsCanvasDrawing: false,
        competenceGoals: ['forklare brukerrettigheter og taushetsplikt'],
      },
...
**Husk:** Taushetsplikten gjelder ogsa ETTER at du slutter i jobb eller praksis - den varer livet ut!`,
    ...
    },
    {
      ...
      exercise: {
        ...
        type: 'multiple-choice',
        difficulty: 'medium',
        task: 'Hvilke unntak finnes fra taushetsplikten?',
        options: [
          { id: 'a', text: 'Med samtykke fra brukeren, med kolleger som trenger informasjonen, ved fare for liv', isCorrect: true },
          { id: 'b', text: 'Nar familie sporr', isCorrect: false },
          { id: 'c', text: 'Nar naboen er bekymret', isCorrect: false },
          { id: 'd', text: 'Det finnes ingen unntak', isCorrect: false },
        ],
        solution: 'Unntak fra taushetsplikten inkluderer: med samtykke fra brukeren, med kolleger som trenger informasjonen for a gi forsvarlig hjelp, ved fare for liv og helse, og ved meldeplikt til barnevernet.',
        competenceGoals: ['forklare brukerrettigheter og taushetsplikt'],
      },
    },
    {
...
**Laering:** Barnets beste (artikkel 3) skal alltid vaere et grunnleggende hensyn. Folg gjeldende avtaler og dokumentasjon, og sorg for at barnet skjermes fra voksenkonflikter.`,
    },
    {
      ...
      exercise: {
        ...
        type: 'classic',
        difficulty: 'medium',
        task: 'Basert pa eksempelet om fru Hansen: Skriv ned noyaktig hva du ville sagt til naboen som sporr om henne.',
        hints: ['Vaer hoflig men bestemt', 'Forklar at du har taushetsplikt', 'Ikke bekreft at du besoker fru Hansen'],
        solution: 'Eksempel pa svar: "Takk for at du sporr, men jeg kan ikke snakke om hvem jeg besoker eller hvordan de har det. Det er taushetsbelagt. Hvis du er bekymret for en nabo, kan du kontakte hjemmetjenesten direkte."',
        allowsUpload: true,
        allowsCanvasDrawing: false,
        competenceGoals: ['forklare brukerrettigheter og taushetsplikt'],
      },
    ...
    // --- Samleoppgaver ---
    {
      ...
      exercise: {
        ...
        type: 'classic',
        difficulty: 'vanskelig',
        task: 'Drofte: Hva ville du gjort hvis du oppdager at en kollega bryter taushetsplikten ved a sladre om en bruker i lunsjen?',
        hints: ['Tenk pa konsekvensene for brukeren', 'Tenk pa ditt ansvar som kollega', 'Hvem bor informeres?'],
        solution: 'Forst ville jeg tatt opp med kollegaen i enerom at det hun/han gjor er brudd pa taushetsplikten. Jeg ville forklart hvorfor dette er alvorlig og at det kan fa konsekvenser. Hvis kollegaen fortsetter, ville jeg informert narmeste leder. Som ansatt har jeg ogsa et ansvar for a bidra til at regler folges og at brukernes rettigheter ivaretas.',
        allowsUpload: true,
        allowsCanvasDrawing: false,
        competenceGoals: ['forklare brukerrettigheter og taushetsplikt'],
      },
    },
    {
      ...
      exercise: {
        ...
        type: 'classic',
        difficulty: 'vanskelig',
        task: 'Velg tre artikler fra FNs barnekonvensjon og forklar med konkrete eksempler hvordan du kan sikre at disse rettighetene ivaretas i arbeid med barn.',
        hints: ['Velg for eksempel artikkel 3 (barnets beste), artikkel 12 (barnets mening) og artikkel 31 (lek og fritid)', 'Gi praktiske eksempler fra barnehage eller skole'],
        solution: 'Eksempel: 1) Artikkel 3 (barnets beste) - Ved foreldrekonflikter holder jeg fokus pa hva som er best for barnet, ikke foreldrenes onsker. 2) Artikkel 12 (barnets mening) - Jeg sporr barnet hva det tenker og foler nar vi planlegger aktiviteter. 3) Artikkel 31 (lek og fritid) - Jeg sorger for at barn har tid til fri lek hver dag, ikke bare strukturerte aktiviteter.',
        allowsUpload: true,
        allowsCanvasDrawing: false,
  ...
  content: [
    ...
    },
    {
      ...
      exercise: {
        ...
        type: 'multiple-choice',
        difficulty: 'lett',
        task: 'Hva er tilknytning i barns utvikling?',
        options: [
          { id: 'a', text: 'Det sterke folelsesmessige baandet mellom barn og omsorgsperson', isCorrect: true },
          { id: 'b', text: 'Barnets fysiske vekst', isCorrect: false },
          { id: 'c', text: 'Barnets spraakutvikling', isCorrect: false },
          { id: 'd', text: 'Evnen til a leke med andre barn', isCorrect: false },
        ],
        solution: 'Tilknytning er det sterke folelsesmessige baandet som dannes mellom barnet og dets naermeste omsorgspersoner. Trygg tilknytning er grunnlaget for sunn utvikling.',
        competenceGoals: ['forklare betydningen av trygg tilknytning og stimulering for barns utvikling'],
      },
    },
    {
    ...
    },
    {
      ...
      exercise: {
        ...
        type: 'classic',
        difficulty: 'medium',
        task: 'Lag en kort oversikt over spraakutviklingen fra 0-3 ar. Beskriv hva som kjennetegner hver fase.',
        hints: ['Start med babling og kurring', 'Tenk pa ettords- og toordsfasen', 'Avslutt med spraakeksplosjonen'],
        solution: '0-6 mnd: Graating og kurring, babling. 6-12 mnd: Forstar enkle ord, sier forste ord. 12-18 mnd: Ettordsfasen - bruker ett ord for aa uttrykke mye. 18-24 mnd: Toordsfasen - setter sammen to ord. 2-3 ar: Spraakeksplosjon - ordforradet oker dramatisk, enkle setninger.',
        allowsUpload: true,
        allowsCanvasDrawing: false,
        competenceGoals: ['gjore rede for barns utvikling fra fodsel til skolealder og faktorer som pavirker utviklingen'],
      },
    },
    {
      id: 'hov1-4-1-ex-inline-3',
      type: 'exercise',
      exercise: {
        id: 'hov1-4-1-ex-inline-3',
        number: '3',
        ...
        options: [
          { id: 'a', text: 'Rundt 12-15 maaneders alder', isCorrect: true },
          { id: 'b', text: 'Rundt 6 maaneders alder', isCorrect: false },
          { id: 'c', text: 'Rundt 24 maaneders alder', isCorrect: false },
          { id: 'd', text: 'Rundt 8 maaneders alder', isCorrect: false },
        ],
        solution: 'De fleste barn tar sine forste skritt rundt 12-15 maaneders alder, men det er store individuelle variasjoner innenfor normalomraadet.',
        competenceGoals: ['gjore rede for barns utvikling fra fodsel til skolealder og faktorer som pavirker utviklingen'],
      },
    },
    {
    ...
    },
    {
      ...
      exercise: {
        ...
        type: 'classic',
        difficulty: 'medium',
        task: 'Gi tre konkrete eksempler pa hvordan du kan stimulere et 2-arings spraakutvikling gjennom hverdagsaktiviteter.',
        hints: ['Tenk pa samtaler om det dere gjor', 'Tenk pa lesing', 'Tenk pa sang og rim'],
        solution: 'Eksempler: 1) Sett ord pa det du gjor: "Na tar vi pa skoa. Forst den ene skoen, sa den andre." 2) Les bildeboker sammen og pek pa bildene mens du navngir dem. 3) Syng sanger og rim som gjentar ord, for eksempel "Bae bae lille lam".',
        allowsUpload: true,
        allowsCanvasDrawing: false,
        competenceGoals: ['forklare betydningen av trygg tilknytning og stimulering for barns utvikling'],
      },
    ...
    // --- Samleoppgaver ---
    {
      ...
      exercise: {
        ...
        type: 'classic',
        difficulty: 'vanskelig',
        task: 'Forklar hva det vil si at barns utvikling folger et "cefalokaudalt" og "proksimodistalt" monster. Hvordan kan du se dette i praksis?',
        hints: ['Cefalokaudalt = fra hodet nedover', 'Proksimodistalt = fra midten og utover', 'Tenk pa hvilke ferdigheter som kommer forst'],
        solution: 'Cefalokaudalt betyr at utviklingen gar fra hodet og nedover - barnet far forst kontroll over hodet, deretter overkroppen, og til slutt bena. Proksimodistalt betyr fra midten og utover - barnet far kontroll over skuldre for armer, og armer for hender. I praksis: Barnet kan loft hodet (3 mnd) for det kan sitte (6 mnd), og sitte for det kan sta (9-12 mnd). Det kan gripe med hele handa for det kan bruke fingrene presist.',
        allowsUpload: true,
        allowsCanvasDrawing: true,
        competenceGoals: ['gjore rede for barns utvikling fra fodsel til skolealder og faktorer som pavirker utviklingen'],
      },
    },
    {
      ...
      exercise: {
        ...
        type: 'classic',
        difficulty: 'vanskelig',
        task: 'Drofte: Hvorfor er det viktig a ikke sammenligne barns utvikling for mye med andre barn? Hva kan konsekvensene vaere hvis foreldre er for bekymret for at barnet skal "henge etter"?',
        hints: ['Tenk pa normalvariasjoner', 'Tenk pa barnets selvbilde', 'Tenk pa foreldrenes stressniva'],
        solution: 'Det er store normalvariasjoner i barns utvikling, og barn nar milepaler til ulik tid. For mye sammenligning kan fore til: 1) Unodvendig stress hos foreldre som overfores til barnet, 2) At barnet foler seg utilstrekkelig, 3) At man overser barnets sterke sider fordi man fokuserer pa det de ikke mestrer, 4) At man presser barnet til noe det ikke er modent for. Det viktigste er a se helheten i barnets utvikling.',
        allowsUpload: true,
        allowsCanvasDrawing: false,
        competenceGoals: ['forklare betydningen av trygg tilknytning og stimulering for barns utvikling'],
      },
...
**Forutsigbarhet** - At barn vet hva som skal skje og kan stole paa de voksne rundt seg.`,
    ...
    },
    {
      ...
      exercise: {
        ...
        type: 'multiple-choice',
        difficulty: 'lett',
        task: 'Hva er omsorgssvikt?',
        options: [
          { id: 'a', text: 'Nar barn ikke far dekket sine grunnleggende behov for omsorg og beskyttelse', isCorrect: true },
          { id: 'b', text: 'Nar foreldre gir barna for mange leker', isCorrect: false },
          { id: 'c', text: 'Nar barn ma dele rom med sosken', isCorrect: false },
          { id: 'd', text: 'Nar barn ma hjelpe til hjemme', isCorrect: false },
        ],
        solution: 'Omsorgssvikt er nar barn ikke far dekket sine grunnleggende behov for omsorg og beskyttelse, inkludert fysisk og emosjonell omsorg.',
        competenceGoals: ['beskrive tegn pa omsorgssvikt og vold mot barn, og kjenne til meldeplikt og handlingsplikt'],
      },
    },
    {
      id: 'hov1-5-1-3',
    ...
    },
    {
      ...
      exercise: {
        ...
        type: 'classic',
        difficulty: 'medium',
        task: 'Basert pa eksempelet om Sofia: List opp alle tegnene pa omsorgssvikt som de ansatte observerte.',
        hints: ['Tenk pa fysiske tegn', 'Tenk pa atferd', 'Tenk pa grunnleggende behov som mat og klaer'],
        solution: 'Tegn pa omsorgssvikt: 1) Kommer uten matpakke (mangler mat). 2) Har skitne klaer (manglende hygiene/omsorg). 3) Virker trott (kanskje sovner for lite). 4) Er tilbaketrukket (emosjonell tilstand). 5) Reagerer sterkt nar voksne hever stemmen (frykt for voksne). 6) Slar andre barn (aggressiv atferd). 7) Blamerker pa overarmen (fysisk skade).',
        allowsUpload: true,
        allowsCanvasDrawing: false,
        competenceGoals: ['beskrive tegn pa omsorgssvikt og vold mot barn, og kjenne til meldeplikt og handlingsplikt'],
      },
    },
    {
      ...
      exercise: {
        ...
        options: [
          { id: 'a', text: 'At ansatte i offentlige tjenester ma melde fra ved bekymring for alvorlig omsorgssvikt', isCorrect: true },
          { id: 'b', text: 'At foreldre ma melde fra til barnehagen om barnets helse', isCorrect: false },
          { id: 'c', text: 'At naboer ma varsle politiet om all bekymring for barn', isCorrect: false },
          { id: 'd', text: 'At man forst ma vaere 100% sikker for man melder', isCorrect: false },
        ],
        solution: 'Meldeplikten betyr at ansatte i offentlige tjenester har plikt til a melde fra til barnevernet ved bekymring for alvorlig omsorgssvikt. Man trenger ikke vaere sikker - det holder med en bekymring.',
        competenceGoals: ['beskrive tegn pa omsorgssvikt og vold mot barn, og kjenne til meldeplikt og handlingsplikt'],
      },
    },
    {
    ...
    // --- Samleoppgaver ---
    {
      ...
      exercise: {
        ...
        type: 'classic',
        difficulty: 'vanskelig',
        task: 'Du jobber i barnehage og observerer tegn som gjor deg bekymret for et barn. Beskriv steg for steg hva du gjor fra du forst blir bekymret til du eventuelt sender bekymringsmelding.',
        hints: ['Tenk pa dokumentasjon', 'Tenk pa hvem du bor snakke med', 'Tenk pa hva som skal sta i en bekymringsmelding'],
        solution: 'Steg: 1) Observer og noter konkrete observasjoner (hva, nar, hvor). 2) Drofte observasjonene med kolleger - er andre enige i bekymringen? 3) Ta det opp med pedagogisk leder/styrer. 4) Vurder om det er grunnlag for bekymringsmelding til barnevernet. 5) Skriv bekymringsmelding med konkrete observasjoner (ikke tolkninger). 6) Send meldingen til barnevernet. 7) Fortsett a gi barnet trygghet og omsorg i barnehagen.',
        allowsUpload: true,
        allowsCanvasDrawing: false,
        competenceGoals: ['beskrive tegn pa omsorgssvikt og vold mot barn, og kjenne til meldeplikt og handlingsplikt'],
      },
    },
    {
      ...
      exercise: {
        ...
        type: 'classic',
        difficulty: 'vanskelig',
        task: 'Drofte: Noen mener at meldeplikten gjor det vanskelig a ha et godt samarbeid med foreldre fordi de kan bli redde for a bli meldt. Er du enig eller uenig? Begrunn svaret.',
        hints: ['Tenk pa barnets beste', 'Tenk pa at tidlig hjelp er bedre enn sen hjelp', 'Tenk pa at barnevernet ogsa gir hjelpetiltak, ikke bare omsorgsovertakelse'],
        solution: 'Det kan oppleves vanskelig, men meldeplikten er der for a beskytte barn. Tidlig hjelp kan fore til at familier far stotte for problemer blir for store. Barnevernet gir ofte hjelpetiltak som stotte og veiledning. Apenhet med foreldre om at man har plikt til a melde bekymring kan faktisk bygge tillit. Barnets beste ma alltid vaere det viktigste hensynet.',
        allowsUpload: true,
        allowsCanvasDrawing: false,
        competenceGoals: ['gjore rede for barns rettigheter og behov for trygghet og omsorg'],
      },
    },
    {
