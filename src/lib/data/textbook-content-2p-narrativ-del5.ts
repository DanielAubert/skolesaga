...
Ofte møter du **sammensatte figurer** som ikke er én enkel form. Da deler du figuren i enklere deler, beregner arealet av hver del, og legger sammen -- eller trekker fra, slik vi gjorde med vinduet i veggen.`,
    },
    {
      ...
      exercise: {
        ...
        task: 'Test deg selv på arealberegning:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        questions: [
          {
            id: '2p-5-1-n-quiz1-q0',
            task: 'Et rom har form som et rektangel med målene 4,5 m x 3,8 m. I rommet er det en sirkulær søyle med diameter 40 cm. Hva er arealet du må dekke med gulvbelegg (omtrent)?',
            options: [
            ...
            solution: 'Gulvareal $= 4{,}5 \\cdot 3{,}8 = 17{,}10$ m$^2$. Søylens radius $= 0{,}2$ m. Søyleareal $= \\pi \\cdot 0{,}2^2 \\approx 0{,}126$ m$^2$. Netto $= 17{,}10 - 0{,}126 \\approx 16{,}97$ m$^2$.',
          },
          {
            id: '2p-5-1-n-quiz1-q1',
            task: 'Et trapesformet hagebed har parallelle sider på 3 m og 5 m, og høyde 2 m. Hva er arealet?',
            options: [
              { id: 'a', text: '$15 \\text{ m}^2$', isCorrect: false },
              { id: 'b', text: '$8 \\text{ m}^2$', isCorrect: true },
              { id: 'c', text: '$16 \\text{ m}^2$', isCorrect: false },
              { id: 'd', text: '$10 \\text{ m}^2$', isCorrect: false },
            ],
            solution: '$A = \\frac{a + b}{2} \\cdot h = \\frac{3 + 5}{2} \\cdot 2 = 4 \\cdot 2 = 8$ m$^2$.',
          },
        ],
        solution: '',
      },
...
Mønsteret er verdt å merke seg: Kjegler og pyramider har alltid en tredjedel av volumet til den tilsvarende sylinderen eller prismet. Det er en vakker sammenheng som går igjen i geometrien.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 2',
        type: 'multiple-choice',
        task: 'Test deg selv på volumberegning:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        questions: [
          {
            id: '2p-5-1-n-quiz2-q0',
            ...
            solution: '$V = \\pi r^2 h = \\pi \\cdot 5^2 \\cdot 20 = 500\\pi \\approx 1\\,571$ cm$^3$.',
          },
          {
            id: '2p-5-1-n-quiz2-q1',
            task: 'En kjegle har samme radius og høyde som sylinderen (r = 5 cm, h = 20 cm). Hva er kjeglas volum?',
            options: [
              { id: 'a', text: '$500\\pi \\approx 1\\,571 \\text{ cm}^3$', isCorrect: false },
              { id: 'b', text: '$\\frac{500\\pi}{3} \\approx 524 \\text{ cm}^3$', isCorrect: true },
              { id: 'c', text: '$250\\pi \\approx 785 \\text{ cm}^3$', isCorrect: false },
              { id: 'd', text: '$\\frac{500\\pi}{2} \\approx 785 \\text{ cm}^3$', isCorrect: false },
            ],
            solution: '$V_{\\text{kjegle}} = \\frac{1}{3}\\pi r^2 h = \\frac{1}{3} \\cdot 500\\pi \\approx 524$ cm$^3$. En kjegle har alltid en tredjedel av volumet til sylinderen med samme grunnflate og høyde.',
          },
        ],
        solution: '',
      },
...
En **kule** har overflaten $O = 4\\pi r^2$, og en **kjegle** (inkludert bunnen) har $O = \\pi r^2 + \\pi r s$, der $s$ er skråhøyden (sidelengden). Tenk deg en iskrem-kjeks med radius 3 cm og skråhøyde 12 cm. Den buede overflaten -- *mantelen* -- er $\\pi \\cdot 3 \\cdot 12 = 36\\pi \\approx 113{,}1 \\text{ cm}^2$. Hvis kjeksen er dekket av sjokolade utenpå, er det altså omtrent 113 kvadratcentimeter sjokolade.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 3',
        type: 'multiple-choice',
        task: 'Test deg selv på overflateberegning:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        questions: [
          {
            id: '2p-5-1-n-quiz3-q0',
            ...
            solution: '$O = 2\\pi r^2 + 2\\pi rh = 2\\pi r(r + h)$. De to leddene representerer de to sirkulære endene ($2\\pi r^2$) og den buede sideflaten ($2\\pi rh$).',
          },
          {
            id: '2p-5-1-n-quiz3-q1',
            task: 'En vanntank har form som en sylinder med radius 0,6 m og høyde 1,5 m. Hva er overflaten som skal males (omtrent)?',
            options: [
              { id: 'a', text: '$1{,}7 \\text{ m}^2$', isCorrect: false },
              { id: 'b', text: '$5{,}65 \\text{ m}^2$', isCorrect: false },
              { id: 'c', text: '$7{,}92 \\text{ m}^2$', isCorrect: true },
              { id: 'd', text: '$11{,}3 \\text{ m}^2$', isCorrect: false },
            ],
            solution: '$O = 2\\pi \\cdot 0{,}6 \\cdot (0{,}6 + 1{,}5) = 2\\pi \\cdot 0{,}6 \\cdot 2{,}1 = 2{,}52\\pi \\approx 7{,}92$ m$^2$.',
          },
        ],
        solution: '',
      },
...
Men her kommer noe viktig: Formlikhet påvirker mer enn bare lengder. Når du skalerer noe med et forholdstall $k$, skalerer lengdene med $k$, men *arealene* skalerer med $k^2$, og *volumene* skalerer med $k^3$. Tenk deg at en arkitekt lager en modell i målestokk 1 : 100. Byggets lengder er 100 ganger større i virkeligheten, arealet er $100^2 = 10\\,000$ ganger større, og volumet er $100^3 = 1\\,000\\,000$ ganger større. Denne sammenhengen er utrolig nyttig og dukker opp overalt i praktisk arbeid.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 4',
        type: 'multiple-choice',
        task: 'Test deg selv på formlikhet og målestokk:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        questions: [
          {
            id: '2p-5-1-n-quiz4-q0',
            ...
            solution: 'Volum skalerer med $k^3$. Med $k = 3$: $3^3 = 27$. Volumet er 27 ganger større.',
          },
          {
            id: '2p-5-1-n-quiz4-q1',
            task: 'Avstanden mellom to steder på et kart med målestokk 1 : 25 000 er 8,4 cm. Hva er den virkelige avstanden?',
            options: [
              { id: 'a', text: '210 m', isCorrect: false },
              { id: 'b', text: '2 100 m = 2,1 km', isCorrect: true },
              { id: 'c', text: '21 km', isCorrect: false },
              { id: 'd', text: '840 m', isCorrect: false },
            ],
            solution: 'Virkelig avstand $= 8{,}4 \\cdot 25\\,000 = 210\\,000$ cm $= 2\\,100$ m $= 2{,}1$ km.',
          },
        ],
        solution: '',
      },
...
Legg merke til noe viktig i disse eksemplene: Matematikken er ikke vanskelig i seg selv. Det som krever øvelse er å *oversette* en virkelig situasjon til et matematisk problem. Hva er grunnflaten? Hvilken formel passer? Hva må trekkes fra? Disse spørsmålene er kjernen i praktisk geometri, og du blir bedre på dem med erfaring. Start gjerne med å tegne en skisse -- det hjelper nesten alltid.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 5',
        type: 'multiple-choice',
        task: 'Test deg selv på praktisk geometri:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        questions: [
          {
            id: '2p-5-1-n-quiz5-q0',
          ...
          {
            id: '2p-5-1-n-quiz5-q1',
            task: 'En sandkasse er 2,4 m lang, 1,8 m bred og 0,30 m dyp. Sand veier 1 500 kg/m$^3$. Hvor mange kg sand trengs?',
            options: [
              { id: 'a', text: 'Ca. 648 kg', isCorrect: false },
              { id: 'b', text: 'Ca. 1 296 kg', isCorrect: false },
              { id: 'c', text: 'Ca. 1 944 kg', isCorrect: true },
              { id: 'd', text: 'Ca. 2 592 kg', isCorrect: false },
            ],
            solution: '$V = 2{,}4 \\cdot 1{,}8 \\cdot 0{,}30 = 1{,}296$ m$^3$. Vekt $= 1{,}296 \\cdot 1\\,500 = 1\\,944$ kg.',
          },
        ],
        solution: '',
      },
...
Pytagoras-trippelet 3-4-5 er det mest kjente: $3^2 + 4^2 = 9 + 16 = 25 = 5^2$. Multipler av dette trippelet, som 6-8-10, fungerer også. Håndverkere bruker denne sammenhengen for å sjekke om et hjørne er rett vinkel: mål 3 m langs én vegg, 4 m langs den andre, og sjekk at diagonalen er 5 m.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 1',
        type: 'multiple-choice',
        task: 'Test deg selv på Pytagoras:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        questions: [
          {
            id: '2p-5-2-n-quiz1-q0',
            ...
            solution: '$c = \\sqrt{6^2 + 8^2} = \\sqrt{36 + 64} = \\sqrt{100} = 10$ cm. Pytagoras-trippelet 6-8-10.',
          },
          {
            id: '2p-5-2-n-quiz1-q1',
            task: 'En stige er 5,0 m lang og lener mot en vegg. Foten står 1,5 m fra veggen. Hvor høyt opp rekker stigen?',
            options: [
              { id: 'a', text: '$\\sqrt{27{,}25} \\approx 5{,}22$ m', isCorrect: false },
              { id: 'b', text: '$3{,}5$ m', isCorrect: false },
              { id: 'c', text: '$\\sqrt{22{,}75} \\approx 4{,}77$ m', isCorrect: true },
              { id: 'd', text: '$6{,}5$ m', isCorrect: false },
            ],
            solution: '$h^2 + 1{,}5^2 = 5{,}0^2 \\Rightarrow h^2 = 25 - 2{,}25 = 22{,}75 \\Rightarrow h = \\sqrt{22{,}75} \\approx 4{,}77$ m.',
          },
        ],
        solution: '',
      },
        ...
        questions: [
          {
            ...
            solution: 'Motstående katet = hypotenus $\\cdot \\sin v = 13 \\cdot \\sin 22° \\approx 4{,}9$ cm. Vi bruker sinus (SOH) fordi vi har hypotenusen og søker den motstående kateten.',
          },
          {
            id: '2p-5-2-n-quiz2-q1',
            task: 'Et tre kaster en skygge på 15 m. Solens vinkel er 38°. Hva er trehøyden?',
            options: [
              { id: 'a', text: '$15 \\cdot \\sin 38° \\approx 9{,}2$ m', isCorrect: false },
              { id: 'b', text: '$15 \\cdot \\cos 38° \\approx 11{,}8$ m', isCorrect: false },
              { id: 'c', text: '$15 \\cdot \\tan 38° \\approx 11{,}7$ m', isCorrect: true },
              { id: 'd', text: '$\\frac{15}{\\tan 38°} \\approx 19{,}2$ m', isCorrect: false },
            ],
            solution: 'Vi kjenner hosliggende katet (skyggen 15 m) og søker motstående katet (trehøyden). $\\tan 38° = \\frac{h}{15}$, altså $h = 15 \\cdot \\tan 38° \\approx 11{,}7$ m.',
          },
        ],
        solution: '',
      },
...
Her er et annet eksempel som viser at trigonometri kan avsløre viktig informasjon. En rampe for rullestol er 6,0 m lang og stiger 0,5 m i høyden. Hvilken vinkel danner rampen med bakken? Vi bruker sinus: $\\sin v = \\frac{0{,}5}{6{,}0} = 0{,}0833$, som gir $v = \\sin^{-1}(0{,}0833) \\approx 4{,}78°$. Norsk Standard sier at ramper for rullestol skal ha maks stigning 1:20, som tilsvarer $\\arctan(1/20) \\approx 2{,}86°$. Rampen i eksempelet er altså for bratt -- den oppfyller ikke kravet. Slik kan trigonometri være avgjørende for tilgjengelighet og sikkerhet.`,
    },
    {
      ...
      exercise: {
        ...
        questions: [
          {
            id: '2p-5-2-n-quiz3-q0',
            task: 'Et saltak har halvbredde 5,0 m og mønet er 2,5 m over takfoten. Hva er helningsvinkelen (omtrent)?',
            options: [
          ...
          {
            id: '2p-5-2-n-quiz3-q1',
            task: 'En rampe er 6,0 m lang og stiger 0,5 m. Hva er vinkelen med bakken?',
            options: [
              { id: 'a', text: '$\\sin^{-1}(0{,}0833) \\approx 4{,}8°$', isCorrect: true },
              { id: 'b', text: '$\\tan^{-1}(0{,}0833) \\approx 4{,}8°$', isCorrect: false },
              { id: 'c', text: 'Ca. 12°', isCorrect: false },
              { id: 'd', text: 'Ca. 8{,}3°', isCorrect: false },
            ],
            solution: 'Vi kjenner motstående katet (0,5 m) og hypotenusen (6,0 m). $\\sin v = \\frac{0{,}5}{6{,}0} = 0{,}0833$. $v = \\sin^{-1}(0{,}0833) \\approx 4{,}78°$.',
          },
        ],
        solution: '',
      },
...
Trigonometri er også nyttig i naturen. Tenk at du går opp en sti og tilbakelegger 250 m langs stien. GPS-en viser at du har steget 85 m i høyden. Stigningsvinkelen finner du med sinus: $\\sin v = 85/250 = 0{,}34$, så $v = \\sin^{-1}(0{,}34) \\approx 19{,}9°$. Den horisontale avstanden er $\\sqrt{250^2 - 85^2} = \\sqrt{55\\,275} \\approx 235{,}1$ m. Du har altså gått lenger langs bakken enn du har beveget deg horisontalt -- forskjellen er nesten 15 m.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 4',
        type: 'multiple-choice',
        task: 'Test deg selv på trigonometri i praksis:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        questions: [
          {
            id: '2p-5-2-n-quiz4-q0',
            task: 'Et tak med helningsvinkel 30° har en takflate som er 8 m lang (skrålengden). Hva er den horisontale bredden fra yttervegg til møne?',
            options: [
            ...
            solution: 'Hosliggende katet = hypotenus $\\cdot \\cos v = 8 \\cdot \\cos 30° \\approx 6{,}93$ m.',
          },
          {
            id: '2p-5-2-n-quiz4-q1',
            task: 'Du står 40 m fra et tårn. Vinkelen opp til toppen er 52°. Øynene dine er 1,7 m over bakken. Hva er tårnets totale høyde?',
            options: [
              { id: 'a', text: 'Ca. 51,2 m', isCorrect: false },
              { id: 'b', text: 'Ca. 52,9 m', isCorrect: true },
              { id: 'c', text: 'Ca. 33,5 m', isCorrect: false },
              { id: 'd', text: 'Ca. 40,0 m', isCorrect: false },
            ],
            solution: 'Høyde over øyehøyde $= 40 \\cdot \\tan 52° \\approx 51{,}2$ m. Total høyde $= 51{,}2 + 1{,}7 \\approx 52{,}9$ m. Husk å legge til øyehøyden!',
          },
        ],
        solution: '',
      },
...
Trigonometri gir oss altså en superkraft: evnen til å finne mål vi ikke kan måle direkte. Med bare en vinkelmåler og et målebånd kan du bestemme høyden på et fjell, bredden av en fjord eller avstanden til en øy. Det er ganske imponerende for en 2500 år gammel oppdagelse.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 5',
        type: 'multiple-choice',
        task: 'Test deg selv på triangulering og huskeregelen:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        questions: [
          {
            id: '2p-5-2-n-quiz5-q0',
            task: 'Huskeregelen SOH-CAH-TOA brukes til å huske trigonometriske forhold. Hva står "TOA" for?',
            options: [
              { id: 'a', text: 'Tan = Opposite / Adjacent (motstående / hosliggende)', isCorrect: true },
              { id: 'b', text: 'Tan = Over / Above (hypotenus / katet)', isCorrect: false },
              { id: 'c', text: 'Tan = Opposite / Angle (motstående / vinkel)', isCorrect: false },
              { id: 'd', text: 'Tan = Opposite / Area (motstående / areal)', isCorrect: false },
            ],
            solution: 'TOA: **T**an = **O**pposite / **A**djacent = motstående katet / hosliggende katet.',
          },
          {
            id: '2p-5-2-n-quiz5-q1',
            task: 'Du står ved en elv og går 50 m langs bredden. Fra den nye posisjonen måler du vinkelen til et tre på den andre siden til 62°. Hvor bred er elven?',
            options: [
              { id: 'a', text: '$50 \\cdot \\sin 62° \\approx 44$ m', isCorrect: false },
              { id: 'b', text: '$50 \\cdot \\cos 62° \\approx 23$ m', isCorrect: false },
              { id: 'c', text: '$50 \\cdot \\tan 62° \\approx 94$ m', isCorrect: true },
              { id: 'd', text: '$\\frac{50}{\\tan 62°} \\approx 27$ m', isCorrect: false },
            ],
            solution: 'Elvebredden er den motstående kateten, og 50 m er den hosliggende. $\\text{bredde} = 50 \\cdot \\tan 62° \\approx 94$ m. Dette er triangulering i praksis.',
          },
        ],
        solution: '',
      },
...
**Steg 5: Vurdere.** Er disse svarene rimelige? For kort fremtid er forskjellen liten. Vi bør sjekke med flere datapunkter for å avgjøre hvilken modell som passer best. Og vi bør tenke over om forutsetningene er realistiske -- vil veksten virkelig fortsette i samme tempo?`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 1',
        type: 'multiple-choice',
        task: 'Test deg selv på modelleringsprosessen:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        questions: [
          {
            id: '2p-6-1-n-quiz1-q0',
            ...
            solution: 'Det siste og viktigste steget er å vurdere om resultatet er rimelig. Uten denne vurderingen vet vi ikke om svaret gir mening.',
          },
          {
            id: '2p-6-1-n-quiz1-q1',
            task: 'Avfallsmengden i en kommune var 1 200 tonn i 2020 og 1 350 tonn i 2024. Hva gir en lineær modell for vekst per år?',
            options: [
              { id: 'a', text: '$150$ tonn per år', isCorrect: false },
              { id: 'b', text: '$37{,}5$ tonn per år', isCorrect: true },
              { id: 'c', text: '$300$ tonn per år', isCorrect: false },
              { id: 'd', text: '$75$ tonn per år', isCorrect: false },
            ],
            solution: 'Stigningstall $= \\frac{1\\,350 - 1\\,200}{2024 - 2020} = \\frac{150}{4} = 37{,}5$ tonn per år.',
          },
        ],
        solution: '',
      },
...
Noen ganger passer ingen av delene helt. Strømprisen for eksempel varierer sesongmessig -- høy om vinteren, lav om sommeren -- og krever en helt annen type modell, en *periodisk* modell. Det er viktig å innse at ikke alt lar seg fange med en rett linje eller en eksponentialkurve.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 2',
        type: 'multiple-choice',
        task: 'Test deg selv på lineær vs. eksponentiell modell:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        questions: [
          {
            id: '2p-6-1-n-quiz2-q0',
            ...
            options: [
              ...
              { id: 'c', text: 'Lineær, fordi differansene øker jevnt', isCorrect: false },
              { id: 'd', text: 'Ingen modell passer', isCorrect: false },
            ],
            solution: 'Forholdstallene er alle $\\approx 1{,}50$ ($150/100$, $225/150$, osv.). Konstante forholdstall betyr eksponentiell vekst: $f(t) = 100 \\cdot 1{,}50^t$.',
          },
          {
            id: '2p-6-1-n-quiz2-q1',
            task: 'Hvordan avgjør du om en dataserie er lineær eller eksponentiell?',
            options: [
              { id: 'a', text: 'Lineær hvis verdiene øker, eksponentiell hvis de synker', isCorrect: false },
              { id: 'b', text: 'Lineær hvis differansene mellom verdiene er omtrent like, eksponentiell hvis forholdstallene er omtrent like', isCorrect: true },
              { id: 'c', text: 'Du kan ikke avgjøre det uten digitale verktøy', isCorrect: false },
              { id: 'd', text: 'Lineær har alltid positive tall, eksponentiell kan ha negative', isCorrect: false },
            ],
            solution: 'Beregn differanser mellom påfølgende verdier: er de omtrent like, er modellen lineær. Beregn forholdstall: er de omtrent like, er modellen eksponentiell.',
          },
        ],
        solution: '',
      },
...
Hovedpoenget er at modellering handler like mye om *vurdering* som om *beregning*. En formel gir deg et tall, men det er du som må avgjøre om tallet er fornuftig.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 3',
        type: 'multiple-choice',
        task: 'Test deg selv på modellvalg i praksis:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        questions: [
          {
            id: '2p-6-1-n-quiz3-q0',
            task: 'Hvilken modell passer best for å beskrive hvordan prisen på strøm varierer gjennom et år?',
            options: [
              ...
              { id: 'd', text: 'Ingen av disse -- strømpris er sesongavhengig og krever en periodisk modell', isCorrect: true },
            ],
            solution: 'Strømpris varierer opp og ned gjennom året (sesongvariasjon), som verken fanges opp av lineær eller eksponentiell modell. Her trenger man en periodisk modell.',
          },
          {
            id: '2p-6-1-n-quiz3-q1',
            task: 'Vanntemperaturen i en kopp øker med 15 °C per minutt fra 20 °C. Hvilken modell passer best?',
            options: [
              { id: 'a', text: 'Eksponentiell, fordi temperaturen øker', isCorrect: false },
              { id: 'b', text: 'Lineær: $T(t) = 15t + 20$, fordi økningen er konstant', isCorrect: true },
              { id: 'c', text: 'Ingen modell passer', isCorrect: false },
              { id: 'd', text: 'Periodisk, fordi temperaturen svinger', isCorrect: false },
            ],
            solution: 'Økningen er konstant (15 °C per minutt), altså lineær modell: $T(t) = 15t + 20$. Merk at modellen er en forenkling -- i virkeligheten bremser oppvarmingen nær kokepunktet.',
          },
        ],
        solution: '',
      },
...
Tenk deg en softisbedrift med 50 000 kr i inntekt i juni 2023 og 65 000 kr i juni 2024. Når når de 100 000 kr? En lineær modell gir $x \\approx 3{,}3$ år (september 2026), en eksponentiell modell gir $x \\approx 2{,}6$ år (januar 2026). Men husk at softissalg er sesongbasert -- modellen beskriver kanskje bare junimåneder. Og 30 prosent årlig vekst er vanskelig å opprettholde over tid. *Konteksten* er alt.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 4',
        type: 'multiple-choice',
        task: 'Test deg selv på modellvurdering:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        questions: [
          {
            id: '2p-6-1-n-quiz4-q0',
            task: 'Hva er den viktigste forskjellen mellom interpolasjon og ekstrapolering?',
            options: [
              { id: 'a', text: 'Interpolasjon bruker lineære modeller, ekstrapolering eksponentielle', isCorrect: false },
              { id: 'b', text: 'Interpolasjon beregner mellom kjente data og er pålitelig, ekstrapolering beregner utenfor og er usikkert', isCorrect: true },
              { id: 'c', text: 'Ingen viktig forskjell', isCorrect: false },
              { id: 'd', text: 'Interpolasjon bruker flere datapunkter', isCorrect: false },
            ],
            solution: 'Interpolasjon beregner innenfor kjente datapunkter (pålitelig). Ekstrapolering beregner utenfor (usikkert) -- vi vet ikke om trenden fortsetter.',
          },
          {
            id: '2p-6-1-n-quiz4-q1',
            task: 'En eksponentiell vekstmodell for en strømmetjeneste forutser at alle 8 milliarder mennesker vil abonnere om 10 år. Hva er problemet?',
            options: [
              { id: 'a', text: 'Eksponentiell modell er feil -- det burde være lineær', isCorrect: false },
              { id: 'b', text: 'Modellen gjelder for alltid', isCorrect: false },
              { id: 'c', text: 'Modellen ekstrapolerer for langt -- veksten vil flate ut når markedet mettes', isCorrect: true },
              { id: 'd', text: 'Det er ingenting galt med denne prediksjonen', isCorrect: false },
            ],
            solution: 'Ingen vekst fortsetter eksponentielt for alltid. Markedet mettes, konkurranse øker, og veksten flater ut (logistisk vekst). Modellen er bare gyldig innenfor et begrenset tidsrom.',
          },
        ],
        solution: '',
      },
...
Det viktigste du tar med deg fra dette kapittelet er at en modell alltid er en *forenkling*. Den er et kart, ikke terrenget. Og akkurat som et kart, er den nyttig så lenge du husker at den ikke viser alt.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 5',
        type: 'multiple-choice',
        task: 'Test deg selv på modellering i praksis:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        questions: [
          {
            id: '2p-6-1-n-quiz5-q0',
            task: 'Antall abonnenter vokser med 600 per år fra 2023 (2 000 stk). Hva gir en lineær modell for 2028?',
            options: [
            ...
            solution: '$f(x) = 600x + 2\\,000$. For 2028 ($x = 5$): $f(5) = 600 \\cdot 5 + 2\\,000 = 5\\,000$.',
          },
          {
            id: '2p-6-1-n-quiz5-q1',
            task: 'Antall elsparkesykler i en by: 200, 520, 1100, 1600, 1900. Forholdstallene avtar (2,6 -- 2,1 -- 1,5 -- 1,2). Hva slags vekst er dette?',
            options: [
              { id: 'a', text: 'Lineær vekst', isCorrect: false },
              { id: 'b', text: 'Eksponentiell vekst', isCorrect: false },
              { id: 'c', text: 'Logistisk vekst (veksten flater ut)', isCorrect: true },
              { id: 'd', text: 'Tilfeldig variasjon', isCorrect: false },
            ],
            solution: 'Verken differanser eller forholdstall er konstante, og veksten avtar. Dette er logistisk vekst: rask i starten, men avtar etter hvert som markedet mettes.',
          },
        ],
        solution: '',
      },
...
Det er to typer **cellreferanser** du må kjenne. En **relativ referanse** som \`A1\` endrer seg når du kopierer formelen nedover (den blir \`A2\`, \`A3\` osv.). En **absolutt referanse** som \`$A$1\` forblir fast uansett hvor du kopierer den. Det er viktig å forstå forskjellen. Tenk deg at du har renten i celle B1 og vil multiplisere mange ulike beløp med denne renten. Da bruker du \`$B$1\` i formelen, så referansen til renten forblir fast mens beløpsreferansen endrer seg. Formelen \`=A1*(1+$B$1)\` i celle C1 kan kopieres nedover, og B1 peker alltid på renten mens A1 endrer seg til A2, A3 og så videre.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 1',
        type: 'multiple-choice',
        task: 'Test deg selv på regneark og formler:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        questions: [
          {
            id: '2p-6-2-n-quiz1-q0',
          ...
          {
            id: '2p-6-2-n-quiz1-q1',
            task: 'Utgiftene dine står i cellene B3 til B8. Hvilken formel summerer alle utgiftene?',
            options: [
              { id: 'a', text: '`=B3+B4+B5+B6+B7+B8`', isCorrect: false },
              { id: 'b', text: '`=GJENNOMSNITT(B3:B8)`', isCorrect: false },
              { id: 'c', text: '`=SUMMER(B3:B8)`', isCorrect: true },
              { id: 'd', text: '`=PRODUKT(B3:B8)`', isCorrect: false },
            ],
            solution: '`=SUMMER(B3:B8)` summerer alle verdier i celleområdet B3 til B8. Alternativ a gir samme resultat, men `SUMMER` er mer effektivt og lettere å vedlikeholde. `GJENNOMSNITT` gir gjennomsnittet, og `PRODUKT` multipliserer verdiene.',
          },
          {
            id: '2p-6-2-n-quiz1-q2',
            task: 'Hva er forskjellen mellom en relativ referanse (`A1`) og en absolutt referanse (`$A$1`)?',
            options: [
              { id: 'a', text: 'Absolutt referanse er mer nøyaktig enn relativ', isCorrect: false },
              { id: 'b', text: 'Relativ referanse endrer seg når du kopierer formelen, absolutt forblir fast', isCorrect: true },
              { id: 'c', text: 'Absolutt referanse kan bare brukes i kolonner, relativ i rader', isCorrect: false },
              { id: 'd', text: 'Det er ingen praktisk forskjell', isCorrect: false },
            ],
            solution: 'En relativ referanse som `A1` endrer seg når formelen kopieres (blir `A2`, `A3`, osv.). En absolutt referanse som `$A$1` forblir fast uansett hvor du kopierer. Dollartegnene "låser" referansen.',
          },
        ],
        solution: '',
      },
...
Den gir deg også en **$r^2$-verdi** -- determinasjonskoeffisienten -- som forteller hvor godt modellen passer. Verdien $r^2 = 0{,}98$ betyr at 98 prosent av variasjonen i dataene forklares av modellen. Jo nærmere 1, desto bedre. Med denne modellen kan du estimere temperaturen etter 45 minutter: $f(45) = 83{,}2 \\cdot 0{,}975^{45} \\approx 27$ grader. Lineær regresjon gjør du med \`RegLin(L1)\`.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 2',
        type: 'multiple-choice',
        task: 'Test deg selv på GeoGebra og regresjon:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        questions: [
          {
            id: '2p-6-2-n-quiz2-q0',
          ...
          {
            id: '2p-6-2-n-quiz2-q1',
            task: 'Hvilken GeoGebra-kommando bruker du for å finne den eksponentielle funksjonen som passer best til en punktliste L1?',
            options: [
              { id: 'a', text: '`RegLin(L1)`', isCorrect: false },
              { id: 'b', text: '`Nullpunkt(L1)`', isCorrect: false },
              { id: 'c', text: '`RegEksp(L1)`', isCorrect: true },
              { id: 'd', text: '`Skjæring(L1)`', isCorrect: false },
            ],
            solution: '`RegEksp(L1)` utforer eksponentiell regresjon og gir deg funksjonen $f(x) = a \\cdot b^x$ som passer best til datapunktene. `RegLin(L1)` gir lineaer regresjon.',
          },
        ],
        solution: '',
      },
    ...
    },
    {
      ...
      exercise: {
        ...
        questions: [
          ...
          {
            id: '2p-6-2-n-quiz3-q1',
            task: 'Du vil vise hvordan budsjettet ditt fordeler seg mellom husleie, mat, transport og fritid. Hvilken diagramtype passer best?',
            options: [
              { id: 'a', text: 'Punktdiagram', isCorrect: false },
              { id: 'b', text: 'Sektordiagram (kakediagram)', isCorrect: true },
              { id: 'c', text: 'Linjediagram', isCorrect: false },
              { id: 'd', text: 'Histogram', isCorrect: false },
            ],
            solution: 'Sektordiagram viser andeler av en helhet og er perfekt for budsjettfordeling. Hver "kakestykke" representerer en utgiftspost som andel av totalen.',
          },
          {
            id: '2p-6-2-n-quiz3-q2',
            task: 'Du vil undersoke sammenhengen mellom antall timer studert og eksamensresultat. Hvilken diagramtype velger du?',
            options: [
              { id: 'a', text: 'Sektordiagram', isCorrect: false },
              { id: 'b', text: 'Soylediagram', isCorrect: false },
              { id: 'c', text: 'Linjediagram', isCorrect: false },
              { id: 'd', text: 'Punktdiagram (spredningsdiagram)', isCorrect: true },
            ],
            solution: 'Punktdiagram viser sammenhengen mellom to variabler. Hvert punkt representerer en elev med studietid langs x-aksen og resultat langs y-aksen. Du kan legge inn en regresjonslinje for aa se trenden.',
          },
        ],
        solution: '',
      },
...
Husk at digitale verktøy er *hjelpemidler*. Regnearket gjør beregningene for deg, men du må fortsatt forstå matematikken bak for å sette opp formlene riktig og tolke resultatene. Verktøyet er bare så smart som den som bruker det.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 4',
        type: 'multiple-choice',
        task: 'Test deg selv paa laan og rente i regneark:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        questions: [
          {
            id: '2p-6-2-n-quiz4-q0',
            task: 'Du har et laan paa 200 000 kr med 4 % aarlig rente. Hva gir formelen `=A1*B1` hvis A1 inneholder 200 000 og B1 inneholder 0,04?',
            options: [
            ...
            solution: '`=A1*B1` = $200\\,000 \\cdot 0{,}04 = 8\\,000$ kr. Dette er rentekostnaden for det forste aaret.',
          },
          {
            id: '2p-6-2-n-quiz4-q1',
            task: 'Du sparer 1 000 kr i maaneden til 3 % aarlig rente. Hva er maanedlig rente?',
            options: [
            ...
            solution: 'Maanedlig rente = aarlig rente / 12 = $3\\% / 12 = 0{,}25\\%$. I regneark bruker du vekstfaktoren $1{,}0025$ for aa beregne rente hver maaned.',
          },
        ],
        solution: '',
      },
...
La oss ta et siste eksempel. Du sammenligner to spareplaner over 10 år: Plan A setter inn 500 kr i måneden til 3,5 prosent årlig rente, og Plan B setter inn 6 000 kr én gang i året til 3,8 prosent rente. Begge planene har totalt 60 000 kr i innskudd. Men resultatet er litt forskjellig -- Plan A gir ca. 71 200 kr og Plan B ca. 71 600 kr. Forskjellen er liten, men den illustrerer to motstridende effekter: Plan A setter inn pengene jevnere slik at de jobber lenger (renters rente oftere), men Plan B har høyere rente. I dette tilfellet oppveier de to effektene hverandre nesten helt. Et regneark lar deg utforske slike sammenligninger enkelt og raskt.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 5',
        type: 'multiple-choice',
        task: 'Test deg selv paa absolutte og relative referanser:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        questions: [
          {
            id: '2p-6-2-n-quiz5-q0',
            ...
            solution: 'B2 er en relativ referanse og endres til B3, B4, B5 naar formelen kopieres nedover. $C$1 er en absolutt referanse (med dollartegn) og forblir fast uansett hvor formelen kopieres.',
          },
          {
            id: '2p-6-2-n-quiz5-q1',
            task: 'Du har renten 0,05 i celle B1 og ulike belop i A2, A3, A4. Du vil beregne renten av hvert belop i kolonne C. Hvilken formel i C2 kan kopieres riktig nedover?',
            options: [
              { id: 'a', text: '`=A2*B1`', isCorrect: false },
              { id: 'b', text: '`=$A$2*$B$1`', isCorrect: false },
              { id: 'c', text: '`=A2*$B$1`', isCorrect: true },
              { id: 'd', text: '`=$A2*B$1`', isCorrect: false },
            ],
            solution: '`=A2*$B$1` bruker relativ referanse for belopet (A2 endres til A3, A4 naar du kopierer nedover) og absolutt referanse for renten ($B$1 forblir fast). Alternativ a ville flytte B1 til B2, B3 osv., som peker paa feil celler.',
          },
        ],
        solution: '',
      },
