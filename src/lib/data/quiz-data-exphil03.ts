...
const quizData_exphil03: Record<string, QuizQuestion[]> = {
  'exphil03-0-1': [
    {
      question: "Hvor mange av de to store oppgavene besvarer du på selvstudiumsvarianten av EXPHIL03 (formatet fra V2023, før H2025-bolkene)?",
      options: ["Én av to — du velger selv hvilken", "Begge to, de er obligatoriske", "Den første er obligatorisk, den andre frivillig", "Begge, men den ene bare i stikkordsform"],
    ...
    {
      question: "Hvordan utløser du gjenbruksbonusen i praksis når du skriver drøftingsdelen?",
      options: ["Ved å koble drøftingen eksplisitt tilbake til poenger fra (a)/(b), f.eks. «som vist i (a) …»", "Ved å gjenta redegjørelsen ordrett en gang til i drøftingen", "Ved å vise til et gammelt eksamenssett du har øvd på", "Ved å sitere pensumboka så ordrett og utførlig som mulig i hvert eneste avsnitt av hele drøftingsdelen"],
      explanation: "Sensor premierer at poenger fra kunnskapsdelene brukes videre i drøftingen med eksplisitt kobling. En drøfting som starter «på nytt» uten kobling til (a)/(b), straffes (feil #5).",
    },
    {
  ...
  'exphil03-0-2': [
    ...
    },
    {
      ...
      options: ["Argumenter for/mot → kritisk vurdering → kobling til pensum → selvstendig refleksjon", "Bred innledning → grundig gjengivelse → oppsummering → en avsluttende og tydelig konklusjon", "Definisjon → eksempel → motargument → mening", "Kilde → sitat → parafrase → litteraturliste"],
    ...
    },
    {
      ...
      options: ["Riktige poeng uten kobling til navngitt pensumtenker stopper på C", "At man aldri skal oppgi hvem som sier hva, for å holde framstillingen mest mulig objektiv", "At forankring i pensum er unødvendig", "At C er beste oppnåelige karakter"],
    ...
    },
    {
      ...
      options: ["Vurderingsevne og selvstendighet", "Besvarelsens samlede lengde og skrivehastigheten under selve eksamen", "Ordforråd og rettskriving", "Antall kilder og antall sitater"],
    ...
    },
    {
      ...
      options: ["Fordi drøftingen står uten presist pensumfundament å bygge på", "Fordi drøfting alltid teller mindre enn presis gjengivelse hos sensor", "Fordi sensor ikke belønner selvstendighet", "Fordi engelsk fagterminologi ikke er tillatt"],
    ...
    },
    {
      ...
      options: ["Ta stilling, og deretter gi det beste argumentet for og mot", "Vente med å konkludere helt til den aller siste setningen i besvarelsen", "Gjengi hele tenkerens teori på nytt", "Liste opp alle mulige argumenter uten å velge"],
  ...
  'exphil03-1-1': [
    {
      ...
      options: ["Tvil brukt som metode for å nå sikker kunnskap", "Påstanden om at sikker kunnskap er umulig", "En vedvarende følelse av usikkerhet overfor tradisjon og autoriteter", "En religiøs tvil på Guds eksistens"],
    ...
    },
    {
      ...
      options: ["Skeptikeren hevder at kunnskap er umulig; Descartes tviler for å nå sikker kunnskap", "Descartes hevder selv at all kunnskap er umulig, mens skeptikeren tvert imot søker full sikkerhet", "Det er ingen forskjell — Descartes var skeptiker", "Skeptisisme gjelder bare sansene, metodisk tvil bare fornuften"],
    ...
    },
    {
      ...
      options: ["Å rive grunnmuren i stedet for å reparere hvert enkelt hus", "Å luke ugress i en hage før man sår på nytt", "Å seile mot en fyrlykt gjennom tåke", "Å telle alle sauene i flokken for å finne den ene som mangler"],
    ...
    },
    {
      ...
      options: ["Fordi hviler de på et usikkert fundament, kan ingen av dem stoles på", "Fordi det ville ta for lang tid å gå gjennom alle", "Fordi noen overbevisninger er for hellige til å betviles", "Fordi sansene alltid gir oss helt riktig og pålitelig informasjon om verden"],
    ...
    },
    {
      ...
      options: ["Sansebedrag → drømmeargumentet → den onde ånd", "Den onde ånd → drømmeargumentet → sansebedrag", "Drømmeargumentet → sansebedrag → den onde ånd", "Sansebedrag → den onde ånd → til slutt drømmeargumentet"],
    ...
    },
    {
      ...
      options: ["Den blinde tilliten til sansene — at de alltid er til å stole på", "Hele sanseverdenens eksistens, inkludert det helt nære", "Matematiske og logiske sannheter, som at to pluss tre til sammen blir fem", "Selve det at jeg tenker og dermed eksisterer"],
    ...
    },
    {
      ...
      options: ["Den trekker også matematikk og logikk i tvil", "Den trekker hele den ytre sanseverdenen i tvil, akkurat slik drømmen gjør", "Den beviser at Gud finnes", "Den gjør cogito usikkert"],
    ...
    },
    {
      ...
      options: ["Fordi den presser tvilen så langt den kan gå, helt til fornuftssannhetene", "Fordi den er ondskapsfull av natur", "Fordi den beviser at ingenting finnes", "Fordi den er det aller første og mildeste trinnet i den stigende tvilstrappen"],
    ...
    },
    {
      ...
      options: ["Nei — den er et tenkt verktøy for å presse tvilen til det ytterste", "Ja — Descartes mente helt bokstavelig at en ond ånd faktisk styrer hele verden", "Ja — det er en religiøs påstand om djevelen", "Nei — den er et bevis for Guds ikke-eksistens"],
    ...
    },
    {
      ...
      options: ["Innsikten «jeg tenker, altså er jeg» — at jeg må eksistere idet jeg tenker", "Beviset for at den ytre verden finnes", "Påstanden om at Gud garanterer sansene", "Regelen om at alle klare og tydelige ideer nødvendigvis må være sanne"],
    ...
    },
    {
      ...
      options: ["Fordi for å bli bedratt må det finnes et jeg som bedras", "Fordi den onde ånd egentlig er god av natur og derfor ikke vil bedra meg", "Fordi Gud beskytter min eksistens", "Fordi sansene garanterer at jeg finnes"],
    ...
    },
    {
      ...
      options: ["Det ene faste holdepunktet all annen kunnskap kan bygges på", "Det punktet der tvilen begynner", "Beviset for at matematikk er sikkert", "Det konkrete stedet i teksten der Descartes selv nevner Arkimedes ved navn"],
    ...
    },
    {
      ...
      options: ["Det gir meg at jeg finnes nå mens jeg tenker, men ikke uten videre at jeg har kropp, fortid eller en verden", "Det gjelder strengt tatt bare for øvede filosofer, ikke for vanlige menneskers dagligdagse erkjennelse", "Det er usikkert og lar seg betvile", "Det gjelder bare matematiske sannheter"],
  ...
  'exphil03-1-3': [
    ...
    },
    {
      ...
      options: ["Begrenset — særlig mot type b, der ny evidens omtolkes; tiltakene må handle om tillit og kildekritikk", "Ja, alltid — mer fakta løser all resistens", "Nei, mer informasjon er fullstendig nytteløst mot begge former for kunnskapsresistens og bør derfor droppes helt", "Bare hvis informasjonen er hemmelig"],
    ...
    },
    {
      ...
      options: ["Descartes og hans krav om sikkerhet", "Sokrates og analysen av bullshit og skinnkunnskap", "Aristoteles og teleologien", "Haslanger og sosial konstruksjon"],
    ...
    },
    {
      ...
      options: ["At sann overbevisning uten gode grunner er flaks, ikke kunnskap", "At selve sannheten alene er fullt tilstrekkelig for å ha ekte kunnskap", "At overbevisning ikke trengs", "At kunnskap krever full sikkerhet"],
    ...
    },
    {
      ...
      options: ["Kunnskap og demokrati — hvem eller hva truer kunnskapssamfunnet mest", "Sinn og kropp — dualismens klassiske interaksjonsproblem hos Descartes", "Lykke og dyd", "Ren og anvendt geometri"],
    ...
    },
    {
      ...
      options: ["Å bare påpeke resistens hos motstandere, uten å se at mekanismen rammer alle", "Å bruke begge de to resistens-typene systematisk og grundig gjennom hele drøftingsdelen", "Å koble til Sokrates og Kant", "Å ta stilling med forbehold"],
    ...
    },
    {
      ...
      options: ["Å føre vilkårene og resistens-typene fra redegjørelsen inn i drøftingsdelen", "Å bruke samme utdrag to ganger", "Å sitere selve sensorveiledningen ordrett i flere av avsnittene i drøftingen", "Å gjenta innledningen til slutt"],
  ...
  'exphil03-1-4': [
    ...
    },
    {
      ...
      options: ["Fordi den skyldes manglende mot og besluttsomhet, ikke manglende forstand", "Fordi den skyldes manglende intelligens hos den enkelte", "Fordi staten og øvrigheten helt bevisst holder borgerne uvitende og umyndige", "Fordi den skyldes mangel på utdanning og bøker"],
    ...
    },
    {
      ...
      options: ["Bruken av fornuften som lærd, henvendt til et lesende publikum", "Bruken av fornuften mens man er ute blant folk", "Bruken av fornuften i et offentlig embete man er betrodd av staten", "Statens offisielle begrunnelse for sine vedtak"],
    ...
    },
    {
      ...
      options: ["Bruken av fornuften i et betrodd embete eller en rolle", "Bruken av fornuften hjemme, når man er alene", "Fritt resonnement rettet mot allmennheten", "Private tanker man holder for seg selv og aldri ytrer offentlig"],
    ...
    },
    {
      ...
      options: ["Å snu offentlig/privat-skillet slik at «privat» blir «hjemme/alene»", "Å tro at umyndighet betyr å være mindreårig", "Å blande sammen sapere aude med Kants kategoriske imperativ fra etikken", "Å tro at Kant avviser all statlig autoritet"],
    ...
    },
    {
      ...
      options: ["Tjeneste = privat (kan bindes); avisinnlegg = offentlig (må være fri)", "Tjeneste = offentlig fornuftsbruk; avisinnlegget derimot = privat fornuftsbruk", "Begge deler = privat fornuftsbruk", "Begge deler = offentlig fornuftsbruk"],
    ...
    },
    {
      ...
      options: ["Utfør rollen lojalt, men behold retten til offentlig å kritisere den", "Adlyd øvrigheten og la være å tenke selv", "Følg fornuften uansett hva loven sier", "Tenk gjerne helt fritt selv, men hold alle meningene dine strengt for deg selv"],
    ...
    },
    {
      ...
      options: ["Kant gir oppfordringen (sapere aude), Wikforss diagnosen av hvorfor den er vanskelig", "De er direkte motstandere og grunnleggende uenige om hva kunnskap egentlig er og hvordan den oppnås", "Begge mener umyndighet skyldes manglende intelligens", "Wikforss avviser Kants opplysningsbegrep"],
    ...
    },
    {
      ...
      options: ["Å trekke inn en klassisk fornuftskritiker som er ute av pensum etter 2021", "Å bruke Wikforss, som er i pensum", "Å bruke Sokrates, som er i pensum", "Å referere altfor mye direkte til Kants egen originaltekst gjennom hele redegjørelsen"],
  ...
  'exphil03-1-5': [
    {
      ...
      options: ["Spørsmålet om hva som skiller vitenskap fra pseudovitenskap", "Spørsmålet om hvordan man beviser en teori endelig", "Spørsmålet om hvem som egentlig eier de vitenskapelige oppdagelsene", "Spørsmålet om hvor mye forskning bør koste"],
    ...
    },
    {
      ...
      options: ["Programmets grunnleggende antakelser, som holdes fast", "Hjelpehypotesene i beltet som justeres når programmet møter motstand", "Den nyeste forutsigelsen programmet har gjort", "Forskningens etiske retningslinjer"],
    ...
    },
    {
      ...
      options: ["Hjelpehypotesene rundt kjernen, som justeres ved motstand", "Programmets helt urokkelige grunnantakelser i den harde kjernen", "Et sett etiske regler for forskere", "Metoden for å måle observasjoner"],
    ...
    },
    {
      ...
      options: ["En hjelpehypotese som demper én anomali uten å forutsi noe nytt", "En justering av beltet som gir en helt ny og testbar forutsigelse", "En endring av den harde kjernen", "En bekreftelse av en eksisterende teori"],
    ...
    },
    {
      ...
      options: ["Fordi enhver lære finner tilhengere som ser den bekreftet overalt", "Fordi bekreftelser koster lite penger", "Fordi bekreftelser i vitenskapen så godt som alltid viser seg å være falske", "Fordi ingen teori kan bekreftes"],
    ...
    },
    {
      ...
      options: ["Fordi hos Lakatos feller ikke ett motbevis et program — beltet absorberer det", "Fordi Lakatos mener alt kan bevises", "Fordi Lakatos avviser observasjon helt", "Fordi Lakatos i virkeligheten bare vurderer enkelthypoteser, ikke hele programmer"],
    ...
    },
    {
      ...
      options: ["Degenerert — justeringene er ad hoc, uten nye forutsigelser", "Progressivt — det tilpasser seg dataene", "Vitenskapelig, siden det stadig finner svært mange bekreftelser", "Umulig å vurdere med Lakatos' kriterium"],
    ...
    },
    {
      ...
      options: ["Å avgjøre om et konkret programs justeringer er ad hoc eller progressive", "Å ramse opp vitenskapshistoriske oppdagelser", "Å gjengi definisjonene så nøyaktig som mulig", "Å sammenligne Lakatos' demarkasjonskriterium grundig med Wikforss' kunnskapssyn"],
    ...
    },
    {
      ...
      options: ["At hva man ser i en observasjon avhenger av teorien man ser med", "At observasjoner alltid er objektive og nøytrale", "At vitenskapelige teorier er fullstendig uavhengige av all observasjon", "At bare teleskoper gir sanne observasjoner"],
    ...
    },
    {
      ...
      options: ["Hvis emosjoner har en positiv erkjennelsesrolle, er det åpent om noe uten følelser kan «vite»", "Jaggar mener KI alltid vet mer enn mennesker", "Jaggar avviser fullstendig at tenkende maskiner i det hele tatt noen gang kan finnes eller lages", "Jaggar mener følelser er irrelevante for KI"],
  ...
  'exphil03-2-1': [
    ...
    },
    {
      ...
      options: ["Gjenerindringslæren: læring er egentlig sjelens gjenkalling av kunnskap den allerede har", "At man må godta at læring faktisk er umulig", "At en tilstrekkelig dyktig lærer alltid kan overføre helt ny kunnskap direkte til en tom og uvitende sjel", "At kunnskap bygges opp gradvis gjennom sanseerfaring"],
    ...
    },
    {
      ...
      options: ["Det er belegg for gjenerindringslæren: gutten finner en geometrisk sannhet uten undervisning, altså kom kunnskapen innenfra", "Det er en underholdende anekdote uten betydning for argumentet", "Det viser at slaver kan lære like godt som frie borgere", "Det beviser i realiteten bare at geometri er den aller enkleste og mest tilgjengelige formen for menneskelig kunnskap å tilegne seg"],
    ...
    },
    {
      ...
      options: ["Sjelens gjenkalling av tidløse sannheter den kjente før kroppen", "Vanlig hukommelse om hendelser man selv har opplevd", "Evnen til å pugge og gjenta det læreren har sagt", "En systematisk metode for å ordne og bearbeide alle sanseinntrykkene våre"],
    ...
    },
    {
      ...
      options: ["At en sanseting er skjønn ved å ha del i det skjønne selv — den «låner» egenskapen fra ideen", "At menneskene deltar aktivt i samfunnet og fellesskapet ved lojalt å følge alle de borgerlige dydene", "At sjelen deltar i kroppens sanseerfaringer", "At alle ideene til sammen utgjør én stor idé"],
    ...
    },
    {
      ...
      options: ["Vi dømmer sansbare ting som like opp mot en fullkommen likhet sansene aldri ga oss, altså må vi ha kjent det like selv på forhånd", "To ting kan aldri være helt like, derfor finnes ingen likhet", "Likhet er utelukkende noe vi gradvis lærer oss gjennom tålmodig å sammenligne svært mange enkeltting med hverandre over tid", "Matematikk er den eneste sikre formen for kunnskap"],
    ...
    },
    {
      ...
      options: ["Fordi ideene ifølge Platon eksisterer selvstendig, uavhengig av om noen tenker på dem", "Fordi ideene i virkeligheten bare finnes i selve språket og ordene våre, aldri i den enkelte tanken", "Fordi ideene er identiske med sansetingene", "Fordi bare filosofer kan ha ideer i hodet"],
    ...
    },
    {
      ...
      options: ["Menon svarer på HVORDAN kunnskap er mulig (gjenerindring); Faidon svarer på HVA kunnskapen er om (ideene)", "Menon handler om etikk; Faidon handler om politikk", "Begge svarer på det samme spørsmålet om dydens vesen", "Menon svarer på nøyaktig hva ideene i seg selv er; Faidon svarer derimot på hvordan sjelen egentlig husker og gjenkaller dem"],
    ...
    },
    {
      ...
      options: ["Ideene er MER virkelige — de er evige og fullkomne, mens sansetingene er skiftende, ufullkomne etterligninger", "Sansetingene er mer virkelige fordi vi kan ta på dem", "Ideene og sansetingene er nøyaktig like virkelige", "Ideene er egentlig bare en uatskillelig del av selve sansetingene og kan aldri løsrives eller skilles fra dem"],
    ...
    },
    {
      ...
      options: ["Fornuften og sjelens gjenerindring av ideene", "Sansene og observasjon av naturen", "Autoriteter og tradisjon", "Praktisk øvelse, gjentakelse og gradvis vanedannelse over tid"],
    ...
    },
    {
      ...
      options: ["At sjelen har eksistert før kroppen og da har vært i berøring med ideene", "At sjelen dannes samtidig med kroppen ved fødselen", "At sjelen i bunn og grunn er fullstendig identisk med selve den fysiske hjernen", "At sjelen bare finnes hos filosofer"],
    ...
    },
    {
      ...
      options: ["At hvert utdrag skal tolkes og plasseres i argumentet, ikke bare det man husker best", "At man skal velge ut det viktigste utdraget og se bort fra resten", "At man skal oversette hvert utdrag ord for ord", "At man i tillegg alltid skal svare grundig på begge de to valgfrie hovedoppgavene i settet"],
  ...
  'exphil03-2-2': [
    ...
    },
    {
      ...
      options: ["At enhver ting er en uatskillelig enhet av form og stoff, der formen er i tingen", "At formen finnes i en atskilt idéverden, adskilt fra stoffet", "At bare stoffet er virkelig, ikke formen", "At form og stoff i virkeligheten er to helt ulike og selvstendige substanser som kan eksistere hver for seg"],
    ...
    },
    {
      ...
      options: ["Platon plasserer formene i en atskilt idéverden; Aristoteles plasserer dem i tingene selv", "Platon mener det ikke finnes former; Aristoteles gjør det", "De er egentlig enige, siden begge snakker om former", "Aristoteles mener formene befinner seg i en egen atskilt idéverden, mens Platon plasserer dem i selve tingene"],
    ...
    },
    {
      ...
      options: ["Stoffårsak, formårsak, virkeårsak og formålsårsak", "Årsak, virkning, hensikt og tilfeldighet", "Materie, energi, tid og rom", "Sansning, erfaring, ren fornuft og sjelens gjenerindring"],
    ...
    },
    {
      ...
      options: ["Virkeårsaken — det som frembrakte tingen i tid", "Stoffårsaken — selve materialet tingen er laget av", "Formårsaken — konstruksjonen", "Formålsårsaken — hensikten"],
    ...
    },
    {
      ...
      options: ["At også naturting har iboende formål — de er rettet mot et mål", "At det utelukkende er menneskeskapte ting og artefakter som har formål", "At naturen styres av tilfeldigheter uten mål", "At alle ting består av form og stoff"],
    ...
    },
    {
      ...
      options: ["Å hoppe over ett av leddene, ofte formålsårsaken", "Å bruke et konkret eksempel", "Å nevne og forklare grundig alle de fire årsaksleddene", "Å skille mellom form og stoff"],
    ...
    },
    {
      ...
      options: ["At naturting har iboende formål — nøtten er rettet mot å bli et eiketre", "At naturen er full av tilfeldigheter", "At formen er i en atskilt idéverden", "At det utelukkende er virkeårsaken alene som kan forklare all vekst og utvikling i naturen"],
    ...
    },
    {
      ...
      options: ["Å ramse opp de fire årsakene generelt uten å føre dem konkret gjennom casen", "Å bruke alle fire ledd på casen", "Å skille artefakt fra naturting", "Å nevne og drøfte særlig formålsårsaken grundig og utførlig i den konkrete casen"],
    ...
    },
    {
      ...
      options: ["Fordi naturlig utvalg lover å forklare den tilsynelatende formålsrettetheten i naturen uten formål", "Fordi Aristoteles skrev om evolusjon", "Fordi Aristoteles' teleologi egentlig først og fremst handler om menneskelig moral og etikk, ikke om biologisk natur", "Fordi Dawkins var Aristoteles' elev"],
    ...
    },
    {
      ...
      options: ["Substans → form og stoff → de fire årsakene → teleologi", "Teleologi → substans → gjenerindring → ideene", "De fire årsakene → Platons atskilte idéverden → det cartesianske sansebedraget", "Virkeårsak alene, siden den er den egentlige årsaken"],
  ...
  'exphil03-2-3': [
    {
      ...
      options: ["Gjennom tilfeldig variasjon og ikke-tilfeldig seleksjon, uten at noe ledd sikter mot et mål", "Gjennom et iboende formål i hver organisme", "Gjennom en formålsgiver som designet organismene", "Gjennom sjelens platonske gjenerindring av de evige og fullkomne formene den kjente før kroppen"],
    ...
    },
    {
      ...
      options: ["Aristoteles forklarer den forfra (et iboende mål); Dawkins forklarer den bakfra (variasjon og seleksjon)", "Aristoteles benekter formål; Dawkins hevder formål", "Begge to forklarer i grunnen den tilsynelatende formålsrettetheten i naturen på nøyaktig én og samme måte", "Dawkins forklarer den forfra; Aristoteles bakfra"],
    ...
    },
    {
      ...
      options: ["Enten benekte evolusjonens påvirkning (usannsynlig), eller forklare et usannsynlig treff mellom seleksjon mot nytte og moralsk sannhet", "Enten være ateist eller religiøs", "Enten godta all moral eller forkaste all moral", "Enten fullt og helt stole på de upålitelige sansene våre, eller i stedet utelukkende stole på den rene fornuften alene i alle moralske spørsmål"],
    ...
    },
    {
      ...
      options: ["At hadde en usann verdi tjent overlevelsen like godt, ville den spredt seg like godt — altså er sannhet irrelevant for seleksjonen", "At det utelukkende er de objektivt sanne og riktige moralske verdiene som overhodet kunne blitt selektert fram gjennom evolusjonen", "At evolusjonen alltid velger de riktige verdiene", "At verdier ikke påvirkes av evolusjon"],
    ...
    },
    {
      ...
      options: ["Nei — evolusjonsforklaringen viser normens opphav, men gjør den ikke usann; den svekker en bestemt begrunnelse for at den er objektivt sann", "Ja, evolusjonsforklaringen beviser at normen er falsk", "Ja, alle evolusjonært forklarte normer er ugyldige", "Nei, tvert imot beviser jo selve evolusjonsforklaringen med all mulig tydelighet at normen om å ta vare på eget barn er objektivt sann"],
    ...
    },
    {
      ...
      options: ["En feiltolkning — argumentet utfordrer objektiviteten, ikke moralens meningsfullhet, og fører mot ydmykhet/antirealisme, ikke nihilisme", "En helt korrekt og presis forståelse av nøyaktig hva som er selve den logiske sluttkonklusjonen av Streets evolusjonære debunking-argument", "En styrking av argumentet", "Det samme som genese/gyldighet-skillet"],
    ...
    },
    {
      ...
      options: ["Begge gir et evolusjonært OPPHAV (til formålsrettethet / til verdier), og spørsmålet er i begge hva opphavet INNEBÆRER", "De har ingen sammenheng", "Begge de to halvdelene av kapitlet handler i bunn og grunn utelukkende om menneskelig moral, plikt og etiske verdier og normer alene", "Begge handler bare om metafysikk"],
    ...
    },
    {
      ...
      options: ["Å beherske genese/gyldighet-skillet presist, skille sterk/svak teleologi og relativisme/skeptisisme/ydmykhet, og koble Dawkins til Street", "Å konkludere skråsikkert at moralen er motbevist", "Å gjengi og ramse opp så mange konkrete biologiske og evolusjonsfaglige detaljer som det overhodet lar seg gjøre gjennom hele hoveddelen av besvarelsen", "Å behandle de to halvdelene helt atskilt"],
    ...
    },
    {
      ...
      options: ["Fordi kreftene som formet dem siktet mot nytte, ikke mot sannhet — så en overensstemmelse med sannheten ville være tilfeldig", "Fordi verdiene er tilfeldig valgt av hver enkelt", "Fordi det ifølge Street strengt tatt ikke finnes noen objektiv moralsk sannhet i det hele tatt som verdiene kunne stemt overens med", "Fordi evolusjonen alltid treffer sannheten"],
  ...
  'exphil03-2-4': [
    {
      ...
      options: ["At virkeligheten består av to grunnleggende ulike substanser: sinn og kropp", "At sinn og kropp er to ord for det samme fenomenet", "At bare det fysiske finnes, og sinnet er noe hjernen gjør", "At selve sinnet i virkeligheten bare er en illusjon skapt av den fysiske kroppen"],
    ...
    },
    {
      ...
      options: ["Hvordan en uutstrakt substans kan sette en utstrakt kropp i bevegelse", "Hvorvidt sinnet finnes i det hele tatt", "Om kroppen kan tenke uten sinnet", "Hvorvidt Gud i det hele tatt kan gripe direkte inn i den fysiske naturen"],
    ...
    },
    {
      ...
      options: ["Den bruker Descartes' egne definisjoner (uutstrakt sinn, utstrakt kropp) mot ham", "Den påberoper seg helt ny naturvitenskap og eksperimentelle funn som Descartes selv umulig kunne ha kjent til", "Den benekter at sinnet finnes", "Den viser at Descartes tar feil om matematikk"],
    ...
    },
    {
      ...
      options: ["Å skille å simulere smerteatferd fra å ha en indre tilstand", "Å skille dyre robot fra billig robot", "Å skille tydelig mellom den fysiske kroppen og selve den biologiske hjernen", "Å skille sannhet fra løgn hos roboten"],
    ...
    },
    {
      ...
      options: ["Postulerer man et uutstrakt sinn i roboten, gjenoppstår interaksjonsproblemet", "Den viser i realiteten at tenkende og følende maskiner overhodet ikke lar seg bygge", "Den beviser at maskiner har sjel", "Den gjelder bare biologiske kropper"],
    ...
    },
    {
      ...
      options: ["#4 — hoppe over/nedprioritere et delspørsmål og bryte jevnhetsregelen", "#14 — gammelt pensum-spøkelse", "#11 — sitatslurv og upresis, unøyaktig gjengivelse av selve originalteksten", "#2 — mening uten grunner"],
    ...
    },
    {
      ...
      options: ["En forklaring på mekanismen for samvirket, ikke bare en påstand om at det skjer", "At han benekter at sinn og kropp samvirker", "At han beviser at Gud finnes", "At han fullstendig oppgir og forkaster hele det filosofiske prosjektet sitt for godt"],
    ...
    },
    {
      ...
      options: ["Descartes forsvarer dualismen, Elisabeth reiser interaksjonsproblemet fra innsiden av hans definisjoner", "De var i nær slekt med hverandre og tilhørte den samme adelige europeiske fyrstefamilien på 1600-tallet", "De var enige om alt", "De skrev samme bok"],
    ...
    },
    {
      ...
      options: ["At sinn og kropp er to substanser med motsatte vesentlige egenskaper", "At Descartes levde på 1600-tallet", "At hjernen har to hjernehalvdeler", "At selve sinnet alltid arbeider langt raskere enn den trege fysiske kroppen"],
  ...
  'exphil03-2-5': [
    ...
    },
    {
      ...
      options: ["Å blande analytisk/syntetisk med a priori/a posteriori", "Å blande sammen Kants posisjon med Descartes' rasjonalisme", "Å blande geometri med aritmetikk", "Å blande ren og anvendt geometri"],
    ...
    },
    {
      ...
      options: ["Kunnskap som er både informativ (syntetisk) og erfaringsuavhengig (a priori)", "Kunnskap som er både tom og erfaringsbasert", "Kunnskap som utelukkende finnes innenfor den rene formallogikken og matematikken", "Et annet navn for analytisk kunnskap"],
    ...
    },
    {
      ...
      options: ["At fornuften alene kan gi informativ og nødvendig kunnskap om verden", "At absolutt all menneskelig kunnskap i bunn og grunn stammer fra erfaringen", "At matematikk er meningsløs", "At vi ikke kan vite noe"],
    ...
    },
    {
      ...
      options: ["Geometri om det fysiske rommet — informativ, men empirisk og usikker", "Geometri som følger av aksiomer alene", "En geometri som er både sikker og informativ", "Nøyaktig det Kant selv kalte syntetisk a priori-kunnskap om det fysiske rommet"],
    ...
    },
    {
      ...
      options: ["At geometrien er syntetisk a priori-kunnskap om verden", "At opplysning er utgang fra umyndighet", "At sinn og kropp utgjør to helt ulike og atskilte substanser", "At alle ungkarer er ugifte"],
    ...
    },
    {
      ...
      options: ["At Kant ikke hevdet a priori-kunnskap om et fysisk rom «der ute», men om rommet som form for vår anskuelse", "At Einstein ikke forsto matematikk", "At hele relativitetsteorien til Einstein rett og slett er feil og bygger på en misforståelse av geometrien", "At geometri ikke finnes"],
    ...
    },
    {
      ...
      options: ["#3 — relativitetsteori-populærstoff uten filosofisk poeng", "#6 — blande distinksjonene", "#4 — å hoppe over eller kraftig nedprioritere et helt delspørsmål", "#14 — å trekke inn tenkere og posisjoner fra gammelt, utgått og fjernet pensum etter 2021"],
  ...
  'exphil03-2-6': [
    ...
    },
    {
      ...
      options: ["Mekanismen — skillet mellom konstruksjon av begreper og av objekter", "Skillet mellom Haslanger og Aristoteles", "Skillet mellom ren og anvendt geometri", "Selve skillet mellom løgn og bullshit slik Frankfurt trekker det skarpt opp"],
    ...
    },
    {
      ...
      options: ["Konstruksjon av begreper — hva som telles som mat avhenger av sosiale praksiser", "Ren konstruksjon av selve objektene og de fysiske tingene som kategorien brukes på", "At mat er biologisk gitt", "Genealogisk eliminativisme"],
    ...
    },
    {
      ...
      options: ["Å avdekke en kategoris historiske opprinnelse og funksjon", "Å kartlegge en persons slektstre", "Å måle og kartlegge de biologiske forskjellene mellom gruppene", "Å telle hvor ofte et begrep brukes"],
    ...
    },
    {
      ...
      options: ["Hva sosialt kjønn (gender) krever av sosial kontekst", "Om biologisk kjønn finnes", "Om mennesker kan overleve alene", "Hvor gammel og historisk innarbeidet en gitt kategori er"],
    ...
    },
    {
      ...
      options: ["Det lar oss si at begrepet «sex» kan være konstruert uten å benekte kroppene selv", "Det viser at sex og gender er det samme", "Det beviser at kjønn ikke finnes", "Det er i virkeligheten fullstendig irrelevant for hele det aktuelle spørsmålet om kjønn"],
    ...
    },
    {
      ...
      options: ["En sosial posisjon i et system av forventninger, roller og hierarkier", "En biologisk egenskap ved kroppen", "En personlig følelse uten sosial side", "Et rent språklig og begrepsmessig fenomen som er fullstendig uten reell virkning"],
    ...
    },
    {
      ...
      options: ["#2 — mening uten grunner", "#6 — upresise begreper", "#13 — ignorere premisser", "#4 — å hoppe helt over ett av de obligatoriske delspørsmålene"],
    ...
    },
    {
      ...
      options: ["At noe er formet av sosiale praksiser snarere enn naturgitt", "At noe er innbilt og uvirkelig", "At noe er biologisk bestemt", "At noe er logisk nødvendig og sant i kraft av begrepene alene"],
    ...
    },
    {
      ...
      options: ["Å demonstrere mekanismen (hva/hvordan) belønnes over å bare slå fast konklusjonen", "Konklusjonen alene er nok for A", "Mekanismen er irrelevant", "Man skal helst utelate både selve mekanismen og konklusjonen fullstendig i besvarelsen"],
  ...
  'exphil03-3-1': [
    {
      ...
      options: ["Et vellykket, blomstrende liv — det gode liv som helhet, ikke en følelse", "En behagelig følelse man har i øyeblikket", "Størst mulig nytelse og minst mulig smerte", "Å gjøre sin plikt av ren pliktfølelse alene, fullstendig uavhengig av handlingens utfall"],
    ...
    },
    {
      ...
      options: ["Fordi den alltid velges for sin egen skyld og aldri som middel til noe annet", "Fordi den kommer sist i livet, når man er gammel", "Fordi den er det vanskeligste målet å nå", "Fordi selve lykken i bunn og grunn bare er et nyttig middel til å oppnå rikdom og ære"],
    ...
    },
    {
      ...
      options: ["Å utøve fornuftsvirksomhet godt, i samsvar med dyd, gjennom et helt liv", "Å oppnå mest mulig kortvarig nytelse på så kort tid som overhodet mulig", "Å følge samfunnets regler uten unntak", "En medfødt følelse man enten har eller ikke har"],
    ...
    },
    {
      ...
      options: ["Gjennom øvelse og vane — vi blir modige ved å gjøre modige handlinger", "Utelukkende gjennom teoretisk kunnskap og boklig lærdom alene, uten øvelse", "De er medfødte og kan ikke endres", "Gjennom en enkelt opplysende innsikt"],
    ...
    },
    {
      ...
      options: ["Aristoteles' eudaimonia er fornuftsvirksomhet i samsvar med dyd, mens Mills lykke er nytelse og fravær av smerte", "Aristoteles og Mill mener nøyaktig det samme med «lykke»", "Aristoteles mener lykke er nytelse, Mill mener det er dyd", "Begge to mener egentlig at sann lykke utelukkende består i å gjøre sin plikt av ren pliktfølelse, slik Kant hevder"],
    ...
    },
    {
      ...
      options: ["At det er tvilsomt om mennesket har én funksjon, slik en kniv har", "At det ikke nevner nytelse i det hele tatt", "At det bygger på Kants kategoriske imperativ", "At hele funksjonsargumentet stilltiende forutsetter at Gud helt sikkert finnes"],
    ...
    },
    {
      ...
      options: ["Aristoteles gjør det gode livet til målet, mens Kant lar moralsk verdi være uavhengig av lykke", "Begge mener lykke er moralens eneste mål", "Kant gjør menneskelig lykke og nytelse til moralens endelige mål, mens Aristoteles fullstendig avviser lykke", "Ingen av dem bruker begrepet lykke"],
    ...
    },
    {
      ...
      options: ["Handlinger som er gale i seg selv, som drap, har ingen «riktig grad»", "At noen mennesker ikke kan bli dydige", "At midten bare finnes for fysiske handlinger", "At menneskelige følelser overhodet ikke lar seg regulere eller styre med fornuften"],
    ...
    },
    {
      ...
      options: ["Mennesket har et iboende formål (funksjon), og det gode er å realisere det — slik naturting er rettet mot sitt formål", "Etikken avviser at naturting har formål", "Etikken hans bygger utelukkende på det moderne, mekanistiske synet på årsak og virkning slik vi kjenner det fra naturvitenskapen", "Det finnes ingen kobling"],
    ...
    },
    {
      ...
      options: ["Fordi eudaimonia er en tilstand ved et vellykket liv som helhet, ikke en øyeblikksfølelse", "Fordi Aristoteles ikke bryr seg om følelser", "Fordi lykke bare finnes hos gamle mennesker", "Fordi menneskelige følelser i seg selv er altfor upålitelige og skiftende til å kunne måles"],
    ...
    },
    {
      ...
      options: ["«Hva slags menneske bør jeg være / hva ville en dydig person gjort?» framfor «hva er min plikt / hva gir mest nytte?»", "«Hvilken regel skal jeg følge?»", "«Hvordan maksimerer jeg egen nytelse?»", "«Hvilken konkret lov og hvilke bestemte regler er det egentlig samfunnet og fellesskapet til enhver tid krever av meg som borger?»"],
    ...
    },
    {
      ...
      options: ["Fordi dyder erverves ved vane, så gode vaner formet tidlig gjør at man senere vil det gode", "Fordi dyd er medfødt og bare må vekkes", "Fordi selve dyden fullt ut kan læres og tilegnes gjennom teoretiske bøker og boklig lærdom alene", "Fordi loven krever det"],
    ...
    },
    {
      ...
      options: ["At det kan hoppe fra en beskrivelse (fornuft er særegen) til en norm (man bør leve fornuftig)", "At det bygger på et matematisk regnestykke", "At hele funksjonsargumentet stilltiende forutsetter at kroppslig nytelse er det aller høyeste gode for mennesket", "At det ignorerer fornuften"],
  ...
  'exphil03-3-2': [
    ...
    },
    {
      ...
      options: ["Plikt er å handle av aktelse for moralloven; tilbøyelighet er å handle av lyst, følelse eller egeninteresse", "Plikt betyr ganske enkelt å følge lovens bokstav, mens tilbøyelighet tvert imot betyr å bryte og overtre selve loven", "Plikt gjelder store valg; tilbøyelighet gjelder små", "Det er ingen forskjell for Kant"],
    ...
    },
    {
      ...
      options: ["At en handling kan være i samsvar med plikten (ærlig) uten å ha moralsk verdi, fordi motivet er egeninteresse", "At ærlighet alltid lønner seg", "At følgene avgjør en handlings verdi", "At kjøpmenn og forretningsfolk av prinsipp aldri kan handle moralsk riktig, siden de alltid tenker på egen vinning"],
    ...
    },
    {
      ...
      options: ["Det er betinget: «hvis du vil X, så gjør Y» — og forplikter bare den som har målet X", "Det gjelder ubetinget for alle", "Det er en moralsk plikt", "Det handler i bunn og grunn utelukkende om menneskelige følelser og tilbøyeligheter, ikke om fornuft"],
    ...
    },
    {
      ...
      options: ["Formuler maksimen → tenk den som allmenn lov → sjekk om den kan villes uten selvmotsigelse", "Regn nøye ut alle følgene → sammenlign dem med alle alternativene → velg det handlingsalternativet med best utfall", "Spør hva den dydige ville gjort → øv → gjenta", "Spør samfunnet → følg flertallet → juster"],
    ...
    },
    {
      ...
      options: ["Det som har pris kan erstattes av noe likeverdig; det som har verdighet er uerstattelig", "Verdighet gjelder rike, pris gjelder fattige", "De betyr det samme", "Pris er noe som utelukkende gjelder mennesker og personer, mens verdighet på sin side bare gjelder varer og ting"],
    ...
    },
    {
      ...
      options: ["At pliktmotivet er pålitelig — det holder også når følelsene svikter og mot dem man ikke liker", "At følelser er onde og bør undertrykkes", "At det til syvende og sist tross alt er de faktiske følgene av handlingen som er det som virkelig betyr noe", "At innvendingen er meningsløs"],
    ...
    },
    {
      ...
      options: ["Den ytre handlingen er riktig, men motivet er ikke aktelse for moralloven — så den mangler moralsk verdi", "Den er både riktig og moralsk verdifull", "Den bryter loven, men føles riktig", "Den er i alle slike tilfeller grunnleggende umoralsk og gal, uansett hvilket motiv som lå bak selve handlingen"],
    ...
    },
    {
      ...
      options: ["«Bare» — det forbudte er å bruke noen *bare* som middel, ikke å bruke dem som middel", "«Alltid» — poenget er at man alltid og under enhver omstendighet må ofre seg selv fullstendig for andre", "«Aldri» — man kan aldri be andre om hjelp", "«Formål» — bare mål teller"],
    ...
    },
    {
      ...
      options: ["«Grunnlegging av moralens metafysikk»", "«Kritikk av den rene fornuft»", "«Hva er opplysning?», Kants berømte lille essay", "«Den nikomakiske etikk»"],
    ...
    },
    {
      ...
      options: ["Feil #1 — gjengivelse uten å få fram at moralsk verdi ligger i pliktmotivet, ikke den ytre handlingen", "Feil #13 — ignorere premissene", "Feil #10 — en ren formal- og oppsettsfeil i besvarelsens struktur, layout og ytre utforming gjennom hele teksten", "Feil #14 — utenom-pensum"],
    ...
    },
    {
      ...
      options: ["At plikten sikrer rett handling også uten den rette følelsen — pålitelighet der følelser er lunefulle", "At følelser er verdiløse", "At man aldri bør hjelpe venner", "At det til syvende og sist tross alt likevel er de faktiske konsekvensene av handlingen som avgjør moralsk verdi"],
    ...
    {
      question: "En kandidat skriver: «Både Kant og Aristoteles gjør lykken til moralens mål.» Hva er galt med påstanden?",
      options: ["For Kant har handlingen moralsk verdi uavhengig av lykke; bare hos Aristoteles er det gode livet moralens mål", "Ingenting — begge gjør faktisk lykke til moralens mål", "Påstanden er gal fordi Aristoteles i virkeligheten fullstendig avviser og forkaster hele lykkebegrepet i etikken sin", "Den er gal fordi ingen av dem bruker begrepet lykke"],
      explanation: "Trekantdrøftingen om moralens forhold til lykken skiller dem: plikt og god vilje (Kant) mot eudaimonia som mål (Aristoteles). Å slå dem sammen er en presisjonsfeil.",
    },
  ],
  'exphil03-3-3': [
    {
      question: "Hva sier nytteprinsippet?",
      options: ["Handlinger er rette i den grad de fremmer lykke, gale i den grad de fremmer det motsatte", "Handlinger er rette hvis de er gjort av plikt", "Handlinger er rette hvis en dydig person ville gjort dem", "Handlinger er alltid rette utelukkende dersom de nøye følger samfunnets gjeldende lover og regler"],
    ...
    },
    {
      ...
      options: ["Prinsippet er et kriterium, ikke en prosedyre — menneskehetens erfaring gir tommelfingerregler", "At man må regne før hver handling likevel", "At følelser skal avgjøre i stedet", "At selve beregningen av all nytte i praksis er fullstendig umulig, og at hele teorien derfor må forkastes"],
    ...
    },
    {
      ...
      options: ["Fordi han rangerer gleder etter kvalitet, ikke bare etter mengde nytelse", "Fordi han avviser at nytelse er godt", "Fordi han utelukkende teller opp det totale antallet gleder og nytelser en person har", "Fordi han mener alle gleder er like gode"],
    ...
    {
      question: "Hvorfor er nettopp Kant mot Mill arkivets hyppigste sammenligningspar?",
      options: ["Fordi de gir motsatte svar på hva som gjør en handling rett — sinnelag mot konsekvenser — langs én skarp akse", "Fordi de var samtidige og diskuterte direkte med hverandre", "Fordi begge to i bunn og grunn bygger hele etikken sin på nøyaktig det samme nytteprinsippet, bare med litt ulik vektlegging", "Fordi sensorene krever at Mill alltid sammenlignes med noen"],
      explanation: "Kant mot Mill (S3) er arkivets hyppigste par fordi kjerneaksen er så skarp: hva som gjør en handling rett — sinnelaget eller konsekvensene.",
    },
    {
    ...
    },
    {
      ...
      options: ["Mill: nytelse og fravær av smerte; Aristoteles: fornuftsvirksomhet i samsvar med dyd", "De mener nøyaktig det samme", "Mill mener lykke er dyd og god karakter; Aristoteles mener lykke er ren og enkel nytelse", "Begge to mener egentlig at sann lykke utelukkende består i å gjøre sin plikt av ren pliktfølelse, slik Kant hevder"],
    ...
    },
    {
      ...
      options: ["Er utilitarismen en holdbar moralteori?", "Var Mill en god forfatter?", "Levde John Stuart Mill egentlig etter sin egen etiske lære?", "Er nytelse alltid godt?"],
    ...
    },
    {
      ...
      options: ["Feil #1 — gjengivelse/behandling uten å vise teorien slik den forsvares; et S1-toppsvar krever par", "Feil #10 — formalfeil", "Feil #12 — å svare fullt og grundig på begge de to valgfrie hovedoppgavene i eksamenssettet samtidig", "Feil #13 — ignorere premissene"],
    ...
    },
    {
      ...
      options: ["Den totale lykken for alle berørte, ikke bare for den handlende", "Bare den handlendes egen lykke", "Utelukkende lykken til det store flertallet av innbyggerne i staten", "Summen av alle følelser man har hatt"],
    ...
    },
    {
      ...
      options: ["Det angir hva som gjør en handling rett, men er ikke en kalkyle man må kjøre før hver handling", "Det er en fast oppskrift for hver enkelt situasjon", "Prinsippet kommer i praksis bare til anvendelse i de vanskelige tvilstilfellene der reglene ikke strekker til", "Det er en juridisk regel"],
    ...
    },
    {
      ...
      options: ["De intellektuelle, estetiske og moralske gledene", "De aller mest intense og kraftfulle kroppslige nytelsene", "De gledene som varer lengst", "De gledene flest mennesker har"],
    ...
    },
    {
      ...
      options: ["Mill formulerer innvendinger mot egen teori og gir svar — og det er paret innvending + svar eksamen tester", "Mill ignorerer alle innvendinger", "Mill innrømmer at teorien er uholdbar", "Mill overlater det fullstendig til leseren selv å finne fram til og besvare alle innvendingene mot hele teorien"],
    ...
    },
    {
      ...
      options: ["Fordi rettferdighetsinnvendingen biter hardere på handlingsnivå, mens regelnivå gir utilitaristen et forsvar", "Fordi handlingsnivået alltid er riktig", "Fordi regelnivået avviser nytte", "Fordi selve skillet mellom handling og regel i praksis ikke har noen som helst betydning for innvendingene mot Mill"],
    ...
    },
    {
      ...
      options: ["Å reise rettferdighetsinnvendingen, gi utilitaristens svar og veie dem, med forbeholden konklusjon", "Å hevde at teorien er perfekt uten innvendinger", "Å liste opp systematisk så mange innvendinger mot teorien som det overhodet er mulig, helt uten å gi noen svar", "Å konkludere uten grunner"],
  ...
  'exphil03-3-4': [
    ...
    },
    {
      ...
      options: ["Identifiser rett-gjørende egenskap → anvend på casen → få fram divergens → vurder med grunner", "Les → oversett → oppsummer → konkluder", "Velg teori → forsvar den → avvis de andre → avslutt", "Beskriv grundig → fortell utfyllende → gjenta alle hovedpoengene → avrund og oppsummer det hele til slutt"],
    ...
    },
    {
      ...
      options: ["Ordningen bruker menneskene bare som midler og krenker deres verdighet, som ikke kan veies mot velferd", "Ordningen gir for lite samlet lykke", "Ordningen bryter en tommelfingerregel", "Selve ordningen er nok noe udydig og lite prisverdig av karakter, men den er likevel ellers fullt ut moralsk tillatt"],
    ...
    },
    {
      ...
      options: ["Nei — begrunnelsene skiller seg og gir ulike svar i randtilfellene", "Ja — når svaret er likt, spiller teorien ingen rolle", "Ja, men dette gjelder utelukkende innenfor selve etikkens eget område", "Nei, fordi teoriene aldri konvergerer"],
    ...
    },
    {
      ...
      options: ["Å behandle de samme dimensjonene for begge teoriene, ikke levere to atskilte oppsummeringer", "Å skrive lengst mulig om hver teori", "Å bare nevne den ene teorien", "Å rangere og sortere alle de ulike moralteoriene rent alfabetisk etter navnet på selve opphavspersonen"],
    ...
    },
    {
      ...
      options: ["Feil #8 — ensidig anvendelse; oppgavene krever ofte to eller tre teorier", "Feil #13 — ignorere premissene", "Feil #10 — en ren formal- og oppsettsfeil i selve besvarelsens struktur og utforming", "Feil #3 — et rent leksikonsvar med generell fakta og lav relevans for selve spørsmålet"],
    ...
    {
      question: "Hvordan lander dydsetikken, brukt som vurderingsverktøy, på slaveri-casen?",
      options: ["Å ta total kontroll over andre springer ikke ut av dyd, men av herskerlyst — ingen dydig person ville gjort det", "Den godtar ordningen fordi velferden stipuleres høy", "Den har ikke noe grep om casen, siden dyder ikke gjelder institusjoner", "Dydsetikken avgjør i realiteten hele denne casen utelukkende ut fra de samlede følgene og konsekvensene av selve ordningen"],
      explanation: "Dydsetikken som verktøy fordømmer ordningen via karakteren — herskerkarakteren er uforenlig med et godt menneske, om enn mindre skarpt formulert enn Kant. Merk skillet fra den historiske Aristoteles, som selv forsvarte «naturlig» slaveri i Politikken; det er teorien, ikke personen, som anvendes her.",
    },
    {
      question: "Hva krever vurderingstrinnet (trinn 4) i firetrinnmetoden?",
      options: ["At du sier hvilken analyse som er mest overbevisende OG viser grunnene, gjerne med forbehold", "At du bare oppgir din mening", "At du velger tilfeldig", "At du bevisst unngår å konkludere klart, og i stedet lar hele spørsmålet stå helt åpent til slutt"],
    ...
    },
    {
      ...
      options: ["Fordi firetrinnmetoden generaliseres til epistemiske caser (f.eks. Lakatos-anvendelse) i kapittel 4.4", "Fordi hele denne metoden i virkeligheten utelukkende lar seg bruke innenfor selve etikken og moralfilosofien", "Fordi den erstatter alle andre metoder", "Fordi den ikke krever teori"],
    ...
    },
    {
      ...
      options: ["Å normalisere bort premisset (feil #13) i stedet for å arbeide innenfor casens stipulasjoner", "Å skrive for kort", "Å bruke for mange teorier", "Å nevne og gjengi altfor mye unødvendig biografisk stoff om selve forfatteren bak den aktuelle teorien"],
  ...
  'exphil03-3-5': [
    ...
    },
    {
      ...
      options: ["Rettferdighet og barmhjertighet", "Dydene mot og måtehold i vanskelige valgsituasjoner", "Klokskap og gavmildhet", "Ærlighet og troskap"],
    ...
    },
    {
      ...
      options: ["Hva vi skylder personen, blant annet respekt for retten til liv og krav om samtykke", "At handlingen gir mest lykke for flest", "At personen har det best mulig", "At samfunnet og hele fellesskapet som helhet spares for størst mulig kostnader og ressursbruk"],
    ...
    },
    {
      ...
      options: ["Retten til å forkorte livet for å forbedre det, og presumpsjonen for personens egen dom", "Rettferdighet og barmhjertighet", "Nytteprinsippet og det kategoriske imperativ", "De to helt grunnleggende liberale prinsippene om frihet og full likhet for alle mennesker"],
    ...
    },
    {
      ...
      options: ["Føre Foots to skranker og Vellemans verdi/gode-skille inn i drøftingen med eksplisitt kobling", "Starte drøftingen på nytt uten å bruke redegjørelsen", "Kopiere en annen kandidats svar", "Utelate hele redegjørelsen fullstendig for å spare mest mulig tid til den avsluttende drøftingsdelen"],
  ...
  'exphil03-3-6': [
    ...
    },
    {
      ...
      options: ["Føre Lockes eiendomsargument og Helds fiksjonskritikk inn i drøftingen med eksplisitt kobling", "Gjenta Locke-triaden som ren definisjonsliste uten å bruke den på spørsmålet", "Bygge drøftingen på allmenn rettferdighetsfølelse i stedet for redegjørelsen", "Nevne Held først i konklusjonen, uten kobling til (a)/(b)"],
  ...
  'exphil03-3-7': [
    ...
    },
    {
      ...
      options: ["Føre Sylvans sjåvinisme-diagnose og teoritrekant-anvendelsen inn i drøftingen med eksplisitt kobling", "Innføre nye miljøfakta i drøftingen som erstatter det (a)/(b) etablerte", "Drøfte naturvern generelt uten å bruke sjåvinisme-diagnosen", "Henvise til redegjørelsen bare med «som nevnt over», uten å bruke innholdet"],
      explanation: "Poeng fra (a)/(b) skal bæres inn i drøftingen. Å starte «på nytt» uten kobling straffes (#5).",
    },
  ],
  'exphil03-3-8': [
    ...
    {
      question: "Hva hevder Benatars feilvurderings-tese IKKE, slik pensumutdraget presenterer den?",
      options: ["At livet objektivt er elendig — tesen sier at vurderingen vår er skjev oppover", "At vi systematisk overvurderer egen livskvalitet", "At tilpasning gjør at vedvarende plager forsvinner fra regnskapet", "At vi sammenligner oss med andre i stedet for med det mulige"],
      explanation: "Tesen i pensumutdraget er en påstand om målefeil, ikke pessimisme; å lese den som «livet er elendig» er en presisjonsfeil (#6). (I andre verker trekker Benatar selv pessimistiske konklusjoner — men det er utenfor tesen slik boka behandler den.)",
    },
    {
    ...
    },
    {
      ...
      options: ["Føre Benatar-mekanismene og lykketeori-koblingen inn i drøftingen med eksplisitt kobling", "Presentere de tre mekanismene på nytt som om de ikke alt var redegjort for", "Drøfte pessimisme generelt uten å bruke koblingen til Mill og Aristoteles", "Spare Benatar-poengene til en avsluttende oppsummering"],
      explanation: "Poeng fra (a)/(b) skal bæres inn i drøftingen. Å starte «på nytt» uten kobling straffes (#5).",
    },
  ],
  'exphil03-4-1': [
    ...
    {
      question: "En kandidat skriver: «Siden vi alltid kan ta feil, vet vi egentlig ingenting.» Hvilket pensumskille overser hun?",
      options: ["Skillet mellom fallibilisme (vi kan ta feil og likevel vite) og skeptisisme (vi vet ingenting)", "Skillet mellom metodisk tvil og drømmeargumentet hos Descartes", "Skillet mellom kunnskapens tre vilkår og de to første alene", "Skillet mellom analytiske og syntetiske dommer hos Kant"],
      explanation: "Slutningen fra «feil er mulig» til «vi vet ingenting» er skeptikerens, ikke fallibilistens. Å la dem gli sammen er den hyppigste presisjonsfeilen i Vite-oppgaver (feil #6).",
    },
    {
  ...
  'exphil03-4-6': [
    ...
    },
    {
      ...
      options: ["Feil #9 — ubalanse kunnskap/analyse", "Feil #4 — hoppe over et delspørsmål", "Feil #1 — gjenfortelling uten drøfting", "Feil #3 — et rent leksikonsvar med generell fakta og lav relevans for selve spørsmålet"],
