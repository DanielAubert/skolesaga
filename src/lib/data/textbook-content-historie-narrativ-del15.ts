      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Som medlemmer av en nasjon med felles språk', isCorrect: false },
              { id: 'b', text: 'Som verdensborgere uten tilhørighet', isCorrect: false },
              { id: 'c', text: 'Som undersåtter av en konge, innbyggere i en by, eller medlemmer av en kirke', isCorrect: true },
              { id: 'd', text: 'Som tilhørende en bestemt politisk ideologi', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Svartedauden', isCorrect: false },
              { id: 'b', text: 'Den franske revolusjonen', isCorrect: true },
              { id: 'c', text: 'Oppdagelsen av Amerika', isCorrect: false },
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Norske dialekter og grammatikk', isCorrect: false },
              { id: 'b', text: 'Vikingtidsskatter og runesteiner', isCorrect: false },
              { id: 'c', text: 'Folkeeventyr fra norske bygder', isCorrect: true },
              { id: 'd', text: 'Kirkesanger og salmer', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'At de brukte for mye penger på innsamlingsreisene', isCorrect: false },
              { id: 'b', text: 'At de bare samlet inn fra Vestlandet', isCorrect: false },
              { id: 'c', text: 'At de valgte ut bestemte elementer og ignorerte andre, som bykultur og unionstid', isCorrect: true },
              { id: 'd', text: 'At de kopierte dansk kultur i stedet for å finne noe eget', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Lindeman', isCorrect: false },
              { id: 'b', text: 'Landstad', isCorrect: false },
              { id: 'c', text: 'Tidemand', isCorrect: false },
        ...
        questions: [
          {
            ...
            options: [
              ...
              { id: 'd', text: 'At nasjonen bare eksisterer i drømmer', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              ...
              { id: 'b', text: 'Francis Fukuyama', isCorrect: false },
              { id: 'c', text: 'Benedict Anderson', isCorrect: true },
              { id: 'd', text: 'Max Weber', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Mediene hadde ingen betydning for nasjonsbygging', isCorrect: false },
              { id: 'b', text: 'Mediene ble brukt til å spre propaganda om kongen', isCorrect: false },
              { id: 'c', text: 'Aviser, bøker og radio ga folk over hele landet felles referanser', isCorrect: true },
              { id: 'd', text: 'Mediene motarbeidet nasjonalfølelsen', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'At Norge fikk nye kolonier', isCorrect: false },
              { id: 'b', text: 'Motstandskampen mot okkupasjonen og frigjøringen', isCorrect: true },
              { id: 'c', text: 'At Norge forble nøytralt hele krigen', isCorrect: false },
              { id: 'd', text: 'At alle nordmenn flyktet til Sverige', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Spørsmålet om oljeutvinning', isCorrect: false },
              { id: 'b', text: 'Innvandring fra Europa', isCorrect: false },
              { id: 'c', text: 'Å definere det norske i kontrast til det danske og svenske', isCorrect: true },
              { id: 'd', text: 'Norges rolle i verdenshandelen', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'At Norge ble en stormakt i Europa', isCorrect: false },
              { id: 'b', text: 'At den skapte fellesskapsfølelse og grunnlag for demokratisk deltakelse', isCorrect: true },
              { id: 'c', text: 'At alle minoriteter ble inkludert', isCorrect: false },
              { id: 'd', text: 'At Norge fikk en stor hær', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'All historie ble fremstilt balansert og nøytralt', isCorrect: false },
              { id: 'b', text: 'Bare moderne historie ble undervist', isCorrect: false },
              { id: 'c', text: 'Historien ble avvist som irrelevant', isCorrect: false },
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'At samer fikk rett til å kjøpe jord overalt', isCorrect: false },
              { id: 'b', text: 'At all jord i Nord-Norge tilhørte staten', isCorrect: false },
              { id: 'c', text: 'At bare norsktalende kunne kjøpe jord', isCorrect: true },
              { id: 'd', text: 'At jord skulle fordeles likt mellom alle folkegrupper', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Militæret', isCorrect: false },
              { id: 'b', text: 'Skolen', isCorrect: true },
              { id: 'c', text: 'Handelsforbud', isCorrect: false },
              { id: 'd', text: 'Utvandring', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'At barna fikk bedre utdanning', isCorrect: false },
              { id: 'b', text: 'At barna lærte å lese og skrive norsk', isCorrect: false },
              { id: 'c', text: 'Skammen over eget språk, som førte til at mange ikke lærte det videre til sine barn', isCorrect: true },
              { id: 'd', text: 'At internatene ble populære utdanningsinstitusjoner', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'De ble oppmuntret til å fortsette', isCorrect: false },
              { id: 'b', text: 'De fikk tolketjenester', isCorrect: false },
              { id: 'c', text: 'Ingenting spesielt -- det var lov å snakke begge språk', isCorrect: false },
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Nasjonalismen hadde ingen kobling til fornorsking', isCorrect: false },
              { id: 'b', text: 'Nasjonalismen krevde respekt for alle kulturer', isCorrect: false },
              { id: 'c', text: 'Ideen om én nasjon med ett folk og ett språk gjorde mangfold til et problem', isCorrect: true },
              { id: 'd', text: 'Nasjonalismen var bare opptatt av utenrikspolitikk', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Frykt for svensk invasjon', isCorrect: false },
              { id: 'b', text: 'Bekymring for at kvener og samer i grenseområdene kunne være mer lojale mot Finland og Russland', isCorrect: true },
              { id: 'c', text: 'Frykt for at samene ville erobre Oslo', isCorrect: false },
              { id: 'd', text: 'Angst for britisk kolonisering av Nord-Norge', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Bare noen få ekstremister sto bak', isCorrect: false },
              { id: 'b', text: 'Bare politikerne mente det, ikke folket', isCorrect: false },
              { id: 'c', text: 'Ideene var mainstream og ble delt av professorer, prester, lærere og politikere', isCorrect: true },
              { id: 'd', text: 'De var bare utbredt blant militære', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Økonomisk fattigdom i samiske områder', isCorrect: false },
              { id: 'b', text: 'Språktap -- flere samiske språk er truet av utryddelse', isCorrect: true },
              { id: 'c', text: 'At samene har mistet sin religion', isCorrect: false },
              { id: 'd', text: 'At samene har forlatt Nord-Norge', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Fordi myndighetene aldri har anerkjent fornorskingen', isCorrect: false },
              { id: 'b', text: 'Fordi etter over hundre år med statlig undertrykkelse er tilliten svekket', isCorrect: true },
              { id: 'c', text: 'Fordi de ikke har stemmerett i Norge', isCorrect: false },
              { id: 'd', text: 'Fordi de ønsker å bli selvstendige', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: '1972', isCorrect: false },
              { id: 'b', text: '1997', isCorrect: true },
              { id: 'c', text: '2010', isCorrect: false },
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'At alle som ble rammet får penger', isCorrect: false },
              { id: 'b', text: 'At samisk språk allerede er fullstendig gjenopprettet', isCorrect: false },
              { id: 'c', text: 'At det gjør det skjedde ugjort', isCorrect: false },
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: '1972', isCorrect: false },
              { id: 'b', text: '1981', isCorrect: false },
              { id: 'c', text: '1988', isCorrect: true },
              { id: 'd', text: '2005', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'En norsk lov om arbeidsrettigheter', isCorrect: false },
              { id: 'b', text: 'En internasjonal konvensjon om urfolks rettigheter som Norge ratifiserte i 1990', isCorrect: true },
              { id: 'c', text: 'En avtale mellom de nordiske landene om samisk samarbeid', isCorrect: false },
              { id: 'd', text: 'En FN-resolusjon om klimaflyktninger', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Bygging av en motorvei gjennom samisk område', isCorrect: false },
              { id: 'b', text: 'Gruvedrift i Finnmark', isCorrect: false },
              { id: 'c', text: 'Planer om å demme opp Altaelva for kraftutbygging', isCorrect: true },
              { id: 'd', text: 'Nedleggelse av samiske skoler', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'At bare samer deltok', isCorrect: false },
              { id: 'b', text: 'At protestene var voldelige', isCorrect: false },
              { id: 'c', text: 'At den skapte brede allianser mellom samer, miljøbevegelsen og kulturpersoner', isCorrect: true },
              { id: 'd', text: 'At den ble ignorert av media', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'I 1981 av statsministeren', isCorrect: false },
              { id: 'b', text: 'I 1997 av kong Harald', isCorrect: false },
              { id: 'c', text: 'I 1989 av kong Olav V', isCorrect: true },
              { id: 'd', text: 'I 2000 av stortingspresidenten', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Det er ingen vesentlig forskjell', isCorrect: false },
              { id: 'b', text: 'Sametinget har lovgivende myndighet over hele Nord-Norge', isCorrect: false },
              { id: 'c', text: 'Sametinget er et rådgivende organ uten lovgivende myndighet', isCorrect: true },
              { id: 'd', text: 'Sametinget har mer makt enn Stortinget i samiske spørsmål', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Alle norske statsborgere', isCorrect: false },
              { id: 'b', text: 'Bare store landbruksselskaper', isCorrect: false },
              { id: 'c', text: 'Bare samer', isCorrect: true },
              { id: 'd', text: 'Bare personer som bor i Finnmark', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'At norsk er forbudt', isCorrect: false },
              ...
              { id: 'c', text: 'At alle i området må lære samisk', isCorrect: false },
              { id: 'd', text: 'At bare samisk brukes i skolen', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'At vindmøllene måtte rives umiddelbart', isCorrect: false },
              { id: 'b', text: 'At vindkraft alltid har forrang foran reindrift', isCorrect: false },
              { id: 'c', text: 'At vindmøllene krenket reindriftssamenes rettigheter etter FNs konvensjon', isCorrect: true },
              { id: 'd', text: 'At samene ikke hadde rett til beiteområdene', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'At miljøbevegelsen vil kolonisere nye land', isCorrect: false },
              { id: 'b', text: 'At urfolk tvinges til å bære kostnadene for majoritetssamfunnets grønne omstilling', isCorrect: true },
              { id: 'c', text: 'At vindkraft er en form for utenlandsk eierskap', isCorrect: false },
              { id: 'd', text: 'At klimapolitikk er det samme som kolonialisme', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'At gruppen har minst 10 000 medlemmer', isCorrect: false },
              { id: 'b', text: 'At gruppen har eget politisk parti', isCorrect: false },
              { id: 'c', text: 'Over hundre års historisk tilknytning til Norge og bevart særegen kultur', isCorrect: true },
              { id: 'd', text: 'At gruppen har et eget territorium i Norge', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Fiske i innsjøer', isCorrect: false },
              { id: 'b', text: 'Brenning av skog for å gjøre jorden fruktbar med aske', isCorrect: true },
              { id: 'c', text: 'Jakt på pelsdyr', isCorrect: false },
              { id: 'd', text: 'Gruvedrift i fjellet', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Den ga romanifolket rett til å reise fritt', isCorrect: false },
              { id: 'b', text: 'Den beskyttet omreisende minoriteters rettigheter', isCorrect: false },
              { id: 'c', text: 'Den kriminaliserte selve levemåten ved å forby reising uten fast bopel', isCorrect: true },
              { id: 'd', text: 'Den regulerte handel mellom omreisende og bofaste', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Privatpersoner som handlet på egen hånd', isCorrect: false },
              { id: 'b', text: 'Utenlandske makter', isCorrect: false },
              { id: 'c', text: 'Staten, gjennom myndigheter, leger og sosialarbeidere', isCorrect: true },
              { id: 'd', text: 'Bare lokale myndigheter i Nord-Norge', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'De fikk gratis utdanning i egne skoler', isCorrect: false },
              { id: 'b', text: 'De ble tatt fra foreldrene og plassert på institusjoner eller i fosterhjem', isCorrect: true },
              { id: 'c', text: 'De ble sendt på ferie til andre land', isCorrect: false },
              { id: 'd', text: 'De fikk spesialundervisning i romani-kultur', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: '200 ble deportert, de fleste overlevde', isCorrect: false },
              { id: 'b', text: '773 ble deportert, bare 38 overlevde', isCorrect: true },
              { id: 'c', text: '5000 ble deportert, halvparten overlevde', isCorrect: false },
              { id: 'd', text: 'Ingen norske jøder ble deportert', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Norske myndigheter forsøkte å stoppe deportasjonene', isCorrect: false },
              { id: 'b', text: 'Norsk politi deltok aktivt i arrestasjonene', isCorrect: true },
              { id: 'c', text: 'Norske myndigheter visste ikke om deportasjonene', isCorrect: false },
              { id: 'd', text: 'Bare tyske soldater gjennomførte arrestasjonene', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Flyktningkrisen i 2015', isCorrect: false },
              { id: 'b', text: 'Arbeidsinnvandring fra Pakistan, Tyrkia og Marokko på 1960-70-tallet', isCorrect: true },
              { id: 'c', text: 'Krigen i Syria', isCorrect: false },
              { id: 'd', text: 'EU-utvidelsen i 2004', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              ...
              { id: 'd', text: 'Ca. 35 prosent', isCorrect: false },
            ],
      ...
      exercise: {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Bare flertallsviljen i demokratiet', isCorrect: false },
              { id: 'b', text: 'Ingenting -- flertallet bestemmer alltid', isCorrect: false },
              { id: 'c', text: 'Menneskerettigheter, som gjelder for alle uansett majoritetens vilje', isCorrect: true },
              { id: 'd', text: 'Bare internasjonale organisasjoner', isCorrect: false },
            ],
          ...
          },
          {
            ...
            options: [
              { id: 'a', text: 'Fordi innvandringen begynte allerede på 1800-tallet', isCorrect: false },
              { id: 'b', text: 'Fordi samer, kvener, romani, jøder og andre har vært her i hundrevis av år', isCorrect: true },
              { id: 'c', text: 'Fordi Norge var en del av Danmark', isCorrect: false },
              { id: 'd', text: 'Fordi Norge alltid har hatt mange flyktninger', isCorrect: false },
            ],
