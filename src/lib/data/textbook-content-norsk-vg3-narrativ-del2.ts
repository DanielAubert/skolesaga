...
Bondefortellingene ble enormt populaere, bade i Norge og i utlandet. De ble oversatt til mange sprak og bidro til a forme bildet av Norge som en nasjon av frie, stolte bonder i et majestetisk landskap. Bjornson hadde gitt nordmenn et speil a se seg selv i - og bildet var smigrende.`,
    ...
    // ========== QUIZ 1 ==========
    {
      ...
      exercise: {
        ...
        task: 'Test deg selv pa Bjornsons oppvekst og gjennombrudd:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'norsk-vg3-1-4-n-quiz1-q0',
            ...
            solution: 'Bjornsons bondefortellinger som «Synnove Solbakken» og «Arne» var idealiserte, poetiske skildringer av norsk bondeland som bidro til a forme det norske selvbildet.',
          },
          {
            id: 'norsk-vg3-1-4-n-quiz1-q1',
            task: 'Hvilken rolle hadde Bjornson i offentligheten?',
            options: [
              { id: 'a', text: 'Han trakk seg tilbake og skrev i stillhet, som Ibsen', isCorrect: false },
              { id: 'b', text: 'Han var bare forfatter og blandet seg aldri i politikk', isCorrect: false },
              { id: 'c', text: 'Han var dikter, folketaler, redaktor og aktiv samfunnsdebattant', isCorrect: true },
              { id: 'd', text: 'Han foretrakk a publisere anonymt', isCorrect: false },
            ],
            solution: 'Bjornson var alt pa en gang: dikter, dramatiker, avisredaktor og folketaler. Der Ibsen trakk seg tilbake i eksil, kastet Bjornson seg ut i offentligheten med alt han hadde.',
          },
        ],
      },
    },
...
Bjornson mente ja. Han var en ihuga forkjemper for kvinners rettigheter, lenge for det var stuerent. Han talte for likestilling, for utdanning for kvinner, for deres rett til a bestemme over egne liv. I dette var han pa linje med Ibsen - men der Ibsen stilte sporsmmlene, ga Bjornson gjerne svarene ogsa.`,
    ...
    // ========== QUIZ 2 ==========
    {
      ...
      exercise: {
        ...
        number: 'Quiz 2',
        type: 'multiple-choice',
        task: 'Test deg selv pa Bjornsons samfunnsdramaer:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'norsk-vg3-1-4-n-quiz2-q0',
            ...
            solution: 'I «En hanske» krever Svava at menn skal holdes til samme moralske standard som kvinner. Nar hun oppdager forlovedets fortid, bryter hun forlovelsen.',
          },
          {
            id: 'norsk-vg3-1-4-n-quiz2-q1',
            task: 'Hva handler «En fallit» om?',
            options: [
              { id: 'a', text: 'En banditts liv pa flukt', isCorrect: false },
              { id: 'b', text: 'Okonomisk krise og borgerskapets hykleri', isCorrect: true },
              { id: 'c', text: 'En students eksamensnervositet', isCorrect: false },
              { id: 'd', text: 'En sjomanns liv til sjoss', isCorrect: false },
            ],
            solution: '«En fallit» (1875) var et frontalangrep pa borgerskapets hykleri - de fine fasadene som skjulte rad og ruin. Stykket tok opp okonomisk krise og moralsk ansvar.',
          },
          {
            id: 'norsk-vg3-1-4-n-quiz2-q2',
            task: 'Hva skilte Bjornsons samfunnsengasjement fra Ibsens?',
            options: [
              { id: 'a', text: 'Bjornson stilte sporsmaal, mens Ibsen ga svar', isCorrect: false },
              { id: 'b', text: 'Bjornson var pa linje med Ibsen i alt', isCorrect: false },
              { id: 'c', text: 'Ibsen stilte sporsmaalene, mens Bjornson gjerne ogsa ga svarene', isCorrect: true },
              { id: 'd', text: 'Bjornson var mer tilbakeholden enn Ibsen', isCorrect: false },
            ],
            solution: 'Der Ibsen stilte de vanskelige sporsmaalene og lot publikum finne sine egne svar, var Bjornson mer direkte. Han ga gjerne svarene ogsa - noe som gjorde dramaene hans mer agitatoriske, men kanskje mindre flertydige.',
          },
        ],
      },
    },
...
Men Bjornsons engasjement strakte seg langt utover Norges grenser. Da den franske offiseren Alfred Dreyfus ble urettmessig domt for spionasje - et justismord preget av antisemittisme - kastet Bjornson seg inn i kampen for hans frikjennelse. Han skrev artikler, holdt taler, og ble en internasjonal rost for rettferdighet. Dette var ikke en sak som angikk Norge - men det angikk Bjornson, fordi det angikk menneskehetens verdighet.`,
    ...
    // ========== QUIZ 3 ==========
    {
      ...
      exercise: {
        ...
        number: 'Quiz 3',
        type: 'multiple-choice',
        task: 'Test deg selv pa Bjornson som folketaler:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'norsk-vg3-1-4-n-quiz3-q0',
            ...
            solution: 'Bjornson engasjerte seg sterkt i Dreyfus-saken, der den franske offiseren ble urettmessig domt for spionasje. Bjornson kjempet for hans frikjennelse.',
          },
          {
            id: 'norsk-vg3-1-4-n-quiz3-q1',
            task: 'Hvilke norske saker engasjerte Bjornson seg i?',
            options: [
              { id: 'a', text: 'Kun litteraere sporsmal', isCorrect: false },
              { id: 'b', text: 'Unionsopplosningen, republikanisme og religios fritenkning', isCorrect: true },
              { id: 'c', text: 'Bare okonomisk politikk', isCorrect: false },
              { id: 'd', text: 'Militaere sporsmal og forsvarspolitikk', isCorrect: false },
            ],
            solution: 'Bjornson engasjerte seg i unionsopplosningen med Sverige, agiterte for republikanisme og kjempet for religios fritenkning. Han mente noe om alt og sa det hoyt.',
          },
        ],
      },
    },
...
Bjornson dode i Paris 26. april 1910. Begravelsen i Kristiania ble en nasjonal begivenhet. Hele byen var pa beina. Kongen fulgte kisten. Nasjonen sorget over sin ukronte konge.`,
    ...
    // ========== QUIZ 4 ==========
    {
      ...
      exercise: {
        ...
        number: 'Quiz 4',
        type: 'multiple-choice',
        task: 'Test deg selv pa Bjornsons hoydepunkter og arv:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'norsk-vg3-1-4-n-quiz4-q0',
            task: 'Hva var spesielt med Bjornsons Nobelpris?',
            options: [
              { id: 'a', text: 'Han var den yngste vinneren noensinne', isCorrect: false },
              { id: 'b', text: 'Han var den forste nordmannen som fikk Nobelprisen i litteratur', isCorrect: true },
              { id: 'c', text: 'Han nektet a ta imot prisen', isCorrect: false },
              { id: 'd', text: 'Han delte prisen med Ibsen', isCorrect: false },
            ],
            solution: 'Bjornson var den forste nordmannen som mottok Nobelprisen i litteratur i 1903.',
          },
          {
            id: 'norsk-vg3-1-4-n-quiz4-q1',
            task: 'Hvilken ironi knytter seg til at Bjornson skrev nasjonalsangen?',
            options: [
              { id: 'a', text: 'Han var egentlig svensk', isCorrect: false },
              { id: 'b', text: 'Han var republikanere, men skrev en sang som hyller «kongenes aett»', isCorrect: true },
              { id: 'c', text: 'Han likte ikke musikken Nordraak skrev', isCorrect: false },
              { id: 'd', text: 'Han angret pa teksten senere', isCorrect: false },
            ],
            solution: 'Det er ironisk at republikaneren Bjornson skrev en nasjonalsang som hyller «kongenes aett». Men nettopp dette kjennetegnet ham: evnen til a favne det nasjonale folelseslivet, selv nar det ikke passet med hans politiske overbevisninger.',
          },
        ],
      },
    },
...
Likevel: Hver gang nordmenn reiser seg og synger «Ja, vi elsker dette landet», lever Bjornson videre. Og det er kanskje den storste udodeligheten av alle.`,
    ...
    // ========== QUIZ 5 ==========
    {
      ...
      exercise: {
        ...
        number: 'Quiz 5',
        type: 'multiple-choice',
        task: 'Test deg selv pa Bjornson vs. Ibsen:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'norsk-vg3-1-4-n-quiz5-q0',
            ...
            solution: 'Ibsens universelle temaer om frihet, sannhet og identitet er like aktuelle i dag. Bjornsons mer direkte agitasjon for spesifikke saker mistet kraft nar sakene var avgjort.',
          },
          {
            id: 'norsk-vg3-1-4-n-quiz5-q1',
            task: 'Hvordan lever Bjornson videre i norsk kultur i dag?',
            options: [
              { id: 'a', text: 'Gjennom dramaene hans som spilles over hele verden', isCorrect: false },
              { id: 'b', text: 'Gjennom nasjonalsangen «Ja, vi elsker dette landet»', isCorrect: true },
              { id: 'c', text: 'Han er helt glemt i dag', isCorrect: false },
              { id: 'd', text: 'Gjennom en statue i Stockholm', isCorrect: false },
            ],
            solution: 'Hver gang nordmenn reiser seg og synger «Ja, vi elsker dette landet», lever Bjornson videre. Nasjonalsangen er kanskje den storste udodeligheten av alle.',
          },
        ],
      },
    },
...
For det er ironien som er Kiellands varemerke. Han skriver med en elegant distanse, en tilsynelatende kjolig tone som bare gjor kritikken desto skarpere. Nar han skildrer borgerskapets middagsselskaper og kirkelige fromhet, aner vi hele tiden spottten under overflaten. Se her, sier Kielland, se pa disse menneskene som tror de er sa respektable. Se hva de egentlig er.`,
    ...
    // ========== QUIZ 1 ==========
    {
      ...
      exercise: {
        ...
        number: 'Quiz 1',
        type: 'multiple-choice',
        task: 'Test deg selv pa Alexander Kiellands stil:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'norsk-vg3-1-5-n-quiz1-q0',
          ...
          {
            id: 'norsk-vg3-1-5-n-quiz1-q1',
            task: 'Hvorfor var Kielland i en spesiell posisjon som forfatter?',
            options: [
              { id: 'a', text: 'Han var fattig og matte skrive for a overleve', isCorrect: false },
              { id: 'b', text: 'Han kom fra en rik familie og skrev fordi han ville, ikke fordi han matte', isCorrect: true },
              { id: 'c', text: 'Han var utdannet laerer og kunne bruke skolen som inspirasjon', isCorrect: false },
              { id: 'd', text: 'Han hadde aldri vaert i Norge', isCorrect: false },
            ],
            solution: 'Kielland kom fra en av Stavangers mektigste kjopmmannsfamilier. Han skrev ikke for a overleve, men fordi han ville avsløre - noe som ga ham en frihet andre forfattere ikke hadde.',
          },
        ],
      },
    },
...
Kielland endte sin karriere som borgermester i Stavanger - en ironisk skjebne for mannen som hadde brukt livet pa a kritisere borgerlige institusjoner. Men kanskje var det nettopp hans bakgrunn som ga ham innsikt. Han kjente systemet fra innsiden.`,
    ...
    // ========== QUIZ 2 ==========
    {
      ...
      exercise: {
        ...
        number: 'Quiz 2',
        type: 'multiple-choice',
        task: 'Test deg selv pa Kiellands hovedverk:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'norsk-vg3-1-5-n-quiz2-q0',
            ...
            solution: '«Gift» er et angrep pa det stive latinskolesystemet der elever matte pugge livslos grammatikk. Tittelen spiller pa bade giftinformasjonen og det dodelige systemet.',
          },
          {
            id: 'norsk-vg3-1-5-n-quiz2-q1',
            task: 'Hva handler novellen «Karen» om?',
            options: [
              { id: 'a', text: 'En rik kvinne som reiser til utlandet', isCorrect: false },
              { id: 'b', text: 'En fattig tjenestepike som blir forfort, gravid og forlatt', isCorrect: true },
              { id: 'c', text: 'En laerinne som kjemper for bedre arbeidsforhold', isCorrect: false },
              { id: 'd', text: 'En prinsesse som rommer fra slottet', isCorrect: false },
            ],
            solution: '«Karen» er historien om en fattig tjenestepike som blir forfort, gravid og forlatt, og som til slutt tar livet av barnet sitt og blir henrettet. Kielland forteller det naermest uten a heve stemmen.',
          },
          {
            id: 'norsk-vg3-1-5-n-quiz2-q2',
            task: 'Hvilken ironisk skjebne fikk Kielland selv?',
            options: [
              { id: 'a', text: 'Han ble prest etter a ha kritisert kirken', isCorrect: false },
              { id: 'b', text: 'Han ble borgermester etter a ha kritisert borgerlige institusjoner', isCorrect: true },
              { id: 'c', text: 'Han ble fattig etter a ha skrevet om rikdom', isCorrect: false },
              { id: 'd', text: 'Han ble laerer etter a ha angrepet skolesystemet', isCorrect: false },
            ],
            solution: 'Kielland endte sin karriere som borgermester i Stavanger - en ironisk skjebne for mannen som hadde brukt livet pa a kritisere borgerlige institusjoner.',
          },
        ],
      },
    },
...
Lies spesialitet var familien - ikke som institusjon a kritisere, men som arena for psykologisk drama. Han forsto at de storste konfliktene ofte utspiller seg mellom mennesker som elsker hverandre, i det stille, i det uuttalte. Hans romaner utforsker det som ligger under overflaten av tilsynelatende harmoniske familieliv.`,
    ...
    // ========== QUIZ 3 ==========
    {
      ...
      exercise: {
        ...
        number: 'Quiz 3',
        type: 'multiple-choice',
        task: 'Test deg selv pa Jonas Lie:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'norsk-vg3-1-5-n-quiz3-q0',
            ...
            solution: 'Lie var opptatt av familien som psykologisk arena. Han utforsket det indre livet og de uuttalte konfliktene mellom mennesker som elsker hverandre.',
          },
          {
            id: 'norsk-vg3-1-5-n-quiz3-q1',
            task: 'Hvorfor ble Lie forfatter?',
            options: [
              { id: 'a', text: 'Fordi han var rik og ville ha et kreativt hobby', isCorrect: false },
              { id: 'b', text: 'Fordi forretningsvirksomheten hans gikk konkurs', isCorrect: true },
              { id: 'c', text: 'Fordi Ibsen overtalte ham', isCorrect: false },
              { id: 'd', text: 'Fordi han vant en skrivekonkurranse', isCorrect: false },
            ],
            solution: 'Der Kielland aldri trengte a tjene penger pa skrivingen, ble Lie forfatter fordi han matte. Forretningsvirksomheten hans gikk konkurs, og litteraturen ble hans vei ut av okonomisk krise.',
          },
        ],
      },
    },
...
Lie dode i 1908, to ar for Bjornson. Han var aldri sa beramt som de andre av «de fire store», men hans psykologiske realisme peker fremover mot det 20. arhundrets litteratur.`,
    ...
    // ========== QUIZ 4 ==========
    {
      ...
      exercise: {
        ...
        number: 'Quiz 4',
        type: 'multiple-choice',
        task: 'Test deg selv pa Lies hovedverk:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'norsk-vg3-1-5-n-quiz4-q0',
            ...
            solution: '«Familien paa Gilje» folger en embetsmannsfamilie pa landsbygda med fokus pa dotrenes drommer og begrensede muligheter.',
          },
          {
            id: 'norsk-vg3-1-5-n-quiz4-q1',
            task: 'Hva er saerpreget ved Lies «Trold»-fortellinger?',
            options: [
              { id: 'a', text: 'De er rene eventyr for barn', isCorrect: false },
              { id: 'b', text: 'De blander realisme med mystikk og folketro', isCorrect: true },
              { id: 'c', text: 'De er vitenskapelige tekster om nordnorsk natur', isCorrect: false },
              { id: 'd', text: 'De er satiriske angrep pa overtro', isCorrect: false },
            ],
            solution: '«Trold»-fortellingene blander realisme med mystikk og folketro fra barndommen i Tromso. De er noe av det mest saerpreget og forsomte i norsk litteratur.',
          },
        ],
      },
    },
...
Sammen fyller de ut bildet av det moderne gjennombruddet. Uten Kielland og Lie ville «de fire store» bare vaert «de to store» - og norsk litteraturhistorie ville vaert fattigere.`,
    ...
    // ========== QUIZ 5 ==========
    {
      ...
      exercise: {
        ...
        number: 'Quiz 5',
        type: 'multiple-choice',
        task: 'Test deg selv pa sammenligningen mellom Kielland og Lie:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'norsk-vg3-1-5-n-quiz5-q0',
            ...
            solution: 'Kielland angrep samfunnet utenfra med ironi og satire, mens Lie utforsket det indre livet og psykologien innenfra.',
          },
          {
            id: 'norsk-vg3-1-5-n-quiz5-q1',
            task: 'Hvorfor var Lies psykologiske realisme nyskapende?',
            options: [
              { id: 'a', text: 'Fordi han brukte vitenskapelige metoder', isCorrect: false },
              { id: 'b', text: 'Fordi han anto det ubevisste for Freud utviklet psykoanalysen', isCorrect: true },
              { id: 'c', text: 'Fordi han skrev pa dialekt', isCorrect: false },
              { id: 'd', text: 'Fordi han var den forste som skrev romaner i Norge', isCorrect: false },
            ],
            solution: 'Lies psykologiske innsikt var pa mange mater mer nyskapende enn Kiellands satire. Han anto det som Freud og psykoanalysen skulle utforske noen tiar senere - det ubevisste, det fortrengte, det som ligger under overflaten.',
          },
        ],
      },
    },
...
Amalie protesterte. Hun mente hun ikke var gal, bare utslitt og deprimert. Men ingen horte pa henne. Legene bestemte. Ektemannen hadde makt. En kvinnes stemme talte ikke.`,
    ...
    // ========== QUIZ 1 ==========
    {
      ...
      exercise: {
        ...
        number: 'Quiz 1',
        type: 'multiple-choice',
        task: 'Test deg selv pa Amalie Skrams liv:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'norsk-vg3-1-6-n-quiz1-q0',
            ...
            solution: 'Amalie ble giftet bort som 17-aring til den eldre sjokapteinen Muller. Ekteskapet var ulykkelig og varte nesten tjue ar for hun fikk skilsmisse.',
          },
          {
            id: 'norsk-vg3-1-6-n-quiz1-q1',
            task: 'Hva skjedde med Amalie Skram i 1894?',
            options: [
              { id: 'a', text: 'Hun vant en litteraer pris', isCorrect: false },
              { id: 'b', text: 'Hun flyttet til Paris', isCorrect: false },
              { id: 'c', text: 'Hun ble innlagt pa lukket psykiatrisk avdeling mot sin vilje', isCorrect: true },
              { id: 'd', text: 'Hun ga ut sin forste roman', isCorrect: false },
            ],
            solution: 'I 1894 ble Skram innlagt pa lukket avdeling pa Kommunehospitalet i Kobenhavn. Denne opplevelsen inspirerte romanene «Professor Hieronimus» og «Paa St. Jorgen».',
          },
        ],
      },
    },
...
Men bak den nokokterne fremstillingen ligger en dyp sympati. Skram dommer ikke sine karakterer. Hun viser at de er ofre - ikke bare for sine egne svakheter, men for et samfunn som gir dem ingen sjanse.`,
    ...
    // ========== QUIZ 2 ==========
    {
      ...
      exercise: {
        ...
        number: 'Quiz 2',
        type: 'multiple-choice',
        task: 'Test deg selv pa Skrams naturalisme:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'norsk-vg3-1-6-n-quiz2-q0',
            ...
            solution: '«Hellemyrsfolket» viser hvordan negative egenskaper gar i arv gjennom generasjoner - en dyster skildring av determinismens jerngrep.',
          },
          {
            id: 'norsk-vg3-1-6-n-quiz2-q1',
            task: 'Hvilken litteraer retning representerer Skram?',
            options: [
              { id: 'a', text: 'Romantikken', isCorrect: false },
              { id: 'b', text: 'Symbolismen', isCorrect: false },
              { id: 'c', text: 'Naturalismen', isCorrect: true },
              { id: 'd', text: 'Modernismen', isCorrect: false },
            ],
            solution: 'Skram regnes som Norges fremste naturalist. Naturalismen tok realismen enda lenger ved a forklare menneskers skjebne gjennom vitenskapelige teorier om arv og miljo.',
          },
        ],
      },
    },
...
Dette var ikke bare litteratur. Det var personlig erfaring, omskapt til kunst. Skram visste hva det ville si a bli fratatt sin stemme, sin kropp, sin frihet. Og hun nektet a tie.`,
    ...
    // ========== QUIZ 3 ==========
    {
      ...
      exercise: {
        ...
        number: 'Quiz 3',
        type: 'multiple-choice',
        task: 'Test deg selv pa Skrams tabuer:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'norsk-vg3-1-6-n-quiz3-q0',
            ...
            solution: 'Skram skrev aepent om tabuemner som kvinners seksualitet og rett til egne folelser, noe som var sjokkerende i samtiden.',
          },
          {
            id: 'norsk-vg3-1-6-n-quiz3-q1',
            task: 'Hva skildrer romanen «Constance Ring»?',
            options: [
              { id: 'a', text: 'En kvinnes kamp for stemmerett', isCorrect: false },
              { id: 'b', text: 'En kvinnes seksuelle oppvakning og rett til egne folelser', isCorrect: true },
              { id: 'c', text: 'En detektivfortelling', isCorrect: false },
              { id: 'd', text: 'En reise til fjerne land', isCorrect: false },
            ],
            solution: 'I «Constance Ring» (1885) skildret Skram en kvinnes seksuelle oppvakning og hennes rett til egne folelser - noe som knapt fantes i litteraturen for.',
          },
          {
            id: 'norsk-vg3-1-6-n-quiz3-q2',
            task: 'Hva skilte Skrams litteratur fra andres behandling av kvinnetemaer?',
            options: [
              { id: 'a', text: 'Hun unngikk kontroversielle emner', isCorrect: false },
              { id: 'b', text: 'Hun skrev fra teori, ikke erfaring', isCorrect: false },
              { id: 'c', text: 'Hun skrev fra egen kropp, eget liv og egen smerte', isCorrect: true },
              { id: 'd', text: 'Hun brukte mannlige pseudonymer', isCorrect: false },
            ],
            solution: 'Skram skrev ikke bare om problemer - hun skrev fra sin egen kropp, sitt eget liv, sin egen smerte. Dette ga litteraturen en autentisitet og kraft som var helt spesiell.',
          },
        ],
      },
    },
...
Skrams boker bidro til debatt om psykiatriens metoder. De ga stemme til de stemmelase. Og de minner oss om at kampen for a bli trodd og hort er en kamp som fortsatt pages.`,
    ...
    // ========== QUIZ 4 ==========
    {
      ...
      exercise: {
        ...
        number: 'Quiz 4',
        type: 'multiple-choice',
        task: 'Test deg selv pa «Professor Hieronimus»:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'norsk-vg3-1-6-n-quiz4-q0',
            ...
            solution: 'Basert pa egne opplevelser avslörte Skram hvordan psykiatrien kunne brukes som maktmiddel mot kvinner.',
          },
          {
            id: 'norsk-vg3-1-6-n-quiz4-q1',
            task: 'Hvordan ble diagnosen «hysteri» brukt som maktmiddel?',
            options: [
              { id: 'a', text: 'Den ga kvinner rett til behandling', isCorrect: false },
              { id: 'b', text: 'Den ugyldiggjorde kvinners protester og opplevelser', isCorrect: true },
              { id: 'c', text: 'Den ble bare brukt pa menn', isCorrect: false },
              { id: 'd', text: 'Den ble aldri brukt i Norge', isCorrect: false },
            ],
            solution: 'Diagnosen «hysteri» ble brukt til a ugyldiggjore kvinners opplevelser. Var du opprort? Hysterisk. Protesterte du? Hysterisk. Pa denne maten kunne menns makt over kvinner opprettholdes med medisinens velsignelse.',
          },
        ],
      },
    },
...
Nar vi leser henne i dag, minner hun oss om hvor mye som sto pa spill for kvinner som ville skrive sin egen sannhet. Og hun minner oss om at litteraturen kan vaere et vaapen - mot makt, mot taushet, mot glemsel.`,
    ...
    // ========== QUIZ 5 ==========
    {
      ...
      exercise: {
        ...
        number: 'Quiz 5',
        type: 'multiple-choice',
        task: 'Test deg selv pa arven etter Skram:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'norsk-vg3-1-6-n-quiz5-q0',
            ...
            solution: 'I dag anerkjennes Skram som en av det moderne gjennombruddets viktigste forfattere. Hennes kompromisslase naturalisme gjor henne fortsatt aktuell.',
          },
          {
            id: 'norsk-vg3-1-6-n-quiz5-q1',
            task: 'Hvem banet veien for kvinner som Skram i norsk litteratur?',
            options: [
              { id: 'a', text: 'Henrik Ibsen', isCorrect: false },
              { id: 'b', text: 'Camilla Collett med «Amtmandens Dotre»', isCorrect: true },
              { id: 'c', text: 'Georg Brandes', isCorrect: false },
              { id: 'd', text: 'Emile Zola', isCorrect: false },
            ],
            solution: 'Camilla Collett hadde banet veien med «Amtmandens Dotre» allerede i 1854. Men Skram gikk lengst - hun blottla seg, tok kostnadene og nektet a tie.',
          },
        ],
      },
    },
...
Men Zola var mer enn en kald observator. Under den kjoolige overflaten ulmet et brennende engasjement. Da den jodiske offiseren Alfred Dreyfus ble urettmessig domt for spionasje, skrev Zola det berammte aapne brevet «J'accuse» - en anklage mot det franske rettsvesenet som ristet hele nasjonen.`,
    ...
    // ========== QUIZ 1 ==========
    {
      ...
      exercise: {
        ...
        number: 'Quiz 1',
        type: 'multiple-choice',
        task: 'Test deg selv pa Zola og naturalismens program:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'norsk-vg3-1-7-n-quiz1-q0',
            ...
            solution: 'Zola argumenterte for at romanen skulle fungere som et vitenskapelig eksperiment der forfatteren observerer karakterer i bestemte miljoer.',
          },
          {
            id: 'norsk-vg3-1-7-n-quiz1-q1',
            task: 'Hva er Zolas hovedverk «Les Rougon-Macquart»?',
            options: [
              { id: 'a', text: 'En enkelt roman om livet i Paris', isCorrect: false },
              { id: 'b', text: 'En romansyklus i tjue bind som folger en slekt gjennom generasjoner', isCorrect: true },
              { id: 'c', text: 'En samling dikt om naturen', isCorrect: false },
              { id: 'd', text: 'Et filosofisk essay', isCorrect: false },
            ],
            solution: '«Les Rougon-Macquart» er en massiv romansyklus i tjue bind som folger en slekt gjennom generasjoner under det franske keiserdommet, og viser hvordan arv former skjebner.',
          },
        ],
      },
    },
...
Disse ideene dannet grunnlaget for naturalismens litteraere program. Forfatteren skulle vaere som en vitenskapsmann: observere, dokumentere, forklare. Ikke doomme, ikke moralisere, ikke tro. Bare se.`,
    ...
    // ========== QUIZ 2 ==========
    {
      ...
      exercise: {
        ...
        number: 'Quiz 2',
        type: 'multiple-choice',
        task: 'Test deg selv pa naturalismens filosofiske grunnlag:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'norsk-vg3-1-7-n-quiz2-q0',
            ...
            solution: 'Determinismen hevder at alle hendelser er bestemt av foregaende arsaker. I naturalismen betyr dette at menneskers skjebner er bestemt av arv og miljo.',
          },
          {
            id: 'norsk-vg3-1-7-n-quiz2-q1',
            task: 'Hva hevdet materialismen?',
            options: [
              { id: 'a', text: 'At penger er det viktigste i livet', isCorrect: false },
              { id: 'b', text: 'At virkeligheten er materiell og bevisstheten bare et biprodukt av hjernen', isCorrect: true },
              { id: 'c', text: 'At kunst bor handle om fysiske gjenstander', isCorrect: false },
              { id: 'd', text: 'At alle bor eie like mye', isCorrect: false },
            ],
            solution: 'Materialismen hevdet at virkeligheten var materiell, at bevisstheten var et biprodukt av hjernen, og at det ikke fantes noen sjel eller noe hoyere enn stoffet.',
          },
          {
            id: 'norsk-vg3-1-7-n-quiz2-q2',
            task: 'Hvilken rolle spilte darwinismen for naturalismen?',
            options: [
              { id: 'a', text: 'Den inspirerte forfattere til a skrive om dyr', isCorrect: false },
              { id: 'b', text: 'Den viste at mennesket var et biologisk vesen underlagt naturlover', isCorrect: true },
              { id: 'c', text: 'Den hadde ingen innflytelse pa litteraturen', isCorrect: false },
              { id: 'd', text: 'Den inspirerte bare vitenskapelig forskning', isCorrect: false },
            ],
            solution: 'Darwinismen viste at mennesket var et dyr blant andre dyr, underlagt naturlover og kampen for tilvaerrelsen. Dette ble et grunnlag for naturalismens syn pa mennesket som biologisk determinert.',
          },
        ],
      },
    },
...
**Miljoobeskrivelsene** var detaljerte og dokumentariske. Zola og hans etterfolgere drev grundig research. De ville at leseren skulle se, hoore, lukte fattigdommens og elendigheten.`,
    ...
    // ========== QUIZ 3 ==========
    {
      ...
      exercise: {
        ...
        number: 'Quiz 3',
        type: 'multiple-choice',
        task: 'Test deg selv pa naturalismens litteraere kjennetegn:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'norsk-vg3-1-7-n-quiz3-q0',
            ...
            solution: 'I naturalistisk litteratur er karakterene determinerte - fanget av arv og miljo med lite handlingsrom.',
          },
          {
            id: 'norsk-vg3-1-7-n-quiz3-q1',
            task: 'Hva kjennetegner stilen i naturalistisk litteratur?',
            options: [
              { id: 'a', text: 'Sterkt folelsesladet og moraliserende', isCorrect: false },
              { id: 'b', text: 'Objektiv og tilbakeholdt, som en vitenskapsmann som observerer', isCorrect: true },
              { id: 'c', text: 'Poetisk og symbolsk', isCorrect: false },
              { id: 'd', text: 'Humoristisk og underholdende', isCorrect: false },
            ],
            solution: 'Den naturalistiske stilen var objektiv og tilbakeholdt. Forfatteren moraliserte ikke, men observerte og rapporterte som en vitenskapsmann - noe som kunne gjore virkningen desto sterkere.',
          },
          {
            id: 'norsk-vg3-1-7-n-quiz3-q2',
            task: 'Hvilken type stoff sokte naturalistene seg ofte til?',
            options: [
              { id: 'a', text: 'Overklassens elegante salongmiljo', isCorrect: false },
              { id: 'b', text: 'Eventyrlige og overnaturlige verdener', isCorrect: false },
              { id: 'c', text: 'Samfunnets skyggesider: fattigdom, sykdom og kriminalitet', isCorrect: true },
              { id: 'd', text: 'Historiske epoker og konger', isCorrect: false },
            ],
            solution: 'Naturalistene sokte seg til samfunnets skyggeside: fattigkvarterer, bordeller, gruver, fengsler. De ville skildre alkoholisme, prostitusjon og sykdom - alt det borgerskapet ville lukke oynene for.',
          },
        ],
      },
    },
...
Zola viser oss elendigheten - men han viser oss ogsa at elendigheten har arsaker. Og det som har arsaker, kan forandres.`,
    ...
    // ========== QUIZ 4 ==========
    {
      ...
      exercise: {
        ...
        number: 'Quiz 4',
        type: 'multiple-choice',
        task: 'Test deg selv pa «Germinal»:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'norsk-vg3-1-7-n-quiz4-q0',
            ...
            solution: '«Germinal» skildrer gruvearbeidernes elendige kar i Nord-Frankrike og en streik som ender i tragedie.',
          },
          {
            id: 'norsk-vg3-1-7-n-quiz4-q1',
            task: 'Hva refererer tittelen «Germinal» til?',
            options: [
              { id: 'a', text: 'Hovedpersonens etternavn', isCorrect: false },
              { id: 'b', text: 'Varenens spiringsmaaned i den revolusjonaere kalenderen', isCorrect: true },
              { id: 'c', text: 'Et gruveskaft', isCorrect: false },
              { id: 'd', text: 'En by i Nord-Frankrike', isCorrect: false },
            ],
            solution: 'Tittelen «Germinal» refererer til varenens spiringsmaaned i den franske revolusjonaere kalenderen. Det antyder at froene som saaes, kanskje vil spire - at haapet lever under asken.',
          },
        ],
      },
    },
...
Og sporsmaalet de stilte, er fortsatt aktuelt: I hvilken grad er vi frie? I hvilken grad er vi formet av krefter vi ikke kontrollerer? Det er et sporsmal som aldri blir ferdig besvart.`,
    ...
    // ========== QUIZ 5 ==========
    {
      ...
      exercise: {
        ...
        number: 'Quiz 5',
        type: 'multiple-choice',
        task: 'Test deg selv pa naturalismens kritikk og arv:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'norsk-vg3-1-7-n-quiz5-q0',
            ...
            solution: 'Kritikere mente naturalismen var for pessimistisk, dvaelte ved det stygge og reduserte mennesket til et dyr uten fri vilje.',
          },
          {
            id: 'norsk-vg3-1-7-n-quiz5-q1',
            task: 'Hva var naturalismens varige bidrag til litteraturen?',
            options: [
              { id: 'a', text: 'Den la grunnlaget for den sosiale romanen og reportasjelitteraturen', isCorrect: true },
              { id: 'b', text: 'Den fjernet all sosial kritikk fra litteraturen', isCorrect: false },
              { id: 'c', text: 'Den inspirerte bare symbolismen', isCorrect: false },
              { id: 'd', text: 'Den hadde ingen varig betydning', isCorrect: false },
            ],
            solution: 'Selv om naturalismen som bevegelse varte kort, lever innflytelsen videre gjennom den sosiale romanen, reportasjelitteraturen og den kompromisslase realismen i moderne litteratur.',
          },
        ],
      },
    },
...
Zola tok Bernard som forbilde. Hvis kroppen kunne studeres vitenskapelig, hvorfor ikke ogsa sjelen? Forfatteren skulle vaere som fysiologen - plassere mennesker i kontrollerte omgivelser og observere hvordan de reagerte.`,
    ...
    // ========== QUIZ 1 ==========
    {
      ...
      exercise: {
        ...
        number: 'Quiz 1',
        type: 'multiple-choice',
        task: 'Test deg selv pa den vitenskapelige bakgrunnen:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'norsk-vg3-1-8-n-quiz1-q0',
            ...
            solution: 'Darwin viste at mennesket ikke var skapt av Gud, men utviklet gjennom evolusjon. Dette rystet datidens verdensbilde fundamentalt.',
          },
          {
            id: 'norsk-vg3-1-8-n-quiz1-q1',
            task: 'Hva hevdet Hippolyte Taine?',
            options: [
              { id: 'a', text: 'At kunst er den hoyeste formen for menneskelig aktivitet', isCorrect: false },
              { id: 'b', text: 'At alle kulturelle fenomener kan forklares ut fra rase, miljo og oyeblikk', isCorrect: true },
              { id: 'c', text: 'At mennesket er grunnleggende godt', isCorrect: false },
              { id: 'd', text: 'At religion er viktigere enn vitenskap', isCorrect: false },
            ],
            solution: 'Taine hevdet at alle kulturelle fenomener kunne forklares ut fra tre faktorer: rase (arvelige egenskaper), miljo og oyeblikk (den historiske situasjonen). Mennesket var et produkt av disse kreftene.',
          },
        ],
      },
    },
...
Vi vet i dag at dette var uvitenskapelig. Alkoholisme er ikke arvelig pa den maten de trodde. Personlighet formes av bade gener og miljo pa komplekse mater. Men i samtiden var det anerkjent vitenskap - og det preget litteraturen dypt.`,
    ...
    // ========== QUIZ 2 ==========
    {
      ...
      exercise: {
        ...
        number: 'Quiz 2',
        type: 'multiple-choice',
        task: 'Test deg selv pa arv i naturalismen:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'norsk-vg3-1-8-n-quiz2-q0',
            ...
            solution: 'Degenerasjonslaren hevdet at negative egenskaper ble forsterket gjennom arv. Teorien er i dag fullstendig avvist.',
          },
          {
            id: 'norsk-vg3-1-8-n-quiz2-q1',
            task: 'Hvordan vises arvens makt i Skrams «Hellemyrsfolket»?',
            options: [
              { id: 'a', text: 'Slekten forbedres for hver generasjon', isCorrect: false },
              { id: 'b', text: 'Sjur Gabriels svakheter gar i arv og forsterkes gjennom generasjonene', isCorrect: true },
              { id: 'c', text: 'Arven spiller ingen rolle i handlingen', isCorrect: false },
              { id: 'd', text: 'Bare de fysiske egenskapene gar i arv', isCorrect: false },
            ],
            solution: 'I «Hellemyrsfolket» gar Sjur Gabriels svakheter i arv til sonnene og videre. For hver generasjon forsterkes det negative, og det finnes ingen vei ut av sirkelen.',
          },
        ],
      },
    },
...
I naturalistisk litteratur ser vi ofte mennesker som prooever a bryte ut av sitt miljo. De kjemper, strever, droommer om noe bedre. Men igjen og igjen mislykkes de. Miljoets gravitasjon er for sterk. De synker tilbake til der de startet - eller enda lenger ned.`,
    ...
    // ========== QUIZ 3 ==========
    {
      ...
      exercise: {
        ...
        number: 'Quiz 3',
        type: 'multiple-choice',
        task: 'Test deg selv pa miljoets rolle i naturalismen:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'norsk-vg3-1-8-n-quiz3-q0',
            ...
            solution: 'Naturalistene ville at miljooskildringene skulle vaere dokumentarisk nooyaktige. Zola dro selv ned i gruvene for a skildre gruvearbeidere.',
          },
          {
            id: 'norsk-vg3-1-8-n-quiz3-q1',
            task: 'Hva skjer typisk med karakterer som prover a bryte ut av sitt miljo i naturalistisk litteratur?',
            options: [
              { id: 'a', text: 'De lykkes alltid til slutt', isCorrect: false },
              { id: 'b', text: 'De mislykkes og synker tilbake eller enda lenger ned', isCorrect: true },
              { id: 'c', text: 'De flytter til et annet land', isCorrect: false },
              { id: 'd', text: 'De finner hjelp fra en rik velgjorer', isCorrect: false },
            ],
            solution: 'I naturalistisk litteratur prover karakterer ofte a bryte ut, men mislykkes. Miljoets gravitasjon er for sterk - de synker tilbake til der de startet, eller enda lenger ned.',
          },
        ],
      },
    },
...
Og likevel - nettopp ved a vise denne virkeligheten, anklaget naturalistene samfunnet som tillot det. De sa: Se her. Se hva som skjer med mennesker under disse forholdene. Er dette akseptabelt?`,
    ...
    // ========== QUIZ 4 ==========
    {
      ...
      exercise: {
        ...
        number: 'Quiz 4',
        type: 'multiple-choice',
        task: 'Test deg selv pa konsekvensene for litteraturen:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'norsk-vg3-1-8-n-quiz4-q0',
            ...
            solution: 'Naturalistiske romaner folger en nedadgaaende kurve der karakterene gradvis synker dypere og ender i tragedie.',
          },
          {
            id: 'norsk-vg3-1-8-n-quiz4-q1',
            task: 'Hvorfor holdt forfatteren seg tilbake fra a moralisere?',
            options: [
              { id: 'a', text: 'Fordi de var likegyldige til karakterene', isCorrect: false },
              { id: 'b', text: 'Fordi de ville at leseren selv skulle reagere og doomme', isCorrect: true },
              { id: 'c', text: 'Fordi det var forbudt a moralisere', isCorrect: false },
              { id: 'd', text: 'Fordi de ikke hadde noen mening om samfunnet', isCorrect: false },
            ],
            solution: 'Den kjoolige, observerende tonen var bevisst. Ved a vise virkeligheten uten moralsk kommentar ble virkningen sterkere - leseren matte selv reagere og doomme.',
          },
        ],
      },
    },
...
Disse sporsmalene lever videre - i filosofien, i jussen, i den offentlige debatten om kriminalitet og straff, ulikhet og muligheter. Naturalismen ga ikke svarene. Men den formulerte sporsmaalene med en klarhet vi fortsatt kan laere av.`,
    ...
    // ========== QUIZ 5 ==========
    {
      ...
      exercise: {
        ...
        number: 'Quiz 5',
        type: 'multiple-choice',
        task: 'Test deg selv pa determinismens aktualitet:',
        options: [{ id: 'a', text: 'placeholder', isCorrect: true }],
        solution: '',
        questions: [
          {
            id: 'norsk-vg3-1-8-n-quiz5-q0',
            ...
            solution: 'Moderne vitenskap viser at forholdet mellom arv og miljo er mer komplekst enn naturalistene antok. Vi er verken fullt determinerte eller fullt frie.',
          },
          {
            id: 'norsk-vg3-1-8-n-quiz5-q1',
            task: 'Hva er epigenetikk?',
            options: [
              { id: 'a', text: 'Studiet av gen-redigering', isCorrect: false },
              { id: 'b', text: 'Laeren om hvordan miljo pavirker genenes uttrykk', isCorrect: true },
              { id: 'c', text: 'En teori om at gener ikke eksisterer', isCorrect: false },
              { id: 'd', text: 'En gammel filosofisk retning', isCorrect: false },
            ],
            solution: 'Epigenetikk viser at miljo pavirker genenes uttrykk - arv og miljo kan ikke skilles skarpt. Dette nyanserer bade naturalismens strenge determinisme og ideen om fullstendig frihet.',
          },
          {
            id: 'norsk-vg3-1-8-n-quiz5-q2',
            task: 'Hvor lever naturalismens sporsmal videre i dag?',
            options: [
              { id: 'a', text: 'De er fullstendig uaktuelle', isCorrect: false },
              { id: 'b', text: 'Bare i litteraturforskning', isCorrect: false },
              { id: 'c', text: 'I debatter om straff, ulikhet og forholdet mellom individ og samfunn', isCorrect: true },
              { id: 'd', text: 'Bare i naturvitenskapen', isCorrect: false },
            ],
            solution: 'Naturalismens sporsmaal om frihet og ansvar lever videre i debatter om kriminalitet og straff, sosial ulikhet og muligheter. Hvor mye er valg, og hvor mye er skjebne?',
          },
        ],
      },
    },
