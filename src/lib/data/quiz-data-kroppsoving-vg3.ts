...
const quizData_kroppsoving_vg3: Record<string, QuizQuestion[]> = {
  'kroppsoving-vg3-1': [
  {
  ...
  },
  {
    ...
    options: ['Autonomi, kompetanse og tilhørighet', 'Mat, søvn og trening', 'Styrke, utholdenhet og bevegelighet', 'Penger, status og makt'],
    explanation: 'Når disse tre behovene dekkes, øker indre motivasjon og sjansen for varig aktivitet.',
  },
  {
  ...
  'kroppsoving-vg3-2': [
  {
    question: 'Hva er en helsefremmende livsstil?',
    options: ["Et mønster av helsebevisste valg som fremmer fysisk, psykisk og sosial helse", "Å leve slik at man aldri blir syk og fullstendig unngår all sykdom i livet", "Å følge strenge dietter og faste kostholdsregler for å kontrollere vekten sin", "Å trene så mye og så hardt som overhodet mulig for å oppnå toppform raskt"],
    explanation: 'Helsefremmende livsstil inkluderer aktivitet, kosthold, søvn, stressmestring og sosiale relasjoner.',
  },
  {
  ...
  {
    question: 'Hva er progresjonsprinsippet?',
    options: ["Gradvis økning av belastning over tid for å oppnå fremgang", "Å starte med maksimal belastning", "Å gjenta nøyaktig samme øvelse med lik belastning hver eneste dag", "Å starte treningen med maksimal belastning helt fra første økt av"],
    explanation: 'Progresjon sikrer at kroppen kontinuerlig får nye stimuli å tilpasse seg.',
  },
  {
  ...
  {
    question: 'Hva kjennetegner mestringsorientering?',
    options: ["Fokus på egen utvikling, ser innsats som vei til suksess", "Sammenligner seg alltid med andre", "Fokus på å slå og prestere bedre enn alle de andre rundt seg", "En tendens til å unngå utfordringer som kan avsløre svakheter"],
    explanation: 'Mestringsorienterte personer fokuserer på læring og utvikling fremfor sammenligning.',
  },
  {
    question: 'Hva er flow?',
    options: ["Total oppslukelse i aktiviteten med balanse mellom utfordring og ferdighet", "Å ta det helt med ro og senke tempoet fullstendig under aktivitet", "En rolig treningsform beslektet med yoga og bevisst pusteøvelser", "Følelsen av å flyte lett og fritt i vannet mens man svømmer"],
    explanation: 'Flow oppstår når utfordringen matcher ferdighetsnivået og gir dyp tilfredsstillelse.',
  },
  {
  ...
  'kroppsoving-vg3-5': [
  {
    ...
    options: ["Bruk av forbudte stoffer eller metoder for å forbedre prestasjon", "All bruk av medisiner og reseptbelagte legemidler under trening", "Å innta kosttilskudd som proteinpulver og vitaminer i forbindelse med trening", "Å trene altfor mye og hardt slik at kroppen blir overbelastet"],
    explanation: 'Doping defineres av WADA-listen og inkluderer stoffer, metoder og tilrettelegging.',
  },
  {
    question: 'Hvorfor er doping et etisk problem?',
    options: ["Bryter med fair play, helseskadelig, undergraver idrettens integritet", "Det medfører ingen konsekvenser verken for helse eller for idretten", "Alle utøvere gjør det uansett, så det spiller egentlig ingen rolle", "Det er utelukkende et juridisk problem fordi det bryter loven"],
    explanation: 'Doping undergraver grunnleggende verdier som ærlighet, rettferdighet og helse.',
  },
  {
  ...
  {
    question: 'Hva er de 7 prinsippene i Leave No Trace?',
    options: ["Planlegg, bruk slitesterke underlag, håndter avfall, la være, minimer bål, respekter dyr, vis hensyn", "Det handler kun om det ene prinsippet å ikke legge igjen søppel i naturen", "Det handler grunnleggende om å holde seg helt borte fra naturen og utmark", "Det handler først og fremst om alltid å tenne bål for varme og matlaging"],
    explanation: 'Leave No Trace gir veiledning for minimal påvirkning på naturen.',
  },
  {
  ...
  {
    question: 'Hva er nærmiljøfriluftsliv?',
    options: ['Å utforske natur nær der du bor', 'Å bare gå på fjelltur', 'Å reise langt for naturopplevelser', 'Å drive med ekstremsport'],
    explanation: 'Nærmiljøfriluftsliv er bærekraftig og lett å opprettholde som vane.',
  },
],
  ...
  {
    question: 'Hva er de fire grunnleggende elementene i dans?',
    options: ["Rom, tid, kraft og kropp", "Trening og konkurranse", "Musikk, kostyme, scene og publikum", "Musikk og kostyme"],
    explanation: 'Ved å variere disse elementene skaper man ulike uttrykk i dans.',
  },
  {
  ...
  'kroppsoving-vg3-9': [
  {
    ...
    options: ["En systematisk prosess der du vurderer egen kompetanse og utvikling opp mot kriterier og mål", "Å måle egen verdi ved stadig å sammenligne prestasjonene med de flinkeste i klassen", "En standardisert test som noen andre gjennomfører og tolker resultatene av for deg", "En prosess der læreren alene fastsetter karakter uten at du deltar i vurderingen"],
  ...
  },
  {
    ...
    options: ["Å tenke om egen tenkning og læring", "Å måle pulsen under aktivitet", "Å trene opp maksimal styrke og eksplosiv kraft i muskulaturen", "Å trene maksimal styrke"],
  ...
  },
  {
    ...
    options: ["Treningsdagbok eller -logg", "Karakteren fra forrige år", "Karakteren man fikk i kroppsøving forrige skoleår", "En enkelt maksimaltest"],
  ...
  },
  {
    ...
    options: ["Den gir bevisstgjøring om styrker og svakheter og ansvar for egen utvikling", "Den erstatter behovet for fysisk aktivitet og trening helt og holdent", "Den gjør at man kan hoppe over treningsøktene og likevel utvikle seg", "Den har verdi utelukkende i konkurransesituasjoner mot andre utøvere"],
  ...
  },
  {
    ...
    options: ["En samling av arbeider over tid som viser bredde, dybde og utvikling", "En treningsøkt med maksimal belastning", "En enkeltstående prøve som måler kompetansen på ett bestemt tidspunkt", "En krevende treningsøkt der man tester maksimal belastning i ulike øvelser"],
  ...
  'kroppsoving-vg3-10': [
  {
    ...
    options: ["Å se fysisk aktivitet som en livslang praksis som tilpasses ulike aldre og livssituasjoner", "Å legge opp til å avslutte all fysisk aktivitet etter at man fyller 30 år", "Å trene på maksimalt nivå gjennom hele livet uansett alder og livsfase", "Å være fysisk aktiv kun i årene man går på skole og deretter avslutte"],
  ...
  },
  {
    ...
    options: ["Tidsklemme der prioritering av aktivitet utfordres av familie og karriere", "At det finnes svært få tilbud og muligheter for aktivitet for voksne", "At kroppen i denne alderen ikke lenger tåler noen form for trening", "At kapasiteten er så høy at trening blir unødvendig i denne fasen"],
  ...
  },
  {
    ...
    options: ["Å lære mange ferdigheter og ha flere aktiviteter å velge mellom", "Å spesialisere seg på kun én idrett tidlig", "Å spesialisere seg tidlig på kun én bestemt idrett og satse alt der", "Å konsentrere all treningen om styrke og la andre ferdigheter ligge"],
...
export default quizData_kroppsoving_vg3;
