...
const quizData_krle_9: Record<string, QuizQuestion[]> = {
  "krle-9-1-1": [
    {
      question: "Nårstårtet reformasjonen?",
    ...
    },
    {
      ...
      options: ["At kirken tilga synder mot betaling", "Handel med religiose bøker", "At munkene drev handel med varer mellom klostrene", "Salg av kirkebygninger"],
      explanation: "Avlatshandel var salg av tilgivelse for synder, noe Luther sterkt kritiserte.",
    },
    {
      question: "Hva betyr \"sola scriptura\"?",
      options: ["Bibelen alene er autoritet", "Bare paven kan tolke Bibelen", "Skriften er hellig", "Bibelen måvære pålatin"],
      explanation: "Sola scriptura betyr at Bibelen alene er autoritet i trosspørsmål.",
    },
    {
      question: "Hva betyr \"sola fide\"?",
      options: ["Frelse ved tro alene", "Frelse ved gjerninger", "Frelse ved paven", "Frelse ved penger"],
      explanation: "Sola fide betyr at frelse kommer gjennom tro alene, ikke gjerninger.",
    },
    {
      question: "Nårble reformasjonen innfort i Norge?",
      options: ["1537", "1517", "1814", "1905"],
      explanation: "Reformasjonen ble innfort i Norge i 1537.",
    },
  ],
  "krle-9-1-2": [
    {
    ...
    {
      question: "I hvilke deler av verden vokser kristendømmen mest?",
      options: ["Afrika og Latin-Amerika", "Europa og Nord-Amerika", "Australia og New Zealand", "Skandinavia og Russland"],
      explanation: "Kristendømmen vokser mest i Afrika, Latin-Amerika og deler av Asia.",
    },
    {
      question: "Nårsluttet Den norske kirke a være statskirke?",
    ...
    {
      question: "Hva betyr det at kristendømmens tyngdepunkt flytter seg?",
      options: ["Kristendømmen vokser i sor og synker i nord", "Paven flytter til Sor-Amerika", "At det bare bygges nye kirkebygg i de sorlige landene", "At nordmenn flest blir langt mer religiose enn tidligere"],
      explanation: "Kristendømmen vokser i det globale sor mens den svekkes i nord.",
    },
  ],
  "krle-9-2-1": [
    {
      question: "Hva er de seks trosartiklene i islam?",
      options: ["Allah, englene, skriftene, profetene, dømmedag og forutbestemmelse", "De hellige tekstene Koranen og hadith som veileder alle muslimer", "De fem søylene: trosbekjennelse, bønn, faste, almisse og pilegrimsreise", "Troen på Allah og profeten Muhammad som hans sendebud alene"],
  ...
  "krle-9-2-2": [
    ...
    },
    {
      ...
      options: ["Uenighet om hvem som skulle lede etter Muhammad", "De tror påforskjellige guder", "At de to retningene tilber helt forskjellige guder", "At de holder sin ukentlige bønnedag på ulike dager"],
    ...
    {
      question: "Ca. hvor mange muslimer bor iNorge?",
      options: ["200 000-250 000", "Rundt 50 000", "Rundt 1 million", "Rundt 500"],
      explanation: "Det bor ca. 200 000-250 000 muslimer i Norge i dag.",
    },
    {
  ...
  "krle-9-3-1": [
    ...
    {
      question: "Hva mener Buddha er årsaken til lidelse?",
      options: ["Begjaer og tilknytning", "For lite penger", "At onde guder straffer menneskene", "Andre mennesker"],
      explanation: "Buddha lærer at lidelse skyldes begjær og tilknytning til ting.",
    },
    {
      question: "Hva er de tre hovedkategoriene i den attefoldige veien?",
      options: ["Visdom, etisk adferd og meditasjon", "Bonn, faste og pilegrimsreise", "Læren om karma, dharma og moksha i samspill", "Karma, dharma og moksha"],
      explanation: "Den attefoldige veien deles i visdom, etisk adferd og meditasjon.",
    },
  ],
  "krle-9-3-2": [
    {
    ...
    {
      question: "Hvilken gud har elefanthode?",
      options: ["Ganesha", "Shiva", "Krishna", "Vishnu"],
      explanation: "Ganesha er guden med elefanthode, kjent som hindringenes fjerner.",
    },
    {
  ...
  "krle-9-4-1": [
    {
      ...
      options: ["Viktige verdier står mot hverandre, alle valg har negative sider", "At det alltid finnes bare ett riktig og opplagt svar", "At det egentlig handler om matematikk og tallregning", "At det alltid er helt enkelt og greit å velge riktig"],
    ...
    },
    {
      ...
      options: ["Beskrive situasjonen", "Spørre andre om råd", "Ta en rask beslutning", "Ignorere problemet"],
      explanation: "Først måman forstå og beskrive situasjonen for man kan analysere.",
    },
    {
      question: "Hva sier konsekvensetikk om trikk-dilemmaet?",
      options: ["Trekk i spaken - fem liv er mer enn ett", "At bare egne følelser skal telle her", "La være å gripe inn i det hele tatt", "Spørre en prest om hva som er rett"],
      explanation: "Konsekvensetikk vurderer resultatet: a redde fem liv er bedre enn ett.",
    },
    {
      question: "Hva sier pliktetikk om a drepe aktivt?",
      options: ["Det er galt a drepe aktivt, selv for a redde flere", "Det er alltid helt greit å drepe aktivt", "Bare konsekvensene av handlingen teller", "Faste moralregler er helt unødvendige"],
      explanation: "Pliktetikk mener at a drepe aktivt er galt, uansett konsekvenser.",
    },
    {
      question: "Hvilke moderne etiske dilemmaer diskuteres i dag?",
      options: ["Personvern vs. sikkerhet, klima, medisin", "Ingen nye dilemmaer, alt er avgjort", "Bare gamle spørsmål fra fortiden", "Bare rent religiose trosspørsmål"],
      explanation: "Moderne dilemmaer inkluderer teknologi, miljø, medisin og global rettferdighet.",
    },
  ],
  "krle-9-1-3": [
    {
      question: "Hva legger pinsebevegelsen særlig vekt på?",
      options: ["Den hellige ånds gaver, som tungetale, profeti og helbredelse", "Dyrking av ikoner, helgener og Jomfru Maria i bønn", "Streng faste og botsøvelser gjennom hele kirkeåret", "Pavens autoritet og de sju sakramentene i kirken"],
      explanation: "Pinsebevegelsen vektlegger Den hellige ånds gaver (karismer). Navnet kommer fra pinsedagen i Apostlenes gjerninger.",
    },
    {
      question: "Når og hvor oppsto pinsebevegelsen?",
      options: ["I USA rundt 1906", "I Tyskland i 1517", "I Roma på 300-tallet", "I Norge i 1956"],
      explanation: "Pinsebevegelsen oppsto i USA rundt 1906 og har i dag over 600 millioner tilhengere globalt.",
    },
    {
    ...
    {
      question: "Hva er en frikirke?",
      options: ["Et kristent trossamfunn som er uavhengig av stat og folkekirke", "En kirke som bare holder gudstjenestene sine på internett", "En kirke som ikke har noen faste regler eller ledere", "En kirke der man slipper å betale for å komme inn"],
      explanation: "Frikirker er kristne menigheter og kirkesamfunn som organiserer seg uavhengig av staten og folkekirken.",
    },
    {
  ...
  "krle-9-1-4": [
    {
      question: "Hvem publiserte evolusjonsteorien, og når?",
      options: ["Charles Darwin i 1859", "Isaac Newton i 1687", "Albert Einstein i 1905", "Galileo Galilei i 1610"],
      explanation: "Charles Darwin publiserte teorien om evolusjon ved naturlig utvalg i boken Artenes opprinnelse i 1859.",
    },
    {
      question: "Hva hevder ung-jord-kreasjonisme?",
      options: ["At jorden er ca. 6000-10 000 år gammel og ble skapt på seks bokstavelige dager", "At jorden er flere milliarder år gammel, slik forskningen mener", "At evolusjonen er selve metoden Gud brukte da han skapte livet", "At universet alltid har eksistert og aldri egentlig ble skapt"],
      explanation: "Ung-jord-kreasjonisme leser Bibelens skapelsesberetning bokstavelig og hevder at jorden er noen tusen år gammel.",
    },
    {
      question: "Hva er teistisk evolusjon?",
      options: ["Synet at Gud skaper gjennom evolusjonsprosessen", "Synet at evolusjon ikke har skjedd", "Synet at naturen styrer seg selv helt uten noen skapende Gud", "Synet at Bibelen må leses helt bokstavelig om skapelsen på seks dager"],
      explanation: "Mange kristne aksepterer evolusjonen og ser den som Guds måte å skape på -- dette kalles teistisk evolusjon.",
    },
    {
    ...
    {
      question: "Hvilke typer bevis støtter evolusjonsteorien?",
      options: ["Fossiler, genetikk og sammenlignende anatomi", "Ingen -- den er bare en gjetning", "Flertallsavstemninger blant forskerne om hva de tror er sant", "Filosofiske tankeeksperimenter uten noen form for observasjon"],
      explanation: "Evolusjonsteorien er støttet av omfattende bevis fra blant annet fossiler, genetikk og sammenlignende anatomi.",
    },
  ],
  "krle-9-1-5": [
    {
      question: "Hva er komplementarisme i kristen sammenheng?",
      options: ["Synet at menn og kvinner er likeverdige, men skapt med ulike roller", "Synet at menn og kvinner kan ha alle de samme rollene", "En lære om hvilke farger og symboler som passer til de ulike kirkeårstidene", "Synet at kun kvinner har rett til å lede menigheten og forkynne fra prekestolen"],
      explanation: "Komplementarisme er synet at kjønnene er likeverdige, men har ulike roller -- blant annet et mannlig lederansvar i kirke og familie.",
    },
    {
      question: "Hva er egalitarisme i spørsmålet om kjønn og kirke?",
      options: ["Synet at menn og kvinner er fullt likestilte og kan ha de samme rollene", "Synet at kjønnene har faste, ulike roller", "Synet at bare menn kan være fullverdige medlemmer av menighetens fellesskap", "Synet at kjønnene er skapt med faste og adskilte roller som ikke bør byttes om"],
      explanation: "Egalitarisme er synet at menn og kvinner er fullt likestilte, også når det gjelder lederroller i kirken.",
    },
    {
      question: "Hva står forkortelsen LHBT+ for?",
      options: ["Lesbiske, homofile, bifile, transpersoner og flere andre identiteter", "Lov om homofiles borgerlige tilhørighet", "En moderne oversettelse av Bibelen tilpasset ungdom og nye lesergrupper", "En internasjonal sammenslutning av kirkesamfunn og religiøse organisasjoner"],
      explanation: "LHBT+ står for lesbiske, homofile, bifile og transpersoner, der + inkluderer blant annet interkjønnede og aseksuelle.",
    },
    {
      question: "Hvordan varierer synet på ordinasjon av kvinner blant kristne kirkesamfunn?",
      options: ["Noen kirkesamfunn ordinerer kvinner som prester, andre gjør det ikke", "Spørsmålet diskuteres ikke i kristendommen", "Spørsmålet om kvinnelige prester regnes som ferdig avklart i kristendommen", "Alle kristne kirkesamfunn ordinerer nå kvinner som både prester og biskoper"],
      explanation: "Den norske kirke ordinerer kvinner som prester og biskoper, mens for eksempel Den katolske kirke ikke gjør det.",
    },
    {
      question: "Hva viser mangfoldet av kristne syn på kjønn og samliv?",
      options: ["At kristne tradisjoner tolker Bibelen og tradisjonen ulikt", "At spørsmålene er avgjort én gang for alle", "At alle kristne til enhver tid er fullstendig enige om kjønn og samliv", "At disse spørsmålene ble endelig avgjort og lukket allerede i oldkirken"],
      explanation: "Innenfor kristendommen finnes både konservative og liberale syn, fordi tekster og tradisjon tolkes ulikt.",
    },
  ],
  "krle-9-2-3": [
    {
  ...
  "krle-9-2-4": [
    {
      question: "Hva betyr ordet hijab bokstavelig?",
      options: ["«Skjerm» eller «gardin»", "«Hellig plagg»", "«Bønn» eller «tilbedelse»", "«Hellig plagg» eller «renhet»"],
      explanation: "Hijab betyr bokstavelig «skjerm» eller «gardin» og brukes vanligvis om hodeslør som dekker håret, men ikke ansiktet.",
    },
    {
      question: "Hva er en niqab?",
      options: ["Et ansiktsslør som dekker alt unntatt øynene", "Et hodeslør som bare dekker håret", "En bønnekrans med perler som brukes når muslimer minnes Guds navn", "En egen type moské som er bygget spesielt for kvinnelige besøkende"],
      explanation: "Niqab er et ansiktsslør som dekker alt unntatt øynene, mens burka er et heldekkende plagg.",
    },
    {
    ...
    {
      question: "Hva viser mangfoldet av muslimske syn på kjønnsroller?",
      options: ["At muslimer tolker de religiøse kildene ulikt", "At kjønnsroller ikke diskuteres i islam", "At Koranen ikke inneholder noe som helst om mennesker og deres samliv", "At Koranen ikke sier noe om mennesker"],
      explanation: "Som i andre religioner finnes det i islam et spekter fra konservative til liberale tolkninger av kjønn og samliv.",
    },
  ],
  "krle-9-2-5": [
    {
    ...
    {
      question: "Hva er forskjellen på religionskritikk og islamofobi?",
      options: ["Religionskritikk retter seg mot ideer og lære, islamofobi rammer mennesker", "Religionskritikk er forbudt, islamofobi er lovlig", "Det er i praksis ingen forskjell, siden begge deler rammer troende mennesker", "Religionskritikk er forbudt ved lov, mens islamofobi regnes som fullt lovlig"],
      explanation: "Det er legitimt å kritisere religiøse ideer og praksiser, men islamofobi er fiendtlighet rettet mot mennesker.",
    },
    {
    ...
    {
      question: "Hva kan bidra til å bekjempe fordommer mot muslimer?",
      options: ["Kunnskap, personlige møter og dialog", "Mindre kontakt mellom grupper", "Mindre kontakt og færre møter på tvers av ulike grupper i samfunnet", "Flere stereotypier i mediene"],
      explanation: "Kunnskap om islam og muslimers faktiske liv, møter på tvers av grupper og dialog motvirker fordommer.",
    },
  ],
  "krle-9-3-3": [
    {
      question: "Hvem grunnla sikhismen?",
      options: ["Guru Nanak", "Guru Gobind Singh", "Mahatma Gandhi", "Buddha"],
      explanation: "Guru Nanak (1469-1539) grunnla sikhismen. Han var den første av de ti guruene.",
    },
    {
  ...
  "krle-9-3-4": [
    {
      question: "Hvor har yoga sin opprinnelse?",
      options: ["Som åndelig praksis i indiske religiøse tradisjoner", "Som treningsform i USA på 1980-tallet", "I den greske idrettskulturen, der kropp og bevegelse sto helt sentralt", "I gammel kinesisk kampsport, der åndedrett og bevegelse ble øvet sammen"],
      explanation: "Yoga har røtter som åndelig praksis i indiske tradisjoner, men i Vesten brukes den ofte som ren trening.",
    },
    {
    ...
    {
      question: "Hva har skjedd med yoga i mange vestlige land?",
      options: ["Den har i stor grad blitt en treningsform løsrevet fra sin åndelige sammenheng", "Den er blitt forbudt ved lov i de fleste vestlige land av religiøse hensyn", "Den praktiseres nå bare i templer under ledelse av innvidde brahmaner og prester", "Den brukes utelukkende av religiøse ledere som en hemmelig innvielsesrite"],
      explanation: "I Vesten har yoga i stor grad blitt trening og avspenning -- et eksempel på hvordan religiøse praksiser endres i nye kulturer.",
    },
  ],
  "krle-9-3-5": [
    {
      question: "Hvilket spenningsforhold finnes i hinduismen når det gjelder kjønn?",
      options: ["Mektige gudinner dyrkes, samtidig som kvinner historisk har hatt en underordnet stilling", "Menn er ikke tillatt å gå inn i tempelet, som er forbeholdt kvinnelige tilbedere alene", "Det finnes ingen kvinnelige gudinner i hinduismen, kun mannlige guder som Vishnu og Shiva", "Kvinner har til alle tider hatt alle ledende prestroller og full religiøs autoritet"],
      explanation: "Hinduismen dyrker mektige gudinner som Durga og Lakshmi, samtidig som samfunnet ofte har vært patriarkalsk -- et spenningsforhold mellom ideal og praksis.",
    },
    {
      question: "Hva er en kjerneverdi i sikhismen når det gjelder kjønn?",
      options: ["Likhet mellom kjønnene", "At kvinner ikke kan delta i gudstjenesten", "At bare menn kan lese den hellige boken", "At kjønn ikke finnes"],
      explanation: "Likhet -- også mellom kjønnene -- er en kjerneverdi i sikhismen, selv om praksis ikke alltid følger idealet.",
    },
    {
      question: "Hva kjennetegner buddhismens forhold til kjønn og likestilling?",
      options: ["Likhet i teorien, men nonner har ofte hatt lavere status enn munker i praksis", "Full likestilling i alle land til alle tider", "Kvinner kan overhodet ikke bli buddhister eller ta del i den religiøse praksisen", "Bare kvinner, og aldri menn, har mulighet til å oppnå nirvana i buddhistisk lære"],
      explanation: "Buddha åpnet for at kvinner kunne ordineres, men i praksis har nonneordener ofte hatt lavere status enn munkeordener.",
    },
    {
      question: "Hva menes med «ideal versus virkelighet» i religion og likestilling?",
      options: ["At religiøse idealer om likhet ikke alltid praktiseres i virkeligheten", "At virkeligheten alltid er bedre enn idealene", "At religionene i realiteten ikke har noen idealer om likhet mellom mennesker", "At virkeligheten i praksis alltid er bedre og mer rettferdig enn selve idealene"],
      explanation: "Mange religioner har idealer om likeverd, men kulturelle og historiske forhold gjør at praksisen ofte ikke lever opp til idealene.",
    },
    {
      question: "Hva gjorde Buddha som var uvanlig i sin samtid?",
      options: ["Han tillot at kvinner ble ordinert som nonner", "Han nektet kvinner å høre læren", "Han innførte det strenge kastesystemet i India", "Han nektet kvinner å høre og lære den nye læren"],
      explanation: "Buddha åpnet for ordinasjon av kvinner som nonner -- et uvanlig steg i datidens indiske samfunn.",
    },
  ],
  "krle-9-4-2": [
    {
      question: "Hva er ifølge Kant det eneste som er godt uten begrensning?",
      options: ["En god vilje", "Kunnskap", "Den store rikdommen", "Rikdom"],
      explanation: "Kant mente at en god vilje -- å handle av plikt -- er det eneste som er godt uten begrensning.",
    },
    {
      question: "Hva sier det kategoriske imperativ?",
      options: ["Handle bare etter den regelen du samtidig kan ville skal bli en allmenn lov", "Følg alltid følelsene og de spontane innskytelsene dine i enhver situasjon", "Gjør alltid det som gir nettopp deg selv størst mulig fordel og vinning", "Gjør alltid det som flertallet i samfunnet rundt deg velger å gjøre"],
      explanation: "Det kategoriske imperativ er Kants test for moralske handlinger: Regelen bak handlingen må kunne gjelde for alle.",
    },
    {
    ...
    {
      question: "Hva er en vanlig innvending mot Kants pliktetikk?",
      options: ["At den er for rigid og ikke tar hensyn til konsekvensene", "At den bryr seg for mye om konsekvenser", "At den i praksis tillater absolutt alle handlinger uansett moralsk innhold", "At den bryr seg altfor mye om handlingenes konsekvenser og for lite om plikt"],
      explanation: "Kritikere mener pliktetikken blir for rigid -- for eksempel at man ifølge Kant ikke kan lyve selv for å redde liv.",
    },
  ],
  "krle-9-4-3": [
    {
      question: "Hva sier nytteprinsippet i utilitarismen?",
      options: ["Den rette handlingen er den som gir størst mulig lykke for flest mulig", "Den rette handlingen er den som gagner deg selv mest", "Den rette handlingen er den som gagner deg selv og din egen familie aller mest", "Den rette handlingen er alltid den som følger faste og ubøyelige moralske regler"],
      explanation: "Utilitarismen vurderer handlinger ut fra konsekvensene: Målet er størst mulig lykke for flest mulig.",
    },
    {
      question: "Hvem regnes som utilitarismens grunnlegger?",
      options: ["Jeremy Bentham", "Immanuel Kant", "Aristoteles", "Søren Kierkegaard"],
      explanation: "Jeremy Bentham (1748-1832) regnes som utilitarismens grunnlegger. John Stuart Mill videreutviklet teorien.",
    },
    {
  ...
  "krle-9-4-4": [
    {
      question: "Hva betyr utsagnet «eksistens kommer før essens»?",
      options: ["Mennesket har ingen forhåndsbestemt natur, men skaper seg selv gjennom sine valg", "At kroppen alltid er viktigere enn sjelen i menneskets tilværelse og valg", "Menneskets natur og skjebne er fullstendig bestemt allerede før fødselen", "At selve eksistensen er en illusjon som mennesket må frigjøre seg fra"],
      explanation: "Eksistensialistene mener at mennesket først eksisterer, og deretter former seg selv gjennom valgene sine.",
    },
    {
      question: "Hvem regnes som eksistensialismens far?",
      options: ["Søren Kierkegaard", "Jean-Paul Sartre", "Immanuel Kant", "Friedrich Nietzsche"],
      explanation: "Den danske filosofen Søren Kierkegaard (1813-1855) regnes som eksistensialismens far.",
    },
    {
      question: "Hva betyr autentisitet i eksistensialismen?",
      options: ["Å leve ekte og sant i tråd med egne valg, ikke bare gjøre det andre forventer", "Å følge alle nedarvede tradisjoner og forventninger fra samfunnet rundt", "Å aldri forandre mening eller standpunkt uansett hva som skjer i livet", "Å ha ekte og gyldige dokumenter som beviser hvem man virkelig er"],
      explanation: "Autentisitet er å leve i tråd med sine egne valg og verdier i stedet for å bare følge andres forventninger.",
    },
    {
  ...
  "krle-9-4-5": [
    ...
    {
      question: "Hvilken form har den gylne regel hos Konfucius?",
      options: ["Negativ form: «Gjør ikke mot andre det du ikke vil at andre skal gjøre mot deg»", "Positiv form: «Gjør mot andre det du vil at andre skal gjøre mot deg»", "Regelen finnes overhodet ikke igjen hos Konfucius, men bare hos Jesus i evangeliene", "En streng matematisk formel for hvordan man skal fordele goder rettferdig i samfunnet"],
      explanation: "Konfucius formulerte regelen negativt: Man skal unngå å gjøre mot andre det man ikke ønsker for seg selv.",
    },
    {
      question: "Hva står sentralt i Jesu etiske lære?",
      options: ["Nestekjærlighet -- også overfor fiender", "At loven alltid går foran mennesket", "At bare de rike og mektige i samfunnet virkelig kan være gode mennesker", "At bare de rike kan være gode"],
      explanation: "Jesu etikk vektlegger nestekjærlighet, tilgivelse og omsorg -- til og med kjærlighet til fiender.",
    },
    {
      question: "Hva vektla Buddha i sin etiske lære?",
      options: ["Medfølelse og ikke-vold overfor alle levende vesener", "Lojalitet til kongen over alt annet", "Streng og hard straff for alle som bryter samfunnets lover og regler", "Ubetinget lojalitet og lydighet overfor kongen framfor alt annet i livet"],
      explanation: "Buddhas etikk vektlegger medfølelse (karuna) og ikke-vold overfor alle levende vesener.",
    },
    {
  ...
  "krle-9-5-1": [
    ...
    {
      question: "Hva er agnostisisme?",
      options: ["Standpunktet om at vi ikke kan vite sikkert om det finnes noen gud", "Den faste og urokkelige troen på at det finnes én eneste sann gud", "En egen teologisk retning innenfor den protestantiske kristendommen", "En aktiv og bestemt benektelse av at noen som helst guder finnes"],
      explanation: "Agnostisisme (fra gresk a-gnosis, «uten kunnskap») er standpunktet om at vi ikke kan vite om det finnes en gud eller ikke.",
    },
    {
  ...
  "krle-9-5-2": [
    ...
    {
      question: "Hva var renessansehumanismen?",
      options: ["En fornyet interesse for antikkens kultur og for mennesket (ca. 1300-1600)", "En kirkelig reformbevegelse som oppsto tidlig på 1900-tallet i Europa", "En kulturell bevegelse for å avskaffe all billedkunst og skulptur", "En politisk revolusjon i Frankrike med krav om frihet og likhet"],
      explanation: "Renessansehumanismen (1300-1600) satte mennesket og antikkens kultur i sentrum og la grunnlag for senere humanisme.",
    },
    {
      question: "Hva vektla opplysningstidens tenkere?",
      options: ["Fornuft, frihet og kritikk av autoriteter", "At bare adelen kunne tenke", "Blind lydighet og troskap mot kongen og de gamle autoritetene", "Blind lydighet mot kongen"],
      explanation: "Opplysningstiden (1600-1800) vektla fornuft, frihet og kritisk tenkning, og banet vei for menneskerettighetene.",
    },
    {
      question: "Hvordan henger humanismen sammen med menneskerettighetene?",
      options: ["Tanken om alle menneskers like verd er grunnlag for universelle rettigheter", "Menneskerettighetene avviser og motsier humanismens grunnleggende ideer", "Bare dypt religiøse mennesker kan i praksis støtte menneskerettighetene", "De to har egentlig ingenting med hverandre å gjøre historisk sett"],
      explanation: "Humanismens idé om menneskeverd -- at alle mennesker har lik og ukrenkelig verdi -- er et grunnlag for menneskerettighetene.",
    },
    {
  ...
  "krle-9-5-3": [
    ...
    {
      question: "Hva kjennetegner dialogmodellen for religion og vitenskap?",
      options: ["At de kan berike hverandre gjennom samtale og gjensidig respekt", "At vitenskapen må underordnes religionen", "At religiøse påstander må bevises gjennom eksperimenter i et laboratorium", "At de to alltid må holdes fullstendig atskilt fra hverandre ved hjelp av lov"],
      explanation: "Dialogmodellen mener religion og vitenskap kan lære av hverandre og være i fruktbar samtale.",
    },
  ],
  "krle-9-5-4": [
    {
      question: "Hva er nyreligiøsitet?",
      options: ["En samlebetegnelse for nye religiøse og spirituelle bevegelser, særlig fra 1960-tallet", "Et annet og mer moderne ord for ateisme og fullstendig avvisning av alt religiøst", "En moderne reformbevegelse innenfor Den norske kirke som fornyer gudstjenesten", "En samlebetegnelse for verdensreligioner som er mer enn to tusen år gamle"],
      explanation: "Nyreligiøsitet er nye religiøse og spirituelle bevegelser som har vokst frem særlig fra 1960-tallet.",
    },
    {
      question: "Hva kjennetegner New Age-bevegelsen?",
      options: ["En blanding av østlig og vestlig spiritualitet, med blant annet healing og astrologi", "En strengt hierarkisk organisasjon med én øverste leder og faste medlemslister", "Et politisk parti som arbeider for å skille religion helt fra staten i landet", "En mystisk retning innenfor jødedommen med røtter i middelalderens kabbala"],
      explanation: "New Age blander elementer fra ulike tradisjoner og omfatter praksiser som healing, astrologi og krystaller.",
    },
    {
  ...
  "krle-9-5-5": [
    {
      question: "Hva menes med «spiritual but not religious» (SBNR)?",
      options: ["Mennesker som tror på noe større, men ikke tilhører noen bestemt religion", "Mennesker som er aktive i flere trossamfunn samtidig", "Mennesker som samtidig er aktive medlemmer i flere organiserte trossamfunn", "Prester og religiøse ledere som er ordinert, men som ikke har egen menighet"],
      explanation: "SBNR beskriver mennesker som har en form for åndelighet og praktiserer for eksempel meditasjon, men uten å tilhøre en organisert religion.",
    },
    {
      question: "Hva er privatisering av religion?",
      options: ["At tro blir en personlig sak som leves utenfor religiøse institusjoner", "At staten overtar styringen av trossamfunnene og bestemmer deres lære", "At kirkebygg og gudshus selges fra staten til private selskaper og eiere", "At all religiøs praksis blir forbudt både i hjemmet og på offentlige steder"],
      explanation: "Privatisering av religion betyr at troen blir en personlig sak, mindre knyttet til institusjoner og fellesskap.",
    },
    {
    ...
    {
      question: "Hvilken tendens ser man hos mange unge når det gjelder religion?",
      options: ["Mer individuell tro og mindre deltakelse i organisert religion", "At ingen unge tenker på eksistensielle spørsmål", "At så godt som alle unge melder seg inn i et organisert trossamfunn", "At ingen unge lenger bryr seg om eksistensielle eller åndelige spørsmål"],
      explanation: "Mange unge utformer sin egen individuelle tro og deltar mindre i organisert religiøst liv.",
    },
    {
  ...
  "krle-9-6-1": [
    ...
    },
    {
      ...
      options: ["1948", "1814", "1905", "1989"],
      explanation: "FNs verdenserklæring om menneskerettigheter ble vedtatt i 1948, etter andre verdenskrig.",
    },
    {
      question: "Hva innebærer religionsfriheten?",
      options: ["Retten til å ha, skifte og praktisere religion -- og til å ikke ha noen", "Retten til å tvinge barn av andre til sin tro", "Retten til å tvinge andres barn til å følge og praktisere ens egen religion", "Bare retten til å tro i det stille og skjulte, uten å vise troen utad for andre"],
      explanation: "Religionsfriheten omfatter retten til å ha, skifte, praktisere -- og ikke ha -- en religion eller et livssyn.",
    },
    {
    ...
    {
      question: "Hva er status for blasfemi i norsk lov i dag?",
      options: ["Blasfemiparagrafen er opphevet -- religionskritikk er lovlig", "Religionskritikk krever tillatelse fra politiet", "Blasfemi straffes fortsatt med bøter eller fengsel dersom man håner en religion", "Bare kritikk rettet mot kristendommen er tillatt, mens andre religioner er vernet"],
      explanation: "Norge har opphevet blasfemiparagrafen. Religionskritikk er beskyttet av ytringsfriheten, men hatefulle ytringer mot personer er forbudt.",
    },
  ],
  "krle-9-6-2": [
    {
      question: "Hva er ytringsfrihet?",
      options: ["Retten til fritt å si, skrive og publisere det man mener", "Retten til å si hva som helst uten noen grenser i noen situasjon", "En plikt til å mene noe om alt", "Retten til å hindre andre i å snakke"],
      explanation: "Ytringsfrihet er retten til fritt å ytre seg, men den har noen grenser, som forbudet mot hatefulle ytringer.",
    },
    {
      question: "Hvor er ytringsfriheten beskyttet?",
      options: ["I FNs verdenserklæring artikkel 19, Den europeiske menneskerettighetskonvensjonen og Grunnloven", "Den er ikke beskyttet i noe lovverk, men bygger kun på uskrevne sedvaner i landet", "Bare i avisenes og medienes egne interne redaksjonelle regler og retningslinjer", "Bare i amerikansk grunnlov, gjennom det første grunnlovstillegget om ytringer"],
      explanation: "Ytringsfriheten er beskyttet i FNs verdenserklæring (artikkel 19), EMK (artikkel 10) og Grunnloven paragraf 100.",
    },
    {
    ...
    {
      question: "Hvilken grense setter norsk lov for ytringer?",
      options: ["Hatefulle ytringer mot grupper er forbudt", "Bare positive ytringer er tillatt", "All kritikk rettet mot religioner og trossamfunn er ulovlig og kan straffes", "All religionskritikk er forbudt"],
      explanation: "Ytringsfriheten er vid, men straffeloven forbyr hatefulle ytringer rettet mot grupper, for eksempel på grunn av religion eller hudfarge.",
    },
    {
      question: "Kan religionskritikk forbys i Norge?",
      options: ["Nei, kritikk av religioner og ideer er beskyttet av ytringsfriheten", "Nei, men bare forskere har lov til å kritisere", "Nei, men bare forskere og teologer har lov til å kritisere religiøse ideer", "Ja, all kritikk av religioner er straffbar og kan føre til bot eller fengsel"],
      explanation: "Kritikk av religion som idé og institusjon er lovlig og beskyttet -- grensen går ved hatefulle ytringer mot mennesker.",
    },
  ],
  "krle-9-6-3": [
    {
      question: "Hva er teknologietikk?",
      options: ["Refleksjon over etiske spørsmål ved utvikling og bruk av teknologi", "Regler for hvordan man reparerer datamaskiner", "Lover og forskrifter som fastsetter hvor rask internett-hastighet må være", "Detaljerte regler for hvordan man skal reparere og vedlikeholde datamaskiner"],
      explanation: "Teknologietikk handler om etiske spørsmål som ansvar, personvern og konsekvenser ved teknologi.",
    },
    {
    ...
    {
      question: "Hvilket etisk spørsmål reiser selvkjørende biler?",
      options: ["Hvem som har ansvaret når bilen forårsaker en ulykke", "Hvor fort bilen kan kjøre på motorvei", "Hvilken farge og design bilen bør ha for å bli mest mulig salgbar", "Hvor fort en selvkjørende bil egentlig kan kjøre på en åpen motorvei"],
      explanation: "Når en selvkjørende bil forårsaker en ulykke, er det uklart om ansvaret ligger hos sjåføren, produsenten eller programmereren.",
    },
    {
  ...
  "krle-9-6-4": [
    {
      ...
      options: ["Utvikling som dekker dagens behov uten å ødelegge for kommende generasjoner", "Utvikling som maksimerer dagens forbruk mest mulig uten tanke på framtiden", "Utvikling og vekst som skjer helt uten bruk av moderne teknologi og maskiner", "En bestemt type kraftverk som produserer fornybar strøm fra vind og vann"],
      explanation: "Definisjonen kommer fra Brundtland-kommisjonen (1987): å tilfredsstille dagens behov uten å ødelegge mulighetene for kommende generasjoner.",
    },
    {
      question: "Hvilke tre dimensjoner har bærekraft?",
      options: ["Økologisk, sosial og økonomisk", "Politisk, militær og religiøs", "Lokalt, nasjonalt og globalt nivå", "Lokal, nasjonal og global"],
      explanation: "Bærekraft har tre dimensjoner: økologisk (natur og klima), sosial (rettferdighet og helse) og økonomisk.",
    },
    {
      question: "Hva er forvalteransvar i religiøs sammenheng?",
      options: ["Ideen om at mennesket har fått ansvar for å ta vare på jorden", "At naturen kan brukes fritt uten hensyn", "Ideen om at bare myndighetene og staten bærer ansvaret for miljø og natur", "En egen regnskapsregel som gjelder for menigheter og trossamfunn sin økonomi"],
      explanation: "Forvalteransvaret er ideen, kjent fra flere religioner, om at mennesket skal forvalte og ta vare på skaperverket.",
    },
    {
    ...
    {
      question: "Hvem formulerte den kjente definisjonen av bærekraftig utvikling i 1987?",
      options: ["Brundtland-kommisjonen", "FNs sikkerhetsråd", "EU-kommisjonen", "Verdens helseorganisasjon"],
      explanation: "Brundtland-kommisjonen lanserte definisjonen av bærekraftig utvikling i rapporten Vår felles framtid (1987).",
    },
  ],
  "krle-9-6-5": [
    {
    ...
    {
      question: "Hva bør du gjøre før du deler en nyhet videre?",
      options: ["Sjekke om informasjonen er sann og hvem som er kilden", "Bare sjekke hvor mange likerklikk den har", "Dele den så raskt som overhodet mulig så du er tidlig ute før andre", "Bare sjekke hvor mange likerklikk og delinger nyheten allerede har fått"],
      explanation: "Kildekritikk -- å sjekke sannhet og kilde -- er en etisk plikt før man deler innhold videre.",
    },
    {
      question: "Hvilket etisk spørsmål bygger på empati i digital kommunikasjon?",
      options: ["«Hvordan ville jeg følt det om noen postet dette om meg?»", "«Hvor mange følgere kan dette gi meg?»", "«Hvor mange nye følgere og likerklikk kan denne posten gi meg?»", "«Er dette morsomt og spennende nok til å bli mye delt av andre?»"],
      explanation: "Empati-testen -- å sette seg i den andres sted -- er et grunnleggende etisk verktøy i digital kommunikasjon.",
    },
  ],
  "krle-9-7-1": [
    {
    ...
    {
      question: "Hvor mange verdener besto tilværelsen av i samisk kosmologi?",
      options: ["Tre", "Én", "Sju", "Tolv"],
      explanation: "Den samiske kosmologien delte tilværelsen inn i tre verdener -- en oververden, en mellomverden og en underverden.",
    },
    {
      question: "Hva er en sieidi?",
      options: ["Et samisk hellig sted, ofte en spesiell stein eller formasjon der man ofret", "En bestemt type tamrein som ble avlet frem spesielt for religiøse ofringer", "En mektig samisk gud for torden og lyn som ble tilbedt over hele Sápmi", "Et tradisjonelt samisk klesplagg som bare noaiden fikk lov til å bruke"],
      explanation: "Sieidi er samenes hellige steder i naturen, der man ofret for å sikre lykke i jakt og reindrift.",
    },
    {
  ...
  "krle-9-7-3": [
    {
      ...
      options: ["Naturtilknytning og at naturen regnes som hellig", "En felles verdensomspennende organisasjon", "At de styres av én felles verdensomspennende organisasjon med et hovedsete", "Skriftlige lærebøker som viktigste kilde"],
      explanation: "Urfolksreligioner kjennetegnes av nær tilknytning til naturen, som regnes som hellig, og av muntlig overlevering.",
    },
    {
      question: "Hva er Drømmetiden i aboriginsk tradisjon?",
      options: ["Fortellingen om forfedreåndenes skapelse av verden -- en dimensjon som også eksisterer i nåtiden", "En årlig idrettsfestival der aboriginske stammer møtes til lek og konkurranser", "En dyster myte om verdens undergang og hvordan menneskene til slutt vil dø ut", "En moderne australsk filmsjanger som handler om drømmer, søvn og fantasi"],
      explanation: "Drømmetiden (Dreamtime) er den sentrale fortellingen om skapelsen, og den eksisterer parallelt med nåtiden.",
    },
    {
      question: "Hvorfor er mange urfolksreligioner under press?",
      options: ["På grunn av kolonisering, misjon og tap av landområder", "Fordi de har for mange tilhengere", "Fordi de har blitt altfor mange tilhengere til at tradisjonene kan holdes samlet", "Fordi naturen ikke lenger finnes"],
      explanation: "Kolonisering, misjonsvirksomhet og tap av tradisjonelle landområder har satt urfolksreligioner under sterkt press.",
    },
    {
  ...
  "krle-9-7-4": [
    {
      question: "Hva betyr FPIC (fritt, forhåndsinformert samtykke)?",
      options: ["At urfolk skal informeres og samtykke før tiltak som berører deres områder settes i gang", "En frivillig miljøsertifisering som bedrifter kan kjøpe for å virke mer bærekraftige", "At staten står helt fritt til å bygge ut og bruke urfolks landområder som den vil", "At urfolk selv må søke myndighetene om lov til å bo og leve på sin egen jord"],
      explanation: "FPIC innebærer at urfolk har rett til å bli informert og gi samtykke -- fritt og på forhånd -- til tiltak som berører deres landområder.",
    },
    {
    ...
    {
      question: "En stat vil bygge i et fjellområde som er hellig for et urfolk. Hva krever FPIC-prinsippet?",
      options: ["At urfolket informeres i god tid og gir sitt samtykke før utbyggingen vedtas", "At urfolket informeres etter at byggingen er ferdig", "At utbyggingen kan starte opp mens forhandlingene med urfolket fortsatt pågår", "At urfolket blir informert om saken først etter at byggingen er ferdig utført"],
      explanation: "FPIC krever at samtykke innhentes fritt og på forhånd, med god informasjon -- før beslutningen tas.",
    },
  ],
  "krle-9-8-1": [
    {
      question: "Hva tror kristne skjer etter døden?",
      options: ["Oppstandelse og evig liv hos Gud", "At sjelen vandrer inn i dyr", "At alt tar helt slutt uten noe håp om et liv", "Gjenfødelse i en ny kropp"],
      explanation: "Kristen tro innebærer håp om oppstandelse og evig liv hos Gud, med Jesu oppstandelse som grunnlag.",
    },
    {
    ...
    {
      question: "Hva er forskjellen på reinkarnasjon i hinduismen og gjenfødelse i buddhismen?",
      options: ["Hinduismen lærer at en evig sjel gjenfødes, buddhismen avviser en permanent sjel", "Buddhismen tror på kroppslig oppstandelse, mens hinduismen tror på gjenfødelse", "De er helt identiske begreper, og hinduisme og buddhisme lærer nøyaktig det samme", "Hinduismen avviser all gjenfødelse, mens buddhismen lærer at sjelen lever evig videre"],
      explanation: "I hinduismen vandrer sjelen (atman) videre, mens buddhismen lærer at en bevissthetsstrøm fortsetter uten noen permanent sjel (anatta).",
    },
    {
  ...
  "krle-9-8-2": [
    ...
    {
      question: "Hvordan varierer religiøse syn på seksualitet?",
      options: ["Fra konservative til liberale tolkninger -- også innenfor samme religion", "Alle religioner har nøyaktig samme strenge syn på seksualitet og samliv", "Religioner uttaler seg aldri om seksualitet, som regnes som et rent privat spørsmål", "Bare sekulære livssyn har ulike syn; religiøse tradisjoner er alltid helt samstemte"],
      explanation: "Innenfor hver religion finnes et spekter av syn på seksualitet og samliv, fra konservative til liberale.",
    },
    {
  ...
  "krle-9-8-3": [
    ...
    {
      question: "Hva er forskjellen på en fordom og diskriminering?",
      options: ["En fordom er en holdning, diskriminering er en handling som forskjellsbehandler", "Begge deler er fullt lovlige i Norge og reguleres ikke av noen lovbestemmelser", "Diskriminering er bare en tanke i hodet, mens fordom er en synlig handling", "De to begrepene betyr det samme og beskriver akkurat den samme handlingen"],
      explanation: "Fordommer er forutinntatte holdninger, mens diskriminering er når holdningene fører til forskjellsbehandling i praksis.",
    },
    {
    ...
    {
      question: "Hva kan religiøs tilhørighet bety for identiteten?",
      options: ["Den kan gi verdier, fellesskap og opplevelse av tilhørighet", "Den bestemmer identiteten fullstendig for alle", "Den har aldri noen betydning for identiteten, som formes helt uavhengig av tro", "Den bestemmer identiteten fullstendig for alle troende, uten rom for egne valg"],
      explanation: "For mange er religion en viktig del av identiteten -- den gir verdier, fellesskap og tilhørighet.",
    },
  ],
  "krle-9-8-4": [
    {
      question: "Hva mente Viktor Frankl om mening og lidelse?",
      options: ["«Den som har et hvorfor å leve for, kan tåle nesten ethvert hvordan»", "At bare lykkelige mennesker finner mening", "At mening er umulig å finne, og at søken etter den bare fører til skuffelse", "At lidelse alltid bryter mennesker ned og fratar dem evnen til å finne mening"],
      explanation: "Psykologen Viktor Frankl, som overlevde Holocaust, mente mennesker kan tåle nesten hva som helst hvis de har en grunn til å leve.",
    },
    {
    ...
    {
      question: "Hvilket klassisk spørsmål handler om Gud og lidelsens eksistens?",
      options: ["Teodicé-spørsmålet: Hvorfor finnes lidelse hvis Gud er god og allmektig?", "Det ontologiske spørsmålet om tallenes natur", "Det ontologiske spørsmålet om tallenes og de matematiske størrelsenes natur", "Spørsmålet om jordens alder og hvordan universet en gang oppstod og ble til"],
      explanation: "Teodicé-spørsmålet handler om hvordan man kan forene troen på en god og allmektig Gud med lidelsen i verden.",
    },
    {
      question: "Hva kan gi håp i ulike tradisjoner?",
      options: ["For eksempel frelse, gjenfødelse til noe bedre, eller menneskelig fellesskap og handlekraft", "Ingenting kan i virkeligheten gi mennesker håp, uansett hvilken tradisjon de tilhører", "Håp finnes bare i én bestemt religion, mens alle andre tradisjoner mangler det helt", "Utelukkende penger og materiell velstand, som er den eneste kilden til ekte håp"],
      explanation: "Ulike tradisjoner gir håp på ulike måter -- religiøse gjennom frelse eller gjenfødelse, sekulære gjennom fellesskap og menneskelig handlekraft.",
    },
  ],
  "krle-9-8-5": [
    {
  ...
  "krle-9-8-6": [
    {
      question: "Hva sier toleransens paradoks?",
      options: ["Et samfunn som tolererer alt, inkludert intoleranse, kan til slutt bli overtatt av de intolerante", "At intoleranse bør tolereres fullt ut, uansett hvor mye den skader andres frihet", "At toleranse er helt umulig å oppnå, fordi mennesker aldri kan akseptere ulikhet", "At toleranse alltid er lett og krever ingen grenser mot dem som truer andre"],
      explanation: "Toleransens paradoks sier at et tolerant samfunn må sette grenser mot intoleranse som truer andres rettigheter.",
    },
    {
      question: "Hvem formulerte toleransens paradoks?",
      options: ["Karl Popper", "Immanuel Kant", "Sokrates", "John Stuart Mill"],
      explanation: "Filosofen Karl Popper formulerte toleransens paradoks.",
    },
    {
...
export default quizData_krle_9;
