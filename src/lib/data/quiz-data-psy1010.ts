...
const quizData_psy1010: Record<string, QuizQuestion[]> = {
  'psy1010-0-1': [
    {
      ...
      options: ["Du får fire oppgaver og skal besvare tre av dem.", "Du får tre oppgaver og skal besvare alle tre.", "Du får fem oppgaver og skal besvare fire av dem.", "Du får fire oppgaver og skal besvare alle fire."],
    ...
    },
    {
      ...
      options: ["Sensor ser bort fra den SISTE oppgaven du besvarte, ikke den dårligste.", "Sensor teller de tre beste oppgavene.", "Du får et lite bonuspoeng for den fjerde.", "Alle fire teller likt inn i snittet."],
    ...
    },
    {
      ...
      options: ["Som gjennomsnittet av de tre — de teller likt.", "Den beste oppgaven avgjør karakteren.", "Den dårligste oppgaven avgjør karakteren.", "De to beste teller dobbelt, den tredje enkelt."],
    ...
    },
    {
      ...
      options: ["Korrelasjon (20 av 29 sett) og hypotesetesting (19 av 29 sett).", "Etikk og fagfellevurdering.", "Cohens kappa og spørreskjemakonstruksjon.", "Kvalitativ metode og normalfordeling."],
    ...
    },
    {
      ...
      options: ["Kvalitativ metode ble en fast egen oppgave, og regnekravet forsvant i praksis.", "Antallet oppgaver økte fra fire til seks.", "Eksamen ble flyttet fra vår til høst.", "Korrelasjon ble tatt helt ut av pensum."],
    ...
    },
    {
      ...
      options: ["Fordi gjenbruk er normen — hele oppgaver resirkuleres med kosmetiske endringer.", "Fordi eksamen alltid gjentar nøyaktig samme tall og navn.", "Fordi sensor liker studenter som har sett settene før.", "Fordi pensum skifter helt hvert år, så bare gamle sett er relevante."],
    ...
    },
    {
      ...
      options: ["Alle tre oppgavene teller likt, så en halvferdig tredjeoppgave trekker snittet mer ned enn finpuss løfter det.", "Ingenting — det lønner seg alltid å perfeksjonere den beste oppgaven.", "Sensor gir bonus for den grundigste oppgaven.", "Den siste oppgaven teller uansett ikke."],
    ...
    },
    {
      ...
      options: ["Oppgavene er tematisk «rene» — én om korrelasjon/regresjon, én om hypotesetesting, én om design, én om måling/utvalg eller kvalitativ.", "Alle fire oppgavene handler om samme tema.", "Oppgavene blandes tilfeldig uten noe mønster.", "To oppgaver handler alltid om etikk."],
  ...
  'psy1010-0-2': [
    {
      ...
      options: ["At forståelse honoreres, og uortodokse løsninger vurderes på egne premisser.", "At bare ordrett gjengivelse av pensum gir full uttelling.", "At det finnes nøyaktig ett riktig svar per deloppgave.", "At sensor teller antall fagord i besvarelsen."],
    ...
    },
    {
      ...
      options: ["Det teller bare når det gjøres relevant for spørsmålet; ellers gir det null.", "Det gir alltid pluss, fordi det viser bred kunnskap.", "Det trekker karakteren ned med ett trinn.", "Det må alltid tas med for å nå toppkarakter."],
    ...
    },
    {
      ...
      options: ["Definer — anvend på caset — begrunn.", "List — gjenta — konkluder.", "Skriv mest mulig — dekk alt du kan.", "Regn ut — rund av — svar kort."],
    ...
    },
    {
      ...
      options: ["C-kjernen er kjernepoengene enhver bestått besvarelse må ha; A-laget er de ekstra grepene som løfter til topps.", "At C-svar alltid er dårlige og A-svar alltid er lange.", "At man skal skrive A-laget først og hoppe over kjernen.", "At karakteren avgjøres av hvor mange sider du skriver."],
    ...
    },
    {
      ...
      options: ["C treffer kjernepoengene men blir stående i definisjonene; A begrunner valg, knytter begreper sammen og case-tilpasser.", "C er alltid feil; A er alltid riktig.", "C er lang og A er kort.", "C bruker kalkulator og A gjør det ikke."],
    ...
    },
    {
      ...
      options: ["Fordi fremgangsmåten teller mest, og et galt sluttsvar fra en enkel regnefeil straffes mildt bare hvis metoden er synlig.", "Fordi sensor kun teller antall regneoperasjoner.", "Fordi utregningen alltid gir mer poeng enn tolkningen.", "Fordi kalkulator er forbudt på eksamen."],
    ...
    },
    {
      ...
      options: ["Et C-tak (feil #8) — oppgaven kan ikke gi bedre enn C uansett hvor komplett lista er.", "Full uttelling, fordi alle metodene er nevnt.", "Automatisk stryk på hele oppgaven.", "Pluss for bredde og fullstendighet."],
    ...
    },
    {
      ...
      options: ["Å forklare at korrelasjon bygger på naturlig variasjon, i motsetning til eksperimentets påførte variasjon.", "Å skrive lengst mulig svar.", "Å gjenta oppgaveteksten i innledningen.", "Å definere alle begreper i faget uansett spørsmål."],
    ...
    },
    {
      ...
      options: ["Hopp videre, sikre C-kjernen på de andre leddene, og kom tilbake til det vanskelige til slutt.", "Bli sittende til du løser det, uansett hvor lang tid det tar.", "Hopp over hele oppgaven og velg en ny.", "Skriv alt du kan om et beslektet tema i stedet."],
    ...
    },
    {
      ...
      options: ["Nei — C er en god og helt vanlig karakter som de fleste velfungerende kandidater lander på.", "Ja — alt under A regnes som stryk.", "Ja — C betyr at oppgaven er reelt tom.", "C finnes ikke i norsk karakterskala."],
    ...
    },
    {
      ...
      options: ["Fordi lengre svar ikke gir mer uttelling — sensor honorerer korte, presise svar, og utbrodering gir null.", "Fordi sensor ikke leser lange besvarelser.", "Fordi man skal lese pensum, men aldri øve på å skrive.", "Fordi eksamen er en ren leseprøve."],
    ...
    },
    {
      ...
      options: ["Å kun definere når oppgaven ber om logikken gir trekk — sensorveiledningene sier dette rett ut.", "Ingenting — definisjoner er alltid nok.", "Kandidaten burde ha regnet ut en p-verdi.", "Kandidaten burde ha skrevet mer om et annet tema."],
      explanation: "Når oppgaven ber om logikken (f.eks. V2022 oppgave 3), holder ikke definisjoner alene — sensor vil ha resonnementet, ikke bare begrepene.",
    },
  ],
  'psy1010-1-1': [
    {
      question: "Hva er hovedforskjellen mellom vitenskapelig metode og hverdagskunnskap?",
      options: ["Vitenskapelig metode samler data systematisk og lar dem kunne motsi antakelsen", "Vitenskapelig metode bygger på magefølelse og erfaring", "Hverdagskunnskap er alltid feil, vitenskap alltid riktig", "Det er ingen reell forskjell"],
    ...
    },
    {
      ...
      options: ["Tilfeldig observasjon, systematisk observasjon, litteraturen og teori", "Intuisjon, tro, tradisjon og autoritet", "Eksperiment, spørreskjema, intervju og observasjon", "Hypotese, design, utvalg og analyse"],
    ...
    },
    {
      ...
      options: ["Empirisk testbart, gjennomførbart og viktig", "Falsifiserbart, deduktivt og kvantitativt", "Nytt, publiserbart og finansiert", "Objektivt, målbart og reliabelt"],
    ...
    },
    {
      ...
      options: ["En falsifiserbar påstand om sammenhengen mellom minst to variabler", "Et åpent spørsmål uten forhåndssvar", "En påstand som ikke kan motbevises", "En oppsummering av resultatene"],
    ...
    },
    {
      ...
      options: ["Det finnes tenkelige data som kan vise at den er gal", "Den er allerede motbevist", "Den kan aldri vise seg gal", "Den er basert på falske forutsetninger"],
    ...
    },
    {
      ...
      options: ["Å gjøre et abstrakt fenomen målbart ved å bestemme hvordan det registreres", "Å velge statistisk analysemetode", "Å rekruttere deltakere til studien", "Å skrive den endelige rapporten"],
    ...
    },
    {
      ...
      options: ["Å prøvekjøre opplegget og avdekke problemer før hovedstudien", "Å samle inn de endelige dataene", "Å erstatte hovedstudien hvis den blir for dyr", "Å publisere de første resultatene"],
    ...
    },
    {
      ...
      options: ["Teorien forklarer hvorfor et fenomen skjer; loven beskriver at det skjer regelmessig", "En teori er bevist, en lov er en antakelse", "De betyr det samme", "En lov forklarer, en teori beskriver"],
    ...
    },
    {
      ...
      options: ["En forenklet framstilling som hjelper oss å tenke om et fenomen", "En velbekreftet, tallfestet regelmessighet", "Et sett antakelser som forklarer hvorfor noe skjer", "Den ferdige forskningsrapporten"],
    ...
    },
    {
      ...
      options: ["Grunnforskning søker kunnskap for kunnskapens skyld; anvendt forskning løser et praktisk problem", "Grunnforskning er alltid kvantitativ, anvendt alltid kvalitativ", "Grunnforskning er dårligere enn anvendt forskning", "Anvendt forskning bruker ikke hypoteser"],
    ...
    },
    {
      ...
      options: ["Resultatene føder nye spørsmål som starter et nytt forskningsløp", "Den må gjentas nøyaktig likt hver gang", "Den har ingen begynnelse eller slutt for den enkelte studie", "Den kan bare gjennomføres i sirkler av forskere"],
    ...
    },
    {
      ...
      options: ["Feil #8 — oppramsing uten begrunnelse (remsefeilen)", "Feil #1 — feil p-verdi-definisjon", "Feil #4 — å blande kasusstudie og N=1", "Feil #12 — hypoteser om utvalgsverdier"],
    ...
    },
    {
      ...
      options: ["Det kan besvares ved å samle inn og undersøke data", "Det er nytt og ingen har stilt det før", "Det kan besvares med logisk tenkning alene", "Det handler om hva man bør gjøre"],
    ...
    },
    {
      ...
      options: ["Å utlede en konkret, testbar forutsigelse fra en generell teori", "Å generalisere fra enkeltobservasjoner til en teori", "Å samle inn data uten forhåndsantakelser", "Å fjerne uteliggere fra datasettet"],
    ...
    },
    {
      ...
      options: ["For å unngå å gjenta det gjorte og forankre spørsmålet i eksisterende kunnskap", "For å samle inn de endelige dataene", "For å rekruttere deltakere", "For å skrive diskusjonsdelen av rapporten"],
    ...
    },
    {
      ...
      options: ["Den konkrete beskrivelsen av hvordan en variabel måles i studien", "Den generelle teorien bak fenomenet", "Antallet deltakere i utvalget", "Den statistiske analysen av dataene"],
    ...
    },
    {
      ...
      options: ["Uavhengige eksperter vurderer om metode og konklusjoner holder mål før publisering", "Å garantere at funnet er sant", "Å skaffe finansiering til studien", "Å rekruttere deltakere"],
    ...
    },
    {
      ...
      options: ["Innledning, metode, resultater og diskusjon", "Sammendrag, hypotese, konklusjon", "Idé, design, utvalg", "Teori, lov, modell"],
    ...
    },
    {
      ...
      options: ["Et gjentatt funn er tryggere enn et enkeltfunn som kan skyldes tilfeldigheter", "Fordi det er billigere enn en ny studie", "Fordi det garanterer publisering", "Fordi det erstatter behovet for fagfellevurdering"],
  ...
  'psy1010-1-2': [
    ...
    },
    {
      ...
      options: ["Den måles som utfall og antas å avhenge av UV", "Den manipuleres av forskeren", "Den kan aldri måles", "Den er alltid nominal"],
    ...
    },
    {
      ...
      options: ["Fordi det ikke kan manipuleres — man kan bare sammenligne eksisterende grupper", "Fordi det alltid er den avhengige variabelen", "Fordi det er målt på forholdsnivå", "Fordi det ikke påvirker noe"],
    ...
    },
    {
      ...
      options: ["Alder kan ikke manipuleres — det er en kvasi-UV", "Ingenting, det er helt korrekt", "Alder er en avhengig variabel", "Alder er alltid nominal"],
    ...
    {
      question: "Hva er operasjonalisering?",
      options: ["Å bestemme hvordan en variabel skal måles konkret", "Å velge deltakere til studien", "Å manipulere den uavhengige variabelen", "Å regne ut gjennomsnittet"],
      explanation: "Operasjonalisering fastsetter den konkrete målemetoden (den operasjonelle definisjonen). Samme begrep kan operasjonaliseres ulikt.",
    },
    {
    ...
    },
    {
      ...
      options: ["At det er en konvensjon — enkeltleddene er strengt tatt ordinale", "At Likert-skalaer alltid er forholdstall", "At sumskårer ikke kan analyseres", "At det er en naturlov"],
    ...
    },
    {
      ...
      options: ["Gjennomsnittet", "Modus", "Andelen i hver kategori", "Antall observasjoner"],
      explanation: "Gjennomsnittet forutsetter like avstander mellom verdiene, altså minst intervall. Modus kan brukes på alle nivåer.",
    },
    {
    ...
    },
    {
      ...
      options: ["Dataene bestemmer ikke rollene; forskeren velger dem ut fra spørsmålet", "Rollene er alltid gitt av dataene", "Korrelasjon har verken UV eller AV", "Rollene bestemmes av målenivået"],
    ...
    },
    {
      ...
      options: ["Diskret har adskilte tellbare verdier; kontinuerlig kan ha alle mellomverdier", "Diskret er alltid nominal, kontinuerlig alltid forhold", "Diskret kan ikke måles", "Det er ingen forskjell"],
    ...
    },
    {
      ...
      options: ["Regelen: at verdiene kan rangeres, men avstandene ikke er like store", "Ingenting, svaret er komplett", "Antall deltakere", "En hypotese"],
    ...
    },
    {
      ...
      options: ["Fordi valget av målemetode avgjør nivået — og hva man fanger og mister", "Fordi målenivået er tilfeldig", "Fordi alle fenomener er forholdstall", "Fordi operasjonalisering ikke påvirker nivået"],
    ...
    },
    {
      ...
      options: ["En egenskap som ikke varierer i studien", "En egenskap målt på forholdsnivå", "Den avhengige variabelen", "Et gjennomsnitt"],
  ...
  'psy1010-1-3': [
    {
      ...
      options: ["En tests stabilitet og konsistens — gir den samme resultat under like forhold?", "Om testen måler det den skal måle", "Om studien kan generaliseres", "Om konklusjonen er kausal"],
    ...
    },
    {
      ...
      options: ["En test som spretter tilfeldig kan ikke treffe presist", "Fordi reliable tester alltid er valide", "Fordi validitet måles før reliabilitet", "Det er det ikke — de er uavhengige"],
    ...
    },
    {
      ...
      options: ["En test kan være reliabel uten å være valid", "En test kan være valid uten å være reliabel", "At reliabilitet og validitet er det samme", "At klokken er ubrukelig som eksempel"],
    ...
    },
    {
      ...
      options: ["Deltakerne kan huske svarene fra første gang", "Den kan bare brukes på flervalgstester", "Den krever to bedømmere", "Den forutsetter et ustabilt fenomen"],
    ...
    },
    {
      ...
      options: ["At deltakerne husker svarene sine", "At testen er for kort", "At egenskapen er ustabil", "At bedømmerne er uenige"],
    ...
    },
    {
      ...
      options: ["At testen er homogen — alle ledd måler det samme", "At testen gis to ganger", "At to bedømmere skårer", "At egenskapen er ustabil"],
    ...
    },
    {
      ...
      options: ["Intern konsistens — hvor samstemte leddene er", "Enighet mellom bedømmere", "Om testen forutsier fremtiden", "Signifikansnivået i en test"],
    ...
    },
    {
      ...
      options: ["At leddene er nesten identiske og dermed delvis overflødige", "At testen er perfekt og bør brukes", "At testen er ustabil", "At testen mangler validitet fullstendig"],
    ...
    },
    {
      ...
      options: ["Når skåringen krever skjønn, som ved intervjuer eller observasjoner", "Ved rene flervalgstester", "Når testen gis to ganger", "Når egenskapen er stabil"],
    ...
    },
    {
      ...
      options: ["Den motiverer deltakere, men gjør testen lett å gjennomskue", "Den er både reliabel og valid", "Den måler både stabilitet og treffsikkerhet", "Den erstatter begrepsvaliditet"],
    ...
    },
    {
      ...
      options: ["Om testens innhold dekker hele bredden av begrepet", "Om testen ser troverdig ut", "Om testen samsvarer med et kriterium", "Om testen er stabil over tid"],
    ...
    },
    {
      ...
      options: ["Testen samsvarer med et kriterium målt samtidig", "Testen forutsier et fremtidig utfall", "Testen dekker hele begrepet", "Testen er stabil over tid"],
    ...
    },
    {
      ...
      options: ["Om testen fanger det teoretiske konstruktet den påstår å måle", "Om testen ser troverdig ut", "Om to bedømmere er enige", "Om testen er stabil"],
    ...
    },
    {
      ...
      options: ["Feil #5 — testvaliditet forvekslet med slutningsvaliditet", "Feil #1 — feil p-verdi-definisjon", "Feil #6 — SD forvekslet med SE", "Feil #9 — bekvemmelighetsutvalg som representativt"],
    ...
    },
    {
      ...
      options: ["Holdbarheten av konklusjoner fra en studie", "Om en test måler riktig begrep", "Om en test er stabil", "Om leddene i en test er samstemte"],
    ...
    },
    {
      ...
      options: ["Enighet man ville fått ved ren tilfeldighet", "Manglende reliabilitet", "Systematisk skjevhet i utvalget", "Manglende validitet"],
    ...
    },
    {
      ...
      options: ["Noe av enigheten skyldes ren tilfeldighet", "Fordi bedømmerne alltid jukser", "Fordi prosent aldri kan regnes ut", "Fordi kappa alltid er høyere"],
    ...
    },
    {
      ...
      options: ["Lav samsvar kan skyldes ekte endring i fenomenet, ikke dårlig test", "Fordi humør ikke kan måles", "Fordi test-retest krever to bedømmere", "Fordi humør alltid er stabilt"],
    ...
    },
    {
      ...
      options: ["De er helt ulike begreper som tilfeldigvis deler symbol", "De er to navn på det samme", "Alfa i reliabilitet er alltid lik signifikansnivået", "De kan regnes om til hverandre"],
    ...
    },
    {
      ...
      options: ["C-tak — sensor vil se formene anvendt på scenariet (feil #8)", "A automatisk, fordi alle formene er nevnt", "Stryk, fordi listen er feil", "Ingen konsekvens"],
  ...
  'psy1010-1-4': [
    {
      ...
      options: ["Hele gruppen forskeren vil uttale seg om", "Den delen man faktisk undersøker", "Listen man trekker fra", "De som melder seg frivillig"],
    ...
    },
    {
      ...
      options: ["Den konkrete listen eller kilden man trekker utvalget fra", "Hele populasjonen", "De som faller fra underveis", "Antall deltakere i studien"],
    ...
    },
    {
      ...
      options: ["Sammensetningen speiler populasjonen — en miniatyrkopi", "At det er så stort som mulig", "At deltakerne meldte seg frivillig", "At alle kommer fra samme sted"],
    ...
    },
    {
      ...
      options: ["Et utvalg der hver enhet har lik sjanse for å bli trukket", "Et utvalg av de lettest tilgjengelige", "Et utvalg delt inn i strata", "Et utvalg av hele grupper"],
    ...
    },
    {
      ...
      options: ["Når man vil garantere at små undergrupper er representert", "Når man ikke har noen liste", "Når man vil rekruttere raskest mulig", "Når populasjonen er ukjent"],
    ...
    },
    {
      ...
      options: ["Man trekker hver k-te enhet fra en liste etter tilfeldig start", "Man deler populasjonen i strata", "Man tar de lettest tilgjengelige", "Man trekker hele grupper"],
    ...
    },
    {
      ...
      options: ["Man trekker tilfeldig hele grupper og undersøker alle i dem", "Man trekker enkeltpersoner tilfeldig", "Man tar de mest motiverte", "Man deler i strata"],
    ...
    },
    {
      ...
      options: ["De lettest tilgjengelige er sjelden representative for populasjonen", "Det er alltid for lite", "Det krever for mye tid", "Det kan ikke analyseres statistisk"],
    ...
    },
    {
      ...
      options: ["De som melder seg frivillig skiller seg systematisk fra dem som ikke gjør det", "At forskeren velger deltakere tilfeldig", "At utvalget er for stort", "At deltakerne får betalt"],
    ...
    },
    {
      ...
      options: ["De som forlater studien skiller seg systematisk fra dem som blir", "At ingen melder seg", "At alle fullfører", "At utvalget er tilfeldig trukket"],
    ...
    },
    {
      ...
      options: ["Hvis bare en liten, spesiell del svarer, forsterkes frivillighetsbias", "Fordi det gjør analysen umulig", "Fordi det alltid betyr for få deltakere", "Fordi responsrate ikke betyr noe"],
    ...
    },
    {
      ...
      options: ["Svekket generaliserbarhet og ytre validitet", "Høyere reliabilitet", "Bedre indre validitet", "Mindre standardfeil"],
    ...
    },
    {
      ...
      options: ["Feil #9 — bekvemmelighetsutvalg behandlet som representativt", "Feil #5 — testvaliditet forvekslet med slutningsvaliditet", "Feil #1 — feil p-verdi-definisjon", "Feil #3 — kausal tolkning av korrelasjon"],
    ...
    },
    {
      ...
      options: ["Feil #8 — sensor vil se et begrunnet valg, ikke en oppramsing", "Ingenting, alle teknikker er nevnt", "Feil #9 — bekvemmelighetsutvalg", "Svaret gir automatisk A"],
    ...
    },
    {
      ...
      options: ["En fullstendig utvalgsramme", "At deltakerne er frivillige", "At utvalget er lite", "At man kjenner strataene"],
    ...
    },
    {
      ...
      options: ["Praktisk gjennomførbarhet vs. representativitet", "Reliabilitet vs. validitet", "Indre vs. ytre validitet", "Nominal vs. ordinal"],
    ...
    },
    {
      ...
      options: ["Ved eksplorerende studier/piloter eller grunnleggende prosesser som neppe varierer sterkt mellom grupper", "Alltid, det er like godt som tilfeldig", "Aldri, det er forbudt", "Bare hvis utvalget er stort nok"],
    ...
    },
    {
      ...
      options: ["N er hele gruppen man vil uttale seg om; n er delen man undersøker", "N er utvalget, n er populasjonen", "De er det samme", "N er antall variabler, n antall grupper"],
    ...
    },
    {
      ...
      options: ["Eksplisitt si at funnene primært gjelder den undersøkte gruppen, og at generalisering er usikker", "Presentere dem som gjeldende for hele populasjonen", "Skjule utvalgsmetoden", "Hevde at utvalget var tilfeldig"],
  ...
  'psy1010-2-1': [
    {
      ...
      options: ["Manipulasjon av UV, randomisert tilordning og en kontrollgruppe", "Store utvalg, pretest og posttest", "Blinding, matching og en kontrollgruppe", "Tilfeldig utvalg fra populasjonen, manipulasjon og hypotese"],
    ...
    },
    {
      ...
      options: ["Å fordele feilvariansen (individforskjeller) likt mellom gruppene", "Å sikre at utvalget er representativt for populasjonen", "Å skjule betingelsen for deltakerne", "Å gjøre fordelingen normal"],
    ...
    },
    {
      ...
      options: ["Systematisk feilvarians — gruppene er forskjellige før tiltaket", "Usystematisk feilvarians øker", "Lav testvaliditet", "For høy ytre validitet"],
    ...
    },
    {
      ...
      options: ["Systematisk trekker konsekvent i én retning i én gruppe; usystematisk er tilfeldig støy", "Systematisk er ønsket; usystematisk er uønsket", "Systematisk skyldes manipulasjonen; usystematisk skyldes kontrollgruppen", "De er to navn på det samme"],
    ...
    },
    {
      ...
      options: ["Graden av holdbar årsaksslutning innenfor studien", "Graden av generaliserbarhet til andre situasjoner", "Om en test måler det den skal", "Om utvalget er tilfeldig trukket"],
    ...
    },
    {
      ...
      options: ["Graden av generaliserbarhet til andre personer, situasjoner og tidspunkter", "Graden av holdbar årsaksslutning", "Om måleinstrumentet er reliabelt", "Om forskeren er blindet"],
    ...
    },
    {
      ...
      options: ["Mer laboratoriekontroll gir høyere indre, men gjør situasjonen mer kunstig (lavere ytre)", "Fordi de måler nøyaktig det samme", "Fordi høy ytre validitet alltid gir lav reliabilitet", "Fordi randomisering svekker begge"],
    ...
    },
    {
      ...
      options: ["Indre/ytre validitet gjelder slutninger fra studier, ikke om en test måler riktig (det er testvaliditet)", "Ingen feil — begrepene er synonyme", "Testvaliditet finnes ikke", "Studenten burde svart reliabilitet"],
    ...
    },
    {
      ...
      options: ["Reaktivitet og forventningseffekter (demand characteristics)", "Systematisk frafall", "Lav statistisk styrke", "Feil målenivå"],
    ...
    },
    {
      ...
      options: ["Kontrollgruppen får tiltaket etter at studien er ferdig", "Kontrollgruppen får en narrepille", "Ingen kontrollgruppe brukes", "Deltakerne velger selv gruppe"],
    ...
    },
    {
      ...
      options: ["Å sjekke om selve pretesten påvirket resultatet", "Å øke utvalgsstørrelsen", "Å blinde forskeren", "Å gjøre studien til et kvasieksperiment"],
    ...
    },
    {
      ...
      options: ["Høy indre og lavere ytre validitet", "Lav indre og høy ytre validitet", "Lav indre og lav ytre validitet", "Høy testvaliditet"],
    ...
    },
    {
      ...
      options: ["En form for ytre validitet: hvor godt studiesituasjonen likner virkelige forhold", "En form for indre validitet", "Om testen er reliabel", "Om utvalget er stort nok"],
    ...
    },
    {
      ...
      options: ["Variasjonen forskeren med vilje skaper ved å manipulere UV — selve effekten", "Tilfeldig målestøy", "Frafall som skjer systematisk", "Forskjeller mellom deltakere før tiltaket"],
    ...
    },
    {
      ...
      options: ["En studie som sammenligner menn og kvinner uten randomisering", "En randomisert studie med placebokontroll", "En studie der deltakere loddtrekkes til to doser", "En randomisert venteliste-kontrollert studie"],
    ...
    },
    {
      ...
      options: ["At deltakere endrer atferd fordi de vet de blir studert", "At forskeren reagerer på resultatene", "At tiltaket virker raskt", "At utvalget reagerer likt"],
    ...
    },
    {
      ...
      options: ["Uten den vet vi ikke hva som ville skjedd uansett (historie, modning)", "Fordi den øker utvalget", "Fordi den gjør fordelingen normal", "Fordi den blinder deltakerne"],
    ...
    },
    {
      ...
      options: ["Randomisering nøytraliserer alle individforskjeller (også ukjente); matching bare de målte", "Matching er alltid bedre for indre validitet", "Randomisering krever et stort utvalg, matching ikke", "De gir identiske resultater"],
    ...
    },
    {
      ...
      options: ["Selvseleksjon — deltakerne kan være systematisk forskjellige fra ikke-deltakerne", "For lav statistisk styrke", "Feil målenivå på stressvariabelen", "At kurset ikke ble blindet"],
    ...
    },
    {
      ...
      options: ["Verken deltaker eller den som måler/behandler vet hvilken betingelse deltakeren er i", "Deltakeren måles to ganger", "To kontrollgrupper brukes", "Forskeren randomiserer to ganger"],
  ...
  'psy1010-2-2': [
    {
      ...
      options: ["Det kontrollerer for individforskjeller og gir høyere statistisk styrke", "Det unngår alle overføringseffekter", "Det krever ingen kontrollgruppe", "Det gir alltid høyere ytre validitet"],
    ...
    },
    {
      ...
      options: ["Overføringseffekter (rekkefølgeeffekter)", "Behov for mange flere deltakere", "Umulig å bruke kontrollgruppe", "Lav testvaliditet"],
    ...
    },
    {
      ...
      options: ["Et mellomgruppedesign", "Et innengruppedesign", "Et faktorielt design", "Et N=1-design"],
      explanation: "Ulike grupper, hver sin betingelse = mellomgruppe (between-subjects).",
    },
    {
      question: "Hva gjør motbalansering?",
      options: ["Fordeler rekkefølgeeffekten likt så den nulles ut i gjennomsnittet", "Fjerner overføringseffekten helt", "Øker utvalgsstørrelsen", "Blinder deltakerne"],
    ...
    },
    {
      ...
      options: ["Treningseffekt (øvelse)", "Uttrøtting", "Habituering", "Kontrast"],
    ...
    },
    {
      ...
      options: ["Uttrøtting (fatigue)", "Trening", "Sensitivisering", "Adaptasjon"],
    ...
    },
    {
      ...
      options: ["Kontrasteffekt", "Habituering", "Trening", "Uttrøtting"],
    ...
    },
    {
      ...
      options: ["Når effekten er irreversibel (f.eks. læring eller behandling)", "Når utvalget er lite", "Når det er to betingelser", "Når man vil ha høy statistisk styrke"],
    ...
    },
    {
      ...
      options: ["Bruk av alle mulige rekkefølger av betingelsene", "Bruk av bare én rekkefølge for alle", "Å droppe kontrollgruppen", "Å måle rekkefølge som egen UV"],
    ...
    },
    {
      ...
      options: ["Delvis motbalansering der hver betingelse forekommer én gang i hver posisjon", "Full motbalansering med alle rekkefølger", "En type kontrollgruppe", "En analysemetode for interaksjon"],
    ...
    },
    {
      ...
      options: ["Å case-tilpasse — peke ut hvilke av de seks som truer akkurat dette scenariet", "Å liste alle seks effektene i riktig rekkefølge", "Å definere hver effekt ordrett", "Å regne ut antall rekkefølger"],
    ...
    },
    {
      ...
      options: ["Fordi individforskjeller fjernes fra støyen, så effekten blir lettere å se", "Fordi det alltid har flere deltakere", "Fordi det blinder forskeren", "Fordi det unngår kontrast: effekter"],
    ...
    },
    {
      ...
      options: ["Mellomgruppe sparer per-person-belastning men koster deltakere; innengruppe sparer deltakere men koster overføringseffekter", "At innengruppe alltid er billigst", "At mellomgruppe alltid gir best styrke", "At man alltid bør motbalansere"],
    ...
    },
    {
      ...
      options: ["Et design med minst én mellomgruppefaktor og minst én innengruppefaktor", "Et design uten kontrollgruppe", "Et design med bare kvasi-UV", "Et N=1-design med to faser"],
    ...
    },
    {
      ...
      options: ["Bruke opp treningseffekten før de egentlige betingelsene", "Blinde deltakerne", "Øke utvalget", "Måle rekkefølge som egen UV"],
    ...
    },
    {
      ...
      options: ["Sensitivisering", "Habituering", "Adaptasjon", "Kontrast"],
    ...
    },
    {
      ...
      options: ["Antall rekkefølger vokser som k! (fire betingelser = 24 rekkefølger)", "Fordi styrken faller", "Fordi individforskjellene øker", "Fordi kontrollgruppen forsvinner"],
  ...
  'psy1010-2-3': [
    ...
    },
    {
      ...
      options: ["I marginalgjennomsnittene (rad- og kolonnegjennomsnitt)", "I cellemønsteret", "I linjediagrammets krysningspunkt", "I standardavviket"],
    ...
    },
    {
      ...
      options: ["I cellemønsteret — endres effekten av én faktor når den andre skifter nivå?", "I marginalene", "I gjennomsnittet av alle fire cellene", "I utvalgsstørrelsen"],
    ...
    },
    {
      ...
      options: ["Ja — kryssende linjer kan nulle ut marginalene mens cellene viser samspill", "Nei, interaksjon krever alltid minst én hovedeffekt", "Bare i design med tre faktorer", "Bare hvis utvalget er stort"],
    ...
    },
    {
      ...
      options: ["Ingen interaksjon — effekten av den ene faktoren er lik på alle nivåer av den andre", "En sterk interaksjon", "At begge hovedeffekter er null", "At designet er et kvasieksperiment"],
    ...
    },
    {
      ...
      options: ["0 (marginalene er begge 6)", "4", "−4", "8"],
    ...
    },
    {
      ...
      options: ["Det er en interaksjon — effekten av koffein snur med oppgavetype", "Det er to hovedeffekter", "Det er ingen effekt i det hele tatt", "Det er en kvasi-UV"],
    ...
    },
    {
      ...
      options: ["Det avslører interaksjonen — hvordan faktorene samspiller — som separate forsøk ville midlet bort", "Det krever færre deltakere alltid", "Det gir høyere ytre validitet", "Det trenger ingen kontrollgruppe"],
    ...
    },
    {
      ...
      options: ["Tofaktor-variansanalyse (ANOVA)", "En enkel t-test", "Pearson-korrelasjon", "Khikvadrat"],
    ...
    },
    {
      ...
      options: ["Kjønn er en kvasi-UV — man kan ikke trekke en ren kausal slutning om den", "Ingen konsekvens — kjønn kan randomiseres", "Designet blir automatisk et innengruppedesign", "Man må droppe interaksjonen"],
    ...
    },
    {
      ...
      options: ["Effekten av én faktor innenfor ett bestemt nivå av den andre", "Gjennomsnittet av alle cellene", "Hovedeffekten midlet over begge faktorer", "Standardfeilen til en celle"],
    ...
    },
    {
      ...
      options: ["Å lese den som «begge faktorer virker» i stedet for «effekten av den ene avhenger av den andre»", "Å regne marginalene", "Å tegne linjediagram", "Å bruke ANOVA"],
    ...
    },
    {
      ...
      options: ["Effekten av B er lik uansett nivå av A, så de bare legger seg oppå hverandre", "De alltid krysser i et diagram", "Begge hovedeffekter er null", "Det finnes en interaksjon"],
  ...
  'psy1010-2-4': [
    {
      ...
      options: ["Kvasieksperimentet mangler randomisert tilordning", "Kvasieksperimentet mangler manipulasjon", "Kvasieksperimentet har bare én deltaker", "Kvasieksperimentet har ingen avhengig variabel"],
    ...
    },
    {
      ...
      options: ["Seleksjon — gruppene kan være systematisk ulike fra start", "Reaktivitet", "Uttrøtting", "For høy statistisk styrke"],
    ...
    },
    {
      ...
      options: ["Ja — det manipulerer en betingelse og bruker personen som sin egen kontroll", "Nei, det er alltid bare beskrivende", "Bare hvis det har minst 30 deltakere", "Nei, det er et kvasieksperiment"],
    ...
    },
    {
      ...
      options: ["Baseline → tiltak → baseline → tiltak", "Tiltak → baseline → tiltak → baseline", "Baseline → baseline → tiltak → tiltak", "Fire ulike tiltak etter hverandre"],
    ...
    },
    {
      ...
      options: ["Om noe manipuleres — N=1 manipulerer, kasusstudien bare beskriver", "Antall deltakere", "Om studien er publisert", "Om den bruker intervju"],
    ...
    },
    {
      ...
      options: ["Personen er sin egen kontroll (sterk kausalitet for individet), men én person kan ikke bære en generalisering", "Fordi det alltid er randomisert", "Fordi det har mange deltakere", "Fordi det mangler manipulasjon"],
    ...
    },
    {
      ...
      options: ["At den er stabil (ligger rimelig flatt) før tiltaket settes inn", "At den stiger jevnt", "At den varer minst ett år", "At den måles bare én gang"],
    ...
    },
    {
      ...
      options: ["Det blir stadig mindre sannsynlig at noe annet enn tiltaket svinger i samme takt", "Fordi utvalget blir større", "Fordi det randomiserer deltakeren", "Fordi baselinen driver mindre"],
    ...
    },
    {
      ...
      options: ["En gruppe dannet uten randomisering som kan skille seg systematisk fra sammenligningsgruppen", "En gruppe med færre enn 10 deltakere", "En randomisert kontrollgruppe", "En gruppe uten avhengig variabel"],
    ...
    },
    {
      ...
      options: ["Når effekten er irreversibel (læring, varig behandling)", "Når baselinen er stabil", "Når man har mange deltakere", "Når tiltaket er billig"],
    ...
    },
    {
      ...
      options: ["Rik beskrivelse og hypotesegenerering — men ikke fastslå årsak", "Sikker kausal slutning", "En gjennomsnittseffekt for populasjonen", "Statistisk styrke"],
    ...
    },
    {
      ...
      options: ["Et eksperiment i naturlige omgivelser, ofte kvasi, med høy ytre validitet", "Et laboratorieeksperiment med streng kontroll", "En ren kasusstudie", "Et design uten uavhengig variabel"],
    ...
    },
    {
      ...
      options: ["Ebbinghaus' studier av egen hukommelse", "Freuds beskrivelse av Anna O.", "En stor spørreundersøkelse", "En tverrsnittstudie av tvillinger"],
    ...
    },
    {
      ...
      options: ["En N=1-variant der tiltaket innføres til ulike tider på tvers av atferder/personer, uten reversering", "Et gruppedesign med to kontrollgrupper", "En kasusstudie med flere kilder", "Et faktorielt design"],
    ...
    },
    {
      ...
      options: ["At ekstreme skårer ved første måling faller nærmere snittet ved neste, rent statistisk", "At tiltaket alltid virker", "At gruppene blir like over tid", "At baselinen driver oppover"],
    ...
    },
    {
      ...
      options: ["Fordi det kan være uforsvarlig å randomisere folk til skadelige betingelser eller nekte behandling", "Fordi de alltid er billigere", "Fordi de gir høyere statistisk styrke", "Fordi de er lettere å publisere"],
    ...
    },
    {
      ...
      options: ["En enkelt endring kan skyldes noe annet som skjedde samtidig (historie)", "Det har for mange deltakere", "Det mangler avhengig variabel", "Det er et kvasieksperiment"],
    ...
    },
    {
      ...
      options: ["Individnivå (N=1) sier at tiltaket virker for én person; gruppenivå sier noe om en gjennomsnittseffekt", "De er det samme", "Individnivå gjelder bare kvasidesign", "Gruppenivå gjelder bare kasusstudier"],
    ...
    },
    {
      ...
      options: ["Feil — det er en kasusstudie (ingen systematisk manipulasjon med kontrollfaser)", "Riktig, fordi den har én person", "Riktig, fordi den er grundig", "Umulig å avgjøre"],
  ...
  'psy1010-3-1': [
    ...
    },
    {
      ...
      options: ["Fordi utvalgsgjennomsnittet gjør kvadratsummen systematisk for liten, så n − 1 korrigerer og gir et forventningsrett estimat", "Fordi vi alltid mister én observasjon i målingen", "Fordi n − 1 gjør tallet penere å regne med", "Fordi variansen ellers kan bli negativ"],
    ...
    },
    {
      ...
      options: ["Fordelingen er høyreskjev (hale mot høyre)", "Fordelingen er venstreskjev", "Fordelingen er symmetrisk", "Fordelingen har ingen uteliggere"],
    ...
    },
    {
      ...
      options: ["Interkvartilbredden (IQR)", "Variasjonsbredden", "Standardavviket", "Variansen"],
    ...
    },
    {
      ...
      options: ["Poeng i annen (poeng²)", "Poeng", "Ingen enhet", "Prosent"],
    ...
    },
    {
      ...
      options: ["Hvor langt observasjonene i snitt ligger fra gjennomsnittet, i målingens egen enhet", "Den midterste verdien i fordelingen", "Den hyppigste verdien", "Forskjellen mellom største og minste verdi"],
    ...
    },
    {
      ...
      options: ["Median og IQR (robust duo)", "Median og standardavvik", "Gjennomsnitt og IQR", "Modus og varians"],
    ...
    },
    {
      ...
      options: ["Han har glemt kvadratrota — SD = √65,4 ≈ 8,09, ikke 65,4", "Han har delt på n i stedet for n − 1", "Han har regnet medianen feil", "Han har brukt feil sentralmål"],
    ...
    },
    {
      ...
      options: ["For å hindre at negative og positive avvik kansellerer til null", "For å gjøre alle tallene mindre", "Fordi kvadrater alltid er penere tall", "For å gjøre om til prosent"],
    ...
    },
    {
      ...
      options: ["Minst intervallnivå", "Nominalnivå holder", "Bare ordinalnivå", "Ingen krav"],
    ...
    },
    {
      ...
      options: ["Den øker kraftig, fordi den bare avhenger av ytterpunktene", "Den er upåvirket, fordi den er robust", "Den halveres", "Den blir negativ"],
  ...
  'psy1010-3-2': [
    {
      ...
      options: ["Hvor mange standardavvik en verdi ligger over eller under gjennomsnittet", "Den hyppigste verdien i fordelingen", "Prosentandelen som svarte riktig", "Forskjellen mellom største og minste verdi"],
    ...
    {
      question: "Hvilket sentralmål vises IKKE i et standard boksplott?",
      options: ["Gjennomsnittet", "Medianen", "Q1", "Q3"],
    ...
    },
    {
      ...
      options: ["Nei — den flytter bare senter til 0 og skala til SD 1; formen bevares", "Ja, den gjør enhver fordeling normal", "Ja, den fjerner alle uteliggere", "Nei, men den fjerner skjevheten"],
    ...
    },
    {
      ...
      options: ["De eksakte tallverdiene", "Fargekoding", "Gjennomsnittet", "Standardavviket"],
    ...
    },
    {
      ...
      options: ["1,5 standardavvik under gjennomsnittet", "1,5 standardavvik over gjennomsnittet", "1,5 enheter under gjennomsnittet", "På 15-persentilen uansett fordeling"],
    ...
    },
    {
      ...
      options: ["Fordi parametriske tester antar tilnærmet normale data eller utvalgsfordelinger, og normalfordelingen beskrives fullt av to parametre", "Fordi den er den eneste fordelingen som finnes i psykologi", "Fordi den alltid er venstreskjev", "Fordi den ikke har noe gjennomsnitt"],
    ...
    },
    {
      ...
      options: ["Fordelingens kjerne er høyreskjev", "Fordelingen er perfekt symmetrisk", "Det finnes ingen uteliggere", "Gjennomsnittet er lik medianen"],
    ...
    },
    {
      ...
      options: ["På IQ er +2 bra (blant de øverste); på feilrate er +2 dårlig (blant de med flest feil)", "Ingen forskjell — z = 2 betyr alltid det samme", "På IQ er det dårlig, på feilrate bra", "z kan ikke sammenlignes mellom tester"],
  ...
  'psy1010-3-3': [
    {
      ...
      options: ["Standardavviket i utvalgsfordelingen — hvor mye et utvalgsgjennomsnitt typisk avviker fra populasjonsgjennomsnittet", "Spredningen mellom enkeltpersoner i dataene", "Den gjennomsnittlige målefeilen på hver enkelt måling", "Forskjellen mellom største og minste verdi"],
    ...
    },
    {
      ...
      options: ["SD er spredningen mellom personer i dataene; SE er presisjonen i gjennomsnittsestimatet", "De er to navn på det samme", "SD gjelder små utvalg, SE store utvalg", "SD er alltid mindre enn SE"],
    ...
    },
    {
      ...
      options: ["Firedoble det", "Doble det", "Åttedoble det", "Halvere det"],
    ...
    },
    {
      ...
      options: ["Den teoretiske fordelingen av gjennomsnitt fra uendelig mange tenkte utvalg av samme størrelse", "Fordelingen av enkeltverdiene i ett utvalg", "Fordelingen av alle verdier i populasjonen", "En figur vi tegner av rådataene"],
    ...
    },
    {
      ...
      options: ["Populasjonen (μ), ikke det utvalget vi målte", "Bare det konkrete utvalget vi målte", "Alle mulige utvalg på én gang", "Forskerens forventninger"],
    ...
    },
    {
      ...
      options: ["Utvalgsfordelingen av gjennomsnittet blir tilnærmet normal når n er stor nok, uansett populasjonens form", "Alle populasjoner er normalfordelte", "Store utvalg gir alltid samme gjennomsnitt", "Standardfeilen blir null ved store utvalg"],
    ...
    },
    {
      ...
      options: ["Feil #6 — hun forveksler standardfeil (presisjon i snittet) med standardavvik (spredning mellom personer)", "Feil #12 — hun glemmer populasjonen", "Hun har regnet SE feil", "Ingen feil, dette er korrekt"],
    ...
    },
    {
      ...
      options: ["Det endres ikke systematisk — SD beskriver den ekte variasjonen mellom personer", "Det halveres når n dobles", "Det krymper med √n", "Det blir null ved store utvalg"],
    ...
    },
    {
      ...
      options: ["På grunn av tilfeldig utvalgsvariasjon — ethvert tilfeldig utvalg treffer ikke μ eksakt", "Fordi forskeren har gjort en målefeil", "Fordi utvalget alltid er for lite", "Fordi SD er regnet feil"],
    ...
    },
    {
      ...
      options: ["Mye — i en normal utvalgsfordeling ligger 99,7 % innenfor ±3 SE, så det er svært usannsynlig hvis antakelsen stemmer", "Lite — 3 SE er innenfor det vanlige", "Umulig å si uten å kjenne SD", "Det avhenger bare av n"],
    ...
    },
    {
      ...
      options: ["Presisjonen øker med √n, så gevinsten avtar per ny deltaker", "Presisjonen øker proporsjonalt med n", "Mer data endrer ikke presisjonen", "Presisjonen øker med n²"],
    ...
    },
    {
      ...
      options: ["Nei — SE måler presisjon, ikke om utvalget treffer riktig populasjon; systematisk skjevhet forsvinner ikke med større n", "Ja, liten SE betyr alltid et godt estimat", "Ja, hvis n er over 100", "Nei, men bare hvis SD også er liten"],
    ...
    },
    {
      ...
      options: ["x̄ ± 1,96 × SE", "x̄ ± 1,96 × SD", "x̄ ± SE", "x̄ ± 3 × SD"],
    ...
    },
    {
      ...
      options: ["En sann ukjent populasjonsverdi (parameter) vs. tallet vi regner fra utvalget for å gjette den (estimat)", "To navn på det samme tallet", "Estimatet er sant, parameteren er en gjetning", "Begge er alltid kjent på forhånd"],
    ...
    },
    {
      ...
      options: ["Fordi den er en teoretisk konstruksjon vi kan regne SE for, ikke noe vi trenger å observere direkte", "Fordi vi faktisk trekker mange utvalg i praksis", "Fordi den er identisk med datafordelingen", "Fordi den alltid har SE = SD"],
    ...
    },
    {
      ...
      options: ["Standardfeilen for differansen mellom to gruppegjennomsnitt, SE(D)", "Standardavviket til populasjonen", "Medianen i utvalget", "Variasjonsbredden"],
    ...
    },
    {
      ...
      options: ["Datafordelingen viser enkeltverdier (spredning SD); utvalgsfordelingen viser gjennomsnitt (spredning SE, alltid smalere)", "De er identiske", "Utvalgsfordelingen er alltid bredere enn datafordelingen", "Datafordelingen er alltid normal"],
  ...
  'psy1010-3-4': [
    {
      ...
      options: ["Forskjellen mellom to gruppegjennomsnitt målt i standardfeil-enheter", "Spredningen innad i én gruppe", "Sannsynligheten for at H0 er sann", "Andelen forklart varians"],
    ...
    },
    {
      ...
      options: ["Standardfeilen for differansen mellom de to gjennomsnittene", "Standardavviket i gruppe 1", "Summen av begge gruppenes gjennomsnitt", "Differansen mellom variansene"],
    ...
    },
    {
      ...
      options: ["Stor |t| gir liten p (mer usannsynlig under H0)", "Stor |t| gir stor p", "|t| og p er alltid like", "|t| påvirker ikke p"],
    ...
    },
    {
      ...
      options: ["Fordi vi tester forskjellen mellom gjennomsnitt, og SE(D) er den tilfeldige variasjonen i den forskjellen", "Fordi SD alltid er for stor", "Fordi SE(D) er lettere å regne", "Det spiller ingen rolle hvilken vi bruker"],
    ...
    },
    {
      ...
      options: ["For å unngå avrundingskaskader der akkumulerte feil kan endre konklusjonen", "Fordi kalkulatorer ikke tåler desimaler", "Fordi mellomsvarene ikke betyr noe", "For å spare tid"],
    ...
    },
    {
      ...
      options: ["Usannsynlig hvis H0 er sann — men ikke nødvendigvis stor eller viktig", "Både signifikant og praktisk viktig", "Alltid en effekt på minst 5 poeng", "Umulig å skyldes tilfeldigheter"],
    ...
    },
    {
      ...
      options: ["Selv bittesmå differanser kan gi en stor t og bli statistisk signifikante", "t blir alltid null", "Forskjellen blir automatisk viktig", "p blir alltid over 0,05"],
    ...
    },
    {
      ...
      explanation: "Er oppgitt p < α, forkaster vi H0. 0,002 < 0,05, så vi forkaster.",
    },
    {
      question: "Oppgitt p = 0,03. Endres konklusjonen om α strammes fra 0,05 til 0,01?",
      options: ["Ja — ved α = 0,05 forkastes H0, men ved α = 0,01 er 0,03 > 0,01, så H0 beholdes", "Nei, konklusjonen er den samme på begge nivåer", "Ja, men bare hvis t er negativ", "Nei, p endres når α endres"],
    ...
    },
    {
      ...
      options: ["At de to populasjonsgjennomsnittene er like (μ₁ = μ₂)", "At utvalgsgjennomsnittene er like", "At variansene er ulike", "At forskjellen er viktig"],
    ...
    },
    {
      ...
      options: ["En konklusjon i ord: hva t og p betyr for studien (forkast/behold H0)", "Å regne p-verdien på nytt", "Å oppgi variansen med fire desimaler", "Å tegne utvalgsfordelingen"],
    ...
    },
    {
      ...
      options: ["Standardfeilen for forskjellen mellom to snitt, og arver usikkerhet fra begge grupper", "Nøyaktig det samme som SE", "Alltid mindre enn hver gruppes SE", "Uavhengig av utvalgsstørrelsene"],
  ...
  'psy1010-4-1': [
    {
      ...
      options: ["Sannsynligheten for et minst like ekstremt resultat gitt at H0 er sann er 3 %.", "Det er 3 % sannsynlig at H0 er sann.", "Det er 3 % sannsynlig at H0 er feil.", "Det er 97 % sannsynlig at H1 er sann."],
    ...
    },
    {
      ...
      options: ["Populasjonsgjennomsnittet μ.", "Utvalgsgjennomsnittet x̄.", "Standardavviket i utvalget.", "p-verdien."],
    ...
    },
    {
      ...
      options: ["retningen er begrunnet i teori/tidligere funn FØR dataene ble sett.", "p-verdien blir mindre enn med en tohalet test.", "forskeren ser hvilken retning dataene peker og velger deretter.", "utvalget er lite."],
    ...
    },
    {
      ...
      options: ["0,036", "0,144", "0,072", "0,010"],
      explanation: "Enhalet p = tohalet p / 2 = 0,036, fordi den ekstreme halen bare telles i én retning. Gyldig kun med forhåndsbegrunnet retning.",
    },
    {
      question: "En tohalet test gir p = 0,048. Hva konkluderer du ved α = 0,05 og ved α = 0,01?",
      options: ["Forkast H0 ved 0,05; behold H0 ved 0,01.", "Forkast H0 ved begge nivåene.", "Behold H0 ved begge nivåene.", "Behold ved 0,05; forkast ved 0,01."],
    ...
    },
    {
      ...
      options: ["Forskjellen er trolig ekte, men ikke nødvendigvis stor eller viktig.", "Forskjellen er stor og praktisk viktig.", "H0 er bevist feil med sikkerhet.", "Effekten er nøyaktig α stor."],
    ...
    },
    {
      ...
      options: ["Vi fant ikke sterke nok bevis mot H0 — det er ikke bevis for at effekten mangler.", "Vi har bevist at det ikke finnes noen effekt.", "H1 er bevist feil.", "p-verdien er nøyaktig 0."],
    ...
    },
    {
      ...
      options: ["Utvalgsfordelingen (fordelingen av tenkte gjentatte utvalgssnitt).", "Selve datamatrisen.", "Populasjonens rådata.", "Standardavviket alene."],
    ...
    },
    {
      ...
      options: ["Terskelen p sammenlignes mot, og risikoen for å forkaste en sann H0.", "Sannsynligheten for at H1 er sann.", "p-verdien vi observerer.", "Standardfeilen i utvalget."],
    ...
    },
    {
      ...
      options: ["Utvalgssnittet x̄ kjenner vi allerede; poenget er å slutte til det ukjente μ.", "μ er lettere å regne ut enn x̄.", "x̄ kan ikke være negativt.", "Fordi eksamen krever greske bokstaver."],
    ...
    },
    {
      ...
      options: ["Feil #1 — p tolket som sannsynlighet for hypotesen.", "Feil #11 — enhalet uten begrunnelse.", "Feil #12 — hypotese om utvalget.", "Feil #6 — SD forvekslet med SE."],
    ...
    },
    {
      ...
      options: ["Et signifikant resultat kan gjelde en triviell effekt hvis utvalget er stort nok.", "Et signifikant resultat er alltid stort.", "Viktige effekter er alltid signifikante.", "Signifikans og viktighet er synonymer."],
    ...
    },
    {
      ...
      options: ["Grensen er en avtalt terskel; p = 0,049 og 0,051 er nesten like sterke resultater.", "Fordi 0,05 er matematisk bevist optimal.", "Fordi loven krever 5 %.", "Fordi SE alltid er 0,05."],
    ...
    },
    {
      ...
      options: ["En p mellom 0,01 og 0,05 som gir ulik konklusjon avhengig av α-nivået.", "En p lik nøyaktig 0.", "En p over 0,50.", "En p som er negativ."],
    ...
    },
    {
      ...
      options: ["Leddet 'gitt at H0 er sann'.", "Ordet 'signifikant'.", "Referansen til utvalget.", "Effektstørrelsen."],
    ...
    },
    {
      ...
      options: ["At du kan snu konklusjonen ved et strengere α og skille signifikans fra viktighet.", "At du regner p-verdien for hånd.", "At du alltid velger enhalet test.", "At du bruker flest mulig formler."],
    ...
    },
    {
      ...
      options: ["Å forkaste en sann H0 (falsk alarm), med risiko α.", "Å beholde en falsk H0.", "Å regne SE feil.", "Å velge feil test."],
    ...
    },
    {
      ...
      options: ["Vi tester H0 (antar ingen effekt) og forkaster den hvis dataene blir usannsynlige — vi beviser aldri H1 direkte.", "Vi regner sannsynligheten for H1 direkte.", "Vi hopper over H0 og går rett på konklusjonen.", "Vi bruker bare beskrivende statistikk."],
    ...
    },
    {
      ...
      options: ["Enhalet halvering krever at retningen var begrunnet FØR dataene ble sett (feil #11).", "Ingenting — halvering er alltid tillatt.", "p kan ikke halveres matematisk.", "Hun burde brukt α = 0,10."],
    ...
    },
    {
      ...
      options: ["Hvor stor effekten er, uavhengig av utvalgsstørrelse.", "Om resultatet er signifikant.", "Hvor stor α er.", "Hvor mange deltakere som var med."],
    ...
    },
    {
      ...
      options: ["H0-logikken er et falsifiseringsapparat — vi kan forkaste, men aldri bevise, H0.", "Fordi H0 alltid er sann.", "Fordi α forbyr aksept.", "Fordi utvalget er for lite."],
  ...
  'psy1010-4-2': [
    {
      ...
      options: ["Å forkaste en sann H0 (falsk alarm).", "Å beholde en falsk H0.", "Å regne standardfeilen feil.", "Å velge feil statistisk test."],
      explanation: "Type I = forkaste en sann H0 — se en effekt som ikke finnes. Risikoen er α.",
    },
    {
      question: "Hva er en Type II-feil?",
      options: ["Å beholde en falsk H0 (oversett effekt).", "Å forkaste en sann H0.", "Å bruke for stort utvalg.", "Å tolke p som P(H0)."],
    ...
    },
    {
      ...
      options: ["α (signifikansnivået).", "β.", "1 − β.", "SE."],
    ...
    },
    {
      ...
      options: ["Power = 1 − β.", "Power = 1 − α.", "Power = α + β.", "Power = β."],
    ...
    },
    {
      ...
      options: ["β øker (flere oversette effekter).", "β synker.", "β blir null.", "β blir lik α."],
    ...
    },
    {
      ...
      options: ["Mindre SE ⟹ ekte effekter gir større testobservator ⟹ lettere å forkaste falsk H0.", "Fordi SD krymper.", "Fordi α automatisk synker.", "Fordi effektstørrelsen øker."],
    ...
    },
    {
      ...
      options: ["SE (presisjonen i gjennomsnittet).", "SD (spredningen mellom personer).", "Begge like mye.", "Ingen av dem."],
    ...
    },
    {
      ...
      options: ["Nei — α gjelder når H0 er sann, β når H0 er falsk.", "Ja, alltid.", "Bare når n er stort.", "Bare ved α = 0,05."],
    ...
    },
    {
      ...
      options: ["Type II (å overse syke personer).", "Type I (falsk alarm).", "Begge er alltid like ille.", "Verken eller."],
    ...
    },
    {
      ...
      options: ["Type I (godkjenne noe virkningsløst).", "Type II (avvise noe virksomt).", "Ingen av dem.", "Alltid Type II."],
    ...
    },
    {
      ...
      options: ["Å konkludere at terapien virker når den egentlig ikke gjør det.", "Å konkludere at terapien ikke virker når den gjør det.", "Å regne t feil.", "Å velge feil utvalg."],
    ...
    {
      question: "Å doble utvalget reduserer SE med omtrent hvilken faktor?",
      options: ["0,71 (altså 1/√2).", "0,50.", "0,25.", "2,0."],
    ...
    },
    {
      ...
      options: ["Å blande Type I og Type II.", "Å regne SE feil.", "Å bruke enhalet test.", "Å glemme kvadratrota."],
    ...
    },
    {
      ...
      options: ["På diagonalen (forkast falsk H0, behold sann H0).", "På motdiagonalen.", "Bare i øverste rad.", "Bare i nederste rad."],
    ...
    },
    {
      ...
      options: ["Spør først om H0 i virkeligheten er sann (⟹ Type I) eller falsk (⟹ Type II).", "Se på p-verdien alene.", "Se på α alene.", "Telle antall deltakere."],
  ...
  'psy1010-4-3': [
    {
      ...
      options: ["Uparet t-test.", "Enveis ANOVA.", "ANCOVA.", "Cohens kappa."],
    ...
    },
    {
      ...
      options: ["Enveis mellomgruppe-ANOVA.", "Ti parvise t-tester.", "En enkelt t-test.", "En korrelasjon."],
    ...
    },
    {
      ...
      options: ["Den samlede sannsynligheten for minst én Type I-feil over flere tester.", "Sannsynligheten for en Type II-feil.", "Feilen ved å regne t feil.", "Feil i utvalgsrammen."],
    ...
    },
    {
      ...
      options: ["ANOVA holder den samlede (familywise) feilraten på α.", "ANOVA er raskere å regne.", "ANOVA gir alltid lavere p.", "ANOVA krever færre deltakere."],
    ...
    },
    {
      ...
      options: ["En tilleggsvariabel korrelert med UV og AV som kontrolleres bort.", "En variabel som manipuleres av forskeren.", "Det samme som avhengig variabel.", "En feilkilde i målingen."],
    ...
    },
    {
      ...
      options: ["En ANOVA som i tillegg kontrollerer bort en eller flere kovariater.", "Regner ut korrelasjonen mellom to variabler.", "Sammenligner nøyaktig to grupper.", "Tester reliabiliteten til en skala."],
    ...
    },
    {
      ...
      options: ["Å nevne ANCOVA/kovariat uoppfordret og forklare hva kovariaten gjør.", "Å regne ANCOVA for hånd.", "Å velge enhalet test.", "Å bruke flest mulig formler."],
    ...
    },
    {
      ...
      options: ["Feil #7 — mange t-tester ved 3+ grupper.", "Feil #1 — p-verdi-feilen.", "Feil #12 — hypotese om utvalget.", "Feil #6 — SD vs. SE."],
    ...
    },
    {
      ...
      options: ["Kovariat (ANCOVA) kontrollerer den bort; ekstra faktor (toveis ANOVA) modellerer den.", "Det er ingen forskjell.", "Kovariat brukes bare ved to grupper.", "Faktor krever alltid regning."],
    ...
    },
    {
      ...
      options: ["Når den er en egenskap som ikke kan manipuleres (kjønn, alder).", "Når den er kontinuerlig.", "Når den er kovariat.", "Når den korrelerer med AV."],
    ...
    },
    {
      ...
      options: ["Nei — testvalget er en begrunnet drøfting, ikke et regnestykke.", "Ja, alltid.", "Bare ANCOVA.", "Bare ved fem grupper."],
    ...
    },
    {
      ...
      options: ["Den må korrelere med AV og helst være målt før manipulasjonen.", "Den må manipuleres av forskeren.", "Den må være normalfordelt og lik i alle grupper.", "Den må være uavhengig av AV."],
    ...
    },
    {
      ...
      options: ["Enveis ANOVA — én samlet test holder familywise error nede.", "Uparet t-test — det er bare gjennomsnitt.", "ANCOVA — det er fire grupper.", "Korrelasjon — variablene henger sammen."],
    ...
    },
    {
      ...
      options: ["Longitudinelle design, multippel regresjon med kontrollvariabler, eller gruppesammenligninger.", "Ved å øke α til 0,10.", "Ved å kjøre flere t-tester.", "Ved å ignorere tredjevariabler."],
    ...
    },
    {
      ...
      options: ["Hvor mange grupper/betingelser er det?", "Hva er p-verdien?", "Er dataene normalfordelt?", "Hvor stort er α?"],
    ...
    },
    {
      ...
      options: ["Tohalet, med mindre en retningshypotese er begrunnet på forhånd.", "Alltid enhalet.", "Alltid tohalet, aldri enhalet.", "Det spiller ingen rolle."],
    ...
    },
    {
      ...
      options: ["Man mangler begrunnelsen (familywise error) som er selve poenget.", "Ingenting — det holder.", "ANOVA må da regnes ut.", "Man har brukt feil test."],
  ...
  'psy1010-5-1': [
    {
      ...
      options: ["Retningen på sammenhengen (+ i takt, − motsatt)", "Styrken på sammenhengen", "Andelen forklart varians", "Sannsynligheten for at sammenhengen er ekte"],
    ...
    },
    {
      ...
      options: ["De er avtalte og kontekstavhengige, ikke naturlover", "De er matematisk bestemte og gjelder likt overalt", "De er feil og bør ikke brukes", "De gjelder bare i fysikk"],
    ...
    },
    {
      ...
      options: ["Feil #3 — kausal tolkning av korrelasjon", "Feil #6 — SD/SE-forveksling", "Feil #4 — kasusstudie ≠ N=1", "Feil #12 — slutning om utvalget"],
    ...
    },
    {
      ...
      options: ["Variasjon forskeren måler slik den finnes, uten å manipulere", "Variasjon forskeren skaper ved å manipulere UV", "Variasjon fjernet ved randomisering", "Feilvariansen i et eksperiment"],
    ...
    },
    {
      ...
      options: ["Manipulasjon + randomisering jevner ut tredjevariabler", "Fordi r blir større", "Fordi utvalget blir mer representativt", "Fordi X og Y byttes om"],
    ...
    },
    {
      ...
      options: ["vilkårlig — r er symmetrisk og uendret", "bestemt av hvilken som er årsak", "bestemt av målenivået", "det samme som i regresjon"],
      explanation: "r er symmetrisk; rollene er et fritt valg (til forskjell fra regresjon).",
    },
    {
      question: "Hva kan r ≈ 0 skjule?",
      options: ["En sterk kurvlineær (buet) sammenheng", "At sammenhengen er kausal", "At r er regnet feil", "At utvalget er for stort"],
    ...
    },
    {
      ...
      options: ["X→Y, Y→X, eller en tredjevariabel z påvirker begge", "kun X→Y", "reliabilitet, validitet og bias", "nominal, ordinal og intervall"],
    ...
    },
    {
      ...
      options: ["Retning, styrke m/forbehold, samvariasjon ≠ kausalitet, variasjonstype", "Middelverdi, median, modus, spredning", "Reliabilitet, validitet, utvalg, design", "Nominal, ordinal, intervall, forhold"],
    ...
    },
    {
      ...
      options: ["Styrke leses av tallverdien |r|, retning av fortegnet", "De er det samme", "Styrke er fortegnet, retning er tallverdien", "Begge leses av r²"],
    ...
    },
    {
      ...
      options: ["Fordi r bare kan rangeres; r² gir andeler som kan sammenlignes", "Fordi 0,4 er negativt", "Fordi begge er svake", "Fordi r alltid er lik r²"],
    ...
    },
    {
      ...
      options: ["Konvensjonsgrensen er kontekstavhengig; 0,30 kan være substansielt i psykologi", "Ingenting — 0,30 er alltid neglisjerbart", "r = 0,30 er negativt", "r kan ikke være 0,30"],
    ...
    },
    {
      ...
      options: ["At kausaliteten kan gå motsatt vei (Y→X) av det man antar", "At r er negativt", "At utvalget er skjevt", "At variablene har ulikt målenivå"],
    ...
    },
    {
      ...
      options: ["Begge variabler måles uten manipulasjon; det gir samvariasjon, ikke kausalitet", "Den ene variabelen manipuleres og deltakere randomiseres", "Det gir alltid kausal kunnskap", "r kan ikke regnes i et korrelasjonsdesign"],
    ...
    },
    {
      ...
      options: ["r avhenger ikke av skalaene på X og Y og kan sammenlignes på tvers av mål", "r har alltid enheten prosent", "r måles i samme enhet som Y", "r er alltid mellom 0 og 100"],
    ...
    },
    {
      ...
      options: ["Fordi det er samvariasjon på naturlig, selvvalgt variasjon — tredjevariabler er ikke utelukket", "Fordi r er for lavt", "Fordi r er negativt", "Fordi r er en prosent"],
    ...
    },
    {
      ...
      options: ["At to variabler samvarierer systematisk — ikke hvorfor", "At X forårsaker Y", "At Y forårsaker X", "At variablene er identiske"],
  ...
  'psy1010-5-2': [
    {
      ...
      options: ["z → X og z → Y (z påvirker begge)", "X → z → Y", "z endrer styrken på X → Y", "Y → X"],
      explanation: "Konfunderen påvirker både X og Y og skaper en (delvis) falsk sammenheng.",
    },
    {
      question: "Hvordan tegnes en mediator?",
      options: ["X → z → Y (z er mekanismen)", "z → X og z → Y", "z endrer styrken på X → Y", "X → Y uten z"],
      explanation: "Mediatoren ligger mellom X og Y — mekanismen X virker gjennom.",
    },
    {
      question: "Hva kjennetegner en moderator?",
      options: ["z endrer styrken (eller retningen) på X → Y", "z påvirker både X og Y", "z ligger mellom X og Y", "z gjør sammenhengen spuriøs"],
    ...
    },
    {
      ...
      options: ["Konfunder kommer før X (falsk sammenheng); mediator kommer etter X (ekte mekanisme)", "Ingenting — de er synonymer", "Konfunder gjelder bare eksperimenter", "Mediator gjør sammenhengen falsk"],
    ...
    },
    {
      ...
      options: ["En korrelasjon uten ekte, direkte forbindelse — drevet av konfunder eller tilfeldighet", "En sterk kausal sammenheng", "En sammenheng der r = 1", "En korrelasjon som alltid er negativ"],
    ...
    },
    {
      ...
      options: ["Varmt vær (som driver begge)", "Isen selv", "Antall livreddere", "Tilfeldig støy"],
    ...
    },
    {
      ...
      options: ["retningsproblemet, tredjevariabler og spuriøse sammenhenger", "reliabilitet, validitet og bias", "nominal, ordinal og intervall", "utvalg, måling og design"],
      explanation: "Å nevne alle tre (ikke bare «en tredjevariabel») løfter svaret.",
    },
    {
      question: "Hva bør man gjøre med en konfunder z?",
      options: ["Kontrollere for den (holde konstant / ta inn i multippel regresjon)", "Forsterke den", "Ignorere den — den er mekanismen", "Bytte den med X"],
    ...
    },
    {
      ...
      options: ["Fordi mediatoren er selve mekanismen — da forsvinner effekten man studerer", "Fordi den er falsk", "Fordi den ikke kan måles", "Fordi den alltid er en konfunder"],
    ...
    },
    {
      ...
      options: ["Oppramsing uten case-tilpasning — nærmer seg C-tak", "Feil #6 (SD/SE)", "Feil #4 (kasus/N=1)", "Ingen feil — det er alltid nok"],
      explanation: "A-kravet er å case-tilpasse modellene til scenariets faktiske variabler.",
    },
    {
      question: "En rivaliserende hypotese er",
      options: ["en alternativ forklaring dataene ikke kan utelukke", "en hypotese som alltid er sann", "det samme som nullhypotesen", "en feil i utvalget"],
    ...
    },
    {
      ...
      options: ["Fastslår tidsrekkefølge — X målt før Y utelukker Y→X", "Fjerner alle konfundere", "Gjør r større", "Erstatter randomisering fullstendig"],
    ...
    },
    {
      ...
      options: ["En konfunder: folketallet driver begge", "Kirker forårsaker barer", "Barer forårsaker kirker", "Ren tilfeldighet uten forklaring"],
    ...
    },
    {
      ...
      options: ["En korrelasjon uten noen felles årsak, funnet ved å lete gjennom mange variabler", "En sammenheng drevet av en konfunder", "En sterk kausal sammenheng", "En mediert sammenheng"],
    ...
    },
    {
      ...
      options: ["konfunder (påvirker både regler og karakterer)", "mediator", "moderator", "kriterievariabel"],
    ...
    },
    {
      ...
      options: ["Den måler begge variabler samtidig, uten tidsrekkefølge eller randomisering", "Fordi r alltid er negativt", "Fordi utvalget er for lite", "Fordi den bruker ordinaldata"],
    ...
    },
    {
      ...
      options: ["Da fjerner man nettopp effekten man ønsker å forklare", "Ingenting — det er alltid riktig", "Mediatoren er en konfunder", "Man kan aldri kontrollere for noe"],
  ...
  'psy1010-5-3': [
    {
      ...
      options: ["Interceptet: predikert Y når X = 0", "Endringen i Y per enhet X", "Korrelasjonen mellom X og Y", "Residualen"],
      explanation: "a er linjens utgangspunkt (Y-akse-kryss), ikke «effekten av X».",
    },
    {
      question: "Hva er b i Ŷ = a + bX?",
      options: ["Regresjonsvekten: endring i predikert Y per én enhets økning i X", "Predikert Y når X = 0", "Andelen forklart varians", "Den observerte Y-verdien"],
      explanation: "b er stigningstallet; fortegnet følger r.",
    },
    {
      question: "Hva er Ŷ («Y-hatt»)?",
      options: ["Den predikerte verdien av Y, lest av linjen", "Den faktisk observerte Y", "Standardavviket til Y", "Korrelasjonen"],
    ...
    },
    {
      ...
      options: ["Andelen av variasjonen i Y som deles med (forklares av) X", "Korrelasjonens fortegn", "Det samme som r", "Regresjonsvekten b"],
    ...
    },
    {
      ...
      options: ["r kan bare rangeres; r² gir andeler som kan sammenlignes direkte", "r² er alltid negativt", "r² fjerner kausalitet", "r² er lettere å regne"],
      explanation: "r = 0,4 gir r² = 0,16 mot 0,04 for 0,2 — fire ganger, ikke dobbelt.",
    },
    {
      question: "Hva er en residual?",
      options: ["Y − Ŷ: avstanden fra en faktisk verdi til linjen", "a + bX", "Det samme som b", "Korrelasjonen"],
      explanation: "Residualen er modellens bomavstand for den enkelte personen.",
    },
    {
      question: "Hva minimerer minste kvadraters metode?",
      options: ["Summen av de kvadrerte residualene", "Summen av X-verdiene", "Korrelasjonen", "Antall punkter"],
    ...
    },
    {
      ...
      options: ["a er predikert Y når X = 0, ikke en effekt — effekten er b", "Ingen feil", "a er alltid null", "a er residualen"],
      explanation: "a er utgangspunktet; b er endringen per X.",
    },
    {
      question: "Hva er ekstrapolering?",
      options: ["Å predikere for X-verdier utenfor det observerte området", "Å regne r²", "Å plotte punktene", "Å velge minste kvadrater"],
    ...
    },
    {
      ...
      options: ["−3 (personen ligger under linjen)", "+3", "0", "50"],
      explanation: "Residual = Y − Ŷ = 47 − 50 = −3; negativ = under linjen.",
    },
    {
      question: "Hva legger regresjon til, sammenlignet med korrelasjon?",
      options: ["En prediksjonslinje — hvor mye Y endrer seg per X", "Kausalitet", "Et signifikansnivå", "Et nytt målenivå"],
    ...
    },
    {
      ...
      options: ["Minste kvadrater minimerer feilen i Y; bytter man om, får man en annen linje", "Fordi r er symmetrisk", "Fordi X alltid er årsak", "Det er de — de er vilkårlige"],
    ...
    },
    {
      ...
      options: ["Den forklarte andelen er r² = 0,25 = 25 %, ikke r", "Ingenting", "r² = 0,50", "r kan ikke være 0,50"],
      explanation: "Å lese r som prosent dobler den forklarte variansen.",
    },
    {
      question: "Fortegnet til b følger",
      options: ["fortegnet til r", "alltid positivt", "fortegnet til a", "målenivået"],
      explanation: "Positiv korrelasjon gir positiv b; negativ gir negativ b.",
    },
    {
      question: "Hva forteller store residualer om modellen?",
      options: ["At linjen forklarer lite (lav r²)", "At r² er høy", "At b er null", "At prediksjonen er perfekt"],
    ...
    },
    {
      ...
      options: ["Feil #13 — usynlig utregning", "Feil #3 — kausal tolkning", "Feil #6 — SD/SE", "Feil #12 — populasjon/utvalg"],
    ...
    },
    {
      ...
      options: ["Nei — det er predikert samvariasjon på korrelasjonsdata, ikke en kausal effekt", "Ja, alltid", "Ja, hvis r > 0,5", "Nei, b er alltid tilfeldig"],
  ...
  'psy1010-8-2': [
    ...
    },
    {
      ...
      explanation: "Enhalet p = tohalet p / 2 = 0,036/2 = 0,018. Men den er kun gyldig med FORHÅNDSbegrunnet retning — å velge enhalet i etterkant for å presse p under grensen er feil #11.",
    },
    {
