    ...
    },
    {
      ...
      exercise: {
        ...
        options: [
          {
            id: 'a',
            text: 'At alle land har blitt demokratiske',
            isCorrect: false,
          },
          {
            id: 'b',
            text: 'Prosessen der verden blir tettere sammenkoblet økonomisk, kulturelt og politisk',
            isCorrect: true,
          },
          {
            id: 'c',
            text: 'At internett finnes i alle land',
            isCorrect: false,
          },
          {
            id: 'd',
            text: 'At alle snakker samme språk',
            isCorrect: false,
          },
        ],
        solution:
          'Globalisering er prosessen der verden blir stadig tettere sammenkoblet på tvers av landegrenser -- økonomisk gjennom handel og investeringer, kulturelt gjennom utveksling av ideer og populærkultur, og politisk gjennom internasjonale organisasjoner og avtaler.',
      },
    },
    {
    ...
    },
    {
      ...
      exercise: {
        ...
        options: [
          {
            id: 'a',
            text: 'At plattformene selv produserer alle varene og tjenestene',
            isCorrect: false,
          },
          {
            id: 'b',
            text: 'At digitale plattformer kobler sammen tilbydere og etterspørrere, og nettverkseffekter skaper dominerende aktører',
            isCorrect: true,
          },
          {
            id: 'c',
            text: 'At alle bedrifter må være på internett',
            isCorrect: false,
          },
          {
            id: 'd',
            text: 'At staten eier alle digitale tjenester',
            isCorrect: false,
          },
        ],
        solution:
          'Plattformøkonomien kjennetegnes av at digitale plattformer fungerer som mellommenn som kobler sammen de som tilbyr og de som etterspør varer og tjenester. Nettverkseffekter -- at verdien øker jo flere som bruker tjenesten -- skaper ofte dominerende monopollignende aktører.',
      },
    },
    {
    ...
    },
    {
      ...
      exercise: {
        ...
        options: [
          {
            id: 'a',
            text: 'Forbrukere som har fått billigere varer',
            isCorrect: false,
          },
          {
            id: 'b',
            text: 'Multinasjonale selskaper med global tilgang',
            isCorrect: false,
          },
          {
            id: 'c',
            text: 'Industriarbeidere i Vesten som har mistet jobber til lavkostland',
            isCorrect: true,
          },
          {
            id: 'd',
            text: 'Høyt utdannede med internasjonale karrierer',
            isCorrect: false,
          },
        ],
        solution:
          'Industriarbeidere i vestlige land har vært blant globaliseringens tydeligste tapere. Fabrikker har flyttet til land med lavere lønninger, og hele lokalsamfunn har mistet sitt økonomiske grunnlag. Denne misnøyen har bidratt til fremveksten av populistiske bevegelser.',
      },
    },
    {
    ...
    },
    {
      ...
      exercise: {
        ...
        options: [
          {
            id: 'a',
            text: 'En funksjon som forsterker lyd i videosamtaler',
            isCorrect: false,
          },
          {
            id: 'b',
            text: 'Når algoritmer viser deg innhold du allerede er enig i, så du lever i din egen informasjonsboble',
            isCorrect: true,
          },
          {
            id: 'c',
            text: 'Et sted der du kan snakke anonymt',
            isCorrect: false,
          },
          {
            id: 'd',
            text: 'En type kryptert meldingstjeneste',
            isCorrect: false,
          },
        ],
        solution:
          'Ekkokamre oppstår når sosiale mediers algoritmer viser deg innhold som bekrefter det du allerede mener. Du ser stadig mer av det du liker, og mindre av motstridende synspunkter. Dette forsterker polarisering og gjør dialog vanskeligere.',
      },
    },
    {
    ...
    },
    {
      ...
      exercise: {
        ...
        options: [
          {
            id: 'a',
            text: 'At all internasjonal handel bør stoppes',
            isCorrect: false,
          },
          {
            id: 'b',
            text: 'At teknologi er skadelig og bør forbys',
            isCorrect: false,
          },
          {
            id: 'c',
            text: 'At gevinstene har vært ujevnt fordelt og taperne trenger beskyttelse',
            isCorrect: true,
          },
          {
            id: 'd',
            text: 'At bare rike land bør handle med hverandre',
            isCorrect: false,
          },
        ],
        solution:
          'Et sentralt argument er at globaliseringens gevinster har vært ujevnt fordelt. Noen har tjent enormt, mens andre har tapt. En bedre styrt globalisering kan fordele gevinstene jevnere, beskytte tapere, sikre arbeideres rettigheter og sørge for at selskaper betaler skatt der de opererer.',
      },
    },
    {
    ...
    },
    {
      ...
      exercise: {
        ...
        options: [
          {
            id: 'a',
            text: 'Det er ingen forskjell i internasjonal rett',
            isCorrect: false,
          },
          {
            id: 'b',
            text: 'Flyktninger har rett til beskyttelse fordi de flykter fra forfølgelse, økonomiske migranter flytter primært for bedre levekår',
            isCorrect: true,
          },
          {
            id: 'c',
            text: 'Flyktninger kommer fra fattige land, økonomiske migranter fra rike land',
            isCorrect: false,
          },
          {
            id: 'd',
            text: 'Økonomiske migranter har flere rettigheter enn flyktninger',
            isCorrect: false,
          },
        ],
        solution:
          'Ifølge FNs flyktningkonvensjon har flyktninger -- de som flykter fra forfølgelse -- rett til beskyttelse og kan ikke sendes tilbake. Økonomiske migranter flytter primært for bedre økonomiske forhold og har ikke samme juridiske krav. I praksis er skillet ofte uklart.',
      },
    },
    {
    ...
    },
    {
      ...
      exercise: {
        ...
        options: [
          {
            id: 'a',
            text: 'At flyktninger må søke asyl i første trygge land de kommer til',
            isCorrect: false,
          },
          {
            id: 'b',
            text: 'At stater ikke kan returnere flyktninger til steder der de risikerer forfølgelse',
            isCorrect: true,
          },
          {
            id: 'c',
            text: 'At flyktninger har rett til statsborgerskap i landet de flykter til',
            isCorrect: false,
          },
          {
            id: 'd',
            text: 'At alle som krysser en grense automatisk blir flyktninger',
            isCorrect: false,
          },
        ],
        solution:
          'Non-refoulement er det viktigste prinsippet i flyktningretten. Det forbyr stater å returnere flyktninger til steder der de risikerer forfølgelse. Dette er en absolutt regel i internasjonal rett og kan ikke fravikes.',
      },
    },
    {
    ...
    },
    {
      ...
      exercise: {
        ...
        options: [
          {
            id: 'a',
            text: 'At innvandrere fullstendig gir opp sin opprinnelige kultur',
            isCorrect: false,
          },
          {
            id: 'b',
            text: 'At ulike kulturer lever helt adskilt fra hverandre',
            isCorrect: false,
          },
          {
            id: 'c',
            text: 'En toveis prosess der innvandrere blir deltakere i samfunnet mens de kan beholde kulturell egenart',
            isCorrect: true,
          },
          {
            id: 'd',
            text: 'At alle innvandrere får automatisk statsborgerskap',
            isCorrect: false,
          },
        ],
        solution:
          'Integrering er en toveis prosess der innvandrere lærer språk, deltar i arbeidsliv og aksepterer grunnleggende verdier, samtidig som samfunnet gir muligheter og ikke diskriminerer. Man kan delta fullt ut og likevel beholde kulturell identitet.',
      },
    },
    {
    ...
    },
    {
      ...
      exercise: {
        ...
        options: [
          {
            id: 'a',
            text: 'At innvandrere ikke bruker offentlige tjenester',
            isCorrect: false,
          },
          {
            id: 'b',
            text: 'At innvandrere som jobber betaler skatt og bidrar til å finansiere velferdsstaten',
            isCorrect: true,
          },
          {
            id: 'c',
            text: 'At velferdsstaten ikke trenger finansiering',
            isCorrect: false,
          },
          {
            id: 'd',
            text: 'At alle innvandrere er rike',
            isCorrect: false,
          },
        ],
        solution:
          'Innvandrere som kommer i arbeid betaler skatt og bidrar til å finansiere velferdsordninger. I aldrende samfunn med synkende fødselstall kan arbeidsinnvandring bidra til å opprettholde velferdsstaten. Nøkkelen er vellykket integrering i arbeidslivet.',
      },
    },
    {
    ...
    },
    {
      ...
      exercise: {
        ...
        options: [
          {
            id: 'a',
            text: 'Fordi klimaendringer ikke er et reelt problem',
            isCorrect: false,
          },
          {
            id: 'b',
            text: 'Fordi klimaflyktninger ikke er dekket av FNs flyktningkonvensjon',
            isCorrect: true,
          },
          {
            id: 'c',
            text: 'Fordi det finnes for mange klimaflyktninger allerede',
            isCorrect: false,
          },
          {
            id: 'd',
            text: 'Fordi klimaflyktninger ikke vil flytte',
            isCorrect: false,
          },
        ],
        solution:
          'FNs flyktningkonvensjon fra 1951 dekker folk som flykter fra forfølgelse, ikke fra klimaendringer. Det betyr at mennesker som mister hjemmet sitt på grunn av stigende hav eller tørke ikke har samme juridiske beskyttelse som tradisjonelle flyktninger.',
      },
    },
    {
    ...
    },
    {
      ...
      exercise: {
        ...
        options: [
          {
            id: 'a',
            text: 'En type fredsprosess mellom etniske grupper',
            isCorrect: false,
          },
          {
            id: 'b',
            text: 'Systematisk fordrivelse av en etnisk gruppe fra et område gjennom vold og terror',
            isCorrect: true,
          },
          {
            id: 'c',
            text: 'En juridisk prosess for å bestemme etnisk tilhørighet',
            isCorrect: false,
          },
          {
            id: 'd',
            text: 'En type folkeavstemning',
            isCorrect: false,
          },
        ],
        solution:
          'Etnisk rensing er systematisk fordrivelse av en etnisk eller religiøs gruppe fra et område gjennom vold, terror, drap eller trusler. Målet er å skape et etnisk "rent" område. Det er en krigsforbrytelse under internasjonal rett.',
      },
    },
    {
    ...
    },
    {
      ...
      exercise: {
        ...
        options: [
          {
            id: 'a',
            text: 'At Irak hadde angrepet USA direkte',
            isCorrect: false,
          },
          {
            id: 'b',
            text: 'At Irak angivelig hadde masseødeleggelsesvåpen og forbindelser til terrorisme',
            isCorrect: true,
          },
          {
            id: 'c',
            text: 'At FN hadde bedt USA invadere',
            isCorrect: false,
          },
          {
            id: 'd',
            text: 'At Irak hadde olje USA ville ha',
            isCorrect: false,
          },
        ],
        solution:
          'USAs offisielle begrunnelse var at Irak hadde masseødeleggelsesvåpen og forbindelser til al-Qaida. Begge påstandene viste seg å være feil, og invasjonen var svært kontroversiell. Mange land nektet å delta, og FN ga aldri mandat til invasjonen.',
      },
    },
    {
    ...
    },
    {
      ...
      exercise: {
        ...
        options: [
          {
            id: 'a',
            text: 'Krim erklærte seg uavhengig og ble anerkjent av FN',
            isCorrect: false,
          },
          {
            id: 'b',
            text: 'Russland annekterte Krim fra Ukraina etter en omstridt folkeavstemning',
            isCorrect: true,
          },
          {
            id: 'c',
            text: 'Ukraina solgte Krim til Russland',
            isCorrect: false,
          },
          {
            id: 'd',
            text: 'NATO tok kontroll over Krim',
            isCorrect: false,
          },
        ],
        solution:
          'I 2014 annekterte Russland Krim-halvøya fra Ukraina etter en folkeavstemning som de fleste land ikke anerkjente. Dette var et brudd på internasjonal rett og førte til vestlige sanksjoner mot Russland.',
      },
    },
    {
    ...
    },
    {
      ...
      exercise: {
        ...
        options: [
          {
            id: 'a',
            text: 'At FN kan stoppe alle kriger',
            isCorrect: false,
          },
          {
            id: 'b',
            text: 'At militær makt fortsatt er viktig og at internasjonal orden kan utfordres av stormakter',
            isCorrect: true,
          },
          {
            id: 'c',
            text: 'At NATO er overflødig',
            isCorrect: false,
          },
          {
            id: 'd',
            text: 'At alle land nå støtter Russland',
            isCorrect: false,
          },
        ],
        solution:
          'Invasjonen viste at militær makt fortsatt er et redskap i internasjonal politikk, og at den internasjonale ordenen som ble bygget etter andre verdenskrig kan utfordres av stormakter som er villige til å bryte folkeretten.',
      },
    },
    {
      ...
      exercise: {
        ...
        options: [
          {
            id: 'a',
            text: 'At jorden har flere magnetiske poler',
            isCorrect: false,
          },
          {
            id: 'b',
            text: 'At flere stormakter konkurrerer om innflytelse, i motsetning til USAs dominans på 1990-tallet',
            isCorrect: true,
          },
          {
            id: 'c',
            text: 'At alle land er like mektige',
            isCorrect: false,
          },
          {
            id: 'd',
            text: 'At FN styrer verden',
            isCorrect: false,
          },
        ],
        solution:
          'En multipolar verden betyr at flere stormakter -- som USA, Kina og Russland -- konkurrerer om innflytelse. Dette er i kontrast til 1990-tallet da USA var eneste supermakt ("unipolar verden") eller den kalde krigen med to supermakter ("bipolar verden").',
      },
    },
    {
    ...
    },
    {
      ...
      exercise: {
        ...
        options: [
          {
            id: 'a',
            text: 'En bok om klimaendringer',
            isCorrect: false,
          },
          {
            id: 'b',
            text: 'En foreslått geologisk epoke der menneskets aktivitet er blitt en dominerende kraft på jorden',
            isCorrect: true,
          },
          {
            id: 'c',
            text: 'En internasjonal klimaavtale',
            isCorrect: false,
          },
          {
            id: 'd',
            text: 'Et annet ord for den industrielle revolusjonen',
            isCorrect: false,
          },
        ],
        solution:
          'Antropocen betyr "menneskets tidsalder" og er en foreslått geologisk epoke der menneskelig aktivitet påvirker jordens systemer i samme skala som naturlige geologiske krefter -- gjennom klimaendringer, artstap, forurensing og landskapsendringer.',
      },
    },
    {
    ...
    },
    {
      ...
      exercise: {
        ...
        options: [
          {
            id: 'a',
            text: 'Utvikling som prioriterer økonomisk vekst over alt annet',
            isCorrect: false,
          },
          {
            id: 'b',
            text: 'Utvikling som bare fokuserer på miljø, ikke økonomi',
            isCorrect: false,
          },
          {
            id: 'c',
            text: 'Utvikling som dekker dagens behov uten å ødelegge fremtidige generasjoners muligheter',
            isCorrect: true,
          },
          {
            id: 'd',
            text: 'Utvikling som stopper all vekst',
            isCorrect: false,
          },
        ],
        solution:
          'Bærekraftig utvikling balanserer tre hensyn: økonomisk velstand, sosial rettferdighet og miljøvern. Kjernen er at vi ikke skal leve på bekostning av fremtidige generasjoner.',
      },
    },
    {
    ...
    },
    {
      ...
      exercise: {
        ...
        options: [
          {
            id: 'a',
            text: 'At alle land har like stort ansvar for klimaendringene',
            isCorrect: false,
          },
          {
            id: 'b',
            text: 'At de som har bidratt mest til klimaendringene bør ta størst ansvar, og de som rammes hardest ofte har bidratt minst',
            isCorrect: true,
          },
          {
            id: 'c',
            text: 'At klimaendringene ikke er et rettferdighetsspørsmål',
            isCorrect: false,
          },
          {
            id: 'd',
            text: 'At bare rike land påvirkes av klimaendringer',
            isCorrect: false,
          },
        ],
        solution:
          'Klimarettferdighet handler om at rike land har stått for mesteparten av de historiske utslippene, men de fattigste landene -- som har bidratt minst -- rammes hardest av konsekvensene. Dette reiser vanskelige spørsmål om ansvar og rettferdig fordeling av byrder.',
      },
    },
    {
    ...
    },
    {
      ...
      exercise: {
        ...
        options: [
          {
            id: 'a',
            text: 'At Norge ikke har noen oljeindustri',
            isCorrect: false,
          },
          {
            id: 'b',
            text: 'At Norge både er klimapioner og stor eksportør av fossil energi',
            isCorrect: true,
          },
          {
            id: 'c',
            text: 'At Norge har de høyeste utslippene i verden',
            isCorrect: false,
          },
          {
            id: 'd',
            text: 'At Norge nekter å delta i klimaforhandlinger',
            isCorrect: false,
          },
        ],
        solution:
          'Det norske paradokset er at vi på den ene siden er klimapionerer med fornybar energi og elbiler, men på den andre siden er en stor eksportør av olje og gass som bidrar til globale utslipp. Dette gjør Norges rolle i klimaspørsmålet kompleks.',
      },
    },
    {
    ...
    },
    {
      ...
      exercise: {
        ...
        options: [
          {
            id: 'a',
            text: 'Teknologioptimisme',
            isCorrect: false,
          },
          {
            id: 'b',
            text: 'Markedsbaserte løsninger som karbonkvoter',
            isCorrect: false,
          },
          {
            id: 'c',
            text: 'Degrowth (nedvekst)',
            isCorrect: true,
          },
          {
            id: 'd',
            text: 'Grønn kapitalisme',
            isCorrect: false,
          },
        ],
        solution:
          'Degrowth eller nedvekst er en tilnærming som mener at kontinuerlig økonomisk vekst er uforenlig med en begrenset planet. Tilhengerne mener vi bevisst må produsere og konsumere mindre, i motsetning til grønn vekst som mener vekst og miljø kan kombineres.',
      },
    },
    {
    ...
    },
    {
      ...
      exercise: {
        ...
        options: [
          {
            id: 'a',
            text: 'Å kunne mange årstall og navn fra historien',
            isCorrect: false,
          },
          {
            id: 'b',
            text: 'Forståelsen av sammenhengen mellom fortid, nåtid og fremtid',
            isCorrect: true,
          },
          {
            id: 'c',
            text: 'Å være interessert i historie som hobby',
            isCorrect: false,
          },
          {
            id: 'd',
            text: 'Å ha studert historie på universitet',
            isCorrect: false,
          },
        ],
        solution:
          'Historiebevissthet handler om å forstå at nåtiden er formet av fortiden, og at våre handlinger i dag former fremtiden. Det er evnen til å tenke historisk -- å se sammenhenger og endringer over tid.',
      },
    },
    {
    ...
    },
    {
      ...
      exercise: {
        ...
        options: [
          {
            id: 'a',
            text: 'Bare om fremstillingen er underholdende',
            isCorrect: false,
          },
          {
            id: 'b',
            text: 'Hvem forteller, hva inkluderes og utelates, og hvilket formål det tjener',
            isCorrect: true,
          },
          {
            id: 'c',
            text: 'Om fremstillingen er gammel eller ny',
            isCorrect: false,
          },
          {
            id: 'd',
            text: 'Om den handler om konger eller vanlige folk',
            isCorrect: false,
          },
        ],
        solution:
          'Kritisk historiebevissthet innebærer å spørre: Hvem forteller denne historien? Hva velger de å inkludere og hva utelater de? Hvilket formål tjener fremstillingen? Alle historiefortellinger gjør valg, og det er viktig å være bevisst disse.',
      },
    },
    {
    ...
    },
    {
      ...
      exercise: {
        ...
        options: [
          {
            id: 'a',
            text: 'Fordi det ikke er underholdende',
            isCorrect: false,
          },
          {
            id: 'b',
            text: 'Fordi det kan legitimere urett, spre hat og hindre forsoning',
            isCorrect: true,
          },
          {
            id: 'c',
            text: 'Fordi det gjør historie kjedelig',
            isCorrect: false,
          },
          {
            id: 'd',
            text: 'Fordi det kun skjer i diktaturer',
            isCorrect: false,
          },
        ],
        solution:
          'Historiemisbruk -- å forvrenge eller forfalske historien for bestemte formål -- er farlig fordi det kan brukes til å legitimere undertrykkelse, rettferdiggjøre konflikter, spre hat og hindre forsoning. Evnen til å gjennomskue slikt misbruk er viktig i et demokrati.',
      },
    },
    {
    ...
    },
    {
      ...
      exercise: {
        ...
        options: [
          {
            id: 'a',
            text: 'Historien gjentar seg alltid eksakt hvis vi glemmer den',
            isCorrect: false,
          },
          {
            id: 'b',
            text: 'Historiekunnskap garanterer at vi unngår alle feil',
            isCorrect: false,
          },
          {
            id: 'c',
            text: 'Historiske mønstre kan gjenta seg, og kunnskap er nyttig men ikke nok alene',
            isCorrect: true,
          },
          {
            id: 'd',
            text: 'Påstanden er helt usann -- historien gjentar seg aldri',
            isCorrect: false,
          },
        ],
        solution:
          'Historiske mønstre kan gjenta seg, og kunnskap om dem er verdifull. Men historien gjentar seg aldri eksakt, og kunnskap alene garanterer ikke at vi unngår feil -- det krever også vilje til å handle på kunnskapen.',
      },
    },
    {
    ...
    },
    {
      ...
      exercise: {
        ...
        options: [
          {
            id: 'a',
            text: 'At fremtiden er forutbestemt og vi ikke kan påvirke den',
            isCorrect: false,
          },
          {
            id: 'b',
            text: 'At fremtiden alltid blir bedre uten at vi trenger å gjøre noe',
            isCorrect: false,
          },
          {
            id: 'c',
            text: 'At fremtiden er åpen, endring er mulig, og mennesker har handlingsrom',
            isCorrect: true,
          },
          {
            id: 'd',
            text: 'At vi bør unngå all endring og bevare alt som det er',
            isCorrect: false,
          },
        ],
        solution:
          'Historien viser at fremtiden er åpen -- ikke forutbestemt. Ting vi tar for gitt i dag var utenkelige for noen generasjoner siden. Endring er mulig, og mennesker som velger å handle kan gjøre en forskjell.',
      },
    },
    {
