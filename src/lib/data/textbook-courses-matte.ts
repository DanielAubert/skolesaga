...
export const COURSE_BI_OKONOMI: TextbookCourse = {
  ...
  chapters: [
    ...
    },
    {
      ...
      description: 'Optimering med bibetingelse — Lagrange-funksjonen, førsteordens betingelser og skyggepristolkning av $\\lambda$.',
      estimatedMinutes: 60,
      exerciseCount: 14,
    ...
    },
    {
      ...
      description: 'Determinant for $2\\times 2$ og $3\\times 3$ (Sarrus, kofaktorutvikling), invers matrise og invertibilitet.',
      estimatedMinutes: 55,
      exerciseCount: 16,
