...
export const COURSE_8: TextbookCourse = {
  ...
  chapters: [
    ...
    },
    {
      ...
      estimatedMinutes: 50,
      exerciseCount: 14,
      topics: ['Prosent', 'Prosent av', 'Hvor mange prosent', 'Hele når delen er kjent', 'Vekstfaktor'],
      competenceGoals: ['utforske og argumentere for korleis rekne med forhold, prosent og vekstfaktor'],
      coverImage: 'https://images.unsplash.com/photo-1554224155-6726b3ff858f?w=800&h=400&fit=crop',
    ...
    // Kapittel 2: Primtall og faktorisering (KM203)
    {
      id: '8-7-1',
      number: '2.1',
    ...
    // Kapittel 3: Algebra og mønstre (KM202, KM238)
    {
      id: '8-2-1',
      number: '3.1',
      title: 'Bokstavregning',
    ...
    },
    {
      ...
      description: 'Løse enkle likninger og ulikheter ved systematiske metoder.',
      estimatedMinutes: 60,
      exerciseCount: 16,
      topics: ['Likninger', 'Ulikheter', 'Ukjent', 'Løse likninger', 'Ulikhetstegn'],
      prerequisites: ['8-2-1'],
      competenceGoals: ['løyse likningar og ulikskapar og forklare kva det vil seie at ein storleik er ukjend'],
      coverImage: 'https://images.unsplash.com/photo-1534551767192-78b8dd45b51b?w=800&h=400&fit=crop',
    ...
    },
    {
      id: '8-4-1',
      number: '4.2',
      title: 'Trekanter og vinkelsum',
      description: 'Vinkelsum, trekanttyper og klassifisering av trekanter.',
      estimatedMinutes: 45,
      exerciseCount: 10,
    ...
    // Kapittel 5: Funksjoner og grafer (KM199, KM232)
    {
      id: '8-10-1',
      number: '5.1',
      title: 'Hva er en funksjon?',
    ...
    },
    {
      ...
      number: '5.2',
      title: 'Koordinatsystemet',
      description: 'Punkter, akser og koordinater i et koordinatsystem.',
      estimatedMinutes: 40,
      exerciseCount: 10,
      topics: ['Koordinatsystem', 'Punkter', 'x-akse', 'y-akse', 'Kvadranter'],
    ...
    },
    {
      id: '8-4-5',
      number: '5.6',
      title: 'Tolke og lese grafer',
      description: 'Lese av og tolke informasjon fra grafer i praktiske sammenhenger.',
      estimatedMinutes: 45,
      exerciseCount: 10,
    ...
    // Kapittel 6: Statistikk og sannsynlighet
    {
      ...
      description: 'Gjennomsnitt, median, typetall, variasjonsbredde og kvartiler.',
      estimatedMinutes: 60,
      exerciseCount: 15,
      topics: ['Gjennomsnitt', 'Median', 'Typetall', 'Sentralmål', 'Variasjonsbredde', 'Kvartiler', 'IQR', 'Spredningsmål'],
    ...
    },
    {
      ...
      estimatedMinutes: 45,
      exerciseCount: 12,
      topics: ['Sannsynlighet', 'Utfall', 'Gunstige utfall', 'Eksperimenter', 'Simulering', 'Python'],
    ...
    // Kapittel 8: Hoderegning og tallforståelse (KM208)
    {
      id: '8-6-1',
      number: '8.1',
    ...
    // Kapittel 9: Programmering og algoritmer (KM201)
    {
      id: '8-11-1',
      number: '9.1',
      title: 'Introduksjon til programmering med Python',
      description: 'Kom i gang med programmering gjennom tekstbasert koding i Python.',
      estimatedMinutes: 50,
      exerciseCount: 10,
...
export const COURSE_1P: TextbookCourse = {
  ...
  chapters: [
    ...
    },
    {
      ...
      description: 'Lær å bruke regneark til matematisk modellering, formler, cellereferanser og diagrammer.',
      estimatedMinutes: 45,
      exerciseCount: 6,
...
export const COURSE_S1: TextbookCourse = {
  ...
  chapters: [
    ...
    // Kapittel 4: Økonomi (KM5/KM6 — derivasjon i økonomi)
    {
      ...
      description: 'Økonomiske funksjoner — kostnad, inntekt og overskudd som grunnlag for økonomisk optimering.',
      estimatedMinutes: 55,
      exerciseCount: 17,
    ...
    },
    {
      id: 's1-4-2',
      number: '4.2',
      title: 'Derivasjon i økonomiske modeller',
      description: 'Anvendelse av derivasjon på kostnads-, inntekts- og overskuddsfunksjoner — finn optimal produksjon.',
      estimatedMinutes: 50,
      exerciseCount: 17,
    ...
    },
    {
      ...
      description: 'Etterspørselsfunksjoner og priselastisitet — analyse med derivasjon.',
      estimatedMinutes: 55,
      exerciseCount: 17,
    ...
    },
    {
      id: 's1-4-5',
      number: '4.5',
      title: 'Elastisitet — utvidet',
      description: 'Priselastisitet, krysspriselastisitet og inntektselastisitet i samfunnsøkonomiske analyser.',
      estimatedMinutes: 50,
      exerciseCount: 15,
    ...
    },
    {
      ...
      number: '4.6',
      title: 'Indeksregning',
      description: 'Prisindeks, konsumprisindeks (KPI), reallønn og kjøpekraft.',
      estimatedMinutes: 50,
      exerciseCount: 11,
      topics: ['Indeks', 'Konsumprisindeks', 'Realverdi', 'Nominell verdi', 'Reallønn'],
    ...
    // Kapittel 7: Regresjon og korrelasjon (KM1/KM5)
    {
      ...
      number: '7.1',
      title: 'Lineær regresjon',
      description: 'Spredningsplott, minste kvadraters metode, regresjonslinje, residualer og determinasjonskoeffisienten R².',
      estimatedMinutes: 55,
      exerciseCount: 19,
    ...
    },
    {
      ...
      number: '7.3',
      title: 'Ikke-lineær regresjon',
      description: 'Eksponentiell, potens- og logaritmisk regresjon — modellvalg og logaritmisk transformasjon.',
      estimatedMinutes: 55,
      exerciseCount: 17,
    ...
    },
    {
      ...
      description: 'Bruk residualer og residualplott til å vurdere modellkvalitet og avgjøre når en annen modelltype bør prøves.',
      estimatedMinutes: 50,
      exerciseCount: 17,
      topics: ['Residual', 'Residualplott', 'Modellvurdering', 'Uteliggere'],
      prerequisites: ['s1-7-1'],
      competenceGoals: ['anvende derivasjon til å analysere og tolke egne matematiske modeller av reelle datasett'],
    ...
    // Seksjon 4 utvidet
    {
      ...
      description: 'Tilbuds- og etterspørselskurver, markedslikevekt og virkninger av endringer i markedet.',
      estimatedMinutes: 55,
      exerciseCount: 9,
    ...
    },
    {
      ...
      description: 'Profittmaksimering og kostnadsminimering med derivasjon.',
      estimatedMinutes: 60,
      exerciseCount: 9,
    ...
    },
    {
      ...
      description: 'Slik planlegger og gjennomfører du et selvstendig statistikk- og dataarbeid med samfunnsøkonomiske data, fra problemstilling til ferdig rapport.',
      estimatedMinutes: 75,
      exerciseCount: 11,
    ...
    },
    {
      ...
      number: '8.4',
      title: 'Modellering med reelle datasett',
      description: 'Velg modelltype, vurder kvalitet med R² og residualer, og valider mot ekte samfunnsøkonomiske data fra SSB.',
      estimatedMinutes: 70,
      exerciseCount: 15,
    ...
    },
    {
      ...
      description: 'Praktisk pipeline fra åpne SSB-data til ferdig analyse: GeoGebra, Excel og Python — hvilket verktøy når.',
      estimatedMinutes: 60,
      exerciseCount: 12,
    ...
    },
    {
      id: 's1-8-6',
      number: '8.6',
      title: 'Selvstendig samfunnsøkonomisk prosjekt',
      description: 'Komplett prosjektmal med vurderingskriterier — binder sammen kapittel 4, 7 og 8 i et fullstendig selvstendig arbeid.',
      estimatedMinutes: 90,
      exerciseCount: 10,
...
export const COURSE_BI_OKONOMI: TextbookCourse = {
  ...
  chapters: [
      ...
      coverImage: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=800&h=400&fit=crop', linkedChapterId: 'bi-okonomi-4-5-narrativ' },
    {
      ...
      estimatedMinutes: 50,
      exerciseCount: 14,
      topics: ['Kontinuerlig forrentning', 'Eulers tall', 'Diskontering', 'Effektiv rente', 'Doblingstid'],
      prerequisites: ['bi-okonomi-4-1', 'bi-okonomi-3-3'],
      competenceGoals: ['utlede og bruke formelen $K_t = K_0 e^{rt}$', 'beregne nåverdi med kontinuerlig diskontering'],
      coverImage: 'https://images.unsplash.com/photo-1579621970795-87facc2f976d?w=800&h=400&fit=crop',
    },
      ...
      coverImage: 'https://images.unsplash.com/photo-1507925921958-8a62f3d1a50d?w=800&h=400&fit=crop', linkedChapterId: 'bi-okonomi-5-5-narrativ' },
    {
      ...
      number: '5.6',
      title: 'Implisitt derivasjon',
      description: 'Derivasjon av kurver gitt på formen F(x,y)=c og beregning av grensesubstitusjonsrate (MRS).',
      estimatedMinutes: 50,
      exerciseCount: 14,
      ...
      coverImage: 'https://images.unsplash.com/photo-1635070041078-e363dbe005cb?w=800&h=400&fit=crop', linkedChapterId: 'bi-okonomi-5-6-narrativ' },
    {
      ...
      description: 'Grenseverdier, ubestemte former og L\'Hôpitals regel for 0/0 og ∞/∞.',
      estimatedMinutes: 50,
      exerciseCount: 14,
      topics: ['Grenseverdi', 'Ubestemt form', 'L\'Hôpitals regel', 'Vekstrangering', 'Eulers grense'],
      prerequisites: ['bi-okonomi-5-3'],
      competenceGoals: ['beregne grenseverdier med L\'Hôpitals regel', 'rangere vekstrater for polynom, eksponential og logaritme'],
      coverImage: 'https://images.unsplash.com/photo-1509228468518-180dd4864904?w=800&h=400&fit=crop',
    },
    {
      id: 'bi-okonomi-5-8',
      number: '5.8',
      title: 'Konveksitet og konkavitet',
      description: 'Definisjon, andrederiverttest, vendepunkter og økonomisk tolkning (risikoaversjon, avtakende grensenytte).',
      estimatedMinutes: 45,
      exerciseCount: 14,
    ...
    // Seksjon 7: Funksjoner av flere variabler
    {
      id: 'bi-okonomi-7-1',
      number: '7.1',
      title: 'Funksjoner av to variabler',
      description: 'Definisjonsmengde, verdimengde og nivåkurver for f(x,y), med Cobb-Douglas og nyttefunksjoner som eksempler.',
      estimatedMinutes: 50,
      exerciseCount: 14,
      ...
      coverImage: 'https://images.unsplash.com/photo-1518186285589-2f7649de83e0?w=800&h=400&fit=crop', linkedChapterId: 'bi-okonomi-7-1-narrativ' },
    {
      id: 'bi-okonomi-7-2',
      number: '7.2',
      title: 'Partielle deriverte',
      description: 'Førsteordens og andreordens partielle deriverte, Young\'s setning, og økonomiske anvendelser som marginalprodukt og grensenytte.',
      estimatedMinutes: 55,
      exerciseCount: 18,
      ...
      coverImage: 'https://images.unsplash.com/photo-1509228468518-180dd4864904?w=800&h=400&fit=crop', linkedChapterId: 'bi-okonomi-7-2-narrativ' },
    {
      id: 'bi-okonomi-7-3',
      number: '7.3',
      title: 'Stasjonære punkter og andrederiverttest',
      description: 'Stasjonære punkter, Hessian-determinanten og klassifisering av lokale ekstrema og sadelpunkter.',
      estimatedMinutes: 60,
      exerciseCount: 16,
      ...
      coverImage: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=800&h=400&fit=crop', linkedChapterId: 'bi-okonomi-7-3-narrativ' },
    {
      id: 'bi-okonomi-7-4',
      number: '7.4',
      title: 'Lagranges multiplikatormetode',
      description: 'Optimering med bibetingelse — Lagrange-funksjonen, førsteordens betingelser og skyggepristolkning av λ.',
      estimatedMinutes: 60,
      exerciseCount: 14,
      ...
      coverImage: 'https://images.unsplash.com/photo-1507925921958-8a62f3d1a50d?w=800&h=400&fit=crop', linkedChapterId: 'bi-okonomi-7-4-narrativ' },
    {
      id: 'bi-okonomi-7-5',
      number: '7.5',
      title: 'Cobb-Douglas og økonomiske anvendelser',
      description: 'Cobb-Douglas produktfunksjon, skalaegenskaper, marginalproduktivitet, MRS og Eulers teorem.',
      estimatedMinutes: 55,
      exerciseCount: 14,
    ...
    // Seksjon 8: Integrasjon
    {
      id: 'bi-okonomi-8-1',
      number: '8.1',
      title: 'Antiderivert og ubestemt integral',
      description: 'Antiderivert, integrasjonskonstant, standardformler og regneregler for ubestemte integraler.',
      estimatedMinutes: 50,
      exerciseCount: 16,
      ...
      coverImage: 'https://images.unsplash.com/photo-1635070041078-e363dbe005cb?w=800&h=400&fit=crop', linkedChapterId: 'bi-okonomi-8-1-narrativ' },
    {
      id: 'bi-okonomi-8-2',
      number: '8.2',
      title: 'Bestemt integral og fundamentalteoremet',
      description: 'Riemann-summer, bestemt integral, fundamentalteoremet (Newton-Leibniz) og areal mellom kurver.',
      estimatedMinutes: 55,
      exerciseCount: 16,
      ...
      coverImage: 'https://images.unsplash.com/photo-1596495577886-d920f1fb7238?w=800&h=400&fit=crop', linkedChapterId: 'bi-okonomi-8-2-narrativ' },
    {
      ...
      number: '8.3',
      title: 'Integrasjonsmetoder',
      description: 'Substitusjon (variabelskift) og delvis integrasjon, med LIATE-regelen som veiledning.',
      estimatedMinutes: 60,
      exerciseCount: 18,
      ...
      coverImage: 'https://images.unsplash.com/photo-1453733190371-0a9bedd82893?w=800&h=400&fit=crop', linkedChapterId: 'bi-okonomi-8-3-narrativ' },
    {
      id: 'bi-okonomi-8-4',
      number: '8.4',
      title: 'Økonomiske anvendelser av integral',
      description: 'Konsument- og produsentoverskudd, effektivitetstap, og kontinuerlig nåverdi av kontantstrømmer.',
      estimatedMinutes: 55,
      exerciseCount: 16,
    ...
    // Seksjon 9: Lineær algebra og matriser
    {
      id: 'bi-okonomi-9-1',
      number: '9.1',
      title: 'Matriser og matriseregning',
      description: 'Matriser, transponering, addisjon, skalarmultiplikasjon og matrise-multiplikasjon.',
      estimatedMinutes: 60,
      exerciseCount: 18,
      ...
      coverImage: 'https://images.unsplash.com/photo-1518186285589-2f7649de83e0?w=800&h=400&fit=crop', linkedChapterId: 'bi-okonomi-9-1-narrativ' },
    {
      id: 'bi-okonomi-9-2',
      number: '9.2',
      title: 'Determinanter og invers matrise',
      description: 'Determinant for 2× 2 og 3× 3 (Sarrus, kofaktorutvikling), invers matrise og invertibilitet.',
      estimatedMinutes: 55,
      exerciseCount: 16,
      ...
      coverImage: 'https://images.unsplash.com/photo-1509228468518-180dd4864904?w=800&h=400&fit=crop', linkedChapterId: 'bi-okonomi-9-2-narrativ' },
    {
      ...
      description: 'Matriseform A x= b, totalmatrise, radoperasjoner og Gauss-eliminasjon.',
      estimatedMinutes: 60,
      exerciseCount: 14,
      topics: ['Lineært likningssystem', 'Totalmatrise', 'Radoperasjoner', 'Trappeform', 'Gauss-eliminasjon'],
      prerequisites: ['bi-okonomi-9-2', 'bi-okonomi-2-3'],
      competenceGoals: ['løse lineære likningssystem med Gauss-eliminasjon', 'avgjøre antall løsninger ut fra trappeformen'],
      coverImage: 'https://images.unsplash.com/photo-1545670723-196ed0954986?w=800&h=400&fit=crop',
    },
    {
      id: 'bi-okonomi-9-4',
      ...
      description: 'Cramers regel og Leontief input-output-modell x=(I-A)⁻¹ d.',
      estimatedMinutes: 55,
      exerciseCount: 14,
      topics: ['Cramers regel', 'Leontief input-output', 'Teknologi-matrise', 'Markedslikevekt med flere varer', 'Portefølje'],
      prerequisites: ['bi-okonomi-9-3'],
      competenceGoals: ['bruke Cramers regel til å løse $A\\mathbf{x}=\\mathbf{b}$', 'analysere produksjonsnivå i en Leontief-modell'],
      coverImage: 'https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=800&h=400&fit=crop',
    },
    // Seksjon 10: Tallfølger og rekker
    {
      id: 'bi-okonomi-10-1',
      number: '10.1',
      title: 'Tallfølger',
      description: 'Eksplisitte og rekursive følger, konvergens og divergens, samt avgrensede og monotone følger.',
      estimatedMinutes: 40,
      exerciseCount: 14,
      ...
      coverImage: 'https://images.unsplash.com/photo-1635070041078-e363dbe005cb?w=800&h=400&fit=crop', linkedChapterId: 'bi-okonomi-10-1-narrativ' },
    {
      ...
      number: '10.2',
      title: 'Aritmetiske rekker',
      description: 'Aritmetisk følge aₙ = a₁ + (n-1)d og sumformelen Sₙ = (n(a₁+aₙ))/2 (Gauss\' bevis).',
      estimatedMinutes: 45,
      exerciseCount: 14,
      topics: ['Aritmetisk følge', 'Differans', 'Sumformel', 'Gauss\' bevis', 'Serielån'],
      prerequisites: ['bi-okonomi-10-1'],
      competenceGoals: ['gjenkjenne og bruke aritmetiske rekker', 'utlede og anvende sumformelen'],
      coverImage: 'https://images.unsplash.com/photo-1604357209793-fca5dca89f97?w=800&h=400&fit=crop',
    },
    {
      id: 'bi-okonomi-10-3',
      ...
      number: '10.3',
      title: 'Geometriske rekker',
      description: 'Geometrisk følge aₙ = a₁ kⁿ⁻¹ og sum Sₙ = a₁(kⁿ-1)/(k-1), med sluttverdi av annuitet som anvendelse.',
      estimatedMinutes: 50,
      exerciseCount: 16,
      topics: ['Geometrisk følge', 'Kvotient', 'Geometrisk rekke', 'Sluttverdi av annuitet', 'Eksponentiell vekst'],
      prerequisites: ['bi-okonomi-10-2'],
      competenceGoals: ['gjenkjenne og bruke geometriske rekker', 'utlede annuitetsformelen som geometrisk rekke'],
      coverImage: 'https://images.unsplash.com/photo-1504868584819-f8e8b4b6d7e3?w=800&h=400&fit=crop',
    },
    {
      id: 'bi-okonomi-10-4',
      ...
      description: 'Uendelig geometrisk rekke Σ a₁ kⁿ = a₁/(1-k), perpetuitet C/r, Gordons formel og multiplikatoreffekten.',
      estimatedMinutes: 55,
      exerciseCount: 16,
      topics: ['Uendelig rekke', 'Konvergens', 'Perpetuitet', 'Gordons formel', 'Multiplikatoreffekten', 'Aksjeprising'],
      prerequisites: ['bi-okonomi-10-3', 'bi-okonomi-4-3'],
      competenceGoals: ['avgjøre om en uendelig geometrisk rekke konvergerer', 'beregne nåverdi av perpetuiteter og bruke Gordons formel'],
      coverImage: 'https://images.unsplash.com/photo-1579621970563-ebec7560ff3e?w=800&h=400&fit=crop',
    },
  ],
};
