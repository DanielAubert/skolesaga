    ...
    // ========== QUIZ 1 ==========
    {
      ...
      exercise: {
        ...
        questions: [
          ...
          {
            id: 'norsk-vg2-3-1-n-quiz1-q1',
            task: 'Hvilken historisk hendelse var bade inspirasjon og advarsel for romantikerne?',
            options: [
              { id: 'a', text: 'Den amerikanske uavhengighetskrigen', isCorrect: false },
              { id: 'b', text: 'Den franske revolusjonen i 1789', isCorrect: true },
              { id: 'c', text: 'Napoleonskrigene', isCorrect: false },
              { id: 'd', text: 'Reformasjonen', isCorrect: false },
            ],
            solution: 'Den franske revolusjonen viste at forandring var mulig, men endte i blodige massakrer. Mange lurte pa om fornuftens prosjekt hadde gatt for langt.',
          },
        ],
      },
    },
    ...
    // ========== QUIZ 2 ==========
    {
      ...
      exercise: {
        ...
        questions: [
          ...
          {
            id: 'norsk-vg2-3-1-n-quiz2-q1',
            task: 'Hva lengtet romantikerne etter nar de brukte begrepet "Sehnsucht"?',
            options: [
              { id: 'a', text: 'Materielle goder og rikdom', isCorrect: false },
              { id: 'b', text: 'Noe som alltid er utenfor rekkevidde - en dypere mening', isCorrect: true },
              { id: 'c', text: 'A reise til eksotiske land', isCorrect: false },
              { id: 'd', text: 'A ga tilbake til opplysningstidens idealer', isCorrect: false },
            ],
            solution: 'Sehnsucht er en lengsel etter noe som alltid er utenfor rekkevidde. Det uttrykker romantikerens folelse av at det finnes noe storre og dypere enn det fornuften kan begripe.',
          },
        ],
      },
    },
    ...
    // ========== QUIZ 3 ==========
    {
      ...
      exercise: {
        ...
        questions: [
          ...
          {
            id: 'norsk-vg2-3-1-n-quiz3-q1',
            task: 'Hva menes med "det sublime" i romantikken?',
            options: [
              { id: 'a', text: 'Noe vakkert og harmonisk', isCorrect: false },
              { id: 'b', text: 'Noe sa overveldende at det fremkaller bade frykt og fascinasjon', isCorrect: true },
              { id: 'c', text: 'Noe enkelt og hverdagslig', isCorrect: false },
              { id: 'd', text: 'Noe religiost og hellig', isCorrect: false },
            ],
            solution: 'Det sublime er en opplevelse av noe sa stort og overveldende at det fremkaller bade frykt og fascinasjon - som et voldsomt fossfall eller et tordenvar i fjellet.',
          },
        ],
      },
    },
    ...
    // ========== QUIZ 4 ==========
    {
      ...
      exercise: {
        ...
        questions: [
          ...
          {
            id: 'norsk-vg2-3-1-n-quiz4-q1',
            task: 'Hva representerte middelalderen for romantikerne?',
            options: [
              { id: 'a', text: 'En morke tid med uvitenhet', isCorrect: false },
              { id: 'b', text: 'En gylden tid da mennesker levde i harmoni med natur og tradisjon', isCorrect: true },
              { id: 'c', text: 'En periode med store vitenskapelige fremskritt', isCorrect: false },
              { id: 'd', text: 'En kjedelig periode uten kunst', isCorrect: false },
            ],
            solution: 'Romantikerne idealiserte middelalderen som en tid med dypere mening og harmoni, i motsetning til det de opplevde som opplysningstidens tomme rasjonalisme.',
          },
        ],
      },
    },
    ...
    // ========== QUIZ 5 ==========
    {
      ...
      exercise: {
        ...
        questions: [
          ...
          {
            id: 'norsk-vg2-3-1-n-quiz5-q1',
            task: 'Hva skjedde i Norge i 1814 som gjorde romantikken sarlig relevant?',
            options: [
              { id: 'a', text: 'Norge ble en del av Sverige', isCorrect: false },
              { id: 'b', text: 'Norge fikk sin egen grunnlov og delvis selvstendighet', isCorrect: true },
              { id: 'c', text: 'Norge ble kolonisert av England', isCorrect: false },
              { id: 'd', text: 'Norge mistet sin flate', isCorrect: false },
            ],
            solution: 'I 1814 fikk Norge sin grunnlov. Romantikkens ideer om nasjonalidentitet og kulturarv passet perfekt til et nytt, lite land som trengte a definere hvem det var.',
          },
        ],
      },
    },
    ...
    // ========== QUIZ 1 ==========
    {
      ...
      exercise: {
        ...
        questions: [
          ...
          {
            id: 'norsk-vg2-3-2-n-quiz1-q1',
            task: 'Hva var Nicolai Wergelands rolle i norsk historie?',
            options: [
              { id: 'a', text: 'Han var Norges forste statsminister', isCorrect: false },
              { id: 'b', text: 'Han var med pa a skrive Grunnloven pa Eidsvoll i 1814', isCorrect: true },
              { id: 'c', text: 'Han var biskop i Bergen', isCorrect: false },
              { id: 'd', text: 'Han var berømt maler', isCorrect: false },
            ],
            solution: 'Nicolai Wergeland var med pa Eidsvoll i 1814 og bidro til Grunnloven. Henrik vokste opp med frihet og demokrati som familieverdier.',
          },
        ],
      },
    },
    ...
    // ========== QUIZ 2 ==========
    {
      ...
      exercise: {
        ...
        questions: [
          ...
          {
            id: 'norsk-vg2-3-2-n-quiz2-q1',
            task: 'Hvem var Wergelands rival i kulturstriden?',
            options: [
              { id: 'a', text: 'Ivar Aasen', isCorrect: false },
              { id: 'b', text: 'Johan Sebastian Welhaven', isCorrect: true },
              { id: 'c', text: 'Bjornstjerne Bjornson', isCorrect: false },
              { id: 'd', text: 'Ludvig Holberg', isCorrect: false },
            ],
            solution: 'Welhaven var Wergelands rival. Kulturstriden handlet om hva norsk kultur skulle vaere: Wergeland ville bygge noe helt nytt basert pa folket, Welhaven ville beholde tilknytningen til dansk-europeisk tradisjon.',
          },
        ],
      },
    },
    ...
    // ========== QUIZ 3 ==========
    {
      ...
      exercise: {
        ...
        questions: [
          ...
          {
            id: 'norsk-vg2-3-2-n-quiz3-q1',
            task: 'Hvorfor er besjeling et effektivt virkemiddel i romantisk diktning?',
            options: [
              { id: 'a', text: 'Fordi det gjor diktet lengre', isCorrect: false },
              { id: 'b', text: 'Fordi det gjor naturen levende og viser samhørighet mellom menneske og natur', isCorrect: true },
              { id: 'c', text: 'Fordi det er lettere a rime da', isCorrect: false },
              { id: 'd', text: 'Fordi vitenskapen krever det', isCorrect: false },
            ],
            solution: 'Besjeling gjor naturen levende ved a gi den menneskelige egenskaper. Det uttrykker romantikernes tro pa at mennesket og naturen henger sammen pa et dypt plan.',
          },
        ],
      },
    },
    ...
    // ========== QUIZ 4 ==========
    {
      ...
      exercise: {
        ...
        questions: [
          ...
          {
            id: 'norsk-vg2-3-2-n-quiz4-q1',
            task: 'Hva kjempet Wergeland for nar det gjaldt jødeparagrafen?',
            options: [
              { id: 'a', text: 'A beholde forbudet mot joder i Norge', isCorrect: false },
              { id: 'b', text: 'A oppheve forbudet slik at joder kunne komme til Norge', isCorrect: true },
              { id: 'c', text: 'A innfore et lignende forbud i Danmark', isCorrect: false },
              { id: 'd', text: 'A la bare rike joder inn i landet', isCorrect: false },
            ],
            solution: 'Wergeland kjempet for a oppheve jodeparagrafen i Grunnloven som forbod joder tilgang til Norge. Paragrafen ble opphevet i 1851, tre ar etter hans dod.',
          },
        ],
      },
    },
    ...
    // ========== QUIZ 5 ==========
    {
      ...
      exercise: {
        ...
        questions: [
          ...
          {
            id: 'norsk-vg2-3-2-n-quiz5-q1',
            task: 'Hva gjor Wergelands siste dikt "Til min Gyldenlak" sa gripende?',
            options: [
              { id: 'a', text: 'Det er veldig langt og komplisert', isCorrect: false },
              { id: 'b', text: 'En dodende mann ser skjonnhet og mening i en liten blomst', isCorrect: true },
              { id: 'c', text: 'Det er skrevet pa norrønt', isCorrect: false },
              { id: 'd', text: 'Det handler om politikk', isCorrect: false },
            ],
            solution: 'Diktet er gripende fordi Wergeland ligger pa dodsleiet og finner skjonnhet og trost i en enkel blomst. Det er en poetisk avskjed med livet skrevet av en mann som visste at doden var naer.',
          },
        ],
      },
    },
    ...
    // ========== QUIZ 1 ==========
    {
      ...
      exercise: {
        ...
        questions: [
          ...
          {
            id: 'norsk-vg2-3-3-n-quiz1-q1',
            task: 'Hva var Welhavens syn pa Bergen sammenlignet med Kristiania?',
            options: [
              { id: 'a', text: 'Han mente Bergen var kulturelt overlegent', isCorrect: false },
              { id: 'b', text: 'Bergen var kosmopolitisk med tilknytning til Europa, noe som preget hans smak', isCorrect: true },
              { id: 'c', text: 'Han hadde ingen tilknytning til Bergen', isCorrect: false },
              { id: 'd', text: 'Han mente Bergen burde vaere hovedstad', isCorrect: false },
            ],
            solution: 'Bergen var en kosmopolitisk handelsby med sterke forbindelser til Europa. Denne bakgrunnen preget Welhavens smak og hans vektlegging av europeisk dannelse.',
          },
        ],
      },
    },
    ...
    // ========== QUIZ 2 ==========
    {
      ...
      exercise: {
        ...
        questions: [
          ...
          {
            id: 'norsk-vg2-3-3-n-quiz2-q1',
            task: 'Hvordan ble "Norges Damring" mottatt da den ble publisert?',
            options: [
              { id: 'a', text: 'Den ble ignorert av alle', isCorrect: false },
              { id: 'b', text: 'Den provoserte voldsomt og utloste en bitter kulturdebatt', isCorrect: true },
              { id: 'c', text: 'Den ble hyllet av alle', isCorrect: false },
              { id: 'd', text: 'Den ble forbudt av kongen', isCorrect: false },
            ],
            solution: '"Norges Damring" provoserte voldsomt fordi Welhaven kritiserte norsk selvtilfredshet og argumenterte for at Norge trengte dansk-europeisk kulturimpuls. Wergeland og hans tilhengere reagerte kraftig.',
          },
        ],
      },
    },
    ...
    // ========== QUIZ 3 ==========
    {
      ...
      exercise: {
        ...
        questions: [
          ...
          {
            id: 'norsk-vg2-3-3-n-quiz3-q1',
            task: 'Hva foretrakk Welhaven i sin diktning sammenlignet med Wergeland?',
            options: [
              { id: 'a', text: 'Lange, kaotiske vers fulle av energi', isCorrect: false },
              { id: 'b', text: 'Stramhet, klarhet og klassisk harmoni', isCorrect: true },
              { id: 'c', text: 'Dialektord og folkelig sprak', isCorrect: false },
              { id: 'd', text: 'Religiose temaer fra barokken', isCorrect: false },
            ],
            solution: 'Welhavens stil er preget av stramhet, klarhet og klassisk harmoni - i motsetning til Wergelands eksplosive, uregjerlige energi. Begge stiler har sin verdi.',
          },
        ],
      },
    },
    ...
    // ========== QUIZ 4 ==========
    {
      ...
      exercise: {
        ...
        questions: [
          ...
          {
            id: 'norsk-vg2-3-3-n-quiz4-q1',
            task: 'Hva er stemningslyrikk slik Welhaven praktiserte det?',
            options: [
              { id: 'a', text: 'Dikt som beskriver naturen med vitenskapelig noyaktighet', isCorrect: false },
              { id: 'b', text: 'Dikt der naturen speiler dikterens indre folelser', isCorrect: true },
              { id: 'c', text: 'Dikt som kritiserer samfunnet', isCorrect: false },
              { id: 'd', text: 'Dikt skrevet i dialog-form', isCorrect: false },
            ],
            solution: 'I stemningslyrikk speiler naturen dikterens indre folelser. Landskapet blir et bilde pa sinnsstemningen. Welhaven var en mester i denne formen.',
          },
        ],
      },
    },
    ...
    // ========== QUIZ 5 ==========
    {
      ...
      exercise: {
        ...
        questions: [
          ...
          {
            id: 'norsk-vg2-3-3-n-quiz5-q1',
            task: 'Hva var Welhavens varige bidrag til norsk litteratur?',
            options: [
              { id: 'a', text: 'Han oppfant nynorsk', isCorrect: false },
              { id: 'b', text: 'Han viste at kvalitet, form og europeisk tilknytning ogsa er verdifullt', isCorrect: true },
              { id: 'c', text: 'Han avskaffet all romantikk', isCorrect: false },
              { id: 'd', text: 'Han grunnla det forste universitetet', isCorrect: false },
            ],
            solution: 'Welhavens arv er a ha holdt fast pa at kvalitet, form og tilknytning til europeisk tradisjon ogsa er verdifullt. Uten kritisk selvrefleksjon kan nasjonalbegeistringen bli hul.',
          },
        ],
      },
    },
    ...
    // ========== QUIZ 1 ==========
    {
      ...
      exercise: {
        ...
        questions: [
          ...
          {
            id: 'norsk-vg2-3-4-n-quiz1-q1',
            task: 'Hva mente romantikerne med at naturen var "besjelet"?',
            options: [
              { id: 'a', text: 'At naturen var styrt av fysiske lover', isCorrect: false },
              { id: 'b', text: 'At naturen hadde en levende and eller kraft som mennesket kunne kommunisere med', isCorrect: true },
              { id: 'c', text: 'At dyr kunne snakke', isCorrect: false },
              { id: 'd', text: 'At naturen var farlig', isCorrect: false },
            ],
            solution: 'Romantikerne sa naturen som gjennomstrømmet av en levende kraft. Mennesket var ikke adskilt fra naturen, men en del av den. Naturen kunne kommunisere med oss gjennom folelser og opplevelser.',
          },
        ],
      },
    },
    ...
    // ========== QUIZ 2 ==========
    {
      ...
      exercise: {
        ...
        questions: [
          ...
          {
            id: 'norsk-vg2-3-4-n-quiz2-q1',
            task: 'Hvorfor var fjellet sa viktig i norsk romantisk diktning?',
            options: [
              { id: 'a', text: 'Fordi det var lett a bestige', isCorrect: false },
              { id: 'b', text: 'Fordi det symboliserte storhet, frihet og nærhet til det guddommelige', isCorrect: true },
              { id: 'c', text: 'Fordi alle nordmenn bodde i fjellet', isCorrect: false },
              { id: 'd', text: 'Fordi det var det eneste naturfenomenet i Norge', isCorrect: false },
            ],
            solution: 'Fjellet symboliserte storhet, frihet og naerhet til det guddommelige. For det nye Norge ble fjellandskapet ogsa et nasjonalt symbol som skilte Norge fra andre land.',
          },
        ],
      },
    },
    ...
    // ========== QUIZ 3 ==========
    {
      ...
      exercise: {
        ...
        questions: [
          ...
          {
            id: 'norsk-vg2-3-4-n-quiz3-q1',
            task: 'Hva betyr det at et dikt bruker synestesi?',
            options: [
              { id: 'a', text: 'At diktet handler om sykdom', isCorrect: false },
              { id: 'b', text: 'At sanseinntrykk blandes - man "horer" farger eller "ser" lyder', isCorrect: true },
              { id: 'c', text: 'At diktet er skrevet pa to sprak', isCorrect: false },
              { id: 'd', text: 'At diktet har mange rim', isCorrect: false },
            ],
            solution: 'Synestesi er en sammenblanding av sanser i spraklig uttrykk. Nar en dikter skriver om "varme farger" eller "mørke toner", blander han syns- og folelsesinntrykk for a skape rikere bilder.',
          },
        ],
      },
    },
    ...
    // ========== QUIZ 4 ==========
    {
      ...
      exercise: {
        ...
        questions: [
          ...
          {
            id: 'norsk-vg2-3-4-n-quiz4-q1',
            task: 'Hva kjennetegner Wergelands naturlyrikk sammenlignet med Welhavens?',
            options: [
              { id: 'a', text: 'Wergeland er eksplosiv og kosmisk, Welhaven er stille og stemningsfull', isCorrect: true },
              { id: 'b', text: 'De skriver pa noyaktig samme mate', isCorrect: false },
              { id: 'c', text: 'Wergeland skriver bare om dyr, Welhaven bare om fjell', isCorrect: false },
              { id: 'd', text: 'Welhaven er mer kaotisk enn Wergeland', isCorrect: false },
            ],
            solution: 'Wergeland er eksplosiv, energisk og kosmisk - naturen er en kraft a hengi seg til. Welhaven er stille, stemningsfull og reflekterende - naturen speiler indre folelser.',
          },
        ],
      },
    },
    ...
    // ========== QUIZ 5 ==========
    {
      ...
      exercise: {
        ...
        questions: [
          ...
          {
            id: 'norsk-vg2-3-4-n-quiz5-q1',
            task: 'Hvorfor trenger vi romantisk naturdiktning i var tid?',
            options: [
              { id: 'a', text: 'Fordi vi har glemt at naturen finnes', isCorrect: false },
              { id: 'b', text: 'Fordi den kan gjenopprette var folelsesmessige forbindelse med naturen i klimakrisens tid', isCorrect: true },
              { id: 'c', text: 'Fordi det er pensum pa skolen', isCorrect: false },
              { id: 'd', text: 'Fordi all annen litteratur er dårlig', isCorrect: false },
            ],
            solution: 'I klimakrisens tid kan romantikernes natursyn minne oss om at naturen ikke bare er en ressurs, men noe vi er dypt forbundet med. Folelsesmessig tilknytning kan motivere handling.',
          },
        ],
      },
    },
    ...
    },
    {
      ...
      exercise: {
        ...
        questions: [
          ...
          {
            id: 'norsk-vg2-3-5-n-quiz1-q1',
            task: 'Hva lette nasjonalromantikerne etter pa bygdene?',
            options: [
              { id: 'a', text: 'Gull og naturressurser', isCorrect: false },
              { id: 'b', text: 'Den ekte norske folkesjelen i eventyr, melodier og dialekter', isCorrect: true },
              { id: 'c', text: 'Nye steder a bygge fabrikker', isCorrect: false },
              { id: 'd', text: 'Ruiner fra vikingtiden', isCorrect: false },
            ],
            solution: 'Nasjonalromantikerne reiste til bygdene for a samle inn det de mente var den ekte norske folkesjelen: eventyr, folkeviser, melodier, dialekter og skikker.',
          },
        ],
      },
    },
    ...
    },
    {
      ...
      exercise: {
        ...
        questions: [
          ...
          {
            id: 'norsk-vg2-3-5-n-quiz2-q1',
            task: 'Hva var idealisert ved bondens liv?',
            options: [
              { id: 'a', text: 'Rikdommen og luksusen', isCorrect: false },
              { id: 'b', text: 'Narheten til naturen og de gamle tradisjonene', isCorrect: true },
              { id: 'c', text: 'Den moderne teknologien de brukte', isCorrect: false },
              { id: 'd', text: 'At de reiste mye utenlands', isCorrect: false },
            ],
            solution: 'Nasjonalromantikerne idealiserte bonden som baerer av de ekte norske tradisjonene, i motsetning til bybefolkningen som var preget av dansk kultur. Men virkeligheten var hardere enn idealbildet.',
          },
        ],
      },
    },
    ...
    },
    {
      ...
      exercise: {
        ...
        questions: [
          ...
          {
            id: 'norsk-vg2-3-5-n-quiz3-q1',
            task: 'Hvem malte "Brudeferden i Hardanger"?',
            options: [
              { id: 'a', text: 'Edvard Munch', isCorrect: false },
              { id: 'b', text: 'Adolph Tidemand og Hans Gude', isCorrect: true },
              { id: 'c', text: 'J.C. Dahl', isCorrect: false },
              { id: 'd', text: 'Christian Krogh', isCorrect: false },
            ],
            solution: 'Adolph Tidemand og Hans Gude malte "Brudeferden i Hardanger" i 1848. Maleriet kombinerer Tidemands folkelivskildring med Gudes naturmaleri og er et ikon for norsk nasjonalromantikk.',
          },
        ],
      },
    },
    ...
    },
    {
      ...
      exercise: {
        ...
        questions: [
          ...
          {
            id: 'norsk-vg2-3-5-n-quiz4-q1',
            task: 'Hva betyr det at bunaden er en konstruksjon?',
            options: [
              { id: 'a', text: 'At den er laget av plast', isCorrect: false },
              { id: 'b', text: 'At den ble designet pa 1800-tallet basert pa eldre tradisjoner, ikke bare kopiert fra fortiden', isCorrect: true },
              { id: 'c', text: 'At den ikke eksisterer', isCorrect: false },
              { id: 'd', text: 'At den er ukomfortabel', isCorrect: false },
            ],
            solution: 'Bunadene vi bruker i dag ble designet pa 1800-1900-tallet, inspirert av eldre folkedrakter men tilpasset og standardisert. Det gjor dem ikke mindre verdifulle, men det er viktig a vite.',
          },
        ],
      },
    },
    ...
    },
    {
      ...
      exercise: {
        ...
        questions: [
          ...
          {
            id: 'norsk-vg2-3-5-n-quiz5-q1',
            task: 'Hva er faren ved a bruke nasjonalromantisk tankegods ukritisk?',
            options: [
              { id: 'a', text: 'At vi fa for mange turister', isCorrect: false },
              { id: 'b', text: 'At det kan brukes til a ekskludere "de andre" og skape et snevert nasjonsbegrep', isCorrect: true },
              { id: 'c', text: 'At vi bruker for mye penger pa kultur', isCorrect: false },
              { id: 'd', text: 'At vi mister kontakten med teknologi', isCorrect: false },
            ],
            solution: 'Nasjonalromantisk tankegods kan brukes til a definere hvem som er "ekte norsk" og ekskludere andre. Et mangfoldig samfunn trenger et rommeligere nasjonsbegrep.',
          },
        ],
      },
    },
    ...
    },
    {
      ...
      exercise: {
        ...
        questions: [
          ...
          {
            id: 'norsk-vg2-3-6-n-quiz1-q1',
            task: 'Hvorfor var det viktig a samle eventyrene pa 1800-tallet?',
            options: [
              { id: 'a', text: 'For a tjene penger', isCorrect: false },
              { id: 'b', text: 'For a dokumentere den muntlige kulturen for den gikk tapt', isCorrect: true },
              { id: 'c', text: 'For a konkurrere med svenske eventyr', isCorrect: false },
              { id: 'd', text: 'Fordi kongen befalte det', isCorrect: false },
            ],
            solution: 'Eventyrene levde i muntlig tradisjon og risikerte a ga tapt med moderniseringen. A samle dem var bade kulturvern og nasjonsbygging - de viste at Norge hadde en rik folkekultur.',
          },
        ],
      },
    },
    ...
    },
    {
      ...
      exercise: {
        ...
        questions: [
          ...
          {
            id: 'norsk-vg2-3-6-n-quiz2-q1',
            task: 'Gi et eksempel pa tretallets lov i et kjent norsk eventyr.',
            options: [
              { id: 'a', text: 'Sju smal bak sju hav', isCorrect: false },
              { id: 'b', text: 'Tre bukker Bruse som krysser broen', isCorrect: true },
              { id: 'c', text: 'Hundre dverger i fjellet', isCorrect: false },
              { id: 'd', text: 'Ti katter i skogen', isCorrect: false },
            ],
            solution: 'Tre bukker Bruse er et kjent eksempel pa tretallets lov: tre bukker, tre forsøk pa a krysse broen. Tretallets lov skaper spenning gjennom gjentakelse og klimaks.',
          },
        ],
      },
    },
    ...
    },
    {
      ...
      exercise: {
        ...
        questions: [
          ...
          {
            id: 'norsk-vg2-3-6-n-quiz3-q1',
            task: 'Hva laerer eventyrene oss om verdier?',
            options: [
              { id: 'a', text: 'At bare de sterkeste overlever', isCorrect: false },
              { id: 'b', text: 'At klokskap, vennlighet og mot er viktigere enn styrke', isCorrect: true },
              { id: 'c', text: 'At rikdom er det viktigste', isCorrect: false },
              { id: 'd', text: 'At man aldri bor stole pa noen', isCorrect: false },
            ],
            solution: 'Askeladden vinner ikke med styrke, men med klokskap, vennlighet og nysgjerrighet. Eventyrene larer at de som stopper opp, lytter og hjelper andre, far belønning.',
          },
        ],
      },
    },
    ...
    },
    {
      ...
      exercise: {
        ...
        questions: [
          ...
          {
            id: 'norsk-vg2-3-6-n-quiz4-q1',
            task: 'Hva er forskjellen mellom et folkeeventyr og et kunsteventyr?',
            options: [
              { id: 'a', text: 'Folkeeventyr er skrevet av en kjent forfatter', isCorrect: false },
              { id: 'b', text: 'Folkeeventyr har vokst frem i muntlig tradisjon, kunsteventyr er skrevet av en bestemt forfatter', isCorrect: true },
              { id: 'c', text: 'Kunsteventyr er for barn, folkeeventyr for voksne', isCorrect: false },
              { id: 'd', text: 'Det er ingen forskjell', isCorrect: false },
            ],
            solution: 'Folkeeventyr har vokst frem i muntlig tradisjon over generasjoner uten kjent forfatter. Kunsteventyr er skrevet av en bestemt forfatter, som H.C. Andersens eventyr.',
          },
        ],
      },
    },
    ...
    },
    {
      ...
      exercise: {
        ...
        questions: [
          ...
          {
            id: 'norsk-vg2-3-6-n-quiz5-q1',
            task: 'Hvorfor leses eventyrene fortsatt av barn i dag?',
            options: [
              { id: 'a', text: 'Bare fordi det er pensum', isCorrect: false },
              { id: 'b', text: 'Fordi de handler om tidlose temaer: mot, rettferdighet og kjærlighet', isCorrect: true },
              { id: 'c', text: 'Fordi det ikke finnes nyere boker for barn', isCorrect: false },
              { id: 'd', text: 'Fordi de er korte og lette a lese', isCorrect: false },
            ],
            solution: 'Eventyrene overlever fordi de tar opp tidlose temaer. Kampen mellom godt og ondt, den lille som besejrer den store, mot og kjaerlighet - dette appellerer til barn i alle tider.',
          },
        ],
      },
    },
    ...
    },
    {
      ...
      exercise: {
        ...
        questions: [
          ...
          {
            id: 'norsk-vg2-3-7-n-quiz1-q1',
            task: 'Hva var det konkrete problemet for norske bonder nar det gjaldt sprak?',
            options: [
              { id: 'a', text: 'De kunne ikke snakke i det hele tatt', isCorrect: false },
              { id: 'b', text: 'De matte skrive pa et sprak (dansk) som var fremmed for talemalet deres', isCorrect: true },
              { id: 'c', text: 'De snakket for mange sprak', isCorrect: false },
              { id: 'd', text: 'De hadde glemt dialekten sin', isCorrect: false },
            ],
            solution: 'Norske bonder snakket sine dialekter, men matte lese og skrive pa dansk. Dette skapte en kløft mellom talesprak og skriftsprak som var vanskelig for vanlige folk.',
          },
        ],
      },
    },
    ...
    },
    {
      ...
      exercise: {
        ...
        questions: [
          ...
          {
            id: 'norsk-vg2-3-7-n-quiz2-q1',
            task: 'Hva var spesielt med Aasens metode for a lage landsmal?',
            options: [
              { id: 'a', text: 'Han kopierte islandsk', isCorrect: false },
              { id: 'b', text: 'Han reiste rundt og samlet dialekter systematisk, som en vitenskapsmann', isCorrect: true },
              { id: 'c', text: 'Han fant pa ordene selv', isCorrect: false },
              { id: 'd', text: 'Han oversatte fra engelsk', isCorrect: false },
            ],
            solution: 'Aasen brukte vitenskapelige metoder: Han reiste gjennom hele Norge, samlet dialekter systematisk og fant de fellestrekkene som dannet grunnlaget for landsmalet.',
          },
        ],
      },
    },
    ...
    },
    {
      ...
      exercise: {
        ...
        questions: [
          ...
          {
            id: 'norsk-vg2-3-7-n-quiz3-q1',
            task: 'Hva beviste Aasen med diktet "Nordmannen"?',
            options: [
              { id: 'a', text: 'At landsmal var for vanskelig a bruke', isCorrect: false },
              { id: 'b', text: 'At landsmal kunne brukes til skjonnlitteratur av hoy kvalitet', isCorrect: true },
              { id: 'c', text: 'At alle nordmenn snakket likt', isCorrect: false },
              { id: 'd', text: 'At norsk var identisk med dansk', isCorrect: false },
            ],
            solution: 'Ved a skrive dikt pa landsmal viste Aasen at det nye spraket ikke bare var et vitenskapelig prosjekt, men et levende sprak som kunne baere kunst og skjonnhet.',
          },
        ],
      },
    },
    ...
    },
    {
      ...
      exercise: {
        ...
        questions: [
          ...
          {
            id: 'norsk-vg2-3-7-n-quiz4-q1',
            task: 'Hva var forskjellen mellom Aasens og Knudsens sprakstrategi?',
            options: [
              { id: 'a', text: 'Aasen ville bygge nytt sprak fra dialektene, Knudsen ville fornorske dansken', isCorrect: true },
              { id: 'b', text: 'De hadde noyaktig samme strategi', isCorrect: false },
              { id: 'c', text: 'Knudsen ville beholde dansk uendret', isCorrect: false },
              { id: 'd', text: 'Aasen ville innfore engelsk som skriftsprak', isCorrect: false },
            ],
            solution: 'Aasen ville skape et helt nytt skriftsprak basert pa norske dialekter (landsmal/nynorsk). Knudsen ville gradvis fornorske det danske skriftspraket (riksmal/bokmal). Begge veier har formet norsk.',
          },
        ],
      },
    },
    ...
    },
    {
      ...
      exercise: {
        ...
        questions: [
          ...
          {
            id: 'norsk-vg2-3-7-n-quiz5-q1',
            task: 'Hva er Aasens viktigste arv utover selve spraket?',
            options: [
              { id: 'a', text: 'Hans reiseberetninger', isCorrect: false },
              { id: 'b', text: 'Ideen om at vanlige folks sprak har verdi og verdighet', isCorrect: true },
              { id: 'c', text: 'Hans politiske karriere', isCorrect: false },
              { id: 'd', text: 'Hans musikalske komposisjoner', isCorrect: false },
            ],
            solution: 'Aasens storste arv er ideen om at vanlige folks sprak har verdi og verdighet. At dialekter og folkesprak fortjener respekt og kan danne grunnlag for et offisielt skriftsprak.',
          },
        ],
      },
    },
    ...
    },
    {
      ...
      exercise: {
        ...
        questions: [
          ...
          {
            id: 'norsk-vg2-3-8-n-quiz1-q1',
            task: 'Hva er funksjonen til et omkved i en folkevise?',
            options: [
              { id: 'a', text: 'A gjore visa lengre', isCorrect: false },
              { id: 'b', text: 'A skape rytme, stemning og gjore visa lettere a huske', isCorrect: true },
              { id: 'c', text: 'A fortelle slutten pa historien', isCorrect: false },
              { id: 'd', text: 'A presentere dikteren', isCorrect: false },
            ],
            solution: 'Omkvædet (refrenget) skaper rytme og stemning, og gjor visa lettere a huske. Det binder strofene sammen og gir tilhorerne noe a synge med pa.',
          },
        ],
      },
    },
    ...
    },
    {
      ...
      exercise: {
        ...
        questions: [
          ...
          {
            id: 'norsk-vg2-3-8-n-quiz2-q1',
            task: 'Hva blander Draumkvedet?',
            options: [
              { id: 'a', text: 'Greske myter og vikingesagaer', isCorrect: false },
              { id: 'b', text: 'Kristen visjon om etterlivet med norrøne forestillinger', isCorrect: true },
              { id: 'c', text: 'Politiske taler og kjærlighetsdikt', isCorrect: false },
              { id: 'd', text: 'Musikk fra ost og vest', isCorrect: false },
            ],
            solution: 'Draumkvedet blander kristent stoff (dommedag, himmel og helvete) med eldre norrøne forestillinger. Det gjenspeiler overgangen mellom to religioner i nordisk kultur.',
          },
        ],
      },
    },
    ...
    },
    {
      ...
      exercise: {
        ...
        questions: [
          ...
          {
            id: 'norsk-vg2-3-8-n-quiz3-q1',
            task: 'Hva handler trollvisene om pa et dypere plan?',
            options: [
              { id: 'a', text: 'Bare underholdende historier om fantasy-vesener', isCorrect: false },
              { id: 'b', text: 'Frykten for det ukjente og grensen mellom trygghet og fare', isCorrect: true },
              { id: 'c', text: 'Historiske hendelser fra vikingtiden', isCorrect: false },
              { id: 'd', text: 'Oppskrifter pa trolldomsdrikker', isCorrect: false },
            ],
            solution: 'Trollvisene handler pa et dypere plan om frykten for det ukjente og grensen mellom det trygge hjemmet og den farlige villmarken. Trollene symboliserer farer som truer samfunnsordenen.',
          },
        ],
      },
    },
    ...
    },
    {
      ...
      exercise: {
        ...
        questions: [
          ...
          {
            id: 'norsk-vg2-3-8-n-quiz4-q1',
            task: 'Hvem var Magnus Brostrup Landstad?',
            options: [
              { id: 'a', text: 'En berømt folkevisesanger fra middelalderen', isCorrect: false },
              { id: 'b', text: 'Den viktigste samleren av norske folkeviser pa 1800-tallet', isCorrect: true },
              { id: 'c', text: 'En dansk professor som studerte norsk musikk', isCorrect: false },
              { id: 'd', text: 'Grunnleggeren av Norges musikkhøyskole', isCorrect: false },
            ],
            solution: 'Magnus Brostrup Landstad ga ut "Norske Folkeviser" i 1853, den viktigste samlingen av norske folkeviser. Han reddet mange viser fra a ga tapt.',
          },
        ],
      },
    },
    ...
    },
    {
      ...
      exercise: {
        ...
        questions: [
          ...
          {
            id: 'norsk-vg2-3-8-n-quiz5-q1',
            task: 'Hvordan lever folkevisene videre i norsk kultur i dag?',
            options: [
              { id: 'a', text: 'De gjor det ikke - de er helt glemt', isCorrect: false },
              { id: 'b', text: 'Gjennom folkemusikkmiljoer, festivaler og moderne tolkninger', isCorrect: true },
              { id: 'c', text: 'Bare som pensum pa skolen', isCorrect: false },
              { id: 'd', text: 'Bare i museer', isCorrect: false },
            ],
            solution: 'Folkevisene lever videre gjennom folkemusikkmiljoer, festivaler og moderne artister som tolker dem pa nye mater. Kappleiker holder tradisjonen levende.',
          },
        ],
      },
    },
    ...
    },
    {
      ...
      exercise: {
        ...
        questions: [
          ...
          {
            id: 'norsk-vg2-3-9-n-quiz1-q1',
            task: 'Hva skapte det danske skriftspraket av problemer for norske bonder?',
            options: [
              { id: 'a', text: 'De foretrakk a snakke svensk', isCorrect: false },
              { id: 'b', text: 'De matte uttrykke seg pa et sprak som var fjernt fra deres eget talesprak', isCorrect: true },
              { id: 'c', text: 'De kunne ikke lese i det hele tatt', isCorrect: false },
              { id: 'd', text: 'Dansk var lettere enn norsk', isCorrect: false },
            ],
            solution: 'Bondene matte skrive pa dansk som var fjernt fra deres talesprak. Det skapte en urettferdig situasjon der byfolkene, som snakket naermere dansk, hadde en fordel.',
          },
        ],
      },
    },
    ...
    },
    {
      ...
      exercise: {
        ...
        questions: [
          ...
          {
            id: 'norsk-vg2-3-9-n-quiz2-q1',
            task: 'Hvorfor handlet sprakstriden ogsa om klasse?',
            options: [
              { id: 'a', text: 'Fordi rike folk snakket engelsk', isCorrect: false },
              { id: 'b', text: 'Fordi dansk var overklassens sprak, mens dialektene tilhorte bondebefolkningen', isCorrect: true },
              { id: 'c', text: 'Fordi arbeiderklassen ikke brydde seg om sprak', isCorrect: false },
              { id: 'd', text: 'Fordi alle snakket likt uansett klasse', isCorrect: false },
            ],
            solution: 'Dansk var overklassens og bybefolkningens sprak. A kjempe for norsk var ogsa a kjempe for bondestandens verdighet og likeverd. Sprakstriden var en demokratisk kamp.',
          },
        ],
      },
    },
    ...
    },
    {
      ...
      exercise: {
        ...
        questions: [
          ...
          {
            id: 'norsk-vg2-3-9-n-quiz3-q1',
            task: 'Hva var ideen bak samnorsk-prosjektet?',
            options: [
              { id: 'a', text: 'A erstatte bade bokmal og nynorsk med engelsk', isCorrect: false },
              { id: 'b', text: 'A smelte bokmal og nynorsk sammen til ett felles norsk skriftsprak', isCorrect: true },
              { id: 'c', text: 'A ga tilbake til dansk', isCorrect: false },
              { id: 'd', text: 'A innfore tre skriftsprak', isCorrect: false },
            ],
            solution: 'Samnorsk var et forsøk pa a smelte bokmal og nynorsk sammen til ett felles skriftsprak. Prosjektet ble aldri gjennomfort - motstanden var for stor fra begge sider.',
          },
        ],
      },
    },
    ...
    },
    {
      ...
      exercise: {
        ...
        questions: [
          ...
          {
            id: 'norsk-vg2-3-9-n-quiz4-q1',
            task: 'Hvorfor vekker sprak sterke folelser hos folk?',
            options: [
              { id: 'a', text: 'Fordi grammatikk er vanskelig', isCorrect: false },
              { id: 'b', text: 'Fordi sprak er knyttet til identitet, tilhørighet og hvem vi er', isCorrect: true },
              { id: 'c', text: 'Fordi folk er uvitende om sprak', isCorrect: false },
              { id: 'd', text: 'Fordi politikerne tvinger folk til a bry seg', isCorrect: false },
            ],
            solution: 'Sprak er dypt knyttet til identitet. Nar noen kritiserer spraket ditt, foler du at de kritiserer deg. Derfor blir sprakdebatter sa folelsesladede.',
          },
        ],
      },
    },
    ...
    },
    {
      ...
      exercise: {
        ...
        questions: [
          ...
          {
            id: 'norsk-vg2-3-9-n-quiz5-q1',
            task: 'Hva er sprakstridens viktigste arv for norsk demokrati?',
            options: [
              { id: 'a', text: 'At alle nordmenn snakker likt', isCorrect: false },
              { id: 'b', text: 'En unik toleranse for spraklig mangfold og dialektbruk', isCorrect: true },
              { id: 'c', text: 'At Norge har avskaffet all sprakpolitikk', isCorrect: false },
              { id: 'd', text: 'At bare ett sprak er tillatt i offentligheten', isCorrect: false },
            ],
            solution: 'Sprakstriden har gitt Norge en unik toleranse for spraklig mangfold. Vi aksepterer dialekter i alle sammenhenger og har to likestilte skriftsprak - noe som er unikt i verden.',
          },
        ],
      },
    },
    ...
    },
    {
      ...
      exercise: {
        ...
        questions: [
          ...
          {
            id: 'norsk-vg2-3-10-n-quiz1-q1',
            task: 'Hvilken annen dikter var ogsa sentral i a forme 17. mai-feiringen?',
            options: [
              { id: 'a', text: 'Henrik Ibsen', isCorrect: false },
              { id: 'b', text: 'Bjornstjerne Bjornson', isCorrect: true },
              { id: 'c', text: 'Knut Hamsun', isCorrect: false },
              { id: 'd', text: 'Alexander Kielland', isCorrect: false },
            ],
            solution: 'Bjornstjerne Bjornson var sentral i a forme 17. mai som barnas dag med tog og feiring. Nasjonalsangen "Ja, vi elsker" er skrevet av Bjornson og baerer sterke romantiske trekk.',
          },
        ],
      },
    },
    ...
    },
    {
      ...
      exercise: {
        ...
        questions: [
          ...
          {
            id: 'norsk-vg2-3-10-n-quiz2-q1',
            task: 'Hvilken romantisk ide ligger bak det norske friluftslivsidealet?',
            options: [
              { id: 'a', text: 'At naturen er farlig og ma temmes', isCorrect: false },
              { id: 'b', text: 'At naturen er en kilde til fornyelse, frihet og identitet', isCorrect: true },
              { id: 'c', text: 'At man bare bor vaere innendors', isCorrect: false },
              { id: 'd', text: 'At naturen har ingen verdi utover det okonomiske', isCorrect: false },
            ],
            solution: 'Det norske friluftslivsidealet bygger pa romantikkens syn pa naturen som en kilde til fornyelse, frihet og identitet. Nar vi gar pa tur i fjellet, er vi arvtakere av romantikerne.',
          },
        ],
      },
    },
    ...
    },
    {
      ...
      exercise: {
        ...
        questions: [
          ...
          {
            id: 'norsk-vg2-3-10-n-quiz3-q1',
            task: 'Hvordan lever romantikken videre i fantasy-litteraturen?',
            options: [
              { id: 'a', text: 'Fantasy har ingenting med romantikken a gjore', isCorrect: false },
              { id: 'b', text: 'Fantasy bygger pa romantikkens fascinasjon for middelalder, magi og det mystiske', isCorrect: true },
              { id: 'c', text: 'Fantasy er bare for barn', isCorrect: false },
              { id: 'd', text: 'Fantasy handler bare om vitenskap', isCorrect: false },
            ],
            solution: 'Fantasy-sjangeren bygger direkte pa romantikkens fascinasjon for middelalder, magi og det mystiske. Tolkiens verk, som er inspirert av norrøn litteratur, er et godt eksempel.',
          },
        ],
      },
    },
    ...
    },
    {
      ...
      exercise: {
        ...
        questions: [
          ...
          {
            id: 'norsk-vg2-3-10-n-quiz4-q1',
            task: 'Hvorfor er det problematisk a bare vise fjorder og fjell i markedsforing av Norge?',
            options: [
              { id: 'a', text: 'Fordi Norge ikke har fjorder', isCorrect: false },
              { id: 'b', text: 'Fordi det gir et ufullstendig bilde som utelater det moderne, mangfoldige Norge', isCorrect: true },
              { id: 'c', text: 'Fordi turistene liker byer bedre', isCorrect: false },
              { id: 'd', text: 'Fordi fjordene er forurensede', isCorrect: false },
            ],
            solution: 'A bare vise det nasjonalromantiske bildet av Norge utelater det moderne, urbane og mangfoldige. Det kan skape et snevert bilde som ikke representerer hele landet og alle dets innbyggere.',
          },
        ],
      },
    },
    ...
    },
    {
      ...
      exercise: {
        ...
        questions: [
          ...
          {
            id: 'norsk-vg2-3-10-n-quiz5-q1',
            task: 'Hva betyr det a vaere "bevisst" om romantikkens arv?',
            options: [
              { id: 'a', text: 'A avvise alt som kommer fra romantikken', isCorrect: false },
              { id: 'b', text: 'A forstå hvordan romantiske ideer pavirker oss og bruke dem reflektert', isCorrect: true },
              { id: 'c', text: 'A bare lese romantisk litteratur', isCorrect: false },
              { id: 'd', text: 'A glemme historien', isCorrect: false },
            ],
            solution: 'A vaere bevisst betyr a forstå hvordan romantiske ideer former var kultur - fra naturopplevelse til nasjonalfølelse - og a bruke dem reflektert, uten a la dem bli til ekskludering eller naivitet.',
          },
        ],
      },
    },
    ...
    },
    {
      ...
      exercise: {
        ...
        questions: [
          ...
          {
            id: 'norsk-vg2-3-11-n-quiz1-q1',
            task: 'Hva star I-en i SVIRP for?',
            options: [
              { id: 'a', text: 'Ironi', isCorrect: false },
              { id: 'b', text: 'Innhold', isCorrect: true },
              { id: 'c', text: 'Inspirasjon', isCorrect: false },
              { id: 'd', text: 'Individ', isCorrect: false },
            ],
            solution: 'SVIRP star for Sjanger, Virkemidler, Innhold, Refleksjon og Perspektiv. Det er en modell for a strukturere litteraer analyse.',
          },
        ],
      },
    },
    ...
    },
    {
      ...
      exercise: {
        ...
        questions: [
          ...
          {
            id: 'norsk-vg2-3-11-n-quiz2-q1',
            task: 'Hva bor man gjore med virkemidler i en analyse?',
            options: [
              { id: 'a', text: 'Bare ramse dem opp', isCorrect: false },
              { id: 'b', text: 'Forklare hvorfor forfatteren bruker dem og hva effekten er', isCorrect: true },
              { id: 'c', text: 'Ignorere dem', isCorrect: false },
              { id: 'd', text: 'Bare nevne de vanskeligste', isCorrect: false },
            ],
            solution: 'Det viktigste er ikke a ramse opp virkemidler, men a forklare hvorfor forfatteren bruker dem og hvilken effekt de har pa leseren. Koble virkemiddel til tolkning.',
          },
        ],
      },
    },
    ...
    },
    {
      ...
      exercise: {
        ...
        questions: [
          ...
          {
            id: 'norsk-vg2-3-11-n-quiz3-q1',
            task: 'Hva menes med "kontekst" i litteraer analyse?',
            options: [
              { id: 'a', text: 'Bare forfatterens biografi', isCorrect: false },
              { id: 'b', text: 'Den historiske, kulturelle og personlige sammenhengen teksten ble skapt i', isCorrect: true },
              { id: 'c', text: 'Bare spraket teksten er skrevet pa', isCorrect: false },
              { id: 'd', text: 'Sidetallet i boken', isCorrect: false },
            ],
            solution: 'Kontekst inkluderer den historiske perioden, kulturelle strømninger, forfatterens bakgrunn og andre tekster den dialog med. Kontekst hjelper oss a forstå teksten dypere.',
          },
        ],
      },
    },
    ...
    },
    {
      ...
      exercise: {
        ...
        questions: [
          ...
          {
            id: 'norsk-vg2-3-11-n-quiz4-q1',
            task: 'Hva er den viktigste regelen for a skrive en god litteraer analyse?',
            options: [
              { id: 'a', text: 'A gjenfortelle handlingen sa detaljert som mulig', isCorrect: false },
              { id: 'b', text: 'A ha en klar problemstilling og begrunne tolkningene med eksempler fra teksten', isCorrect: true },
              { id: 'c', text: 'A bruke sa mange fagbegreper som mulig', isCorrect: false },
              { id: 'd', text: 'A skrive sa kort som mulig', isCorrect: false },
            ],
            solution: 'Det viktigste er a ha en klar problemstilling og begrunne tolkningene med konkrete eksempler fra teksten. Analysen bor vaere argumenterende, ikke bare beskrivende.',
          },
        ],
      },
    },
    ...
    },
    {
      ...
      exercise: {
        ...
        questions: [
          ...
          {
            id: 'norsk-vg2-3-11-n-quiz5-q1',
            task: 'Hva er forskjellen mellom a beskrive og a tolke i en analyse?',
            options: [
              { id: 'a', text: 'Det er det samme', isCorrect: false },
              { id: 'b', text: 'A beskrive sier hva som star, a tolke sier hva det betyr', isCorrect: true },
              { id: 'c', text: 'A tolke er a finne feil', isCorrect: false },
              { id: 'd', text: 'A beskrive er viktigere enn a tolke', isCorrect: false },
            ],
            solution: 'A beskrive er a si hva som star i teksten. A tolke er a si hva det betyr - hva det forteller oss om temaer, verdier og menneskelige erfaringer. God analyse gjor begge deler.',
          },
        ],
      },
    },
    ...
    },
    {
      ...
      exercise: {
        ...
        questions: [
          ...
          {
            id: 'norsk-vg2-3-12-n-quiz1-q1',
            task: 'Hva var Welhavens hovedargument mot Wergeland?',
            options: [
              { id: 'a', text: 'At Wergeland var for gammel', isCorrect: false },
              { id: 'b', text: 'At norsk kultur trengte europeisk dannelse og kvalitetskrav', isCorrect: true },
              { id: 'c', text: 'At Wergeland ikke kunne skrive', isCorrect: false },
              { id: 'd', text: 'At diktning burde vaere forbudt', isCorrect: false },
            ],
            solution: 'Welhaven mente at norsk kultur trengte europeisk dannelse og kvalitetskrav, ikke bare nasjonal begeistring. Han fryktet at Wergelands linje forte til selvtilfredshet og lav kvalitet.',
          },
        ],
      },
    },
    ...
    },
    {
      ...
      exercise: {
        ...
        questions: [
          ...
          {
            id: 'norsk-vg2-3-12-n-quiz2-q1',
            task: 'Hva var Aasens praktiske argument for landsmalet?',
            options: [
              { id: 'a', text: 'At dansk var et stygt sprak', isCorrect: false },
              { id: 'b', text: 'At et skriftsprak basert pa folks eget talemaal ville vaere mer rettferdig og lettere a laere', isCorrect: true },
              { id: 'c', text: 'At nynorsk var identisk med gammelnorsk', isCorrect: false },
              { id: 'd', text: 'At alle andre land hadde to skriftsprak', isCorrect: false },
            ],
            solution: 'Aasen argumenterte for at det var urettferdig at nordmenn matte skrive pa et fremmed sprak. Et skriftsprak basert pa deres eget talemaal ville vaere lettere a laere og mer demokratisk.',
          },
        ],
      },
    },
    ...
    },
    {
      ...
      exercise: {
        ...
        questions: [
          ...
          {
            id: 'norsk-vg2-3-12-n-quiz3-q1',
            task: 'Hva laerer du av a gjore rollespill med historiske figurer?',
            options: [
              { id: 'a', text: 'A memorere datoer', isCorrect: false },
              { id: 'b', text: 'A forstå andres perspektiv og argumentere fra ulike standpunkt', isCorrect: true },
              { id: 'c', text: 'A spille teater', isCorrect: false },
              { id: 'd', text: 'A underhalde klassen', isCorrect: false },
            ],
            solution: 'Rollespill tvinger deg til a sette deg inn i en annen persons tankematte og argumentere fra deres perspektiv. Det utvikler empati og retoriske ferdigheter.',
          },
        ],
      },
    },
    ...
    },
    {
      ...
      exercise: {
        ...
        questions: [
          ...
          {
            id: 'norsk-vg2-3-12-n-quiz4-q1',
            task: 'Hva er forskjellen mellom en debatt og en krangel?',
            options: [
              { id: 'a', text: 'Det er ingen forskjell', isCorrect: false },
              { id: 'b', text: 'En debatt bruker argumenter og lyetter til motparten, en krangel handler bare om a vinne', isCorrect: true },
              { id: 'c', text: 'En krangel er mer strukturert', isCorrect: false },
              { id: 'd', text: 'En debatt har ingen regler', isCorrect: false },
            ],
            solution: 'I en debatt bruker man argumenter, lytter til motparten og forsøker a overbevise gjennom fornuft. I en krangel handler det bare om a vinne - uansett metode.',
          },
        ],
      },
    },
    ...
    },
    {
      ...
      exercise: {
        ...
        questions: [
          ...
          {
            id: 'norsk-vg2-3-12-n-quiz5-q1',
            task: 'Hvorfor er det verdifullt a argumentere for et standpunkt du er uenig i?',
            options: [
              { id: 'a', text: 'Det er det ikke - det er bortkastet tid', isCorrect: false },
              { id: 'b', text: 'Det tvinger deg til a forstå motpartens perspektiv og styrker din egen argumentasjon', isCorrect: true },
              { id: 'c', text: 'Fordi du ma vaere enig med alle', isCorrect: false },
              { id: 'd', text: 'Fordi laereren krever det', isCorrect: false },
            ],
            solution: 'A argumentere for noe du er uenig i tvinger deg til a forstå motpartens logikk. Det gjor deg til en bedre tenker og en mer nyansert debattant. Du laerer a se flere sider av en sak.',
          },
        ],
      },
    },
