...
Men Skram var ingen slaveisk etterligner. Hun tilforte naturalismen noe eget - et sarlig blikk for kvinnenes situasjon. I "Hellemyrsfolket" ser vi hvordan de fattige kvinnene sliter og kjemper, uten a fa anerkjennelse, uten mulighet til a forandre sin skjebne. Skrams sympati med disse kvinnene loser teksten fra den kalde objektiviteten naturalismen ofte preget av.`,
    ...
    // ========== QUIZ 1 ==========
    {
      ...
      exercise: {
        ...
        correctAnswer: 'b',
        solution: 'Naturalismen hevdet at mennesket er determinert - bestemt pa forhand - av sin biologiske arv og det sosiale miljoet det vokser opp i. Individet har liten eller ingen mulighet til a bryte ut av dette monsteret.',
      },
    },
...
Det siste bindet, "Afkom", folger Siverts sonn Severin. Her er vi ved bunnen. Severin representerer den endelige degenerasjonen - han havner i kriminalitet og galskap. Det naturalistiske eksperimentet er fullfort: Arven har seiret, miljoet har seiret, individet har tapt.`,
    ...
    // ========== QUIZ 2 ==========
    {
      ...
      exercise: {
        ...
        correctAnswer: 'c',
        solution: '"Hellemyrsfolket" bestar av fire bind: "Sjur Gabriel" (1887), "To Venner" (1887), "S.G. Myre" (1890) og "Afkom" (1898). Sammen folger de en slekt gjennom fire generasjoner.',
      },
    },
...
Det er et mprkt verdensbilde. Mennesket fremstar som et hjelpeløst offer for biologiske og sosiale krefter det ikke kan kontrollere. Men nettopp denne kompromissløsheten gir verket sin kraft.`,
    ...
    // ========== QUIZ 3 ==========
    {
      ...
      exercise: {
        ...
        correctAnswer: 'b',
        solution: 'Zola kalte sin metode for "det naturlige eksperimentet". Forfatteren skulle fungere som en vitenskapsmann som observerer mennesker i bestemte sosiale og biologiske forhold, og registrerer resultatene objektivt.',
      },
    },
...
I "Hellemyrsfolket" er kvinnene de som holder ut lengst. De ser klarere, de arbeider hardere, de gir mindre opp. Men det hjelper ikke. De er like fanget som mennene - kanskje mer. For de har ikke engang illusjonen om frihet.`,
    ...
    // ========== QUIZ 4 ==========
    {
      ...
      exercise: {
        ...
        correctAnswer: 'b',
        solution: 'Skrams kvinner har ofte stor styrke og dypere innsikt enn mennene rundt dem, men samfunnet gir dem ingen muligheter til a bruke disse egenskapene. De er like fanget som mennene - kanskje mer - men de holder ut lenger.',
      },
    },
...
Skram hadde ingen losninger a tilby. Men hun viste oss problemet med en klarhet som fortsatt utfordrer oss.`,
    ...
    // ========== QUIZ 5 ==========
    {
      ...
      exercise: {
        ...
        correctAnswer: 'b',
        solution: '"Hellemyrsfolket" var for morkt og kompromissløst for det brede publikum. Skildringen av fattigdom, alkoholisme og degenerasjon var ubehagelig lesning. Men nettopp denne kompromissløsheten har gitt verket varig litteraer verdi.',
      },
    },
...
En ny generasjon var klar for noe annet.`,
    ...
    // ========== QUIZ 1 ==========
    {
      ...
      exercise: {
        ...
        correctAnswer: 'b',
        solution: 'Nyromantikerne mente realismen var for opptatt av det ytre - sosiale problemer, samfunnsstrukturer, det som kunne observeres. De savnet utforsking av det indre livet, stemningene, det mystiske og uforklarlige.',
      },
    },
...
Og stilen forandret seg. Den nøkterne, observerende realismens sprak ble erstattet av noe mer poetisk, mer musikalsk, mer suggestivt. Ordene skulle ikke bare beskrive - de skulle fremkalle stemninger.`,
    ...
    // ========== QUIZ 2 ==========
    {
      ...
      exercise: {
        ...
        correctAnswer: 'b',
        solution: 'I nyromantikken ble naturskildringene ofte uttrykk for karakterenes indre tilstander. En stormfull nat kunne speile indre uro, en stille sommernatt kunne speile lengsel. Naturen var ikke bare kulisse, men sjelslandskap.',
      },
    },
...
Forelesningene skapte skandale. De etablerte forfatterne ble fornaermet. Men Hamsun hadde formulert noe som la i tiden - en tretthet med det gamle, en lengsel etter noe nytt. Han talte for en ny generasjon.`,
    ...
    // ========== QUIZ 3 ==========
    {
      ...
      exercise: {
        ...
        correctAnswer: 'c',
        solution: 'Hamsun krevde en litteratur som utforsket "det ubevisste sjeleliv" og "hemmelighetsfulde nervevirksomheter" - de irrasjonelle impulsene, de merkelige tankene, det som ligger under bevissthetens overflate.',
      },
    },
...
Alle disse stromningene hang sammen. De representerte et opprør mot 1800-tallets trygge, rasjonelle verdensbilde. Og de pekte fremover mot det 20. arhundrets modernisme.`,
    ...
    // ========== QUIZ 4 ==========
    {
      ...
      exercise: {
        ...
        number: 'Quiz 4',
        type: 'multiple-choice',
        task: 'Hvilken litteraer bevegelse i Frankrike inspirerte de skandinaviske nyromantikerne?',
        options: [
        ...
        correctAnswer: 'b',
        solution: 'Symbolismen, med diktere som Mallarme, Verlaine og Rimbaud, var en viktig inspirasjonskilde for skandinaviske nyromantikere. Symbolistene sokte a uttrykke det usigelige gjennom symboler, klang og suggestive bilder.',
      },
    },
...
Men det fantes ogsa radikale nyromantikere som Hamsun, som virkelig ville starte helt pa nytt. Hans tidlige romaner representerte noe genuint nytt i skandinavisk litteratur - en intensitet, en naerhet til bevisstheten, som ingen hadde oppnadd for.`,
    ...
    // ========== QUIZ 5 ==========
    {
      ...
      exercise: {
        ...
        correctAnswer: 'b',
        solution: 'Ibsens sene dramaer, fra "Vildanden" og utover, har sterke symbolistiske trekk. Symboler som vildanden, taarnvarelset og havet peker mot noe mer enn realistisk samfunnskritikk. Ibsen utviklet seg i takt med tiden.',
      },
    },
...
I 1888 publiserte han et fragment av det som skulle bli "Sult" i et tidsskrift. Responsen var overveldende. Her var noe nytt, noe annerledes. I 1890 kom romanen i bokform - og Hamsuns liv forandret seg for alltid.`,
    ...
    // ========== QUIZ 1 ==========
    {
      ...
      exercise: {
        ...
        correctAnswer: 'c',
        solution: 'Hamsun ble født i Lom, men vokste opp i Hamaroy i Nordland fra han var tre ar. Det nordnorske landskapet preget hans forfatterskap dypt, saerlig i romaner som "Pan".',
      },
    },
    ...
    // ========== QUIZ 2 ==========
    {
      ...
      exercise: {
        ...
        options: [
          ...
          { id: 'b', text: 'At tankenes strøm ble gjengitt direkte, uten forklarende forteller', isCorrect: true },
          { id: 'c', text: 'At den var skrevet pa dialekt', isCorrect: false },
          { id: 'd', text: 'At den kritiserte samfunnet', isCorrect: false },
        ],
        correctAnswer: 'b',
        solution: '"Sult" var revolusjonerende fordi den gjengav bevissthetens strøm direkte - tankenes springende bevegelser, de irrasjonelle impulsene - uten en forteller som ordnet og forklarte. Denne teknikken pekte fremover mot modernismen.',
      },
    },
...
Men sa kom krigen. Og med den, Hamsuns storste feilgrep.`,
    ...
    // ========== QUIZ 4 ==========
    {
      ...
      exercise: {
        ...
        correctAnswer: 'b',
        solution: 'Hamsun var en pioner for bevissthetsstrøm-teknikken - gjengivelsen av tankenes strøm direkte, uten ordnende forteller. Denne teknikken ble senere sentral i modernismen, hos forfattere som Joyce og Woolf.',
      },
    },
...
Debatten fortsetter. Men uansett standpunkt: Hamsuns litteraere betydning forblir ubestridelig. Han forandret romankunsten - og den forandringen lever videre, uavhengig av mannens feilgrep.`,
    ...
    // ========== QUIZ 5 ==========
    {
      ...
      exercise: {
        ...
        correctAnswer: 'b',
        solution: 'Hamsuns støtte til nazistene under krigen, inkludert hans mote med Hitler og nekrologen over ham, har kastet en skygge over hans ettermæle. Debatten om hvordan vi skal forholde oss til dette, fortsetter.',
      },
    },
...
Disse fire - Baudelaire, Mallarme, Verlaine, Rimbaud - skapte symbolismen. Snart skulle ideene deres spre seg over hele Europa.`,
    ...
    // ========== QUIZ 1 ==========
    {
      ...
      exercise: {
        ...
        number: 'Quiz 1',
        type: 'multiple-choice',
        task: 'Hvem regnes som symbolismens forloiper i Frankrike?',
        options: [
        ...
        correctAnswer: 'b',
        solution: 'Charles Baudelaire regnes som symbolismens forloiper med sin diktsamling "Ondets blomster" (1857). Hans ide om "correspondances" - skjulte sammenhenger mellom sansene - ble grunnleggende for symbolismen.',
      },
    },
...
Og i dramaet? Ibsens sene stykker beveget seg i symbolistisk retning. "Vildanden" med sin mystiske fugl, "Bygmester Solness" med sitt taarn, "Nar vi dode vaagner" med sin symbolmetning - alt dette viser at symbolismens pavirkning rakk langt utover lyrikken.`,
    ...
    // ========== QUIZ 3 ==========
    {
      ...
      exercise: {
        ...
        correctAnswer: 'c',
        solution: 'Sigbjorn Obstfelder regnes som Norges fremste symbolist. Hans dikt, saerlig "Jeg ser", fanger eksistensiell fremmedgjoering med en enkelhet og intensitet som gjor dem tidlose.',
      },
    },
    ...
    // ========== QUIZ 4 ==========
    {
      ...
      exercise: {
        ...
        options: [
          ...
          { id: 'd', text: 'En type billedsprak', isCorrect: false },
        ],
        correctAnswer: 'b',
    ...
    // ========== QUIZ 5 ==========
    {
      ...
      exercise: {
        ...
        options: [
          ...
          { id: 'd', text: 'Den fort kun til mer realistisk diktning', isCorrect: false },
        ],
        correctAnswer: 'b',
...
Men det varte ikke. Den 29. juli 1900 dode han av tuberkulose i Kobenhavn. Han var bare 33 ar gammel.`,
    ...
    // ========== QUIZ 1 ==========
    {
      ...
      exercise: {
        ...
        correctAnswer: 'b',
        solution: 'Obstfelder levde bare 33 ar - han dode av tuberkulose i 1900. Til tross for det korte livet og den lille produksjonen har han fatt en sentral plass i norsk litteraturhistorie.',
      },
    },
...
Denne folelsen - av a vaere fremmed i verden, av a se det selvfolgelige som underlig - er kanskje den mest moderne av alle folelser. Den forespeiler 1900-tallets eksistensialisme. Obstfelder var der forst.`,
    ...
    // ========== QUIZ 3 ==========
    {
      ...
      exercise: {
        ...
        correctAnswer: 'b',
        solution: 'Diktet er bygget opp av tre parallelle sekvenser der jeg-et forst ser pa himmelen, sa pa jorden (hus, vinduer), og til slutt pa menneskene. Hver sekvens folges av en refleksjon, for sluttlinjen samler alt.',
      },
    },
