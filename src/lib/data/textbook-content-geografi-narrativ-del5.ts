...
Sa er det bare fordeler med frihandel? Nei, bildet er mer nyansert. Forbrukere far lavere priser og storre utvalg. Bedrifter far tilgang til storre markeder. Men noen arbeidsplasser forsvinner nar produksjonen flyttes til lavkostland. Og konkurransen kan fore til et "kapplop mot bunnen" der land senker standarder for a tiltrekke investeringer. Vi skal se mer pa denne debatten senere i kapittelet.`,
    },
    {
      ...
      exercise: {
        ...
        task: 'Test deg selv pa handel og globalisering:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        questions: [
          {
            id: 'geografi-1-21-n-quiz1-q0',
          ...
          {
            id: 'geografi-1-21-n-quiz1-q1',
            task: 'Hva er handelsbalansen?',
            options: [
              { id: 'a', text: 'Antall handelsavtaler et land har med andre land', isCorrect: false },
              { id: 'b', text: 'Forskjellen mellom eksport og import', isCorrect: true },
              { id: 'c', text: 'Den totale verdien av all handel i verden', isCorrect: false },
              { id: 'd', text: 'Forholdet mellom offentlig og privat handel', isCorrect: false },
            ],
            solution: 'Handelsbalansen er forskjellen mellom eksport og import. Hvis et land eksporterer mer enn det importerer, har det et handelsoverskudd. Norge har vanligvis handelsoverskudd, forst og fremst takket vare olje og gass.',
          },
          {
            id: 'geografi-1-21-n-quiz1-q2',
            task: 'Hva gir EOS-avtalen Norge tilgang til?',
            options: [
              { id: 'a', text: 'Fullt EU-medlemskap med stemmerett', isCorrect: false },
              { id: 'b', text: 'Tollfri handel med USA og Kina', isCorrect: false },
              { id: 'c', text: 'EUs indre marked uten fullt medlemskap', isCorrect: true },
              { id: 'd', text: 'Gratis import av alle varer fra hele verden', isCorrect: false },
            ],
            solution: 'EOS-avtalen gir Norge tilgang til EUs indre marked uten fullt medlemskap. Det betyr at norske bedrifter kan selge varer og tjenester i hele EU uten tollbarrierer.',
          },
        ],
        solution: '',
      },
...
**COVID-19-pandemien** avslorte sarbarhetene i disse verdikjedene. Plutselig stoppet forsyningene opp, fabrikker ble stengt, og verden opplevde mangel pa alt fra medisinsk utstyr til bilbrikker. Mange land begynte a tenke pa om de var for avhengige av produksjon i utlandet.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 2',
        type: 'multiple-choice',
        task: 'Test deg selv pa globale verdikjeder:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        questions: [
          {
            id: 'geografi-1-21-n-quiz2-q0',
          ...
          {
            id: 'geografi-1-21-n-quiz2-q1',
            task: 'Hva betyr "just-in-time-leveranser"?',
            options: [
              { id: 'a', text: 'At varer leveres gratis', isCorrect: false },
              { id: 'b', text: 'At delene ankommer akkurat nar de trengs, for a minimere lagerkostnader', isCorrect: true },
              { id: 'c', text: 'At alle leveranser skjer pa samme dag', isCorrect: false },
              { id: 'd', text: 'At varene alltid leveres for tidlig for sikkerhets skyld', isCorrect: false },
            ],
            solution: 'Just-in-time-leveranser betyr at deler og komponenter ankommer akkurat nar de trengs i produksjonen, slik at bedrifter slipper a lagre store mengder. COVID-19-pandemien avslorte sarbarhetene i dette systemet da forsyningskjedene stoppet opp.',
          },
          {
            id: 'geografi-1-21-n-quiz2-q2',
            task: 'Hva avslorte COVID-19-pandemien om globale verdikjeder?',
            options: [
              { id: 'a', text: 'At verdikjedene er robuste og tilpasningsdyktige', isCorrect: false },
              { id: 'b', text: 'At verden ikke lenger er avhengig av internasjonal handel', isCorrect: false },
              { id: 'c', text: 'At systemet er sarbart nar forsyningene stopper opp', isCorrect: true },
              { id: 'd', text: 'At bare utviklingsland ble pavirket', isCorrect: false },
            ],
            solution: 'COVID-19 avslorte sarbarhetene i globale verdikjeder. Fabrikker ble stengt, forsyninger stoppet opp, og verden opplevde mangel pa alt fra medisinsk utstyr til bilbrikker. Mange land begynte a tenke pa om de var for avhengige av produksjon i utlandet.',
          },
        ],
        solution: '',
      },
...
Sa hva er svaret? Er kulturell globalisering kulturimperialisme -- at vestlig kultur patvinges resten av verden? Eller er det gjensidig kulturutveksling der pavirkningen gar begge veier? Sannheten ligger nok et sted imellom. Vestlig kultur har stor gjennomslagskraft, men ikke-vestlige kulturer pavirker ogsa Vesten -- yoga, sushi, K-pop og Bollywood er eksempler pa dette. Og lokale kulturer dor sjelden helt ut -- de tilpasser seg og blander seg med det nye.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 3',
        type: 'multiple-choice',
        task: 'Test deg selv pa kulturell globalisering:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        questions: [
          {
            id: 'geografi-1-21-n-quiz3-q0',
          ...
          {
            id: 'geografi-1-21-n-quiz3-q1',
            task: 'Hva beskriver begrepet McDonaldization?',
            options: [
              { id: 'a', text: 'At McDonald\'s er verdens storste restaurant', isCorrect: false },
              { id: 'b', text: 'At rasjonelle, standardiserte systemer sprer seg til alle deler av samfunnet', isCorrect: true },
              { id: 'c', text: 'At all mat i verden smaker likt', isCorrect: false },
              { id: 'd', text: 'At vestlig mat er sunnere enn lokal mat', isCorrect: false },
            ],
            solution: 'Sosiologen George Ritzer lanserte begrepet McDonaldization for a beskrive hvordan rasjonelle, standardiserte systemer -- effektivitet, forutsigbarhet og kontroll -- sprer seg til alle deler av samfunnet, fra utdanning til helsevesen.',
          },
          {
            id: 'geografi-1-21-n-quiz3-q2',
            task: 'Hva er hybridisering i kulturell sammenheng?',
            options: [
              { id: 'a', text: 'At kulturer forsvinner helt', isCorrect: false },
              { id: 'b', text: 'At kulturer blander seg og skaper nye uttrykk', isCorrect: true },
              { id: 'c', text: 'At alle land far noyaktig samme kultur', isCorrect: false },
              { id: 'd', text: 'At bare vestlig kultur overlever', isCorrect: false },
            ],
            solution: 'Hybridisering betyr at kulturer blander seg og skaper nye uttrykk. Bollywood kombinerer indisk og vestlig filmtradisjon. K-pop blander koreansk og vestlig popmusikk. Kulturpavirkning gar begge veier, ikke bare fra vest til ost.',
          },
        ],
        solution: '',
      },
...
Hva gjor vi med dette dilemmaet? Globaliseringen gir oss tilgang til varer vi ellers ikke ville hatt, til priser vi har rad til. Men den har miljokostnader som ikke alltid gjenspeiles i prislappen. Det finnes ingen enkle svar, men bevisstheten om disse sammenhengene er forste steg.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 4',
        type: 'multiple-choice',
        task: 'Test deg selv pa handel og miljo:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        questions: [
          {
            id: 'geografi-1-21-n-quiz4-q0',
          ...
          {
            id: 'geografi-1-21-n-quiz4-q1',
            task: 'Hva beskriver begrepet "food miles"?',
            options: [
              { id: 'a', text: 'Hvor mange kalorier maten inneholder', isCorrect: false },
              { id: 'b', text: 'Hvor langt maten reiser fra produsent til forbruker', isCorrect: true },
              { id: 'c', text: 'Hvor mange ledd maten passerer i butikkjeden', isCorrect: false },
              { id: 'd', text: 'Hvor mange land som importerer maten', isCorrect: false },
            ],
            solution: 'Food miles beskriver avstanden maten reiser fra produsent til forbruker. Norske jordbor om sommeren har lave food miles, mens importerte jordbor fra Spania om vinteren har hoye. Men produksjonsmetoden kan noen ganger telle mer enn transportavstanden.',
          },
          {
            id: 'geografi-1-21-n-quiz4-q2',
            task: 'Hva menes med "race to the bottom" i globaliseringssammenheng?',
            options: [
              { id: 'a', text: 'At bedrifter konkurrerer om a selge billigst', isCorrect: false },
              { id: 'b', text: 'At land senker miljo- og arbeidsstandarder for a tiltrekke investeringer', isCorrect: true },
              { id: 'c', text: 'At lonnningene oker raskt i fattige land', isCorrect: false },
              { id: 'd', text: 'At de fattigste landene alltid taper i internasjonal handel', isCorrect: false },
            ],
            solution: '"Race to the bottom" betyr at land konkurrerer om a tiltrekke investeringer ved a senke miljo- og arbeidsstandarder. Dette kan gjore land med svake regler til "forurensningsparadiser" der produksjon som er forbudt i rike land fortsetter.',
          },
        ],
        solution: '',
      },
...
Dette er politiske sporsmal uten enkle svar. Men de er viktige sporsmal for din generasjon -- for det er dere som skal leve med konsekvensene av de valgene som gjores na.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 5',
        type: 'multiple-choice',
        task: 'Test deg selv pa globaliseringens vinnere og tapere:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        questions: [
          {
            id: 'geografi-1-21-n-quiz5-q0',
          ...
          {
            id: 'geografi-1-21-n-quiz5-q1',
            task: 'Hvem har tjent mest pa globaliseringen?',
            options: [
              { id: 'a', text: 'Lavtlonte arbeidere i rike land', isCorrect: false },
              { id: 'b', text: 'Alle har tjent likt', isCorrect: false },
              { id: 'c', text: 'De med kapital og kompetanse, samt forbrukere som far billigere varer', isCorrect: true },
              { id: 'd', text: 'Bare utviklingsland', isCorrect: false },
            ],
            solution: 'De som har tjent mest pa globaliseringen er de med kapital og kompetanse -- investorer, hoytkvalifiserte arbeidere og store selskaper. Forbrukere har ogsa tjent gjennom lavere priser og storre utvalg. Lavtlonte arbeidere i rike land har ofte tapt jobber til lavkostland.',
          },
        ],
        solution: '',
      },
...
Og sa finnes det mal for fattigdom spesifikt. Verdensbanken definerer **ekstrem fattigdom** som a leve pa under 2,15 dollar om dagen. Ca. 700 millioner mennesker lever under denne grensen -- en dramatisk nedgang fra 1,9 milliarder i 1990, men fortsatt altfor mange.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 1',
        type: 'multiple-choice',
        task: 'Test deg selv pa mal for utvikling:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        questions: [
          {
            id: 'geografi-1-22-n-quiz1-q0',
          ...
          {
            id: 'geografi-1-22-n-quiz1-q1',
            task: 'Hva er en viktig svakhet ved BNP per innbygger som mal pa utvikling?',
            options: [
              { id: 'a', text: 'Det er vanskelig a beregne', isCorrect: false },
              { id: 'b', text: 'Det fanger ikke fordeling -- et land kan ha hoyt gjennomsnitt med enorm ulikhet', isCorrect: true },
              { id: 'c', text: 'Det brukes bare i rike land', isCorrect: false },
              { id: 'd', text: 'Det maler bare jordbruksproduksjon', isCorrect: false },
            ],
            solution: 'BNP per innbygger viser gjennomsnittlig okonomisk produksjon, men fanger ikke fordeling. Et land kan ha hoyt gjennomsnitt mens noen fa er steinrike og flertallet er fattige. Det ignorerer ogsa ubetalt arbeid og miljokostnader.',
          },
          {
            id: 'geografi-1-22-n-quiz1-q2',
            task: 'Hva maler Gini-koeffisienten?',
            options: [
              { id: 'a', text: 'Et lands totale BNP', isCorrect: false },
              { id: 'b', text: 'Forventet levealder i et land', isCorrect: false },
              { id: 'c', text: 'Ulikhet i inntektsfordeling', isCorrect: true },
              { id: 'd', text: 'Antall mennesker i ekstrem fattigdom', isCorrect: false },
            ],
            solution: 'Gini-koeffisienten maler ulikhet i inntektsfordeling. En verdi pa 0 betyr perfekt likhet, mens 1 betyr perfekt ulikhet. Skandinaviske land har lave verdier (rundt 0,25-0,30), mens land som Sor-Afrika har hoye (over 0,60).',
          },
        ],
        solution: '',
      },
...
Hva er riktig? Sannsynligvis er alle disse faktorene relevante i ulik grad for ulike land. Nigeria har andre utfordringer enn Nepal, og Haiti har andre enn Haiti. Enkle forklaringer er sjelden tilstrekkelige -- virkeligheten er kompleks.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 2',
        type: 'multiple-choice',
        task: 'Test deg selv pa arsaker til fattigdom:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        questions: [
          {
            id: 'geografi-1-22-n-quiz2-q0',
            ...
            solution: 'Acemoglu og Robinson argumenterer i "Why Nations Fail" for at inkluderende institusjoner -- rettssikkerhet, eiendomsrettigheter, politisk representasjon -- er avgjorendes for langsiktig okonomisk velstand.',
          },
          {
            id: 'geografi-1-22-n-quiz2-q1',
            task: 'Hvordan forklarer avhengighetsteorien fattigdom?',
            options: [
              { id: 'a', text: 'At fattige land mangler naturressurser', isCorrect: false },
              { id: 'b', text: 'At fattige land er fattige pa grunn av rike lands utbytting og urettferdige strukturer', isCorrect: true },
              { id: 'c', text: 'At fattige land har for stor befolkning', isCorrect: false },
              { id: 'd', text: 'At fattigdom skyldes darlig klima', isCorrect: false },
            ],
            solution: 'Avhengighetsteorien fra 1960-tallet argumenterer for at fattige land er fattige pa grunn av rike lands utbytting. Handelsregler favoriserer rike land, gjeldsbyrde tynger fattige land, og skatteparadiser tapper ressurser fra utviklingsland.',
          },
          {
            id: 'geografi-1-22-n-quiz2-q2',
            task: 'Hvordan har kolonialismen bidratt til utfordringer i Afrika?',
            options: [
              { id: 'a', text: 'Kolonimaktene bygde infrastruktur som fortsatt fungerer', isCorrect: false },
              { id: 'b', text: 'Kolonimaktene trakk grenser uten hensyn til lokale forhold og etterlot institusjoner designet for utbytting', isCorrect: true },
              { id: 'c', text: 'Kolonimaktene innforte demokrati i alle kolonier', isCorrect: false },
              { id: 'd', text: 'Kolonialismen hadde ingen langvarig effekt', isCorrect: false },
            ],
            solution: 'Europeiske kolonimakter utbyttet ressurser, etablerte grenser uten hensyn til lokale forhold, utsatte befolkninger for slaveri, og etterlot institusjoner designet for utbytting -- ikke utvikling. Denne arven preger fortsatt mange land.',
          },
        ],
        solution: '',
      },
...
Det viktige er kanskje at det ikke finnes en enkelt losning. Bistand, handel, utdanning, helse, godt styresett -- alle disse faktorene spiller inn. Og losningene ma tilpasses lokale forhold.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 3',
        type: 'multiple-choice',
        task: 'Test deg selv pa fattigdomsfeller og veier ut:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        questions: [
          {
            id: 'geografi-1-22-n-quiz3-q0',
            ...
            solution: 'En fattigdomsfelle er en selvforsterkende sirkel som holder mennesker i fattigdom. For eksempel: fattige foreldre har ikke rad til a sende barn pa skole, barna far darlige jobber, og har ikke rad til utdanning for egne barn.',
          },
          {
            id: 'geografi-1-22-n-quiz3-q1',
            task: 'Hva er mikrofinans?',
            options: [
              { id: 'a', text: 'Lan fra Verdensbanken til stater', isCorrect: false },
              { id: 'b', text: 'Store investeringer i infrastruktur', isCorrect: false },
              { id: 'c', text: 'Sma lan til fattige mennesker som ikke har tilgang til vanlige banker', isCorrect: true },
              { id: 'd', text: 'Bistand fra FN til krigsomrader', isCorrect: false },
            ],
            solution: 'Mikrofinans er sma lan til fattige mennesker uten tilgang til vanlige banker. Muhammad Yunus grunnla Grameen Bank i Bangladesh og fikk Nobels fredspris i 2006 for dette. Lanene brukes ofte til a starte smabedrifter.',
          },
          {
            id: 'geografi-1-22-n-quiz3-q2',
            task: 'Omtrent hvor mye av BNI gir Norge i bistand arlig?',
            options: [
            ...
            solution: 'Norge gir ca. 1 % av bruttonasjonalinntekten (BNI) i bistand arlig, noe som gjor Norge til et av landene som gir mest i bistand relativt sett.',
          },
        ],
        solution: '',
      },
...
Ulikhet er et av var tids mest omdiskuterte temaer. Noen mener at ulikhet er naturlig og nodvendig for okonomisk vekst -- rike mennesker investerer og skaper arbeidsplasser. Andre mener at den ekstreme ulikheten vi ser i dag er skadelig og ma bekjempes gjennom skatter, omfordeling og sterkere rettigheter for arbeidere. Debatten fortsetter.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 4',
        type: 'multiple-choice',
        task: 'Test deg selv pa global ulikhet:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        questions: [
          {
            id: 'geografi-1-22-n-quiz4-q0',
            ...
            solution: 'Ulikheten mellom land har gatt ned de siste tiarene, hovedsakelig pa grunn av okonomisk vekst i Kina og India. Men ulikheten innad i mange land har okt -- de rikeste har tatt en stadig storre andel av inntektene.',
          },
          {
            id: 'geografi-1-22-n-quiz4-q1',
            task: 'Hvor stor andel av verdens formue eier de 10 % rikeste?',
            options: [
              { id: 'a', text: 'Ca. 25 %', isCorrect: false },
              { id: 'b', text: 'Ca. 50 %', isCorrect: false },
              { id: 'c', text: 'Over 75 %', isCorrect: true },
              { id: 'd', text: 'Ca. 90 %', isCorrect: false },
            ],
            solution: 'De 10 % rikeste i verden eier over 75 % av verdens formue. De 50 % fattigste eier under 2 %. Oxfam har rapportert at de atte rikeste menneskene eier like mye som den fattigste halvdelen av verdens befolkning.',
          },
        ],
        solution: '',
      },
...
Klimarettferdighet er et av de mest krevende sporsmalene i var tid. Det handler ikke bare om miljo -- det handler om global rettferdighet, om hvem som har ansvar for fortiden og hvem som har rett til fremtiden.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 5',
        type: 'multiple-choice',
        task: 'Test deg selv pa klimarettferdighet:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        questions: [
          {
            id: 'geografi-1-22-n-quiz5-q0',
            ...
            solution: 'Loss and Damage handler om at rike land bor kompensere fattige land for klimaskader som allerede har skjedd. Et fond ble opprettet pa COP27 i 2022, men finansieringen er fortsatt under debatt.',
          },
          {
            id: 'geografi-1-22-n-quiz5-q1',
            task: 'Hvorfor er klimaendringene spesielt urettferdige for fattige land?',
            options: [
              { id: 'a', text: 'Fordi fattige land har bidratt mest til klimagassutslipp', isCorrect: false },
              { id: 'b', text: 'Fordi fattige land har bidratt minst til problemet, men rammes hardest og har minst ressurser til tilpasning', isCorrect: true },
              { id: 'c', text: 'Fordi fattige land ikke er med i noen klimaavtaler', isCorrect: false },
              { id: 'd', text: 'Fordi fattige land har kaldere klima enn rike land', isCorrect: false },
            ],
            solution: 'Klimaendringene er spesielt urettferdige fordi de som har bidratt minst -- fattige land -- rammes hardest gjennom torke, flom og havnivastigning. Samtidig har de minst ressurser til tilpasning. USA og EU star for mesteparten av historiske utslipp.',
          },
          {
            id: 'geografi-1-22-n-quiz5-q2',
            task: 'Hvor mye har rike land lovet a bidra arlig til klimatiltak i utviklingsland?',
            options: [
              { id: 'a', text: '10 milliarder dollar', isCorrect: false },
              { id: 'b', text: '50 milliarder dollar', isCorrect: false },
              { id: 'c', text: '100 milliarder dollar', isCorrect: true },
              { id: 'd', text: '1 billion dollar', isCorrect: false },
            ],
            solution: 'Rike land har lovet a bidra med 100 milliarder dollar arlig til klimatiltak i utviklingsland. Men malet har vart vanskelig a na, og det er debatt om hva som egentlig telles som klimafinansiering.',
          },
        ],
        solution: '',
      },
...
Havet har sine egne grenser, regulert av **FNs Havrettskonvensjon (UNCLOS)**. Hvert land har et **territorialfarvann** pa 12 nautiske mil fra kysten. Utenfor det har de en **okonomisk sone** pa 200 nautiske mil der de har rett til ressursene. Og **kontinentalsokkelen** -- den undersjoiske forlengelsen av landmassen -- kan gi rettigheter enda lenger ut. For Norge, med var enorme kystlinje, er disse havgrensene ekstremt viktige.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 1',
        type: 'multiple-choice',
        task: 'Test deg selv pa grenser og territorier:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        questions: [
          {
            id: 'geografi-1-23-n-quiz1-q0',
            ...
            solution: 'Da europeiske kolonimakter delte Afrika pa Berlin-konferansen i 1885, trakk de grenser uten hensyn til etniske, spraklige eller religiose grupper. Dette splittet folkegrupper og tvang fiendtlige grupper sammen.',
          },
          {
            id: 'geografi-1-23-n-quiz1-q1',
            task: 'Hvor langt ut fra kysten strekker et lands okonomiske sone seg ifølge UNCLOS?',
            options: [
            ...
            solution: 'FNs Havrettskonvensjon (UNCLOS) gir hvert land et territorialfarvann pa 12 nautiske mil og en okonomisk sone pa 200 nautiske mil fra kysten, der de har rett til ressursene.',
          },
          {
            id: 'geografi-1-23-n-quiz1-q2',
            task: 'Hva er forskjellen mellom naturlige og kunstige grenser?',
            options: [
              { id: 'a', text: 'Naturlige grenser er eldre enn kunstige', isCorrect: false },
              { id: 'b', text: 'Naturlige grenser folger terreng som elver og fjell, kunstige er trukket uten hensyn til naturlige forhold', isCorrect: true },
              { id: 'c', text: 'Kunstige grenser er alltid rette linjer', isCorrect: false },
              { id: 'd', text: 'Det er ingen reell forskjell mellom dem', isCorrect: false },
            ],
            solution: 'Naturlige grenser folger naturlige trekk som elver, fjellkjeder og kystlinjer. Kunstige grenser er trukket pa kart uten hensyn til naturlige forhold eller til menneskene som bor der, som mange av Afrikas grenser.',
          },
        ],
        solution: '',
      },
...
Disse ressurskonfliktene viser noe viktig om geopolitikken: Det handler ikke bare om ideologi eller verdier. Det handler om helt konkrete, materielle interesser -- hvem som kontrollerer det verdensokonomien trenger for a fungere.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 2',
        type: 'multiple-choice',
        task: 'Test deg selv pa ressurskonflikter:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        questions: [
          {
            id: 'geografi-1-23-n-quiz2-q0',
            task: 'Hvilket land dominerer produksjonen av sjeldne jordarter?',
            options: [
            ...
            solution: 'Kina dominerer produksjonen av sjeldne jordarter og har brukt dette som politisk pressmiddel. Vestlige land soker na etter alternative kilder for a redusere avhengigheten.',
          },
          {
            id: 'geografi-1-23-n-quiz2-q1',
            task: 'Hvordan bruker Russland sine gassressurser geopolitisk?',
            options: [
              { id: 'a', text: 'De gir bort gass gratis til fattige land', isCorrect: false },
              { id: 'b', text: 'De bruker gassleveranser som politisk pressmiddel overfor Europa', isCorrect: true },
              { id: 'c', text: 'De eksporterer bare til Kina', isCorrect: false },
              { id: 'd', text: 'De bruker ikke gass som politisk verktoy', isCorrect: false },
            ],
            solution: 'Russland bruker sine gassleveranser som et politisk verktoy -- muligheten til a skru av gassen til Europa gir betydelig innflytelse. Dette ble sorlig tydelig etter invasjonen av Ukraina i 2022.',
          },
          {
            id: 'geografi-1-23-n-quiz2-q2',
            task: 'Hvilket land har ca. 70 % av verdens koboltreserver?',
            options: [
              { id: 'a', text: 'Kina', isCorrect: false },
              { id: 'b', text: 'Australia', isCorrect: false },
              { id: 'c', text: 'Kongo', isCorrect: true },
              { id: 'd', text: 'Chile', isCorrect: false },
            ],
            solution: 'Kongo har ca. 70 % av verdens koboltreserver. Kobolt er viktig for elbilbatterier og elektronikk, men utvinningen er preget av konflikt og barnearbeid.',
          },
        ],
        solution: '',
      },
...
Og sa har vi **Svalbard** -- oygruppen i Arktis der norsk suverenitet er sikret av en internasjonal traktat. Vi kommer tilbake til Svalbard i neste kapittel.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 3',
        type: 'multiple-choice',
        task: 'Test deg selv pa Norges geopolitiske posisjon:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        questions: [
          {
            id: 'geografi-1-23-n-quiz3-q0',
            ...
            solution: 'Norges okonomiske sone er pa ca. 2 millioner kvadratkilometer -- nesten sju ganger sa stort som fastlandet. Dette gjor Norge til en betydelig maritim nasjon.',
          },
          {
            id: 'geografi-1-23-n-quiz3-q1',
            task: 'Hva er Norges balansepolitikk overfor Russland?',
            options: [
              { id: 'a', text: 'Norge samarbeider ikke med Russland i det hele tatt', isCorrect: false },
              { id: 'b', text: 'Norge onsker a avskrekke Russland fra aggresjon, men ogsa unnga unodvendig provokasjon', isCorrect: true },
              { id: 'c', text: 'Norge er alliert med Russland', isCorrect: false },
              { id: 'd', text: 'Norge ignorerer Russland fullstendig', isCorrect: false },
            ],
            solution: 'Norges balansepolitikk overfor Russland inneborer bade avskrekking og dialog. Vi er NATO-medlem for sikkerhet, men samarbeider ogsa med Russland om fiskeriforvaltning. Denne balansen har blitt vanskeligere etter Ukraina-invasjonen i 2022.',
          },
        ],
        solution: '',
      },
...
Hva betyr dette for oss? En multipolar verden er mer kompleks. Det er flere maktsentra a forholde seg til. Risikoen for konflikter der stormaktsinteresser kolliderer oker. For sma land som Norge betyr det at vi ma navigere forsiktig mellom store aktorer.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 4',
        type: 'multiple-choice',
        task: 'Test deg selv pa stormaktene:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        questions: [
          {
            id: 'geografi-1-23-n-quiz4-q0',
            ...
            solution: 'Belt and Road Initiative er Kinas enorme infrastrukturprosjekt som bygger veier, havner og jernbaner i utviklingsland over hele verden, og knytter dem tettere til Kina okonomisk og politisk.',
          },
          {
            id: 'geografi-1-23-n-quiz4-q1',
            task: 'Hva menes med en multipolar verden?',
            options: [
              { id: 'a', text: 'En verden der ett land dominerer alt', isCorrect: false },
              { id: 'b', text: 'En verden med flere maktsentra', isCorrect: true },
              { id: 'c', text: 'En verden uten stormakter', isCorrect: false },
              { id: 'd', text: 'En verden der bare polene er viktige', isCorrect: false },
            ],
            solution: 'En multipolar verden er et internasjonalt system med flere maktsentra -- ikke dominert av en enkelt supermakt. Etter den kalde krigen var USA den ubestridte supermakten, men na utfordres dette av Kina, Russland og EU.',
          },
          {
            id: 'geografi-1-23-n-quiz4-q2',
            task: 'Hva er EUs storste styrke og svakhet som global aktor?',
            options: [
              { id: 'a', text: 'Styrke: stor haer. Svakhet: liten okonomi', isCorrect: false },
              { id: 'b', text: 'Styrke: okonomisk gigant. Svakhet: vanskelig a enes om utenrikspolitikk med 27 land', isCorrect: true },
              { id: 'c', text: 'Styrke: enhetlig lederskap. Svakhet: fa medlemsland', isCorrect: false },
              { id: 'd', text: 'Styrke: militor makt. Svakhet: svak okonomi', isCorrect: false },
            ],
            solution: 'EU er en okonomisk gigant -- verdens storste handelsblokk -- med stor "myk makt" gjennom demokrati og menneskerettigheter. Men det er vanskelig a enes om utenrikspolitikk nar 27 land skal bli enige, og EU er en militaer dverg.',
          },
        ],
        solution: '',
      },
...
Disse teoriene er ikke perfekte, men de gir oss redskaper til a tenke systematisk om geografi og makt. Og de minner oss om at kart aldri er noytrale -- de er alltid tegnet av noen, med et bestemt perspektiv.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 5',
        type: 'multiple-choice',
        task: 'Test deg selv pa geopolitiske teorier:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        questions: [
          {
            id: 'geografi-1-23-n-quiz5-q0',
            ...
            solution: 'Mackinders Heartland-teori (1904) hevdet at den som kontrollerer det eurasiske hjertlandet -- Sentral-Asia og Sibir -- kontrollerer verden. Omradet er rikt pa ressurser og vanskelig a invadere.',
          },
          {
            id: 'geografi-1-23-n-quiz5-q1',
            task: 'Hva argumenterte admiral Mahan for i sin sjomaktsteori?',
            options: [
              { id: 'a', text: 'At landmakt er viktigere enn sjomakt', isCorrect: false },
              { id: 'b', text: 'At kontroll over havene er nokkelen til verdensmakt', isCorrect: true },
              { id: 'c', text: 'At romfart er fremtidens maktfaktor', isCorrect: false },
              { id: 'd', text: 'At sma land alltid vinner kriger', isCorrect: false },
            ],
            solution: 'Admiral Mahan argumenterte for at kontroll over havene er nokkelen til verdensmakt. Sjohandel, flatebaser og strategiske sund er avgjorendes. Denne teorien har pavirket USAs globale flatestrategi med baser over hele verden.',
          },
          {
            id: 'geografi-1-23-n-quiz5-q2',
            task: 'Hva utfordrer kritisk geopolitikk ved de klassiske teoriene?',
            options: [
              { id: 'a', text: 'At de er for nye og umodne', isCorrect: false },
              { id: 'b', text: 'At de fokuserer for mye pa okonomi', isCorrect: false },
              { id: 'c', text: 'At geopolitisk kunnskap ikke er objektiv, men formet av maktinteresser', isCorrect: true },
              { id: 'd', text: 'At de ikke tar hensyn til klimaendringer', isCorrect: false },
            ],
            solution: 'Kritisk geopolitikk argumenterer for at geopolitisk kunnskap ikke er objektiv, men formet av maktinteresser. Kart og territorielle fremstillinger er politiske verktoy. Den spor: Hvem tjener pa denne maten a se verden pa?',
          },
        ],
        solution: '',
      },
...
Dette har konsekvenser langt utenfor Arktis. Gronlandsisen -- som ligger pa land -- bidrar til havnivastigning nar den smelter. Klimamonstre endres nar temperaturforskjellen mellom pol og ekvator minker. Og permafrosten inneholder enorme mengder karbon som kan frigjores som CO2 og metan -- en potensiell klimabombe.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 1',
        type: 'multiple-choice',
        task: 'Test deg selv pa Arktis og issmelting:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        questions: [
          {
            id: 'geografi-1-24-n-quiz1-q0',
            ...
            solution: 'Is-albedo-tilbakekoblingen forklarer dette. Hvit is reflekterer sollys, mens morkt hav absorberer det. Nar is smelter og mer hav eksponeres, absorberes mer varme, som smelter mer is -- en selvforsterkende sirkel.',
          },
          {
            id: 'geografi-1-24-n-quiz1-q1',
            task: 'Omtrent hvor mye har minimumsutbredelsen av sjois i Arktis krympet siden 1980?',
            options: [
              { id: 'a', text: 'Ca. 10 prosent', isCorrect: false },
              { id: 'b', text: 'Ca. 20 prosent', isCorrect: false },
              { id: 'c', text: 'Ca. 40 prosent', isCorrect: true },
              { id: 'd', text: 'Ca. 80 prosent', isCorrect: false },
            ],
            solution: 'Minimumsutbredelsen av sjoisen i september har krympet med nesten 40 prosent siden 1980 -- fra rundt 7,5 millioner til 4-5 millioner kvadratkilometer. I tillegg blir isen tynnere.',
          },
          {
            id: 'geografi-1-24-n-quiz1-q2',
            task: 'Hva er den grunnleggende forskjellen mellom Arktis og Antarktis?',
            options: [
              { id: 'a', text: 'Arktis er varmere enn Antarktis', isCorrect: false },
              { id: 'b', text: 'Arktis er et hav omgitt av land, Antarktis er land omgitt av hav', isCorrect: true },
              { id: 'c', text: 'Arktis har mer is enn Antarktis', isCorrect: false },
              { id: 'd', text: 'Antarktis har urfolk mens Arktis ikke har det', isCorrect: false },
            ],
            solution: 'Arktis er et hav (Nordishavet) omgitt av land, med urfolk og moderne samfunn. Antarktis er et kontinent omgitt av hav, uten permanent befolkning -- bare forskere. Denne forskjellen pavirker bade klima og politikk.',
          },
        ],
        solution: '',
      },
...
Turismen har ogsa okt -- rundt 100 000 turister besoker Antarktis arlig, de fleste pa cruiseskip. Det skaper bekymring for miljopavirkning pa sårbare okosystemer, sorlig pingvinkolonier.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 2',
        type: 'multiple-choice',
        task: 'Test deg selv pa Antarktis:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        questions: [
          {
            id: 'geografi-1-24-n-quiz2-q0',
          ...
          {
            id: 'geografi-1-24-n-quiz2-q1',
            task: 'Hva fastslar Antarktistraktaten fra 1959?',
            options: [
              { id: 'a', text: 'At Antarktis tilhorer USA og Russland', isCorrect: false },
              { id: 'b', text: 'At alle territorielle krav fryses, og kontinentet skal kun brukes til fredelige formal', isCorrect: true },
              { id: 'c', text: 'At hvert land kan gjore krav pa den delen de oppdaget forst', isCorrect: false },
              { id: 'd', text: 'At Antarktis skal deles likt mellom alle FN-land', isCorrect: false },
            ],
            solution: 'Antarktistraktaten fra 1959 fryser alle territorielle krav, forbyr militaer aktivitet og atomprovesprengninger, og fastslar at kontinentet kun skal brukes til fredelige formal. Vitenskapelig forskning er fri og apen for alle.',
          },
          {
            id: 'geografi-1-24-n-quiz2-q2',
            task: 'Hvor mye ville havnivaet stige hvis all is pa Antarktis smeltet?',
            options: [
              { id: 'a', text: 'Ca. 5 meter', isCorrect: false },
              { id: 'b', text: 'Ca. 20 meter', isCorrect: false },
              { id: 'c', text: 'Over 60 meter', isCorrect: true },
              { id: 'd', text: 'Ca. 2 meter', isCorrect: false },
            ],
            solution: 'Antarktis\' isdekke inneholder 70 prosent av jordens ferskvann. Hvis alt smeltet, ville havnivaet stige med over 60 meter. Heldigvis er dette ekstremt usannsynlig pa kort sikt.',
          },
        ],
        solution: '',
      },
...
Hvem eier Arktis? **Arktisk rad** samler de atte arktiske statene (Russland, Canada, USA, Norge, Danmark, Island, Finland, Sverige) pluss representanter for urfolk. Radet har vaert en arena for samarbeid, men etter Russlands invasjon av Ukraina i 2022 har samarbeidet i praksis stoppet opp. Spenningen mellom samarbeid og rivalisering preger regionen.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 3',
        type: 'multiple-choice',
        task: 'Test deg selv pa ressurser og rivalisering i Arktis:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        questions: [
          {
            id: 'geografi-1-24-n-quiz3-q0',
            ...
            solution: 'Nordostpassasjen kan kutte seilasen mellom Asia og Europa med opptil 40 prosent sammenlignet med ruten via Suezkanalen.',
          },
          {
            id: 'geografi-1-24-n-quiz3-q1',
            task: 'Hvor stor andel av verdens uoppdagede gass anslås a ligge i Arktis?',
            options: [
              { id: 'a', text: 'Ca. 5 prosent', isCorrect: false },
              { id: 'b', text: 'Ca. 15 prosent', isCorrect: false },
              { id: 'c', text: 'Ca. 30 prosent', isCorrect: true },
              { id: 'd', text: 'Ca. 50 prosent', isCorrect: false },
            ],
            solution: 'US Geological Survey anslaar at ca. 30 prosent av verdens uoppdagede gass og 13 prosent av uoppdaget olje ligger i Arktis. Dette gjor regionen geopolitisk viktig etter hvert som isen smelter og omradene blir tilgjengelige.',
          },
          {
            id: 'geografi-1-24-n-quiz3-q2',
            task: 'Hvilke land er med i Arktisk rad?',
            options: [
              { id: 'a', text: 'Alle FN-land som onsker det', isCorrect: false },
              { id: 'b', text: 'De atte arktiske statene: Russland, Canada, USA, Norge, Danmark, Island, Finland og Sverige', isCorrect: true },
              { id: 'c', text: 'Bare NATO-land med arktisk kyst', isCorrect: false },
              { id: 'd', text: 'Norge, Russland og Kina', isCorrect: false },
            ],
            solution: 'Arktisk rad samler de atte arktiske statene (Russland, Canada, USA, Norge, Danmark, Island, Finland, Sverige) pluss representanter for urfolk. Etter Russlands invasjon av Ukraina i 2022 har samarbeidet i praksis stoppet opp.',
          },
        ],
        solution: '',
      },
...
I **Dronning Maud Land** i Antarktis har Norge ogsa et krav -- fremsatt i 1939 og frosset under Antarktistraktaten. Her ligger Troll-stasjonen, der norske forskere arbeider med klima, geologi og atmosforeforskning.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 4',
        type: 'multiple-choice',
        task: 'Test deg selv pa Svalbard og Norges polaromrader:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        questions: [
          {
            id: 'geografi-1-24-n-quiz4-q0',
            task: 'Hva er spesielt med Svalbardtraktaten?',
            options: [
              { id: 'a', text: 'Den gir Russland delt suverenitet med Norge', isCorrect: false },
              { id: 'b', text: 'Den gir Norge suverenitet, men borgere fra alle signatarstater har lik rett til noringsvirksomhet', isCorrect: true },
          ...
          {
            id: 'geografi-1-24-n-quiz4-q1',
            task: 'Hva er Frohvelvet pa Svalbard?',
            options: [
              { id: 'a', text: 'Et museum over Svalbards historie', isCorrect: false },
              { id: 'b', text: 'En global matreserve som lagrer froeprobver fra hele verden i en gruvesjakt', isCorrect: true },
              { id: 'c', text: 'En militoer bunker fra den kalde krigen', isCorrect: false },
              { id: 'd', text: 'Et observatorium for nordlys', isCorrect: false },
            ],
            solution: 'Frohvelvet (Svalbard Global Seed Vault) er en global matreserve som lagrer froeprobver fra hele verden i en gruvesjakt pa Svalbard, beskyttet av permafrost. Det er en sikkerhetskopi for verdens matproduksjon.',
          },
          {
            id: 'geografi-1-24-n-quiz4-q2',
            task: 'Hvorfor er fiskevernsonen rundt Svalbard omstridt?',
            options: [
              { id: 'a', text: 'Fordi det ikke finnes fisk i farvannene rundt Svalbard', isCorrect: false },
              { id: 'b', text: 'Fordi flere land mener Svalbardtraktatens likebehandlingsprinsipp ogsa bor gjelde i havet', isCorrect: true },
              { id: 'c', text: 'Fordi Norge ikke har lov til a opprette slike soner', isCorrect: false },
              { id: 'd', text: 'Fordi Russland eier halvparten av sonen', isCorrect: false },
            ],
            solution: 'Norge opprettet en fiskevernsone pa 200 nautiske mil rundt Svalbard i 1977. Flere land -- Russland, EU, Island -- mener Svalbardtraktatens likebehandlingsprinsipp bor gjelde ogsa i havet, ikke bare pa land. Norge kaller den en "fiskevernsone" for a unnga konfrontasjon.',
          },
        ],
        solution: '',
      },
...
Permafrostsmelting har ogsa praktiske konsekvenser. Bygninger, veier og rorledninger som er bygget pa permafrost, synker og skades nar grunnen tiner. I Sibir har hele landsbyer blitt ustabile. Infrastruktur verdt hundrevis av milliarder dollar er truet.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 5',
        type: 'multiple-choice',
        task: 'Test deg selv pa permafrost:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        questions: [
          {
            id: 'geografi-1-24-n-quiz5-q0',
            ...
            solution: 'Permafrosten inneholder anslagsvis 1500 milliarder tonn karbon -- nesten dobbelt sa mye som i atmosforen. Nar den tiner, frigjores CO2 og metan, som forsterker oppvarmingen -- en selvforsterkende tilbakekobling.',
          },
          {
            id: 'geografi-1-24-n-quiz5-q1',
            task: 'Omtrent hvor mye karbon er lagret i permafrosten?',
            options: [
              { id: 'a', text: 'Ca. 100 milliarder tonn', isCorrect: false },
              { id: 'b', text: 'Ca. 500 milliarder tonn', isCorrect: false },
              { id: 'c', text: 'Ca. 1500 milliarder tonn', isCorrect: true },
              { id: 'd', text: 'Ca. 5000 milliarder tonn', isCorrect: false },
            ],
            solution: 'Anslagsvis 1500 milliarder tonn karbon ligger lagret i permafrosten -- nesten dobbelt sa mye som i hele atmosfaren. Dette gjor permafrostsmelting til en potensiell "tipping point" i klimasystemet.',
          },
          {
            id: 'geografi-1-24-n-quiz5-q2',
            task: 'Hvilke praktiske konsekvenser far permafrostsmelting utover klimaeffektene?',
            options: [
              { id: 'a', text: 'Ingen praktiske konsekvenser', isCorrect: false },
              { id: 'b', text: 'Bygninger, veier og rorledninger pa permafrost synker og skades', isCorrect: true },
              { id: 'c', text: 'Jordbruket forbedres dramatisk', isCorrect: false },
              { id: 'd', text: 'Fiskebestandene oker', isCorrect: false },
            ],
            solution: 'Nar permafrost tiner, synker og skades bygninger, veier og rorledninger som er bygget pa den. I Sibir har hele landsbyer blitt ustabile, og infrastruktur verdt hundrevis av milliarder dollar er truet.',
          },
        ],
        solution: '',
      },
...
**Etiske hensyn** er viktige fra starten. Hvis du skal intervjue folk, ma de vite hva informasjonen brukes til og samtykke til a delta. Respekter privat eiendom. Ikke fotografer folk uten tillatelse. Anonymiser personopplysninger. God forskning handler ikke bare om gode data -- det handler om a behandle mennesker og natur med respekt.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 1',
        type: 'multiple-choice',
        task: 'Test deg selv pa problemstilling og forberedelse:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        questions: [
          {
            id: 'geografi-1-25-n-quiz1-q0',
          ...
          {
            id: 'geografi-1-25-n-quiz1-q1',
            task: 'Hva er forskjellen mellom primaerdata og sekundardata?',
            options: [
              { id: 'a', text: 'Primaerdata er alltid bedre enn sekundardata', isCorrect: false },
              { id: 'b', text: 'Primaerdata er data du samler selv, sekundardata er data andre har samlet', isCorrect: true },
              { id: 'c', text: 'Sekundardata samles i felt, primaerdata fra nettet', isCorrect: false },
              { id: 'd', text: 'Det er ingen forskjell', isCorrect: false },
            ],
            solution: 'Primaerdata er data du samler selv gjennom feltarbeid -- malinger, observasjoner, intervjuer. Sekundardata er data andre har samlet, som statistikk fra SSB eller kart fra Kartverket. Begge typer er nyttige.',
          },
          {
            id: 'geografi-1-25-n-quiz1-q2',
            task: 'Hvorfor er det viktig a lage hypoteser for feltarbeidet?',
            options: [
              { id: 'a', text: 'Fordi hypotesene alltid ma vare riktige', isCorrect: false },
              { id: 'b', text: 'Fordi det er et krav fra laereren', isCorrect: false },
              { id: 'c', text: 'Fordi de hjelper a fokusere datainnsamlingen og gir noe a teste resultatene mot', isCorrect: true },
              { id: 'd', text: 'Fordi de erstatter konklusjonen', isCorrect: false },
            ],
            solution: 'Hypoteser hjelper deg a fokusere datainnsamlingen og gir noe a teste resultatene mot. Det er helt greit om hypotesene viser seg a vaere feil -- det er ogsa et viktig funn.',
          },
        ],
        solution: '',
      },
...
En viktig distinksjon er mellom **kvantitative** og **kvalitative** metoder. Kvantitative metoder gir tall og malbare data som kan analyseres statistisk. Kvalitative metoder gir ord, beskrivelser og forstaelse. De fleste gode prosjekter kombinerer begge -- det kalles **mixed methods** eller **triangulering**: a bruke flere metoder for a belyse samme sporsmal styrker troverdigheten av resultatene.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 2',
        type: 'multiple-choice',
        task: 'Test deg selv pa metoder for datainnsamling:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        questions: [
          {
            id: 'geografi-1-25-n-quiz2-q0',
            ...
            solution: 'Triangulering betyr a bruke flere metoder, datakilder eller perspektiver for a belyse samme problemstilling. Dette styrker troverdigheten av resultatene.',
          },
          {
            id: 'geografi-1-25-n-quiz2-q1',
            task: 'Hva er forskjellen mellom kvantitative og kvalitative metoder?',
            options: [
              { id: 'a', text: 'Kvantitative metoder er bedre enn kvalitative', isCorrect: false },
              { id: 'b', text: 'Kvantitative gir tall og malbare data, kvalitative gir ord og forstaelse', isCorrect: true },
              { id: 'c', text: 'Kvalitative metoder bruker bare tall', isCorrect: false },
              { id: 'd', text: 'Det er ingen forskjell mellom dem', isCorrect: false },
            ],
            solution: 'Kvantitative metoder gir tall og malbare data som kan analyseres statistisk (f.eks. trafikktelling). Kvalitative metoder gir ord, beskrivelser og forstaelse (f.eks. intervjuer). De fleste gode prosjekter kombinerer begge.',
          },
          {
            id: 'geografi-1-25-n-quiz2-q2',
            task: 'Hva er forskjellen mellom et strukturert og et ustrukturert intervju?',
            options: [
              { id: 'a', text: 'Strukturert har faste sporsmal i fast rekkefolge, ustrukturert er mer som en samtale', isCorrect: true },
              { id: 'b', text: 'Strukturert tar lengre tid enn ustrukturert', isCorrect: false },
              { id: 'c', text: 'Ustrukturert er alltid bedre enn strukturert', isCorrect: false },
              { id: 'd', text: 'Strukturert brukes bare i naturgeografi', isCorrect: false },
            ],
            solution: 'Et strukturert intervju bruker faste sporsmal i fast rekkefolge -- godt for sammenligning. Et ustrukturert intervju er mer som en samtale -- godt for dybdeforstaelse. Valget avhenger av hva du trenger.',
          },
        ],
        solution: '',
      },
...
Etter feltarbeidet: Sjekk at alt er notert og leselig mens du fortsatt husker detaljene. Overfør data til regneark eller database sa raskt som mulig. Sikkerhetskopier alt.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 3',
        type: 'multiple-choice',
        task: 'Test deg selv pa praktisk gjennomforing:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        questions: [
          {
            id: 'geografi-1-25-n-quiz3-q0',
            ...
            solution: 'Etter feltarbeid bor du umiddelbart sjekke at alt er notert og leselig, overfore data til regneark, og sikkerhetskopiere -- mens du fortsatt husker detaljene.',
          },
          {
            id: 'geografi-1-25-n-quiz3-q1',
            task: 'Hvorfor er systematikk viktig under feltarbeidet?',
            options: [
              { id: 'a', text: 'For a gjore arbeidet raskere', isCorrect: false },
              { id: 'b', text: 'For a sikre at du registrerer de samme tingene pa samme mate, slik at data kan sammenlignes', isCorrect: true },
              { id: 'c', text: 'Fordi laereren krever det', isCorrect: false },
              { id: 'd', text: 'For a spare papir', isCorrect: false },
            ],
            solution: 'Systematikk sikrer at du registrerer de samme tingene pa samme mate gjennom hele feltarbeidet. Bruk observasjonsskjema, noter tid og sted, og beskriv objektivt. Uten systematikk kan dataene vaere ubrukelige.',
          },
        ],
        solution: '',
      },
...
Bruk geografisk fagsprak, men skriv slik at en medelev kan forsta. Vaer aerlig om begrensninger og feilkilder. Det viser at du har forstatt vitenskapelig metode.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 4',
        type: 'multiple-choice',
        task: 'Test deg selv pa analyse og presentasjon:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        questions: [
          {
            id: 'geografi-1-25-n-quiz4-q0',
            ...
            solution: 'Korrelasjon beskriver sammenheng, men at to ting samvarierer betyr ikke at det ene forarsaker det andre. Det kan vaere en tredje faktor som forklarer begge, eller sammenhengen kan vaere tilfeldig.',
          },
          {
            id: 'geografi-1-25-n-quiz4-q1',
            task: 'Hva er den riktige rekkefølgen i en feltrapport?',
            options: [
              { id: 'a', text: 'Konklusjon, resultater, metode, innledning, drofting', isCorrect: false },
              { id: 'b', text: 'Innledning, metode, resultater, drofting, konklusjon', isCorrect: true },
              { id: 'c', text: 'Metode, innledning, drofting, resultater, konklusjon', isCorrect: false },
              { id: 'd', text: 'Resultater, metode, innledning, konklusjon, drofting', isCorrect: false },
            ],
            solution: 'En feltrapport folger strukturen: Innledning (bakgrunn, problemstilling, hypoteser), Metode (datainnsamling), Resultater (funn med kart og diagrammer), Drofting (tolkning og feilkilder), og Konklusjon (svar pa problemstillingen).',
          },
          {
            id: 'geografi-1-25-n-quiz4-q2',
            task: 'Hva er forskjellen mellom gjennomsnitt og median?',
            options: [
              { id: 'a', text: 'Det er ingen forskjell', isCorrect: false },
              { id: 'b', text: 'Gjennomsnitt er summen delt pa antall, median er midtverdien i sorterte data', isCorrect: true },
              { id: 'c', text: 'Median er alltid hoyere enn gjennomsnitt', isCorrect: false },
              { id: 'd', text: 'Gjennomsnitt brukes bare i naturgeografi', isCorrect: false },
            ],
            solution: 'Gjennomsnitt er summen delt pa antall. Median er midtverdien nar du sorterer dataene. Medianen er mindre folsom for ekstremverdier -- noen fa veldig hoye eller lave verdier pavirker gjennomsnittet mye, men ikke medianen.',
          },
        ],
        solution: '',
      },
...
Et siste poeng: **statistisk leseferdighet**. Forsta forskjellen mellom absolutte tall og relative tall (prosent). Forsta forskjellen mellom gjennomsnitt og median. Vaer oppmerksom pa hvordan diagrammer kan manipuleres gjennom valg av skala. Et soylediagram som ikke starter pa null, kan fa sma forskjeller til a se dramatiske ut. Kritisk blikk er viktig.`,
    },
    {
      ...
      exercise: {
        ...
        number: 'Quiz 5',
        type: 'multiple-choice',
        task: 'Test deg selv pa kildekritikk og feilkilder:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        questions: [
          {
            id: 'geografi-1-25-n-quiz5-q0',
            ...
            solution: 'Primaerdata er data du samler inn selv gjennom eget feltarbeid -- malinger, observasjoner, intervjuer. Sekundardata er data andre har samlet.',
          },
          {
            id: 'geografi-1-25-n-quiz5-q1',
            task: 'Hvorfor bor du rapportere begrensninger og feilkilder i feltarbeidet ditt?',
            options: [
              { id: 'a', text: 'For a fylle rapporten med mer tekst', isCorrect: false },
              { id: 'b', text: 'Fordi det viser at du forstaar vitenskapelig metode', isCorrect: true },
              { id: 'c', text: 'For a fa sympati fra laereren', isCorrect: false },
              { id: 'd', text: 'Det er ikke nodvendig a rapportere begrensninger', isCorrect: false },
            ],
            solution: 'A rapportere begrensninger og feilkilder viser at du forstaar vitenskapelig metode. All forskning har begrensninger -- a innromme dette styrker troverdigheten av arbeidet ditt.',
          },
          {
            id: 'geografi-1-25-n-quiz5-q2',
            task: 'Hva er bias i en kilde?',
            options: [
              { id: 'a', text: 'At kilden er skrevet pa et fremmedsprak', isCorrect: false },
              { id: 'b', text: 'At kilden er gammel', isCorrect: false },
              { id: 'c', text: 'At kilden har en skjevhet formet av forfatterens perspektiv eller interesser', isCorrect: true },
              { id: 'd', text: 'At kilden inneholder feil i tallene', isCorrect: false },
            ],
            solution: 'Bias (skjevhet) betyr at en kilde er formet av forfatterens perspektiv, interesser eller formal. Statistikk kan presenteres selektivt, kart kan fremheve visse aspekter, og intervjuobjekter har egne interesser. Vaer bevisst pa dette.',
          },
        ],
        solution: '',
      },
