...
// @ts-nocheck
/**
 * Fransk Nivå 3 - Kapittel 4-6 (Detaljerte underkapitler)
 *
 * Dekker:
...
export const CHAPTER_FRANSK_3_4_1: TextbookChapter = {
  ...
  description: 'Lær de viktigste stilfigurene i fransk litteratur og retorikk, inkludert metafor, sammenligning, personifikasjon og flere.',
  estimatedMinutes: 50,
  competenceGoals: [
    'identifisere og forklare sentrale stilfigurer i franske tekster',
    'bruke stilfigurer i egen skriftlig produksjon på fransk',
  ],
  content: [
    {
...
Stilfigurer (les figures de style) er litterære virkemidler som forfattere bruker for å gjøre teksten mer uttrykksfull, poetisk eller overbevisende. Å kjenne til stilfigurene er avgjørende for å kunne analysere franske tekster på et avansert nivå.

De viktigste kategoriene er:
- **Les figures d'analogie** (sammenligningsfigurer)
- **Les figures d'insistance** (førsterkningsfigurer)
...
- Her sammenligner Hugo månen med en gullsigd, uten å bruke "comme"
...
| L'allegorie | Utvidet metafor/personifikasjon | *La Justice, les yeux bandés, tient sa balance.* |

**La personnification** er særlig vanlig i fransk poesi. Naturen får ofte menneskelige egenskaper:
- *Les fleurs dansent sous la brise.* (Blomstene danser i brisen.)
- *La mer se déchaîne.* (Havet raser.)`,
    },
    {
...
a) *"Ses cheveux étaient d'or."* (Victor Hugo)
...
a) **Metaphore** - Håret sammenlignes med gull uten bruk av "comme". Det er ikke bokstavelig gull, men en metafor for lyst, skinnende hår.

b) **Personnification** - Naturen fremstilles som et tempel, og søylene (trærne) "snakker". Dette er også en allegori.

c) **Comparaison** - Sammenligningsordet "comme" brukes til å sammenligne skjønnheten med dagen.`,
    },
    {
      ...
      exercise: {
        ...
        subTasks: [
          { label: 'a', task: '"Le soleil se couche doucement." (Solen legger seg forsiktig.)', solution: 'Personnification - Solen får den menneskelige egenskapen å "legge seg". Det skaper et poetisk bilde av solnedgangen.' },
          { label: 'b', task: '"Mon coeur est un oiseau en cage." (Hjertet mitt er en fugl i bur.)', solution: 'Metaphore - Hjertet sammenlignes direkte med en fugl i bur uten "comme". Det uttrykker følelsen av å være fanget.' },
...
|--------|------------|----------|
| L'hyperbole | Overdrivelse | *Je meurs de faim!* (Jeg dør av sult!) |
| L'anaphore | Gjentakelse av ord i begynnelsen | *Paris! Paris outrage! Paris brise! Paris martyrise!* (de Gaulle) |
| La gradation | Stigende/synkende oppramsing | *Va, cours, vole!* (Corneille) |

**Motsetningsfigurer:**

| Figure | Definisjon | Eksempel |
|--------|------------|----------|
| L'antithese | Motsetning mellom to ideer | *Être ou ne pas être.* |
...
| Figure | Definisjon | Eksempel |
|--------|------------|----------|
| La litote | Si lite for å uttrykke mye | *"Va, je ne te hais point."* (= Jeg elsker deg, Corneille) |
| L'euphemisme | Mildere uttrykk | *Il nous a quittes.* (= Han er død.) |`,
    },
    {
...
b) *"Moi, président de la République, je ne traiterai pas... Moi, président de la République, je ferai..."* (François Hollande)
c) *"Un illustre inconnu."*`,
      solution: `**Løsning:**

a) **Hyperbole** - Overdrivelse. Man er ikke bokstavelig død av tretthet, men uttrykket forsterker følelsen.

b) **Anaphore** - Gjentakelse av "Moi, président de la République" i begynnelsen av flere setninger. Skaper rytme og forsterker budskapet.

c) **Oxymore** - "Illustre" (berømmet) og "inconnu" (ukjent) er motsetninger som står sammen. Det skaper en paradoksal effekt.`,
    },
    {
      ...
      exercise: {
        ...
        subTasks: [
          { label: 'a', task: '"Il fait un froid de canard!" (Det er and-kaldt! = Det er steinkald!)', solution: 'Hyperbole - Overdrivelse for å forsterke kulden.' },
          { label: 'b', task: '"Je vis, je meurs; je me brule et me noie." (Louise Labe)', solution: 'Antithese - Motsetningene "vis/meurs" (lever/dør) og "brule/noie" (brenner/drukner) står mot hverandre.' },
          { label: 'c', task: '"Ce n\'est pas mauvais." (om noe som er veldig bra)', solution: 'Litote - Man sier "det er ikke dårlig" for å uttrykke at det er veldig bra. Man sier mindre enn man mener.' },
        ],
    ...
    },
    {
      ...
      exercise: {
        ...
        task: 'Skriv en setning på fransk som bruker den angitte stilfiguren:',
        subTasks: [
          { label: 'a', task: 'En metafor om livet', solution: 'For eksempel: "La vie est un voyage sans retour." (Livet er en reise uten retur.)' },
          { label: 'b', task: 'En personifikasjon av høsten', solution: 'For eksempel: "L\'automne pleure ses dernières feuilles." (Høsten gråter sine siste blader.)' },
          { label: 'c', task: 'En hyperbel om å være sulten', solution: 'For eksempel: "J\'ai tellement faim que je pourrais manger un elephant." (Jeg er så sulten at jeg kunne spist en elefant.)' },
        ],
    ...
    },
    {
      ...
      exercise: {
        ...
        subTasks: [
          { label: 'a', task: '"Sois sage, o ma Douleur, et tiens-toi plus tranquille." - Hvilken stilfigur åpner diktet?', solution: 'Personnification og apostrofe - Smerten (la Douleur) tiltales som en person og får menneskelige egenskaper (være fornuftig, holde seg rolig).' },
          ...
          { label: 'c', task: 'Skriv din egen apostrofe (tiltale til noe abstrakt) på fransk.', solution: 'For eksempel: "O Liberté, guide nos pas!" (Å Frihet, led våre skritt!)' },
        ],
        solution: 'a) Personnification/apostrofe, b) Allegori-effekt, c) Åpent svar.',
        hints: ['Apostrofe = tiltale til noe fraværende eller abstrakt', 'Stor forbokstav kan signalisere allegori'],
      },
    },
    {
      id: 'fransk-3-4-1-tip-1',
      type: 'tip',
      content: `**Tips for å huske stilfigurene:**
...
export const CHAPTER_FRANSK_3_4_2: TextbookChapter = {
  ...
  description: 'Lær om de ulike språkregistrene i fransk, med fokus på det formelle registeret og litterært vokabular.',
  estimatedMinutes: 50,
  competenceGoals: [
  ...
  content: [
    {
      ...
      type: 'text',
      content: `## Les registres de langue - Språkregistrene

Fransk har tre hovedregistre som brukes i ulike situasjoner:

| Registre | Norsk | Bruksområde |
|----------|-------|--------------|
| **Soutenu** (formelt) | Høytidelig/litterært | Litteratur, formelle taler, akademiske tekster |
| **Courant** (standard) | Nøytralt/standard | Dagligtale, aviser, skole |
| **Familier** (uformelt) | Uformelt/muntlig | Venner, familie, SMS |

Å beherske disse registrene er viktig for å forstå franske tekster i ulike sjangre og for å tilpasse eget språk til konteksten.`,
    },
    {
      id: 'fransk-3-4-2-def-1',
      type: 'definition',
      content: `**Le registre soutenu** kjennetegnes av:
- Bruk av passé simple (historisk fortid)
- Inversjon i spørsmål (*Pourriez-vous...*)
- Litterært og presist vokabular
...
- Enkle, korte setninger`,
    },
    {
      ...
      type: 'text',
      content: `## Ordforråd i ulike registre

| Soutenu | Courant | Familier | Norsk |
|---------|---------|----------|-------|
| un ouvrage | un livre | un bouquin | en bok |
| se restaurer | manger | bouffer | å spise |
| une demeure | une maison | une baraque | et hus |
| un véhicule | une voiture | une bagnole | en bil |
| se vêtir | s'habiller | se fringuer | å kle seg |
| demeurer | habiter | cracher | å bo |
| être las | être fatigué | être crevé | å være trøtt |
| decevoir | ennuyer | gonfler | å skuffe/kjede |
| un labeur | un travail | un boulot | en jobb |
| se quereller | se disputer | s'engueuler | å krangle |

**Merk:** I akademisk skriving og på eksamen forventes det at du bruker **courant** eller **soutenu** register.`,
    },
    {
      id: 'fransk-3-4-2-example-1',
      type: 'example',
      title: 'Eksempel 1: Identifiser registeret',
      problem: `Hvilket register tilhører disse setningene?
...
a) **Soutenu** - Inversjon (*pourriez-vous*), formelt vokabular (*m'indiquer*, *me rendre a*), lang og høflig formulering.

b) **Familier** - Ingen inversjon, direkte "tu"-tiltale, kort og enkel setning, mangler formell høflighet.

c) **Courant** - Høflig "vous"-tiltale, inversjon (*savez-vous*), men enklere ordvalg enn soutenu. Standard spørsmålsform.`,
    },
    {
      ...
      exercise: {
        ...
        subTasks: [
          ...
          { label: 'c', task: '"Je ne comprends pas ce que vous dites."', solution: 'Courant - Standard nektelse med "ne...pas", høflig "vous", normal setningsstruktur.' },
        ],
...
I det formelle registeret brukes **le passé simple** i stedet for **le passé composé**. Dette er den viktigste markoren for litterært språk:

| Passé composé (courant) | Passé simple (soutenu) | Norsk |
|--------------------------|------------------------|-------|
| Il a mange | Il mangea | Han spiste |
| Elle est partie | Elle partit | Hun dro |
| Ils ont vu | Ils virent | De så |
| J'ai compris | Je compris | Jeg forsto |

**Bøyning av passé simple (1. gruppe, -er):**
...
I moderne fransk brukes passé simple nesten utelukkende i **skriftspråk**: romaner, historiske tekster og formelle beretninger.`,
    },
    {
...
- "bouffe" (familier) -> "se restaura" (soutenu, passé simple)
- "s'est tire" (familier) -> "prit conge" (soutenu, passé simple)

b) **Soutenu:** *"Elle se vêtit et se rendit a son labeur."*
- "s'est frinquee" (familier) -> "se vêtit" (soutenu, passé simple)
- "partie bosser" (familier) -> "se rendit a son labeur" (soutenu)`,
    },
    {
      ...
      exercise: {
        ...
        subTasks: [
          { label: 'a', task: '"Il a mange dans un bon restaurant."', solution: '"Il se restaura dans un établissement de renom." (passé simple + formelt vokabular)' },
          { label: 'b', task: '"Elle a achete une belle maison."', solution: '"Elle fit l\'acquisition d\'une belle demeure." (passé simple + litterært vokabular)' },
          { label: 'c', task: '"Nous avons travaille toute la journée."', solution: '"Nous oeuvrames tout au long de la journée." (passé simple + formelt uttrykk)' },
        ],
        solution: 'a) "Il se restaura...", b) "Elle fit l\'acquisition...", c) "Nous oeuvrames..."',
        hints: ['Bruk passé simple i stedet for passé composé', 'Bytt ut hverdagsord med litterære synonymer'],
      },
    },
    {
      ...
      exercise: {
        ...
        subTasks: [
          { label: 'a', task: 'une voiture (courant)', solution: 'un véhicule' },
          ...
          { label: 'd', task: 'être fatigué (courant)', solution: 'être las / etre épuisé' },
        ],
        solution: 'a) un véhicule, b) se restaurer, c) une demeure, d) être las',
        hints: ['Tenk på litterært og formelt vokabular', 'Soutenu-ord er ofte lengre og mer presise'],
      },
    },
    {
      ...
      exercise: {
        ...
        subTasks: [
          { label: 'a', task: '"Le marquis entra dans la salle et salua l\'assemblée d\'un geste gracieux. Il prit place aupres de la comtesse." - Hvilket register? Begrunn.', solution: 'Soutenu - Passé simple (entra, salua, prit), formelt vokabular (assemblée, aupres de), litterær setningsstruktur.' },
        ...
        solution: 'a) Soutenu (passé simple, formelt vokabular), b-c) Se løsninger over.',
        hints: ['Passé simple = soutenu', 'Courant bruker passé composé', 'Familier bruker slang'],
      },
    },
    {
...
2. Unngå forkortelser og slang
3. Vis at du behersker **le subjonctif** og komplekse setningsstrukturer
4. I tekstanalyse: kommenter alltid registeret forfatteren bruker - det sier noe om sjanger og målgruppe`,
    },
  ],
  exercises: [],
};
...
export const CHAPTER_FRANSK_3_4_3: TextbookChapter = {
  ...
  description: 'Lær om klassisk retorikk med logos, ethos og pathos, og analyser berømte franske taler.',
  estimatedMinutes: 50,
  competenceGoals: [
    'forstå og anvende begrepene logos, ethos og pathos',
...
Retorikk er kunsten å overbevise gjennom tale og tekst. Den klassiske retorikken stammer fra antikkens Hellas (Aristoteles), men har hatt enorm innflytelse på fransk kultur og utdanning. Frankrike har en særlig sterk retorisk tradisjon, og retorikk var lenge et sentralt fag i fransk skole.
...
I fransk sammenheng er retorikk viktig for å forstå:
- Politiske taler (de Gaulle, Mitterrand, Macron)
- Litterære tekster og essay
...
- Eksempel: *"En tant que président..."* (Som président...)

**Pathos (l'émotion)** - Appell til følelser:
- Vekke sympati, frykt, håp, sinne
- Bruk av levende bilder og personlige historier
- Eksempel: *"Pensez aux enfants qui souffrent..."* (Tenk på barna som lider...)`,
    },
    {
...
|-------------|-------------|-------------|----------|
| Retorisk spørsmål | La question rhétorique | Spørsmål som ikke krever svar | *"N'avons-nous pas le devoir d'agir?"* |
| Gjentakelse | La répétition | Gjenta for å forsterke | *"Liberté, liberté chérie!"* |
...
| Innrømmelse | La concession | Innrømme motpartens poeng | *"Certes... mais..."* |
...
3. **L'élocution** (elocutio) - Formulere språklig
4. **La mémoire** (memoria) - Huske talen
5. **L'action** (actio) - Fremføre talen`,
    },
    {
      id: 'fransk-3-4-3-text-2',
      type: 'text',
      content: `## Analyse de discours célèbres - Analyse av berømte taler

### Charles de Gaulle: L'appel du 18 juin 1940

De Gaulles radiotale fra London 18. juni 1940 er en av de mest berømte franske talene:

*"La France a perdu une bataille! Mais la France n'a pas perdu la guerre!"*
(Frankrike har tapt et slag! Men Frankrike har ikke tapt krigen!)

**Retorisk analyse:**
- **Antithese**: "perdu une bataille" vs. "pas perdu la guerre" - motsetning mellom tap og håp
- **Anaphore**: Gjentakelsen av "La France" forsterker nasjonalfølelsen
- **Pathos**: Appell til nasjonal stolthet og motstandsvilje
- **Ethos**: de Gaulle taler som militær leder med autoritet

### Victor Hugo: Discours sur la misère (1849)

*"Vous n'avez rien fait tant que le peuple souffre!"*
(Dere har ikke gjort noe så lenge folket lider!)

**Retorisk analyse:**
- **Pathos**: Sterkt følelsesladet appell om fattigdom
- **Hyperbole**: "Rien fait" (ingenting gjort) - overdrivelse for å forsterke
- **Apostrofe**: Direkte tiltale til politikerne`,
    },
    {
      ...
      problem: `Analyser følgende utdrag og identifiser logos, ethos og pathos:
...
**Ethos:** Hollande bygger sin troverdighet ved å gjentatte ganger nevne "Moi, président de la République" - han viser hvilken rolle han vil fylle og hvilke verdier han står for.

**Pathos:** Han appellerer til velgernes ønsker om en rettferdig og verdig président. Løftene om eksemplarisk oppførsel vekker følelsen av tillit.

**Logos:** Konkrete løfter om hva han vil og ikke vil gjøre gir logiske argumenter for hvorfor velgerne bør stemme på ham.
...
- **Antithese**: Kontrast mellom hva han ikke vil gjøre og hva han vil gjøre`,
    },
    {
      ...
      exercise: {
        ...
        subTasks: [
          { label: 'a', task: '"Selon les statistiques de l\'INSEE, le chômage a diminué de 3%." (Ifølge INSEEs statistikk har arbeidsledigheten sunket med 3%.)', solution: 'Logos - Bruk av statistikk og fakta fra en offisiell kilde (INSEE) for å underbygge påstand med fornuft.' },
          { label: 'b', task: '"En tant que médecin avec trente ans d\'expérience, je peux affirmer que..." (Som lege med tretti års erfaring kan jeg bekrefte at...)', solution: 'Ethos - Taleren viser til sin profesjonelle erfaring og ekspertise for å bygge troverdighet.' },
          { label: 'c', task: '"Imaginez un enfant seul, sans nourriture, dans le froid de l\'hiver." (Forestill dere et barn alene, uten mat, i vinterkulden.)', solution: 'Pathos - Appell til medfølelse gjennom et levende, følelsesladet bilde av et lidende barn.' },
        ],
        solution: 'a) Logos, b) Ethos, c) Pathos',
        hints: ['Logos = fakta og logikk', 'Ethos = troverdighet og autoritet', 'Pathos = følelser'],
      },
    },
    {
      ...
      exercise: {
        ...
        subTasks: [
          ...
          { label: 'b', task: 'Hvilken retorisk appell (logos/ethos/pathos) dominerer?', solution: 'Pathos dominerer - sterke følelsesladete ord (outrage, brise, martyrise, libere) som appellerer til nasjonalfølelse og triumf etter frigjøringen.' },
          { label: 'c', task: 'Hvorfor er den treledde oppbyggingen effektiv her?', solution: 'De tre negative ordene (outrage, brise, martyrise) følges av det positive "libere". Tre-tallet skaper rytme og forventning, og vendepunktet til "libere" blir desto sterkere.' },
        ],
    ...
    },
    {
      ...
      exercise: {
        ...
        type: 'classic',
        difficulty: 'vanskelig',
        task: 'Skriv en kort retorisk tekst (3-5 setninger) på fransk om et selvvalgt tema. Bruk:',
        subTasks: [
          { label: 'a', task: 'Minst ett retorisk spørsmål', solution: 'For eksempel: "Ne devons-nous pas protéger notre planète?" (Bør vi ikke beskytte planeten vår?)' },
          { label: 'b', task: 'Minst en anaphore', solution: 'For eksempel: "Nous devons agir. Nous devons changer. Nous devons espérer." (Vi må handle. Vi må endre oss. Vi må håpe.)' },
          { label: 'c', task: 'Identifiser selv hvilke appeller (logos/ethos/pathos) du bruker', solution: 'Åpent svar. Eksempel: Pathos (følelser om planeten), logos (fakta om klimaendringer).' },
        ],
        solution: 'Åpent svar - vurder om eleven bruker virkemidlene korrekt.',
        hints: ['Retorisk spørsmål slutter med "?"', 'Anaphore = samme ord i starten av flere setninger', 'Kombiner gjerne alle tre appellformene'],
      },
    },
    {
      id: 'fransk-3-4-3-tip-1',
      type: 'tip',
      content: `**Tips for retorisk analyse på eksamen:**

1. Start alltid med å identifisere **konteksten**: Hvem taler? Til hvem? Når? Hvorfor?
...
5. Bruk fagtermer på fransk: *procédés rhétoriques, figure de style, argumentation*`,
    },
  ],
  exercises: [],
};
...
export const CHAPTER_FRANSK_3_4_4: TextbookChapter = {
  ...
  description: 'Lær å gjennomføre en stilistisk analyse av franske tekster, med vokabular for litterær analyse og mønsterbesvarelse.',
  estimatedMinutes: 50,
  competenceGoals: [
    'gjennomføre en strukturert stilistisk analyse av en fransk tekst',
    'bruke fagvokabular for litterær analyse på fransk',
  ],
  content: [
    {
...
Stilistisk analyse (l'analyse stylistique) er en metode for å undersøke hvordan en forfatter bruker språklige virkemidler for å skape mening og virkning. Det handler ikke bare om *hva* teksten sier, men *hvordan* den sier det.

En god stilistisk analyse følger vanligvis denne strukturen:
...
|-------------|-------|------|
| le champ lexical | det leksikalske feltet | Ord som tilhører samme temaområde |
...
| le registre | registeret | Formelt, nøytralt, uformelt |
...
- Åpne for et bredere perspektiv (*l'ouverture*)
...
- Koble stil til **innhold og budskap**`,
    },
    {
      ...
      type: 'example',
      title: 'Eksempel: Mønsterbesvarelse - Stilistisk analyse',
...
(I dag døde mamma. Eller kanskje i går, jeg vet ikke. Jeg fikk et telegram fra institusjonen: "Mor avdod. Begravelse i morgen. Med vennlig hilsen." Det betyr ingenting.)`,
      solution: `**Mønsterbesvarelse:**

**Presentasjon:** Utdraget er aapningen av Albert Camus' roman *L'Etranger* (Den fremmede, 1942), et sentralt verk innen eksistensialismen. Hovedpersonen Meursault forteller om morens død.

**Analyse av stilistiske trekk:**

1. **Korte, enkle setninger** - "Aujourd'hui, maman est morte." Setningene er påfallende korte og nøkterne. Fraværet av komplekse strukturer gjenspeiler Meursaults følelsesmessige avstand.
...
3. **Likegyldighet i tonen** - "Ou peut-être hier, je ne sais pas" viser en manglende reaksjon på morens død. Usikkerheten om tidspunktet er sjokkerende.

4. **Ironien i telegrammet** - Den formelle avslutningen "Sentiments distingués" (Med vennlig hilsen) i en dødsmelding understreker det absurde.

5. **Konklusjon** - "Cela ne veut rien dire" oppsummerer Meursaults holdning og introduserer romanens eksistensialistiske tema: livets meningsløshet.

**Stilens funksjon:** Den nøkterne, nesten dokumentariske stilen gjenspeiler Meursaults karakter som en "fremmed" i sitt eget liv. Camus bruker minimalistisk prosa for å uttrykke eksistensiell fremmedgjøring.`,
    },
    {
      ...
      exercise: {
        ...
        type: 'classic',
        difficulty: 'medium',
        task: 'Bruk riktig fagterm på fransk:',
        subTasks: [
          ...
          { label: 'b', task: 'Hva kaller vi en gruppe ord som tilhører samme temaområde i en tekst?', solution: 'Le champ lexical (det leksikalske feltet). For eksempel kan en tekst ha et champ lexical knyttet til doden: "mourir, décéder, enterrement, deuil".' },
    ...
    },
    {
      ...
      exercise: {
        ...
        subTasks: [
          { label: 'a', task: '"Les misérables, ce sont les affamés, les déshérités, les abandonnés, les méprisés." - Identifiser stilfigurene.', solution: 'Gradation (stigende oppramsing), anaphore (gjentakelse av "les"), champ lexical knyttet til lidelse og utstøtelse.' },
          { label: 'b', task: 'Hva er tonaliteten (tonen) i utdraget?', solution: 'Tonalité pathétique (patospreget/medfølende) - Hugo vekker sympati for de undertrykte gjennom den følelsesladete oppramsing.' },
          { label: 'c', task: 'Hvilken retorisk appell bruker Hugo her?', solution: 'Pathos - Han appellerer til leserens medfølelse og rettferdighetsfølelse gjennom en bevissthetsgjørende liste over lidende mennesker.' },
        ],
        solution: 'a) Gradation, anaphore, champ lexical. b) Tonalité pathétique. c) Pathos.',
        hints: ['Se etter oppramsing', 'Vurder den emosjonelle virkningen', 'Tenk på formål: Hugo ville kjempe mot fattigdom'],
      },
    },
    {
      ...
      exercise: {
        ...
        type: 'classic',
        difficulty: 'vanskelig',
        task: 'Skriv en kort stilistisk analyse (5-8 setninger på fransk) av følgende tekst:',
        subTasks: [
...
**4.2 Le registre soutenu** - Språkregistrene:
- Soutenu (formelt), courant (standard), familier (uformelt)
- Le passé simple som markør for litterært språk

**4.3 La rhétorique classique** - Klassisk retorikk:
- Logos, ethos, pathos
- Retoriske virkemidler og den retoriske prosessen
- Analyse av berømte franske taler

**4.4 L'analyse stylistique** - Stilistisk analyse:
- Vokabular for litterær analyse
- Le commentaire compose som eksamensform
- Mønsterbesvarelse for stilistisk analyse`,
    },
    {
...
1. Les teksten **minst to ganger** for du begynner å analysere
2. **Marker** stilfigurer, interessante ordvalg og setningsstrukturer
3. Still deg alltid spørsmålene: **Hva gjør forfatteren?** og **Hvorfor/med hvilken effekt?**
4. Bruk **fagtermer** på fransk - det viser kompetanse
5. Husk at stil og innhold henger sammen - stilen er aldri tilfeldig`,
    },
  ],
  exercises: [],
};
...
export const CHAPTER_FRANSK_3_5_1: TextbookChapter = {
  ...
  estimatedMinutes: 50,
  competenceGoals: [
    'gjøre rede for sentrale verk og forfattere fra fransk middelalder og renessanse',
...
**Register:** Soutenu/poetisk - inversjon, litterært vokabular (vesprée, pourprée)`,
    },
    {
      ...
      exercise: {
        ...
        subTasks: [
          { label: 'a', task: 'La Chanson de Roland', solution: 'Middelalder (ca. 1100) - Chanson de geste (heltedikt). Forteller om Rolands heroiske død.' },
          ...
          { label: 'c', task: 'Ronsards "Mignonne, allons voir si la rose"', solution: 'Renessanse (1500-tallet) - Lyrikk/Pléiade. Carpe diem-dikt om forgjengelig skjønnhet.' },
    ...
    },
    {
      ...
      exercise: {
        ...
        type: 'classic',
        difficulty: 'vanskelig',
        task: 'Forklar betydningen av disse berømte sitatene:',
        subTasks: [
          ...
          { label: 'b', task: '"Que sais-je?" (Montaigne)', solution: 'Hva vet jeg? Montaignes motto uttrykker hans skeptisisme - en erkjennelse av at menneskelig kunnskap er begrenset og at vi bør være ydmyke.' },
          { label: 'c', task: '"Frères humains, qui après nous vivez..." (Villon)', solution: 'Menneskebrødre, som lever etter oss... Villon henvender seg til fremtidige generasjoner fra galgen og ber om medfølelse - en universell appell om menneskelig solidaritet.' },
        ],
        solution: 'a) Advarsel mot kunnskap uten moral, b) Filosofisk ydmykhet, c) Appell om medmenneskelighet.',
        hints: ['Tenk på den historiske konteksten', 'Hva sier sitatet om forfatteren?', 'Koble til humanisme/middelalder-verdier'],
      },
    },
    {
      ...
      exercise: {
        ...
        subTasks: [
          ...
          { label: 'b', task: 'Hvordan endret litteraturen seg fra chanson de geste til Montaignes essay?', solution: 'Fra kollektive heltefortellinger (nasjonal/religiøs identitet) til personlig refleksjon (individet og selverkjennelse). Fra muntlig tradisjon til skriftlig, individuell uttrykksform.' },
          { label: 'c', task: 'Hvorfor var Du Bellays Défense et illustration de la langue française viktig?', solution: 'Den argumenterte for at fransk var like verdig som latin for litteratur og vitenskap. Dette var avgjørende for utviklingen av fransk som litterært språk og kulturspråk.' },
        ],
        solution: 'a) Teosentrisk vs. antroposentrisk, b) Kollektiv helteepikk vs. personlig refleksjon, c) Opphøyelse av fransk språk.',
        hints: ['Teosentrisk = Gud i sentrum', 'Humanisme = mennesket i sentrum', 'Pléiade ville gjøre fransk til et litterært språk'],
      },
    },
    {
      id: 'fransk-3-5-1-tip-1',
      type: 'tip',
      content: `**Tips for å huske fransk litteraturhistorie:**
...
3. Husk nøkkelpersonene: **Rabelais** (humor + humanisme), **Montaigne** (essay + skeptisisme), **Ronsard** (lyrikk + carpe diem)
...
export const CHAPTER_FRANSK_3_5_2: TextbookChapter = {
  ...
  estimatedMinutes: 50,
  competenceGoals: [
    'gjøre rede for klassisismens kjennetegn og sentrale forfattere',
    'analysere utdrag fra klassisistiske tekster med fokus på les trois unités og sjangerkrav',
  ],
  content: [
    {
...
1600-tallet er den franske litteraturens gylne tidsalder - **le Grand Siècle** (det store århundret). Under Ludvig XIV (Solkongen) blomstret kunst og litteratur, og Frankrike ble Europas kulturelle sentrum.

Klassisismen kjennetegnes av:
- **Orden og harmoni** - klare regler for kunst og litteratur
- **Fornuft over følelser** - rasjonalitet og måtefullhet
- **Antikke forbilder** - inspirasjon fra gresk og romersk kultur
- **Moralsk formål** - litteratur skal både underholde og belære (*plaire et instruire*)
...
Klassisistisk teater må følge tre strenge regler:

1. **L'unité de temps** (tidsenhet) - Handlingen skal utspille seg i løpet av 24 timer
2. **L'unité de lieu** (stedsenhet) - Handlingen skal foregå på ett sted
3. **L'unité d'action** (handlingsenhet) - Det skal bare være en hovedhandling, ingen sidehistorier

**La bienséance** (sommelighet) - Det som er usommelig (vold, død) skal ikke vises på scenen, men fortelles av en budbringer.

**La vraisemblance** (sannsynlighet) - Handlingen skal være troverdig og sannsynlig.

Disse reglene ble formulert av Académie française og gjaldt særlig for tragedien.`,
    },
    {
...
Jean-Baptiste Poquelin, kjent som **Molière**, er den største franske komediforfatteren. Han var også skuespiller og regissør.

### Viktige verk:

| Verk | År | Tema |
|------|-----|------|
| *Le Misanthrope* | 1666 | Hykleri og oppriktighet i samfunnet |
...
**Molières metode:**
- **Castigat ridendo mores** (Han korrigerer sedene ved å le av dem)
- Bruker humor for å kritisere samfunnets laster
- Typifiserte karakterer: den gjerrige, hykleren, den innbilte syke

**Berømt sitat fra Tartuffe:**
...
Jean Racine er den største franske tragediforfatteren. Hans tragedier følger de klassisistiske reglene strengt.

### Viktige verk:

| Verk | År | Tema |
|------|-----|------|
| *Andromaque* | 1667 | Kjærlighet og plikt etter Trojas fall |
| *Britannicus* | 1669 | Neros tyranni |
| *Phèdre* | 1677 | Forbudt kjærlighet og skyld |

**Phèdre** - Racines mesterverk:
Phèdre er forelsket i sin stesønn Hippolyte. Hennes forbudte kjærlighet fører til tragedie.
...
**Berømt aapningslinje:**
*"La Cigale, ayant chanté tout l'été, / Se trouva fort dépourvue / Quand la bise fut venue."*
(Gresshoppen, som hadde sunget hele sommeren, / fant seg helt blottstilt / da nordavinden kom.)

**La Fontaines metode:** Bruke dyr for å kommentere menneskelig oppførsel - en indirekte samfunnskritikk.`,
    },
    {
...
(Tyv! Tyv! Morder! Drapsmann! Rettferdighet, rettferdige himmel! Jeg er fortapt, jeg er myrdet, de har kuttet halsen på meg, de har stjålet pengene mine!)`,
      solution: `**Løsning:**
...
**Komisk effekt:**
- Overdrivelsen skaper humor - Harpagon reagerer på tapet av penger som om det var hans eget liv
- Det avslører hans karakter: pengene er viktigere enn livet
- **Castigat ridendo mores** - Molière får publikum til å le av gjerrigheten
...
**Register:** Blanding av dramatisk (assassiné, coupé la gorge) og hverdagslig (mon argent) skaper komisk kontrast.`,
    },
    {
      ...
      exercise: {
        ...
        subTasks: [
          { label: 'a', task: 'Phèdre', solution: 'Racine - Tragedie. Forteller om Phèdres forbudte kjærlighet til sin stesønn Hippolyte.' },
          { label: 'b', task: 'Le Corbeau et le Renard', solution: 'La Fontaine - Fabel. Reven lurer korporet til å slippe osten ved å smigre den.' },
          { label: 'c', task: 'Tartuffe', solution: 'Molière - Komedie. Satiriserer religiost hykleri gjennom karakteren Tartuffe.' },
          { label: 'd', task: 'Andromaque', solution: 'Racine - Tragedie. Handler om kjærlighet og plikt etter Trojakrigen.' },
        ],
    ...
    },
    {
      ...
      exercise: {
        ...
        subTasks: [
          { label: 'a', task: 'Hva er l\'unité de temps?', solution: 'Handlingen må utspille seg i løpet av 24 timer. Dette gir intensitet og fokus til dramaet.' },
          { label: 'b', task: 'Hva er l\'unité de lieu?', solution: 'Handlingen må foregå på ett enkelt sted (f.eks. ett rom, en plass). Dette hindrer urealistiske sceneskifter.' },
          { label: 'c', task: 'Hva er l\'unité d\'action?', solution: 'Det skal være en hovedhandling uten sidehistorier. Alt må være knyttet til det sentrale konflikten.' },
          { label: 'd', task: 'Hvorfor er la bienséance viktig?', solution: 'Bienséance (sommelighet) krever at vold og død ikke vises på scenen - det må fortelles. Dette bevarer teaterets verdighet og estetikk.' },
        ],
        solution: 'a) Tid: 24 timer, b) Sted: ett sted, c) Handling: en hovedhandling, d) Bienséance: sommelighet på scenen.',
    ...
    },
    {
      ...
      exercise: {
        ...
        subTasks: [
          { label: 'a', task: 'La Cigale et la Fourmi (Gresshoppen og mauren): Gresshoppen synger hele sommeren og har ingenting når vinteren kommer. Mauren nekter å hjelpe.', solution: 'Moral: Man må planlegge for fremtiden og arbeide hardt. Den som nyter livet uten ansvar, vil lide konsekvensene. Men La Fontaine er også tvetydig - er mauren for hard?' },
          { label: 'b', task: 'Le Corbeau et le Renard (Korporet og reven): Reven smigrer korporet for å få den til å åpne nebbet og slippe osten.', solution: 'Moral: "Tout flatteur vit aux dépens de celui qui l\'écoute." (Enhver smigrer lever på bekostning av den som lytter.) Man bør være skeptisk til smiger.' },
          { label: 'c', task: 'Hvorfor bruker La Fontaine dyr i stedet for mennesker?', solution: 'Dyr gjør det mulig å kritisere menneskelig oppførsel indirekte, uten å fornærme mektige personer. Det er en form for allegori som gjør budskapet tilgjengelig for alle aldre.' },
        ],
    ...
    },
    {
      ...
      type: 'tip',
      content: `**Tips for å huske klassisismen:**
...
4. Motto: **"Plaire et instruire"** (behage og belære)
5. **Castigat ridendo mores** = Molières metode: le av laster for å forbedre samfunnet`,
    },
  ],
  exercises: [],
};
...
export const CHAPTER_FRANSK_3_5_3: TextbookChapter = {
  ...
  estimatedMinutes: 50,
  competenceGoals: [
    'gjøre rede for opplysningstidens og romantikkens idealer og sentrale forfattere',
...
To av de mest innflytelsesrike epokene i fransk litteratur er **les Lumières** (Opplysningstiden, 1700-tallet) og **le romantisme** (Romantikken, første halvdel av 1800-tallet). De representerer svært ulike idealer:

| | Les Lumières (1700-tallet) | Le romantisme (1800-tallet) |
|--|---------------------------|---------------------------|
| **Sentral verdi** | Fornuft (*la raison*) | Følelser (*le sentiment*) |
| **Mål** | Opplyse og frigjore | Uttrykke individet |
| **Stil** | Klar, logisk, satirisk | Lyrisk, patospreget, personlig |
| **Syn på naturen** | Noe som skal forstås | Noe som skal føles |
| **Nøkkelpersoner** | Voltaire, Rousseau, Diderot | Hugo, Lamartine, Musset |

Begge epokene har formet fransk kultur og tenkning på avgjørende måter.`,
    },
    {
      id: 'fransk-3-5-3-def-1',
      type: 'definition',
      content: `**Les Lumières (Opplysningstiden):**
En intellektuell bevegelse som fremmet fornuft, vitenskap og fremskritt mot overtro, tyranni og religiøs intoleranse. Filosofene (les philosophes) ville "opplyse" folket.

**L'Encyclopédie** (1751-1772):
Det store oppslagsverket redigert av **Diderot** og **d'Alembert**, med bidrag fra Voltaire, Rousseau og andre. Målte å samle all menneskelig kunnskap og fremme kritisk tenkning.

**Le romantisme (Romantikken):**
En litterær og kunstnerisk bevegelse som reagerte mot opplysningstidens rasjonalisme. Romantikerne verdsatte følelser, fantasi, natur og det individuelle. I Frankrike ble romantikken lansert med Victor Hugos forord til *Cromwell* (1827) og teaterstykket *Hernani* (1830).`,
    },
    {
...
Voltaire er den mest berømte av opplysningsfilosofene. Han kjempet for ytringsfrihet, religiøs toleranse og mot urettferdighet.

**Viktige verk:**
- *Candide* (1759) - Satirisk roman som gjør narr av overdrevent optimisme
...
Rousseau var filosof, forfatter og musiker. Han skilte seg fra de andre opplysningsfilosofene ved å vektlegge følelser og natur fremfor ren fornuft.

**Viktige verk:**
- *Du contrat social* (1762) - Om samfunnspakten og folkesuvereniteten
- *Emile, ou De l'éducation* (1762) - Om naturlig oppdragelse
- *Les Confessions* (1782) - Selvbiografi, en av de første i sjangeren
...
Diderot var redaktør for *L'Encyclopédie* og var forfatter, filosof og kunstkritiker.

**Viktige verk:**
- *L'Encyclopédie* (1751-1772) - Hovedredaktør
...
Hugo er den største franske romantikeren og en av de mest berømte franske forfatterne overhodet. Han var dikter, romanforfatter, dramatiker og politisk aktivist.

**Viktige verk:**
- *Les Misérables* (1862) - Roman om fattigdom, rettferdighet og frelse
- *Notre-Dame de Paris* (1831) - Roman om ringeren Quasimodo
- *Hernani* (1830) - Teaterstykke som utløste "la bataille d'Hernani"
- *Les Contemplations* (1856) - Diktsamling om tap og sorg

**Les Misérables som kulturell referanse:**
Romanen handler om Jean Valjean, en tidligere straffange som søker frelse. Den er blitt en av de mest kjente musikalene i verden og er en sentral kulturell referanse for sosial rettferdighet i Frankrike.
...
Lamartine var den første store romantiske dikteren i Frankrike.

*"Le Lac"* (Innsjøen, 1820) - Et av de mest berømte franske diktene om tapt kjærlighet og tidens gang:
*"Ô temps! suspends ton vol, et vous, heures propices! / Suspendez votre cours."*
(Å tid! Stopp din flukt, og dere, gunstige timer! / Stans deres løp.)

### Alfred de Musset (1810-1857)

Musset er kjent for sine kjærlighetsdikt og teaterstykker, preget av lidenskapelig følelser:
- *Les Nuits* (Nettene) - Diktsamling om kjærlighetssmerte
- *On ne badine pas avec l'amour* (Man spoker ikke med kjærligheten) - Teaterstykke`,
    },
    {
      id: 'fransk-3-5-3-example-1',
      type: 'example',
      title: 'Eksempel: Sammenligning opplysning vs. romantikk',
      problem: `Sammenlign disse to utdragene og identifiser hvilken epoke de tilhører:

A) *"Il faut cultiver notre jardin."* (Voltaire, Candide)
(Vi må dyrke vår hage.)

B) *"Je suis une force qui va! / Agent aveugle et sourd de mystères funèbres!"* (Victor Hugo, Hernani)
(Jeg er en kraft som går! / Blind og dov agent for dystre mysterier!)`,
      solution: `**Løsning:**

**A) Les Lumières (Opplysningstiden) - Voltaire:**
- **Stil**: Kort, klar, ironisk setning
- **Budskap**: Praktisk filosofi - i stedet for å spekulere om verden, bør vi arbeide konkret
- **Tone**: Nøktern, rasjonell
- **Voltaires satire**: Etter Candides mange eventyr er konklusjonen enkel og jordnær

**B) Le romantisme (Romantikken) - Hugo:**
- **Stil**: Dramatisk, eksklamasjon, sterke metafører
- **Budskap**: Individet som kraft, skjebne og mystikk
- **Tone**: Patospreget, lidenskapelig
- **Romantiske trekk**: Følelser, det mystiske, heltens indre kamp

**Sammenligning:**
- Voltaire bruker **fornuft og ironi**, Hugo bruker **følelser og patos**
- Voltaire er **jordnær**, Hugo er **opphøyd**
- Voltaires stil er **minimalistisk**, Hugos er **overdådig**`,
    },
    {
      ...
      exercise: {
        ...
        subTasks: [
          { label: 'a', task: 'Rousseau: Du contrat social', solution: 'Les Lumières (1762). Politisk-filosofisk verk om samfunnspakten. Men Rousseau peker også mot romantikken med sin vektlegging av følelser.' },
          ...
          { label: 'c', task: 'Voltaire: Candide', solution: 'Les Lumières (1759). Satirisk roman som bruker humor og ironi for å kritisere optimistisk filosofi og samfunnets onder.' },
          { label: 'd', task: 'Lamartine: Le Lac', solution: 'Le romantisme (1820). Lyrisk dikt om tapt kjærlighet og tidens forgjengelighet - typisk romantisk tematikk.' },
        ],
        solution: 'a) Lumières, b) Romantisme, c) Lumières, d) Romantisme.',
        hints: ['Lumières = 1700-tallet, fornuft', 'Romantisme = 1800-tallet, følelser', 'Rousseau er en overgangsfigur'],
      },
    },
    {
      ...
      exercise: {
        ...
        subTasks: [
          { label: 'a', task: '"L\'homme est né libre, et partout il est dans les fers." (Rousseau)', solution: 'Mennesket er naturlig fritt, men samfunnet har fanget det i lenker (urettferdige lover, ulikhet, undertrykkelse). Rousseau argumenterer for en ny samfunnspakt basert på folkeviljen.' },
          { label: 'b', task: '"Ecrasez l\'infâme!" (Voltaire)', solution: '"Knus det infame!" - Voltaires kamprop mot religiøs fanatisme og overtro. "L\'infâme" refererer til religiøs intoleranse og misbruk av makt.' },
          { label: 'c', task: '"Ceux qui vivent, ce sont ceux qui luttent." (Hugo)', solution: '"De som lever, er de som kjemper." - Hugo uttrykker den romantiske idealismen: å virkelig leve betyr å engasjere seg, kjempe for rettferdighet og ha overbevisning.' },
        ],
        solution: 'a) Kritikk av samfunnets undertrykkelse, b) Kamp mot religiøs fanatisme, c) Livet som kamp og engasjement.',
        hints: ['Tenk på den historiske konteksten', 'Rousseau levde for Den franske revolusjon', 'Hugo var politisk engasjert'],
      },
    },
    {
      ...
      exercise: {
        ...
        subTasks: [
          { label: 'a', task: 'Hva handler Les Misérables om? Beskriv kort hovedpersonene Jean Valjean og Javert.', solution: 'Les Misérables handler om fattigdom og sosial urettferdighet i Frankrike på 1800-tallet. Jean Valjean er en tidligere straffange som søker frelse gjennom godhet. Javert er en politiinspektør som jakter ham og representerer kompromissløs lov og orden.' },
          { label: 'b', task: 'Hvilke romantiske trekk finner vi i romanen?', solution: 'Sterke følelser, moralsk kamp mellom godt og ondt, idealisering av det gode i mennesket, sosial pathos for de fattige, episk format, den enkelte heltens kamp mot samfunnet.' },
          { label: 'c', task: 'Hvorfor er Les Misérables fortsatt relevant i dag?', solution: 'Temaene - fattigdom, sosial urettferdighet, rettssystemets strenghet, muligheten for personlig forandring - er universelle. Musikalversjonen har gjort verket kjent globalt. Hugo peker på at samfunnet må vise medmenneskelighet.' },
        ],
        solution: 'a) Roman om fattigdom og frelse (Valjean vs. Javert), b) Romantiske trekk: følelser, moralsk kamp, idealisme, c) Universelle temaer.',
        hints: ['Valjean = frelse, Javert = lov', 'Romantikken = følelser og engasjement', 'Universelle temaer overskrider tid'],
      },
    },
    {
      id: 'fransk-3-5-3-tip-1',
      type: 'tip',
      content: `**Tips for å huske opplysningstid og romantikk:**

1. **Opplysningstiden**: Fornuft, kritikk, frihet - *la raison*. Tenk: Voltaire (satire), Rousseau (samfunnspakt), Diderot (leksikon)
2. **Romantikken**: Følelser, natur, individ - *le sentiment*. Tenk: Hugo (engasjement), Lamartine (lyrikk), Musset (lidelse)
3. Rousseau er en **bro** mellom epokene: opplysningsfilosof med romantisk åre
4. **Les Misérables** = den ultimate franske kulturreferansen på sosial rettferdighet`,
    },
  ],
  exercises: [],
};
...
export const CHAPTER_FRANSK_3_5_4: TextbookChapter = {
  ...
  estimatedMinutes: 50,
  competenceGoals: [
    'gjøre rede for kjennetegnene ved realisme og naturalisme i fransk litteratur',
...
Etter romantikkens følelsesladete idealisme kom en reaksjon: **le réalisme** (realismen, ca. 1850-1880) og **le naturalisme** (naturalismen, ca. 1870-1900). Disse bevegelsene ville skildre virkeligheten slik den faktisk var.

| | Le réalisme | Le naturalisme |
|--|-------------|----------------|
| **Periode** | ca. 1850-1880 | ca. 1870-1900 |
| **Mål** | Skildre virkeligheten objektivt | Vitenskapelig studie av mennesket |
| **Metode** | Observasjon og presisjon | Eksperimentell roman (jf. vitenskap) |
| **Temaer** | Borgerskap, hverdagsliv, penger | Arv, miljø, sosial determinisme |
| **Stil** | Nøktern, presis, detaljert | Rå, detaljert, ofte sjokkerende |
| **Nøkkelpersoner** | Flaubert, Stendhal, Balzac | Zola, Maupassant |
...
En litterær retning som søker å gjengi virkeligheten objektivt og nøyaktig, uten idealisering eller overdrivelse. Forfatteren er som en "speilende observator" av samfunnet.

**Le naturalisme (naturalismen):**
En videreføring av realismen, inspirert av naturvitenskapen. Naturalisten ser på romanen som et **eksperiment**: Plasser en karakter i et bestemt miljø med bestemte arvelige egenskaper, og observer hva som skjer. Emile Zola formulerte dette i *Le Roman expérimental* (1880).

**Le déterminisme (determinismen):**
Troen på at mennesket er styrt av arv (*l'hérédité*) og miljø (*le milieu*). Mennesket har ikke full fri vilje, men er et produkt av sine biologiske og sosiale betingelser.

**L'objectivité (objektiviteten):**
Forfatteren skal ikke uttrykke egne meninger eller følelser. Teksten skal skildre virkeligheten "som den er", uten moralsk kommentar.`,
    },
    {
...
Flaubert er kjent for sin ekstreme presisjon i språklig stil. Han søkte alltid *le mot juste* (det rette ordet).

### Madame Bovary (1857)

Flauberts mesterverk handler om Emma Bovary, en leges kone i provinsen som drømmer om romantikk og luksus. Hennes urealistiske forventninger fører til utroskap, gjeld og til slutt selvmord.
...
- **Objektivitet** - Forfatteren dømmer ikke eksplisitt

**Rettssak:** Flaubert ble stilt for retten for "usommelighet" i Madame Bovary (1857), men ble frikjent. Rettssaken gjorde boken berømt.

### Gustave Flaubert om skriving:
*"Le style, c'est l'homme."* (Stilen, det er mennesket.)
Han kunne bruke dager på å finne det perfekte ordet.`,
    },
    {
...
Zola er den mest berømte naturalisten. Han skrev en serie på 20 romaner kalt **Les Rougon-Macquart** (1871-1893), som følger to familier gjennom flere generasjoner og viser hvordan arv og miljø former skjebnene deres.
...
Romanen følger gruvearbeideren Etienne Lantier som organiserer streik mot umenneskelige arbeidsforhold. Den er en kraftfull skildring av arbeiderklassens lidelser.

### Zola og Dreyfus-saken

I 1898 skrev Zola det berømte åpne brevet **"J'accuse...!"** (Jeg anklager!) i avisen L'Aurore. Han forsvarte kaptein Alfred Dreyfus, en jødisk offiser urettferdig dømt for spionasje. Brevet er et av historiens mest berømte eksempler på intellektuelt engasjement.

## Guy de Maupassant (1850-1893) - Novellens mester

Maupassant er den største franske novelleforfatteren. Han var elev av Flaubert og påvirket av Zola.
...
- Ironisk blikk på menneskelig svakhet
...
(Hun hadde lest Paul og Virginie, og hun hadde drømt om bambushytten, tjeneren Domingo, hunden Fidèle, men fremfor alt det søte vennskapet med en god liten bror.)`,
      solution: `**Løsning:**
...
2. **Ironi** - Flaubert lister opp Emmas romantiske drømmer med presis detalj. Oppramsinng (maisonnette, nègre Domingo, chien Fidèle) skaper en nesten karikert effekt. Leseren forstår at Emmas drømmer er naive.

3. **Gradation** - "mais surtout" (men fremfor alt) forsterker og avslører det mest sentimentale ønsket.

4. **Champ lexical** - Ord som "rêvé", "douce", "bon petit" tilhører et leksikalsk felt av sentimental romantikk.
...
5. **Funksjon:** Utdraget viser at Emmas livssyn er formet av romantisk litteratur - noe som vil lede til hennes undergang. Flaubert kritiserer indirekte romantikkens innflytelse.`,
    },
    {
      ...
      exercise: {
        ...
        subTasks: [
          { label: 'a', task: 'Hva er hovedforskjellen mellom realisme og naturalisme?', solution: 'Realismen søker å skildre virkeligheten objektivt. Naturalismen går lenger og behandler romanen som et vitenskapelig eksperiment basert på determinisme (arv og miljø styrer mennesket).' },
          ...
          { label: 'c', task: 'Hva menes med "le mot juste" i forbindelse med Flaubert?', solution: '"Det rette ordet" - Flauberts besettelse med å finne det eneste perfekte ordet for hver situasjon. Han kunne bruke dager på en enkelt setning.' },
        ],
    ...
    },
    {
      ...
      exercise: {
        ...
        subTasks: [
          { label: 'a', task: 'Hvilket litterært trekk er "le style indirect libre"? Gi et eksempel.', solution: 'Fri indirekte tale - fortellerens stemme og karakterens tanker/ord blandes uten anførselstegn eller "sa hun". Eksempel: "Elle voulait mourir. Mais elle voulait mourir a Paris." - Er det fortelleren eller Emma som tenker?' },
          { label: 'b', task: 'Hvordan skiller Zolas "J\'accuse" seg fra hans romaner?', solution: '"J\'accuse" er et direkte, personlig innlegg i en politisk sak (Dreyfus-affæren), mens romanene søker objektivitet og vitenskapelig distanse. Her bryter Zola med naturalismens ideal om nøytralitet.' },
          { label: 'c', task: 'Sammenlign Hugos romantiske stil med Flauberts realistiske stil.', solution: 'Hugo: patospreget, følelsesladet, storslagne bilder, forfatteren tar stilling. Flaubert: nøktern, presis, ironisk, forfatteren er usynlig. Hugo idealiserer, Flaubert observerer.' },
        ],
        solution: 'a) Blanding av forteller og karakter, b) Personlig engasjement vs. objektivitet, c) Patos vs. presisjon.',
        hints: ['Style indirect libre = ingen anførselstegn', 'Tenk på forfatterens rolle i teksten', 'Romantikk vs. realisme = følelse vs. observasjon'],
      },
    },
    {
      ...
      exercise: {
        ...
        subTasks: [
          { label: 'a', task: 'Mathilde Loisel låner et diamantkjede til et ball, mister det, og bruker ti år på å betale tilbake gjelden. Til slutt får hun vite at smykket var falskt. - Hva er novellens moral?', solution: 'Moralen handler om forfengelighet og illusjoner: Mathildes ønske om å fremstå som rik ødelegger livet hennes. Ironien er at lidelsen var unødvendig - smykket var falskt. Det kommenterer borgerlig fasade og forfengelig jag.' },
          { label: 'b', task: 'Hvilke realistiske/naturalistiske trekk finner du?', solution: 'Realistiske: detaljert skildring av borgerlig liv, økonomiske forhold, sosialt press. Ironisk distanse fra fortelleren. Naturalistiske: miljøets innflytelse - Mathildes sosiale posisjon former hennes misnøye.' },
          { label: 'c', task: 'Hvordan bruker Maupassant den overraskende slutten (la chute)?', solution: 'Den sjokkerende avsløringen at smykket var falskt snur hele historien. Alt Mathildes lidelse var forgjeves. Teknikken "la chute" (fallet/overraskelsen) er Maupassants signatur og skaper en sterk ironisk effekt.' },
        ],
        solution: 'a) Forfengelighet og illusjoner, b) Sosial skildring, miljøets makt, c) Overraskende slutt som avslører ironi.',
        hints: ['Tenk på hva smykket symboliserer', 'Borgerlig fasade = viktig realistisk tema', '"La chute" = overraskende slutt'],
      },
    },
    {
...
| Epoke | Periode | Kjennetegn | Nøkkelpersoner |
|-------|---------|------------|-----------------|
...
| Romantikk | 1820-1850 | Følelser, natur, individ, patos | Hugo, Lamartine, Musset |
| Realisme | 1850-1880 | Objektiv skildring, presisjon, ironi | Flaubert, Stendhal, Balzac |
| Naturalisme | 1870-1900 | Vitenskapelig, determinisme, rå | Zola, Maupassant |

**Utviklingslinjen:** Fra muntlig helteepikk -> personlig humanisme -> ordnet klassisisme -> kritisk opplysning -> følelsesladet romantikk -> objektiv realisme -> vitenskapelig naturalisme`,
    },
    {
      id: 'fransk-3-5-4-tip-1',
      type: 'tip',
      content: `**Tips for å huske realisme og naturalisme:**
...
5. På eksamen: Vis at du kan **skille epokene** og **forklare utviklingen** fra romantikk til realisme`,
    },
  ],
  exercises: [],
};
...
export const CHAPTER_FRANSK_3_6_1: TextbookChapter = {
  ...
  estimatedMinutes: 50,
  competenceGoals: [
    'gjøre rede for hovedtrekk i fransk filmhistorie, spesielt La Nouvelle Vague',
    'bruke relevant filmvokabular på fransk og analysere filmklipp',
  ],
  content: [
    {
...
Frankrike er filmens fødeland. Brødrene Lumière viste verdens første filmvisning i Paris i 1895. Siden da har fransk film vært i forkant av filmkunsten.

**Viktige milepæler:**
- **1895** - Brødrene Lumière: første offentlige filmvisning
- **1902** - Georges Méliès: *Le Voyage dans la Lune* (Reisen til månen)
- **1930-tallet** - Poetisk realisme: Jean Renoir, Marcel Carné
- **1959-1968** - **La Nouvelle Vague** (Den nye bølgen) - den viktigste franske filmbevegelsen
...
Frankrike har det nest største filmmarkedet i Europa etter Storbritannia, og den franske staten støtter aktivt nasjonal filmproduksjon.`,
    },
    {
      id: 'fransk-3-6-1-def-1',
      type: 'definition',
      content: `**La Nouvelle Vague (Den nye bølgen, ca. 1959-1968):**
En filmbevegelse som bryt med tradisjonell filmfortelling. Regissørene var ofte unge filmkritikere fra tidsskriftet *Cahiers du cinéma* som ville lage personlige, innovative filmer.

**Kjennetegn:**
- Filming på location (ikke i studio)
- Naturlig lys og håndholdt kamera
...
Ideen om at regissøren er filmens "forfatter" (*auteur*), med en personlig visjon som preger alle filmene. Dette konseptet har påvirket hele verdens filmkritikk.`,
    },
    {
      id: 'fransk-3-6-1-text-1',
      type: 'text',
      content: `## Les grands réalisateurs - Store regissører

### La Nouvelle Vague

**François Truffaut (1932-1984)**
- *Les Quatre Cents Coups* (De 400 slag, 1959) - Halvautobiografisk film om en forsømt gutts oppvekst i Paris
- *Jules et Jim* (1962) - Kjærlighetstrekant
- Varm, humanistisk stil med fokus på karakterer

**Jean-Luc Godard (1930-2022)**
- *À bout de souffle* (Til siste åndedrag, 1960) - Banebrytende krimfilm med Jean-Paul Belmondo
- *Le Mépris* (Forakten, 1963) - Om film og kjærlighet
- Eksperimentell, politisk, utfordrende stil med jump cuts og brudd

**Agnès Varda (1928-2019)**
- *Cléo de 5 a 7* (1962) - En sangerinne venter på svar om kreftdiagnose
- Pioner for kvinnelige regissører
- Kalles "La Nouvelle Vagues bestemor"

### Andre viktige regissører
...
| le dénouement | løsningen/avslutningen |
| le suspense | spenningen |
| les effets spéciaux | spesialeffekter |

**Nyttige uttrykk for filmanalyse:**
- *Le réalisateur utilise un gros plan pour montrer...* (Regissøren bruker nærbilde for å vise...)
- *La bande-son crée une atmosphère de...* (Lydsporet skaper en stemning av...)
- *Le montage rapide renforce le sentiment de...* (Den raske klippingen forsterker følelsen av...)`,
    },
    {
...
2. Den ble filmet på gaten i Paris med håndholdt kamera
3. Skuespillerne improviserte mye av dialogen
4. Hovedpersonen Michel Poiccard (Belmondo) hermer etter Humphrey Bogart`,
      solution: `**Løsning - Filmanalyse:**

**1. Jump cuts:**
Godard bryter med tradisjonell klipping ved å kutte midt i scener. Dette skaper en *effet de rupture* (brudeffekt) som gjør seeren bevisst på at man ser en film. Det er et brudd med Hollywoods "usynlige klipping".

**2. Filming på location:**
I stedet for studio filmer Godard på ekte gater i Paris. Dette gir en *atmosphère documentaire* (dokumentarisk stemning) og virkelighetsnærhet. Lav budsjett ble en estetisk styrke.

**3. Improvisasjon:**
Dialogene føles naturlige og spontane, i motsetning til tradisjonelle manusskrevne replikker. Det gir filmen en *spontanéité* (spontanitet) som var revolusjonær.

**4. Intertekstualitet:**
Referansen til Bogart viser Godards kjærlighet til amerikansk film. Han *cite* (siterer) andre filmer - noe som ble typisk for Nouvelle Vague.

**Konklusjon:** Filmen bryter alle konvensjoner og definerer en ny måte å lage film på. Godard demonstrerer *la politique des auteurs* - regissøren som personlig kunstner.`,
    },
    {
      ...
      exercise: {
        ...
        subTasks: [
          { label: 'a', task: 'Regissøren bruker nærbilde for å vise karakterens følelser.', solution: 'Le réalisateur utilise un gros plan pour montrer les émotions du personnage.' },
          { label: 'b', task: 'Filmen vant Gullpalmen på Cannes-festivalen.', solution: 'Le film a remporté la Palme d\'Or au Festival de Cannes.' },
        ...
        hints: ['Nærbilde = un gros plan', 'Gullpalmen = la Palme d\'Or', 'Lydspor = la bande-son'],
      },
    },
    {
      ...
      exercise: {
        ...
        type: 'classic',
        difficulty: 'medium',
        task: 'Koble film til regissør og bevegelse:',
        subTasks: [
          { label: 'a', task: 'Les Quatre Cents Coups (1959)', solution: 'François Truffaut - La Nouvelle Vague. Halvautobiografisk film om en forsømt gutt i Paris.' },
    ...
    },
    {
      ...
      exercise: {
        ...
        subTasks: [
          { label: 'a', task: 'Hva menes med "la politique des auteurs"? Hvorfor er det viktig?', solution: 'Det er ideen om at filmregissøren er en kunstner/forfatter med en personlig visjon, ikke bare en tekniker. Filmen er regissørens personlige uttrykk. Dette har påvirket all moderne filmkritikk og begrepet "auteur".' },
          { label: 'b', task: 'Hvordan bryt La Nouvelle Vague med tradisjonell film?', solution: 'Location i stedet for studio, håndholdt kamera, jump cuts, improvisasjon, lave budsjetter, unge ukjente skuespillere, personlige temaer. De bryt med "cinéma de papa" (pappas kino).' },
          { label: 'c', task: 'Skriv en kort filmanbefaling (3-4 setninger) på fransk om en fransk film du kjenner eller vil se.', solution: 'Eksempel: "Je recommande le film Intouchables de Nakache et Toledano. C\'est une comédie dramatique sur l\'amitié entre un aristocrate tétraplégique et son aide-soignant. Le film est a la fois drôle et émouvant. Il a eu un énorme succès en France et a l\'international."' },
        ],
        solution: 'a) Regissøren som kunstner/forfatter, b) Brudd med konvensjoner, c) Åpent svar.',
        hints: ['Auteur = forfatter/kunstner', 'Cinéma de papa = tradisjonell, formelbasert film', 'Bruk filmvokabularet du har lært'],
      },
    },
    {
      id: 'fransk-3-6-1-tip-1',
      type: 'tip',
      content: `**Tips for filmanalyse på fransk:**

1. Bruk fagvokabular: *le réalisateur, un gros plan, la bande-son, le montage*
2. Analyser **tre nivåer**: bilde (det visuelle), lyd (musikk/dialog), fortelling (handling/karakter)
3. Koble filmen til sin **historiske kontekst** og **filmbevegelse**
4. Husk at fransk film verdsetter **auteur-tradisjonen** - regissøren er kunstneren`,
    },
  ],
  exercises: [],
};
...
export const CHAPTER_FRANSK_3_6_2: TextbookChapter = {
  ...
  estimatedMinutes: 50,
  competenceGoals: [
    'gjøre rede for hovedtrekk i fransk musikk fra chanson française til i dag',
...
Fransk musikk har en rik tradisjon som spenner fra middelalderens trubadurer til moderne rap og elektronisk musikk. Musikk er en utmerket måte å lære fransk på - man trener lytteforståelse, lærer nytt vokabular og får innsikt i fransk kultur.

**Viktige perioder og sjangre:**
- **La chanson française** - Den klassiske franske visetradisjonen (1930-1970-tallet)
- **Le yéyé** - Fransk pop på 1960-tallet (inspirert av rock'n'roll)
- **Le rap français** - Frankrikes største musikksjanger i dag
- **L'électro** - Fransk elektronisk musikk (Daft Punk, Air)
- **La variété française** - Popmusikk for et bredt publikum

Frankrike har også innfort **les quotas radio**: minst 40% av musikken på fransk radio må være franskspråklig.`,
    },
    {
      id: 'fransk-3-6-2-def-1',
      type: 'definition',
      content: `**La chanson française:**
Sjangeren kjennetegnes av at **teksten** er det viktigste elementet. Melodien stotter teksten, men ordene står i sentrum. Artistene kalles *auteurs-compositeurs-interprètes* (tekst-komponist-utover) - de skriver, komponerer og synger selv.

**Le slam:**
En poetisk muntlig uttrykksform der teksten fremføres uten musikk. Populært i Frankrike gjennom artister som Grand Corps Malade.

**Le rap français:**
Fransk rap oppsto på 1980-tallet i *les banlieues* (forsteder). Den er ofte sosialt og politisk engasjert, og handler om identitet, ulikhet og hverdagsliv. Frankrike har det nest største rapmarkedet i verden etter USA.`,
    },
    {
...
Den mest ikoniske franske sangerinnen. Hennes stemme og livshistorie er blitt et symbol på Frankrike.

**Berømte sanger:**
- *La Vie en rose* (1947) - Livet i rosa, om kjærlighetens lykke
- *Non, je ne regrette rien* (1960) - Nei, jeg angrer ingenting
- *Hymne a l'amour* (1949) - Hymne til kjærligheten
...
- *La Chanson des vieux amants* (1967) - Om gammel kjærlighet
...
**Berømte sanger:**
- *La Bohème* (1965) - Om ungdom og kunstnerliv på Montmartre
- *Hier encore* (1964) - I går ennå (om tidens gang)
...
**Berømt sang:** *Les Copains d'abord* (1964) - Vennene forst`,
    },
    {
...
| Aya Nakamura | 2020-tallet | Afropop/R&B, mest strømmet franskspråklig artist |

**Stromae** er særlig intéressant for fransklæringe:
- *Alors on danse* (2009) - Om å danse bort problemene
- *Papaoutai* (2013) - "Papa ou t'es?" (Pappa, hvor er du?) - om fraværende fedre
- *Formidable* (2013) - Om kjærlighetssorg

### L'électro française

- **Daft Punk** - Legendarisk elektronisk duo (*Around the World*, *Get Lucky*)
- **Air** - Drømmerisk elektronisk musikk (*Sexy Boy*)
...
**Språklig analyse:**
- **"Papaoutai"** er en sammenskriving av "Papa où t'es?" (Pappa, hvor er du?). Dette er **familier register** / muntlig språk: "où t'es" i stedet for "où es-tu"
...
**Tematisk analyse:**
- Sangen handler om **fraværende fedre** - et sosialt tema
- Tonen er både **lekende** (barnlig gjentakelse) og **trist** (reelt savn)
- Musikkvideoen forsterker temaet: en gutt prøver å få kontakt med en livløs far
...
- Stomaes styrke er å kombinere **dansbar musikk** med **alvorlige temaer**`,
    },
    {
    ...
    },
    {
      ...
      exercise: {
        ...
        subTasks: [
          { label: 'a', task: 'Hvorfor tror du Frankrike har innfort kvoter for franskspråklig musikk på radio (minst 40%)?', solution: 'For å beskytte fransk språk og kultur mot dominansen av engelskspråklig (særlig amerikansk) musikk. Det er en del av Frankrikes politikk for "l\'exception culturelle" (kulturelt unntak) - at kultur ikke bare er en vare.' },
...
export const CHAPTER_FRANSK_3_6_3: TextbookChapter = {
  ...
  estimatedMinutes: 50,
  competenceGoals: [
    'gjøre rede for sentrale franske kunstbevegelser og kunstnere',
    'analysere kunstverk med relevant vokabular på fransk',
  ],
  content: [
    {
...
Frankrike har vært sentrum for visuell kunst i flere hundre år. Paris var kunstverdenens hovedstad fra 1800-tallet til midten av 1900-tallet, og mange av de viktigste kunstbevegelsene oppsto her.
...
Kunstbevegelsen som revolusjonerte maleriet. Impresjonistene malte **utendors** (en plein air), fanget **oyeblikkets lys**, og brukte synlige penselstrøk og klare farger. Navnet kom fra Claude Monets maleri *Impression, soleil levant* (1872).

**Le post-impressionnisme (Post-impresjonismen, ca. 1886-1905):**
En videreføring av impresjonismen som gikk i ulike retninger. Cézanne søkte geometriske former, Gauguin brukte sterke farger og eksotiske motiver, Van Gogh uttrykte intense følelser.

**Le fauvisme (Fauvismen, ca. 1905-1908):**
"De ville dyrene" (*les fauves*) - kunstnere som brukte ekstremt sterke, rene farger på en uttrykksfullt måte. Ledet av Henri Matisse.
...
- Fokus: Lys, vann, refleksjoner, øyeblikkets skiftende karakter

**Pierre-Auguste Renoir (1841-1919)**
- *Le Bal du Moulin de la Galette* (1876) - Festscene i Paris
- *Le Déjeuner des canotiers* (1881) - Lunsj på en elvebredd
- Fokus: Menneskelig glaede, varme farger, sosiale scener

**Edgar Degas (1834-1917)**
- *La Classe de danse* (Balletttimen) - Berømte ballettscener
...
- Malte på Tahiti med sterke farger og symbolisme
...
Matisse var leder for **le fauvisme** og en av de største kunstnerne i det 20. århundret.
...
**Berømt sitat:** *"La couleur surtout, et peut-être plus encore que le dessin, est une libération."*
...
- *Nu descendant un escalier* (Naken som går ned en trapp, 1912)

**Duchamps bidrag:** Han stilte spørsmålet "Hva er kunst?" og viste at ideen bak verket kan være viktigere enn den fysiske gjenstanden. Dette la grunnlaget for all konseptkunst.
...
| une huile (sur toile) | en olje (på lerret) |
| le pinceau | penselen |
| la palette | paletten |
| la lumière | lyset |
| l'ombre | skyggen |
...
Maleriet viser en havn (Le Havre) i morgengryet. En rod/oransje sol reflekteres i vannet. Baater og industrielle kraner er synlige i bakgrunnen som duse silhuetter.`,
      solution: `**Løsning - Analyse på fransk:**
...
(Dette maleriet av Claude Monet forestiller havnen i Le Havre i morgengryet. I forgrunnen ser vi havnevannet med oransje refleksjoner. I sentrum stiger en rød sol opp over horisonten. I bakgrunnen skimter man silhuetter av båter og industrielle kraner i tåken.)

**Analyse stylistique (Stilistisk analyse):**
- **La lumière** (lyset) er det viktigste elementet - Monet fanger øyeblikkets lys
- **Les couleurs** (fargene): Kontrastene mellom den varme solen (oransje/rod) og den kjolige bakgrunnen (blaa/graa) skaper dybde
- **La technique** (teknikken): Synlige penselstrøk gir et "uferdig" inntrykk som var revolusjonærende
...
Maleriet ga navn til hele den impresjonistiske bevegelsen da en kritiker spottet tittelen.`,
    },
    {
      ...
      exercise: {
        ...
        subTasks: [
          { label: 'a', task: 'Claude Monet', solution: 'Impresjonisme. Kjennetegn: Lys, vann, refleksjoner, utendørs maling (en plein air). Hovedverk: Impression, soleil levant, Les Nymphéas.' },
    ...
    },
    {
      ...
      exercise: {
        ...
        type: 'classic',
        difficulty: 'medium',
        task: 'Bruk kunstvokabularet på fransk:',
        subTasks: [
          ...
          { label: 'b', task: 'Si at Monet bruker varme farger og synlige penselstrøk.', solution: '"Monet utilise des couleurs chaudes et des coups de pinceau visibles."' },
    ...
    },
    {
      ...
      exercise: {
        ...
        subTasks: [
          { label: 'a', task: 'Hvorfor var impresjonismen revolusjonær? Hva bryt den med?', solution: 'Impresjonismen bryt med akademisk maleri som krevde presise, detaljerte gjengivelser. Impresjonistene malte utendørs, brukte synlige penselstrøk, fanget øyeblikkets lys og valgte hverdagsmotiver. De ble avvist av det offisielle Salon og måtte utstille i "Salon des Refusés".' },
          { label: 'b', task: 'Er Duchamps "Fontaine" (et urinal) kunst? Argumenter for og mot på fransk.', solution: 'For: "Oui, c\'est de l\'art parce que Duchamp pose la question \'Qu\'est-ce que l\'art?\' L\'idée est plus importante que l\'objet." Mot: "Non, ce n\'est pas de l\'art parce qu\'il n\'y a pas de talent artistique. N\'importe qui peut présenter un objet." Duchamps poeng var nettopp å provosere denne debatten.' },
          { label: 'c', task: 'Velg en fransk kunstner og skriv 3-4 setninger på fransk om hvorfor du finner kunstneren intéressant.', solution: 'Eksempel: "Je trouve Monet fascinant parce qu\'il a changé notre façon de voir la lumière. Ses tableaux des Nymphéas sont d\'une beauté extraordinaire. Il a peint le même sujet encore et encore pour capturer les changements de lumière. C\'est un artiste qui nous apprend a regarder le monde autrement."' },
        ],
        solution: 'a) Brudd med akademisk tradisjon, b) Debatten om kunstens definisjon, c) Åpent svar.',
    ...
    },
    {
      ...
      type: 'tip',
      content: `**Tips for bildeanalyse på fransk:**

1. **Beskriv først**: Hva ser du? Bruk *au premier plan, a l'arrière-plan, au centre*
...
export const CHAPTER_FRANSK_3_6_4: TextbookChapter = {
  ...
  estimatedMinutes: 50,
  competenceGoals: [
    'gjøre rede for sentrale elementer i fransk kulturarv og livsstil',
...
"L'art de vivre a la française" (kunsten å leve på den franske måten) er et begrep som beskriver den franske tilnærmingen til dagliglivet - der mat, vin, mote, design og kultur er integrert i hverdagen. I 2010 ble **le repas gastronomique des Français** (det franske gastronomiske måltidet) oppført på UNESCOs liste over immateriell kulturarv.
...
- **La joie de vivre** - Livsglede og å nyte øyeblikket

Disse elementene er ikke bare overflate - de er dypt forankret i fransk identitet og selvforståelse.`,
    },
    {
...
- Høy kvalitet på råvarene (*les produits du terroir*)
...
**Le savoir-vivre:**
Bokstavelig "å vite å leve" - den franske formen for høflighet, etikette og god oppførsel i sosiale sammenhenger. Inkluderer bordskikk, høflighetsfraser og sosiale koder.

**L'exception culturelle:**
Prinsippet om at kultur (film, musikk, kunst) ikke bare er en vare, men en verdi som må beskyttes. Frankrike bruker dette prinsippet for å begrunne støtte til nasjonal kulturproduksjon.`,
    },
    {
...
Det franske gastronomiske måltidet følger en fast struktur:

| Rekkefølge | Fransk | Norsk |
|------------|--------|-------|
| 1 | L'apéritif | Aperitiff (drink for måltidet) |
...
- **Le pain** (brødet) - La baguette ble oppført på UNESCOs kulturarvliste i 2022
...
Chanel frigjorde kvinner fra korsetter og komplisert klær. Hun introduserte komfortable, elegante plagg som bukser for kvinner, den lille sorte kjolen og Chanel-dressen. Hennes motto: *"La mode se démode, le style jamais."* (Moten går ut av moten, stilen aldri.)
...
**Haussmanns Paris:** Baron Haussmann omformet Paris på 1850-60-tallet med brede boulevarder, uniformerte bygninger og parker. Dette er det Paris vi kjenner i dag.`,
    },
    {
      id: 'fransk-3-6-4-example-1',
      type: 'example',
      title: 'Eksempel: Diskusjon om kulturarv',
      problem: `UNESCO har oppført det franske gastronomiske måltidet (2010) og den franske baguetten (2022) på sin liste over immateriell kulturarv. Analyser:
...
- Det stotter **le terroir** - lokale produkter og håndverkstradisjoner
- Det styrker Frankrikes "soft power" - kulturell innflytelse i verden
- Det anerkjenner måltidet som en **sosial praksis**, ikke bare naering
...
- Kokkekunst betraktes som en **kunstform** på linje med maleri og musikk
- Den franske mattradisjonen handler om **kvalitet fremfor kvantitet**
- Baguetten er et dagligdags symbol: den kjøpes fersk hver dag og representerer det enkle, gode livet
    ...
    },
    {
      ...
      exercise: {
        ...
        subTasks: [
          ...
          { label: 'b', task: 'Le savoir-vivre', solution: '"Å vite å leve" - Fransk høflighet, etikette og sosiale koder. Inkluderer bordskikk, høflighetsfraser og god oppførsel.' },
          { label: 'c', task: 'L\'exception culturelle', solution: 'Prinsippet om at kultur ikke bare er en vare, men en verdi som må beskyttes. Frankrike bruker dette for å støtte nasjonal film, musikk og kunst.' },
          { label: 'd', task: 'L\'art de vivre', solution: '"Kunsten å leve" - Den franske tilnærmingen til dagliglivet der mat, vin, kultur og estetikk er integrert i hverdagen.' },
        ],
        solution: 'a) Sted-produkt-sammenheng, b) Hoflighet/etikette, c) Kulturbeskyttelse, d) Livsstil/livskunst.',
        hints: ['Terroir = jord/sted', 'Savoir-vivre = vite å leve', 'Exception = unntak'],
      },
    },
    {
      ...
      exercise: {
        ...
        subTasks: [
          { label: 'a', task: 'Det franske gastronomiske måltidet er på UNESCOs kulturarvliste.', solution: '"Le repas gastronomique des Français est inscrit au patrimoine culturel immatériel de l\'UNESCO."' },
          { label: 'b', task: 'Coco Chanel revolusjonerte moten ved å introdusere den lille sorte kjolen.', solution: '"Coco Chanel a révolutionné la mode en introduisant la petite robe noire."' },
    ...
    },
    {
      ...
      exercise: {
        ...
        subTasks: [
          ...
          { label: 'b', task: 'Hvorfor tror du Frankrike aktivt beskytter sin kulturelle produksjon (film, musikk, mat)?', solution: 'Frankrike ser kultur som en del av nasjonal identitet, ikke bare underholdning. L\'exception culturelle beskytter mot dominans av (særlig amerikansk) massekultur. Det handler om språk, identitet og mangfold. Ogsaa økonomisk: kulturindustrien er viktig for Frankrike.' },
          { label: 'c', task: 'Skriv 3-4 setninger på fransk om et aspekt ved fransk kultur du beundrer eller synes er intéressant.', solution: 'Eksempel: "J\'admire la tradition gastronomique française parce qu\'elle accorde une grande importance a la qualité des produits et au plaisir de manger ensemble. En France, le repas est un moment social, pas seulement une nécessité. Cette façon de vivre nous rappelle l\'importance de prendre le temps de savourer la vie."' },
        ],
        solution: 'a) Sammenligning av kulturtradisjoner, b) Identitet og kulturbeskyttelse, c) Åpent svar.',
        hints: ['Tenk på mat, natur, høflighet', 'L\'exception culturelle = kulturbeskyttelse', 'Bruk vokabular fra kapittelet'],
      },
    },
    {
...
- Le terroir, le savoir-vivre, l'exception culturelle`,
    },
    {
      ...
      type: 'tip',
      content: `**Tips for å snakke om fransk kultur på eksamen:**

1. Vis **bredde**: Koble ulike kulturområder (litteratur, film, kunst, mat)
...
5. Husk at fransk kultur er **mangfoldig** - ikke bare Paris, men også regioner, førstedskultur, frankofonien`,
    },
  ],
  exercises: [],
};
