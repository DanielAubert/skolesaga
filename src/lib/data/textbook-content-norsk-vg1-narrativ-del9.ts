...
Her er et nyttig triks: start alltid med a finne verbalet nar du skal analysere en setning. Nar du vet hva som skjer, blir det mye lettere a finne de andre leddene.`,
    ...
    // ========== QUIZ 1 ==========
    {
      ...
      exercise: {
        ...
        task: 'Test deg selv pa verbalet:',
        options: [
        ...
        questions: [
          {
            ...
            solution: 'Verbalet er "har likt" - hjelpeverbet "har" pluss hovedverbet "likt". "Alltid" er et adverbial, ikke del av verbalet.',
          },
          {
            id: 'norsk-vg1-8-1-n-quiz1-q1',
            task: 'Hvilket sporsmal stiller du for a finne verbalet?',
            options: [
              { id: 'a', text: 'Hvem gjor det?', isCorrect: false },
              { id: 'b', text: 'Hva skjer? eller Hva gjores?', isCorrect: true },
              { id: 'c', text: 'Nar skjer det?', isCorrect: false },
              { id: 'd', text: 'Hvor skjer det?', isCorrect: false },
            ],
            solution: 'For a finne verbalet spor du "Hva skjer?" eller "Hva gjores?" Svaret er verbalet. Start alltid med verbalet nar du analyserer en setning.',
          },
          {
            id: 'norsk-vg1-8-1-n-quiz1-q2',
            task: 'Hva er verbalet i "Brevet ble skrevet i gar"?',
            options: [
              { id: 'a', text: 'Brevet', isCorrect: false },
              { id: 'b', text: 'skrevet', isCorrect: false },
              { id: 'c', text: 'ble skrevet', isCorrect: true },
              { id: 'd', text: 'i gar', isCorrect: false },
            ],
            solution: 'Verbalet er "ble skrevet" - det bestar av hjelpeverbet "ble" og hovedverbet "skrevet". Verbalet kan besta av flere ord nar det inkluderer hjelpeverb.',
          },
        ],
      },
    },
...
Ikke alle setninger har objekt. "Solen skinner" har bare subjekt og verbal. Solen gjor ikke noe med noen - den bare skinner.`,
    ...
    // ========== QUIZ 2 ==========
    {
      ...
      exercise: {
        ...
        number: 'Quiz 2',
        type: 'multiple-choice',
        task: 'Test deg selv pa subjekt og objekt:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        solution: '',
        questions: [
          {
            ...
            solution: 'Barnet er det indirekte objektet - den som mottar. "En is" er direkte objekt - det som gis. Spor: "Til hvem ga moren en is?" Svaret er "barnet".',
          },
          {
            id: 'norsk-vg1-8-1-n-quiz2-q1',
            task: 'Hva er subjektet i "Det regner"?',
            options: [
              { id: 'a', text: 'regner', isCorrect: false },
              { id: 'b', text: 'Det finnes ikke noe subjekt', isCorrect: false },
              { id: 'c', text: '"Det" er et formelt subjekt', isCorrect: true },
              { id: 'd', text: 'Regnet', isCorrect: false },
            ],
            solution: '"Det" er et formelt subjekt - det fyller plassen subjektet ma ha i norske setninger, selv om det ikke egentlig er noe som "regner". Formelle subjekt er vanlige i setninger om vaer og tilstand.',
          },
          {
            id: 'norsk-vg1-8-1-n-quiz2-q2',
            task: 'Har setningen "Solen skinner" et objekt?',
            options: [
              { id: 'a', text: 'Ja, "skinner" er objektet', isCorrect: false },
              { id: 'b', text: 'Ja, "solen" er objektet', isCorrect: false },
              { id: 'c', text: 'Nei, setningen har bare subjekt og verbal', isCorrect: true },
              { id: 'd', text: 'Ja, men det er skjult', isCorrect: false },
            ],
            solution: 'Ikke alle setninger har objekt. "Solen skinner" har bare subjekt (solen) og verbal (skinner). Solen gjor ikke noe med noen - den bare skinner. Objekt finnes bare nar handlingen rammer noe eller noen.',
          },
        ],
      },
    },
...
Det finnes ogsا setningsadverbialer som modifiserer hele setningen: "Dessverre kan jeg ikke komme." "Kanskje har han rett." Disse uttrykker talerens holdning til det som sies.`,
    ...
    // ========== QUIZ 3 ==========
    {
      ...
      exercise: {
        ...
        number: 'Quiz 3',
        type: 'multiple-choice',
        task: 'Test deg selv pa adverbialer:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        solution: '',
        questions: [
          {
            ...
            solution: '"I morgen" er tidsadverbial (nar?) og "til Paris" er stedsadverbial (hvor?). En setning kan ha flere adverbialer av ulike typer.',
          },
          {
            id: 'norsk-vg1-8-1-n-quiz3-q1',
            task: 'Hva slags adverbial er "fort" i setningen "Hun lop fort"?',
            options: [
              { id: 'a', text: 'Tidsadverbial', isCorrect: false },
              { id: 'b', text: 'Stedsadverbial', isCorrect: false },
              { id: 'c', text: 'Matesadverbial', isCorrect: true },
              { id: 'd', text: 'Arsaksadverbial', isCorrect: false },
            ],
            solution: '"Fort" er et matesadverbial som svarer pa sporsmalet "Hvordan lop hun?" Matesadverbialer beskriver maten handlingen utføres pa.',
          },
        ],
      },
    },
...
Huskeregelen er: Predikativ kommer etter kopulaverb som "vare", "bli", "virke", "synes", "smaker", "foles". Disse verbene forbinder subjektet med en beskrivelse. Adverbial kommer etter handlingsverb og beskriver handlingen.`,
    ...
    // ========== QUIZ 4 ==========
    {
      ...
      exercise: {
        ...
        number: 'Quiz 4',
        type: 'multiple-choice',
        task: 'Test deg selv pa predikativ:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        solution: '',
        questions: [
          {
            ...
            solution: 'I setning 1 er "flittig" predikativ: hun = flittig. I setning 2 er "flittig" adverbial: det beskriver hvordan hun arbeider.',
          },
          {
            id: 'norsk-vg1-8-1-n-quiz4-q1',
            task: 'Etter hvilke verb finner vi vanligvis predikativ?',
            options: [
              { id: 'a', text: 'Handlingsverb som "lope", "spise" og "skrive"', isCorrect: false },
              { id: 'b', text: 'Kopulaverb som "vaere", "bli", "virke", "synes" og "smaker"', isCorrect: true },
              { id: 'c', text: 'Alle verb kan ha predikativ', isCorrect: false },
              { id: 'd', text: 'Bare hjelpeverb som "ha" og "skulle"', isCorrect: false },
            ],
            solution: 'Predikativ kommer etter kopulaverb - verb som forbinder subjektet med en beskrivelse: "vaere", "bli", "virke", "synes", "smaker", "foles". Disse verbene sier noe om hva subjektet er eller blir.',
          },
        ],
      },
    },
...
Denne ferdigheten er gull verd nar du skal skrive selv. Nar du kan se strukturen i setninger, kan du variere den bevisst. Du kan velge a starte med tidsadverbialet for effekt, eller du kan omorganisere for bedre flyt. Du blir en bevisst skribent, ikke bare en som skriver pa mag.`,
    ...
    // ========== QUIZ 5 ==========
    {
      ...
      exercise: {
        ...
        number: 'Quiz 5',
        type: 'multiple-choice',
        task: 'Test deg selv pa fullstendig setningsanalyse:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        solution: '',
        questions: [
          ...
          {
            id: 'norsk-vg1-8-1-n-quiz5-q1',
            task: 'I setningen "I gar ga laereren elevene en vanskelig oppgave pa skolen", hva er "pa skolen"?',
            options: [
              { id: 'a', text: 'Direkte objekt', isCorrect: false },
              { id: 'b', text: 'Indirekte objekt', isCorrect: false },
              { id: 'c', text: 'Stedsadverbial', isCorrect: true },
              { id: 'd', text: 'Predikativ', isCorrect: false },
            ],
            solution: '"Pa skolen" er et stedsadverbial - det svarer pa sporsmalet "Hvor ga laereren oppgaven?" Stedsadverbialer angir hvor handlingen finner sted.',
          },
          {
            id: 'norsk-vg1-8-1-n-quiz5-q2',
            task: 'Hvorfor er det lurt a starte en setningsanalyse med a finne verbalet?',
            options: [
              { id: 'a', text: 'Fordi verbalet alltid star forst i setningen', isCorrect: false },
              { id: 'b', text: 'Fordi alle andre setningsledd defineres i forhold til verbalet', isCorrect: true },
              { id: 'c', text: 'Fordi verbalet er det lengste ordet', isCorrect: false },
              { id: 'd', text: 'Fordi det finnes bare ett verbal i hver tekst', isCorrect: false },
            ],
            solution: 'Alle andre setningsledd defineres ut fra verbalet: Subjektet er den som handler (hvem + verbal), objektet rammes av handlingen (verbal + hva), adverbialene beskriver omstendighetene rundt verbalet. Derfor er verbalet utgangspunktet for all analyse.',
          },
        ],
      },
    },
...
Subjunksjoner viser ulike typer sammenhenger: tid (nar, da, mens), arsak (fordi, siden), betingelse (hvis, dersom), inrømmelse (selv om). A bruke riktig subjunksjon viser leseren nøyaktig hvordan setningene henger sammen.`,
    ...
    // ========== QUIZ 1 ==========
    {
      ...
      exercise: {
        ...
        number: 'Quiz 1',
        type: 'multiple-choice',
        task: 'Test deg selv pa konjunksjoner og subjunksjoner:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        solution: '',
        questions: [
          ...
          {
            id: 'norsk-vg1-8-2-n-quiz1-q1',
            task: 'Hva er hovedforskjellen mellom konjunksjoner og subjunksjoner?',
            options: [
              { id: 'a', text: 'Konjunksjoner brukes bare i muntlig sprak', isCorrect: false },
              { id: 'b', text: 'Konjunksjoner binder likeverdige ledd, subjunksjoner innleder underordnede setninger', isCorrect: true },
              { id: 'c', text: 'Subjunksjoner brukes bare i skriftlig sprak', isCorrect: false },
              { id: 'd', text: 'Det er ingen forskjell mellom dem', isCorrect: false },
            ],
            solution: 'Konjunksjoner (og, men, eller) binder likeverdige ledd - ingen er sjefen. Subjunksjoner (fordi, hvis, nar) innleder underordnede setninger (leddsetninger) som ikke kan sta alene.',
          },
          {
            id: 'norsk-vg1-8-2-n-quiz1-q2',
            task: 'Hvilken logisk sammenheng uttrykker konjunksjonen "men"?',
            options: [
              { id: 'a', text: 'Tillegg', isCorrect: false },
              { id: 'b', text: 'Arsak', isCorrect: false },
              { id: 'c', text: 'Motsetning', isCorrect: true },
              { id: 'd', text: 'Betingelse', isCorrect: false },
            ],
            solution: '"Men" uttrykker motsetning: "Hun ville ga, men han ville bli." Konjunksjoner viser ulike logiske sammenhenger: "og" legger til, "men" viser motsetning, "eller" gir alternativer, "for" forklarer arsak.',
          },
        ],
      },
    },
...
Referentbinding gjor teksten mer variert og elegant. Men pass pa: referansen ma være tydelig! "Per og Ole kom. Han var sur." Hvem var sur? Per eller Ole? Uklar referanse forvirrer leseren.`,
    ...
    // ========== QUIZ 2 ==========
    {
      ...
      exercise: {
        ...
        number: 'Quiz 2',
        type: 'multiple-choice',
        task: 'Test deg selv pa referentbinding:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        solution: '',
        questions: [
          ...
          {
            id: 'norsk-vg1-8-2-n-quiz2-q1',
            task: '"Oslo vokser. Hovedstaden trenger flere boliger." Hvilken type referentbinding brukes her?',
            options: [
              { id: 'a', text: 'Pronomen', isCorrect: false },
              { id: 'b', text: 'Gjentagelse', isCorrect: false },
              { id: 'c', text: 'Parafrasering (alternativ betegnelse)', isCorrect: true },
              { id: 'd', text: 'Antonym', isCorrect: false },
            ],
            solution: '"Hovedstaden" er en alternativ betegnelse (parafrasering) for "Oslo". I stedet for a gjenta "Oslo" eller bruke pronomenet "den", brukes en annen mate a si det pa som gir ekstra informasjon.',
          },
          {
            id: 'norsk-vg1-8-2-n-quiz2-q2',
            task: 'Hva er problemet med setningen "Per og Ole kom. Han var sur."?',
            options: [
              { id: 'a', text: 'Man kan ikke bruke pronomen etter egennavn', isCorrect: false },
              { id: 'b', text: 'Det mangler et komma', isCorrect: false },
              { id: 'c', text: 'Referansen er uklar - vi vet ikke om det er Per eller Ole', isCorrect: true },
              { id: 'd', text: 'Man bor bruke "den" i stedet for "han"', isCorrect: false },
            ],
            solution: 'Nar "han" kan vise tilbake til bade Per og Ole, er referansen uklar. Leseren vet ikke hvem som var sur. Man ma skrive "Per var sur" eller "Ole var sur" for a unnga forvirring.',
          },
        ],
      },
    },
...
Nar du skriver, tenk bevisst pa hva som er tema i setningene dine. Det hjelper leseren a folge med.`,
    ...
    // ========== QUIZ 3 ==========
    {
      ...
      exercise: {
        ...
        number: 'Quiz 3',
        type: 'multiple-choice',
        task: 'Test deg selv pa tematisk binding:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        solution: '',
        questions: [
          {
            ...
            solution: 'Dette er lineaer progresjon fordi ny informasjon i en setning (damen, brevet) blir tema i neste setning. Informasjonen flyter fremover som en kjede.',
          },
          {
            id: 'norsk-vg1-8-2-n-quiz3-q1',
            task: '"Hunden lop. Den bjeffet. Den var sulten." Hvilken tematisk progresjon er dette?',
            options: [
              { id: 'a', text: 'Lineaer progresjon', isCorrect: false },
              { id: 'b', text: 'Overordnet tema', isCorrect: false },
              { id: 'c', text: 'Konstant tema', isCorrect: true },
              { id: 'd', text: 'Kontrastiv progresjon', isCorrect: false },
            ],
            solution: 'Dette er konstant tema - hunden er tema i alle tre setningene. Denne typen passer nar du vil holde fokus pa en ting og fortelle om den fra ulike vinkler.',
          },
          {
            id: 'norsk-vg1-8-2-n-quiz3-q2',
            task: 'Hva menes med "tema" og "rema" i en setning?',
            options: [
              { id: 'a', text: 'Tema er overskriften, rema er brodteksten', isCorrect: false },
              { id: 'b', text: 'Tema er det setningen handler om, rema er ny informasjon', isCorrect: true },
              { id: 'c', text: 'Tema er subjektet, rema er objektet', isCorrect: false },
              { id: 'd', text: 'Tema og rema betyr det samme', isCorrect: false },
            ],
            solution: 'Tema er det kjente - det setningen handler om. Rema er den nye informasjonen om temaet. God tekst balanserer mellom kjent og nytt, slik at leseren kan folge med.',
          },
        ],
      },
    },
...
God leksikalsk binding skaper et tematisk nett gjennom teksten. Leseren foler at alt hanger sammen, selv uten a tenke bevisst pa det.`,
    ...
    // ========== QUIZ 4 ==========
    {
      ...
      exercise: {
        ...
        number: 'Quiz 4',
        type: 'multiple-choice',
        task: 'Test deg selv pa leksikalsk binding:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        solution: '',
        questions: [
          {
            ...
            solution: '"Bil" og "kjoretoy" er synonymer - ord med lignende betydning. Dette skaper variasjon i teksten samtidig som det holder tematisk fokus.',
          },
          {
            id: 'norsk-vg1-8-2-n-quiz4-q1',
            task: '"Doktor - pasient - sykehus - behandling." Hvilken type leksikalsk binding representerer dette?',
            options: [
              { id: 'a', text: 'Synonymer', isCorrect: false },
              { id: 'b', text: 'Antonymer', isCorrect: false },
              { id: 'c', text: 'Kollokasjon', isCorrect: true },
              { id: 'd', text: 'Gjentagelse', isCorrect: false },
            ],
            solution: 'Dette er kollokasjon - ord som ofte opptrer sammen og signaliserer et bestemt tema. Alle disse ordene horer til det medisinske feltet og skaper en tematisk sammenheng.',
          },
          {
            id: 'norsk-vg1-8-2-n-quiz4-q2',
            task: '"Noen er rike, andre er fattige." Hvilken type leksikalsk binding er dette?',
            options: [
              { id: 'a', text: 'Synonymer', isCorrect: false },
              { id: 'b', text: 'Kollokasjon', isCorrect: false },
              { id: 'c', text: 'Gjentagelse', isCorrect: false },
              { id: 'd', text: 'Antonymer', isCorrect: true },
            ],
            solution: '"Rike" og "fattige" er antonymer - motsetningsord. Antonymer skaper sammenheng ved a kontrastere og fremheve forskjeller.',
          },
        ],
      },
    },
...
Nar du skriver, les teksten hoyt. Hakker den? Da trenger den bedre binding. Varier bindemetodene - bruk bade bindeord, pronomen, synonymer og tematisk fokus. Husk: god tekstbinding er usynlig. Leseren legger ikke merke til den - de bare glir gjennom teksten.`,
    ...
    // ========== QUIZ 5 ==========
    {
      ...
      exercise: {
        ...
        number: 'Quiz 5',
        type: 'multiple-choice',
        task: 'Test deg selv pa a forbedre tekstbinding:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        solution: '',
        questions: [
          ...
          {
            id: 'norsk-vg1-8-2-n-quiz5-q1',
            task: 'Hva er problemet med teksten "Skolen er gammel. Skolen har darlige vinduer. Skolen trenger renovering."?',
            options: [
              { id: 'a', text: 'Setningene er for korte', isCorrect: false },
              { id: 'b', text: 'Monoton gjentagelse av "Skolen" og ingen bindeord', isCorrect: true },
              { id: 'c', text: 'Det mangler utropstegn', isCorrect: false },
              { id: 'd', text: 'Informasjonen er feil', isCorrect: false },
            ],
            solution: 'Teksten hakker fordi "Skolen" gjentas monotont og det mangler bindeord som viser sammenheng. Bedre: "Skolen er gammel og har darlige vinduer. Den trenger derfor renovering."',
          },
          {
            id: 'norsk-vg1-8-2-n-quiz5-q2',
            task: 'Hvilke fire hovedtyper tekstbinding har vi laert om?',
            options: [
              { id: 'a', text: 'Konjunksjoner/subjunksjoner, referentbinding, tematisk binding, leksikalsk binding', isCorrect: true },
              { id: 'b', text: 'Komma, punktum, kolon, semikolon', isCorrect: false },
              { id: 'c', text: 'Substantiv, verb, adjektiv, adverb', isCorrect: false },
              { id: 'd', text: 'Innledning, hoveddel, avslutning, litteraturliste', isCorrect: false },
            ],
            solution: 'De fire hovedtypene tekstbinding er: 1) konjunksjoner og subjunksjoner (bindeord), 2) referentbinding (pronomen og synonymer), 3) tematisk binding (fokus og progresjon), og 4) leksikalsk binding (ord som horer tematisk sammen).',
          },
        ],
      },
    },
        ...
        questions: [
          {
            ...
            solution: '"Da" er riktig fordi dette handler om fortid - en engangshendelse. Du var ti ar en gang i livet. Bruk "da" for fortid, "nar" for gjentakelse.',
          },
          {
            id: 'norsk-vg1-8-3-n-quiz1-q1',
            task: 'Hvilken huskeregel hjelper deg a velge mellom "da" og "nar"?',
            options: [
              { id: 'a', text: '"Da" betyr "snart" og "nar" betyr "da"', isCorrect: false },
              { id: 'b', text: '"Da" kan byttes med "dengang", "nar" kan byttes med "hver gang"', isCorrect: true },
              { id: 'c', text: '"Da" brukes i sporsmål, "nar" brukes i svar', isCorrect: false },
              { id: 'd', text: '"Da" er formelt, "nar" er uformelt', isCorrect: false },
            ],
            solution: 'Kan du bytte ut med "dengang"? Bruk "da". Kan du bytte ut med "hver gang"? Bruk "nar". "Dengang jeg var liten" (fortid) vs. "Hver gang det regner" (gjentakelse).',
          },
          {
            id: 'norsk-vg1-8-3-n-quiz1-q2',
            task: '"___ det regner, tar jeg paraply." Hva er riktig?',
            options: [
              { id: 'a', text: 'Da', isCorrect: false },
              { id: 'b', text: 'Nar', isCorrect: true },
              { id: 'c', text: 'Begge er riktige', isCorrect: false },
              { id: 'd', text: 'Ingen av dem', isCorrect: false },
            ],
            solution: '"Nar" er riktig fordi dette er gjentakelse - hver gang det regner. Du tar paraply ikke bare en gang, men hver gang det regner. "Nar" brukes om gjentatte hendelser.',
          },
        ],
      },
    },
    ...
    // ========== QUIZ 2 ==========
    {
      ...
      exercise: {
        ...
        questions: [
          ...
          {
            id: 'norsk-vg1-8-3-n-quiz2-q1',
            task: 'Hva er den beste testen for a finne ut om det skal vaere "og" eller "a"?',
            options: [
              { id: 'a', text: 'Se om det er et substantiv etter', isCorrect: false },
              { id: 'b', text: 'Prov a bytte ut med "for a" - fungerer det, er det "a"', isCorrect: true },
              { id: 'c', text: 'Se om setningen er lang', isCorrect: false },
              { id: 'd', text: '"Og" brukes alltid i begynnelsen av setninger', isCorrect: false },
            ],
            solution: 'Den beste testen er a prove "for a". "Jeg liker (for a) lese" gir mening, altsaa "a lese". "Eple (for a) paere" gir ikke mening, altsaa "eple og paere".',
          },
          {
            id: 'norsk-vg1-8-3-n-quiz2-q2',
            task: 'Hva er riktig: "Vi bestemte oss for ___ reise"?',
            options: [
              { id: 'a', text: 'og', isCorrect: false },
              { id: 'b', text: 'a', isCorrect: true },
              { id: 'c', text: 'Begge er riktige', isCorrect: false },
              { id: 'd', text: 'Ingen av dem', isCorrect: false },
            ],
            solution: '"A reise" er riktig fordi det er infinitivsmerke foran verbet "reise". Test: "Vi bestemte oss for (for a) reise" - det gir mening! Altsaa skal det vaere "a".',
          },
        ],
      },
    },
    ...
    // ========== QUIZ 3 ==========
    {
      ...
      exercise: {
        ...
        questions: [
          ...
          {
            id: 'norsk-vg1-8-3-n-quiz3-q1',
            task: 'Hvilken test kan du bruke for a velge mellom "de" og "dem"?',
            options: [
              { id: 'a', text: 'Bytt ut med "han" eller "ham"', isCorrect: false },
              { id: 'b', text: 'Bytt ut med "vi" eller "oss"', isCorrect: true },
              { id: 'c', text: 'Se om det star et verb etter', isCorrect: false },
              { id: 'd', text: '"De" brukes alltid i begynnelsen av setninger', isCorrect: false },
            ],
            solution: 'Bytt ut med "vi" (subjekt) eller "oss" (objekt). "Vi kom" fungerer = "de". "Jeg sa oss" fungerer = "dem". Denne testen fungerer nesten alltid.',
          },
          {
            id: 'norsk-vg1-8-3-n-quiz3-q2',
            task: '"___ som vil, kan komme." Hva er riktig?',
            options: [
              { id: 'a', text: 'Dem', isCorrect: false },
              { id: 'b', text: 'De', isCorrect: true },
              { id: 'c', text: 'Begge er riktige', isCorrect: false },
              { id: 'd', text: 'Det avhenger av sammenhengen', isCorrect: false },
            ],
            solution: '"De som..." er alltid "de", aldri "dem". Det er en fast konstruksjon. "De som vil, kan komme." Pronomenet er subjekt i leddsetningen "som vil".',
          },
        ],
      },
    },
...
Nar du er usikker, slå opp i ordboka!`,
    ...
    // ========== QUIZ 4 ==========
    {
      ...
      exercise: {
        ...
        number: 'Quiz 4',
        type: 'multiple-choice',
        task: 'Test deg selv pa sarskriving og sammenskriving:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        solution: '',
        questions: [
          {
            ...
            solution: '"Fotball kamp" er feil - det skal vaere "fotballkamp" (ett ord). De andre er riktig skrevet som to ord fordi de er adverbiale uttrykk, ikke sammensatte substantiv.',
          },
          {
            id: 'norsk-vg1-8-3-n-quiz4-q1',
            task: 'Hvilken test kan du bruke for a sjekke om et ord er sammensatt (ett ord) eller to ord?',
            options: [
              { id: 'a', text: 'Se om ordet er langt eller kort', isCorrect: false },
              { id: 'b', text: 'Prov a sette "en", "ei" eller "et" foran', isCorrect: true },
              { id: 'c', text: 'Sjekk om ordet finnes pa engelsk', isCorrect: false },
              { id: 'd', text: 'Hvert ord med mer enn 8 bokstaver er sammensatt', isCorrect: false },
            ],
            solution: 'Kan du sette "en/ei/et" foran? "En fotballkamp" fungerer, sa det er ett ord. "En i dag" gir ikke mening, sa det er to ord. Denne testen skiller sammensatte substantiv fra adverbiale uttrykk.',
          },
          {
            id: 'norsk-vg1-8-3-n-quiz4-q2',
            task: 'Hvorfor er sarskriving sa vanlig i moderne norsk?',
            options: [
              { id: 'a', text: 'Fordi norsk grammatikk har endret seg', isCorrect: false },
              { id: 'b', text: 'Fordi det er pavirkning fra engelsk der sammensatte ord ofte skrives i to ord', isCorrect: true },
              { id: 'c', text: 'Fordi sarskriving er tillatt i ny rettskriving', isCorrect: false },
              { id: 'd', text: 'Fordi det er lettere a lese to ord enn ett langt', isCorrect: false },
            ],
            solution: 'Pavirkningen fra engelsk gjor sarskriving vanligere. Pa engelsk skrives ofte sammensatte ord i to ord ("football game"), men pa norsk skal de vaere ett ord ("fotballkamp"). Regelen har ikke endret seg.',
          },
        ],
      },
    },
...
Tips: Finn din stil. Liker du a-former (boka, kasta) eller e-former (boken, kastet)? Velg det som foler seg naturlig, og hold deg til det.`,
    ...
    // ========== QUIZ 5 ==========
    {
      ...
      exercise: {
        ...
        number: 'Quiz 5',
        type: 'multiple-choice',
        task: 'Test deg selv pa rettskriving bokmal:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        solution: '',
        questions: [
          ...
          {
            id: 'norsk-vg1-8-3-n-quiz5-q1',
            task: 'Hva er hovedregelen for dobbeltkonsonant?',
            options: [
              { id: 'a', text: 'Alle konsonanter skal dobles i norsk', isCorrect: false },
              { id: 'b', text: 'Etter lang vokal kommer dobbeltkonsonant', isCorrect: false },
              { id: 'c', text: 'Etter kort, trykksterk vokal kommer dobbeltkonsonant', isCorrect: true },
              { id: 'd', text: 'Dobbeltkonsonant brukes bare i slutten av ord', isCorrect: false },
            ],
            solution: 'Etter kort, trykksterk vokal kommer dobbeltkonsonant: "takk" (kort a, dobbel k) vs. "tak" (lang a, enkel k). Les ordet hoyt for a hore om vokalen er kort.',
          },
          {
            id: 'norsk-vg1-8-3-n-quiz5-q2',
            task: 'Hva er viktigst nar du bruker bokmålets valgfrihet (boka/boken, kastet/kasta)?',
            options: [
              { id: 'a', text: 'A bruke mest mulig a-former', isCorrect: false },
              { id: 'b', text: 'A veksle mellom formene for variasjon', isCorrect: false },
              { id: 'c', text: 'A bare bruke e-former', isCorrect: false },
              { id: 'd', text: 'A vaere konsekvent gjennom hele teksten', isCorrect: true },
            ],
            solution: 'Det viktigste er a vaere konsekvent. Velg en stil (boka/boken, kastet/kasta) og hold deg til den gjennom hele teksten. A veksle mellom formene virker uryddig.',
          },
        ],
      },
    },
...
Desse orda er obligatoriske. Det finst ikkje val. "Ikkje", ikkje "ikke". "Kva", ikkje "hva". Alltid.`,
    ...
    // ========== QUIZ 1 ==========
    {
      ...
      exercise: {
        ...
        number: 'Quiz 1',
        type: 'multiple-choice',
        task: 'Test deg selv pa nynorske ord:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        solution: '',
        questions: [
          ...
          {
            id: 'norsk-vg1-8-4-n-quiz1-q1',
            task: 'Kva er rett nynorsk for sporjeordet "hvorfor"?',
            options: [
              { id: 'a', text: 'korfor', isCorrect: false },
              { id: 'b', text: 'hvorfor', isCorrect: false },
              { id: 'c', text: 'kvifor', isCorrect: true },
              { id: 'd', text: 'kvafor', isCorrect: false },
            ],
            solution: '"Kvifor" er rett nynorsk for "hvorfor". Alle sporjeorda er annleis pa nynorsk: kva, kven, kvar, korleis, kvifor. Desse er obligatoriske former.',
          },
          {
            id: 'norsk-vg1-8-4-n-quiz1-q2',
            task: 'Kva er den store misforstaainga mange har om nynorsk?',
            options: [
              { id: 'a', text: 'At nynorsk er vanskelegare enn bokmal', isCorrect: false },
              { id: 'b', text: 'At nynorsk berre er bokmal med andre endingar', isCorrect: true },
              { id: 'c', text: 'At nynorsk berre brukast i Vestland', isCorrect: false },
              { id: 'd', text: 'At nynorsk er eit gamalt sprak', isCorrect: false },
            ],
            solution: 'Mange trur nynorsk berre er bokmal med a-endingar og nokre andre ord. Men nynorsk er eit eige skriftsprak med eigen grammatikk, eigne ord og eigen stil. Du ma tenkje nynorsk, ikkje "omsetje" fraa bokmal.',
          },
        ],
      },
    },
...
Elles folger nynorsk verb dei same boyningsmonstra som bokmal, men med nokre endringar i endingar. A-infinitiv (a kasta) eller e-infinitiv (a kaste) er begge tillatne - velg ein og ver konsekvent.`,
    ...
    // ========== QUIZ 2 ==========
    {
      ...
      exercise: {
        ...
        number: 'Quiz 2',
        type: 'multiple-choice',
        task: 'Test deg selv pa nynorsk verbboyning:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        solution: '',
        questions: [
          ...
          {
            id: 'norsk-vg1-8-4-n-quiz2-q1',
            task: 'Kva er rett perfektumform av "a ta" pa nynorsk?',
            options: [
              { id: 'a', text: 'har tatt', isCorrect: false },
              { id: 'b', text: 'har tatt', isCorrect: false },
              { id: 'c', text: 'har teke', isCorrect: true },
              { id: 'd', text: 'har tok', isCorrect: false },
            ],
            solution: '"Har teke" er rett perfektumform av "a ta" pa nynorsk. "Har tatt" er bokmalform. Presens er "tek", preteritum er "tok", og perfektum er "har teke".',
          },
          {
            id: 'norsk-vg1-8-4-n-quiz2-q2',
            task: 'Kva gjeld for infinitivsendingar pa nynorsk?',
            options: [
              { id: 'a', text: 'Berre a-infinitiv er tillaten (a kasta)', isCorrect: false },
              { id: 'b', text: 'Berre e-infinitiv er tillaten (a kaste)', isCorrect: false },
              { id: 'c', text: 'Begge er tillatne, men du ma vere konsekvent', isCorrect: true },
              { id: 'd', text: 'Det er ingen infinitivsending pa nynorsk', isCorrect: false },
            ],
            solution: 'Nynorsk har valfridom mellom a-infinitiv (a kasta) og e-infinitiv (a kaste). Begge er tillatne, men du ma velje ein og halde deg til den gjennom heile teksten.',
          },
        ],
      },
    },
...
Pa bokmal kan du skrive "guttene", men pa nynorsk ma det vere "gutane". Pa bokmal kan du skrive "husene", men pa nynorsk er det "husa".`,
    ...
    // ========== QUIZ 3 ==========
    {
      ...
      exercise: {
        ...
        number: 'Quiz 3',
        type: 'multiple-choice',
        task: 'Test deg selv pa nynorsk substantivboyning:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        solution: '',
        questions: [
          ...
          {
            id: 'norsk-vg1-8-4-n-quiz3-q1',
            task: 'Kva er spesielt med hokjonn pa nynorsk samanlikna med bokmal?',
            options: [
              { id: 'a', text: 'Hokjonn finst ikkje pa nynorsk', isCorrect: false },
              { id: 'b', text: 'Hokjonn er valfri pa nynorsk, akkurat som pa bokmal', isCorrect: false },
              { id: 'c', text: 'Hokjonn er obligatorisk pa nynorsk', isCorrect: true },
              { id: 'd', text: 'Hokjonn og hankonn er slatt saman pa nynorsk', isCorrect: false },
            ],
            solution: 'Pa bokmal kan du velje om du vil bruke hokjonn (ei bok - boka) eller hankonn (en bok - boken). Pa nynorsk er hokjonn obligatorisk - alle hokjonnsord ma boyas som hokjonn.',
          },
          {
            id: 'norsk-vg1-8-4-n-quiz3-q2',
            task: 'Kva er rett bestemt fleirtal av "hus" pa nynorsk?',
            options: [
              { id: 'a', text: 'husene', isCorrect: false },
              { id: 'b', text: 'husane', isCorrect: false },
              { id: 'c', text: 'husa', isCorrect: true },
              { id: 'd', text: 'husar', isCorrect: false },
            ],
            solution: '"Husa" er rett bestemt fleirtal av "hus" pa nynorsk. Inkjekonnsord far typisk -a i bestemt fleirtal. "Husene" er bokmalform.',
          },
        ],
      },
    },
...
Tips: Lag deg ei personleg sjekkliste med dei orda DU ofte gløymer. Ga gjennom denne for kvar nynorsktekst du skriv.`,
    ...
    // ========== QUIZ 4 ==========
    {
      ...
      exercise: {
        ...
        number: 'Quiz 4',
        type: 'multiple-choice',
        task: 'Test deg selv pa vanlege bokmaalsfeil i nynorsk:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        solution: '',
        questions: [
          ...
          {
            id: 'norsk-vg1-8-4-n-quiz4-q1',
            task: 'Kva bor du gjere nar du skriv nynorsk og er usikker pa eit ord?',
            options: [
              { id: 'a', text: 'Skrive bokmalsforma og hape pa det beste', isCorrect: false },
              { id: 'b', text: 'Droppe ordet og skrive noko anna', isCorrect: false },
              { id: 'c', text: 'Sla opp i Nynorskordboka (ordbok.uib.no)', isCorrect: true },
              { id: 'd', text: 'Sporje ein ven som kan nynorsk', isCorrect: false },
            ],
            solution: 'Bruk Nynorskordboka pa ordbok.uib.no. Det tek berre nokre sekund a sla opp eit ord, og det kan spare deg for ein bokmaalsfeil som trekkjer ned karakteren.',
          },
          {
            id: 'norsk-vg1-8-4-n-quiz4-q2',
            task: 'Kva er rett nynorsk for "Noen kommer bare derfor"?',
            options: [
              { id: 'a', text: 'Noen kjem bare difor', isCorrect: false },
              { id: 'b', text: 'Nokon kommer berre derfor', isCorrect: false },
              { id: 'c', text: 'Noen kommer berre difor', isCorrect: false },
              { id: 'd', text: 'Nokon kjem berre difor', isCorrect: true },
            ],
            solution: 'Alle fire orda ma endrast: "noen" → "nokon", "kommer" → "kjem", "bare" → "berre", "derfor" → "difor". Kvart einaste bokmalsord i nynorskteksten trekkjer ned.',
          },
        ],
      },
    },
...
Til slutt: Respekter spraket. Nynorsk er ikkje "vanskeleg bokmal" eller eit hinder. Det er eit rikt, levande sprak med lang tradisjon. Nar du skriv nynorsk, deltar du i ein kulturtradisjon som strekkjer seg tilbake til Ivar Aasen og fram til dagens nynorskforfattarar.`,
    ...
    // ========== QUIZ 5 ==========
    {
      ...
      exercise: {
        ...
        number: 'Quiz 5',
        type: 'multiple-choice',
        task: 'Test deg selv pa a tenkje nynorsk:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        solution: '',
        questions: [
          ...
          {
            id: 'norsk-vg1-8-4-n-quiz5-q1',
            task: 'Kva er det beste radet for a skrive god nynorsk?',
            options: [
              { id: 'a', text: 'Skriv teksten pa bokmal fyrst og omsett etterpaa', isCorrect: false },
              { id: 'b', text: 'Bruk sa mange dialektord som mogleg', isCorrect: false },
              { id: 'c', text: 'Tenkj nynorsk fraa fyrste stund - ikkje omsett fraa bokmal', isCorrect: true },
              { id: 'd', text: 'Kopier tekstar fraa nynorske aviser', isCorrect: false },
            ],
            solution: 'Det beste radet er a tenkje nynorsk fraa start. Nar du sit med eit bokmalshode og prover a "omsetje", ender du opp med a leite etter nynorskord for kvart bokmalsord, noko som blir tungt og feilfullt.',
          },
          {
            id: 'norsk-vg1-8-4-n-quiz5-q2',
            task: 'Kven skapte landsmaal (seinare nynorsk)?',
            options: [
              { id: 'a', text: 'Henrik Ibsen', isCorrect: false },
              { id: 'b', text: 'Bjornstjerne Bjornson', isCorrect: false },
              { id: 'c', text: 'Knud Knudsen', isCorrect: false },
              { id: 'd', text: 'Ivar Aasen', isCorrect: true },
            ],
            solution: 'Ivar Aasen skapte landsmaal (seinare nynorsk) pa 1800-talet med utgangspunkt i norske dialektar. Maalet var eit skriftsprak som laag naerare folkespraket enn det danske skriftspraket som dominerte.',
          },
        ],
      },
    },
...
"Kari, kan du hjelpe meg?" "Ja, det kan jeg."`,
    ...
    // ========== QUIZ 1 ==========
    {
      ...
      exercise: {
        ...
        number: 'Quiz 1',
        type: 'multiple-choice',
        task: 'Test deg selv pa kommaregler:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        solution: '',
        questions: [
          ...
          {
            id: 'norsk-vg1-8-5-n-quiz1-q1',
            task: 'Hvilken kommaregel skiller norsk fra engelsk?',
            options: [
              { id: 'a', text: 'Pa norsk setter vi komma foran leddsetninger', isCorrect: false },
              { id: 'b', text: 'Pa norsk setter vi IKKE komma foran "og" i oppramsinger', isCorrect: true },
              { id: 'c', text: 'Pa norsk bruker vi aldri komma', isCorrect: false },
              { id: 'd', text: 'Pa norsk setter vi komma etter hvert ord', isCorrect: false },
            ],
            solution: 'Pa norsk setter vi IKKE komma foran "og" i oppramsinger: "epler, bananer og druer" (ikke "epler, bananer, og druer"). Pa engelsk er det siste kommaet (Oxford-komma) vanlig, men det er feil pa norsk.',
          },
          {
            id: 'norsk-vg1-8-5-n-quiz1-q2',
            task: 'Hvor mange hovedregler for komma ble presentert i teksten?',
            options: [
              { id: 'a', text: 'Tre', isCorrect: false },
              { id: 'b', text: 'Fire', isCorrect: false },
              { id: 'c', text: 'Fem', isCorrect: true },
              { id: 'd', text: 'Sju', isCorrect: false },
            ],
            solution: 'Det ble presentert fem hovedregler: 1) komma ved oppramsing, 2) komma foran leddsetninger, 3) komma ved innskudd, 4) komma foran "og/men/eller" med nytt subjekt, og 5) komma ved tiltale.',
          },
          {
            id: 'norsk-vg1-8-5-n-quiz1-q3',
            task: 'Hvilken setning har riktig kommabruk ved innskudd?',
            options: [
              { id: 'a', text: 'Kari som er min venn kommer.', isCorrect: false },
              { id: 'b', text: 'Kari, som er min venn kommer.', isCorrect: false },
              { id: 'c', text: 'Kari som er min venn, kommer.', isCorrect: false },
              { id: 'd', text: 'Kari, som er min venn, kommer.', isCorrect: true },
            ],
            solution: 'Innskutte ledd far komma pa BEGGE sider: "Kari, som er min venn, kommer." Mange glemmer det andre kommaet etter innskuddet.',
          },
        ],
      },
    },
...
En nyttig test: Les setningen hoyt. Der du naturlig tar en liten pause, kan det være komma. Men dette er bare en hjelpende hand, ikke en regel - noen pauser er ikke komma.`,
    ...
    // ========== QUIZ 2 ==========
    {
      ...
      exercise: {
        ...
        number: 'Quiz 2',
        type: 'multiple-choice',
        task: 'Test deg selv pa vanlige kommafeil:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        solution: '',
        questions: [
          ...
          {
            id: 'norsk-vg1-8-5-n-quiz2-q1',
            task: 'Hvorfor er "Per, gikk hjem." feil?',
            options: [
              { id: 'a', text: 'Fordi "Per" skal ha liten forbokstav', isCorrect: false },
              { id: 'b', text: 'Fordi det aldri skal vaere komma mellom subjekt og verbal', isCorrect: true },
              { id: 'c', text: 'Fordi det mangler et utropstegn', isCorrect: false },
              { id: 'd', text: 'Fordi "gikk" er feil bøyning', isCorrect: false },
            ],
            solution: 'Det skal aldri vaere komma mellom subjekt og verbal. "Per gikk hjem." er riktig. Dette er en av de vanligste kommafeilene.',
          },
          {
            id: 'norsk-vg1-8-5-n-quiz2-q2',
            task: '"Per kom hit!" - hva er feilen?',
            options: [
              { id: 'a', text: 'Det mangler punktum', isCorrect: false },
              { id: 'b', text: 'Det er ingen feil', isCorrect: false },
              { id: 'c', text: 'Det mangler komma etter "Per" fordi vi tiltaler Per', isCorrect: true },
              { id: 'd', text: '"Kom" burde vaere "kjem"', isCorrect: false },
            ],
            solution: 'Nar du tiltaler noen, skal det vaere komma: "Per, kom hit!" Kommaet markerer at du snakker TIL Per, ikke om Per. Uten komma er setningen tvetydig.',
          },
        ],
      },
    },
...
Tips: Er du usikker pa semikolon? Bruk punktum i stedet. Semikolon brukes sjelden i moderne norsk, og det er aldri feil a bruke punktum.`,
    ...
    // ========== QUIZ 3 ==========
    {
      ...
      exercise: {
        ...
        number: 'Quiz 3',
        type: 'multiple-choice',
        task: 'Test deg selv pa kolon og semikolon:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        solution: '',
        questions: [
          ...
          {
            id: 'norsk-vg1-8-5-n-quiz3-q1',
            task: 'Hva er hovedforskjellen mellom kolon og semikolon?',
            options: [
              { id: 'a', text: 'Kolon er formelt, semikolon er uformelt', isCorrect: false },
              { id: 'b', text: 'Kolon sier "forklaring folger", semikolon binder naert beslektede setninger', isCorrect: true },
              { id: 'c', text: 'De betyr det samme og kan brukes om hverandre', isCorrect: false },
              { id: 'd', text: 'Semikolon brukes foran oppramsinger, kolon mellom setninger', isCorrect: false },
            ],
            solution: 'Kolon sier "nemlig" eller "forklaring folger" og innleder oppramsinger, forklaringer og sitat. Semikolon binder selvstendige setninger som henger naert sammen, som "Han var trott; likevel fortsatte han."',
          },
          {
            id: 'norsk-vg1-8-5-n-quiz3-q2',
            task: 'Hva er det tryggeste radet hvis du er usikker pa om du skal bruke semikolon?',
            options: [
              { id: 'a', text: 'Bruk kolon i stedet', isCorrect: false },
              { id: 'b', text: 'Bruk komma i stedet', isCorrect: false },
              { id: 'c', text: 'Bruk punktum i stedet', isCorrect: true },
              { id: 'd', text: 'Bruk tankestrek i stedet', isCorrect: false },
            ],
            solution: 'Semikolon brukes sjelden i moderne norsk, og det er aldri feil a bruke punktum i stedet. Nar du er usikker, er punktum det trygge valget.',
          },
        ],
      },
    },
...
IKKE apostrof ved vanlig genitiv: "Karins bok" (ikke "Karin's bok")!`,
    ...
    // ========== QUIZ 4 ==========
    {
      ...
      exercise: {
        ...
        number: 'Quiz 4',
        type: 'multiple-choice',
        task: 'Test deg selv pa tankestrek, bindestrek og anforselstegn:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        solution: '',
        questions: [
          ...
          {
            id: 'norsk-vg1-8-5-n-quiz4-q1',
            task: 'Hva er riktig bruk av apostrof pa norsk?',
            options: [
              { id: 'a', text: '"Karin\'s bok" - apostrof ved genitiv', isCorrect: false },
              { id: 'b', text: '"Marx\' teorier" - apostrof ved genitiv av navn pa s', isCorrect: true },
              { id: 'c', text: '"Gutten\'s hund" - apostrof mellom ord og ending', isCorrect: false },
              { id: 'd', text: 'Apostrof brukes aldri pa norsk', isCorrect: false },
            ],
            solution: 'Pa norsk brukes apostrof sjelden. Det er riktig ved genitiv av navn som ender pa s: "Marx\' teorier". Men IKKE ved vanlig genitiv: "Karins bok" (ikke "Karin\'s bok"). Denne feilen er pavirket av engelsk.',
          },
          {
            id: 'norsk-vg1-8-5-n-quiz4-q2',
            task: 'Hva er forskjellen mellom tankestrek (–) og bindestrek (-)?',
            options: [
              { id: 'a', text: 'De er identiske og kan brukes om hverandre', isCorrect: false },
              { id: 'b', text: 'Tankestrek brukes bare i matematikk', isCorrect: false },
              { id: 'c', text: 'Bindestrek brukes bare i starten av linjer', isCorrect: false },
              { id: 'd', text: 'Tankestrek markerer innskudd og strekninger, bindestrek binder ord', isCorrect: true },
            ],
            solution: 'Tankestrek (–) er lang og markerer innskudd, opphold og strekninger (Oslo–Bergen). Bindestrek (-) er kort og binder sammensatte ord (IT-avdeling, 17-aring). Tankestrek har mellomrom ved innskudd, bindestrek har aldri mellomrom.',
          },
        ],
      },
    },
...
Derfor er tegnsetting sa viktig. Det handler ikke bare om a folge regler - det handler om a kontrollere hva teksten din faktisk sier. Nar du mestrer tegnsetting, mestrer du kommunikasjon.`,
    ...
    // ========== QUIZ 5 ==========
    {
      ...
      exercise: {
        ...
        number: 'Quiz 5',
        type: 'multiple-choice',
        task: 'Test deg selv pa tegnsetting og mening:',
        options: [
          { id: 'a', text: 'placeholder', isCorrect: true },
        ],
        solution: '',
        questions: [
          {
            ...
            options: [
              ...
              { id: 'b', text: 'Forste inviterer bestemor til a spise, andre foreslar a spise bestemor', isCorrect: true },
              { id: 'c', text: 'Forste er sporsmal, andre er utrop', isCorrect: false },
          ...
          {
            id: 'norsk-vg1-8-5-n-quiz5-q1',
            task: 'Hva er forskjellen mellom "Studentene som ikke besto, ma ta eksamen pa nytt" og "Studentene, som ikke besto, ma ta eksamen pa nytt"?',
            options: [
              { id: 'a', text: 'Forste: bare de som strok ma ta eksamen. Andre: alle strok og ma ta eksamen.', isCorrect: true },
              { id: 'b', text: 'De betyr det samme, bare skrevet ulikt', isCorrect: false },
              { id: 'c', text: 'Forste er feil, andre er riktig', isCorrect: false },
              { id: 'd', text: 'Forste er uformelt, andre er formelt', isCorrect: false },
            ],
            solution: 'Uten komma er "som ikke besto" en nodvendig presisering - bare noen strok. Med komma er det et innskudd - tilleggsinformasjon som viser at ALLE studentene strok. Kommaet endrer hvem som ma ta eksamen!',
          },
          {
            id: 'norsk-vg1-8-5-n-quiz5-q2',
            task: 'Hva er hovedinnsikten om tegnsetting fra dette kapittelet?',
            options: [
              { id: 'a', text: 'Tegnsetting er unodvendig i moderne norsk', isCorrect: false },
              { id: 'b', text: 'Det finnes ingen faste regler for tegnsetting', isCorrect: false },
              { id: 'c', text: 'Tegnsetting er bare viktig pa eksamen', isCorrect: false },
              { id: 'd', text: 'Tegnsetting pavirker mening og handler om kommunikasjon, ikke bare regler', isCorrect: true },
            ],
            solution: 'Tegnsetting handler om mer enn bare regler - det handler om a kontrollere hva teksten din faktisk sier. Riktig tegnsetting gjor teksten tydelig og profesjonell, og feil tegnsetting kan endre meningen helt.',
          },
        ],
      },
    },
