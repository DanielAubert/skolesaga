...
export default function ChallengePage() {
  ...
  const challengeType = currentModule ? `pluss-minus-${currentModule.id}` as ChallengeType : 'pluss-minus';
      ...
      <main className="flex-1 container mx-auto px-4 py-8 max-w-4xl">
        <Breadcrumb className="mb-6">
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href={`/hoderegning/gh-pluss-minus/${oppgaveSlug}`}>Oppgave {currentModule.id}</BreadcrumbLink>
            </BreadcrumbItem>
            <BreadcrumbSeparator />
            <BreadcrumbItem>
