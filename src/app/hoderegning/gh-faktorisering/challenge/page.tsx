...
export default function FaktoriseringChallengePage() {
  ...
  const challengeType: ChallengeType = 'faktorisering';
          ...
          <CardContent>
            <ol className="space-y-3 text-muted-foreground">
              ...
              <li className="flex gap-3">
                ...
                <span>Alle løser de samme 15 faktoriseringsoppgavene - førstemann ferdig vinner!</span>
              </li>
            </ol>
          </CardContent>
        </Card>
