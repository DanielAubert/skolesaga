...
export default function BrokregningChallengePage() {
  ...
  const challengeType: ChallengeType = 'brokregning';
          ...
          <CardContent>
            <ol className="space-y-3 text-muted-foreground">
              ...
              <li className="flex gap-3">
                ...
                <span>Alle løser de samme 15 brøkoppgavene - førstemann ferdig vinner!</span>
              </li>
            </ol>
          </CardContent>
        </Card>
