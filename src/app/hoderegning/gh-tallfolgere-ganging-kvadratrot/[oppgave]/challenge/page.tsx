...
const currentModules = [
  { id: 1, name: "Tallfølger", description: "Enkle tallfølger", gradient: "from-blue-400 to-blue-600", icon: Target },
  { id: 2, name: "Tallfølger +", description: "Avanserte tallfølger", gradient: "from-purple-400 to-purple-600", icon: Brain },
  { id: 3, name: "Avanserte tallfølger", description: "Komplekse tallfølger", gradient: "from-green-400 to-green-600", icon: Trophy },
  { id: 4, name: "Ganging", description: "Grunnleggende ganging", gradient: "from-orange-400 to-orange-600", icon: Calculator },
  { id: 5, name: "Blandet regning", description: "Blandet multiplikasjon", gradient: "from-indigo-400 to-indigo-600", icon: Brain },
  { id: 6, name: "Gangestykke", description: "Finn manglende tall", gradient: "from-pink-400 to-pink-600", icon: Target },
  { id: 7, name: "Multiplikasjon 10/100/1000", description: "Ganging med 10, 100, 1000", gradient: "from-red-400 to-red-600", icon: Hash },
  { id: 8, name: "Gangestykke med 10", description: "Ganging med tier", gradient: "from-yellow-400 to-yellow-600", icon: Calculator },
  { id: 9, name: "Ganging med 5", description: "Ganging med 5", gradient: "from-cyan-400 to-cyan-600", icon: Target },
  { id: 10, name: "Ganging med 5 (avansert)", description: "Avansert ganging med 5", gradient: "from-violet-400 to-violet-600", icon: Trophy },
  { id: 11, name: "Ganging 6-14", description: "Gangetabellen 6-14", gradient: "from-emerald-400 to-emerald-600", icon: Award },
  { id: 12, name: "Kvadratrøtter", description: "Kvadratrøtter", gradient: "from-rose-400 to-rose-600", icon: Sparkles },
  { id: 13, name: "Store tall", description: "Ganging med store tall", gradient: "from-amber-400 to-amber-600", icon: Hash },
  { id: 14, name: "To-sifret ganging", description: "To-sifret ganging", gradient: "from-fuchsia-400 to-fuchsia-600", icon: Brain },
];
...
export default function ChallengePage() {
  ...
  const challengeType = currentModule ? `tallfolgere-${currentModule.id}` as ChallengeType : 'tallfolgere';
      ...
      <main className="flex-1 container mx-auto px-4 py-8 max-w-4xl">
        <Breadcrumb className="mb-6">
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/hoderegning/gh-tallfolgere-ganging-kvadratrot">Ganging & Kvadratrot</BreadcrumbLink>
            </BreadcrumbItem>
            <BreadcrumbSeparator />
            <BreadcrumbItem>
