...
const currentModules = [
  { id: 1, name: "Grunnleggende divisjon", description: "Lær divisjon steg for steg", gradient: "from-blue-400 to-blue-600", icon: Target },
  { id: 2, name: "Multiplikasjonsligninger", description: "Finn manglende faktor", gradient: "from-purple-400 to-purple-600", icon: Brain },
  { id: 3, name: "Faktorisering", description: "Bryt ned tall i faktorer", gradient: "from-green-400 to-green-600", icon: Trophy },
  { id: 4, name: "Divisjon og brøk", description: "Koble divisjon og brøk", gradient: "from-orange-400 to-orange-600", icon: Divide },
  { id: 5, name: "Brøkforenkling", description: "Forenkle brøker med faktorisering", gradient: "from-indigo-400 to-indigo-600", icon: CheckCircle2 },
  { id: 6, name: "Desimaltall-addisjon", description: "Legg sammen desimaltall", gradient: "from-pink-400 to-pink-600", icon: Hash },
  { id: 7, name: "Desimaltall-subtraksjon", description: "Trekk fra desimaltall", gradient: "from-red-400 to-red-600", icon: Brain },
  { id: 8, name: "Desimaltall-multiplikasjon", description: "Multipliser desimaltall", gradient: "from-yellow-400 to-yellow-600", icon: Trophy },
];
...
export default function ChallengePage() {
  ...
  const challengeType = currentModule ? `divisjon-${currentModule.id}` as ChallengeType : 'divisjon';
      ...
      <main className="flex-1 container mx-auto px-4 py-8 max-w-4xl">
        <Breadcrumb className="mb-6">
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/hoderegning/gh-divisjon-brok">Divisjon & Brøk</BreadcrumbLink>
            </BreadcrumbItem>
            <BreadcrumbSeparator />
            <BreadcrumbItem>
