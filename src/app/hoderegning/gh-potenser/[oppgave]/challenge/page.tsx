...
export default function ChallengePage() {
  ...
  const challengeType = currentModule ? `potenser-${currentModule.id}` as ChallengeType : 'potenser';
      ...
      <main className="flex-1 container mx-auto px-4 py-8 max-w-4xl">
        <Breadcrumb className="mb-6">
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href={`/hoderegning/gh-potenser/${oppgaveSlug}`}>Oppgave {currentModule.id}</BreadcrumbLink>
            </BreadcrumbItem>
            <BreadcrumbSeparator />
            <BreadcrumbItem>
          ...
          <CardContent>
            <ol className="space-y-3 text-muted-foreground">
              ...
              <li className="flex gap-3">
                ...
                <span>Alle løser de samme 15 potensoppgavene - førstemann ferdig vinner!</span>
              </li>
            </ol>
          </CardContent>
        </Card>
