...
const MODULE_INFO = {
  name: "Algebra",
  description: "Bokstavregning og algebraiske uttrykk",
...
export default function AlgebraChallengePage() {
  ...
  const challengeType: ChallengeType = 'algebra';
          ...
          <CardContent>
            <ol className="space-y-3 text-muted-foreground">
              ...
              <li className="flex gap-3">
                ...
                <span>Alle løser de samme 15 algebraoppgavene - førstemann ferdig vinner!</span>
              </li>
            </ol>
          </CardContent>
        </Card>
