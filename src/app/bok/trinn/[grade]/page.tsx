...
const GRADE_CONFIG: Record<string, {
  ...
  'vg1': {
    ...
    subjects: [
      ...
      { courseId: 'geografi', name: 'Geografi', icon: '🗺️', color: 'from-emerald-500 to-teal-600', image: '/images/subjects/geografi-hero.png' },
      { courseId: 'kroppsoving-vg1', name: 'Kroppsøving', icon: '🏃', color: 'from-cyan-500 to-teal-600', image: '/images/subjects/kroppsoving-vg1-hero.png' },
