...
const GRADE_CONFIG: Record<string, {
  ...
  'vg2': {
    ...
    subjects: [
      ...
      { courseId: 'historie-vg2', name: 'Historie', icon: '📜', color: 'from-amber-500 to-orange-600' },
      ...
      { courseId: 'kjemi1', name: 'Kjemi 1', icon: '🧪', color: 'from-orange-500 to-amber-600' },
    ],
  },
  'vg3': {
    title: 'VG3',
    ...
    subjects: [
      ...
      { courseId: 'kjemi2', name: 'Kjemi 2', icon: '🧪', color: 'from-orange-500 to-amber-600' },
    ],
  },
  'hoyere': {
