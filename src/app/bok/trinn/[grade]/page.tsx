...
const GRADE_CONFIG: Record<string, {
  ...
  'vg2': {
    ...
    subjects: [
      ...
      { courseId: 'it-1', name: 'Informasjonsteknologi 1', icon: '💻', color: 'from-sky-500 to-blue-600' },
      { courseId: 'geofag-1', name: 'Geofag 1', icon: '🌋', color: 'from-amber-600 to-orange-700', image: '/images/textbook-covers/geofag-1-hero.png' },
      { courseId: 'tof-1', name: 'Teknologi og forskningslære 1', icon: '🔬', color: 'from-teal-500 to-cyan-600' },
      ...
      { courseId: 'rettslaere-1', name: 'Rettslære 1', icon: '⚖️', color: 'from-slate-600 to-gray-700' },
      { courseId: 'politikk-menneskerett', name: 'Politikk og menneskerettigheter', icon: '🏛️', color: 'from-red-600 to-rose-700' },
  ...
  'vg3': {
    ...
    subjects: [
      ...
      { courseId: 'it-2', name: 'Informasjonsteknologi 2', icon: '💻', color: 'from-sky-500 to-blue-600' },
      { courseId: 'geofag-2', name: 'Geofag 2', icon: '🌋', color: 'from-amber-600 to-orange-700', image: '/images/textbook-covers/geofag-2-hero.png' },
      { courseId: 'tof-2', name: 'Teknologi og forskningslære 2', icon: '🔬', color: 'from-teal-500 to-cyan-600' },
      // Programfag samfunn/økonomi
