...
- **Forkunnskaper (kryssbok):** Firetrinnsmetoden (faktum → problemstilling → regel → subsumsjon) er felles med JUS1111 — lenk til [Praktikumsmetoden — fra anførsler til disposisjon](/bok/jus1111/jus1111-0-2) *(verifiser kapittel-id før lenking)*. Dette kapitlet legger til det arbeids-/personaljuridiske og de to sjangrene.
...
- **Forkunnskaper (kryssbok):** Avtalebinding (tilbud/aksept, konkludent atferd) er avtalerett fra JUS1111 — lenk til [Avtaleinngåelse — tilbud, aksept og binding](/bok/jus1111/jus1111-1-1) *(verifiser kapittel-id; ellers nærmeste JUS1111-avtalekapittel)*.
