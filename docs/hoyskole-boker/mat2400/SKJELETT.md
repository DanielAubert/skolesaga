...
bygget ennå; aktiver `/mat1100/<id>`- / `/mat1110/<id>`-lenke når den
...
- **Forkunnskaper (kryssbok):** Kap. 0.2 (aksiomlisten). Grenser og reelle følger fra kalkulus *(MAT1100 — forgjengerbok, ikke bygget ennå; aktiver `/mat1100/<id>`-lenke når den finnes)*. [Følger og grenseverdi](/r2/r2-1-1) (VGS-følgebegrepet — verifiser lenke i byggefasen).
...
- **Forkunnskaper (kryssbok):** Kap. 1.2–1.3 (kontinuitet, kompletthet). Rekker og grenser fra kalkulus *(MAT1100 — ikke bygget; aktiver lenke når den finnes)*. [Rekker](/r2/r2-2-1) (VGS-rekkebegrepet — verifiser lenke).
...
- **Forkunnskaper (kryssbok):** Kap. 1.1 (metrikk), 1.3 (kompletthet). Vektorrom og lineær algebra *(MAT1110 — forgjengerbok, ikke bygget ennå; aktiver `/mat1110/<id>`-lenke når den finnes)*. [Vektorer i planet](/r1/r1-6-1) (VGS-vektorregning — verifiser lenke).
...
- **Forkunnskaper (kryssbok):** Kap. 4.1 (norm), 1.3 (kompletthet). [Skalarprodukt](/r1/r1-6-3) (VGS-prikkprodukt — verifiser lenke).
...
- **Forkunnskaper (kryssbok):** Kap. 4.4 (indreprodukt, ortonormal basis). [Integrasjon ved delbrøk og substitusjon](/r2/r2-4-1) (delvis integrasjon — verifiser lenke).
...
- [ ] **Navigasjon**: `mat2400` inn i `src/app/trinn/hoyere/institusjoner.ts`
