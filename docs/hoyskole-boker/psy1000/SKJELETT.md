# Bokskjelett: PSY1000 Innføring i generell psykologi (UiO) — eksamensrettet lærebok
...
> `EKSAMENSANALYSE.md` (20 komplette oppgavesett H2009–H2018-utsatt + 3
> sensorveiledninger V2018/H2018/H2018-utsatt, Psykologisk institutt, UiO). Alle
> oppgaver, vignetter, case, modellbesvarelser og formuleringer i boka skal være
> NYSKREVNE (se §6). Pensumlitteratur (Holt, Teigen, Benjamin) refereres — aldri
> siteres i lengde.
>
> **Faglig presisjon er kritisk.** Psykologiske detaljer, teoretiker-attribusjoner
> og pensumsidetall forfatteren er usikker på merkes `(verifiser)` for fagfellesjekk
> i fase 6. Sidehenvisninger stammer fra sensorveiledningene og gjelder de utgavene
> de er skrevet mot — merkes ⚠ (utgaveavhengig).
...
- **Kurs-id:** `psy1000`
- **Tittel:** *PSY1000 Innføring i generell psykologi (UiO)*
- **Level:** `'Høyskole'`
- **Institusjon (navigasjon):** Universitetet i Oslo. Visningsnavn i
  `institusjoner.ts`: «PSY1000 Innføring i generell psykologi».
- **Arketype:** **drøfting/fakta-hybrid** — primærmalen er DNA-drøfting, men
  temakapitlene bygges som **eksamensessay-moduler** med lånt «faktakontrakt +
  momentliste»-mønster fra NOKUT-AFB (kalibrert mot reproduksjon og bredde, ikke
  fri drøfting). Hybrid-valget er dokumentert i §2 «Arketypetilpasning».
- **Kapittelantall:** 56 (Del 0: 2 · temadeler 1–10: 43 · eksamenstrening Del 11: 11)
- **Estimert totaltid:** ~3 130 minutter (~52 timer) fordelt per kapittel under
- **Quiz totalt:** 636 (krav ≥500) · **Flashcards totalt:** 796 (sikt 650–800,
  faktarikt fag — se kvotesammendrag)

**⚠ Emnet er nedlagt.** PSY1000 hadde siste undervisning V2018 og siste eksamen
H2018; arkivet er komplett og lukket. Boka profileres derfor som «Innføring i
generell psykologi» — **pensumet (grunnleggende psykologi + psykologihistorie) er
stabilt og direkte gjenbrukbart** for dagens innføringsemner i psykologi og som
øvingsbank for beslektede fag. **Byggefasen skal verifisere pensumkoblinger mot
gjeldende UiO-innføringsemne** (f.eks. dagens PSYC-innføring), siden lærebok og
sidetall kan ha flyttet seg. Dette er anbefalt i Del 0.1 og gjentatt i
verifikasjonssjekklista (§6).

**Pitch:** PSY1000-eksamen har én fast logikk: **6 timers skoleeksamen uten
hjelpemidler**, der du får 7 (før 2015: 10) selvstendige kortessay-spørsmål som
spenner over hele faget og besvarer **6 av 7**. Det finnes ingen deloppgaver,
ingen sammenhengende case — hvert spørsmål er ett avgrenset tema. Fra 2015-
innstrammingen («6 av 7») forsvant valgrommet: du må reelt kunne *nesten alt*.
Sensorveiledningene er **momentlister** — grunnvalutaen er fullstendig, korrekt og
pensumforankret dekning av sjekklista («prinsipper viktigere enn navn»); A/B
avgjøres av et eksplisitt **tilleggspoeng-lag** (kritikk, kontrast, illusjoner/
anvendelser, kobling til overordnede prinsipper). Fordi de samme spørsmålene
resirkuleres nesten ordrett år etter år, ER momentlistene reell fasit. Boka er
bygget baklengs fra dette: hvert av fagets ~43 kjernetemaer leveres som en
**eksamensessay-modul** — (1) rammesetting, (2) fullstendig innhold bygd på sensors
momentliste, (3) markert tilleggspoeng-felt, (4) modellbesvarelse i C- og A-versjon
der forskjellen er nøyaktig tilleggspoenglaget og prinsippforståelsen.
**Psykologihistorie er bokas bærebjelke** (Del 1, 8 kapitler) — ~1/3 av hvert sett
er rene historiespørsmål, PSY1000s signatur, med eget pensum (Teigen 2004,
Benjamin 2007) i tillegg til Holt.
...
oppdragets fagbolk-struktur: **historie først (bærebjelken), deretter fagets
systematiske bolker fra biologisk grunnlag til klinikk.**

| Del | Tittel | Kap. | Prioritet | Begrunnelse for omfang (analysen §2/§7) |
|---|---|---|---|---|
| 0 | Eksamenskart og essayhåndverk | 2 | perfekt (meta) | Eksamensformen, «6 av 7»-logikken, momentliste-/tilleggspoeng-håndverket og nedlagt-statusen må etableres FØR fagstoffet. |
| 1 | Psykologiens historie | 8 | perfekt | **Bærebjelken.** ~1/3 av hvert sett er historie. Kognitiv revolusjon 6, Darwin 4, assosiasjon 4, dyrestudier 4, ny eksperimentalpsyk. 3, neobehaviorisme 3, Gestalt 3, James 2. Eget pensum (Teigen/Benjamin). |
| 2 | Biologisk psykologi og nevrovitenskap | 2 | kunne/perfekt | Hjernen (struktur/lateralisering/metoder) 3 sett; autonome NS 1; arvelighet 1. Grunnlag for sansing, emosjon, klinikk. |
| 3 | Sansing og persepsjon | 4 | perfekt | Persepsjonstrioen: dybde 4, fargesyn 4, hørsel 3, psykofysikk 3, smerte 2. Faste momentlister = billige, forutsigbare poeng. |
| 4 | Læring og betinging | 3 | perfekt/kunne | Observasjonslæring 4, operant/Skinner 4+, klassisk betinging, atferdsterapi 2. Kobler til historie (behaviorisme) og klinikk. |
| 5 | Hukommelse, kognisjon og intelligens | 4 | perfekt/kunne | Linda/heuristikker 4, intelligens 4, hukommelse 2, språk 2, problemløsning 1. |
| 6 | Utviklingspsykologi | 4 | perfekt | **Tyngdepunkt.** Sosial-emosjonell voksen/eldre 7 (emnets hyppigste), Piaget 6, moralutvikling 3, tilknytning/språk/spedbarn. |
| 7 | Personlighet | 4 | perfekt/kunne | Trekk/Big Five 4, personlighetsforstyrrelser 3, Freud 2, Rogers/selvaktualisering 2. |
| 8 | Sosialpsykologi | 4 | perfekt | Konformitet/lydighet 5, krysskulturelle studier 4, fordommer/gruppe/prososial, attribusjon/dissonans. |
| 9 | Motivasjon, emosjon, stress og bevissthet | 5 | perfekt/kunne | Universelle emosjoner 4, stress/GAS 4, kognisjon–emosjon 3, overspising 3, helseatferd 3, søvn/drøm/hypnose/placebo (lav). |
| 10 | Psykiske lidelser og behandling | 5 | perfekt | Biologisk behandling 5, schizofreni 4, angst 4, kognitiv terapi 2 + depresjon/psykoanalyse/fellestrekk/diagnostikk. |
| 11 | Eksamenstrening | 11 | perfekt (meta) | 5 sjanger-/drillkapitler (T1–T5 + feilvaksine) + 3 modellbesvarelser (DNA-krav ≥3) + 3 komplette øvingseksamener i «6 av 7»-format. |

Rasjonale: ⭐⭐⭐-temaene (voksenutvikling, Piaget, kognitiv revolusjon,
dybde/fargesyn/hørsel, konformitet, biologisk behandling, schizofreni, angst,
universelle emosjoner, stress/GAS, trekk/Big Five, Linda, Darwin/assosiasjon/
dyrestudier) får egne kapitler med høyest kvote og full momentdrill; ⭐⭐-temaer
får eget eller delt kapittel; ⭐-temaer (søvn/drøm/hypnose, placebo, PTSD,
fakultetspsyk., Lewin, prososial, korrelasjonskoeffisient) dekkes kompakt inne i
beslektede kapitler og merkes «bør kjenne til». **Ingenting utelates** — «6 av 7»
gjør nesten hele bredden eksamensrelevant; prioriteringen styrer *dybde og
...
| 2 | Biologisk psykologi og nevrovitenskap |
| 3 | Sansing og persepsjon |
| 4 | Læring og betinging |
| 5 | Hukommelse, kognisjon og intelligens |
| 6 | Utviklingspsykologi |
| 7 | Personlighet |
| 8 | Sosialpsykologi |
| 9 | Motivasjon, emosjon, stress og bevissthet |
| 10 | Psykiske lidelser og behandling |
| 11 | Eksamenstrening |

### Sjangerkoder (fra analysen §3 — brukes i «Eksamensbelegg» under)

**T1** redegjørelse «beskriv / gjør rede for X» (dominerende — fullstendig,
korrekt, velstrukturert gjengivelse mot momentliste) · **T2** begrepsredegjørelse
«hva menes med X?» (presis definisjon + kontekst + kjernetrekk, ofte med invitasjon
til kritikk) · **T3** drøfting «drøft X» (T1-kunnskapsbunn + selvstendig vurderings-/
avveiingslag) · **T4** studie-/vignettoppgave (navngitt klassisk eksperiment gjengitt:
funn → hvorfor → generalisering — f.eks. Linda, Asch, Milgram, Selye) · **T5**
historieoppgave (personer/retninger/tidslinje/sammenhenger fra Teigen/Benjamin —
sensor vil ha *sammenhenger* og *flere sider*, ikke navneliste).

### Feilkoder (fra analysen §5 — brukes i «Typiske feil» under)

**F1** ufullstendig momentdekning — svare «halve» spørsmålet (bare monokulare cues;
bare Erikson; bare Big Five uten leksikalsk/faktoranalyse). Selve C→A-aksen ·
**F2** navneramsing uten prinsipp («Cattell, Eysenck, McCrae» uten å forklare hva
faktoranalyse gjør) — eksplisitt straffet · **F3** ignorere bonuslaget — korrekt men
«tørr» redegjørelse uten kritikk/kontrast/anvendelse (gratis A/B-poeng som ligger
igjen) · **F4** bruke tid på avgrenset stoff (Milgram-prosedyren når faktorene
spørres; stabilitet som hovedpoeng i voksenutvikling) · **F5** manglende
pensumforankring — generell allmennpsykologi/populærvitenskap i stedet for
lærebokstoffet · **F6** blande teoretikere og retninger — særlig historie (Wundt/
James/Ebbinghaus; Tolman/Hull/Skinner; strukturalisme/funksjonalisme/Gestalt/
behaviorisme) · **F7** konjunksjonsfeilen misforstått (Linda) — beskrive funnet uten
å forklare *hvorfor* det er en normativ feil, eller uten å navngi
representativitetsheuristikken · **F8** «drøft» besvart som ren gjengivelse (droppe
vurderingslaget) — eller motsatt: mene uten kunnskapsbunn · **F9** svare på for
mange spørsmål tynt (bedre seks solide enn spre seg; lite å hente på det sjuende) ·
**F10** historisk overforenkling — den kognitive revolusjon som rent brudd uten
kontinuiteten med neobehaviorismens mellomliggende variabler (nyansen sensor
premierer).

### Sensorkrav og kredittlogikk (fra analysen §4 — etableres i Del 0.2, refereres i hvert kapittel)

1. **Grunnvaluta = fullstendighet mot momentlista.** Toppsvaret treffer alle
   punktene sensor lister. Å hoppe over et delmoment senker svaret (F1).
2. **Prinsipper > navn.** Vis forståelse av mekanismen, ikke bare betegnelser (F2).
3. **Pensumforankring.** Stoffet hentes fra Holt/Teigen/Benjamin, ikke fra
   allmennkunnskap (F5).
4. **Tilleggspoeng-laget avgjør A/B.** Kritikk, kontrast, illusjoner/anvendelser,
   kobling til overordnede prinsipper — eksplisitt belønnet. Å la det ligge er
   gratis tap (F3).
5. **Avgrensninger respekteres.** Sensor setter grenser («ikke hovedfokus på
   Milgram-prosedyren»; «stabilitet ikke hovedfokus»; «diskutér viktigheten, ikke
   ram opp flest studier»). Tid på avgrenset stoff er bortkastet (F4).
6. **«Drøft» krever begge lag.** Kunnskapsbunn + vurdering; verken tørr gjengivelse
   eller pensumløs synsing (F8).
7. **Seks solide slår sju tynne** (F9).

### Arketypetilpasning (dokumenterte valg og avvik)

1. **Hybrid, ikke ren drøfting.** PSY1000 er verken et EXPHIL-drøftingsfag eller et
   regnefag — det er et **bredde- og reproduksjonsfag** der hovedvalutaen er presis,
   dekkende gjengivelse av navngitt lærebokstoff, med et sekundært (men
   karakteravgjørende) drøftings-/kritikklag. Derfor beholdes DNA-drøftings
   makrostruktur (Del 0-håndverk, temadeler etter frekvens, eksamenstrening med
   modellbesvarelser), men **temakapittelets DNA låner faktakontrakt-/momentliste-
   logikken fra NOKUT-AFB**: hvert temakapittel er en **eksamensessay-modul** med
   fem faste komponenter — (a) **faktakontrakt** (begreper/teoretikere/studier som
   SKAL med, forankret i pensum — flashcard-kilden), (b) **sensors momentliste**
   (den fullstendige sjekklista temaet krever, som speiler sensors egen — reell
   fasit), (c) **tilleggspoeng-felt** (det eksplisitte A/B-laget), (d)
   **modellbesvarelse i C- og A-versjon** (forskjellen = tilleggspoenglaget og
   prinsippforståelsen), (e) **øvingsoppgaver** som kloner de reelle
   oppgavemønstrene tett (nyskrevet).
2. **«Symbol- og formelliste» → «Begreps- og navneliste».** README-kravet om en
   collapsible rett etter Forkunnskaper omtolkes for et fag nesten uten formler:
   hvert kapittel får en `collapsible` **«Begreps- og navneliste»** som samler de
   sentrale fagbegrepene, teoretikerne og klassiske studiene kapitlet krever (det
   studenten må ha *utenat* i akkurat dette kapitlet), med pensumavsender. Unntak
   kun der det er smertefritt åpenbart.
3. **Momentlisten er reell fasit — massiv oppgavegjenbruk.** Fordi de samme
   spørsmålene resirkuleres nesten ordrett (voksenutvikling 7 sett, dybde 4 med
   *identisk* sensormomentliste, Linda 4, kognitiv revolusjon 6, konformitet 5,
   biologisk behandling 5), gjelder momentlistene bakover i tid selv der
   sensorveiledning mangler. Øvingsoppgavene kloner mønstrene tett, men er
   NYSKREVNE (endrede vignetter/formuleringer).
4. **Pensumforankring med reelle avsendere.** I motsetning til et rent puggefag
   HAR PSY1000 navngitte teoretikere/verk å forankre i (Wundt, James, Skinner,
   Piaget, Erikson, Ekman, Selye, Kahneman/Tversky, McCrae/Costa osv.). Forankringen
   er EKTE — aldri oppdiktede referanser. Men «prinsipper > navn»: modellsvarene
   viser at forståelse av mekanismen veier tyngre enn navnelister.
5. **Tre pensumankere.** Holt m.fl. (hovedbok — hele det systematiske faget), Teigen
   2004 og Benjamin 2007 (historiebolken). Se §pensumankere under. Sidetall er
   utgaveavhengige (⚠) og fra sensorveiledningene — verifiseres mot gjeldende utgave.

### Pensumankere (fra analysen §6 — brukes i faktakontraktene)

| Kilde | Rolle | Det veiledningene henter derfra (attesterte sidetall ⚠, verifiser) |
|---|---|---|
| **Holt, Bremner, Sutherland, Vliek, Passer & Smith, *Psychology: The Science of Mind and Behaviour*** (2./3. utg.) | Hovedbok — hele det systematiske faget | Sansing/persepsjon (dybde-cues s. 189ff, fargesyn, hørsel, psykofysikk); hjerne & atferd (kap. 4); hukommelse (kap. 8); tenkning (Linda/heuristikker s. 392); utvikling (kap. 12: Piaget, Kohlberg, voksen/eldre s. 559–566); sosialpsykologi (kap. 14: Asch, Milgram); personlighet (trekk s. 644–651); behandling (kap. 18: biologisk s. 805–811, Ellis, Beck) |
| **Karl Halvor Teigen, *En psykologihistorie*** (2004) | Historiebolken | Den nye eksperimentalpsykologien (kap. 4: psykofysikk, Wundt, Ebbinghaus); evolusjon/funksjonalisme (kap. 6); neobehaviorisme (s. 204–215); den kognitive revolusjon (kap. 12); rasjonalitet/heuristikker (s. 302) |
| **Ludy Benjamin, *A Brief History of Modern Psychology*** (2007) | Historiebolken | Neobehaviorisme (s. 144–153); Wundt, James, funksjonalisme, strukturalisme; assosiasjonspsykologiens linje |

### Kapittel-DNA (temakapittel = eksamensessay-modul — obligatorisk blokk-rekkefølge)

1. `tip` **Eksamensvinkel** — frekvens (antall sett), sjangre (T1–T5) temaet
   inngår i, gjenbruksmønster, prioritetsklasse. Fylles fra skjelettets
...
3. `text` **Temaet i fagets landskap** — kort rammesetting: hvilket problem temaet
   svarer på, hvor det står i faget/debattene.
4. `definition` **Kjernefakta og begreper** — presise definisjoner OG forankring
   (teoretiker/verk fra pensum) per begrep. **Toppnivå med `title` — dette er
   flashcard-kilden.**
5. `theorem`/`text` **Sensors momentliste** — den fullstendige sjekklista temaet
   krever, nummerert/strukturert, som speiler sensors egen momentliste (grunnvalutaen).
6. `example` **Modellbesvarelse (C→A)** — samme oppgave i C-versjon (korrekt men
   flat gjengivelse, tynn forankring) og A-versjon (treffer hele momentlista + leverer
   tilleggspoeng-laget + prinsippforståelse), med margnotater om gapet.
7. `tip` **Tilleggspoeng** — det eksplisitte A/B-laget for temaet (kritikk, kontrast,
   illusjon/anvendelse, kobling til overordnede prinsipper — det veiledningene
   belønner).
8. `warning` **Typiske feil** — feilkodene (F1–F10) som gjelder temaet.
9. `exercise` × 4–8 — stigende, blandet: 2–3 begreps-/kontrollspørsmål (T2-nivå,
   flashcard-/quizmateriale), 1–2 kortessay-oppgaver i T1/T3-sjanger med
   **momentliste-løsning** (ikke fullt essay), 1 studie-/historieoppgave (T4/T5) der
   relevant. Hver oppgave merket med sjangerkode.
10. `collapsible` **Pensumkart og repetisjon** — avsender → verk → hvilke
    begreper/poenger de «eier» (flashcard-råstoff) + 4–6 kontrollpunkter.

Sjanger-, feildrill- og modellbesvarelseskapitlene (Del 11) har egne oppsett — se §3.
...
> (T1–T5) + prioritetsklasse (perfekt/kunne/kjenne, fra analysen §7). **Faktakontrakt**
> = begreper/teoretikere/studier som SKAL med (flashcard-kilden). **Sensors momentliste**
> = den fullstendige sjekklista temaet krever (fasit-speil). **Tilleggspoeng** = det
> eksplisitte A/B-laget. **Kvote** = quiz/flashcards.

### Del 0 — Eksamenskart og essayhåndverk

#### Kapittel 0.1: Slik testes PSY1000
**id:** `psy1000-0-1` · **number:** 0.1 · **estimatedMinutes:** 35 · **prerequisites:** ingen

- **Kapitteltype:** eksamenskart.
- **Description:** Eksamensformen, «6 av 7»-logikken, temafrekvensen og
  gjenbruksmønstrene — pluss emnets nedlagt-status og hvordan boka brukes.
- **Eksamensbelegg:** Metakapittel (hele arkivet 2009–2018). Skal formidle: (a)
  **formen** — 6 timers skriftlig skoleeksamen (fra V2017 digitalt via Inspera),
  **ingen hjelpemidler** (senere ordbok tillatt), karakter A–F; oppgaven gis på
  bokmål/nynorsk/engelsk, kandidaten svarer på ett språk; (b) **oppgavestrukturen**
  — 7 (H2009–V2015: 10) selvstendige kortessay-spørsmål, **besvar 6**; ingen
  deloppgaver, ingen sammenhengende case; alle seks teller likt (helhetsvurdering);
  (c) **faseskiftet 2015** — fra «6 av 10» til «6 av 7» forsvant valgrommet: fra
  2015 må kandidaten kunne *nesten alt* på settet (den viktigste formendringen); (d)
  **temafrekvens-tabellen** (bærebjelke-spørsmålene som opptrer i 4–7 sett): sosial-
  emosjonell voksen/eldre 7 · Piaget 6 · kognitiv revolusjon 6 · konformitet/lydighet
  5 · biologisk behandling 5 · Darwin 4 · assosiasjon 4 · dyrestudier 4 · fargesyn 4 ·
  dybde 4 · universelle emosjoner 4 · Linda/heuristikker 4 · schizofreni 4 · angst 4 ·
  stress/GAS 4 · trekk/Big Five 4 · intelligens 4 · observasjonslæring 4 · krysskultur
  4; (e) **gjenbruket** — flere spørsmål resirkuleres nesten ordrett (voksenutvikling
  7 sett ofte ordrett, dybde 4 med *identisk* momentliste, Linda 4 med samme vignett)
  → å drille gamle sett er den mest treffsikre forberedelsen som finnes; (f)
  **nedlagt-status og profil**: siste eksamen H2018, arkivet lukket; pensumet er
  stabilt og gjenbrukbart, men **byggefasen skal verifisere lærebok-/pensumkobling
  mot gjeldende UiO-innføringsemne** (sidetall og utgave kan ha flyttet seg).
  Prioritet: perfekt (meta).
- **Faktakontrakt:** eksamensform-fakta; «6 av 10»→«6 av 7»-skiftet; temafrekvens-
  tabellen; de tre pensumankerne (Holt/Teigen/Benjamin) og hvem som «eier» hva;
  sjangeroversikten T1–T5 (peker til 0.2).
- **Sensors momentliste:** ingen (kartkapittel) — men en «slik leser du et sett»-
  gjennomgang av ett nyskrevet 7-spørsmåls eksempelsett med markering av hvilket
  ene spørsmål en kandidat kan velge bort, og hvorfor bredde slår dybde-i-lommer.
- **Tilleggspoeng:** ikke relevant (meta).
- **Typiske feil:** F9 (svare på for mange tynt); misforståelsen at man kan «velge
  bort» hele fagområder etter 2015.
- **Kvote:** 10 quiz / 10 flashcards (formfakta, «6 av 7», temafrekvens, hvem-eier-hva,
  nedlagt-status).

#### Kapittel 0.2: Essayhåndverket — momentlister, tilleggspoeng og karakternivåene
**id:** `psy1000-0-2` · **number:** 0.2 · **estimatedMinutes:** 45 · **prerequisites:** `psy1000-0-1`

- **Kapitteltype:** essayhåndverk.
- **Description:** Hvordan et PSY1000-kortessay bygges, hvordan sensor retter mot
  momentlister, hva tilleggspoeng-laget er, og hva som skiller A/C/E.
- **Eksamensbelegg:** Destillat av sensorkravene (analysen §4), stabile V2018–H2018.
  Prioritet: perfekt (meta). Skal operasjonalisere: (a) **de fem sjangrene T1–T5**
  med typisk formulering og tidsbudsjett (~35 min per essay: ~5 min rammesetting/
  disposisjon, ~25 min systematisk momentdekning, ~5 min tilleggspoenglag); (b)
  **momentliste-metoden** — toppsvaret treffer alle punktene sensor lister
  (grunnvalutaen); (c) **«prinsipper > navn»** — forståelse av mekanismen veier
  tyngre enn betegnelser; (d) **tilleggspoeng-laget** som A/B-markør (kritikk,
  kontrast, illusjoner/anvendelser, kobling til overordnede prinsipper); (e)
  **avgrensningsrespekt** (ikke bruk tid på det sensor uttrykkelig nedtoner); (f)
  **nivåbildet**: A/B = hele momentlista + tilleggspoenglaget + prinsipper +
  strukturert språk; C = kjernemomentene korrekt, men ren gjengivelse uten nyanser/
  kritikk/kobling (navnetungt); D/E = ufullstendig dekning, upresise begreper,
  blandede teoretikere, pensumløs prat; F = to eller færre reelt besvarte spørsmål.
- **Faktakontrakt:** besvarelsesarkitektur (rammesett/definer → systematisk
  momentdekning med rette begreper og klassiske studier → tilleggspoenglag →
  kort konklusjon); sjangerdefinisjonene T1–T5; de sju sensorkravene fra §2; «drøft
  krever begge lag»; «forankring uten avsender er C-stoff» og «gjengivelse uten
  tilleggspoeng lar A-poeng ligge» innføres som bokas mantraer.
- **Sensors momentliste:** samme kortessay-oppgave («Beskriv X») besvart tre ganger
  — E-versjon (ufullstendig, pensumløs), C-versjon (korrekt momentdekning, tørr),
  A-versjon (full momentliste + tilleggspoeng + prinsipper) — med margnotater om hvor
  poengene faller.
- **Tilleggspoeng:** kapitlet DEFINERER tilleggspoeng-begrepet — vis de fire faste
  typene med eksempler (dybde→Ames-rommet/illusjoner; krysskultur→oversettelses-
  problem; moralutvikling→Gilligan-kritikk; Linda→rasjonalitetsdebatten; kognitiv
  revolusjon→«hvor revolusjonær?»).
- **Typiske feil:** F1 (ufullstendig), F2 (navneramsing), F3 (droppe tilleggspoeng),
  F8 («drøft» som gjengivelse), F5 (pensumløs).
- **Kvote:** 12 quiz / 12 flashcards (sjangrene T1–T5, sensorkravene, nivåkjennetegn,
  de fire tilleggspoeng-typene).

### Del 1 — Psykologiens historie (bærebjelken)

> ~1/3 av hvert sett er rene historiespørsmål (T5). Egen fyldig del med eget pensum
> (Teigen 2004, Benjamin 2007). Sensor vil ha *sammenhenger* og *flere sider* belyst
> — hvorfor oppsto retningen, hva sto den i motsetning til, hva ble konsekvensen —
> ikke navnelister. Retningskart-/tidslinje-logikken (assosiasjonisme → psykofysikk/
> Wundt → strukturalisme/funksjonalisme → behaviorisme → neobehaviorisme → kognitiv
> revolusjon → humanisme) med eksplisitte kontinuitets-/bruddmarkører løper gjennom
> hele delen (den nyansen sensor premierer, jf. F10).

#### Kapittel 1.1: Assosiasjonisme, fakultetspsykologi og førvitenskapelig psykologi
**id:** `psy1000-1-1` · **number:** 1.1 · **estimatedMinutes:** 50 · **prerequisites:** `psy1000-0-2`

- **Kapitteltype:** tema (historie).
- **Description:** Assosiasjonsbegrepets linje gjennom psykologiens historie, skillet
  førvitenskapelig/vitenskapelig, og fakultetspsykologien — det historiske
  utgangspunktet for både læring og eksperimentalpsykologi.
- **Eksamensbelegg:** Assosiasjonsbegrepet 4 sett (H2012, H2013, V2014, V2015 —
  gjenganger); førvitenskapelig vs. vitenskapelig 1 (H2010); fakultetspsykologi 1
  (H2011). Sjangre: T5, T2. Prioritet: **perfekt** (§7 pkt. 11 — historiens bærebjelker).
- **Faktakontrakt:** Teigen/Benjamin ⚠: **assosiasjonspsykologi** (idéer knyttes ved
  likhet, nærhet i tid/rom, kontrast; den britiske empiristiske linjen — læring som
  assosiasjonsdannelse); assosiasjonsbegrepet som bro fra filosofi til
  eksperimentell læringsforskning (Ebbinghaus, senere betingingsteori);
  **fakultetspsykologi** (sinnet delt i medfødte «evner»/fakulteter — og hvorfor det
  ble forlatt); **førvitenskapelig vs. vitenskapelig psykologi** (spekulasjon/
  filosofi vs. systematisk observasjon og eksperiment; hva som gjorde psykologien til
  en egen vitenskap ~1879).
- **Sensors momentliste:** (1) hva assosiasjon betyr og assosiasjonslovene; (2)
  den historiske linjen fra empirismen til eksperimentell psykologi; (3)
  assosiasjonsbegrepets rolle i læringsteori (kobling fremover til Del 4); (4)
  skillet førvitenskapelig/vitenskapelig med Wundt (1879) som vannskille; (5)
  fakultetspsykologien som kontrast.
- **Tilleggspoeng:** trekke linjen helt frem til klassisk/operant betinging og
  moderne assosiativ læring; peke på hvordan assosiasjonstenkningen både muliggjorde
  og begrenset behaviorismen; kontrastere fakultetspsykologi mot senere
  lokaliseringsforskning (Del 2).
- **Typiske feil:** F6 (blande assosiasjonisme med behaviorisme uten å vise den
  historiske broen); F5 (svare filosofihistorie uten psykologikoblingen); F1
  (assosiasjonslovene uten den historiske linjen).
- **Kvote:** 12 quiz / 16 flashcards.

#### Kapittel 1.2: Den nye eksperimentalpsykologien — psykofysikk, Wundt og Ebbinghaus
**id:** `psy1000-1-2` · **number:** 1.2 · **estimatedMinutes:** 55 · **prerequisites:** `psy1000-1-1`

- **Kapitteltype:** tema (historie).
- **Description:** Psykofysikken (Weber, Fechner), Wundts laboratorium (1879) og
  Ebbinghaus' hukommelsesstudier — fødselen av psykologien som eksperimentell vitenskap.
- **Eksamensbelegg:** «Den nye eksperimentalpsykologien» 3 sett (H2015, H2017,
  H2018-utsatt — gjenganger, attestert Teigen kap. 4). Sjangre: T5, T2. Prioritet:
  **perfekt** (§7 pkt. 11).
- **Faktakontrakt:** Teigen kap. 4 ⚠: **psykofysikk** (Weber, Fechner — det
  kvantitative studiet av forholdet mellom fysisk stimulus og psykologisk
  opplevelse); absolutt terskel og differensiell terskel (JND); Webers lov;
  **Wundt** og verdens første psykologiske laboratorium (Leipzig **1879**);
  introspeksjon som metode; **Ebbinghaus** (hukommelseskurver, meningsløse
  stavelser, glemselskurven, læringskurven — hukommelse gjort eksperimentelt målbar).
- **Sensors momentliste:** (1) hva psykofysikk er og hvorfor det var et gjennombrudd
  (psykologiske fenomener kvantifisert); (2) Weber/Fechner og terskelbegrepene med
  Webers lov; (3) Wundt 1879 som psykologiens institusjonelle fødsel + introspeksjon;
  (4) Ebbinghaus' metode og funn (glemsels-/læringskurve); (5) hvordan disse gjorde
  psykologien til en egen eksperimentell vitenskap.
- **Tilleggspoeng:** koble psykofysikken fremover til moderne persepsjonsforskning
  (Del 3.1); vurdere introspeksjonens svakheter (som drev behaviorismens senere
  avvisning); peke på at Ebbinghaus etablerte den kvantitative hukommelsestradisjonen
  (kobling til Del 5.1).
- **Typiske feil:** F6 (blande Wundt/Fechner/Ebbinghaus, eller Wundt/Titchener —
  strukturalismen kommer i 1.3); F1 (nevne Wundt uten terskler/Ebbinghaus); F5
  (bordfast årstall uten forståelse av hva laboratoriet betød).
- **Kvote:** 12 quiz / 16 flashcards.

#### Kapittel 1.3: Strukturalisme, funksjonalisme og William James
**id:** `psy1000-1-3` · **number:** 1.3 · **estimatedMinutes:** 50 · **prerequisites:** `psy1000-1-2`

- **Kapitteltype:** tema (historie).
- **Description:** Titcheners strukturalisme, den amerikanske funksjonalismen og
  William James som mer enn James–Lange — de to første konkurrerende «skolene».
- **Eksamensbelegg:** William James 2 sett (H2017, H2018-utsatt — «mer enn James–
  Lange»); funksjonalisme inngår i Darwin-/evolusjonstemaet (1.4). Sjangre: T5, T2.
  Prioritet: kunne, høy (§7 pkt. 17/22 — James er stigende gjenganger; kontrastfigur
  i historieoppgaver).
- **Faktakontrakt:** Benjamin/Teigen ⚠: **strukturalisme** (Titchener — sinnets
  *elementer* kartlagt ved introspeksjon; hva bevisstheten består AV); **funksjonalisme**
  (hva bevisstheten er TIL FOR — tilpasning, påvirket av Darwin; kontrasten til
  strukturalismen); **William James** (*The Principles of Psychology* **1890**;
  bevissthetsstrømmen; selvet; vanen; instinkt; pragmatisk funksjonalisme — langt mer
  enn emosjonsteorien James–Lange, som hører i Del 9.2).
- **Sensors momentliste:** (1) strukturalismens prosjekt og metode (elementer,
  introspeksjon); (2) funksjonalismens motprosjekt (funksjon, tilpasning, Darwin-
  innflytelse); (3) James' bredde: bevissthetsstrøm, selv, vane, instinkt, *Principles*
  1890; (4) hvorfor James var «mer enn James–Lange»; (5) kontrasten struktur vs.
  funksjon som drivkraft i faget.
- **Tilleggspoeng:** vise funksjonalismens bro til behaviorismen og anvendt psykologi;
  peke på introspeksjonens felles svakhet i begge skoler; koble James' vanebegrep til
  senere lærings-/personlighetsteori.
- **Typiske feil:** F6 (redusere James til James–Lange-teorien; blande strukturalisme/
  funksjonalisme); F1 (James' bredde ikke dekket); F10 (fremstille skolene uten
  Darwin-koblingen for funksjonalismen).
- **Kvote:** 10 quiz / 14 flashcards.

#### Kapittel 1.4: Darwin og evolusjonens innflytelse på psykologien
**id:** `psy1000-1-4` · **number:** 1.4 · **estimatedMinutes:** 55 · **prerequisites:** `psy1000-1-3`

- **Kapitteltype:** tema (historie).
- **Description:** Hvordan Darwins evolusjonsteori formet dyrestudier, individuelle
  forskjeller, funksjonalisme, behaviorisme og moderne evolusjonspsykologi — et av
  historiens hyppigste og mest sammensatte spørsmål.
- **Eksamensbelegg:** Darwins innflytelse 4 sett (H2011, H2014, V2018, H2018 —
  gjenganger, attestert historie kap. 6). Sjangre: T5, T3. Prioritet: **perfekt**
  (§7 pkt. 11).
- **Faktakontrakt:** Teigen kap. 6 ⚠: **Darwin** og naturlig utvalg; hvordan
  evolusjonstanken åpnet for (a) studiet av **dyr** (kontinuitet menneske–dyr →
  dyrestudier, se 1.5), (b) **individuelle forskjeller** (variasjon → intelligenstesting,
  Galton), (c) **tilpasning/funksjon** (funksjonalismen, 1.3), (d) **instinkt** og
  medfødt atferd, (e) **behaviorismens** dyremodell, (f) moderne **evolusjonspsykologi**.
- **Sensors momentliste:** (1) kjernen i Darwins teori (variasjon, seleksjon,
  tilpasning); (2) dyrestudienes fremvekst (menneske–dyr-kontinuitet); (3)
  individuelle forskjeller → intelligensmåling; (4) funksjonalismen og
  tilpasningsperspektivet; (5) instinkt/medfødt atferd; (6) linjen til behaviorisme
  og moderne evolusjonspsykologi. Sensor vil se *flere av disse sidene*, ikke bare én.
- **Tilleggspoeng:** vurdere hvor gjennomgripende Darwins innflytelse egentlig var
  (kontinuitet vs. brudd); koble til dyrestudie-etikken (Del 11 metode); peke på
  spenningen mellom evolusjonær forklaring og kulturell variasjon (kobling Del 8.4/9.3).
- **Typiske feil:** F1 (bare én av de mange sidene dekket — Darwin er nettopp et
  bredde-spørsmål); F6 (blande Darwin/Galton/funksjonalisme-aktørene); F5 (biologi
  uten psykologikoblingen).
- **Kvote:** 14 quiz / 18 flashcards.

#### Kapittel 1.5: Behaviorismen — Watson, Pavlov, Thorndike og dyrestudiene
**id:** `psy1000-1-5` · **number:** 1.5 · **estimatedMinutes:** 55 · **prerequisites:** `psy1000-1-4`

- **Kapitteltype:** tema (historie).
- **Description:** Den klassiske behaviorismens fremvekst, dyrestudienes rolle i
  psykologiens historie, og bruddet med introspeksjonen.
- **Eksamensbelegg:** Dyrestudienes rolle 4 sett (H2013, V2014, V2015, H2015 —
  gjenganger); Thorndike & Köhlers læringssyn 1 (V2011). Sjangre: T5, T2, T3.
  Prioritet: **perfekt** (§7 pkt. 11). (Selve læringsmekanikken bygges ut i Del 4 —
  her ligger vekten på det *historiske*.)
- **Faktakontrakt:** Teigen/Benjamin ⚠: **Watson** (behaviorismens manifest 1913 —
  psykologi som studiet av observerbar atferd, avvisning av bevissthet/introspeksjon;
  «Lille Albert»); **Pavlov** (klassisk betinging som objektiv metode); **Thorndike**
  (effektloven, puzzle box — læring ved prøving og feiling); **dyrestudienes rolle**
  (Darwin-arven: kontinuitet menneske–dyr; kontrollerbarhet; generalisering fra dyr
  til menneske — og dens grenser). Kontrast: Köhlers innsiktslæring (Gestalt, 1.7)
  utfordret prøving-og-feiling-synet.
- **Sensors momentliste:** (1) behaviorismens programerklæring (observerbar atferd,
  avvisning av introspeksjon) med Watson; (2) hvorfor dyr ble sentrale (Darwin-
  kontinuitet, kontroll, etikk-frihet); (3) Pavlov/Thorndike som metodiske
  grunnpilarer; (4) hva dyrestudiene lærte oss og hvor generalisering brister; (5)
  kontrasten til Köhlers innsiktslæring.
- **Tilleggspoeng:** drøfte generaliserbarheten fra dyr til menneske (styrke/
  begrensning); koble til dyreetikk (Del 11); vise dyrestudienes vedvarende rolle
  (fra Pavlov til Bandura til biologisk psykologi).
- **Typiske feil:** F6 (blande Watson/Pavlov/Thorndike/Skinner — Skinner hører i
  1.6); F4 (utdype én enkelt studie når spørsmålet er dyrestudienes *rolle*); F1
  (glemme Darwin-koblingen som forklarer *hvorfor* dyr).
- **Kvote:** 12 quiz / 16 flashcards.

#### Kapittel 1.6: Neobehaviorismen — Tolman, Hull og Skinner
**id:** `psy1000-1-6` · **number:** 1.6 · **estimatedMinutes:** 50 · **prerequisites:** `psy1000-1-5`

- **Kapitteltype:** tema (historie).
- **Description:** Andre generasjon behaviorister — Tolmans kognitive kart, Hulls
  drivteori og Skinners radikale behaviorisme — og mellomliggende variabler, broen
  til den kognitive revolusjonen.
- **Eksamensbelegg:** Neobehaviorisme 3 sett (H2016, V2017, V2018 — gjenganger,
  attestert Teigen s. 204–215, Benjamin s. 144–153); Skinners bidrag også som
  læringstema (H2010, H2012). Sjangre: T5, T2. Prioritet: **perfekt** (§7 pkt. 11 —
  og kritisk for kontinuitetsnyansen i kognitiv revolusjon, 1.8).
- **Faktakontrakt:** Teigen s. 204–215 / Benjamin s. 144–153 ⚠: **Tolman** (målrettet
  atferd, **kognitive kart**, latent læring — indre representasjoner hos rotter);
  **Hull** (hypotetisk-deduktiv teori, **drives**/drivreduksjon); **Skinner** (radikal
  behaviorisme, operant betinging, avvisning av indre årsaker — se Del 4.2 for
  mekanikken); **mellomliggende variabler** (Tolman/Hull tillot indre konstrukter
  mellom stimulus og respons — nettopp det som pekte fremover mot kognitivismen).
- **Sensors momentliste:** (1) hva som skiller neobehaviorisme fra Watsons klassiske
  variant (aksept av mellomliggende variabler); (2) Tolmans kognitive kart/latent
  læring; (3) Hulls drivteori; (4) Skinners radikale kontrast (ingen indre årsaker);
  (5) mellomliggende variabler som forvarsel om den kognitive revolusjonen.
- **Tilleggspoeng:** eksplisitt koble mellomliggende variabler til kontinuiteten i
  den kognitive revolusjon (den A-differensierende nyansen, F10); kontrastere Tolman/
  Hull mot Skinner *innad* i retningen.
- **Typiske feil:** F6 (blande Tolman/Hull/Skinner-posisjonene); F10 (fremstille
  behaviorisme som monolittisk, uten Tolmans kognitive elementer); F2 (navnene uten
  «mellomliggende variabler»-prinsippet).
- **Kvote:** 12 quiz / 16 flashcards.

#### Kapittel 1.7: Gestaltpsykologi, humanistisk psykologi og Lewins feltteori
**id:** `psy1000-1-7` · **number:** 1.7 · **estimatedMinutes:** 50 · **prerequisites:** `psy1000-1-5`

- **Kapitteltype:** tema (historie).
- **Description:** Gestaltpsykologien (persepsjon og innsiktslæring), den humanistiske
  «tredje kraft» og Kurt Lewins feltteori — alternativene til behaviorisme og
  psykoanalyse.
- **Eksamensbelegg:** Gestalt 3 sett (V2010, H2010, V2016 — opprinnelse + bidrag til
  persepsjon/tenkning); humanistisk psykologi 1 (H2009); Lewins feltteori 1 (H2009).
  Sjangre: T5, T2. Prioritet: kunne/kjenne (§7 pkt. 22 — differensierer; Gestalt-
  persepsjonsbidraget kobler til Del 3).
- **Faktakontrakt:** Teigen ⚠: **Gestaltpsykologi** (Wertheimer, Köhler, Koffka;
  **phi-fenomenet**; «helheten er mer enn summen av delene»; grupperingslovene i
  persepsjon; **Köhlers innsiktslæring** — sjimpansene, «aha»-opplevelsen, kontrast
  til Thorndikes prøving-og-feiling); **humanistisk psykologi** («tredje kraft» ved
  siden av behaviorisme og psykoanalyse; Maslow, Rogers — se Del 7.2; fokus på vekst,
  mening, selvrealisering); **Kurt Lewin** (feltteori — atferd = funksjon av person og
  miljø; livsrom; grunnlegger av moderne sosialpsykologi).
- **Sensors momentliste:** (1) Gestaltpsykologiens opprinnelse og kjerneprinsipp
  (helhet > deler); (2) bidrag til persepsjon (gruppering, phi) og tenkning
  (innsiktslæring); (3) humanismens plassering som «tredje kraft» og dens fokus; (4)
  Lewins felttenkning og betydning for sosialpsykologien.
- **Tilleggspoeng:** koble Gestalt-persepsjon fremover til Del 3 (persepsjonsorganisering,
  illusjoner); kontrastere innsiktslæring mot behaviorismens læringssyn (1.5); vise
  humanismens kritikk av både behaviorisme og psykoanalyse.
- **Typiske feil:** F6 (blande Gestalt-teoretikerne; Köhler som Gestalt vs. behaviorist);
  F1 (Gestalt uten både persepsjons- OG tenkningsbidraget); F5 («helhet > deler» som
  slagord uten prinsipp).
- **Kvote:** 10 quiz / 14 flashcards.

#### Kapittel 1.8: Den kognitive revolusjon
**id:** `psy1000-1-8` · **number:** 1.8 · **estimatedMinutes:** 55 · **prerequisites:** `psy1000-1-6`

- **Kapitteltype:** tema (historie).
- **Description:** Mennesket som informasjonsbehandler, bruddet med behaviorismen og
  de tverrfaglige inspirasjonskildene — og det karakteravgjørende spørsmålet: hvor
  «revolusjonær» var den egentlig?
- **Eksamensbelegg:** Den kognitive revolusjon 6 sett (H2009, V2012, H2012, H2014,
  V2016, H2018 — ett av emnets hyppigste, attestert Teigen kap. 12 + Holt kap. 8).
  Sjangre: T2, T3, T5. Prioritet: **perfekt** (§7 pkt. 3).
- **Faktakontrakt:** Teigen kap. 12 ⚠: **den kognitive revolusjon** (~1950–60-tallet);
  **informasjonsbehandler-metaforen** (mennesket som prosesserer input → representasjon
  → output; datamaskin-analogien); bruddet med behaviorismens black box (indre
  prosesser blir legitime igjen); **tverrfaglige inspirasjonskilder** — informatikk/
  kunstig intelligens, lingvistikk (Chomskys kritikk av Skinners språksyn),
  hjerneforskning, informasjonsteori; sentrale skikkelser (Miller, Neisser, Chomsky
  `(verifiser omfang i pensum)`); kontinuiteten med neobehaviorismens mellomliggende
  variabler (1.6).
- **Sensors momentliste:** (1) hva «kognitiv revolusjon» betyr — informasjonsbehandler-
  metaforen; (2) bruddet med behaviorismen (indre mentale prosesser legitimt igjen);
  (3) de tverrfaglige inspirasjonskildene (IT/AI, lingvistikk, hjerneforskning); (4)
  konsekvensene for faget (kognitiv psykologi som dominerende paradigme); (5) spørsmålet
  om hvor revolusjonær den var (kontinuiteten med Tolman/Hulls mellomliggende variabler).
- **Tilleggspoeng:** eksplisitt problematisere «revolusjon» vs. «evolusjon» —
  kontinuiteten med neobehaviorismen (F10 er den vanligste feilen her, og nyansen
  sensor eksplisitt premierer); koble Chomsky–Skinner-debatten (Del 5.2); vise
  informasjonsmetaforens grenser.
- **Typiske feil:** F10 (fremstille som rent brudd uten kontinuiteten — den A-
