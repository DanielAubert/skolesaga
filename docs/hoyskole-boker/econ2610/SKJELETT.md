...
- **ECON1410 Internasjonal økonomi** — den nærmeste slektningen (samme HO-teoremer,
  ...
  `[…](/econ1410/<id>)` for grafisk fordypning der 2610 forutsetter figuren kjent.
...
- [ ] **Kryssbok-lenker**: alle `/econ1410/...`, `/econ1210/...`,
  `/econ2220/...`-lenker peker på eksisterende kapitler; er målboka ikke publisert,
