...
`/bok/mat111-uib/<id>`-lenke når den finnes)*. Referanser til bygde bøker lenkes
...
- **Forkunnskaper (kryssbok):** [Likningssett](/bok/1t/1t-4-1) og [Lineære likningssystem og Gauss-eliminasjon](/bok/bi-okonomi/bi-okonomi-9-3) (elementær eliminasjon + matriseføring). Matrisenotasjonen bygges fra grunnen her; ingen forkunnskaper i abstrakt lineær algebra forutsettes.
...
- **Forkunnskaper (kryssbok):** Kap. 1.1. [Likningssett](/bok/1t/1t-4-1) (VGS-eliminasjon som utgangspunkt).
...
- **Forkunnskaper (kryssbok):** Kap. 1.1–1.2. [Vektorer i tre dimensjoner](/bok/r2/r2-5-1) (vektorbegrepet i $\mathbb{R}^n$).
...
- **Forkunnskaper (kryssbok):** Kap. 1.1–1.3. [Vektorregning](/bok/r1/r1-6-2) (lineærkombinasjon i planet).
...
- **Forkunnskaper (kryssbok):** Kap. 1.1–1.4. [Matriser og matriseregning](/bok/bi-okonomi/bi-okonomi-9-1) og [Determinanter og invers matrise](/bok/bi-okonomi/bi-okonomi-9-2) (matriseproduktet og 2×2-invers fra økonomi-innføringen).
...
- **Forkunnskaper (kryssbok):** Kap. 2.1. [Determinanter og invers matrise](/bok/bi-okonomi/bi-okonomi-9-2) (2×2- og 3×3-determinant fra økonomi-innføringen).
...
- **Forkunnskaper (kryssbok):** Kap. 2.1–2.2. [Kryssproduktet](/bok/r2/r2-5-4) (determinant som areal/volum-kjennskap).
...
- **Forkunnskaper (kryssbok):** Kap. 1.4 (span, underrom i $\mathbb{R}^n$). [Vektorer i tre dimensjoner](/bok/r2/r2-5-1) (konkret vektorrom som utgangspunkt).
...
- **Forkunnskaper (kryssbok):** Kap. 2.1 (matriseprodukt), 1.4 (span/uavhengighet). [Hva er en funksjon?](/bok/1t/1t-3-3) (avbildning generelt).
...
- **Forkunnskaper (kryssbok):** Kap. 4.2, 3.3 (basisskifte). [Kryssproduktet](/bok/r2/r2-5-4) og [Skalarproduktet](/bok/r2/r2-5-3) (geometrien bak projeksjon/refleksjon).
...
- **Forkunnskaper (kryssbok):** Kap. 1.3 ($\operatorname{Nul}$/$\operatorname{Col}$). [Skalarproduktet](/bok/r2/r2-5-3) (prikkprodukt og vinkel i $\mathbb{R}^3$).
...
- **Forkunnskaper (kryssbok):** Kap. 6.1. [Vektorregning](/bok/r1/r1-6-2) (projeksjon av vektor på vektor).
...
- **Forkunnskaper (kryssbok):** Kap. 6.1–6.2 (projeksjon), 2.1 (invers/system). [Modellering med reelle data](/bok/r2/r2-6-5) (regresjonsintuisjon fra VGS).
...
- **Forkunnskaper (kryssbok):** Kap. 1.3–1.4 (rang, underrom), 6.1 ($W^{\perp}$, $\operatorname{Nul}(A^{T})$). [Bevis og matematisk argumentasjon](/bok/r2/r2-6-6) (bevisføring generelt).
...
- [ ] **Navigasjon**: `mat121-uib` inn i `src/app/bok/trinn/hoyere/institusjoner.ts`
