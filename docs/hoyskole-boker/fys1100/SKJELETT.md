...
5. **Midtveis-MCQ-simulering (kap. 11.2)** speiler at midtveiseksamen (**20 %** av karakteren — verifisert 26. juli 2026 mot UiOs emneside) er ren flervalg over første
   halvdel. **Quizbanken i Del 1–7 er direkte midtveistrening** (se under); 11.2
   samler den til et generalprøve-format.

**Midtveiseksamen (**20 %** av karakteren — verifisert mot emnesiden 26. juli 2026; ren
...
**Del 1–7 + 9 utgjør 400 quiz — det er midtveispensumet** (20 %), kalibrert
...
(20 % av karakteren; dekker Del 1–7 + 9, aldri tung ODE-løsning/Python/SR).
...
1. **Slik ser eksamen ut** — den todelte vurderingen (midtveis flervalg 20 %
