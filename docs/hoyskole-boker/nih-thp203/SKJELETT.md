...
- **Forkunnskapslenke:** momentarmer, leddakser og muskelvirkeretning hentes fra **THP101 Funksjonell anatomi** — lenk dit (`/bok/nih-thp101/...` når kapitlet finnes) og gjenta ikke anatomien.
