...
*(MAT1100 — forgjengerbok, ikke bygget ennå; aktiver `/mat1110/…`→`/mat1100/<id>`-lenke når den finnes)*.
...
- **Forkunnskaper (kryssbok):** [Lineære likningssystemer](/1t/1t-4-1) og [Løsning av likningssett](/r1/r1-6-1) (VGS-eliminasjon som utgangspunkt). Matriseføring av likningssystemer er nytt — bygges fra grunnen. Determinant/invers 2×2 fra *(MAT1100 kap. 5.1–5.2 — forgjengerbok, ikke bygget ennå; aktiver lenke når den finnes)* forutsettes kjent, men repeteres ikke.
...
- **Forkunnskaper (kryssbok):** Kap. 1.1; [Vektorer i tre dimensjoner](/r2/r2-5-1) (vektorbegrepet i $\mathbb{R}^3$).
...
- **Forkunnskaper (kryssbok):** Kap. 1.1–1.3; [Funksjonsbegrepet](/1t/1t-3-1) (avbildning generelt).
...
- **Forkunnskaper (kryssbok):** Gradient og retningsderivert *(MAT1100 kap. 5.4 — forgjengerbok, ikke bygget ennå; aktiver lenke når den finnes)* **forutsettes kjent** og repeteres kun kompakt. [Skalarproduktet](/r2/r2-5-3) (retningsderivert som prikkprodukt).
...
- **Forkunnskaper (kryssbok):** Kap. 2.1 (gradient, andrederiverte). [Funksjonsdrøfting](/r1/r1-4-6) (ekstremalpunkt-intuisjon i én variabel).
...
- **Forkunnskaper (kryssbok):** Kap. 2.1, 3.1 (gradient, Hesse). [Potensrekker og Taylor-rekker](/s2/s2-7-4) (Taylor-intuisjon i én variabel).
...
- **Forkunnskaper (kryssbok):** Kap. 2.1. [Bestemt integral](/r2/r2-2-4) og [Areal mellom kurver](/r2/r2-2-7) (enkeltintegral + arealtolkning).
...
- **Forkunnskaper (kryssbok):** Kap. 4.1–4.2. [Volum av omdreiningslegemer](/r2/r2-3-6) (volumtolkning). Formelsamlingen gir sylinder-/kulekoordinatenes volumelementer.
...
- **Forkunnskaper (kryssbok):** Kap. 2.1; [Kryssproduktet](/r2/r2-5-4) og [Vektorer i tre dimensjoner](/r2/r2-5-1). Formelsamlingen gir hastighet/fart/akselerasjon/buelengde og flateintegralformlene.
...
- **Forkunnskaper (kryssbok):** [Uendelige rekker og konvergens](/r2/r2-1-5) og [Geometriske følger](/r2/r2-1-3) (rekkebegrepet fra VGS). Formelsamlingen gir geometriske/binomiske rekker og standard Taylor-rekker.
...
- **Forkunnskaper (kryssbok):** Kap. 6.3; [Potensrekker og Taylor-rekker](/s2/s2-7-4). Formelsamlingen gir standard Taylor-rekker ($e^x$, $\sin$, $\cos$, $\ln(1-x)$, $\arctan$) og geometrisk rekke.
...
- **Forkunnskaper (kryssbok):** [Separable differensiallikninger](/s2/s2-2-2) og [Lineære differensiallikninger](/s2/s2-2-3) (S2-nivå). Enkeltvariabel integrasjonsteknikk fra *(MAT1100 Del 4 — forgjengerbok, ikke bygget ennå; aktiver lenke når den finnes)*.
