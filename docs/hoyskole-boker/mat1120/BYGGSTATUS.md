...
| 5 | FERDIG (173 sympy-sjekker: projeksjon/minste kvadrater, alle residualer ⊥-testet) | 4 rettet i kap: 5-1-ex-wperp (faktor-2-feil mellomregning fjernet), 5-2-ex-normal (forvansket Cᵀb-display), 5-2 bb-21/bb-23 (dobbelt-escapede backslasher), 5-3-e13 (P₁→P₂). Quiz: fasit OK i alle 54; 3 defekte + 2 dupliserte distraktorer byttet (5-1/5-2/5-3) |
